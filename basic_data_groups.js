...
import archetypeinvestigator from './json/archetypes_investigator.json' with {type: 'json'};
import archetypekineticist from './json/archetypes_kineticist.json' with {type: 'json'};
import archetypemagus from './json/archetypes_magus.json' with {type: 'json'};
...
import archetypeunchained_monk from './json/archetypes_monk_UC.json' with {type: 'json'};
...
import archetypepaladin from './json/archetypes_paladin.json' with {type: 'json'};
import archetypepsychic from './json/archetypes_psychic.json' with {type: 'json'};
import archetyperanger from './json/archetypes_ranger.json' with {type: 'json'};
import archetyperogue from './json/archetypes_rogue.json' with {type: 'json'};
import archetypesamurai from './json/archetypes_samurai.json' with {type: 'json'};
import archetypeshaman from './json/archetypes_shaman.json' with {type: 'json'};
import archetypeshifter from './json/archetypes_shifter.json' with {type: 'json'};
import archetypeskald from './json/archetypes_skald.json' with {type: 'json'};
import archetypeslayer from './json/archetypes_slayer.json' with {type: 'json'};
import archetypesorcerer from './json/archetypes_sorcerer.json' with {type: 'json'};
import archetypespiritualist from './json/archetypes_spiritualist.json' with {type: 'json'};
import archetypesummoner from './json/archetypes_summoner.json' with {type: 'json'};
import archetypeunchained_summoner from './json/archetypes_summoner_UC.json' with {type: 'json'};
import archetypeswashbuckler from './json/archetypes_swashbuckler.json' with {type: 'json'};
import archetypevigilante from './json/archetypes_vigilante.json' with {type: 'json'};
import archetypewarpriest from './json/archetypes_warpriest.json' with {type: 'json'};
import archetypewitch from './json/archetypes_witch.json' with {type: 'json'};
...
import magicaltar from './json/magic_altar.json' with {type: 'json'};
...
import magicrelic from './json/magic_relics.json' with {type: 'json'};
import magicring from './json/magic_ring.json' with {type: 'json'};
import magicrod from './json/magic_rod.json' with {type: 'json'};
import magicset from './json/magic_set.json' with {type: 'json'};
import magicpiercing from './json/magic_shadow_piercings.json' with {type: 'json'};
import magicstaff from './json/magic_staff.json' with {type: 'json'};
import magictattoo from './json/magic_tattoo.json' with {type: 'json'};
import magicthrone from './json/magic_throne.json' with {type: 'json'};
import subtype from './json/monster_subtypes.json' with {type: 'json'};
import mtype from './json/monster_types.json' with {type: 'json'};
import npcclass from './json/npc_classes.json' with {type: 'json'};
import sidekick from './json/sidekicks.json' with {type: 'json'};
import skill from './json/skills.json' with {type: 'json'};
import spelldef from './json/spell_definitions.json' with {type: 'json'};
import trap from './json/traps.json' with {type: 'json'};
import umr from './json/umr.json' with {type: 'json'};
import ability1 from './json/class_abilities.json' with {type: 'json'};
import ability2 from './json/class_abilities2.json' with {type: 'json'};
...
import classes4 from './json/classes4.json' with {type: 'json'};
import classes5 from './json/classes5.json' with {type: 'json'};
import classes6 from './json/classes6.json' with {type: 'json'};
import classes7 from './json/classes7.json' with {type: 'json'};
import classes8 from './json/classes8.json' with {type: 'json'};
import equipmentmisc1 from './json/equipment_misc.json' with {type: 'json'};
import equipmentmisc2 from './json/equipment_misc2.json' with {type: 'json'};
import equipmentmisc3 from './json/equipment_misc3.json' with {type: 'json'};
import equipmentmisc4 from './json/equipment_misc4.json' with {type: 'json'};
import faith1 from './json/faiths.json' with {type: 'json'};
import faith2 from './json/faiths2.json' with {type: 'json'};
import faith3 from './json/faiths3.json' with {type: 'json'};
...
import main5 from './json/main05.json' with {type: 'json'};
import main6 from './json/main06.json' with {type: 'json'};
import main7 from './json/main07.json' with {type: 'json'};
import main8 from './json/main08.json' with {type: 'json'};
import main9 from './json/main09.json' with {type: 'json'};
import main10 from './json/main10.json' with {type: 'json'};
import main11 from './json/main11.json' with {type: 'json'};
import main12 from './json/main12.json' with {type: 'json'};
import main13 from './json/main13.json' with {type: 'json'};
import main14 from './json/main14.json' with {type: 'json'};
import main15 from './json/main15.json' with {type: 'json'};
import main16 from './json/main16.json' with {type: 'json'};
import main17 from './json/main17.json' with {type: 'json'};
import main18 from './json/main18.json' with {type: 'json'};
import main19 from './json/main19.json' with {type: 'json'};
import main20 from './json/main20.json' with {type: 'json'};
import main21 from './json/main21.json' with {type: 'json'};
import main22 from './json/main22.json' with {type: 'json'};
import main23 from './json/main23.json' with {type: 'json'};
import main24 from './json/main24.json' with {type: 'json'};
import main25 from './json/main25.json' with {type: 'json'};
import main26 from './json/main26.json' with {type: 'json'};
import main27 from './json/main27.json' with {type: 'json'};
import main28 from './json/main28.json' with {type: 'json'};
import main29 from './json/main29.json' with {type: 'json'};
import main30 from './json/main30.json' with {type: 'json'};
import main31 from './json/main31.json' with {type: 'json'};
import main32 from './json/main32.json' with {type: 'json'};
...
import monster4 from './json/monsters04.json' with {type: 'json'};
import monster5 from './json/monsters05.json' with {type: 'json'};
import monster6 from './json/monsters06.json' with {type: 'json'};
import monster7 from './json/monsters07.json' with {type: 'json'};
import monster8 from './json/monsters08.json' with {type: 'json'};
import monster9 from './json/monsters09.json' with {type: 'json'};
import monster10 from './json/monsters10.json' with {type: 'json'};
import monster11 from './json/monsters11.json' with {type: 'json'};
import monster12 from './json/monsters12.json' with {type: 'json'};
import monster13 from './json/monsters13.json' with {type: 'json'};
import monster14 from './json/monsters14.json' with {type: 'json'};
import monster15 from './json/monsters15.json' with {type: 'json'};
import monster16 from './json/monsters16.json' with {type: 'json'};
import monster17 from './json/monsters17.json' with {type: 'json'};
import monster18 from './json/monsters18.json' with {type: 'json'};
import monster19 from './json/monsters19.json' with {type: 'json'};
import monster20 from './json/monsters20.json' with {type: 'json'};
import monster21 from './json/monsters21.json' with {type: 'json'};
import monster22 from './json/monsters22.json' with {type: 'json'};
import monster23 from './json/monsters23.json' with {type: 'json'};
import monster24 from './json/monsters24.json' with {type: 'json'};
import monster25 from './json/monsters25.json' with {type: 'json'};
import monster26 from './json/monsters26.json' with {type: 'json'};
import monster27 from './json/monsters27.json' with {type: 'json'};
import monster28 from './json/monsters28.json' with {type: 'json'};
import monster29 from './json/monsters29.json' with {type: 'json'};
import monster30 from './json/monsters30.json' with {type: 'json'};
import monster31 from './json/monsters31.json' with {type: 'json'};
import monster32 from './json/monsters32.json' with {type: 'json'};
import monster33 from './json/monsters33.json' with {type: 'json'};
import monster34 from './json/monsters34.json' with {type: 'json'};
import monster35 from './json/monsters35.json' with {type: 'json'};
import monster36 from './json/monsters36.json' with {type: 'json'};
import monster37 from './json/monsters37.json' with {type: 'json'};
import monster38 from './json/monsters38.json' with {type: 'json'};
import monster39 from './json/monsters39.json' with {type: 'json'};
import monster40 from './json/monsters40.json' with {type: 'json'};
import monster41 from './json/monsters41.json' with {type: 'json'};
import monster42 from './json/monsters42.json' with {type: 'json'};
import monsteru1 from './json/monsters_unique.json' with {type: 'json'};
import monsteru2 from './json/monsters_unique2.json' with {type: 'json'};
import monsteru3 from './json/monsters_unique3.json' with {type: 'json'};
import monsteru4 from './json/monsters_unique4.json' with {type: 'json'};
import monsterm1 from './json/mythic_monsters.json' with {type: 'json'};
import monsterm2 from './json/mythic_monsters2.json' with {type: 'json'};
import template1 from './json/monsters_templates.json' with {type: 'json'};
import template2 from './json/monsters_templates2.json' with {type: 'json'};
import template3 from './json/monsters_templates3.json' with {type: 'json'};
...
import race4 from './json/races4.json' with {type: 'json'};
import rule1 from './json/rule01.json' with {type: 'json'};
import rule2 from './json/rule02.json' with {type: 'json'};
import rule3 from './json/rule03.json' with {type: 'json'};
import rule4 from './json/rule04.json' with {type: 'json'};
import rule5 from './json/rule05.json' with {type: 'json'};
import rule6 from './json/rule06.json' with {type: 'json'};
import rule7 from './json/rule07.json' with {type: 'json'};
import rule8 from './json/rule08.json' with {type: 'json'};
import rule9 from './json/rule09.json' with {type: 'json'};
import rule10 from './json/rule10.json' with {type: 'json'};
import rule11 from './json/rule11.json' with {type: 'json'};
import rule12 from './json/rule12.json' with {type: 'json'};
import rule13 from './json/rule13.json' with {type: 'json'};
import rule14 from './json/rule14.json' with {type: 'json'};
import rule15 from './json/rule15.json' with {type: 'json'};
import rule16 from './json/rule16.json' with {type: 'json'};
import rule17 from './json/rule17.json' with {type: 'json'};
import rule18 from './json/rule18.json' with {type: 'json'};
import rule19 from './json/rule19.json' with {type: 'json'};
import rule20 from './json/rule20.json' with {type: 'json'};
import rule21 from './json/rule21.json' with {type: 'json'};
import rule22 from './json/rule22.json' with {type: 'json'};
import rule23 from './json/rule23.json' with {type: 'json'};
import rule24 from './json/rule24.json' with {type: 'json'};
import rule25 from './json/rule25.json' with {type: 'json'};
import rule26 from './json/rule26.json' with {type: 'json'};
import rule27 from './json/rule27.json' with {type: 'json'};
import rule28 from './json/rule28.json' with {type: 'json'};
import rule29 from './json/rule29.json' with {type: 'json'};
import rule30 from './json/rule30.json' with {type: 'json'};
import rule31 from './json/rule31.json' with {type: 'json'};
import rule32 from './json/rule32.json' with {type: 'json'};
import rule33 from './json/rule33.json' with {type: 'json'};
import rule34 from './json/rule34.json' with {type: 'json'};
import rule35 from './json/rule35.json' with {type: 'json'};
import rule36 from './json/rule36.json' with {type: 'json'};
import rule37 from './json/rule37.json' with {type: 'json'};
...
import spell4 from './json/spells4.json' with {type: 'json'};
import spell5 from './json/spells5.json' with {type: 'json'};
import spell6 from './json/spells6.json' with {type: 'json'};
import spell7 from './json/spells7.json' with {type: 'json'};
import spell8 from './json/spells8.json' with {type: 'json'};
import spell9 from './json/spells9.json' with {type: 'json'};
import spell10 from './json/spells10.json' with {type: 'json'};
import spell11 from './json/spells11.json' with {type: 'json'};
import spell12 from './json/spells12.json' with {type: 'json'};
import spell13 from './json/spells13.json' with {type: 'json'};
import spell14 from './json/spells14.json' with {type: 'json'};
