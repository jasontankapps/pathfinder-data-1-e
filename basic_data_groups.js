...
import rule1 from './json/rules_basics01.json' with {type: 'json'};
import rule2 from './json/rules_basics02.json' with {type: 'json'};
import rule3 from './json/rules_basics03.json' with {type: 'json'};
import rule4 from './json/rules_basics04.json' with {type: 'json'};
import rule5 from './json/rules_combat01.json' with {type: 'json'};
import rule6 from './json/rules_gm01.json' with {type: 'json'};
import rule7 from './json/rules_gm02.json' with {type: 'json'};
import rule8 from './json/rules_gm03.json' with {type: 'json'};
import rule9 from './json/rules_gm04.json' with {type: 'json'};
import rule10 from './json/rules_gm05.json' with {type: 'json'};
import rule11 from './json/rules_gm06.json' with {type: 'json'};
import rule12 from './json/rules_gm07.json' with {type: 'json'};
import rule13 from './json/rules_gm08.json' with {type: 'json'};
import rule14 from './json/rules_adv_pc01.json' with {type: 'json'};
import rule15 from './json/rules_adv_gm01.json' with {type: 'json'};
