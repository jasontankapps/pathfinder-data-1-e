...
const all = [
	...
	["eq-reagent", eqreagent], ["eq-armor", eqarmor],
	["eq-armorenh", eqarmorenh],
	...
	["magic-augmentation", magicaugmentation], ["magic-enh", magicenh],
...
const testLinks = () => {
	...
	all.forEach(([link, object]) => {
		...
		Object.keys(object).forEach(prop => {
			const {sources, tables, description, topLink, backwardsLink} = object[prop];
			...
			const hierarchies = [topLink, backwardsLink].filter(x => x);
