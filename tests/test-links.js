...
const checkForMalformedLinks = (line) => {
	...
	//                   1           2         3                   4                    5                 6
	if(m = line.match(/(?<!\])(?<!(?::::|;;;)div|::drug|::trap|::meco)(?<!(?::::|;;;)blockquote)(?<!:::archetype)(?<!::aff)(?<!::haunt|::spell|::minfo)(?<!:::mythic)(?<!::mdefense|::moffense)(?<!::mspell|::mstats)\{(?![-a-z_]+[/][^}]+\})(?!SOURCE|table[0-9]+|jumplist).{0,10}/)) {
