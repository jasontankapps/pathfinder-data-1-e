...
import family1 from '../json/monster_families.json' with {type: 'json'};
import family2 from '../json/monster_families2.json' with {type: 'json'};
...
import main44 from '../json/main44.json' with {type: 'json'};
