			...
			<IonReactRouter>
				<IonSplitPane contentId="main">
					...
					<IonRouterOutlet id="main">
						...
						<Route path="/arcaneschool/:id" render={(props) => <></>} />
						<Route path="/aspect/:id" render={(props) => <></>} />
						<Route path="/bardicmasterpiece/:id" render={(props) => <></>} />
						<Route path="/blessing/:id" render={(props) => <></>} />
						<Route path="/bloodragerbloodline/:id" render={(props) => <></>} />
						...
						<Route path="/discipline/:id" render={(props) => <></>} />
						<Route path="/disease/:id" render={(props) => <></>} />
						<Route path="/domain/:id" render={(props) => <></>} />
						<Route path="/drug/:id" render={(props) => <></>} />
						<Route path="/druidcompanion/:id" render={(props) => <></>} />
						<Route path="/druiddomain/:id" render={(props) => <></>} />
						...
						<Route path="/exploit/:id" render={(props) => <></>} />
						<Route path="/faith/:id" render={(props) => <></>} />
						<Route path="/greaterexploit/:id" render={(props) => <></>} />
						<Route path="/haunt/:id" render={(props) => <></>} />
						<Route path="/hellknightorder/:id" render={(props) => <></>} />
						<Route path="/implement/:id" render={(props) => <></>} />
						<Route path="/inquisition/:id" render={(props) => <></>} />
						<Route path="/kinetic/:id" render={(props) => <></>} />
						<Route path="/legendaryspirit/:id" render={(props) => <></>} />
						...
						<Route path="/magusarcana/:id" render={(props) => <></>} />
						...
						<Route path="/mystery/:id" render={(props) => <></>} />
						<Route path="/npc/:id" render={(props) => <></>} />
						<Route path="/oath/:id" render={(props) => <></>} />
						<Route path="/occultritual/:id" render={(props) => <></>} />
						<Route path="/oraclecurse/:id" render={(props) => <></>} />
						<Route path="/order/:id" render={(props) => <></>} />
						<Route path="/outsiderspirit/:id" render={(props) => <></>} />
						<Route path="/race/:id" render={(props) => <></>} />
						<Route path="/ragepower/:id" render={(props) => <></>} />
						<Route path="/rule/:id" render={(props) => <></>} />
						<Route path="/shamanspirit/:id" render={(props) => <></>} />
						<Route path="/skill/:id" render={(props) => <></>} />
						<Route path="/sorcererbloodline/:id" render={(props) => <></>} />
						<Route path="/source/:id" render={(props) => <></>} />
						<Route path="/spell/:id" render={(props) => <></>} />
						<Route path="/spell/definition/:id" render={(props) => <></>} />
						<Route path="/spirit/:id" render={(props) => <></>} />
						<Route path="/stanceragepower/:id" render={(props) => <></>} />
