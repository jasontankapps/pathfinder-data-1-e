...
import data from '../json/_GEN_main.json';
...
const MainGroup38Page = lazy(() => import("./MainGroup38Page"));
const MainGroup39Page = lazy(() => import("./MainGroup39Page"));
const MainGroup40Page = lazy(() => import("./MainGroup40Page"));
...
const pages = [
	({id}: Props) => <MainGroup01Page id={id} />,
	({id}: Props) => <MainGroup02Page id={id} />,
	({id}: Props) => <MainGroup03Page id={id} />,
	({id}: Props) => <MainGroup04Page id={id} />,
	({id}: Props) => <MainGroup05Page id={id} />,
	({id}: Props) => <MainGroup06Page id={id} />,
	({id}: Props) => <MainGroup07Page id={id} />,
	({id}: Props) => <MainGroup08Page id={id} />,
	({id}: Props) => <MainGroup09Page id={id} />,
	({id}: Props) => <MainGroup10Page id={id} />,
	({id}: Props) => <MainGroup11Page id={id} />,
	({id}: Props) => <MainGroup12Page id={id} />,
	({id}: Props) => <MainGroup13Page id={id} />,
	({id}: Props) => <MainGroup14Page id={id} />,
	({id}: Props) => <MainGroup15Page id={id} />,
	({id}: Props) => <MainGroup16Page id={id} />,
	({id}: Props) => <MainGroup17Page id={id} />,
	({id}: Props) => <MainGroup18Page id={id} />,
	({id}: Props) => <MainGroup19Page id={id} />,
	({id}: Props) => <MainGroup20Page id={id} />,
	({id}: Props) => <MainGroup21Page id={id} />,
	({id}: Props) => <MainGroup22Page id={id} />,
	({id}: Props) => <MainGroup23Page id={id} />,
	({id}: Props) => <MainGroup24Page id={id} />,
	({id}: Props) => <MainGroup25Page id={id} />,
	({id}: Props) => <MainGroup26Page id={id} />,
	({id}: Props) => <MainGroup27Page id={id} />,
	({id}: Props) => <MainGroup28Page id={id} />,
	({id}: Props) => <MainGroup29Page id={id} />,
	({id}: Props) => <MainGroup30Page id={id} />,
	({id}: Props) => <MainGroup31Page id={id} />,
	({id}: Props) => <MainGroup32Page id={id} />,
	({id}: Props) => <MainGroup33Page id={id} />,
	({id}: Props) => <MainGroup34Page id={id} />,
	({id}: Props) => <MainGroup35Page id={id} />,
	({id}: Props) => <MainGroup36Page id={id} />,
	({id}: Props) => <MainGroup37Page id={id} />,
	({id}: Props) => <MainGroup38Page id={id} />,
	({id}: Props) => <MainGroup39Page id={id} />,
	({id}: Props) => <MainGroup40Page id={id} />,
