...
<p><strong className="hl">Archetypes:</strong> <Link to="/arc-wizard/runesage">Runesage</Link> (Wizard), <Link to="/arc-magus/sigilus">Sigilus</Link> (Magus), <Link to="/arcaneschool/thassilonian_magic">Thassilonian Magic</Link> specialists (Wizard)</p>
...
<p><strong className="hl">15 TPA, 1 CPA:</strong> Transform the character's <Link to="/ability/familiar">familiar</Link> into an undead version of its living self. This change requires an 8-hour ritual. The familiar's type changes to <Link to="/type/undead">undead</Link> but it retains all of its other familiar abilities. This does not work on familiars of the construct or outsider type (such as imps and quasits from the <Link to="/feat/improved_familiar">Improved Familiar</Link> feat).</p>
