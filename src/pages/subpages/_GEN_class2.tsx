...
<Ability id="bravery-ex" icon={["def"]}>
<Pair single id="bravery-ex">Bravery (Ex)</Pair>
...
<Ability id="armor-training-ex" icon={["boost"]}>
<Pair single id="armor-training-ex" flavor="You learn to be more maneuverable while wearing armor.">Armor Training (Ex)</Pair>
...
</aside><Ability id="weapon-training-ex" icon={["boost"]}>
...
</aside><Ability id="armor-mastery-ex" icon={["def"]}>
...
<Ability id="weapon-mastery-ex" icon={["boost"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-fighter--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-fighter/aerial_assaulter">Aerial Assaulter</Link></p><p><strong>Modifies or Replaces:</strong> Class Skills; Bravery; 2nd, 12th-level Bonus Feat; Armor Mastery; Weapon Mastery</p><p>Aerial assaulters leap to great heights and create higher ground where there is none.</p></div>
...
<DisplayTable table={{"id":"fighter archetypes","columns":[{"header":"Archetype","link":"arc-fighter"},{"header":"Armor Proficiency"},{"header":"Armor Training"},{"header":"Armor Training 1"},{"header":"Armor Training 2"},{"header":"Armor Training 3"},{"header":"Armor Training 4"},{"header":"Armor Mastery"},{"header":"Bonus Feats"},{"header":"1st-level Bonus Feat"},{"header":"2nd-level Bonus Feat"},{"header":"4th-level Bonus Feat"},{"header":"6th-level Bonus Feat"},{"header":"8th-level Bonus Feat"},{"header":"10th-level Bonus Feat"},{"header":"12th-level Bonus Feat"},{"header":"14th-level Bonus Feat"},{"header":"16th-level Bonus Feat"},{"header":"18th-level Bonus Feat"},{"header":"20th-level Bonus Feat"},{"header":"Bravery"},{"header":"Class Skills"},{"header":"Skill Ranks"},{"header":"Weapon Training"},{"header":"Weapon Training 1"},{"header":"Weapon Training 2"},{"header":"Weapon Training 3"},{"header":"Weapon Training 4"},{"header":"Weapon Mastery"},{"header":"Weapon Proficiency"}],"data":[[["Aerial Assaulter","aerial_assaulter"],null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X",null,null,null,null,"X","X",null,null,null,null,null,null,"X",null],[["Airborne Ambusher","airborne_ambusher"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,"X",null,null,null,null,null,"X"],[["Aldori Defender","aldori_defender"],null,"X",null,null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Aquanaut","aquanaut"],"X","X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,null],[["Archer","archer"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,null],[["Armiger","armiger"],null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null],[["Armor Master","armor_master"],null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X",null],[["Brawler","brawler"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null],[["Cad","cad"],"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X","X"],[["Calistrian Hunter","calistrian_hunter"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,"X",null,null,null,null,"X","X"],[["Cavern Sniper","cavern_sniper"],null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,"X","X",null,"X",null,null,null,null,"X",null],[["Child of Acavna and Amaznen","child_of_acavna_and_amaznen"],"X","X",null,null,null,null,null,null,"X","X",null,null,"X",null,"X",null,"X",null,"X",null,"X",null,"X",null,null,null,null,null,"X"],[["Corsair","corsair"],null,"X",null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Crossbowman","crossbowman"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null],[["Cyber-Soldier","cyber_soldier"],null,null,null,"X",null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null],[["Dirty Fighter","dirty_fighter"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,null],[["Dragonheir Scion","dragonheir_scion"],null,"X",null,null,null,null,"X",null,"X",null,"X","X",null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,"X",null],[["Dragoon","dragoon"],"X",null,null,"X","X","X",null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X"],[["Drill Sergeant","drill_sergeant"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,null],[["Druman Blackjacket","druman_blackjacket"],null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,"X",null,"X",null,null,"X",null,null,null,null,null,null,null,null,null],[["Eldritch Guardian","eldritch_guardian"],null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null],[["Foehammer","foehammer"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X","X",null],[["Free Hand Fighter","free_hand_fighter"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,null],[["Gladiator","gladiator"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,"X"],[["Gloomblade","gloomblade"],"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null],[["High Guardian","high_guardian"],null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null],[["Lore Warden","lore_warden"],"X","X",null,null,null,null,"X",null,null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null],[["Lore Warden (PFS Field Guide)","lore_warden_pfs_field_guide"],"X","X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null],[["Martial Master","martial_master"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null],[["Mobile Fighter","mobile_fighter"],null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X",null],[["Molthuni Defender","molthuni_defender"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Mutation Warrior","mutation_warrior"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Opportunist","opportunist"],null,null,null,null,null,null,null,null,"X",null,"X",null,"X",null,"X",null,"X",null,"X","X","X",null,null,"X",null,null,null,null,null],[["Pack Mule","pack_mule"],null,"X",null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null],[["Phalanx Soldier","phalanx_soldier"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X",null],[["Polearm Master","polearm_master"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,null],[["Qadira: Dawnflower Dervish","qadira_dawnflower_dervish"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Relic Master","relic_master"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null],[["Roughrider","roughrider"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,null],[["Savage Warrior","savage_warrior"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X",null],[["Scrapper","scrapper"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null],[["Seasoned Commander","seasoned_commander"],"X",null,"X",null,"X","X",null,null,"X",null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null],[["Sensate","sensate"],"X","X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,"X","X","X","X","X"],[["Shielded Fighter","shielded_fighter"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null],[["Siegebreaker","siegebreaker"],null,null,null,null,null,null,null,null,"X","X","X",null,"X",null,null,null,null,null,null,"X",null,null,null,null,null,null,null,"X",null],[["Skirmisher","skirmisher"],"X","X",null,null,null,null,"X",null,null,"X",null,null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null],[["Spear Fighter","spear_fighter"],"X","X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,"X",null,null,null,null,"X",null],[["Steelbound Fighter","steelbound_fighter"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null],[["Swarm Fighter","swarm_fighter"],"X",null,null,null,null,null,null,null,"X","X",null,"X",null,"X",null,"X",null,"X",null,"X",null,null,"X",null,null,null,null,"X","X"],[["Tactician","tactician"],"X",null,null,null,"X","X",null,null,"X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,"X"],[["Taldor: Rondelero Duelist","taldor_rondelero_duelist"],null,null,"X","X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null],[["Thunderstriker","thunderstriker"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null],[["Titan Fighter","titan_fighter"],null,"X",null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null],[["Tower Shield Specialist","tower_shield_specialist"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X",null],[["Trench Fighter","trench_fighter"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Tribal Fighter","tribal_fighter"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null],[["Two-Handed Fighter","two_handed_fighter"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null],[["Two-Weapon Warrior","two_weapon_warrior"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null],[["Unarmed Fighter","unarmed_fighter"],"X","X",null,null,null,null,"X",null,"X",null,null,null,"X",null,"X",null,null,null,null,"X",null,null,"X",null,null,null,null,"X","X"],[["Unbreakable","unbreakable"],"X",null,null,null,"X","X",null,null,"X",null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X","X"],[["Ustalavic Duelist","ustalavic_duelist"],"X",null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X"],[["Varisian Free-Style Fighter","varisian_free_style_fighter"],null,"X",null,null,null,null,null,null,"X",null,null,"X",null,"X","X",null,null,null,null,null,"X",null,"X",null,null,null,null,"X",null],[["Venomblade","venomblade"],null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null],[["Viking","viking"],"X","X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,"X"],[["Warlord","warlord"],"X","X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,"X"],[["Weapon Bearer Squire","weapon_bearer_squire"],null,null,"X",null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Weapon Master","weapon_master"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,null]],"initialColumn":0,"nullValue":"&nbsp;"}} />
<h3 id="class-fighter-favored-class-bonuses" data-hash-target><Link to="/rule/favored_class">Favored Class Bonuses</Link></h3>
<RacialOptions cls="fighter" />
</>};
...
</aside><Ability id="nature-training-ex" icon={["boost"]}>
<Pair single id="nature-training-ex">Nature Training (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="animal-focus-su" icon={["boost"]}>
...
</aside><Ability id="wild-empathy-ex" icon={["boost"]}>
<Pair single id="wild-empathy-ex" flavor="A hunter can improve the attitude of an animal.">Wild Empathy (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="precise-companion-ex" icon={["power"]}>
<Pair single id="precise-companion-ex">Precise Companion (Ex)</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="bonus-tricks-ex" icon={["power"]}>
<Pair single id="bonus-tricks-ex">Bonus Tricks (Ex)</Pair>
...
<Ability id="speak-with-master-ex" icon={["power"]}>
<Pair single id="speak-with-master-ex">Speak with Master (Ex)</Pair>
...
<Ability id="greater-empathic-link-su" icon={["boost"]}>
...
<Ability id="one-with-the-wild-ex" icon={["def","power"]}>
...
<Ability id="master-hunter-ex" icon={["boost"]}>
<Pair single id="master-hunter-ex" flavor="You become a master hunter, able to track down foes with ease.">Master Hunter (Ex)</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-hunter--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-hunter/aquatic_beastmaster">Aquatic Beastmaster</Link></p><p><strong>Modifies or Replaces:</strong> Animal Focus; Wild Empathy; Improved Empathic Link</p><p>Hunters beneath the sea are just as committed as their surface-dwelling counterparts to working alongside their animal companions to eradicate threats.</p></div>
...
<div className="archetype"><p><Link to="/arc-hunter/roof_runner">Roof Runner</Link></p><p><strong>Modifies or Replaces:</strong> Class Skills; Armor Proficiency; Track; Woodland Stride; Swift Tracker; Master Hunter</p><p>Roof runners are skilled ambushers, skirmishers, and spies who eschew heavier types of armor in order to remain light on their feet.</p></div>
...
<Ability id="judgment-su" icon={["power"]}>
...
<Ability id="monster-lore-ex" icon={["boost"]}>
<Pair single id="monster-lore-ex">Monster Lore (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="stern-gaze-ex" icon={["boost"]}>
<Pair single id="stern-gaze-ex" flavor="Inquisitors are skilled at sensing deception and intimidating their foes.">Stern Gaze (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="cunning-initiative-ex" icon={["boost"]}>
<Pair single id="cunning-initiative-ex">Cunning Initiative (Ex)</Pair>
<Pair title="Gained">At 2nd Level</Pair>
<Pair title="Passive Ability">You add your Wisdom modifier on initiative checks (in addition to your Dexterity modifier).</Pair>
</Ability>
<Ability id="detect-alignment-sp" icon={["power"]}>
<Pair single id="detect-alignment-sp">Detect Alignment (Sp)</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="solo-tactics-ex" icon={["boost"]}>
...
<Ability id="discern-lies-sp" icon={["power"]}>
...
<Ability id="second-judgment-ex" icon={["boost"]}>
<Pair single id="second-judgment-ex">Second Judgment (Ex)</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Pair single id="stalwart-ex" flavor="An inquisitor can use mental and physical resiliency to avoid certain attacks.">Stalwart (Ex)</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="greater-bane-su" icon={["boost"]}>
<Pair single id="greater-bane-su">Greater Bane (Su)</Pair>
...
<Ability id="exploit-weakness-ex" icon={["lower"]}>
<Pair single id="exploit-weakness-ex" flavor="The inquisitor learns to take advantage of any opportunity that presents itself.">Exploit Weakness (Ex)</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="third-judgment-ex" icon={["boost"]}>
<Pair single id="third-judgment-ex">Third Judgment (Ex)</Pair>
...
<Ability id="slayer-ex" icon={["boost"]}>
<Pair single id="slayer-ex" flavor="An inquisitor learns to focus her judgment.">Slayer (Ex)</Pair>
<Pair title="Gained">At 17th Level</Pair>
...
<Ability id="true-judgment-su" icon={["boost"]}>
<Pair single id="true-judgment-su" flavor="An inquisitor can call true judgment down upon a foe during combat.">True Judgment (Su)</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-inquisitor--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Deep Magics (Su)</td><td>At 20th level, the character's repertoire of spells deepens dramatically. She gains an additional spell known for each spell level she can cast. A character of any class with spells known can select this capstone.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
...
<Message arch /><div className="archetype"><p><Link to="/arc-inquisitor/abolisher">Abolisher</Link></p><p><strong>Modifies or Replaces:</strong> Domains; Stern Gaze; Detect Alignment; Discern Lies</p><p>Abolishers are incorruptible inquisitors who weed out creatures of alien, unnatural origins, finding and exposing aberrations for what they are.</p></div>
...
<Ability id="alchemy-su" icon={["boost","magic"]}>
...
<Ability id="inspiration-ex" icon={["boost"]}>
<Pair single id="inspiration-ex" flavor="An investigator is beyond knowledgeable and skilled - he also possesses keen powers of observation and deduction that far surpass the abilities of others.">Inspiration (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="trapfinding" icon={["boost"]}>
...
<Ability id="poison-lore-ex" icon={["def","boost"]}>
<Pair single id="poison-lore-ex" flavor="An investigator has a deep understanding and appreciation for poisons.">Poison Lore (Ex)</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="investigator-talent-ex-or-su" icon={["power"]}>
<Pair single id="investigator-talent-ex-or-su">Investigator Talent (Ex or Su)</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="keen-recollection" icon={["power"]}>
<Pair single id="keen-recollection">Keen Recollection</Pair>
<Pair title="Gained">At 3rd Level</Pair>
<Pair title="Ability">You can attempt all Knowledge skill checks untrained.</Pair>
</Ability>
<Ability id="trap-sense-ex" icon={["def"]}>
<Pair single id="trap-sense-ex" flavor="An investigator gains an intuitive sense that alerts him to danger from traps.">Trap Sense (Ex)</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="studied-combat-ex" icon={["melee"]}>
<Pair single id="studied-combat-ex" flavor="With a keen eye and calculating mind, an investigator can assess the mettle of his opponent to take advantage of gaps in talent and training.">Studied Combat (Ex)</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="studied-strike-ex" icon={["melee"]}>
...
<Ability id="swift-alchemy-ex" icon={["boost"]}>
<Pair single id="swift-alchemy-ex">Swift Alchemy (Ex)</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="true-inspiration-ex" icon={["boost"]}>
<Pair single id="true-inspiration-ex">True Inspiration (Ex)</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-investigator--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-investigator/antiquarian">Antiquarian</Link></p><p><strong>Modifies or Replaces:</strong> Alchemy; Poison Lore; Poison Resistance; Poison Immunity; Swift Alchemy</p><p>Antiquarians are collectors, explorers, and scholars who delve into ruined places in search of lost lore and artifacts.</p></div>
...
<Ability id="elemental-focus-su" icon={["power","skill"]}>
<Pair single id="elemental-focus-su">Elemental Focus (Su)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="wild-talents" icon={["power"]}>
...
<Ability id="kinetic-blast-sp" icon={["power"]}>
...
<Ability id="gather-power-su" icon={["power","boost"]}>
<Pair single id="gather-power-su">Gather Power (Su)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="infusion-su" icon={["power"]}>
...
<Ability id="elemental-defense-su" icon={["def"]}>
<Pair single id="elemental-defense-su">Elemental Defense (Su)</Pair>
<Pair title="Gained">At 2nd Level</Pair>
<Pair title="Ability">You gain your element's <Link to="/ability/defense_wild_talents">defense wild talent</Link>.</Pair>
</Ability>
<Ability id="elemental-overflow-ex" icon={["boost"]}>
<Pair single id="elemental-overflow-ex" flavor="A kineticist's body surges with energy from her chosen element whenever she accepts burn, causing her to glow with a nimbus of fire, weep water from her pores, or experience some other thematic effect.">Elemental Overflow (Ex)</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="infusion-specialization-ex" icon={["boost"]}>
<Pair single id="infusion-specialization-ex">Infusion Specialization (Ex)</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="metakinesis-su" icon={["boost"]}>
<Pair single id="metakinesis-su" flavor="A kineticist can alter her kinetic blasts as if with metamagic feats by accepting burn.">Metakinesis (Su)</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="internal-buffer-su" icon={["power"]}>
<Pair single id="internal-buffer-su" flavor="A kineticist's study of her body and the elemental forces that course through it allow her to form an internal buffer to store extra energy.">Internal Buffer (Su)</Pair>
...
<Ability id="expanded-element-su" extraClasses="hasSubs" icon={["boost"]}>
<Pair single id="expanded-element-su" flavor="A kineticist learns to use another element or expands her understanding of her own element.">Expanded Element (Su)</Pair>
<Pair title="Gained">At 7th Level</Pair>
<Pair title="Ability">You can choose any element, including your primary element.</Pair>
</Ability>
<Ability id="new-element" extraClasses="subAbility numbered" icon={["boost"]}>
<Pair single id="new-element">New Element</Pair>
...
<Ability id="primary-element" extraClasses="subAbility numbered" icon={["boost"]}>
<Pair single id="primary-element">Primary Element</Pair>
...
<Ability id="supercharge-su" icon={["boost"]}>
<Pair single id="supercharge-su">Supercharge (Su)</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="composite-specialization-su" icon={["boost"]}>
<Pair single id="composite-specialization-su">Composite Specialization (Su)</Pair>
<Pair title="Gained">At 16th Level</Pair>
...
<Ability id="metakinetic-master-su" icon={["boost"]}>
<Pair single id="metakinetic-master-su">Metakinetic Master (Su)</Pair>
<Pair title="Gained">At 19th Level</Pair>
...
<Ability id="omnikinesis-su" icon={["power"]}>
<Pair single id="omnikinesis-su" flavor="A kineticist can transcend the distinction between the different elements and can bend all creation to her will.">Omnikinesis (Su)</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-kineticist--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
<tr><td>The Boss (Ex)</td><td>At 20th level, the character has become more than just a lone hero - she has become one of the senior figures of her field, with powers and responsibilities to match. The character becomes one of the leading figures in some manner of group or organization, as appropriate to the campaign and the setting. A wizard might become the dean of an arcane university or mages' guild, a fighter could command a mercenary army or a city guard, a cleric might lead a major temple or her own sect, and so forth. The player and the GM should work together to determine the specifics. The character gains the <Link to="/feat/leadership">Leadership</Link> feat if she does not already have it, and the number of followers that the feat grants is multiplied by 10 (although depending on the campaign and setting, the position may grant other powers as well). If multiple characters in a party select this capstone, the GM may consider pooling them to grant the players a particularly large and powerful organization, such as a small kingdom. Characters of any class can select this ability.</td></tr>
