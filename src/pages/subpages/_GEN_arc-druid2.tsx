...
<Pair title="At 3rd Level">He can now create two doses of poison each day.</Pair>
...
<Pair title="At 5th Level">He can now produce three doses of poison per day.</Pair>
<Pair title="At 7th Level">The urushiol can now produce four doses of poison per day. He can spend 2 daily doses of his poison as a <strong className="hl">standard action</strong> to secrete a contact poison and coat one of his limbs with the secreted poison. The urushiol can deliver the poison by making a successful touch attack as a <strong className="hl">standard action</strong>, which can be part of the same standard action he used to secrete the poison. If the attack misses, the poison persists upon his limb throughout the subsequent rounds until he hits a target or touches something else with his poisoned limb.</Pair>
<Pair title="At 9th Level">He can now produce five doses of poison each day.</Pair>
<Pair title="At 11th Level">The urushiol can produce six doses of poison each day. He can spend 3 daily doses of his poison as a <strong className="hl">standard action</strong> to release a 20-foot-radius cloud of inhaled poison centered around him that lasts for 1 round.</Pair>
<Pair title="At 13th Level">He can now produce seven doses of poison each day.</Pair>
...
<Pair title="At 15th Level">He can produce eight doses of poison each day.</Pair>
<Pair title="At 17th Level">He can now produce nine doses of poison daily.</Pair>
<Pair title="At 19th Level">The urushiol can produce ten doses of poison each day.</Pair>
