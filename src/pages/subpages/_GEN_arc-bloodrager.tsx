...
<Ability id="spirit-guardian-sp" icon={["power","magic"]}>
...
<Ability id="spirit-servants" icon={["learn","magic","boost"]}>
...
<Ability id="contact-specialist-ex" icon={["power"]}>
...
<Ability id="spell-conduit-su" icon={["magic"]}>
...
<Ability id="reflexive-conduit-ex" icon={["magic"]}>
...
<Ability id="familiar-abilities" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="squeezer-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="grotesque-appendages-ex" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="spell-catalyst-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="heavenly-touch-su" extraClasses="subAbility" icon={["aid"]}>
...
<Ability id="foretold-touch-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="dragons-flight-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="dualistic-energy-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="amusing-familiar-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="hellish-aura-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="unliving-physiology-su" extraClasses="subAbility" icon={["down"]}>
...
<Ability id="feral-mount-ex" icon={["power"]}>
...
<Ability id="blood-bond-su" icon={["boost"]}>
...
<Ability id="bloody-knuckles" icon={["down"]}>
...
<Ability id="reduced-spells-known" icon={["down"]}>
...
<Ability id="pugilist-ex" icon={["power"]}>
...
<Ability id="combat-style-student" icon={["power"]}>
...
<Ability id="hand-to-hand-training-ex" extraClasses="hasSubs" icon={["melee"]}>
...
<Ability id="two-bloodlines" icon={["power"]}>
...
<Ability id="bloodline-powers" icon={["power"]}>
...
<Ability id="drawbacks" icon={["down"]}>
...
<Ability id="enlightened-spellcasting" icon={["power","magic"]}>
...
<Ability id="enlightened-bloodrage-su" icon={["power"]}>
...
<Ability id="bloodline-feat" icon={["power"]}>
...
<Ability id="unfettered-fury-ex" icon={["power"]}>
...
<Ability id="summoning-rager-sp" icon={["learn"]}>
...
<Ability id="furious-summoning-su" icon={["boost"]}>
...
<Ability id="claws-of-the-hag-ex" icon={["melee"]}>
...
<Ability id="sorcerous-claws-su" icon={["boost"]}>
...
<Ability id="scarred-hide-ex" icon={["def"]}>
...
<Ability id="hexing-claws-su" icon={["power"]}>
...
<Ability id="atavistic-avatar-su" icon={["power"]}>
...
<Ability id="atavistic-caster" icon={["magic"]}>
...
<Ability id="meta-rage-su" icon={["magic"]}>
...
<Ability id="primal-choices" icon={["power"]}>
...
<Ability id="spirit-su" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="spirit-surge-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="chosen-of-the-spirits-su" icon={["magic"]}>
...
<Ability id="shapeshifted-spellcasting-su" icon={["magic"]}>
...
<Ability id="bestial-aspect-su" icon={["magic","melee","boost"]}>
...
<Ability id="furious-transformation-su" icon={["magic","boost"]}>
...
<Ability id="blood-of-life-su" icon={["aid"]}>
...
<Ability id="spell-eating-su" icon={["aid"]}>
...
<Ability id="weapon-and-armor-proficiency" icon={["def","magic"]}>
...
<Ability id="blood-deflection-su" icon={["def"]}>
...
<Ability id="rune-training-sp" icon={["magic","learn"]}>
...
<Ability id="weapon-rune-su" icon={["boost"]}>
...
<Ability id="rune-trap-sp" icon={["magic"]}>
...
<Ability id="raging-resistance-ex" icon={["def"]}>
...
<Ability id="resistance-control-ex" icon={["def"]}>
...
<Ability id="controlled-bloodrage" icon={["down","boost"]}>
...
<Ability id="restrained-magic-su" icon={["protect"]}>
...
<Ability id="adopted-magic" icon={["learn"]}>
