...
<Ability id="always-prepared-ex" icon={["power"]}>
...
<Ability id="ancestral-enlightenment-ex" icon={["boost"]}>
...
<Ability id="beginners-luck-ex" icon={["boost"]}>
...
<Ability id="bellflower-innuendo-ex" icon={["power","boost"]}>
...
<Ability id="case-the-joint-ex" icon={["power","roll"]}>
...
<Ability id="companion-to-the-lonely-ex" icon={["power","roll","boost","def"]}>
...
<Ability id="conflicted-identity-ex" icon={["def"]}>
...
<Ability id="double-time-ex" icon={["boost"]}>
...
<Ability id="in-vogue-ex" icon={["boost"]}>
...
<Ability id="entrepreneur-ex" icon={["power","boost"]}>
...
<Ability id="gossip-collector-ex" icon={["power","boost"]}>
...
<Ability id="guise-of-life-su" icon={["power"]}>
...
<Ability id="guise-of-unlife-su" icon={["power"]}>
...
<Ability id="hidden-magic-ex" icon={["def"]}>
...
<Ability id="intrigue-feats-ex" icon={["power"]}>
...
<Ability id="kalistocrats-acumen-ex" icon={["warning","boost"]}>
...
<Ability id="everyman-ex" icon={["power","boost"]}>
...
<Ability id="any-guise-su" icon={["power"]}>
...
<Ability id="mockingbird-ex" icon={["power","magic"]}>
...
<Ability id="morphic-mask-su" icon={["power","boost"]}>
...
<Ability id="notorious-fool-ex" icon={["def"]}>
...
<Ability id="obscurity-ex" icon={["def"]}>
...
<Ability id="owls-sight-ex" icon={["power","boost"]}>
...
<Ability id="quick-change-ex" icon={["boost","def"]}>
...
<Ability id="immediate-change-ex" icon={["boost"]}>
...
<Ability id="celebrity-discount-ex" icon={["boost"]}>
...
<Ability id="celebrity-perks-ex" icon={["boost"]}>
...
<Ability id="discreet-inquiries-ex" icon={["def"]}>
...
<Ability id="feign-innocence-ex" icon={["def"]}>
...
<Ability id="subjective-truth-ex" icon={["def"]}>
...
<Ability id="great-renown-ex" icon={["boost"]}>
...
<Ability id="incredible-renown-ex" icon={["boost"]}>
...
<Ability id="instant-recognition-ex" icon={["boost"]}>
...
<Ability id="triumphant-return-ex" icon={["boost"]}>
...
<Ability id="safe-house-ex" icon={["power","def"]}>
...
<Ability id="seemless-shapechanger-ex" icon={["def"]}>
...
<Ability id="skill-familiarity-ex" icon={["power","boost"]}>
...
<Ability id="social-grace-ex" icon={["boost"]}>
...
<Ability id="songbird-su" icon={["magic","skill"]}>
...
<Ability id="beast-friend-su" icon={["magic"]}>
...
<Ability id="beast-speech-su" icon={["magic"]}>
