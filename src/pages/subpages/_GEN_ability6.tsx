...
<Ability id="ability-channel_energy-channel-energy-su" icon={["aura"]}>
<Pair single id="ability-channel_energy-channel-energy-su">Channel Energy (Su)</Pair>
...
<div className="sideNoteWrap"><ScrollContainer id="ability-rage_powers--table-7"><table><tbody><tr><ThLink scope="row" rowSpan={6} to="/rule/curses"><IonIcon aria-label="Curse" icon="/icons/death-note.svg" /></ThLink><th colSpan={4} scope="col" className="title">Curse of Boiling Blood</th></tr><tr><th scope="row">Type</th><td colSpan={3}>Curse</td></tr><tr><th scope="row">Save DC</th><td colSpan={3}>Will 10 + 1/2 the character's level + their Charisma modifier</td></tr><tr><th scope="row">Effect</th><td colSpan={3}>Target gains <Link to="/umr/vulnerability">vulnerability</Link> to fire and is permanently <Link to="/misc/staggered">staggered</Link> from the pain of its boiling blood (this is a pain effect)</td></tr></tbody></table></ScrollContainer></div><p><strong className="hl"><Link to="/ragepower/liquid_courage">Liquid Courage:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-26" id="ability-rage_powers-ref-I-26" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> the barbarian increases her morale bonus on saving throws against mind-affecting effects by +1 for each alcoholic drink she consumes during her <em>rage,</em> to a maximum of +1 increase per four barbarian levels.</p>
