...
<p><strong className="hl"><Link to="/ragepower/fueled_by_vengeance">Fueled by Vengeance:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-E-5" id="ability-rage_powers-ref-E-5" data-hash-target to="ability-rage_powers-E">5</InnerLink></sup> While <em>raging,</em> whenever you deal weapon damage to a creature that dealt damage to you since the end of your last turn, add 1 round to your remaining number of rounds of <em>rage</em> for the current day. You can gain no more than 1 extra round of <em>rage</em> each round. You must be at least 6th level to select this rage power.</p>
