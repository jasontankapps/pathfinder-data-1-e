...
const _channel_energy = {title: "Channel Energy", jsx: <><p><strong>Sources</strong> <Link to="/source/prpg_core_rulebook">PRPG Core Rulebook</Link>, <Link to="/source/advanced_players_guide">Advanced Player's Guide</Link>, <Link to="/source/ultimate_magic">Ultimate Magic</Link><br/>At 1st level, regardless of alignment, any <Link to="/class/cleric">cleric</Link> can release a wave of energy by channeling the power of her faith through her holy (or unholy) symbol. This energy can be used to cause or heal damage, depending on the type of energy channeled and the creatures targeted.</p>
...
<hr/>
<p><strong className="hl"><Link to="/ragepower/animal_fury">Animal Fury:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-1" id="ability-rage_powers-ref-A-1" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> While <em>raging,</em> the barbarian gains a bite attack. If used as part of a full attack action, the bite attack is made at the barbarian's full base attack bonus -5. If the bite hits, it deals 1d4 points of damage (assuming the barbarian is Medium; 1d3 points of damage if Small) plus half the barbarian's Strength modifier. A barbarian can make a bite attack as part of the action to maintain or break free from a grapple. This attack is resolved before the grapple check is made. If the bite attack hits, any grapple checks made by the barbarian against the target this round are at a +2 bonus.</p>
<blockquote>
...
<p><strong className="hl"><Link to="/ragepower/armor_ripper">Armor Ripper:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-E-1" id="ability-rage_powers-ref-E-1" data-hash-target to="ability-rage_powers-E">5</InnerLink></sup> While <em>raging,</em> you gain a +2 bonus on combat maneuver checks made to <Link to="/rule/sunder">sunder</Link> with any of your natural attacks. You must be <Link to="/race/wereboar_kin">wereboar-kin</Link> or be associated with wereboar-kin to select this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/auspicious_mark">Auspicious Mark:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-F-1" id="ability-rage_powers-ref-F-1" data-hash-target to="ability-rage_powers-F">6</InnerLink></sup> The barbarian has been marked by the spirits, as indicated by an impressive tattoo, scar, or birthmark she possesses. Once per <em>rage,</em> as a swift action that costs 2 rounds of <em>rage,</em> the barbarian can call upon the spirits' favor. Using auspicious mark grants her a +1d6 bonus on one d20 roll she has just made. She can call on the auspicious mark after seeing the result of the d20 roll.</p>
<p><strong className="hl"><Link to="/ragepower/autumn_rage">Autumn Rage:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-G-1" id="ability-rage_powers-ref-G-1" data-hash-target to="ability-rage_powers-G">7</InnerLink></sup> The barbarian becomes a servant of the harvest. While <em>raging,</em> she gains a +2 bonus on combat maneuver checks to <Link to="/rule/reposition">reposition</Link> or <Link to="/rule/trip">trip</Link>. She also gains this bonus on attack rolls to confirm critical hits. A barbarian can have only one season-themed rage power, choosing between <Link to="/ragepower/spring_rage">spring</Link>, <Link to="/ragepower/summer_rage">summer</Link>, autumn, or <Link to="/ragepower/winter_rage">winter</Link> rage.</p>
<p><strong className="hl"><Link to="/ragepower/bloody_fist">Bloody Fist:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-H-1" id="ability-rage_powers-ref-H-1" data-hash-target to="ability-rage_powers-H">8</InnerLink></sup> While <em>raging,</em> the barbarian may attempt to punch through an opponent's flesh and rip out one of its vital organs. In order to do so, the barbarian must confirm a critical hit against an opponent with a natural attack or unarmed strike. The barbarian deals damage as normal for a critical hit and the opponent must succeed at a Fortitude save (DC = 10 + 1/2 the barbarian's class level + the barbarian's Strength modifier) or take 1d4 points of <Link to="/rule/constitution_damage">Constitution damage</Link> as one of its vital organs is ripped free from its body. This power can only be used once per <em>rage.</em> A barbarian must be at least 12th level to select this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/feast_of_blood">Feast of Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-H-2" id="ability-rage_powers-ref-H-2" data-hash-target to="ability-rage_powers-H">8</InnerLink></sup> While <em>raging,</em> the barbarian may feast on the organs of her foes and absorb their power. After successfully ripping out a creature's vital organ, the barbarian may eat the organ within 1 minute of extracting it as a full-round action that provokes attacks of opportunity. Once the organ is consumed, the barbarian recovers a number of hit points equal to the Hit Dice of the organ's owner. In addition, the barbarian gains any energy immunities or resistances the victim had, though the effectiveness of these resistances is halved (for instance, a barbarian who eats the heart of a creature with resist cold 10 would gain resist cold 5; energy immunities are reduced to resist energy 20). This energy resistance lasts for a number of rounds equal to half the Hit Dice of the creature whose organ was consumed. A barbarian must have the <Link to="/ragepower/bloody_fist">bloody fist</Link> rage power to select this rage power. A barbarian must be at least 14th level to select this rage power.</p>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/boars_charge">Boar's Charge:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-E-2" id="ability-rage_powers-ref-E-2" data-hash-target to="ability-rage_powers-E">5</InnerLink></sup> While <em>raging,</em> when you hit with a gore attack as part of a charge, you automatically score a critical threat. You must still confirm the critical hit as normal. You must be at least 12th level and be <Link to="/race/wereboar_kin">wereboar-kin</Link> or be associated with wereboar-kin to select this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/boasting_taunt">Boasting Taunt:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-1" id="ability-rage_powers-ref-I-1" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> the barbarian can incite a creature to attack her by making an Intimidate check to demoralize. If the check succeeds, the target is also <Link to="/misc/shaken">shaken</Link> as long as the barbarian is visible and <em>raging</em> or until it makes a melee attack against the barbarian. The barbarian receives a +2 circumstance bonus on this check for every alcoholic drink she has consumed during this <em>rage.</em> This is a language-dependent mind-affecting effect, and it relies on audible components. The barbarian must be at least 6th level to select this power.</p>
<p><strong className="hl"><Link to="/ragepower/body_bludgeon">Body Bludgeon:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-F-2" id="ability-rage_powers-ref-F-2" data-hash-target to="ability-rage_powers-F">6</InnerLink></sup> While <em>raging,</em> if the barbarian pins an opponent that is smaller than her, she can then use that opponent as a two-handed <Link to="/misc/improvised_weapon">improvised weapon</Link> that deals 1d8 points of bludgeoning damage, assuming the opponent is sized Small. Larger or smaller creatures used as a bludgeon deal damage based on their size using this base damage. A size Tiny creature deals 1d6 points of damage, a size Medium creature deals 1d10 points of damage, and so on. The barbarian can make a single attack using the pinned opponent as part of the action she uses to maintain the grapple, using her highest attack bonus. Whenever the barbarian hits using the pinned opponent as a weapon, she deals damage to her target normally, and the grappled opponent used as a bludgeon also takes the same damage she dealt to the target. If the pinned opponent is unable to resist being pinned for any reason, the barbarian can use that opponent as an improvised weapon without grappling or pinning the opponent, until the creature is reduced to 0 or fewer hit points, at which point the creature becomes useless as an improvised weapon. A barbarian must be at least 10th level before selecting this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/brawler">Brawler:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-2" id="ability-rage_powers-ref-I-2" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> the barbarian is treated as if she has <Link to="/feat/improved_unarmed_strike">Improved Unarmed Strike</Link>. If she already has the feat, her unarmed strikes deal 1d6 points of damage (1d4 if she is Small).</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_brawler">Greater Brawler:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-3" id="ability-rage_powers-ref-I-3" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> the barbarian is treated as if she has <Link to="/feat/two_weapon_fighting">Two-Weapon Fighting</Link> when making unarmed strike attacks. A barbarian must have the <Link to="/ragepower/brawler">brawler</Link> rage power to select this rage power.</p>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/breathtaker">Breathtaker:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-J-1" id="ability-rage_powers-ref-J-1" data-hash-target to="ability-rage_powers-J">10</InnerLink></sup> The barbarian's blows take the air from her foes' lungs. While <em>raging,</em> whenever the barbarian makes a successful melee attack against an opponent that is holding its breath, in addition to any other effects caused by that attack, the opponent loses a number of rounds of breath equal to the barbarian's Strength modifier.</p>
<p><strong className="hl"><Link to="/ragepower/clear_mind">Clear Mind:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-2" id="ability-rage_powers-ref-A-2" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> A barbarian may reroll a failed Will save. This power is used as an immediate action after the first save is attempted, but before the results are revealed by the GM. The barbarian must take the second result, even if it is worse. A barbarian must be at least 8th level before selecting this power. This power can only be used once per <em>rage.</em></p>
<p><strong className="hl"><Link to="/ragepower/come_and_get_me">Come and Get Me:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-4" id="ability-rage_powers-ref-I-4" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> as a free action the barbarian may leave herself open to attack while preparing devastating counterattacks. Enemies gain a +4 bonus on attack and damage rolls against the barbarian until the beginning of her next turn, but every attack against the barbarian provokes an attack of opportunity from her, which is resolved prior to resolving each enemy attack. A barbarian must be at least 12th level to select this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/contagious_rage">Contagious Rage:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-G-2" id="ability-rage_powers-ref-G-2" data-hash-target to="ability-rage_powers-G">7</InnerLink></sup> The barbarian howls during combat, agitating nearby fauna. Willing animals and magical beasts within 30 feet of the barbarian gain the benefits of the <Link to="/spell/rage">rage</Link> spell for as long as she maintains her <em>rage.</em> After the barbarian's <em>rage</em> ends, creatures affected by her <em>rage</em> are fatigued for the same number of rounds as the barbarian. A barbarian must be at least 6th level to choose this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/deathless_frenzy">Deathless Frenzy:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-E-3" id="ability-rage_powers-ref-E-3" data-hash-target to="ability-rage_powers-E">5</InnerLink></sup> While <em>raging,</em> you ignore the effects of being at 0 or fewer hit points until you have been at 0 or fewer hit points for 1 round, at which point the appropriate consequences for your current hit point total take effect. Even death can be postponed this way, potentially allowing you to survive if you receive sufficient healing before the round is up. You must be at least 12th level and be <Link to="/race/wereboar_kin">wereboar-kin</Link> or be associated with wereboar-kin to select this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/disemboweling_tusks">Disemboweling Tusks:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-E-4" id="ability-rage_powers-ref-E-4" data-hash-target to="ability-rage_powers-E">5</InnerLink></sup> While <em>raging,</em> when you confirm a critical hit with your gore attack, you deal 1d4 points of <Link to="/rule/constitution_damage">Constitution damage</Link> in addition to the normal damage for the gore attack. You must be at least 10th level and be <Link to="/race/wereboar_kin">wereboar-kin</Link> or be associated with wereboar-kin to select this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/dissipating_rage">Dissipating Rage:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-G-3" id="ability-rage_powers-ref-G-3" data-hash-target to="ability-rage_powers-G">7</InnerLink></sup> When the barbarian <em>rages,</em> her feverish frenzy and hot breath burn or blow fog, smoke and similar effects away from her. The barbarian and creatures adjacent to her do not gain <Link to="/rule/concealment">concealment</Link> from obfuscating effects like fog or precipitation. Magical effects that require more than a strong wind to dissipate are not affected by this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/eclipsing_rage">Eclipsing Rage:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-G-4" id="ability-rage_powers-ref-G-4" data-hash-target to="ability-rage_powers-G">7</InnerLink></sup> While the barbarian is <em>raging,</em> the <Link to="/rule/light_level">light level</Link> within 10 feet of her lowers by one step. She can't decrease the light level below normal darkness with this ability. Multiple barbarians with this rage power don't further reduce the light level. A barbarian must be at least 6th level to choose this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_eclipsing_rage">Greater Eclipsing Rage:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-G-5" id="ability-rage_powers-ref-G-5" data-hash-target to="ability-rage_powers-G">7</InnerLink></sup> Whenever the barbarian <em>rages,</em> the <Link to="/rule/light_level">light level</Link> within 20 feet of her lowers by two steps instead of one. She still can't decrease the light level below normal darkness with this ability. A barbarian must be at least 10th level and have the <Link to="/ragepower/eclipsing_rage">eclipsing rage</Link> rage power to choose this rage power.</p>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_elemental_rage">Lesser Elemental Rage:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-5" id="ability-rage_powers-ref-I-5" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> As a swift action, the barbarian can cause her melee attacks to deal an additional 1d6 points of energy damage (acid, cold, electricity, or fire) for 1 round. A barbarian must be at least 4th level to select this rage power. This power can only be used once per <em>rage.</em></p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/elemental_rage">Elemental Rage:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-6" id="ability-rage_powers-ref-I-6" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> all of the barbarian's melee attacks deal an additional 1d6 points of energy damage (acid, cold, electricity, or fire). The type is chosen when the barbarian begins her <em>rage.</em> A barbarian must have the <Link to="/ragepower/lesser_elemental_rage">lesser elemental rage</Link> power to select this rage power. A barbarian must be at least 8th level to select this rage power. Note that the barbarian can still use her lesser elemental rage power while using this rage power, but she must select a different energy type.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_elemental_rage">Greater Elemental Rage:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-7" id="ability-rage_powers-ref-I-7" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> all of the barbarian's critical hits made with melee weapons deal an additional 1d10 points of energy damage (2d10 if the weapon deals &times;3 damage on a critical hit, 3d10 if the weapon deals &times;4 on a critical hit). The type of this damage is the same as the type chosen for the elemental rage power. A barbarian must have the <Link to="/ragepower/elemental_rage">elemental rage</Link> power to select this rage power. A barbarian must be at least 12th level to select this rage power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/energy_resistance">Energy Resistance:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-8" id="ability-rage_powers-ref-I-8" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> the barbarian gains resistance to one energy type (acid, cold, electricity, fire, or sonic) equal to 1/2 her barbarian level (minimum 1). The energy type is chosen when this rage power is selected and it cannot be changed. This rage power can be selected more than once. Its effects do not stack. Each time is applies to a different energy type.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_energy_resistance">Greater Energy Resistance:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-9" id="ability-rage_powers-ref-I-9" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> Once per <em>rage,</em> a barbarian can reduce damage by half from a single attack against which she has energy resistance (halve the damage, then apply resistance). A barbarian must have the <Link to="/ragepower/energy_resistance">energy resistance</Link> rage power to select this rage power. A barbarian must be at least 8th level to select this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/energy_absorption">Energy Absorption:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-10" id="ability-rage_powers-ref-I-10" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> the barbarian can absorb energy from a single attack of her chosen energy type once per <em>rage.</em> She does not make a saving throw against the effect but takes no damage from it, instead gaining 1 temporary hit point per 3 points of damage the attack would have inflicted. These <Link to="/rule/temporary_hit_points">temporary hit points</Link> last until the end of the barbarian's <em>rage.</em> A barbarian must have the <Link to="/ragepower/greater_energy_resistance">greater energy resistance</Link> rage power to select this rage power. A barbarian must be at least 12th level to select this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/energy_eruption">Energy Eruption:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-11" id="ability-rage_powers-ref-I-11" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> the barbarian can absorb energy from a single attack and unleash it upon her enemies once per <em>rage.</em> She does not make a saving throw against the effect but takes no damage from it. At any point during the remainder of her <em>rage</em> she can unleash the stored energy as a breath weapon in either a 60-foot line or 30-foot cone. The breath weapon inflicts damage equal to the damage from the attack absorbed by the barbarian, but creatures within the area may make a Reflex save (DC 10 + 1/2 the barbarian's level + the barbarian's Constitution modifier) for half damage even if the original effect did not allow a save. A barbarian must have the <Link to="/ragepower/energy_absorption">energy absorption</Link> rage power to select this rage power. A barbarian must be at least 16th level to select this rage power.</p>
</blockquote>
</blockquote>
</blockquote>
...
<p><strong className="hl"><Link to="/ragepower/fearless_rage">Fearless Rage:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-3" id="ability-rage_powers-ref-A-3" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> While <em>raging,</em> the barbarian is immune to the shaken and frightened conditions. A barbarian must be at least 12th level before selecting this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/ferocious_beast">Ferocious Beast:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-L-1" id="ability-rage_powers-ref-L-1" data-hash-target to="ability-rage_powers-L">12</InnerLink></sup> While the barbarian is <em>raging,</em> her animal companion also gains the benefits of <em>rage</em> (including <em>greater rage, mighty rage,</em> and <em>tireless rage</em>), though the barbarian must spend 1 additional round of <em>rage</em> per round if her companion begins or ends its turn adjacent to her, and 2 additional rounds of <em>rage</em> per round if not.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_ferocious_beast">Greater Ferocious Beast:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-L-2" id="ability-rage_powers-ref-L-2" data-hash-target to="ability-rage_powers-L">12</InnerLink></sup> While the barbarian is <em>raging,</em> her animal companion shares the benefits of the barbarian's rage powers that are constant in effect. It gains no benefit from rage powers that require actions to activate, even if they are free actions. A barbarian must have the <Link to="/ragepower/ferocious_beast">ferocious beast</Link> rage power and be at least 8th level to select this rage power.</p>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/ferocious_mount">Ferocious Mount:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-12" id="ability-rage_powers-ref-I-12" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging</em> and mounted, the barbarian's mount also gains the benefits of <em>rage</em> (including <em>greater rage</em> and <em>mighty rage</em>) as long as the barbarian is mounted or adjacent to it. While her mount is <em>raging</em> in this way, she must spend one additional round of <em>rage</em> per round. She can elect not to pay this cost, in which case her mount does not <em>rage.</em></p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_ferocious_mount">Greater Ferocious Mount:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-13" id="ability-rage_powers-ref-I-13" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging</em> and mounted, the barbarian's mount gains the benefits of any rage powers that are constant in effect when the barbarian is <em>raging.</em> It does not gain the benefit of any rage powers that require actions to activate, even if they are free actions. A barbarian must have the <Link to="/ragepower/ferocious_mount">ferocious mount</Link> rage power to select this rage power. A barbarian must be at least 8th level to select this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/ferocious_trample">Ferocious Trample:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-14" id="ability-rage_powers-ref-I-14" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging</em> and mounted, the barbarian's mount gains the <Link to="/umr/trample">trample</Link> special attack. This attack inflicts 1d8 points of damage for a Medium mount, 2d6 for a Large mount, or 2d8 for a Huge mount, plus 1-1/2 times the mount's Strength modifier. A successful Reflex save (DC 10 + 1/2 the barbarian's level + the mount's Strength modifier) halves this damage. Creatures in the mount's path or that threaten squares it passes through may make attacks of opportunity against either the barbarian or the mount, but not both. A barbarian must have the <Link to="/ragepower/ferocious_mount">ferocious mount</Link> rage power to select this rage power. A barbarian must be at least 8th level to select this rage power.</p>
<blockquote>
...
<p><strong className="hl"><Link to="/ragepower/ghost_rager">Ghost Rager:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-F-3" id="ability-rage_powers-ref-F-3" data-hash-target to="ability-rage_powers-F">6</InnerLink></sup> While <em>raging,</em> the barbarian deals normal damage to incorporeal creatures even when using nonmagical weapons. She also gains a +3 morale bonus to touch AC, which increases by 1 at 8th level and every 4 levels thereafter (to a maximum of +7 at 20th level). This can't raise her touch AC above her full AC. A barbarian must be at least 6th level before selecting this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/good_for_what_ails_you">Good for What Ails You:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-18" id="ability-rage_powers-ref-I-18" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> the barbarian who takes a drink of alcohol may attempt a new saving throw against one of the following conditions that may be affecting her: blinded, confused, dazzled, deafened, exhausted, fatigued, frightened, nauseated, panicked, shaken, or sickened. If she succeeds at the save, the effect is suppressed for the duration of the <em>rage.</em> She also may attempt a new saving throw if poisoned; a successful save counts against those required for a cure, but a failed save has no ill effect.</p>
<p><strong className="hl"><Link to="/ragepower/ground_breaker">Ground Breaker:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-19" id="ability-rage_powers-ref-I-19" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> Once per <em>rage,</em> the barbarian can attack the floor around her as a standard action. This attack automatically hits and deals damage normally. If the barbarian manages to deal more damage than the floor's hardness, the space she occupies and all of the squares adjacent to her become <Link to="/rule/difficult_terrain">difficult terrain</Link>. Creatures in these squares, except the barbarian, must make a DC 15 Reflex save or be knocked <Link to="/rule/prone">prone</Link>. A barbarian must be at least 6th level to select this rage power.</p>
<blockquote>
...
<p><strong className="hl"><Link to="/ragepower/guarded_life">Guarded Life:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-20" id="ability-rage_powers-ref-I-20" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> if the barbarian is reduced below 0 hit points, 1 hit point of lethal damage per barbarian level is converted to nonlethal damage. If the barbarian is at negative hit points due to lethal damage, she immediately <Link to="/misc/stabilize">stabilizes</Link>.</p>
<blockquote>
...
<p><strong className="hl"><Link to="/ragepower/hurling_charge">Hurling Charge:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-24" id="ability-rage_powers-ref-I-24" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging</em> and making a charge attack, the barbarian may draw and throw a hurled weapon during her charge, gaining the normal +2 attack roll bonus on the thrown weapon attack as well as on the melee attack at the end of the charge. The barbarian must move at least 10 feet before using a thrown weapon and at least 10 additional feet before making a melee attack at the end of her charge. The barbarian must have a thrown weapon in hand or have one hand free at the beginning of her charge. A barbarian must have the <Link to="/ragepower/lesser_hurling">lesser hurling</Link> rage power to select this rage power. A barbarian must be at least 6th level to select this rage power.</p>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/impelling_disarm">Impelling Disarm:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-O-1" id="ability-rage_powers-ref-O-1" data-hash-target to="ability-rage_powers-O">15</InnerLink></sup> Once per <em>rage,</em> the barbarian can make a <Link to="/rule/disarm">disarm</Link> attempt against a target in place of a melee attack. This attempt does not provoke attacks of opportunity. If successful, the barbarian sends the target's weapon flying - either straight at the target, or spinning away to strike another foe up to 20 feet away. This ranged attack has a -4 penalty, as it is treated as <Link to="/rule/weapons">throwing a weapon that isn't designed to be thrown</Link>, even if the weapon disarmed is a thrown weapon. The barbarian makes a ranged attack, which doesn't provoke attacks of opportunity, at either the target of his disarm maneuver or another creature within 20 feet. If the barbarian is aiming for the disarmed creature, the foe doesn't count as being in melee for determining any penalty on the ranged attack from throwing a ranged weapon into melee. If the ranged attack hits, the disarmed weapon deals damage as if the barbarian had thrown it. The barbarian can choose to aim the disarmed weapon at a square rather than at a foe. A barbarian must be at least 4th level to select this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/increased_damage_reduction">Increased Damage Reduction:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-5" id="ability-rage_powers-ref-A-5" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> The barbarian's damage reduction increases by 1/-. This increase is always active while the barbarian is <em>raging.</em> A barbarian can select this rage power up to three times. Its effects stack. A barbarian must be at least 8th level before selecting this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/internal_fortitude">Internal Fortitude:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-6" id="ability-rage_powers-ref-A-6" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> While <em>raging,</em> the barbarian is immune to the sickened and nauseated conditions. A barbarian must be at least 8th level before selecting this rage power.</p>
...
<p><strong className="hl"><Link to="/ragepower/inured_to_the_dead">Inured to the Dead:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-P-1" id="ability-rage_powers-ref-P-1" data-hash-target to="ability-rage_powers-P">16</InnerLink></sup> Once per <em>rage,</em> when the barbarian fails a saving throw against an effect created by an undead creature, she can reroll the saving throw. She must use the second result, even if it is worse. This does not require spending an action. A barbarian must be at least 4th level to select this rage power.</p>
...
<p><strong className="hl"><Link to="/ragepower/knockdown">Knockdown:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-25" id="ability-rage_powers-ref-I-25" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> Once per <em>rage,</em> the barbarian can make a trip attack against one target in place of a melee attack. If successful, the target takes damage equal to the barbarian's Strength modifier and is knocked <Link to="/rule/prone">prone</Link>. This does not provoke an attack of opportunity.</p>
...
<AffInfo type="Curse" save="Will 10 + 1/2 the character's level + their Charisma modifier" eff={<>Target takes 1 point of <Link to="/rule/con_damage">Con damage</Link> per day and <Link to="/rule/age">ages</Link> at a rate of 1 year per day (eventually incurring all of the penalties of old age but none of the bonuses)</>} undefined icon="c">Curse of Decay</AffInfo>
<p><strong className="hl"><Link to="/ragepower/crag_linnorm_death_curse">Crag Linnorm Death Curse:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-4" id="ability-rage_powers-ref-M-4" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> The character channels the power of a <Link to="/monster/crag_linnorm">crag linnorm</Link>. The character's melee attacks deal an additional 1 point of fire damage. If the character is knocked unconscious or killed by an attack or spell, the attacker suffers the <em>curse of fire</em> (Will negates). A character must be at least 4th level to select this rage power.</p>
<AffInfo type="Curse" save="Will 10 + 1/2 the character's level + their Charisma modifier" eff={<>Target gains <Link to="/umr/vulnerability">vulnerability</Link> to fire</>} undefined icon="c">Curse of Fire</AffInfo>
<p><strong className="hl"><Link to="/ragepower/fjord_linnorm_death_curse">Fjord Linnorm Death Curse:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-5" id="ability-rage_powers-ref-M-5" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> The character channels the power of a <Link to="/monster/fjord_linnorm">fjord linnorm</Link>. The character's melee attacks deal an additional 1 point of cold damage. If the character is knocked unconscious or killed by an attack or spell, the attacker suffers the <em>curse of drowning</em> (Will negates). A character must be at least 4th level to select this rage power.</p>
<AffInfo type="Curse" save="Will 10 + 1/2 the character's level + their Charisma modifier" eff={<>Target is unable to breathe water (even with magic), can hold its breath only half as long as normal, and is <Link to="/misc/sickened">sickened</Link> whenever it holds its breath</>} undefined icon="c">Curse of Drowning</AffInfo>
<p><strong className="hl"><Link to="/ragepower/ice_linnorm_death_curse">Ice Linnorm Death Curse:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-6" id="ability-rage_powers-ref-M-6" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> The character channels the power of an <Link to="/monster/ice_linnorm">ice linnorm</Link>. The character's melee attacks deal an additional 1 point of cold damage. If the character is knocked unconscious or killed, the attacker suffers the <em>curse of frost.</em> A character must be at least 4th level to select this rage power.</p>
<AffInfo type="Curse" save="Will 10 + 1/2 the character's level + their Charisma modifier" eff={<>Target gains <Link to="/umr/vulnerability">vulnerability</Link> to cold</>} undefined icon="c">Curse of Frost</AffInfo>
<p><strong className="hl"><Link to="/ragepower/taiga_linnorm_death_curse">Taiga Linnorm Death Curse:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-7" id="ability-rage_powers-ref-M-7" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> The character channels the power of a <Link to="/monster/taiga_linnorm">taiga linnorm</Link>. The character's melee attacks deal an additional 1 point of electricity damage. If the character is knocked unconscious or killed by an attack or spell, the attacker suffers the <em>curse of electricity</em> (Will negates). A character must be at least 4th level to select this rage power.</p>
<AffInfo type="Curse" save="Will 10 + 1/2 the character's level + their Charisma modifier" eff={<>Target gains <Link to="/umr/vulnerability">vulnerability</Link> to electricity</>} undefined icon="c">Curse of Electricity</AffInfo>
<p><strong className="hl"><Link to="/ragepower/tarn_linnorm_death_curse">Tarn Linnorm Death Curse:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-8" id="ability-rage_powers-ref-M-8" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> The character channels the power of a <Link to="/monster/tarn_linnorm">tarn linnorm</Link>. The character's melee attacks deal an additional 1 point of acid damage. If the character is knocked unconscious or killed by an attack or spell, the attacker suffers the <em>curse of death</em> (Will negates). A character must be at least 4th level to select this rage power.</p>
<AffInfo type="Curse" save="Will 10 + 1/2 the character's level + their Charisma modifier" eff={<>Target is no longer affected by healing spells and can't heal damage naturally by resting</>} undefined icon="c">Curse of Death</AffInfo>
<p><strong className="hl"><Link to="/ragepower/tor_linnorm_death_curse">Tor Linnorm Death Curse:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-9" id="ability-rage_powers-ref-M-9" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> The character channels the power of a <Link to="/monster/tor_linnorm">tor linnorm</Link>. The character's melee attacks deal an additional 1 point of fire damage. If the character is knocked unconscious or killed by an attack or spell, the attacker suffers the <em>curse of boiling blood</em> (Will negates). A character must be at least 8th level to select this rage power.</p>
<AffInfo type="Curse" save="Will 10 + 1/2 the character's level + their Charisma modifier" eff={<>Target gains <Link to="/umr/vulnerability">vulnerability</Link> to fire and is permanently <Link to="/misc/staggered">staggered</Link> from the pain of its boiling blood (this is a pain effect)</>} undefined icon="c">Curse of Boiling Blood</AffInfo>
<p><strong className="hl"><Link to="/ragepower/liquid_courage">Liquid Courage:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-26" id="ability-rage_powers-ref-I-26" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> the barbarian increases her morale bonus on saving throws against mind-affecting effects by +1 for each alcoholic drink she consumes during her <em>rage,</em> to a maximum of +1 increase per four barbarian levels.</p>
<p><strong className="hl"><Link to="/ragepower/lizard_stride">Lizard Stride:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-G-7" id="ability-rage_powers-ref-G-7" data-hash-target to="ability-rage_powers-G">7</InnerLink></sup> When the barbarian makes a charge or run action while <em>raging,</em> she can move across the surface of water without sinking. She sinks immediately if she ends her turn standing on water.</p>
<p><strong className="hl"><Link to="/ragepower/low_light_vision">Low-Light Vision:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-10" id="ability-rage_powers-ref-A-10" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> The barbarian's senses sharpen and she gains low-light vision while <em>raging.</em></p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/night_vision">Night Vision:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-11" id="ability-rage_powers-ref-A-11" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> The barbarian's senses grow incredibly sharp while <em>raging</em> and she gains darkvision 60 feet. A barbarian must have <Link to="/ragepower/low_light_vision">low-light vision</Link> as a rage power or a racial trait to select this rage power.</p>
</blockquote>
...
<p><strong className="hl"><Link to="/ragepower/mighty_swing">Mighty Swing:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-12" id="ability-rage_powers-ref-A-12" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> The barbarian automatically confirms a critical hit. This power is used as an immediate action once a critical threat has been determined. A barbarian must be at least 12th level before selecting this power. This power can only be used once per <em>rage.</em></p>
<p><strong className="hl"><Link to="/ragepower/moment_of_clarity">Moment of Clarity:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-13" id="ability-rage_powers-ref-A-13" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> The barbarian does not gain any benefits or take any of the penalties from <em>rage</em> for 1 round. Activating this power is a swift action. This includes the penalty to Armor Class and the restriction on what actions can be performed. This round still counts against her total number of rounds of <em>rage</em> per day. This power can only be used once per <em>rage.</em></p>
<blockquote>
...
<p><strong className="hl"><Link to="/ragepower/quick_reflexes">Quick Reflexes:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-16" id="ability-rage_powers-ref-A-16" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> While <em>raging,</em> the barbarian can make one additional attack of opportunity per round.</p>
<p><strong className="hl"><Link to="/ragepower/raging_climber">Raging Climber:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-17" id="ability-rage_powers-ref-A-17" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> When <em>raging,</em> the barbarian adds her level as an enhancement bonus on all Climb skill checks.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/bestial_climber">Bestial Climber:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-F-9" id="ability-rage_powers-ref-F-9" data-hash-target to="ability-rage_powers-F">6</InnerLink></sup> While <em>raging,</em> the barbarian gains a natural climb speed equal to her land speed. A barbarian must have the <Link to="/ragepower/raging_climber">raging climber</Link> rage power and be at least 6th level before selecting this rage power.</p>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/raging_flyer">Raging Flyer:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-G-9" id="ability-rage_powers-ref-G-9" data-hash-target to="ability-rage_powers-G">7</InnerLink></sup> When <em>raging,</em> the barbarian adds her level as an enhancement bonus to Fly checks.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/bestial_flyer">Bestial Flyer:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-G-10" id="ability-rage_powers-ref-G-10" data-hash-target to="ability-rage_powers-G">7</InnerLink></sup> While <em>raging,</em> the barbarian's fly speed increases by 10 feet and her maneuverability improves by one category. A barbarian must have a fly speed before <em>raging,</em> have the <Link to="/ragepower/raging_flyer">raging flyer</Link> power, and be at least 6th level to choose this rage power.</p>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/raging_leaper">Raging Leaper:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-18" id="ability-rage_powers-ref-A-18" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> When <em>raging,</em> the barbarian adds her level as an enhancement bonus on all <Link to="/skill/acrobatics">Acrobatics</Link> skill checks made to jump. When making a jump in this way, the barbarian is always considered to have a running start.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/bestial_leaper">Bestial Leaper:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-F-10" id="ability-rage_powers-ref-F-10" data-hash-target to="ability-rage_powers-F">6</InnerLink></sup> While <em>raging,</em> the barbarian can take a move action to move and can take her normal standard action at any point during the move. A barbarian must have the <Link to="/ragepower/raging_leaper">raging leaper</Link> rage power and be at least 6th level before selecting this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/raging_flier">Raging Flier:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-11" id="ability-rage_powers-ref-M-11" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> Once per <em>rage,</em> the character can fly up to her base speed as a move action. If she uses the charge action, she can use this flight as part of her movement during the charge. A character must be at least 6th level and have the <Link to="/ragepower/raging_leaper">raging leaper</Link> rage power to select this rage power.</p>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/raging_grappler">Raging Grappler:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-J-2" id="ability-rage_powers-ref-J-2" data-hash-target to="ability-rage_powers-J">10</InnerLink></sup> While <em>raging,</em> the barbarian grapples her foes with the power and viciousness of a river crocodile. As long as she is <em>raging,</em> whenever the barbarian succeeds at a check to start a <Link to="/rule/grapple">grapple</Link>, she can choose to deal damage as if she had also succeeded at a check to maintain the grapple. In addition, while she is <em>raging,</em> whenever the barbarian succeeds at a combat maneuver check to maintain a grapple, she can choose to give herself, the target of her grapple, or both the <Link to="/rule/prone">prone</Link> condition as a free action while continuing to maintain the grapple.</p>
<p><strong className="hl"><Link to="/ragepower/raging_swimmer">Raging Swimmer:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-19" id="ability-rage_powers-ref-A-19" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> When <em>raging,</em> the barbarian adds her level as an enhancement bonus on all Swim skill checks.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/bestial_swimmer">Bestial Swimmer:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-F-11" id="ability-rage_powers-ref-F-11" data-hash-target to="ability-rage_powers-F">6</InnerLink></sup> While <em>raging,</em> the barbarian gains a natural swim speed equal to her normal land speed. A barbarian must have the <Link to="/ragepower/raging_swimmer">raging swimmer</Link> rage power and be at least 6th level before selecting this rage power.</p>
</blockquote>
...
<p><strong className="hl"><Link to="/ragepower/reckless_abandon">Reckless Abandon:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-29" id="ability-rage_powers-ref-I-29" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> the barbarian can take a -1 penalty to AC to gain a +1 bonus on attack rolls. The AC penalty increases by -1 and the attack roll bonus increases by +1 at 4th level and every four levels thereafter.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/inspire_ferocity">Inspire Ferocity:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-30" id="ability-rage_powers-ref-I-30" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> the barbarian can use a move action to impart her reckless abandon modifier to all willing allies within 30 feet for a number of rounds equal to her Charisma modifier (minimum 1). A barbarian must have the <Link to="/ragepower/reckless_abandon">reckless abandon</Link> rage power to select this rage power.</p>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/renewed_vigor">Renewed Vigor:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-20" id="ability-rage_powers-ref-A-20" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> As a standard action, the barbarian heals 1d8 points of damage + her Constitution modifier. For every four levels the barbarian has attained above 4th, this amount of damage healed increases by 1d8, to a maximum of 5d8 at 20th level. A barbarian must be at least 4th level before selecting this power. This power can be used only once per day and only while <em>raging.</em></p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/regenerative_vigor">Regenerative Vigor:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-F-12" id="ability-rage_powers-ref-F-12" data-hash-target to="ability-rage_powers-F">6</InnerLink></sup> After using her renewed vigor rage power until her current <em>rage</em> ends, the barbarian gains <Link to="/umr/fast_healing">fast healing</Link> 1 for every 6 barbarian levels she has (maximum fast healing 3). She regains hit points from fast healing at the start of each of her turns. A barbarian must have the <Link to="/ragepower/renewed_vigor">renewed vigor</Link> rage power and be at least 6th level before selecting this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/renewed_vitality">Renewed Vitality:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-F-13" id="ability-rage_powers-ref-F-13" data-hash-target to="ability-rage_powers-F">6</InnerLink></sup> While <em>raging,</em> the barbarian ignores the effect of 1 point of ability penalty or damage per two barbarian levels she has (maximum 10). Once per day, when a barbarian with ability penalties or damage ends her <em>rage,</em> she can reroll a saving throw, if any, against an effect that imposed an ability penalty or dealt her ability damage. If successful, she removes an amount of ability penalty or damage equal to the amount she can ignore while <em>raging.</em> A barbarian must have the <Link to="/ragepower/renewed_vigor">renewed vigor</Link> rage power and be at least 4th level before selecting this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/renewed_life">Renewed Life:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-F-14" id="ability-rage_powers-ref-F-14" data-hash-target to="ability-rage_powers-F">6</InnerLink></sup> While <em>raging,</em> the barbarian ignores the effect of one temporary negative level per four barbarian levels she has (maximum 5). Once per day, when a barbarian with temporary negative levels ends her <em>rage,</em> she can attempt saving throws to remove a number of negative levels equal to the number of levels she could ignore while <em>raging.</em> A barbarian must have the <Link to="/ragepower/renewed_vitality">renewed vitality</Link> rage power and be at least 6th level before selecting this rage power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/roaring_drunk">Roaring Drunk:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-I-31" id="ability-rage_powers-ref-I-31" data-hash-target to="ability-rage_powers-I">9</InnerLink></sup> While <em>raging,</em> the barbarian gains a +1 morale bonus on Intimidate checks and to the save DC of any fear effects she creates for each alcoholic drink she has consumed during her <em>rage,</em> to a maximum of +1 per four barbarian levels.</p>
...
<p><strong className="hl"><Link to="/ragepower/savage_dirty_trick">Savage Dirty Trick:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-O-2" id="ability-rage_powers-ref-O-2" data-hash-target to="ability-rage_powers-O">15</InnerLink></sup> Once per round while <em>raging,</em> (6th) the barbarian can attempt a <Link to="/rule/dirty_trick">dirty trick</Link> combat maneuver in place of a melee attack. This attempt does not provoke attacks of opportunity. If successful, the target takes an amount of damage equal to the barbarian's Strength modifier and must succeed at a Fortitude save (DC 10 + 1/2 the barbarian's level + the barbarian's Strength modifier) or take an additional penalty from the dirty trick based on the type of dirty trick performed and the following table.</p>
<ScrollContainer id="ability-rage_powers--table-0"><table>
<thead>
<tr>
...
<p>This power can only be used once per opponent per <em>rage.</em> A barbarian must be at least 6th level to select this rage power.</p>
...
<p><strong className="hl"><Link to="/ragepower/swift_foot">Swift Foot:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-27" id="ability-rage_powers-ref-A-27" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> The barbarian gains a 5-foot enhancement bonus to her speed. This increase is always active while the barbarian is <em>raging.</em> A barbarian can select this rage power up to three times. Its effects stack.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/sprint">Sprint:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-F-23" id="ability-rage_powers-ref-F-23" data-hash-target to="ability-rage_powers-F">6</InnerLink></sup> Once per <em>rage,</em> the barbarian can use a single full-round run action to move up to 6 times her speed or a single full-round charge action to move up to 3 times her speed. A barbarian must have the <Link to="/ragepower/swift_foot">swift foot</Link> rage power and be at least 4th level before selecting this rage power.</p>
</blockquote>
...
<p><strong className="hl"><Link to="/ragepower/unexpected_strike">Unexpected Strike:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-A-28" id="ability-rage_powers-ref-A-28" data-hash-target to="ability-rage_powers-A">1</InnerLink></sup> The barbarian can make an attack of opportunity against a foe that moves into any square threatened by the barbarian, regardless of whether or not that movement would normally provoke an attack of opportunity. This power can only be used once per <em>rage.</em> A barbarian must be at least 8th level before selecting this power.</p>
<p><strong className="hl"><Link to="/ragepower/unrestrained_rage">Unrestrained Rage:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-P-3" id="ability-rage_powers-ref-P-3" data-hash-target to="ability-rage_powers-P">16</InnerLink></sup> While <em>raging,</em> the barbarian is immune to paralysis. If the barbarian is targeted by an effect that would cause her to become <Link to="/rule/paralyzed">paralyzed</Link>, she can enter a <em>rage</em> as an immediate action, as long as she still has rounds of <em>rage</em> remaining. A barbarian must be at least 12th level to select this rage power.</p>
...
<hr/>
<p><strong className="hl"><Link to="/ragepower/aryzuls_curse">Aryzul's Curse:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-R-1" id="ability-rage_powers-ref-R-1" data-hash-target to="ability-rage_powers-R">18</InnerLink></sup> When <em>raging,</em> the barbarian emanates a 5-foot-radius aura of radioactivity. Each round that another creature begins its turn within this aura, it takes a cumulative -2 penalty to Strength (Fortitude negates, DC = 10 + 1/2 the barbarian's level + her Constitution modifier) for the duration of the <em>rage.</em> A creature's Strength penalty from this ability cannot exceed the barbarian's class level. At 12th level, the barbarian can choose to create a 10-foot-radius aura of radioactivity when she begins her <em>rage.</em></p>
<p><strong className="hl"><Link to="/ragepower/hshurhas_veil">Hshurha's Veil:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-R-2" id="ability-rage_powers-ref-R-2" data-hash-target to="ability-rage_powers-R">18</InnerLink></sup> When <em>raging,</em> the barbarian can use Stealth, and she gains a bonus equal to 1/2 her barbarian level on Stealth checks plus the benefits of <Link to="/rule/concealment">concealment</Link> against ranged attacks and attacks of opportunity.</p>
<p><strong className="hl"><Link to="/ragepower/kelizandris_tide">Kelizandri's Tide:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-R-3" id="ability-rage_powers-ref-R-3" data-hash-target to="ability-rage_powers-R">18</InnerLink></sup> When the barbarian <em>rages,</em> enemies find it difficult to escape the vortex of her fury. As a full-round action while <em>raging,</em> the barbarian can attempt a single combat maneuver check against each creature within 10 feet of her. If her roll equals or exceeds a creature's CMD, she moves that creature 5 feet closer to her. Once per day after attempting this maneuver, she can attack each adjacent creature as a free action as if using the <Link to="/feat/whirlwind_attack">Whirlwind Attack</Link> feat. If she has the Whirlwind Attack feat, she can also use it as a free action in this way one additional time per day.</p>
<p><strong className="hl"><Link to="/ragepower/ymeris_pyre">Ymeri's Pyre:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-R-4" id="ability-rage_powers-ref-R-4" data-hash-target to="ability-rage_powers-R">18</InnerLink></sup> The barbarian visibly burns with an inner flame that consumes all impurities affecting her. Each round that the barbarian <em>rages</em> reduces the duration of negative spells and effects inflicted upon her as if 2 rounds had passed; this has no effect on the duration of such effects against other creatures. Once per day, the barbarian can expend 5 rounds of <em>rage</em> to attempt a new saving throw against each non-permanent effect currently affecting her. Each successful saving throw ends the related effect, and she can choose not to make a save against an effect.</p>
...
<hr/>
<p><strong className="hl"><Link to="/ragepower/lesser_abyssal_blood">Lesser Abyssal Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-12" id="ability-rage_powers-ref-M-12" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> the barbarian gains two claw attacks. These attacks are considered primary attacks and are made at the barbarian's full base attack bonus. They deal 1d6 points of slashing damage for Medium creatures (1d4 if Small) plus her Strength modifier.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/abyssal_blood">Abyssal Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-13" id="ability-rage_powers-ref-M-13" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> Once per day when the barbarian enters a <em>rage,</em> she can choose to grow one size category larger than her base size (as <Link to="/spell/enlarge_person">enlarge person</Link>, even if the barbarian isn't humanoid). You must be 6th level and have the <Link to="/ragepower/lesser_abyssal_blood">lesser abyssal blood</Link> rage power to select this power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_abyssal_blood">Greater Abyssal Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-14" id="ability-rage_powers-ref-M-14" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> the barbarian gains resistance 5 to acid, cold, and fire. You must be 10th level and have the <Link to="/ragepower/abyssal_blood">abyssal blood</Link> rage power to select this power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_celestial_blood">Lesser Celestial Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-15" id="ability-rage_powers-ref-M-15" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> the barbarian's melee attacks are considered good-aligned weapons for the purpose of bypassing damage reduction. Furthermore, the barbarian deals an additional 1d6 points of damage when she damages an evil outsider with a melee attack.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/celestial_blood">Celestial Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-16" id="ability-rage_powers-ref-M-16" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> the barbarian gains resistance 5 to acid and cold. You must be 6th level and have the <Link to="/ragepower/lesser_celestial_blood">lesser celestial blood</Link> rage power to select this power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_celestial_blood">Greater Celestial Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-17" id="ability-rage_powers-ref-M-17" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> Once per <em>rage,</em> the barbarian can reroll one ability check, skill check, or saving throw she just made. She must take the second result, even if it's lower. She must decide to use this ability after the die is rolled but before results are revealed. You must be 10th level and have the <Link to="/ragepower/celestial_blood">celestial blood</Link> rage power to select this power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_draconic_blood">Lesser Draconic Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-18" id="ability-rage_powers-ref-M-18" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> the barbarian gains two claw attacks. These attacks are considered primary attacks and are made at the barbarian's full base attack bonus. They deal 1d6 points of slashing damage for Medium creatures (1d4 if Small) plus her Strength modifier.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/draconic_blood">Draconic Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-19" id="ability-rage_powers-ref-M-19" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> Choose an energy type from the following: acid, cold, fire, or electricity. While <em>raging,</em> the barbarian gains resistance 5 against the chosen energy type and a +1 natural armor bonus. You must be 6th level and have the <Link to="/ragepower/lesser_draconic_blood">lesser draconic blood</Link> rage power to select this power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_draconic_blood">Greater Draconic Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-20" id="ability-rage_powers-ref-M-20" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> the barbarian gains a breath weapon that she can use once per day. For every 2 barbarian levels, this breath weapon deals 1d6 points of damage of the energy type she choose for the draconic blood power, either in a 30-foot cone (if cold or fire) or a 60-foot line (if acid or electricity). Those caught in the area of the breath can attempt a Reflex saving throw for half damage. The DC of this save is equal to 10 + 1/2 the barbarian's level + her Constitution modifier. You must be 10th level and have the <Link to="/ragepower/draconic_blood">draconic blood</Link> rage power to select this power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_elemental_blood">Lesser Elemental Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-21" id="ability-rage_powers-ref-M-21" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> Choose an energy type: acid, cold, fire, or electricity. While <em>raging,</em> as a swift action up to three times a day, the barbarian can imbue her melee attacks with elemental energy, dealing an additional 1d6 points of damage of the chosen energy type for 1 round.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/elemental_blood">Elemental Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-22" id="ability-rage_powers-ref-M-22" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging</em> the barbarian gains energy resistance 10 against the energy type chosen when she took lesser elemental blood. You must be 6th level and have the <Link to="/ragepower/lesser_elemental_blood">lesser elemental blood</Link> rage power to select this power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_elemental_blood">Greater Elemental Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-23" id="ability-rage_powers-ref-M-23" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> the barbarian gains a special movement type or bonus based on her chosen element: acid grants a burrow speed of 30 feet, cold grants a swim speed of 60 feet, fire grants an increase of 30 feet to her base land speed, and electricity grants a fly speed of 60 feet (good maneuverability). You must be 10th level and have the <Link to="/ragepower/elemental_blood">elemental blood</Link> rage power to select this power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_fey_blood">Lesser Fey Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-24" id="ability-rage_powers-ref-M-24" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> each time the barbarian confirms a critical hit, the target must succeed at a Will saving throw (DC = 10 + 1/2 the barbarian's level + her Constitution modifier) or be <Link to="/misc/confused">confused</Link> for one round. This is a mind-affecting compulsion effect.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/fey_blood">Fey Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-25" id="ability-rage_powers-ref-M-25" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> when the barbarian charges, she ignores <Link to="/rule/difficult_terrain">difficult terrain</Link> (including magical terrain, but not other creatures). You must be 6th level and have the <Link to="/ragepower/lesser_fey_blood">lesser fey blood</Link> rage power to select this power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_fey_blood">Greater Fey Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-26" id="ability-rage_powers-ref-M-26" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> as long as the barbarian moves at least 10 feet, she gain the effects of <Link to="/spell/blur">blur</Link> for 1 round. You must be 10th level and have the <Link to="/ragepower/fey_blood">fey blood</Link> rage power to select this power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_infernal_blood">Lesser Infernal Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-27" id="ability-rage_powers-ref-M-27" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> up to three times a day as a swift action, the barbarian can infuse her attacks with hellfire for 1 round. During this time, all of her melee attacks gain the <Link to="/magic-enh/flaming">flaming</Link> magic weapon special ability.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/infernal_blood">Infernal Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-28" id="ability-rage_powers-ref-M-28" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> the barbarian gains fire resistance 5, as well as a +2 bonus on saving throws against poison. You must be 6th level and have the <Link to="/ragepower/lesser_infernal_blood">lesser infernal blood</Link> rage power to select this power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_infernal_blood">Greater Infernal Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-29" id="ability-rage_powers-ref-M-29" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> the barbarian gains a +4 bonus against enchantment and fear effects. You must be 10th level and have the <Link to="/ragepower/infernal_blood">infernal blood</Link> rage power to select this power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_undead_blood">Lesser Undead Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-30" id="ability-rage_powers-ref-M-30" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> when the barbarian hits a creature with a charge attack, the creature she hit becomes <Link to="/misc/shaken">shaken</Link> for a number of rounds equal to 1/2 her barbarian level (minimum 1). This effect does not stack with other fear effects to cause a stronger condition.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/undead_blood">Undead Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-31" id="ability-rage_powers-ref-M-31" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> all of the barbarian's melee attacks are treated as if they were made with a weapon with the <Link to="/magic-enh/ghost_touch">ghost touch</Link> weapon special ability. You must be 6th level and have the <Link to="/ragepower/lesser_undead_blood">lesser undead blood</Link> rage power to select this power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_undead_blood">Greater Undead Blood:</Link></strong> <sup><InnerLink showBacklink="backlink-ability-rage_powers-ref-M-32" id="ability-rage_powers-ref-M-32" data-hash-target to="ability-rage_powers-M">13</InnerLink></sup> While <em>raging,</em> the barbarian gains cold resistance 10, as well as DR 10/- against nonlethal damage. You must be 10th level and have the <Link to="/ragepower/undead_blood">undead blood</Link> rage power to select this power.</p>
</blockquote>
</blockquote>
