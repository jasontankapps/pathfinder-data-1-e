...
<Ability id="basic-magic-sp" icon={["magic"]}>
...
<Ability id="bleed-ex" icon={["melee"]}>
...
<Ability id="hooves-ex" icon={["melee"]}>
...
<Ability id="reach-ex" icon={["melee"]}>
...
<Ability id="sticky-ex" icon={["boost"]}>
...
<Ability id="unnatural-aura-su" icon={["def"]}>
...
<Ability id="alignment-smite-su" icon={["boost"]}>
...
<Ability id="channel-resistance-ex" icon={["def"]}>
...
<Ability id="keen-scent-ex" icon={["boost"]}>
...
<Ability id="poison-ex" icon={["melee"]}>
...
<Ability id="rider-bond-ex" icon={["boost","power"]}>
...
<Ability id="shadow-blend-su" icon={["def"]}>
...
<Ability id="shadow-form-su" icon={["def","boost","down"]}>
...
<Ability id="sickening-ex" icon={["def","aura"]}>
...
<Ability id="trample-ex" icon={["melee"]}>
...
<Ability id="undead-appearance-ex" icon={["down","boost"]}>
...
<Ability id="weapon-training-ex" icon={["melee"]}>
...
<Ability id="celestial-appearance-ex" icon={["power","def"]}>
...
<Ability id="fiendish-appearance-ex" icon={["power","def"]}>
...
<Ability id="sacrifice-su" icon={["aid"]}>
...
<Ability id="blindsight-ex" icon={["boost"]}>
...
<Ability id="dimension-door-sp" icon={["magic"]}>
...
<Ability id="incorporeal-form-sp" icon={["power"]}>
...
<Ability id="no-breath-ex" icon={["power","def"]}>
...
<Ability id="ultimate-magic-sp" icon={["magic"]}>
