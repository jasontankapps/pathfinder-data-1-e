...
<Ability id="animal-friend" icon={["boost","def"]}>
...
<Ability id="natures-speaker" icon={["boost","magic"]}>
...
<Ability id="bardic-performance" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="soothing-performance" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="attract-rats" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="summon-natures-ally" icon={["learn"]}>
...
<Ability id="arcane-strike" icon={["power"]}>
...
<Ability id="rallying-cry-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="bladethirst-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="mass-bladethirst-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="arcane-armor-ex" icon={["def","power"]}>
...
<Ability id="channel-energy-su" icon={["power","aura"]}>
...
<Ability id="inspiring-healing-sp" icon={["magic"]}>
...
<Ability id="clever-explorer-ex" icon={["boost"]}>
...
<Ability id="advanced-talent" icon={["boost"]}>
...
<Ability id="naturalist-ex" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="lamentable-belaborment-ex" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="pedantic-lecture-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="lore-master-ex" icon={["boost"]}>
...
<Ability id="magic-lore-ex" icon={["boost","def"]}>
...
<Ability id="jack-of-all-trades-ex" icon={["power"]}>
...
<Ability id="probable-path-ex" icon={["roll"]}>
...
<Ability id="limning-verse-su" extraClasses="subAbility" icon={["lower","aura"]}>
...
<Ability id="shattering-crescendo-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="devilbane-refrain-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="dedicated-performance-ex" icon={["boost"]}>
...
<Ability id="weapon-proficiency" icon={["ranged","down"]}>
...
<Ability id="arcane-archery" icon={["learn","boost"]}>
...
<Ability id="precise-minstrel-ex" icon={["power","lower"]}>
...
<Ability id="arrowsong-strike-su" icon={["magic","ranged"]}>
...
<Ability id="inspire-teamwork-ex" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="ritual-of-reconciliation-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="versatile-teamwork-ex" icon={["power"]}>
...
<Ability id="deceptive-tale-su" icon={["boost"]}>
...
<Ability id="shameless-scoundrel-ex" icon={["boost"]}>
...
<Ability id="blatant-subtlety-ex" icon={["def"]}>
...
<Ability id="invoke-vyriavaxus-ex" icon={["learn"]}>
...
<Ability id="hilt-bash-ex" icon={["power"]}>
...
<Ability id="song-of-surrender-su" icon={["lower"]}>
...
<Ability id="knock-out-ex" icon={["power"]}>
...
<Ability id="mass-song-of-surrender-su" icon={["boost"]}>
...
<Ability id="busker-stunts-su" extraClasses="hasSubs" icon={["boost"]}>
...
<Ability id="quick-hands-su" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="patter-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="living-statue-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="fascinate-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="suggestion-sp" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="inventive-juggler-ex" extraClasses="subAbility" icon={["melee"]}>
...
<Ability id="impossible-sleight-of-hand-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="flexible-performer-ex" icon={["power"]}>
...
<Ability id="gather-crowd-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="shining-star-su" icon={["boost"]}>
...
<Ability id="prima-donna-ex" icon={["boost","lower"]}>
...
<Ability id="costume-proficiency-ex" icon={["def"]}>
...
<Ability id="devastating-aria-su" extraClasses="subAbility" icon={["zap"]}>
...
<Ability id="scathing-tirade-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="planar-lore-ex" icon={["power"]}>
...
<Ability id="quintessence-infusion-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="mantra-of-tabris-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="amoral-scholar-ex" icon={["def"]}>
...
<Ability id="scriveners-versatility-ex" icon={["boost"]}>
...
<Ability id="satire-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="mockery-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="glorious-epic-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="scandal-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="heraldic-expertise-ex" icon={["boost","roll"]}>
...
<Ability id="wide-audience-su" icon={["cone","boost"]}>
...
<Ability id="buffoonery-ex" icon={["boost"]}>
...
<Ability id="distracting-motley-su" extraClasses="subAbility" icon={["def","protect"]}>
...
<Ability id="defuse-tension-su" extraClasses="subAbility" icon={["aid"]}>
...
<Ability id="caper-and-jeer-ex" icon={["boost"]}>
...
<Ability id="plant-magic" icon={["learn"]}>
...
<Ability id="verdant-voice" icon={["power"]}>
...
<Ability id="song-of-growth-su" icon={["def","protect"]}>
...
<Ability id="resist-natures-lure-ex" icon={["power","def"]}>
...
<Ability id="nature-lore-ex" icon={["power","down"]}>
...
<Ability id="agile-ex" icon={["boost"]}>
...
<Ability id="derring-do-su" extraClasses="subAbility" icon={["def","protect","boost"]}>
...
<Ability id="canny-foe-ex" icon={["melee","def"]}>
...
<Ability id="dauntless-ex" icon={["def"]}>
...
<Ability id="scoundrels-fortune-ex" icon={["roll"]}>
...
<Ability id="battle-dance" icon={["power"]}>
...
<Ability id="dervish-dance-ex" icon={["power"]}>
...
<Ability id="spinning-spellcaster-ex" icon={["def"]}>
...
<Ability id="meditative-whirl-ex" icon={["magic","aid"]}>
...
<Ability id="incite-violence-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="righteous-cause-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="battle-dance" extraClasses="hasSubs" icon={["power"]}>
<Pair single id="battle-dance">Battle Dance</Pair>
<Pair hl title="Alters">Bardic performance</Pair>
...
<Ability id="rain-of-blows-su" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="razors-kiss-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="leaf-on-the-wind-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="fleet-su" icon={["boost"]}>
...
<Ability id="versatile-dance-ex" icon={["boost"]}>
...
<Ability id="dance-of-fury-su" icon={["melee","boost"]}>
...
<Ability id="battle-fury-su" icon={["melee","boost"]}>
...
<Ability id="careful-teamwork-su" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="true-confession-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="show-yourselves-ex" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="eye-for-detail-ex" icon={["boost"]}>
...
<Ability id="arcane-insight-ex" icon={["power","def"]}>
...
<Ability id="arcane-investigation" icon={["learn"]}>
...
<Ability id="dance-of-the-dead-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="haunted-eyes-ex" icon={["def"]}>
...
<Ability id="secrets-of-the-grave-ex" icon={["boost"]}>
...
<Ability id="haunting-refrain-su" icon={["lower"]}>
...
<Ability id="venomous-whispers-su" icon={["lower"]}>
...
<Ability id="serpent-of-the-mind-su" icon={["learn"]}>
...
<Ability id="coat-of-arms-ex" icon={["def"]}>
...
<Ability id="dragon-voice-ex" icon={["boost","power"]}>
...
<Ability id="diplomatic-immunity-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="diplomatic-protection-su" extraClasses="subAbility" icon={["protect"]}>
...
<Ability id="rebuke-foes-su" extraClasses="subAbility" icon={["zap"]}>
...
<Ability id="retreat-to-lair-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="master-of-persuasion-ex" icon={["boost"]}>
...
<Ability id="extol-glory-su" icon={["power"]}>
...
<Ability id="yapping-song-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="frightful-song-su" extraClasses="subAbility" icon={["lower","aura"]}>
...
<Ability id="diminished-competency" icon={["down"]}>
...
<Ability id="versatile-familiar-ex" icon={["boost"]}>
...
<Ability id="performing-familiar-su" icon={["power"]}>
...
<Ability id="harmonizing-familiar-su" icon={["boost"]}>
...
<Ability id="symphonic-familiar-su" icon={["power"]}>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-bard-dwarven_scholar--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>This archetype appears to be intended for <Link to="/race/dwarves">dwarves</Link> only, but that limitation is never explicitly stated.</td></tr></tbody></table></ScrollContainer></div><Ability id="weapon-and-armor-proficiency" icon={["power","down"]}>
<Pair single id="weapon-and-armor-proficiency">Weapon and Armor Proficiency</Pair>
...
<Ability id="dwarven-training-ex" icon={["power"]}>
...
<Ability id="war-chant-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="devout-spell-knowledge-su" icon={["power","magic"]}>
...
<Ability id="scorn-of-the-wilds-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="stone-dance-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="fey-contacts" icon={["power","boost"]}>
...
<Ability id="summon-fey-allies" icon={["learn","power"]}>
...
<Ability id="mischievous-talent-ex" icon={["boost","power"]}>
...
<Ability id="song-of-clumsiness-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="incite-unreliability-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="embarrassing-satire-su" extraClasses="subAbility" icon={["zap"]}>
...
<Ability id="dirty-trickster-ex" icon={["power"]}>
...
<Ability id="master-of-mischief-ex" icon={["power","boost"]}>
...
<Ability id="armor-and-weapon-proficiency" icon={["down"]}>
...
<Ability id="natural-magic" icon={["magic"]}>
...
<Ability id="natures-song" icon={["magic"]}>
...
<Ability id="echoes-of-natures-song-su" extraClasses="subAbility" icon={["protect"]}>
...
<Ability id="divinatory-song-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="voices-of-life-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="unity-of-life-su" extraClasses="subAbility" icon={["magic","protect"]}>
...
<Ability id="song-of-the-cycle-su" extraClasses="subAbility" icon={["protect"]}>
...
<Ability id="fey-magic" icon={["learn"]}>
...
<Ability id="echoes-of-the-first-world-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="gremlins-luck-su" extraClasses="subAbility" icon={["lower","roll"]}>
...
<Ability id="fire-dance-su" extraClasses="subAbility" icon={["def","protect"]}>
...
<Ability id="song-of-the-fiery-gaze-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="fire-break-su" extraClasses="subAbility" icon={["protect"]}>
...
<Ability id="fan-the-flames-su" icon={["learn"]}>
...
<Ability id="fire-music" icon={["power","learn"]}>
...
<Ability id="blazing-blades-su" extraClasses="subAbility" icon={["boost","magic"]}>
...
<Ability id="wildfire-ex" icon={["boost"]}>
...
<Ability id="fortune-tellers-divinations" icon={["learn"]}>
...
<Ability id="oracular-performance" icon={["magic"]}>
...
<Ability id="fortune-tellers-acumen" icon={["magic"]}>
...
<Ability id="transparent-fate-su" extraClasses="subAbility" icon={["lower","aura"]}>
