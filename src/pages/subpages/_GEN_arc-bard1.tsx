...
<Ability id="animal-friend" icon={["upgrade","armor-upgrade"]}>
...
<Ability id="natures-speaker" icon={["upgrade","magic-swirl"]}>
<Pair single id="natures-speaker">Nature's Speaker</Pair>
...
<Ability id="soothing-performance" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="soothing-performance">Soothing Performance</Pair>
...
<Ability id="attract-rats" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="attract-rats">Attract Rats</Pair>
...
<Ability id="summon-natures-ally" icon={["spell-book"]}>
<Pair single id="summon-natures-ally">Summon Nature's Ally</Pair>
...
<Ability id="arcane-strike" icon={["stairs-goal"]}>
<Pair single id="arcane-strike">Arcane Strike</Pair>
...
<Ability id="rallying-cry-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="rallying-cry-su" flavor="An arcane duelist can use performance to rally dispirited allies.">Rallying Cry (Su)</Pair>
...
<Ability id="bladethirst-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="bladethirst-su">Bladethirst (Su)</Pair>
<Pair hl title="Replaces">Suggestion</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="mass-bladethirst-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="mass-bladethirst-su">Mass Bladethirst (Su)</Pair>
<Pair hl title="Replaces">Mass suggestion</Pair>
...
<Pair single id="bonus-feats" flavor="An arcane duelist weaves might and magic in his combat style.">Bonus Feats</Pair>
...
<Ability id="arcane-armor-ex" icon={["armor-upgrade","stairs-goal"]}>
<Pair single id="arcane-armor-ex">Arcane Armor (Ex)</Pair>
...
<Ability id="channel-energy-su" icon={["stairs-goal","aura"]}>
...
<Ability id="inspiring-healing-sp" icon={["magic-swirl"]}>
<Pair single id="inspiring-healing-sp" flavor="An arcane healer gains the ability to expend rounds of his bardic performance to provide extra healing to his allies.">Inspiring Healing (Sp)</Pair>
...
<Ability id="bardic-performance" icon={["broken-shield"]}>
<Pair single id="bardic-performance">Bardic Performance</Pair>
<Pair title="Info">Archaeologists do not gain the <em>bardic performance</em> ability or any of its performance types.</Pair>
</Ability>
<Ability id="archaeologists-luck-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="archaeologists-luck-ex" flavor="Fortune favors the archaeologist.">Archaeologist's Luck (Ex)</Pair>
...
<Ability id="clever-explorer-ex" icon={["upgrade"]}>
<Pair single id="clever-explorer-ex">Clever Explorer (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="advanced-talent" icon={["upgrade"]}>
...
<Ability id="naturalist-ex" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="naturalist-ex">Naturalist (Ex)</Pair>
...
<Ability id="lamentable-belaborment-ex" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="lamentable-belaborment-ex">Lamentable Belaborment (Ex)</Pair>
<Pair hl title="Replaces">Suggestion</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="pedantic-lecture-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="pedantic-lecture-su">Pedantic Lecture (Su)</Pair>
<Pair hl title="Replaces">Mass suggestion</Pair>
<Pair title="Gained">At 18th Level</Pair>
...
<Ability id="lore-master-ex" icon={["upgrade"]}>
...
<Ability id="magic-lore-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="magic-lore-ex">Magic Lore (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
...
<Ability id="jack-of-all-trades-ex" icon={["stairs-goal"]}>
...
<Ability id="probable-path-ex" icon={["rolling-dices"]}>
<Pair single id="probable-path-ex" flavor="An archivist can calculate the action likely to bring success with the least risk">Probable Path (Ex)</Pair>
<Pair hl title="Replaces">Jack of all trades</Pair>
...
<Ability id="limning-verse-su" extraClasses="subAbility" icon={["armor-downgrade","aura"]}>
<Pair single id="limning-verse-su">Limning Verse (Su)</Pair>
<Pair hl title="Replaces">Fascinate</Pair>
...
<Ability id="shattering-crescendo-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="shattering-crescendo-sp" flavor="The argent voice learns to sing at frequencies capable of shattering magical effects.">Shattering Crescendo (Sp)</Pair>
...
<Ability id="devilbane-refrain-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="devilbane-refrain-su" flavor="The argent voice learns how to mimic aspects of the magical &quot;Song of Silver&quot; with his performance, enhancing his allies' ability to combat devils and similar fiends.">Devilbane Refrain (Su)</Pair>
...
<Ability id="dedicated-performance-ex" icon={["upgrade"]}>
<Pair single id="dedicated-performance-ex" flavor="An argent voice can call upon the training of the Chelish opera to influence and scrutinize his foes.">Dedicated Performance (Ex)</Pair>
...
<Ability id="weapon-proficiency" icon={["bowman","broken-shield"]}>
...
<Ability id="arcane-archery" icon={["spell-book","upgrade"]}>
<Pair single id="arcane-archery" flavor="An Arrowsong minstrel's skill at ranged martial arts allows her to learn to cast a number of powerful, offensive spells that would otherwise be unavailable to her.">Arcane Archery</Pair>
...
<Ability id="precise-minstrel-ex" icon={["stairs-goal","armor-downgrade"]}>
<Pair single id="precise-minstrel-ex">Precise Minstrel (Ex)</Pair>
...
<Ability id="arrowsong-strike-su" icon={["magic-swirl","bowman"]}>
<Pair single id="arrowsong-strike-su">Arrowsong Strike (Su)</Pair>
<Pair hl title="Replaces">Suggestion, mass suggestion</Pair>
...
<Ability id="inspire-teamwork-ex" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="inspire-teamwork-ex">Inspire Teamwork (Ex)</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="ritual-of-reconciliation-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="ritual-of-reconciliation-su">Ritual of Reconciliation (Su)</Pair>
...
<Ability id="versatile-teamwork-ex" icon={["stairs-goal"]}>
<Pair single id="versatile-teamwork-ex">Versatile Teamwork (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance, well-versed</Pair>
...
<Ability id="deceptive-tale-su" icon={["upgrade"]}>
<Pair single id="deceptive-tale-su">Deceptive Tale (Su)</Pair>
...
<Ability id="shameless-scoundrel-ex" icon={["upgrade"]}>
<Pair single id="shameless-scoundrel-ex">Shameless Scoundrel (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="blatant-subtlety-ex" icon={["armor-upgrade"]}>
<Pair single id="blatant-subtlety-ex">Blatant Subtlety (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
...
<Ability id="invoke-vyriavaxus-ex" icon={["spell-book"]}>
<Pair single id="invoke-vyriavaxus-ex">Invoke Vyriavaxus (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
...
<Ability id="hilt-bash-ex" icon={["stairs-goal"]}>
<Pair single id="hilt-bash-ex" flavor="A buccaneer develops the ability to fight with the hilts and flats of his weapons, aiming to leave his victims alive.">Hilt Bash (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="song-of-surrender-su" icon={["armor-downgrade"]}>
<Pair single id="song-of-surrender-su">Song of Surrender (Su)</Pair>
<Pair hl title="Replaces">Suggestion</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="knock-out-ex" icon={["stairs-goal"]}>
<Pair single id="knock-out-ex" flavor="A buccaneer may focus his blows in an attempt to knock out an opponent.">Knock Out (Ex)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="mass-song-of-surrender-su" icon={["upgrade"]}>
<Pair single id="mass-song-of-surrender-su">Mass Song of Surrender (Su)</Pair>
<Pair hl title="Replaces">Mass suggestion</Pair>
...
<Ability id="busker-stunts-su" extraClasses="hasSubs" icon={["upgrade"]}>
<Pair single id="busker-stunts-su">Busker Stunts (Su)</Pair>
<Pair title="Usage">4 + Cha modifier rounds/day</Pair>
...
<Ability id="quick-hands-su" extraClasses="subAbility" icon={["upgrade","armor-upgrade"]}>
<Pair single id="quick-hands-su">Quick Hands (Su)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="patter-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="patter-su">Patter (Su)</Pair>
...
<Ability id="living-statue-su" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="living-statue-su">Living Statue (Su)</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="fascinate-su" extraClasses="subAbility" icon={["stairs-goal"]}>
...
<Ability id="suggestion-sp" extraClasses="subAbility" icon={["stairs-goal"]}>
...
<Ability id="inventive-juggler-ex" extraClasses="subAbility" icon={["mailed-fist"]}>
<Pair single id="inventive-juggler-ex" flavor="A busker masters unconventionally dangerous juggling techniques.">Inventive Juggler (Ex)</Pair>
...
<Ability id="impossible-sleight-of-hand-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="impossible-sleight-of-hand-su">Impossible Sleight of Hand (Su)</Pair>
...
<Ability id="flexible-performer-ex" icon={["stairs-goal"]}>
<Pair single id="flexible-performer-ex">Flexible Performer (Ex)</Pair>
...
<Ability id="famous" icon={["upgrade"]}>
<Pair single id="famous">Famous</Pair>
<Pair hl title="Replaces">Inspire courage</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="gather-crowd-ex" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="gather-crowd-ex">Gather Crowd (Ex)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="shining-star-su" icon={["upgrade"]}>
<Pair single id="shining-star-su">Shining Star (Su)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="prima-donna-ex" icon={["upgrade","armor-downgrade"]}>
<Pair single id="prima-donna-ex">Prima Donna (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="costume-proficiency-ex" icon={["armor-upgrade"]}>
<Pair single id="costume-proficiency-ex">Costume Proficiency (Ex)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
...
<Ability id="devastating-aria-su" extraClasses="subAbility" icon={["smoking-finger"]}>
<Pair single id="devastating-aria-su">Devastating Aria (Su)</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-bard-chronicler_of_worlds--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Must have an alignment with at least one neutral component</td></tr></tbody></table></ScrollContainer></div><Ability id="wanderers-insight" icon={["info"]}>
<Pair single id="wanderers-insight">Wanderer's Insight</Pair>
<Pair title="Info">A chronicler of worlds gains power not from her personality but from an analytical understanding of existence. She uses Intelligence instead of Charisma to determine the effects of bard class features, including spellcasting and bardic performance.</Pair>
</Ability>
<Ability id="planar-lore-ex" icon={["stairs-goal"]}>
<Pair single id="planar-lore-ex">Planar Lore (Ex)</Pair>
...
<Ability id="quintessence-infusion-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="quintessence-infusion-su" flavor="This performance infuses allies with planar quintessence.">Quintessence Infusion (Su)</Pair>
...
<Ability id="mantra-of-tabris-su" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="mantra-of-tabris-su" flavor="Tabris survived his travels through the darkest realms, his dedication to the pursuit of knowledge a shield against planar horrors. The chronicler of worlds walks in his footsteps.">Mantra of Tabris (Su)</Pair>
...
<Ability id="amoral-scholar-ex" icon={["armor-upgrade"]}>
<Pair single id="amoral-scholar-ex">Amoral Scholar (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="scriveners-versatility-ex" icon={["upgrade"]}>
<Pair single id="scriveners-versatility-ex" flavor="A chronicler of worlds seeks to emulate history's greatest scribe; studying the lore of Tabris grants insight into widely varying subjects, from anatomy to discourse.">Scrivener's Versatility (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="satire-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="satire-su">Satire (Su)</Pair>
<Pair hl title="Replaces">Inspire courage</Pair>
...
<Ability id="mockery-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="mockery-su" flavor="A court bard can subtly ridicule and defame a specific individual.">Mockery (Su)</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="glorious-epic-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="glorious-epic-su" flavor="A court bard can weave captivating tales that engross those who hear them.">Glorious Epic (Su)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="scandal-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="scandal-su" flavor="A court bard can combine salacious gossip and biting calumny to incite a riot.">Scandal (Su)</Pair>
...
<Ability id="heraldic-expertise-ex" icon={["upgrade","rolling-dices"]}>
<Pair single id="heraldic-expertise-ex">Heraldic Expertise (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="wide-audience-su" icon={["tornado-discs","upgrade"]}>
<Pair single id="wide-audience-su">Wide Audience (Su)</Pair>
...
<Ability id="buffoonery-ex" icon={["upgrade"]}>
<Pair single id="buffoonery-ex">Buffoonery (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="distracting-motley-su" extraClasses="subAbility" icon={["armor-upgrade","shield-reflect"]}>
<Pair single id="distracting-motley-su">Distracting Motley (Su)</Pair>
<Pair hl title="Replaces">Countersong</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="defuse-tension-su" extraClasses="subAbility" icon={["remedy"]}>
<Pair single id="defuse-tension-su">Defuse Tension (Su)</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="caper-and-jeer-ex" icon={["upgrade"]}>
<Pair single id="caper-and-jeer-ex">Caper and Jeer (Ex)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="verdant-voice" icon={["stairs-goal"]}>
<Pair single id="verdant-voice">Verdant Voice</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="song-of-growth-su" icon={["armor-upgrade","shield-reflect"]}>
<Pair single id="song-of-growth-su" flavor="A cultivator can spontaneously promote massive plant growth with his bardic performance.">Song of Growth (Su)</Pair>
<Pair hl title="Replaces">Countersong</Pair>
...
<Ability id="resist-natures-lure-ex" icon={["stairs-goal","armor-upgrade"]}>
...
<Ability id="nature-lore-ex" icon={["stairs-goal","broken-shield"]}>
<Pair single id="nature-lore-ex">Nature Lore (Ex)</Pair>
...
<Ability id="agile-ex" icon={["upgrade"]}>
<Pair single id="agile-ex">Agile (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="derring-do-su" extraClasses="subAbility" icon={["armor-upgrade","shield-reflect","upgrade"]}>
<Pair single id="derring-do-su" flavor="A daredevil can use her performance to bring out grace in the clumsiest allies.">Derring-do (Su)</Pair>
<Pair hl title="Replaces">Inspire courage</Pair>
...
<Ability id="canny-foe-ex" icon={["mailed-fist","armor-upgrade"]}>
<Pair single id="canny-foe-ex">Canny Foe (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="dauntless-ex" icon={["armor-upgrade"]}>
<Pair single id="dauntless-ex">Dauntless (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="scoundrels-fortune-ex" icon={["rolling-dices"]}>
<Pair single id="scoundrels-fortune-ex">Scoundrel's Fortune (Ex)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="dervish-dance-ex" icon={["stairs-goal"]}>
...
<Ability id="spinning-spellcaster-ex" icon={["armor-upgrade"]}>
<Pair single id="spinning-spellcaster-ex">Spinning Spellcaster (Ex)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="meditative-whirl-ex" icon={["magic-swirl","remedy"]}>
<Pair single id="meditative-whirl-ex" flavor="When using battle dance, the Dawnflower dervish can enter a trance-like state where his spinning motion represents the movement of the planets around the sun, and his spirit is attuned to the healing aspects of Sarenrae.">Meditative Whirl (Ex)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="incite-violence-ex" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="incite-violence-ex">Incite Violence (Ex)</Pair>
<Pair hl title="Replaces">Suggestion</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="righteous-cause-ex" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="righteous-cause-ex">Righteous Cause (Ex)</Pair>
<Pair hl title="Replaces">Mass suggestion</Pair>
<Pair title="Gained">At 18th Level</Pair>
...
<Ability id="rain-of-blows-su" extraClasses="subAbility" icon={["upgrade","armor-upgrade"]}>
<Pair single id="rain-of-blows-su">Rain of Blows (Su)</Pair>
<Pair hl title="Replaces">Suggestion, mass suggestion</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="razors-kiss-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="razors-kiss-su">Razor's Kiss (Su)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="leaf-on-the-wind-su" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="leaf-on-the-wind-su">Leaf on the Wind (Su)</Pair>
...
<Ability id="fleet-su" icon={["upgrade"]}>
<Pair single id="fleet-su">Fleet (Su)</Pair>
...
<Ability id="versatile-dance-ex" icon={["upgrade"]}>
<Pair single id="versatile-dance-ex">Versatile Dance (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="dance-of-fury-su" icon={["mailed-fist","upgrade"]}>
<Pair single id="dance-of-fury-su">Dance of Fury (Su)</Pair>
...
<Ability id="battle-fury-su" icon={["mailed-fist","upgrade"]}>
<Pair single id="battle-fury-su" flavor={<>The dervish dancer can unleash a whirlwind of blows while performing a <em>battle dance.</em></>}>Battle Fury (Su)</Pair>
...
<Ability id="careful-teamwork-su" extraClasses="subAbility" icon={["upgrade","armor-upgrade"]}>
<Pair single id="careful-teamwork-su">Careful Teamwork (Su)</Pair>
<Pair hl title="Replaces">Inspire courage</Pair>
...
<Ability id="true-confession-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="true-confession-su">True Confession (Su)</Pair>
<Pair hl title="Replaces">Inspire greatness</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="show-yourselves-ex" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="show-yourselves-ex">Show Yourselves (Ex)</Pair>
<Pair hl title="Replaces">Inspire heroics</Pair>
<Pair title="Gained">At 15th Level</Pair>
...
<Ability id="eye-for-detail-ex" icon={["upgrade"]}>
<Pair single id="eye-for-detail-ex">Eye for Detail (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="arcane-insight-ex" icon={["stairs-goal","armor-upgrade"]}>
<Pair single id="arcane-insight-ex">Arcane Insight (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="arcane-investigation" icon={["spell-book"]}>
<Pair single id="arcane-investigation">Arcane Investigation</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
...
<Ability id="dance-of-the-dead-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="dance-of-the-dead-su">Dance of the Dead (Su)</Pair>
<Pair hl title="Replaces">Jack-of-all-trades</Pair>
...
<Ability id="haunted-eyes-ex" icon={["armor-upgrade"]}>
<Pair single id="haunted-eyes-ex">Haunted Eyes (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="secrets-of-the-grave-ex" icon={["upgrade"]}>
<Pair single id="secrets-of-the-grave-ex">Secrets of the Grave (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="haunting-refrain-su" icon={["armor-downgrade"]}>
<Pair single id="haunting-refrain-su">Haunting Refrain (Su)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="venomous-whispers-su" icon={["armor-downgrade"]}>
<Pair single id="venomous-whispers-su">Venomous Whispers (Su)</Pair>
<Pair hl title="Replaces">Inspire greatness</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="serpent-of-the-mind-su" icon={["spell-book"]}>
<Pair single id="serpent-of-the-mind-su">Serpent of the Mind (Su)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
...
<Ability id="dragon-patron-ex" icon={["info"]}>
<Pair single id="dragon-patron-ex">Dragon Patron (Ex)</Pair>
...
<Ability id="coat-of-arms-ex" icon={["armor-upgrade"]}>
<Pair single id="coat-of-arms-ex">Coat of Arms (Ex)</Pair>
...
<Ability id="dragon-voice-ex" icon={["upgrade","stairs-goal"]}>
<Pair single id="dragon-voice-ex">Dragon Voice (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="diplomatic-immunity-su" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="diplomatic-immunity-su">Diplomatic Immunity (Su)</Pair>
...
<Ability id="diplomatic-protection-su" extraClasses="subAbility" icon={["shield-reflect"]}>
<Pair single id="diplomatic-protection-su">Diplomatic Protection (Su)</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="rebuke-foes-su" extraClasses="subAbility" icon={["smoking-finger"]}>
<Pair single id="rebuke-foes-su">Rebuke Foes (Su)</Pair>
<Pair hl title="Replaces">Soothing performance</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="retreat-to-lair-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="retreat-to-lair-sp">Retreat to Lair (Sp)</Pair>
<Pair hl title="Replaces">Inspire heroics</Pair>
<Pair title="Gained">At 15th Level</Pair>
...
<Ability id="master-of-persuasion-ex" icon={["upgrade"]}>
<Pair single id="master-of-persuasion-ex">Master of Persuasion (Ex)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="extol-glory-su" icon={["stairs-goal"]}>
<Pair single id="extol-glory-su">Extol Glory (Su)</Pair>
<Pair hl title="Replaces">Jack-of-all-trades</Pair>
...
<Ability id="yapping-song-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="yapping-song-su">Yapping Song (Su)</Pair>
<Pair hl title="Replaces">Fascinate</Pair>
...
<Ability id="frightful-song-su" extraClasses="subAbility" icon={["armor-downgrade","aura"]}>
<Pair single id="frightful-song-su">Frightful Song (Su)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="versatile-performance-ex" icon={["info"]}>
...
<Ability id="diminished-competency" icon={["broken-shield"]}>
<Pair single id="diminished-competency">Diminished Competency</Pair>
...
<Ability id="versatile-familiar-ex" icon={["upgrade"]}>
<Pair single id="versatile-familiar-ex" flavor="A duettist's familiar learns to use performance to supplement its skills.">Versatile Familiar (Ex)</Pair>
<Pair hl title="Alters">Versatile performance</Pair>
<Pair title="At 2nd Level">A duettist's familiar benefits from its master's <em>versatile performance</em> class feature.</Pair>
</Ability>
<Ability id="performing-familiar-su" icon={["stairs-goal"]}>
<Pair single id="performing-familiar-su" flavor="A duettist's familiar learns how to create supernatural effects with its performances, just like its master.">Performing Familiar (Su)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
...
<Ability id="harmonizing-familiar-su" icon={["upgrade"]}>
<Pair single id="harmonizing-familiar-su" flavor="The duettist and his familiar have learned how to perform together in harmony.">Harmonizing Familiar (Su)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
...
<Ability id="symphonic-familiar-su" icon={["stairs-goal"]}>
<Pair single id="symphonic-familiar-su" flavor="The duettist and his familiar have learned how to create a symphony of complementary performances that meld together to produce two different effects.">Symphonic Familiar (Su)</Pair>
<Pair hl title="Replaces">Frightening tune</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-bard-dwarven_scholar--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>This archetype appears to be intended for <Link to="/race/dwarves">dwarves</Link> only, but that limitation is never explicitly stated.</td></tr></tbody></table></ScrollContainer></div><Ability id="weapon-and-armor-proficiency" icon={["stairs-goal","broken-shield"]}>
<Pair single id="weapon-and-armor-proficiency">Weapon and Armor Proficiency</Pair>
...
<Ability id="studied-insight-ex" icon={["info"]}>
<Pair single id="studied-insight-ex">Studied Insight (Ex)</Pair>
...
<Ability id="dwarven-training-ex" icon={["stairs-goal"]}>
<Pair single id="dwarven-training-ex">Dwarven Training (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
...
<Ability id="war-chant-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="war-chant-su">War Chant (Su)</Pair>
...
<Ability id="devout-spell-knowledge-su" icon={["stairs-goal","magic-swirl"]}>
<Pair single id="devout-spell-knowledge-su">Devout Spell Knowledge (Su)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
...
<Ability id="scorn-of-the-wilds-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="scorn-of-the-wilds-sp">Scorn of the Wilds (Sp)</Pair>
<Pair hl title="Replaces">Dirge of doom, frightening tune</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="stone-dance-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="stone-dance-sp">Stone Dance (Sp)</Pair>
<Pair hl title="Replaces">Inspire heroics</Pair>
<Pair title="Gained">At 15th Level</Pair>
...
<Ability id="fey-contacts" icon={["stairs-goal","upgrade"]}>
<Pair single id="fey-contacts">Fey Contacts</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="summon-fey-allies" icon={["spell-book","stairs-goal"]}>
<Pair single id="summon-fey-allies">Summon Fey Allies</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="mischievous-talent-ex" icon={["upgrade","stairs-goal"]}>
<Pair single id="mischievous-talent-ex">Mischievous Talent (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="song-of-clumsiness-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="song-of-clumsiness-su">Song of Clumsiness (Su)</Pair>
<Pair hl title="Replaces">Countersong</Pair>
...
<Ability id="incite-unreliability-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="incite-unreliability-su">Incite Unreliability (Su)</Pair>
<Pair hl title="Replaces">Inspire courage</Pair>
...
<Ability id="embarrassing-satire-su" extraClasses="subAbility" icon={["smoking-finger"]}>
<Pair single id="embarrassing-satire-su">Embarrassing Satire (Su)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="dirty-trickster-ex" icon={["stairs-goal"]}>
<Pair single id="dirty-trickster-ex">Dirty Trickster (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="master-of-mischief-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="master-of-mischief-ex">Master of Mischief (Ex)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
<Pair title="Gained">At 5th Level</Pair>
<Pair title="Usage">1 time/day + 1 per six bard levels beyond 5th<ByLevelPop levels={[[5,1],[11,2],[17,3]]} unit="time" postText="/day" /></Pair>
...
<Ability id="armor-and-weapon-proficiency" icon={["broken-shield"]}>
<Pair single id="armor-and-weapon-proficiency">Armor and Weapon Proficiency</Pair>
...
<Ability id="natural-magic" icon={["magic-swirl"]}>
...
<Ability id="natures-song" icon={["magic-swirl"]}>
<Pair single id="natures-song">Nature's Song</Pair>
...
<Ability id="echoes-of-natures-song-su" extraClasses="subAbility" icon={["shield-reflect"]}>
<Pair single id="echoes-of-natures-song-su">Echoes of Nature's Song (Su)</Pair>
<Pair hl title="Replaces">Inspire courage</Pair>
...
<Ability id="divinatory-song-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="divinatory-song-sp">Divinatory Song (Sp)</Pair>
<Pair hl title="Replaces">Suggestion</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="voices-of-life-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="voices-of-life-su">Voices of Life (Su)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="unity-of-life-su" extraClasses="subAbility" icon={["magic-swirl","shield-reflect"]}>
<Pair single id="unity-of-life-su">Unity of Life (Su)</Pair>
<Pair hl title="Replaces">Inspire heroics</Pair>
<Pair title="Gained">At 15th Level</Pair>
...
<Ability id="song-of-the-cycle-su" extraClasses="subAbility" icon={["shield-reflect"]}>
<Pair single id="song-of-the-cycle-su">Song of the Cycle (Su)</Pair>
<Pair hl title="Replaces">Deadly performance</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="fey-magic" icon={["spell-book"]}>
<Pair single id="fey-magic">Fey Magic</Pair>
...
<Ability id="echoes-of-the-first-world-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="echoes-of-the-first-world-su">Echoes of the First World (Su)</Pair>
<Pair hl title="Replaces">Inspire courage</Pair>
...
<Ability id="gremlins-luck-su" extraClasses="subAbility" icon={["armor-downgrade","rolling-dices"]}>
<Pair single id="gremlins-luck-su">Gremlin's Luck (Su)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
...
<Ability id="fire-dance-su" extraClasses="subAbility" icon={["armor-upgrade","shield-reflect"]}>
<Pair single id="fire-dance-su" flavor="A fire dancer learns to protect himself and others from the pain of fire, and discovers how to control the flame while enduring its heat.">Fire Dance (Su)</Pair>
<Pair hl title="Replaces">Countersong</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="fan-the-flames-su" icon={["spell-book"]}>
<Pair single id="fan-the-flames-su">Fan the Flames (Su)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="fire-music" icon={["stairs-goal","spell-book"]}>
<Pair single id="fire-music">Fire Music</Pair>
<Pair hl title="Replaces">Bardic knowledge, lore master</Pair>
...
<Ability id="blazing-blades-su" extraClasses="subAbility" icon={["upgrade","magic-swirl"]}>
<Pair single id="blazing-blades-su">Blazing Blades (Su)</Pair>
<Pair hl title="Replaces">Inspire courage</Pair>
...
<Ability id="wildfire-ex" icon={["upgrade"]}>
<Pair single id="wildfire-ex" flavor="Like a raging wildfire, a flamesinger moves with blistering speed.">Wildfire (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
...
<Ability id="fortune-tellers-divinations" icon={["spell-book"]}>
<Pair single id="fortune-tellers-divinations">Fortune-Teller's Divinations</Pair>
<Pair hl title="Alters">Spell list</Pair>
...
<Ability id="fortune-tellers-acumen" icon={["magic-swirl"]}>
<Pair single id="fortune-tellers-acumen">Fortune-Teller's Acumen</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
