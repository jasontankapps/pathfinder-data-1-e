...
<Ability id="extra-channel" icon={["power"]}>
...
<Ability id="channel-angelfire-su" icon={["info","boost"]}>
...
<Ability id="versatile-healing-channel-sp" icon={["magic"]}>
...
<Ability id="cleansing-flames-su" icon={["magic"]}>
...
<Ability id="channel-utility-su" icon={["power"]}>
...
<Ability id="divine-apologist-ex" icon={["info","down"]}>
...
<Ability id="mollified-domain-su" icon={["down","power"]}>
...
<Ability id="pact-bound-ex" icon={["info","down","warning"]}>
...
<Ability id="serpent-su" icon={["power"]}>
...
<Ability id="devil-in-the-details-ex" icon={["power","boost"]}>
...
<Ability id="shoulder-devil-su" icon={["power"]}>
...
<Ability id="promise-of-faith" icon={["down"]}>
...
<Ability id="promise-of-purity" icon={["info","warning"]}>
...
<Ability id="luminous-font-su" icon={["down","boost","magic"]}>
...
<Ability id="political-skill" icon={["skill","boost","down"]}>
...
<Ability id="spells" icon={["down","learn"]}>
...
<Ability id="unknown-aura-su" icon={["def"]}>
...
<Ability id="channel-entropy-su" icon={["power"]}>
...
<Ability id="power-of-the-unknown" icon={["down","boost"]}>
...
<Ability id="spontaneous-casting" icon={["down","magic"]}>
...
<Ability id="breadth-of-knowledge" icon={["boost","power"]}>
...
<Ability id="well-read-ex" icon={["boost","def"]}>
...
<Ability id="verbal-instruction-ex" icon={["boost"]}>
...
<Ability id="scribe-scroll-su" icon={["power"]}>
...
<Ability id="balanced-channel-su" icon={["aura","zap","aid"]}>
...
<Ability id="spontaneous-casting" icon={["down","learn"]}>
<Pair single id="spontaneous-casting">Spontaneous Casting</Pair>
<Pair hl title="Alters">Spontaneous casting</Pair>
...
<Ability id="legions-blessing-su" icon={["magic","power"]}>
...
<Ability id="demonic-familiar" icon={["power"]}>
...
<Ability id="demonic-channel-su" icon={["power","aura"]}>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-cleric-divine_paragon--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>A divine paragon is intensely devoted to a single deity, and her alignment must be identical to her deity's alignment.</td></tr></tbody></table></ScrollContainer></div><Ability id="devoted-domain" icon={["power","boost","warning"]}>
...
<Ability id="divine-brand-ex" icon={["power","aura"]}>
...
<Ability id="curser-ex" icon={["info","down"]}>
...
<Ability id="divine-hexes" icon={["power"]}>
...
<Ability id="blessing-of-the-faithful-su" icon={["boost","def"]}>
...
<Ability id="domain-mastery" icon={["power","magic"]}>
...
<Ability id="bonded-holy-symbol-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="domain" icon={["info","down"]}>
...
<Ability id="forbidden-knowledge-ex" icon={["boost","power"]}>
...
<Ability id="unhinged-mind-ex" icon={["magic","down"]}>
...
<Ability id="maddening-gaze-su" icon={["zap"]}>
...
<Ability id="single-minded" icon={["down"]}>
...
<Ability id="public-speaker" icon={["skill","boost"]}>
...
<Ability id="sermonic-performance" icon={["power"]}>
...
<Ability id="fiendish-familiar" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="fiendish-augury-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="fiendish-divination-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="extra-divination-sp" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="fiendish-summoning" icon={["down"]}>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-cleric-forgemaster--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><ul><li><Link to="/race/dwarf">Dwarf</Link></li><li>Worships a deity that grants the <Link to="/domain/artifice">Artifice</Link> domain</li></ul></td></tr></tbody></table></ScrollContainer></div><Ability id="artificer" icon={["down"]}>
...
<Ability id="steel-spells" icon={["learn"]}>
...
<Ability id="divine-smith-su" icon={["boost"]}>
...
<Ability id="runeforger-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="ancient-splendor" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="bloodthirst42" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="deathstrike" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="durability" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="featherlight" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="forgemasters-blessing" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="ghostglyph42" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="glowglyph" extraClasses="subAbility" icon={["power","aura"]}>
...
<Ability id="invulnerability42" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="powerstrike42" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="return42" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="spellguard" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="spellglyph42" extraClasses="subAbility" icon={["def","magic"]}>
...
<Ability id="thief-curse" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="tracer" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="channel-energy" icon={["down"]}>
...
<Ability id="bastion-ex" icon={["def"]}>
...
<Ability id="granite-focus-ex" icon={["def"]}>
...
<Ability id="rooted-vitality-su" icon={["aid"]}>
...
<Ability id="dedicated-summoner" icon={["down"]}>
...
<Ability id="mighty-heralds" icon={["power"]}>
...
<Ability id="false-arcanist-ex" icon={["boost"]}>
...
<Ability id="unseen-devotion-su" icon={["power"]}>
...
<Ability id="planar-bond-su" extraClasses="hasSubs" icon={["magic"]}>
...
<Ability id="abaddon" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="abyss" extraClasses="subAbility" icon={["learn"]}>
<Pair single id="abyss">Abyss</Pair>
<Pair plain title="1st"><Link to="/spell/doom">Doom</Link></Pair>
<Pair plain title="4th"><Link to="/spell/unholy_blight">Unholy blight</Link></Pair>
<Pair plain title="7th"><Link to="/spell/blasphemy">Blasphemy</Link></Pair>
</Ability>
<Ability id="astral" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="axis" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="boneyard" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="elysium" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="ethereal" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="first-world" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="heaven" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="hell" extraClasses="subAbility" icon={["learn"]}>
<Pair single id="hell">Hell</Pair>
<Pair plain title="1st"><Link to="/spell/command">Command</Link></Pair>
<Pair plain title="4th"><Link to="/spell/tongues">Tongues</Link></Pair>
<Pair plain title="7th"><Link to="/spell/dictum">Dictum</Link></Pair>
</Ability>
<Ability id="maelstrom" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="nirvana" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="plane-of-air" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="plane-of-earth" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="plane-of-fire" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="plane-of-water" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="shadow-plane" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="other" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="invoke-realm-su" icon={["magic"]}>
...
<Ability id="channel-energy-su" icon={["magic"]}>
...
<Ability id="circumvent-obfuscation-sp" icon={["magic"]}>
...
<Ability id="demonic-knowledge-ex" icon={["boost"]}>
...
<Ability id="willing-healer" icon={["down"]}>
...
<Ability id="channel-energy-su" icon={["power"]}>
<Pair single id="channel-energy-su">Channel Energy (Su)</Pair>
<Pair hl title="Replaces">Channel energy</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="combat-medic-ex" icon={["def"]}>
...
<Ability id="merciful-healing-su" icon={["power","aid"]}>
...
<Ability id="true-healer-su" icon={["power","roll"]}>
...
<Ability id="dedicated-wanderer" icon={["down"]}>
...
<Ability id="unseen-revealed-ex" icon={["boost"]}>
...
<Ability id="curse-seeker-su" icon={["boost"]}>
...
<Ability id="dispossession-su" icon={["power"]}>
...
<Ability id="curse-eater-su" icon={["power","boost","def"]}>
...
<Ability id="channel-beauty-su" icon={["power"]}>
...
<Ability id="nurture-grace-su" icon={["boost"]}>
...
<Ability id="inspiring-camaraderie-sp" icon={["boost"]}>
...
<Ability id="diligent-student-ex" icon={["skill","boost"]}>
...
<Ability id="secrets-revealed-sp" icon={["power","magic"]}>
...
<Ability id="flash-of-insight-su" icon={["boost","def"]}>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-cleric-separatist--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Must worship a deity.</td></tr></tbody></table></ScrollContainer></div><Ability id="weapon-and-armor-proficiency" icon={["down"]}>
<Pair single id="weapon-and-armor-proficiency">Weapon and Armor Proficiency</Pair>
...
<Ability id="forbidden-rites" icon={["down","power"]}>
...
<Ability id="midwife-training-su" icon={["boost","def"]}>
...
<Ability id="fated-cures-su" icon={["lower","roll"]}>
...
<Ability id="three-aspect-channel-su" icon={["power"]}>
...
<Ability id="focused-domain" icon={["down","boost","magic"]}>
...
<Ability id="domain-secret-ex" icon={["boost","magic"]}>
...
<Ability id="triadic-bond-su" icon={["power"]}>
...
<Ability id="bonded-domain-su" extraClasses="hasSubs" icon={["down"]}>
...
<Ability id="bonded-power-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="bonded-unity-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="bonded-ritual" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="corpse-companion-su" icon={["power"]}>
...
<Ability id="unlife-healer-su" icon={["aid"]}>
...
<Ability id="fortunate-road" icon={["power"]}>
...
<Ability id="caravan-bond-su" icon={["power"]}>
...
<Ability id="blessing-of-the-harrow-su" icon={["power"]}>
