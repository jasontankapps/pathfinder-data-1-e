...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-cleric-angelfire_apostle--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>An angelfire apostle must be of good or neutral alignment.</td></tr></tbody></table></ScrollContainer></div><Ability id="armor-proficiency" icon={["broken-shield"]}>
...
<Pair single id="diminished-spellcasting" flavor="An angelfire apostle is less concerned with the traditional divine magic that many religious adherents receive.">Diminished Spellcasting</Pair>
...
<Ability id="extra-channel" icon={["stairs-goal"]}>
<Pair single id="extra-channel">Extra Channel</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Ability">The angelfire apostle gains <Link to="/feat/extra_channel">Extra Channel</Link> as a bonus feat.</Pair>
</Ability>
<Ability id="channel-angelfire-su" icon={["info","upgrade"]}>
<Pair single id="channel-angelfire-su">Channel Angelfire (Su)</Pair>
...
<Ability id="versatile-healing-channel-sp" icon={["magic-swirl"]}>
<Pair single id="versatile-healing-channel-sp">Versatile Healing Channel (Sp)</Pair>
...
<Ability id="cleansing-flames-su" icon={["magic-swirl"]}>
<Pair single id="cleansing-flames-su" flavor="The angelfire apostle becomes a direct conduit for the righteous power of his deity.">Cleansing Flames (Su)</Pair>
...
<Ability id="channel-utility-su" icon={["stairs-goal"]}>
<Pair single id="channel-utility-su">Channel Utility (Su)</Pair>
<Pair hl title="Alters">Channel energy</Pair>
...
<Ability id="divine-apologist-ex" icon={["info","broken-shield"]}>
<Pair single id="divine-apologist-ex">Divine Apologist (Ex)</Pair>
...
<Ability id="mollified-domain-su" icon={["broken-shield","stairs-goal"]}>
<Pair single id="mollified-domain-su">Mollified Domain (Su)</Pair>
...
<Ability id="pact-bound-ex" icon={["info","broken-shield","hazard-sign"]}>
<Pair single id="pact-bound-ex">Pact-Bound (Ex)</Pair>
<Pair hl title="Alters">Domains</Pair>
...
<Ability id="serpent-su" icon={["stairs-goal"]}>
<Pair single id="serpent-su">Serpent (Su)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="devil-in-the-details-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="devil-in-the-details-ex">Devil in the Details (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="shoulder-devil-su" icon={["stairs-goal"]}>
<Pair single id="shoulder-devil-su">Shoulder Devil (Su)</Pair>
...
<Ability id="promise-of-faith" icon={["broken-shield"]}>
<Pair single id="promise-of-faith">Promise of Faith</Pair>
...
<Ability id="promise-of-purity" icon={["info","hazard-sign"]}>
<Pair single id="promise-of-purity">Promise of Purity</Pair>
...
<Ability id="luminous-font-su" icon={["broken-shield","upgrade","magic-swirl"]}>
<Pair single id="luminous-font-su" flavor="A blossoming light forsakes her deity's deeper mysteries to focus on benevolence, healing, and bringing light to darkness.">Luminous Font (Su)</Pair>
...
<Ability id="political-skill" icon={["skills","upgrade","broken-shield"]}>
<Pair single id="political-skill">Political Skill</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-cleric-channeler_of_the_unknown--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Ex-cleric</td></tr></tbody></table></ScrollContainer></div><Ability id="weaponarmor-proficiency" icon={["broken-shield","stairs-goal"]}>
<Pair single id="weaponarmor-proficiency">Weapon/Armor Proficiency</Pair>
...
<Ability id="spells" icon={["broken-shield","spell-book"]}>
...
<Ability id="unknown-aura-su" icon={["armor-upgrade"]}>
<Pair single id="unknown-aura-su">Unknown Aura (Su)</Pair>
...
<Ability id="channel-entropy-su" icon={["stairs-goal"]}>
<Pair single id="channel-entropy-su">Channel Entropy (Su)</Pair>
<Pair hl title="Alters">Channel energy</Pair>
...
<Ability id="power-of-the-unknown" icon={["broken-shield","upgrade"]}>
<Pair single id="power-of-the-unknown">Power of the Unknown</Pair>
<Pair hl title="Alters">Domains</Pair>
...
<Ability id="spontaneous-casting" icon={["broken-shield","magic-swirl"]}>
...
<Ability id="breadth-of-knowledge" icon={["upgrade","stairs-goal"]}>
<Pair single id="breadth-of-knowledge">Breadth of Knowledge</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="well-read-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="well-read-ex">Well-Read (Ex)</Pair>
...
<Ability id="verbal-instruction-ex" icon={["upgrade"]}>
<Pair single id="verbal-instruction-ex">Verbal Instruction (Ex)</Pair>
...
<Ability id="scribe-scroll-su" icon={["stairs-goal"]}>
<Pair single id="scribe-scroll-su">Scribe Scroll (Su)</Pair>
...
<Ability id="sworn-to-the-sea" icon={["info"]}>
<Pair single id="sworn-to-the-sea">Sworn to the Sea</Pair>
...
<Ability id="spontaneous-casting" icon={["broken-shield","spell-book"]}>
<Pair single id="spontaneous-casting">Spontaneous Casting</Pair>
<Pair hl title="Alters">Spontaneous casting</Pair>
...
<Ability id="legions-blessing-su" icon={["magic-swirl","stairs-goal"]}>
<Pair single id="legions-blessing-su" flavor="A crusader gains the ability to confer beneficial spells quickly to a large group of allies.">Legion's Blessing (Su)</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="demonic-familiar" icon={["stairs-goal"]}>
<Pair single id="demonic-familiar">Demonic Familiar</Pair>
...
<Ability id="demonic-channel-su" icon={["stairs-goal","aura"]}>
<Pair single id="demonic-channel-su">Demonic Channel (Su)</Pair>
<Pair hl title="Replaces">Channel energy</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="divine-brand-ex" icon={["stairs-goal","aura"]}>
<Pair single id="divine-brand-ex">Divine Brand (Ex)</Pair>
<Pair hl title="Alters">Aura</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="curser-ex" icon={["info","broken-shield"]}>
<Pair single id="curser-ex">Curser (Ex)</Pair>
<Pair hl title="Alters">Domains</Pair>
...
<Ability id="divine-hexes" icon={["stairs-goal"]}>
<Pair single id="divine-hexes">Divine Hexes</Pair>
<Pair hl title="Replaces">Channel energy</Pair>
...
<Ability id="domains" icon={["broken-shield"]}>
<Pair single id="domains">Domains</Pair>
<Pair title="Info">A divine strategist gains only a single domain.</Pair>
</Ability>
<Ability id="master-tactician-ex" icon={["stairs-goal","upgrade","rolling-dices"]}>
...
<Ability id="caster-support-su" icon={["upgrade","armor-upgrade"]}>
...
<Ability id="tactical-expertise-ex" icon={["upgrade"]}>
<Pair single id="tactical-expertise-ex" flavor="A divine strategist knows how to take best advantage of tactical opportunities.">Tactical Expertise (Ex)</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="ecclesitheurges-vow" icon={["info"]}>
<Pair single id="ecclesitheurges-vow">Ecclesitheurge's Vow</Pair>
...
<Ability id="blessing-of-the-faithful-su" icon={["upgrade","armor-upgrade"]}>
...
<Ability id="domain" icon={["info","broken-shield"]}>
...
<Ability id="forbidden-knowledge-ex" icon={["upgrade","stairs-goal"]}>
<Pair single id="forbidden-knowledge-ex">Forbidden Knowledge (Ex)</Pair>
...
<Ability id="unhinged-mind-ex" icon={["magic-swirl","broken-shield"]}>
<Pair single id="unhinged-mind-ex" flavor="Bartering sanity for unspeakable knowledge, an Elder Mythos cultist props up his crumbling sanity with a darkly enigmatic personality.">Unhinged Mind (Ex)</Pair>
...
<Ability id="channel-the-void-su" icon={["aura"]}>
<Pair single id="channel-the-void-su">Channel the Void (Su)</Pair>
...
<Ability id="maddening-gaze-su" icon={["smoking-finger"]}>
<Pair single id="maddening-gaze-su">Maddening Gaze (Su)</Pair>
...
<Ability id="single-minded" icon={["broken-shield"]}>
<Pair single id="single-minded">Single-Minded</Pair>
...
<Ability id="public-speaker" icon={["skills","upgrade"]}>
<Pair single id="public-speaker">Public Speaker</Pair>
...
<Ability id="sermonic-performance" icon={["stairs-goal"]}>
<Pair single id="sermonic-performance">Sermonic Performance</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-cleric-fiendish_vessel--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><ul><li><Link to="/race/tiefling">Tiefling</Link></li><li>Alignment must match patron's</li></ul></td></tr></tbody></table></ScrollContainer></div><Ability id="domains" icon={["info"]}>
<Pair single id="domains">Domains</Pair>
<Pair title="Usage">3 + Cha modifier times/day</Pair>
...
<Ability id="fiendish-augury-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="fiendish-augury-sp">Fiendish Augury (Sp)</Pair>
...
<Ability id="fiendish-divination-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="fiendish-divination-sp">Fiendish Divination (Sp)</Pair>
...
<Ability id="extra-divination-sp" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="extra-divination-sp">Extra Divination (Sp)</Pair>
...
<Ability id="fiendish-summoning" icon={["broken-shield"]}>
<Pair single id="fiendish-summoning">Fiendish Summoning</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-cleric-forgemaster--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><ul><li><Link to="/race/dwarf">Dwarf</Link></li><li>Worships a deity that grants the <Link to="/domain/artifice">Artifice</Link> domain</li></ul></td></tr></tbody></table></ScrollContainer></div><Ability id="artificer" icon={["broken-shield"]}>
<Pair single id="artificer">Artificer</Pair>
<Pair title="Info">A forgemaster gains only one domain, which must be the Artifice domain (not including subdomains).</Pair>
</Ability>
<Ability id="steel-spells" icon={["spell-book"]}>
<Pair single id="steel-spells">Steel Spells</Pair>
...
<Ability id="divine-smith-su" icon={["upgrade"]}>
<Pair single id="divine-smith-su">Divine Smith (Su)</Pair>
...
<Ability id="runeforger-su" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="runeforger-su">Runeforger (Su)</Pair>
<Pair hl title="Replaces">Channel energy</Pair>
...
<Ability id="ancient-splendor" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="ancient-splendor">Ancient Splendor</Pair>
...
<Ability id="bloodthirst42" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="bloodthirst42">Bloodthirst&#42;</Pair>
...
<Ability id="deathstrike" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="deathstrike">Deathstrike</Pair>
<Pair title="Prerequisites">4th-level cleric</Pair>
...
<Ability id="durability" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="durability">Durability</Pair>
...
<Ability id="featherlight" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="featherlight">Featherlight</Pair>
...
<Ability id="forgemasters-blessing" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="forgemasters-blessing">Forgemaster's Blessing</Pair>
<Pair title="Passive Ability">The inscribed nonmagical item functions as a masterwork item.</Pair>
</Ability>
<Ability id="ghostglyph42" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="ghostglyph42">Ghostglyph&#42;</Pair>
<Pair title="Prerequisites">4th-level cleric</Pair>
...
<Ability id="glowglyph" extraClasses="subAbility" icon={["stairs-goal","aura"]}>
<Pair single id="glowglyph">Glowglyph</Pair>
...
<Ability id="invulnerability42" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="invulnerability42">Invulnerability&#42;</Pair>
...
<Ability id="powerstrike42" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="powerstrike42">Powerstrike&#42;</Pair>
...
<Ability id="return42" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="return42">Return&#42;</Pair>
<Pair title="Prerequisites">4th-level cleric</Pair>
...
<Ability id="spellguard" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="spellguard">Spellguard</Pair>
...
<Ability id="spellglyph42" extraClasses="subAbility" icon={["armor-upgrade","magic-swirl"]}>
<Pair single id="spellglyph42">Spellglyph&#42;</Pair>
<Pair title="Prerequisites">4th-level cleric</Pair>
...
<Ability id="thief-curse" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="thief-curse">Thief-Curse</Pair>
<Pair title="Prerequisites">6th-level cleric</Pair>
...
<Ability id="tracer" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="tracer">Tracer</Pair>
...
<Ability id="channel-energy" icon={["broken-shield"]}>
<Pair single id="channel-energy">Channel Energy</Pair>
<Pair title="Info">A foundation of faith does not gain the <em>channel energy</em> ability.</Pair>
</Ability>
<Ability id="bastion-ex" icon={["armor-upgrade"]}>
<Pair single id="bastion-ex" flavor="A foundation of faith is an unbreakable obstacle, unmoved by threats and violence alike.">Bastion (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="granite-focus-ex" icon={["armor-upgrade"]}>
<Pair single id="granite-focus-ex" flavor="A foundation of faith's focus is truly impressive.">Granite Focus (Ex)</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="rooted-vitality-su" icon={["remedy"]}>
<Pair single id="rooted-vitality-su" flavor="A foundation of faith draws healing from the earth.">Rooted Vitality (Su)</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="dedicated-summoner" icon={["broken-shield"]}>
<Pair single id="dedicated-summoner">Dedicated Summoner</Pair>
...
<Ability id="call-heralds-su" icon={["stairs-goal","magic-swirl","armor-upgrade"]}>
...
<Ability id="mighty-heralds" icon={["stairs-goal"]}>
<Pair single id="mighty-heralds">Mighty Heralds</Pair>
...
<Ability id="unseen-devotion-su" icon={["stairs-goal"]}>
<Pair single id="unseen-devotion-su">Unseen Devotion (Su)</Pair>
...
<Ability id="planar-bond-su" extraClasses="hasSubs" icon={["magic-swirl"]}>
...
<Ability id="abaddon" extraClasses="subAbility" icon={["spell-book"]}>
<Pair single id="abaddon">Abaddon</Pair>
...
<Ability id="abyss" extraClasses="subAbility" icon={["spell-book"]}>
<Pair single id="abyss">Abyss</Pair>
<Pair plain title="1st"><Link to="/spell/doom">Doom</Link></Pair>
<Pair plain title="4th"><Link to="/spell/unholy_blight">Unholy blight</Link></Pair>
<Pair plain title="7th"><Link to="/spell/blasphemy">Blasphemy</Link></Pair>
</Ability>
<Ability id="astral" extraClasses="subAbility" icon={["spell-book"]}>
<Pair single id="astral">Astral</Pair>
...
<Ability id="axis" extraClasses="subAbility" icon={["spell-book"]}>
<Pair single id="axis">Axis</Pair>
...
<Ability id="boneyard" extraClasses="subAbility" icon={["spell-book"]}>
<Pair single id="boneyard">Boneyard</Pair>
...
<Ability id="elysium" extraClasses="subAbility" icon={["spell-book"]}>
<Pair single id="elysium">Elysium</Pair>
...
<Ability id="ethereal" extraClasses="subAbility" icon={["spell-book"]}>
...
<Ability id="first-world" extraClasses="subAbility" icon={["spell-book"]}>
...
<Ability id="heaven" extraClasses="subAbility" icon={["spell-book"]}>
<Pair single id="heaven">Heaven</Pair>
...
<Ability id="hell" extraClasses="subAbility" icon={["spell-book"]}>
<Pair single id="hell">Hell</Pair>
<Pair plain title="1st"><Link to="/spell/command">Command</Link></Pair>
<Pair plain title="4th"><Link to="/spell/tongues">Tongues</Link></Pair>
<Pair plain title="7th"><Link to="/spell/dictum">Dictum</Link></Pair>
</Ability>
<Ability id="maelstrom" extraClasses="subAbility" icon={["spell-book"]}>
<Pair single id="maelstrom">Maelstrom</Pair>
...
<Ability id="nirvana" extraClasses="subAbility" icon={["spell-book"]}>
<Pair single id="nirvana">Nirvana</Pair>
...
<Ability id="plane-of-air" extraClasses="subAbility" icon={["spell-book"]}>
...
<Ability id="plane-of-earth" extraClasses="subAbility" icon={["spell-book"]}>
...
<Ability id="plane-of-fire" extraClasses="subAbility" icon={["spell-book"]}>
...
<Ability id="plane-of-water" extraClasses="subAbility" icon={["spell-book"]}>
...
<Ability id="shadow-plane" extraClasses="subAbility" icon={["spell-book"]}>
<Pair single id="shadow-plane">Shadow Plane</Pair>
...
<Ability id="other" extraClasses="subAbility" icon={["spell-book"]}>
<Pair single id="other">Other</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-cleric-lawspeaker--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Lawful alignment</td></tr></tbody></table></ScrollContainer></div><Ability id="divine-judgment" icon={["broken-shield"]}>
<Pair single id="divine-judgment">Divine Judgment</Pair>
<Pair hl title="Alters">Domains</Pair>
...
<Ability id="circumvent-obfuscation-sp" icon={["magic-swirl"]}>
<Pair single id="circumvent-obfuscation-sp">Circumvent Obfuscation (Sp)</Pair>
...
<Ability id="demonic-knowledge-ex" icon={["upgrade"]}>
<Pair single id="demonic-knowledge-ex">Demonic Knowledge (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="willing-healer" icon={["broken-shield"]}>
<Pair single id="willing-healer">Willing Healer</Pair>
...
<Ability id="channel-energy-su" icon={["stairs-goal"]}>
<Pair single id="channel-energy-su">Channel Energy (Su)</Pair>
<Pair hl title="Replaces">Channel energy</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="combat-medic-ex" icon={["armor-upgrade"]}>
<Pair single id="combat-medic-ex">Combat Medic (Ex)</Pair>
...
<Ability id="merciful-healing-su" icon={["stairs-goal","remedy"]}>
<Pair single id="merciful-healing-su">Merciful Healing (Su)</Pair>
...
<Ability id="true-healer-su" icon={["stairs-goal","rolling-dices"]}>
<Pair single id="true-healer-su">True Healer (Su)</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="dedicated-wanderer" icon={["broken-shield"]}>
<Pair single id="dedicated-wanderer" flavor="A roaming exorcist is dedicated to her cause and affords no time to other pursuits typical of clerics.">Dedicated Wanderer</Pair>
...
<Ability id="unseen-revealed-ex" icon={["upgrade"]}>
<Pair single id="unseen-revealed-ex">Unseen Revealed (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="curse-seeker-su" icon={["upgrade"]}>
<Pair single id="curse-seeker-su" flavor="A roaming exorcist can more readily identify cursed items.">Curse Seeker (Su)</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="dispossession-su" icon={["stairs-goal"]}>
<Pair single id="dispossession-su">Dispossession (Su)</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="curse-eater-su" icon={["stairs-goal","upgrade","armor-upgrade"]}>
<Pair single id="curse-eater-su">Curse Eater (Su)</Pair>
...
<Ability id="channel-beauty-su" icon={["stairs-goal"]}>
<Pair single id="channel-beauty-su">Channel Beauty (Su)</Pair>
<Pair hl title="Alters">Channel energy</Pair>
...
<Ability id="nurture-grace-su" icon={["upgrade"]}>
<Pair single id="nurture-grace-su">Nurture Grace (Su)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="inspiring-camaraderie-sp" icon={["upgrade"]}>
<Pair single id="inspiring-camaraderie-sp">Inspiring Camaraderie (Sp)</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 time/day + 1 per four cleric levels beyond 8th<ByLevelPop levels={[[8,1],[12,2],[16,3],[20,4]]} unit="time" postText="/day" /></Pair>
...
<Ability id="secrets-revealed-sp" icon={["stairs-goal","magic-swirl"]}>
...
<Ability id="flash-of-insight-su" icon={["upgrade","armor-upgrade"]}>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-cleric-separatist--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Must worship a deity.</td></tr></tbody></table></ScrollContainer></div><Ability id="weapon-and-armor-proficiency" icon={["broken-shield"]}>
<Pair single id="weapon-and-armor-proficiency">Weapon and Armor Proficiency</Pair>
...
<Ability id="forbidden-rites" icon={["broken-shield","stairs-goal"]}>
<Pair single id="forbidden-rites">Forbidden Rites</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-cleric-stoic_caregiver--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Cannot worship a deity who is evil.</td></tr></tbody></table></ScrollContainer></div><Ability id="positive-channeler-su" icon={["info"]}>
<Pair single id="positive-channeler-su">Positive Channeler (Su)</Pair>
<Pair hl title="Alters">Channel energy</Pair>
...
<Ability id="fated-cures-su" icon={["armor-downgrade","rolling-dices"]}>
<Pair single id="fated-cures-su">Fated Cures (Su)</Pair>
...
<Ability id="three-aspect-channel-su" icon={["stairs-goal"]}>
<Pair single id="three-aspect-channel-su">Three-Aspect Channel (Su)</Pair>
...
<Ability id="domain-secret-ex" icon={["upgrade","magic-swirl"]}>
<Pair single id="domain-secret-ex">Domain Secret (Ex)</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="bonded-channeler-su" icon={["aura"]}>
<Pair single id="bonded-channeler-su">Bonded Channeler (Su)</Pair>
...
<Ability id="bonded-domain-su" extraClasses="hasSubs" icon={["broken-shield"]}>
<Pair single id="bonded-domain-su">Bonded Domain (Su)</Pair>
<Pair hl title="Alters">Domains</Pair>
...
<Ability id="bonded-power-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="bonded-power-su">Bonded Power (Su)</Pair>
...
<Ability id="bonded-unity-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="bonded-unity-su">Bonded Unity (Su)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="bonded-ritual" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="bonded-ritual">Bonded Ritual</Pair>
...
<Ability id="corpse-companion-su" icon={["stairs-goal"]}>
<Pair single id="corpse-companion-su">Corpse Companion (Su)</Pair>
...
<Ability id="unlife-healer-su" icon={["remedy"]}>
<Pair single id="unlife-healer-su">Unlife Healer (Su)</Pair>
...
<Ability id="fortunate-road" icon={["stairs-goal"]}>
<Pair single id="fortunate-road">Fortunate Road</Pair>
<Pair hl title="Replaces">Domains</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="caravan-bond-su" icon={["stairs-goal"]}>
<Pair single id="caravan-bond-su">Caravan Bond (Su)</Pair>
...
<Ability id="blessing-of-the-harrow-su" icon={["stairs-goal"]}>
<Pair single id="blessing-of-the-harrow-su">Blessing of the Harrow (Su)</Pair>
