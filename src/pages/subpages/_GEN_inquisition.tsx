...
<Ability id="hateful-resort-ex" icon={["melee"]}>
...
<Ability id="divine-anger-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="righteous-awe-su" icon={["touch","lower"]}>
...
<Ability id="dismissive-touch-sp" icon={["touch","magic"]}>
...
<Ability id="granted-powers" icon={["power","lower"]}>
...
<Ability id="mount-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="mount-ex" extraClasses="subAbility" icon={["power"]}>
<Pair single id="mount-ex">Mount (Ex)</Pair>
...
<Ability id="faithful-steed-su" icon={["power"]}>
...
<Ability id="disappear-sp" icon={["def"]}>
...
<Ability id="blessed-secrecy-su" icon={["roll"]}>
...
<Ability id="delayed-spells-su" icon={["magic"]}>
...
<Ability id="charm-of-wisdom-ex" icon={["boost"]}>
...
<Ability id="swaying-word-sp" icon={["magic"]}>
...
<Ability id="criminal-minds-sp" icon={["touch"]}>
...
<Ability id="thiefs-soul-ex" icon={["power"]}>
...
<Ability id="fear-the-flames-su" icon={["magic"]}>
...
<Ability id="collector-of-souls-sp" icon={["magic"]}>
...
<Ability id="touch-of-silence-su" icon={["touch"]}>
...
<Ability id="excommunicate-su" icon={["lower"]}>
...
<Ability id="chosen-victim-sp" icon={["boost"]}>
...
<Ability id="executioners-strike-su" icon={["boost"]}>
...
<Ability id="augury-sp" icon={["magic"]}>
...
<Ability id="agent-of-fate-su" icon={["aid","boost","def"]}>
...
<Ability id="fire-of-belief-sp" icon={["zap"]}>
...
<Ability id="fervent-action-ex" icon={["power"]}>
...
<Ability id="disrupt-animation-sp" icon={["magic"]}>
...
<Ability id="unravel-animation-su" icon={["boost"]}>
...
<Ability id="righteous-infiltration-ex" icon={["boost"]}>
...
<Ability id="blessed-infiltration-ex" icon={["roll"]}>
...
<Ability id="word-of-anathema-sp" icon={["magic","lower"]}>
...
<Ability id="illuminating-touch-sp" icon={["protect","boost"]}>
...
<Ability id="aura-of-enlightenment-su" icon={["aura","boost"]}>
...
<Ability id="caging-strike-su" icon={["lower"]}>
...
<Ability id="divine-prison" icon={["magic"]}>
...
<Ability id="judicious-force-su" icon={["boost"]}>
...
<Ability id="chains-of-justice-su" icon={["lower","down"]}>
...
<Ability id="life-anchor-su" icon={["aura","aid"]}>
...
<Ability id="stare-of-oblivion-sp" icon={["zap"]}>
...
<Ability id="mantle-against-chaos-sp" icon={["def","protect"]}>
...
<Ability id="commanding-order-sp" icon={["magic"]}>
...
<Ability id="inner-strength-su" icon={["aid"]}>
...
<Ability id="labyrinthine-words-ex" icon={["boost"]}>
...
<Ability id="hearts-desire-sp" icon={["magic"]}>
...
<Ability id="self-control-ex" icon={["def"]}>
...
<Ability id="beast-ride-su" icon={["magic"]}>
...
<Ability id="body-snatch-sp" icon={["magic"]}>
...
<Ability id="focused-search-ex" icon={["boost"]}>
...
<Ability id="locate-focus-sp" icon={["magic"]}>
...
<Ability id="patient-sensibility-su" icon={["boost"]}>
...
<Ability id="redeemers-mercy-su" icon={["boost"]}>
...
<Ability id="second-chance-sp" icon={["magic","aid"]}>
...
<Ability id="inspired-rhetoric-ex" icon={["boost","skill"]}>
...
<Ability id="blessed-correction-ex" icon={["roll"]}>
...
<Ability id="awaken-discontent-su" icon={["magic"]}>
...
<Ability id="mend-the-broken-su" icon={["aid"]}>
...
<Ability id="cleanse-impunity-su" icon={["boost"]}>
...
<Ability id="burn-shroud-su" icon={["touch"]}>
...
<Ability id="reveal-form-su" icon={["magic","lower"]}>
...
<Ability id="detect-secrets-su" icon={["magic"]}>
...
<Ability id="closed-book-sp" icon={["def"]}>
...
<Ability id="undermine-authority-sp" icon={["magic"]}>
...
<Ability id="rebel-leader-ex" icon={["power"]}>
...
<Ability id="disarming-flirtation-sp" icon={["power","lower"]}>
...
<Ability id="inspire-devotion-ex" icon={["power"]}>
...
<Ability id="sin-sense-su" icon={["boost"]}>
...
<Ability id="indulge-su" icon={["lower"]}>
...
<Block size="simple">
<Row><Cell>Associated Deities</Cell><Cell>Any (with GM approval)</Cell></Row></Block>
<Ability id="granted-powers" icon={["power","def"]}>
<Pair single id="granted-powers">Granted Powers</Pair>
...
<Ability id="inquisitors-direction-su" icon={["down","boost"]}>
...
<Ability id="grant-the-initiative-ex" icon={["boost"]}>
...
<Ability id="torturers-presence-ex" icon={["boost"]}>
...
<Ability id="torturers-touch-sp" icon={["magic","touch"]}>
...
<Ability id="critical-precision-ex" icon={["boost"]}>
...
<Ability id="back-to-the-graves-su" icon={["boost"]}>
...
<Ability id="hallowed-rite-su" icon={["protect"]}>
...
<Ability id="justices-true-path-sp" icon={["boost"]}>
...
<Ability id="grasp-of-honesty-su" icon={["lower"]}>
...
<Ability id="touch-of-resolve-sp" icon={["aid"]}>
...
<Ability id="divine-retribution-sp" icon={["magic"]}>
...
<Ability id="final-vengeance-su" icon={["melee"]}>
...
<Ability id="zealous-surge-sp" icon={["def"]}>
...
<Ability id="scourge-of-the-enemy-ex" icon={["boost","def"]}>
