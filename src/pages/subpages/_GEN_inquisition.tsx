...
<p><strong>Granted Powers:</strong> Fate is a powerful tool for those who dole out justice for their deity. You can read the strands of fate, and those strands guide your endeavors.</p>
<p><strong>Augury (Sp):</strong> Once per day, you can use <Link to="/spell/augury">augury</Link> as a spell-like ability.</p>
<p><strong>Agent of Fate (Su):</strong> At 8th level, when you use your <em>augury</em> spell-like ability, you gain a benefit that lasts until the end of your next combat. If the result was "weal," all curing effects used on you cure an additional +1d10 hit points. If the result was "woe," your melee attacks deal an additional +1d6 points of damage. If the result is "weal and woe" or "nothing," you gain a +2 insight bonus to your Armor Class.</p>
</>};
const _fervor = {title: "Fervor", jsx: <><h2 id="inquisition-fervor-fervor">Fervor</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 42</Link><br/><strong>Deities</strong> <Link to="/faith/calistria">Calistria</Link>, <Link to="/faith/cayden_cailean">Cayden Cailean</Link>, <Link to="/faith/gozreh">Gozreh</Link>, <Link to="/faith/shelyn">Shelyn</Link></p>
<p><strong>Granted Powers:</strong> Only a passionate and righteous will such as yours can ensure that justice will be properly done.</p>
<p><strong>Fire of Belief (Sp):</strong> You can unleash a gout of holy or unholy flame that sears one target within 30 feet as a ranged touch attack. The target takes 1d6 points of fire damage plus half your inquisitor level (minimum +1). If you are good, the flames only harm nongood targets. If you are evil, the flames only harm nonevil targets. If you are neither good nor evil, when you gain this ability you must decide whether the flames harm only nongood or nonevil targets; once you make this decision, it cannot be changed (though if your alignment changes, the effect of the flames changes appropriately). You can use this ability a number of times per day equal to 3 + your Wisdom modifier.</p>
<p><strong>Fervent Action (Ex):</strong> At 8th level, once per day as a swift action, you can make a single melee attack at your highest attack bonus, move up to your speed, or cast a prepared inquisitor spell (of a spell level up to one lower than the highest level spell you can cast) as per <Link to="/feat/quicken_spell">Quicken Spell</Link>.</p>
</>};
const _final_rest = {title: "Final Rest", jsx: <><h2 id="inquisition-final_rest-final-rest">Final Rest</h2>
<p><strong>Sources</strong> <Link to="/source/champions_of_purity">Champions of Purity pg. 22</Link><br/><strong>Deities</strong> <Link to="/faith/iomedae">Iomedae</Link>, <Link to="/faith/pharasma">Pharasma</Link>, <Link to="/faith/sarenrae">Sarenrae</Link></p>
<p><strong>Granted Powers:</strong> The dead have paid their dues; there is no need, and no excuse, for them to walk. You protect their rest personally.</p>
<p><strong>Disrupt Animation (Sp):</strong> You can use <Link to="/spell/disrupt_undead">disrupt undead</Link> as a spell-like ability, adding your wisdom modifier to the damage. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.</p>
<p><strong>Unravel Animation (Su):</strong> At 8th level, when you activate your bane ability with undead as the creature type, you can choose for your weapon to instead gain the <Link to="/magic-enh/disruption">disruption</Link> weapon special ability. The DC to resist this effect is equal to 10 + 1/2 your inquisitor level + your Wisdom modifier.</p>
</>};
const _heresy = {title: "Heresy", jsx: <><h2 id="inquisition-heresy-heresy">Heresy</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 42</Link><br/><strong>Deities</strong> <Link to="/faith/abadar">Abadar</Link>, <Link to="/faith/asmodeus">Asmodeus</Link>, <Link to="/faith/calistria">Calistria</Link>, <Link to="/faith/desna">Desna</Link>, <Link to="/faith/erastil">Erastil</Link>, <Link to="/faith/gorum">Gorum</Link>, <Link to="/faith/gozreh">Gozreh</Link>, <Link to="/faith/iomedae">Iomedae</Link>, <Link to="/faith/lamashtu">Lamashtu</Link>, <Link to="/faith/nethys">Nethys</Link>, <Link to="/faith/norgorber">Norgorber</Link>, <Link to="/faith/pharasma">Pharasma</Link>, <Link to="/faith/rovagug">Rovagug</Link>, <Link to="/faith/sarenrae">Sarenrae</Link>, <Link to="/faith/shelyn">Shelyn</Link>, <Link to="/faith/torag">Torag</Link>, <Link to="/faith/urgathoa">Urgathoa</Link>, <Link to="/faith/zon_kuthon">Zon-Kuthon</Link></p>
<p><strong>Granted Powers:</strong> Often it is hard to tell heretics from the faithful. You use duplicity, stealth, and the heretics' own arguments to root them out and bring them to justice.</p>
<p><strong>Righteous Infiltration (Ex):</strong> You use your Wisdom modifier instead of your Charisma modifier when making Bluff and Intimidate checks.</p>
<p><strong>Blessed Infiltration (Ex):</strong> At 4th level, when you make a Bluff, Diplomacy, or Stealth check, you may roll twice and take the more favorable result. You can use this ability a number of times per day equal to your Wisdom bonus.</p>
<p><strong>Word of Anathema (Sp):</strong> At 8th level, once per day, you can speak a word of anathema against a single creature within 60 feet (Will negates). This acts as <Link to="/spell/bestow_curse">bestow curse</Link> and lasts for 1 minute, giving the target a -4 penalty on attack rolls, saves, ability checks, and skill checks.</p>
</>};
const _illumination = {title: "Illumination", jsx: <><h2 id="inquisition-illumination-illumination">Illumination</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 43</Link><br/><strong>Deities</strong> <Link to="/faith/desna">Desna</Link>, <Link to="/faith/erastil">Erastil</Link>, <Link to="/faith/irori">Irori</Link>, <Link to="/faith/sarenrae">Sarenrae</Link></p>
<p><strong>Granted Powers:</strong> Many times an inquisitor's greatest weapon is pure and unflinching illumination; errors are often illuminated by light and wisdom.</p>
<p><strong>Illuminating Touch (Sp):</strong> You cause your hand to shimmer with divine radiance, allowing you to touch a creature as a standard action and give it a bonus equal to 1/2 your inquisitor level on a single Will saving throw, Knowledge check, Perception check, or Sense Motive check. This ability lasts for 1 hour or until the creature chooses to apply the bonus to a roll. You can use this ability to grant the bonus a number of times per day equal to 3 + your Wisdom modifier.</p>
<p><strong>Aura of Enlightenment (Su):</strong> At 4th level, you can create a 30-foot-radius aura of normal light. Allies in this aura gain a +2 insight bonus on skill checks. This counts as a 2nd-level <Link to="/spelldef/light">light</Link> effect for the purpose of countering or dispelling darkness effects. You can use this aura for a number of rounds per day equal to your inquisitor level. These rounds do not need to be consecutive.</p>
</>};
const _imprisonment = {title: "Imprisonment", jsx: <><h2 id="inquisition-imprisonment-imprisonment">Imprisonment</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 42</Link><br/><strong>Deities</strong> <Link to="/faith/abadar">Abadar</Link>, <Link to="/faith/asmodeus">Asmodeus</Link>, <Link to="/faith/torag">Torag</Link></p>
<p><strong>Granted Powers:</strong> Sometimes it is better to capture foes than to kill them - whether your intention is to punish them for their crimes or to torture them for information.</p>
<p><strong>Caging Strike (Su):</strong> With a devastating weapon strike, spectral chains wrap around your target for a short period of time. Whenever you confirm a critical hit with a melee or ranged weapon attack (including spells that require attack rolls), you can choose to also entangle that target for 1d4 rounds (Fortitude negates). You may use this ability a number of times per day equal to 3 + your Wisdom modifier.</p>
<p><strong>Divine Prison</strong> At 8th level, once per day upon making a successful melee attack, you can affect your target with hold monster (Will negates).</p>
</>};
const _justice = {title: "Justice", jsx: <><h2 id="inquisition-justice-justice">Justice</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 43</Link><br/><strong>Deities</strong> <Link to="/faith/iomedae">Iomedae</Link>, <Link to="/faith/pharasma">Pharasma</Link></p>
<p><strong>Granted Powers:</strong> Some must learn that to submit to one's fate often means submitting to your form of justice.</p>
<p><strong>Judicious Force (Su):</strong> If you or an ally within 10 feet makes a critical threat with a melee or ranged attack, as an immediate action you may add +4 to the confirmation roll. This does not stack with the <Link to="/feat/critical_focus">Critical Focus</Link> feat. You may use this ability a number of times per day equal to your Wisdom bonus.</p>
<p><strong>Chains of Justice (Su):</strong> At 6th level, once per day, you can bind an opponent within 60 feet to you with spectral chains (Will negates). When you take damage from an enemy, the bound target takes this damage as well. Whenever the bound target takes damage from you or one of your allies, you take this damage as well. You and the target are not physically bound to each other, and either can end the connection by breaking the line of effect or exceeding the ability's range. You may dismiss the chains as a standard action.</p>
</>};
const _oblivion = {title: "Oblivion", jsx: <><h2 id="inquisition-oblivion-oblivion">Oblivion</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 43</Link><br/><strong>Deities</strong> <Link to="/faith/desna">Desna</Link>, <Link to="/faith/lamashtu">Lamashtu</Link>, <Link to="/faith/pharasma">Pharasma</Link>, <Link to="/faith/zon_kuthon">Zon-Kuthon</Link></p>
<p><strong>Granted Powers:</strong> Some inquisitors believe that without faith there is only oblivion. But there are some divine servants who know enough about the darkness that lies beyond faith to use it as a tool- and a weapon.</p>
<p><strong>Life Anchor (Su):</strong> You gain a 10-foot-radius aura that helps dying creatures cling to life. Within this aura, a dying creature (including yourself) adds your Wisdom bonus to its stabilization checks (in addition to any other modifiers to stabilization checks).</p>
<p><strong>Stare of Oblivion (Sp):</strong> At 8th level, you can use <Link to="/spell/feeblemind">feeblemind</Link> as a gaze attack against one creature (Will negates). This effect lasts 1d4 rounds. You can use this ability once per day at 8th level, and one additional time per day for every four levels beyond 8th.</p>
</>};
const _order = {title: "Order", jsx: <><h2 id="inquisition-order-order">Order</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 43</Link><br/><strong>Deities</strong> Abadar, Iomedae, Sarenrae</p>
<p><strong>Granted Powers:</strong> Most inquisitors fight insane aberrations and demonic creatures as well as the chaos of heresy. They use the dictum and the mantles of law in order to aid their struggle.</p>
<p><strong>Mantle against Chaos (Sp):</strong> You can use <Link to="/spell/protection_from_chaos">protection from chaos</Link> on yourself or another creature as a spell-like ability. You can use this ability for a number of minutes per day equal to your inquisitor level (minimum 1). This duration does not need to be consecutive, but it must be used in 1 minute increments.</p>
<p><strong>Commanding Order (Sp):</strong> At 8th level, you can use <Link to="/spell/greater_command">greater command</Link>, except it only affects a single target. You can use this ability a number of times per day equal to 3 + your Wisdom bonus.</p>
</>};
const _persistence = {title: "Persistence", jsx: <><h2 id="inquisition-persistence-persistence">Persistence</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 43</Link><br/><strong>Deities</strong> <Link to="/faith/asmodeus">Asmodeus</Link>, <Link to="/faith/iomedae">Iomedae</Link>, <Link to="/faith/urgathoa">Urgathoa</Link></p>
<p><strong>Granted Powers:</strong> Your deity chose you for your persistence. You have vowed to pursue the enemies of the faith to the world's end if necessary. You receive <Link to="/feat/step_up">Step Up</Link> as a bonus feat.</p>
<p><strong>Relentless Footing (Ex):</strong> As a swift action, you can add 10 feet to your land speed. This increase counts as an enhancement bonus, and it affects your jumping distance as normal for increased speed. You can use this ability a number of times per day equal to 3 + your Wisdom bonus (minimum 1).</p>
<p><strong>Inner Strength (Su):</strong> At 6th level, once per day, you may heal yourself as a swift action, healing 1d6 hit points for every two inquisitor levels you possess. When you use this ability, you can also remove one of the following conditions from yourself: blinded, confused, dazzled, deafened, frightened, nauseated, shaken, sickened, or staggered.</p>
</>};
const _politics = {title: "Politics", jsx: <><h2 id="inquisition-politics-politics">Politics</h2>
<p><strong>Sources</strong> <Link to="/source/inner_sea_intrigue">Inner Sea Intrigue pg. 30</Link><br/><strong>Deities</strong> <Link to="/faith/abadar">Abadar</Link>, <Link to="/faith/asmodeus">Asmodeus</Link>, <Link to="/faith/calistria">Calistria</Link>, <Link to="/faith/norgorber">Norgorber</Link></p>
<p><strong>Granted Powers:</strong> Your divine guidance twists agreements, laws, and policies to suit the interests of the faith.</p>
<p><strong>Labyrinthine Words (Ex):</strong> You add your Wisdom modifier in addition to your Charisma modifier on Bluff checks to lie and Diplomacy checks to influence other creatures.</p>
<p><strong>Heart's Desire (Sp):</strong> At 8th level, you receive divine guidance on the goals of your political allies and rivals. Once per day, you can use <Link to="/spell/commune">commune</Link> as a spell-like ability using your inquisitor level as your caster level, but only to ask questions about others' goals.</p>
</>};
const _possession = {title: "Possession", jsx: <><h2 id="inquisition-possession-possession">Possession</h2>
<p><strong>Sources</strong> <Link to="/source/blood_of_fiends">Blood of Fiends pg. 27</Link><br/><strong>Deities</strong> <Link to="/faith/calistria">Calistria</Link>, <Link to="/faith/lamashtu">Lamashtu</Link>, <Link to="/faith/nethys">Nethys</Link>, <Link to="/faith/norgorber">Norgorber</Link>, <Link to="/faith/urgathoa">Urgathoa</Link></p>
<p><strong>Granted Powers:</strong> You can invade the bodies of lesser beings and command them to bend to your will.</p>
<p><strong>Self-Control (Ex):</strong> You possess remarkable control over your own body, and gain a +2 competence bonus on saving throws made against enchantment spells of the charm or compulsion subschool.</p>
<p><strong>Beast Ride (Su):</strong> At 4th level, once per day as a standard action, you can vacate your body and inhabit that of any creature belonging to the animal type within 30 feet for a number of rounds up to your inquisitor level. While you are possessing an animal in this way, your own body becomes helpless and unaware. You can travel any distance from your body so long as you remain on the same plane, and can return to your own body as a free action at any time. If the animal or your body takes damage, or you attempt to make the animal attack or do anything out of character, the effect immediately ends and you return to your own body.</p>
<p><strong>Body Snatch (Sp):</strong> At 10th level, once per day as an immediate action upon falling unconscious because of dropping below 0 hit points, you can cast your soul from your body and attempt to occupy the body of another creature within 30 feet. This ability otherwise functions identically to <Link to="/spell/magic_jar">magic jar</Link> except that your actual body serves as the receptacle and you suppress the consciousness of your target rather than casting it out. Your body continues to <Link to="/misc/dying">bleed as normal</Link> unless it is somehow stabilized, and if its hit points drop to a negative number equal to your Constitution score, the <em>magic jar</em> effect prematurely ends and you die as normal.</p>
</>};
const _recovery = {title: "Recovery", jsx: <><h2 id="inquisition-recovery-recovery">Recovery</h2>
<p><strong>Sources</strong> <Link to="/source/champions_of_purity">Champions of Purity pg. 22</Link><br/><strong>Deities</strong> <Link to="/faith/abadar">Abadar</Link>, <Link to="/faith/erastil">Erastil</Link>, <Link to="/faith/nivi_rhombodazzle">Nivi Rhombodazzle</Link>, <Link to="/faith/shelyn">Shelyn</Link></p>
<p><strong>Granted Powers:</strong> Some hunt down secrets, but you focus on the search for more tangible items.</p>
<p><strong>Focused Search (Ex):</strong> Once per day, you may designate a person or object as your focus. This takes 1 minute of concentration, during which time you must either picture this item or person if familiar to you, or meditate on the item's or person's description if not. Until you choose a new focus, you gain a bonus equal to half your inquisitor level on Perception checks to see or hear your focus, or when using Survival to track your focus or a creature with your focus in its possession. This bonus stacks with that gained from the track special ability.</p>
<p><strong>Locate Focus (Sp):</strong> At 8th level, once per day you may use either <Link to="/spell/locate_creature">locate creature</Link> or <Link to="/spell/locate_object">locate object</Link> as a spell-like ability using your current focus as the target. The range of this effect is 1 mile per level.</p>
</>};
...
<p><strong>Granted Powers:</strong> You reach out to your misguided fellows and give them every chance to turn back from conflict with the true faith, even if your differences come to violence.</p>
<p><strong>Patient Sensibility (Su):</strong> You gain a +2 bonus on Diplomacy, Perception, and Sense Motive checks.</p>
<p><strong>Redeemer's Mercy (Su):</strong> At 4th level, any weapon you wield gains the <Link to="/magic-enh/merciful">merciful</Link> magic weapon special ability. The weapon immediately reverts to its original abilities when you cease to wield it.</p>
<p><strong>Second Chance (Sp):</strong> At 8th level, you can give an enemy a second chance to correct the error of its ways. Once per day as a standard action, you can cast <Link to="/spell/atonement">atonement</Link> as a spell-like ability, targeting a creature that has violated the tenets of a religion you both share or that freely desires to convert to your alignment. If costly material components are required for the <em>atonement,</em> you may choose to accept a permanent negative level as a sacrifice in place of those components. The target of this effect also receives the benefits of a <Link to="/spell/cure_serious_wounds">cure serious wounds</Link> spell as part of the effects of the <em>atonement.</em></p>
</>};
...
<p><strong>Granted Powers:</strong> You can speak with divine persuasiveness.</p>
<p><strong>Inspired Rhetoric (Ex):</strong> You use your Wisdom modifier in place of your Charisma modifier when making Diplomacy, Intimidate, and Perform (oratory) checks. Perform (oratory) is an inquisitor class skill for you.</p>
<p><strong>Blessed Correction (Ex):</strong> At 4th level, when you make a Diplomacy, Intimidate, or Perform (oratory) check, you may roll twice and take the more favorable result. You can use this ability a number of times per day equal to your Wisdom bonus.</p>
<p><strong>Awaken Discontent (Su):</strong> At 8th level, you can deliver a stirring speech condemning the mistakes of those in power and calling for reform, causing the target of your rhetoric to be affected by <Link to="/spell/charm_person">charm person</Link> with a caster level equal to your inquisitor level and a save DC of 10 + 1/2 your inquisitor level + your Wisdom modifier. You may use this ability a number of times per day equal to your Wisdom modifier.</p>
</>};
const _restoration = {title: "Restoration", jsx: <><h2 id="inquisition-restoration-restoration">Restoration</h2>
<p><strong>Sources</strong> <Link to="/source/magical_marketplace">Magical Marketplace pg. 10</Link><br/><strong>Deities</strong> <Link to="/faith/desna">Desna</Link>, <Link to="/faith/irori">Irori</Link>, <Link to="/faith/sarenrae">Sarenrae</Link>, <Link to="/faith/shelyn">Shelyn</Link></p>
<p><strong>Granted Powers:</strong> You are a healer, not just of people but also of sacred sites tainted by enemies of your faith.</p>
<p><strong>Mend the Broken (Su):</strong> You can touch an object or creature as a standard action, healing it of 1d4 points of damage + 1 for every 2 inquisitor levels you possess. You can use this ability only on a broken object or a creature with fewer than half its maximum hit points. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.</p>
<p><strong>Cleanse Impunity (Su):</strong> At 8th level, choose an alignment (chaotic, evil, good, or lawful) that is opposite to one axis of your own. Once chosen, this cannot be changed. Add your Wisdom bonus on caster level checks to overcome the spell resistance of creatures with the chosen alignment subtype; dispel effects with the chosen alignment descriptor; and remove curses, diseases, and poisons. A neutral inquisitor gains only the bonus on caster level checks to remove curses, diseases, and poisons.</p>
</>};
const _revelation = {title: "Revelation", jsx: <><h2 id="inquisition-revelation-revelation">Revelation</h2>
<p><strong>Sources</strong> <Link to="/source/blood_of_angels">Blood of Angels pg. 27</Link><br/><strong>Deities</strong> <Link to="/faith/desna">Desna</Link>, <Link to="/faith/irori">Irori</Link>, <Link to="/faith/sarenrae">Sarenrae</Link>, <Link to="/faith/shelyn">Shelyn</Link></p>
<p><strong>Granted Powers:</strong> Evil often hides itself behind a mask of good. You are an expert at ferreting out those who are not what they seem, and use your powers to reveal the true forms of the unworthy.</p>
<p><strong>Burn Shroud (Su):</strong> As a standard action, you can make an unarmed touch attack against a creature. The target takes 1d4 points of fire damage + 1/2 your inquisitor level (minimum 1). If the target is currently the subject of a polymorph effect that changes its appearance (such as by <Link to="/spell/alter_self">alter self</Link>, <Link to="/spell/shapechange">shapechange</Link>, or an innate shapechanging ability such as that possessed by <Link to="/monster/doppelganger">doppelgangers</Link>), it instead takes 1d6 points of fire damage + 1/2 your inquisitor level (minimum 1). You can use this ability a number of times per day equal to 3 + your Wisdom modifier.</p>
<p><strong>Reveal Form (Su):</strong> At 8th level, once per day as a standard action, you can invoke the name of your deity and order one shapechanged target within 30 feet to reveal its true form. The target must succeed at a Will save (DC 10 + 1/2 your inquisitor level + your Wisdom modifier) or be forced on its next turn to dispel any ongoing polymorph effects or innate shapechanging abilities to assume its natural form. If a creature affected by this ability fails its save and is for some reason unable to dispel any ongoing polymorph effects or innate shapechanging abilities, it is instead <Link to="/misc/staggered">staggered</Link> for 1 round. This is a mind-affecting compulsion effect.</p>
</>};
...
<p><strong>Granted Powers:</strong> You have learned to keep your own secrets close, and your enemies' secrets closer.</p>
<p><strong>Detect Secrets (Su):</strong> You have learned how to detect any of a creature's secrets, not just its thoughts. Whenever you cast <Link to="/spell/detect_anxieties">detect anxieties</Link>, <Link to="/spell/detect_desires">detect desires</Link>, or <Link to="/spell/detect_thoughts">detect thoughts</Link> or use any of those spells as a spell-like ability, you can choose to gain the effects of one of the other two spells instead. You are never overwhelmed by a target of these spells that has a high ability score.</p>
<p><strong>Closed Book (Sp):</strong> At 8th level, it becomes difficult for your foes to unveil your secrets. You are constantly under the effect of <Link to="/spell/nondetection">nondetection</Link>, as if you cast the spell on yourself.</p>
</>};
const _sedition = {title: "Sedition", jsx: <><h2 id="inquisition-sedition-sedition">Sedition</h2>
<p><strong>Sources</strong> <Link to="/source/inner_sea_intrigue">Inner Sea Intrigue pg. 30</Link><br/><strong>Deities</strong> <Link to="/faith/cayden_cailean">Cayden Cailean</Link>, <Link to="/faith/desna">Desna</Link>, <Link to="/faith/iomedae">Iomedae</Link>, <Link to="/faith/milani">Milani</Link>, <Link to="/faith/nethys">Nethys</Link>, <Link to="/faith/norgorber">Norgorber</Link>, <Link to="/faith/sarenrae">Sarenrae</Link>, <Link to="/faith/shelyn">Shelyn</Link></p>
<p><strong>Granted Powers:</strong> Your deity calls you to cast down a hostile government. Stealth is a class skill for you.</p>
<p><strong>Undermine Authority (Sp):</strong> A number of times per day equal to your Wisdom bonus, you can worsen the attitude of a character toward any governmental officer or leader acting against your religion. This likewise reduces that officer's or leader's influence with that character. The persuasion requires enough conversation to attempt a Diplomacy check (usually 1 minute) and you attempt a Diplomacy check as normal to influence the target's attitude. However, if you fail the check, the target is subject to a mind-affecting compulsion that alters its attitude for a number of days equal to your inquisitor level. The target can resist the compulsion with a successful Will saving throw (DC = 10 + 1/2 your inquisitor level + your Wisdom modifier). If the target is under a mind-affecting effect from that officer or leader, the effect is automatically suppressed for 1 minute.</p>
<p><strong>Rebel Leader (Ex):</strong> At 8th level, you gain <Link to="/feat/leadership">Leadership</Link> as a bonus feat.</p>
</>};
const _seduction = {title: "Seduction", jsx: <><h2 id="inquisition-seduction-seduction">Seduction</h2>
<p><strong>Sources</strong> <Link to="/source/inner_sea_intrigue">Inner Sea Intrigue pg. 30</Link><br/><strong>Deities</strong> <Link to="/faith/arshea">Arshea</Link>, <Link to="/faith/calistria">Calistria</Link>, <Link to="/faith/cayden_cailean">Cayden Cailean</Link>, <Link to="/faith/shelyn">Shelyn</Link></p>
<p><strong>Granted Powers:</strong> Your deity blesses your attempts to use sex and love for a higher purpose.</p>
<p><strong>Disarming Flirtation (Sp):</strong> You can attempt a Charisma check to entice a target that could be sexually attracted to you into letting you speak for up to 1 minute when it would otherwise be unwilling to consider your words. The DC of this Charisma check is equal to 10 + the target's Wisdom modifier. If successfully used in combat, this ability instead functions as a successful <Link to="/skill/feint">feint</Link> and the target cannot take any actions that would attack you as long as it is denied its Dexterity bonus against you.</p>
<p><strong>Inspire Devotion (Ex):</strong> By spending at least 1 hour engaged in acts of physical pleasure with a willing partner, you can attempt a Diplomacy check to improve that partner's attitude or increase your influence with that partner (or reduce a rival's influence with that partner) with no maximum on the number of steps by which you can change that partner's attitude or disposition.</p>
</>};
const _sin = {title: "Sin", jsx: <><h2 id="inquisition-sin-sin">Sin</h2>
<p><strong>Sources</strong> <Link to="/source/blood_of_fiends">Blood of Fiends pg. 27</Link><br/><strong>Deities</strong> <Link to="/faith/asmodeus">Asmodeus</Link>, <Link to="/faith/calistria">Calistria</Link>, <Link to="/faith/norgorber">Norgorber</Link>, <Link to="/faith/rovagug">Rovagug</Link>, <Link to="/faith/urgathoa">Urgathoa</Link>, <Link to="/faith/zon_kuthon">Zon-Kuthon</Link></p>
<p><strong>Granted Powers:</strong> You know how to stoke the seven sins in others (envy, gluttony, greed, lust, pride, sloth, and wrath), and twist their dark desires to suit your own purposes.</p>
<p><strong>Sin Sense (Su):</strong> As a full-round action, you can determine which sin most strongly influences a target by quickly reading its mind. Once you learn this fact, you gain a +4 bonus on your next Charisma-based skill check made against the target as long as it somehow incorporates a temptation that relates to that sin. You can use this ability a number of times per day equal to 3 + your Wisdom modifier. This is a mind-affecting effect.</p>
<p><strong>Indulge (Su):</strong> At 8th level, once per day as a standard action, you can awaken a creature's vice and overwhelm its senses with urgency. You must decide to use this ability before using your sin sense ability on a creature, and the target receives a Will save to negate the effect. If the creature fails its saving throw, for the next 24 hours, whenever the affected creature is given an opportunity to indulge in its favored sin, that creature must yield to the impulse or make a second Will saving throw to avoid becoming <Link to="/misc/sickened">sickened</Link> for 1 minute. This is a mind-affecting effect.</p>
</>};
...
<p><strong>Granted Powers:</strong> You gain the <Link to="/feat/disruptive">Disruptive</Link> feat as a bonus feat (even if you do not meet the prerequisites). When you defeat an enemy (whether by reducing it to 0 or fewer hit points, taking the enemy captive, or accepting a truce), you gain a +2 sacred or profane bonus to AC for 1 minute per level. You gain a sacred bonus if you are good, profane if you are evil; if you are neutral, you choose either sacred or profane when you select this inquisition. After you choose which type of bonus you gain, you cannot change the bonus type. When you hit a creature with levels of <Link to="/class/alchemist">alchemist</Link> or any arcane spellcasting class, or that uses spell-like abilities, you can end this effect to stagger that creature. The creature gets a Fortitude saving throw against this effect on each of its turns (including the turn in which it gained the effect). A successful save ends the <Link to="/misc/staggered">staggered</Link> condition.</p>
</>};
const _tactics = {title: "Tactics", jsx: <><h2 id="inquisition-tactics-tactics">Tactics</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 43</Link><br/><strong>Deities</strong> <Link to="/faith/gorum">Gorum</Link>, <Link to="/faith/irori">Irori</Link>, <Link to="/faith/torag">Torag</Link></p>
<p><strong>Granted Powers:</strong> It is the cold and tactical mind that often wins the day. A proper, carefully considered sacrifice can inspire one's allies to serve your cause.</p>
<p><strong>Inquisitor's Direction (Su):</strong> At the start of your turn, you can choose to enter a tranquil, reflective state and forgo all actions (standard, move, swift, immediate, and free actions, including attacks of opportunity) for that round; one ally of your choice within 30 feet gains the benefit of <Link to="/spell/haste">haste</Link> for 1 round. You can use this ability a number of times per day equal to your 3 + Wisdom bonus (minimum 1).</p>
<p><strong>Grant the Initiative (Ex):</strong> At 8th level, you and all allies within 30 feet may add your Wisdom bonus to your initiative checks.</p>
</>};
const _torture = {title: "Torture", jsx: <><h2 id="inquisition-torture-torture">Torture</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 44</Link><br/><strong>Deities</strong> <Link to="/faith/asmodeus">Asmodeus</Link>, <Link to="/faith/calistria">Calistria</Link>, <Link to="/faith/norgorber">Norgorber</Link>, <Link to="/faith/zon_kuthon">Zon-Kuthon</Link></p>
<p><strong>Granted Powers:</strong> Only through pain can truth and justice come to the surface. And if that doesn't work, at least you've enacted divine vengeance.</p>
<p><strong>Torturer's Presence (Ex):</strong> You gain a +2 bonus when using the Intimidate skill. This is in addition to your bonus for Stern Gaze.</p>
<p><strong>Torturer's Touch (Sp):</strong> You may use <Link to="/spell/touch_of_fatigue">touch of fatigue</Link> as a spell-like ability. Creatures that are immune to pain effects are immune to this touch. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.</p>
<p><strong>Critical Precision (Ex):</strong> At 8th level, when you roll a critical threat, you may expend one use of your torturer's touch ability to add +4 on your critical confirmation roll. This does not stack with <Link to="/feat/critical_focus">Critical Focus</Link>.</p>
</>};
const _true_death = {title: "True Death", jsx: <><h2 id="inquisition-true_death-true-death">True Death</h2>
<p><strong>Sources</strong> <Link to="/source/blood_of_angels">Blood of Angels pg. 27</Link><br/><strong>Deities</strong> <Link to="/faith/abadar">Abadar</Link>, <Link to="/faith/cayden_cailean">Cayden Cailean</Link>, <Link to="/faith/pharasma">Pharasma</Link></p>
<p><strong>Granted Powers:</strong> You see undead as a perversion of the natural order, a misuse of magic, or an unjust enslavement of a departed spirit's body, and are sworn to destroying such beings.</p>
<p><strong>Back to the Graves (Su):</strong> When you cast cure spells (any spells with <Link to="/main/spell_groupings">"cure"</Link> in their name) to deal damage to undead creatures, you add +2 points of damage per caster level instead of +1 point of damage per caster level. The maximum damage for each spell remains unchanged.</p>
<p><strong>Hallowed Rite (Su):</strong> At 8th level, you gain the ability to conduct a sacred funeral rite. This rite takes 1 day, during which you perform the necessary chants and prayers and burn incense. At the end of the rite you must oversee the burial of the corpse. The burial must take place within 24 hours of the preparation or the ritual fails. Once the body is interred, it cannot be turned into an undead creature, as if it were under the effect of a <Link to="/spell/hallow">hallow</Link> spell (caster level equal to your inquisitor level).</p>
</>};
const _truth = {title: "Truth", jsx: <><h2 id="inquisition-truth-truth">Truth</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 44</Link><br/><strong>Deities</strong> <Link to="/faith/iomedae">Iomedae</Link>, <Link to="/faith/pharasma">Pharasma</Link>, <Link to="/faith/sarenrae">Sarenrae</Link></p>
<p><strong>Granted Powers:</strong> To find truth, one has to wring honesty from others - whether in a friendly or hostile manner.</p>
<p><strong>Justice's True Path (Sp):</strong> As a standard action, you can touch a creature, granting an insight bonus on one attack roll, skill check, ability check, or saving throw before your next turn; this bonus is equal to half your inquisitor level (minimum 1) and lasts for 1 round. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.</p>
<p><strong>Grasp of Honesty (Su):</strong> At 8th level, any creature you are grappling or pinning is affected by <Link to="/spell/zone_of_truth">zone of truth</Link> (Will negates). Outside of combat, you may use this ability by touching a target with both hands. You can use this ability a number of rounds per day equal to your inquisitor level. These rounds do not need to be consecutive. The effect ends if you stop grappling, pinning, or touching the target.</p>
</>};
const _valor = {title: "Valor", jsx: <><h2 id="inquisition-valor-valor">Valor</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 44</Link><br/><strong>Deities</strong> <Link to="/faith/cayden_cailean">Cayden Cailean</Link>, <Link to="/faith/erastil">Erastil</Link>, <Link to="/faith/iomedae">Iomedae</Link>, <Link to="/faith/sarenrae">Sarenrae</Link></p>
<p><strong>Granted Powers:</strong> It takes courage to confront the enemies of your faith.</p>
<p><strong>Touch of Resolve (Sp):</strong> You may use <Link to="/spell/remove_fear">remove fear</Link> on a single creature a number of times per day equal to your 3 + your Wisdom bonus.</p>
<p><strong>Fearless (Su):</strong> At 8th level, you become immune to fear.</p>
</>};
const _vengeance = {title: "Vengeance", jsx: <><h2 id="inquisition-vengeance-vengeance">Vengeance</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 44</Link><br/><strong>Deities</strong> <Link to="/faith/calistria">Calistria</Link>, <Link to="/faith/lamashtu">Lamashtu</Link>, <Link to="/faith/norgorber">Norgorber</Link>, <Link to="/faith/rovagug">Rovagug</Link>, <Link to="/faith/urgathoa">Urgathoa</Link></p>
<p><strong>Granted Powers:</strong> Vengeance is justice naked of pretense. On your oath, you will deliver justice so unbounded.</p>
...
<p><strong>Final Vengeance (Su):</strong> At 8th level, once per day, you can make one melee attack against an opponent within reach in response to an attack that would reduce you to negative hit points. Once your attack is resolved, you suffer the normal effect of the attack that provoked this ability. Effects that kill you or do not reduce you to negative hit points (such as ability damage or drain, negative levels, and <Link to="/spell/disintegrate">disintegrate</Link>) do not trigger this ability.</p>
</>};
const _zeal = {title: "Zeal", jsx: <><h2 id="inquisition-zeal-zeal">Zeal</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 44</Link><br/><strong>Deities</strong> <Link to="/faith/erastil">Erastil</Link>, <Link to="/faith/nethys">Nethys</Link></p>
<p><strong>Granted Powers:</strong> An inquisitor needs unyielding zeal in order to make sure her deity's work is done.</p>
<p><strong>Zealous Surge (Sp):</strong> Once per day, when you are reduced to 0 or fewer hit points, you heal a number of hit points equal to your inquisitor level + your Wisdom modifier.</p>
<p><strong>Scourge of the Enemy (Ex):</strong> At 8th level, select one religion that is a rival or opponent of your religion. You treat members of this religion as if they were your <Link to="/ability/favored_enemy">favored enemy</Link> (as the ranger class ability), gaining a +2 bonus on the appropriate rolls. At 13th level, these bonuses increase to +4, and at 18th level, the bonuses increase to +6. These bonuses do not stack with other favored enemy bonuses (use the highest bonus that applies).</p>
</>};
