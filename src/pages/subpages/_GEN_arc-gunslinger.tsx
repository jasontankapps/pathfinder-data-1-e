...
<Ability id="deeds" extraClasses="hasSubs" icon={["info"]}>
...
<Pair title="Ability">The black powder vaulter can make two attacks with firearms while using the <em>shot on the run</em> deed.</Pair>
</Ability>
</>};
...
<Pair hl title="Replaces"><Link to="/deed/startling_shot">Startling shot</Link> deed</Pair>
<Pair title="Gained">At 7th Level</Pair>
<Pair title="Passive Ability">When the blatherskite succeeds at a saving throw against a spell or an effect that would cause him to be blinded, confused, dazed, fascinated, frightened, nauseated, paralyzed, or stunned, he can allow the effect to affect him normally. As long as he has at least 1 grit point, as an <strong className="hl">immediate action</strong> he can cause the creature from which the effect originated to lose its Dexterity bonus to AC for a number of rounds equal to half the duration of the effect (in rounds) or <Link to="/misc/half">half</Link> the gunslinger's level, whichever is lower (minimum 1 round). If he instead spends 1 grit point, he does not need to allow the effect to affect him normally to use this deed.</Pair>
</Ability>
</>};
...
<Pair title="Choice">A bolt ace can select one specific type of crossbow, such as <Link to="/eq-weapon/hand_crossbow">hand crossbow</Link> or <Link to="/eq-weapon/heavy_crossbow">heavy crossbow</Link>. She gains a bonus on damage rolls equal to her Dexterity modifier with that crossbow. Furthermore, when she scores a critical hit with that type of crossbow, her critical modifier increases by 1 (a &times;2 becomes a &times;3, for example).</Pair>
<Pair title="At 9th Level">She can pick a different type of crossbow, gaining the bonus damage and increased critical multiplier with that type of crossbow as well.</Pair>
<Pair title="At 13th Level">She can pick a third crossbow.</Pair>
<Pair title="At 17th Level">She can pick a fourth crossbow.</Pair>
</Ability>
</>};
...
<Pair title="Gained">At 11th Level</Pair>
<Pair title="Ability">A buccaneer can spend 2 grit points to use <Link to="/spell/old_salts_curse">old salt's curse</Link> as a spell-like ability.</Pair>
<Pair title="At 15th Level">She may use <Link to="/spell/black_mark">black mark</Link> instead.</Pair>
<Pair title="Special">The caster level for these spell-like abilities is equal to the buccaneer's class level, and the save DC is equal to 10 + her buccaneer level + her Charisma modifier.</Pair>
</Ability>
<Ability id="grit-ex" icon={["info"]}>
<Pair single id="grit-ex" flavor="Like the sea itself, a buccaneer is a force of nature.">Grit (Ex)</Pair>
<Pair hl title="Alters">Grit</Pair>
...
<Pair title="Ability">A buccaneer gains the ability to fortify her grit with strong drink. The act of drinking is a <strong className="hl">standard action</strong> that provokes attacks of opportunity, and each drink provides 1 grog point. Grog points can be used in place of grit points to fuel deeds or grit feats (including those requiring a minimum of 1 grit point to use).</Pair>
<Pair title="Passive Ability">She gains a morale bonus on saves against fear and a dodge bonus to AC against attacks of opportunity equal to her current grog point total.</Pair>
<Pair title="Special">The buccaneer can gain a maximum number of grog points each day equal to her Constitution modifier (minimum 1), and they last for 1 hour or until used, whichever comes first.</Pair>
</Ability>
<Ability id="bonus-feat" icon={["info"]}>
...
<Pair title="Passive Ability">Whenever an enemy misses a buccaneer with an attack of opportunity, it provokes an attack of opportunity from the buccaneer.</Pair>
</Ability>
</>};
...
<Pair hl title="Alters">Grit</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Info">At the start of each day, a bushwhacker gains grit points equal to her Wisdom modifier - 1 (minimum of 1).</Pair>
<Pair title="Ability">In addition to all the ways any gunslinger can regain grit, a bushwhacker who reduces a helpless or unaware opponent to 0 hit points or fewer also regains 1 grit point. This expands the way in which the bushwhacker gains grit points, so a bushwhacker who gains grit points in this way only gains 1 grit point for reducing a helpless or unaware opponent, not 2 grit points. This otherwise works like the gunslinger's <em>grit</em> ability.</Pair>
</Ability>
<Ability id="craven-deeds-ex" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="craven-deeds-ex">Craven Deeds (Ex)</Pair>
...
<Pair title="Ability">A bushwhacker deals extra damage when using a firearm to attack opponents who are unable to properly defend themselves. The extra damage is a number of d6s equal to <Link to="/misc/one_fourth">one-fourth</Link> of her gunslinger level.</Pair>
<Pair title="Special">Unlike with the <em>shifty shot</em> ability, she deals this extra damage regardless of whether or not she has any grit points when making the attack. Except for the requirement that she makes a firearm attack, this works identically to a rogue's <em>sneak attack</em> class feature. This extra damage stacks with <em>sneak attack</em> and the damage from <em>shifty shot.</em></Pair>
</Ability>
</>};
...
<Pair hl title="Replaces">Nimble</Pair>
<Pair title="Gained">At 2nd Level</Pair>
<Pair title="Ability">A commando gains the <Link to="/ability/favored_terrain">favored terrain</Link> ranger class feature.</Pair>
<Pair title="At 6th Level">The commando can select a second favored terrain.</Pair>
<Pair title="At 10th Level">She can pick a third favored terrain.</Pair>
...
<Pair title="Gained">At 5th Level</Pair>
<Pair title="Ability">A commando can learn how to create one <Link to="/ability/ranger_traps">ranger trap</Link> in place of gaining the next level of gun training. A commando can use a known trap a number of times per day equal to her Wisdom bonus (minimum 1). The DC for a commando's trap is equal to 10 + half her commando level + her Wisdom bonus, and it lasts 1 day per 2 levels she has.</Pair>
<Pair title="Special">A commando can set only extraordinary ranger traps with this ability; as with extraordinary ranger traps, the trap DC for these traps has a -2 penalty.</Pair>
</Ability>
</>};
...
<p>As he gains levels, the experimental gunsmith learns additional innovations from the list below. These represent constant and increasingly skilled tinkering with a single firearm in her possession, and when the experimental gunsmith gains an innovation, she may immediately apply it to her experimental firearm.</p>
</Pair>
<Pair title="At 5th Level">The gunslinger learns a second innovation.</Pair>
<Pair title="At 9th Level">The gunslinger learns a third innovation.</Pair>
<Pair title="At 13th Level">She learns a fourth innovation.</Pair>
...
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Ability">A firebrand gains a <Link to="/eq-weapon/dragon_pistol">dragon pistol</Link> as her battered firearm.</Pair>
</Ability>
<Ability id="wild-card-ex" icon={["info"]}>
<Pair single id="wild-card-ex">Wild Card (Ex)</Pair>
<Pair hl title="Alters">Grit</Pair>
<Pair title="Info">A firebrand uses her Charisma instead of Wisdom to determine the number of grit points she gains at the start of each day and to determine the DCs of her gunslinger deeds.</Pair>
...
<Pair hl title="Replaces">Gun training</Pair>
<Pair title="Gained">At 5th Level</Pair>
<Pair title="Ability">The firebrand gains the bombs ability as an <Link to="/class/alchemist">alchemist</Link> of her gunslinger level - 4, using her Charisma modifier in place of her Intelligence modifier to determine her number of bombs per day and the DC to avoid splash damage. The firebrand adds her Charisma modifier to her bombs' damage instead of her Intelligence modifier, even if she has the <em>throw anything</em> class feature. In addition, the firebrand's bombs are always under the effect of the <Link to="/discovery/explosive_bomb">explosive bomb</Link> discovery.</Pair>
<Pair title="Special">Firebrand levels do not stack with levels in other classes with the bombs class feature.</Pair>
</Ability>
</>};
const _graveslinger = {title: "Graveslinger", jsx: <><h2 id="arc-gunslinger-graveslinger-graveslinger">Graveslinger</h2>
<p><strong>Sources</strong> <Link to="/source/pathfinder_139_the_dead_road">Pathfinder #139: The Dead Road pg. 65</Link><br/>Graveslingers craft signature bullets to hunt down wandering undead. With this infused ammunition, they can take on the most resilient spectral foes with ease.</p>
<Ability id="deeds" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="deeds">Deeds</Pair>
...
<Pair hl title="Replaces">The bonus feat gained at 4th level</Pair>
<Pair title="Gained">At 4th Level</Pair>
<Pair title="Ability">The graveslinger gains <Link to="/feat/blind_fight">Blind-Fight</Link> as a bonus feat.</Pair>
<Pair title="Passive Ability">As long as she has 1 grit point, she can always act in surprise rounds that are triggered by haunts and incorporeal undead, even if she fails to notice them.</Pair>
</Ability>
</>};
...
<Pair title="Gained">At 9th Level</Pair>
<Pair title="Ability">When the gulch gunner successfully hits an adjacent target with a ranged firearm attack, she deals +1d6 points of damage.</Pair>
<Pair title="At 13th Level">The extra damage becomes +2d6.</Pair>
<Pair title="At 17th Level">The extra damage increases to +3d6.</Pair>
<Pair title="Special">Creatures immune to <Link to="/misc/precision_damage">precision damage</Link>, critical hits, or sneak attacks do not take this additional damage.</Pair>
</Ability>
</>};
const _gun_scavenger = {title: "Gun Scavenger", jsx: <><h2 id="arc-gunslinger-gun_scavenger-gun-scavenger">Gun Scavenger</h2>
<p><strong>Sources</strong> <Link to="/source/inner_sea_combat">Inner Sea Combat pg. 38</Link><br/>Although Alkenstar is the center of firearm production and innovation in the Inner Sea, the crack of flint and tang of gun smoke is enough to inspire enthusiasts elsewhere to try their hand at making their own guns using intuition instead of blueprints. A gun scavenger collects scraps, spare parts, and other components that might - if modified properly - give her firearm an extra edge.</p>
<Ability id="gunsmith" icon={["info"]}>
<Pair single id="gunsmith">Gunsmith</Pair>
<Pair hl title="Alters">Gunsmith</Pair>
...
<ul>
<li>Gives the firearm the <Link to="/misc/scatter">scatter</Link> weapon quality</li>
<li>Increases the damage dealt by the <Link to="/deed/pistol_whip">pistol-whip</Link> deed by one die size</li>
<li>Increases the firearm's range increment by 10 feet.</li>
</ul>
<p>A firearm with such a modification increases its misfire chance cumulatively by 1 each time it is fired until it misfires. When it does misfire, the effects of the temporary component are lost.</p>
</Pair>
...
<Pair hl title="Replaces">Nimble</Pair>
<Pair title="Gained">At 2nd Level</Pair>
<Pair title="Passive Ability">When shooting a firearm at a creature that has a dodge or insight bonus to its Armor Class, the gun scavenger treats the combined bonus as if it were 1 lower.</Pair>
<Pair title="At 6th Level">The reduction becomes 2.</Pair>
<Pair title="At 10th Level">The reduction increases to 3.</Pair>
<Pair title="At 14th Level">The reduction becomes 4.</Pair>
<Pair title="At 18th Level">The reduction increases to 5.</Pair>
</Ability>
</>};
...
<Pair hl title="Replaces"><Link to="/deed/gunslingers_dodge">Gunslinger's dodge</Link> deed</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Immediate Action">When the gun tank is wearing medium or heavy armor and is subject to a critical hit or <Link to="/ability/sneak_attack">sneak attack</Link>, she can spend 1 grit point to attempt to negate the critical hit or sneak attack damage. She has a 25% chance of doing so.</Pair>
<Pair title="At 10th Level">The negation chance becomes 50%.</Pair>
...
<Pair title="Gained">At 4th Level</Pair>
<Pair title="Passive Ability">Whenever she is wearing armor, the armor check penalty is reduced by <Link to="/misc/one_fourth">one-fourth</Link> of her gunslinger level (to a minimum of 0) and the maximum Dexterity bonus allowed by her armor increases by one-fourth of her gunslinger level.</Pair>
<Pair title="Special">This ability stacks with the <Link to="/class/fighter">fighter</Link> class ability of the same name. If the gun tank has both class features, she takes the most advantageous benefit of the two class features.</Pair>
</Ability>
</>};
const _gunner_squire = {title: "Gunner Squire", jsx: <><h2 id="arc-gunslinger-gunner_squire-gunner-squire">Gunner Squire</h2>
<p><strong>Sources</strong> <Link to="/source/knights_of_the_inner_sea">Knights of the Inner Sea pg. 20</Link><br/>Prepared to reload or repair her lord's firearms at a moment's notice, the gunner squire is an indispensable aid for knights skilled in the use of pistols and rifles.</p>
<Ability id="deeds" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="deeds">Deeds</Pair>
...
<Pair title="Gained">At 2nd Level</Pair>
<Pair title="Full-Round Action">A gunner squire can temporarily ensure the safety of a firearm she is holding, reducing its misfire chance by 1 (to a minimum of 0) on the next attack roll made with that firearm. This reduction does not stack with itself. This reduction occurs after any increases are calculated for firing with the <Link to="/misc/broken">broken</Link> condition, or for any other effect that might increase the misfire value of a firearm.</Pair>
</Ability>
</>};
...
<Pair hl title="Replaces"><Link to="/deed/gunslinger_initiative">Gunslinger initiative</Link> deed</Pair>
<Pair title="Gained">At 3rd Level</Pair>
<Pair title="Ability">As long as the maverick has at least 1 grit point, she can use flashy gunplay to intimidate her opponents. She gains the <Link to="/feat/dazzling_display">Dazzling Display</Link> feat and can use it with any firearm, even if she doesn't have <Link to="/feat/weapon_focus">Weapon Focus</Link> in that firearm.</Pair>
</Ability>
</>};
...
<Pair single id="gunsmith">Gunsmith</Pair>
<Pair hl title="Alters">Gunsmith</Pair>
<Pair title="Info">A musket master must take a <Link to="/eq-weapon/musket">musket</Link> when she chooses a battered firearm at 1st level.</Pair>
</Ability>
<Ability id="deeds" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="deeds">Deeds</Pair>
...
<Pair title="Gained">At 5th Level</Pair>
<Pair title="Ability">A musket master increases her skill with two-handed firearms. She gains a bonus on damage rolls equal to her Dexterity modifier, and when she misfires with a two-handed firearm, the misfire value increases by 2 instead of 4.</Pair>
<Pair title="At 9th Level">The damage bonus becomes +1.</Pair>
<Pair title="At 13th Level">The damage bonus increases to +2.</Pair>
<Pair title="At 17th Level">The damage bonus becomes +3.</Pair>
</Ability>
</>};
const _mysterious_stranger = {title: "Mysterious Stranger", jsx: <><h2 id="arc-gunslinger-mysterious_stranger-mysterious-stranger">Mysterious Stranger</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_combat">Ultimate Combat pg. 51</Link><br/>Gunslingers use a potent mixture of common sense and manual dexterity in order to control the fickle power of their weapons. But a few rare gunslingers seem to accomplish their chosen tasks purely through willpower and an unwillingness to ever give up. These mysterious strangers use their force of personality to keep going when the chips are down, often moving on from a region as soon as they accomplish their goals - hence the name.</p>
<Ability id="grit-ex" icon={["info"]}>
<Pair single id="grit-ex">Grit (Ex)</Pair>
<Pair hl title="Alters">Grit</Pair>
<Pair title="Info">A mysterious stranger is a force to be reckoned with. Instead of using her Wisdom to determine the number of grit points she gains at the start of each day, she uses Charisma. This ability works in all other ways like the gunslinger's <em>grit</em> class feature.</Pair>
</Ability>
<Ability id="deeds" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="deeds">Deeds</Pair>
...
<Pair hl title="Replaces">Nimble</Pair>
<Pair title="Gained">At 2nd Level</Pair>
<Pair title="Passive Ability">A mysterious stranger gains a +1 luck bonus on Will saving throws.</Pair>
...
<Pair title="Free Action">A mysterious stranger can ignore a firearm misfire.</Pair>
</Ability>
</>};
...
<Pair single id="gunsmith">Gunsmith</Pair>
<Pair hl title="Alters">Gunsmith</Pair>
<Pair title="Info">A pistolero must take a <Link to="/eq-weapon/pistol">pistol</Link> when she chooses a battered firearm at 1st level.</Pair>
</Ability>
<Ability id="deeds" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="deeds">Deeds</Pair>
...
<Pair title="Gained">At 5th Level</Pair>
<Pair title="Passive Ability">A pistolero increases her skill with one-handed firearms. She gains a bonus on damage rolls equal to her Dexterity modifier, and when she misfires with a one-handed firearm, the misfire value increases by 2 instead of 4.</Pair>
<Pair title="At 9th Level">The bonus on damage rolls becomes +2.</Pair>
<Pair title="At 13th Level">The bonus on damage rolls increases to +3.</Pair>
<Pair title="At 17th Level">The bonus on damage rolls becomes +4.</Pair>
</Ability>
</>};
...
<Pair title="Standard Action">Whenever he is on a plane that has an alignment or elemental trait, he can switch his attunement to match one of that plane's traits.</Pair>
<Pair title="Free Action">After reducing an outsider to 0 hit points or below, he can switch his attunement to match one of that outsider's subtypes.</Pair>
<Pair title="Special">He regains grit as normal from critical hits, but killing blows replenish his grit pool only if the target is an outsider.</Pair>
</Ability>
<Ability id="deeds" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="deeds">Deeds</Pair>
...
<ul>
<li>If he infuses his bullets with an alignment, his bullet's damage counts as that alignment for the purposes of overcoming DR</li>
<li>If he infuses his bullets with an element, half of his bullet's damage changes to an energy type determined by the element infused: acid (earth), cold (water), electricity (air), or fire (fire)</li>
</ul>
</Pair>
</Ability>
...
<Pair hl title="Replaces">Gun training</Pair>
<Pair title="Gained">At 5th Level</Pair>
<Pair title="Passive Ability">As long as he has at least 1 point in his grit pool, a planar rifter's weapon attacks deal an extra 1d6 points of damage of the same damage type reduced by his planar resistance. Aligned damage harms only creatures of an opposed alignment.</Pair>
<Pair title="At 13th Level">This damage increases to 2d6.</Pair>
</Ability>
</>};
const _scatter_gunner = {title: "Scatter Gunner", jsx: <><h2 id="arc-gunslinger-scatter_gunner-scatter-gunner">Scatter Gunner</h2>
<p><strong>Sources</strong> <Link to="/source/people_of_the_wastes">People of the Wastes pg. 12</Link><br/>Punishing firearms such as the blunderbuss and dragon pistol can lay waste to invaders in tight corridors, and the dwarves of Dongun Hold have pioneered masterful methods for making the most of these indiscriminate weapons.</p>
<Ability id="scatter-specialist" icon={["info"]}>
<Pair single id="scatter-specialist">Scatter Specialist</Pair>
<Pair hl title="Alters">Gunsmith</Pair>
<Pair title="Info">A scatter gunner must take a <Link to="/eq-weapon/blunderbuss">blunderbuss</Link> or <Link to="/eq-weapon/dragon_pistol">dragon pistol</Link> when he chooses a battered firearm at 1st level.</Pair>
</Ability>
<Ability id="deeds" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="deeds">Deeds</Pair>
...
<ul>
<li><strong className="hl">Restricted Barrel:</strong> The scattering shot attacks all creatures in a line rather than in a cone. The line's length is twice the length of the weapon's cone (30 feet for most early firearms).</li>
<li><strong className="hl">Shaped Blast:</strong> Select one additional square adjacent to the scattering shot's area of effect; creatures in this square are also affected by the scattering shot.</li>
<li><strong className="hl">Vortex:</strong> The firearm releases an explosive torrent of air in the scattering shot's affected area for 1 round, creating a strong <Link to="/rule/wind">wind</Link> effect (25 mph) that can disperse fog and smoke effects such as those created by <Link to="/spell/fog_cloud">fog cloud</Link>.</li>
</ul>
</Pair>
</Ability>
...
<Pair hl title="Replaces"><Link to="/deed/dead_shot">Dead shot</Link> deed</Pair>
<Pair title="Gained">At 7th Level</Pair>
<Pair title="Full-Round Action">A scatter gunner can make a scattering shot to fire a concentrated payload of pellets that strains his firearm. This doubles the area affected by the scattering shot (a 30-foot cone for most early firearms), increases the firearm's misfire value by 2, and causes each successful attack to deal an additional 1d6 points of damage that is not multiplied on a critical hit. The scatter gunner must spend 1 grit point to perform this deed.</Pair>
...
<Pair hl title="Replaces"><Link to="/deed/targeting">Targeting</Link> deed</Pair>
<Pair title="Gained">At 7th Level</Pair>
<Pair title="Full-Round Action">A scatter gunner can load and fire an explosive shell, consuming ammunition as though he had made a scattering shot. This functions like <Link to="/rule/throw_splash_weapon">throwing a splash weapon</Link> at a grid intersection but uses his firearm's range increment, attack bonus, and magic special abilities (if any). The shell affects creatures in a 10-foot radius as though the scatter gunner had made a scattering shot against them, and damaged creatures must succeed at a Reflex save (DC = 10 + half the scatter gunner's level + the scatter gunner's Dexterity modifier) or <Link to="/rule/catch_fire">catch fire</Link>.</Pair>
</Ability>
</>};
const _siege_gunner = {title: "Siege Gunner", jsx: <><h2 id="arc-gunslinger-siege_gunner-siege-gunner">Siege Gunner</h2>
<p><strong>Sources</strong> <Link to="/source/inner_sea_combat">Inner Sea Combat pg. 45</Link><br/>The Grand Duchy of Alkenstar has spawned all manner of firearm specialists, wielding small and large firearms alike. Siege gunners specialize in the very largest: <Link to="/eq-siegeengine/cannon">cannons</Link>, <Link to="/eq-siegeengine/bombard">bombards</Link>, and <Link to="/eq-siegeengine/firedrake">firedrakes</Link>. These specialists are rarely seen outside of Alkenstar, however, in part because the duchy keeps close tabs on its most powerful guns and few are found elsewhere in the Inner Sea. A few siege gunners outside of Alkenstar make a living renting out their services and the use of their personal collection of siege weaponry to causes in which they believe or to the highest bidder.</p>
<Ability id="grit-ex" icon={["info"]}>
<Pair single id="grit-ex">Grit (Ex)</Pair>
...
<Pair hl title="Replaces">Nimble</Pair>
<Pair title="Gained">At 2nd Level</Pair>
<Pair title="Passive Ability">A siege gunner gains a bonus on Knowledge (engineering) checks equal to 1/2 her gunslinger level.</Pair>
</Ability>
<Ability id="deeds" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="deeds">Deeds</Pair>
...
<Pair title="At 8th Level">She gains <Link to="/feat/master_siege_engineer">Master Siege Engineer</Link> as a bonus feat. She does not need to meet the prerequisites for this feat.</Pair>
<Pair title="At 12th Level">The siege gunner gains a bonus feat in addition to those gained by normal advancement. This must be a <Link to="/main/combat_feat">combat feat</Link> or <Link to="/main/grit_feat">grit feat</Link>, and she must meet the prerequisites as normal.</Pair>
<Pair title="At 16th Level">She gains another bonus combat or grit feat, as above.</Pair>
<Pair title="At 20th Level">She gains a third bonus combat or grit feat, as above.</Pair>
</Ability>
</>};
const _techslinger = {title: "Techslinger", jsx: <><h2 id="arc-gunslinger-techslinger-techslinger">Techslinger</h2>
<p><strong>Sources</strong> <Link to="/source/technology_guide">Technology Guide pg. 13</Link><br/>Techslingers spurn unreliable gunpowder weapons in favor of high-tech armaments. They learn to master the quirks of <Link to="/rule/timeworn_technology">timeworn technology</Link> and methods of keeping weapons charged in a primitive world. Techslingers still start play with the black powder blunderbuss, pistol, or rifle granted by the gunsmith class ability, but they gain specialized powers for use after they gain weapons of advanced technology. A techslinger has the following class features.</p>
<Ability id="deeds" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="deeds">Deeds</Pair>
...
<Pair hl title="Replaces"><Link to="/deed/expert_loading">Expert loading</Link></Pair>
<Pair title="Gained">At 11th Level</Pair>
<Pair title="Ability">By spending 1 grit point, a techslinger can grant 1 temporary charge to a technological firearm, even if the firearm normally can no longer be recharged. This charge must be used within 1 hour or it fades. The techslinger can grant temporary charges to multiple firearms as long as she has enough grit, but temporary charges do not stack with themselves in the same firearm.</Pair>
...
<Pair hl title="Replaces">Gun training</Pair>
<Pair title="Gained">At 5th Level</Pair>
<Pair title="Choice">A techslinger can select one specific type of advanced technology firearm (such as a <Link to="/tech-weapon/laser_pistol">laser pistol</Link>, <Link to="/tech-weapon/mindrender">mindrender</Link>, <Link to="/tech-weapon/stun_gun">stun gun</Link>, or <Link to="/tech-weapon/zero_rifle">zero rifle</Link>).</Pair>
<Pair title="Passive Ability">She gains a bonus equal to her Dexterity modifier on damage rolls when using that firearm. Furthermore, she treats all detrimental <Link to="/rule/weapon_glitches">glitches</Link> of <em>timeworn</em> versions of her selected firearm as a result of no glitch. (She can retain the effects of beneficial glitches if she wishes.)</Pair>
<Pair title="At 9th Level">The techslinger selects another type of advanced technology firearm, gaining these bonuses for that type as well.</Pair>
<Pair title="At 13th Level">She selects a third type, gaining the same benefits as above.</Pair>
<Pair title="At 17th Level">She selects a fourth type, gainaing the same benefits as above.</Pair>
</Ability>
</>};
...
<Pair hl title="Replaces">Nimble</Pair>
<Pair title="Gained">At 2nd Level</Pair>
<Pair title="Ability">As long as she has at least 1 grit point, a thronewarden can act in a surprise round even if she doesn't notice her enemies, though she remains <Link to="/rule/flat_footed">flat-footed</Link> until she acts.</Pair>
<Pair title="Passive Ability">She gains a +1 bonus on initiative checks.</Pair>
<Pair title="At 6th Level">The initiative bonus becomes +2.</Pair>
<Pair title="At 10th Level">The initiative bonus increases to +3. She can spend 1 grit point to take both a <strong className="hl">standard action</strong> and a <strong className="hl">move action</strong> (or a <strong className="hl">full-round action</strong>) during the surprise round.</Pair>
...
<Pair hl title="Replaces">The bonus feat gained at 4th level</Pair>
<Pair title="Gained">At 4th Level</Pair>
<Pair title="Ability">A thronewarden can spend 1 grit point when she attempts a Perception or Sense Motive check to roll 1d6 and add the result to the check. She can do this after she attempts the check but only before the result is revealed.</Pair>
</Ability>
<Ability id="deeds" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="deeds">Deeds</Pair>
...
<Pair title="At 9th Level">The gunslinger may again select another type of light siege engine.</Pair>
...
export default {black_powder_vaulter:_black_powder_vaulter,blatherskite:_blatherskite,bolt_ace:_bolt_ace,buccaneer:_buccaneer,bushwhacker:_bushwhacker,commando:_commando,experimental_gunsmith:_experimental_gunsmith,firebrand:_firebrand,graveslinger:_graveslinger,gulch_gunner:_gulch_gunner,gun_scavenger:_gun_scavenger,gun_tank:_gun_tank,gunner_squire:_gunner_squire,maverick:_maverick,musket_master:_musket_master,mysterious_stranger:_mysterious_stranger,pistolero:_pistolero,planar_rifter:_planar_rifter,scatter_gunner:_scatter_gunner,siege_gunner:_siege_gunner,techslinger:_techslinger,thronewarden:_thronewarden,wyrm_sniper:_wyrm_sniper}