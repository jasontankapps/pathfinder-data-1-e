...
<Ability id="ameliorating-su" icon={["aid","protect"]}>
...
<Ability id="aura-of-purity-su" icon={["aura","aid"]}>
...
<Ability id="beast-of-ill-omen-su" icon={["lower"]}>
...
<Ability id="blight-su" icon={["lower","touch"]}>
...
<Ability id="cackle-su" icon={["boost"]}>
...
<Ability id="cauldron-ex" icon={["power","boost"]}>
...
<Ability id="poison-steep-sp" icon={["magic"]}>
...
<Ability id="witchs-bottle-su" icon={["magic"]}>
...
<Ability id="charm-su" icon={["power"]}>
...
<Ability id="child-scent-ex" icon={["power"]}>
...
<Ability id="city-sight-su" icon={["lower"]}>
...
<Ability id="combat-hypnosis-su" icon={["magic"]}>
...
<Ability id="congeal-su" icon={["lower"]}>
...
<Ability id="coven-ex" icon={["boost"]}>
...
<Ability id="cursed-wound" icon={["lower"]}>
...
<Ability id="dark-apothecary-ex" icon={["boost"]}>
...
<Ability id="deathcall-su" icon={["lower","aura"]}>
...
<Ability id="discord-su" icon={["lower"]}>
...
<Ability id="disguise-sp" icon={["magic"]}>
...
<Ability id="disrupt-connection-su" icon={["lower"]}>
...
<Ability id="distraction-su" icon={["lower"]}>
...
<Ability id="enemy-ground-su" icon={["lower"]}>
...
<Ability id="feral-speech-su" icon={["power"]}>
...
<Ability id="flight-su" icon={["magic","boost"]}>
...
<Ability id="floating-lotus-su" icon={["magic","boost"]}>
...
<Ability id="fortune-su" icon={["roll","boost"]}>
...
<Ability id="gift-of-consumption-su" icon={["lower"]}>
...
<Ability id="greater-gift-of-consumption-su" icon={["lower"]}>
...
<Ability id="healing-su" icon={["aid"]}>
...
<Ability id="heralding-bloom-su" icon={["magic"]}>
...
<Ability id="iceplant-su" icon={["def"]}>
...
<Ability id="leshy-summoning-su" icon={["boost","magic"]}>
...
<Ability id="minor-prophecy-su" icon={["magic"]}>
...
<Ability id="misfortune-su" icon={["roll","lower"]}>
...
<Ability id="mothers-eye-su" icon={["power"]}>
...
<Ability id="murksight-su" icon={["power"]}>
...
<Ability id="nails-ex" icon={["melee"]}>
...
<Ability id="no-place-like-home-su" icon={["protect","lower"]}>
...
<Ability id="peacebond-su" icon={["lower"]}>
...
<Ability id="poison-touch-ex" icon={["melee"]}>
...
<Ability id="pollute-water-su" icon={["magic","lower"]}>
...
<Ability id="polluting-glance-su" icon={["magic","lower"]}>
...
<Ability id="prehensile-hair-su" icon={["melee"]}>
...
<Ability id="protective-luck-su" icon={["roll","protect"]}>
...
<Ability id="seduction-su" icon={["lower"]}>
...
<Ability id="slumber-su" icon={["magic"]}>
...
<Ability id="soothsayer-su" icon={["boost"]}>
...
<Ability id="summers-heat-su" icon={["lower"]}>
...
<Ability id="swamp-hag-sp" icon={["power","def"]}>
...
<Ability id="mud-witch-su" icon={["magic","def"]}>
...
<Ability id="swamps-grasp" icon={["power"]}>
...
<Ability id="swine-su" icon={["magic","lower"]}>
...
<Ability id="tongues-su" icon={["power"]}>
...
<Ability id="unnerve-beasts-su" icon={["lower"]}>
...
<Ability id="verdant-familiar-ex" icon={["power"]}>
...
<Ability id="ward-su" icon={["protect"]}>
...
<Ability id="water-lung-su" icon={["power"]}>
...
<Ability id="agony-su" icon={["lower"]}>
...
<Ability id="animal-skin" icon={["magic"]}>
...
<Ability id="beast-eye-su" icon={["magic"]}>
...
<Ability id="beasts-gift-su" icon={["melee"]}>
...
<Ability id="cook-people-su" icon={["magic"]}>
...
<Ability id="delicious-fright" icon={["lower","boost","def"]}>
...
<Ability id="drugged-su" icon={["lower"]}>
...
<Ability id="false-hospitality-su" icon={["magic"]}>
...
<Ability id="hags-eye-su" icon={["magic"]}>
...
<Ability id="harrowing-curse-su" icon={["lower"]}>
...
<Ability id="hidden-home-sp" icon={["def","magic"]}>
...
<Ability id="hoarfrost-su" icon={["lower"]}>
...
<Ability id="ice-tomb-su" icon={["lower"]}>
...
<Ability id="infected-wounds-su" icon={["lower"]}>
...
<Ability id="major-ameliorating-su" icon={["aid","protect"]}>
...
<Ability id="major-healing-su" icon={["aid"]}>
...
<Ability id="nightmares-su" icon={["lower"]}>
...
<Ability id="pariah-su" icon={["lower"]}>
...
<Ability id="prophecy-su" icon={["magic"]}>
...
<Ability id="regenerative-sinew-su" icon={["aid"]}>
...
<Ability id="restless-slumber-su" icon={["lower"]}>
...
<Ability id="retribution-su" icon={["lower"]}>
...
<Ability id="speak-in-dreams-sp" icon={["magic"]}>
...
<Ability id="steal-voice-su" icon={["lower"]}>
...
<Ability id="vision-su" icon={["magic"]}>
...
<Ability id="waxen-image-su" icon={["magic","lower"]}>
...
<Ability id="weather-control-su" icon={["magic"]}>
...
<Ability id="witchs-bounty-su" icon={["magic"]}>
...
<Ability id="witchs-brew-ex" icon={["power"]}>
...
<Ability id="witchs-charge-su" icon={["protect"]}>
...
<Ability id="withering-su" icon={["lower","boost"]}>
...
<Ability id="abominate-su" icon={["magic","lower"]}>
...
<Ability id="animal-servant-su" icon={["lower"]}>
...
<Ability id="curse-of-nonviolence-su" icon={["lower"]}>
...
<Ability id="death-curse-su" icon={["lower"]}>
...
<Ability id="death-interrupted-su" icon={["magic","aid"]}>
...
<Ability id="dire-prophecy-su" icon={["lower"]}>
...
<Ability id="eternal-slumber-su" icon={["lower"]}>
...
<Ability id="forced-reincarnation-su" icon={["lower","magic"]}>
...
<Ability id="lay-to-rest-sp" icon={["magic","lower"]}>
...
<Ability id="life-giver-su" icon={["aid"]}>
...
<Ability id="natural-disaster-su" icon={["magic"]}>
...
<Ability id="summon-spirit-sp" icon={["magic"]}>
...
<Ability id="witchs-hut-su" icon={["magic"]}>
