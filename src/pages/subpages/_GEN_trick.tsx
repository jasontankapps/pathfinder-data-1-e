...
<Ability id="astounding-avoidance" icon={["protect"]}>
...
<Ability id="break-stupor" icon={["aid","down"]}>
...
<Ability id="chain-of-eyes" icon={["power","down"]}>
...
<Ability id="compel-alacrity" icon={["boost","def"]}>
...
<Ability id="enchanting-words" icon={["boost"]}>
...
<Ability id="false-flanker" icon={["boost"]}>
...
<Ability id="fearsome-guise" icon={["magic","boost"]}>
...
<Ability id="fleet-in-shadows" icon={["boost"]}>
...
<Ability id="gift-of-will" icon={["protect"]}>
...
<Ability id="levitation-buffer" icon={["protect"]}>
...
<Ability id="life-revier" icon={["boost"]}>
...
<Ability id="linked-reaction" icon={["boost"]}>
...
<Ability id="mask-misery" icon={["aid"]}>
...
<Ability id="meek-facade" icon={["protect","magic"]}>
...
<Ability id="mesmeric-mirror" icon={["protect"]}>
...
<Ability id="mesmeric-pantomime" icon={["boost"]}>
...
<Ability id="misdirection" icon={["lower"]}>
...
<Ability id="psychic-impression" icon={["magic"]}>
...
<Ability id="psychosomatic-surge" icon={["aid"]}>
...
<Ability id="reflect-fear" icon={["aid"]}>
...
<Ability id="reflection-of-weakness" icon={["protect","lower"]}>
...
<Ability id="see-in-darkness" icon={["power"]}>
...
<Ability id="shadow-splinter" icon={["protect"]}>
...
<Ability id="slip-bonds" icon={["protect"]}>
...
<Ability id="spectral-smoke" icon={["protect"]}>
...
<Ability id="telepathic-link" icon={["power"]}>
...
<Ability id="umbral-shield" icon={["protect"]}>
...
<Ability id="unwitting-messenger" icon={["magic"]}>
...
<Ability id="vanish-arrow" icon={["protect"]}>
...
<Ability id="voice-of-reason" icon={["protect"]}>
...
<Ability id="allay-pain" icon={["protect"]}>
...
<Ability id="avian-escape" icon={["protect","magic"]}>
...
<Ability id="concealing-veil" icon={["protect"]}>
...
<Ability id="cursed-sanction" icon={["protect"]}>
...
<Ability id="faked-death" icon={["protect","magic"]}>
...
<Ability id="free-in-body" icon={["protect"]}>
...
<Ability id="greater-mask-misery" icon={["aid"]}>
...
<Ability id="mental-fallback" icon={["protect","magic"]}>
...
<Ability id="shadow-blend" icon={["protect"]}>
...
<Ability id="spatial-switch" icon={["magic"]}>
...
<Ability id="spell-anticipation" icon={["protect","magic"]}>
...
<Ability id="umbral-transformation" icon={["power","down"]}>
...
<Ability id="vision-of-blood" icon={["lower"]}>
...
<Ability id="willful-ignorance" icon={["power","protect"]}>
