...
<p><strong className="hl">Languages:</strong> This lists the <Link to="/misc/languages">languages</Link> necessary to navigate the library without magical aid or Linguistics checks. If a library has multiple languages, and the researcher does not possess the ability to read all the listed languages, she can still attempt checks, but for each language she doesn't know, she takes a -2 penalty on Research checks.</p>
