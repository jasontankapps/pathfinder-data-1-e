...
<Ability id="construct-eidolon-ex" icon={["info"]}>
<Pair single id="construct-eidolon-ex">Construct Eidolon (Ex)</Pair>
...
<Pair single id="natures-call">Nature's Call</Pair>
<Pair hl title="Alters">Summon monster</Pair>
...
<Ability id="fey-eidolon" extraClasses="hasSubs" icon={["info"]}>
...
<Pair title="At 12th Level">Fey eidolons gain DR 5/cold iron. They also grow gossamer wings, gaining the <Link to="/unchevolution/flight">flight</Link> evolution.</Pair>
...
<section data-footnotes><h3 id="arc-unchained_summoner-fey_caller-label">Footnotes</h3><ol>
<li id="arc-unchained_summoner-fey_caller-fake-fn-1-target"><p>There is no such unchained evolution. Consider using the original summoner's <Link to="/evolution/low_light_vision">low-light vision</Link> evolution. Consult your GM. <InnerLink aria-label="Back to reference 1" id="backlink-arc-unchained_summoner-fey_caller-fake-fn-1" data-hash-target to="arc-unchained_summoner-fey_caller-fake-fn-1">↩</InnerLink></p></li>
</ol></section></>};
