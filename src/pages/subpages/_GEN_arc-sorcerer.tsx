...
<Ability id="familiar" extraClasses="hasSubs" icon={["power","down"]}>
...
<Ability id="unliving-physiology-su" extraClasses="subAbility" icon={["power","down"]}>
...
<Ability id="bloodlines" icon={["power"]}>
...
<Ability id="class-skill" icon={["skill"]}>
...
<Ability id="bloodline-arcana" icon={["power"]}>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-sorcerer-dragon_drinker--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><Link to="/sorcbloodline/draconic">Draconic</Link> bloodline</td></tr></tbody></table></ScrollContainer></div><Ability id="bleeding-spells-su" icon={["boost"]}>
...
<Ability id="blood-drinking-su" icon={["power","boost","aid","def"]}>
...
<Ability id="energy-assimilation-su" icon={["def"]}>
...
<Ability id="breath-mimicry-su" icon={["cone","line"]}>
...
<Ability id="blood-siphon-su" icon={["power","aid","def"]}>
...
<Ability id="martial-flexibility-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="martial-flexibility-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="bloodline-weapons" icon={["melee"]}>
...
<Ability id="mongrel-reservoir-su" icon={["magic"]}>
...
<Ability id="bloodline-spells" icon={["learn"]}>
...
<Ability id="false-piety-ex" icon={["power","boost"]}>
...
<Ability id="lay-healer-su" icon={["learn"]}>
...
<Ability id="razmiran-channel-su" icon={["magic"]}>
...
<Ability id="seeker-magic-su" icon={["boost"]}>
...
<Ability id="pesh-expert" icon={["boost"]}>
...
<Ability id="sahir-afiyun" icon={["power"]}>
...
<Ability id="pesh-touch-su" icon={["touch","boost","lower"]}>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-sorcerer-stone_warder--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><Link to="/sorcbloodline/deep_earth">deep earth</Link>, <Link to="/sorcbloodline/draconic">draconic</Link> (copper dragon only), <Link to="/sorcbloodline/elemental">elemental</Link> (earth only), <Link to="/sorcbloodline/orc">orc</Link>, or <Link to="/sorcbloodline/shaitan">shaitan</Link> bloodline</td></tr></tbody></table></ScrollContainer></div><Ability id="power-of-stone-su" icon={["boost","down"]}>
...
<Ability id="rune-of-warding-sp" icon={["magic"]}>
...
<Ability id="familiar-tattoo-su" icon={["power"]}>
...
<Ability id="varisian-tattoo-ex" icon={["power"]}>
...
<Ability id="bloodline-tattoos-ex" icon={["magic"]}>
...
<Ability id="create-spell-tattoo-su" icon={["touch"]}>
...
<Ability id="enhanced-varisian-tattoo-su" icon={["magic"]}>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-sorcerer-umbral_scion--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><Link to="/sorcbloodline/shadow">Shadow</Link> bloodline</td></tr></tbody></table></ScrollContainer></div><Ability id="diminished-spellcasting" icon={["down"]}>
...
<Ability id="shrouded-spells-su" icon={["boost"]}>
...
<Ability id="encroaching-darkness-su" icon={["magic"]}>
...
<Ability id="potent-shadows-su" icon={["boost"]}>
...
<Ability id="crippling-darkness-su" icon={["boost"]}>
...
<Ability id="expanded-wishcraft" icon={["learn"]}>
...
<Ability id="hearts-desire-su" icon={["magic"]}>
...
<Ability id="twisted-wish-su" icon={["lower"]}>
...
<Ability id="perfect-wishcraft-su" icon={["magic"]}>
