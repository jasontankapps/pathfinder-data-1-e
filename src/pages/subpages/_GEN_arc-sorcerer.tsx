...
<Ability id="familiar" extraClasses="hasSubs" icon={["stairs-goal","broken-shield"]}>
...
<Ability id="unliving-physiology-su" extraClasses="subAbility" icon={["stairs-goal","broken-shield"]}>
...
<Ability id="bloodlines" icon={["stairs-goal"]}>
<Pair single id="bloodlines">Bloodlines</Pair>
...
<Ability id="bloodline-arcana" icon={["stairs-goal"]}>
<Pair single id="bloodline-arcana">Bloodline Arcana</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-sorcerer-dragon_drinker--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><Link to="/sorcbloodline/draconic">Draconic</Link> bloodline</td></tr></tbody></table></ScrollContainer></div><Ability id="bleeding-spells-su" icon={["upgrade"]}>
<Pair single id="bleeding-spells-su">Bleeding Spells (Su)</Pair>
...
<Ability id="blood-drinking-su" icon={["stairs-goal","upgrade","remedy","armor-upgrade"]}>
<Pair single id="blood-drinking-su">Blood Drinking (Su)</Pair>
<Pair hl title="Replaces">1st-level bloodline power</Pair>
...
<Ability id="energy-assimilation-su" icon={["armor-upgrade"]}>
<Pair single id="energy-assimilation-su">Energy Assimilation (Su)</Pair>
...
<Ability id="breath-mimicry-su" icon={["tornado-discs","barbed-arrow"]}>
<Pair single id="breath-mimicry-su">Breath Mimicry (Su)</Pair>
...
<Ability id="blood-siphon-su" icon={["stairs-goal","remedy","armor-upgrade"]}>
<Pair single id="blood-siphon-su">Blood Siphon (Su)</Pair>
...
<Ability id="martial-flexibility-ex" extraClasses="hasSubs" icon={["stairs-goal"]}>
...
<Ability id="martial-flexibility-ex" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="martial-flexibility-ex" flavor="Text from the brawler class ability.">Martial Flexibility (Ex)</Pair>
...
<Ability id="bloodline-weapons" icon={["mailed-fist"]}>
<Pair single id="bloodline-weapons">Bloodline Weapons</Pair>
...
<Ability id="bloodline-spells" icon={["spell-book"]}>
<Pair single id="bloodline-spells">Bloodline Spells</Pair>
...
<Pair single id="false-piety-ex">False Piety (Ex)</Pair>
...
<Ability id="lay-healer-su" icon={["spell-book"]}>
<Pair single id="lay-healer-su">Lay Healer (Su)</Pair>
...
<Ability id="razmiran-channel-su" icon={["magic-swirl"]}>
<Pair single id="razmiran-channel-su">Razmiran Channel (Su)</Pair>
...
<Pair single id="seeker-lore-ex" flavor="A seeker has already learned much about his bloodline, and is more comfortable using the bonus spells gained by that bloodline.">Seeker Lore (Ex)</Pair>
...
<Ability id="seeker-magic-su" icon={["upgrade"]}>
<Pair single id="seeker-magic-su" flavor="A seeker becomes skilled at modifying his bloodline spells with metamagic.">Seeker Magic (Su)</Pair>
...
<Ability id="pesh-expert" icon={["upgrade"]}>
<Pair single id="pesh-expert">Pesh Expert</Pair>
<Pair hl title="Replaces">Bloodline arcana</Pair>
...
<Ability id="sahir-afiyun" icon={["stairs-goal"]}>
<Pair single id="sahir-afiyun">Sahir-Afiyun</Pair>
<Pair hl title="Replaces">Eschew materials</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="pesh-touch-su" icon={["magic-palm","upgrade","armor-downgrade"]}>
<Pair single id="pesh-touch-su">Pesh Touch (Su)</Pair>
<Pair hl title="Replaces">1st-level bloodline power</Pair>
<Pair title="Usage">3 + Charisma modifier times/day</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-sorcerer-stone_warder--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><Link to="/sorcbloodline/deep_earth">deep earth</Link>, <Link to="/sorcbloodline/draconic">draconic</Link> (copper dragon only), <Link to="/sorcbloodline/elemental">elemental</Link> (earth only), <Link to="/sorcbloodline/orc">orc</Link>, or <Link to="/sorcbloodline/shaitan">shaitan</Link> bloodline</td></tr></tbody></table></ScrollContainer></div><Ability id="power-of-stone-su" icon={["upgrade","broken-shield"]}>
<Pair single id="power-of-stone-su" flavor="A stone warder draws power from natural rock.">Power of Stone (Su)</Pair>
...
<Ability id="rune-of-warding-sp" icon={["magic-swirl"]}>
<Pair single id="rune-of-warding-sp">Rune of Warding (Sp)</Pair>
...
<Ability id="familiar-tattoo-su" icon={["stairs-goal"]}>
<Pair single id="familiar-tattoo-su">Familiar Tattoo (Su)</Pair>
<Pair hl title="Replaces">1st-level bloodline power</Pair>
...
<Ability id="varisian-tattoo-ex" icon={["stairs-goal"]}>
<Pair single id="varisian-tattoo-ex">Varisian Tattoo (Ex)</Pair>
<Pair hl title="Replaces">Eschew Materials bonus feat</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="bloodline-tattoos-ex" icon={["magic-swirl"]}>
<Pair single id="bloodline-tattoos-ex">Bloodline Tattoos (Ex)</Pair>
...
<Ability id="create-spell-tattoo-su" icon={["magic-palm"]}>
<Pair single id="create-spell-tattoo-su">Create Spell Tattoo (Su)</Pair>
<Pair hl title="Replaces">7th-level bloodline feat</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="enhanced-varisian-tattoo-su" icon={["magic-swirl"]}>
<Pair single id="enhanced-varisian-tattoo-su">Enhanced Varisian Tattoo (Su)</Pair>
<Pair hl title="Replaces">9th-level bloodline power</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-sorcerer-umbral_scion--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><Link to="/sorcbloodline/shadow">Shadow</Link> bloodline</td></tr></tbody></table></ScrollContainer></div><Ability id="diminished-spellcasting" icon={["broken-shield"]}>
...
<Ability id="shrouded-spells-su" icon={["upgrade"]}>
<Pair single id="shrouded-spells-su" flavor="An umbral scion is enveloped by wisps of shadow whenever she casts a spell.">Shrouded Spells (Su)</Pair>
...
<Ability id="encroaching-darkness-su" icon={["magic-swirl"]}>
<Pair single id="encroaching-darkness-su" flavor="An umbral scion is capable of influencing light around her.">Encroaching Darkness (Su)</Pair>
<Pair hl title="Replaces">1st-level bloodline power</Pair>
<Pair title="Usage">3 + Charisma modifier times/day</Pair>
...
<Ability id="potent-shadows-su" icon={["upgrade"]}>
<Pair single id="potent-shadows-su">Potent Shadows (Su)</Pair>
<Pair hl title="Replaces">7th-level bloodline feat</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="crippling-darkness-su" icon={["upgrade"]}>
<Pair single id="crippling-darkness-su">Crippling Darkness (Su)</Pair>
<Pair hl title="Replaces">13th-level bloodline feat</Pair>
<Pair title="Gained">At 13th Level</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-sorcerer-wishcrafter--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><Link to="/race/ifrit">Ifrit</Link></td></tr></tbody></table></ScrollContainer></div><Ability id="wishbound-arcana-su" icon={["magic-swirl","upgrade"]}>
<Pair single id="wishbound-arcana-su" flavor="The wishcrafter can use the wishes of non-genie creatures other than herself in place of the normal verbal components of her spells.">Wishbound Arcana (Su)</Pair>
<Pair hl title="Replaces">Bloodline arcana</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="expanded-wishcraft" icon={["spell-book"]}>
<Pair single id="expanded-wishcraft" flavor="The wishcrafter grows more adept at altering reality to fit the whims of others.">Expanded Wishcraft</Pair>
...
<Ability id="hearts-desire-su" icon={["magic-swirl"]}>
<Pair single id="hearts-desire-su">Heart's Desire (Su)</Pair>
<Pair hl title="Replaces">7th-level bloodline feat</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="twisted-wish-su" icon={["armor-downgrade"]}>
<Pair single id="twisted-wish-su" flavor="A wishcrafter becomes adept at corrupting wishes to negatively affect the creature that wished them.">Twisted Wish (Su)</Pair>
<Pair hl title="Replaces">13th-level bloodline feat</Pair>
<Pair title="Gained">At 13th Level</Pair>
...
<Ability id="perfect-wishcraft-su" icon={["magic-swirl"]}>
<Pair single id="perfect-wishcraft-su" flavor="The wishcrafter perfects her ability to manipulate reality.">Perfect Wishcraft (Su)</Pair>
<Pair hl title="Replaces">19th-level bloodline feat</Pair>
<Pair title="Gained">At 19th Level</Pair>
