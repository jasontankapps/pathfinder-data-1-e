...
<Ability id="warding-talisman-su" icon={["def"]}>
...
<Ability id="mind-barrier-sp" icon={["def"]}>
...
<Ability id="energy-shield-sp" icon={["def"]}>
...
<Ability id="globe-of-negation-sp" icon={["def"]}>
...
<Ability id="loci-sentry-sp" icon={["magic"]}>
...
<Ability id="planar-ward-sp" icon={["def"]}>
...
<Ability id="unraveling-sp" icon={["magic"]}>
...
<Ability id="grandmothers-ward-su" icon={["def"]}>
...
<Ability id="casting-focus-su" icon={["boost"]}>
...
<Ability id="servitor-sp" icon={["magic"]}>
...
<Ability id="conjure-implement-sp" icon={["magic"]}>
...
<Ability id="flesh-mend-sp" icon={["aid"]}>
...
<Ability id="mind-steed-sp" icon={["magic"]}>
...
<Ability id="psychic-fog-sp" icon={["magic"]}>
...
<Ability id="purge-corruption-sp" icon={["aid"]}>
...
<Ability id="side-step-sp" icon={["magic"]}>
...
<Ability id="amber-prison-su" icon={["magic","lower"]}>
...
<Ability id="third-eye-su" icon={["boost","power"]}>
...
<Ability id="sudden-insight-sp" icon={["boost"]}>
...
<Ability id="danger-sight-sp" icon={["def"]}>
...
<Ability id="future-gaze-sp" icon={["magic"]}>
...
<Ability id="mind-eye-sp" icon={["magic"]}>
...
<Ability id="object-seer-sp" icon={["magic"]}>
...
<Ability id="powerful-connection-su" icon={["boost"]}>
...
<Ability id="watchful-eye-sp" icon={["magic"]}>
...
<Ability id="glorious-presence-su" icon={["boost"]}>
...
<Ability id="cloud-mind-su" icon={["lower"]}>
...
<Ability id="binding-pattern-sp" icon={["lower"]}>
...
<Ability id="forced-alliance-sp" icon={["magic"]}>
...
<Ability id="mind-slumber-sp" icon={["lower"]}>
...
<Ability id="forgotten-sp" icon={["magic"]}>
...
<Ability id="intense-focus-su" icon={["boost"]}>
...
<Ability id="energy-ray-sp" icon={["zap"]}>
...
<Ability id="energy-blast-sp" icon={["magic"]}>
...
<Ability id="energy-ward-sp" icon={["def"]}>
...
<Ability id="light-matrix-sp" icon={["magic","touch"]}>
...
<Ability id="radiance-sp" icon={["magic","lower"]}>
...
<Ability id="shape-mastery-su" icon={["boost"]}>
...
<Ability id="wall-of-power-sp" icon={["magic"]}>
...
<Ability id="footsteps-of-the-rough-beast-su" icon={["magic"]}>
...
<Ability id="distortion-sp" icon={["def"]}>
...
<Ability id="minor-figment-sp" icon={["magic"]}>
...
<Ability id="cloak-image-sp" icon={["def","magic"]}>
...
<Ability id="color-beam-sp" icon={["zap"]}>
...
<Ability id="masquerade-sp" icon={["magic"]}>
...
<Ability id="mirage-sp" icon={["magic"]}>
...
<Ability id="shadow-beast-sp" icon={["magic"]}>
...
<Ability id="unseen-sp" icon={["def","protect"]}>
...
<Ability id="psychic-mirage-sp" icon={["def"]}>
...
<Ability id="necromantic-focus-su" icon={["boost","lower"]}>
...
<Ability id="mind-fear-sp" icon={["lower"]}>
...
<Ability id="flesh-rot-sp" icon={["touch"]}>
...
<Ability id="necromantic-servant-sp" icon={["magic"]}>
...
<Ability id="pain-wave-sp" icon={["lower"]}>
...
<Ability id="psychic-curse-sp" icon={["lower"]}>
...
<Ability id="soulbound-puppet-su" icon={["power"]}>
...
<Ability id="spirit-shroud-su" icon={["def"]}>
...
<Ability id="wake-su" icon={["boost","lower"]}>
...
<Ability id="mind-over-gravity-sp" icon={["power"]}>
...
<Ability id="philosophers-touch-su" icon={["boost"]}>
...
<Ability id="quickness-sp" icon={["boost"]}>
...
<Ability id="size-alteration-sp" icon={["magic","down","touch"]}>
...
<Ability id="sudden-speed-sp" icon={["boost"]}>
...
<Ability id="telekinetic-mastery-sp" icon={["magic"]}>
...
<Ability id="parity-su" icon={["magic"]}>
...
<Ability id="scholarly-knowledge-su" icon={["boost","magic"]}>
...
<Ability id="metamagic-knowledge-su" icon={["power"]}>
...
<Ability id="metamagic-master-su" icon={["boost"]}>
...
<Ability id="spell-power-su" icon={["boost"]}>
...
<Ability id="actors-skill-su" icon={["boost","def"]}>
...
<Ability id="false-persona-su" icon={["def"]}>
...
<Ability id="false-confidence-sp" icon={["boost","def","lower"]}>
...
<Ability id="hypnotic-gaze-sp" icon={["magic"]}>
...
<Ability id="puppet-master-sp" icon={["magic"]}>
...
<Ability id="font-of-healing-su" icon={["aid"]}>
...
<Ability id="restoring-touch-sp" icon={["aid"]}>
...
<Ability id="guardian-aura-sp" icon={["aura","def","protect","down"]}>
...
<Ability id="martyrs-benediction-sp" icon={["aid"]}>
...
<Ability id="rebuke-anathema-sp" icon={["def"]}>
...
<Ability id="martial-skill-ex" icon={["boost"]}>
...
<Ability id="combat-trick-ex" icon={["power"]}>
...
<Ability id="shield-ally-ex" icon={["protect"]}>
...
<Ability id="warriors-resilience-su" icon={["aid"]}>
