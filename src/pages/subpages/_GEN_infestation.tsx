...
<AffInfo start type="Infestation" save="Fort 15" freq="1/hour" onset="4d6 hours" eff={<>1d6 <Link to="/rule/con_damage">Con damage</Link></>} undefined icon="i" />
...
<p><strong>Sources</strong> <Link to="/source/gamemastery_guide">GameMastery Guide pg. 244</Link></p>
<AffInfo start type="Infestation" save="Fort 17" freq="1/round" onset="immediate" eff={<>1d2 per grub <Link to="/rule/con_damage">Con damage</Link></>} undefined icon="i" />
