...
<Ability id="exotic-mount-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="small-size" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="medium-size" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="castle-defender" icon={["def","boost"]}>
...
<Ability id="castle-lore" icon={["boost"]}>
...
<Ability id="guard-companion" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="ranger-animal-companions" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="mighty-defense" icon={["boost","melee"]}>
...
<Ability id="defending-challenge" icon={["def"]}>
...
<Ability id="supreme-defense" icon={["boost","melee"]}>
...
<Ability id="weapon-and-armor-proficiency" icon={["down","boost"]}>
...
<Ability id="natural-mount-ex" icon={["power"]}>
...
<Ability id="thundering-hooves-ex" icon={["boost"]}>
...
<Ability id="courser-ex" icon={["boost"]}>
...
<Ability id="ride-down-ex" icon={["melee"]}>
...
<Ability id="circuit-ex" icon={["boost"]}>
...
<Ability id="sentence-ex" icon={["power","boost","down"]}>
...
<Ability id="double-jeopardy-ex" icon={["boost"]}>
...
<Ability id="apprehend-ex" icon={["power","boost"]}>
...
<Ability id="squad-commander-ex" icon={["boost"]}>
...
<Ability id="quick-interrogator-ex" icon={["boost"]}>
...
<Ability id="badge-ex" icon={["def","boost"]}>
...
<Ability id="instant-order-ex" icon={["power"]}>
...
<Ability id="greater-badge-ex" icon={["def"]}>
...
<Ability id="social-presence-ex" icon={["boost"]}>
...
<Ability id="grand-boast-ex" icon={["power"]}>
...
<Ability id="champions-finesse-ex" icon={["power"]}>
...
<Ability id="champions-weapon-mastery-ex" icon={["melee","boost"]}>
...
<Ability id="aides-de-camp-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="groom-cohort-role" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="squire-cohort-role" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="standard-bearer-cohort-role" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="footman-follower-role" extraClasses="subAbility" icon={["boost","down"]}>
...
<Ability id="honor-guard-follower-role" extraClasses="subAbility" icon={["def","down"]}>
...
<Ability id="shared-challenge-ex" icon={["power","boost"]}>
...
<Ability id="supreme-tactician-ex" icon={["power"]}>
...
<Ability id="bigger-they-are-ex" icon={["def"]}>
...
<Ability id="pike-charge-ex" icon={["boost","def"]}>
...
<Ability id="monster-hunter-ex" icon={["boost"]}>
...
<Ability id="agile-charger-ex" icon={["boost"]}>
...
<Ability id="deadly-charge-ex" icon={["boost"]}>
...
<Ability id="drake-mount" icon={["power","down"]}>
...
<Ability id="in-or-out-of-the-saddle-ex" icon={["power","boost"]}>
...
<Ability id="battlefield-agility-ex" icon={["power"]}>
...
<Ability id="mounted-acrobatics-ex" icon={["power"]}>
...
<Ability id="mounted-dervish-ex" icon={["power","boost"]}>
...
<Ability id="erratic-charge-ex" icon={["power"]}>
...
<Ability id="aide-de-camp-ex" icon={["power"]}>
...
<Ability id="teamwork-ex" icon={["power"]}>
...
<Ability id="shared-challenge-ex" icon={["boost"]}>
<Pair single id="shared-challenge-ex">Shared Challenge (Ex)</Pair>
<Pair hl title="Replaces">Expert trainer</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="banner-ex" icon={["power","boost"]}>
...
<Ability id="avenge-me-ex" icon={["power"]}>
...
<Ability id="fight-as-one-ex" icon={["boost"]}>
...
<Ability id="rampage-ex" icon={["power","boost"]}>
...
<Ability id="dread-rider-ex" icon={["boost","power"]}>
...
<Ability id="fell-presence-ex" icon={["lower","aura"]}>
...
<Ability id="deadly-rampage-ex" icon={["def","melee"]}>
...
<Ability id="terror-ex" icon={["lower","aura"]}>
...
<Ability id="unstoppable-rampage-ex" icon={["power","melee","boost"]}>
...
<Ability id="serpent-mount-ex" icon={["power"]}>
...
<Ability id="honored-warrior-ex" icon={["power","boost"]}>
...
<Ability id="code-of-gallantry" icon={["info","warning"]}>
...
<Ability id="symbol-of-inspiration-ex" icon={["def","aura"]}>
...
<Ability id="symbol-of-resilience-su" icon={["def"]}>
...
<Ability id="transfixing-charge-ex" icon={["boost"]}>
...
<Ability id="ghost-mount-su" icon={["power"]}>
...
<Ability id="frightful-gaze-su" icon={["zap"]}>
...
<Ability id="fearless-su" icon={["def"]}>
...
<Ability id="spirited-mount-su" icon={["boost","magic"]}>
...
<Ability id="ghost-wind-su" icon={["magic","power"]}>
...
<Ability id="implacable-knight-ex" icon={["power"]}>
...
<Ability id="ferocious-ex" icon={["boost","def"]}>
...
<Ability id="oaken-vitality-su" icon={["def"]}>
...
<Ability id="take-their-heads-su" icon={["boost"]}>
...
<Ability id="indestructible-su" icon={["boost","def"]}>
...
<Ability id="introduction-ex" icon={["roll","power"]}>
...
<Ability id="fleet-of-foot-ex" icon={["power","boost"]}>
...
<Ability id="transcend-language-sp" icon={["magic"]}>
...
<Ability id="sworn-defense-ex" icon={["down","def"]}>
...
<Ability id="intercept-ex" icon={["power","def"]}>
...
<Ability id="warding-charge-ex" icon={["def"]}>
...
<Ability id="defensive-challenge-ex" icon={["lower"]}>
...
<Ability id="feytouched-mount" icon={["power"]}>
...
<Ability id="hero-of-the-roads-ex" icon={["boost"]}>
...
<Ability id="champion-of-the-roads-sp" icon={["magic"]}>
...
<Ability id="paragon-of-the-roads-sp" icon={["boost"]}>
...
<Ability id="hunting-pack-ex" icon={["power","boost"]}>
...
<Ability id="bestial-challenge-ex" icon={["boost","down"]}>
...
<Ability id="swift-tracker-ex" icon={["power"]}>
...
<Ability id="pack-attack-ex" icon={["melee","boost"]}>
...
<Ability id="improved-quarry-ex" icon={["power"]}>
...
<Ability id="fast-mount-ex" icon={["boost"]}>
...
<Ability id="skillful-rider-ex" icon={["boost"]}>
...
<Ability id="maneuverable-mount-ex" icon={["boost","def"]}>
...
<Ability id="sudden-swerve-ex" icon={["power"]}>
...
<Ability id="shield-expertise" icon={["power"]}>
...
<Ability id="heraldic-banner-ex" icon={["power"]}>
...
<Ability id="soul-shield-su" icon={["def"]}>
...
<Ability id="heart-shield-su" icon={["def"]}>
...
<Ability id="far-challenge-ex" icon={["ranged","boost","down"]}>
...
<Ability id="careful-aim" icon={["ranged","boost"]}>
...
<Ability id="infuriating-aim-ex" icon={["lower"]}>
...
<Ability id="versatile-challenge-ex" icon={["power"]}>
...
<Ability id="supreme-aim-ex" icon={["boost"]}>
...
<Ability id="gifted-firearm-ex" icon={["power","ranged","warning"]}>
...
<Ability id="swift-powder-ex" icon={["power"]}>
...
<Ability id="aquatic-mount" icon={["power"]}>
...
<Ability id="maneuver-tactics-ex" icon={["power"]}>
...
<Ability id="mindlink-su" icon={["def","melee"]}>
...
<Ability id="mindlink-pulse-su" icon={["boost"]}>
...
<Ability id="desert-wind-ex" icon={["boost"]}>
...
<Ability id="desert-mastery-ex" icon={["power"]}>
...
<Ability id="sand-storm-ex" icon={["power","boost","melee"]}>
...
<Ability id="as-one-ex" icon={["power","boost","melee"]}>
...
<Ability id="sand-scourge-ex" icon={["power","melee"]}>
...
<Ability id="savage-combatant-ex" icon={["down"]}>
...
<Ability id="titanic-challenge-ex" icon={["down","boost"]}>
...
<Ability id="wild-warrior-ex" icon={["down"]}>
...
<Ability id="dinosaur-mount-ex" icon={["power"]}>
...
<Ability id="nimble-rider-ex" icon={["def"]}>
...
<Ability id="fierce-devotion-ex" icon={["power"]}>
...
<Ability id="quick-rider-ex" icon={["power"]}>
...
<Ability id="titanic-mount-ex" icon={["boost"]}>
...
<Ability id="primeval-devotion-ex" icon={["def"]}>
...
<Ability id="half-hearted-challenge-ex" icon={["down"]}>
...
<Ability id="maidens-order-ex" icon={["info","power"]}>
...
<Ability id="devoted-defender-ex" icon={["power"]}>
...
<Ability id="maidens-loyalty-ex" icon={["def"]}>
...
<Ability id="have-gun" icon={["power"]}>
...
<Ability id="daring-deeds-ex" icon={["power"]}>
...
<Ability id="worn-banner-ex" icon={["power"]}>
...
<Ability id="notorious-deeds-ex" icon={["power"]}>
...
<Ability id="old-reliable-ex" icon={["boost"]}>
...
<Ability id="spell-severed-ex" icon={["def"]}>
...
<Ability id="infamous-deeds-ex" icon={["power"]}>
...
<Ability id="tough-as-nails-ex" icon={["power","boost"]}>
...
<Ability id="banner-of-solace-ex" icon={["boost","def"]}>
...
<Ability id="awesome-pennon-ex" icon={["boost","def"]}>
...
<Ability id="tactician-ex" icon={["boost"]}>
<Pair single id="tactician-ex">Tactician (Ex)</Pair>
...
<Ability id="drill-instructor-ex" icon={["power"]}>
...
<Ability id="tactical-advantage-ex" icon={["power"]}>
...
<Ability id="strategic-supremacy-ex" icon={["power","lower"]}>
...
<Ability id="plant-mount-ex" icon={["power"]}>
...
<Ability id="effloresce" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="shieldvines-ex" extraClasses="subAbility" icon={["def","aura"]}>
...
<Ability id="floatflower-ex" extraClasses="subAbility" icon={["boost","aura"]}>
...
<Ability id="innervating-pollen-ex" extraClasses="subAbility" icon={["boost","def","aura"]}>
...
<Ability id="bolsterbloom-su" extraClasses="subAbility" icon={["aid","aura"]}>
...
<Ability id="charged-blossoms-su" extraClasses="subAbility" icon={["def","aura"]}>
...
<Ability id="slipstrands-su" extraClasses="subAbility" icon={["boost","aura"]}>
...
<Ability id="ambrosia-su" extraClasses="subAbility" icon={["def","aura"]}>
...
<Ability id="luckleaf-su" extraClasses="subAbility" icon={["roll","aura"]}>
...
<Ability id="sinuous-steps-ex" icon={["power","def"]}>
...
<Ability id="darklands-mount-ex" icon={["power"]}>
...
<Ability id="stuck-in-the-saddle-ex" icon={["boost"]}>
...
<Ability id="disorienting-challenge-ex" icon={["lower"]}>
...
<Ability id="seafaring-companion" icon={["power"]}>
