...
<Ability id="small-size" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="small-size">Small Size</Pair>
...
<Ability id="medium-size" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="medium-size">Medium Size</Pair>
...
<Ability id="castle-defender" icon={["armor-upgrade","upgrade"]}>
<Pair single id="castle-defender">Castle Defender</Pair>
...
<Ability id="castle-lore" icon={["upgrade"]}>
<Pair single id="castle-lore">Castle Lore</Pair>
...
<Ability id="guard-companion" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="guard-companion">Guard Companion</Pair>
...
<Ability id="mighty-defense" icon={["upgrade","mailed-fist"]}>
<Pair single id="mighty-defense">Mighty Defense</Pair>
...
<Ability id="defending-challenge" icon={["armor-upgrade"]}>
<Pair single id="defending-challenge">Defending Challenge</Pair>
...
<Ability id="supreme-defense" icon={["upgrade","mailed-fist"]}>
<Pair single id="supreme-defense">Supreme Defense</Pair>
...
<Ability id="weapon-and-armor-proficiency" icon={["broken-shield","upgrade"]}>
...
<Ability id="natural-mount-ex" icon={["stairs-goal"]}>
<Pair single id="natural-mount-ex">Natural Mount (Ex)</Pair>
<Pair hl title="Replaces">Mount</Pair>
...
<Ability id="thundering-hooves-ex" icon={["upgrade"]}>
<Pair single id="thundering-hooves-ex">Thundering Hooves (Ex)</Pair>
<Pair hl title="Replaces">Cavalier's charge</Pair>
...
<Ability id="courser-ex" icon={["upgrade"]}>
<Pair single id="courser-ex">Courser (Ex)</Pair>
<Pair hl title="Replaces">Expert trainer</Pair>
...
<Ability id="ride-down-ex" icon={["mailed-fist"]}>
<Pair single id="ride-down-ex">Ride Down (Ex)</Pair>
<Pair hl title="Replaces">Mighty charge</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="circuit-ex" icon={["upgrade"]}>
<Pair single id="circuit-ex">Circuit (Ex)</Pair>
...
<Ability id="double-jeopardy-ex" icon={["upgrade"]}>
<Pair single id="double-jeopardy-ex">Double Jeopardy (Ex)</Pair>
<Pair hl title="Replaces">Demanding challenge</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="apprehend-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="apprehend-ex">Apprehend (Ex)</Pair>
<Pair hl title="Replaces">Mount</Pair>
...
<Ability id="squad-commander-ex" icon={["upgrade"]}>
<Pair single id="squad-commander-ex">Squad Commander (Ex)</Pair>
<Pair hl title="Replaces">Cavalier's charge</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="quick-interrogator-ex" icon={["upgrade"]}>
<Pair single id="quick-interrogator-ex">Quick Interrogator (Ex)</Pair>
<Pair hl title="Replaces">Expert trainer</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="badge-ex" icon={["armor-upgrade","upgrade"]}>
<Pair single id="badge-ex">Badge (Ex)</Pair>
...
<Ability id="instant-order-ex" icon={["stairs-goal"]}>
<Pair single id="instant-order-ex">Instant Order (Ex)</Pair>
...
<Ability id="greater-badge-ex" icon={["armor-upgrade"]}>
<Pair single id="greater-badge-ex">Greater Badge (Ex)</Pair>
...
<Ability id="social-presence-ex" icon={["upgrade"]}>
...
<Ability id="imperious-attitude-ex" icon={["stairs-goal"]}>
...
<Ability id="grand-boast-ex" icon={["stairs-goal"]}>
<Pair single id="grand-boast-ex">Grand Boast (Ex)</Pair>
...
<Ability id="champions-finesse-ex" icon={["stairs-goal"]}>
<Pair single id="champions-finesse-ex">Champion's Finesse (Ex)</Pair>
<Pair hl title="Replaces">Mount</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="champions-weapon-mastery-ex" icon={["mailed-fist","upgrade"]}>
<Pair single id="champions-weapon-mastery-ex">Champion's Weapon Mastery (Ex)</Pair>
<Pair hl title="Replaces">Supreme charge</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="groom-cohort-role" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="groom-cohort-role">Groom (Cohort Role)</Pair>
...
<Ability id="squire-cohort-role" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="squire-cohort-role">Squire (Cohort Role)</Pair>
...
<Ability id="standard-bearer-cohort-role" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="standard-bearer-cohort-role">Standard Bearer (Cohort Role)</Pair>
...
<Ability id="footman-follower-role" extraClasses="subAbility" icon={["upgrade","broken-shield"]}>
<Pair single id="footman-follower-role">Footman (Follower Role)</Pair>
...
<Ability id="honor-guard-follower-role" extraClasses="subAbility" icon={["armor-upgrade","broken-shield"]}>
<Pair single id="honor-guard-follower-role">Honor Guard (Follower Role)</Pair>
...
<Ability id="shared-challenge-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="shared-challenge-ex">Shared Challenge (Ex)</Pair>
<Pair hl title="Replaces">Demanding challenge</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="supreme-tactician-ex" icon={["stairs-goal"]}>
<Pair single id="supreme-tactician-ex">Supreme Tactician (Ex)</Pair>
<Pair hl title="Replaces">Supreme charge</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="bigger-they-are-ex" icon={["armor-upgrade"]}>
<Pair single id="bigger-they-are-ex">Bigger They Are (Ex)</Pair>
<Pair hl title="Replaces">Mount</Pair>
...
<Ability id="pike-charge-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="pike-charge-ex">Pike Charge (Ex)</Pair>
<Pair hl title="Replaces">Cavalier's charge</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="monster-hunter-ex" icon={["upgrade"]}>
<Pair single id="monster-hunter-ex">Monster Hunter (Ex)</Pair>
<Pair hl title="Replaces">Expert trainer</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="agile-charger-ex" icon={["upgrade"]}>
<Pair single id="agile-charger-ex">Agile Charger (Ex)</Pair>
<Pair hl title="Replaces">Mighty charge</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="deadly-charge-ex" icon={["upgrade"]}>
<Pair single id="deadly-charge-ex">Deadly Charge (Ex)</Pair>
<Pair hl title="Replaces">Supreme charge</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="drake-mount" icon={["stairs-goal","broken-shield"]}>
...
<Ability id="approved-order" icon={["info"]}>
<Pair single id="approved-order">Approved Order</Pair>
...
<Ability id="in-or-out-of-the-saddle-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="in-or-out-of-the-saddle-ex">In or Out of the Saddle (Ex)</Pair>
<Pair hl title="Replaces">Tactician</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="battlefield-agility-ex" icon={["stairs-goal"]}>
<Pair single id="battlefield-agility-ex">Battlefield Agility (Ex)</Pair>
<Pair hl title="Replaces">Banner</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="mounted-acrobatics-ex" icon={["stairs-goal"]}>
<Pair single id="mounted-acrobatics-ex">Mounted Acrobatics (Ex)</Pair>
<Pair hl title="Replaces">Greater tactician</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="mounted-dervish-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="mounted-dervish-ex">Mounted Dervish (Ex)</Pair>
<Pair hl title="Replaces">Greater banner</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="erratic-charge-ex" icon={["stairs-goal"]}>
...
<Ability id="teamwork-ex" icon={["stairs-goal"]}>
<Pair single id="teamwork-ex">Teamwork (Ex)</Pair>
<Pair hl title="Replaces">Cavalier's charge</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="shared-challenge-ex" icon={["upgrade"]}>
<Pair single id="shared-challenge-ex">Shared Challenge (Ex)</Pair>
<Pair hl title="Replaces">Expert trainer</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="banner-ex" icon={["stairs-goal","upgrade"]}>
...
<Ability id="avenge-me-ex" icon={["stairs-goal"]}>
<Pair single id="avenge-me-ex">Avenge Me (Ex)</Pair>
<Pair hl title="Replaces">Mighty charge</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="fight-as-one-ex" icon={["upgrade"]}>
<Pair single id="fight-as-one-ex">Fight As One (Ex)</Pair>
<Pair hl title="Replaces">Supreme charge</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="rampage-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="rampage-ex">Rampage (Ex)</Pair>
<Pair hl title="Replaces">Cavalier's charge</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="dread-rider-ex" icon={["upgrade","stairs-goal"]}>
<Pair single id="dread-rider-ex">Dread Rider (Ex)</Pair>
<Pair hl title="Replaces">Expert trainer</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="fell-presence-ex" icon={["armor-downgrade","aura"]}>
<Pair single id="fell-presence-ex">Fell Presence (Ex)</Pair>
<Pair hl title="Replaces">Banner</Pair>
...
<Ability id="deadly-rampage-ex" icon={["armor-upgrade","mailed-fist"]}>
<Pair single id="deadly-rampage-ex">Deadly Rampage (Ex)</Pair>
<Pair hl title="Replaces">Mighty charge</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="terror-ex" icon={["armor-downgrade","aura"]}>
<Pair single id="terror-ex">Terror (Ex)</Pair>
<Pair hl title="Replaces">Greater banner</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="unstoppable-rampage-ex" icon={["stairs-goal","mailed-fist","upgrade"]}>
<Pair single id="unstoppable-rampage-ex">Unstoppable Rampage (Ex)</Pair>
<Pair hl title="Replaces">Supreme charge</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="serpent-mount-ex" icon={["stairs-goal"]}>
<Pair single id="serpent-mount-ex">Serpent Mount (Ex)</Pair>
<Pair hl title="Alters">Mount</Pair>
...
<Ability id="honored-warrior-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="honored-warrior-ex">Honored Warrior (Ex)</Pair>
...
<Ability id="code-of-gallantry" icon={["info","hazard-sign"]}>
<Pair single id="code-of-gallantry">Code of Gallantry</Pair>
...
<Ability id="symbol-of-inspiration-ex" icon={["armor-upgrade","aura"]}>
<Pair single id="symbol-of-inspiration-ex" flavor="The gallant's personal crest becomes an inspirational symbol of his chivalrous ideals.">Symbol of Inspiration (Ex)</Pair>
<Pair hl title="Replaces">Banner</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="symbol-of-resilience-su" icon={["armor-upgrade"]}>
<Pair single id="symbol-of-resilience-su" flavor="The gallant's personal crest empowers his allies to stand firm against evil.">Symbol of Resilience (Su)</Pair>
<Pair hl title="Replaces">Greater banner</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="transfixing-charge-ex" icon={["upgrade"]}>
<Pair single id="transfixing-charge-ex">Transfixing Charge (Ex)</Pair>
<Pair hl title="Replaces">Supreme charge</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="frightful-gaze-su" icon={["smoking-finger"]}>
<Pair single id="frightful-gaze-su">Frightful Gaze (Su)</Pair>
<Pair hl title="Replaces">Tactician, greater tactician, master tactician</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="spirited-mount-su" icon={["upgrade","magic-swirl"]}>
<Pair single id="spirited-mount-su">Spirited Mount (Su)</Pair>
...
<Ability id="ghost-wind-su" icon={["magic-swirl","stairs-goal"]}>
<Pair single id="ghost-wind-su">Ghost Wind (Su)</Pair>
...
<Ability id="beast-tongue-ex" icon={["stairs-goal"]}>
...
<Ability id="implacable-knight-ex" icon={["stairs-goal"]}>
<Pair single id="implacable-knight-ex">Implacable Knight (Ex)</Pair>
<Pair hl title="Replaces">Mount</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="natures-servant-ex" icon={["info"]}>
<Pair single id="natures-servant-ex">Nature's Servant (Ex)</Pair>
...
<Ability id="ferocious-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="ferocious-ex">Ferocious (Ex)</Pair>
<Pair hl title="Replaces">Cavalier's charge</Pair>
...
<Ability id="oaken-vitality-su" icon={["armor-upgrade"]}>
<Pair single id="oaken-vitality-su" flavor="Nature protects a green knight from many afflictions.">Oaken Vitality (Su)</Pair>
<Pair hl title="Replaces">Mighty charge, greater banner</Pair>
...
<Ability id="take-their-heads-su" icon={["upgrade"]}>
<Pair single id="take-their-heads-su" flavor="A green knight's blade is blessed by mighty fey powers and unerringly seeks out foes' necks.">Take Their Heads (Su)</Pair>
<Pair hl title="Replaces">Master tactician</Pair>
...
<Ability id="indestructible-su" icon={["upgrade","armor-upgrade"]}>
<Pair single id="indestructible-su">Indestructible (Su)</Pair>
<Pair hl title="Replaces">Supreme charge</Pair>
...
<Ability id="introduction-ex" icon={["rolling-dices","stairs-goal"]}>
<Pair single id="introduction-ex">Introduction (Ex)</Pair>
<Pair hl title="Replaces">Tactician</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="fleet-of-foot-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="fleet-of-foot-ex">Fleet of Foot (Ex)</Pair>
...
<Ability id="transcend-language-sp" icon={["magic-swirl"]}>
<Pair single id="transcend-language-sp">Transcend Language (Sp)</Pair>
<Pair hl title="Replaces">Cavalier's charge</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="sworn-defense-ex" icon={["broken-shield","armor-upgrade"]}>
<Pair single id="sworn-defense-ex">Sworn Defense (Ex)</Pair>
...
<Ability id="intercept-ex" icon={["stairs-goal","armor-upgrade"]}>
<Pair single id="intercept-ex">Intercept (Ex)</Pair>
<Pair hl title="Replaces">Cavalier's charge</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="warding-charge-ex" icon={["armor-upgrade"]}>
<Pair single id="warding-charge-ex" flavor="An honor guard can flash across the battlefield to protect his ward against the target of his challenge.">Warding Charge (Ex)</Pair>
<Pair hl title="Replaces">Mighty charge</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="defensive-challenge-ex" icon={["armor-downgrade"]}>
<Pair single id="defensive-challenge-ex">Defensive Challenge (Ex)</Pair>
<Pair hl title="Replaces">Demanding challenge</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="feytouched-mount" icon={["stairs-goal"]}>
<Pair single id="feytouched-mount">Feytouched Mount</Pair>
...
<Ability id="hero-of-the-roads-ex" icon={["upgrade"]}>
<Pair single id="hero-of-the-roads-ex">Hero of the Roads (Ex)</Pair>
<Pair hl title="Replaces">Tactician</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="champion-of-the-roads-sp" icon={["magic-swirl"]}>
<Pair single id="champion-of-the-roads-sp">Champion of the Roads (Sp)</Pair>
<Pair hl title="Replaces">Greater tactician</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="paragon-of-the-roads-sp" icon={["upgrade"]}>
<Pair single id="paragon-of-the-roads-sp">Paragon of the Roads (Sp)</Pair>
<Pair hl title="Replaces">Master tactician</Pair>
<Pair title="Gained">At 17th Level</Pair>
...
<Ability id="bestial-challenge-ex" icon={["upgrade","broken-shield"]}>
<Pair single id="bestial-challenge-ex">Bestial Challenge (Ex)</Pair>
<Pair hl title="Alters">Challenge</Pair>
...
<Ability id="tactician-ex" icon={["info"]}>
...
<Ability id="animal-trainer-ex" icon={["info"]}>
...
<Ability id="swift-tracker-ex" icon={["stairs-goal"]}>
...
<Ability id="pack-attack-ex" icon={["mailed-fist","upgrade"]}>
<Pair single id="pack-attack-ex">Pack Attack (Ex)</Pair>
<Pair hl title="Replaces">Mighty charge</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="improved-quarry-ex" icon={["stairs-goal"]}>
...
<Ability id="fast-mount-ex" icon={["upgrade"]}>
<Pair single id="fast-mount-ex" flavor="A hussar is able to spur on any mount that he rides to faster speeds than other riders.">Fast Mount (Ex)</Pair>
...
<Ability id="skillful-rider-ex" icon={["upgrade"]}>
<Pair single id="skillful-rider-ex" flavor="A hussar and his mount work in tandem to achieve amazing accomplishments of dexterity while riding.">Skillful Rider (Ex)</Pair>
<Pair hl title="Replaces">Bonus feats gained at 6th, 12th, and 18th levels</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="maneuverable-mount-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="maneuverable-mount-ex" flavor="A hussar is able to maneuver his mount with exceptional grace and poise, even in areas that would normally be a difficult fit for such a creature.">Maneuverable Mount (Ex)</Pair>
<Pair hl title="Replaces">Greater tactician</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="sudden-swerve-ex" icon={["stairs-goal"]}>
<Pair single id="sudden-swerve-ex" flavor="A hussar's control over his mount is advanced enough to allow the mount to turn on the spot, even when charging forward at full speed.">Sudden Swerve (Ex)</Pair>
<Pair hl title="Replaces">Master tactician</Pair>
<Pair title="Gained">At 17th Level</Pair>
...
<Ability id="shield-expertise" icon={["stairs-goal"]}>
<Pair single id="shield-expertise">Shield Expertise</Pair>
<Pair hl title="Replaces">Tactician</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Pair single id="deflective-shield-ex" flavor="A knight of Arnisant specializes in using his shield to deflect attacks.">Deflective Shield (Ex)</Pair>
<Pair hl title="Replaces">Expert trainer</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="heraldic-banner-ex" icon={["stairs-goal"]}>
<Pair single id="heraldic-banner-ex">Heraldic Banner (Ex)</Pair>
<Pair hl title="Alters">Banner</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="soul-shield-su" icon={["armor-upgrade"]}>
<Pair single id="soul-shield-su">Soul Shield (Su)</Pair>
<Pair hl title="Replaces">Greater tactician</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="heart-shield-su" icon={["armor-upgrade"]}>
<Pair single id="heart-shield-su">Heart Shield (Su)</Pair>
<Pair hl title="Replaces">Greater tactician</Pair>
<Pair title="Gained">At 17th Level</Pair>
...
<Ability id="far-challenge-ex" icon={["bowman","upgrade","broken-shield"]}>
<Pair single id="far-challenge-ex">Far Challenge (Ex)</Pair>
<Pair hl title="Replaces">Challenge</Pair>
...
<Ability id="careful-aim" icon={["bowman","upgrade"]}>
<Pair single id="careful-aim">Careful Aim</Pair>
<Pair hl title="Replaces">Cavalier's charge</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="infuriating-aim-ex" icon={["armor-downgrade"]}>
<Pair single id="infuriating-aim-ex">Infuriating Aim (Ex)</Pair>
<Pair hl title="Replaces">Mighty charge</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="versatile-challenge-ex" icon={["stairs-goal"]}>
<Pair single id="versatile-challenge-ex">Versatile Challenge (Ex)</Pair>
<Pair hl title="Replaces">Demanding challenge</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="supreme-aim-ex" icon={["upgrade"]}>
<Pair single id="supreme-aim-ex">Supreme Aim (Ex)</Pair>
<Pair hl title="Replaces">Supreme charge</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="gifted-firearm-ex" icon={["stairs-goal","bowman","hazard-sign"]}>
<Pair single id="gifted-firearm-ex">Gifted Firearm (Ex)</Pair>
<Pair hl title="Replaces">Mount</Pair>
...
<Ability id="swift-powder-ex" icon={["stairs-goal"]}>
<Pair single id="swift-powder-ex">Swift Powder (Ex)</Pair>
<Pair hl title="Replaces">Expert trainer</Pair>
...
<Ability id="aquatic-mount" icon={["stairs-goal"]}>
<Pair single id="aquatic-mount">Aquatic Mount</Pair>
<Pair hl title="Replaces">Expert trainer</Pair>
<Pair hl title="Alters">Mount</Pair>
...
<Ability id="maneuver-tactics-ex" icon={["stairs-goal"]}>
<Pair single id="maneuver-tactics-ex">Maneuver Tactics (Ex)</Pair>
<Pair hl title="Replaces">Tactician, greater tactician, master tactician</Pair>
...
<Ability id="mindlink-su" icon={["armor-upgrade","mailed-fist"]}>
<Pair single id="mindlink-su">Mindlink (Su)</Pair>
<Pair hl title="Replaces">Banner</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="mindlink-pulse-su" icon={["upgrade"]}>
<Pair single id="mindlink-pulse-su">Mindlink Pulse (Su)</Pair>
<Pair hl title="Replaces">Greater banner</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="desert-wind-ex" icon={["upgrade"]}>
<Pair single id="desert-wind-ex">Desert Wind (Ex)</Pair>
<Pair hl title="Replaces">Tactician</Pair>
...
<Ability id="desert-mastery-ex" icon={["stairs-goal"]}>
<Pair single id="desert-mastery-ex">Desert Mastery (Ex)</Pair>
<Pair hl title="Replaces">Cavalier's charge</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="sand-storm-ex" icon={["stairs-goal","upgrade","mailed-fist"]}>
<Pair single id="sand-storm-ex">Sand Storm (Ex)</Pair>
...
<Ability id="as-one-ex" icon={["stairs-goal","upgrade","mailed-fist"]}>
<Pair single id="as-one-ex">As One (Ex)</Pair>
<Pair hl title="Replaces">Greater tactician</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="sand-scourge-ex" icon={["stairs-goal","mailed-fist"]}>
<Pair single id="sand-scourge-ex">Sand Scourge (Ex)</Pair>
<Pair hl title="Replaces">Master tactician</Pair>
<Pair title="Gained">At 17th Level</Pair>
...
<Ability id="savage-combatant-ex" icon={["broken-shield"]}>
<Pair single id="savage-combatant-ex">Savage Combatant (Ex)</Pair>
...
<Ability id="titanic-challenge-ex" icon={["broken-shield","upgrade"]}>
<Pair single id="titanic-challenge-ex">Titanic Challenge (Ex)</Pair>
<Pair hl title="Alters">Challenge</Pair>
...
<Ability id="wild-warrior-ex" icon={["broken-shield"]}>
<Pair single id="wild-warrior-ex">Wild Warrior (Ex)</Pair>
<Pair hl title="Replaces">Order</Pair>
...
<Ability id="nimble-rider-ex" icon={["armor-upgrade"]}>
<Pair single id="nimble-rider-ex">Nimble Rider (Ex)</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="fierce-devotion-ex" icon={["stairs-goal"]}>
<Pair single id="fierce-devotion-ex">Fierce Devotion (Ex)</Pair>
<Pair hl title="Replaces">Banner</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="quick-rider-ex" icon={["stairs-goal"]}>
<Pair single id="quick-rider-ex">Quick Rider (Ex)</Pair>
...
<Ability id="titanic-mount-ex" icon={["upgrade"]}>
<Pair single id="titanic-mount-ex">Titanic Mount (Ex)</Pair>
...
<Ability id="primeval-devotion-ex" icon={["armor-upgrade"]}>
<Pair single id="primeval-devotion-ex">Primeval Devotion (Ex)</Pair>
<Pair hl title="Replaces">Greater banner</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="half-hearted-challenge-ex" icon={["broken-shield"]}>
<Pair single id="half-hearted-challenge-ex">Half-hearted Challenge (Ex)</Pair>
<Pair hl title="Alters">Challenge</Pair>
...
<Ability id="devoted-defender-ex" icon={["stairs-goal"]}>
<Pair single id="devoted-defender-ex" flavor="Sisters-in-arms cling to their fellow Gray Maidens as closely as family and protect them with intense devotion.">Devoted Defender (Ex)</Pair>
<Pair hl title="Replaces">Cavalier's charge</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="maidens-loyalty-ex" icon={["armor-upgrade"]}>
...
<Ability id="dedicated-commander-ex" icon={["upgrade"]}>
...
<Ability id="have-gun" icon={["stairs-goal"]}>
...
<Ability id="daring-deeds-ex" icon={["stairs-goal"]}>
<Pair single id="daring-deeds-ex">Daring Deeds (Ex)</Pair>
<Pair hl title="Replaces">Cavalier's charge</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="worn-banner-ex" icon={["stairs-goal"]}>
<Pair single id="worn-banner-ex">Worn Banner (Ex)</Pair>
<Pair hl title="Alters">Banner</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="notorious-deeds-ex" icon={["stairs-goal"]}>
<Pair single id="notorious-deeds-ex">Notorious Deeds (Ex)</Pair>
<Pair hl title="Replaces">Greater tactician</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="old-reliable-ex" icon={["upgrade"]}>
<Pair single id="old-reliable-ex">Old Reliable (Ex)</Pair>
<Pair hl title="Replaces">Mighty charge</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="spell-severed-ex" icon={["armor-upgrade"]}>
<Pair single id="spell-severed-ex">Spell Severed (Ex)</Pair>
<Pair hl title="Replaces">Demanding challenge</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="infamous-deeds-ex" icon={["stairs-goal"]}>
<Pair single id="infamous-deeds-ex">Infamous Deeds (Ex)</Pair>
<Pair hl title="Replaces">Master tactician</Pair>
<Pair title="Gained">At 17th Level</Pair>
...
<Ability id="tough-as-nails-ex" icon={["stairs-goal","upgrade"]}>
...
<Ability id="banner-of-solace-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="banner-of-solace-ex" flavor="A standard bearer's banner becomes an even more potent symbol of protection and inspiration to those around him.">Banner of Solace (Ex)</Pair>
<Pair hl title="Replaces">Mighty charge</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="awesome-pennon-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="awesome-pennon-ex" flavor="A standard bearer's banner has become a powerful rallying point to his allies, and a bane to his foes.">Awesome Pennon (Ex)</Pair>
<Pair hl title="Replaces">Supreme charge</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="tactician-ex" icon={["upgrade"]}>
<Pair single id="tactician-ex">Tactician (Ex)</Pair>
...
<Ability id="drill-instructor-ex" icon={["stairs-goal"]}>
<Pair single id="drill-instructor-ex">Drill Instructor (Ex)</Pair>
<Pair hl title="Replaces">Expert trainer</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="tactical-advantage-ex" icon={["stairs-goal"]}>
<Pair single id="tactical-advantage-ex">Tactical Advantage (Ex)</Pair>
<Pair hl title="Replaces">Greater banner</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="strategic-supremacy-ex" icon={["stairs-goal","armor-downgrade"]}>
<Pair single id="strategic-supremacy-ex">Strategic Supremacy (Ex)</Pair>
...
<Ability id="effloresce" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="effloresce">Effloresce</Pair>
...
<Ability id="shieldvines-ex" extraClasses="subAbility" icon={["armor-upgrade","aura"]}>
<Pair single id="shieldvines-ex">Shieldvines (Ex)</Pair>
...
<Ability id="floatflower-ex" extraClasses="subAbility" icon={["upgrade","aura"]}>
<Pair single id="floatflower-ex">Floatflower (Ex)</Pair>
...
<Ability id="innervating-pollen-ex" extraClasses="subAbility" icon={["upgrade","armor-upgrade","aura"]}>
<Pair single id="innervating-pollen-ex">Innervating Pollen (Ex)</Pair>
...
<Ability id="bolsterbloom-su" extraClasses="subAbility" icon={["remedy","aura"]}>
<Pair single id="bolsterbloom-su">Bolsterbloom (Su)</Pair>
...
<Ability id="charged-blossoms-su" extraClasses="subAbility" icon={["armor-upgrade","aura"]}>
<Pair single id="charged-blossoms-su">Charged Blossoms (Su)</Pair>
...
<Ability id="slipstrands-su" extraClasses="subAbility" icon={["upgrade","aura"]}>
<Pair single id="slipstrands-su">Slipstrands (Su)</Pair>
...
<Ability id="ambrosia-su" extraClasses="subAbility" icon={["armor-upgrade","aura"]}>
<Pair single id="ambrosia-su">Ambrosia (Su)</Pair>
...
<Ability id="luckleaf-su" extraClasses="subAbility" icon={["rolling-dices","aura"]}>
<Pair single id="luckleaf-su">Luckleaf (Su)</Pair>
...
<Ability id="sinuous-steps-ex" icon={["stairs-goal","armor-upgrade"]}>
<Pair single id="sinuous-steps-ex">Sinuous Steps (Ex)</Pair>
<Pair hl title="Alters">Cavalier's charge</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="stuck-in-the-saddle-ex" icon={["upgrade"]}>
<Pair single id="stuck-in-the-saddle-ex" flavor="A practiced vermin tamer can remain steady in the saddle even in unconventional situations.">Stuck in the Saddle (Ex)</Pair>
...
<Ability id="disorienting-challenge-ex" icon={["armor-downgrade"]}>
<Pair single id="disorienting-challenge-ex">Disorienting Challenge (Ex)</Pair>
<Pair hl title="Replaces">Demanding challenge</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="seafaring-companion" icon={["stairs-goal"]}>
<Pair single id="seafaring-companion">Seafaring Companion</Pair>
<Pair hl title="Alters">Mount</Pair>
<Pair title="Gained">At 1st Level</Pair>
