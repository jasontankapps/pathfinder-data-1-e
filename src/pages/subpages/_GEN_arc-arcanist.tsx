...
<Ability id="air-mastery-su" icon={["upgrade"]}>
<Pair single id="air-mastery-su" flavor="Aeromancers specialize in magic that manipulates the wind and sky.">Air Mastery (Su)</Pair>
...
<Ability id="winds-embrace-su" icon={["magic-swirl"]}>
<Pair single id="winds-embrace-su">Wind's Embrace (Su)</Pair>
...
<Ability id="rebuking-gale-su" icon={["aura","tornado-discs"]}>
<Pair single id="rebuking-gale-su">Rebuking Gale (Su)</Pair>
...
<Ability id="manipulate-construct-su" icon={["armor-downgrade"]}>
<Pair single id="manipulate-construct-su" flavor="An arcane tinkerer can turn the animating magic of a construct against itself.">Manipulate Construct (Su)</Pair>
...
<Ability id="break-magic-immunity-su" icon={["magic-swirl"]}>
<Pair single id="break-magic-immunity-su">Break Magic Immunity (Su)</Pair>
...
<Ability id="sword-bond-su" extraClasses="hasSubs" icon={["stairs-goal","magic-swirl"]}>
<Pair single id="sword-bond-su" flavor="A blade adept develops a bond with a blade and infuses it with arcane power.">Sword Bond (Su)</Pair>
...
<Ability id="sentient-sword-su" icon={["upgrade","magic-swirl"]}>
<Pair single id="sentient-sword-su" flavor="The blade adept's bonded sword becomes a powerful, sentient black blade.">Sentient Sword (Su)</Pair>
...
<Ability id="adept-exploits" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="adept-exploits">Adept Exploits</Pair>
<Pair title="Ability">A blade adept can select from the following five additional exploits.</Pair>
</Ability>
<Ability id="eldritch-blade" extraClasses="subAbility numbered" icon={["upgrade"]}>
<Pair single id="eldritch-blade">Eldritch Blade</Pair>
...
<Ability id="magus-arcana" extraClasses="subAbility numbered" icon={["stairs-goal"]}>
...
<Ability id="spell-strike-su" extraClasses="subAbility numbered" icon={["mailed-fist"]}>
<Pair single id="spell-strike-su">Spell Strike (Su)</Pair>
...
<Ability id="student-of-the-blade-ex" extraClasses="subAbility numbered" icon={["stairs-goal"]}>
<Pair single id="student-of-the-blade-ex">Student of the Blade (Ex)</Pair>
...
<Ability id="weapon-specialization-ex" extraClasses="subAbility numbered" icon={["stairs-goal"]}>
<Pair single id="weapon-specialization-ex">Weapon Specialization (Ex)</Pair>
...
<Ability id="bloodline" icon={["magic-swirl","stairs-goal"]}>
...
<Ability id="powerful-change-su" icon={["magic-swirl"]}>
<Pair single id="powerful-change-su" flavor="The brown-fur transmuter learns to harness the power of her magic to empower her transmutations.">Powerful Change (Su)</Pair>
<Pair hl title="Replaces">The arcanist exploit gained at 3rd level</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="share-transmutation-su" icon={["magic-swirl"]}>
<Pair single id="share-transmutation-su" flavor="The brown-fur transmuter can target others with her transmutation spells.">Share Transmutation (Su)</Pair>
...
<Ability id="transmutation-supremacy-su" icon={["magic-swirl"]}>
<Pair single id="transmutation-supremacy-su" flavor="The brown-fur transmuter learns to fully master the power of transmutation.">Transmutation Supremacy (Su)</Pair>
...
<Ability id="font-of-power" icon={["upgrade","broken-shield"]}>
<Pair single id="font-of-power">Font of Power</Pair>
...
<Ability id="eldritch-surge-su" icon={["upgrade","magic-swirl"]}>
<Pair single id="eldritch-surge-su">Eldritch Surge (Su)</Pair>
<Pair hl title="Replaces">The arcanist exploit gained at 3rd level</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="improved-surge-su" icon={["rolling-dices"]}>
<Pair single id="improved-surge-su">Improved Surge (Su)</Pair>
...
<Ability id="greater-surge-su" icon={["rolling-dices","armor-downgrade"]}>
<Pair single id="greater-surge-su">Greater Surge (Su)</Pair>
...
<Ability id="bottomless-well" icon={["magic-swirl"]}>
<Pair single id="bottomless-well">Bottomless Well</Pair>
<Pair hl title="Replaces">Magical supremacy</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="elemental-focus-su" icon={["magic-swirl"]}>
...
<Ability id="elemental-attack-su" icon={["stairs-goal"]}>
<Pair single id="elemental-attack-su">Elemental Attack (Su)</Pair>
<Pair hl title="Replaces">The arcanist exploit gained at 3rd level</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="powerful-exploit-su" icon={["upgrade"]}>
<Pair single id="powerful-exploit-su">Powerful Exploit (Su)</Pair>
<Pair hl title="Replaces">The arcanist exploit gained at 9th level</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="greater-elemental-attack-su" icon={["stairs-goal"]}>
<Pair single id="greater-elemental-attack-su">Greater Elemental Attack (Su)</Pair>
...
</aside><Ability id="psychic-reader-ex" icon={["stairs-goal","skills"]}>
<Pair single id="psychic-reader-ex">Psychic Reader (Ex)</Pair>
...
<Ability id="harrow-reservoir-ex" icon={["magic-swirl","upgrade"]}>
<Pair single id="harrow-reservoir-ex">Harrow Reservoir (Ex)</Pair>
...
<Ability id="divine-the-mysteries-ex" icon={["spell-book"]}>
<Pair single id="divine-the-mysteries-ex">Divine the Mysteries (Ex)</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-arcanist-magaambyan_initiate--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>A Magaambyan initiate must be of a good alignment.</td></tr></tbody></table></ScrollContainer></div><Ability id="aura-of-good-ex" icon={["aura"]}>
...
<Ability id="halcyon-spell-lore-su" icon={["spell-book"]}>
<Pair single id="halcyon-spell-lore-su" flavor="A Magaambyan initiate's studies of the philanthropic teachings of Old-Mage Jatembe allow her to cast a limited number of spells per day beyond those she could normally prepare ahead of time.">Halcyon Spell Lore (Su)</Pair>
...
<Ability id="conjurers-focus-sp" icon={["magic-swirl"]}>
<Pair single id="conjurers-focus-sp">Conjurer's Focus (Sp)</Pair>
<Pair hl title="Replaces">The arcanist exploit gained at 1st level</Pair>
...
<Ability id="planar-contact-sp" icon={["magic-swirl"]}>
<Pair single id="planar-contact-sp">Planar Contact (Sp)</Pair>
<Pair hl title="Replaces">The arcanist exploit gained at 7th level</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="perfect-summoner" icon={["magic-swirl"]}>
<Pair single id="perfect-summoner">Perfect Summoner</Pair>
<Pair hl title="Replaces">Magical supremacy</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="signature-spells" extraClasses="hasSubs" icon={["magic-swirl"]}>
<Pair single id="signature-spells">Signature Spells</Pair>
...
<Ability id="dismiss-su" extraClasses="subAbility numbered" icon={["upgrade"]}>
<Pair single id="dismiss-su">Dismiss (Su)</Pair>
...
<Ability id="spell-bender-su" extraClasses="subAbility numbered" icon={["magic-swirl","barbed-arrow"]}>
<Pair single id="spell-bender-su">Spell Bender (Su)</Pair>
...
<Ability id="spellwarp-su" extraClasses="subAbility numbered" icon={["aura","tornado-discs","barbed-arrow"]}>
<Pair single id="spellwarp-su">Spellwarp (Su)</Pair>
...
<Ability id="consume-life-su" icon={["magic-swirl"]}>
<Pair single id="consume-life-su" flavor="By wresting a soul from life to death, a twilight sage gains a slightly deeper understanding of mortality, fueling her curiosity and eldritch power.">Consume Life (Su)</Pair>
<Pair hl title="Replaces">Consume spells</Pair>
...
<Ability id="necromantic-focus-ex" icon={["magic-swirl"]}>
...
<Ability id="twilight-barrier-ex" icon={["magic-swirl","armor-upgrade","stairs-goal"]}>
<Pair single id="twilight-barrier-ex" flavor="A twilight sage's arcane barrier differs from those of other arcanists, as it draws upon both negative and positive energy to protect the sage.">Twilight Barrier (Ex)</Pair>
...
<Ability id="twilight-transfer-su" icon={["remedy","magic-swirl"]}>
<Pair single id="twilight-transfer-su" flavor="A twilight sage's mastery over life and death allows her to transfer life energy into a fading vessel.">Twilight Transfer (Su)</Pair>
<Pair hl title="Replaces">The arcanist exploit gained at 11th level</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="deaths-release-su" icon={["magic-swirl"]}>
<Pair single id="deaths-release-su" flavor="A twilight sage has mastered the relationship between death and arcane power, and has gained a limited ability to surpass her own mortality.">Death's Release (Su)</Pair>
<Pair hl title="Replaces">Magical supremacy</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="witch-spells" icon={["magic-swirl"]}>
<Pair single id="witch-spells">Witch Spells</Pair>
...
<Ability id="spontaneous-healing-su" icon={["remedy"]}>
<Pair single id="spontaneous-healing-su">Spontaneous Healing (Su)</Pair>
<Pair hl title="Replaces">The arcanist exploits gained at 1st and 9th levels</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="greater-exploit" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="greater-exploit">Greater Exploit</Pair>
<Pair title="Info">A white mage can select the following greater exploit.</Pair>
</Ability>
<Ability id="fast-healing-su" extraClasses="subAbility" icon={["remedy"]}>
