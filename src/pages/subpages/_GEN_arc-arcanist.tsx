...
<Ability id="air-mastery-su" icon={["boost"]}>
...
<Ability id="winds-embrace-su" icon={["magic"]}>
...
<Ability id="rebuking-gale-su" icon={["aura","cone"]}>
...
<Ability id="manipulate-construct-su" icon={["lower"]}>
...
<Ability id="break-magic-immunity-su" icon={["magic"]}>
...
<Ability id="sword-bond-su" extraClasses="hasSubs" icon={["power","magic"]}>
...
<Ability id="sentient-sword-su" icon={["boost","magic"]}>
...
<Ability id="adept-exploits" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="eldritch-blade" extraClasses="subAbility numbered" icon={["boost"]}>
...
<Ability id="magus-arcana" extraClasses="subAbility numbered" icon={["power"]}>
...
<Ability id="spell-strike-su" extraClasses="subAbility numbered" icon={["melee"]}>
...
<Ability id="student-of-the-blade-ex" extraClasses="subAbility numbered" icon={["power"]}>
...
<Ability id="weapon-specialization-ex" extraClasses="subAbility numbered" icon={["power"]}>
...
<Ability id="bloodline" icon={["magic","power"]}>
...
<Ability id="powerful-change-su" icon={["magic"]}>
...
<Ability id="share-transmutation-su" icon={["magic"]}>
...
<Ability id="transmutation-supremacy-su" icon={["magic"]}>
...
<Ability id="font-of-power" icon={["boost","down"]}>
...
<Ability id="eldritch-surge-su" icon={["boost","magic"]}>
...
<Ability id="improved-surge-su" icon={["roll"]}>
...
<Ability id="greater-surge-su" icon={["roll","lower"]}>
...
<Ability id="bottomless-well" icon={["magic"]}>
...
<Ability id="elemental-focus-su" icon={["magic"]}>
...
<Ability id="elemental-attack-su" icon={["power"]}>
...
<Ability id="powerful-exploit-su" icon={["boost"]}>
...
<Ability id="greater-elemental-attack-su" icon={["power"]}>
...
</aside><Ability id="psychic-reader-ex" icon={["power","skill"]}>
...
<Ability id="harrow-reservoir-ex" icon={["magic","boost"]}>
...
<Ability id="divine-the-mysteries-ex" icon={["learn"]}>
...
<Ability id="trump-card-su" icon={["boost","def","aid","lower"]}>
...
<Ability id="halcyon-spell-lore-su" icon={["learn"]}>
...
<Ability id="spell-mastery" icon={["power"]}>
...
<Ability id="planar-spells" icon={["learn"]}>
...
<Ability id="conjurers-focus-sp" icon={["magic"]}>
...
<Ability id="planar-contact-sp" icon={["magic"]}>
...
<Ability id="perfect-summoner" icon={["magic"]}>
...
<Ability id="school-focus-su" icon={["magic"]}>
...
<Ability id="signature-spells" extraClasses="hasSubs" icon={["magic"]}>
...
<Ability id="dismiss-su" extraClasses="subAbility numbered" icon={["boost"]}>
...
<Ability id="spell-bender-su" extraClasses="subAbility numbered" icon={["magic","line"]}>
...
<Ability id="spellwarp-su" extraClasses="subAbility numbered" icon={["aura","cone","line"]}>
...
<Ability id="consume-life-su" icon={["magic"]}>
...
<Ability id="necromantic-focus-ex" icon={["magic"]}>
...
<Ability id="twilight-barrier-ex" icon={["magic","def","power"]}>
...
<Ability id="twilight-transfer-su" icon={["aid","magic"]}>
...
<Ability id="deaths-release-su" icon={["magic"]}>
...
<Ability id="witch-spells" icon={["magic"]}>
...
<Ability id="spontaneous-healing-su" icon={["aid"]}>
...
<Ability id="greater-exploit" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="fast-healing-su" extraClasses="subAbility" icon={["aid"]}>
