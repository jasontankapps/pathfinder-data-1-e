...
<AffInfo type="Disease; Inherited-non-contagious" save="Fort 15" freq="1/week" eff={<>Gain one runescar</>} cure={<>none (but see above)</>} extra={<>When a runeslave's number of runescars equals its Hit Dice, it dies.</>} icon="d">Arcane Decay</AffInfo>
</blockquote>
...
<AffInfo type="Ingested" save="Fort 20" freq="1/round for 6 rounds" eff={<><Link to="/misc/confusion">confusion</Link> for 1 round and 1d4 <Link to="/rule/wisdom_drain">Wisdom drain</Link> (if this results in the giant's Wisdom being drained to 0, the giant immediately transforms into a runeslave)</>} cure3c icon="p">Runeslave Poison</AffInfo>
<p><strong>Runeslave Cauldron:</strong> Brought forth from Gastash, the domain of gluttony, these <Link to="/magic-artifact/runeslave_cauldron">massive cauldrons</Link> were large enough to fit an adult stone giant and infused with necromantic energies. Any giant placed in a cauldron and then slain is immediately resurrected as a runeslave.</p>
</>};
...
<AffInfo type="Natural or touch attack" save="Fort 10 + 1/2 the the seeded one's HD + their Cha modifier" freq="1/month" onset="1 month" eff={<>1d2 <Link to="/rule/cha_damage">Cha damage</Link> and this damage cannot be healed while the creature is infected</>} cure3c icon="d">Seedborne Consumption (Su)</AffInfo>
<blockquote>
...
<AffInfo type="Injury-slam" save="Fort 10 + 1/2 the zombie's HD + its Cha modifier" freq="1/day" onset="1d4 days" eff={<>1d2 <Link to="/rule/con_damage">Con damage</Link> and this damage cannot be healed while the creature is infected</>} cure2c extra={<>Anyone who dies while infected rises as a plague zombie in 2d6 hours.</>} icon="d">Zombie Rot</AffInfo>
</blockquote>
...
<AffInfo type="Injury" save="Fort 14" freq="1/round for 6 rounds" cure2 icon="p">Deathspore Toxin</AffInfo>
<h5 id="template-zombie-gold-musk-zombie-cr-2">Gold Musk Zombie (CR +2)</h5>
