...
const _runeslave = {title: "Runeslave", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Runeslave</span><span>CR +1</span></p>
...
const _runewarped_creature = {title: "Runewarped Creature", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Runewarped Creature</span><span>CR +1</span></p>
...
const _sea_sworn = {title: "Sea-Sworn", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Sea-Sworn</span><span>CR +1</span></p>
...
const _seeded = {title: "Seeded", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Seeded</span><span>CR +1</span></p>
...
const _shadow = {title: "Shadow", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Shadow</span><span>CR +1</span></p>
...
const _shadow_animal = {title: "Shadow Animal", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Shadow Animal</span><span>CR +1 or +2</span></p>
...
const _shadow_lord = {title: "Shadow Lord", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Shadow Lord</span><span>CR +2</span></p>
...
const _shadowbound_creature = {title: "Shadowbound Creature", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Shadowbound Creature</span><span>CR +1</span></p>
...
const _shadowfire_creature = {title: "Shadowfire Creature", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Shadowfire Creature</span><span>CR +1</span></p>
...
const _shaggra_ogre = {title: "Shaggra Ogre", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Shaggra Ogre</span><span>CR +1</span></p>
...
const _siabrae = {title: "Siabrae", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Siabrae</span><span>CR +2</span></p>
...
const _silverblood_lycanthrope = {title: "Silverblood Lycanthrope", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Silverblood Lycanthrope</span><span>CR +2</span></p>
...
const _sorcerer = {title: "Sorcerer", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Sorcerer</span><span>CR +1, +2 or +3</span></p>
...
const _soulbound_construct = {title: "Soulbound Construct", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Soulbound Construct</span><span>CR +1 or +2</span></p>
...
const _spore_zombie = {title: "Spore Zombie", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Spore Zombie</span><span>CR +1</span></p>
...
const _steam_powered_construct = {title: "Steam-Powered Construct", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Steam-Powered Construct</span><span>CR +2</span></p>
...
const _sunbaked_zombie = {title: "Sunbaked Zombie", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Sunbaked Zombie</span><span>CR Varies</span></p>
...
const _taxidermic_creature = {title: "Taxidermic Creature", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Taxidermic Creature</span><span>CR Varies</span></p>
...
const _terror_creature = {title: "Terror Creature", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Terror Creature</span><span>CR +0</span></p>
...
const _thicken_ogre = {title: "Thicken Ogre", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Thicken Ogre</span><span>CR +0</span></p>
<p><strong>Sources</strong> <Link to="/source/monster_codex">Monster Codex pg. 152</Link><br/><strong>Acquired/Inherited Template</strong> Inherited<br/><strong>Simple Template</strong> Yes<br/><strong>Usable with Summons</strong> No</p>
...
const _trompe_loeil = {title: "Trompe l'Oeil", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Trompe l'Oeil</span><span>CR +1</span></p>
...
const _tsukumogami = {title: "Tsukumogami", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Tsukumogami</span><span>CR +2</span></p>
...
const _tulpa = {title: "Tulpa", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Tulpa</span><span>CR +2</span></p>
...
const _unknown = {title: "Unknown", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Unknown</span><span>CR +2</span></p>
...
const _vahana = {title: "Vahana", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Vahana</span><span>CR +2</span></p>
...
const _vampire_minion_addle_minded = {title: "Vampire Minion, Addle-Minded", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Addle Minded</span><span>CR +0</span></p>
...
const _vampire_minion_repeatedly_drained = {title: "Vampire Minion, Repeatedly Drained", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Repeatedly Drained</span><span>CR -1</span></p>
<p><strong>Sources</strong> <Link to="/source/monster_codex">Monster Codex pg. 236</Link><br/><strong>Acquired/Inherited Template</strong> Acquired<br/><strong>Simple Template</strong> Yes<br/><strong>Usable with Summons</strong> No</p>
...
const _vampire_spawn = {title: "Vampire Spawn", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Vampire Spawn</span><span>CR +1</span></p>
...
const _vampiric_creature = {title: "Vampiric Creature", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Vampiric Creature</span><span>CR +1</span></p>
<p><strong>Sources</strong> <Link to="/source/horror_adventures">Horror Adventures pg. 250</Link><br/><strong>Acquired/Inherited Template</strong> Acquired<br/><strong>Simple Template</strong> Yes<br/><strong>Usable with Summons</strong> No</p>
...
const _vetala = {title: "Vetala", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Vetala</span><span>CR +2</span></p>
...
const _winter_fey = {title: "Winter Fey", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Winter Fey</span><span>CR +1</span></p>
...
const _winter_touched_fey = {title: "Winter-Touched Fey", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Winter-Touched Fey</span><span>CR +0</span></p>
...
const _wizard = {title: "Wizard", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Wizard</span><span>CR +1 +2 or +3</span></p>
...
const _young = {title: "Young", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Young</span><span>CR -1</span></p>
...
const _zombie_lord = {title: "Zombie Lord", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Zombie Lord</span><span>CR +1</span></p>
