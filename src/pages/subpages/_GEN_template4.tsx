...
<AffInfo type="Slam" save="Will 10 + 1/2 the zombie's HD + its Cha modifier" freq="-" eff={<>as <Link to="/spell/bestow_curse">bestow curse</Link></>} icon="c">Zombie Curse (Su)</AffInfo>
