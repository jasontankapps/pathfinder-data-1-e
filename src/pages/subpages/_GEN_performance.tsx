...
<Ability id="countersong-su" icon={["protect","def"]}>
...
<Ability id="distraction-su" icon={["protect","def"]}>
...
<Ability id="fascinate-su" icon={["magic","lower"]}>
...
<Ability id="inspire-courage-su" icon={["boost"]}>
...
<Ability id="suggestion-sp" icon={["magic"]}>
...
<Ability id="dirge-of-doom-su" icon={["lower"]}>
...
<Ability id="inspire-greatness-su" icon={["aid","boost","def"]}>
...
<Ability id="soothing-performance-su" icon={["aid"]}>
...
<Ability id="frightening-tune-sp" icon={["lower"]}>
...
<Ability id="inspire-heroics-su" icon={["def","protect"]}>
...
<Ability id="mass-suggestion-sp" icon={["magic","boost"]}>
...
<Ability id="deadly-performance-su" icon={["lower"]}>
