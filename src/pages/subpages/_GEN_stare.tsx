...
<Ability id="devilbane-binding" icon={["lower"]}>
...
<Ability id="devilbane-dampening" icon={["lower"]}>
...
<Ability id="devilbane-dismissal" icon={["lower"]}>
...
<Ability id="devilbane-impediment" icon={["lower"]}>
...
<Ability id="devilbane-mundanity" icon={["lower"]}>
...
<Ability id="devilbane-withering" icon={["lower"]}>
...
<Ability id="disorientation" icon={["lower"]}>
...
<Ability id="disquiet" icon={["lower"]}>
...
<Ability id="distracted" icon={["lower"]}>
...
<Ability id="infiltration" icon={["lower"]}>
...
<Ability id="lethality" icon={["lower"]}>
...
<Ability id="nightblindness" icon={["lower"]}>
...
<Ability id="nightmare" icon={["lower","roll"]}>
...
<Ability id="oscillation" icon={["lower"]}>
...
<Ability id="psychic-inception" icon={["boost"]}>
...
<Ability id="restriction" icon={["lower"]}>
...
<Ability id="sabotage" icon={["lower"]}>
...
<Ability id="sapped-magic" icon={["lower"]}>
...
<Ability id="sluggishness" icon={["lower"]}>
...
<Ability id="susceptibility" icon={["lower"]}>
...
<Ability id="timidity" icon={["lower"]}>
