...
<Ability id="chant-su" icon={["boost"]}>
...
<Ability id="charm-su" icon={["magic"]}>
...
<Ability id="draconic-resilience-ex" icon={["protect"]}>
...
<Ability id="fetish-ex" icon={["power","boost"]}>
...
<Ability id="fortune-su" icon={["roll"]}>
...
<Ability id="fury-su" icon={["boost","def"]}>
...
<Ability id="intimidating-display-ex" icon={["power"]}>
...
<Ability id="secret-ex" icon={["power"]}>
...
<Ability id="shapeshift-su" icon={["magic"]}>
...
<Ability id="silkstring-snare-su" icon={["lower"]}>
...
<Ability id="witch-hex" icon={["power"]}>
