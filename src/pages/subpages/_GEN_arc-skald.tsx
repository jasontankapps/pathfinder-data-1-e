...
<Ability id="raging-song-su" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="raging-song-su">Raging Song (Su)</Pair>
...
<AffInfo type="Bite-injury" save="Fort 10 + 1/2 the serpent herald's level + his Con modifier" freq="1/round for 6 rounds" eff={<>1 <Link to="/rule/con_damage">Con damage</Link></>} cure1 icon="p">Poison</AffInfo>
<p>This is a polymorph effect; a creature under another polymorph effect, such as <em>wild shape,</em> does not gain the aspect. If the serpent herald grants one of these aspects to himself, he also gains the ability to <Link to="/spell/speak_with_animals">speak with animals</Link> (reptiles and creatures with the aquatic subtype only) for as long as he has the aspect.</p>
</Pair>
...
<Ability id="channel-solar-energy-su" icon={["aura"]}>
<Pair single id="channel-solar-energy-su">Channel Solar Energy (Su)</Pair>
<Pair hl title="Replaces">Spell kenning</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="undying-song-su" extraClasses="hasSubs" icon={["info"]}>
