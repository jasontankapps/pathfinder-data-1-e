...
<Ability id="shadow-double-sp" icon={["stairs-goal"]}>
<Pair single id="shadow-double-sp">Shadow Double (Sp)</Pair>
...
<Pair title="At 5th Level"><p>An ankou's shadow gains a second <em>shadow double.</em> In addition to using these <em>shadow doubles</em> as <em>mirror images</em> in his square, he can move his doubles as part of his own move action, dividing his movement between himself and his doubles.</p>
<p>When outside his square, <em>shadow doubles</em> do not protect the ankou's shadow as <em>mirror image</em> and are limited in the actions they can take. Shadow doubles provide <Link to="/rule/flanking">flanking</Link> for the ankou's shadow and his allies, but they do not possess teamwork feats or special abilities that alter the effects of flanking or aiding another.</p>
<p>As a <strong className="hl">swift action</strong>, the ankou's shadow can direct his <em>shadow doubles</em> to use the <Link to="/rule/aid_another_2">aid another</Link> action, using his own base attack bonus plus his Intelligence modifier for the roll. Although a <em>shadow double</em> appears to duplicate the ankou's shadow's gear, this gear is part of its form; a <em>shadow double's</em> gear cannot be destroyed, dropped, or stolen. A <em>shadow double</em> disappears if it ventures more than 50 feet from the ankou's shadow or if it leaves his line of sight or effect. A <em>shadow double</em> that is hit by an attack roll or takes any damage is destroyed.</p>
<p>The AC of a <em>shadow double</em> is equal to the ankou's shadow's touch AC, and it has the same CMD and saving throw bonuses as the ankou's shadow. Shadow doubles possess <Link to="/ability/evasion">evasion</Link> if the ankou's shadow does. Mind-affecting effects targeting a <em>shadow double</em> affect the ankou's shadow instead, though he isn't affected twice by effects that target both him and a <em>shadow double.</em></p>
</Pair>
...
<Ability id="ankous-vision-sp" icon={["magic-swirl"]}>
<Pair single id="ankous-vision-sp">Ankou's Vision (Sp)</Pair>
...
<Ability id="shadow-prey-ex" icon={["broken-shield","info"]}>
<Pair single id="shadow-prey-ex">Shadow Prey (Ex)</Pair>
...
<Ability id="unfettered-shadows-su" icon={["stairs-goal"]}>
<Pair single id="unfettered-shadows-su">Unfettered Shadows (Su)</Pair>
...
<Ability id="falling-strike-ex" icon={["upgrade"]}>
...
<Ability id="cliff-jumper-ex" icon={["upgrade","armor-upgrade"]}>
...
<Ability id="falling-dodge-ex" icon={["armor-upgrade"]}>
<Pair single id="falling-dodge-ex">Falling Dodge (Ex)</Pair>
<Pair hl title="Replaces">Stalker</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="fall-by-attack-ex" icon={["stairs-goal"]}>
<Pair single id="fall-by-attack-ex">Fall-By Attack (Ex)</Pair>
...
<Ability id="death-from-above-ex" icon={["stairs-goal"]}>
<Pair single id="death-from-above-ex" flavor="An avalancher can take down his foe with a single attack.">Death from Above (Ex)</Pair>
...
<Ability id="cruel-tricks" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="cruel-tricks" flavor="Bloody jakes use backwoods folk magic to confuse, terrify, and weaken their prey.">Cruel Tricks</Pair>
...
<Pair title="Ability">He gains the <em>cruel tricks</em> below at the indicated slayer levels.</Pair>
</Ability>
<Ability id="distant-voices-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="distant-voices-sp">Distant Voices (Sp)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="lose-your-way-sp" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="lose-your-way-sp">Lose Your Way (Sp)</Pair>
...
<Ability id="somethings-not-right-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="somethings-not-right-su">Something's Not Right (Su)</Pair>
...
<Ability id="the-woods-have-eyes-sp" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="the-woods-have-eyes-sp">The Woods Have Eyes (Sp)</Pair>
...
<Ability id="poor-study-ex" icon={["broken-shield"]}>
<Pair single id="poor-study-ex">Poor Study (Ex)</Pair>
...
<Ability id="sadistic-snare-ex" icon={["stairs-goal"]}>
<Pair single id="sadistic-snare-ex">Sadistic Snare (Ex)</Pair>
...
<Ability id="cruel-trick-ex" icon={["armor-downgrade"]}>
<Pair single id="cruel-trick-ex">Cruel Trick (Ex)</Pair>
...
<Ability id="woodland-shortcut-sp" icon={["magic-swirl"]}>
<Pair single id="woodland-shortcut-sp">Woodland Shortcut (Sp)</Pair>
...
<Ability id="dirty-trick-ex" icon={["armor-downgrade"]}>
<Pair single id="dirty-trick-ex">Dirty Trick (Ex)</Pair>
...
<Ability id="submission-hold-ex" icon={["mailed-fist"]}>
<Pair single id="submission-hold-ex">Submission Hold (Ex)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 6th level</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="incapacitate-ex" icon={["armor-downgrade"]}>
<Pair single id="incapacitate-ex">Incapacitate (Ex)</Pair>
...
<Ability id="studied-stalker-ex" icon={["stairs-goal","broken-shield"]}>
<Pair single id="studied-stalker-ex">Studied Stalker (Ex)</Pair>
...
<Ability id="butterflys-kiss-ex" extraClasses="hasSubs" icon={["stairs-goal","upgrade"]}>
<Pair single id="butterflys-kiss-ex" flavor="Butterfly blades train to inflict painful cuts rather than lethal ones.">Butterfly's Kiss (Ex)</Pair>
...
<Ability id="knockout-ex" extraClasses="subAbility" icon={["mailed-fist"]}>
<Pair single id="knockout-ex" flavor="Text from the brawler class ability.">Knockout (Ex)</Pair>
...
<Ability id="innocent-butterfly-sp" icon={["magic-swirl"]}>
<Pair single id="innocent-butterfly-sp">Innocent Butterfly (Sp)</Pair>
...
<Ability id="deadly-butterfly-ex" icon={["upgrade"]}>
<Pair single id="deadly-butterfly-ex" flavor="A butterfly blade becomes a bloody whirlwind in combat.">Deadly Butterfly (Ex)</Pair>
...
<Ability id="without-a-trace-ex" icon={["stairs-goal","upgrade"]}>
...
<Ability id="mislead-sp" icon={["magic-swirl"]}>
<Pair single id="mislead-sp">Mislead (Sp)</Pair>
<Pair hl title="Replaces">Stalker</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="hag-sense-su" icon={["upgrade"]}>
<Pair single id="hag-sense-su">Hag Sense (Su)</Pair>
<Pair hl title="Replaces">Track</Pair>
...
<Ability id="studied-coven-su" icon={["upgrade"]}>
<Pair single id="studied-coven-su">Studied Coven (Su)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 2nd level</Pair>
<Pair hl title="Alters">Studied target</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="disrupt-coven-su" icon={["armor-downgrade"]}>
<Pair single id="disrupt-coven-su">Disrupt Coven (Su)</Pair>
<Pair hl title="Replaces">Stalker</Pair>
...
<Ability id="unseen-sense-su" icon={["upgrade","stairs-goal"]}>
<Pair single id="unseen-sense-su">Unseen Sense (Su)</Pair>
<Pair hl title="Replaces">Swift tracker</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Pair single id="street-stalker-ex">Street Stalker (Ex)</Pair>
<Pair hl title="Replaces">Track</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="opportune-target-ex" icon={["upgrade"]}>
<Pair single id="opportune-target-ex" flavor="A cutthroat who catches a foe by surprise can quickly study that foe to find its weaknesses.">Opportune Target (Ex)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 2nd level</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="determined-zeal-ex" icon={["armor-upgrade"]}>
<Pair single id="determined-zeal-ex" flavor="A deliverer shrugs off attempts by his moral opposite to control or kill him.">Determined Zeal (Ex)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 2nd level</Pair>
<Pair title="Gained">At 2nd Level</Pair>
<Pair title="Passive Ability">On any round in which the deliverer attacks an opponent whose alignment is at least two steps away from his own (such as a lawful good deliverer fighting a chaotic good or lawful evil foe, or a neutral foe with no other alignment components), he gains a +2 bonus on Will saving throws against that opponent's abilities, as well as the benefit of the <Link to="/feat/diehard">Diehard</Link> feat until the end of his next turn.</Pair>
</Ability>
<Ability id="true-believer-ex" icon={["armor-upgrade"]}>
<Pair single id="true-believer-ex" flavor="Mortal wounds cannot stop a deliverer from performing his divine duty.">True Believer (Ex)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 6th level</Pair>
<Pair title="Gained">At 6th Level</Pair>
<Pair title="Passive Ability">On any round in which he attacks an opponent whose alignment is at least two steps away from his own (see <em>determined zeal,</em> above) while benefiting from the Diehard feat, he isn't staggered from having negative hit points, nor does he automatically lose 1 hit point per round.</Pair>
</Ability>
<Ability id="divine-anathema-ex" icon={["upgrade"]}>
<Pair single id="divine-anathema-ex">Divine Anathema (Ex)</Pair>
<Pair hl title="Replaces">Advanced slayer talent gained at 10th level</Pair>
<Pair title="Gained">At 10th Level</Pair>
<Pair title="Free Action">A deliverer can declare a <em>studied target</em> to be his divine anathema. The <em>studied target's</em> alignment must be at least two steps away from that of the deliverer. Against this target, the deliverer's attacks deal an additional 2d6 points of damage; this damage is directly from divine power and does not stack with the bonus damage from a <Link to="/magic-enh/holy">holy</Link> or <Link to="/magic-enh/unholy">unholy</Link> weapon, or a weapon with a similar weapon special ability or effect.</Pair>
<Pair title="Special">A deliverer can have only one divine anathema at a time.</Pair>
</Ability>
<p><strong className="hl">The following slayer talents complement the deliverer archetype:</strong> <Link to="/slayertalent/foil_scrutiny">foil scrutiny</Link>, <Link to="/slayertalent/rogue_talent">rogue talent</Link> (<Link to="/talent/combat_trick">combat trick</Link>, <Link to="/talent/finesse_rogue">finesse rogue</Link>, <Link to="/talent/terrain_mastery">terrain mastery</Link>, <Link to="/talent/trap_spotter">trap spotter</Link>), <Link to="/slayertalent/trapfinding">trapfinding›</Link></p><p><strong className="hl">The following advanced slayer talents complement the deliverer archetype:</strong> <Link to="/slayertalent/advanced_rogue_talent">advanced rogue talent</Link> (<Link to="/talent/hunters_surprise">hunter's surprise</Link>, <Link to="/talent/master_of_disguise">master of disguise</Link>), <Link to="/slayertalent/assassinate">assassinate</Link>, <Link to="/slayertalent/ninja_master_trick">ninja master trick</Link> (<Link to="/ninjatrick/evasion">evasion</Link>)</p></>};
...
<Ability id="sand-foot-ex" icon={["upgrade"]}>
<Pair single id="sand-foot-ex">Sand Foot (Ex)</Pair>
...
<Ability id="desert-skirmisher-ex" icon={["upgrade"]}>
<Pair single id="desert-skirmisher-ex">Desert Skirmisher (Ex)</Pair>
<Pair hl title="Replaces">Studied target</Pair>
...
<Ability id="galloping-fire-ex" icon={["upgrade"]}>
<Pair single id="galloping-fire-ex">Galloping Fire (Ex)</Pair>
...
<Ability id="dust-vision-ex" icon={["armor-upgrade","upgrade"]}>
<Pair single id="dust-vision-ex" flavor="The dune rider is at home in the desert.">Dust Vision (Ex)</Pair>
...
<Ability id="dunes-of-death-su" icon={["armor-downgrade"]}>
<Pair single id="dunes-of-death-su" flavor="A dune rider can use the desert's heat to finish off his foes.">Dunes of Death (Su)</Pair>
<Pair hl title="Replaces">Master slayer</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="find-family-sp" icon={["stairs-goal"]}>
<Pair single id="find-family-sp">Find Family (Sp)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 2nd level</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="kinslayer-su" icon={["upgrade"]}>
<Pair single id="kinslayer-su">Kinslayer (Su)</Pair>
...
<Ability id="studied-target-ex" icon={["broken-shield"]}>
...
<Ability id="disrupt-teamwork-ex" icon={["armor-upgrade"]}>
<Pair single id="disrupt-teamwork-ex">Disrupt Teamwork (Ex)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 6th level</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="holy-water-sprinkler-ex" icon={["stairs-goal","mailed-fist"]}>
<Pair single id="holy-water-sprinkler-ex">Holy Water Sprinkler (Ex)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 2nd level</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="death-ward-sp" icon={["armor-upgrade"]}>
<Pair single id="death-ward-sp">Death Ward (Sp)</Pair>
<Pair hl title="Replaces">Stalker</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="dustbringer-ex" icon={["upgrade"]}>
<Pair single id="dustbringer-ex">Dustbringer (Ex)</Pair>
<Pair hl title="Replaces">Advanced slayer talent gained at 10th level</Pair>
<Pair title="Gained">At 10th Level</Pair>
...
<Ability id="strike-first-strike-last-ex" icon={["upgrade"]}>
<Pair single id="strike-first-strike-last-ex">Strike First, Strike Last (Ex)</Pair>
<Pair hl title="Replaces">Track, swift tracker</Pair>
...
<Ability id="quick-start-ex" icon={["mailed-fist"]}>
<Pair single id="quick-start-ex">Quick Start (Ex)</Pair>
...
<Ability id="astonishing-strike-ex" icon={["armor-downgrade"]}>
<Pair single id="astonishing-strike-ex">Astonishing Strike (Ex)</Pair>
<Pair hl title="Replaces">Quarry, improved quarry</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="aberration-hunter-ex" icon={["upgrade"]}>
<Pair single id="aberration-hunter-ex">Aberration Hunter (Ex)</Pair>
<Pair hl title="Replaces">Track</Pair>
...
<Ability id="alien-prescience-sp" icon={["magic-swirl"]}>
<Pair single id="alien-prescience-sp">Alien Prescience (Sp)</Pair>
...
<Ability id="discern-weakness-ex" icon={["rolling-dices"]}>
<Pair single id="discern-weakness-ex" flavor="A Pureblade becomes an expert at locating an aberration's weak points.">Discern Weakness (Ex)</Pair>
<Pair hl title="Replaces">Stalker</Pair>
<Pair title="Gained">At 7th Level</Pair>
<Pair title="Ability">The Pureblade rolls twice to confirm critical hits against aberrations and keeps the higher roll.</Pair>
</Ability>
<Ability id="steely-mind-ex" icon={["armor-upgrade"]}>
<Pair single id="steely-mind-ex">Steely Mind (Ex)</Pair>
...
<Ability id="aberration-slayer-ex" icon={["upgrade"]}>
<Pair single id="aberration-slayer-ex">Aberration Slayer (Ex)</Pair>
...
<Ability id="bloodstained-hands-ex" icon={["hazard-sign"]}>
<Pair single id="bloodstained-hands-ex">Bloodstained Hands (Ex)</Pair>
...
<Pair single id="focused-killer-ex">Focused Killer (Ex)</Pair>
<Pair hl title="Alters">Studied target</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="painful-strike-ex" icon={["stairs-goal"]}>
<Pair single id="painful-strike-ex" flavor="Sczarni executioners are trained to cause excruciating pain when striking targets, often leaving them reeling in agony or completely incapacitated as they slowly bleed out.">Painful Strike (Ex)</Pair>
<Pair hl title="Replaces">Swift tracker</Pair>
...
<Pair single id="assassinate-ex">Assassinate (Ex)</Pair>
...
<Ability id="swift-death-ex" icon={["stairs-goal"]}>
<Pair single id="swift-death-ex">Swift Death (Ex)</Pair>
<Pair hl title="Replaces">Quarry, improved quarry</Pair>
<Pair title="Gained">At 14th Level</Pair>
<Pair title="Ability">Once per day a Sczarni executioner can attempt to <em>assassinate</em> a foe without <em>studying</em> his foe beforehand. He must still succeed at a sneak attack against the target.</Pair>
...
<Ability id="accuracy-ex" icon={["upgrade"]}>
...
<Ability id="deadly-sniper-ex" icon={["bowman"]}>
<Pair single id="deadly-sniper-ex">Deadly Sniper (Ex)</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="studied-spawn-ex" icon={["upgrade"]}>
<Pair single id="studied-spawn-ex" flavor="A spawn slayer specializes in fighting against larger, single targets.">Studied Spawn (Ex)</Pair>
...
<Ability id="gain-leverage-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="gain-leverage-ex" flavor="A spawn slayer learns techniques to counteract a foe's size advantage.">Gain Leverage (Ex)</Pair>
<Pair hl title="Replaces">Stalker</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="force-vulnerability-ex" icon={["armor-downgrade"]}>
<Pair single id="force-vulnerability-ex" flavor="A spawn slayer can create an opening in even an invulnerable foe's defenses.">Force Vulnerability (Ex)</Pair>
<Pair hl title="Replaces">Master slayer</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="studied-target-ex" icon={["broken-shield","upgrade"]}>
<Pair single id="studied-target-ex">Studied Target (Ex)</Pair>
...
<Ability id="hold-breath-ex" icon={["armor-upgrade"]}>
...
<Pair single id="slayer-talents">Slayer Talents</Pair>
...
<Ability id="swift-swimmer-ex" icon={["stairs-goal"]}>
<Pair single id="swift-swimmer-ex">Swift Swimmer (Ex)</Pair>
<Pair hl title="Replaces">Swift tracker</Pair>
<Pair title="Gained">At 11th Level</Pair>
<Pair title="Ability">A spire diver gains a swim speed equal to her base speed.</Pair>
</Ability>
<Ability id="divers-advance-ex" icon={["stairs-goal"]}>
<Pair single id="divers-advance-ex">Diver's Advance (Ex)</Pair>
<Pair hl title="Replaces">Slayer's advance</Pair>
<Pair title="Gained">At 13th Level</Pair>
...
<Ability id="divers-quarry-ex" icon={["broken-shield","upgrade"]}>
<Pair single id="divers-quarry-ex">Diver's Quarry (Ex)</Pair>
<Pair hl title="Alters">Quarry, improved quarry</Pair>
...
<Ability id="spirit-sense-ex" icon={["stairs-goal","upgrade","armor-upgrade"]}>
<Pair single id="spirit-sense-ex" flavor="A spiritslayer manifests an uncanny sixth sense regarding the presence of invisible creatures.">Spirit Sense (Ex)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 2nd level</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="spiritslayer-talents" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="spiritslayer-talents">Spiritslayer Talents</Pair>
<Pair title="Ability">A spiritslayer can select the following slayer talents, in addition to general slayer talents.</Pair>
</Ability>
<Ability id="disrupt-possession-ex" extraClasses="subAbility" icon={["upgrade","shield-reflect"]}>
<Pair single id="disrupt-possession-ex">Disrupt Possession (Ex)</Pair>
...
<Ability id="improved-spirit-sense" extraClasses="subAbility" icon={["stairs-goal","upgrade"]}>
<Pair single id="improved-spirit-sense">Improved Spirit Sense</Pair>
...
<Ability id="greater-spirit-sense" extraClasses="subAbility" icon={["stairs-goal","upgrade"]}>
<Pair single id="greater-spirit-sense">Greater Spirit Sense</Pair>
...
<Ability id="ghost-slayer-ex" icon={["armor-downgrade","upgrade"]}>
<Pair single id="ghost-slayer-ex">Ghost Slayer (Ex)</Pair>
<Pair hl title="Replaces">Stalker</Pair>
...
<Ability id="invisibility-sp" icon={["magic-swirl"]}>
<Pair single id="invisibility-sp">Invisibility (Sp)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 4th level</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="spell-use" icon={["magic-swirl"]}>
<Pair single id="spell-use">Spell Use</Pair>
<Pair hl title="Replaces">Stalker</Pair>
<Pair title="Gained">At 7th Level</Pair>
<Pair title="Ability">A stygian slayer is able to use spell completion and spell trigger items as if he were an arcane caster with these spells on his spell list: <Link to="/spell/darkness">darkness</Link>, <Link to="/spell/forced_quiet">forced quiet</Link>, <Link to="/spell/modify_memory">modify memory</Link>, <Link to="/spell/nondetection">nondetection</Link>, <Link to="/spell/obscuring_mist">obscuring mist</Link>, <Link to="/spell/phantom_steed">phantom steed</Link>, <Link to="/spell/shadow_walk">shadow walk</Link>, and wizard spells of the <Link to="/main/spells_illusion">illusion school</Link> of spell level 0 through 4th. The slayer's uses his class level as his caster level for this ability.</Pair>
</Ability>
<Ability id="shadowy-mist-form-sp" icon={["magic-swirl"]}>
<Pair single id="shadowy-mist-form-sp">Shadowy Mist Form (Sp)</Pair>
<Pair hl title="Replaces">Advanced slayer talent gained at 10th level</Pair>
<Pair title="Gained">At 10th Level</Pair>
...
<p><strong>Sources</strong> <Link to="/source/people_of_the_wastes">People of the Wastes pg. 27</Link><br/>Followers of the daemonic harbinger <Link to="/faith/cixyron">Cixyron</Link> hide throughout the Mana Wastes, scavenging for guns. With significant firepower in hand, the Furious Thunder's snipers bring poisonous death to the wastes.</p>
...
<Ability id="scrappers-gun" icon={["stairs-goal"]}>
<Pair single id="scrappers-gun">Scrapper's Gun</Pair>
<Pair hl title="Replaces">Track</Pair>
...
<Ability id="sharpshooters-study-ex" icon={["broken-shield"]}>
<Pair single id="sharpshooters-study-ex" flavor="A toxic sniper's focus makes him extremely deadly with ranged weapons.">Sharpshooter's Study (Ex)</Pair>
<Pair hl title="Alters">Studied target</Pair>
...
<Ability id="toxic-grit-ex" icon={["stairs-goal"]}>
<Pair single id="toxic-grit-ex">Toxic Grit (Ex)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 2nd level</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="toxic-shots-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="toxic-shots-ex">Toxic Shots (Ex)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 4th level</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="marksman-ex" icon={["upgrade"]}>
<Pair single id="marksman-ex">Marksman (Ex)</Pair>
...
<Ability id="precise-toxin-ex" icon={["upgrade"]}>
<Pair single id="precise-toxin-ex" flavor={<>A toxic sniper can deliver a <em>toxic shot</em> to especially vulnerable areas.</>}>Precise Toxin (Ex)</Pair>
...
<Ability id="dubious-recognition-ex" icon={["upgrade"]}>
<Pair single id="dubious-recognition-ex">Dubious Recognition (Ex)</Pair>
<Pair hl title="Replaces">Track</Pair>
...
<Ability id="double-speak-ex" icon={["upgrade"]}>
<Pair single id="double-speak-ex">Double Speak (Ex)</Pair>
<Pair hl title="Replaces">Stalker</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="sudden-betrayal-ex" icon={["upgrade"]}>
<Pair single id="sudden-betrayal-ex">Sudden Betrayal (Ex)</Pair>
<Pair hl title="Replaces">Quarry, improved quarry</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="lookout-ex" icon={["upgrade"]}>
<Pair single id="lookout-ex">Lookout (Ex)</Pair>
<Pair hl title="Replaces">Track</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="vanguards-bond-ex" icon={["upgrade"]}>
<Pair single id="vanguards-bond-ex" flavor="A vanguard forms a bond with his fighting companions.">Vanguard's Bond (Ex)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 4th level</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="ever-ready-ex" icon={["upgrade"]}>
<Pair single id="ever-ready-ex">Ever Ready (Ex)</Pair>
<Pair hl title="Replaces">Stalker</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="studied-socialite-ex" icon={["upgrade","broken-shield"]}>
<Pair single id="studied-socialite-ex" flavor="A velvet blade focuses her studies on social infiltration rather than brute force, believing it is easier to kill an opponent quietly and unprepared than in a loud battle.">Studied Socialite (Ex)</Pair>
<Pair hl title="Alters">Studied target</Pair>
...
<Ability id="courtly-graces-ex" icon={["upgrade"]}>
<Pair single id="courtly-graces-ex" flavor="A velvet blade spends long hours memorizing etiquette and family lineages of royalty and other prominent families.">Courtly Graces (Ex)</Pair>
<Pair hl title="Replaces">Track</Pair>
...
<Ability id="treacherous-blade-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="treacherous-blade-ex" flavor="A velvet blade can capitalize on how others underestimate her and allow her close to them, assuming she is harmless.">Treacherous Blade (Ex)</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Pair single id="silent-dispatch-ex" flavor="A velvet blade becomes adept at taking out her targets quietly.">Silent Dispatch (Ex)</Pair>
<Pair hl title="Replaces">Swift tracker</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="superstitous-ex" icon={["stairs-goal"]}>
<Pair single id="superstitous-ex">Superstitous (Ex)</Pair>
<Pair hl title="Alters">Slayer talents</Pair>
...
<Ability id="lingering-thrust-ex" icon={["armor-downgrade"]}>
<Pair single id="lingering-thrust-ex">Lingering Thrust (Ex)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 4th level</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="scent-magic-su" icon={["magic-swirl"]}>
<Pair single id="scent-magic-su" flavor="A witch killer can detect arcane magic by scent.">Scent Magic (Su)</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Pair title="Passive Ability">Even when he isn't concentrating on using his <em>scent magic,</em> when a creature within scent range casts an arcane spell (including arcane spell-like abilities or magic item effects), the witch killer automatically pinpoints the caster's location.</Pair>
</Ability>
<Ability id="burn-the-witch-sp" icon={["magic-swirl"]}>
<Pair single id="burn-the-witch-sp">Burn the Witch (Sp)</Pair>
<Pair hl title="Replaces">Slayer talent gained at 10th level</Pair>
<Pair title="Gained">At 10th Level</Pair>
...
<Ability id="tree-climber-ex" icon={["upgrade","bowman"]}>
<Pair single id="tree-climber-ex">Tree Climber (Ex)</Pair>
<Pair hl title="Replaces">Track</Pair>
...
<Ability id="ranged-sneak-attack-ex" icon={["upgrade"]}>
<Pair single id="ranged-sneak-attack-ex">Ranged Sneak Attack (Ex)</Pair>
<Pair hl title="Alters">Sneak attack</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="still-shot-ex" icon={["upgrade"]}>
<Pair single id="still-shot-ex">Still Shot (Ex)</Pair>
<Pair hl title="Replaces">Stalker</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="branchwalking-ex" icon={["stairs-goal"]}>
<Pair single id="branchwalking-ex">Branchwalking (Ex)</Pair>
