...
<Pair single id="arc-slayer-bloody_jake-cruel-tricks" flavor="Bloody jakes use backwoods folk magic to confuse, terrify, and weaken their prey.">Cruel Tricks</Pair>
...
<Ability id="arc-slayer-deliverer-weapon-and-armor-proficiency" icon={["stairs-goal"]}>
