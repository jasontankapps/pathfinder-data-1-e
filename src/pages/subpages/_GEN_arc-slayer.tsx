...
<Ability id="ankous-vision-sp" icon={["magic"]}>
...
<Ability id="shadow-prey-ex" icon={["down","info"]}>
...
<Ability id="unfettered-shadows-su" icon={["power"]}>
...
<Ability id="falling-dodge-ex" icon={["def"]}>
...
<Ability id="fall-by-attack-ex" icon={["power"]}>
...
<Ability id="death-from-above-ex" icon={["power"]}>
...
<Ability id="cruel-tricks" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="distant-voices-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="lose-your-way-sp" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="somethings-not-right-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="the-woods-have-eyes-sp" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="poor-study-ex" icon={["down"]}>
...
<Ability id="sadistic-snare-ex" icon={["power"]}>
...
<Ability id="cruel-trick-ex" icon={["lower"]}>
...
<Ability id="woodland-shortcut-sp" icon={["magic"]}>
...
<Ability id="dirty-trick-ex" icon={["lower"]}>
...
<Ability id="submission-hold-ex" icon={["melee"]}>
...
<Ability id="incapacitate-ex" icon={["lower"]}>
...
<Ability id="studied-stalker-ex" icon={["power","down"]}>
...
<Ability id="butterflys-kiss-ex" extraClasses="hasSubs" icon={["power","boost"]}>
...
<Ability id="knockout-ex" extraClasses="subAbility" icon={["melee"]}>
...
<Ability id="innocent-butterfly-sp" icon={["magic"]}>
...
<Ability id="deadly-butterfly-ex" icon={["boost"]}>
...
<Ability id="deceitful" icon={["power"]}>
...
<Ability id="without-a-trace-ex" icon={["power","boost"]}>
...
<Ability id="mislead-sp" icon={["magic"]}>
...
<Ability id="hag-sense-su" icon={["boost"]}>
...
<Ability id="studied-coven-su" icon={["boost"]}>
...
<Ability id="disrupt-coven-su" icon={["lower"]}>
...
<Ability id="unseen-sense-su" icon={["boost","power"]}>
...
<Ability id="street-stalker-ex" icon={["boost"]}>
...
<Ability id="opportune-target-ex" icon={["boost"]}>
...
<Ability id="determined-zeal-ex" icon={["def"]}>
...
<Ability id="true-believer-ex" icon={["def"]}>
...
<Ability id="divine-anathema-ex" icon={["boost"]}>
...
<Ability id="sand-foot-ex" icon={["boost"]}>
...
<Ability id="desert-skirmisher-ex" icon={["boost"]}>
...
<Ability id="galloping-fire-ex" icon={["boost"]}>
...
<Ability id="dust-vision-ex" icon={["def","boost"]}>
...
<Ability id="dunes-of-death-su" icon={["lower"]}>
...
<Ability id="find-family-sp" icon={["power"]}>
...
<Ability id="kinslayer-su" icon={["boost"]}>
...
<Ability id="studied-target-ex" icon={["down"]}>
...
<Ability id="disrupt-teamwork-ex" icon={["def"]}>
...
<Ability id="holy-water-sprinkler-ex" icon={["power","melee"]}>
...
<Ability id="death-ward-sp" icon={["def"]}>
...
<Ability id="dustbringer-ex" icon={["boost"]}>
...
<Ability id="strike-first-strike-last-ex" icon={["boost"]}>
...
<Ability id="quick-start-ex" icon={["melee"]}>
...
<Ability id="astonishing-strike-ex" icon={["lower"]}>
...
<Ability id="aberration-hunter-ex" icon={["boost"]}>
...
<Ability id="alien-prescience-sp" icon={["magic"]}>
...
<Ability id="discern-weakness-ex" icon={["roll"]}>
...
<Ability id="steely-mind-ex" icon={["def"]}>
...
<Ability id="aberration-slayer-ex" icon={["boost"]}>
...
<Ability id="bloodstained-hands-ex" icon={["warning"]}>
...
<Ability id="focused-killer-ex" icon={["boost","down"]}>
...
<Ability id="painful-strike-ex" icon={["power"]}>
...
<Ability id="assassinate-ex" icon={["power"]}>
...
<Ability id="swift-death-ex" icon={["power"]}>
...
<Ability id="accuracy-ex" icon={["boost"]}>
...
<Ability id="deadly-sniper-ex" icon={["ranged"]}>
...
<Ability id="studied-spawn-ex" icon={["boost"]}>
...
<Ability id="gain-leverage-ex" icon={["boost","def"]}>
...
<Ability id="force-vulnerability-ex" icon={["lower"]}>
...
<Ability id="studied-target-ex" icon={["down","boost"]}>
<Pair single id="studied-target-ex">Studied Target (Ex)</Pair>
...
<Ability id="hold-breath-ex" icon={["def"]}>
...
<Ability id="swift-swimmer-ex" icon={["power"]}>
...
<Ability id="divers-advance-ex" icon={["power"]}>
...
<Ability id="divers-quarry-ex" icon={["down","boost"]}>
...
<Ability id="spirit-sense-ex" icon={["power","boost","def"]}>
...
<Ability id="spiritslayer-talents" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="disrupt-possession-ex" extraClasses="subAbility" icon={["boost","protect"]}>
...
<Ability id="improved-spirit-sense" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="greater-spirit-sense" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="ghost-slayer-ex" icon={["lower","boost"]}>
...
<Ability id="invisibility-sp" icon={["magic"]}>
...
<Ability id="spell-use" icon={["magic"]}>
...
<Ability id="shadowy-mist-form-sp" icon={["magic"]}>
...
<Ability id="scrappers-gun" icon={["power"]}>
...
<Ability id="sharpshooters-study-ex" icon={["down"]}>
...
<Ability id="toxic-grit-ex" icon={["power"]}>
...
<Ability id="toxic-shots-ex" icon={["power","boost"]}>
...
<Ability id="marksman-ex" icon={["boost"]}>
...
<Ability id="precise-toxin-ex" icon={["boost"]}>
...
<Ability id="dubious-recognition-ex" icon={["boost"]}>
...
<Ability id="double-speak-ex" icon={["boost"]}>
...
<Ability id="sudden-betrayal-ex" icon={["boost"]}>
...
<Ability id="lookout-ex" icon={["boost"]}>
...
<Ability id="vanguards-bond-ex" icon={["boost"]}>
...
<Ability id="ever-ready-ex" icon={["boost"]}>
...
<Ability id="studied-socialite-ex" icon={["boost","down"]}>
...
<Ability id="courtly-graces-ex" icon={["boost"]}>
...
<Ability id="treacherous-blade-ex" icon={["power","boost"]}>
...
<Ability id="silent-dispatch-ex" icon={["power"]}>
...
<Ability id="studied-witch-ex" icon={["boost","down"]}>
...
<Ability id="superstitous-ex" icon={["power"]}>
...
<Ability id="lingering-thrust-ex" icon={["lower"]}>
...
<Ability id="scent-magic-su" icon={["magic"]}>
...
<Ability id="burn-the-witch-sp" icon={["magic"]}>
...
<Ability id="tree-climber-ex" icon={["boost","ranged"]}>
...
<Ability id="ranged-sneak-attack-ex" icon={["boost"]}>
...
<Ability id="still-shot-ex" icon={["boost"]}>
...
<Ability id="branchwalking-ex" icon={["power"]}>
