...
const _traits_combat_all = {title: "All Combat Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_combat" className="reversed" info="Back to Combat Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitabsalombouncer-absalom-bouncer-fn1" extraClasses="trait" icon={["crossed-sabres"]}>
...
const _traits_combat_ab = {title: "Skill/Feat/Ability Combat Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_combat" className="reversed" info="Back to Combat Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitabsoluteloyalty-absolute-loyalty-fn1" extraClasses="trait" icon={["crossed-sabres"]}>
...
const _traits_combat_off = {title: "Offense Combat Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_combat" className="reversed" info="Back to Combat Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitabsalombouncer-absalom-bouncer-fn1" extraClasses="trait" icon={["crossed-sabres"]}>
...
const _traits_combat_def = {title: "Defense Combat Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_combat" className="reversed" info="Back to Combat Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitaldoricaution-aldori-caution-fn1" extraClasses="trait" icon={["crossed-sabres"]}>
...
const _traits_combat_class = {title: "Class-Specific Combat Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_combat" className="reversed" info="Back to Combat Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitberserkerofthesociety-berserker-of-the-society-fn1-fn2" extraClasses="trait" icon={["crossed-sabres"]}>
...
const _traits_combat_init = {title: "Initiative Combat Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_combat" className="reversed" info="Back to Combat Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitambushtraining-ambush-training-fn1" extraClasses="trait" icon={["crossed-sabres"]}>
