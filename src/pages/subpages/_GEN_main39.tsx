...
<Pair single="benefit" id="traitthunderandfangperformer-thunder-and-fang-performer-fn4-11-benefit">You gain a +2 trait bonus on Intimidate checks while wielding a two-handed melee weapon.</Pair>
</Ability>
...
const _traits_combat_ab = {title: "Skill/Feat/Ability-Focused Combat Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_combat" className="reversed" info="Back to Combat Traits" /><Ability id="traitabsoluteloyalty-absolute-loyalty-fn1" extraClasses="trait" icon={["crossed-sabres"]}>
...
<Ability id="traitundergrowthspecialist-undergrowth-specialist-fn20" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitundergrowthspecialist-undergrowth-specialist-fn20"><Link to="/trait/undergrowth_specialist">⮞</Link> Undergrowth Specialist <sup><InnerLink showBacklink="backlink-main-traits_combat_ab-fake-fn-20" id="main-traits_combat_ab-fake-fn-20" data-hash-target to="main-traits_combat_ab-fake-fn-20-target">20</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitundergrowthspecialist-undergrowth-specialist-fn20-flavor">You've trained yourself to move in and out of undergrowth with ease.</Pair>
<Pair single="benefit" id="traitundergrowthspecialist-undergrowth-specialist-fn20-benefit">The DCs of <Link to="/skill/acrobatics">Acrobatics</Link> checks don't increase for you when you're moving through light undergrowth, and the DCs of Acrobatics checks you attempt while you're moving through heavy undergrowth increase only by 2.</Pair>
</Ability>
<Ability id="traitvandal-vandal-fn21" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitvandal-vandal-fn21"><Link to="/trait/vandal">⮞</Link> Vandal <sup><InnerLink showBacklink="backlink-main-traits_combat_ab-fake-fn-21" id="main-traits_combat_ab-fake-fn-21" data-hash-target to="main-traits_combat_ab-fake-fn-21-target">21</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="benefit" id="traitvandal-vandal-fn21-benefit">You gain a +2 bonus on Strength checks to break objects, and when damaging an object with a weapon, natural weapon, or unarmed attack, you ignore 2 points of its hardness.</Pair>
</Ability>
...
<Ability id="traitvolatilefuse-volatile-fuse-fn20-2" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitvolatilefuse-volatile-fuse-fn20-2"><Link to="/trait/volatile_fuse">⮞</Link> Volatile Fuse <sup><InnerLink showBacklink="backlink-main-traits_combat_ab-fake-fn-20.2" id="main-traits_combat_ab-fake-fn-20.2" data-hash-target to="main-traits_combat_ab-fake-fn-20-target">20</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitvolatilefuse-volatile-fuse-fn20-2-flavor">Firearms you wield are especially dangerous to you and everyone nearby.</Pair>
<Pair single="benefit" id="traitvolatilefuse-volatile-fuse-fn20-2-benefit"><p>Whenever a firearm you wield misfires or explodes, roll a d%. On a result of 1-25, the misfire or explosion is delayed; reroll the attack with a -5 penalty (penalties from the broken condition are not applied to this reroll, and a firearm that was already broken does not explode). After the reroll is resolved, apply the effects of the misfire or explosion as normal. (If the d% roll result is 26 or higher, the misfire or explosion happens as normal.)</p>
<p>Whenever a firearm you wield explodes due to a misfire, increase the explosion's damage by 1d6 plus 1d6 for every 4 character levels you have.</p>
</Pair>
</Ability>
...
<li id="main-traits_combat_ab-fake-fn-20-target"><p><Link to="/source/people_of_the_wastes">People of the Wastes</Link> <InnerLink aria-label="Back to reference 20" id="backlink-main-traits_combat_ab-fake-fn-20" data-hash-target to="main-traits_combat_ab-fake-fn-20">↩</InnerLink> <InnerLink aria-label="Back to reference 20" id="backlink-main-traits_combat_ab-fake-fn-20.2" data-hash-target to="main-traits_combat_ab-fake-fn-20.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_combat_ab-fake-fn-21-target"><p><Link to="/source/heroes_of_the_wild">Heroes of the Wild</Link> <InnerLink aria-label="Back to reference 21" id="backlink-main-traits_combat_ab-fake-fn-21" data-hash-target to="main-traits_combat_ab-fake-fn-21">↩</InnerLink></p></li>
</ol></section></IonList>};
const _traits_combat_off = {title: "Offense-Focused Combat Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_combat" className="reversed" info="Back to Combat Traits" /><Ability id="traitabsalombouncer-absalom-bouncer-fn1" extraClasses="trait" icon={["crossed-sabres"]}>
...
<Ability id="traitelementalapprentice-elemental-apprentice-fn16" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitelementalapprentice-elemental-apprentice-fn16"><Link to="/trait/elemental_apprentice">⮞</Link> Elemental Apprentice <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-16" id="main-traits_combat_off-fake-fn-16" data-hash-target to="main-traits_combat_off-fake-fn-16-target">16</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitelementalapprentice-elemental-apprentice-fn16-flavor">You spent your childhood in a region of Golarion where the use of elemental magic is commonplace or the environment is heavily infused with elemental energies, such as the volcano Asuulek's Mouth or the hurricane-lashed Sodden Lands. Your time near raw elemental energies has inured you to taking damage from them.</Pair>
<Pair single="benefit" id="traitelementalapprentice-elemental-apprentice-fn16-benefit">At character creation, select acid, cold, electricity, or fire (once chosen, this damage type can't be changed). Once per day as a <strong className="hl">free action</strong>, when you hit a creature with a melee weapon, you can convert an amount of damage dealt by your attack equal to your character level into the selected energy type. You cannot convert this damage if any damage from the attack would normally deal a different type of energy damage (such as that of a <Link to="/magic-enh/flaming">flaming</Link> weapon).</Pair>
</Ability>
<Ability id="traitfailedaspirant-failed-aspirant-fn1-2" extraClasses="trait" icon={["crossed-sabres"]}>
...
<Ability id="traitfirebugqac-firebug-qac-fn17" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitfirebugqac-firebug-qac-fn17"><Link to="/trait/firebug_qac">⮞</Link> Firebug (QaC) <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-17" id="main-traits_combat_off-fake-fn-17" data-hash-target to="main-traits_combat_off-fake-fn-17-target">17</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitfirebugqac-firebug-qac-fn17-flavor">You were the child of a gunsmith or alchemist and always enjoyed experimenting with fiery alchemical items and minor explosives.</Pair>
<Pair single="benefit" id="traitfirebugqac-firebug-qac-fn17-benefit"><p>You gain a +1 trait bonus on attack rolls made with <Link to="/rule/throw_splash_weapon">thrown splash weapons</Link> and <Link to="/class/alchemist">alchemist</Link> bombs.</p>
<p><strong>Suggested Characters:</strong> Alkenstar natives, Katapeshi, Thuvians.</p>
</Pair>
</Ability>
<Ability id="traithellknightdevotion-hellknight-devotion-fn1-3" extraClasses="trait" icon={["crossed-sabres"]}>
...
<Ability id="traithellknightinitiate-hellknight-initiate-fn18" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traithellknightinitiate-hellknight-initiate-fn18"><Link to="/trait/hellknight_initiate">⮞</Link> Hellknight Initiate <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-18" id="main-traits_combat_off-fake-fn-18" data-hash-target to="main-traits_combat_off-fake-fn-18-target">18</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traithellknightinitiate-hellknight-initiate-fn18-flavor">You have laboriously studied the training rites of various <Link to="/rule/hellknights">Hellknight</Link> orders with the intent of joining one yourself.</Pair>
<Pair single="benefit" id="traithellknightinitiate-hellknight-initiate-fn18-benefit">You gain a +2 trait bonus on damage rolls against outsiders summoned through conjuration (calling) and conjuration (summoning) spells and effects.</Pair>
</Ability>
...
<Ability id="traithillfighter-hill-fighter-fn19" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traithillfighter-hill-fighter-fn19"><Link to="/trait/hill_fighter">⮞</Link> Hill Fighter <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-19" id="main-traits_combat_off-fake-fn-19" data-hash-target to="main-traits_combat_off-fake-fn-19-target">19</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair title="Region" hl>Sargava</Pair>
<Pair single="flavor" id="traithillfighter-hill-fighter-fn19-flavor">You are used to fighting in <Link to="/rule/hills_terrain">hilly environments</Link>.</Pair>
<Pair single="benefit" id="traithillfighter-hill-fighter-fn19-benefit">You may <Link to="/rule/run">run</Link> or <Link to="/rule/charge">charge</Link> downhill on a steep slope (moving up to your base speed) without making an <Link to="/skill/acrobatics">Acrobatics</Link> check to avoid stumbling - but if you travel farther than this distance, the normal rules for steep slopes apply.</Pair>
</Ability>
...
<Ability id="traitinspiringrush-inspiring-rush-fn20" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitinspiringrush-inspiring-rush-fn20"><Link to="/trait/inspiring_rush">⮞</Link> Inspiring Rush <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-20" id="main-traits_combat_off-fake-fn-20" data-hash-target to="main-traits_combat_off-fake-fn-20-target">20</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitinspiringrush-inspiring-rush-fn20-flavor">Your charge inspires nearby companions to new heights of daring.</Pair>
<Pair single="benefit" id="traitinspiringrush-inspiring-rush-fn20-benefit">Once per day when you make a <Link to="/rule/charge">charge</Link> attack, you gain a +1 trait bonus on both your attack and damage rolls, as do any allies who make a charge attack before the beginning of your next turn.</Pair>
</Ability>
...
<Ability id="traitperformerssurprise-performers-surprise-fn8-4" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitperformerssurprise-performers-surprise-fn8-4"><Link to="/trait/performers_surprise">⮞</Link> Performer's Surprise <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-8.4" id="main-traits_combat_off-fake-fn-8.4" data-hash-target to="main-traits_combat_off-fake-fn-8-target">8</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitperformerssurprise-performers-surprise-fn8-4-flavor">You are practiced at the surprising combat tricks of Varisian wanderers.</Pair>
<Pair single="benefit" id="traitperformerssurprise-performers-surprise-fn8-4-benefit">Against foes denied their Dexterity bonus to AC, you gain a +1 trait bonus on damage rolls with <Link to="/misc/improvised_weapons">improvised weapons</Link>, exotic weapons, and thrown weapons.</Pair>
</Ability>
<Ability id="traitpillager-pillager-fn17-2" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitpillager-pillager-fn17-2"><Link to="/trait/pillager">⮞</Link> Pillager <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-17.2" id="main-traits_combat_off-fake-fn-17.2" data-hash-target to="main-traits_combat_off-fake-fn-17-target">17</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitpillager-pillager-fn17-2-flavor">Growing up in a place where authorities, if there were any, rarely enforced property laws, you learned quickly that you have only what you can hold - but you gain whatever you can take.</Pair>
<Pair single="benefit" id="traitpillager-pillager-fn17-2-benefit"><p>You gain a +1 trait bonus on combat maneuver checks to perform <Link to="/rule/disarm">disarm</Link> and <Link to="/rule/steal">steal</Link> combat maneuvers.</p>
<p><strong>Suggested Characters:</strong> Halflings, River Kingdoms natives, Shackles natives.</p>
</Pair>
</Ability>
...
<Ability id="traitredmantisbleeding-red-mantis-bleeding-fn8-5" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitredmantisbleeding-red-mantis-bleeding-fn8-5"><Link to="/trait/red_mantis_bleeding">⮞</Link> Red Mantis Bleeding <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-8.5" id="main-traits_combat_off-fake-fn-8.5" data-hash-target to="main-traits_combat_off-fake-fn-8-target">8</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitredmantisbleeding-red-mantis-bleeding-fn8-5-flavor">You witnessed the training of <Link to="/rule/red_mantis">Red Mantis</Link> assassins, either as a child on Mediogalti Island or as an aspirant, and learned to leave bleeding wounds.</Pair>
<Pair single="benefit" id="traitredmantisbleeding-red-mantis-bleeding-fn8-5-benefit">Whenever you confirm a critical hit with a slashing weapon, you also deal 1 point of <Link to="/rule/bleed">bleed</Link> damage.</Pair>
</Ability>
<Ability id="traitriverfighter-river-fighter-fn19-2" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitriverfighter-river-fighter-fn19-2"><Link to="/trait/river_fighter">⮞</Link> River Fighter <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-19.2" id="main-traits_combat_off-fake-fn-19.2" data-hash-target to="main-traits_combat_off-fake-fn-19-target">19</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair title="Region" hl>Sargava</Pair>
<Pair single="flavor" id="traitriverfighter-river-fighter-fn19-2-flavor">You are used to fighting while swimming.</Pair>
<Pair single="benefit" id="traitriverfighter-river-fighter-fn19-2-benefit">You may swim downstream or cross-current as a <Link to="/rule/charge">charge</Link> if you make your <Link to="/skill/swim">Swim</Link> DC by 5 or more.</Pair>
</Ability>
<Ability id="traitrovingrange-roving-range-fn8-6" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitrovingrange-roving-range-fn8-6"><Link to="/trait/roving_range">⮞</Link> Roving Range <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-8.6" id="main-traits_combat_off-fake-fn-8.6" data-hash-target to="main-traits_combat_off-fake-fn-8-target">8</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitrovingrange-roving-range-fn8-6-flavor">You learned from pirates to make the most of ranged attacks as you close with targets.</Pair>
<Pair single="benefit" id="traitrovingrange-roving-range-fn8-6-benefit">Increase the range increment of ranged weapons (but not thrown weapons) you wield by 5 feet.</Pair>
</Ability>
...
<Ability id="traitswornenemy-sworn-enemy-fn17-3" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitswornenemy-sworn-enemy-fn17-3"><Link to="/trait/sworn_enemy">⮞</Link> Sworn Enemy <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-17.3" id="main-traits_combat_off-fake-fn-17.3" data-hash-target to="main-traits_combat_off-fake-fn-17-target">17</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitswornenemy-sworn-enemy-fn17-3-flavor">You were raised with defiance, fear, or hatred of a particular sort of foe. To make you ready to resist such foes, you were trained for long hours in the proper ways to defeat them.</Pair>
<Pair single="benefit" id="traitswornenemy-sworn-enemy-fn17-3-benefit"><p>Choose a foe from the ranger's list of <Link to="/ability/favored_enemies">favored enemies</Link>. You gain a +1 trait bonus on attacks of opportunity against the chosen foe.</p>
<p><strong>Suggested Characters:</strong> Dwarves, Isgeri, Mendevian crusaders.</p>
</Pair>
</Ability>
...
<Ability id="traitthreateningdefender-threatening-defender-fn28" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitthreateningdefender-threatening-defender-fn28"><Link to="/trait/threatening_defender">⮞</Link> Threatening Defender <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-28" id="main-traits_combat_off-fake-fn-28" data-hash-target to="main-traits_combat_off-fake-fn-28-target">28</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitthreateningdefender-threatening-defender-fn28-flavor">You know how to avoid a blow while still maintaining your offensive posture.</Pair>
<Pair single="benefit" id="traitthreateningdefender-threatening-defender-fn28-benefit">When you use <Link to="/feat/combat_expertise">Combat Expertise</Link>, reduce the number you subtract from your melee attack rolls by 1.</Pair>
</Ability>
...
<Ability id="traitvengefulcombat-vengeful-combat-fn17-4" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitvengefulcombat-vengeful-combat-fn17-4"><Link to="/trait/vengeful_combat">⮞</Link> Vengeful (Combat) <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-17.4" id="main-traits_combat_off-fake-fn-17.4" data-hash-target to="main-traits_combat_off-fake-fn-17-target">17</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitvengefulcombat-vengeful-combat-fn17-4-flavor">During your childhood, you suffered occasional or frequent abuse from those too powerful for you to resist. Now you thrill at the chance to get back at those who wronged you.</Pair>
<Pair single="benefit" id="traitvengefulcombat-vengeful-combat-fn17-4-benefit"><p>Whenever you strike the last creature that damaged you in the past 24 hours, you gain a +1 trait bonus on damage rolls against that creature.</p>
<p><strong>Suggested Characters:</strong> Calistrians, Galtan refugees, Gyronna worshipers.</p>
</Pair>
</Ability>
...
<Ability id="traityouthfulinfiltrator-youthful-infiltrator-fn29" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traityouthfulinfiltrator-youthful-infiltrator-fn29"><Link to="/trait/youthful_infiltrator">⮞</Link> Youthful Infiltrator <sup><InnerLink showBacklink="backlink-main-traits_combat_off-fake-fn-29" id="main-traits_combat_off-fake-fn-29" data-hash-target to="main-traits_combat_off-fake-fn-29-target">29</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traityouthfulinfiltrator-youthful-infiltrator-fn29-flavor">You were trained from a young age to ambush the enemies of your order or organization, which makes you hard to trust for most outside your organization if they learn your affiliation.</Pair>
<Pair single="benefit" id="traityouthfulinfiltrator-youthful-infiltrator-fn29-benefit">You gain a +1 trait bonus on attack rolls against <Link to="/rule/flat_footed">flat-footed</Link> foes, as long as they have not seen you make an attack with this bonus before.</Pair>
</Ability>
...
<li id="main-traits_combat_off-fake-fn-15-target"><p><Link to="/source/antiheros_handbook">Antihero's Handbook</Link> <InnerLink aria-label="Back to reference 15" id="backlink-main-traits_combat_off-fake-fn-15" data-hash-target to="main-traits_combat_off-fake-fn-15">↩</InnerLink></p></li>
<li id="main-traits_combat_off-fake-fn-16-target"><p><Link to="/source/elemental_masters_handbook">Elemental Master's Handbook</Link> <InnerLink aria-label="Back to reference 16" id="backlink-main-traits_combat_off-fake-fn-16" data-hash-target to="main-traits_combat_off-fake-fn-16">↩</InnerLink></p></li>
<li id="main-traits_combat_off-fake-fn-17-target"><p><Link to="/source/quests_and_campaigns">Quests and Campaigns</Link> <InnerLink aria-label="Back to reference 17" id="backlink-main-traits_combat_off-fake-fn-17" data-hash-target to="main-traits_combat_off-fake-fn-17">↩</InnerLink> <InnerLink aria-label="Back to reference 17" id="backlink-main-traits_combat_off-fake-fn-17.2" data-hash-target to="main-traits_combat_off-fake-fn-17.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 17" id="backlink-main-traits_combat_off-fake-fn-17.3" data-hash-target to="main-traits_combat_off-fake-fn-17.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 17" id="backlink-main-traits_combat_off-fake-fn-17.4" data-hash-target to="main-traits_combat_off-fake-fn-17.4">↩<sup>4</sup></InnerLink></p></li>
<li id="main-traits_combat_off-fake-fn-18-target"><p><Link to="/source/monster_summoners_handbook">Monster Summoner's Handbook</Link> <InnerLink aria-label="Back to reference 18" id="backlink-main-traits_combat_off-fake-fn-18" data-hash-target to="main-traits_combat_off-fake-fn-18">↩</InnerLink></p></li>
<li id="main-traits_combat_off-fake-fn-19-target"><p><Link to="/source/sargava_the_lost_colony">Sargava, the Lost Colony</Link> <InnerLink aria-label="Back to reference 19" id="backlink-main-traits_combat_off-fake-fn-19" data-hash-target to="main-traits_combat_off-fake-fn-19">↩</InnerLink> <InnerLink aria-label="Back to reference 19" id="backlink-main-traits_combat_off-fake-fn-19.2" data-hash-target to="main-traits_combat_off-fake-fn-19.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_combat_off-fake-fn-20-target"><p><Link to="/source/knights_of_the_inner_sea">Knights of the Inner Sea</Link> <InnerLink aria-label="Back to reference 20" id="backlink-main-traits_combat_off-fake-fn-20" data-hash-target to="main-traits_combat_off-fake-fn-20">↩</InnerLink></p></li>
...
<li id="main-traits_combat_off-fake-fn-28-target"><p><Link to="/source/cheliax_empire_of_devils">Cheliax, Empire of Devils</Link> <InnerLink aria-label="Back to reference 28" id="backlink-main-traits_combat_off-fake-fn-28" data-hash-target to="main-traits_combat_off-fake-fn-28">↩</InnerLink></p></li>
<li id="main-traits_combat_off-fake-fn-29-target"><p><Link to="/source/spymasters_handbook">Spymaster's Handbook</Link> <InnerLink aria-label="Back to reference 29" id="backlink-main-traits_combat_off-fake-fn-29" data-hash-target to="main-traits_combat_off-fake-fn-29">↩</InnerLink></p></li>
</ol></section></IonList>};
const _traits_combat_def = {title: "Defense-Focused Combat Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_combat" className="reversed" info="Back to Combat Traits" /><Ability id="traitaldoricaution-aldori-caution-fn1" extraClasses="trait" icon={["crossed-sabres"]}>
...
<Ability id="traitimproviseddefense-improvised-defense-fn11" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitimproviseddefense-improvised-defense-fn11"><Link to="/trait/improvised_defense">⮞</Link> Improvised Defense <sup><InnerLink showBacklink="backlink-main-traits_combat_def-fake-fn-11" id="main-traits_combat_def-fake-fn-11" data-hash-target to="main-traits_combat_def-fake-fn-11-target">11</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitimproviseddefense-improvised-defense-fn11-flavor">You're never defenseless, even when you are caught off guard.</Pair>
<Pair single="benefit" id="traitimproviseddefense-improvised-defense-fn11-benefit">Whenever you wield an improvised weapon, you gain a +1 shield bonus to AC. If you use the improvised weapon to attack, you lose this shield bonus until the beginning of your next turn.</Pair>
</Ability>
<Ability id="traitmonstersurvivor-monster-survivor-fn12" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitmonstersurvivor-monster-survivor-fn12"><Link to="/trait/monster_survivor">⮞</Link> Monster Survivor <sup><InnerLink showBacklink="backlink-main-traits_combat_def-fake-fn-12" id="main-traits_combat_def-fake-fn-12" data-hash-target to="main-traits_combat_def-fake-fn-12-target">12</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitmonstersurvivor-monster-survivor-fn12-flavor">You've escaped with your life after a terrible monster attack.</Pair>
<Pair single="benefit" id="traitmonstersurvivor-monster-survivor-fn12-benefit">You gain a +4 dodge bonus to AC against attacks of opportunity made against you by Large or larger opponents when you're making a <Link to="/rule/withdraw">withdraw</Link> action.</Pair>
</Ability>
...
<Ability id="traitwaryeye-wary-eye-fn13" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitwaryeye-wary-eye-fn13"><Link to="/trait/wary_eye">⮞</Link> Wary Eye <sup><InnerLink showBacklink="backlink-main-traits_combat_def-fake-fn-13" id="main-traits_combat_def-fake-fn-13" data-hash-target to="main-traits_combat_def-fake-fn-13-target">13</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitwaryeye-wary-eye-fn13-flavor">You know that you could be exposed at any time. Even your closest friends could someday become enemies, and so you have trained yourself to never be surprised by a betrayal.</Pair>
<Pair single="benefit" id="traitwaryeye-wary-eye-fn13-benefit"><p>At the beginning of combat, before initiative checks are revealed, you can select one opponent you are aware of to be the subject of this trait. If you succeed at a Wisdom check opposed by the subject's initiative check, you are not considered <Link to="/rule/flat_footed">flat-footed</Link> against this subject for this combat, even if you normally would be.</p>
<p>You can use this trait in a surprise round, even if you cannot otherwise act that round.</p>
</Pair>
</Ability>
<section data-footnotes><h3 id="main-traits_combat_def-label">Footnotes</h3><ol>
<li id="main-traits_combat_def-fake-fn-1-target"><p><Link to="/source/weapon_masters_handbook">Weapon Master's Handbook</Link> <InnerLink aria-label="Back to reference 1" id="backlink-main-traits_combat_def-fake-fn-1" data-hash-target to="main-traits_combat_def-fake-fn-1">↩</InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-main-traits_combat_def-fake-fn-1.2" data-hash-target to="main-traits_combat_def-fake-fn-1.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-main-traits_combat_def-fake-fn-1.3" data-hash-target to="main-traits_combat_def-fake-fn-1.3">↩<sup>3</sup></InnerLink></p></li>
...
<li id="main-traits_combat_def-fake-fn-11-target"><p><Link to="/source/bastards_of_golarion">Bastards of Golarion</Link> <InnerLink aria-label="Back to reference 11" id="backlink-main-traits_combat_def-fake-fn-11" data-hash-target to="main-traits_combat_def-fake-fn-11">↩</InnerLink></p></li>
<li id="main-traits_combat_def-fake-fn-12-target"><p><Link to="/source/monster_hunters_handbook">Monster Hunter's Handbook</Link> <InnerLink aria-label="Back to reference 12" id="backlink-main-traits_combat_def-fake-fn-12" data-hash-target to="main-traits_combat_def-fake-fn-12">↩</InnerLink></p></li>
<li id="main-traits_combat_def-fake-fn-13-target"><p><Link to="/source/spymasters_handbook">Spymaster's Handbook</Link> <InnerLink aria-label="Back to reference 13" id="backlink-main-traits_combat_def-fake-fn-13" data-hash-target to="main-traits_combat_def-fake-fn-13">↩</InnerLink></p></li>
</ol></section></IonList>};
const _traits_combat_offdef = {title: "Combat Traits with Offensive and Defensive Benefits", jsx: <IonList lines="full"><MainLink to="/main/traits_combat" className="reversed" info="Back to Combat Traits" /><Ability id="traitduelingcloakadept-dueling-cloak-adept-fn1" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitduelingcloakadept-dueling-cloak-adept-fn1"><Link to="/trait/dueling_cloak_adept">⮞</Link> Dueling Cloak Adept <sup><InnerLink showBacklink="backlink-main-traits_combat_offdef-fake-fn-1" id="main-traits_combat_offdef-fake-fn-1" data-hash-target to="main-traits_combat_offdef-fake-fn-1-target">1</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitduelingcloakadept-dueling-cloak-adept-fn1-flavor">You are trained in using your cloak to disguise your body and deceive your enemies.</Pair>
<Pair single="benefit" id="traitduelingcloakadept-dueling-cloak-adept-fn1-benefit">While wearing a cloak and using an <Link to="/eq-weapon/aldori_dueling_sword">Aldori dueling sword</Link>, you gain a +2 trait bonus on <Link to="/skill/bluff">Bluff</Link> checks made to feint. Additionally, every time you successfully feint while wearing a cloak, you gain a +1 dodge bonus to your Armor Class until your next turn.</Pair>
</Ability>
<Ability id="traitozeminspired-ozem-inspired-fn2" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitozeminspired-ozem-inspired-fn2"><Link to="/trait/ozem_inspired">⮞</Link> Ozem-Inspired <sup><InnerLink showBacklink="backlink-main-traits_combat_offdef-fake-fn-2" id="main-traits_combat_offdef-fake-fn-2" data-hash-target to="main-traits_combat_offdef-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitozeminspired-ozem-inspired-fn2-flavor">Tales of the Knights of Ozem have inspired you since childhood to lash out reflexively against the undead.</Pair>
<Pair single="benefit" id="traitozeminspired-ozem-inspired-fn2-benefit">You gain a +1 trait bonus on attack rolls and damage rolls when making attacks of opportunity against undead. While you wield a shield, your shield bonus to AC improves by 1 against attacks of opportunity made by undead.</Pair>
</Ability>
<Ability id="traitsavannahunter-savanna-hunter-fn3" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitsavannahunter-savanna-hunter-fn3"><Link to="/trait/savanna_hunter">⮞</Link> Savanna Hunter <sup><InnerLink showBacklink="backlink-main-traits_combat_offdef-fake-fn-3" id="main-traits_combat_offdef-fake-fn-3" data-hash-target to="main-traits_combat_offdef-fake-fn-3-target">3</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitsavannahunter-savanna-hunter-fn3-flavor">You have been trained to hunt and fight on the open plains since birth.</Pair>
<Pair single="benefit" id="traitsavannahunter-savanna-hunter-fn3-benefit">You gain a +1 trait bonus on attacks of opportunity attack rolls made with a <Link to="/eq-weapon/shortspear">shortspear</Link>, as well as a +1 racial bonus on Constitution checks to continue <Link to="/rule/run">running</Link> and avoid nonlethal damage from a <Link to="/rule/forced_march">forced march</Link>.</Pair>
</Ability>
<Ability id="traitspiritofthelaw-spirit-of-the-law-fn4" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitspiritofthelaw-spirit-of-the-law-fn4"><Link to="/trait/spirit_of_the_law">⮞</Link> Spirit of the Law <sup><InnerLink showBacklink="backlink-main-traits_combat_offdef-fake-fn-4" id="main-traits_combat_offdef-fake-fn-4" data-hash-target to="main-traits_combat_offdef-fake-fn-4-target">4</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitspiritofthelaw-spirit-of-the-law-fn4-flavor">You have seen the rules of society endlessly twisted in their implementation, and as such, you are especially wary of those who exploit the law to impose their own will.</Pair>
<Pair single="benefit" id="traitspiritofthelaw-spirit-of-the-law-fn4-benefit">You gain a +1 trait bonus on attacks against lawful-aligned humanoids and a +2 trait bonus on saving throws against effects with the lawful descriptor.</Pair>
</Ability>
<Ability id="traittarnishedhallsrunner-tarnished-halls-runner-fn5" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traittarnishedhallsrunner-tarnished-halls-runner-fn5"><Link to="/trait/tarnished_halls_runner">⮞</Link> Tarnished Halls Runner <sup><InnerLink showBacklink="backlink-main-traits_combat_offdef-fake-fn-5" id="main-traits_combat_offdef-fake-fn-5" data-hash-target to="main-traits_combat_offdef-fake-fn-5-target">5</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traittarnishedhallsrunner-tarnished-halls-runner-fn5-flavor">You evaded Technic League patrols with the <Link to="/rule/tarnished_halls">Blood Gar pirates</Link>.</Pair>
<Pair single="benefit" id="traittarnishedhallsrunner-tarnished-halls-runner-fn5-benefit">When you move at least 10 feet, you gain a +1 trait bonus on attack rolls with firearms and technological weapons and a +1 dodge bonus to your AC against such weapons until the start of your next turn.</Pair>
</Ability>
<section data-footnotes><h3 id="main-traits_combat_offdef-label">Footnotes</h3><ol>
<li id="main-traits_combat_offdef-fake-fn-1-target"><p><Link to="/source/knights_of_the_inner_sea">Knights of the Inner Sea</Link> <InnerLink aria-label="Back to reference 1" id="backlink-main-traits_combat_offdef-fake-fn-1" data-hash-target to="main-traits_combat_offdef-fake-fn-1">↩</InnerLink></p></li>
<li id="main-traits_combat_offdef-fake-fn-2-target"><p><Link to="/source/weapon_masters_handbook">Weapon Master's Handbook</Link> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_combat_offdef-fake-fn-2" data-hash-target to="main-traits_combat_offdef-fake-fn-2">↩</InnerLink></p></li>
<li id="main-traits_combat_offdef-fake-fn-3-target"><p><Link to="/source/sargava_the_lost_colony">Sargava, the Lost Colony</Link> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_combat_offdef-fake-fn-3" data-hash-target to="main-traits_combat_offdef-fake-fn-3">↩</InnerLink></p></li>
<li id="main-traits_combat_offdef-fake-fn-4-target"><p><Link to="/source/antiheros_handbook">Antihero's Handbook</Link> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_combat_offdef-fake-fn-4" data-hash-target to="main-traits_combat_offdef-fake-fn-4">↩</InnerLink></p></li>
<li id="main-traits_combat_offdef-fake-fn-5-target"><p><Link to="/source/black_markets">Black Markets</Link> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_combat_offdef-fake-fn-5" data-hash-target to="main-traits_combat_offdef-fake-fn-5">↩</InnerLink></p></li>
</ol></section></IonList>};
...
<Ability id="traitresolveoftherejected-resolve-of-the-rejected-fn3-10" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitresolveoftherejected-resolve-of-the-rejected-fn3-10"><Link to="/trait/resolve_of_the_rejected">⮞</Link> Resolve of the Rejected <sup><InnerLink showBacklink="backlink-main-traits_combat_class-fake-fn-3.10" id="main-traits_combat_class-fake-fn-3.10" data-hash-target to="main-traits_combat_class-fake-fn-3-target">3</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitresolveoftherejected-resolve-of-the-rejected-fn3-10-flavor">Some disagree with your choice to wield a firearm, and their scorn has only hardened your resolve in battle.</Pair>
<Pair single="benefit" id="traitresolveoftherejected-resolve-of-the-rejected-fn3-10-benefit">You gain a +1 trait bonus on all saving throws against charm and compulsion effects. Also, once per day when you succeed at a saving throw against such an effect, you regain 1 grit point.</Pair>
</Ability>
...
<Ability id="traitscarreddescendant-scarred-descendant-fn3-11" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitscarreddescendant-scarred-descendant-fn3-11"><Link to="/trait/scarred_descendant">⮞</Link> Scarred Descendant <sup><InnerLink showBacklink="backlink-main-traits_combat_class-fake-fn-3.11" id="main-traits_combat_class-fake-fn-3.11" data-hash-target to="main-traits_combat_class-fake-fn-3-target">3</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitscarreddescendant-scarred-descendant-fn3-11-flavor">Your own people are your <Link to="/ability/favored_enemy">favored enemy</Link>.</Pair>
<Pair single="benefit" id="traitscarreddescendant-scarred-descendant-fn3-11-benefit">You gain a +1 trait bonus on rolls to confirm critical hits against favored enemies of your own subtype and on Survival checks made to track such creatures.</Pair>
</Ability>
...
const _traits_combat_init = {title: "Initiative-Focused Combat Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_combat" className="reversed" info="Back to Combat Traits" /><Ability id="traitambushtraining-ambush-training-fn1" extraClasses="trait" icon={["crossed-sabres"]}>
...
<Ability id="traitthunderandfangperformer-thunder-and-fang-performer-fn9" extraClasses="trait" icon={["crossed-sabres"]}>
<Pair single id="traitthunderandfangperformer-thunder-and-fang-performer-fn9"><Link to="/trait/thunder_and_fang_performer">⮞</Link> Thunder and Fang Performer <sup><InnerLink showBacklink="backlink-main-traits_combat_init-fake-fn-9" id="main-traits_combat_init-fake-fn-9" data-hash-target to="main-traits_combat_init-fake-fn-9-target">9</InnerLink></sup></Pair>
<Pair title="Type">Combat</Pair>
<Pair single="flavor" id="traitthunderandfangperformer-thunder-and-fang-performer-fn9-flavor">You learned from Shoanti champions to take advantage of the dramatic swings required by heavy weapons like the <Link to="/eq-weapon/earth_breaker">earth breaker</Link>.</Pair>
<Pair single="benefit" id="traitthunderandfangperformer-thunder-and-fang-performer-fn9-benefit">You gain a +2 trait bonus on Intimidate checks while wielding a two-handed melee weapon.</Pair>
</Ability>
...
<li id="main-traits_combat_init-fake-fn-9-target"><p><Link to="/source/weapon_masters_handbook">Weapon Master's Handbook</Link> <InnerLink aria-label="Back to reference 9" id="backlink-main-traits_combat_init-fake-fn-9" data-hash-target to="main-traits_combat_init-fake-fn-9">↩</InnerLink></p></li>
</ol></section></IonList>};
export default {traits_combat:_traits_combat,traits_combat_all:_traits_combat_all,traits_combat_ab:_traits_combat_ab,traits_combat_off:_traits_combat_off,traits_combat_def:_traits_combat_def,traits_combat_offdef:_traits_combat_offdef,traits_combat_class:_traits_combat_class,traits_combat_init:_traits_combat_init}