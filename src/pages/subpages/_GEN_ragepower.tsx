...
<Ability id="animal-fury-ex" icon={["melee"]}>
...
<Ability id="greater-animal-fury-ex" icon={["boost"]}>
...
<Ability id="bloody-bite-ex" icon={["boost"]}>
...
<Ability id="feasting-bite-ex" icon={["aid"]}>
...
<Ability id="penetrating-bite-ex" icon={["boost"]}>
...
<Ability id="savage-jaw-ex" icon={["melee"]}>
...
<Ability id="vipers-kiss-ex" icon={["melee"]}>
...
<Ability id="vipers-breath-ex" icon={["cone"]}>
...
<Ability id="enhance-venom-ex" icon={["boost"]}>
...
<Ability id="armor-ripper" icon={["boost"]}>
...
<Ability id="auspicious-mark-su" icon={["boost"]}>
...
<Ability id="autumn-rage-su" icon={["boost"]}>
...
<Ability id="bloody-fist-ex" icon={["melee"]}>
...
<Ability id="feast-of-blood-su" icon={["aid","def"]}>
...
<Ability id="boars-charge" icon={["melee","boost"]}>
...
<Ability id="boasting-taunt-ex" icon={["lower"]}>
...
<Ability id="body-bludgeon-ex" icon={["melee"]}>
...
<Ability id="greater-brawler" icon={["melee"]}>
...
<Ability id="breathtaker-ex" icon={["lower"]}>
...
<Ability id="clear-mind-ex" icon={["def","roll"]}>
...
<Ability id="come-and-get-me-ex" icon={["down","melee"]}>
...
<Ability id="contagious-rage-su" icon={["boost"]}>
...
<Ability id="deathless-frenzy" icon={["power"]}>
...
<Ability id="disemboweling-tusks" icon={["boost"]}>
...
<Ability id="dissipating-rage-su" icon={["lower"]}>
...
<Ability id="eclipsing-rage-su" icon={["magic"]}>
...
<Ability id="greater-eclipsing-rage-su" icon={["magic"]}>
...
<Ability id="lesser-elemental-rage-su" icon={["boost"]}>
...
<Ability id="elemental-rage-su" icon={["boost"]}>
...
<Ability id="greater-elemental-rage-su" icon={["boost"]}>
...
<Ability id="energy-resistance-ex" icon={["def"]}>
...
<Ability id="greater-energy-resistance-ex" icon={["def"]}>
...
<Ability id="energy-eruption-su" icon={["def","line","cone"]}>
...
<Ability id="erratic-charge-ex" icon={["melee"]}>
...
<Ability id="greater-erratic-charge-ex" icon={["melee"]}>
...
<Ability id="fearless-rage-ex" icon={["def"]}>
...
<Ability id="ferocious-beast-ex" icon={["power"]}>
...
<Ability id="greater-ferocious-beast-ex" icon={["power"]}>
...
<Ability id="ferocious-mount-ex" icon={["power"]}>
...
<Ability id="greater-ferocious-mount-ex" icon={["power"]}>
...
<Ability id="ferocious-trample-ex" icon={["melee"]}>
...
<Ability id="greater-ferocious-trample-ex" icon={["boost","melee"]}>
...
<Ability id="spirit-steed-su" icon={["def","boost"]}>
...
<Ability id="fierce-fortitude-ex" icon={["def"]}>
...
<Ability id="flesh-wound-ex" icon={["def"]}>
...
<Ability id="flight-response" icon={["def"]}>
...
<Ability id="fueled-by-vengeance" icon={["boost"]}>
...
<Ability id="furious-draw" icon={["power"]}>
...
<Ability id="furious-barrage-ex" icon={["power","ranged"]}>
...
<Ability id="ghost-rager-su" icon={["boost","def"]}>
...
<Ability id="good-for-what-ails-you-ex" icon={["def"]}>
...
<Ability id="ground-breaker-ex" icon={["melee","lower"]}>
...
<Ability id="greater-ground-breaker-ex" icon={["boost"]}>
...
<Ability id="guarded-life-ex" icon={["def"]}>
...
<Ability id="greater-guarded-life-ex" icon={["boost"]}>
...
<Ability id="hissing-rage-su" icon={["touch"]}>
...
<Ability id="lesser-hurling-ex" icon={["zap"]}>
...
<Ability id="hurling-ex" icon={["boost"]}>
...
<Ability id="greater-hurling-ex" icon={["boost"]}>
...
<Ability id="hurling-charge-ex" icon={["zap"]}>
...
<Ability id="impelling-disarm-ex" icon={["melee","ranged"]}>
...
<Ability id="increased-damage-reduction-ex" icon={["def"]}>
...
<Ability id="internal-fortitude-ex" icon={["def"]}>
...
<Ability id="intimidating-glare-ex" icon={["lower"]}>
...
<Ability id="battle-roar-su" icon={["zap"]}>
...
<Ability id="terrifying-howl-ex" icon={["lower"]}>
...
<Ability id="inured-to-the-dead" icon={["def","roll"]}>
...
<Ability id="knockback-ex" icon={["melee"]}>
...
<Ability id="knockdown-ex" icon={["melee"]}>
...
<Ability id="cairn-linnorm-death-curse-su" icon={["boost","def"]}>
...
<Ability id="crag-linnorm-death-curse-su" icon={["boost","def"]}>
...
<Ability id="fjord-linnorm-death-curse-su" icon={["boost","def"]}>
...
<Ability id="ice-linnorm-death-curse-su" icon={["boost","def"]}>
...
<Ability id="taiga-linnorm-death-curse-su" icon={["boost","def"]}>
...
<Ability id="tarn-linnorm-death-curse-su" icon={["boost","def"]}>
...
<Ability id="tor-linnorm-death-curse-su" icon={["boost","def"]}>
...
<Ability id="liquid-courage-ex" icon={["def"]}>
...
<Ability id="lizard-stride-su" icon={["magic"]}>
...
<Ability id="night-vision-ex" icon={["power"]}>
...
<Ability id="master-of-the-deep-su" icon={["magic"]}>
...
<Ability id="mighty-swing-ex" icon={["boost"]}>
...
<Ability id="moment-of-clarity-ex" icon={["power"]}>
...
<Ability id="perfect-clarity-ex" icon={["def","roll"]}>
...
<Ability id="ultimate-clarity-su" icon={["power"]}>
...
<Ability id="overbearing-advance-ex" icon={["boost"]}>
...
<Ability id="overbearing-onslaught-ex" icon={["boost"]}>
...
<Ability id="no-escape-ex" icon={["power"]}>
...
<Ability id="pack-rage-ex" icon={["power"]}>
...
<Ability id="bleeding-blow-ex" icon={["boost"]}>
...
<Ability id="crippling-blow-ex" icon={["boost"]}>
...
<Ability id="quick-reflexes-ex" icon={["melee"]}>
...
<Ability id="raging-climber-ex" icon={["boost"]}>
...
<Ability id="bestial-climber-ex" icon={["power"]}>
...
<Ability id="raging-flyer-ex" icon={["boost"]}>
...
<Ability id="bestial-flyer-ex" icon={["boost"]}>
...
<Ability id="raging-leaper-ex" icon={["boost"]}>
...
<Ability id="bestial-leaper-ex" icon={["power"]}>
...
<Ability id="raging-flier-su" icon={["power"]}>
...
<Ability id="raging-grappler-ex" icon={["melee"]}>
...
<Ability id="raging-swimmer-ex" icon={["boost"]}>
...
<Ability id="bestial-swimmer-ex" icon={["power"]}>
...
<Ability id="raging-whirlwind-su" icon={["lower"]}>
...
<Ability id="reckless-abandon-ex" icon={["boost","down"]}>
...
<Ability id="inspire-ferocity-ex" icon={["boost","down"]}>
...
<Ability id="renewed-vigor-ex" icon={["aid"]}>
...
<Ability id="regenerative-vigor-ex" icon={["aid"]}>
...
<Ability id="renewed-vitality-ex" icon={["boost"]}>
...
<Ability id="renewed-life-ex" icon={["boost"]}>
...
<Ability id="roaring-drunk-ex" icon={["boost"]}>
...
<Ability id="reflexive-dodge-ex" icon={["def"]}>
...
<Ability id="roused-anger-ex" icon={["power"]}>
...
<Ability id="savage-dirty-trick-ex" icon={["melee","lower"]}>
...
<Ability id="savage-hurl-ex" icon={["boost"]}>
...
<Ability id="savage-intuition" icon={["power"]}>
...
<Ability id="primal-scent-ex" icon={["boost"]}>
...
<Ability id="smasher-ex" icon={["boost"]}>
...
<Ability id="gearbreaker-ex" icon={["boost"]}>
...
<Ability id="spiritual-awareness" icon={["def"]}>
...
<Ability id="spring-rage-su" icon={["boost"]}>
...
<Ability id="staggering-drunk-ex" icon={["def"]}>
...
<Ability id="strength-surge-ex" icon={["boost","def"]}>
...
<Ability id="suffocating-grip-ex" icon={["lower"]}>
...
<Ability id="greater-suffocating-grip-ex" icon={["lower"]}>
...
<Ability id="summer-rage-su" icon={["lower"]}>
...
<Ability id="disruptive" icon={["power"]}>
...
<Ability id="eater-of-magic-su" icon={["def"]}>
...
<Ability id="spellbreaker" icon={["power"]}>
...
<Ability id="witch-hunter-ex" icon={["boost"]}>
...
<Ability id="spell-sunder-su" icon={["magic"]}>
...
<Ability id="sunder-enchantment-su" icon={["magic"]}>
...
<Ability id="surprise-accuracy-ex" icon={["boost"]}>
...
<Ability id="deadly-accuracy-ex" icon={["boost"]}>
...
<Ability id="lethal-accuracy-ex" icon={["boost"]}>
...
<Ability id="sharpened-accuracy-ex" icon={["boost"]}>
...
<Ability id="swift-foot-ex" icon={["boost"]}>
...
<Ability id="sprint-ex" icon={["power"]}>
...
<Ability id="two-fanged-pounce" icon={["power"]}>
...
<Ability id="unexpected-strike-ex" icon={["melee"]}>
...
<Ability id="unrestrained-rage" icon={["def"]}>
...
<Ability id="water-sense-ex" icon={["lower","boost"]}>
...
<Ability id="winter-rage-su" icon={["cone"]}>
...
<Ability id="hshurhas-veil-su" icon={["power","boost"]}>
...
<Ability id="kelizandris-tide-su" icon={["melee"]}>
...
<Ability id="ymeris-pyre-su" icon={["def"]}>
...
<Ability id="lesser-ancestor-totem-su" icon={["boost"]}>
...
<Ability id="ancestor-totem-su" icon={["boost"]}>
...
<Ability id="greater-ancestor-totem-su" icon={["boost","roll"]}>
...
<Ability id="lesser-atavism-totem-su" icon={["melee"]}>
...
<Ability id="atavism-totem-su" icon={["power"]}>
...
<Ability id="greater-atavism-totem-su" icon={["power","melee"]}>
...
<Ability id="lesser-beast-totem-su" icon={["melee"]}>
...
<Ability id="greater-beast-totem-su" icon={["melee","boost"]}>
...
<Ability id="lesser-celestial-totem-su" icon={["aid","boost"]}>
...
<Ability id="celestial-totem-su" icon={["magic"]}>
...
<Ability id="greater-celestial-totem-su" icon={["def"]}>
...
<Ability id="lesser-chaos-totem-su" icon={["def"]}>
...
<Ability id="chaos-totem-su" icon={["boost","def"]}>
...
<Ability id="greater-chaos-totem-su" icon={["def","boost"]}>
...
<Ability id="lesser-cult-totem-ex" icon={["power"]}>
...
<Ability id="cult-totem-ex" icon={["protect"]}>
...
<Ability id="greater-cult-totem-ex" icon={["power"]}>
...
<Ability id="lesser-daemon-totem" icon={["def"]}>
...
<Ability id="daemon-totem-su" icon={["lower"]}>
...
<Ability id="greater-daemon-totem-su" icon={["aid"]}>
...
<Ability id="dragon-totem-su" icon={["boost","def"]}>
...
<Ability id="dragon-totem-resilience-su" icon={["def"]}>
...
<Ability id="dragon-totem-wings-su" icon={["skill","power"]}>
...
<Ability id="air-totem-su" icon={["magic"]}>
...
<Ability id="greater-air-totem-su" icon={["aura","lower","def"]}>
...
<Ability id="earth-totem-ex" icon={["power"]}>
...
<Ability id="greater-earth-totem-su" icon={["def"]}>
...
<Ability id="fire-totem-su" icon={["def"]}>
...
<Ability id="greater-fire-totem-su" icon={["aura","lower"]}>
...
<Ability id="water-totem-ex" icon={["power"]}>
...
<Ability id="greater-water-totem-su" icon={["power","boost"]}>
...
<Ability id="lesser-fiend-totem-su" icon={["melee"]}>
...
<Ability id="fiend-totem-su" icon={["def"]}>
...
<Ability id="greater-fiend-totem-su" icon={["aura","lower"]}>
...
<Ability id="hive-totem-su" icon={["def","boost"]}>
...
<Ability id="hive-totem-resilience-su" icon={["def","def"]}>
...
<Ability id="hive-totem-toxicity-su" icon={["boost","melee","lower"]}>
...
<Ability id="lesser-moon-totem-su" icon={["power"]}>
...
<Ability id="moon-totem-su" icon={["boost","def"]}>
...
<Ability id="greater-moon-totem-su" icon={["boost"]}>
...
<Ability id="lesser-psychopomp-totem" icon={["def"]}>
...
<Ability id="psychopomp-totem" icon={["lower"]}>
...
<Ability id="greater-psychopomp-totem" icon={["power","boost"]}>
...
<Ability id="lesser-spire-totem-su" icon={["boost"]}>
...
<Ability id="spire-totem-su" icon={["boost"]}>
...
<Ability id="greater-spire-totem-su" icon={["def","protect","roll"]}>
...
<Ability id="lesser-spirit-totem-su" icon={["melee"]}>
...
<Ability id="spirit-totem-su" icon={["def"]}>
...
<Ability id="greater-spirit-totem-su" icon={["aura","ranged"]}>
...
<Ability id="lesser-sun-totem-su" icon={["def"]}>
...
<Ability id="sun-totem-su" icon={["def","boost"]}>
...
<Ability id="greater-sun-totem-su" icon={["def","aura","melee"]}>
...
<Ability id="lesser-tyrant-totem-ex" icon={["boost"]}>
...
<Ability id="tyrant-totem-ex" icon={["melee"]}>
...
<Ability id="greater-tyrant-totem-su" icon={["melee"]}>
...
<Ability id="world-serpent-totem-su" icon={["def"]}>
...
<Ability id="world-serpent-spirit-su" icon={["boost","def"]}>
...
<Ability id="world-serpent-totem-unity-su" icon={["boost","def"]}>
...
<Ability id="lesser-abyssal-blood-su" icon={["power"]}>
...
<Ability id="abyssal-blood-su" icon={["power"]}>
...
<Ability id="greater-abyssal-blood-su" icon={["def"]}>
...
<Ability id="lesser-celestial-blood-su" icon={["boost"]}>
...
<Ability id="celestial-blood-su" icon={["def"]}>
...
<Ability id="greater-celestial-blood-su" icon={["roll"]}>
...
<Ability id="lesser-draconic-blood-su" icon={["power"]}>
...
<Ability id="draconic-blood-su" icon={["def"]}>
...
<Ability id="greater-draconic-blood-su" icon={["line","cone"]}>
...
<Ability id="lesser-elemental-blood-su" icon={["boost"]}>
...
<Ability id="elemental-blood-su" icon={["def"]}>
...
<Ability id="greater-elemental-blood-su" icon={["power","boost"]}>
...
<Ability id="lesser-fey-blood-su" icon={["lower"]}>
...
<Ability id="fey-blood-su" icon={["power"]}>
...
<Ability id="greater-fey-blood-su" icon={["def"]}>
...
<Ability id="lesser-infernal-blood-su" icon={["melee"]}>
...
<Ability id="infernal-blood-su" icon={["def"]}>
...
<Ability id="greater-infernal-blood-su" icon={["def"]}>
...
<Ability id="lesser-undead-blood-su" icon={["lower"]}>
...
<Ability id="undead-blood-su" icon={["boost"]}>
...
<Ability id="greater-undead-blood-su" icon={["def"]}>
...
<Ability id="calm-stance-ex" icon={["down","boost"]}>
...
<Ability id="elemental-stance-su" icon={["boost"]}>
...
<Ability id="knockdown-stance-ex" icon={["melee"]}>
...
<Ability id="reckless-stance-ex" icon={["boost","down"]}>
...
<Ability id="regenerative-stance-ex" icon={["aid"]}>
...
<Ability id="strength-stance-ex" icon={["boost"]}>
...
<Ability id="taunting-stance-ex" icon={["down","melee"]}>
