...
<p><strong>Hard as Stone (Ex):</strong> At 2nd level, whenever an opponent rolls to confirm a critical hit against a student of stone, treat the student of stone's AC as +4 higher than normal.</p>
<p>This ability replaces <strong className="hl">evasion</strong>.</p>
<p><strong>Strength of Stone (Ex):</strong> At 3rd level, a student of stone learns to draw strength from the earth. So long as both he and his opponent are touching the ground, the student of stone gains a +1 bonus on attack rolls, damage rolls, bull rush and trip combat maneuver rolls, and to his CMD when resisting a bull rush or trip attempt.</p>
<p>This ability replaces <strong className="hl">fast movement</strong>.</p>
<p><strong>Bonus Feat:</strong> At 6th level, a student of stone adds <Link to="/feat/elemental_fist">Elemental Fist</Link> to his list of available bonus feats. If the student of stone selects Elemental Fist as a bonus feat, he may only deal acid damage when using the feat. At 10th level, the student of stone adds <Link to="/feat/shaitan_style">Shaitan Style</Link> to his list of bonus feats, at 14th level, he adds <Link to="/feat/shaitan_skin">Shaitan Skin</Link>, and at 18th level, he adds <Link to="/feat/shaitan_earthblast">Shaitan Earthblast</Link>. This otherwise functions as and alters the bonus feat ability.</p>
<p><strong>Bones of Stone (Su):</strong> At 7th level, as a swift action, a student of stone can spend 1 ki point to gain DR 2/magic until the beginning of his next turn. At 10th level, he can spend 1 ki point to gain DR 2/chaotic until his next turn. At 15th level, he can spend 1 ki point to gain DR 5/chaotic until his next turn.</p>
<p>This ability replaces <strong className="hl">high jump</strong>.</p>
<p><strong>Body of Stone (Ex):</strong> At 9th level, a student of stone gains the benefits of the <Link to="/magic-enh/light_fortification">light fortification</Link> armor property.</p>
<p>This ability replaces <strong className="hl">improved evasion</strong>.</p>
<p><strong>Soul of Stone (Su):</strong> At 12th level, as a swift action, a student of stone can spend 1 ki point to gain <Link to="/umr/tremorsense">tremorsense</Link> 15 feet until his next turn. At 16th level, the range of this tremorsense increases to 30 feet.</p>
<p>This ability replaces <strong className="hl">abundant step</strong>.</p>
<p><strong>Stone Self:</strong> At 20th level, a student of stone becomes an earth outsider. He gains the earth subtype, as well as DR 5/chaotic, burrow speed 20 feet, and tremorsense 20 feet.</p>
</>};
...
<p><strong>Trap Intuition (Ex):</strong> At 2nd level, whenever a terra-cotta monk comes within 10 feet of a trap, he receives an immediate Perception check to notice the trap. The GM should make this check in secret. A terra-cotta monk gains a +2 bonus on Perception checks to notice traps. This bonus increases to +4 if the trap is located in a stone wall or floor.</p>
<p>This ability replaces <strong className="hl">evasion</strong>.</p>
<p><strong>Stone Grip (Su):</strong> At 5th level, a terra-cotta monk adds a bonus equal to his class level on all Climb checks. He can move at his full movement rate while climbing with no increase to the check's DC. By spending 1 point from his ki pool as a swift action, a monk gains the benefits of <Link to="/spell/spider_climb">spider climb</Link> for 1 round.</p>
<p>This ability replaces <strong className="hl">high jump</strong>.</p>
<p><strong>Trap Dodge (Ex):</strong> At 10th level, a terra-cotta monk gains a bonus equal to his Wisdom modifier on all saving throws made against effects produced by mechanical traps.</p>
<p>This ability replaces <strong className="hl">improved evasion</strong>.</p>
<p><strong>Sudden Adit (Su):</strong> At 12th level, a terra-cotta monk can create passages through stone or dirt as if using the spell <Link to="/spell/passwall">passwall</Link> with a caster level equal to his monk level. Using this ability is a move action that consumes 2 points of the monk's ki pool.</p>
<p>This ability replaces <strong className="hl">abundant step</strong>.</p>
<p><strong>Petrifying Strike (Su):</strong> At 15th level, a terra-cotta monk can turn an opponent to stone with a single strike. He can use this ability once per day, and must announce the attempt before making his attack roll. If the terra-cotta monk's strike is successful, the creature must succeed at a Fortitude save (DC = 10 + 1/2 the monk's level + the monk's Wis modifier) or be petrified for 1 hour per monk level. Incorporeal creatures and creatures immune to petrification are unaffected by this ability.</p>
<p>This ability replaces <strong className="hl">quivering palm</strong>.</p>
<p><strong>Rainmaker (Su):</strong> At 19th level, anytime a terra-cotta monk is underground, he may cause a section of the roof to come down on his enemies per the spell <Link to="/spell/earthquake">earthquake</Link>, with a caster level equal to his monk level. The terra-cotta monk may use this ability only while in a cave, cavern, or tunnel. Using this ability is a standard action that consumes 3 points from his ki pool.</p>
...
<p><strong>Bonus Feat:</strong> A tetori gains the following bonus feats: 1st level-<Link to="/feat/improved_grapple">Improved Grapple</Link>, 2nd level-<Link to="/feat/stunning_pin">Stunning Pin</Link>, 6th Level-<Link to="/feat/greater_grapple">Greater Grapple</Link>, 10th level-<Link to="/feat/pinning_knockout">Pinning Knockout</Link>, 14th level-<Link to="/feat/chokehold">Chokehold</Link>, 18th level-<Link to="/feat/neckbreaker">Neckbreaker</Link>. These feats replace a monk's normal bonus feats.</p>
<p><strong>Graceful Grappler (Ex):</strong> A tetori uses his monk level in place of his base attack bonus to determine CMB and CMD for grappling. At 4th level, he suffers no penalties on attack rolls, can make attacks of opportunity while grappling, and retains his Dexterity bonus to AC when pinning an opponent or when grappled. At 8th level, a tetori gains the <Link to="/umr/grab">grab</Link> special attack when using unarmed strikes, and can use this ability against creatures his own size or smaller by spending 1 point from his ki pool, or against larger creatures by spending 2 points from his ki pool. At 15th level, a tetori gains the <Link to="/umr/constrict">constrict</Link> special attack, inflicting his unarmed strike damage on any successful grapple check.</p>
<p>This ability replaces <strong className="hl">flurry of blows</strong>.</p>
<p><strong>Counter-Grapple (Ex):</strong> At 4th level, a tetori wrestler may make an attack of opportunity against a creature attempting to grapple him. This ability does not allow the tetori to make an attack of opportunity against a creature with the Greater Grapple feat. At 6th level, he may use counter-grapple even if his attacker has <Link to="/rule/concealment">concealment</Link> or total concealment, at 8th level even if he is flat-footed, and at 10th level even if his attacker has exceptional reach.</p>
<p>This ability replaces <strong className="hl">slow fall</strong>.</p>
<p><strong>Break Free (Ex):</strong> At 5th level, a tetori adds his monk level on combat maneuver or Escape Artist checks made to escape a grapple. If a tetori fails a save against an effect that causes him to become entangled, paralyzed, slowed, or staggered, he may spend 1 point from his ki pool as an immediate action to attempt a new save.</p>
<p>This ability replaces <strong className="hl">high jump</strong>.</p>
<p><strong>Inescapable Grasp (Su):</strong> At 9th level, a tetori can spend 1 point from his ki pool to suppress his opponents' <Link to="/spell/freedom_of_movement">freedom of movement</Link> and magical bonuses to Escape Artist or on checks to escape a grapple. At 13th level, this ability also duplicates the effect of <Link to="/spell/dimensional_anchor">dimensional anchor</Link>. At 17th level, the tetori's unarmed strike gains the <Link to="/magic-enh/ghost_touch">ghost touch</Link> special ability, and an incorporeal creature that he strikes gains the grappled condition (Reflex negates, DC 10 + 1/2 the wrestler's level + his Wisdom modifier). Inescapable grasp is a swift action and lasts until the beginning of the wrestler's next turn.</p>
<p>This ability replaces <strong className="hl">abundant step</strong>, <strong className="hl">improved evasion</strong>, <strong className="hl">timeless body</strong>, and <strong className="hl">tongue of sun and moon</strong>.</p>
<p><strong>Form Lock (Su):</strong> At 13th level, a tetori can negate a polymorph effect by touch with a Wisdom check, adding a bonus equal to his monk level, against a DC of 11 + the caster level of the effect (or HD of the creature, for supernatural polymorph effects). This is a standard action requiring 2 points from the tetori's ki pool, or an immediate action if a creature the tetori is grappling attempts to use a polymorph effect.</p>
<p>This ability replaces <strong className="hl">diamond soul</strong>.</p>
<p><strong>Iron Body (Su):</strong> At 19th level, as a move action, a tetori can make his tissues ultra-dense for 1 minute as the <Link to="/spell/iron_body">iron body</Link> spell by spending 3 points from his ki pool.</p>
<p>This ability replaces <strong className="hl">empty body</strong>.</p>
</>};
...
<p><strong>Branch Runner (Ex):</strong> At 3rd level, a treetop monk adds half the base speed bonus from his fast movement ability to his racial climb speed.</p>
<p>This ability replaces <strong className="hl">still mind</strong>.</p>
<p><strong>Wood Affinity (Su):</strong> At 5th level, a treetop monk may expend 1 point from his ki pool as a free action to treat a wooden object as if it were not broken for 1 minute (this includes a weapon with a wooden haft such as an axe or spear). At 8th level, as a free action, a treetop monk can expend 1 point from his ki pool to use the <Link to="/feat/lunge">Lunge</Link> feat with any wooden or wood-hafted melee weapon.</p>
<p>This ability replaces <strong className="hl">purity of body</strong>.</p>
<p><strong>Freedom of Movement (Su):</strong> At 12th level, a treetop may expend 1 point from his ki pool as a swift action to gain the effects of <Link to="/spell/freedom_of_movement">freedom of movement</Link> for 1 round.</p>
<p>This ability replaces <strong className="hl">abundant step</strong>.</p>
</>};
...
<p><strong>Underfoot Grace (Ex):</strong> At 1st level, an underfoot adept uses his size and grace to avoid the attacks of those he passes. When using the Acrobatics skill to avoid attacks of opportunity by moving through a threatened area or an enemy's space, he only takes a -5 penalty when doing so at full speed, instead of the normal -10 penalty.</p>
<p>This ability replaces the <strong className="hl">bonus feat</strong> gained at 1st level.</p>
<p><strong>Underfoot Trip (Ex):</strong> At 1st level, an underfoot adept learns a number of maneuvers and grabs that can cause even the largest opponents to stumble and fall. He gains <Link to="/feat/improved_trip">Improved Trip</Link> as a bonus feat, even if he does not meet the requirements. At 4th level, and every four levels thereafter, he acts as if he is one size larger for the purposes of determining the maximum size of creatures he can trip and when determining his CMB and CMD for purposes of a trip combat maneuver.</p>
<p>This ability replaces <strong className="hl">stunning fist</strong>.</p>
<p><strong>Improved Underfoot Grace (Ex):</strong> At 5th level, an underfoot adept's ability to avoid attacks of opportunity against those he passes improves. When using the Acrobatics skill to avoid attacks of opportunity, while moving through a threatened area or through an enemy's space, he takes no penalty when doing so at full speed.</p>
<p>This ability replaces <strong className="hl">high jump</strong>.</p>
</>};
...
<p><strong>Far Traveler (Ex):</strong> At 1st level, the wanderer gains either one additional language known or proficiency in one exotic or martial weapon. At 4th level and every four levels thereafter, the wanderer may gain an additional language known or may retrain her weapon proficiency from this ability to a different exotic or martial weapon.</p>
<p>This ability replaces the <strong className="hl">bonus feat</strong> gained at 1st level.</p>
<p><strong>Long Walk (Ex):</strong> At 3rd level, the wanderer gains <Link to="/feat/endurance">Endurance</Link> as a bonus feat, and the feat bonus doubles when he makes Constitution checks because of a forced march. In addition, a wanderer gains a +2 bonus on saving throws against spells and effects that cause exhaustion and fatigue.</p>
<p>This ability replaces <strong className="hl">still mind</strong>.</p>
<p><strong>Light Step (Su):</strong> At 5th level, a wanderer leaves no trail and cannot be tracked, though he can leave a trail if desired. By spending 1 point from his ki pool, he can use <Link to="/spell/ant_haul">ant haul</Link>, <Link to="/spell/feather_step">feather step</Link>, <Link to="/spell/pass_without_trace">pass without trace</Link>, or <Link to="/spell/tireless_pursuit">tireless pursuit</Link> as a spell-like ability (with a caster level equal to his monk level).</p>
<p>This ability replaces <strong className="hl">slow fall</strong>.</p>
<p><strong>Inscrutable (Su):</strong> At 5th level, the wanderer gains a supernatural air of mystery. The DC to gain information or insight into the wanderer with Diplomacy, Knowledge skills, or Sense Motive increases by 5. In addition, by spending 1 point from his ki pool, the wanderer gains <Link to="/spell/nondetection">nondetection</Link> for 24 hours with a caster level equal to his monk level.</p>
<p>This ability replaces <strong className="hl">high jump</strong>.</p>
<p><strong>Wanderer's Wisdom (Ex):</strong> At 7th level, the wanderer can dispense excellent advice in the form of philosophical proverbs and parables. As a swift action, the wanderer can inspire courage or inspire competence as a <Link to="/class/bard">bard</Link> of his monk level by spending 2 points from his ki pool. This affects one creature within 30 feet and lasts a number of rounds equal to the wanderer's Wisdom modifier (minimum 1 round). This ability is language-dependent.</p>
<p>This ability replaces <strong className="hl">wholeness of body</strong>.</p>
<p><strong>Disappear Unnoticed (Ex):</strong> At 12th level, the wanderer may use Stealth to hide even while being directly observed or when no cover or concealment is available, as long as he is adjacent to at least one creature of his size or larger, by spending 1 point from his ki pool. This effect lasts until the beginning of the wanderer's next turn and may be continued in consecutive rounds by spending 1 ki point each round.</p>
<p>This ability replaces <strong className="hl">abundant step</strong>.</p>
<p><strong>Free Step (Su):</strong> At 13th level, the wanderer gains continuous <Link to="/spell/freedom_of_movement">freedom of movement</Link> as a continuous spell-like ability.</p>
<p>This ability replaces <strong className="hl">diamond soul</strong>.</p>
</>};
