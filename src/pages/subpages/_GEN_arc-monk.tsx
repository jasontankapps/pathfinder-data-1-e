...
<div className="abPair"><div className="abStart"><div className="box hl">Replaces</div></div><div className="abEnd"><div className="box">Diamond soul</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 13th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">A drunken master gains DR 1/- as long as he has at least 1 point of <em>drunken ki.</em></div></div></div>
...
<p><strong>Cunning Fist (Ex):</strong> A sage counselor gains <Link to="/feat/combat_expertise">Combat Expertise</Link> as a bonus feat, even if he doesn't meet the prerequisites, and he can ignore the Intelligence prerequisite on feats that have Combat Expertise as a prerequisite. At 2nd level, he gains <Link to="/feat/improved_feint">Improved Feint</Link>, and at 6th level, he gains <Link to="/feat/greater_feint">Greater Feint</Link>, even if he doesn't meet the prerequisites.</p>
<p>This ability replaces the <strong className="hl">bonus feats</strong> gained at 1st, 2nd, and 6th levels.</p>
<p><strong>Feinting Flurry:</strong> At 4th level, a sage counselor can spend 1 ki point while performing a flurry of blows to feint an opponent as a swift action, but he can't spend 1 ki point to make an additional attack when making a flurry of blows. At 10th level, he can also choose to replace his first attack during a flurry of blows with a feint check.</p>
<p>This ability alters <strong className="hl">flurry of blows</strong> and <strong className="hl">ki pool</strong>, and it replaces the <strong className="hl">bonus feat</strong> gained at 10th level.</p>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
...
<div className="abPair"><div className="abStart"><div className="box hl">Alters</div></div><div className="abEnd"><div className="box">Ki pool</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 4th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Swift Action</div></div><div className="abEnd"><div className="box">The sage counselor can spend 1 point from his ki pool to give himself a +4 insight bonus on his next Bluff check.</div></div></div></div>
</>};
...
<p><strong>Draconic Might:</strong> Any of the scaled fist's class abilities that make calculations based on her Wisdom (including bonus feats with DCs or uses per day, such as <Link to="/feat/stunning_fist">Stunning Fist</Link>, but not Wisdom-based skills or Will saving throws) are instead based on her Charisma.</p>
<p><strong>Bonus Feats:</strong> A scaled fist adds <Link to="/feat/dragon_style">Dragon Style</Link> and <Link to="/feat/intimidating_prowess">Intimidating Prowess</Link> to her list of bonus feats at 1st level. At 6th level, she adds <Link to="/feat/dazzling_display">Dazzling Display</Link> and <Link to="/feat/dragon_ferocity">Dragon Ferocity</Link>. At 10th level, she adds <Link to="/feat/disheartening_display">Disheartening Display</Link>, <Link to="/feat/dragon_roar">Dragon Roar</Link> and <Link to="/feat/shatter_defenses">Shatter Defenses</Link>.</p>
<p>This ability modifies <strong className="hl">bonus feats</strong>.</p>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
...
<div className="abPair"><div className="abStart"><div className="box">Swift Action</div></div><div className="abEnd"><div className="box">The scaled fist can expend 1 point from her ki pool to imbue her natural attacks with this energy, causing them to deal an extra 1d6 points of damage of the chosen energy type for a number of rounds equal to 1/2 her monk level.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/tornado-discs"><IonIcon icon="/icons/tornado-discs.svg" color="secondary" /></Link></div>
...
<div className="abPair"><div className="abStart"><div className="box hl">Replaces</div></div><div className="abEnd"><div className="box">Quivering palm</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 15th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Standard Action</div></div><div className="abEnd"><div className="box">A scaled fist can spend 3 points from her ki pool to make a breath weapon attack that deals 1d6 points of damage of her energy type per monk level in a 30-foot cone. Those caught in the area of the breath can attempt a Reflex save (DC = 10 + 1/2 the scaled fist's monk level + her Charisma modifier) to halve the normal damage.</div></div></div></div>
</>};
...
<p><strong>Skills:</strong> A sensei gains Diplomacy, Linguistics, and all Knowledge skills as class skills.</p>
<p><strong>Advice (Ex):</strong> A sensei's advice is identical to <Link to="/ability/bardic_performance">bardic performance</Link> (using oratory), allowing him to <Link to="/performance/inspire_courage">inspire courage</Link> at 1st level, <Link to="/performance/inspire_competence">inspire competence</Link> at 3rd level, and <Link to="/performance/inspire_greatness">inspire greatness</Link> at 9th level, as a bard of the sensei's level, usable a total number of rounds per day equal to his level + his Wisdom modifier (minimum 1).</p>
<p>This ability replaces <strong className="hl">flurry of blows</strong>, <strong className="hl">fast movement</strong>, and <strong className="hl">improved evasion</strong>.</p>
<p><strong>Insightful Strike (Ex):</strong> At 2nd level, a sensei may use his Wisdom bonus in lieu of his Strength or Dexterity on attack rolls and combat maneuver checks with unarmed strikes or monk weapons.</p>
<p>This ability replaces <strong className="hl">evasion</strong> and the <strong className="hl">bonus feat</strong> gained at 2nd level.</p>
<p><strong>Mystic Wisdom (Su):</strong> At 6th level, a sensei may use his advice ability when spending points from his ki pool to activate a class ability (using the normal actions required for each) in order to have that ability affect one ally within 30 feet rather than the sensei himself. At 10th level, a sensei may affect all allies within 30 feet rather than himself (spending points from his ki pool only once, not once for each target).</p>
<p>At 10th level, a sensei may instead spend 1 point from his ki pool (as a swift action) while using advice to provide a single ally within 30 feet with evasion, fast movement, high jump, purity of body, or slow fall. At 14th level, a sensei may spend 2 points to grant one of the abilities listed above to all allies within 30 feet, or diamond body, diamond soul, or improved evasion to a single ally within 30 feet. These abilities function at the sensei's level and last 1 round.</p>
<p>This ability replaces the <strong className="hl">bonus feats</strong> at 6th, 10th, and 14th level.</p>
</>};
...
<p><strong>Chakra Training:</strong> A serpent-fire adept gains <Link to="/feat/chakra_initiate">Chakra Initiate</Link> and <Link to="/feat/psychic_sensitivity">Psychic Sensitivity</Link> as bonus feats. She need not meet these feats' prerequisites, and can use her serpent-fire ki from Chakra Initiate to open and maintain her root chakra, despite not being 2nd level.</p>
<p>This ability replaces <strong className="hl">stunning fist</strong> and the <strong className="hl">bonus feat</strong> gained at 1st level.</p>
<p><strong>Chakra Expertise (Ex):</strong> At 2nd level, the serpent-fire adept gains a bonus equal to 1/2 her monk level on Fortitude and Will saves attempted to maintain awakened chakras. At 8th level, when she has opened one or more chakras, she can maintain those chakras (without opening any new chakras) for 1 round without taking a swift action, expending ki, or attempting Fortitude or Will saves to maintain the chakras. This increases to 2 rounds at 16th level. After maintaining her chakras with chakra expertise, the monk must open a new chakra or maintain her open chakras normally before she can use chakra expertise again.</p>
<p>This ability replaces the <strong className="hl">bonus feat</strong> gained at 2nd level.</p>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
...
<p><strong>Chakra Adept (Ex):</strong> At 6th level, the serpent-fire adept gains <Link to="/feat/chakra_adept">Chakra Adept</Link> as a bonus feat. She need not meet the feat's prerequisites. When the serpent-fire adept has used all her rounds of chakra expertise to maintain open chakras, if she does not spend additional ki to maintain her open chakras on the next round, her highest chakra closes and she can spend a swift action to use any one of the abilities of her remaining open chakras. On the round after that, all her chakras close, and if she wishes to reopen them, she must start again with her root chakra.</p>
...
<p><strong>Chakra Mastery (Ex):</strong> At 10th level, the serpent-fire adept gains <Link to="/feat/chakra_master">Chakra Master</Link> as a bonus feat. She need not meet the feat's prerequisites. When maintaining her open chakras with chakra expertise, she can spend 1 point of ki to gain the benefits of two chakras rather than one in that round (or three chakras, if she has opened her crown chakra). At 14th level, the serpent-fire adept's pool of serpent-fire ki increases to 7 points, and at 18th level, it increases to 9 points.</p>
<p>This ability replaces the <strong className="hl">bonus feats</strong> gained at 10th, 14th, and 18th level.</p>
</>};
...
<p>This is an ex-class archetype and can be taken by a character immediately upon becoming an ex-monk.</p>
<p><strong>The following archetype can be taken by an ex-monk immediately upon becoming an ex-monk, regardless of character level, replacing some or all of the lost class abilities.</strong> If another archetype the character had before she became an ex-monk replaces the same ability as the ex-class archetype, she loses the old archetype in favor of the new one; otherwise, she can retain both archetypes as normal. Sin monks can gain further levels in the monk class, even though becoming an ex-monk normally prohibits further advancement in the class. While an ex-member of a class can recant her failings and atone for her fall from her original class (typically involving an <Link to="/spell/atonement">atonement</Link> spell), her acceptance of her ex-class archetype means she must atone both for her initial fall and for further straying from the path. As a result, such a character must be the target of two atonement spells or a similar effect to regain her lost class features. Upon doing so, she immediately loses this archetype and regains her original class (and archetype, if she had one).</p>
<p><strong>Well of Sin (Su):</strong> At 4th level, a sin monk gains a pool of sin points, representing energy he has gained from indulging in forbidden vices. The sin monk has a number of sin points equal to half his class level + his Wisdom modifier; these points cannot be used on abilities that require spending ki points. As a swift action, he can spend 1 point from his sin pool to activate one of the following abilities until the start of his next turn.</p>
<blockquote>
<p><strong>Envy:</strong> The sin monk gains a +4 bonus on Perception and Sense Motive checks. This bonus increases to +6 at 10th level and +8 at 16th level.</p>
<p><strong>Gluttony:</strong> Each time the sin monk deals lethal damage with a melee attack, he regains a number of hit points equal to the amount of damage dealt (maximum 2). He can't exceed his maximum number of hit points. The maximum number of hit points he regains increases to 4 at 10th level and 6 at 16th level.</p>
<p><strong>Greed:</strong> The sin monk's attacks count as being either cold iron or silver (sin monk's choice) for the purpose of overcoming DR. At 10th level, he adds adamantine to the list of materials he can choose to have his attacks count as being for the purpose of overcoming DR. At 16th level, the sin monk's attacks also ignore hardness.</p>
<p><strong>Lust:</strong> The sin monk gains a +4 bonus on Bluff and Diplomacy checks. This bonus increases to +6 at 10th level and +8 at 16th level.</p>
<p><strong>Pride:</strong> The sin monk gains one illusory double of himself, which functions as mirror image. This double automatically disappears at the beginning of the sin monk's next turn unless destroyed first. At 10th level, the sin monk gains two such replicas of himself, and at 16th level, he gains three.</p>
<p><strong>Sloth:</strong> The sin monk gains the benefits of <Link to="/feat/vital_strike">Vital Strike</Link>. At 10th level, he also gains the benefits of <Link to="/feat/improved_vital_strike">Improved Vital Strike</Link>, and at 16th level, he also gains the benefits of <Link to="/feat/greater_vital_strike">Greater Vital Strike</Link>.</p>
<p><strong>Wrath:</strong> The sin monk increases the save DCs of his attacks with <Link to="/feat/stunning_fist">Stunning Fist</Link> (and <Link to="/feat/punishing_kick">Punishing Kick</Link>, if he has that feat) by 1. The save DC instead increases by 2 at 10th level and by 3 at 16th level.</p>
</blockquote>
<p>When a sin monk gains a level in the monk class and would gain one of the following class features, he can forfeit that class feature to instead increase the size of his sin pool by 1 sin point: purity of body, diamond body, diamond soul, timeless body, tongue of the sun and moon. Once the decision is made, it cannot be changed.</p>
<p>This replaces <strong className="hl">ki pool</strong> and <strong className="hl">alters high jump</strong>.</p>
<p><strong>Sinful Strike (Su):</strong> At 7th level, a sin monk can spend 2 sin points as a swift action to focus his power. The next time he deals damage before the end of his next turn, he deals an additional amount damage equal to his monk level.</p>
<p>This replaces <strong className="hl">wholeness of body</strong>.</p>
<p><strong>Burden with Sin (Su):</strong> At 12th level, a sin monk can spend a swift action and one daily use of Stunning Fist to draw his sinful nature to the fore of his consciousness. The next person he hits with a melee attack before the end of his next turn must succeed at a Will save (DC = 10 + half the sin monk's class level + his Wisdom modifier) or suffer the burden of the sin monk's sins. The target is treated as if she were carrying a load one step heavier (from a light load to a medium load, and so on) and must succeed at a caster level check to use any form of teleportation (DC = 10 + the monk's class level). This is a curse effect that lasts a number of rounds equal to the sin monk's Wisdom modifier unless it is removed through remove curse or a similar effect.</p>
<p>This replaces <strong className="hl">abundant step</strong>.</p>
<p><strong>Simultaneous Sins (Su):</strong> At 19th level, a sin monk can spend 3 points from his sin pool as a swift action to gain the benefits of two different sins simultaneously.</p>
<p>This replaces <strong className="hl">empty body</strong>.</p>
<p><strong>Spawn of Sin (Ex):</strong> At 20th level, the sin monk becomes the physical manifestation of his sins. He is forevermore treated as an aberration rather than a humanoid (or whatever the monk's creature type was) for the purpose of spells and magical effects, and his mind is so consumed by sin that he gains immunity to mind-affecting effects. He does not change in appearance or gain other abilities; however, should the sin monk be slain and brought back from the dead, he returns to life as a <Link to="/monster/sinspawn">sinspawn</Link>, retaining his class levels but otherwise replacing his creature type and racial abilities with those of his new form and becoming an NPC under the GM's control.</p>
<p>This replaces <strong className="hl">perfect self</strong>.</p>
</>};
...
<p><strong>Weapon Proficiency:</strong> A softstrike monk is proficient with the <Link to="/eq-weapon/aklys">aklys</Link>, <Link to="/eq-weapon/bolas">bolas</Link>, <Link to="/eq-weapon/club">club</Link>, <Link to="/eq-weapon/light_flail">light flail</Link>, <Link to="/eq-weapon/light_mace">light mace</Link>, <Link to="/eq-weapon/nunchaku">nunchaku</Link>, <Link to="/eq-weapon/quarterstaff">quarterstaff</Link>, <Link to="/eq-weapon/sap">sap</Link>, <Link to="/eq-weapon/sling">sling</Link>, and any weapon with the monk special quality that can deal bludgeoning damage. He is considered proficient only with monk weapons that can deal multiple types of damage when dealing bludgeoning damage.</p>
<p>This replaces the monk's <strong className="hl">weapon proficiency</strong>.</p>
<p><strong>Feather Touch (Ex):</strong> A softstrike monk does not take the normal -4 penalty on attack rolls for using a lethal weapon to deal nonlethal damage. In addition, he can use his stunning fist ability while making a nonlethal attack with a weapon.</p>
<p><strong>Nonlethal Strikes (Ex):</strong> A softstrike monk focuses on blows that do not inflict deadly harm. When a softstrike monk deals nonlethal damage with his unarmed strikes, his monk level is treated as 4 levels higher for the purposes of determining the damage he deals (to a maximum of 4d8 at 20th level for a Medium monk). When dealing lethal damage with his unarmed strikes, his monk level is treated as if it were 4 levels lower (minimum 1st level) for the purpose of determining damage.</p>
<p>This alters <strong className="hl">unarmed strike</strong>.</p>
<p><strong>Tenet of Life (Su):</strong> Though a softstrike monk accepts that death may happen in combat, he cannot abide killing in cold blood. If he slays an unconscious or helpless living foe, or merely stands by and allows such a killing to occur, he becomes shaken for 1 hour. In addition, the act disrupts the softstrike monk's ki; if he has a ki pool, he loses a number of ki points equal to half his level, as if they had been spent.</p>
<p><strong>Life-Giving Blows (Su):</strong> At 6th level, a softstrike monk can force a piece of his life force into a nonliving creature to disrupt its animating essence. If he hits an undead foe with an unarmed attack, he can spend 1 ki point as a free action to remove the target's immunity to nonlethal damage for a number of minutes equal to his Wisdom modifier. If, during this time, the target's nonlethal damage exceeds its current hit points, it is destroyed. At 10th level, a softstrike monk can also use this ability against constructs.</p>
<p>This replaces the <strong className="hl">bonus feats</strong> gained at 6th and 10th levels.</p>
...
<div className="abPair"><div className="abStart"><div className="box hl">Alters</div></div><div className="abEnd"><div className="box">Quivering palm</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 15th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">A softstrike monk renders the target of his quivering palm unconscious instead of killing the creature. Upon failing its Fortitude saving throw, the target is knocked unconscious for a number of minutes equal to the softstrike monk's level.</div></div></div></div>
<p><strong>Resilient Body (Su):</strong> At 19th level, a softstrike monk's mastery of nonlethal combat lets him apply his techniques to his defense. A softstrike monk converts any <Link to="/misc/precision_damage">precision damage</Link> he takes to nonlethal damage.</p>
<p>This replaces <strong className="hl">empty body</strong>.</p>
</>};
...
<p><strong>Skills:</strong> A sohei gains Handle Animal as a class skill.</p>
<p><strong>Weapon and Armor Proficiency:</strong> A sohei is proficient with all simple and martial weapons and with light armor, instead of a monk's usual weapon and armor proficiencies.</p>
<p>This ability alters the monk's <strong className="hl">weapon and armor proficiencies</strong>.</p>
<p><strong>Bonus Feats:</strong> A sohei may select mounted combat feats as bonus feats.</p>
<p><strong>Devoted Guardian (Ex):</strong> At 1st level, a sohei can always act in a surprise round even if he does not notice his enemies, though he remains flat-footed until he acts. In addition, a sohei gains a bonus on initiative rolls equal to 1/2 his monk level. At 20th level, a sohei's initiative roll is automatically a natural 20.</p>
<p>This ability replaces <strong className="hl">stunning fist</strong>.</p>
<p><strong>Unarmed Strike:</strong> A sohei's unarmed strike damage does not increase at 4th level and above.</p>
<p><strong>Monastic Mount (Su):</strong> At 4th level, a sohei may spend 1 point from his ki pool to grant his mount temporary hit points equal to twice his level for 1 hour per level. In addition, as long as the sohei and his mount are adjacent, including when mounted, the mount gains any of the following abilities the sohei possesses: AC bonus, diamond soul, evasion, high jump, improved evasion, ki strike (as long as the sohei has at least 1 point in his ki pool), perfect self, and still mind. When a sohei spends points from his ki pool, his mount gains the same benefits as the sohei.</p>
<p>This ability replaces <strong className="hl">fast movement</strong> and <strong className="hl">increased unarmed damage</strong>.</p>
<p><strong>Ki Weapon (Su):</strong> At 4th level, as a swift action, a sohei may spend 1 point from his ki pool to grant any weapon he wields (including his unarmed strike) a +1 enhancement bonus on attack and damage rolls, increasing by +1 per four levels after 4th to a maximum bonus of +5 at 20th level, until the end of his next turn.</p>
<p>This ability replaces <strong className="hl">slow fall</strong> and <strong className="hl">abundant step</strong>.</p>
<p><strong>Weapon Training (Ex):</strong> At 6th level, a sohei gains weapon training in one of the following <Link to="/ability/weapon_groups">weapon groups</Link>, as the <Link to="/class/fighter">fighter</Link> class feature: bows, crossbows, monk weapons, polearms, spears, or thrown weapons. He may select an additional group of weapons for every six levels after 6th, to a maximum of three at 18th level. A sohei may use flurry of blows and ki strike with any weapon in which he has weapon training.</p>
<p>This ability replaces <strong className="hl">purity of body</strong>, <strong className="hl">diamond body</strong>, <strong className="hl">quivering palm</strong>, <strong className="hl">timeless body</strong>, and <strong className="hl">tongue of sun and moon</strong>.</p>
</>};
...
<p><strong>Calming Strike (Su):</strong> As an immediate action after hitting an incorporeal undead creature with an unarmed strike, a soul shepherd can attempt to calm the creature, encouraging it to move peacefully to the next stage of its metaphysical journey. The target must succeed at a Will save (DC = 10 + half soul shepherd's level + the soul shepherd's Wisdom modifier) or be calmed, as <Link to="/spell/calm_spirit">calm spirit</Link>, for 1 minute.</p>
<p>The soul shepherd can use this ability against a haunt by making a touch attack against an AC of 10 + the haunt's CR. A haunt does not receive a saving throw against this ability, but the ability's duration changes to concentration + 1 round, up to 1 round per level. A soul shepherd can use this ability a number of times per day equal to his soul shepherd level.</p>
<p>This replaces <strong className="hl">stunning fist</strong>.</p>
<p><strong>Otherworldly Resilience (Ex):</strong> At 2nd level, a soul shepherd gains DR 2/adamantine, cold resistance 5, and electricity resistance 5. At 9th level, this improves to DR 5/adamantine, cold resistance 10, and electricity resistance 10.</p>
<p>This replaces <strong className="hl">evasion</strong> and <strong className="hl">improved evasion</strong>.</p>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
...
<div className="abPair"><div className="abStart"><div className="box hl">Replaces</div></div><div className="abEnd"><div className="box">Abundant step</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 12th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Swift Action</div></div><div className="abEnd"><div className="box">A soul shepherd can spend 1 point from his ki pool to grant himself the ability to notice, locate, and distinguish between living and undead creatures within 30 feet, just as if he had a <Link to="/subtype/psychopomp">psychopomp's</Link> spiritsense ability, for a number of rounds equal to his Wisdom modifier (minimum 1).</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/heart-plus"><IonIcon icon="/icons/heart-plus.svg" color="secondary" /></Link></div>
