...
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 4th Level</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
...
<p><strong>Dehydrating Strike (Su):</strong> As a free action as part of a melee attack, a wasteland meditant can draw the moisture out of a living creature damaged by his unarmed strike. Unless the creature succeeds at a Will save (DC = 10 + half the monk's level + his Wisdom modifier), the creature is fatigued for a number of rounds equal to half the wasteland meditant's level (minimum 1). At 5th level, the creature struck is also staggered for 1 round if it fails its save. At 10th level, a creature that fails its save is exhausted instead of fatigued.</p>
<p>When used against a plant creature or a creature with the water subtype, dehydrating strike inflicts the above conditions (as applicable) on a failed save and also deals 1d6 points of damage, plus 1d6 additional points of damage at 4th level and every 4 levels thereafter. This damage is in addition to the wasteland meditant's normal unarmed strike damage. A wasteland meditant can use this ability a number of times per day equal to 3 + his Wisdom modifier but only once per round.</p>
<p>Creatures immune to critical hits or <Link to="/misc/precision_damage">precision damage</Link> are immune to this ability.</p>
<p>This replaces <strong className="hl">stunning fist</strong>.</p>
<p><strong>Vigor (Ex):</strong> At 2nd level, when a wasteland meditant succeeds at a Fortitude save against an effect with a partial effect on a successful save, he instead suffers no effect.</p>
<p>This replaces <strong className="hl">evasion</strong>.</p>
<p><strong>Desert Strider (Ex):</strong> At 4th level, a wasteland meditant ignores movement penalties for <Link to="/rule/difficult_terrain">difficult terrain</Link> when in desert terrain. Additionally, he kicks up dust around his body whenever he performs a double move action in desert terrain. This dust grants the wasteland meditant <Link to="/rule/concealment">concealment</Link>. The miss chance granted by this concealment starts at 10% at 4th level and increases by 10% at 6th level and every 2 levels thereafter, to a maximum of 80% at 18th level. This concealment lasts until the start of the meditant's next turn and stacks with any concealment provided by movement, such as from the <Link to="/feat/wind_stance">Wind Stance</Link> feat.</p>
<p>This replaces <strong className="hl">slow fall</strong>.</p>
<p><strong>Improved Vigor (Ex):</strong> At 9th level, a wasteland meditant's vigor ability improves. He still takes no damage on a successful Fortitude saving throw against attacks, but henceforth he takes only half damage on a failed save.</p>
<p>This replaces <strong className="hl">improved evasion</strong>.</p>
<p><strong>Pillar of Salt (Su):</strong> At 15th level, a wasteland meditant can transform a creature's body into a column of crumbling salt with a touch. He can use pillar of salt once per day as part of an unarmed strike, and he must announce his intent before making his attack roll. Creatures immune to critical hits or transmutation effects cannot be affected. A creature successfully damaged by the wasteland meditant's unarmed strike must succeed at a Fortitude saving throw (DC = 10 + half the monk's level + his Wisdom modifier) or begin to calcify. Each round thereafter, the target of pillar of salt takes 2 points of <Link to="/rule/dexterity_drain">Strength and Dexterity drain</Link> and gains a +1 bonus to its natural armor as a crust of salt begins to cover its body and restrict movement. These effects take place every round at the start of the wasteland meditant's turn and continue for 1 round per level the wasteland meditant has. If the target is reduced to 0 Strength or Dexterity at any time during this duration, the creature is instantly killed and its body is transformed into a pillar of salt. A creature killed in this way can't be brought back to life except by <Link to="/spell/miracle">miracle</Link>, <Link to="/spell/true_resurrection">true resurrection</Link>, or <Link to="/spell/wish">wish</Link>. Total immersion in water suppresses the ongoing effects of pillar of salt but resets the accumulated natural armor bonus to zero. As long as the target lives, the ongoing effect of pillar of salt can be ended via a heal spell.</p>
<p>This replaces <strong className="hl">quivering palm</strong>.</p>
</>};
...
<p><strong>Elemental Focus (Su and Sp):</strong> A water dancer gains the elemental focus ability of the <Link to="/class/kineticist">kineticist</Link> class, but must choose water as his <Link to="/ability/elements">element</Link>. He gains the <Link to="/kinetic/basic_hydrokinesis">basic hydrokinesis</Link> wild talent as normal, and gains the <Link to="/kinetic/water_blast">kinetic blast</Link> feature of the kineticist class for the water element, using his monk level as his effective kineticist level. He can't use his kinetic blast when armored or encumbered.</p>
<p>This replaces <strong className="hl">flurry of blows</strong>, <strong className="hl">stunning fist</strong>, and <strong className="hl">quivering palm</strong>.</p>
<p><strong>Nereid's Grace (Su):</strong> When unarmored and unencumbered, a water dancer adds 1 point of Charisma bonus per monk level to his Armor Class as a dodge bonus. If he is caught flat-footed or otherwise denied his Dexterity bonus, he also loses this bonus. He uses his Charisma score instead of his Wisdom score to determine the size of his ki pool and the DC and effects of monk class features.</p>
<p>This replaces the <strong className="hl">bonus feat</strong> the monk normally gains at 1st level.</p>
<p><strong>Unarmed Strike:</strong> A water dancer gains the unarmed strike monk class feature but treats his unarmed strike damage as that of a monk 4 levels lower (minimum 1st level).</p>
<p>This alters <strong className="hl">unarmed strike</strong>.</p>
<p><strong>Burn (Ex):</strong> At 2nd level, a water dancer gains the burn class feature of the kineticist class.</p>
<p>This replaces <strong className="hl">evasion</strong>.</p>
<p><strong>Wild Talents:</strong> At 2nd level and every 4 levels thereafter, a water dancer selects a new <Link to="/ability/utility_wild_talents">utility wild talent</Link> from the list of options available to the kineticist class, treating his monk level - 2 (minimum 1) as his kineticist level for the purpose of fulfilling prerequisites as well as for level-dependent effects of the utility talent. He can select only universal wild talents or those that match his element (see elemental focus above). At 6th, 10th, and 16th levels, he can replace one of his utility wild talents with another wild talent of the same level or lower. He can't replace a wild talent that he used to qualify for another of his wild talents.</p>
<p>This replaces the <strong className="hl">bonus feats</strong> at 2nd, 6th, 10th, 14th, and 18th levels.</p>
<p><strong>Water Dance (Su):</strong> At 4th level, a water dancer can move across any liquid surface as though it were solid ground up to a maximum distance of 20 feet before falling through the liquid's surface as normal. This distance increases by 10 feet at 6th level and every 2 levels thereafter, to a maximum of 90 feet at 18th level. Additionally, at 10th level the water dancer can even move vertically up water surfaces (such as a flowing waterfall) as though under the effects of <Link to="/spell/spider_climb">spider climb</Link>. If he runs out of movement before reaching a solid surface when climbing a vertical water source, he immediately falls.</p>
<p>This replaces <strong className="hl">slow fall</strong>.</p>
<p><strong>Metakinesis (Su):</strong> At 9th level, a water dancer gains the ability to alter his kinetic blasts as the kineticist's metakinesis (empower) class feature.</p>
<p>This replaces <strong className="hl">improved evasion</strong>.</p>
<p><strong>Water Stride (Sp):</strong> At 12th level, a water dancer can leap from one source of water to another as per <Link to="/spell/dimension_door">dimension door</Link> as a move action by expending 1 point of ki from his ki pool. He must begin and end his movement in a space of water equal to his size. He cannot take other creatures with him when he uses this ability.</p>
<p>This replaces <strong className="hl">abundant step</strong>.</p>
</>};
...
<p><strong>Perfect Strike (Ex):</strong> At 1st level, a weapon adept gains <Link to="/feat/perfect_strike">Perfect Strike</Link> as a bonus feat, even if he does not meet the prerequisites. At 10th level, the monk can roll his attack roll three times and take the higher result. If one of these rolls is a critical threat, he can choose which one of his other two rolls to use as his confirmation roll.</p>
<p>This ability replaces <strong className="hl">Stunning Fist</strong>.</p>
<p><strong>Way of the Weapon Master (Ex):</strong> At 2nd level, a weapon adept gains <Link to="/feat/weapon_focus">Weapon Focus</Link> as a bonus feat with one of his monk weapons. At 6th level, the monk gains <Link to="/feat/weapon_specialization">Weapon Specialization</Link> with the same weapon as a bonus feat, even if he does not meet the prerequisites.</p>
<p>This ability replaces <strong className="hl">evasion</strong>.</p>
<p><strong>Evasion (Ex):</strong> At 9th level, the monk gains <Link to="/ability/evasion">evasion</Link>.</p>
<p>This ability replaces <strong className="hl">improved evasion</strong>.</p>
<p><strong>Uncanny Initiative (Ex):</strong> At 17th level, a weapon adept does not need to roll for initiative. He always treats his initiative roll as if it resulted in any number of his choosing (from 1 to 20).</p>
<p>This ability replaces <strong className="hl">timeless body</strong>.</p>
<p><strong>Pure Power:</strong> At 20th level, a weapon adept forsakes the ideals of the perfect self to become a bastion of the physical and mental virtues monks hold dear. The monk gains a +2 bonus to Strength, Dexterity, and Wisdom.</p>
<p>This ability replaces <strong className="hl">perfect self</strong>.</p>
</>};
...
<p><strong>Ready for Anything (Ex):</strong> At 3rd level, a wildcat gains a +2 bonus on initiative checks and Perception checks to act in a surprise round.</p>
<p>This ability replaces <strong className="hl">still mind</strong>.</p>
<p><strong>Brawler Maneuver Training (Ex):</strong> At 4th level, a wildcat gains additional training with the <Link to="/rule/dirty_trick">dirty trick</Link> combat maneuver. He gains a +1 bonus on combat maneuver checks when attempting this combat maneuver and a +1 bonus to his CMD when defending against this maneuver.</p>
<p>At 7th, 10th, and 16th levels, a wildcat becomes further trained in another combat maneuver, gaining the above +1 bonus on combat maneuver checks and to CMD. In addition, the bonuses granted by previous maneuver training increase by 1 each. For example, when a wildcat reaches 7th level, he gains a +1 bonus on one type of combat maneuver, +1 to her CMD against that combat maneuver, and the bonuses for the dirty trick combat maneuver increase to +2.</p>
<p>This ability replaces <strong className="hl">ki pool</strong> and <strong className="hl">high jump</strong>.</p>
<p><strong>Improvised Weapon Mastery (Ex):</strong> Starting at 4th level, a wildcat's damage with improvised weapons increases. When wielding an <Link to="/misc/improvised_weapon">improvised weapon</Link>, he uses the unarmed strike damage of a monk four levels lower instead of the base damage for that weapon (minimum monk level 1). For example, a 6th-level Medium wildcat wielding a broken bottle deals 1d6 points of damage instead of the weapon's normal 1d4. If the weapon normally deals more damage than this, its damage is unchanged. This increase in damage does not affect any other aspect of the weapon. The wildcat can decide to use the weapon's base damage instead of his adjusted unarmed strike damage. This must be declared before the attack roll is attempted.</p>
<p>This ability replaces all instances of <strong className="hl">slow fall</strong>.</p>
<p><strong>Bonus Feat:</strong> A wildcat adds the following feats to his list of bonus feats at 6th level: <Link to="/feat/improved_dirty_trick">Improved Dirty Trick</Link>, <Link to="/feat/improved_reposition">Improved Reposition</Link>, <Link to="/feat/improved_steal">Improved Steal</Link>. He adds the following feats to his list of bonus feats at 10th level: <Link to="/feat/quick_dirty_trick">Quick Dirty Trick</Link>, <Link to="/feat/quick_reposition">Quick Reposition</Link>, <Link to="/feat/quick_steal">Quick Steal</Link>.</p>
<p><strong>Knockout (Ex):</strong> Starting at 9th level, once per day a wildcat can unleash a devastating attack that can instantly knock a target unconscious. He must announce this intent before making his attack roll. If the wildcat's strike is successful and the target takes damage from the blow, the target must succeed at a Fortitude saving throw (DC = 10 + 1/2 the wildcat's level + the higher of the wildcat's Strength or Dexterity modifier) or fall unconscious for 1d6 rounds. Each round on its turn, the unconscious target can attempt a new saving throw to end the effect; this is a full-round action that does not provoke attacks of opportunity. Creatures immune to critical hits or nonlethal damage are immune to this ability. At 12th level, a wildcat can use this ability twice per day.</p>
<p>This ability replaces <strong className="hl">improved evasion</strong> and <strong className="hl">abundant step</strong>.</p>
<p><strong>Turn the Tables (Ex):</strong> At 13th level, opponents provoke an attack of opportunity from the wildcat whenever they fail at a combat maneuver against the wildcat.</p>
<p>This ability replaces <strong className="hl">diamond soul</strong>.</p>
<p><strong>Dirty Blow (Ex):</strong> At 19th level, when a wildcat succeeds at a dirty trick combat maneuver, he can deal his unarmed strike damage to that opponent.</p>
<p>This ability replaces <strong className="hl">empty body</strong>.</p>
</>};
...
<p><strong>Hurricane Punch (Ex):</strong> At 1st level, a windstep master gains <Link to="/feat/hurricane_punch">Hurricane Punch</Link> as a bonus feat, even if he does not meet the prerequisites. While using this feat, he doesn't provoke an attack of opportunity, even if he doesn't have the <Link to="/feat/improved_bull_rush">Improved Bull Rush</Link> feat.</p>
<p>At 4th level, while using the Hurricane Punch feat, the windstep master can <Link to="/rule/bull_rush">bull rush</Link> a target up to two size categories larger. At 12th level, the windstep master's target can be up to three size categories larger. At 20th level, the target can be of any size category.</p>
<p>At 8th level, when the windstep master uses the Hurricane Punch feat to successfully bull rush a creature, he can push the creature back an additional 5 feet. At 16th level, he can push the creature back an additional 10 feet.</p>
<p>This ability replaces <strong className="hl">stunning fist</strong>.</p>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
...
<p><strong>Swift Ki (Su):</strong> At 4th level, the windstep master can spend 1 point from his ki pool as a swift action to sustain his wind step for 1 minute. During this time, the windstep master can remain airborne even if he doesn't reach a solid surface. He can also spend 1 point from his ki pool as a swift action to increase his wind step distance by 20 feet for 1 round. The windstep master does not gain the ability to spend ki to increase his base speed by 20 feet for 1 round.</p>
<p>This ability alters <strong className="hl">ki pool</strong>.</p>
</>};
...
<p><strong>Weapon and Armor Proficiency:</strong> Zen archers are proficient with <Link to="/eq-weapon/longbow">longbows</Link>, <Link to="/eq-weapon/shortbow">shortbows</Link>, <Link to="/eq-weapon/composite_longbow">composite longbows</Link>, and <Link to="/eq-weapon/composite_shortbow">composite shortbows</Link> in addition to their normal weapon proficiencies.</p>
<p><strong>Flurry of Blows (Ex):</strong> Starting at 1st level, a zen archer can make a flurry of blows as a full-attack action, but only when using a bow (even though it is a ranged weapon). He may not make a flurry of blows with his unarmed attacks or any other weapons. A zen archer does not apply his Strength bonus on damage rolls made with flurry of blows unless he is using a composite bow with a Strength rating. A zen archer's flurry of blows otherwise functions as normal for a monk of his level.</p>
<p><strong>A zen archer cannot use <Link to="/feat/rapid_shot">Rapid Shot</Link></strong> or <Link to="/feat/manyshot">Manyshot</Link> when making a flurry of blows with his bow.</p>
<p><strong>Bonus Feats:</strong> A zen archer's bonus feats must be taken from the following list: <Link to="/feat/combat_reflexes">Combat Reflexes</Link>, <Link to="/feat/deflect_arrows">Deflect Arrows</Link>, <Link to="/feat/dodge">Dodge</Link>, <Link to="/feat/far_shot">Far Shot</Link>, <Link to="/feat/point_blank_shot">Point-Blank Shot</Link>, <Link to="/feat/precise_shot">Precise Shot</Link>, and Rapid Shot. At 6th level, the following feats are added to the list: <Link to="/feat/focused_shot">Focused Shot</Link>, <Link to="/feat/improved_precise_shot">Improved Precise Shot</Link>, Manyshot, <Link to="/feat/mobility">Mobility</Link>, and <Link to="/feat/parting_shot">Parting Shot</Link>. At 10th level, the following feats are added to the list: <Link to="/feat/improved_critical">Improved Critical</Link>, <Link to="/feat/pinpoint_targeting">Pinpoint Targeting</Link>, <Link to="/feat/shot_on_the_run">Shot on the Run</Link>, and <Link to="/feat/snatch_arrows">Snatch Arrows</Link>. A monk need not have any of the prerequisites normally required for these feats to select them. These feats replace the monk's normal bonus feats.</p>
<p><strong>Perfect Strike (Ex):</strong> At 1st level, a zen archer gains <Link to="/feat/perfect_strike">Perfect Strike</Link> as a bonus feat, even if he does not meet the prerequisites. A zen archer can use Perfect Strike with any bow. At 10th level, the monk can roll his attack roll three times and take the highest result. If one of these rolls is a critical threat, the monk must choose one of his other two rolls to use as his confirmation roll.</p>
<p>This ability replaces <strong className="hl">Stunning Fist</strong>.</p>
<p><strong>Way of the Bow (Ex):</strong> At 2nd level, a zen archer gains <Link to="/feat/weapon_focus">Weapon Focus</Link> as a bonus feat with one type of bow. At 6th level, the monk gains <Link to="/feat/weapon_specialization">Weapon Specialization</Link> with the same weapon as a bonus feat, even if he does not meet the prerequisites.</p>
<p>This ability replaces <strong className="hl">evasion</strong>.</p>
<p><strong>Zen Archery (Ex):</strong> At 3rd level, a zen archer may use his Wisdom modifier instead of his Dexterity modifier on ranged attack rolls when using a bow.</p>
<p>This ability replaces <strong className="hl">maneuver training</strong>.</p>
<p><strong>Point Blank Master (Ex):</strong> At 3rd level, a zen archer gains <Link to="/feat/point_blank_master">Point-Blank Master</Link> as a bonus feat, even if he does not meet the prerequisites.</p>
<p>This ability replaces <strong className="hl">still mind</strong>.</p>
<p><strong>Ki Pool (Su):</strong> At 4th level, in addition to the normal abilities of his ki pool, a zen archer may spend 1 point from his ki pool to increase the range increment for his bow by 50 feet for 1 round.</p>
<p><strong>Ki Arrows (Su):</strong> At 5th level, a zen archer may spend 1 point from his ki pool as a swift action to change the damage dice of arrows he shoots to that of his unarmed strikes. This lasts until the start of his next turn. For example, a Medium zen archer's short bow normally deals 1d6 damage; using this ability, his arrows deal 1d8 damage until the start of his next turn.</p>
<p>This ability replaces <strong className="hl">purity of body</strong>.</p>
<p><strong>Reflexive Shot (Ex):</strong> At 9th level, a zen archer can make attacks of opportunity with arrows from his bow. The monk still threatens squares he could reach with unarmed strikes, and can still only make one attack of opportunity per round (unless he has Combat Reflexes).</p>
<p>This ability replaces <strong className="hl">improved evasion</strong>.</p>
<p><strong>Trick Shot (Su):</strong> At 11th level, a zen archer may hit targets that he might otherwise miss. By spending 1 point from his ki pool as a swift action, the zen archer can ignore <Link to="/rule/concealment">concealment</Link>. By spending 2 points, he can ignore total concealment or <Link to="/rule/cover">cover</Link>. By spending 3 points, he can ignore total cover, even firing arrows around corners. The arrow must still be able to reach the target; a target inside a closed building with no open doors or windows cannot be attacked. These effects last for 1 round.</p>
<p>This ability replaces <strong className="hl">diamond body</strong>.</p>
<p><strong>Ki Focus Bow (Su):</strong> At 17th level, as long as he has at least 1 point of ki in his ki pool, a zen archer may treat arrows fired from his bow as if they were <Link to="/magic-enh/ki_focus">ki focus</Link> weapons, allowing him to use his special ki attacks as if his arrows were unarmed attacks.</p>
