...
<Ability id="bomb-su" extraClasses="hasSubs" icon={["ranged"]}>
...
<Ability id="spellblast-bombs-su" icon={["boost","learn"]}>
...
<Ability id="school-of-the-bomb" icon={["down"]}>
...
<Ability id="medicinal-alchemy" icon={["learn","power"]}>
...
<Ability id="ready-for-anything-ex" icon={["power"]}>
...
<Ability id="generous-touch-su" icon={["boost"]}>
...
<Ability id="restorative-shelter-su" icon={["learn","boost","def"]}>
...
<Ability id="hidden-bond-sp" icon={["magic"]}>
...
<Ability id="bonded-force-su" icon={["magic"]}>
...
<Ability id="reshape-bond-sp" icon={["magic"]}>
...
<Ability id="temporal-pool-su" icon={["magic"]}>
...
<Ability id="forewarned" icon={["roll","boost","def"]}>
...
<Ability id="accelerate" icon={["magic"]}>
...
<Ability id="complex-contingency" icon={["magic"]}>
...
<Ability id="parallel-self" icon={["magic"]}>
...
<Ability id="clockwork-expertise-ex" icon={["def"]}>
...
<Ability id="craft-construct" icon={["power","down"]}>
...
<Ability id="familiar-tinkering-ex" icon={["boost"]}>
...
<Ability id="focused-infusion" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="sickening-infusion" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="blood-command-su" extraClasses="hasSubs" icon={["boost"]}>
...
<Ability id="commanding-infusion" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="blood-desecration-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="desecrating-infusion" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="blood-ability-su" icon={["magic"]}>
...
<Ability id="perfect-infusion-su" icon={["boost"]}>
...
<Ability id="eldritch-knowledge-su" icon={["down","def"]}>
...
<Ability id="eldritch-grimoire-" icon={["down","boost"]}>
...
<Ability id="talisman-of-revealing" icon={["magic","boost","learn"]}>
...
<Ability id="eldritch-infusion-su" icon={["boost","down"]}>
...
<Ability id="arcane-reservoir-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="arcane-reservoir-su" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="exploiter-exploit" icon={["power"]}>
...
<Ability id="diminished-expertise" icon={["down"]}>
...
<Ability id="school-familiar-ex" icon={["power","down"]}>
...
<Ability id="familiar-spells-ex" icon={["learn"]}>
...
<Ability id="focused-school-ex" icon={["boost"]}>
...
<Ability id="fey-familiar" icon={["power"]}>
...
<Ability id="fey-summoner" icon={["magic"]}>
...
<Ability id="warp-reality-su" icon={["magic"]}>
...
<Ability id="turn-undead-su" icon={["power"]}>
...
<Ability id="positive-touch-su" icon={["touch","zap"]}>
...
<Ability id="death-bane-su" icon={["boost"]}>
...
<Ability id="ghostbane-su" icon={["boost"]}>
...
<Ability id="guarded-life-su" icon={["def","roll"]}>
...
<Ability id="apprentice-ex" icon={["power"]}>
...
<Ability id="trained-teamwork-ex" icon={["power"]}>
...
<Ability id="pact-focus-ex" icon={["down"]}>
...
<Ability id="pact-ex" icon={["power","warning"]}>
...
<Ability id="pact-summons-ex" icon={["boost"]}>
...
<Ability id="true-form-ex" icon={["boost"]}>
...
<Ability id="effortless-magic-ex" icon={["boost"]}>
...
<Ability id="patron-spells" icon={["power","learn","magic"]}>
...
<Ability id="great-power-greater-expense-ex" icon={["down","power","learn","roll","def"]}>
...
<Ability id="bonded-book-sp" icon={["power","learn","boost"]}>
...
<Ability id="great-odyssey" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="mount-sp" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="master-mariner-su" extraClasses="subAbility" icon={["magic","boost"]}>
...
<Ability id="primal-magic-su" icon={["magic"]}>
...
<Ability id="enhance-primal-magic-event-su" icon={["magic"]}>
...
<Ability id="primal-surge-su" icon={["roll","def"]}>
...
<Ability id="runic-focus-su" icon={["power"]}>
...
<Ability id="secrets-revealed-sp" icon={["magic"]}>
...
<Ability id="flash-of-insight-su" icon={["boost"]}>
...
<Ability id="scroll-blade-su" icon={["melee"]}>
...
<Ability id="scroll-shield-su" icon={["def"]}>
...
<Ability id="improved-scroll-casting-su" icon={["magic","boost"]}>
...
<Ability id="shadow-spells-su" icon={["magic","boost"]}>
...
<Ability id="siege-engineer" icon={["power"]}>
...
<Ability id="siege-engine-bond-su" icon={["ranged"]}>
...
<Ability id="empower-siege-engine-su" icon={["boost","learn"]}>
...
<Ability id="siege-school" icon={["down"]}>
...
<Ability id="focused-spells-su" icon={["boost"]}>
...
<Ability id="spell-study-su" icon={["magic"]}>
...
<Ability id="arcane-gun-su" icon={["power","ranged","zap","boost"]}>
...
<Ability id="mage-bullets-su" icon={["boost"]}>
...
<Ability id="school-of-the-gun" icon={["down"]}>
...
<Ability id="soulbound-familiar-ex" icon={["info","power"]}>
...
<Ability id="spirit-link-su" icon={["power"]}>
...
<Ability id="spirit-hex" icon={["power"]}>
...
<Ability id="hand-of-the-apprentice-su" extraClasses="subAbility" icon={["zap"]}>
...
<Ability id="telekinetic-sword-sp" icon={["magic"]}>
...
<Ability id="necromantic-focus" icon={["warning"]}>
...
<Ability id="necropolitan-ex" icon={["boost","down"]}>
...
<Ability id="corpse-bond-su" extraClasses="hasSubs" icon={["info","down"]}>
...
<Ability id="corpse-companion-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="reanimator-su" icon={["learn"]}>
...
<Ability id="lich-loved-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="one-of-us-ex" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="spontaneous-divination-su" icon={["magic"]}>
...
<Ability id="abjuration-sense-ex" icon={["boost"]}>
...
<Ability id="wispy-form-ex" icon={["def","magic"]}>
...
<Ability id="listening-to-the-wind-sp" icon={["magic"]}>
...
<Ability id="walk-the-planes-sp-su" icon={["boost","def"]}>
...
<Ability id="planar-associates-ex" icon={["info","power","learn","boost"]}>
...
<Ability id="planar-redoubt-sp" icon={["magic"]}>
