...
const _thassilonian_specialist = {hasJL:true,title: "Thassilonian Specialist", jsx: <><div className="jumpList" id="arc-wizard-thassilonian_specialist-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="arc-wizard-thassilonian_specialist-thassilonian-schools-of-magic">Thassilonian Schools of Magic</InnerLink></li></ul></div><h2 id="arc-wizard-thassilonian_specialist-thassilonian-specialist">Thassilonian Specialist</h2>
<p><strong>Sources</strong> <Link to="/source/inner_sea_magic">Inner Sea Magic pg. 17</Link><br/>Only wizards can truly follow the ancient philosophies created by Thassilon's runelords, for only wizards have the capability to specialize in a school of magic.</p>
...
<hr/>
<p><strong>Envy (Abjuration):</strong> The art of suppressing magic other than your own.<br/><strong>Prohibited Schools:</strong> evocation, necromancy.</p>
<p><strong>Gluttony (Necromancy):</strong> Magic that manipulates the physical body to provide for an unending hunger for life.<br/><strong>Prohibited Schools:</strong> abjuration, enchantment.</p>
<p><strong>Greed (Transmutation):</strong> Magically transforming things into objects of greater value or utility, and enhancing the physical self.<br/><strong>Prohibited Schools:</strong> enchantment, illusion.</p>
<p><strong>Lust (Enchantment):</strong> Magically controlling and dominating other creatures to satisfy your desires, and manipulating others' minds, emotions, and wills.<br/><strong>Prohibited Schools:</strong> necromancy, transmutation.</p>
<p><strong>Pride (Illusion):</strong> Perfecting your own appearance and domain through trickery and illusions.<br/><strong>Prohibited Schools:</strong> conjuration, transmutation.</p>
<p><strong>Sloth (Conjuration):</strong> Calling agents and minions to perform your deeds for you, or creating what you need as you need it.<br/><strong>Prohibited Schools:</strong> evocation, illusion.</p>
<p><strong>Wrath (Evocation):</strong> Mastery of the raw destructive power of magic, and channeling those destructive forces.<br/><strong>Prohibited Schools:</strong> abjuration, conjuration.</p>
</>};
