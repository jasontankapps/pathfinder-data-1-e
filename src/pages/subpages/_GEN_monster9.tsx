...
<Info source={[["Pathfinder #36: Sound of a Thousand Screams",82]]} xp="3,200" cn medium magicalBeast init={10} dv={60} scent pcp={16} />
<Defense ac={[23,17,16]} mod="+6 Dex, +1 dodge, +6 natural" hp={[85,"10d10+30"]} fort="+10" ref="+13" will="+6" dr="5/magic" sr="19" />
<Offense sp={40} melee="2 claws +16 (1d4+2), bite +16 (1d6+2)" specAtt={[["dweomer leap","dweomer leap"]]} pounce rake="2 claws +11, 1d4+2" />
<SpellBlock id="1" sla={{"cl":10,"content":[{"constant":true,"content":<Link to="/spell/detect_magic">detect magic</Link>},{"will":true,"content":<><Link to="/spell/lesser_globe_of_invulnerability">lesser globe of invulnerability</Link>, <Link to="/spell/dispel_magic">dispel magic</Link></>},{"day":3,"content":<><Link to="/spell/dimension_door">dimension door</Link> (self only), <Link to="/spell/antimagic_field">antimagic field</Link></>}]}} />
<Stats atts={[15,23,16,13,16,16]} bab={10} cmb={12} cmd={29} cmdP="33 vs. trip" feats={["Dodge","Improved Initiative","Mobility","Spring Attack","Weapon Finesse"]} skills={{"climb":{"b":6},"k":{"a":11},"per":{"b":16},"stl":{"b":19}}} racial="+4 Climb" lang={["C","S"]} sq="spell link" />
<Ecology env="any forest (First World)" org={<>solitary, hunt (2-3), ambush (1-3 dweomercats and 2-12 <Link to="/monster/dweomercat_cub">dweomercat cubs</Link>)</>} treasure={{"S":false}} />
</div>
...
<div className="reduce">
<Info source={[["Pathfinder #36: Sound of a Thousand Screams",82]]} xp="600" cn tiny magicalBeast init={2} dv={60} scent pcp={5} />
<Defense ac={[16,15,13]} mod="+2 Dex, +1 dodge, +1 natural, +2 size" hp={[16,"3d10"]} fort="+3" ref="+5" will="+2" dr="5/magic" sr="14" />
<Offense sp={20} melee="2 claws +7 (1d2-1), bite +7 (1d3-1)" specAtt={[["dweomer leap","dweomer leap"]]} pounce rake="2 claws +6, 1d2-1" />
<SpellBlock id="1" sla={{"cl":4,"content":[{"constant":true,"content":<Link to="/spell/detect_magic">detect magic</Link>},{"per":"week","content":<><Link to="/spell/dimension_door">dimension door</Link> (self only)</>}]}} />
<Stats atts={[9,15,10,9,12,14]} bab={3} cmb={3} cmd={13} cmdP="17 vs. trip" feats={["Dodge","Weapon Finesse"]} skills={{"climb":{"b":3},"k":{"a":0},"per":{"b":5},"stl":{"b":4}}} racial="+4 Climb" lang={["C","S"]} />
<Ecology env="any forest" org={<>solitary or ambush (1-3 <Link to="/monster/dweomercat">dweomercats</Link> and 2-12 dweomercat cubs)</>} treasure={{"S":false}} />
</div>
<Header sub>Special Abilities</Header>
<p><strong>Dweomer Leap (Su)</strong> When a dweomercat is targeted by a spell or within the area of effect of a spell, it can, as a swift action, choose to teleport to a square adjacent to the spell's caster, effectively appearing mid-leap and aimed toward the caster. This ability takes effect regardless of whether or not the spell overcomes the dweomercat's spell resistance. If it chooses, the dweomercat can immediately make a full attack against the spell's caster as though pouncing. Using this ability does not provoke an attack of opportunity. If there is no safe space adjacent to the caster - or if the dweomercat chooses - the dweomercat can forgo using this ability.</p>
<Header sub>Description</Header>
...
<div className="reduce">
<Info source={[["Bestiary 3",108]]} xp="51,200" ne medium undead subs={["incorporeal"]} init={15} dv={60} pcp={29} />
<Defense ac={[28,28,17]} mod="+7 deflection, +11 Dex" hp={[207,"18d8+126"]} fort="+13" ref="+17" will="+17" chanRes="+4" incorp dr="10/good" immune={<Link to="/umr/undead_traits">undead traits</Link>} sr="26" />
<Offense fl={60} flP="perfect" melee="pain touch +25 touch (7d6)" specAtt={[["malevolence","malevolence"]]} />
<SpellBlock id="1" sla={{"cl":18,"con":"+25","content":[{"will":true,"content":<><Link to="/spell/detect_thoughts">detect thoughts</Link> (DC 19), <Link to="/spell/telekinesis">telekinesis</Link> (DC 22)</>},{"day":3,"content":<><Link to="/spell/dominate_monster">dominate monster</Link> (DC 26), <Link to="/spell/feeblemind">feeblemind</Link> (DC 22), <Link to="/spell/inflict_serious_wounds">inflict serious wounds</Link> (DC 20)</>},{"day":1,"content":<><Link to="/spell/greater_heroism">greater heroism</Link>, <Link to="/spell/modify_memory">modify memory</Link> (DC 21), <Link to="/spell/tongues">tongues</Link></>}]}} />
<Stats atts={[0,32,0,15,18,25]} bab={13} cmb={24} cmd={41} feats={["Alertness","Blind-Fight","Combat Reflexes","Flyby Attack","Improved Initiative","Iron Will","Lunge","Step Up",["Weapon Focus"," (pain touch)"]]} skills={{"bluff":{"b":25},"diplo":{"b":25},"sm":{"b":29},"stl":{"b":32}}} lang={["A","Ce","C"]} />
...
<div className="reduce">
<Info source={[["Pathfinder RPG Bestiary",118]]} xp="200" n small animal init={2} llv pcp={10} />
<Defense ac={[14,13,12]} mod="+2 Dex, +1 natural, +1 size" hp={[5,"1d8+1"]} fort="+3" ref="+4" will="+2" />
<Offense sp={10} fl={80} flP="average" melee="2 talons +3 (1d4), bite +3 (1d4)" />
<Stats atts={[10,15,12,2,15,7]} bab={0} cmb={-1} cmd={11} feats={["Weapon Finesse"]} skills={{"fly":{"b":8},"per":{"b":10}}} racial="+8 Perception" />
<Ecology env="temperate mountains" org="solitary or pair" treasure={{"X":false}} />
</div>
<Header sub>Description</Header>
...
<div className="reduce">
<Info source={[["Ire of the Storm",62]]} xp="400" ne medium undead subs={["aquatic"]} init={0} dv={60} pcp={3} />
<Defense ac={[12,10,12]} mod="+2 natural" hp={[16,"3d8+3"]} fort="+2" ref="+1" will="+4" dr="5/piercing or slashing" immune={<Link to="/umr/undead_traits">undead traits</Link>} resist="cold 5, fire 5" />
<Offense sp={30} melee="slam +4 (1d8+3)" ranged={<>gush +2 (1d4+2 plus <Link to="/umr/trip">trip</Link>)</>} specAtt={[["create spawn","create spawn"],["embedded debris","embedded debris"],["gush","gush"]]} />
<Stats atts={[15,10,0,6,8,13]} bab={2} cmb={4} cmd={14} feats={["Blind-Fight","Iron Will"]} skills={{"intm":{"b":6},"per":{"b":3},"stl":{"b":5,"x":"+9 underwater"},"swim":{"b":6}}} racial="+4 Stealth underwater" lang={["Aq"]} />
<Ecology env="any swamp or water" org="solitary, pair, or wreck (3-15)" treasure={{"S":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<div className="reduce">
<Info source={[["Bestiary 5",103]]} xp="400" n small magicalBeast subs={["aquatic"]} init={4} dv={60} llv pcp={5} />
<Defense ac={[13,11,13]} mod="+2 natural, +1 size" hp={[19,"3d10+3"]} fort="+4" ref="+5" will="+1" />
<Offense sp={5} sw={20} melee="bite +5 (1d4+1 plus attach), tail slap +0 (1d4) or sucker +5 touch (attach), tail slap +0 (1d4)" specAtt={[["sap speed","sap speed"]]} attach />
<Stats atts={[12,11,13,2,10,13]} bab={3} cmb={3} cmbP="+11 grapple while attached" cmd={13} cmdP="17 vs. grapple while attached" feats={["Improved Initiative","Lightning Reflexes"]} skills={{"per":{"b":5},"stl":{"b":8},"swim":{"b":9}}} />
<Ecology env="warm or temperate water" org="solitary, pair, or school (3-8)" treasure={{"X":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<div className="reduce">
<Info source={[["Pathfinder RPG Bestiary",119]]} xp="600" n small animal init={6} llv pcp={4} />
<Defense ac={[15,13,13]} mod="+2 Dex, +2 natural, +1 size" hp={[17,"2d8+8"]} fort="+7" ref="+5" will="+0" resist="electricity 10" />
<Offense sp={5} sw={30} melee="bite +3 (1d6+1) and tail -2 touch (1d6 electricity)" />
<Stats atts={[13,14,19,1,10,6]} bab={1} cmb={1} cmd={13} cmdP="can't be tripped" feats={["Improved Initiative"]} skills={{"ea":{"b":10},"per":{"b":4},"stl":{"b":10},"swim":{"b":9}}} racial="+8 Escape Artist" />
<Ecology env="warm fresh water" org="solitary" treasure={{"X":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<div className="reduce">
<Info source={[["Occult Bestiary",26]]} xp="9,600" ce small aberration init={11} sen={["analyze aura"]} dv={60} pcp={23} />
<Defense ac={[25,19,17]} mod="+7 Dex, +1 dodge, +6 natural, +1 size" hp={[123,"13d8+65"]} fort="+9" ref="+11" will="+12" dr="10/adamantine and magic" immune="fire, mind-affecting effects" resist="cold 20, electricity 20, sonic 20" sr="25" weak={[<>vulnerable to <em>protection from evil</em></>]} />
<Offense sp={10} fl={50} flP="perfect" melee="8 claws +18 (1d4+2 plus attach [once per round if two or more claws hit the same creature])" specAtt={[["body thief","body thief"]]} />
<SpellBlock id="1" sla={{"cl":10,"content":[{"constant":true,"content":<Link to="/spell/analyze_aura">analyze aura</Link>},{"will":true,"content":<><Link to="/spell/invisibility">invisibility</Link>, <em>reduce size</em>|as <Link to="/spell/reduce_person">reduce person</Link> but self only and affects aberrations</>}]}} />
<SpellBlock id="2" psy={{"pe":24,"cl":10,"content":<><Link to="/spell/anticipate_thoughts">anticipate thoughts</Link> (2 PE, DC 16), <Link to="/spell/ego_whip_iv">ego whip IV</Link> (6 PE, DC 20), <Link to="/spell/globe_of_invulnerability">globe of invulnerability</Link> (4 PE), <Link to="/spell/id_insinuation_iii">id insinuation III</Link> (4 PE, DC 17)</>,"con":"+14"}} />
<Stats atts={[15,25,21,16,14,18]} bab={9} cmb={15} cmd={28} feats={["Agile Maneuvers","Dodge","Improved Initiative","Iron Will","Mobility","Weapon Finesse",["Weapon Focus"," (claw)"]]} skills={{"bluff":{"b":25},"diplo":{"b":24},"dis":{"b":25},"sm":{"b":15},"stl":{"b":35}}} racial="+8 Bluff, +8 Perception, +8 Stealth" lang={["AkX","CX","UX",";",[<><Link to="/umr/telepathy">telepathy</Link> 100 ft.</>]]} />
<Ecology env="any underground" org="solitary, brood (4-8), or tribe (10-30)" treasure={{"D":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<Ecology env="any" org="cult (1 plus 13-20 cultists)" treasure={{"S":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<div className="reduce">
<Info source={[["Bestiary 4",84]]} xp="9,600" cn medium outsider subs={["extraplanar"]} init={7} senSpell={["deathwatch"]} dv={60} pcp={18} />
<Defense ac={[24,13,21]} mod="+7 armor, +3 Dex, +4 shield" hp={[123,"13d10+52"]} fh="5" fort="+12" ref="+11" will="+8" def={[["freedom of movement",<em>freedom of movement</em>]]} dr="10/cold iron and lawful" immune="cold, disease, fear, poison" resist="acid 10, electricity 10, fire 10" sr="21" />
<Offense sp={30} melee="+2 battleaxe +19/+14/+9 (1d8+6/&times;3)" ranged="mwk throwing axe +17 (1d6+4)" specAtt={[["challenge of single combat","challenge of single combat"]]} />
<SpellBlock id="1" sla={{"cl":10,"con":"+10","content":[{"constant":true,"content":<><Link to="/spell/deathwatch">deathwatch</Link>, <Link to="/spell/freedom_of_movement">freedom of movement</Link></>},{"will":true,"content":<Link to="/spell/rage">rage</Link>},{"day":3,"content":<Link to="/spell/divine_power">divine power</Link>},{"day":1,"content":<Link to="/spell/heroes_feast">heroes' feast</Link>}]}} />
<Stats atts={[19,16,19,10,14,11]} bab={13} cmb={17} cmd={30} feats={["Combat Reflexes","Improved Initiative",["Improved Iron Will",<sup>B</sup>],"Iron Will","Power Attack","Stand Still","Step Up","Strike Back"]} skills={{"intm":{"b":16},"k":{"e":16},"per":{"b":18}}} lang={["Ce","C"]} sq="battle-trained, thirst for battle" />
<p className="spells indented"><sup><strong>B</strong></sup> Bonus feat.</p>
<Ecology env="any" org="solitary, squad (3-6), or warband (7-16)" treasure={{"T":[["+2","Asm"],["+2","Ahws"],["+2","Wba"],["Mw","W-throwing axe"]]}} />
</div>
<Header sub>Special Abilities</Header>
...
<div className="reduce">
<Info source={[["Bestiary 4",85],["Pathfinder #46: Wake of the Watcher",82]]} xp="1,600" ln medium aberration subs={["aquatic"]} init={2} dv={60} aav pcp={13} />
<Defense ac={[18,12,16]} mod="+2 Dex, +6 natural" hp={[59,"7d8+28"]} fort="+8" ref="+4" will="+8" immune="cold" resist="fire 10" />
<Offense sp={30} fl={20} flP="clumsy" sw={40} melee={<>5 tentacles +7 (1d4+2 plus <Link to="/umr/grab">grab</Link>)</>} constrict="1d4+2" />
...
<Ecology env="any" org="solitary, pair, pod (3-8), or expedition (9-16)" treasure={{"S":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<div className="reduce">
<Info source={[["Bestiary 5",106]]} xp="400" n small outsider subs={["aether","elemental","extraplanar"]} init={6} dv={60} blindsense={60} pcp={5} />
<Defense ac={[14,14,12]} mod="+1 deflection, +2 Dex, +1 size" hp={[13,"2d10+2"]} fort="+4" ref="+5" will="+0" def={[["telekinetic deflection","telekinetic deflection"]]} immune={<><Link to="/subtype/elemental">elemental</Link> traits, force</>} />
<Offense fl={60} flP="good" melee="slam +4 (1d4+1)" ranged="telekinetic throw +5 (1d8+2)" specAtt={[["telekinetic maneuver","telekinetic maneuver"],["telekinetic throw DC 12","telekinetic throw (DC 12)"]]} />
<Stats atts={[12,15,12,4,11,11]} bab={2} cmb={2} cmd={15} feats={[["Improved Initiative",<sup>B</sup>],"Point-Blank Shot"]} skills={{"acro":{"b":6},"fly":{"b":12},"per":{"b":5},"stl":{"b":11}}} lang={["Aq","Au","Ig","T"]} sq="telekinetic invisibility" />
<p className="spells indented"><sup><strong>B</strong></sup> Bonus feat.</p>
<Ecology env={<>any (<Link to="/rule/ethereal_plane">Ethereal Plane</Link>)</>} org="solitary, pair, or gang (3-8)" treasure={{"X":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<Header full id="medium-aether-elemental"><span>Medium Aether Elemental</span><span>CR 3</span></Header>
<div className="reduce">
<Info source={[["Bestiary 5",106]]} xp="800" n medium outsider subs={["aether","elemental","extraplanar"]} init={8} dv={60} blindsense={60} pcp={7} />
<Defense ac={[17,17,13]} mod="+3 deflection, +4 Dex" hp={[34,"4d10+12"]} fort="+7" ref="+8" will="+3" def={[["telekinetic deflection","telekinetic deflection"]]} immune={<><Link to="/subtype/elemental">elemental</Link> traits, force</>} />
<Offense fl={60} flP="good" melee="slam +6 (1d6+3)" ranged="telekinetic throw +8 (2d6+2)" specAtt={[["telekinetic maneuver","telekinetic maneuver"],["telekinetic throw DC 16","telekinetic throw (DC 16)"]]} />
<Stats atts={[14,19,16,4,11,11]} bab={4} cmb={6} cmd={23} feats={[["Improved Initiative",<sup>B</sup>],"Iron Will","Point-Blank Shot"]} skills={{"acro":{"b":9},"fly":{"b":13},"per":{"b":7},"stl":{"b":11}}} lang={["Aq","Au","Ig","T"]} sq="telekinetic invisibility" />
<p className="spells indented"><sup><strong>B</strong></sup> Bonus feat.</p>
...
<div className="reduce">
<Info source={[["Pathfinder RPG Bestiary",120]]} xp="400" n small outsider subs={["air","elemental","extraplanar"]} init={7} dv={60} pcp={4} />
<Defense ac={[17,14,14]} mod="+3 Dex, +3 natural, +1 size" hp={[13,"2d10+2"]} fort="+4" ref="+6" will="+0" def={[["air mastery","air mastery"]]} immune={<><Link to="/subtype/elemental">elemental</Link> traits</>} />
<Offense fl={100} flP="perfect" melee="slam +6 (1d4+1)" whirlwind="DC 12" />
<Stats atts={[12,17,12,4,11,11]} bab={2} cmb={2} cmd={15} feats={["Flyby Attack",["Improved Initiative",<sup>B</sup>],["Weapon Finesse",<sup>B</sup>]]} skills={{"acro":{"b":7},"ea":{"b":7},"fly":{"b":17},"k":{"p":1},"per":{"b":4},"stl":{"b":11}}} />
<p className="spells indented"><sup><strong>B</strong></sup> Bonus feat.</p>
<Ecology env={<Link to="/rule/plane_of_air">Plane of Air</Link>} org="solitary, pair, or gang (3-8)" treasure={{"X":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<p><strong>Family:</strong> <Link to="/family/elemental">Elemental</Link></p>
<Header full id="small-air-elemental"><span>Small Air Elemental</span><span>CR 1</span></Header>
<div className="reduce">
<Info source={[["Pathfinder RPG Bestiary",120]]} xp="400" n small outsider subs={["air","elemental","extraplanar"]} init={7} dv={60} pcp={4} />
<Defense ac={[17,14,14]} mod="+3 Dex, +3 natural, +1 size" hp={[13,"2d10+2"]} fort="+4" ref="+6" will="+0" def={[["air mastery","air mastery"]]} immune={<><Link to="/subtype/elemental">elemental</Link> traits</>} />
<Offense fl={100} flP="perfect" melee="slam +6 (1d4+1)" whirlwind="DC 12" />
<Stats atts={[12,17,12,4,11,11]} bab={2} cmb={2} cmd={15} feats={["Flyby Attack",["Improved Initiative",<sup>B</sup>],["Weapon Finesse",<sup>B</sup>]]} skills={{"acro":{"b":7},"ea":{"b":7},"fly":{"b":17},"k":{"p":1},"per":{"b":4},"stl":{"b":11}}} />
<p className="spells indented"><sup><strong>B</strong></sup> Bonus feat.</p>
<Header full id="medium-air-elemental"><span>Medium Air Elemental</span><span>CR 3</span></Header>
<Info source={[["Pathfinder RPG Bestiary",120]]} xp="800" n medium outsider subs={["air","elemental","extraplanar"]} init={9} dv={60} pcp={7} />
<Defense ac={[19,16,13]} mod="+5 Dex, +1 dodge, +3 natural" hp={[30,"4d10+8"]} fort="+6" ref="+9" will="+1" def={[["air mastery","air mastery"]]} immune={<><Link to="/subtype/elemental">elemental</Link> traits</>} />
<Offense fl={100} flP="perfect" melee="slam +9 (1d6+3)" whirlwind="DC 14" />
<Stats atts={[14,21,14,4,11,11]} bab={4} cmb={6} cmd={22} feats={["Dodge","Flyby Attack",["Improved Initiative",<sup>B</sup>],["Weapon Finesse",<sup>B</sup>]]} skills={{"acro":{"b":11},"ea":{"b":9},"fly":{"b":17},"k":{"p":1},"per":{"b":7},"stl":{"b":10}}} />
<p className="spells indented"><sup><strong>B</strong></sup> Bonus feat.</p>
...
<div className="reduce">
<Info source={[["Pathfinder RPG Bestiary",122]]} xp="400" n small outsider subs={["earth","elemental","extraplanar"]} init={-1} dv={60} tremorsense={60} pcp={4} />
<Defense ac={[17,10,17]} mod="-1 Dex, +7 natural, +1 size" hp={[13,"2d10+2"]} fort="+4" ref="-1" will="+3" immune="elemental traits" />
<Offense sp={20} br={20} spExtra="earth glide" melee="slam +6 (1d6+4)" specAtt={[["earth mastery","earth mastery"]]} />
<Stats atts={[16,8,13,4,11,11]} bab={2} cmb={4} cmd={13} feats={[["Improved Bull Rush",<sup>B</sup>],"Power Attack"]} skills={{"app":{"b":1},"climb":{"b":7},"k":{"d":1},"per":{"b":4},"stl":{"b":7}}} />
<p className="spells indented"><sup><strong>B</strong></sup> Bonus feat.</p>
<Ecology env={<>any (<Link to="/rule/plane_of_earth">Plane of Earth</Link>)</>} org="solitary, pair, or gang (3-8)" treasure={{"X":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<p><strong>Family:</strong> <Link to="/family/elemental">Elemental</Link></p>
<Header full id="medium-earth-elemental"><span>Medium Earth Elemental</span><span>CR 3</span></Header>
<div className="reduce">
<Info source={[["Pathfinder RPG Bestiary",122]]} xp="800" n medium outsider subs={["earth","elemental","extraplanar"]} init={-1} dv={60} tremorsense={60} pcp={7} />
<Defense ac={[18,9,18]} mod="-1 Dex, +9 natural" hp={[34,"4d10+12"]} fort="+7" ref="+0" will="+4" immune="elemental traits" />
<Offense sp={20} br={20} spExtra="earth glide" melee="slam +9 (1d8+7)" specAtt={[["earth mastery","earth mastery"]]} />
<Stats atts={[20,8,17,4,11,11]} bab={4} cmb={9} cmd={18} feats={["Cleave",["Improved Bull Rush",<sup>B</sup>],"Power Attack"]} skills={{"app":{"b":1},"climb":{"b":10},"k":{"d":2},"per":{"b":7},"stl":{"b":3}}} />
<p className="spells indented"><sup><strong>B</strong></sup> Bonus feat.</p>
...
<div className="reduce">
<Info source={[["Pathfinder RPG Bestiary",124]]} xp="400" n small outsider subs={["elemental","extraplanar","fire"]} init={5} dv={60} pcp={4} />
<Defense ac={[16,13,14]} mod="+1 Dex, +1 dodge, +3 natural, +1 size" hp={[11,"2d10"]} fort="+3" ref="+4" will="+0" immune="elemental traits, fire" weak={[<><Link to="/umr/vulnerable">vulnerable</Link> to cold</>]} />
<Offense sp={50} melee="slam +4 (1d4 plus burn)" burn="1d4, DC 11" />
<Stats atts={[10,13,10,4,11,11]} bab={2} cmb={1} cmd={13} feats={["Dodge",["Improved Initiative",<sup>B</sup>],["Weapon Finesse",<sup>B</sup>]]} skills={{"acro":{"b":5},"climb":{"b":4},"ea":{"b":5},"intm":{"b":4},"k":{"p":1},"per":{"b":4}}} />
<p className="spells indented"><sup><strong>B</strong></sup> Bonus feat.</p>
<Ecology env={<>any (<Link to="/rule/plane_of_fire">Plane of Fire</Link>)</>} org="solitary, pair, or gang (3-8)" treasure={{"X":false}} />
</div>
<Header sub>Description</Header>
...
<p><strong>Family:</strong> <Link to="/family/elemental">Elemental</Link></p>
<Header full id="medium-fire-elemental"><span>Medium Fire Elemental</span><span>CR 3</span></Header>
<div className="reduce">
<Info source={[["Pathfinder RPG Bestiary",124]]} xp="800" n medium outsider subs={["elemental","extraplanar","fire"]} init={7} dv={60} pcp={7} />
<Defense ac={[17,14,13]} mod="+3 Dex, +1 dodge, +3 natural" hp={[30,"4d10+8"]} fort="+6" ref="+7" will="+1" immune="elemental traits, fire" weak={[<><Link to="/umr/vulnerable">vulnerable</Link> to cold</>]} />
<Offense sp={50} melee="slam +7 (1d6+1 plus burn)" burn="1d6, DC 14" />
<Stats atts={[12,17,14,4,11,11]} bab={4} cmb={5} cmd={19} feats={["Dodge",["Improved Initiative",<sup>B</sup>],"Mobility",["Weapon Finesse",<sup>B</sup>]]} skills={{"acro":{"b":8},"climb":{"b":5},"ea":{"b":8},"intm":{"b":5},"k":{"p":1},"per":{"b":7}}} />
<p className="spells indented"><sup><strong>B</strong></sup> Bonus feat.</p>
...
<div className="reduce">
<Info source={[["Bestiary 2",114]]} xp="400" n small outsider subs={["air","cold","elemental","extraplanar","water"]} init={-1} sen={["snow vision"]} dv={60} pcp={5} />
<Defense ac={[16,10,16]} mod="-1 Dex, +6 natural, +1 size" hp={[13,"2d10+2"]} fort="+4" ref="+2" will="+0" immune="cold, elemental traits" weak={[<><Link to="/umr/vulnerable">vulnerable</Link> to fire</>]} />
<Offense sp={20} br={20} brP="ice and snow only" sw={60} melee="slam +4 (1d4+1 plus 1d3 cold)" specAtt={[["numbing cold DC 12","numbing cold (DC 12)"]]} />
<Stats atts={[12,8,13,4,11,11]} bab={2} cmb={2} cmd={11} cmdP="can't be tripped" feats={["Power Attack"]} skills={{"k":{"p":2},"per":{"b":5},"stl":{"b":8},"swim":{"b":9}}} sq="ice glide, icewalking" />
<Ecology env={<>any land or water (<Link to="/rule/plane_of_water">Plane of Water</Link>)</>} org="solitary, pair, or gang (3-8)" treasure={{"X":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<p><strong>Family:</strong> <Link to="/family/elemental">Elemental</Link></p>
<Header full id="medium-ice-elemental"><span>Medium Ice Elemental</span><span>CR 3</span></Header>
<div className="reduce">
<Info source={[["Bestiary 2",114]]} xp="800" n medium outsider subs={["air","cold","elemental","extraplanar","water"]} init={0} sen={["snow vision"]} dv={60} pcp={7} />
<Defense ac={[16,10,16]} mod="+6 natural" hp={[30,"4d10+8"]} fort="+6" ref="+4" will="+1" immune="cold, elemental traits" weak={[<><Link to="/umr/vulnerable">vulnerable</Link> to fire</>]} />
<Offense sp={20} br={20} brP="ice and snow only" sw={60} melee="slam +7 (1d6+4 plus 1d4 cold)" specAtt={[["numbing cold DC 14","numbing cold (DC 14)"]]} />
<Stats atts={[16,10,15,4,11,11]} bab={4} cmb={7} cmd={17} cmdP="can't be tripped" feats={["Cleave","Power Attack"]} skills={{"k":{"p":4},"per":{"b":7},"stl":{"b":7},"swim":{"b":11}}} sq="ice glide, icewalking" />
...
<div className="reduce">
<Info source={[["Bestiary 2",116]]} xp="400" n small outsider subs={["air","elemental","extraplanar"]} init={6} dv={60} pcp={5} />
<Defense ac={[14,13,12]} mod="+2 Dex, +1 natural, +1 size" hp={[11,"2d10"]} fort="+3" ref="+5" will="+0" immune="electricity, elemental traits" />
<Offense fl={100} flP="perfect" melee="slam +5 (1d4 plus 1d3 electricity)" specAtt={[["metal mastery","metal mastery"],["spark leap","spark leap"]]} />
<Stats atts={[10,15,10,4,11,11]} bab={2} cmb={1} cmd={13} feats={["Improved Initiative",["Weapon Finesse",<sup>B</sup>]]} skills={{"acro":{"b":7},"ea":{"b":6},"fly":{"b":12},"k":{"p":1},"per":{"b":5}}} />
<p className="spells indented"><sup><strong>B</strong></sup> Bonus feat.</p>
<Ecology env={<>any (<Link to="/rule/plane_of_air">Plane of Air</Link>)</>} org="solitary, pair, or gang (3-8)" treasure={{"X":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<p><strong>Family:</strong> <Link to="/family/elemental">Elemental</Link></p>
<Header full id="medium-lightning-elemental"><span>Medium Lightning Elemental</span><span>CR 3</span></Header>
<div className="reduce">
<Info source={[["Bestiary 2",116]]} xp="800" n medium outsider subs={["air","elemental","extraplanar"]} init={8} dv={60} pcp={7} />
<Defense ac={[16,15,11]} mod="+4 Dex, +1 dodge, +1 natural" hp={[26,"4d10+4"]} fort="+5" ref="+8" will="+1" immune="electricity, elemental traits" />
<Offense fl={100} flP="perfect" melee="slam +8 (1d6+3 plus 1d4 electricity)" specAtt={[["metal mastery","metal mastery"],["spark leap","spark leap"]]} />
<Stats atts={[14,19,12,4,11,11]} bab={4} cmb={6} cmd={21} feats={["Dodge","Improved Initiative",["Weapon Finesse",<sup>B</sup>]]} skills={{"acro":{"b":11},"ea":{"b":9},"fly":{"b":12},"k":{"p":2},"per":{"b":7}}} />
<p className="spells indented"><sup><strong>B</strong></sup> Bonus feat.</p>
...
<div className="reduce">
<Info source={[["Bestiary 2",118]]} xp="400" n small outsider subs={["earth","elemental","extraplanar","fire"]} init={3} dv={60} pcp={5} />
<Defense ac={[15,10,15]} mod="-1 Dex, +5 natural, +1 size" hp={[11,"2d10"]} fort="+3" ref="+2" will="+0" immune="fire, elemental traits" weak={[<><Link to="/umr/vulnerable">vulnerable</Link> to cold</>]} />
<Offense sp={20} br={20} spExtra="earth glide" melee="slam +3 (1d3 plus burn)" specAtt={[["lava puddle","lava puddle"]]} burn="1d4, DC 9" />
<Stats atts={[10,8,11,4,11,11]} bab={2} cmb={1} cmd={10} feats={["Improved Initiative"]} skills={{"k":{"d":2},"per":{"b":5},"stl":{"b":8}}} sq="earth glide" />
<Ecology env={<>any (<Link to="/rule/plane_of_fire">Plane of Fire</Link>)</>} org="solitary, pair, or gang (3-8)" treasure={{"X":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<p><strong>Family:</strong> <Link to="/family/elemental">Elemental</Link></p>
<Header full id="medium-magma-elemental"><span>Medium Magma Elemental</span><span>CR 3</span></Header>
<div className="reduce">
<Info source={[["Bestiary 2",118]]} xp="800" n medium outsider subs={["earth","elemental","extraplanar","fire"]} init={3} dv={60} pcp={7} />
<Defense ac={[16,9,16]} mod="-1 Dex, +7 natural" hp={[30,"4d10+8"]} fort="+6" ref="+3" will="+1" immune="fire, elemental traits" weak={[<><Link to="/umr/vulnerable">vulnerable</Link> to cold</>]} />
<Offense sp={20} br={20} spExtra="earth glide" melee="slam +6 (1d6+3 plus burn)" specAtt={[["lava puddle","lava puddle"]]} burn="1d4, DC 12" />
<Stats atts={[14,8,15,4,11,11]} bab={4} cmb={6} cmd={15} feats={["Improved Initiative","Power Attack"]} skills={{"k":{"d":4},"per":{"b":7},"stl":{"b":6}}} sq="earth glide" />
...
<div className="reduce">
<Info source={[["Bestiary 2",120]]} xp="400" n small outsider subs={["earth","elemental","extraplanar","water"]} init={-1} dv={60} tremorsense={30} pcp={5} />
<Defense ac={[16,10,16]} mod="-1 Dex, +6 natural, +1 size" hp={[13,"2d10+2"]} fort="+4" ref="+2" will="+0" immune="acid, elemental traits" />
<Offense sp={20} br={10} sw={30} spExtra="earth glide" melee="slam +5 (1d4+3 plus entrap)" entrap="DC 12, 10 minutes, hardness 5, hp 5" />
<Stats atts={[14,8,13,4,11,11]} bab={2} cmb={3} cmd={12} feats={["Improved Bull Rush","Power Attack"]} skills={{"climb":{"b":6}}} />
<Ecology env={<>any land or water (<Link to="/rule/plane_of_earth">Plane of Earth</Link>)</>} org="solitary, pair, or gang (3-8)" treasure={{"X":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<p><strong>Family:</strong> <Link to="/family/elemental">Elemental</Link></p>
<Header full id="medium-mud-elemental"><span>Medium Mud Elemental</span><span>CR 3</span></Header>
<div className="reduce">
<Info source={[["Bestiary 2",120]]} xp="800" n medium outsider subs={["earth","elemental","extraplanar","water"]} init={0} dv={60} tremorsense={30} pcp={7} />
<Defense ac={[16,10,16]} mod="+6 natural" hp={[30,"4d10+8"]} fort="+6" ref="+4" will="+1" immune="acid, elemental traits" />
<Offense sp={20} br={10} sw={30} spExtra="earth glide" melee="slam +7 (1d6+4 plus entrap)" entrap="DC 14, 10 minutes, hardness 5, hp 5" />
<Stats atts={[16,10,15,4,11,11]} bab={4} cmb={7} cmd={17} feats={["Cleave","Improved Bull Rush","Power Attack"]} skills={{"climb":{"b":8}}} />
...
<div className="reduce">
<Info source={[["Pathfinder RPG Bestiary",126]]} xp="400" n small outsider subs={["elemental","extraplanar","water"]} init={0} dv={60} pcp={4} />
<Defense ac={[17,11,17]} mod="+6 natural, +1 size" hp={[13,"2d10+2"]} fort="+4" ref="+3" will="+0" immune="elemental traits" />
<Offense sp={20} sw={90} melee="slam +5 (1d6+3)" specAtt={[["drench","drench"],["vortex DC 13","vortex (DC 13)"],["water mastery","water mastery"]]} />
<Stats atts={[14,10,13,4,11,11]} bab={2} cmb={3} cmd={13} feats={["Power Attack"]} skills={{"acro":{"b":4},"ea":{"b":4},"k":{"p":1},"per":{"b":4},"stl":{"b":8},"swim":{"b":14}}} />
<Ecology env={<>any (<Link to="/rule/plane_of_water">Plane of Water</Link>)</>} org="solitary, pair, or gang (3-8)" treasure={{"X":false}} />
</div>
<Header sub>Special Abilities</Header>
...
<p><strong>Family:</strong> <Link to="/family/elemental">Elemental</Link></p>
<Header full id="medium-water-elemental"><span>Medium Water Elemental</span><span>CR 3</span></Header>
<div className="reduce">
<Info source={[["Pathfinder RPG Bestiary",126]]} xp="800" n medium outsider subs={["elemental","extraplanar","water"]} init={1} dv={60} pcp={5} />
<Defense ac={[17,11,16]} mod="+1 Dex, +6 natural" hp={[30,"4d10+8"]} fort="+6" ref="+5" will="+1" immune="elemental traits" />
<Offense sp={20} sw={90} melee="slam +7 (1d8+4)" specAtt={[["drench","drench"],["vortex DC 15","vortex (DC 15)"],["water mastery","water mastery"]]} />
<Stats atts={[16,12,15,4,11,11]} bab={4} cmb={7} cmd={18} feats={["Cleave","Power Attack"]} skills={{"acro":{"b":6},"ea":{"b":6},"k":{"p":2},"per":{"b":5},"stl":{"b":6},"swim":{"b":16}}} />
...
<div className="reduce">
<Info source={[["Pathfinder #91: Battle of Bloodmarch Hills",54],["Tome of Horrors Complete (PF)",504]]} xp="400" n small undead init={3} dv={60} scent pcp={8} />
<Defense ac={[14,14,11]} mod="+3 Dex, +1 size" hp={[11,"2d8+2"]} fort="+1" ref="+3" will="+4" def={[["incorporeal form","incorporeal form"],["shadow blend","shadow blend"]]} immune={<Link to="/umr/undead_traits">undead traits</Link>} />
<Offense sp={40} cl={20} melee={<>bite +5 (1d4 plus 1d3 <Link to="/rule/strength_damage">Strength damage</Link> and disease)</>} />
<Stats atts={[10,17,0,2,12,13]} bab={1} cmb={0} cmd={13} cmdP="17 vs. trip" feats={[["Skill Focus"," (Perception)"],["Weapon Finesse",<sup>B</sup>]]} skills={{"climb":{"b":11},"per":{"b":8},"stl":{"b":15}}} racial="+4 Stealth; uses Dex to modify Climb" />
<p className="spells indented"><sup><strong>B</strong></sup> Bonus feat.</p>
<Ecology env="underground" org="solitary or pack (6-11)" treasure={{"X":false}} />
</div>
<Header sub>Special Abilities</Header>
