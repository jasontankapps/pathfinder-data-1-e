...
<Ability id="biokinetic-healing-su" icon={["aid"]}>
...
<Ability id="complex-countermeasures-ex" icon={["boost"]}>
...
<Ability id="conjured-armor-su" icon={["def"]}>
...
<Ability id="defensive-prognostication-su" icon={["def"]}>
...
<Ability id="dragons-breath-su" icon={["cone"]}>
...
<Ability id="focused-force-su" icon={["boost"]}>
...
<Ability id="intense-focus-ex" icon={["boost"]}>
...
<Ability id="minds-eye-su" icon={["boost"]}>
...
<Ability id="mindshield-su" icon={["def"]}>
...
<Ability id="mindtouch-su" icon={["magic"]}>
...
<Ability id="ongoing-defense-su" icon={["def"]}>
...
<Ability id="overpowering-mind-ex" icon={["boost"]}>
...
<Ability id="perfect-body-ex" icon={["def"]}>
...
<Ability id="phrenic-strike-su" icon={["melee","magic"]}>
...
<Ability id="psychic-defense-su" icon={["boost"]}>
...
<Ability id="psychofeedback-su" icon={["boost"]}>
...
<Ability id="relentless-casting-su" icon={["roll","boost"]}>
...
<Ability id="telempathic-restoration-su" icon={["aid","down"]}>
...
<Ability id="transfer-fear-su" icon={["aid"]}>
...
<Ability id="undercast-surge-su" icon={["boost"]}>
...
<Ability id="whisper-of-ancients-ex" icon={["boost"]}>
...
<Ability id="will-of-the-dead-su" icon={["boost"]}>
...
<Ability id="deflection-field-su" icon={["def"]}>
...
<Ability id="dispelling-pulse-su" icon={["lower"]}>
...
<Ability id="dual-amplification-ex" icon={["power"]}>
...
<Ability id="mimic-metamagic-ex" icon={["power","magic"]}>
...
<Ability id="space-rending-spell-su" icon={["magic"]}>
...
<Ability id="subordinate-spell-ex" icon={["magic"]}>
...
<Ability id="synaptic-shock-su" icon={["lower"]}>
...
<Ability id="telepathic-targeting-su" icon={["magic","boost"]}>
...
<Ability id="turning-shield-su" icon={["def"]}>
