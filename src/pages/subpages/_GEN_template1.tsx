...
const _accursed = {title: "Accursed", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Accursed</span><span>CR +1</span></p>
...
const _advanced = {title: "Advanced", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Advanced</span><span>CR +1</span></p>
...
const _aerial = {title: "Aerial", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Aerial</span><span>CR +0 or +1</span></p>
...
const _aggregate = {title: "Aggregate", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Aggregate</span><span>CR +1</span></p>
...
const _alchemically_invisible = {title: "Alchemically Invisible", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Alchemically Invisible</span><span>CR +2</span></p>
...
const _alebrije = {title: "Alebrije", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Alebrije</span><span>CR +2</span></p>
...
const _alter_ego = {title: "Alter Ego", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Alter Ego</span><span>CR +0</span></p>
...
const _animus_shade = {title: "Animus Shade", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Animus Shade</span><span>CR +2</span></p>
...
const _apostle_kyton = {title: "Apostle Kyton", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Apostle Kyton</span><span>CR +2</span></p>
...
const _aqueous = {title: "Aqueous", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Aqueous</span><span>CR +0 or +1</span></p>
...
const _barbarian = {title: "Barbarian", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Barbarian</span><span>CR +2 or +3</span></p>
...
const _bard = {title: "Bard", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Bard</span><span>CR +1 or +2</span></p>
<p><strong>Sources</strong> <Link to="/source/monster_codex">Monster Codex pg. 246</Link><br/><strong>Acquired/Inherited Template</strong> Acquired<br/><strong>Simple Template</strong> Yes<br/><strong>Usable with Summons</strong> No</p>
...
const _bestial_creature = {title: "Bestial Creature", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Bestial Creature</span><span>CR +0</span></p>
...
const _black_blooded = {title: "Black-Blooded", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Black-Blooded</span><span>CR +3</span></p>
...
const _blighted_fey = {title: "Blighted Fey", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Blighted Fey</span><span>CR +2</span></p>
...
const _boreal_creature = {title: "Boreal Creature", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Boreal Creature</span><span>CR +1</span></p>
...
const _broken_soul = {title: "Broken Soul", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Broken Soul</span><span>CR +2</span></p>
...
const _calcified = {title: "Calcified", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Calcified</span><span>CR +1</span></p>
...
const _celestial = {title: "Celestial", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Celestial</span><span>CR +0 or +1</span></p>
...
const _child_of_yog_sothoth = {title: "Child of Yog-Sothoth", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Child of Yog-Sothoth</span><span>CR +1</span></p>
...
const _chthonic = {title: "Chthonic", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Chthonic</span><span>CR +0 or +1</span></p>
<p><strong>Sources</strong> <Link to="/source/monster_summoners_handbook">Monster Summoner's Handbook pg. 19</Link><br/><strong>Acquired/Inherited Template</strong> Acquired<br/><strong>Simple Template</strong> Yes<br/><strong>Usable with Summons</strong> See Text</p>
<p>Applying this template to a summoned creature requires the feat <Link to="/feat/versatile_summon_monster">Versatile Summon Monster</Link> or <Link to="/feat/versatile_summon_natures_ally">Versatile Summon Nature's Ally</Link>.</p>
...
const _cleric = {title: "Cleric", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Cleric</span><span>CR +1, +2, or +3</span></p>
<p><strong>Sources</strong> <Link to="/source/monster_codex">Monster Codex pg. 246</Link><br/><strong>Acquired/Inherited Template</strong> Acquired<br/><strong>Simple Template</strong> Yes<br/><strong>Usable with Summons</strong> No</p>
...
const _colour_blighted = {title: "Colour-Blighted", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Colour-Blighted</span><span>CR +0</span></p>
...
const _commando_construct = {title: "Commando Construct", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Commando Construct</span><span>CR +1 or +2</span></p>
...
const _counterpoised = {title: "Counterpoised", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Counterpoised</span><span>CR +0 to +1</span></p>
...
const _cursed_lord = {title: "Cursed Lord", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Cursed Lord</span><span>CR +2</span></p>
...
const _cytillesh_zombie = {title: "Cytillesh Zombie", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Cytillesh Zombie</span><span>CR +1</span></p>
...
const _dark = {title: "Dark", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Dark</span><span>CR +0 or +1</span></p>
<p><strong>Sources</strong> <Link to="/source/monster_summoners_handbook">Monster Summoner's Handbook pg. 19</Link><br/><strong>Acquired/Inherited Template</strong> Acquired<br/><strong>Simple Template</strong> Yes<br/><strong>Usable with Summons</strong> See Text</p>
...
const _deep_creature = {title: "Deep Creature", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Deep Creature</span><span>CR +1</span></p>
<p><strong>Sources</strong> <Link to="/source/horror_adventures">Horror Adventures pg. 248</Link><br/><strong>Acquired/Inherited Template</strong> Acquired<br/><strong>Simple Template</strong> Yes<br/><strong>Usable with Summons</strong> No</p>
...
const _degenerate = {title: "Degenerate", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Degenerate</span><span>CR -1</span></p>
...
const _demonic_vermin = {title: "Demonic Vermin", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Demonic Vermin</span><span>CR +1</span></p>
...
const _devilbound = {title: "Devilbound", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Devilbound</span><span>CR +1</span></p>
...
const _divine_guardian = {title: "Divine Guardian", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Divine Guardian</span><span>CR +1</span></p>
...
const _dread_lord = {title: "Dread Lord", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Dread Lord</span><span>CR +1</span></p>
...
const _dream_eater = {title: "Dream Eater", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Dream Eater</span><span>CR +2</span></p>
...
const _dreamspawn = {title: "Dreamspawn", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Dreamspawn</span><span>CR +1</span></p>
...
const _druid = {title: "Druid", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Druid</span><span>CR +1, +2, or +3</span></p>
...
const _echohusk = {title: "Echohusk", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Echohusk</span><span>CR Varies</span></p>
...
const _ectoplasmic = {title: "Ectoplasmic", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Ectoplasmic</span><span>CR +1</span></p>
...
const _elemental_infused_creature = {title: "Elemental-Infused Creature", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Elemental-Infused Creature</span><span>CR +1 or +2</span></p>
...
const _energized = {title: "Energized", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Energized</span><span>CR +2</span></p>
...
const _enlightened_construct = {title: "Enlightened Construct", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Enlightened Construct</span><span>CR +1, +2, or +3</span></p>
...
const _entropic = {title: "Entropic", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Entropic</span><span>CR +0 or +1</span></p>
...
const _eruphyte = {title: "Eruphyte", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Eruphyte</span><span>CR +1</span></p>
...
const _failed_prophet = {title: "Failed Prophet", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Failed Prophet</span><span>CR +2</span></p>
...
const _fey_animal = {title: "Fey Animal", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Fey Animal</span><span>CR +1</span></p>
...
const _fey_creature = {title: "Fey Creature", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Fey Creature</span><span>CR +1 or +2</span></p>
...
const _fey_touched_creature = {title: "Fey-Touched Creature", jsx: <><div style={{clear:"both"}}></div><p className="statblockHeaderFull"><span>Fey-Touched Creature</span><span>CR +0 or +1</span></p>
