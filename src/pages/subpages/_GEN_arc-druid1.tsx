...
<Ability id="community-bond-ex" icon={["info"]}>
<Pair single id="community-bond-ex">Community Bond (Ex)</Pair>
<Pair hl title="Alters">Nature bond</Pair>
...
<Ability id="devolved-companion-ex" icon={["info"]}>
<Pair single id="devolved-companion-ex">Devolved Companion (Ex)</Pair>
<Pair hl title="Alters">Nature bond</Pair>
...
<Ability id="natures-bond-ex" icon={["info"]}>
<Pair single id="natures-bond-ex">Nature's Bond (Ex)</Pair>
<Pair hl title="Alters">Nature's bond</Pair>
...
<Pair title="Special"><p><a href="https://paizo.com/paizo/faq/v5748nruor1fn#v5748eaic9raj" data-outgoing>From the FAQ</a>: The lack of suitable giant bird stat blocks in official Paizo products hinders the rules options for this archetype.</p>
...
<Ability id="devotion-to-ascension-ex" icon={["info"]}>
<Pair single id="devotion-to-ascension-ex">Devotion to Ascension (Ex)</Pair>
<Pair hl title="Alters">Nature bond</Pair>
...
<Ability id="primal-bond-ex" icon={["info"]}>
