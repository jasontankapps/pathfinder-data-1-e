...
<Ability id="weapon-and-armor-proficiency" icon={["down","magic"]}>
...
<Ability id="tea-ceremony-su" icon={["boost"]}>
...
<Ability id="geisha-knowledge" icon={["boost"]}>
...
<Ability id="called-favor-ex" icon={["power"]}>
...
<Ability id="informed-persuasion-ex" icon={["boost"]}>
...
<Ability id="master-of-manipulation-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="counterfeiter-ex" icon={["boost"]}>
...
<Ability id="bardic-performance-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="bad-deal-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="buyer-beware-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="personal-guarantee-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="curse-breaker-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="misery-ex" icon={["boost"]}>
...
<Ability id="versed-in-curses-ex" icon={["def"]}>
...
<Ability id="curse-crafter-ex" icon={["power","magic"]}>
...
<Ability id="chant-of-perfect-recall-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="song-of-subterfuge-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="unbroken-stride-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="cryptic-whisper-ex" icon={["boost","def"]}>
...
<Ability id="fast-reactions-ex" icon={["power"]}>
...
<Ability id="combat-juggling-ex" icon={["power"]}>
...
<Ability id="enrapturing-performance-su" icon={["power"]}>
...
<Ability id="fey-secrets" icon={["boost"]}>
...
<Ability id="luring-presentation-ex" icon={["lower","down"]}>
...
<Ability id="charming-melody-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="deadly-lure-sp" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="fey-wounding-song-sp" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="pipers-attention-ex" icon={["def","roll"]}>
...
<Ability id="dweomercraft-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="spell-suppression-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="metamagic-mastery-ex" extraClasses="subAbility" icon={["magic","boost"]}>
...
<Ability id="magical-talent-ex" icon={["boost"]}>
...
<Ability id="extended-performance-su" icon={["boost"]}>
...
<Ability id="expanded-repertoire-ex" icon={["learn"]}>
...
<Ability id="arcane-bond-ex" extraClasses="hasSubs" icon={["boost"]}>
...
<Ability id="arcane-bond-bonded-object" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="wand-mastery-ex" icon={["boost"]}>
...
<Ability id="dual-identity-ex" icon={["power"]}>
...
<Ability id="seamless-guise-ex" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="exaggerated-pose-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="stage-combat-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="multiplicity-of-masks-su" extraClasses="subAbility" icon={["magic","aura"]}>
...
<Ability id="social-grace-ex" icon={["power"]}>
...
<Ability id="masked-talents" icon={["power"]}>
...
<Ability id="eschew-materials-ex" icon={["power"]}>
...
<Ability id="symphony-of-silence-su" extraClasses="subAbility" icon={["aura","protect"]}>
...
<Ability id="maddening-harmonics-su" extraClasses="subAbility" icon={["aura","lower"]}>
...
<Ability id="ceaseless-performance-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="song-of-the-conjunction-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="insights-from-beyond-ex" icon={["learn"]}>
...
<Ability id="dulled-horror-ex" icon={["def"]}>
...
<Ability id="eldritch-caesura-su" icon={["boost"]}>
...
<Ability id="ex-mute-musicians" icon={["warning"]}>
...
<Ability id="hard-bargainer" icon={["boost"]}>
...
<Ability id="counterargument-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="fast-talk-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="binding-contract-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="master-of-rhetoric-ex" icon={["power"]}>
...
<Ability id="phrenological-knowledge-ex" icon={["power","boost"]}>
...
<Ability id="skull-versed-ex" icon={["lower"]}>
...
<Ability id="phrenological-savant" icon={["boost"]}>
...
<Ability id="in-your-head-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="fingers-of-fascination-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="focused-performance-ex" icon={["power"]}>
...
<Ability id="leshy-speaker-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="plant-speech" icon={["boost","power"]}>
...
<Ability id="mystical-allegory-su" icon={["power","magic"]}>
...
<Ability id="mock-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="punchline-sp" extraClasses="subAbility" icon={["power","magic"]}>
...
<Ability id="mass-punchline-sp" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="provocateur-ex" icon={["boost"]}>
...
<Ability id="calumny-ex" icon={["power"]}>
...
<Ability id="damning-performance-su" icon={["power"]}>
...
<Ability id="cunning-plan-su" icon={["boost"]}>
...
<Ability id="never-lose-face-ex" icon={["def"]}>
...
<Ability id="sinister-mien-ex" icon={["power","boost"]}>
...
<Ability id="countless-contingencies-su" icon={["power"]}>
...
<Ability id="inspire-competence-su" icon={["boost"]}>
...
<Ability id="inspired-plan-su" icon={["boost"]}>
...
<Ability id="hidden-plans-ex" icon={["def"]}>
...
<Ability id="prepared-ex" icon={["power"]}>
...
<Ability id="stealspell-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="slumber-song-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="dramatic-subtext-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="greater-stealspell-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="mass-slumber-song-sp" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="spell-catching-su" extraClasses="subAbility" icon={["def","magic"]}>
...
<Ability id="master-of-deception-ex" icon={["boost","power"]}>
...
<Ability id="sneakspell-ex" icon={["boost"]}>
...
<Pair hl title="Replaces">Inspire competence</Pair>
<Pair title="Gained">At 3rd Level</Pair>
<Pair title="Passive Ability">A sandman gains a bonus on Reflex saves against traps and a dodge bonus to AC against traps. <Bonus m c="bard" n={3} pl link={false} />.</Pair>
</Ability>
...
<Ability id="inspiring-blow-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="incite-rage-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="song-of-the-fallen-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="berserkergang-ex" extraClasses="subAbility" icon={["protect"]}>
...
<Ability id="battle-song-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="sea-shanty-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="still-water-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="whistle-the-wind-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="call-the-storm-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="world-traveler-ex" icon={["boost","roll"]}>
...
<Ability id="sea-legs-ex" icon={["def"]}>
...
<Ability id="shadow-servant-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="shadow-puppets-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="break-curse-su" extraClasses="subAbility" icon={["protect"]}>
...
<Ability id="holy-vibration-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="mass-break-curse-su" extraClasses="subAbility" icon={["protect"]}>
...
<Ability id="pure-heart-ex" icon={["def"]}>
...
<Ability id="silver-mastery-su" icon={["boost"]}>
...
<Ability id="learned-physician-ex" icon={["boost","power"]}>
...
<Ability id="inspire-tenacity-su" icon={["protect"]}>
...
<Ability id="creative-treatment-su" icon={["roll","power"]}>
...
<Ability id="invigorating-artistry-su" icon={["protect"]}>
...
<Ability id="enhance-healing-su" icon={["boost"]}>
...
<Ability id="healing-performance-su" extraClasses="subAbility" icon={["magic","aid"]}>
...
<Ability id="funereal-ballad-su" extraClasses="subAbility" icon={["magic","aid"]}>
...
<Ability id="lyric-sorrow-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="inspire-courage" extraClasses="subAbility" icon={["def","boost"]}>
...
<Ability id="inspire-greatness" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="inspire-heroics" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="darkness-denied-ex" icon={["def"]}>
...
<Ability id="spurn-harm-su" icon={["def"]}>
...
<Ability id="wordstrike-su" extraClasses="subAbility" icon={["zap"]}>
...
<Ability id="weird-words-su" extraClasses="subAbility" icon={["zap"]}>
...
<Ability id="corpse-speaker-su" icon={["magic"]}>
...
<Ability id="keen-ritualist-ex" icon={["magic","boost"]}>
...
<Ability id="earth-magic" icon={["power","learn"]}>
...
<Ability id="stone-song-su" icon={["power"]}>
...
<Ability id="tremor-su" icon={["power","lower"]}>
...
<Ability id="disappearing-act-su" extraClasses="subAbility" icon={["power","aura"]}>
...
<Ability id="harmless-performer-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="madcap-prank-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="slip-through-the-crowd-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="gladhanding" icon={["boost"]}>
...
<Ability id="streetwise" icon={["boost"]}>
...
<Ability id="quick-change-ex" icon={["power"]}>
...
<Ability id="critical-research-focus-ex" icon={["boost"]}>
...
<Ability id="perfect-recollection-ex" icon={["boost"]}>
...
<Ability id="one-with-the-library-ex" icon={["learn"]}>
...
<Ability id="bound-to-the-land-ex" icon={["boost"]}>
...
<Ability id="thunder-call-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="incite-rage-su" extraClasses="subAbility" icon={["magic","aura"]}>
<Pair single id="incite-rage-su">Incite Rage (Su)</Pair>
<Pair hl title="Replaces">Suggestion, mass suggestion</Pair>
...
<Ability id="call-lightning-su" extraClasses="subAbility" icon={["zap"]}>
...
<Ability id="call-lightning-storm-su" extraClasses="subAbility" icon={["zap"]}>
...
<Ability id="brighs-knowledge-ex" icon={["boost","power"]}>
...
<Ability id="brighs-soothing-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="brighs-anger-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="brighs-spark-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="brighs-wrath-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="wild-knowledge-ex" icon={["boost","power"]}>
...
<Ability id="nature-magic" icon={["learn"]}>
...
<Ability id="song-of-the-wild-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="wasteland-knowledge-ex" icon={["boost"]}>
...
<Ability id="wasteland-specialist-ex" icon={["power"]}>
...
<Ability id="watersong-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="waterstrike-su" extraClasses="subAbility" icon={["melee"]}>
...
<Ability id="lifewater-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="watersinger-spells" icon={["learn"]}>
...
<Ability id="way-with-words-ex" icon={["boost"]}>
<Pair single id="way-with-words-ex">Way with Words (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
<Pair title="Passive Ability">A wit gains a bonus on Bluff, Diplomacy, Intimidate, Linguistics, and Sense Motive checks. <Bonus m c="bard" n={4} link={false} p={1} />. He also gains a number of edges at the beginning of any <Link to="/rule/verbal_duels">verbal duel</Link> equal to this bonus.</Pair>
</Ability>
<Ability id="counterargument" icon={["down"]}>
...
<Ability id="cutting-remark-su" extraClasses="subAbility" icon={["zap"]}>
...
<Ability id="quick-witted-ex" icon={["power","boost"]}>
...
<Ability id="on-the-ball-ex" icon={["roll"]}>
...
<Ability id="duel-master-ex" icon={["boost"]}>
