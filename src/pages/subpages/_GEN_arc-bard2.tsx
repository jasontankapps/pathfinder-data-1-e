...
<Ability id="weapon-and-armor-proficiency" icon={["broken-shield","magic-swirl"]}>
...
<Ability id="tea-ceremony-su" icon={["upgrade"]}>
<Pair single id="tea-ceremony-su">Tea Ceremony (Su)</Pair>
...
<Ability id="geisha-knowledge" icon={["upgrade"]}>
<Pair single id="geisha-knowledge">Geisha Knowledge</Pair>
...
<Ability id="informed-persuasion-ex" icon={["upgrade"]}>
<Pair single id="informed-persuasion-ex" flavor="A Hatharat agent uses his knowledge of a target to increase his persuasiveness.">Informed Persuasion (Ex)</Pair>
...
<Ability id="master-of-manipulation-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="master-of-manipulation-su" flavor="A Hatharat agent gains a reputation of being able to sense lies.">Master of Manipulation (Su)</Pair>
...
<Ability id="counterfeiter-ex" icon={["upgrade"]}>
<Pair single id="counterfeiter-ex">Counterfeiter (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="bardic-performance-su" extraClasses="hasSubs" icon={["stairs-goal"]}>
...
<Ability id="bad-deal-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="bad-deal-su" flavor="A hoaxer can use his performance to coax a bit of luck (good or bad) into a valuable-seeming object.">Bad Deal (Su)</Pair>
...
<Ability id="buyer-beware-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="buyer-beware-su">Buyer Beware (Su)</Pair>
...
<Ability id="personal-guarantee-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="personal-guarantee-su">Personal Guarantee (Su)</Pair>
...
<Ability id="curse-breaker-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="curse-breaker-su">Curse Breaker (Su)</Pair>
...
<Ability id="misery-ex" icon={["upgrade"]}>
<Pair single id="misery-ex" flavor="A hoaxer learns to take joy in the misfortune of others.">Misery (Ex)</Pair>
...
<Ability id="versed-in-curses-ex" icon={["armor-upgrade"]}>
<Pair single id="versed-in-curses-ex">Versed in Curses (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="curse-crafter-ex" icon={["stairs-goal","magic-swirl"]}>
<Pair single id="curse-crafter-ex">Curse Crafter (Ex)</Pair>
...
<Ability id="bardic-performance-su" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="bardic-performance-su">Bardic Performance (Su)</Pair>
<Pair title="Info">An impervious messenger gains the following types of bardic performances.</Pair>
</Ability>
<Ability id="chant-of-perfect-recall-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="chant-of-perfect-recall-su">Chant of Perfect Recall (Su)</Pair>
...
<Ability id="song-of-subterfuge-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="song-of-subterfuge-su">Song of Subterfuge (Su)</Pair>
...
<Ability id="unbroken-stride-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="unbroken-stride-su">Unbroken Stride (Su)</Pair>
...
<Ability id="cryptic-whisper-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="cryptic-whisper-ex" flavor="The impervious messenger internalizes his understanding of language and ciphers, and filters them through his bardic abilities.">Cryptic Whisper (Ex)</Pair>
...
<Ability id="weapon-and-armor-proficiencies" icon={["info"]}>
...
<Ability id="fast-reactions-ex" icon={["stairs-goal"]}>
<Pair single id="fast-reactions-ex">Fast Reactions (Ex)</Pair>
...
<Ability id="combat-juggling-ex" icon={["stairs-goal"]}>
<Pair single id="combat-juggling-ex">Combat Juggling (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="luring-presentation-ex" icon={["armor-downgrade","broken-shield"]}>
<Pair single id="luring-presentation-ex">Luring Presentation (Ex)</Pair>
...
<Ability id="charming-melody-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="charming-melody-su">Charming Melody (Su)</Pair>
...
<Ability id="deadly-lure-sp" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="deadly-lure-sp">Deadly Lure (Sp)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="fey-wounding-song-sp" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="fey-wounding-song-sp">Fey-Wounding Song (Sp)</Pair>
...
<Ability id="pipers-attention-ex" icon={["armor-upgrade","rolling-dices"]}>
<Pair single id="pipers-attention-ex">Piper's Attention (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="dweomercraft-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="dweomercraft-su">Dweomercraft (Su)</Pair>
...
<Ability id="spell-suppression-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="spell-suppression-su" flavor="A magician can use performance to counter the spells of his foes.">Spell Suppression (Su)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="metamagic-mastery-ex" extraClasses="subAbility" icon={["magic-swirl","upgrade"]}>
<Pair single id="metamagic-mastery-ex">Metamagic Mastery (Ex)</Pair>
...
<Ability id="magical-talent-ex" icon={["upgrade"]}>
<Pair single id="magical-talent-ex">Magical Talent (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="extended-performance-su" icon={["upgrade"]}>
<Pair single id="extended-performance-su">Extended Performance (Su)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="expanded-repertoire-ex" icon={["spell-book"]}>
<Pair single id="expanded-repertoire-ex">Expanded Repertoire (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
...
<Ability id="arcane-bond-ex" extraClasses="hasSubs" icon={["upgrade"]}>
...
<Ability id="wand-mastery-ex" icon={["upgrade"]}>
<Pair single id="wand-mastery-ex">Wand Mastery (Ex)</Pair>
...
<Ability id="dual-identity-ex" icon={["stairs-goal"]}>
...
<Ability id="seamless-guise-ex" extraClasses="subAbility" icon={["stairs-goal","upgrade"]}>
<Pair single id="seamless-guise-ex">Seamless Guise (Ex)</Pair>
<Pair hl title="Replaces">Countersong</Pair>
...
<Ability id="exaggerated-pose-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="exaggerated-pose-su">Exaggerated Pose (Su)</Pair>
...
<Ability id="stage-combat-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="stage-combat-su">Stage Combat (Su)</Pair>
...
<Ability id="multiplicity-of-masks-su" extraClasses="subAbility" icon={["magic-swirl","aura"]}>
<Pair single id="multiplicity-of-masks-su">Multiplicity of Masks (Su)</Pair>
...
<Ability id="social-grace-ex" icon={["stairs-goal"]}>
...
<Ability id="masked-talents" icon={["stairs-goal"]}>
<Pair single id="masked-talents">Masked Talents</Pair>
<Pair hl title="Replaces">Lore master</Pair>
...
<Ability id="mute-ex" icon={["broken-shield"]}>
<Pair single id="mute-ex">Mute (Ex)</Pair>
...
<Ability id="eschew-materials-ex" icon={["stairs-goal"]}>
<Pair single id="eschew-materials-ex">Eschew Materials (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="symphony-of-silence-su" extraClasses="subAbility" icon={["aura","shield-reflect"]}>
<Pair single id="symphony-of-silence-su">Symphony of Silence (Su)</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="maddening-harmonics-su" extraClasses="subAbility" icon={["aura","armor-downgrade"]}>
<Pair single id="maddening-harmonics-su">Maddening Harmonics (Su)</Pair>
<Pair hl title="Replaces">Frightening tune</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="ceaseless-performance-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="ceaseless-performance-su">Ceaseless Performance (Su)</Pair>
...
<Ability id="song-of-the-conjunction-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="song-of-the-conjunction-su">Song of the Conjunction (Su)</Pair>
<Pair hl title="Replaces">Mass suggestion</Pair>
<Pair title="Gained">At 18th Level</Pair>
...
<Ability id="insights-from-beyond-ex" icon={["spell-book"]}>
<Pair single id="insights-from-beyond-ex">Insights from Beyond (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="dulled-horror-ex" icon={["armor-upgrade"]}>
<Pair single id="dulled-horror-ex">Dulled Horror (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="eldritch-caesura-su" icon={["upgrade"]}>
<Pair single id="eldritch-caesura-su">Eldritch Caesura (Su)</Pair>
<Pair hl title="Replaces">Jack-of-all-trades</Pair>
...
<Ability id="ex-mute-musicians" icon={["hazard-sign"]}>
<Pair single id="ex-mute-musicians">Ex-Mute Musicians</Pair>
...
<Ability id="hard-bargainer" icon={["upgrade"]}>
<Pair single id="hard-bargainer">Hard Bargainer</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="counterargument-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="counterargument-su">Counterargument (Su)</Pair>
...
<Ability id="fast-talk-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="fast-talk-su">Fast Talk (Su)</Pair>
<Pair hl title="Replaces">Inspire courage</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="binding-contract-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="binding-contract-sp">Binding Contract (Sp)</Pair>
<Pair hl title="Replaces">Inspire greatness</Pair>
...
<Ability id="master-of-rhetoric-ex" icon={["stairs-goal"]}>
<Pair single id="master-of-rhetoric-ex">Master of Rhetoric (Ex)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="phrenological-knowledge-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="phrenological-knowledge-ex">Phrenological Knowledge (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="skull-versed-ex" icon={["armor-downgrade"]}>
<Pair single id="skull-versed-ex">Skull-Versed (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="phrenological-savant" icon={["upgrade"]}>
<Pair single id="phrenological-savant">Phrenological Savant</Pair>
<Pair hl title="Replaces">Jack-of-all-trades</Pair>
<Pair title="Gained">At 10th Level</Pair>
...
<Ability id="skull-sonata-su" extraClasses="subAbility" icon={["aura"]}>
<Pair single id="skull-sonata-su">Skull Sonata (Su)</Pair>
<Pair hl title="Replaces">Inspire courage</Pair>
...
<Ability id="in-your-head-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="in-your-head-sp">In Your Head (Sp)</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
...
<Ability id="fingers-of-fascination-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="fingers-of-fascination-su">Fingers of Fascination (Su)</Pair>
<Pair hl title="Alters">Fascinate</Pair>
...
<Ability id="focused-performance-ex" icon={["stairs-goal"]}>
<Pair single id="focused-performance-ex">Focused Performance (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="leshy-speaker-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="leshy-speaker-su">Leshy Speaker (Su)</Pair>
<Pair hl title="Replaces">Inspire greatness</Pair>
...
<Ability id="plant-speech" icon={["upgrade","stairs-goal"]}>
<Pair single id="plant-speech">Plant Speech</Pair>
<Pair hl title="Replaces">Bardic knowledge, well-versed</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="mystical-allegory-su" icon={["stairs-goal","magic-swirl"]}>
<Pair single id="mystical-allegory-su">Mystical Allegory (Su)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
...
<Ability id="mock-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="mock-su">Mock (Su)</Pair>
<Pair hl title="Replaces">Fascinate</Pair>
...
<Ability id="punchline-sp" extraClasses="subAbility" icon={["stairs-goal","magic-swirl"]}>
<Pair single id="punchline-sp">Punchline (Sp)</Pair>
<Pair hl title="Replaces">Suggestion</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="mass-punchline-sp" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="mass-punchline-sp">Mass Punchline (Sp)</Pair>
<Pair hl title="Replaces">Mass suggestion</Pair>
<Pair title="Gained">At 18th Level</Pair>
...
<Ability id="swap-ex" icon={["stairs-goal"]}>
<Pair single id="swap-ex">Swap (Ex)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
...
<Ability id="provocateur-ex" icon={["upgrade"]}>
<Pair single id="provocateur-ex">Provocateur (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="calumny-ex" icon={["stairs-goal"]}>
<Pair single id="calumny-ex">Calumny (Ex)</Pair>
...
<Ability id="damning-performance-su" icon={["stairs-goal"]}>
<Pair single id="damning-performance-su">Damning Performance (Su)</Pair>
<Pair hl title="Replaces">Suggestion, mass suggestion</Pair>
...
<Ability id="cunning-plan-su" icon={["upgrade"]}>
<Pair single id="cunning-plan-su">Cunning Plan (Su)</Pair>
<Pair hl title="Alters">Bardic performance</Pair>
...
<Ability id="never-lose-face-ex" icon={["armor-upgrade"]}>
<Pair single id="never-lose-face-ex">Never Lose Face (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="sinister-mien-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="sinister-mien-ex">Sinister Mien (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
...
<Ability id="countless-contingencies-su" icon={["stairs-goal"]}>
<Pair single id="countless-contingencies-su">Countless Contingencies (Su)</Pair>
...
<Ability id="hidden-plans-ex" icon={["armor-upgrade"]}>
<Pair single id="hidden-plans-ex">Hidden Plans (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="prepared-ex" icon={["stairs-goal"]}>
<Pair single id="prepared-ex">Prepared (Ex)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="stealspell-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="stealspell-su">Stealspell (Su)</Pair>
<Pair hl title="Replaces">Inspire courage</Pair>
...
<Ability id="slumber-song-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="slumber-song-sp">Slumber Song (Sp)</Pair>
<Pair hl title="Replaces">Suggestion</Pair>
...
<Ability id="dramatic-subtext-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="dramatic-subtext-su">Dramatic Subtext (Su)</Pair>
<Pair hl title="Replaces">Inspire greatness</Pair>
...
<Ability id="greater-stealspell-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="greater-stealspell-su">Greater Stealspell (Su)</Pair>
<Pair hl title="Replaces">Inspire heroics</Pair>
...
<Ability id="mass-slumber-song-sp" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="mass-slumber-song-sp">Mass Slumber Song (Sp)</Pair>
<Pair hl title="Replaces">Mass suggestion</Pair>
...
<Ability id="spell-catching-su" extraClasses="subAbility" icon={["armor-upgrade","magic-swirl"]}>
<Pair single id="spell-catching-su">Spell Catching (Su)</Pair>
...
<Ability id="master-of-deception-ex" icon={["upgrade","stairs-goal"]}>
<Pair single id="master-of-deception-ex">Master of Deception (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="sneakspell-ex" icon={["upgrade"]}>
<Pair single id="sneakspell-ex">Sneakspell (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
...
<Ability id="inspiring-blow-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="inspiring-blow-su" flavor="A savage skald roars his war-cries with each telling blow.">Inspiring Blow (Su)</Pair>
<Pair hl title="Replaces">Fascinate</Pair>
...
<Ability id="incite-rage-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="incite-rage-su">Incite Rage (Su)</Pair>
<Pair hl title="Replaces">Suggestion</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="song-of-the-fallen-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="song-of-the-fallen-sp">Song of the Fallen (Sp)</Pair>
<Pair hl title="Replaces">Jack of all trades</Pair>
...
<Ability id="berserkergang-ex" extraClasses="subAbility" icon={["shield-reflect"]}>
<Pair single id="berserkergang-ex">Berserkergang (Ex)</Pair>
<Pair hl title="Replaces">Soothing performance</Pair>
...
<Ability id="battle-song-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="battle-song-su">Battle Song (Su)</Pair>
<Pair hl title="Replaces">Mass suggestion</Pair>
...
<Ability id="sea-shanty-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="sea-shanty-su">Sea Shanty (Su)</Pair>
<Pair hl title="Replaces">Countersong</Pair>
...
<Ability id="still-water-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="still-water-su">Still Water (Su)</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
...
<Ability id="whistle-the-wind-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="whistle-the-wind-su">Whistle the Wind (Su)</Pair>
<Pair hl title="Replaces">Suggestion</Pair>
...
<Ability id="call-the-storm-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="call-the-storm-su">Call the Storm (Su)</Pair>
<Pair hl title="Replaces">Mass suggestion</Pair>
...
<Ability id="world-traveler-ex" icon={["upgrade","rolling-dices"]}>
<Pair single id="world-traveler-ex">World Traveler (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="sea-legs-ex" icon={["armor-upgrade"]}>
...
<Ability id="shadow-servant-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="shadow-servant-sp">Shadow Servant (Sp)</Pair>
...
<Ability id="shadow-puppets-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="shadow-puppets-sp">Shadow Puppets (Sp)</Pair>
...
<Ability id="break-curse-su" extraClasses="subAbility" icon={["shield-reflect"]}>
<Pair single id="break-curse-su">Break Curse (Su)</Pair>
<Pair hl title="Replaces">Suggestion</Pair>
...
<Ability id="holy-vibration-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="holy-vibration-su">Holy Vibration (Su)</Pair>
<Pair hl title="Replaces">Inspire greatness</Pair>
...
<Ability id="mass-break-curse-su" extraClasses="subAbility" icon={["shield-reflect"]}>
<Pair single id="mass-break-curse-su">Mass Break Curse (Su)</Pair>
<Pair hl title="Replaces">Mass suggestion</Pair>
...
<Ability id="pure-heart-ex" icon={["armor-upgrade"]}>
<Pair single id="pure-heart-ex">Pure Heart (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="silver-mastery-su" icon={["upgrade"]}>
<Pair single id="silver-mastery-su">Silver Mastery (Su)</Pair>
...
<Pair single id="learned-physician-ex">Learned Physician (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge, lore master</Pair>
...
<Ability id="inspire-tenacity-su" icon={["shield-reflect"]}>
<Pair single id="inspire-tenacity-su">Inspire Tenacity (Su)</Pair>
<Pair hl title="Replaces">Countersong</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="creative-treatment-su" icon={["rolling-dices","stairs-goal"]}>
<Pair single id="creative-treatment-su">Creative Treatment (Su)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="invigorating-artistry-su" icon={["shield-reflect"]}>
<Pair single id="invigorating-artistry-su" flavor="A solacer can use his performances to protect and heal a target's soul.">Invigorating Artistry (Su)</Pair>
<Pair hl title="Replaces">Jack-of-all-trades</Pair>
<Pair title="Gained">At 10th Level</Pair>
...
<Ability id="enhance-healing-su" icon={["upgrade"]}>
<Pair single id="enhance-healing-su">Enhance Healing (Su)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
...
<Ability id="healing-performance-su" extraClasses="subAbility" icon={["magic-swirl","remedy"]}>
<Pair single id="healing-performance-su">Healing Performance (Su)</Pair>
<Pair hl title="Replaces">Frightening tune</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="funereal-ballad-su" extraClasses="subAbility" icon={["magic-swirl","remedy"]}>
<Pair single id="funereal-ballad-su">Funereal Ballad (Su)</Pair>
<Pair hl title="Replaces">Deadly performance</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="lyric-sorrow-su" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="lyric-sorrow-su">Lyric Sorrow (Su)</Pair>
...
<Ability id="inspire-courage" extraClasses="subAbility" icon={["armor-upgrade","upgrade"]}>
<Pair single id="inspire-courage">Inspire Courage</Pair>
...
<Ability id="inspire-greatness" extraClasses="subAbility" icon={["upgrade","armor-upgrade"]}>
<Pair single id="inspire-greatness">Inspire Greatness</Pair>
...
<Ability id="inspire-heroics" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="inspire-heroics">Inspire Heroics</Pair>
...
<Ability id="darkness-denied-ex" icon={["armor-upgrade"]}>
<Pair single id="darkness-denied-ex">Darkness Denied (Ex)</Pair>
<Pair hl title="Replaces">Well-versed</Pair>
<Pair title="Gained">At 2nd Level</Pair>
<Pair title="Passive Ability">A sorrowsoul gains a +4 bonus on saving throws against negative energy and death effects.</Pair>
</Ability>
<Ability id="spurn-harm-su" icon={["armor-upgrade"]}>
<Pair single id="spurn-harm-su" flavor="A sorrowsoul can funnel his bardic powers to persevere in the face of seemingly certain death.">Spurn Harm (Su)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
...
<Ability id="wordstrike-su" extraClasses="subAbility" icon={["smoking-finger"]}>
<Pair single id="wordstrike-su">Wordstrike (Su)</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="weird-words-su" extraClasses="subAbility" icon={["smoking-finger"]}>
<Pair single id="weird-words-su">Weird Words (Su)</Pair>
<Pair hl title="Replaces">Suggestion</Pair>
...
<Ability id="corpse-speaker-su" icon={["magic-swirl"]}>
<Pair single id="corpse-speaker-su">Corpse Speaker (Su)</Pair>
<Pair hl title="Replaces">Countersong</Pair>
...
<Ability id="keen-ritualist-ex" icon={["magic-swirl","upgrade"]}>
<Pair single id="keen-ritualist-ex">Keen Ritualist (Ex)</Pair>
<Pair hl title="Replaces">Jack-of-all-trades</Pair>
...
<Ability id="earth-magic" icon={["stairs-goal","spell-book"]}>
<Pair single id="earth-magic">Earth Magic</Pair>
...
<Ability id="stone-song-su" icon={["stairs-goal"]}>
<Pair single id="stone-song-su">Stone Song (Su)</Pair>
<Pair hl title="Alters">Bardic performance</Pair>
...
<Ability id="tremor-su" icon={["stairs-goal","armor-downgrade"]}>
<Pair single id="tremor-su">Tremor (Su)</Pair>
<Pair hl title="Replaces">Countersong</Pair>
...
<Ability id="quake-su" icon={["aura"]}>
<Pair single id="quake-su">Quake (Su)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
...
<Ability id="disappearing-act-su" extraClasses="subAbility" icon={["stairs-goal","aura"]}>
<Pair single id="disappearing-act-su">Disappearing Act (Su)</Pair>
<Pair hl title="Replaces">Inspire courage</Pair>
...
<Ability id="harmless-performer-su" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="harmless-performer-su">Harmless Performer (Su)</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
...
<Ability id="madcap-prank-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="madcap-prank-su">Madcap Prank (Su)</Pair>
<Pair hl title="Replaces">Inspire greatness</Pair>
...
<Ability id="slip-through-the-crowd-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="slip-through-the-crowd-su">Slip through the Crowd (Su)</Pair>
<Pair hl title="Replaces">Inspire heroics</Pair>
...
<Ability id="gladhanding" icon={["upgrade"]}>
<Pair single id="gladhanding">Gladhanding</Pair>
<Pair hl title="Replaces">Countersong</Pair>
...
<Ability id="streetwise" icon={["upgrade"]}>
<Pair single id="streetwise">Streetwise</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="quick-change-ex" icon={["stairs-goal"]}>
<Pair single id="quick-change-ex">Quick Change (Ex)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="scribe-scroll" icon={["upgrade"]}>
<Pair single id="scribe-scroll">Scribe Scroll</Pair>
<Pair hl title="Replaces">Distraction</Pair>
<Pair title="Ability">A studious librarian gains <Link to="/feat/scribe_scroll">Scribe Scroll</Link> as a bonus feat.</Pair>
</Ability>
<Ability id="comparative-arcane-studies-su" icon={["magic-swirl"]}>
<Pair single id="comparative-arcane-studies-su" flavor="The studious librarian is exposed to a wide variety of magical writing, and can use his own magic to duplicate spells from other classes' spell lists.">Comparative Arcane Studies (Su)</Pair>
...
<Ability id="critical-research-focus-ex" icon={["upgrade"]}>
<Pair single id="critical-research-focus-ex">Critical Research Focus (Ex)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
...
<Ability id="perfect-recollection-ex" icon={["upgrade"]}>
<Pair single id="perfect-recollection-ex">Perfect Recollection (Ex)</Pair>
<Pair hl title="Replaces">Mass suggestion</Pair>
<Pair title="At 19th Level">The studious librarian can always take 20 on Knowledge checks.</Pair>
</Ability>
<Ability id="one-with-the-library-ex" icon={["spell-book"]}>
<Pair single id="one-with-the-library-ex">One with the Library (Ex)</Pair>
<Pair hl title="Replaces">Deadly performance</Pair>
...
<Ability id="bound-to-the-land-ex" icon={["upgrade"]}>
<Pair single id="bound-to-the-land-ex">Bound to the Land (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="thunder-call-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="thunder-call-su">Thunder Call (Su)</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
...
<Ability id="incite-rage-su" extraClasses="subAbility" icon={["magic-swirl","aura"]}>
<Pair single id="incite-rage-su">Incite Rage (Su)</Pair>
<Pair hl title="Replaces">Suggestion, mass suggestion</Pair>
...
<Ability id="call-lightning-su" extraClasses="subAbility" icon={["smoking-finger"]}>
<Pair single id="call-lightning-su">Call Lightning (Su)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
...
<Ability id="call-lightning-storm-su" extraClasses="subAbility" icon={["smoking-finger"]}>
<Pair single id="call-lightning-storm-su">Call Lightning Storm (Su)</Pair>
<Pair hl title="Replaces">Frightening tune</Pair>
...
<Ability id="brighs-knowledge-ex" icon={["upgrade","stairs-goal"]}>
<Pair single id="brighs-knowledge-ex">Brigh's Knowledge (Ex)</Pair>
...
<Ability id="brighs-soothing-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="brighs-soothing-su">Brigh's Soothing (Su)</Pair>
<Pair hl title="Replaces">Fascinate</Pair>
...
<Ability id="brighs-anger-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="brighs-anger-su">Brigh's Anger (Su)</Pair>
<Pair hl title="Replaces">Dirge of doom</Pair>
...
<Ability id="brighs-spark-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="brighs-spark-su">Brigh's Spark (Su)</Pair>
<Pair hl title="Replaces">Soothing performance</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="brighs-wrath-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="brighs-wrath-su">Brigh's Wrath (Su)</Pair>
<Pair hl title="Replaces">Frightening tune</Pair>
...
<Ability id="wild-knowledge-ex" icon={["upgrade","stairs-goal"]}>
<Pair single id="wild-knowledge-ex">Wild Knowledge (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="nature-magic" icon={["spell-book"]}>
<Pair single id="nature-magic">Nature Magic</Pair>
...
<Ability id="song-of-the-wild-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="song-of-the-wild-su">Song of the Wild (Su)</Pair>
...
<Ability id="wasteland-knowledge-ex" icon={["upgrade"]}>
<Pair single id="wasteland-knowledge-ex">Wasteland Knowledge (Ex)</Pair>
<Pair hl title="Replaces">Bardic knowledge</Pair>
...
<Ability id="wasteland-specialist-ex" icon={["stairs-goal"]}>
<Pair single id="wasteland-specialist-ex">Wasteland Specialist (Ex)</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
...
<Ability id="watersong-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="watersong-su">Watersong (Su)</Pair>
...
<Ability id="waterstrike-su" extraClasses="subAbility" icon={["mailed-fist"]}>
<Pair single id="waterstrike-su">Waterstrike (Su)</Pair>
<Pair hl title="Replaces">Inspire competence</Pair>
...
<Ability id="lifewater-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="lifewater-su">Lifewater (Su)</Pair>
...
<Ability id="watersinger-spells" icon={["spell-book"]}>
<Pair single id="watersinger-spells">Watersinger Spells</Pair>
...
<Ability id="cutting-remark-su" extraClasses="subAbility" icon={["smoking-finger"]}>
<Pair single id="cutting-remark-su">Cutting Remark (Su)</Pair>
...
<Ability id="quick-witted-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="quick-witted-ex">Quick Witted (Ex)</Pair>
<Pair hl title="Replaces">Versatile performance</Pair>
...
<Ability id="on-the-ball-ex" icon={["rolling-dices"]}>
<Pair single id="on-the-ball-ex">On the Ball (Ex)</Pair>
<Pair hl title="Replaces">Lore master</Pair>
...
<Ability id="duel-master-ex" icon={["upgrade"]}>
<Pair single id="duel-master-ex">Duel Master (Ex)</Pair>
<Pair hl title="Replaces">Jack-of-all-trades</Pair>
<Pair title="Gained">At 10th Level</Pair>
