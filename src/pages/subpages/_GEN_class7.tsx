...
<Ability id="favored-enemy-ex" icon={["boost"]}>
...
<Ability id="combat-style-feat-ex" icon={["power"]}>
...
</td></tr></tbody></table></ScrollContainer></div><Ability id="endurance" icon={["power"]}>
...
<Ability id="hunters-bond-ex" extraClasses="hasSubs" icon={["boost"]}>
...
<Ability id="companions-bond" extraClasses="subAbility numbered" icon={["boost"]}>
...
<Ability id="animal-companion" extraClasses="subAbility numbered" icon={["power"]}>
...
<Ability id="hide-in-plain-sight-ex" icon={["boost"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-ranger--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Ability id="shifter-aspect-su" icon={["power"]}>
...
<Ability id="shifter-claws-su" icon={["melee"]}>
...
<Ability id="defensive-instinct-ex" icon={["def"]}>
...
<Ability id="shifters-fury-ex" icon={["melee"]}>
...
<Ability id="chimeric-aspect-su" icon={["boost"]}>
...
<Ability id="greater-chimeric-aspect-su" icon={["boost"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-shifter--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<DisplayTable table={{"id":"shifter archetypes","columns":[{"header":"Archetype","link":"arc-shifter"},{"header":"Alignment"},{"header":"Armor Proficiency"},{"header":"Defensive Instinct"},{"header":"Languages"},{"header":"Shifter Aspect"},{"header":"Chimeric Aspect"},{"header":"Greater Chimeric Aspect"},{"header":"Greater Chimeric Instinct"},{"header":"Final Aspect"},{"header":"Shifter Claws"},{"header":"Track"},{"header":"Trackless Step"},{"header":"Weapon Proficiency"},{"header":"Wild Empathy"},{"header":"Wild Shape"},{"header":"Woodland Stride"}],"data":[[["Adaptive Shifter","adaptive_shifter"],null,null,null,null,"X","X","X",null,"X","X","X","X",null,"X","X","X"],[["Dragonblood Shifter","dragonblood_shifter"],null,null,null,null,"X","X","X",null,"X",null,null,null,null,null,"X",null],[["Elementalist Shifter","elementalist_shifter"],null,null,null,"X","X","X","X",null,null,"X",null,null,null,"X","X",null],[["Feyform Shifter","feyform_shifter"],null,null,null,null,"X","X","X",null,"X",null,null,null,null,null,"X",null],[["Fiendflesh Shifter","fiendflesh_shifter"],"X",null,"X",null,"X","X",null,"X",null,"X",null,null,null,null,"X",null],[["Holy Beast","holy_beast"],null,null,null,null,null,null,null,null,null,"X","X","X",null,"X",null,"X"],[["Leafshifter","leafshifter"],null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null,null],[["Oozemorph","oozemorph"],null,"X","X",null,"X","X","X",null,null,"X",null,null,"X","X","X","X"],[["Rageshaper","rageshaper"],"X",null,"X",null,"X","X","X",null,null,"X",null,"X",null,null,"X","X"],[["Style Shifter","style_shifter"],null,"X",null,null,"X","X","X",null,"X",null,null,null,null,null,"X",null],[["Swarm Shifter","swarm_shifter"],null,null,null,null,"X","X","X",null,"X",null,null,null,null,null,"X",null],[["Verdant Shifter","verdant_shifter"],null,null,"X",null,"X","X","X",null,null,null,null,null,null,"X","X",null],[["Weretouched","weretouched"],null,null,null,null,"X",null,null,null,null,null,null,null,null,"X","X",null],[["Wild Effigy","wild_effigy"],null,null,"X",null,null,null,null,null,null,null,"X","X",null,"X",null,"X"]],"initialColumn":0,"nullValue":"&nbsp;"}} />
...
<Ability id="spellbooks" icon={["power"]}>
...
<Ability id="arcane-pool-su" icon={["magic"]}>
...
<Ability id="spell-combat-ex" icon={["power","melee","magic"]}>
...
<Ability id="spellstrike-su" icon={["melee"]}>
...
<Ability id="magus-arcana" icon={["power","magic"]}>
...
<Ability id="spell-recall-su" icon={["magic"]}>
...
<Ability id="knowledge-pool-su" icon={["magic"]}>
...
<Ability id="medium-armor-ex" icon={["def"]}>
...
<Ability id="improved-spell-combat-ex" icon={["def"]}>
...
<Ability id="fighter-training-ex" icon={["boost"]}>
...
<Ability id="improved-spell-recall-su" icon={["boost"]}>
...
<Ability id="heavy-armor-ex" icon={["def"]}>
...
<Ability id="greater-spell-combat-ex" icon={["def"]}>
...
<Ability id="counterstrike-ex" icon={["melee"]}>
...
<Ability id="greater-spell-access-su" icon={["magic"]}>
...
<Ability id="true-magus-su" icon={["boost","melee"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-magus--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-magus/armored_battlemage">Armored Battlemage</Link></p><p><strong>Modifies or Replaces:</strong> Spell Combat; Arcane Pool; 3rd, 18th-level Magus Arcana; Improved Spell Combat; Greater Spell Combat</p><p>Armored battlemages learn to move and cast spells in even the most restrictive armors, and have developed new methods to magically enhance their armor.</p></div>
...
<div className="archetype"><p><Link to="/arc-magus/kapenia_dancer">Kapenia Dancer</Link></p><p><strong>Modifies or Replaces:</strong> Weapon/Armor Proficiencies; Spellcasting</p><p>The kapenia dancer laces their deadly scarves with powerful magic.</p></div>
...
<DisplayTable table={{"id":"magus archetypes","columns":[{"header":"Archetype","link":"arc-magus"},{"header":"Arcane Pool"},{"header":"Armor Proficiency"},{"header":"Medium Armor"},{"header":"Heavy Armor"},{"header":"Bonus Feats"},{"header":"5th-level Bonus Feat"},{"header":"Cantrips"},{"header":"Class Skills"},{"header":"Counterstrike"},{"header":"Fighter Training"},{"header":"Greater Spell Access"},{"header":"Knowledge Pool"},{"header":"3rd-level Magus Arcana"},{"header":"6th-level Magus Arcana"},{"header":"9th-level Magus Arcana"},{"header":"12th-level Magus Arcana"},{"header":"18th-level Magus Arcana"},{"header":"Skills"},{"header":"Speed Weapon Property"},{"header":"Spell Combat"},{"header":"Improved Spell Combat"},{"header":"Greater Spell Combat"},{"header":"Spell Recall"},{"header":"Improved Spell Recall"},{"header":"Spellcasting"},{"header":"Spellstrike"},{"header":"True Magus"},{"header":"Weapon Proficiency"}],"data":[[["Armored Battlemage","armored_battlemage"],"X",null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,"X","X","X",null,null,null,null,null,null],[["Beastblade","beastblade"],null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null],[["Bladebound","bladebound"],"X",null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Card Caster","card_caster"],"X",null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null],[["Deep Marshal","deep_marshal"],"X","X","X","X",null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,"X",null,null,null,null,"X","X",null,null],[["Eldritch Archer","eldritch_archer"],"X",null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null],[["Eldritch Scion","eldritch_scion"],"X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,"X","X","X","X",null,"X",null,null,null],[["Elemental Knight","elemental_knight"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null],[["Esoteric","esoteric"],"X","X","X","X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X","X",null,"X"],[["Fiend Flayer","fiend_flayer"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Greensting Slayer","greensting_slayer"],"X",null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Hexbreaker","hexbreaker"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null],[["Hexcrafter","hexcrafter"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null],[["Iron-Ring Striker","iron_ring_striker"],"X",null,"X","X",null,"X",null,null,"X",null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,"X"],[["Jistkan Artificer","jistkan_artificer"],"X",null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null],[["Kapenia Dancer","kapenia_dancer"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X"],[["Kensai","kensai"],null,"X","X","X",null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,null,null,"X","X","X",null,"X","X"],[["Magic Warrior","magic_warrior"],null,null,null,null,null,null,null,"X",null,null,"X",null,"X",null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null],[["Mindblade","mindblade"],"X",null,"X","X",null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,"X","X","X","X","X",null,null,null],[["Myrmidarch","myrmidarch"],null,null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,"X","X",null,null,null,"X","X","X","X","X",null,"X",null],[["Nature-Bonded Magus","nature_bonded_magus"],"X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null],[["Puppetmaster","puppetmaster"],"X",null,"X","X",null,null,null,null,"X","X","X","X",null,null,null,null,null,"X",null,"X","X","X",null,null,null,"X","X",null],[["Sigilus","sigilus"],null,null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null],[["Skirnir","skirnir"],null,null,null,null,null,null,null,null,"X",null,"X","X",null,null,null,null,null,null,null,"X","X","X","X",null,"X",null,null,null],[["Sorrowblade","sorrowblade"],null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,"X",null,null,null,null,null,null,null,null,null],[["Soul Forger","soul_forger"],null,null,null,null,null,null,null,null,"X",null,"X","X",null,null,null,null,null,null,null,null,null,null,"X","X","X",null,null,null],[["Spell Dancer","spell_dancer"],"X",null,"X","X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Spell Trapper","spell_trapper"],null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null],[["Spellblade","spellblade"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null],[["Spire Defender","spire_defender"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X"],[["Staff Magus","staff_magus"],null,"X","X","X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X"]],"initialColumn":0,"nullValue":"&nbsp;"}} />
...
<Ability id="grit-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="critical-hit-with-a-firearm" extraClasses="subAbility numbered" icon={["power","ranged"]}>
...
<Ability id="killing-blow-with-a-firearm" extraClasses="subAbility numbered" icon={["power","ranged"]}>
...
</aside><Ability id="deeds" icon={["power"]}>
...
</aside><Ability id="nimble-ex" icon={["def"]}>
...
</aside><Ability id="gun-training-ex" icon={["boost","ranged"]}>
...
<Ability id="true-grit-ex" icon={["boost"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-gunslinger--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Old Dog, New Tricks (Ex)</td><td>At 20th level, the character shows that a true warrior always has one more surprise the enemy hasn't seen. The character gains four <Link to="/main/combat_feat">combat feats</Link>. This capstone is available to characters of any class that gains at least four bonus combat feats.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
...
<Message arch /><div className="archetype"><p><Link to="/arc-gunslinger/black_powder_vaulter">Black Powder Vaulter</Link></p><p><strong>Modifies or Replaces:</strong> Deadeye; Gunslinger's Dodge; Gunslinger Initiative; Startling Shot; Expert Loading</p><p>Black powder vaulters like to get into the thick of the battle, maneuvering among the fray to find the most advantageous positions from which to kill their enemies.</p></div>
...
<Ability id="rage-ex" icon={["boost","down"]}>
...
<Ability id="rage-powers-ex" icon={["power","boost","def"]}>
...
<Ability id="greater-rage-ex" icon={["boost","def"]}>
...
<Ability id="indomitable-will-ex" icon={["def"]}>
...
<Ability id="tireless-rage-ex" icon={["boost"]}>
...
<Ability id="mighty-rage-ex" icon={["boost","def"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-barbarian--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
<tr><td>The Boss (Ex)</td><td>At 20th level, the character has become more than just a lone hero - she has become one of the senior figures of her field, with powers and responsibilities to match. The character becomes one of the leading figures in some manner of group or organization, as appropriate to the campaign and the setting. A wizard might become the dean of an arcane university or mages' guild, a fighter could command a mercenary army or a city guard, a cleric might lead a major temple or her own sect, and so forth. The player and the GM should work together to determine the specifics. The character gains the <Link to="/feat/leadership">Leadership</Link> feat if she does not already have it, and the number of followers that the feat grants is multiplied by 10 (although depending on the campaign and setting, the position may grant other powers as well). If multiple characters in a party select this capstone, the GM may consider pooling them to grant the players a particularly large and powerful organization, such as a small kingdom. Characters of any class can select this ability.</td></tr>
...
<Message arch /><div className="archetype"><p><Link to="/arc-barbarian/armored_hulk">Armored Hulk</Link></p><p><strong>Modifies or Replaces:</strong> Fast Movement; Uncanny Dodge; Trap Sense; Improved Uncanny Dodge</p><p>Some barbarians disdain the hides and leather used as armor by most of their kin. Instead they master the heaviest of armors, even those created by more civilized people, to gain greater protection and stability in battle.</p></div>
...
<Ability id="rage-ex" icon={["power","boost","def"]}>
<Pair single id="rage-ex" flavor="A barbarian can call upon inner reserves of strength and ferocity, granting her additional combat prowess.">Rage (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Usage">2 rounds/day + double your barbarian level + your Constitution modifier<ByLevelPop levels={[[1,4],[2,6],[3,8],[4,10],[5,12],[6,14],[7,16],[8,18],[9,20],[10,22],[11,24],[12,26],[13,28],[14,30],[15,32],[16,34],[17,36],[18,38],[19,40],[20,42]]} preText="Con modifier + " unit="round" postText="/day" /></Pair>
...
<Ability id="rage-powers-ex" icon={["power","boost"]}>
<Pair single id="rage-powers-ex" flavor={<>As a barbarian gains levels, she learns to use her <em>rage</em> in new ways.</>}>Rage Powers (Ex)</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Pair title="Gained">At 3rd Level</Pair>
<Pair title="Passive Ability">You gain a bonus on Reflex saves made to avoid traps, a dodge bonus to AC against attacks made by traps, and a bonus on Perception checks to avoid being surprised by a foe. <Bonus y c="barbarian" n={3} pl link={false} />.</Pair>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-unchained_barbarian--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
<tr><td>The Boss (Ex)</td><td>At 20th level, the character has become more than just a lone hero - she has become one of the senior figures of her field, with powers and responsibilities to match. The character becomes one of the leading figures in some manner of group or organization, as appropriate to the campaign and the setting. A wizard might become the dean of an arcane university or mages' guild, a fighter could command a mercenary army or a city guard, a cleric might lead a major temple or her own sect, and so forth. The player and the GM should work together to determine the specifics. The character gains the <Link to="/feat/leadership">Leadership</Link> feat if she does not already have it, and the number of followers that the feat grants is multiplied by 10 (although depending on the campaign and setting, the position may grant other powers as well). If multiple characters in a party select this capstone, the GM may consider pooling them to grant the players a particularly large and powerful organization, such as a small kingdom. Characters of any class can select this ability.</td></tr>
<tr><td>Unstoppable (Ex)</td><td>At 20th level, nothing can kill the barbarian, though not for lack of trying. The barbarian gains DR 3/- or increases the value of any existing damage reduction by 3. In addition, she gains energy resistance to acid, cold, electricity, and fire equal to her DR/- value.</td></tr>
...
<Message arch /><p>When the <em>unchained</em> classes were introduced, they came with a note saying "these classes should work with any of the archetypes from previous books as long as the classes still have the appropriate class features to replace." (<em><Link to="/source/pathfinder_unchained">Pathfinder Unchained</Link> pg. 8</em>) The <em>deepwater rager</em> archetype was printed with a note saying it works for the unchained barbarian, and <em>danger sense</em> above explicitly says it can be treated as <em>trap sense</em> for archetype purposes.</p>
