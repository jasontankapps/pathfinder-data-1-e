...
<div className="abPair"><div className="abStart"><div className="box">At 8th Level</div></div><div className="abEnd"><div className="box">You may select a new favorite terrain. The bonuses in any one favored terrain (including the one just selected, if so desired) increase by +2.</div></div></div></div>
<div className="columnar">
<ul>
...
<ScrollContainer id="class-ranger--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<h3 id="class-ranger-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
...
<div className="archetype"><p><Link to="/arc-ranger/poison_darter">Poison Darter</Link></p><p><strong>Modifies or Replaces:</strong> Favored Enemy; Wild Empathy; Combat Style; Hunter's Bond; Master Hunter</p><p>In dense jungles, foliage and tight spaces hinder all but the most deceptively humble weapons: blowguns and poison.</p></div>
...
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-shifter--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<h3 id="class-shifter-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
...
<div className="title abSingle" id="class-magus-spells" data-hash-target><div className="box">Spells</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-magus--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<h3 id="class-magus-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
...
<div className="ability subAbility numbered"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link><Link to="/icons/bowman"><IonIcon icon="/icons/bowman.svg" color="secondary" /></Link></div>
...
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-gunslinger--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Old Dog, New Tricks (Ex)</td><td>At 20th level, the character shows that a true warrior always has one more surprise the enemy hasn't seen. The character gains four <Link to="/main/combat_feat">combat feats</Link>. This capstone is available to characters of any class that gains at least four bonus combat feats.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
...
<h3 id="class-gunslinger-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
...
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-barbarian--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
<tr><td>The Boss (Ex)</td><td>At 20th level, the character has become more than just a lone hero - she has become one of the senior figures of her field, with powers and responsibilities to match. The character becomes one of the leading figures in some manner of group or organization, as appropriate to the campaign and the setting. A wizard might become the dean of an arcane university or mages' guild, a fighter could command a mercenary army or a city guard, a cleric might lead a major temple or her own sect, and so forth. The player and the GM should work together to determine the specifics. The character gains the <Link to="/feat/leadership">Leadership</Link> feat if she does not already have it, and the number of followers that the feat grants is multiplied by 10 (although depending on the campaign and setting, the position may grant other powers as well). If multiple characters in a party select this capstone, the GM may consider pooling them to grant the players a particularly large and powerful organization, such as a small kingdom. Characters of any class can select this ability.</td></tr>
...
<h3 id="class-barbarian-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
...
<p><strong>Dwarf:</strong> Add +1 to the barbarian's total number of rage rounds per day.<sup><InnerLink showBacklink="backlink-class-barbarian-ref-B-1" id="class-barbarian-ref-B-1" data-hash-target to="class-barbarian-B">2</InnerLink></sup> <sup><InnerLink showBacklink="backlink-class-barbarian-ref-C-1" id="class-barbarian-ref-C-1" data-hash-target to="class-barbarian-C">3</InnerLink></sup></p>
...
<p><strong>Fetchling:</strong> Add +1 to either cold or electricity resistance while raging (maximum resistance 15 for either type).<sup><InnerLink showBacklink="backlink-class-barbarian-ref-F-1" id="class-barbarian-ref-F-1" data-hash-target to="class-barbarian-F">6</InnerLink></sup></p>
...
<p><strong>Half-orc:</strong> Add +1 to the barbarian's total number of rage rounds per day.<sup><InnerLink showBacklink="backlink-class-barbarian-ref-N-1" id="class-barbarian-ref-N-1" data-hash-target to="class-barbarian-N">14</InnerLink></sup> <sup><InnerLink showBacklink="backlink-class-barbarian-ref-O-1" id="class-barbarian-ref-O-1" data-hash-target to="class-barbarian-O">15</InnerLink></sup></p>
...
<p><strong>Kobold:</strong> While you are raging, your racial natural attacks deal +1/4 point of damage.<sup><InnerLink showBacklink="backlink-class-barbarian-ref-S-1" id="class-barbarian-ref-S-1" data-hash-target to="class-barbarian-S">19</InnerLink></sup></p>
<p><strong>Orc:</strong> Add +1 to the barbarian's total number of rage rounds per day.<sup><InnerLink showBacklink="backlink-class-barbarian-ref-T-1" id="class-barbarian-ref-T-1" data-hash-target to="class-barbarian-T">20</InnerLink></sup></p>
<p><strong>Ratfolk:</strong> When raging, add +1/4 to the barbarian's swarming trait's flanking bonus on attack rolls.<sup><InnerLink showBacklink="backlink-class-barbarian-ref-U-1" id="class-barbarian-ref-U-1" data-hash-target to="class-barbarian-U">21</InnerLink></sup></p>
<p><strong>Strix:</strong> Add +1 to the barbarian's total number of rage rounds per day.<sup><InnerLink showBacklink="backlink-class-barbarian-ref-V-1" id="class-barbarian-ref-V-1" data-hash-target to="class-barbarian-V">22</InnerLink></sup></p>
...
<div className="archetype"><p><Link to="/arc-barbarian/beastkin_berserker">Beastkin Berserker</Link></p><p><strong>Modifies or Replaces:</strong> Fast Movement; 4th, 8th, 12th-level Rage Power</p><p>While some barbarians take on bestial aspects in their rages, the beastkin berserker descends so deeply into primal fury that she actually transforms into an animal.</p></div>
...
<div className="archetype"><p><Link to="/arc-barbarian/drunken_brute">Drunken Brute</Link></p><p><strong>Modifies or Replaces:</strong> Fast Movement</p><p>Drunken brutes use potent liquor to fuel their rage and grant them additional powers.</p></div>
...
<div className="archetype"><p><Link to="/arc-barbarian/pack_rager">Pack Rager</Link></p><p><strong>Modifies or Replaces:</strong> 2nd, 6th, 10th, 14th, and 18th-level Rage Powers; Damage Reduction</p><p>Barbarian rages can be a thing of savage beauty, exhibiting a lethal grace. While such uncontrolled displays of carnage often disregard group tactics, there are those barbarians whose rages inspire and spur on their allies during the ferocious dance of death.</p></div>
<div className="archetype"><p><Link to="/arc-barbarian/primal_hunter">Primal Hunter</Link></p><p><strong>Modifies or Replaces:</strong> Fast Movement; Rage</p><p>Rather than exploding with anger, primal hunters focus their rage to strike distant targets.</p></div>
...
<p><strong>Unchained:</strong> The unchained barbarian is similar in many regards to its counterpart in the Core Rulebook - she still goes into a rage and gains rage powers, but many of the details have been changed. Rage now grants <Link to="/rule/temporary_hit_points">temporary hit points</Link> and static bonuses on attack and damage rolls, rather than bonuses to ability scores that force players to recalculate a number of statistics. Additionally, many rage powers now function whenever the barbarian is raging, as opposed to just once per rage. Finally, the overall utility of many of the rage powers has been adjusted to make them more useful and interesting.</p>
<table className="class"><tbody><tr><th scope="row" className="nw">Alignment</th><td colSpan={2} className="ne"><div className="colFlex"><span>Any nonlawful</span><table className="basic alignment"><tbody><tr><td>LG</td><td>LN</td><td>LE</td></tr><tr><td data-lit>NG</td><td data-lit>N</td><td data-lit>NE</td></tr><tr><td data-lit>CG</td><td data-lit>CN</td><td data-lit>CE</td></tr></tbody></table></div></td></tr><tr><th scope="row">Hit Die</th><td colSpan={2}>d12</td></tr><tr><th scope="row">Starting Wealth</th><td colSpan={2}>3d6 &times; 10 gp (average 105 gp)</td></tr><tr><th scope="row">Skill Points per Level</th><td colSpan={2}>4 + Int modifier</td></tr><tr><th scope="row" rowSpan={5} className="sw">Class Skills</th><td><Link to="/skill/climb">Climb</Link>, <Link to="/skill/swim">Swim</Link></td><td className="c">(STR)</td></tr><tr><td><Link to="/skill/acrobatics">Acrobatics</Link>, <Link to="/skill/ride">Ride</Link></td><td className="c">(DEX)</td></tr><tr><td><Link to="/skill/craft_any">Craft (any)</Link>, <Link to="/skill/knowledge_nature">Knowledge (nature)</Link></td><td className="c">(INT)</td></tr><tr><td><Link to="/skill/perception">Perception</Link>, <Link to="/skill/survival">Survival</Link></td><td className="c">(WIS)</td></tr><tr><td><Link to="/skill/handle_animal">Handle Animal</Link>, <Link to="/skill/intimidate">Intimidate</Link></td><td className="c se">(CHA)</td></tr></tbody></table>
...
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-unchained_barbarian--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
<tr><td>The Boss (Ex)</td><td>At 20th level, the character has become more than just a lone hero - she has become one of the senior figures of her field, with powers and responsibilities to match. The character becomes one of the leading figures in some manner of group or organization, as appropriate to the campaign and the setting. A wizard might become the dean of an arcane university or mages' guild, a fighter could command a mercenary army or a city guard, a cleric might lead a major temple or her own sect, and so forth. The player and the GM should work together to determine the specifics. The character gains the <Link to="/feat/leadership">Leadership</Link> feat if she does not already have it, and the number of followers that the feat grants is multiplied by 10 (although depending on the campaign and setting, the position may grant other powers as well). If multiple characters in a party select this capstone, the GM may consider pooling them to grant the players a particularly large and powerful organization, such as a small kingdom. Characters of any class can select this ability.</td></tr>
<tr><td>Unstoppable (Ex)</td><td>At 20th level, nothing can kill the barbarian, though not for lack of trying. The barbarian gains DR 3/- or increases the value of any existing damage reduction by 3. In addition, she gains energy resistance to acid, cold, electricity, and fire equal to her DR/- value.</td></tr>
...
<h3 id="class-unchained_barbarian-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
