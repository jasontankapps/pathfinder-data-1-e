...
<p><strong>Dwarf:</strong> Increase the bloodrager's total number of <em>bloodrage</em> rounds per day by 1.<sup><InnerLink showBacklink="backlink-class-bloodrager-ref-C-1" id="class-bloodrager-ref-C-1" data-hash-target to="class-bloodrager-C">3</InnerLink></sup></p>
...
<p><strong>Gathlain:</strong> Add 1 additional round of <em>bloodrage</em> per day.<sup><InnerLink showBacklink="backlink-class-bloodrager-ref-D-1" id="class-bloodrager-ref-D-1" data-hash-target to="class-bloodrager-D">4</InnerLink></sup></p>
...
<p><strong>Halfling:</strong> Gain a +1/4 dodge bonus to AC while <em>bloodraging</em> against creatures at least one size category larger than the bloodrager.<sup><InnerLink showBacklink="backlink-class-bloodrager-ref-E-3" id="class-bloodrager-ref-E-3" data-hash-target to="class-bloodrager-E">5</InnerLink></sup></p>
<p><strong>Half-orc:</strong> Increase the bloodrager's total number of <em>bloodrage</em> rounds per day by 1.<sup><InnerLink showBacklink="backlink-class-bloodrager-ref-F-1" id="class-bloodrager-ref-F-1" data-hash-target to="class-bloodrager-F">6</InnerLink></sup></p>
<p><strong>Human:</strong> Increase the bloodrager's total number of <em>bloodrage</em> rounds per day by 1.<sup><InnerLink showBacklink="backlink-class-bloodrager-ref-F-2" id="class-bloodrager-ref-F-2" data-hash-target to="class-bloodrager-F">6</InnerLink></sup></p>
...
<p><strong>Strix:</strong> Increase the bloodrager's total number of <em>bloodrage</em> rounds per day by 1.<sup><InnerLink showBacklink="backlink-class-bloodrager-ref-I-1" id="class-bloodrager-ref-I-1" data-hash-target to="class-bloodrager-I">9</InnerLink></sup></p>
<p><strong>Wyvaran:</strong> Add 1 to the bloodrager's total rounds of <em>bloodrage</em> each day.<sup><InnerLink showBacklink="backlink-class-bloodrager-ref-J-1" id="class-bloodrager-ref-J-1" data-hash-target to="class-bloodrager-J">10</InnerLink></sup></p>
</div>
