...
<Ability id="alchemy-su" icon={["boost","power"]}>
...
<Ability id="extracts" icon={["magic"]}>
...
<Ability id="brew-potion-ex" icon={["power"]}>
...
<Ability id="throw-anything-ex" icon={["power"]}>
...
<Ability id="mutagen-su" icon={["boost"]}>
...
</aside><Ability id="poison-resistance-ex" icon={["def"]}>
...
<Ability id="swift-poisoning-ex" icon={["boost"]}>
...
<Ability id="persistent-mutagen-su" icon={["boost"]}>
...
<Ability id="instant-alchemy-ex" icon={["boost"]}>
...
<Ability id="grand-discovery-su" icon={["power"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-alchemist--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Ability id="detect-good-sp" icon={["power"]}>
...
<Ability id="smite-good-su" icon={["boost","def"]}>
...
<Ability id="unholy-resilience-su" icon={["def"]}>
...
<Ability id="touch-of-corruption-su" icon={["touch","aid"]}>
...
<Ability id="aura-of-cowardice-su" icon={["lower"]}>
...
<Ability id="plague-bringer-ex" icon={["def"]}>
...
<Ability id="cruelty-su" icon={["boost"]}>
...
<Ability id="channel-negative-energy-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="fiendish-boon-sp" extraClasses="hasSubs" icon={["magic"]}>
...
<Ability id="weapon-bond" extraClasses="subAbility numbered" icon={["melee"]}>
...
<Ability id="fiendish-servant" extraClasses="subAbility numbered" icon={["power"]}>
...
<Ability id="aura-of-vengeance-su" icon={["boost"]}>
...
<Ability id="aura-of-sin-su" icon={["lower"]}>
...
<Ability id="aura-of-depravity-su" icon={["def","lower"]}>
...
<Ability id="unholy-champion-su" icon={["def","boost"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-antipaladin--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Ability id="cantrips" icon={["magic"]}>
...
<Ability id="arcane-reservoir-su" icon={["power","boost"]}>
...
<Ability id="arcanist-exploits" icon={["power"]}>
...
</aside><Ability id="consume-spells-su" icon={["magic"]}>
...
<Ability id="greater-exploits" icon={["power"]}>
...
<Ability id="magical-supremacy-su" icon={["power"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-arcanist--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-arcanist/aeromancer">Aeromancer</Link></p><p><strong>Modifies or Replaces:</strong> 1st, 5th, 11th-level Arcanist Exploit</p><p>While the practice of aeromancy is rare, some arcanists today are able to rival the aerial mastery of the ancient Shory aeromancers.</p></div>
...
<Ability id="bardic-knowledge-ex" icon={["boost","power"]}>
...
<Ability id="bardic-performance" icon={["power"]}>
...
<Pair title="At 7th Level">You can begin a performance as a <strong className="hl">move-equivalent action</strong>.</Pair>
<Pair title="At 13th Level">You can begin a performance as a <strong className="hl">swift action</strong>.</Pair>
</Ability>
...
</aside><Ability id="versatile-performance-ex" icon={["power"]}>
...
</aside><Ability id="well-versed-ex" icon={["def"]}>
...
<Ability id="jack-of-all-trades-ex" icon={["power","skill"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-bard--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-bard/animal_speaker">Animal Speaker</Link></p><p><strong>Modifies or Replaces:</strong> Fascinate; Well-Versed; Inspire Competence; Suggestion; Mass Suggestion</p><p>An animal speaker focuses not on the ears and minds of humans, but on the creatures of the wild and those in the underbellies of cities.</p></div>
...
<Ability id="bloodline" icon={["magic","boost"]}>
...
</aside><Ability id="bloodrage-su" icon={["power","boost","def","down"]}>
...
<Ability id="blood-sanctuary-su" icon={["def"]}>
...
<Ability id="blood-casting-su" icon={["magic"]}>
...
<Ability id="eschew-materials" icon={["power"]}>
...
<Ability id="greater-bloodrage-su" icon={["boost","def","magic"]}>
...
<Ability id="tireless-bloodrage-su" icon={["boost"]}>
...
<Ability id="mighty-bloodrage-su" icon={["boost","def","magic"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-bloodrager--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Deep Magics (Su)</td><td>At 20th level, the character's repertoire of spells deepens dramatically. She gains an additional spell known for each spell level she can cast. A character of any class with spells known can select this capstone.</td></tr>
<tr><td>Empowered Bloodrage (Su)</td><td>At 20th level, the bloodrager is as much spell as mortal flesh. When the bloodrager enters a <em>bloodrage,</em> he can apply two spells to himself rather than one.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
<tr><td>The Boss (Ex)</td><td>At 20th level, the character has become more than just a lone hero - she has become one of the senior figures of her field, with powers and responsibilities to match. The character becomes one of the leading figures in some manner of group or organization, as appropriate to the campaign and the setting. A wizard might become the dean of an arcane university or mages' guild, a fighter could command a mercenary army or a city guard, a cleric might lead a major temple or her own sect, and so forth. The player and the GM should work together to determine the specifics. The character gains the <Link to="/feat/leadership">Leadership</Link> feat if she does not already have it, and the number of followers that the feat grants is multiplied by 10 (although depending on the campaign and setting, the position may grant other powers as well). If multiple characters in a party select this capstone, the GM may consider pooling them to grant the players a particularly large and powerful organization, such as a small kingdom. Characters of any class can select this ability.</td></tr>
<tr><td>With This Sword (Ex)</td><td>At 20th level, the character's blade has become as well-known as the character herself. The character selects one item she has - preferably something iconic and significant, such as a weapon or arcane bond. The item becomes a <Link to="/rule/artifacts">minor artifact</Link> and gains 100,000 gp worth of new powers. The player and the GM should work together to select the new powers, with an eye towards making something memorable yet campaign-appropriate. Characters of any class can select this ability.</td></tr>
<tr><td>Won't Stay Dead (Ex)</td><td>At 20th level, the character becomes a paragon of resilience. Once per week, if the character is killed, petrified, or otherwise removed from play, the character manages to survive by some dint of skill or luck and returns at the end of the combat or the scene (GM's discretion). The player and the GM should work together to ensure that the method of the character's survival is at least vaguely plausible, if unlikely. Characters of any class can select this ability.</td></tr>
...
<Message arch /><div className="archetype"><p><Link to="/arc-bloodrager/ancestral_harbinger">Ancestral Harbinger</Link></p><p><strong>Modifies or Replaces:</strong> Uncanny Dodge; Improved Uncanny Dodge; 6th, 12th, and 18th-level Bloodline Feats</p><p>While all bloodragers tap into their bloodlines to fuel the arcane energies they use in battle, some have the ability to call directly to the spirits of their ancestors to aid them, summoning spirits to fight for them or inspire their allies.</p></div>
...
<DisplayTable table={{"id":"bloodrager archetypes","columns":[{"header":"Archetype","link":"arc-bloodrager"},{"header":"Armor Proficiency"},{"header":"Blood Casting"},{"header":"Blood Sanctuary"},{"header":"Bloodline"},{"header":"Bloodline Feats"},{"header":"6th-level Bloodline Feat"},{"header":"9th-level Bloodline Feat"},{"header":"12th-level Bloodline Feat"},{"header":"15th-level Bloodline Feat"},{"header":"18th-level Bloodline Feat"},{"header":"Bloodline Powers"},{"header":"1st-level Bloodline Power"},{"header":"4th-level Bloodline Power"},{"header":"Bloodline Spells"},{"header":"Bloodrage"},{"header":"Greater Bloodrage"},{"header":"Mighty Bloodrage"},{"header":"Bonus Feats"},{"header":"Class Skills"},{"header":"Damage Reduction"},{"header":"7th-level Damage Reduction"},{"header":"13th-level Damage Reduction"},{"header":"19th-level Damage Reduction"},{"header":"Eschew Materials"},{"header":"Fast Movement"},{"header":"Indomitable Will"},{"header":"Saving Throws"},{"header":"Spellcasting"},{"header":"Uncanny Dodge"},{"header":"Improved Uncanny Dodge"},{"header":"Weapon Proficiency"}],"data":[[["Ancestral Harbinger","ancestral_harbinger"],null,null,null,null,null,"X",null,"X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null],[["Blood Conduit","blood_conduit"],null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,"X","X",null],[["Bloodline Familiars","bloodline_familiars"],null,null,null,"X",null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Bloodrider","bloodrider"],null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X","X",null],[["Bloody-Knuckled Rowdy","bloody_knuckled_rowdy"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,"X","X","X",null],[["Crossblooded Rager","crossblooded_rager"],null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,"X",null,null,null,null],[["Enlightened Bloodrager","enlightened_bloodrager"],null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null,null,null,"X",null,null,"X","X","X",null,null,null,null,"X",null,null,null],[["Greenrager","greenrager"],null,null,"X",null,null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Hag-Riven","hag_riven"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,"X","X","X"],[["Id Rager","id_rager"],null,null,null,"X","X",null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null],[["Metamagic Rager","metamagic_rager"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null],[["Primalist","primalist"],null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Prowler at World's End","prowler_at_worlds_end"],null,null,null,null,null,null,"X","X","X",null,"X",null,null,null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Rageshaper","rageshaper"],null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null],[["Spelleater","spelleater"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,"X","X",null],[["Steelblood","steelblood"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,"X","X",null],[["Symbol Striker","symbol_striker"],null,null,null,null,null,"X","X","X",null,"X",null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null],[["Untouchable Rager","untouchable_rager"],null,"X",null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null],[["Urban Bloodrager","urban_bloodrager"],"X",null,"X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,null,"X"]],"initialColumn":0,"nullValue":"&nbsp;"}} />
