...
<Ability id="arc-magus-armored_battlemage-medium-armor-ex" icon={["stairs-goal","armor-upgrade"]}>
<Pair single id="arc-magus-armored_battlemage-medium-armor-ex">Medium Armor (Ex)</Pair>
...
<Ability id="arc-magus-armored_battlemage-arcane-pool-su" icon={["broken-shield","armor-upgrade"]}>
<Pair single id="arc-magus-armored_battlemage-arcane-pool-su">Arcane Pool (Su)</Pair>
...
<Pair title="At 5th Level">The enhancement bonus becomes +2. These bonuses can be used to add any of the following armor special abilities: <Link to="/magic-enh/balanced">balanced</Link>, <Link to="/magic-enh/bitter">bitter</Link>, <Link to="/magic-enh/fortification_light">fortification (heavy, light, or medium)</Link>, <Link to="/magic-enh/ghost_touch_a">ghost touch</Link>, <Link to="/magic-enh/invulnerability">invulnerability</Link>, <Link to="/magic-enh/spell_resistance_13">spell resistance (13, 15, 17, or 19)</Link>, or <Link to="/magic-enh/spell_storing_a">spell storing</Link>. Adding these special abilities consumes an amount of bonus equal to the ability's base price modifier. In addition, the armored battlemage can grant his armor the <Link to="/magic-enh/energy_resistance">energy resistance</Link> special ability at the cost of a +3 bonus or the <Link to="/magic-enh/improved_energy_resistance">improved energy resistance</Link> special ability at the cost of a +5 bonus. These special abilities are added to any the armor already has, but duplicates do not stack.</Pair>
<Pair title="At 9th Level">The enhancement bonus increases to +3.</Pair>
<Pair title="At 13th Level">The enhancement bonus becomes +4.</Pair>
...
<Ability id="arc-magus-armored_battlemage-expanded-arcane-pool-su" icon={["upgrade"]}>
<Pair single id="arc-magus-armored_battlemage-expanded-arcane-pool-su">Expanded Arcane Pool (Su)</Pair>
<Pair hl title="Replaces">Greater spell combat</Pair>
<Pair title="Gained">At 14th Level</Pair>
<Pair title="Ability">The armored battlemage can grant his armor the <Link to="/magic-enh/glamered">glamered</Link> special ability at the cost of a +2 bonus, the <Link to="/magic-enh/slick">slick</Link> or <Link to="/magic-enh/shadow">shadow</Link> special ability at the cost of a +3 bonus, and the <Link to="/magic-enh/greater_slick">greater slick</Link> or <Link to="/magic-enh/greater_shadow">greater shadow</Link> special ability at the cost of a +5 bonus when using his <em>arcane pool.</em></Pair>
</Ability>
</>};
...
<Ability id="arc-magus-beastblade-familiar-ex" icon={["stairs-goal"]}>
<Pair single id="arc-magus-beastblade-familiar-ex">Familiar (Ex)</Pair>
...
<Ability id="arc-magus-beastblade-tandem-touch-su" icon={["magic-swirl"]}>
<Pair single id="arc-magus-beastblade-tandem-touch-su">Tandem Touch (Su)</Pair>
...
<Ability id="arc-magus-beastblade-familiar-pool-su" icon={["magic-swirl"]}>
<Pair single id="arc-magus-beastblade-familiar-pool-su">Familiar Pool (Su)</Pair>
...
<Ability id="arc-magus-beastblade-familiar-spellstrike-su" icon={["armor-downgrade"]}>
<Pair single id="arc-magus-beastblade-familiar-spellstrike-su">Familiar Spellstrike (Su)</Pair>
<Pair hl title="Replaces">Improved spell recall</Pair>
<Pair title="Gained">At 11th Level</Pair>
<Pair title="Passive Ability">Whenever a beastblade's familiar successfully delivers a touch spell against a creature the magus threatens, the target provokes an attack of opportunity from the magus.</Pair>
</Ability>
</>};
const _bladebound = {title: "Bladebound", jsx: <><h2 id="arc-magus-bladebound-bladebound">Bladebound</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic pg. 47</Link><br/>A select group of magi are called to carry a <strong className="hl">black blade</strong>: a sentient weapon of often unknown and possibly unknowable purpose. These weapons become valuable tools and allies, as both the magus and weapon typically crave arcane power, but as a <em>black blade</em> becomes more aware, its true motivations manifest, and as does its ability to influence its wielder with its ever-increasing ego.</p>
<h3 id="arc-magus-bladebound-black-blades">Black Blades</h3>
<p>A <em>black blade</em> is a particular form of <Link to="/rule/intelligent_items">intelligent weapon</Link> gained by a magus with the bladebound archetype. There are several ways a magus might gain this weapon. Sometimes it just appears among the magus's possessions, and its origin is a mystery. Other times the magus finds a <em>black blade</em> during an adventure or event of some kind. Sometimes a <em>black blade</em> is passed down generation to generation in an ongoing search for a magus who can unlock its true potential. A <em>black blade</em> is always a one-handed slashing weapon, a <Link to="/eq-weapon/rapier">rapier</Link>, or a <Link to="/eq-weapon/sword_cane">sword cane</Link>. The magus chooses the blade's type upon gaining the blade, and once chosen, it can't be changed. As a bladebound magus increases in level, his <em>black blade</em> gains power. A <em>black blade</em> is independently conscious but features some personality traits reflecting its wielder. A <em>black blade</em> always has the same alignment as its wielder and even changes its alignment if its wielder does. The blade typically works toward its wielder's goals, but not always without argument or backlash. Each <em>black blade</em> has a mission, and while sometimes two or more <em>black blades</em> will work in concert, each mission is singular in purpose (the <em>black blade's</em> mission is usually up to the GM and the needs of the campaign or the adventure, or a GM can roll randomly for the weapon's purpose using the <Link to="/rule/special_purpose_items">Intelligent Item Purpose</Link> table). Some <em>black blades</em> are very open about their missions, but most are secretive. Certain sages have speculated that an invisible hand or arcane purpose moves these weapons.</p>
<ScrollContainer id="arc-magus-bladebound--table-0"><table>
<thead>
<tr>
...
<Ability id="arc-magus-bladebound-black-blade-ex" icon={["stairs-goal","mailed-fist","broken-shield"]}>
<Pair single id="arc-magus-bladebound-black-blade-ex">Black Blade (Ex)</Pair>
<Pair hl title="Replaces">Magus arcana gained at 3rd level</Pair>
<Pair hl title="Alters">Arcane Pool</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<p><strong className="hl">Wisdom and Charisma:</strong> As the bladebound magus increases in level, so do the Wisdom and Charisma of the <em>black blade.</em> These abilities start at 6 and increase by 1 for every two levels of magus.</p>
<p><strong className="hl">Ego:</strong> A <em>black blade</em> starts with an ego of 5, and that ego increases as the blade becomes more powerful. In cases where a wielder and the <em>black blade</em> come into conflict, like any intelligent item, a <em>black blade</em> can attempt to exert its dominance using the <Link to="/rule/items_against_characters">items against characters</Link> rules. Due to its flexible and powerful nature, a <em>black blade</em> has a non-standard ego progression.</p>
<p><strong className="hl">Languages and Skills:</strong> A <em>black blade</em> starts with Common as a language. As the <em>black blade</em> increases in Intelligence, it manifests knowledge of languages and arcane lore. Upon reaching an Intelligence of 12, it gains a bonus language of the GM's choice, and gains 1 rank in Knowledge (arcana). Each time the sword gains a bonus to Intelligence, it gains another language and another rank in Knowledge (arcana).</p>
<p><strong className="hl">Senses:</strong> A <em>black blade</em> is aware of everything around it like a creature that can see and hear. It can be blinded and deafened as if it were a creature. It uses the saving throws of its magus, even if the magus is not currently wielding the <em>black blade.</em></p>
<p><strong className="hl">Black Blade Arcane Pool:</strong> A <em>black blade</em> has an <em>arcane pool</em> with a number of points equal to 1 + its Intelligence bonus.</p>
</blockquote>
</Pair>
</Ability>
<Ability id="arc-magus-bladebound-black-blade-ability-descriptions" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="arc-magus-bladebound-black-blade-ability-descriptions">Black Blade Ability Descriptions</Pair>
...
<Ability id="arc-magus-bladebound-alertness-ex" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="arc-magus-bladebound-alertness-ex">Alertness (Ex)</Pair>
...
<Ability id="arc-magus-bladebound-black-blade-strike-sp" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="arc-magus-bladebound-black-blade-strike-sp">Black Blade Strike (Sp)</Pair>
...
<Pair title="At 9th Level">The bonus increases to +3.</Pair>
<Pair title="At 13th Level">The bonus becomes +4.</Pair>
<Pair title="At 17th Level">The bonus increases to +5.</Pair>
</Ability>
<Ability id="arc-magus-bladebound-telepathy-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="arc-magus-bladebound-telepathy-su">Telepathy (Su)</Pair>
...
<Ability id="arc-magus-bladebound-unbreakable-ex" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-bladebound-unbreakable-ex">Unbreakable (Ex)</Pair>
...
<Ability id="arc-magus-bladebound-energy-attunement-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="arc-magus-bladebound-energy-attunement-su">Energy Attunement (Su)</Pair>
...
<Ability id="arc-magus-bladebound-teleport-blade-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="arc-magus-bladebound-teleport-blade-sp">Teleport Blade (Sp)</Pair>
...
<Ability id="arc-magus-bladebound-transfer-arcana-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="arc-magus-bladebound-transfer-arcana-su">Transfer Arcana (Su)</Pair>
...
<Ability id="arc-magus-bladebound-spell-defense-sp" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-bladebound-spell-defense-sp">Spell Defense (Sp)</Pair>
...
<ul>
<li>The <em>black blade</em> restores 2 points to its <em>arcane pool.</em></li>
<li>The <em>black blade</em> restores 1 point to its <em>arcane pool</em> and the magus restores 1 point to his <em>arcane pool.</em></li>
<li>The magus gains a number of <Link to="/rule/temporary_hit_points">temporary hit points</Link> equal to the <em>black blade's</em> ego (these temporary hit points last until spent or 1 minute, whichever is shorter).</li>
</ul>
</Pair>
<Pair title="Special">The creature killed must have a number of Hit Dice equal to half the magus's character level for this to occur.</Pair>
</Ability>
<p><strong className="hl">Magus Arcana:</strong> The following magus arcana complement the bladebound magus archetype: <Link to="/arcana/arcane_accuracy">arcane accuracy</Link>, <Link to="/arcana/broad_study">broad study</Link>, <Link to="/arcana/dispelling_strike">dispelling strike</Link>, and <Link to="/arcana/reflection">reflection</Link>.</p>
</>};
...
<Ability id="arc-magus-card_caster-deadly-dealer-su" icon={["stairs-goal"]}>
<Pair single id="arc-magus-card_caster-deadly-dealer-su">Deadly Dealer (Su)</Pair>
...
<Ability id="arc-magus-card_caster-arcane-pool-focus-su" icon={["broken-shield"]}>
<Pair single id="arc-magus-card_caster-arcane-pool-focus-su">Arcane Pool Focus (Su)</Pair>
<Pair hl title="Alters">Arcane pool</Pair>
...
<Ability id="arc-magus-card_caster-harrowed-spellstrike-su" icon={["bowman","magic-swirl"]}>
<Pair single id="arc-magus-card_caster-harrowed-spellstrike-su">Harrowed Spellstrike (Su)</Pair>
...
<Ability id="arc-magus-card_caster-role-dealer-su" icon={["upgrade"]}>
<Pair single id="arc-magus-card_caster-role-dealer-su">Role Dealer (Su)</Pair>
<Pair hl title="Replaces">Magus arcana gained at 3rd level</Pair>
<Pair title="Gained">At 3rd Level</Pair>
<Pair title="Passive Ability">Whenever the card caster randomly draws and throws a harrow card matching one axis of his alignment, the card's critical threat range increases to 19-20. If the card caster draws and throws a harrow card matching his alignment exactly, the attack's critical multiplier also increases to &times;3 and the magus gains a +4 bonus on his confirmation roll.</Pair>
</Ability>
</>};
...
<Ability id="arc-magus-deep_marshal-weapon-and-armor-proficiency" icon={["upgrade"]}>
<Pair single id="arc-magus-deep_marshal-weapon-and-armor-proficiency">Weapon and Armor Proficiency</Pair>
...
<Ability id="arc-magus-deep_marshal-deep-spellcasting" icon={["spell-book","broken-shield"]}>
<Pair single id="arc-magus-deep_marshal-deep-spellcasting">Deep Spellcasting</Pair>
...
<Ability id="arc-magus-deep_marshal-bound-by-tradition" icon={["broken-shield"]}>
<Pair single id="arc-magus-deep_marshal-bound-by-tradition">Bound by Tradition</Pair>
...
<Ability id="arc-magus-deep_marshal-miners-focus-suex" icon={["upgrade"]}>
<Pair single id="arc-magus-deep_marshal-miners-focus-suex">Miner's Focus (Su/Ex)</Pair>
<Pair hl title="Replaces">Magus arcana gained at 3rd level</Pair>
<Pair title="Gained">At 3rd Level</Pair>
<Pair title="Ability">A deep marshal can use the magical properties of her weapon in order to augment her spellcasting. Whenever she casts a magus spell while wielding a magic battleaxe, heavy pick, warhammer, or weapon with the word "dwarven" in its name, she adds half the weapon's enhancement bonus to the her caster level (minimum +1). When attempting a caster level check to overcome spell resistance, she instead adds her weapon's full enhancement bonus.</Pair>
<Pair title="Passive Ability">In addition, she is treated as having a number of ranks in Knowledge (dungeoneering) and Profession (miner) equal to her magus level, and she attempts Profession (miner) checks using her Intelligence modifier instead of her Wisdom modifier.</Pair>
</Ability>
</>};
...
<Ability id="arc-magus-eldritch_archer-arcane-pool-su" icon={["stairs-goal","broken-shield"]}>
<Pair single id="arc-magus-eldritch_archer-arcane-pool-su">Arcane Pool (Su)</Pair>
<Pair hl title="Alters">Arcane pool</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="arc-magus-eldritch_archer-ranged-weapon-bond-ex" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="arc-magus-eldritch_archer-ranged-weapon-bond-ex">Ranged Weapon Bond (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="arc-magus-eldritch_archer-ranged-spell-combat-ex" icon={["stairs-goal","bowman"]}>
<Pair single id="arc-magus-eldritch_archer-ranged-spell-combat-ex">Ranged Spell Combat (Ex)</Pair>
...
<Ability id="arc-magus-eldritch_archer-ranged-spellstrike-su" icon={["bowman","smoking-finger"]}>
<Pair single id="arc-magus-eldritch_archer-ranged-spellstrike-su">Ranged Spellstrike (Su)</Pair>
...
<Ability id="arc-magus-eldritch_archer-focusing-spellstrike-su" icon={["magic-swirl"]}>
<Pair single id="arc-magus-eldritch_archer-focusing-spellstrike-su">Focusing Spellstrike (Su)</Pair>
<Pair hl title="Replaces">Counterstrike</Pair>
<Pair title="Gained">At 16th Level</Pair>
<Pair title="Ability">An eldritch archer can use <em>ranged spellstrike</em> to deliver a cone- or line-shaped spell as a ray, affecting only the creature or object struck.</Pair>
</Ability>
</>};
...
<Ability id="arc-magus-eldritch_scion-bloodline" icon={["stairs-goal"]}>
<Pair single id="arc-magus-eldritch_scion-bloodline">Bloodline</Pair>
<Pair hl title="Replaces">Spell recall</Pair>
...
<Ability id="arc-magus-eldritch_scion-spell-combat-ex" icon={["broken-shield"]}>
<Pair single id="arc-magus-eldritch_scion-spell-combat-ex">Spell Combat (Ex)</Pair>
<Pair hl title="Alters">Spell combat</Pair>
...
<Ability id="arc-magus-eldritch_scion-bonus-spells" icon={["spell-book"]}>
<Pair single id="arc-magus-eldritch_scion-bonus-spells">Bonus Spells</Pair>
<Pair hl title="Replaces">Knowledge pool</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="arc-magus-eldritch_scion-improved-spell-combat-ex" icon={["stairs-goal"]}>
<Pair single id="arc-magus-eldritch_scion-improved-spell-combat-ex">Improved Spell Combat (Ex)</Pair>
...
<Ability id="arc-magus-eldritch_scion-greater-spell-combat-ex" icon={["stairs-goal"]}>
<Pair single id="arc-magus-eldritch_scion-greater-spell-combat-ex">Greater Spell Combat (Ex)</Pair>
<Pair hl title="Alters">Greater spell combat</Pair>
<Pair title="Gained">At 18th Level</Pair>
<Pair title="Ability">An eldritch scion gains the <em>greater spell combat</em> class feature.</Pair>
</Ability>
</>};
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-magus-elemental_knight--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><Link to="/race/suli">Suli</Link></td></tr></tbody></table></ScrollContainer></div><Ability id="arc-magus-elemental_knight-elemental-arcana-su" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="arc-magus-elemental_knight-elemental-arcana-su">Elemental Arcana (Su)</Pair>
<Pair title="Gained">At 3rd Level</Pair>
<Pair title="Ability">Elemental knights may select the following magus arcana available only to them.</Pair>
</Ability>
<Ability id="arc-magus-elemental_knight-assault-synergy-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="arc-magus-elemental_knight-assault-synergy-su">Assault Synergy (Su)</Pair>
...
<Ability id="arc-magus-elemental_knight-energy-reflection-su" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-elemental_knight-energy-reflection-su">Energy Reflection (Su)</Pair>
...
<Ability id="arc-magus-elemental_knight-energy-resistance-boost-su" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-elemental_knight-energy-resistance-boost-su">Energy Resistance Boost (Su)</Pair>
...
<Ability id="arc-magus-elemental_knight-elemental-matrix-su" icon={["stairs-goal"]}>
<Pair single id="arc-magus-elemental_knight-elemental-matrix-su">Elemental Matrix (Su)</Pair>
<Pair hl title="Replaces">Spell recall</Pair>
<Pair title="Gained">At 4th Level</Pair>
<Pair title="Ability">An elemental knight gains <Link to="/feat/incremental_elemental_assault">Incremental Elemental Assault</Link> as a bonus feat.</Pair>
<Pair title="Swift Action">An elemental knight may expend rounds of duration from his <em>elemental assault</em> ability. For every 4 rounds expended, he gains 1 <em>arcane pool</em> point.</Pair>
</Ability>
<p><strong className="hl">Magus Arcana:</strong> The following magus arcana complement the elemental knight archetype: <Link to="/arcana/empowered_magic">empowered magic</Link>, <Link to="/arcana/pool_strike">pool strike</Link>, <Link to="/arcana/spell_shield">spell shield</Link>.</p>
</>};
...
<Ability id="arc-magus-esoteric-weapon-and-armor-proficiency" icon={["broken-shield"]}>
<Pair single id="arc-magus-esoteric-weapon-and-armor-proficiency">Weapon and Armor Proficiency</Pair>
...
<Ability id="arc-magus-esoteric-diminished-spellcasting" icon={["broken-shield","magic-swirl"]}>
<Pair single id="arc-magus-esoteric-diminished-spellcasting">Diminished Spellcasting</Pair>
<Pair hl title="Alters">Spellcasting</Pair>
...
<Ability id="arc-magus-esoteric-arcane-pool-su" icon={["mailed-fist"]}>
<Pair single id="arc-magus-esoteric-arcane-pool-su">Arcane Pool (Su)</Pair>
<Pair hl title="Alters">Arcane pool</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="arc-magus-esoteric-ki-arcana-su" icon={["stairs-goal"]}>
<Pair single id="arc-magus-esoteric-ki-arcana-su">Ki Arcana (Su)</Pair>
<Pair hl title="Replaces">Spell recall</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="arc-magus-esoteric-tattooed-spell-sp" icon={["magic-swirl"]}>
<Pair single id="arc-magus-esoteric-tattooed-spell-sp">Tattooed Spell (Sp)</Pair>
<Pair hl title="Replaces">Bonus feats</Pair>
<Pair title="Gained">At 5th Level</Pair>
<Pair title="Ability">An esoteric can permanently tattoo one spell from his magus spellbook onto his body. The spell that is tattooed must be of 2nd-level or lower and not have an expensive material component or a focus.</Pair>
<Pair title="At 11th Level">He can tattoo a second spell following the restrictions above, except the spell must be of 4th level or lower.</Pair>
...
<Ability id="arc-magus-esoteric-ac-bonus-ex" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-esoteric-ac-bonus-ex">AC Bonus (Ex)</Pair>
...
<Ability id="arc-magus-esoteric-improved-tattooed-spell-sp" icon={["upgrade"]}>
<Pair single id="arc-magus-esoteric-improved-tattooed-spell-sp">Improved Tattooed Spell (Sp)</Pair>
<Pair hl title="Replaces">Improved spell recall</Pair>
<Pair title="Gained">At 11th Level</Pair>
<Pair title="Ability">An esoteric can use each of his spell-like abilities from <em>tattooed spell</em> one additional time per day.</Pair>
</Ability>
</>};
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-magus-fiend_flayer--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><Link to="/race/tiefling">Tiefling</Link></td></tr></tbody></table></ScrollContainer></div><Ability id="arc-magus-fiend_flayer-infernal-mortification-su" icon={["stairs-goal","broken-shield"]}>
<Pair single id="arc-magus-fiend_flayer-infernal-mortification-su">Infernal Mortification (Su)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="arc-magus-fiend_flayer-magus-arcana" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="arc-magus-fiend_flayer-magus-arcana">Magus Arcana</Pair>
...
<Ability id="arc-magus-fiend_flayer-fiendblade-su" extraClasses="subAbility" icon={["mailed-fist"]}>
<Pair single id="arc-magus-fiend_flayer-fiendblade-su">Fiendblade (Su)</Pair>
...
<Pair title="At 7th Level">The weapon's bonus becomes +2.</Pair>
<Pair title="At 11th Level">The weapon's bonus increases to +3.</Pair>
<Pair title="At 15th Level">The weapon's bonus becomes +4.</Pair>
...
<Ability id="arc-magus-fiend_flayer-bypassing-strike-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="arc-magus-fiend_flayer-bypassing-strike-su">Bypassing Strike (Su)</Pair>
...
<Ability id="arc-magus-greensting_slayer-arcane-pool" icon={["stairs-goal","broken-shield"]}>
<Pair single id="arc-magus-greensting_slayer-arcane-pool">Arcane Pool</Pair>
<Pair hl title="Alters">Arcane pool</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Swift Action">A greensting slayer can expend 1 point from his <em>arcane pool</em> to add 1d6 points of <Link to="/ability/sneak_attack">sneak attack</Link> damage to his next melee attack that round. The attack must meet all of the usual prerequisites for making a sneak attack, as the <Link to="/class/rogue">rogue</Link> class feature.</Pair>
<Pair title="At 5th Level">The amount of sneak attack damage becomes +2d6.</Pair>
<Pair title="At 9th Level">The amount of sneak attack damage increases to +3d6.</Pair>
<Pair title="At 13th Level">The amount of sneak attack damage becomes +4d6.</Pair>
...
<Ability id="arc-magus-greensting_slayer-evasion-ex" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-greensting_slayer-evasion-ex">Evasion (Ex)</Pair>
...
<Ability id="arc-magus-greensting_slayer-improved-evasion-ex" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-greensting_slayer-improved-evasion-ex">Improved Evasion (Ex)</Pair>
...
<Ability id="arc-magus-greensting_slayer-magus-arcana" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="arc-magus-greensting_slayer-magus-arcana">Magus Arcana</Pair>
...
<Ability id="arc-magus-greensting_slayer-dark-shifter-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="arc-magus-greensting_slayer-dark-shifter-su">Dark Shifter (Su)</Pair>
...
<Pair title="Special">If the spell effect the magus is moving originated from another creature, the magus must succeed at a caster level check to reposition the effect (DC = 11 + the effect's caster level). Failure wastes the magus's move action, but does not expend the point from his <em>arcane pool.</em></Pair>
</Ability>
</>};
...
<Ability id="arc-magus-hexbreaker-repel-curse-su" icon={["shield-reflect","spell-book"]}>
<Pair single id="arc-magus-hexbreaker-repel-curse-su" flavor="A hexbreaker has the chance to protect others from being cursed.">Repel Curse (Su)</Pair>
<Pair hl title="Replaces">Spell recall</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="arc-magus-hexbreaker-counter-curse-su" icon={["shield-reflect"]}>
<Pair single id="arc-magus-hexbreaker-counter-curse-su">Counter Curse (Su)</Pair>
<Pair hl title="Replaces">Improved spell recall</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="arc-magus-hexbreaker-hexbreaker-arcana" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="arc-magus-hexbreaker-hexbreaker-arcana">Hexbreaker Arcana</Pair>
<Pair title="Info">A hexbreaker can select from the following arcana in addition to those normally available.</Pair>
</Ability>
<Ability id="arc-magus-hexbreaker-improved-remove-curse-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="arc-magus-hexbreaker-improved-remove-curse-su">Improved Remove Curse (Su)</Pair>
...
<Ability id="arc-magus-hexbreaker-wracking-dispel-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="arc-magus-hexbreaker-wracking-dispel-su">Wracking Dispel (Su)</Pair>
...
<p><strong>Magus Arcana:</strong> The following magus arcana complement the hexbreaker: <Link to="/arcana/bane_blade">bane blade</Link>, <Link to="/arcana/dispelling_strike">dispelling strike</Link>, <Link to="/arcana/disruptive">disruptive</Link>, <Link to="/arcana/lingering_pain">lingering pain</Link>, <Link to="/arcana/spellbreaker">spellbreaker</Link>, and <Link to="/arcana/reflection">reflection</Link>.</p>
</>};
...
<Ability id="arc-magus-hexcrafter-hex-magus-su" icon={["stairs-goal"]}>
<Pair single id="arc-magus-hexcrafter-hex-magus-su">Hex Magus (Su)</Pair>
<Pair hl title="Replaces">Spell recall</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="arc-magus-hexcrafter-hex-arcana" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="arc-magus-hexcrafter-hex-arcana">Hex Arcana</Pair>
...
<Ability id="arc-magus-hexcrafter-accursed-strike-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="arc-magus-hexcrafter-accursed-strike-sp">Accursed Strike (Sp)</Pair>
...
<Ability id="arc-magus-hexcrafter-spells" icon={["spell-book"]}>
<Pair single id="arc-magus-hexcrafter-spells">Spells</Pair>
...
<p><strong>Magus Arcana:</strong> The following magus arcana complement the hexcrafter archetype: <Link to="/arcana/arcane_accuracy">arcane accuracy</Link>, <Link to="/arcana/broad_study">broad study</Link>, <Link to="/arcana/familiar">familiar</Link>, and <Link to="/arcana/quickened_magic">quickened magic</Link>.</p>
</>};
...
<Ability id="arc-magus-iron_ring_striker-weapon-proficiency" icon={["broken-shield"]}>
<Pair single id="arc-magus-iron_ring_striker-weapon-proficiency">Weapon Proficiency</Pair>
...
<Ability id="arc-magus-iron_ring_striker-diminished-spellcasting" icon={["broken-shield"]}>
<Pair single id="arc-magus-iron_ring_striker-diminished-spellcasting">Diminished Spellcasting</Pair>
<Pair hl title="Alters">Spellcasting</Pair>
...
<Ability id="arc-magus-iron_ring_striker-arcane-pool-su" icon={["mailed-fist"]}>
<Pair single id="arc-magus-iron_ring_striker-arcane-pool-su">Arcane Pool (Su)</Pair>
<Pair hl title="Alters">Arcane pool</Pair>
...
<Ability id="arc-magus-iron_ring_striker-unarmed-spellstrike-su" icon={["broken-shield"]}>
<Pair single id="arc-magus-iron_ring_striker-unarmed-spellstrike-su">Unarmed Spellstrike (Su)</Pair>
<Pair hl title="Alters">Spellstrike</Pair>
...
<Ability id="arc-magus-iron_ring_striker-empower-combat-su" icon={["upgrade"]}>
<Pair single id="arc-magus-iron_ring_striker-empower-combat-su" flavor="An iron-ring striker learns to use magic to grant himself the power of a larger creature.">Empower Combat (Su)</Pair>
<Pair hl title="Replaces">Medium armor, heavy armor</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="arc-magus-iron_ring_striker-spell-maneuvers-su" icon={["mailed-fist"]}>
<Pair single id="arc-magus-iron_ring_striker-spell-maneuvers-su">Spell Maneuvers (Su)</Pair>
<Pair hl title="Replaces">Knowledge pool</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="arc-magus-iron_ring_striker-reflexive-spell-maneuver-ex" icon={["armor-upgrade","magic-swirl"]}>
<Pair single id="arc-magus-iron_ring_striker-reflexive-spell-maneuver-ex">Reflexive Spell Maneuver (Ex)</Pair>
<Pair hl title="Replaces">Counterstrike</Pair>
<Pair title="Gained">At 16th Level</Pair>
<Pair title="Immediate Action">When an iron-ring striker is the target of a combat maneuver check to bull rush, disarm, sunder, or trip, he can target his attacker with a magus spell he has prepared with a range of touch. If the spell would normally require a touch attack, an iron-ring striker can attempt a combat maneuver check for this attack instead.</Pair>
<Pair title="Special">The iron-ring striker must be wearing light armor or no armor to use reflexive spell maneuver.</Pair>
</Ability>
</>};
...
<Ability id="arc-magus-jistkan_artificer-diminished-spellcasting" icon={["broken-shield"]}>
<Pair single id="arc-magus-jistkan_artificer-diminished-spellcasting">Diminished Spellcasting</Pair>
<Pair hl title="Alters">Spellcasting</Pair>
...
<Pair title="At 1st Level">A Jistkan artificer can use his <em>arcane pool</em> to enhance his unarmed strikes as if they were manufactured weapons.</Pair>
...
<Ability id="arc-magus-jistkan_artificer-empowered-arm-ex" icon={["upgrade"]}>
<Pair single id="arc-magus-jistkan_artificer-empowered-arm-ex">Empowered Arm (Ex)</Pair>
<Pair hl title="Replaces">The magus arcana gained at 3rd level</Pair>
<Pair title="Gained">At 3rd Level</Pair>
<Pair title="Ability">A Jistkan artificer's <em>golem arm</em> is treated as a magic weapon and gains a +1 enhancement bonus on attack and damage rolls.</Pair>
...
<Ability id="arc-magus-jistkan_artificer-unarmed-spellstrike-su" icon={["broken-shield"]}>
<Pair single id="arc-magus-jistkan_artificer-unarmed-spellstrike-su">Unarmed Spellstrike (Su)</Pair>
<Pair hl title="Alters">Spellstrike</Pair>
...
<Ability id="arc-magus-jistkan_artificer-magus-arcana" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="arc-magus-jistkan_artificer-magus-arcana">Magus Arcana</Pair>
...
<Ability id="arc-magus-jistkan_artificer-break-spell-ex" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-jistkan_artificer-break-spell-ex">Break Spell (Ex)</Pair>
...
<Ability id="arc-magus-jistkan_artificer-flurrying-arm-ex" extraClasses="subAbility" icon={["stairs-goal","mailed-fist"]}>
<Pair single id="arc-magus-jistkan_artificer-flurrying-arm-ex">Flurrying Arm (Ex)</Pair>
...
<Ability id="arc-magus-jistkan_artificer-sharpened-arm-ex" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="arc-magus-jistkan_artificer-sharpened-arm-ex">Sharpened Arm (Ex)</Pair>
...
<Ability id="arc-magus-jistkan_artificer-shielding-arm-ex" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-jistkan_artificer-shielding-arm-ex">Shielding Arm (Ex)</Pair>
...
<Ability id="arc-magus-kapenia_dancer-weapon-and-armor-proficiency" icon={["stairs-goal","broken-shield"]}>
<Pair single id="arc-magus-kapenia_dancer-weapon-and-armor-proficiency">Weapon and Armor Proficiency</Pair>
...
<Ability id="arc-magus-kapenia_dancer-diminished-spellcasting" icon={["broken-shield"]}>
<Pair single id="arc-magus-kapenia_dancer-diminished-spellcasting">Diminished Spellcasting</Pair>
...
<Ability id="arc-magus-kapenia_dancer-canny-defense-ex" extraClasses="hasSubs" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-kapenia_dancer-canny-defense-ex">Canny Defense (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="arc-magus-kapenia_dancer-from-the-duelist-class" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-kapenia_dancer-from-the-duelist-class">From the Duelist class</Pair>
...
<Ability id="arc-magus-kapenia_dancer-weapon-focus-ex" icon={["stairs-goal"]}>
<Pair single id="arc-magus-kapenia_dancer-weapon-focus-ex">Weapon Focus (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Ability">A kapenia dancer gains <Link to="/feat/weapon_focus">Weapon Focus</Link> (bladed scarf) as a bonus feat.</Pair>
</Ability>
<Ability id="arc-magus-kapenia_dancer-kapenia-dancer-arcana" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="arc-magus-kapenia_dancer-kapenia-dancer-arcana">Kapenia Dancer Arcana</Pair>
...
<Ability id="arc-magus-kapenia_dancer-elasticity-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="arc-magus-kapenia_dancer-elasticity-su">Elasticity (Su)</Pair>
...
<Ability id="arc-magus-kapenia_dancer-kapenia-curse-su" extraClasses="subAbility" icon={["armor-downgrade"]}>
<Pair single id="arc-magus-kapenia_dancer-kapenia-curse-su">Kapenia Curse (Su)</Pair>
...
<Ability id="arc-magus-kapenia_dancer-spirit-fingers-su" extraClasses="subAbility" icon={["mailed-fist"]}>
<Pair single id="arc-magus-kapenia_dancer-spirit-fingers-su">Spirit Fingers (Su)</Pair>
...
<Ability id="arc-magus-kapenia_dancer-spirit-step-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="arc-magus-kapenia_dancer-spirit-step-su">Spirit Step (Su)</Pair>
<Pair title="Prerequisites">12th-level magus</Pair>
...
<p><strong>Magus Arcana:</strong> The following magus arcana complement the kapenia dancer archetype: <Link to="/arcana/arcane_cloak">arcane cloak</Link>, <Link to="/arcana/dispelling_strike">dispelling strike</Link>, <Link to="/arcana/hasted_assault">hasted assault</Link>, <Link to="/arcana/maneuver_mastery">maneuver mastery</Link>, <Link to="/arcana/prescient_attack">prescient attack</Link>, <Link to="/arcana/prescient_defense">prescient defense</Link>.</p>
</>};
...
<Ability id="arc-magus-kensai-weapon-and-armor-proficiency" icon={["stairs-goal","broken-shield"]}>
<Pair single id="arc-magus-kensai-weapon-and-armor-proficiency">Weapon and Armor Proficiency</Pair>
...
<Ability id="arc-magus-kensai-diminished-spellcasting" icon={["broken-shield"]}>
<Pair single id="arc-magus-kensai-diminished-spellcasting">Diminished Spellcasting</Pair>
...
<Ability id="arc-magus-kensai-canny-defense-ex" extraClasses="hasSubs" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-kensai-canny-defense-ex">Canny Defense (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="arc-magus-kensai-from-the-duelist-class" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-kensai-from-the-duelist-class">From the Duelist class</Pair>
<Pair title="Passive Ability">When wearing light or no armor and not using a shield, a duelist adds 1 point of Intelligence bonus (if any) per duelist class level as a dodge bonus to her Armor Class while wielding a melee weapon. If a duelist is caught <Link to="/rule/flat_footed">flat-footed</Link> or otherwise denied her Dexterity bonus, she also loses this bonus.</Pair>
</Ability>
<Ability id="arc-magus-kensai-weapon-focus-ex" icon={["stairs-goal"]}>
<Pair single id="arc-magus-kensai-weapon-focus-ex">Weapon Focus (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="arc-magus-kensai-perfect-strike-ex" icon={["mailed-fist","upgrade"]}>
<Pair single id="arc-magus-kensai-perfect-strike-ex">Perfect Strike (Ex)</Pair>
<Pair hl title="Replaces">Spell recall</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="arc-magus-kensai-fighter-training-ex" icon={["stairs-goal"]}>
<Pair single id="arc-magus-kensai-fighter-training-ex">Fighter Training (Ex)</Pair>
<Pair hl title="Replaces">Knowledge pool</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="arc-magus-kensai-iaijutsu-ex" icon={["upgrade"]}>
<Pair single id="arc-magus-kensai-iaijutsu-ex">Iaijutsu (Ex)</Pair>
<Pair hl title="Replaces">Medium armor</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="arc-magus-kensai-critical-perfection-ex" icon={["upgrade","stairs-goal"]}>
<Pair single id="arc-magus-kensai-critical-perfection-ex">Critical Perfection (Ex)</Pair>
...
<Ability id="arc-magus-kensai-superior-reflexes-ex" icon={["stairs-goal"]}>
<Pair single id="arc-magus-kensai-superior-reflexes-ex">Superior Reflexes (Ex)</Pair>
<Pair hl title="Replaces">Improved spell recall</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="arc-magus-kensai-iaijutsu-focus-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="arc-magus-kensai-iaijutsu-focus-ex">Iaijutsu Focus (Ex)</Pair>
<Pair hl title="Replaces">Heavy armor</Pair>
<Pair title="Gained">At 13th Level</Pair>
...
<Ability id="arc-magus-kensai-iaijutsu-master-ex" icon={["upgrade","rolling-dices"]}>
<Pair single id="arc-magus-kensai-iaijutsu-master-ex">Iaijutsu Master (Ex)</Pair>
...
<Ability id="arc-magus-kensai-weapon-mastery-ex" icon={["stairs-goal"]}>
<Pair single id="arc-magus-kensai-weapon-mastery-ex">Weapon Mastery (Ex)</Pair>
<Pair hl title="Replaces">True magus</Pair>
<Pair title="Gained">At 20th Level</Pair>
<Pair title="Ability">A kensai gains <em>weapon mastery</em> with his favored weapon, as the <Link to="/class/fighter">fighter</Link> class ability.</Pair>
</Ability>
<p><strong>Magus Arcana:</strong> The following magus arcana complement the kensai archetype: <Link to="/arcana/concentrate">concentrate</Link>, <Link to="/arcana/critical_strike">critical strike</Link>, <Link to="/arcana/prescient_attack">prescient attack</Link>, <Link to="/arcana/prescient_defense">prescient defense</Link>, <Link to="/arcana/spell_shield">spell shield</Link>.</p>
</>};
...
<Ability id="arc-magus-magic_warrior-nameless-mask-ex" icon={["armor-upgrade","broken-shield","hazard-sign"]}>
<Pair single id="arc-magus-magic_warrior-nameless-mask-ex">Nameless Mask (Ex)</Pair>
...
<Ability id="arc-magus-magic_warrior-magic-warriors-aspect-su" icon={["stairs-goal"]}>
<Pair single id="arc-magus-magic_warrior-magic-warriors-aspect-su">Magic Warrior's Aspect (Su)</Pair>
<Pair hl title="Replaces">Magus arcana gained at 3rd level</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="arc-magus-magic_warrior-nameless-anonymity-su" icon={["armor-upgrade","broken-shield"]}>
<Pair single id="arc-magus-magic_warrior-nameless-anonymity-su" flavor="A Magic Warrior's masked identity further protects her from divinations.">Nameless Anonymity (Su)</Pair>
<Pair hl title="Replaces">Greater spell combat</Pair>
<Pair hl title="Alters">Improved spell combat</Pair>
...
<Ability id="arc-magus-magic_warrior-magaambya-spell-access-su" icon={["spell-book"]}>
<Pair single id="arc-magus-magic_warrior-magaambya-spell-access-su">Magaambya Spell Access (Su)</Pair>
<Pair hl title="Replaces">Greater spell access</Pair>
<Pair title="Gained">At 19th Level</Pair>
<Pair title="Ability">A Magic Warrior learns ancient secrets to using natural magic. She learns seven spells from the <Link to="/main/spells_druid">spells_druid's spell list</Link> and places them in her spellbook as magus spells of the same level at which they appear on the druid spell list. She gains one druid spell not on the magus spell list for each of the listed spell levels: 0 level, 1st level, 2nd level, 3rd level, 4th level, 5th level, and 6th level. She can ignore the divine focus component of these spells.</Pair>
</Ability>
<p><strong>Magus Arcana:</strong> The following magus arcana complement the Magic Warrior archetype: <Link to="/arcana/accurate_strike">accurate strike</Link>, <Link to="/arcana/arcane_accuracy">arcane accuracy</Link>, <Link to="/arcana/arcane_cloak">arcane cloak</Link>, <Link to="/arcana/arcane_edge">arcane edge</Link>, <Link to="/arcana/bane_blade">bane blade</Link>, <Link to="/arcana/devoted_blade">devoted blade</Link>, <Link to="/arcana/empowered_magic">empowered magic</Link>, <Link to="/arcana/maximized_magic">maximized magic</Link>, <Link to="/arcana/quickened_magic">quickened magic</Link>, <Link to="/arcana/silent_magic">silent magic</Link>, <Link to="/arcana/spell_blending">spell blending</Link>, and <Link to="/arcana/still_magic">still magic</Link>.</p>
</>};
...
<p>At 5th level and every 3 levels thereafter, a mindblade can learn a new spell in place of one she already knows, using the same rules as a bard. In effect, the mindblade loses the old spell in exchange for the new one. The new spell's level must be the same as that of the spell being exchanged, and the new spell must be at least 1 level lower than the highest-level spell the mindblade can cast.</p>
...
<Ability id="arc-magus-mindblade-psychic-pool-su" icon={["magic-swirl","mailed-fist"]}>
<Pair single id="arc-magus-mindblade-psychic-pool-su">Psychic Pool (Su)</Pair>
<Pair hl title="Replaces">Arcane pool</Pair>
<Pair title="Ability">A mindblade gains a <em>psychic pool,</em> similar to a normal magus's <em>arcane pool.</em></Pair>
<Pair title="At 1st Level">A mindblade can expend 1 point from her <em>psychic pool</em> as a <strong className="hl">standard action</strong> to manifest a light melee weapon of her choice, formed from psychic energy. By spending 2 points, the mindblade can manifest a one-handed melee weapon, and by spending 3 points, she can manifest a two-handed melee weapon (but not a <Link to="/misc/double">double</Link> weapon). This psychic weapon can last indefinitely, but it vanishes if it leaves the mindblade's hand. The mindblade can dismiss a held psychic weapon as a <strong className="hl">free action</strong>. When a psychic weapon vanishes, the mindblade regains the psychic energy used to create it. She can maintain only one weapon at a time. A psychic weapon counts as a magic weapon of whatever type the mindblade selected, with an enhancement bonus equal to 1 + <Link to="/misc/one_third">one-third</Link> of her magus level, to a maximum of +5 at 12th level. At 15th and 18th levels, the weapon gains an additional +1 enhancement bonus, which the mindblade can spend only on weapon special abilities (see below).</Pair>
...
<Ability id="arc-magus-mindblade-psychic-access-su" icon={["spell-book"]}>
<Pair single id="arc-magus-mindblade-psychic-access-su">Psychic Access (Su)</Pair>
<Pair hl title="Replaces">Spell recall, knowledge pool, improved spell recall, greater spell combat, greater spell access</Pair>
<Pair title="Gained">At 4th Level</Pair>
<Pair title="Ability">The mindblade gains access to an expanded spell list. She adds two spells from the <Link to="/main/spells_psychic">psychic class spell list</Link> to her magus spell list as magus spells of the same spell level. These must be spells of levels the mindblade is able to cast.</Pair>
<Pair title="At 7th Level">She adds two more psychic class spells to her spell list, following the same restrictions.</Pair>
<Pair title="At 11th Level">She adds two more psychic class spells to her spell list, following the same restrictions.</Pair>
<Pair title="At 14th Level">She adds two more psychic class spells to her spell list, following the same restrictions.</Pair>
...
<Ability id="arc-magus-mindblade-dual-weapons-su" icon={["stairs-goal","mailed-fist"]}>
<Pair single id="arc-magus-mindblade-dual-weapons-su">Dual Weapons (Su)</Pair>
<Pair hl title="Replaces">Medium armor</Pair>
...
<Ability id="arc-magus-mindblade-rapid-manifest-su" icon={["upgrade"]}>
<Pair single id="arc-magus-mindblade-rapid-manifest-su">Rapid Manifest (Su)</Pair>
...
<Ability id="arc-magus-mindblade-dual-manifest-su" icon={["upgrade"]}>
<Pair single id="arc-magus-mindblade-dual-manifest-su">Dual Manifest (Su)</Pair>
<Pair hl title="Replaces">Heavy armor</Pair>
<Pair title="Gained">At 13th Level</Pair>
<Pair title="Ability">A mindblade can manifest two psychic weapons with the same action. She must pay the cost for both weapons. Also, when wielding a weapon two-handed, she can use her <em>spell combat</em> ability as though she had a hand free.</Pair>
</Ability>
</>};
...
<Ability id="arc-magus-myrmidarch-diminished-spellcasting" icon={["broken-shield"]}>
<Pair single id="arc-magus-myrmidarch-diminished-spellcasting">Diminished Spellcasting</Pair>
...
<Ability id="arc-magus-myrmidarch-ranged-spellstrike-su" icon={["bowman"]}>
<Pair single id="arc-magus-myrmidarch-ranged-spellstrike-su">Ranged Spellstrike (Su)</Pair>
...
<Pair hl title="Replaces">True magus</Pair>
<Pair title="Gained">At 20th Level</Pair>
<Pair title="Passive Ability">A myrmidarch gains DR 5/- when wearing armor.</Pair>
</Ability>
<p><strong>Magus Arcana:</strong> The following magus arcana complement the myrmidarch archetype: <Link to="/arcana/accurate_strike">accurate strike</Link>, <Link to="/arcana/arcane_edge">arcane edge</Link>, <Link to="/arcana/lingering_pain">lingering pain</Link>, <Link to="/arcana/prescient_attack">prescient attack</Link>, <Link to="/arcana/prescient_defense">prescient defense</Link>, <Link to="/arcana/spell_shield">spell shield</Link>, <Link to="/arcana/spellbreaker">spellbreaker</Link>.</p>
</>};
...
<Ability id="arc-magus-nature_bonded_magus-natural-magic" icon={["spell-book"]}>
<Pair single id="arc-magus-nature_bonded_magus-natural-magic">Natural Magic</Pair>
...
<Ability id="arc-magus-nature_bonded_magus-plant-familiar" icon={["stairs-goal"]}>
<Pair single id="arc-magus-nature_bonded_magus-plant-familiar">Plant Familiar</Pair>
<Pair hl title="Replaces">Arcane pool</Pair>
...
<Ability id="arc-magus-nature_bonded_magus-familiar-symbiosis-su" icon={["stairs-goal","armor-upgrade"]}>
<Pair single id="arc-magus-nature_bonded_magus-familiar-symbiosis-su">Familiar Symbiosis (Su)</Pair>
<Pair hl title="Replaces">Spell recall</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="arc-magus-nature_bonded_magus-woodland-stride-ex" icon={["stairs-goal"]}>
<Pair single id="arc-magus-nature_bonded_magus-woodland-stride-ex">Woodland Stride (Ex)</Pair>
<Pair hl title="Replaces">Knowledge pool</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="arc-magus-nature_bonded_magus-improved-familiar-symbiosis-su" icon={["upgrade"]}>
<Pair single id="arc-magus-nature_bonded_magus-improved-familiar-symbiosis-su">Improved Familiar Symbiosis (Su)</Pair>
<Pair hl title="Replaces">Improved spell recall</Pair>
<Pair title="Gained">At 11th Level</Pair>
<Pair title="Passive Ability">When a nature-bonded magus is merged with his familiar, he gains a +4 enhancement bonus to his Strength and Constitution.</Pair>
</Ability>
</>};
...
<Ability id="arc-magus-puppetmaster-skills" icon={["info"]}>
<Pair single id="arc-magus-puppetmaster-skills">Skills</Pair>
<Pair hl title="Alters">Skills</Pair>
<Pair title="Info">A puppetmaster gains 4 skill points per level.</Pair>
</Ability>
<Ability id="arc-magus-puppetmaster-spells" icon={["spell-book"]}>
<Pair single id="arc-magus-puppetmaster-spells">Spells</Pair>
...
<Pair title="At 7th Level">The increase to the spell's save DC or caster level changes to 2.</Pair>
...
<Ability id="arc-magus-puppetmaster-puppet-combat-ex" icon={["broken-shield"]}>
<Pair single id="arc-magus-puppetmaster-puppet-combat-ex">Puppet Combat (Ex)</Pair>
...
<Ability id="arc-magus-puppetmaster-charmstrike-su" icon={["magic-swirl"]}>
<Pair single id="arc-magus-puppetmaster-charmstrike-su">Charmstrike (Su)</Pair>
<Pair hl title="Replaces">Spellstrike, fighter training, counterstrike</Pair>
<Pair title="Gained">At 2nd Level</Pair>
<Pair title="Swift Action">When a foe fails a saving throw against a spell (but not a spell-like or supernatural ability) cast by a puppetmaster, the puppetmaster can expend 1 point from his <em>arcane pool</em> to cast a prepared 1st-level enchantment on the foe. The foe must be one that the spell can target, and is the only creature affected (even if the spell can normally target multiple creatures).</Pair>
<Pair title="At 10th Level">The puppetmaster can instead cast a 2nd-level enchantment spell on the foe.</Pair>
...
<Ability id="arc-magus-puppetmaster-the-show-must-go-on-su" icon={["magic-swirl"]}>
<Pair single id="arc-magus-puppetmaster-the-show-must-go-on-su">The Show Must Go On (Su)</Pair>
<Pair hl title="Replaces">Medium armor, heavy armor</Pair>
...
<Ability id="arc-magus-puppetmaster-scene-stealer-su" icon={["magic-swirl"]}>
<Pair single id="arc-magus-puppetmaster-scene-stealer-su">Scene Stealer (Su)</Pair>
<Pair hl title="Replaces">True magus</Pair>
<Pair title="Gained">At 20th Level</Pair>
<Pair title="Ability">If a puppetmaster successfully disbelieves an illusion, he can expend 1 point from his <em>arcane pool</em> to try to negate or steal control of the illusion. The puppetmaster attempts a caster level check as if he were dispelling the effect with <Link to="/spell/dispel_magic">dispel magic</Link>. If he succeeds, he can either end the effect or alter it as if he were the spell's caster. If the spell's duration is concentration, the puppetmaster must concentrate on the new effect (or transfer it to an enchanted target using <em>the show must go on</em>) or it ends.</Pair>
</Ability>
</>};
const _sigilus = {title: "Sigilus", jsx: <><h2 id="arc-magus-sigilus-sigilus">Sigilus</h2>
...
<p>Once a weapon has been infused with a rune, the sigilus becomes more adept at using her <em>spell combat</em> ability with spells of that rune's school. Her penalty on attack rolls when using <em>spell combat</em> is reduced by 1 (to -1) when she casts a spell from the same school as her inscribed rune, but is increased by 2 (to -4) when she uses <em>spell combat</em> with a spell not from her inscribed rune's school. As long as she has a rune inscribed on her weapon in this manner, she cannot use spells from that rune's opposition schools at all with <em>spell combat.</em></p>
...
<Ability id="arc-magus-sigilus-inscribe-sihedron-su" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-sigilus-inscribe-sihedron-su">Inscribe Sihedron (Su)</Pair>
<Pair hl title="Replaces">Medium armor, heavy armor</Pair>
<Pair title="Gained">At 7th Level</Pair>
<Pair title="Ability">A sigilus learns to inscribe the Sihedron rune (the seven-pointed star that symbolizes all seven schools of Thassilonian magic) on a suit of light armor she wears. When she does so, her armor becomes physically empowered with defensive magic, granting her energy <Link to="/umr/resistance">resistance</Link> 5 to two energy types of her choice selected from acid, cold, fire, electricity, or sonic, and increasing the armor's armor bonus by 1. (Note that this increase is an armor bonus increase, and thus stacks with any enhancement bonus a suit of magic light armor may have.) Inscribing the Sihedron rune in this way becomes part of the sigilus's spell preparation ritual - she can inscribe a Sihedron rune in this way once per day as a result. Each day she inscribes the Sihedron rune, she can change the two types of energy resistance it grants as she wishes.</Pair>
<Pair title="At 13th Level">An inscribed Sihedron rune grants energy resistance 10 to one energy type and energy resistance 5 to two other energy types, and its armor bonus increases to +2.</Pair>
<Pair title="Special">A Sihedron rune can be inscribed only on light armor - it cannot be inscribed on medium or heavy armor, even if the magus later gains proficiency with medium or heavy armor.</Pair>
</Ability>
</>};
...
<Ability id="arc-magus-skirnir-diminished-spellcasting" icon={["broken-shield"]}>
...
<Ability id="arc-magus-skirnir-sorcerous-shield-ex" icon={["stairs-goal"]}>
<Pair single id="arc-magus-skirnir-sorcerous-shield-ex">Sorcerous Shield (Ex)</Pair>
<Pair hl title="Replaces">Spell combat</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="arc-magus-skirnir-spellstrike-su" icon={["stairs-goal"]}>
<Pair single id="arc-magus-skirnir-spellstrike-su">Spellstrike (Su)</Pair>
<Pair hl title="Alters">Spellstrike</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Ability">A skirnir may use this ability with a weapon or <Link to="/misc/shield_bash">shield bash</Link> attack.</Pair>
</Ability>
<Ability id="arc-magus-skirnir-shield-pool-ex" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-skirnir-shield-pool-ex">Shield Pool (Ex)</Pair>
<Pair hl title="Replaces">Spell recall</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="arc-magus-skirnir-spellshield-su" icon={["magic-swirl"]}>
<Pair single id="arc-magus-skirnir-spellshield-su">Spellshield (Su)</Pair>
<Pair hl title="Replaces">Knowledge pool</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="arc-magus-skirnir-shielded-spell-combat-su" icon={["stairs-goal"]}>
<Pair single id="arc-magus-skirnir-shielded-spell-combat-su">Shielded Spell Combat (Su)</Pair>
<Pair hl title="Replaces">Improved spell combat, greater spell combat, greater spell access</Pair>
<Pair hl title="Alters">Spell combat</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Ability">A skirnir gains the <em>spell combat</em> ability, but only when wielding his <em>bonded shield.</em> A skirnir may use his shield hand to perform somatic components for magus spells, forfeiting the shield's bonus to AC until the beginning of his next turn; if the <em>bonded shield</em> is a buckler, he retains its bonus to AC.</Pair>
...
<Ability id="arc-magus-skirnir-greater-spellshield-su" icon={["magic-swirl"]}>
<Pair single id="arc-magus-skirnir-greater-spellshield-su">Greater Spellshield (Su)</Pair>
<Pair hl title="Replaces">Counterstrike</Pair>
<Pair title="Gained">At 16th Level</Pair>
<Pair title="Immediate Action">A skirnir may activate a stored spell after being struck in combat. He may choose to have the spell affect himself or the creature that struck him.</Pair>
</Ability>
<p><strong>Magus Arcana:</strong> The following magus arcana complement the skirnir archetype: <Link to="/arcana/arcane_redoubt">arcane redoubt</Link>, <Link to="/arcana/greater_arcane_redoubt">greater arcane redoubt</Link>, <Link to="/arcana/enduring_blade">enduring blade</Link> (may use on weapon or shield), <Link to="/arcana/pool_strike">pool strike</Link>, <Link to="/arcana/pool_strike_arcing">pool strike (arcing)</Link>, <Link to="/arcana/pool_strike_clinging">pool strike (clinging)</Link>, <Link to="/arcana/pool_strike_thunderous">pool strike (thunderous)</Link>, <Link to="/arcana/prescient_defense">prescient defense</Link>, <Link to="/arcana/reflection">reflection</Link>.</p>
</>};
...
<Ability id="arc-magus-sorrowblade-despairing-strike-su" icon={["armor-downgrade"]}>
<Pair single id="arc-magus-sorrowblade-despairing-strike-su" flavor="The sorrowblade can wield the power of despair.">Despairing Strike (Su)</Pair>
<Pair hl title="Replaces">Magus arcana gained at 3rd level</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="arc-magus-sorrowblade-cruel-weapon-su" icon={["stairs-goal","broken-shield"]}>
<Pair single id="arc-magus-sorrowblade-cruel-weapon-su">Cruel Weapon (Su)</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="arc-magus-sorrowblade-wretched-strike-su" icon={["armor-downgrade"]}>
<Pair single id="arc-magus-sorrowblade-wretched-strike-su" flavor="The sorrowblade can cause foes to lose all hope.">Wretched Strike (Su)</Pair>
<Pair hl title="Replaces">Magus arcana gained at 12th level</Pair>
<Pair title="Gained">At 12th Level</Pair>
<Pair title="Swift Action">By spending 1 point from her <em>arcane pool,</em> she can imbue the weapon she is wielding with the power of unbridled pessimism. The first creature she strikes with this weapon within the next minute must succeed at a Will saving throw (DC = to + 1/2 the sorrowblade's magus level + her intelligence modifier) or take a -2 penalty an attack rolls, saving throws, ability checks, skill checks, and weapon damage rolls for 1 hour.</Pair>
<Pair title="Special">Additionally, during this time, the creature can't gain morale bonuses of any kind, and whenever the creature rolls a natural 1 on an attack roll or saving throw, fails an ability or skill check by more than 5, or takes additional damage as a result of a foe's confirmed critical hit, the penalty on rolls imposed by the wretched strike becomes -3 for 1 round. This increased penalty doesn't stack, even if multiple catastrophes occur on the same round.</Pair>
</Ability>
</>};
...
<Ability id="arc-magus-soul_forger-diminished-spellcasting" icon={["broken-shield"]}>
...
<Ability id="arc-magus-soul_forger-spellstrike-su" icon={["broken-shield"]}>
<Pair single id="arc-magus-soul_forger-spellstrike-su">Spellstrike (Su)</Pair>
<Pair hl title="Alters">Spellstrike</Pair>
<Pair title="Ability">A soul forger may use this ability only when wielding his <em>bonded weapon.</em></Pair>
</Ability>
<Ability id="arc-magus-soul_forger-master-smith-ex" icon={["upgrade"]}>
<Pair single id="arc-magus-soul_forger-master-smith-ex">Master Smith (Ex)</Pair>
<Pair hl title="Replaces">Knowledge pool</Pair>
...
<Ability id="arc-magus-soul_forger-fortify-bond-su" icon={["upgrade"]}>
<Pair single id="arc-magus-soul_forger-fortify-bond-su">Fortify Bond (Su)</Pair>
<Pair hl title="Replaces">Spell recall</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="arc-magus-soul_forger-destructive-counterstrike-su" icon={["armor-downgrade"]}>
<Pair single id="arc-magus-soul_forger-destructive-counterstrike-su">Destructive Counterstrike (Su)</Pair>
<Pair hl title="Replaces">Counterstrike</Pair>
<Pair title="Gained">At 16th Level</Pair>
...
<Ability id="arc-magus-spell_dancer-spell-dance-su" icon={["upgrade","armor-upgrade"]}>
<Pair single id="arc-magus-spell_dancer-spell-dance-su">Spell Dance (Su)</Pair>
...
<Pair title="At 5th Level">These bonuses increase to a +20 enhancement to movement and a +4 dodge bonus. Once per spelldance as a <strong className="hl">swift action</strong>, the spell dancer may use one of the following on himself: <Link to="/spell/blur">blur</Link>, <Link to="/spell/fly">fly</Link>, or <Link to="/spell/haste">haste</Link>. These abilities last for 1 round.</Pair>
<Pair title="At 9th Level">These bonuses increase to a +30 enhancement to movement and a +6 dodge bonus. The spell dancer gains the option to use <Link to="/spell/dimension_door">dimension door</Link> as a spell-like ability, in lieu of the 5th-level options.</Pair>
...
<Ability id="arc-magus-spell_dancer-arcane-movement-su" icon={["upgrade"]}>
<Pair single id="arc-magus-spell_dancer-arcane-movement-su">Arcane Movement (Su)</Pair>
...
<Ability id="arc-magus-spell_dancer-dance-of-avoidance-su" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-spell_dancer-dance-of-avoidance-su">Dance of Avoidance (Su)</Pair>
<Pair hl title="Replaces">Medium armor</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="arc-magus-spell_dancer-greater-dance-of-avoidance-su" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-spell_dancer-greater-dance-of-avoidance-su">Greater Dance of Avoidance (Su)</Pair>
<Pair hl title="Replaces">Heavy armor</Pair>
<Pair title="Gained">At 13th Level</Pair>
<Pair title="Passive Ability">While wearing light armor or no armor, a spell dancer's insight bonus to Armor Class increases to +4.</Pair>
</Ability>
<p><strong>Magus Arcana:</strong> The following magus arcana complement the spell dancer archetype: <Link to="/arcana/arcane_cloak">arcane cloak</Link>, <Link to="/arcana/prescient_defense">prescient defense</Link>, <Link to="/arcana/close_range">close range</Link>, <Link to="/arcana/concentrate">concentrate</Link>, <Link to="/arcana/hasted_assault">hasted assault</Link>, <Link to="/arcana/spell_shield">spell shield</Link>.</p>
</>};
...
<Ability id="arc-magus-spell_trapper-diminished-arcana" icon={["broken-shield","stairs-goal"]}>
<Pair single id="arc-magus-spell_trapper-diminished-arcana">Diminished Arcana</Pair>
...
<Ability id="arc-magus-spell_trapper-spell-traps-sp" icon={["stairs-goal"]}>
<Pair single id="arc-magus-spell_trapper-spell-traps-sp">Spell Traps (Sp)</Pair>
<Pair hl title="Replaces">Spell recall</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="arc-magus-spell_trapper-distant-trapping-sp" icon={["stairs-goal"]}>
<Pair single id="arc-magus-spell_trapper-distant-trapping-sp" flavor="A spell trapper can create spell traps at a distance.">Distant Trapping (Sp)</Pair>
<Pair hl title="Replaces">Fighter training</Pair>
<Pair title="Gained">At 10th Level</Pair>
<Pair title="Ability">She can create her traps at close range (25 feet + 5 feet per 2 caster levels) as a <strong className="hl">full-round action</strong> that provokes attacks of opportunity.</Pair>
</Ability>
</>};
...
<Ability id="arc-magus-spellblade-force-athame-sp" icon={["stairs-goal","mailed-fist"]}>
<Pair single id="arc-magus-spellblade-force-athame-sp">Force Athame (Sp)</Pair>
<Pair hl title="Replaces">Spellstrike</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="arc-magus-spellblade-spellblade-arcana" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="arc-magus-spellblade-spellblade-arcana">Spellblade Arcana</Pair>
...
<Ability id="arc-magus-spellblade-pool-sourced-athame-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="arc-magus-spellblade-pool-sourced-athame-su">Pool-Sourced Athame (Su)</Pair>
...
<Ability id="arc-magus-spellblade-spellblade-parry-su" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-spellblade-spellblade-parry-su">Spellblade Parry (Su)</Pair>
...
<Ability id="arc-magus-spellblade-throw-athame-su" extraClasses="subAbility" icon={["bowman"]}>
<Pair single id="arc-magus-spellblade-throw-athame-su">Throw Athame (Su)</Pair>
...
<p><strong>Magus Arcana:</strong> The following magus arcana complement the spellblade archetype: <Link to="/arcana/critical_strike">critical strike</Link>, <Link to="/arcana/hasted_assault">hasted assault</Link>, <Link to="/arcana/pool_strike">pool strike</Link>, and <Link to="/arcana/spell_shield">spell shield</Link>.</p>
</>};
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-magus-spire_defender--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>It's exceptionally rare for a non-<Link to="/race/elf">elf</Link> to be granted access to the training required to take this archetype (non-elves need GM approval to take this archetype).</td></tr></tbody></table></ScrollContainer></div><Ability id="arc-magus-spire_defender-weapon-proficiency" icon={["stairs-goal"]}>
<Pair single id="arc-magus-spire_defender-weapon-proficiency">Weapon Proficiency</Pair>
...
<Ability id="arc-magus-spire_defender-bonus-feats-ex" icon={["stairs-goal","broken-shield"]}>
<Pair single id="arc-magus-spire_defender-bonus-feats-ex">Bonus Feats (Ex)</Pair>
...
<Ability id="arc-magus-spire_defender-arcane-augmentation-su" icon={["upgrade"]}>
<Pair single id="arc-magus-spire_defender-arcane-augmentation-su">Arcane Augmentation (Su)</Pair>
<Pair hl title="Replaces">Spell recall</Pair>
<Pair title="Gained">At 4th Level</Pair>
<Pair title="Swift Action">A magus can expend 1 point from his <em>arcane pool</em> to grant himself a +5 competence bonus for 1 minute to one of the following skills: Acrobatics, Climb, Escape Artist, Perception, Stealth, and Swim.</Pair>
<Pair title="At 7th Level">The competence bonus becomes +2.</Pair>
<Pair title="At 10th Level">The competence bonus increases to +3.</Pair>
<Pair title="At 13th Level">The competence bonus becomes +4.</Pair>
<Pair title="At 16th Level">The competence bonus increases to +5.</Pair>
<Pair title="At 19th Level">The competence bonus becomes +6.</Pair>
</Ability>
</>};
...
<Ability id="arc-magus-staff_magus-weapon-and-armor-proficiency" icon={["broken-shield"]}>
<Pair single id="arc-magus-staff_magus-weapon-and-armor-proficiency">Weapon and Armor Proficiency</Pair>
...
<Ability id="arc-magus-staff_magus-quarterstaff-master-ex" icon={["stairs-goal"]}>
<Pair single id="arc-magus-staff_magus-quarterstaff-master-ex">Quarterstaff Master (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="arc-magus-staff_magus-quarterstaff-defense-ex" icon={["armor-upgrade"]}>
<Pair single id="arc-magus-staff_magus-quarterstaff-defense-ex">Quarterstaff Defense (Ex)</Pair>
<Pair hl title="Replaces">Medium armor, heavy armor</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="arc-magus-staff_magus-staff-weapon-su" icon={["mailed-fist"]}>
<Pair single id="arc-magus-staff_magus-staff-weapon-su">Staff Weapon (Su)</Pair>
<Pair hl title="Replaces">Fighter training</Pair>
<Pair title="Gained">At 10th Level</Pair>
<Pair title="Passive Ability">A staff magus treats any <Link to="/main/magic_staves">magical staff</Link> he is wielding as a magical quarterstaff with an enhancement bonus to attack and damage equal to <Link to="/misc/one_fourth">one-fourth</Link> of the staff's caster level (minimum +1). The staff must have at least 1 charge for the magus to use this ability.</Pair>
<Pair title="Ability">A staff magus can restore 1 charge to a staff by expending a number of points from his <em>arcane pool</em> equal to the level of the highest-level spell cast in the staff, as long as at least one spell in the staff is on the magus spell list. The magus cannot restore charges to more than one staff per day.</Pair>
</Ability>
<p><strong>Magus Arcana:</strong> The following magus arcana complement the staff magus archetype: <Link to="/arcana/critical_strike">critical strike</Link>, <Link to="/arcana/dispelling_strike">dispelling strike</Link>, <Link to="/arcana/maneuver_mastery">maneuver mastery</Link>, and <Link to="/arcana/spell_shield">spell shield</Link>.</p>
</>};
export default {armored_battlemage:_armored_battlemage,beastblade:_beastblade,bladebound:_bladebound,card_caster:_card_caster,deep_marshal:_deep_marshal,eldritch_archer:_eldritch_archer,eldritch_scion:_eldritch_scion,elemental_knight:_elemental_knight,esoteric:_esoteric,fiend_flayer:_fiend_flayer,greensting_slayer:_greensting_slayer,hexbreaker:_hexbreaker,hexcrafter:_hexcrafter,iron_ring_striker:_iron_ring_striker,jistkan_artificer:_jistkan_artificer,kapenia_dancer:_kapenia_dancer,kensai:_kensai,magic_warrior:_magic_warrior,mindblade:_mindblade,myrmidarch:_myrmidarch,nature_bonded_magus:_nature_bonded_magus,puppetmaster:_puppetmaster,sigilus:_sigilus,skirnir:_skirnir,sorrowblade:_sorrowblade,soul_forger:_soul_forger,spell_dancer:_spell_dancer,spell_trapper:_spell_trapper,spellblade:_spellblade,spire_defender:_spire_defender,staff_magus:_staff_magus}