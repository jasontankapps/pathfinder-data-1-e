...
<AffInfo start type="Affliction" save="" freq="1/day" onset="1d3 days" eff={<>1 point of damage to any one ability score (chosen when the monster gains this option)</>} cure2c icon="d">Basic Disease</AffInfo>
...
<ScrollContainer id="rule-monstrous--table-0"><table>
<thead>
<tr>
<th>CR</th>
<th>Cone</th>
...
<AffInfo type="Poison; Injury" save="" freq="1/minute for 6 minutes" eff={<>1d3 <Link to="/rule/str_damage">Str damage</Link></>} cure2c icon="p" />
</>};
...
<AffInfo type="Poison; Injury" save="" freq="1/minute for 6 minutes" eff={<>1d2 <Link to="/rule/dex_damage">Dex damage</Link></>} cure1 icon="p" />
</>};
...
<AffInfo type="Affliction" save="" freq="1/day" onset="immediate" eff={<>1d4 <Link to="/rule/str_damage">Str damage</Link></>} cure2c icon="d">Disease</AffInfo>
<AffInfo type="Injury" save="" freq="1/minute for 10 minutes" eff={<>1d6 <Link to="/rule/con_damage">Con damage</Link></>} cure3c icon="p">Poison</AffInfo>
</>};
