...
<Ability id="touch" icon={["rolling-dices"]}>
<Pair single id="touch">Touch of Law (Sp)</Pair>
...
<Ability id="staff" icon={["upgrade"]}>
<Pair single id="staff">Staff of Order (Su)</Pair>
...
<Pair single id="command-su">Command (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-law-touch">touch of law</InnerLink> power of the Law domain</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Pair single id="prohibition-su">Prohibition (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-law-touch">touch of law</InnerLink> power of the Law domain</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="lib" icon={["upgrade"]}>
<Pair single id="lib">Liberation (Su)</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<Ability id="free" icon={["aura"]}>
<Pair single id="free">Freedom's Call (Su)</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<Pair single id="perfected-form-su">Perfected Form (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-liberation-lib">liberation</InnerLink> power of the Liberation domain</Pair>
...
<Ability id="bit" icon={["rolling-dices"]}>
<Pair single id="bit">Bit of Luck (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="good" icon={["rolling-dices"]}>
<Pair single id="good">Good Fortune (Ex)</Pair>
...
<Ability id="vis" icon={["magic-palm"]}>
<Pair single id="vis">Vision of Madness (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Pair single id="aura">Aura of Madness (Su)</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<Ability id="hand" icon={["smoking-finger"]}>
<Pair single id="hand">Hand of the Acolyte (Su)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="dispelling-touch-sp" icon={["magic-palm"]}>
<Pair single id="dispelling-touch-sp">Dispelling Touch (Sp)</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 time/day + 1 per four cleric levels beyond 8th<ByLevelPop levels={[[8,1],[12,2],[16,3],[20,4]]} unit="time" postText="/day" /></Pair>
...
<Pair single id="enduring-ritual-su">Enduring Ritual (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-magic-hand">hand of the acolyte</InnerLink> power of the Magic domain</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="word" icon={["upgrade","shield-reflect"]}>
<Pair single id="word">Inspiring Word (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="lead" icon={["stairs-goal"]}>
<Pair single id="lead">Leadership (Ex)</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="romance-beyond-death-su" icon={["aura"]}>
<Pair single id="romance-beyond-death-su">Romance Beyond Death (Su)</Pair>
...
<Ability id="fist" icon={["mailed-fist"]}>
...
<Ability id="armor" icon={["armor-upgrade"]}>
<Pair single id="armor">Bramble Armor (Su)</Pair>
<Pair title="Gained">At 6th Level</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<Pair single id="leshy-caller-sp">Leshy Caller (Sp)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-plant-fist">wooden fist</InnerLink> power of the Plant domain</Pair>
...
<Ability id="res" icon={["upgrade"]}>
<Pair single id="res">Resistance</Pair>
...
<Ability id="touch" icon={["shield-reflect"]}>
<Pair single id="touch">Resistant Touch (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="protect" icon={["shield-reflect"]}>
<Pair single id="protect">Aura of Protection (Su)</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<Ability id="rest" icon={["magic-palm"]}>
<Pair single id="rest">Gentle Rest (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="ward" icon={["shield-reflect"]}>
<Pair single id="ward">Ward Against Death (Su)</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<Ability id="exorcism-of-undeath-sp" icon={["shield-reflect"]}>
<Pair single id="exorcism-of-undeath-sp">Exorcism of Undeath (Sp)</Pair>
...
<Ability id="blast" icon={["magic-swirl"]}>
<Pair single id="blast">Blast Rune (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="spell" icon={["magic-swirl"]}>
<Pair single id="spell">Spell Rune (Sp)</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="stare" icon={["smoking-finger"]}>
<Pair single id="stare">Venomous Stare (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="comp" icon={["stairs-goal"]}>
...
<Ability id="str" icon={["upgrade"]}>
<Pair single id="str">Strength Surge (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="might" icon={["upgrade"]}>
<Pair single id="might">Might of the Gods (Su)</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<Ability id="sun" icon={["upgrade"]}>
<Pair single id="sun">Sun's Blessing (Su)</Pair>
...
<Ability id="light" icon={["aura"]}>
<Pair single id="light">Nimbus of Light (Su)</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<Ability id="withering-nimbus-su" icon={["aura"]}>
<Pair single id="withering-nimbus-su">Withering Nimbus (Su)</Pair>
