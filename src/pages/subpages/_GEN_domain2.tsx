...
<Ability id="domain-law-touch" icon={["rolling-dices"]}>
<Pair single id="domain-law-touch">Touch of Law (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
<Pair title="Standard Action">You can touch a willing creature, infusing it with the power of divine order and allowing it to treat all attack rolls, skill checks, ability checks, and saving throws for 1 round as if the natural d20 roll resulted in an 11.</Pair>
</Ability>
<Ability id="domain-law-staff" icon={["upgrade"]}>
<Pair single id="domain-law-staff">Staff of Order (Su)</Pair>
...
<Ability id="domain-law-aura-of-menace-su" icon={["armor-downgrade"]}>
<Pair single id="domain-law-aura-of-menace-su">Aura of Menace (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-law-staff">staff of order</InnerLink> power of the Law domain</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="domain-law-hells-corruption-su" icon={["magic-palm","rolling-dices"]}>
<Pair single id="domain-law-hells-corruption-su">Hell's Corruption (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-law-touch">touch of law</InnerLink> power of the Law domain</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="domain-law-command-su" icon={["smoking-finger"]}>
<Pair single id="domain-law-command-su">Command (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-law-touch">touch of law</InnerLink> power of the Law domain</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/damerrich">Damerrich</Link>, <Link to="/faith/maat">Maat</Link>, <Link to="/faith/neshen">Neshen</Link>, <Link to="/faith/ragathiel">Ragathiel</Link>, <Link to="/faith/zohls">Zohls</Link></p><Ability id="domain-law-chastisement-su" icon={["smoking-finger"]}>
<Pair single id="domain-law-chastisement-su">Chastisement (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-law-touch">touch of law</InnerLink> ability of the Law domain</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="domain-law-pain-is-power-su" icon={["armor-upgrade"]}>
<Pair single id="domain-law-pain-is-power-su">Pain Is Power (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-law-staff">staff of order</InnerLink> ability of the Law domain</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 time/day + 1 per four cleric levels beyond 8th<ByLevelPop levels={[[8,1],[12,2],[16,3],[20,4]]} unit="time" postText="/day" /></Pair>
...
<Ability id="domain-law-prohibition-su" icon={["smoking-finger"]}>
<Pair single id="domain-law-prohibition-su">Prohibition (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-law-touch">touch of law</InnerLink> power of the Law domain</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/aesocar">Aesocar</Link>, <Link to="/faith/ghenshau">Ghenshau</Link>, <Link to="/faith/grundinnar">Grundinnar</Link>, <Link to="/faith/kols">Kols</Link>, <Link to="/faith/matravash">Matravash</Link>, <Link to="/faith/sicva">Sicva</Link>, <Link to="/faith/winlas">Winlas</Link></p><Ability id="domain-law-touch-of-loyalty-su" icon={["shield-reflect"]}>
<Pair single id="domain-law-touch-of-loyalty-su">Touch of Loyalty (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-law-touch">touch of law</InnerLink> power of the Law domain</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/asmodeus">Asmodeus</Link>, <Link to="/faith/dispater">Dispater</Link>, <Link to="/faith/iomedae">Iomedae</Link>, <Link to="/faith/lissala">Lissala</Link>, <Link to="/faith/zon_kuthon">Zon-Kuthon</Link></p><Ability id="domain-law-demand-subjugation-sp" icon={["magic-swirl"]}>
<Pair single id="domain-law-demand-subjugation-sp">Demand Subjugation (Sp)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-law-staff">staff of order</InnerLink> power of the Law domain</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
const _liberation = {hasJL:true,title: "Liberation", jsx: <><div className="jumpList" id="domain-liberation-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="domain-liberation-freedom-subdomain">Freedom Subdomain</InnerLink></li><li><InnerLink toTop to="domain-liberation-revolution-subdomain">Revolution Subdomain</InnerLink></li><li><InnerLink toTop to="domain-liberation-self-realization-subdomain">Self-Realization Subdomain</InnerLink></li></ul></div><h2 id="domain-liberation-liberation">Liberation</h2>
<p><strong>Sources</strong> <Link to="/source/prpg_core_rulebook">PRPG Core Rulebook pg. 45</Link></p>
<p><strong>Deities:</strong> <Link to="/faith/anogetz">Anogetz</Link>, <Link to="/faith/arshea">Arshea</Link>, <Link to="/faith/black_butterfly">Black Butterfly</Link>, <Link to="/faith/desna">Desna</Link>, <Link to="/faith/eaqueo">Eaqueo</Link>, <Link to="/faith/falayna">Falayna</Link>, <Link to="/faith/feronia">Feronia</Link>, <Link to="/faith/kazutal">Kazutal</Link>, <Link to="/faith/khepri">Khepri</Link>, <Link to="/faith/llamolaek">Llamolaek</Link>, <Link to="/faith/lorris">Lorris</Link>, <Link to="/faith/milani">Milani</Link>, <Link to="/faith/mneoc">Mneoc</Link>, <Link to="/faith/narriseminek">Narriseminek</Link>, <Link to="/faith/neshen">Neshen</Link>, <Link to="/faith/ondisso">Ondisso</Link>, <Link to="/faith/saloc">Saloc</Link>, <Link to="/faith/scal">Scal</Link>, <Link to="/faith/shei">Shei</Link>, <Link to="/faith/ssilameshnik">Ssila'meshnik</Link>, <Link to="/faith/sun_wukong">Sun Wukong</Link>, <Link to="/faith/taraksun">Taraksun</Link>, <Link to="/faith/vapula">Vapula</Link>, <Link to="/faith/vevelor">Vevelor</Link>, <Link to="/faith/xhasnaphar">Xhasnaphar</Link>, <Link to="/faith/zaigasnar">Zaigasnar</Link></p><p><strong className="hl">Granted Powers:</strong> You are a spirit of freedom and a staunch foe against all who would enslave and oppress.</p>
<Ability id="domain-liberation-lib" icon={["upgrade"]}>
<Pair single id="domain-liberation-lib">Liberation (Su)</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<Ability id="domain-liberation-perfected-form-su" icon={["armor-upgrade"]}>
<Pair single id="domain-liberation-perfected-form-su">Perfected Form (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-liberation-lib">liberation</InnerLink> power of the Liberation domain</Pair>
...
const _luck = {hasJL:true,title: "Luck", jsx: <><div className="jumpList" id="domain-luck-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="domain-luck-curse-subdomain">Curse Subdomain</InnerLink></li><li><InnerLink toTop to="domain-luck-fate-subdomain">Fate Subdomain</InnerLink></li><li><InnerLink toTop to="domain-luck-imagination-subdomain">Imagination Subdomain</InnerLink></li></ul></div><h2 id="domain-luck-luck">Luck</h2>
<p><strong>Sources</strong> <Link to="/source/prpg_core_rulebook">PRPG Core Rulebook pg. 45</Link></p>
<p><strong>Deities:</strong> <Link to="/faith/andirifkhu">Andirifkhu</Link>, <Link to="/faith/atropos">Atropos</Link>, <Link to="/faith/bes">Bes</Link>, <Link to="/faith/calistria">Calistria</Link>, <Link to="/faith/chadali">Chadali</Link>, <Link to="/faith/chaldira">Chaldira</Link>, <Link to="/faith/chinostes_evil_aspect">Chinostes (Evil Aspect)</Link>, <Link to="/faith/chinostes_good_aspect">Chinostes (Good Aspect)</Link>, <Link to="/faith/dachzerul">Dachzerul</Link>, <Link to="/faith/dammar">Dammar</Link>, <Link to="/faith/desna">Desna</Link>, <Link to="/faith/graffiacane">Graffiacane</Link>, <Link to="/faith/grandmother_spider">Grandmother Spider</Link>, <Link to="/faith/halcamora">Halcamora</Link>, <Link to="/faith/hembad">Hembad</Link>, <Link to="/faith/imot">Imot</Link>, <Link to="/faith/irez">Irez</Link>, <Link to="/faith/kofusachi">Kofusachi</Link>, <Link to="/faith/kurgess">Kurgess</Link>, <Link to="/faith/lalaci">Lalaci</Link>, <Link to="/faith/lao_shu_po">Lao Shu Po</Link>, <Link to="/faith/magdh">Magdh</Link>, <Link to="/faith/nivi_rhombodazzle">Nivi Rhombodazzle</Link>, <Link to="/faith/raetorgash">Raetorgash</Link>, <Link to="/faith/shelyn">Shelyn</Link>, <Link to="/faith/shelyn_pre_earthfall">Shelyn (pre-Earthfall)</Link>, <Link to="/faith/sinashakti">Sinashakti</Link>, <Link to="/faith/uaransaph">Uaransaph</Link>, <Link to="/faith/yabu">Yabu</Link></p><p><strong className="hl">Granted Powers:</strong> You are infused with luck, and your mere presence can spread good fortune.</p>
<Ability id="domain-luck-bit" icon={["rolling-dices"]}>
<Pair single id="domain-luck-bit">Bit of Luck (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
<Pair title="Standard Action">You can touch a willing creature, giving it a bit of luck. For the next round, any time the target rolls a d20, he may roll twice and take the more favorable result.</Pair>
</Ability>
<Ability id="domain-luck-good" icon={["rolling-dices"]}>
<Pair single id="domain-luck-good">Good Fortune (Ex)</Pair>
...
<Ability id="domain-madness-vis" icon={["magic-palm"]}>
<Pair single id="domain-madness-vis">Vision of Madness (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="domain-madness--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>This subdomain requires the <Link to="/trait/acolyte_of_apocrypha">Acolyte of Apocrypha</Link> trait to access.</td></tr></tbody></table></ScrollContainer></div><p><strong className="hl">Associated Deities:</strong> <Link to="/faith/groetus">Groetus</Link>, <Link to="/faith/lamashtu">Lamashtu</Link>, <Link to="/faith/sifkesh">Sifkesh</Link>, <Link to="/faith/sivanah">Sivanah</Link></p><Ability id="domain-madness-dawning-realization-su" icon={["magic-palm"]}>
<Pair single id="domain-madness-dawning-realization-su">Dawning Realization (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-madness-aura">aura of madness</InnerLink> power of the Madness domain</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 time/day per two cleric levels<ByLevelPop levels={[[8,4],[10,5],[12,6],[14,7],[16,8],[18,9],[20,10]]} unit="time" postText="/day" /></Pair>
...
<Ability id="domain-magic-hand" icon={["smoking-finger"]}>
<Pair single id="domain-magic-hand">Hand of the Acolyte (Su)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
<Pair title="Standard Action">You can cause your melee weapon to fly from your grasp and strike a foe before instantly returning. You can make a single attack using a melee weapon at a range of 30 feet. This attack is treated as a ranged attack with a thrown weapon, except that you add your Wisdom modifier to the attack roll instead of your Dexterity modifier (damage still relies on Strength). This ability cannot be used to perform a combat maneuver.</Pair>
</Ability>
<Ability id="domain-magic-dispelling-touch-sp" icon={["magic-palm"]}>
<Pair single id="domain-magic-dispelling-touch-sp">Dispelling Touch (Sp)</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 time/day + 1 per four cleric levels beyond 8th<ByLevelPop levels={[[8,1],[12,2],[16,3],[20,4]]} unit="time" postText="/day" /></Pair>
...
<Ability id="domain-magic-divine-alchemy-su" icon={["magic-swirl"]}>
<Pair single id="domain-magic-divine-alchemy-su">Divine Alchemy (Su)</Pair>
...
<Ability id="domain-magic-enduring-ritual-su" icon={["magic-swirl"]}>
<Pair single id="domain-magic-enduring-ritual-su">Enduring Ritual (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-magic-hand">hand of the acolyte</InnerLink> power of the Magic domain</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
<Pair title="Swift Action">When you cast a spell with a duration of at least 1 minute per caster level, you can increase the spell's effective caster level by 1 for the purpose of determining its duration and preventing attempts to dispel it.</Pair>
...
<Ability id="domain-nobility-word" icon={["upgrade","shield-reflect"]}>
<Pair single id="domain-nobility-word">Inspiring Word (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
<Pair title="Standard Action">You can speak an inspiring word to a creature within 30 feet. That creature receives a +2 morale bonus on attack rolls, skill checks, ability checks, and saving throws for a number of rounds equal to 1/2 your cleric level (minimum 1).</Pair>
</Ability>
<Ability id="domain-nobility-lead" icon={["stairs-goal"]}>
<Pair single id="domain-nobility-lead">Leadership (Ex)</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/abadar">Abadar</Link>, <Link to="/faith/nalinivati">Nalinivati</Link></p><Ability id="domain-nobility-noble-visage-su" icon={["upgrade"]}>
<Pair single id="domain-nobility-noble-visage-su">Noble Visage (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-nobility-word">inspiring word</InnerLink> ability of the Nobility domain</Pair>
<Pair title="Passive Ability">You gain a bonus on Charisma checks and Charisma-based skill checks against creatures that share your creature type (and subtype, if you are a humanoid). This bonus is equal to 1 + <Link to="/misc/one_fifth">one-fifth</Link> of your cleric level.</Pair>
...
<Ability id="domain-nobility-divine-demand-su" icon={["upgrade"]}>
<Pair single id="domain-nobility-divine-demand-su">Divine Demand (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-nobility-lead">leadership</InnerLink> power of the Nobility domain</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/abadar">Abadar</Link>, <Link to="/faith/chinostes_evil_aspect">Chinostes (Evil Aspect)</Link>, <Link to="/faith/chinostes_good_aspect">Chinostes (Good Aspect)</Link>, <Link to="/faith/count_ranalc">Count Ranalc</Link>, <Link to="/faith/folgrit">Folgrit</Link>, <Link to="/faith/naderi">Naderi</Link>, <Link to="/faith/olheon">Olheon</Link>, <Link to="/faith/ragathiel">Ragathiel</Link>, <Link to="/faith/shax">Shax</Link>, <Link to="/faith/smiad">Smiad</Link>, <Link to="/faith/sugroz">Sugroz</Link>, <Link to="/faith/the_lost_prince">The Lost Prince</Link>, <Link to="/faith/trudd">Trudd</Link>, <Link to="/faith/vildeis">Vildeis</Link>, <Link to="/faith/ydersius">Ydersius</Link>, <Link to="/faith/zaebos">Zaebos</Link></p><Ability id="domain-nobility-sacrificial-bond-su" icon={["shield-reflect"]}>
<Pair single id="domain-nobility-sacrificial-bond-su">Sacrificial Bond (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-nobility-lead">leadership</InnerLink> power of the Nobility domain</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 time/day + 1 per six cleric levels beyond 8th<ByLevelPop levels={[[8,1],[14,2],[20,3]]} unit="time" postText="/day" /></Pair>
...
const _plant = {hasJL:true,title: "Plant", jsx: <><div className="jumpList" id="domain-plant-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="domain-plant-decay-subdomain">Decay Subdomain</InnerLink></li><li><InnerLink toTop to="domain-plant-growth-subdomain">Growth Subdomain</InnerLink></li><li><InnerLink toTop to="domain-plant-leshy-subdomain">Leshy Subdomain</InnerLink></li><li><InnerLink toTop to="domain-plant-thorns-subdomain">Thorns Subdomain</InnerLink></li></ul></div><h2 id="domain-plant-plant">Plant</h2>
<p><strong>Sources</strong> <Link to="/source/prpg_core_rulebook">PRPG Core Rulebook pg. 46</Link></p>
<p><strong>Deities:</strong> <Link to="/faith/angazhan">Angazhan</Link>, <Link to="/faith/barbariccia">Barbariccia</Link>, <Link to="/faith/cernunnos">Cernunnos</Link>, <Link to="/faith/cyth_vsug">Cyth-V'sug</Link>, <Link to="/faith/daikitsu">Daikitsu</Link>, <Link to="/faith/diceid">Diceid</Link>, <Link to="/faith/erastil">Erastil</Link>, <Link to="/faith/fandarra">Fandarra</Link>, <Link to="/faith/furcas">Furcas</Link>, <Link to="/faith/gozreh">Gozreh</Link>, <Link to="/faith/green_faith">Green Faith</Link>, <Link to="/faith/halcamora">Halcamora</Link>, <Link to="/faith/ilsurrish">Il'surrish</Link>, <Link to="/faith/immonhiel">Immonhiel</Link>, <Link to="/faith/jaidi">Jaidi</Link>, <Link to="/faith/kelksiomides">Kelksiomides</Link>, <Link to="/faith/ketephys">Ketephys</Link>, <Link to="/faith/lady_nanbyo">Lady Nanbyo</Link>, <Link to="/faith/nhimbaloth">Nhimbaloth</Link>, <Link to="/faith/oaur_ooung">Oaur-Ooung</Link>, <Link to="/faith/osiris">Osiris</Link>, <Link to="/faith/pirias">Pirias</Link>, <Link to="/faith/shub_niggurath">Shub-Niggurath</Link>, <Link to="/faith/tamede">Tamede</Link>, <Link to="/faith/the_green_mother">The Green Mother</Link>, <Link to="/faith/treerazer">Treerazer</Link>, <Link to="/faith/vermilion_mother">Vermilion Mother</Link>, <Link to="/faith/xhamen_dor">Xhamen-Dor</Link>, <Link to="/faith/zyphus">Zyphus</Link></p><p><strong className="hl">Granted Powers:</strong> You find solace in the green, can grow defensive thorns, and can communicate with plants.</p>
<Ability id="domain-plant-fist" icon={["mailed-fist"]}>
<Pair single id="domain-plant-fist">Wooden Fist (Su)</Pair>
...
<Ability id="domain-plant-armor" icon={["armor-upgrade"]}>
<Pair single id="domain-plant-armor">Bramble Armor (Su)</Pair>
<Pair title="Gained">At 6th Level</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<p><strong>Sources</strong> <Link to="/source/advanced_players_guide">Advanced Player's Guide pg. 88</Link></p>
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/angazhan">Angazhan</Link>, <Link to="/faith/cyth_vsug">Cyth-V'sug</Link>, <Link to="/faith/gozreh">Gozreh</Link>, <Link to="/faith/lady_nanbyo">Lady Nanbyo</Link>, <Link to="/faith/nhimbaloth">Nhimbaloth</Link>, <Link to="/faith/oaur_ooung">Oaur-Ooung</Link>, <Link to="/faith/shub_niggurath">Shub-Niggurath</Link>, <Link to="/faith/tamede">Tamede</Link>, <Link to="/faith/the_green_mother">The Green Mother</Link>, <Link to="/faith/treerazer">Treerazer</Link>, <Link to="/faith/trelmarixian">Trelmarixian</Link>, <Link to="/faith/vermilion_mother">Vermilion Mother</Link>, <Link to="/faith/vorasha">Vorasha</Link>, <Link to="/faith/xhamen_dor">Xhamen-Dor</Link>, <Link to="/faith/zyphus">Zyphus</Link></p><Ability id="domain-plant-aura-of-decay-su" icon={["armor-downgrade"]}>
<Pair single id="domain-plant-aura-of-decay-su">Aura of Decay (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-plant-armor">bramble armor</InnerLink> power of the Plant domain</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<Ability id="domain-plant-leshy-caller-sp" icon={["magic-swirl","upgrade"]}>
<Pair single id="domain-plant-leshy-caller-sp">Leshy Caller (Sp)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-plant-fist">wooden fist</InnerLink> power of the Plant domain</Pair>
<Pair title="Passive Ability">You can spontaneously swap out any of your domain spells for a <em>summon nature's ally</em> spell of the same level or lower, to a maximum of <Link to="/spell/summon_natures_ally_vii">summon nature's ally VII</Link>. If you do, you must use the spell to summon one or more <Link to="/family/leshy">leshys</Link>. Add <Link to="/monster/leaf_leshy">leaf leshy</Link>, <Link to="/monster/gourd_leshy">gourd leshy</Link>, <Link to="/monster/fungus_leshy">fungus leshy</Link>, <Link to="/monster/seaweed_leshy">seaweed leshy</Link>, and <Link to="/monster/lotus_leshy">lotus leshy</Link> to your <em>summon nature's ally I, II, III, IV,</em> and <em>V</em> lists, respectively.</Pair>
<Pair title="Standard Action">You can grant a single leshy within 30 feet a +4 sacred bonus on its next attack roll before the start of your next turn.</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="domain-protection-res" icon={["upgrade"]}>
<Pair single id="domain-protection-res">Resistance</Pair>
<Pair title="Passive Ability">You receive a resistance bonus on saving throws equal to 1 + <Link to="/misc/one_fifth">one-fifth</Link> of your cleric level.</Pair>
</Ability>
<Ability id="domain-protection-touch" icon={["shield-reflect"]}>
<Pair single id="domain-protection-touch">Resistant Touch (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
<Pair title="Standard Action">You can touch an ally to grant him your resistance bonus for 1 minute. When you use this ability, you lose your resistance bonus granted by the Protection domain for 1 minute.</Pair>
</Ability>
<Ability id="domain-protection-protect" icon={["shield-reflect"]}>
<Pair single id="domain-protection-protect">Aura of Protection (Su)</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
<Pair title="Standard Action">You can emit a 30-foot aura of protection. You and your allies within this aura gain a +1 deflection bonus to AC and <Link to="/umr/resistance">resistance</Link> 5 against all elements (acid, cold, electricity, fire, and sonic).</Pair>
<Pair title="At 12th Level">The deflection bonus becomes +2.</Pair>
<Pair title="At 14th Level">The elemental resistance increases to 10.</Pair>
...
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/abadar">Abadar</Link>, <Link to="/faith/arqueros">Arqueros</Link>, <Link to="/faith/torag">Torag</Link></p><Ability id="domain-protection-sheltering-walls-sp" icon={["shield-reflect"]}>
<Pair single id="domain-protection-sheltering-walls-sp">Sheltering Walls (Sp)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-protection-touch">resistant touch</InnerLink> power of the Protection domain</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
<Pair title="Standard Action">You can touch an ally to summon a floating blockade of stone, granting the ally the benefits of partial <Link to="/rule/cover">cover</Link> for 1 round. This ability does not grant the ally enough cover to attempt a Stealth check or avoid provoking attacks of opportunity. If the ally benefits from any other form of cover against an attack, the bonuses to AC and on Reflex saving throws increase by 1.</Pair>
<Pair title="At 6th Level">The cover lasts for 2 rounds.</Pair>
...
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/nethys">Nethys</Link>, <Link to="/faith/yamatsumi">Yamatsumi</Link></p><Ability id="domain-protection-taboo-su" icon={["armor-downgrade"]}>
<Pair single id="domain-protection-taboo-su">Taboo (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-protection-touch">resistant touch</InnerLink> ability of the Protection domain</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
...
<Ability id="domain-repose-rest" icon={["magic-palm"]}>
<Pair single id="domain-repose-rest">Gentle Rest (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
<Pair title="Standard Action">Your touch can fill a creature with lethargy, causing a living creature to become <Link to="/misc/staggered">staggered</Link> for 1 round as a melee touch attack. If you touch a staggered living creature, that creature falls asleep for 1 round instead. Undead creatures touched are staggered for a number of rounds equal to your Wisdom modifier.</Pair>
</Ability>
<Ability id="domain-repose-ward" icon={["shield-reflect"]}>
<Pair single id="domain-repose-ward">Ward Against Death (Su)</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<p><strong>Sources</strong> <Link to="/source/advanced_players_guide">Advanced Player's Guide pg. 86</Link></p>
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/acavna">Acavna</Link>, <Link to="/faith/anubis">Anubis</Link>, <Link to="/faith/ashava">Ashava</Link>, <Link to="/faith/bergelmir">Bergelmir</Link>, <Link to="/faith/fharaas">Fharaas</Link>, <Link to="/faith/ghenshau">Ghenshau</Link>, <Link to="/faith/magrim">Magrim</Link>, <Link to="/faith/myr">Myr</Link>, <Link to="/faith/osiris">Osiris</Link>, <Link to="/faith/pharasma">Pharasma</Link>, <Link to="/faith/ragadahn">Ragadahn</Link>, <Link to="/faith/rhan_tegoth">Rhan-Tegoth</Link>, <Link to="/faith/selket">Selket</Link>, <Link to="/faith/shizuru">Shizuru</Link>, <Link to="/faith/the_lost_prince">The Lost Prince</Link>, <Link to="/faith/tsukiyo">Tsukiyo</Link>, <Link to="/faith/yhidothrus">Yhidothrus</Link></p><Ability id="domain-repose-speak-with-dead-su" icon={["magic-swirl"]}>
<Pair single id="domain-repose-speak-with-dead-su">Speak With Dead (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-repose-ward">ward against death</InnerLink> power of the Repose domain</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="domain-repose-spirit-touch-su" icon={["upgrade"]}>
<Pair single id="domain-repose-spirit-touch-su">Spirit Touch (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-repose-ward">ward against death</InnerLink> ability of the Repose domain</Pair>
<Pair title="Gained">At 6th Level</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<p><strong>Sources</strong> <Link to="/source/haunted_heroes_handbook">Haunted Heroes Handbook pg. 9</Link></p>
<p>The Lady of Graves seeks the destruction of undead, be they corporeal or manifested spirits. Inquisitors of <Link to="/faith/pharasma">Pharasma</Link> scour the world for signs of the undead, destroying such abominations on sight by means both traditional and esoteric in nature. As a result, most people come first to the church of Pharasma when seeking assistance against foul spirits. One unusual facet of Pharasma's faithful is their reluctance to excise non-undead spirits, such as demons or devils. Only the most altruistic of Pharasmin priests offer their services against possessing outsiders, as most faithful see battling such foes as being beyond their true calling.</p>
<Ability id="domain-repose-exorcism-of-undeath-sp" icon={["shield-reflect"]}>
<Pair single id="domain-repose-exorcism-of-undeath-sp">Exorcism of Undeath (Sp)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-repose-ward">ward against death</InnerLink> domain power of the Repose domain</Pair>
<Pair title="Usage">Once per day</Pair>
<Pair title="Full-Round Action">You can try to end any possession spells or effects, or effects that directly exercise mental control over a creature, as long as the effect was caused by an undead creature. You must touch the affected creature (this requires a melee touch attack if the target is neither willing nor helpless) and use a vial of <Link to="/eq-weapon/holy_water">holy water</Link> as a material component that is consumed as part of using this ability. The target must immediately attempt a new Will save against the original save DC of the controlling effect. If the save is successful, the possession effect immediately ends, as if the target had succeeded at its original saving throw. If the possessing force is a <Link to="/template/ghost">ghost</Link> or similar undead, it manifests adjacent to the target and is <Link to="/misc/staggered">staggered</Link> for 1 round.</Pair>
</Ability>
</>};
const _rune = {hasJL:true,title: "Rune", jsx: <><div className="jumpList" id="domain-rune-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="domain-rune-language-subdomain">Language Subdomain</InnerLink></li><li><InnerLink toTop to="domain-rune-legislation-subdomain">Legislation Subdomain</InnerLink></li><li><InnerLink toTop to="domain-rune-wards-subdomain">Wards Subdomain</InnerLink></li></ul></div><h2 id="domain-rune-rune">Rune</h2>
<p><strong>Sources</strong> <Link to="/source/prpg_core_rulebook">PRPG Core Rulebook pg. 47</Link></p>
<p><strong>Deities:</strong> <Link to="/faith/benorus">Benorus</Link>, <Link to="/faith/bifrons">Bifrons</Link>, <Link to="/faith/braismois">Braismois</Link>, <Link to="/faith/gaap">Gaap</Link>, <Link to="/faith/hastur">Hastur</Link>, <Link to="/faith/imot">Imot</Link>, <Link to="/faith/irez">Irez</Link>, <Link to="/faith/irori">Irori</Link>, <Link to="/faith/lissala">Lissala</Link>, <Link to="/faith/lissala_pre_earthfall">Lissala (pre-Earthfall)</Link>, <Link to="/faith/magdh">Magdh</Link>, <Link to="/faith/magrim">Magrim</Link>, <Link to="/faith/mephistopheles">Mephistopheles</Link>, <Link to="/faith/mneoc">Mneoc</Link>, <Link to="/faith/nalinivati">Nalinivati</Link>, <Link to="/faith/narakaas">Narakaas</Link>, <Link to="/faith/nethys">Nethys</Link>, <Link to="/faith/onmyuza">Onmyuza</Link>, <Link to="/faith/sivanah">Sivanah</Link>, <Link to="/faith/stygidvod">Stygidvod</Link>, <Link to="/faith/thoth">Thoth</Link>, <Link to="/faith/valmallos">Valmallos</Link>, <Link to="/faith/ydajisk">Ydajisk</Link></p><p><strong className="hl">Granted Powers:</strong> In strange and eldritch runes you find potent magic.</p>
<Ability id="domain-rune-bonus-feat-ex" icon={["stairs-goal"]}>
<Pair single id="domain-rune-bonus-feat-ex">Bonus Feat (Ex)</Pair>
<Pair title="Passive Ability">You gain <Link to="/feat/scribe_scroll">Scribe Scroll</Link> as a bonus feat.</Pair>
</Ability>
<Ability id="domain-rune-blast" icon={["magic-swirl"]}>
<Pair single id="domain-rune-blast">Blast Rune (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
<Pair title="Standard Action">You can create a blast rune in any adjacent square. Any creature entering this square takes 1d6 points of damage + 1 point for every two cleric levels you possess. This rune deals either acid, cold, electricity, or fire damage, decided when you create the rune. The rune is invisible and lasts a number of rounds equal to your cleric level or until discharged. You cannot create a blast rune in a square occupied by another creature. This rune counts as a 1st-level spell for the purposes of <Link to="/spell/dispel">dispelling</Link>. It can be discovered with a DC 26 Perception skill check and disarmed with a DC 26 Disable Device skill check.</Pair>
</Ability>
<Ability id="domain-rune-spell" icon={["magic-swirl"]}>
<Pair single id="domain-rune-spell">Spell Rune (Sp)</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<p><strong>Sources</strong> <Link to="/source/advanced_players_guide">Advanced Player's Guide pg. 92</Link></p>
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/bifrons">Bifrons</Link>, <Link to="/faith/braismois">Braismois</Link>, <Link to="/faith/hastur">Hastur</Link>, <Link to="/faith/irez">Irez</Link>, <Link to="/faith/irori">Irori</Link>, <Link to="/faith/lissala">Lissala</Link>, <Link to="/faith/lissala_pre_earthfall">Lissala (pre-Earthfall)</Link>, <Link to="/faith/mephistopheles">Mephistopheles</Link>, <Link to="/faith/onmyuza">Onmyuza</Link>, <Link to="/faith/pavnuri">Pavnuri</Link>, <Link to="/faith/stygidvod">Stygidvod</Link>, <Link to="/faith/thoth">Thoth</Link>, <Link to="/faith/titivilus">Titivilus</Link>, <Link to="/faith/vapula">Vapula</Link></p><Ability id="domain-rune-rune-shift-su" icon={["magic-swirl"]}>
<Pair single id="domain-rune-rune-shift-su">Rune Shift (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-rune-spell">spell rune</InnerLink> power of the Rune domain</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<p><strong>Sources</strong> <Link to="/source/heroes_of_the_streets">Heroes of the Streets pg. 19</Link></p>
<p><strong className="hl">Associated Domains:</strong> Law, Rune<br/><strong className="hl">Associated Deities:</strong> <Link to="/faith/abadar">Abadar</Link>, <Link to="/faith/asmodeus">Asmodeus</Link>, <Link to="/faith/dispater">Dispater</Link>, <Link to="/faith/lissala">Lissala</Link>, <Link to="/faith/winlas">Winlas</Link></p>
<Ability id="domain-rune-prohibition-su" icon={["smoking-finger"]}>
<Pair single id="domain-rune-prohibition-su">Prohibition (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-rune-blast">blast rune</InnerLink> power of the Rune domain</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
<Pair title="Standard Action">You can command a creature within 30 feet to refrain from committing a particular action (including any referenced in the spell <em>forbid action</em>). If the creature performs the named action before the beginning of your next turn, it takes 1d6 points of damage + 1 point for every 2 cleric levels you possess and the effect ends. This is a language-dependent effect.</Pair>
...
<Ability id="domain-scalykind-stare" icon={["smoking-finger"]}>
<Pair single id="domain-scalykind-stare">Venomous Stare (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
<Pair title="Standard Action">You can activate a <Link to="/umr/gaze">gaze</Link> attack with a 30-foot range that can target a single creature within range. The target must make a Will save (DC = 10 + 1/2 your cleric level + your Wisdom modifier). Those that fail take 1d6 points of nonlethal damage + 1 point for every two cleric levels you possess and are <Link to="/misc/fascinated">fascinated</Link> until the beginning of your next turn. This is a mind-affecting effect.</Pair>
</Ability>
<Ability id="domain-scalykind-comp" icon={["stairs-goal"]}>
<Pair single id="domain-scalykind-comp">Serpent Companion (Ex)</Pair>
...
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/sobek">Sobek</Link>, <Link to="/faith/ydersius">Ydersius</Link>, <Link to="/faith/zevgavizeb">Zevgavizeb</Link></p><Ability id="domain-scalykind-dinosaur-companion-ex" icon={["stairs-goal"]}>
<Pair single id="domain-scalykind-dinosaur-companion-ex">Dinosaur Companion (Ex)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-scalykind-comp">serpent companion</InnerLink> ability of the Scalykind domain</Pair>
...
<div className="sideNoteWrap"><ScrollContainer id="domain-scalykind--table-0"><table><tbody><tr><ThLink scope="row" rowSpan={9} to="/rule/poison"><IonIcon aria-label="Poison" icon="/icons/poison-bottle.svg" /></ThLink><th colSpan={4} scope="col" className="title">Life-Stealing Venom</th></tr><tr><th scope="row">Type</th><td colSpan={3}>Poison; injury</td></tr><tr><th scope="row">Save DC</th><td colSpan={3}>Fort 10 + 1/2 your class level + your Wis modifier</td></tr><tr><th scope="row">Onset</th><td colSpan={3}>immediate</td></tr><tr><th scope="row">Frequency</th><td colSpan={3}>1/round for 3 rounds</td></tr><tr><th scope="row">Effect</th><td colSpan={3}>1 <Link to="/rule/con_damage">Con damage</Link></td></tr><tr><th scope="row">Cure</th><td colSpan={3}>1 save</td></tr></tbody></table></ScrollContainer></div><table className="basic spellList"><thead><tr><th colSpan={2}>Replacement Domain Spells</th></tr></thead><tbody><tr><th scope="row">1st</th><td><em>magic fang</em></td></tr>
...
<Ability id="domain-strength-str" icon={["upgrade"]}>
<Pair single id="domain-strength-str">Strength Surge (Sp)</Pair>
<Pair title="Usage">3 + Wis modifier times/day</Pair>
<Pair title="Standard Action">You can touch a creature to give it great strength. For 1 round, the target gains an enhancement bonus equal to 1/2 your cleric level (minimum +1) to melee attacks, combat maneuver checks that rely on Strength, Strength-based skills, and Strength checks.</Pair>
</Ability>
<Ability id="domain-strength-might" icon={["upgrade"]}>
<Pair single id="domain-strength-might">Might of the Gods (Su)</Pair>
<Pair title="Usage">1 round/day per cleric level; these rounds need not be consecutive</Pair>
...
<p><strong>Sources</strong> <Link to="/source/heroes_of_the_streets">Heroes of the Streets pg. 18</Link></p>
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/cayden_cailean">Cayden Cailean</Link>, <Link to="/faith/irori">Irori</Link>, <Link to="/faith/kurgess">Kurgess</Link>, <Link to="/faith/marishi">Marishi</Link>, <Link to="/faith/trudd">Trudd</Link></p><Ability id="domain-strength-athletic-exploit-su" icon={["upgrade"]}>
<Pair single id="domain-strength-athletic-exploit-su">Athletic Exploit (Su)</Pair>
...
<p><strong>Sources</strong> <Link to="/source/champions_of_balance">Champions of Balance pg. 17</Link></p>
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/gorum">Gorum</Link>, <Link to="/faith/irori">Irori</Link>, <Link to="/faith/yamatsumi">Yamatsumi</Link></p><Ability id="domain-strength-fist" icon={["mailed-fist"]}>
<Pair single id="domain-strength-fist">Wooden Fist (Su)</Pair>
...
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/abhoth">Abhoth</Link>, <Link to="/faith/alocer">Alocer</Link>, <Link to="/faith/arlachramas">Arlachramas</Link>, <Link to="/faith/ashukharma">Ashukharma</Link>, <Link to="/faith/baphomet">Baphomet</Link>, <Link to="/faith/bohga">Bohga</Link>, <Link to="/faith/cayden_cailean">Cayden Cailean</Link>, <Link to="/faith/cihua_couatl">Cihua Couatl</Link>, <Link to="/faith/dranngvit">Dranngvit</Link>, <Link to="/faith/falayna">Falayna</Link>, <Link to="/faith/geryon">Geryon</Link>, <Link to="/faith/gorum">Gorum</Link>, <Link to="/faith/haagenti">Haagenti</Link>, <Link to="/faith/iapholi">Iapholi</Link>, <Link to="/faith/imbrex">Imbrex</Link>, <Link to="/faith/irori">Irori</Link>, <Link to="/faith/kols">Kols</Link>, <Link to="/faith/kurgess">Kurgess</Link>, <Link to="/faith/lanishra">Lanishra</Link>, <Link to="/faith/marishi">Marishi</Link>, <Link to="/faith/minderhal">Minderhal</Link>, <Link to="/faith/myr">Myr</Link>, <Link to="/faith/nameless">Nameless</Link>, <Link to="/faith/neshen">Neshen</Link>, <Link to="/faith/ondisso">Ondisso</Link>, <Link to="/faith/ruapceras">Ruapceras</Link>, <Link to="/faith/sobek">Sobek</Link>, <Link to="/faith/trudd">Trudd</Link>, <Link to="/faith/urazra">Urazra</Link>, <Link to="/faith/uruskreil">Uruskreil</Link>, <Link to="/faith/yamatsumi">Yamatsumi</Link>, <Link to="/faith/zevgavizeb">Zevgavizeb</Link></p><Ability id="domain-strength-bestow-resolve-su" icon={["upgrade"]}>
<Pair single id="domain-strength-bestow-resolve-su">Bestow Resolve (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-strength-might">might of the gods</InnerLink> power of the Strength domain</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 time/day + 1 per four cleric levels beyond 8th<ByLevelPop levels={[[8,1],[12,2],[16,3],[20,4]]} unit="time" postText="/day" /></Pair>
...
<Ability id="domain-strength-perfected-form-su" icon={["armor-upgrade"]}>
<Pair single id="domain-strength-perfected-form-su">Perfected Form (Su)</Pair>
<Pair hl title="Replaces">The <InnerLink toTop to="domain-strength-str">strength surge</InnerLink> ability of the Strength domain</Pair>
<Pair title="Passive Ability">You maintain an unshakable sense of who you are, and no force can compel you to be anything else. You gain a +1 sacred (if your patron is good or neutral) or profane (if your patron is evil) bonus on saving throws against polymorph, petrification, and transmutation effects. This bonus increases by 1 for every 5 cleric levels you have (maximum +5). Once per day when you succeed at a saving throw against such an effect, you can gain a surge of self-confidence as an immediate action that grants you a number of <Link to="/rule/temporary_hit_points">temporary hit points</Link> equal to your cleric level and a +2 morale bonus on attack rolls, skill checks, and saving throws; both effects last for 1 minute.</Pair>
</Ability>
<table className="basic spellList"><thead><tr><th colSpan={2}>Replacement Domain Spells</th></tr></thead><tbody><tr><th scope="row">1st</th><td><em>enlarge person</em></td></tr>
...
<Ability id="domain-sun-sun" icon={["upgrade"]}>
...
<p><strong>Sources</strong> <Link to="/source/champions_of_purity">Champions of Purity pg. 21</Link></p>
<p><strong className="hl">Associated Deities:</strong> <Link to="/faith/iomedae">Iomedae</Link>, <Link to="/faith/sarenrae">Sarenrae</Link>, <Link to="/faith/shizuru">Shizuru</Link></p><Ability id="domain-sun-guided-eyes-su" icon={["skills","upgrade"]}>
<Pair single id="domain-sun-guided-eyes-su">Guided Eyes (Su)</Pair>
