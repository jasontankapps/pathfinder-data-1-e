...
<Ability id="combat-skill-ex" icon={["power"]}>
...
<Ability id="fist-of-the-avenger-ex" icon={["power","boost"]}>
...
<Ability id="heavy-training-ex" icon={["power","boost"]}>
...
<Ability id="mad-rush-ex" icon={["melee","down"]}>
...
<Ability id="nothing-can-stop-me-ex" icon={["melee"]}>
...
<Ability id="signature-weapon-ex" icon={["power"]}>
...
<Ability id="steel-soldier-ex" icon={["power","def","boost"]}>
...
<Ability id="sucker-punch-ex" icon={["boost"]}>
...
<Ability id="sweeping-strike-ex" icon={["power","boost"]}>
...
<Ability id="unkillable-ex" icon={["power","def"]}>
...
<Ability id="weapon-familiarity-ex" icon={["power"]}>
...
<Ability id="blind-spot-ex" icon={["boost"]}>
...
<Ability id="rogue-talent-ex" icon={["power"]}>
...
<Ability id="sniper-ex" icon={["boost"]}>
...
<Ability id="stalker-sense-ex" icon={["power","def"]}>
...
<Ability id="twisting-fear-ex" icon={["lower"]}>
...
<Ability id="up-close-and-personal-ex" icon={["melee"]}>
...
<Ability id="foe-collision-ex" icon={["melee"]}>
...
<Ability id="leave-an-opening-ex" icon={["lower"]}>
...
<Ability id="mighty-ambush-ex" icon={["lower"]}>
...
<Ability id="throat-jab-ex" icon={["lower"]}>
...
<Ability id="animal-patron-ex" icon={["power"]}>
...
<Ability id="another-day-ex-su" icon={["def"]}>
...
<Ability id="armor-skin-ex" icon={["boost"]}>
...
<Ability id="brutal-maneuver" icon={["melee"]}>
...
<Ability id="chase-master-ex" icon={["boost"]}>
...
<Ability id="close-the-gap-ex" icon={["def"]}>
...
<Ability id="combat-expertise-ex" icon={["power"]}>
...
<Ability id="concealed-strike-ex" icon={["power"]}>
...
<Ability id="cunning-feint-ex" icon={["power","lower"]}>
...
<Ability id="deceitful-trick" icon={["melee"]}>
...
<Ability id="environmental-weapon-ex" icon={["power"]}>
...
<Ability id="swamp-concoctions-ex" icon={["power"]}>
...
<Ability id="expose-weaknesses-ex" icon={["melee"]}>
...
<Ability id="fantastic-stride-ex" icon={["power"]}>
...
<Ability id="favored-maneuver-ex" icon={["power"]}>
...
<Ability id="gator-wrangle-ex" icon={["def","boost"]}>
...
<Ability id="inspired-vigilante-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="instant-plan-ex" icon={["def","protect","boost"]}>
...
<Ability id="leap-and-bound-ex" icon={["boost","power"]}>
...
<Ability id="lethal-grace-ex" icon={["power","boost"]}>
...
<Ability id="living-shield-ex" icon={["def"]}>
...
<Ability id="magical-familiarity-sp" icon={["magic"]}>
...
<Ability id="malleable-flesh-su" icon={["power","magic","down"]}>
...
<Pair title="Choice">A vigilante with this talent selects one of the following spells lists: <Link to="/main/spells_bard">bard</Link>, <Link to="/main/spells_cleric">cleric</Link>, <Link to="/main/spells_druid">druid</Link>, <Link to="/main/spells_psychic">psychic</Link>, <Link to="/main/spells_shaman">shaman</Link>, <Link to="/main/spells_sorcerer">sorcerer</Link>/<Link to="/main/spells_wizard">wizard</Link> spell list, or <Link to="/main/spells_witch">witch</Link>. Once this decision is made, the selection cannot be changed.</Pair>
...
<Ability id="mockery-ex" icon={["boost"]}>
...
<Ability id="morphic-weaponry-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="perfect-fall-ex" icon={["def"]}>
...
<Ability id="perfect-vulnerability-ex" icon={["boost"]}>
...
<Ability id="poisoner-ex" icon={["power"]}>
...
<Ability id="pull-into-the-shadows-ex" icon={["melee","boost","def"]}>
...
<Ability id="racial-paragon" icon={["power"]}>
...
<Ability id="returning-weapon-ex" icon={["ranged"]}>
...
<Ability id="rooftop-infiltrator-ex" icon={["power"]}>
...
<Ability id="monkeys-paws-ex" icon={["power","boost"]}>
...
<Ability id="shackle-smash-ex" icon={["boost"]}>
...
<Ability id="shadows-sight-ex" icon={["power"]}>
...
<Ability id="shadows-speed-ex" icon={["boost"]}>
...
<Ability id="shield-of-blades-ex" icon={["power","def"]}>
...
<Ability id="shield-of-fury-ex" icon={["power"]}>
...
<Ability id="signature-arrows-ex" icon={["boost","magic"]}>
...
<Ability id="steely-resolve-ex" icon={["power"]}>
...
<Ability id="strike-the-unseen-ex" icon={["power","boost"]}>
...
<Ability id="sure-footed-ex" icon={["power"]}>
...
<Ability id="surprise-strike-ex" icon={["boost"]}>
...
<Ability id="take-em-alive-ex" icon={["boost"]}>
...
<Ability id="team-player-ex" icon={["power"]}>
...
<Ability id="tigers-claws-ex" icon={["melee"]}>
...
<Ability id="turnabout-ex" icon={["melee"]}>
...
<Ability id="unexpected-strike-ex" icon={["power"]}>
...
<Ability id="vigilantes-reflexes-ex" icon={["power"]}>
...
<Ability id="vital-punishment-ex" icon={["power","melee"]}>
...
<Ability id="volatile-arrows-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="vortex-splash-ex" icon={["melee"]}>
...
<Ability id="whip-of-vengeance-ex" icon={["power"]}>
