...
<Ability id="zephyrs-gift-minor" icon={["boost","def"]}>
...
<Ability id="soaring-assault-major" icon={["power","boost"]}>
...
<Ability id="animal-fury-minor" icon={["melee"]}>
...
<Ability id="battle-companion-major" icon={["magic"]}>
...
<Ability id="crafters-wrath-minor" icon={["boost"]}>
...
<Ability id="transfer-magic-major" icon={["magic"]}>
...
<Ability id="anarchic-strike-minor" icon={["boost"]}>
...
<Ability id="charming-presence-minor" icon={["def"]}>
...
<Ability id="dominance-aura-major" icon={["aura","magic"]}>
...
<Ability id="communal-aid-minor" icon={["boost"]}>
...
<Ability id="fight-as-one-major" icon={["boost"]}>
...
<Ability id="hexing-attack-minor" icon={["lower"]}>
...
<Ability id="retributive-curse-major" icon={["lower"]}>
...
<Ability id="enshrouding-darkness-minor" icon={["def"]}>
...
<Ability id="darkened-vision-major" icon={["lower"]}>
...
<Ability id="from-the-grave-minor" icon={["boost","def"]}>
...
<Ability id="deaths-touch-major" icon={["lower"]}>
...
<Ability id="destructive-attacks-minor" icon={["boost"]}>
...
<Ability id="heart-of-carnage-major" icon={["boost","def"]}>
...
<Ability id="acid-strike-minor" icon={["boost"]}>
...
<Ability id="armor-of-earth-major" icon={["def"]}>
...
<Ability id="stones-base-minor" icon={["def"]}>
...
<Ability id="earth-hammer-major" icon={["lower"]}>
...
<Ability id="unholy-strike-minor" icon={["boost"]}>
...
<Ability id="fire-strike-minor" icon={["boost"]}>
...
<Ability id="armor-of-flame-major" icon={["def"]}>
...
<Ability id="lasting-breath-minor" icon={["def"]}>
...
<Ability id="tsunami-burst-major" icon={["def"]}>
...
<Ability id="glorious-presence-minor" icon={["def"]}>
...
<Ability id="demoralizing-glory-major" icon={["lower"]}>
...
<Ability id="command-obedience-minor" icon={["def"]}>
...
<Ability id="tactical-readiness-major" icon={["power","def"]}>
...
<Ability id="holy-strike-minor" icon={["boost"]}>
...
<Ability id="powerful-healer-minor" icon={["boost"]}>
...
<Ability id="fast-healing-major" icon={["aid"]}>
...
<Ability id="lore-keeper-minor" icon={["touch"]}>
...
<Ability id="monster-lore-major" icon={["boost","def"]}>
...
<Ability id="axiomatic-strike-minor" icon={["boost"]}>
...
<Ability id="liberation-minor" icon={["magic"]}>
...
<Ability id="freedoms-shout-major" icon={["aura","magic"]}>
...
<Ability id="lucky-presence-minor" icon={["roll"]}>
...
<Ability id="unlucky-enemy-major" icon={["roll"]}>
...
<Ability id="madness-supremacy-minor" icon={["aid"]}>
...
<Ability id="control-madness-major" icon={["power"]}>
...
<Ability id="hand-of-the-acolyte-minor" icon={["ranged"]}>
...
<Ability id="blessed-magic-major" icon={["magic"]}>
...
<Ability id="inspiring-word-minor" icon={["boost","def"]}>
...
<Ability id="lead-by-example-major" icon={["boost"]}>
...
<Ability id="creeping-vines-minor" icon={["lower"]}>
...
<Ability id="increased-defense-minor" icon={["def"]}>
...
<Ability id="aura-of-protection-major" icon={["aura","def","protect"]}>
...
<Ability id="gentle-rest-minor" icon={["touch"]}>
...
<Ability id="blast-rune-minor" icon={["magic"]}>
...
<Ability id="spell-storing-weapon-major" icon={["magic"]}>
...
<Ability id="scaly-touch-minor" icon={["def"]}>
...
<Ability id="serpent-fang-major" icon={["melee"]}>
...
<Ability id="flicker-of-shadows-minor" icon={["boost"]}>
...
<Ability id="swift-as-shadow-major" icon={["boost"]}>
...
<Ability id="strength-surge-minor" icon={["boost"]}>
...
<Ability id="strength-of-will-major" icon={["boost","def"]}>
...
<Ability id="blinding-strike-minor" icon={["lower"]}>
...
<Ability id="cleansing-fire-major" icon={["boost"]}>
...
<Ability id="dust-devil-minor" icon={["lower"]}>
...
<Ability id="agile-feet-minor" icon={["boost"]}>
...
<Ability id="dimensional-hop-major" icon={["magic"]}>
...
<Ability id="double-minor" icon={["def"]}>
...
<Ability id="greater-invisibility-major" icon={["magic"]}>
...
<Ability id="airless-touch-minor" icon={["touch","lower"]}>
...
<Ability id="deny-gravity-major" icon={["boost"]}>
...
<Ability id="war-mind-minor" icon={["boost","def"]}>
...
<Ability id="battle-lust-major" icon={["boost"]}>
...
<Ability id="ice-strike-minor" icon={["boost"]}>
...
<Ability id="armor-of-ice-major" icon={["protect"]}>
...
<Ability id="storm-strike-minor" icon={["boost"]}>
...
<Ability id="wind-barrier-major" icon={["magic"]}>
...
<Ability id="leaping-flames-minor" icon={["boost","def"]}>
...
<Ability id="fiery-wake-major" icon={["magic"]}>
