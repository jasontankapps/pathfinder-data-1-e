...
<Ability id="blinding-strike-ex" icon={["lower"]}>
...
<Ability id="confusing-strike-ex" icon={["lower"]}>
...
<Ability id="deafening-strike-ex" icon={["lower"]}>
...
<Ability id="domino-effect-ex" icon={["boost"]}>
...
<Ability id="iconclastic-strike-ex" icon={["melee"]}>
...
<Ability id="numerical-strike-ex" icon={["roll"]}>
...
<Ability id="greater-numerical-strike-ex" icon={["boost"]}>
...
<Ability id="masterful-numerical-strike-ex" icon={["boost"]}>
...
<Ability id="prolonged-study-ex" icon={["boost"]}>
...
<Ability id="repositioning-strike-ex" icon={["melee"]}>
...
<Ability id="sapping-offensive-ex" icon={["lower"]}>
...
<Ability id="sickening-offensive-ex" icon={["lower"]}>
...
<Ability id="silencing-strike-ex" icon={["lower"]}>
...
<Ability id="slowing-strike-ex" icon={["lower"]}>
...
<Ability id="stealing-strike-ex" icon={["melee"]}>
...
<Ability id="timed-strike-ex" icon={["boost"]}>
...
<Ability id="toppling-strike-ex" icon={["melee"]}>
...
<Ability id="twilight-talon-improvisation-ex" icon={["melee"]}>
...
<Ability id="didactic-strike" icon={["boost"]}>
...
<Ability id="quick-study-ex" icon={["boost"]}>
...
<Ability id="studied-defense-ex" icon={["def"]}>
...
<Ability id="amazing-inspiration-ex" icon={["boost"]}>
...
<Ability id="applied-engineering-ex" icon={["boost"]}>
...
<Ability id="atheist-inspiration-ex" icon={["def"]}>
...
<Ability id="chroniclers-insight-ex" extraClasses="hasSubs" icon={["boost"]}>
...
<Ability id="combat-inspiration-ex" icon={["boost"]}>
...
<Ability id="greater-combat-inspiration-ex" icon={["boost"]}>
...
<Ability id="eidetic-recollection-su" icon={["boost"]}>
...
<Ability id="empathy-ex-su" icon={["roll","power"]}>
...
<Ability id="expanded-inspiration-ex" icon={["boost"]}>
...
<Ability id="hidden-agendas-ex" icon={["roll","def"]}>
...
<Ability id="inspirational-expertise-ex" icon={["boost"]}>
...
<Ability id="sustained-inspirational-expertise-ex" icon={["boost"]}>
...
<Ability id="inspired-alertness-ex" icon={["def"]}>
...
<Ability id="inspired-intelligence-ex" icon={["boost"]}>
...
<Ability id="inspired-intimidator-ex" icon={["lower"]}>
...
<Ability id="tenacious-inspiration-ex" icon={["roll"]}>
...
<Ability id="unconventional-inspiration-ex" icon={["boost"]}>
...
<Ability id="underworld-inspiration-ex" icon={["boost"]}>
...
<Ability id="innocent-facade-sp" icon={["magic","def"]}>
...
<Ability id="alchemist-discovery-ex" icon={["power"]}>
...
<Ability id="anathema-ex" icon={["lower"]}>
...
<Ability id="greater-anathema-ex" icon={["boost","lower"]}>
...
<Ability id="false-spellcaster-ex" icon={["power","magic"]}>
...
<Ability id="lingering-venom-ex" icon={["boost"]}>
...
<Ability id="numerical-alchemy-su" icon={["boost"]}>
...
<Ability id="greater-numerical-alchemy-su" icon={["boost"]}>
...
<Ability id="device-talent-ex" icon={["boost"]}>
...
<Ability id="effortless-aid-ex" icon={["boost"]}>
...
<Ability id="eldritch-conduit-su" icon={["boost","magic"]}>
...
<Ability id="favored-beat-ex" icon={["power"]}>
...
<Ability id="item-lore-ex" icon={["boost","magic"]}>
...
<Ability id="just-a-face-in-the-crowd-su" icon={["def","boost"]}>
...
<Ability id="occult-dungeoneer-su" icon={["power","magic"]}>
...
<Ability id="perceptive-tracking-ex" icon={["boost"]}>
...
<Ability id="scrying-familiarity-ex" icon={["roll","def","boost"]}>
...
<Ability id="the-whole-time-su" icon={["power","magic","def"]}>
