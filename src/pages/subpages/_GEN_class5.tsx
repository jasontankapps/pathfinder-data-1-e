...
<Ability id="challenge-ex" icon={["melee"]}>
<Pair single id="challenge-ex">Challenge (Ex)</Pair>
...
<Ability id="order-ex" icon={["boost"]}>
...
<Ability id="tactician-ex" icon={["power","boost"]}>
...
<Ability id="cavaliers-charge-ex" icon={["melee","def"]}>
<Pair single id="cavaliers-charge-ex">Cavalier's Charge (Ex)</Pair>
...
<Ability id="expert-trainer-ex" icon={["boost"]}>
<Pair single id="expert-trainer-ex">Expert Trainer (Ex)</Pair>
...
<Ability id="banner-ex" icon={["def","melee"]}>
<Pair single id="banner-ex" flavor="A cavalier's banner becomes a symbol of inspiration to his allies and companions.">Banner (Ex)</Pair>
...
</aside><Ability id="bonus-feat" icon={["power"]}>
...
<Ability id="greater-tactician-ex" icon={["power"]}>
...
<Ability id="mighty-charge-ex" icon={["melee","power"]}>
<Pair single id="mighty-charge-ex" flavor="A cavalier learns to make devastating charge attacks while mounted.">Mighty Charge (Ex)</Pair>
...
<Ability id="demanding-challenge-ex" icon={["lower"]}>
...
<Ability id="greater-banner-ex" icon={["def"]}>
<Pair single id="greater-banner-ex" flavor="A cavlier's banner becomes a rallying call to his allies.">Greater Banner (Ex)</Pair>
...
<Ability id="master-tactician-ex" icon={["power"]}>
...
<Ability id="supreme-charge-ex" icon={["melee"]}>
<Pair single id="supreme-charge-ex">Supreme Charge (Ex)</Pair>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-cavalier--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-cavalier/beast_rider">Beast Rider</Link></p><p><strong>Modifies or Replaces:</strong> Mount; Expert Trainer</p><p>Where some cavaliers are simply skilled with horses or well-trained knights, the beast rider spends his life in constant pursuit of the most perfect mount, forming bonds with greater, more powerful, and more exotic creatures.</p></div>
...
<DisplayTable table={{"id":"cavalier archetypes","columns":[{"header":"Archetype","link":"arc-cavalier"},{"header":"Armor Proficiency"},{"header":"Banner"},{"header":"Greater Banner"},{"header":"Bonus Feats"},{"header":"6th-level Bonus Feat"},{"header":"18th-level Bonus Feat"},{"header":"Cavalier's Charge"},{"header":"Mighty Charge"},{"header":"Supreme Charge"},{"header":"Challenge"},{"header":"Demanding Challenge"},{"header":"Class Skills"},{"header":"Expert Trainer"},{"header":"Mount"},{"header":"Order"},{"header":"2nd-level Order Ability"},{"header":"Tactician"},{"header":"Greater Tactician"},{"header":"Master Tactician"},{"header":"Weapon Proficiency"}],"data":[[["Beast Rider","beast_rider"],null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null],[["Castellan","castellan"],null,null,null,null,null,null,"X","X","X",null,"X",null,"X","X",null,null,null,null,null,null],[["Charger","charger"],"X",null,null,null,null,null,"X","X",null,null,null,"X","X","X",null,null,null,null,null,"X"],[["Circuit Judge","circuit_judge"],null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,"X","X","X",null],[["Constable","constable"],null,"X","X",null,null,null,"X","X","X",null,null,"X","X","X",null,null,null,null,null,null],[["Courtly Knight","courtly_knight"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null],[["Daring Champion","daring_champion"],"X",null,null,null,null,null,"X","X","X",null,null,null,"X","X",null,null,null,null,null,"X"],[["Daring General","daring_general"],null,null,null,"X",null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null],[["Disciple of the Pike","disciple_of_the_pike"],null,"X","X",null,null,null,"X","X","X",null,null,null,"X","X",null,null,null,null,null,null],[["Drakerider","drakerider"],null,"X","X",null,null,null,null,null,null,null,null,null,"X","X",null,null,"X","X","X",null],[["Emissary","emissary"],null,"X","X",null,null,null,null,null,"X",null,null,null,null,null,null,null,"X","X",null,null],[["Esquire","esquire"],null,"X",null,null,null,null,"X","X","X",null,null,null,"X","X",null,null,null,null,null,null],[["Fell Rider","fell_rider"],null,"X","X",null,null,null,"X","X","X",null,null,null,"X","X",null,null,null,null,null,null],[["First Mother's Fang","first_mothers_fang"],null,null,null,null,null,null,null,null,null,null,null,"X",null,"X","X",null,null,null,null,"X"],[["Gallant","gallant"],null,"X","X",null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null],[["Gendarme","gendarme"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,"X","X","X",null],[["Ghost Rider","ghost_rider"],null,"X","X",null,null,null,"X","X",null,null,null,null,"X","X",null,null,"X","X","X",null],[["Green Knight","green_knight"],null,"X","X",null,null,null,"X","X","X",null,null,null,"X","X","X",null,"X","X","X",null],[["Herald Squire","herald_squire"],null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,"X","X",null,null,null],[["Honor Guard","honor_guard"],null,null,null,null,null,null,"X","X",null,"X","X",null,null,null,null,null,null,null,null,null],[["Hooded Knight","hooded_knight"],null,null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,null,"X","X","X",null],[["Huntmaster","huntmaster"],"X","X","X","X",null,null,"X","X","X","X",null,null,"X","X",null,null,"X","X","X","X"],[["Hussar","hussar"],"X","X","X","X",null,null,null,null,null,null,null,"X",null,null,null,null,"X","X","X",null],[["Knight of Arnisant","knight_of_arnisant"],null,"X",null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,"X","X",null,null],[["Luring Cavalier","luring_cavalier"],null,null,null,null,null,null,"X","X","X","X","X",null,null,null,null,null,null,null,null,null],[["Musketeer","musketeer"],null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null],[["Oceanrider","oceanrider"],"X",null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null],[["Qabarat Outrider","qabarat_outrider"],"X","X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null],[["Qadiran Horselord","qadiran_horselord"],"X",null,null,null,"X",null,"X",null,null,null,null,null,null,"X",null,null,"X","X","X","X"],[["Saurian Champion","saurian_champion"],"X","X","X",null,null,null,null,null,null,"X",null,"X",null,"X","X",null,"X","X","X","X"],[["Sister-in-Arms","sister_in_arms"],null,null,null,null,null,null,"X","X","X","X",null,null,"X","X","X",null,null,null,null,null],[["Spellscar Drifter","spellscar_drifter"],"X","X",null,"X",null,null,"X","X","X",null,"X",null,null,null,null,null,"X","X","X","X"],[["Standard Bearer","standard_bearer"],null,"X",null,null,null,null,null,"X","X",null,null,null,null,"X",null,null,null,null,null,null],[["Strategist","strategist"],null,null,"X",null,null,"X",null,null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Verdivant","verdivant"],null,"X","X","X",null,null,"X",null,null,null,null,null,"X",null,null,null,"X","X","X",null],[["Vermin Tamer","vermin_tamer"],null,null,null,null,null,null,null,null,null,null,"X",null,"X","X",null,null,null,null,null,null],[["Wave Rider","wave_rider"],"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X"]],"initialColumn":0,"nullValue":"&nbsp;"}} />
<h3 id="class-cavalier-favored-class-bonuses" data-hash-target><Link to="/rule/favored_class">Favored Class Bonuses</Link></h3>
<RacialOptions cls="cavalier" />
</>};
const _cleric = {hasJL:true,title: "Cleric", jsx: <><div className="jumpList" id="class-cleric-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="class-cleric-bonus-languages">Bonus Languages</InnerLink></li><li><InnerLink toTop to="class-cleric-aura-ex">Aura</InnerLink></li><li><InnerLink toTop to="class-cleric-spells">Spells</InnerLink></li><li><InnerLink toTop to="class-cleric-chaotic-evil-good-and-lawful-spells">Aligned Spells</InnerLink></li><li><InnerLink toTop to="class-cleric-channel-energy-su">Channel Energy</InnerLink></li><li><InnerLink toTop to="class-cleric-domains">Domains</InnerLink></li><li><InnerLink toTop to="class-cleric-spontaneous-casting">Spontaneous Casting</InnerLink></li><li><InnerLink toTop to="class-cleric-ex-clerics">Ex-Clerics</InnerLink></li><li><InnerLink toTop to="class-cleric-alternate-capstones">Alternate Capstones</InnerLink></li><li><InnerLink toTop to="class-cleric-archetypes">Archetypes</InnerLink></li><li><InnerLink toTop to="class-cleric-archetypes-by-feature">Archetypes by Feature</InnerLink></li><li><InnerLink toTop to="class-cleric-favored-class-bonuses">Favored Class Bonuses</InnerLink></li></ul></div><h2 id="class-cleric-cleric">Cleric</h2>
...
<Ability id="chaotic-evil-good-and-lawful-spells" icon={["magic"]}>
...
<Pair single id="channel-energy-su" flavor="Regardless of alignment, any cleric can release a wave of energy by channeling the power of her faith through her holy (or unholy) symbol. This energy can be used to cause or heal damage, depending on the type of energy channeled and the creatures targeted.">Channel Energy (Su)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
</aside><Ability id="domains" icon={["power","magic"]}>
...
<Ability id="spontaneous-casting" icon={["magic"]}>
<Pair single id="spontaneous-casting" flavor="A good cleric (or a neutral cleric of a good deity) can channel stored spell energy into healing spells that she did not prepare ahead of time.">Spontaneous Casting:</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<p>A cleric who grossly violates the code of conduct required by her god loses all spells and class features, except for armor and shield proficiencies and proficiency with simple weapons. She cannot thereafter gain levels as a cleric of that god until she <Link to="/spell/atonement">atones</Link> for her deeds. (Also see the <Link to="/arc-cleric/channeler_of_the_unknown">Channeler of the Unknown</Link> archetype for options.)</p>
<h3 id="class-cleric-alternate-capstones" data-hash-target>Alternate Capstones</h3>
<Message capstone /><div className="capstones"><ScrollContainer id="class-cleric--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
...
<DisplayTable table={{"id":"cleric archetypes","columns":[{"header":"Archetype","link":"arc-cleric"},{"header":"Alignment"},{"header":"Armor Proficiency"},{"header":"Aura"},{"header":"Base Attack Bonus"},{"header":"Bonus Languages"},{"header":"Channel Energy"},{"header":"5th-level Channel Energy increase"},{"header":"11th-level Channel Energy increase"},{"header":"19th-level Channel Energy increase"},{"header":"Class Skills"},{"header":"Deity"},{"header":"Domains"},{"header":"1st-level Domain Power"},{"header":"8th-level Domain Power"},{"header":"Skill Ranks"},{"header":"Spellcasting"},{"header":"4th-level spell slot"},{"header":"Spontaneous Casting"},{"header":"Weapon Proficiency"}],"data":[[["Angelfire Apostle","angelfire_apostle"],"X","X",null,null,null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null],[["Appeaser","appeaser"],"X",null,"X",null,null,"X",null,null,null,null,null,"X",null,null,null,"X",null,null,null],[["Asmodean Advocate","asmodean_advocate"],null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Blossoming Light","blossoming_light"],"X","X",null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Cardinal","cardinal"],null,"X",null,"X",null,null,null,null,null,"X",null,"X",null,null,"X",null,null,"X",null],[["Channeler of the Unknown","channeler_of_the_unknown"],null,"X","X",null,null,"X",null,null,null,null,null,"X",null,null,null,"X",null,"X","X"],[["Cloistered Cleric","cloistered_cleric"],null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,"X"],[["Crashing Wave","crashing_wave"],null,null,null,null,"X","X",null,null,null,null,"X",null,null,null,null,null,null,"X",null],[["Crusader","crusader"],null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null],[["Demonic Apostle","demonic_apostle"],null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Divine Paragon","divine_paragon"],null,null,"X",null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Divine Scourge","divine_scourge"],null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Divine Strategist","divine_strategist"],null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Ecclesitheurge","ecclesitheurge"],null,"X",null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,"X"],[["Elder Mythos Cultist","elder_mythos_cultist"],"X",null,null,null,null,"X","X","X","X",null,null,"X",null,null,null,null,null,"X",null],[["Evangelist","evangelist"],null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,"X",null],[["Fiendish Vessel","fiendish_vessel"],null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Forgemaster","forgemaster"],null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Foundation of Faith","foundation_of_faith"],null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null],[["Herald Caller","herald_caller"],null,"X",null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null],[["Hidden Priest","hidden_priest"],null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null],[["Idealist","idealist"],null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,"X",null],[["Iron Priest","iron_priest"],null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,"X",null,null,null],[["Lawspeaker","lawspeaker"],"X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Mendevian Priest","mendevian_priest"],null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Merciful Healer","merciful_healer"],null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Roaming Exorcist","roaming_exorcist"],null,"X",null,null,null,"X",null,null,null,null,null,"X",null,null,"X",null,null,null,"X"],[["Sacred Attendant","sacred_attendant"],null,"X",null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Scroll Scholar","scroll_scholar"],null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,"X",null,null],[["Separatist","separatist"],null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Stoic Caregiver","stoic_caregiver"],null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Theologian","theologian"],null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Triadic Priest","triadic_priest"],null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Undead Lord","undead_lord"],null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null],[["Varisian Pilgrim","varisian_pilgrim"],null,"X",null,null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null]],"initialColumn":0,"nullValue":"&nbsp;"}} />
<h3 id="class-cleric-favored-class-bonuses" data-hash-target><Link to="/rule/favored_class">Favored Class Bonuses</Link></h3>
<RacialOptions cls="cleric" />
</>};
const _druid = {hasJL:true,title: "Druid", jsx: <><div className="jumpList" id="class-druid-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="class-druid-spells">Spells</InnerLink></li><li><InnerLink toTop to="class-druid-spontaneous-casting">Spontaneous Casting</InnerLink></li><li><InnerLink toTop to="class-druid-chaotic-evil-good-and-lawful-spells">Aligned Spells</InnerLink></li><li><InnerLink toTop to="class-druid-bonus-languages">Bonus Languages</InnerLink></li><li><InnerLink toTop to="class-druid-nature-bond-ex">Nature Bond</InnerLink></li><li><InnerLink toTop to="class-druid-nature-sense-ex">Nature Sense</InnerLink></li><li><InnerLink toTop to="class-druid-wild-empathy-ex">Wild Empathy</InnerLink></li><li><InnerLink toTop to="class-druid-woodland-stride-ex">Woodland Stride</InnerLink></li><li><InnerLink toTop to="class-druid-trackless-step-ex">Trackless Step</InnerLink></li><li><InnerLink toTop to="class-druid-resist-natures-lure-ex">Resist Nature's Lure</InnerLink></li><li><InnerLink toTop to="class-druid-wild-shape-su">Wild Shape</InnerLink></li><li><InnerLink toTop to="class-druid-venom-immunity-ex">Other Abilities</InnerLink></li><li><InnerLink toTop to="class-druid-ex-druids">Ex-Druids</InnerLink></li><li><InnerLink toTop to="class-druid-alternate-capstones">Alternate Capstones</InnerLink></li><li><InnerLink toTop to="class-druid-archetypes">Archetypes</InnerLink></li><li><InnerLink toTop to="class-druid-archetypes-by-feature">Archetypes by Feature</InnerLink></li><li><InnerLink toTop to="class-druid-favored-class-bonuses">Favored Class Bonuses</InnerLink></li></ul></div><h2 id="class-druid-druid">Druid</h2>
...
<Ability id="spontaneous-casting" icon={["magic"]}>
<Pair single id="spontaneous-casting" flavor="A druid can channel stored spell energy into summoning spells that she hasn't prepared ahead of time.">Spontaneous Casting</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="nature-bond-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="domain" extraClasses="subAbility numbered" icon={["power","magic"]}>
...
<Ability id="companion" extraClasses="subAbility numbered" icon={["power"]}>
<Pair single id="companion">Companion</Pair>
...
<Ability id="herbalism" extraClasses="subAbility numbered" icon={["power","magic"]}>
<Pair single id="herbalism">Herbalism</Pair>
...
<Ability id="nature-sense-ex" icon={["boost"]}>
<Pair single id="nature-sense-ex">Nature Sense (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Pair single id="wild-empathy-ex" flavor="A druid can improve the attitude of an animal.">Wild Empathy (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="woodland-stride-ex" icon={["boost"]}>
...
<Ability id="trackless-step-ex" icon={["boost"]}>
...
<Ability id="wild-shape-su" icon={["power"]}>
...
<Ability id="a-thousand-faces-su" icon={["power"]}>
...
<Message arch /><div className="archetype"><p><Link to="/arc-druid/aerie_protector">Aerie Protector</Link></p><p><strong>Modifies or Replaces:</strong> Weapon/Armor Proficiencies; Nature Bond; Wild Empathy; Woodland Stride; Resist Nature's Lure; Wild Shape; Venom Immunity</p><p>The aerie protector guards nature's nests and lairs in the highest mountains, and she is only ever truly at ease when under vast expanses of open sky.</p></div>
...
<DisplayTable table={{"id":"druid archetypes","columns":[{"header":"Archetype","link":"arc-druid"},{"header":"A Thousand Faces"},{"header":"Alignment"},{"header":"Armor Proficiency"},{"header":"Base Attack Bonus"},{"header":"Bonus Languages"},{"header":"Class Skills"},{"header":"Deity"},{"header":"Domains"},{"header":"Nature Bond"},{"header":"Nature Sense"},{"header":"Resist Nature's Lure"},{"header":"Skill Ranks"},{"header":"Spellcasting"},{"header":"Spontaneous Casting"},{"header":"Timeless Body"},{"header":"Trackless Step"},{"header":"Venom Immunity"},{"header":"Weapon Proficiency"},{"header":"Wild Empathy"},{"header":"Wild Shape"},{"header":"6th-level Wild Shape"},{"header":"8th-level Wild Shape"},{"header":"10th-level Wild Shape"},{"header":"12th-level Wild Shape"},{"header":"Woodland Stride"}],"data":[[["Aerie Protector","aerie_protector"],null,null,"X",null,null,null,null,null,"X",null,"X",null,null,null,null,null,"X","X","X","X",null,null,null,null,"X"],[["Ancient Guardian","ancient_guardian"],"X",null,null,null,null,null,null,null,"X",null,"X",null,null,"X",null,"X",null,"X","X",null,null,null,null,null,"X"],[["Ape Shaman","ape_shaman"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Aquatic Druid","aquatic_druid"],"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X",null,null,null,null,null,null,null,"X"],[["Arctic Druid","arctic_druid"],"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X",null,null,null,null,null,null,null,"X"],[["Ashvawg Tamer","ashvawg_tamer"],null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,"X",null,null,null,null,null],[["Bat Shaman","bat_shaman"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Bear Shaman","bear_shaman"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Blight Druid","blight_druid"],"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X",null,"X",null,null,null,null,null,null],[["Boar Shaman","boar_shaman"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Cave Druid","cave_druid"],null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,"X",null,null,null,null,null,null,null,null,"X"],[["Death Druid","death_druid"],null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,"X",null,null,"X",null,null,null,null,null],[["Defender of the True World","defender_of_the_true_world"],"X",null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,"X","X",null,"X",null,null,null,null,null,null],[["Desert Druid","desert_druid"],"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X",null,null,null,null,null,null,null,"X"],[["Devolutionist","devolutionist"],null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Dinosaur Druid","dinosaur_druid"],null,null,null,null,null,null,null,null,"X",null,"X",null,null,"X",null,null,null,null,null,"X",null,null,null,null,null],[["Draconic Druid","draconic_druid"],"X",null,null,null,null,null,null,null,"X","X","X",null,null,null,"X",null,"X",null,"X",null,null,null,null,null,"X"],[["Dragon Shaman","dragon_shaman"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Drovier","drovier"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null],[["Eagle Shaman","eagle_shaman"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Elemental Ally","elemental_ally"],null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,"X","X",null,null,null,null,null],[["Feral Child","feral_child"],"X",null,"X",null,null,"X",null,null,"X",null,"X",null,null,null,"X","X","X","X",null,"X",null,null,null,null,null],[["Feral Shifter","feral_shifter"],"X",null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null],[["Feyspeaker","feyspeaker"],null,null,"X","X",null,"X",null,null,null,"X",null,"X",null,"X",null,null,null,null,null,"X",null,null,null,null,null],[["Fungal Pilgrim","fungal_pilgrim"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null],[["Goliath Druid","goliath_druid"],"X",null,null,null,null,"X",null,null,"X","X","X",null,null,null,null,null,"X",null,"X","X",null,null,null,null,null],[["Green Faith Initiate","green_faith_initiate"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,"X",null,"X",null,null],[["Green Scourge","green_scourge"],null,null,null,null,null,null,null,null,null,"X","X",null,null,"X",null,"X",null,null,null,null,null,null,null,null,null],[["Halcyon Druid","halcyon_druid"],"X",null,null,null,null,"X",null,null,"X","X","X",null,null,"X",null,null,null,null,"X","X",null,null,null,null,null],[["Jungle Druid","jungle_druid"],"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,"X"],[["Kraken Caller","kraken_caller"],"X",null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,"X",null,null,null,null,"X"],[["Leshy Warden","leshy_warden"],"X",null,null,null,null,null,null,null,"X",null,"X",null,null,"X",null,null,null,null,"X","X",null,null,null,null,null],[["Life Channeler","life_channeler"],null,"X",null,null,null,null,null,null,"X",null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null],[["Lion Shaman","lion_shaman"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Mantella","mantella"],null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,"X",null,null,null,null,null],[["Menhir Savant","menhir_savant"],"X",null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,"X"],[["Mooncaller","mooncaller"],"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,"X"],[["Mountain Druid","mountain_druid"],"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X",null,null,null,null,null,null,null,"X"],[["Naga Aspirant","naga_aspirant"],"X",null,null,null,null,null,null,null,null,null,"X",null,null,"X","X",null,"X",null,null,"X",null,null,null,null,null],[["Nature Fang","nature_fang"],null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,"X",null,"X","X",null,null,null,null,"X"],[["Nature Priest","nature_priest"],null,null,null,null,null,"X","X",null,"X","X","X",null,null,null,null,null,"X","X",null,null,null,null,null,null,null],[["Nithveil Adept","nithveil_adept"],null,null,null,null,null,null,null,null,"X","X","X",null,null,"X",null,null,null,null,null,null,null,null,null,null,null],[["Pack Lord","pack_lord"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null],[["Plains Druid","plains_druid"],"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X",null,null,null,null,null,null,null,"X"],[["Planar Extremist","planar_extremist"],null,"X",null,null,null,null,null,null,"X",null,"X",null,"X","X",null,null,null,null,null,"X",null,null,null,null,null],[["Progenitor","progenitor"],null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null],[["Reincarnated Druid","reincarnated_druid"],null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,"X",null,null,null,null,null,null,null,"X"],[["Restorer","restorer"],"X",null,null,null,null,null,null,null,null,"X","X",null,null,"X",null,null,null,null,null,null,null,null,null,null,null],[["River Druid","river_druid"],null,null,null,null,null,"X",null,null,null,"X","X",null,null,null,"X","X",null,null,null,"X",null,null,null,null,"X"],[["Road Keeper","road_keeper"],null,null,null,null,null,null,null,null,"X",null,"X",null,null,"X",null,null,null,null,"X","X",null,null,null,null,"X"],[["Rot Warden","rot_warden"],null,null,null,null,null,null,null,null,"X",null,"X",null,null,"X",null,"X","X",null,"X","X",null,null,null,null,null],[["Saurian Shaman","saurian_shaman"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Season Keeper","season_keeper"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X","X","X",null,null,"X",null,null,null,null,null],[["Season Sage","season_sage"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null],[["Serpent Shaman","serpent_shaman"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Shark Shaman","shark_shaman"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Skinshaper","skinshaper"],"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null],[["Sky Druid","sky_druid"],"X",null,"X",null,null,null,null,null,"X",null,"X",null,null,null,null,"X","X","X",null,"X",null,null,null,null,"X"],[["Storm Druid","storm_druid"],"X",null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,"X","X",null,null,null,null,null,null,null,"X"],[["Sunrider","sunrider"],null,null,"X",null,null,"X",null,null,"X",null,"X",null,null,null,null,"X",null,"X",null,"X",null,null,null,null,"X"],[["Supernaturalist","supernaturalist"],null,null,"X",null,null,null,null,null,"X","X","X",null,null,null,null,"X",null,"X","X","X",null,null,null,null,null],[["Survivor","survivor"],null,null,"X",null,null,"X",null,null,"X",null,"X",null,"X",null,null,null,"X","X",null,"X",null,null,null,null,null],[["Swamp Druid","swamp_druid"],"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,"X"],[["Swarm Monger","swarm_monger"],null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null,null,null,null,null,null,"X","X"],[["Tempest Druid","tempest_druid"],null,"X","X",null,null,null,null,null,"X","X","X",null,null,null,null,"X","X","X",null,null,null,null,null,null,null],[["Tempest Tamer","tempest_tamer"],null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null,"X",null,null,null,null,null],[["Toxicologist","toxicologist"],null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,"X",null,null,"X","X",null,null,null,null,"X"],[["Treesinger","treesinger"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null],[["Troll Fury","troll_fury"],null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,"X",null,null,null,null,null,null],[["Undine Adept","undine_adept"],null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X","X",null,null,"X",null,null,null,null,"X"],[["Urban Druid","urban_druid"],null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,"X","X",null,null,null,null,null,null,null,"X"],[["Urushiol","urushiol"],null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Wild Whisperer","wild_whisperer"],null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,"X",null,null,null,null,"X"],[["Wolf Shaman","wolf_shaman"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["World Walker","world_walker"],null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X","X","X",null,null,null,null,null,null,null,null]],"initialColumn":0,"nullValue":"&nbsp;"}} />
<h3 id="class-druid-favored-class-bonuses" data-hash-target><Link to="/rule/favored_class">Favored Class Bonuses</Link></h3>
<RacialOptions cls="druid" />
</>};
const _monk = {hasJL:true,title: "Monk", jsx: <><div className="jumpList" id="class-monk-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="class-monk-ac-bonus-ex">AC Bonus</InnerLink></li><li><InnerLink toTop to="class-monk-flurry-of-blows-ex">Flurry of Blows</InnerLink></li><li><InnerLink toTop to="class-monk-unarmed-strike">Unarmed Strike</InnerLink></li><li><InnerLink toTop to="class-monk-vows">Vows</InnerLink></li><li><InnerLink toTop to="class-monk-bonus-feat">Bonus Feat</InnerLink></li><li><InnerLink toTop to="class-monk-stunning-fist-ex">Stunning Fist</InnerLink></li><li><InnerLink toTop to="class-monk-evasion-ex">Evasion</InnerLink></li><li><InnerLink toTop to="class-monk-fast-movement-ex">Third-Level Abilities</InnerLink></li><li><InnerLink toTop to="class-monk-ki-pool-su">Ki Pool</InnerLink></li><li><InnerLink toTop to="class-monk-slow-fall-ex">Slow Fall</InnerLink></li><li><InnerLink toTop to="class-monk-high-jump-ex">Fifth-to-Tenth-Level Abilities</InnerLink></li><li><InnerLink toTop to="class-monk-diamond-body-su">Eleventh-to-Fourteenth-Level Abilities</InnerLink></li><li><InnerLink toTop to="class-monk-quivering-palm-su">Higher-Level Abilities</InnerLink></li><li><InnerLink toTop to="class-monk-ex-monks">Ex-Monks</InnerLink></li><li><InnerLink toTop to="class-monk-alternate-capstones">Alternate Capstones</InnerLink></li><li><InnerLink toTop to="class-monk-archetypes">Archetypes</InnerLink></li><li><InnerLink toTop to="class-monk-archetypes-by-feature">Archetypes by Feature</InnerLink></li><li><InnerLink toTop to="class-monk-favored-class-bonuses">Favored Class Bonuses</InnerLink></li></ul></div><h2 id="class-monk-monk">Monk</h2>
...
<Ability id="flurry-of-blows-ex" icon={["melee"]}>
...
<Ability id="unarmed-strike" icon={["melee"]}>
...
</aside><Ability id="stunning-fist-ex" icon={["melee"]}>
...
<Ability id="maneuver-training-ex" icon={["melee"]}>
...
<Ability id="slow-fall-ex" icon={["def"]}>
<Pair single id="slow-fall-ex">Slow Fall (Ex)</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="high-jump-ex" icon={["boost"]}>
...
<Ability id="wholeness-of-body-su" icon={["boost"]}>
<Pair single id="wholeness-of-body-su">Wholeness of Body (Su)</Pair>
...
<Ability id="diamond-body-su" icon={["def"]}>
...
<Ability id="abundant-step-su" icon={["magic"]}>
...
<Ability id="diamond-soul-ex" icon={["def"]}>
...
<Ability id="quivering-palm-su" icon={["melee","magic"]}>
<Pair single id="quivering-palm-su" flavor="A monk can set up vibrations within the body of another creature that can thereafter be fatal.">Quivering Palm (Su)</Pair>
<Pair title="Gained">At 15th Level</Pair>
<Pair title="Usage">Once a day.</Pair>
...
<Ability id="perfect-self" icon={["boost","def"]}>
<Pair single id="perfect-self" flavor="A monk becomes a magical creature.">Perfect Self</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<p>A monk who becomes nonlawful cannot gain new levels as a monk but retains all monk abilities. (Also see the <Link to="/arc-monk/sin_monk">Sin Monk</Link> archetype for more options.)</p>
<h3 id="class-monk-alternate-capstones" data-hash-target>Alternate Capstones</h3>
<Message capstone /><div className="capstones"><ScrollContainer id="class-monk--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-monk/black_asp">Black Asp</Link></p><p><strong>Modifies or Replaces:</strong> Stunning Fist; Still Mind</p><p>The black asps are a sinister order of monks who train as assassins and infiltrators with no need for weapons to achieve their goals.</p></div>
...
<DisplayTable table={{"id":"monk archetypes","columns":[{"header":"Archetype","link":"arc-monk"},{"header":"Abundant Step"},{"header":"Alignment"},{"header":"Armor Proficiency"},{"header":"Bonus Feats"},{"header":"1st-level Bonus Feat"},{"header":"2nd-level Bonus Feat"},{"header":"6th-level Bonus Feat"},{"header":"10th-level Bonus Feat"},{"header":"12th-level Bonus Feat"},{"header":"14th-level Bonus Feat"},{"header":"18th-level Bonus Feat"},{"header":"Class Skills"},{"header":"Diamond Body"},{"header":"Diamond Soul"},{"header":"Empty Body"},{"header":"Evasion"},{"header":"Improved Evasion"},{"header":"Fast Movement"},{"header":"Flurry of Blows"},{"header":"High Jump"},{"header":"Key Ability Score"},{"header":"Ki Pool"},{"header":"Maneuver Training"},{"header":"Monk's AC"},{"header":"Perfect Self"},{"header":"Purity of Body"},{"header":"Quivering Palm"},{"header":"Slow Fall"},{"header":"Still Mind"},{"header":"Stunning Fist"},{"header":"Timeless Body"},{"header":"Tongue of the Sun and Moon"},{"header":"Unarmed Strike"},{"header":"Weapon Proficiency"},{"header":"Wholeness of Body"}],"data":[[["Black Asp","black_asp"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,"X",null],[["Brazen Disciple","brazen_disciple"],"X",null,null,null,"X",null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,"X",null],[["Disciple of Wholeness","disciple_of_wholeness"],null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,null,null,"X",null],[["Drunken Master","drunken_master"],null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X",null],[["Elemental Monk","elemental_monk"],null,"X",null,"X",null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,"X",null,null,null,"X",null,null,null,"X",null,null,null,"X",null],[["Far Strike Monk","far_strike_monk"],null,null,"X","X",null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,"X",null,null,"X","X",null,null,null,"X",null],[["Flowing Monk","flowing_monk"],null,null,null,null,null,"X",null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,"X","X",null,null,"X",null,null,null,"X",null],[["Gray Disciple","gray_disciple"],"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,"X","X","X",null,null,"X",null,"X","X"],[["Hamatulatsu Master","hamatulatsu_master"],null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,"X",null,null,null,"X",null],[["Harrow Warden","harrow_warden"],null,null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,"X",null],[["Hellcat","hellcat"],null,"X",null,"X",null,null,null,null,null,null,null,"X","X",null,null,"X","X","X",null,null,null,"X",null,null,null,"X",null,"X","X","X",null,null,null,"X","X"],[["Hungry Ghost Monk","hungry_ghost_monk"],null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,"X","X"],[["Invested Regent","invested_regent"],null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null],[["Ironskin Monk","ironskin_monk"],null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null,"X",null,"X",null,"X","X",null,null,"X",null,null,null,"X",null,"X",null],[["Karmic Monk","karmic_monk"],null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,"X",null,null,"X",null,null,"X","X","X",null,null,null,"X",null],[["Kata Master","kata_master"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,"X","X",null,null,null,"X","X"],[["Ki Mystic","ki_mystic"],null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X",null],[["Lifting Hand","lifting_hand"],"X",null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null],[["Maneuver Master","maneuver_master"],null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,"X","X","X","X",null,null,null,null,"X",null],[["Martial Artist","martial_artist"],"X",null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,"X",null,null,"X","X",null,"X","X",null,"X","X",null,"X","X"],[["Master of Many Styles","master_of_many_styles"],null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null,"X",null],[["Menhir Guardian","menhir_guardian"],null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,"X",null,null,null,null,"X",null,null,"X",null,null,"X","X",null],[["Monk of the Empty Hand","monk_of_the_empty_hand"],null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X",null],[["Monk of the Four Winds","monk_of_the_four_winds"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X",null,null,"X",null],[["Monk of the Healing Hand","monk_of_the_healing_hand"],null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,"X","X"],[["Monk of the Lotus","monk_of_the_lotus"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,"X",null,"X",null],[["Monk of the Mantis","monk_of_the_mantis"],null,null,null,null,null,"X","X","X",null,"X","X",null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,"X","X"],[["Monk of the Sacred Mountain","monk_of_the_sacred_mountain"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,"X",null,null,null,null,null,null,null,"X",null,null,null,"X",null,"X",null],[["Monk of the Seven Forms","monk_of_the_seven_forms"],"X",null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,"X",null,null,null,"X",null],[["Nimble Guardian","nimble_guardian"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X","X"],[["Nornkith","nornkith"],null,null,null,null,"X",null,null,"X",null,null,null,null,null,"X","X",null,null,null,null,null,"X",null,null,null,"X","X","X",null,null,"X",null,null,null,"X",null],[["Ouat","ouat"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X","X"],[["Perfect Scholar","perfect_scholar"],null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X","X",null,null,"X",null,"X",null],[["Qinggong Monk","qinggong_monk"],"X",null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,"X",null,null,null,null,"X",null,"X","X",null,null,"X","X",null,"X","X"],[["Sage Counselor","sage_counselor"],null,null,null,null,"X","X","X","X",null,null,null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,"X",null],[["Scaled Fist","scaled_fist"],null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,"X",null,null,null,null,"X",null],[["Scarred Monk","scarred_monk"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null,null,null,"X","X"],[["Sensei","sensei"],null,null,null,null,null,"X","X",null,"X",null,"X",null,null,null,null,"X","X","X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null],[["Serpent-Fire Adept","serpent_fire_adept"],null,null,null,null,"X","X","X","X",null,"X","X","X",null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,"X",null,"X",null,null,null,"X","X"],[["Sin Monk","sin_monk"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,"X",null,null,"X",null,null,null,null,null,null,null,null,"X","X"],[["Softstrike Monk","softstrike_monk"],null,null,null,null,null,null,"X","X",null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X","X","X"],[["Sohei","sohei"],"X",null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,"X","X","X",null,"X","X","X","X","X",null],[["Soul Shepherd","soul_shepherd"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,"X",null],[["Spirit Master","spirit_master"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,"X",null,"X","X","X",null,"X",null,null,null,null,"X","X"],[["Student of Stone","student_of_stone"],"X",null,null,"X",null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null],[["Terra-Cotta Monk","terra_cotta_monk"],"X",null,null,null,null,null,null,null,null,null,null,"X",null,null,"X","X","X",null,null,"X",null,null,null,null,null,null,"X",null,null,null,null,null,null,"X",null],[["Tetori","tetori"],"X",null,null,"X",null,null,null,null,null,null,null,null,null,"X","X",null,"X",null,"X","X",null,null,null,null,null,null,null,"X",null,null,"X","X",null,"X",null],[["Treetop Monk","treetop_monk"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X",null],[["Underfoot Adept","underfoot_adept"],null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null],[["Wanderer","wanderer"],"X",null,null,null,"X",null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,"X","X",null,null,null,null,"X","X"],[["Wasteland Meditant","wasteland_meditant"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,"X","X",null,"X",null,null,null,"X",null],[["Water Dancer","water_dancer"],"X",null,null,null,"X","X","X","X",null,"X","X",null,null,null,null,"X","X",null,"X",null,null,null,null,null,null,null,"X","X",null,"X",null,null,"X","X",null],[["Weapon Adept","weapon_adept"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,"X",null,null,null,null,"X","X",null,null,"X",null],[["Wildcat","wildcat"],"X",null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,"X",null,null,"X",null,"X",null,null,null,null,null,"X","X",null,null,null,null,"X",null],[["Windstep Master","windstep_master"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,"X",null,null,null,"X",null],[["Zen Archer","zen_archer"],null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X","X",null,null,null,null,null,"X",null,null,"X",null,null,"X","X",null,"X",null,"X",null]],"initialColumn":0,"nullValue":"&nbsp;"}} />
<h3 id="class-monk-favored-class-bonuses" data-hash-target><Link to="/rule/favored_class">Favored Class Bonuses</Link></h3>
<RacialOptions cls="cleric" />
</>};
