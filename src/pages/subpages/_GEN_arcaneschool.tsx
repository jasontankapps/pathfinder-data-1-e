...
<Ability id="aura-of-banishment-su" icon={["aura"]}>
<Pair single id="aura-of-banishment-su">Aura of Banishment (Su)</Pair>
...
<Ability id="lightning-flash-su" icon={["aura"]}>
<Pair single id="lightning-flash-su">Lightning Flash (Su)</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Usage">3 + Int modifier times/day</Pair>
...
<Ability id="cyclone-su" icon={["aura"]}>
<Pair single id="cyclone-su">Cyclone (Su)</Pair>
<Pair title="Gained">At 8th Level</Pair>
<Pair title="Usage">1 round/day per wizard level; these rounds need not be consecutive</Pair>
...
<Ability id="freezing-shards-su" icon={["aura"]}>
<Pair single id="freezing-shards-su">Freezing Shards (Su)</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Usage">3 + Int modifier times/day</Pair>
...
<Ability id="cold-blast-su" icon={["aura"]}>
<Pair single id="cold-blast-su">Cold Blast (Su)</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Usage">3 + Int modifier times/day</Pair>
