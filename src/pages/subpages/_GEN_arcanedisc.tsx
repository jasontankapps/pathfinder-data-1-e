...
<Ability id="alchemical-affinity" icon={["boost","learn"]}>
...
<Ability id="arcane-builder" icon={["boost"]}>
...
<Ability id="balanced-summoning" icon={["boost"]}>
...
<Ability id="beyond-morality-su" icon={["def"]}>
...
<Ability id="bonded-mask" icon={["def"]}>
...
<Ability id="creative-destruction-su" icon={["aid"]}>
...
<Ability id="defensive-feedback-su" icon={["def","magic"]}>
...
<Ability id="faith-magic" icon={["learn"]}>
...
<Ability id="fast-study" icon={["boost"]}>
...
<Ability id="golem-constructor" icon={["power"]}>
...
<Ability id="idealize-su" icon={["boost"]}>
...
<Ability id="immortality-ex" icon={["def"]}>
...
<Ability id="infectious-charms" icon={["magic","boost"]}>
...
<Ability id="ioun-bond" icon={["magic"]}>
...
<Ability id="knowledge-is-power-ex" icon={["boost","def"]}>
...
<Ability id="multimorph-su" icon={["power"]}>
...
<Ability id="observant-illusion-su" icon={["power"]}>
...
<Ability id="opposition-research" icon={["magic","boost"]}>
...
<Ability id="psychic-preparation" icon={["magic"]}>
...
<Ability id="resilient-illusions" icon={["boost"]}>
...
<Ability id="split-slot" icon={["magic"]}>
...
<Ability id="staff-like-wand" icon={["boost"]}>
...
<Ability id="steward-of-the-great-beyond" icon={["magic"]}>
...
<Ability id="time-stutter-sp" icon={["magic"]}>
...
<Ability id="true-name-sp" icon={["magic"]}>
...
<Ability id="werewolf-shape" icon={["boost"]}>
...
<Ability id="yuelrals-blessing" icon={["boost"]}>
