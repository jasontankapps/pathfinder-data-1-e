...
<Ability id="dark-communion-su" extraClasses="hasSubs" icon={["power","down"]}>
...
<Ability id="dark-power" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="fiendish-form" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="natural-attacks" extraClasses="subAbility" icon={["melee"]}>
...
<Ability id="spirit-power" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="unholy-resilience" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="ex-fiend-keepers" icon={["warning"]}>
...
<Ability id="kami-channeler-su" icon={["power","down"]}>
...
<Ability id="natural-taboo-ex" icon={["power"]}>
...
<Ability id="ofuda-su" icon={["magic"]}>
...
<Ability id="shikigami-ex" icon={["magic"]}>
...
<Ability id="ask-the-kami-su" icon={["magic"]}>
...
<Ability id="unarmed-strike" icon={["power"]}>
...
<Ability id="dedicated-spirit-su" icon={["down"]}>
...
<Ability id="dedicated-surge-su" icon={["boost"]}>
...
<Ability id="spirit-call-su" icon={["power"]}>
...
<Ability id="masters-power-su" extraClasses="hasSubs" icon={["melee"]}>
...
<Ability id="shared-prowess-su" icon={["def"]}>
...
<Ability id="masters-strike-su" icon={["power"]}>
...
<Ability id="ki-contact-su" icon={["power"]}>
...
<Ability id="masters-style-su" icon={["power"]}>
...
<Ability id="third-eye-sp-su" icon={["down","power"]}>
...
<Ability id="impossible-eye-su" icon={["boost","power"]}>
...
<Ability id="third-eye-mastery-su" icon={["boost"]}>
...
<Ability id="living-third-eye-su" icon={["boost"]}>
...
<Ability id="outsider-invocation-su" icon={["power"]}>
...
<Ability id="taboo-ex" icon={["down","warning"]}>
...
<Ability id="shared-seance-su" icon={["down"]}>
...
<Ability id="servitor-ex" icon={["power"]}>
...
<Ability id="ask-the-planes-sp" icon={["power"]}>
...
<Ability id="channel-self-su" icon={["info","power","down"]}>
...
<Ability id="nothing-is-taboo-ex" icon={["down"]}>
...
<Ability id="ease-passage-su" icon={["boost"]}>
...
<Ability id="lingering-spirit-su" icon={["def"]}>
...
<Ability id="spirit-warding-su" icon={["def"]}>
...
<Ability id="living-legend-su" icon={["power"]}>
...
<Ability id="relics-su" icon={["power"]}>
...
<Ability id="powerful-bond-su" icon={["power"]}>
...
<Ability id="apport-relic-su" icon={["magic"]}>
...
<Ability id="connection-specialty-sp" icon={["power"]}>
...
<Ability id="mind-and-soul-ex" icon={["info","down"]}>
...
<Ability id="spiritual-invocation-su" extraClasses="hasSubs" icon={["power","down"]}>
...
<Ability id="text-from-the-spirit-dancer-ability" extraClasses="subAbility" icon={["power","down"]}>
...
<Ability id="spiritual-parley-ex" icon={["boost"]}>
...
<Ability id="wrangle-condition-su" extraClasses="hasSubs" icon={["aid"]}>
...
<Ability id="text-from-the-animist-ability" extraClasses="subAbility" icon={["aid"]}>
...
<Ability id="haunt-channeler" icon={["down"]}>
...
<Ability id="spirit-dance-su" icon={["power","down"]}>
...
<Ability id="spirit-aura-su" icon={["aura","boost"]}>
...
<Ability id="spirit-troika-su" icon={["boost"]}>
...
<Ability id="attacca-su" icon={["boost"]}>
...
<Ability id="dance-of-infinite-forms-su" icon={["boost"]}>
...
<Ability id="ectoplasmic-strikes-su" icon={["boost"]}>
...
<Ability id="consume-spirit-su" icon={["power","boost"]}>
...
<Ability id="gozrehs-domain-su" icon={["power","learn"]}>
...
<Ability id="storm-trance-su" icon={["def"]}>
...
<Ability id="dream-storm-sp" icon={["magic"]}>
...
<Ability id="storm-seer-su" icon={["power"]}>
...
<Ability id="diminished-spirits-ex" icon={["down"]}>
...
<Ability id="storytellers-performance-su" icon={["power"]}>
...
<Ability id="learn-the-story-sp" icon={["magic"]}>
...
<Ability id="living-story-sp" icon={["magic"]}>
...
<Ability id="wendo-su" icon={["power","learn","down","warning"]}>
...
<Ability id="wendos-secrets-ex" icon={["boost"]}>
...
<Ability id="wendo-tongue-su" icon={["power"]}>
...
<Ability id="will-of-the-failed-su" icon={["power","down"]}>
...
<Ability id="reckless-surge-su" icon={["boost","down"]}>
...
<Ability id="heroic-exceptions-ex" icon={["boost","down"]}>
...
<Ability id="spiritual-swan-song-sp" icon={["magic"]}>
...
<Ability id="champion" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="guardian" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="marshal" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="trickster" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="emissary-su" icon={["power","down"]}>
...
<Ability id="surge-of-the-void-su" icon={["power","down"]}>
...
<Ability id="blasphemy-ex" icon={["power","down"]}>
