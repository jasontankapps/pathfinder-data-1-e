...
<Pair single id="evil-spirit-su">Evil Spirit (Su)</Pair>
...
<Ability id="dark-power" extraClasses="subAbility" icon={["upgrade","armor-upgrade"]}>
<Pair single id="dark-power">Dark Power</Pair>
...
<Ability id="fiendish-form" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="fiendish-form">Fiendish Form</Pair>
...
<Ability id="natural-attacks" extraClasses="subAbility" icon={["mailed-fist"]}>
<Pair single id="natural-attacks">Natural Attacks</Pair>
...
<Ability id="spirit-power" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="spirit-power">Spirit Power</Pair>
...
<Ability id="unholy-resilience" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="unholy-resilience">Unholy Resilience</Pair>
...
<Ability id="ex-fiend-keepers" icon={["hazard-sign"]}>
<Pair single id="ex-fiend-keepers">Ex-Fiend Keepers</Pair>
...
<Ability id="kami-channeler-su" icon={["stairs-goal","broken-shield"]}>
<Pair single id="kami-channeler-su">Kami Channeler (Su)</Pair>
<Pair hl title="Alters">Spirit</Pair>
...
<Ability id="natural-taboo-ex" icon={["stairs-goal"]}>
<Pair single id="natural-taboo-ex">Natural Taboo (Ex)</Pair>
...
<Ability id="shikigami-ex" icon={["magic-swirl"]}>
<Pair single id="shikigami-ex">Shikigami (Ex)</Pair>
...
<Ability id="ask-the-kami-su" icon={["magic-swirl"]}>
<Pair single id="ask-the-kami-su">Ask the Kami (Su)</Pair>
...
<Ability id="ward-su" icon={["magic-swirl"]}>
...
<Ability id="unarmed-strike" icon={["stairs-goal"]}>
...
<Ability id="dedicated-spirit-su" icon={["broken-shield"]}>
<Pair single id="dedicated-spirit-su">Dedicated Spirit (Su)</Pair>
<Pair hl title="Alters">Spirit</Pair>
...
<Ability id="dedicated-surge-su" icon={["upgrade"]}>
<Pair single id="dedicated-surge-su">Dedicated Surge (Su)</Pair>
...
<Ability id="spirit-call-su" icon={["stairs-goal"]}>
<Pair single id="spirit-call-su" flavor={<>The medium of the master's unique bond allows her to briefly call on a champion spirit without performing a <em>seance.</em></>}>Spirit Call (Su)</Pair>
...
<Ability id="masters-power-su" extraClasses="hasSubs" icon={["mailed-fist"]}>
<Pair single id="masters-power-su">Master's Power (Su)</Pair>
...
<Ability id="shared-prowess-su" icon={["armor-upgrade"]}>
<Pair single id="shared-prowess-su" flavor="A medium of the master's spirit endows her with greater martial expertise.">Shared Prowess (Su)</Pair>
...
<Ability id="masters-strike-su" icon={["stairs-goal"]}>
<Pair single id="masters-strike-su">Master's Strike (Su)</Pair>
...
<Ability id="ki-contact-su" icon={["stairs-goal"]}>
<Pair single id="ki-contact-su">Ki Contact (Su)</Pair>
...
<Ability id="masters-style-su" icon={["stairs-goal"]}>
<Pair single id="masters-style-su">Master's Style (Su)</Pair>
...
<Ability id="legend-of-nex-su" icon={["info"]}>
<Pair single id="legend-of-nex-su">Legend of Nex (Su)</Pair>
<Pair hl title="Alters">Spirit</Pair>
...
<Ability id="third-eye-sp-su" icon={["broken-shield","stairs-goal"]}>
<Pair single id="third-eye-sp-su">Third Eye (Sp, Su)</Pair>
...
<Ability id="impossible-eye-su" icon={["upgrade","stairs-goal"]}>
<Pair single id="impossible-eye-su" flavor="A Nexian channeler gains additional powers from his third eye.">Impossible Eye (Su)</Pair>
...
<Ability id="third-eye-mastery-su" icon={["upgrade"]}>
<Pair single id="third-eye-mastery-su" flavor={<>A Nexian channeler can open his <em>third eye</em> for longer than normal.</>}>Third Eye Mastery (Su)</Pair>
...
<Ability id="living-third-eye-su" icon={["upgrade"]}>
<Pair single id="living-third-eye-su" flavor={<>A Nexian channeler is as one with his <em>third eye.</em></>}>Living Third Eye (Su)</Pair>
...
<Ability id="taboo-ex" icon={["broken-shield","hazard-sign"]}>
...
<Ability id="shared-seance-su" icon={["broken-shield"]}>
...
<Ability id="servitor-ex" icon={["stairs-goal"]}>
<Pair single id="servitor-ex">Servitor (Ex)</Pair>
...
<Ability id="site-channeling-su" icon={["info"]}>
<Pair single id="site-channeling-su">Site Channeling (Su)</Pair>
...
<Ability id="ask-the-planes-sp" icon={["stairs-goal"]}>
<Pair single id="ask-the-planes-sp">Ask the Planes (Sp)</Pair>
<Pair hl title="Replaces">Astral journey</Pair>
...
<Ability id="channel-self-su" icon={["info","stairs-goal","broken-shield"]}>
<Pair single id="channel-self-su">Channel Self (Su)</Pair>
<Pair hl title="Alters">Spirit</Pair>
...
<Ability id="nothing-is-taboo-ex" icon={["broken-shield"]}>
<Pair single id="nothing-is-taboo-ex">Nothing Is Taboo (Ex)</Pair>
<Pair title="Info">A reanimated medium doesn't gain the <em>taboo</em> class feature.</Pair>
</Ability>
<Ability id="ease-passage-su" icon={["upgrade"]}>
<Pair single id="ease-passage-su">Ease Passage (Su)</Pair>
...
<Ability id="lingering-spirit-su" icon={["armor-upgrade"]}>
<Pair single id="lingering-spirit-su">Lingering Spirit (Su)</Pair>
<Pair hl title="Replaces">Location channel</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="spirit-warding-su" icon={["armor-upgrade"]}>
<Pair single id="spirit-warding-su" flavor="The reanimated medium can ward himself from other spirits and the grave's call.">Spirit Warding (Su)</Pair>
...
<Ability id="living-legend-su" icon={["stairs-goal"]}>
<Pair single id="living-legend-su">Living Legend (Su)</Pair>
<Pair hl title="Replaces">Astral beacon</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="relics-su" icon={["stairs-goal"]}>
...
<Ability id="powerful-bond-su" icon={["stairs-goal"]}>
...
<Pair single id="object-reading-su" flavor="Text from the occultist class">Object Reading (Su)</Pair>
...
<Ability id="apport-relic-su" icon={["magic-swirl"]}>
<Pair single id="apport-relic-su">Apport Relic (Su)</Pair>
<Pair hl title="Replaces">Location channel</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="connection-specialty-sp" icon={["stairs-goal"]}>
<Pair single id="connection-specialty-sp">Connection Specialty (Sp)</Pair>
...
<Ability id="mind-and-soul-ex" icon={["info","broken-shield"]}>
<Pair single id="mind-and-soul-ex">Mind and Soul (Ex)</Pair>
<Pair hl title="Alters">Spellcasting</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="spiritual-invocation-su" extraClasses="hasSubs" icon={["stairs-goal","broken-shield"]}>
<Pair single id="spiritual-invocation-su">Spiritual Invocation (Su)</Pair>
...
<Ability id="spiritual-parley-ex" icon={["upgrade"]}>
<Pair single id="spiritual-parley-ex">Spiritual Parley (Ex)</Pair>
...
<Ability id="wrangle-condition-su" extraClasses="hasSubs" icon={["remedy"]}>
<Pair single id="wrangle-condition-su">Wrangle Condition (Su)</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="haunt-channeler" icon={["broken-shield"]}>
<Pair single id="haunt-channeler">Haunt Channeler</Pair>
...
<Ability id="spirit-aura-su" icon={["aura","upgrade"]}>
<Pair single id="spirit-aura-su">Spirit Aura (Su)</Pair>
<Pair hl title="Replaces">Shared seance</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="spirit-troika-su" icon={["upgrade"]}>
<Pair single id="spirit-troika-su">Spirit Troika (Su)</Pair>
<Pair hl title="Replaces">Trance of three</Pair>
<Pair title="Gained">At 15th Level</Pair>
...
<Ability id="attacca-su" icon={["upgrade"]}>
<Pair single id="attacca-su">Attacca (Su)</Pair>
...
<Ability id="dance-of-infinite-forms-su" icon={["upgrade"]}>
<Pair single id="dance-of-infinite-forms-su">Dance of Infinite Forms (Su)</Pair>
<Pair hl title="Replaces">Astral beacon</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="ectoplasmic-strikes-su" icon={["upgrade"]}>
<Pair single id="ectoplasmic-strikes-su">Ectoplasmic Strikes (Su)</Pair>
<Pair hl title="Replaces">Haunt channeler</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="gozrehs-domain-su" icon={["stairs-goal","spell-book"]}>
<Pair single id="gozrehs-domain-su">Gozreh's Domain (Su)</Pair>
...
<Ability id="storm-trance-su" icon={["armor-upgrade"]}>
<Pair single id="storm-trance-su">Storm Trance (Su)</Pair>
<Pair hl title="Replaces">Haunt channeler</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="dream-storm-sp" icon={["magic-swirl"]}>
<Pair single id="dream-storm-sp">Dream Storm (Sp)</Pair>
<Pair hl title="Replaces">Location channel</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="storm-seer-su" icon={["stairs-goal"]}>
<Pair single id="storm-seer-su">Storm Seer (Su)</Pair>
<Pair hl title="Replaces">Connection channel</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="diminished-spirits-ex" icon={["broken-shield"]}>
<Pair single id="diminished-spirits-ex">Diminished Spirits (Ex)</Pair>
<Pair hl title="Alters">Spirit</Pair>
...
<Ability id="knowledge-of-tales-ex" icon={["upgrade"]}>
...
<Ability id="versatile-surge-su" icon={["stairs-goal"]}>
...
<Ability id="storytellers-performance-su" icon={["stairs-goal"]}>
<Pair single id="storytellers-performance-su">Storyteller's Performance (Su)</Pair>
...
<Ability id="learn-the-story-sp" icon={["magic-swirl"]}>
<Pair single id="learn-the-story-sp">Learn the Story (Sp)</Pair>
...
<Ability id="living-story-sp" icon={["magic-swirl"]}>
<Pair single id="living-story-sp">Living Story (Sp)</Pair>
<Pair hl title="Replaces">Astral beacon</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="wendos-secrets-ex" icon={["upgrade"]}>
<Pair single id="wendos-secrets-ex">Wendo's Secrets (Ex)</Pair>
<Pair hl title="Replaces">Shared seance</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="wendo-tongue-su" icon={["stairs-goal"]}>
<Pair single id="wendo-tongue-su">Wendo Tongue (Su)</Pair>
<Pair hl title="Replaces">Haunt channeler, location channel, connection channel</Pair>
...
<Ability id="reckless-surge-su" icon={["upgrade","broken-shield"]}>
<Pair single id="reckless-surge-su">Reckless Surge (Su)</Pair>
<Pair hl title="Alters">Spirit surge</Pair>
...
<Ability id="heroic-exceptions-ex" icon={["upgrade","broken-shield"]}>
<Pair single id="heroic-exceptions-ex">Heroic Exceptions (Ex)</Pair>
<Pair hl title="Alters">Taboo</Pair>
...
<Ability id="champion" extraClasses="subAbility" icon={["magic-swirl"]}>
...
<Ability id="guardian" extraClasses="subAbility" icon={["magic-swirl"]}>
...
<Ability id="marshal" extraClasses="subAbility" icon={["magic-swirl"]}>
...
<Ability id="trickster" extraClasses="subAbility" icon={["magic-swirl"]}>
...
<Ability id="emissary-su" icon={["stairs-goal","broken-shield"]}>
<Pair single id="emissary-su">Emissary (Su)</Pair>
<Pair hl title="Alters">Spirit</Pair>
...
<Ability id="surge-of-the-void-su" icon={["stairs-goal","broken-shield"]}>
<Pair single id="surge-of-the-void-su">Surge of the Void (Su)</Pair>
<Pair hl title="Alters">Spirit surge</Pair>
...
<Ability id="blasphemy-ex" icon={["stairs-goal","broken-shield"]}>
<Pair single id="blasphemy-ex">Blasphemy (Ex)</Pair>
<Pair hl title="Alters">Taboo</Pair>
...
<Ability id="void-channeler-su" icon={["aura"]}>
<Pair single id="void-channeler-su" flavor="The voice of the void can funnel energy from the emissaries' realm through himself.">Void Channeler (Su)</Pair>
<Pair hl title="Replaces">Haunt channeler</Pair>
<Pair title="Gained">At 3rd Level</Pair>
