...
<Ability id="bloody-gift-su" icon={["power"]}>
...
<Ability id="avatar-gambit-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="rage-power-ex" icon={["power"]}>
...
<Ability id="blood-offering-su" icon={["boost"]}>
...
<Ability id="blood-travel-su" icon={["magic"]}>
...
<Ability id="fiendish-calling-su" icon={["magic"]}>
...
<Ability id="blood-possession-su" icon={["magic"]}>
...
<Ability id="eidolon-brood" icon={["power"]}>
...
<Ability id="brood-link-su" icon={["protect"]}>
...
<Ability id="bond-senses-su" icon={["power"]}>
...
<Ability id="makers-call-su" icon={["power"]}>
...
<Ability id="larger-brood" icon={["boost"]}>
...
<Ability id="brood-bond-su" icon={["def"]}>
...
<Ability id="counter-summon-su" icon={["magic"]}>
...
<Ability id="detect-summons-su" icon={["power"]}>
...
<Ability id="weaken-summons-su" icon={["magic","lower"]}>
...
<Ability id="improved-weaken-summons-su" icon={["lower"]}>
...
<Ability id="mutate-eidolon-su" icon={["power"]}>
...
<Ability id="evolve-base-form-su" icon={["power"]}>
...
<Ability id="transmogrify-sp" icon={["magic"]}>
...
<Ability id="summon-natures-ally-sp" icon={["learn","magic"]}>
...
<Ability id="fey-summons-su" icon={["magic"]}>
...
<Ability id="lesser-eidolon" icon={["down"]}>
...
<Ability id="summoning-mastery-sp" icon={["magic","boost"]}>
...
<Ability id="augment-summoning" icon={["power"]}>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-summoner-morphic_savant--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Chaotic alignment</td></tr></tbody></table></ScrollContainer></div><Ability id="eidolon-of-chaos" icon={["info","power"]}>
...
<Ability id="natures-call-sp" icon={["magic"]}>
...
<Ability id="third-animal-focus-su" icon={["boost"]}>
...
<Ability id="bound-to-fire-ex" icon={["def","down"]}>
...
<Ability id="heart-of-earth-and-fire-ex" icon={["boost","def"]}>
...
<Ability id="shadow-eidolon" icon={["info","magic"]}>
...
<Ability id="shaitan-magic-su" icon={["power"]}>
...
<Ability id="stone-curse-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="stone-curse-su" extraClasses="subAbility" icon={["melee"]}>
...
<Ability id="noble-eidolon-sp" icon={["magic"]}>
...
<Ability id="spirit-su" icon={["power","learn"]}>
...
<Ability id="eidolon" icon={["power","down"]}>
<Pair single id="eidolon">Eidolon</Pair>
<Pair hl title="Alters">Eidolon</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="storykin-eidolon" icon={["boost","down"]}>
...
<Ability id="summon-arcana" icon={["boost"]}>
...
<Ability id="evolve-base-form-su" icon={["magic"]}>
<Pair single id="evolve-base-form-su">Evolve Base Form (Su)</Pair>
<Pair hl title="Replaces">Transposition</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="fused-eidolon" icon={["power","boost","def","down"]}>
...
<Ability id="fused-link-su" icon={["protect"]}>
...
<Ability id="shielded-meld-ex" icon={["def"]}>
...
<Ability id="makers-jump-sp" icon={["magic"]}>
...
<Ability id="greater-shielded-meld-ex" icon={["def"]}>
...
<Ability id="split-forms-su" icon={["magic"]}>
...
<Ability id="twinned-eidolon-evolutions" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="shared-evolution" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="extra-feat" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="shared-slot" extraClasses="subAbility" icon={["power"]}>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-summoner-unwavering_conduit--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Alignment must be lawful</td></tr></tbody></table></ScrollContainer></div><Ability id="eidolon-of-law" icon={["info","def","down"]}>
...
<Ability id="law-magic" icon={["learn"]}>
...
<Ability id="eidolon" icon={["boost","down"]}>
...
<Ability id="summon-natures-ally-i-sp" icon={["magic"]}>
...
<Ability id="fey-friend-ex" icon={["boost"]}>
