...
<Ability id="bloody-gift-su" icon={["stairs-goal"]}>
<Pair single id="bloody-gift-su">Bloody Gift (Su)</Pair>
...
<Ability id="avatar-gambit-ex" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="avatar-gambit-ex">Avatar Gambit (Ex)</Pair>
...
<Ability id="rage-power-ex" icon={["stairs-goal"]}>
...
<Ability id="blood-travel-su" icon={["magic-swirl"]}>
<Pair single id="blood-travel-su">Blood Travel (Su)</Pair>
...
<Ability id="fiendish-calling-su" icon={["magic-swirl"]}>
<Pair single id="fiendish-calling-su">Fiendish Calling (Su)</Pair>
...
<Ability id="blood-possession-su" icon={["magic-swirl"]}>
<Pair single id="blood-possession-su">Blood Possession (Su)</Pair>
...
<Ability id="eidolon-brood" icon={["stairs-goal"]}>
<Pair single id="eidolon-brood">Eidolon Brood</Pair>
...
<Ability id="brood-link-su" icon={["shield-reflect"]}>
<Pair single id="brood-link-su">Brood Link (Su)</Pair>
...
<Ability id="bond-senses-su" icon={["stairs-goal"]}>
...
<Ability id="makers-call-su" icon={["stairs-goal"]}>
...
<Ability id="larger-brood" icon={["upgrade"]}>
<Pair single id="larger-brood">Larger Brood</Pair>
...
<Ability id="brood-bond-su" icon={["armor-upgrade"]}>
<Pair single id="brood-bond-su">Brood Bond (Su)</Pair>
...
<Ability id="counter-summon-su" icon={["magic-swirl"]}>
<Pair single id="counter-summon-su">Counter-Summon (Su)</Pair>
...
<Ability id="detect-summons-su" icon={["stairs-goal"]}>
<Pair single id="detect-summons-su">Detect Summons (Su)</Pair>
...
<Ability id="weaken-summons-su" icon={["magic-swirl","armor-downgrade"]}>
<Pair single id="weaken-summons-su">Weaken Summons (Su)</Pair>
...
<Ability id="improved-weaken-summons-su" icon={["armor-downgrade"]}>
<Pair single id="improved-weaken-summons-su">Improved Weaken Summons (Su)</Pair>
...
<Ability id="mutate-eidolon-su" icon={["stairs-goal"]}>
<Pair single id="mutate-eidolon-su">Mutate Eidolon (Su)</Pair>
...
<Ability id="evolve-base-form-su" icon={["stairs-goal"]}>
<Pair single id="evolve-base-form-su">Evolve Base Form (Su)</Pair>
<Pair hl title="Replaces">Transposition</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="transmogrify-sp" icon={["magic-swirl"]}>
<Pair single id="transmogrify-sp">Transmogrify (Sp)</Pair>
<Pair hl title="Replaces">Greater shield ally</Pair>
...
<Ability id="summon-natures-ally-sp" icon={["spell-book","magic-swirl"]}>
...
<Ability id="leshy-eidolon" icon={["info"]}>
<Pair single id="leshy-eidolon">Leshy Eidolon</Pair>
...
<Ability id="lesser-eidolon" icon={["broken-shield"]}>
<Pair single id="lesser-eidolon">Lesser Eidolon</Pair>
<Pair hl title="Replaces">Eidolon</Pair>
...
<Ability id="summoning-mastery-sp" icon={["magic-swirl","upgrade"]}>
<Pair single id="summoning-mastery-sp">Summoning Mastery (Sp)</Pair>
...
<Ability id="augment-summoning" icon={["stairs-goal"]}>
<Pair single id="augment-summoning">Augment Summoning</Pair>
<Pair hl title="Replaces">Bond senses</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-summoner-morphic_savant--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Chaotic alignment</td></tr></tbody></table></ScrollContainer></div><Ability id="eidolon-of-chaos" icon={["info","stairs-goal"]}>
...
<Ability id="natures-call-sp" icon={["magic-swirl"]}>
<Pair single id="natures-call-sp">Nature's Call (Sp)</Pair>
...
<Pair single id="shared-focus-su" flavor="The naturalist begins to take on some of the feral nature of his eidolon.">Shared Focus (Su)</Pair>
<Pair hl title="Replaces">Life bond</Pair>
...
<Ability id="third-animal-focus-su" icon={["upgrade"]}>
<Pair single id="third-animal-focus-su">Third Animal Focus (Su)</Pair>
<Pair hl title="Replaces">Greater aspect</Pair>
<Pair title="Gained">At 18th Level</Pair>
...
<Ability id="bound-to-fire-ex" icon={["armor-upgrade","broken-shield"]}>
<Pair single id="bound-to-fire-ex">Bound to Fire (Ex)</Pair>
...
<Ability id="detonate-su" icon={["aura"]}>
<Pair single id="detonate-su">Detonate (Su)</Pair>
<Pair hl title="Replaces">Maker's call</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="heart-of-earth-and-fire-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="heart-of-earth-and-fire-ex">Heart of Earth and Fire (Ex)</Pair>
<Pair hl title="Replaces">Transposition</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="shadow-eidolon" icon={["info","magic-swirl"]}>
<Pair single id="shadow-eidolon">Shadow Eidolon</Pair>
...
<Ability id="shaitan-magic-su" icon={["stairs-goal"]}>
<Pair single id="shaitan-magic-su">Shaitan Magic (Su)</Pair>
<Pair hl title="Replaces">Shield ally, greater shield ally</Pair>
...
<Ability id="stone-curse-su" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="stone-curse-su">Stone Curse (Su)</Pair>
<Pair hl title="Replaces">Greater aspect</Pair>
<Pair title="Gained">At 18th Level</Pair>
...
<Ability id="stone-curse-su" extraClasses="subAbility" icon={["mailed-fist"]}>
<Pair single id="stone-curse-su" flavor="Text from the shaitan ability.">Stone Curse (Su)</Pair>
...
<Ability id="noble-eidolon-sp" icon={["magic-swirl"]}>
<Pair single id="noble-eidolon-sp">Noble Eidolon (Sp)</Pair>
<Pair hl title="Replaces">Twin eidolon</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="spirit-su" icon={["stairs-goal","spell-book"]}>
<Pair single id="spirit-su">Spirit (Su)</Pair>
<Pair hl title="Replaces">Summon monster</Pair>
...
<Ability id="eidolon" icon={["stairs-goal","broken-shield"]}>
<Pair single id="eidolon">Eidolon</Pair>
<Pair hl title="Alters">Eidolon</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="hex" icon={["stairs-goal"]}>
<Pair single id="hex">Hex</Pair>
...
<Ability id="storykin-eidolon" icon={["upgrade","broken-shield"]}>
<Pair single id="storykin-eidolon">Storykin Eidolon</Pair>
<Pair title="Usage">3 + Charisma modifier times/day</Pair>
...
<Ability id="summon-arcana" icon={["upgrade"]}>
<Pair single id="summon-arcana">Summon Arcana</Pair>
<Pair hl title="Replaces">Bond senses</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="evolve-base-form-su" icon={["magic-swirl"]}>
<Pair single id="evolve-base-form-su">Evolve Base Form (Su)</Pair>
<Pair hl title="Replaces">Transposition</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="fused-link-su" icon={["shield-reflect"]}>
<Pair single id="fused-link-su">Fused Link (Su)</Pair>
<Pair hl title="Replaces">Life link</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="shielded-meld-ex" icon={["armor-upgrade"]}>
<Pair single id="shielded-meld-ex">Shielded Meld (Ex)</Pair>
<Pair hl title="Replaces">Shield ally</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="makers-jump-sp" icon={["magic-swirl"]}>
<Pair single id="makers-jump-sp">Maker's Jump (Sp)</Pair>
<Pair hl title="Replaces">Maker's call, transposition</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="greater-shielded-meld-ex" icon={["armor-upgrade"]}>
<Pair single id="greater-shielded-meld-ex">Greater Shielded Meld (Ex)</Pair>
<Pair hl title="Replaces">Greater shield ally</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="split-forms-su" icon={["magic-swirl"]}>
<Pair single id="split-forms-su">Split Forms (Su)</Pair>
<Pair hl title="Replaces">Merge forms</Pair>
<Pair title="Gained">At 16th Level</Pair>
...
<Ability id="twinned-eidolon-evolutions" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="twinned-eidolon-evolutions">Twinned Eidolon Evolutions</Pair>
<Pair title="Info">The following evolutions are only available to this archetype.</Pair>
</Ability>
<Ability id="shared-evolution" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="shared-evolution">Shared Evolution</Pair>
...
<Ability id="extra-feat" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="extra-feat">Extra Feat</Pair>
...
<Ability id="shared-slot" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="shared-slot">Shared Slot</Pair>
<Pair title="Cost">2 points</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-summoner-unwavering_conduit--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Alignment must be lawful</td></tr></tbody></table></ScrollContainer></div><Ability id="eidolon-of-law" icon={["info","armor-upgrade","broken-shield"]}>
...
<Pair single id="unwavering-monsters">Unwavering Monsters</Pair>
<Pair hl title="Alters">Summon monster</Pair>
...
<Ability id="law-magic" icon={["spell-book"]}>
<Pair single id="law-magic">Law Magic</Pair>
<Pair hl title="Alters">Spells known</Pair>
...
<Ability id="summon-natures-ally-i-sp" icon={["magic-swirl"]}>
<Pair single id="summon-natures-ally-i-sp">Summon Nature's Ally I (Sp)</Pair>
<Pair hl title="Replaces">Summon monster I</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Usage">3 + Charisma modifier times/day</Pair>
...
<Ability id="plant-eidolon" icon={["info"]}>
<Pair single id="plant-eidolon">Plant Eidolon</Pair>
...
<Ability id="fey-friend-ex" icon={["upgrade"]}>
<Pair single id="fey-friend-ex">Fey Friend (Ex)</Pair>
<Pair hl title="Replaces">Aspect</Pair>
<Pair title="Gained">At 10th Level</Pair>
<Pair title="Passive Ability">The wild caller gains a +4 bonus on Bluff, Diplomacy, and Sense Motive checks against fey.</Pair>
</Ability>
<Ability id="aspect" icon={["upgrade"]}>
<Pair single id="aspect">Aspect</Pair>
<Pair hl title="Replaces">Greater aspect</Pair>
<Pair title="Gained">At 18th Level</Pair>
