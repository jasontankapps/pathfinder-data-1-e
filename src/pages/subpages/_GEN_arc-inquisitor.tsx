...
<Ability id="aura-of-repetition-su" icon={["aura"]}>
...
<Ability id="judgment-su" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="judgment-su">Judgment (Su)</Pair>
...
<Ability id="solo-tactics-ex" icon={["info"]}>
...
<Pair single id="dark-descent-su">Dark Descent (Su)</Pair>
<Pair hl title="Alters">Domain</Pair>
...
<Ability id="judgment" extraClasses="hasSubs" icon={["info"]}>
<Pair single id="judgment">Judgment</Pair>
...
<Ability id="purity" extraClasses="subAbility" icon={["info"]}>
...
<Ability id="smiting" extraClasses="subAbility" icon={["info"]}>
<Pair single id="smiting">Smiting</Pair>
<Pair title="Gained">At 6th Level</Pair>
