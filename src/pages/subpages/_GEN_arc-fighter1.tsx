...
<Ability id="hellknight-order" icon={["info"]}>
<Pair single id="hellknight-order">Hellknight Order</Pair>
...
<Ability id="spear-training-ex" icon={["info"]}>
<Pair single id="spear-training-ex">Spear Training (Ex)</Pair>
...
<Ability id="weapon-mastery" icon={["info"]}>
