...
<Ability id="aberrant-sight-ex" icon={["stairs-goal"]}>
<Pair single id="aberrant-sight-ex">Aberrant Sight (Ex)</Pair>
...
<Ability id="alien-mind-ex" icon={["armor-upgrade"]}>
<Pair single id="alien-mind-ex">Alien Mind (Ex)</Pair>
...
<Ability id="fluid-bones-ex" icon={["stairs-goal"]}>
<Pair single id="fluid-bones-ex">Fluid Bones (Ex)</Pair>
...
<Ability id="bestial-flashes-su" icon={["mailed-fist","broken-shield"]}>
<Pair single id="bestial-flashes-su">Bestial Flashes (Su)</Pair>
...
<Ability id="bloodthirsty-su" icon={["upgrade","broken-shield"]}>
<Pair single id="bloodthirsty-su">Bloodthirsty (Su)</Pair>
...
<Ability id="festering-flesh-su" icon={["armor-upgrade","broken-shield"]}>
<Pair single id="festering-flesh-su">Festering Flesh (Su)</Pair>
...
<Ability id="palsy-su" icon={["armor-upgrade","broken-shield"]}>
<Pair single id="palsy-su">Palsy (Su)</Pair>
...
<Ability id="rabid-vomit-ex" icon={["tornado-discs","broken-shield"]}>
<Pair single id="rabid-vomit-ex">Rabid Vomit (Ex)</Pair>
...
<Ability id="scavenger-su" icon={["upgrade","armor-upgrade","broken-shield"]}>
<Pair single id="scavenger-su">Scavenger (Su)</Pair>
...
<Ability id="unexpected-frenzy-su" icon={["upgrade","broken-shield"]}>
<Pair single id="unexpected-frenzy-su">Unexpected Frenzy (Su)</Pair>
...
<Ability id="unsavory-friends-su" icon={["armor-upgrade","broken-shield"]}>
<Pair single id="unsavory-friends-su">Unsavory Friends (Su)</Pair>
...
<Ability id="camouflage-ex" icon={["upgrade"]}>
...
<Ability id="cunning-ambusher-ex" icon={["armor-upgrade","upgrade","armor-downgrade"]}>
<Pair single id="cunning-ambusher-ex">Cunning Ambusher (Ex)</Pair>
...
<Ability id="native-environment-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="native-environment-ex">Native Environment (Ex)</Pair>
<Pair hl title="Replaces">Share Spells</Pair>
...
<Ability id="augmented-body-ex" icon={["broken-shield"]}>
<Pair single id="augmented-body-ex">Augmented Body (Ex)</Pair>
...
<Ability id="augmented-sight-ex" icon={["stairs-goal"]}>
<Pair single id="augmented-sight-ex">Augmented Sight (Ex)</Pair>
<Pair hl title="Replaces">Share Spells</Pair>
<Pair title="Passive Ability">An augmented companion gains low-light vision and darkvision to a range of 60 feet.</Pair>
</Ability>
<Ability id="constructed-form-ex" icon={["armor-upgrade"]}>
<Pair single id="constructed-form-ex">Constructed Form (Ex)</Pair>
<Pair hl title="Replaces">Devotion</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="aligned-ex" icon={["stairs-goal"]}>
<Pair single id="aligned-ex">Aligned (Ex)</Pair>
...
<Ability id="auspicious-boon-sp-su" icon={["stairs-goal","magic-swirl"]}>
<Pair single id="auspicious-boon-sp-su">Auspicious Boon (Sp, Su)</Pair>
...
<Ability id="aligned-strike-ex" icon={["mailed-fist"]}>
<Pair single id="aligned-strike-ex">Aligned Strike (Ex)</Pair>
...
<Ability id="animal-feats" icon={["stairs-goal"]}>
...
<Ability id="shared-vigilance-ex" icon={["stairs-goal"]}>
<Pair single id="shared-vigilance-ex">Shared Vigilance (Ex)</Pair>
<Pair hl title="Replaces">Share Spells</Pair>
...
<Ability id="tenacious-guardian-ex" icon={["upgrade","mailed-fist"]}>
<Pair single id="tenacious-guardian-ex">Tenacious Guardian (Ex)</Pair>
<Pair hl title="Replaces">Evasion</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="greater-tenacity-ex" icon={["mailed-fist","armor-upgrade"]}>
<Pair single id="greater-tenacity-ex">Greater Tenacity (Ex)</Pair>
<Pair hl title="Replaces">Improved Evasion</Pair>
<Pair title="Gained">At 15th Level</Pair>
...
<Ability id="bully-feats" icon={["stairs-goal"]}>
<Pair single id="bully-feats">Bully Feats</Pair>
<Pair hl title="Replaces">Share Spells</Pair>
...
<Ability id="bullying-thrill-ex" icon={["mailed-fist"]}>
<Pair single id="bullying-thrill-ex">Bullying Thrill (Ex)</Pair>
<Pair hl title="Replaces">Multiattack</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="barding-training-ex" icon={["upgrade"]}>
<Pair single id="barding-training-ex">Barding Training (Ex)</Pair>
...
<Ability id="indefatigable-ex" icon={["armor-upgrade"]}>
<Pair single id="indefatigable-ex">Indefatigable (Ex)</Pair>
<Pair hl title="Replaces">Devotion</Pair>
<Pair title="Gained">At 6th Level</Pair>
<Pair title="Passive Ability">A charger becomes immune to <Link to="/misc/fatigue">fatigue</Link>.</Pair>
</Ability>
<Ability id="stalwart-steed-ex" icon={["armor-upgrade"]}>
<Pair single id="stalwart-steed-ex">Stalwart Steed (Ex)</Pair>
<Pair hl title="Replaces">Improved Evasion</Pair>
<Pair title="Gained">At 15th Level</Pair>
...
<Ability id="artful-acrobat-ex" icon={["upgrade"]}>
<Pair single id="artful-acrobat-ex">Artful Acrobat (Ex)</Pair>
<Pair hl title="Replaces">Share Spells</Pair>
...
<Ability id="devil-may-care-ex" icon={["armor-upgrade"]}>
<Pair single id="devil-may-care-ex">Devil May Care (Ex)</Pair>
<Pair hl title="Replaces">Multiattack</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="deathtouched-skills" icon={["upgrade"]}>
<Pair single id="deathtouched-skills">Deathtouched Skills</Pair>
...
<Ability id="dead-sight-ex" icon={["stairs-goal"]}>
<Pair single id="dead-sight-ex">Dead Sight (Ex)</Pair>
<Pair hl title="Replaces">Share Spells</Pair>
<Pair title="Passive Ability">A deathtouched companion gains darkvision to a range of 60 feet.</Pair>
</Ability>
<Ability id="negative-energy-affinity-ex" icon={["broken-shield"]}>
<Pair single id="negative-energy-affinity-ex">Negative Energy Affinity (Ex)</Pair>
...
<Ability id="draconic-sight-ex" icon={["stairs-goal"]}>
<Pair single id="draconic-sight-ex">Draconic Sight (Ex)</Pair>
<Pair hl title="Replaces">Share Spells</Pair>
...
<Ability id="improved-draconic-resistance-ex" icon={["armor-upgrade"]}>
<Pair single id="improved-draconic-resistance-ex">Improved Draconic Resistance (Ex)</Pair>
<Pair hl title="Replaces">Devotion</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="breath-weapon-ex" icon={["tornado-discs","barbed-arrow"]}>
<Pair single id="breath-weapon-ex">Breath Weapon (Ex)</Pair>
...
<Ability id="elemental-type-ex" icon={["stairs-goal"]}>
...
<Ability id="lesser-elemental-manifestation-ex" icon={["armor-upgrade","stairs-goal"]}>
<Pair single id="lesser-elemental-manifestation-ex">Lesser Elemental Manifestation (Ex)</Pair>
...
<Ability id="greater-elemental-manifestation-su" icon={["stairs-goal","mailed-fist"]}>
<Pair single id="greater-elemental-manifestation-su">Greater Elemental Manifestation (Su)</Pair>
<Pair hl title="Replaces">Multiattack</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="small-but-fierce-ex" icon={["upgrade"]}>
<Pair single id="small-but-fierce-ex">Small but Fierce (Ex)</Pair>
...
<Ability id="fey-magic-sp" icon={["stairs-goal","magic-swirl"]}>
<Pair single id="fey-magic-sp">Fey Magic (Sp)</Pair>
...
<Ability id="iron-bane-ex" icon={["armor-upgrade"]}>
<Pair single id="iron-bane-ex">Iron Bane (Ex)</Pair>
...
<Ability id="expanded-tricks-ex" icon={["upgrade"]}>
<Pair single id="expanded-tricks-ex">Expanded Tricks (Ex)</Pair>
<Pair hl title="Replaces">Evasion, Improved Evasion</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="perspicacious-mind-ex" icon={["upgrade"]}>
<Pair single id="perspicacious-mind-ex">Perspicacious Mind (Ex)</Pair>
...
<Ability id="racer-feats" icon={["stairs-goal"]}>
<Pair single id="racer-feats">Racer Feats</Pair>
...
<Ability id="sprint-ex" icon={["upgrade"]}>
...
<Ability id="spiritual-guidance-sp" icon={["stairs-goal","magic-swirl"]}>
<Pair single id="spiritual-guidance-sp">Spiritual Guidance (Sp)</Pair>
<Pair hl title="Replaces">Evasion</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="beast-speech-ex" icon={["stairs-goal"]}>
<Pair single id="beast-speech-ex">Beast Speech (Ex)</Pair>
<Pair hl title="Replaces">Devotion</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="eldritch-claws" icon={["stairs-goal","mailed-fist"]}>
<Pair single id="eldritch-claws">Eldritch Claws</Pair>
<Pair hl title="Replaces">Multiattack</Pair>
<Pair title="Gained">At 9th Level</Pair>
<Pair title="Passive Ability">A totem guide gains <Link to="/feat/eldritch_claws">Eldritch Claws</Link> as a bonus feat.</Pair>
</Ability>
<Ability id="ghost-guardian-ex" icon={["mailed-fist","armor-upgrade","upgrade"]}>
<Pair single id="ghost-guardian-ex">Ghost Guardian (Ex)</Pair>
<Pair hl title="Replaces">Improved Evasion</Pair>
<Pair title="Gained">At 15th Level</Pair>
...
<Ability id="tracker-skills" icon={["upgrade"]}>
<Pair single id="tracker-skills">Tracker Skills</Pair>
<Pair title="Passive Ability">Trackers treat Survival as a class skill.</Pair>
</Ability>
<Ability id="expert-tracker-ex" icon={["upgrade"]}>
<Pair single id="expert-tracker-ex">Expert Tracker (Ex)</Pair>
...
<Ability id="genius-that-creeps-and-crawls-ex" icon={["upgrade"]}>
<Pair single id="genius-that-creeps-and-crawls-ex">Genius that Creeps and Crawls (Ex)</Pair>
<Pair hl title="Replaces">Share Spells</Pair>
...
<Ability id="photosynthesis-ex" icon={["stairs-goal"]}>
<Pair single id="photosynthesis-ex">Photosynthesis (Ex)</Pair>
...
<Ability id="verdant-resistance-ex" icon={["armor-upgrade"]}>
<Pair single id="verdant-resistance-ex">Verdant Resistance (Ex)</Pair>
...
<Ability id="wrecker-feats" icon={["upgrade"]}>
<Pair single id="wrecker-feats">Wrecker Feats</Pair>
...
<Ability id="destructive-wrecker-ex" icon={["mailed-fist"]}>
<Pair single id="destructive-wrecker-ex">Destructive Wrecker (Ex)</Pair>
<Pair hl title="Replaces">Share Spells, Multiattack</Pair>
