...
<Ability id="not-quite-animal" icon={["def"]}>
...
<Ability id="aberrant-sight-ex" icon={["power"]}>
...
<Ability id="alien-mind-ex" icon={["def"]}>
...
<Ability id="fluid-bones-ex" icon={["power"]}>
...
<Ability id="bestial-flashes-su" icon={["melee","down"]}>
...
<Ability id="bloodthirsty-su" icon={["boost","down"]}>
...
<Ability id="festering-flesh-su" icon={["def","down"]}>
...
<Ability id="palsy-su" icon={["def","down"]}>
...
<Ability id="rabid-vomit-ex" icon={["cone","down"]}>
...
<Ability id="scavenger-su" icon={["boost","def","down"]}>
...
<Ability id="unexpected-frenzy-su" icon={["boost","down"]}>
...
<Ability id="unsavory-friends-su" icon={["def","down"]}>
...
<Ability id="camouflage-ex" icon={["boost"]}>
...
<Ability id="cunning-ambusher-ex" icon={["def","boost","lower"]}>
...
<Ability id="native-environment-ex" icon={["power","boost"]}>
...
<Ability id="natural-selection-ex" icon={["def"]}>
...
<Ability id="master-of-the-wild-ex" icon={["power","def"]}>
...
<Ability id="augmented-body-ex" icon={["down"]}>
...
<Ability id="augmented-sight-ex" icon={["power"]}>
...
<Ability id="constructed-form-ex" icon={["def"]}>
...
<Ability id="aligned-ex" icon={["power"]}>
...
<Ability id="auspicious-boon-sp-su" icon={["power","magic"]}>
...
<Ability id="aligned-strike-ex" icon={["melee"]}>
...
<Ability id="animal-feats" icon={["power"]}>
...
<Ability id="shared-vigilance-ex" icon={["power"]}>
...
<Ability id="tenacious-guardian-ex" icon={["boost","melee"]}>
...
<Ability id="greater-tenacity-ex" icon={["melee","def"]}>
...
<Ability id="bully-feats" icon={["power"]}>
...
<Ability id="bullying-thrill-ex" icon={["melee"]}>
...
<Ability id="mounted-challenge-ex" icon={["boost"]}>
...
<Ability id="barding-training-ex" icon={["boost"]}>
...
<Ability id="indefatigable-ex" icon={["def"]}>
...
<Ability id="stalwart-steed-ex" icon={["def"]}>
...
<Ability id="artful-acrobat-ex" icon={["boost"]}>
...
<Ability id="devil-may-care-ex" icon={["def"]}>
...
<Ability id="deathtouched-skills" icon={["boost"]}>
...
<Ability id="dead-sight-ex" icon={["power"]}>
...
<Ability id="negative-energy-affinity-ex" icon={["down"]}>
...
<Ability id="draconic-sight-ex" icon={["power"]}>
...
<Ability id="improved-draconic-resistance-ex" icon={["def"]}>
...
<Ability id="breath-weapon-ex" icon={["cone","line"]}>
...
<Ability id="elemental-type-ex" icon={["power"]}>
...
<Ability id="lesser-elemental-manifestation-ex" icon={["def","power"]}>
...
<Ability id="greater-elemental-manifestation-su" icon={["power","melee"]}>
...
<Ability id="small-but-fierce-ex" icon={["boost"]}>
...
<Ability id="fey-magic-sp" icon={["power","magic"]}>
...
<Ability id="iron-bane-ex" icon={["def"]}>
...
<Ability id="expanded-tricks-ex" icon={["boost"]}>
...
<Ability id="perspicacious-mind-ex" icon={["boost"]}>
...
<Ability id="racer-feats" icon={["power"]}>
...
<Ability id="sprint-ex" icon={["boost"]}>
...
<Ability id="spiritual-guidance-sp" icon={["power","magic"]}>
...
<Ability id="beast-speech-ex" icon={["power"]}>
...
<Ability id="eldritch-claws" icon={["power","melee"]}>
...
<Ability id="ghost-guardian-ex" icon={["melee","def","boost"]}>
...
<Ability id="tracker-skills" icon={["boost"]}>
...
<Ability id="expert-tracker-ex" icon={["boost"]}>
...
<Ability id="genius-that-creeps-and-crawls-ex" icon={["boost"]}>
...
<Ability id="photosynthesis-ex" icon={["power"]}>
...
<Ability id="verdant-resistance-ex" icon={["def"]}>
...
<Ability id="wrecker-feats" icon={["boost"]}>
...
<Ability id="destructive-wrecker-ex" icon={["melee"]}>
