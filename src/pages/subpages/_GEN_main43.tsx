...
const _traits_religion_lg = {title: "Religion Traits: Lawful Good", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitinspiringleader-inspiring-leader-fn1" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitscalyally-scaly-ally-fn1-2-fn2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitdeadeyebowman-deadeye-bowman-fn1-3" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="benefit" id="traitdeadeyebowman-deadeye-bowman-fn1-3-benefit">When you are using a longbow, if only a single creature is providing soft cover to your target, your target does not receive the +4 bonus to AC.</Pair>
</Ability>
<Ability id="traiterastilsspeaker-erastils-speaker-fn1-4-fn2-2" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traiterastilsspeaker-erastils-speaker-fn1-4-fn2-2"><Link to="/trait/erastils_speaker">⮞</Link> Erastil's Speaker <sup><InnerLink showBacklink="backlink-main-traits_religion_lg-fake-fn-1.4" id="main-traits_religion_lg-fake-fn-1.4" data-hash-target to="main-traits_religion_lg-fake-fn-1-target">1</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_lg-fake-fn-2.2" id="main-traits_religion_lg-fake-fn-2.2" data-hash-target to="main-traits_religion_lg-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/erastil">Erastil</Link></Pair>
<Pair single="flavor" id="traiterastilsspeaker-erastils-speaker-fn1-4-fn2-2-flavor">You understand the importance of keeping the peace in your community, and you have learned how to speak to the faithful in ways that they understand.</Pair>
<Pair single="benefit" id="traiterastilsspeaker-erastils-speaker-fn1-4-fn2-2-benefit">You gain a +1 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link> checks, and Diplomacy is a class skill for you.</Pair>
</Ability>
<Ability id="traitpatientoptimist-patient-optimist-fn3-fn4-fn5" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitprovider-provider-fn6" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitwiseteacher-wise-teacher-fn1-5-fn2-3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitashiningbeacon-a-shining-beacon-fn1-6-fn2-4" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="flavor" id="traitashiningbeacon-a-shining-beacon-fn1-6-fn2-4-flavor">You carry a burning hatred in your heart for all things demonic, and have studied their weaknesses carefully.</Pair>
<Pair single="benefit" id="traitashiningbeacon-a-shining-beacon-fn1-6-fn2-4-benefit">You deal an amount of additional damage equal to your weapon's critical hit modifier when you score a successful critical hit with a weapon against a <Link to="/family/demon">demon</Link>. This damage is added only after the damage is totaled, and is not multiplied by the critical hit multiplier.</Pair>
</Ability>
<Ability id="traitdivinewarrior-divine-warrior-fn3-2-fn7-fn4-2" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitdivinewarrior-divine-warrior-fn3-2-fn7-fn4-2"><Link to="/trait/divine_warrior">⮞</Link> Divine Warrior <sup><InnerLink showBacklink="backlink-main-traits_religion_lg-fake-fn-3.2" id="main-traits_religion_lg-fake-fn-3.2" data-hash-target to="main-traits_religion_lg-fake-fn-3-target">3</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_lg-fake-fn-7" id="main-traits_religion_lg-fake-fn-7" data-hash-target to="main-traits_religion_lg-fake-fn-7-target">7</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_lg-fake-fn-4.2" id="main-traits_religion_lg-fake-fn-4.2" data-hash-target to="main-traits_religion_lg-fake-fn-4-target">4</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/iomedae">Iomedae</Link></Pair>
<Pair single="flavor" id="traitdivinewarrior-divine-warrior-fn3-2-fn7-fn4-2-flavor">From an early age, you were trained by a militaristic order of clerics. You are devoted to the teachings of Iomedae and to spreading those teachings by force.</Pair>
<Pair single="benefit" id="traitdivinewarrior-divine-warrior-fn3-2-fn7-fn4-2-benefit">Whenever you cast a divine spell that affects any melee weapons, choose one of those weapons; it gains a +1 trait bonus on damage rolls for the duration of the spell.</Pair>
</Ability>
<Ability id="traitinheritorsimmunity-inheritors-immunity-fn8" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitpurityoffaith-purity-of-faith-fn1-7-fn2-5" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitregalpresence-regal-presence-fn1-8" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitsearingbeacon-searing-beacon-fn9" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="benefit" id="traitsearingbeacon-searing-beacon-fn9-benefit">You deal additional precision damage equal to your Wisdom modifier when you score a critical hit with a melee weapon against an undead opponent.</Pair>
</Ability>
<Ability id="traitancestorsblade-ancestors-blade-fn10" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitancestorsblade-ancestors-blade-fn10"><Link to="/trait/ancestors_blade">⮞</Link> Ancestor's Blade <sup><InnerLink showBacklink="backlink-main-traits_religion_lg-fake-fn-10" id="main-traits_religion_lg-fake-fn-10" data-hash-target to="main-traits_religion_lg-fake-fn-10-target">10</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/shizuru">Shizuru</Link></Pair>
<Pair single="flavor" id="traitancestorsblade-ancestors-blade-fn10-flavor">You were trained by your family with a weapon passed down from a venerable ancestor.</Pair>
<Pair single="benefit" id="traitancestorsblade-ancestors-blade-fn10-benefit">You begin play with an heirloom <Link to="/rule/masterwork_w">masterwork weapon</Link> worth up to 400 gp. You gain a +1 trait bonus on attack rolls with weapons of this type (not just your initial heirloom weapon) when you <em>smite evil.</em></Pair>
</Ability>
<Ability id="traitpristinereputation-pristine-reputation-fn10-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitdefensivestrategist-defensive-strategist-fn1-9-fn2-6" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="flavor" id="traitdefensivestrategist-defensive-strategist-fn1-9-fn2-6-flavor">Your study of dwarven history has trained you in defensive strategy.</Pair>
<Pair single="benefit" id="traitdefensivestrategist-defensive-strategist-fn1-9-fn2-6-benefit">You aren't <Link to="/rule/flat_footed">flat-footed</Link> during a surprise round that you don't get to act in or before you get to act at the start of a battle.</Pair>
</Ability>
<Ability id="traiteyeofthefather-eye-of-the-father-fn1-10-fn2-7" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traiteyeofthefather-eye-of-the-father-fn1-10-fn2-7"><Link to="/trait/eye_of_the_father">⮞</Link> Eye of the Father <sup><InnerLink showBacklink="backlink-main-traits_religion_lg-fake-fn-1.10" id="main-traits_religion_lg-fake-fn-1.10" data-hash-target to="main-traits_religion_lg-fake-fn-1-target">1</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_lg-fake-fn-2.7" id="main-traits_religion_lg-fake-fn-2.7" data-hash-target to="main-traits_religion_lg-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/torag">Torag</Link></Pair>
<Pair single="flavor" id="traiteyeofthefather-eye-of-the-father-fn1-10-fn2-7-flavor">You have an innate sense of what is right and wrong in the works you craft, based on your years studying with the church elders at their forges.</Pair>
<Pair single="benefit" id="traiteyeofthefather-eye-of-the-father-fn1-10-fn2-7-benefit">Choose one <Link to="/skill/craft">Craft</Link> skill; you gain a +1 trait bonus on Craft checks of the selected type.</Pair>
</Ability>
<Ability id="traitguardianoftheforge-guardian-of-the-forge-fn3-3-fn11-fn4-3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitprotectivefaith-protective-faith-fn1-11" extraClasses="trait" icon={["Religion"]}>
...
</IonLabel></IonItem><section data-footnotes><h3 id="main-traits_religion_lg-label">Footnotes</h3><ol>
...
<li id="main-traits_religion_lg-fake-fn-2-target"><p><Link to="/source/faiths_of_purity">Faiths of Purity</Link> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_lg-fake-fn-2" data-hash-target to="main-traits_religion_lg-fake-fn-2">↩</InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_lg-fake-fn-2.2" data-hash-target to="main-traits_religion_lg-fake-fn-2.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_lg-fake-fn-2.3" data-hash-target to="main-traits_religion_lg-fake-fn-2.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_lg-fake-fn-2.4" data-hash-target to="main-traits_religion_lg-fake-fn-2.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_lg-fake-fn-2.5" data-hash-target to="main-traits_religion_lg-fake-fn-2.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_lg-fake-fn-2.6" data-hash-target to="main-traits_religion_lg-fake-fn-2.6">↩<sup>6</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_lg-fake-fn-2.7" data-hash-target to="main-traits_religion_lg-fake-fn-2.7">↩<sup>7</sup></InnerLink></p></li>
<li id="main-traits_religion_lg-fake-fn-3-target"><p><Link to="/source/ultimate_campaign">Ultimate Campaign</Link> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_lg-fake-fn-3" data-hash-target to="main-traits_religion_lg-fake-fn-3">↩</InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_lg-fake-fn-3.2" data-hash-target to="main-traits_religion_lg-fake-fn-3.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_lg-fake-fn-3.3" data-hash-target to="main-traits_religion_lg-fake-fn-3.3">↩<sup>3</sup></InnerLink></p></li>
<li id="main-traits_religion_lg-fake-fn-4-target"><p><Link to="/source/advanced_players_guide">Advanced Player's Guide</Link> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_lg-fake-fn-4" data-hash-target to="main-traits_religion_lg-fake-fn-4">↩</InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_lg-fake-fn-4.2" data-hash-target to="main-traits_religion_lg-fake-fn-4.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_lg-fake-fn-4.3" data-hash-target to="main-traits_religion_lg-fake-fn-4.3">↩<sup>3</sup></InnerLink></p></li>
<li id="main-traits_religion_lg-fake-fn-5-target"><p><Link to="/source/cheliax_empire_of_devils">Cheliax, Empire of Devils</Link> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_lg-fake-fn-5" data-hash-target to="main-traits_religion_lg-fake-fn-5">↩</InnerLink></p></li>
<li id="main-traits_religion_lg-fake-fn-6-target"><p><Link to="/source/halflings_of_golarion">Halflings of Golarion</Link> <InnerLink aria-label="Back to reference 6" id="backlink-main-traits_religion_lg-fake-fn-6" data-hash-target to="main-traits_religion_lg-fake-fn-6">↩</InnerLink></p></li>
<li id="main-traits_religion_lg-fake-fn-7-target"><p><Link to="/source/taldor_echoes_of_glory">Taldor, Echoes of Glory</Link> <InnerLink aria-label="Back to reference 7" id="backlink-main-traits_religion_lg-fake-fn-7" data-hash-target to="main-traits_religion_lg-fake-fn-7">↩</InnerLink></p></li>
<li id="main-traits_religion_lg-fake-fn-8-target"><p><Link to="/source/people_of_the_wastes">People of the Wastes</Link> <InnerLink aria-label="Back to reference 8" id="backlink-main-traits_religion_lg-fake-fn-8" data-hash-target to="main-traits_religion_lg-fake-fn-8">↩</InnerLink></p></li>
<li id="main-traits_religion_lg-fake-fn-9-target"><p><Link to="/source/knights_of_the_inner_sea">Knights of the Inner Sea</Link> <InnerLink aria-label="Back to reference 9" id="backlink-main-traits_religion_lg-fake-fn-9" data-hash-target to="main-traits_religion_lg-fake-fn-9">↩</InnerLink></p></li>
<li id="main-traits_religion_lg-fake-fn-10-target"><p><Link to="/source/divine_anthology">Divine Anthology</Link> <InnerLink aria-label="Back to reference 10" id="backlink-main-traits_religion_lg-fake-fn-10" data-hash-target to="main-traits_religion_lg-fake-fn-10">↩</InnerLink> <InnerLink aria-label="Back to reference 10" id="backlink-main-traits_religion_lg-fake-fn-10.2" data-hash-target to="main-traits_religion_lg-fake-fn-10.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_religion_lg-fake-fn-11-target"><p><Link to="/source/dwarves_of_golarion">Dwarves of Golarion</Link> <InnerLink aria-label="Back to reference 11" id="backlink-main-traits_religion_lg-fake-fn-11" data-hash-target to="main-traits_religion_lg-fake-fn-11">↩</InnerLink></p></li>
</ol></section></IonList>};
const _traits_religion_ln = {title: "Religion Traits: Lawful Neutral", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traiteyeforquality-eye-for-quality-fn1" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traiteyeforquality-eye-for-quality-fn1"><Link to="/trait/eye_for_quality">⮞</Link> Eye for Quality <sup><InnerLink showBacklink="backlink-main-traits_religion_ln-fake-fn-1" id="main-traits_religion_ln-fake-fn-1" data-hash-target to="main-traits_religion_ln-fake-fn-1-target">1</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/abadar">Abadar</Link></Pair>
<Pair single="flavor" id="traiteyeforquality-eye-for-quality-fn1-flavor">Your deity has granted you an uncanny ability to find the true worth of items.</Pair>
<Pair single="benefit" id="traiteyeforquality-eye-for-quality-fn1-benefit">You gain a +1 trait bonus on <Link to="/skill/appraise">Appraise</Link> checks, you don't suffer the effects of failing such checks by 5 or more, and Appraise is a class skill for you.</Pair>
</Ability>
<Ability id="traiteyesandearsofthecity-eyes-and-ears-of-the-city-fn2-fn3-fn4" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traiteyesandearsofthecity-eyes-and-ears-of-the-city-fn2-fn3-fn4"><Link to="/trait/eyes_and_ears_of_the_city">⮞</Link> Eyes and Ears of the City <sup><InnerLink showBacklink="backlink-main-traits_religion_ln-fake-fn-2" id="main-traits_religion_ln-fake-fn-2" data-hash-target to="main-traits_religion_ln-fake-fn-2-target">2</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_ln-fake-fn-3" id="main-traits_religion_ln-fake-fn-3" data-hash-target to="main-traits_religion_ln-fake-fn-3-target">3</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_ln-fake-fn-4" id="main-traits_religion_ln-fake-fn-4" data-hash-target to="main-traits_religion_ln-fake-fn-4-target">4</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/abadar">Abadar</Link></Pair>
<Pair single="flavor" id="traiteyesandearsofthecity-eyes-and-ears-of-the-city-fn2-fn3-fn4-flavor">Your religious training involved serving in the city watch of a large city, the primary duty of which was standing sentinel on a city wall.</Pair>
<Pair single="benefit" id="traiteyesandearsofthecity-eyes-and-ears-of-the-city-fn2-fn3-fn4-benefit">You gain a +1 trait bonus on <Link to="/skill/perception">Perception</Link> checks, and Perception is always a class skill for you.</Pair>
</Ability>
<Ability id="traithoneytongued-honey-tongued-fn1-2-fn5" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitloverofthelaw-lover-of-the-law-fn1-3-fn5-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitsenseoforder-sense-of-order-fn6" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitthecityprotects-the-city-protects-fn4-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitopenerofdoors-opener-of-doors-fn1-4-fn5-3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitcentered-centered-fn1-5-fn5-4" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="flavor" id="traitcentered-centered-fn1-5-fn5-4-flavor">Having anchored yourself in your faith and your knowledge of yourself, you've made it difficult for others to dominate you.</Pair>
<Pair single="benefit" id="traitcentered-centered-fn1-5-fn5-4-benefit">You gain a +1 trait bonus on saving throws against charm and compulsion effects, and the DC of any attempts to use the <Link to="/skill/intimidate">Intimidate</Link> skill on you increases by 1.</Pair>
</Ability>
<Ability id="traiteternalunderstanding-eternal-understanding-fn1-6" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traiteternalunderstanding-eternal-understanding-fn1-6"><Link to="/trait/eternal_understanding">⮞</Link> Eternal Understanding <sup><InnerLink showBacklink="backlink-main-traits_religion_ln-fake-fn-1.6" id="main-traits_religion_ln-fake-fn-1.6" data-hash-target to="main-traits_religion_ln-fake-fn-1-target">1</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/irori">Irori</Link></Pair>
<Pair single="flavor" id="traiteternalunderstanding-eternal-understanding-fn1-6-flavor">Though you haven't been traditionally educated, you're blessed with potent observation and discernment.</Pair>
<Pair single="benefit" id="traiteternalunderstanding-eternal-understanding-fn1-6-benefit">You can attempt <Link to="/skill/knowledge">Knowledge</Link> checks with a DC of 15 or lower untrained.</Pair>
</Ability>
<Ability id="traitseerofreality-seer-of-reality-fn1-7-fn5-5" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitsensingimperfection-sensing-imperfection-fn6-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitwisdomintheflesh-wisdom-in-the-flesh-fn2-2-fn4-3-fn3-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitrejectedemperor-rejected-emperor-fn7" extraClasses="trait" icon={["Religion"]}>
...
</IonLabel></IonItem><section data-footnotes><h3 id="main-traits_religion_ln-label">Footnotes</h3><ol>
...
<li id="main-traits_religion_ln-fake-fn-2-target"><p><Link to="/source/ultimate_campaign">Ultimate Campaign</Link> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ln-fake-fn-2" data-hash-target to="main-traits_religion_ln-fake-fn-2">↩</InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ln-fake-fn-2.2" data-hash-target to="main-traits_religion_ln-fake-fn-2.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_religion_ln-fake-fn-3-target"><p><Link to="/source/advanced_players_guide">Advanced Player's Guide</Link> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_ln-fake-fn-3" data-hash-target to="main-traits_religion_ln-fake-fn-3">↩</InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_ln-fake-fn-3.2" data-hash-target to="main-traits_religion_ln-fake-fn-3.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_religion_ln-fake-fn-4-target"><p><Link to="/source/legacy_of_fire_players_guide">Legacy of Fire Player's Guide</Link> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_ln-fake-fn-4" data-hash-target to="main-traits_religion_ln-fake-fn-4">↩</InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_ln-fake-fn-4.2" data-hash-target to="main-traits_religion_ln-fake-fn-4.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_ln-fake-fn-4.3" data-hash-target to="main-traits_religion_ln-fake-fn-4.3">↩<sup>3</sup></InnerLink></p></li>
<li id="main-traits_religion_ln-fake-fn-5-target"><p><Link to="/source/faiths_of_balance">Faiths of Balance</Link> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_ln-fake-fn-5" data-hash-target to="main-traits_religion_ln-fake-fn-5">↩</InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_ln-fake-fn-5.2" data-hash-target to="main-traits_religion_ln-fake-fn-5.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_ln-fake-fn-5.3" data-hash-target to="main-traits_religion_ln-fake-fn-5.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_ln-fake-fn-5.4" data-hash-target to="main-traits_religion_ln-fake-fn-5.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_ln-fake-fn-5.5" data-hash-target to="main-traits_religion_ln-fake-fn-5.5">↩<sup>5</sup></InnerLink></p></li>
<li id="main-traits_religion_ln-fake-fn-6-target"><p><Link to="/source/halflings_of_golarion">Halflings of Golarion</Link> <InnerLink aria-label="Back to reference 6" id="backlink-main-traits_religion_ln-fake-fn-6" data-hash-target to="main-traits_religion_ln-fake-fn-6">↩</InnerLink> <InnerLink aria-label="Back to reference 6" id="backlink-main-traits_religion_ln-fake-fn-6.2" data-hash-target to="main-traits_religion_ln-fake-fn-6.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_religion_ln-fake-fn-7-target"><p><Link to="/source/blood_of_the_ancients">Blood of the Ancients</Link> pg. 23 <InnerLink aria-label="Back to reference 7" id="backlink-main-traits_religion_ln-fake-fn-7" data-hash-target to="main-traits_religion_ln-fake-fn-7">↩</InnerLink></p></li>
</ol></section></IonList>};
const _traits_religion_le = {title: "Religion Traits: Lawful Evil", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitdeepwounding-deep-wounding-fn1" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitdeepwounding-deep-wounding-fn1"><Link to="/trait/deep_wounding">⮞</Link> Deep Wounding <sup><InnerLink showBacklink="backlink-main-traits_religion_le-fake-fn-1" id="main-traits_religion_le-fake-fn-1" data-hash-target to="main-traits_religion_le-fake-fn-1-target">1</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/achaekek">Achaekek</Link></Pair>
<Pair single="flavor" id="traitdeepwounding-deep-wounding-fn1-flavor">You have learned the bloody secret of striking true and deep.</Pair>
<Pair single="benefit" id="traitdeepwounding-deep-wounding-fn1-benefit">When you deal <Link to="/rule/bleed">bleed</Link> damage with a melee weapon, a successful DC 20 <Link to="/skill/heal">Heal</Link> check is required to stop the bleed damage. Magical healing stops the damage as normal.</Pair>
</Ability>
<Ability id="traitfrighteningspeed-frightening-speed-fn1-2-fn2" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitfrighteningspeed-frightening-speed-fn1-2-fn2"><Link to="/trait/frightening_speed">⮞</Link> Frightening Speed <sup><InnerLink showBacklink="backlink-main-traits_religion_le-fake-fn-1.2" id="main-traits_religion_le-fake-fn-1.2" data-hash-target to="main-traits_religion_le-fake-fn-1-target">1</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_le-fake-fn-2" id="main-traits_religion_le-fake-fn-2" data-hash-target to="main-traits_religion_le-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/achaekek">Achaekek</Link></Pair>
<Pair single="flavor" id="traitfrighteningspeed-frightening-speed-fn1-2-fn2-flavor">Your careful study of Achaekek's kills has unlocked a divine speed in you.</Pair>
<Pair single="benefit" id="traitfrighteningspeed-frightening-speed-fn1-2-fn2-benefit">Once per day during a combat encounter, you can move an additional 5 feet as a part of a move action without penalty.</Pair>
</Ability>
<Ability id="traitcontractmaster-contract-master-fn1-3-fn2-2" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitcontractmaster-contract-master-fn1-3-fn2-2"><Link to="/trait/contract_master">⮞</Link> Contract Master <sup><InnerLink showBacklink="backlink-main-traits_religion_le-fake-fn-1.3" id="main-traits_religion_le-fake-fn-1.3" data-hash-target to="main-traits_religion_le-fake-fn-1-target">1</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_le-fake-fn-2.2" id="main-traits_religion_le-fake-fn-2.2" data-hash-target to="main-traits_religion_le-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/asmodeus">Asmodeus</Link></Pair>
<Pair single="flavor" id="traitcontractmaster-contract-master-fn1-3-fn2-2-flavor">Your facility with contracts makes you good at understanding dense text and obfuscating your intent.</Pair>
<Pair single="benefit" id="traitcontractmaster-contract-master-fn1-3-fn2-2-benefit">You gain a +1 trait bonus on <Link to="/skill/linguistics">Linguistics</Link> checks, and Linguistics is a class skill for you.</Pair>
</Ability>
<Ability id="traitdemonhunter-demon-hunter-fn3-fn4-fn5" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitdemonhunter-demon-hunter-fn3-fn4-fn5"><Link to="/trait/demon_hunter">⮞</Link> Demon Hunter <sup><InnerLink showBacklink="backlink-main-traits_religion_le-fake-fn-3" id="main-traits_religion_le-fake-fn-3" data-hash-target to="main-traits_religion_le-fake-fn-3-target">3</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_le-fake-fn-4" id="main-traits_religion_le-fake-fn-4" data-hash-target to="main-traits_religion_le-fake-fn-4-target">4</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_le-fake-fn-5" id="main-traits_religion_le-fake-fn-5" data-hash-target to="main-traits_religion_le-fake-fn-5-target">5</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/asmodeus">Asmodeus</Link></Pair>
<Pair single="flavor" id="traitdemonhunter-demon-hunter-fn3-fn4-fn5-flavor">Raised in the church (whether or not you are currently a follower), you've focused your indoctrinated fervor primarily on the elimination of demons.</Pair>
<Pair single="benefit" id="traitdemonhunter-demon-hunter-fn3-fn4-fn5-benefit">You gain a +3 trait bonus on <Link to="/skill/knowledge_planes">Knowledge (planes)</Link> checks about <Link to="/family/demon">demons</Link> and a +2 trait bonus on Will saves against mind-affecting spells and effects from demons.</Pair>
</Ability>
<Ability id="traitfiendishconfidence-fiendish-confidence-fn1-4-fn2-3" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitfiendishconfidence-fiendish-confidence-fn1-4-fn2-3"><Link to="/trait/fiendish_confidence">⮞</Link> Fiendish Confidence <sup><InnerLink showBacklink="backlink-main-traits_religion_le-fake-fn-1.4" id="main-traits_religion_le-fake-fn-1.4" data-hash-target to="main-traits_religion_le-fake-fn-1-target">1</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_le-fake-fn-2.3" id="main-traits_religion_le-fake-fn-2.3" data-hash-target to="main-traits_religion_le-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/asmodeus">Asmodeus</Link></Pair>
<Pair single="flavor" id="traitfiendishconfidence-fiendish-confidence-fn1-4-fn2-3-flavor">You expect to be obeyed, and are rarely proven wrong.</Pair>
<Pair single="benefit" id="traitfiendishconfidence-fiendish-confidence-fn1-4-fn2-3-benefit">You gain a +1 trait bonus on <Link to="/skill/intimidate">Intimidate</Link> checks, and Intimidate is a class skill for you.</Pair>
</Ability>
<Ability id="traitliarstongue-liars-tongue-fn1-5" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitbattlefieldsurgeon-battlefield-surgeon-fn1-6-fn2-4" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="flavor" id="traitbattlefieldsurgeon-battlefield-surgeon-fn1-6-fn2-4-flavor">You're skilled at both dealing and repairing wounds.</Pair>
<Pair single="benefit" id="traitbattlefieldsurgeon-battlefield-surgeon-fn1-6-fn2-4-benefit"><Link to="/skill/heal">Heal</Link> is a class skill for you, and you can use the <em>treat deadly wounds</em> aspect of Heal 1 additional time per creature per day.</Pair>
</Ability>
<Ability id="traitdemoralizingpresence-demoralizing-presence-fn1-7" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitdemoralizingpresence-demoralizing-presence-fn1-7"><Link to="/trait/demoralizing_presence">⮞</Link> Demoralizing Presence <sup><InnerLink showBacklink="backlink-main-traits_religion_le-fake-fn-1.7" id="main-traits_religion_le-fake-fn-1.7" data-hash-target to="main-traits_religion_le-fake-fn-1-target">1</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/zon_kuthon">Zon-Kuthon</Link></Pair>
<Pair single="flavor" id="traitdemoralizingpresence-demoralizing-presence-fn1-7-flavor">Your very existence is unsettling to your foes.</Pair>
<Pair single="benefit" id="traitdemoralizingpresence-demoralizing-presence-fn1-7-benefit">You gain a +2 trait bonus on <Link to="/skill/intimidate">Intimidate</Link> checks made to demoralize opponents.</Pair>
</Ability>
<Ability id="traitkuthitecaster-kuthite-caster-fn1-8-fn2-5" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitkuthitecaster-kuthite-caster-fn1-8-fn2-5"><Link to="/trait/kuthite_caster">⮞</Link> Kuthite Caster <sup><InnerLink showBacklink="backlink-main-traits_religion_le-fake-fn-1.8" id="main-traits_religion_le-fake-fn-1.8" data-hash-target to="main-traits_religion_le-fake-fn-1-target">1</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_le-fake-fn-2.5" id="main-traits_religion_le-fake-fn-2.5" data-hash-target to="main-traits_religion_le-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/zon_kuthon">Zon-Kuthon</Link></Pair>
<Pair single="benefit" id="traitkuthitecaster-kuthite-caster-fn1-8-fn2-5-benefit">You gain a +4 trait bonus on <Link to="/rule/concentration">concentration</Link> checks when casting spells with the darkness, pain, or shadow descriptor.</Pair>
</Ability>
<Ability id="traitpainispleasure-pain-is-pleasure-fn5-2" extraClasses="trait" icon={["Religion"]}>
...
</IonLabel></IonItem><section data-footnotes><h3 id="main-traits_religion_le-label">Footnotes</h3><ol>
...
<li id="main-traits_religion_le-fake-fn-2-target"><p><Link to="/source/faiths_of_corruption">Faiths of Corruption</Link> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_le-fake-fn-2" data-hash-target to="main-traits_religion_le-fake-fn-2">↩</InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_le-fake-fn-2.2" data-hash-target to="main-traits_religion_le-fake-fn-2.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_le-fake-fn-2.3" data-hash-target to="main-traits_religion_le-fake-fn-2.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_le-fake-fn-2.4" data-hash-target to="main-traits_religion_le-fake-fn-2.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_le-fake-fn-2.5" data-hash-target to="main-traits_religion_le-fake-fn-2.5">↩<sup>5</sup></InnerLink></p></li>
<li id="main-traits_religion_le-fake-fn-3-target"><p><Link to="/source/advanced_players_guide">Advanced Player's Guide</Link> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_le-fake-fn-3" data-hash-target to="main-traits_religion_le-fake-fn-3">↩</InnerLink></p></li>
<li id="main-traits_religion_le-fake-fn-4-target"><p><Link to="/source/cheliax_empire_of_devils">Cheliax, Empire of Devils</Link> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_le-fake-fn-4" data-hash-target to="main-traits_religion_le-fake-fn-4">↩</InnerLink></p></li>
<li id="main-traits_religion_le-fake-fn-5-target"><p><Link to="/source/ultimate_campaign">Ultimate Campaign</Link> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_le-fake-fn-5" data-hash-target to="main-traits_religion_le-fake-fn-5">↩</InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_le-fake-fn-5.2" data-hash-target to="main-traits_religion_le-fake-fn-5.2">↩<sup>2</sup></InnerLink></p></li>
</ol></section></IonList>};
const _traits_religion_ng = {title: "Religion Traits: Neutral Good", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitstrengthsfanfare-strengths-fanfare-fn1" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traittheflexingarm-the-flexing-arm-fn1-2-fn2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitambassador-ambassador-fn3" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="flavor" id="traitambassador-ambassador-fn3-flavor">Your natural abilities at mediation and compromise manifested at a young age. For as long as you can remember, you were always more able to solve disputes and carefully settle violent disagreements than others.</Pair>
<Pair single="benefit" id="traitambassador-ambassador-fn3-benefit">You gain a +2 trait bonus to <Link to="/skill/diplomacy">Diplomacy</Link> checks.</Pair>
</Ability>
<Ability id="traitbladeofmercy-blade-of-mercy-fn4" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitbladeofmercy-blade-of-mercy-fn4"><Link to="/trait/blade_of_mercy">⮞</Link> Blade of Mercy <sup><InnerLink showBacklink="backlink-main-traits_religion_ng-fake-fn-4" id="main-traits_religion_ng-fake-fn-4" data-hash-target to="main-traits_religion_ng-fake-fn-4-target">4</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/sarenrae">Sarenrae</Link></Pair>
<Pair single="flavor" id="traitbladeofmercy-blade-of-mercy-fn4-flavor">You know that within the heart of even the most hateful and cruel living creature exists a sliver of shame and hope for redemption. You have trained long on martial techniques to use bladed weapons not to kill, but to subdue.</Pair>
<Pair single="benefit" id="traitbladeofmercy-blade-of-mercy-fn4-benefit">When striking to inflict nonlethal damage with any slashing weapon, you do not take the normal -4 penalty on your attack roll, and gain a +1 trait bonus to any nonlethal damage you inflict with a slashing weapon.</Pair>
</Ability>
<Ability id="traitcleansinglight-cleansing-light-fn1-3-fn2-2" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitcleansinglight-cleansing-light-fn1-3-fn2-2"><Link to="/trait/cleansing_light">⮞</Link> Cleansing Light <sup><InnerLink showBacklink="backlink-main-traits_religion_ng-fake-fn-1.3" id="main-traits_religion_ng-fake-fn-1.3" data-hash-target to="main-traits_religion_ng-fake-fn-1-target">1</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_ng-fake-fn-2.2" id="main-traits_religion_ng-fake-fn-2.2" data-hash-target to="main-traits_religion_ng-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/sarenrae">Sarenrae</Link></Pair>
<Pair single="flavor" id="traitcleansinglight-cleansing-light-fn1-3-fn2-2-flavor">Your faith is pure and strong, and your positive energy purges undead.</Pair>
<Pair single="benefit" id="traitcleansinglight-cleansing-light-fn1-3-fn2-2-benefit">When dealing damage to undead with your <Link to="/ability/channel_energy">channel energy</Link> ability, you can reroll any damage die roll that results in a natural 1.</Pair>
</Ability>
<Ability id="traitcleansingthetwisted-cleansing-the-twisted-fn4-2" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitcleansingthetwisted-cleansing-the-twisted-fn4-2"><Link to="/trait/cleansing_the_twisted">⮞</Link> Cleansing the Twisted <sup><InnerLink showBacklink="backlink-main-traits_religion_ng-fake-fn-4.2" id="main-traits_religion_ng-fake-fn-4.2" data-hash-target to="main-traits_religion_ng-fake-fn-4-target">4</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/sarenrae">Sarenrae</Link></Pair>
<Pair single="flavor" id="traitcleansingthetwisted-cleansing-the-twisted-fn4-2-flavor">You have studied well the many religious texts that chronicle Sarenrae's neverending struggle against <Link to="/faith/rovagug">Rovagug</Link> and his monstrous offspring. Your fighting style works particularly well when you utilize slashing weapons against aberrations.</Pair>
<Pair single="benefit" id="traitcleansingthetwisted-cleansing-the-twisted-fn4-2-benefit">You gain a +1 trait bonus to slashing weapon damage against all aberrations.</Pair>
</Ability>
<Ability id="traitdawnrenewal-dawn-renewal-fn5" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitdawnrenewal-dawn-renewal-fn5"><Link to="/trait/dawn_renewal">⮞</Link> Dawn Renewal <sup><InnerLink showBacklink="backlink-main-traits_religion_ng-fake-fn-5" id="main-traits_religion_ng-fake-fn-5" data-hash-target to="main-traits_religion_ng-fake-fn-5-target">5</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/sarenrae">Sarenrae</Link></Pair>
<Pair title="Requirements" hl><Link to="/race/halfling">Halfling</Link></Pair>
<Pair single="flavor" id="traitdawnrenewal-dawn-renewal-fn5-flavor">Your morning prayers often send a welcome spark of divine vitality into your most recent patients.</Pair>
<Pair single="benefit" id="traitdawnrenewal-dawn-renewal-fn5-benefit">When you use the <Link to="/skill/heal">Heal</Link> skill to provide long-term care, your patients heal an extra 2 hit points at sunrise.</Pair>
</Ability>
<Ability id="traitenvoyofhealing-envoy-of-healing-fn6" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitenvoyofhealing-envoy-of-healing-fn6"><Link to="/trait/envoy_of_healing">⮞</Link> Envoy of Healing <sup><InnerLink showBacklink="backlink-main-traits_religion_ng-fake-fn-6" id="main-traits_religion_ng-fake-fn-6" data-hash-target to="main-traits_religion_ng-fake-fn-6-target">6</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/sarenrae">Sarenrae</Link></Pair>
<Pair single="flavor" id="traitenvoyofhealing-envoy-of-healing-fn6-flavor">You strive to spread the Dawnflower's message of kindness and compassion throughout the land, no matter how dangerous the road may be.</Pair>
<Pair single="benefit" id="traitenvoyofhealing-envoy-of-healing-fn6-benefit">Whenever you use <Link to="/ability/channel_energy">channel energy</Link>, <em>fervor,</em> or <Link to="/ability/lay_on_hands">lay on hands</Link> to heal a living creature, you can reroll any healing die roll that results in a natural 1 (you must use the new result).</Pair>
</Ability>
<Ability id="traitflameofthedawnflower-flame-of-the-dawnflower-fn7-fn8-fn9" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitflameofthedawnflower-flame-of-the-dawnflower-fn7-fn8-fn9"><Link to="/trait/flame_of_the_dawnflower">⮞</Link> Flame of the Dawnflower <sup><InnerLink showBacklink="backlink-main-traits_religion_ng-fake-fn-7" id="main-traits_religion_ng-fake-fn-7" data-hash-target to="main-traits_religion_ng-fake-fn-7-target">7</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_ng-fake-fn-8" id="main-traits_religion_ng-fake-fn-8" data-hash-target to="main-traits_religion_ng-fake-fn-8-target">8</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_ng-fake-fn-9" id="main-traits_religion_ng-fake-fn-9" data-hash-target to="main-traits_religion_ng-fake-fn-9-target">9</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/sarenrae">Sarenrae</Link></Pair>
<Pair single="flavor" id="traitflameofthedawnflower-flame-of-the-dawnflower-fn7-fn8-fn9-flavor">You have been raised to view yourself as a blade in Sarenrae's service, or you have taken on that duty for yourself.</Pair>
<Pair single="benefit" id="traitflameofthedawnflower-flame-of-the-dawnflower-fn7-fn8-fn9-benefit">Whenever you score a critical hit with a <Link to="/eq-weapon/scimitar">scimitar</Link>, you deal 2 additional points of fire damage to your target.</Pair>
</Ability>
<Ability id="traitilluminator-illuminator-fn1-4-fn2-3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitlightbringer-light-bringer-fn1-5" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitstrengthofthesun-strength-of-the-sun-fn4-3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitundersiege-under-siege-fn3-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitearformusic-ear-for-music-fn7-2-fn9-2" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="flavor" id="traitearformusic-ear-for-music-fn7-2-fn9-2-flavor">You spent countless hours of your youth in one of Shelyn's temples, listening to wonderful musicians and singers.</Pair>
<Pair single="benefit" id="traitearformusic-ear-for-music-fn7-2-fn9-2-benefit">You gain a +1 trait bonus on one category of <Link to="/skill/perform">Perform</Link> checks and a +2 trait bonus on <Link to="/skill/knowledge_local">Knowledge (local)</Link> checks that deal with the local art or music scene.</Pair>
</Ability>
<Ability id="traitinnerbeauty-inner-beauty-fn1-6-fn2-4" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitintenseartist-intense-artist-fn1-7-fn2-5" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitselfsacrifice-self-sacrifice-fn5-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitunswayinglove-unswaying-love-fn1-8" extraClasses="trait" icon={["Religion"]}>
...
</IonLabel></IonItem><section data-footnotes><h3 id="main-traits_religion_ng-label">Footnotes</h3><ol>
...
<li id="main-traits_religion_ng-fake-fn-2-target"><p><Link to="/source/faiths_of_purity">Faiths of Purity</Link> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ng-fake-fn-2" data-hash-target to="main-traits_religion_ng-fake-fn-2">↩</InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ng-fake-fn-2.2" data-hash-target to="main-traits_religion_ng-fake-fn-2.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ng-fake-fn-2.3" data-hash-target to="main-traits_religion_ng-fake-fn-2.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ng-fake-fn-2.4" data-hash-target to="main-traits_religion_ng-fake-fn-2.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ng-fake-fn-2.5" data-hash-target to="main-traits_religion_ng-fake-fn-2.5">↩<sup>5</sup></InnerLink></p></li>
<li id="main-traits_religion_ng-fake-fn-3-target"><p><Link to="/source/taldor_echoes_of_glory">Taldor, Echoes of Glory</Link> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_ng-fake-fn-3" data-hash-target to="main-traits_religion_ng-fake-fn-3">↩</InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_ng-fake-fn-3.2" data-hash-target to="main-traits_religion_ng-fake-fn-3.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_religion_ng-fake-fn-4-target"><p><Link to="/source/legacy_of_fire_players_guide">Legacy of Fire Player's Guide</Link> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_ng-fake-fn-4" data-hash-target to="main-traits_religion_ng-fake-fn-4">↩</InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_ng-fake-fn-4.2" data-hash-target to="main-traits_religion_ng-fake-fn-4.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_ng-fake-fn-4.3" data-hash-target to="main-traits_religion_ng-fake-fn-4.3">↩<sup>3</sup></InnerLink></p></li>
<li id="main-traits_religion_ng-fake-fn-5-target"><p><Link to="/source/halflings_of_golarion">Halflings of Golarion</Link> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_ng-fake-fn-5" data-hash-target to="main-traits_religion_ng-fake-fn-5">↩</InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_ng-fake-fn-5.2" data-hash-target to="main-traits_religion_ng-fake-fn-5.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_religion_ng-fake-fn-6-target"><p><Link to="/source/healers_handbook">Healer's Handbook</Link> <InnerLink aria-label="Back to reference 6" id="backlink-main-traits_religion_ng-fake-fn-6" data-hash-target to="main-traits_religion_ng-fake-fn-6">↩</InnerLink></p></li>
<li id="main-traits_religion_ng-fake-fn-7-target"><p><Link to="/source/ultimate_campaign">Ultimate Campaign</Link> <InnerLink aria-label="Back to reference 7" id="backlink-main-traits_religion_ng-fake-fn-7" data-hash-target to="main-traits_religion_ng-fake-fn-7">↩</InnerLink> <InnerLink aria-label="Back to reference 7" id="backlink-main-traits_religion_ng-fake-fn-7.2" data-hash-target to="main-traits_religion_ng-fake-fn-7.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_religion_ng-fake-fn-8-target"><p><Link to="/source/qadira_gateway_to_the_east">Qadira, Gateway to the East</Link> <InnerLink aria-label="Back to reference 8" id="backlink-main-traits_religion_ng-fake-fn-8" data-hash-target to="main-traits_religion_ng-fake-fn-8">↩</InnerLink></p></li>
<li id="main-traits_religion_ng-fake-fn-9-target"><p><Link to="/source/advanced_players_guide">Advanced Player's Guide</Link> <InnerLink aria-label="Back to reference 9" id="backlink-main-traits_religion_ng-fake-fn-9" data-hash-target to="main-traits_religion_ng-fake-fn-9">↩</InnerLink> <InnerLink aria-label="Back to reference 9" id="backlink-main-traits_religion_ng-fake-fn-9.2" data-hash-target to="main-traits_religion_ng-fake-fn-9.2">↩<sup>2</sup></InnerLink></p></li>
</ol></section></IonList>};
const _traits_religion_nn = {title: "Religion Traits: True Neutral", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitbrighsinsight-brighs-insight-fn1" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitbrighsinsight-brighs-insight-fn1"><Link to="/trait/brighs_insight">⮞</Link> Brigh's Insight <sup><InnerLink showBacklink="backlink-main-traits_religion_nn-fake-fn-1" id="main-traits_religion_nn-fake-fn-1" data-hash-target to="main-traits_religion_nn-fake-fn-1-target">1</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/brigh">Brigh</Link></Pair>
<Pair single="flavor" id="traitbrighsinsight-brighs-insight-fn1-flavor">You hear Brigh's whisper in the workings of technology, granting you better understanding of and insight into constructs.</Pair>
<Pair single="benefit" id="traitbrighsinsight-brighs-insight-fn1-benefit">You gain a +2 trait bonus on caster level checks to overcome the spell resistance of constructs.</Pair>
</Ability>
<Ability id="traitnimblefingerskeenmind-nimble-fingers-keen-mind-fn2-fn3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitchildofnature-child-of-nature-fn2-2-fn3-2-fn4-fn5" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="flavor" id="traitchildofnature-child-of-nature-fn2-2-fn3-2-fn4-fn5-flavor">The wild places are your home, and provide everything you need to be happy.</Pair>
<Pair single="benefit" id="traitchildofnature-child-of-nature-fn2-2-fn3-2-fn4-fn5-benefit">You gain a +2 trait bonus on <Link to="/skill/survival">Survival</Link> checks, and Survival is a class skill for you.</Pair>
</Ability>
<Ability id="traitgozrehssight-gozrehs-sight-fn1-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitnaturalphilosopher-natural-philosopher-fn2-3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitstrongswimmer-strong-swimmer-fn2-4-fn3-3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traiteyesofthewild-eyes-of-the-wild-fn2-5-fn3-4" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="flavor" id="traiteyesofthewild-eyes-of-the-wild-fn2-5-fn3-4-flavor">Having spent much time immersed in the wilderness, you're now attuned to its ways.</Pair>
<Pair single="benefit" id="traiteyesofthewild-eyes-of-the-wild-fn2-5-fn3-4-benefit">You gain a +2 trait bonus on <Link to="/skill/perception">Perception</Link> checks in natural settings.</Pair>
</Ability>
<Ability id="traitknowtheland-know-the-land-fn2-6-fn3-5" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitspirittalker-spirit-talker-fn6" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitemptyheartfullheart-empty-heart-full-heart-fn2-7-fn3-6" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="benefit" id="traitemptyheartfullheart-empty-heart-full-heart-fn2-7-fn3-6-benefit">Because of the aching strength of your forbidden love, you gain a +1 trait bonus on saving throws against charm effects, and targets of your charm spells take a -1 penalty on their saving throws.</Pair>
</Ability>
<Ability id="traitarcanedepth-arcane-depth-fn2-8-fn3-7" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitarcanedepth-arcane-depth-fn2-8-fn3-7"><Link to="/trait/arcane_depth">⮞</Link> Arcane Depth <sup><InnerLink showBacklink="backlink-main-traits_religion_nn-fake-fn-2.8" id="main-traits_religion_nn-fake-fn-2.8" data-hash-target to="main-traits_religion_nn-fake-fn-2-target">2</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_nn-fake-fn-3.7" id="main-traits_religion_nn-fake-fn-3.7" data-hash-target to="main-traits_religion_nn-fake-fn-3-target">3</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/nethys">Nethys</Link></Pair>
<Pair single="flavor" id="traitarcanedepth-arcane-depth-fn2-8-fn3-7-flavor">You have studied the great masters of spellcraft, and your knowledge is exceptional.</Pair>
<Pair single="benefit" id="traitarcanedepth-arcane-depth-fn2-8-fn3-7-benefit">You gain a bonus of either +1 on <Link to="/skill/spellcraft">Spellcraft</Link> checks or +2 on <Link to="/skill/knowledge_arcana">Knowledge (arcana)</Link> checks. You must choose which bonus you receive when you take the trait; once chosen, it cannot be changed.</Pair>
</Ability>
<Ability id="traitmagicislife-magic-is-life-fn4-2-fn5-2-fn7" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitthirstforknowledge-thirst-for-knowledge-fn2-9" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitunderlyingprinciples-underlying-principles-fn2-10-fn3-8" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitagentofchance-agent-of-chance-fn2-11-fn8" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="flavor" id="traitagentofchance-agent-of-chance-fn2-11-fn8-flavor">You can change the fortunes of others, typically for the better.</Pair>
<Pair single="benefit" id="traitagentofchance-agent-of-chance-fn2-11-fn8-benefit">Once per day, you can allow an adjacent ally to reroll a skill check as an <strong className="hl">immediate action</strong> before the result is revealed. The ally must take the second roll, even if it is worse.</Pair>
</Ability>
<Ability id="traitcorpsehunter-corpse-hunter-fn2-12-fn3-9" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitcorpsehunter-corpse-hunter-fn2-12-fn3-9"><Link to="/trait/corpse_hunter">⮞</Link> Corpse Hunter <sup><InnerLink showBacklink="backlink-main-traits_religion_nn-fake-fn-2.12" id="main-traits_religion_nn-fake-fn-2.12" data-hash-target to="main-traits_religion_nn-fake-fn-2-target">2</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_nn-fake-fn-3.9" id="main-traits_religion_nn-fake-fn-3.9" data-hash-target to="main-traits_religion_nn-fake-fn-3-target">3</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/pharasma">Pharasma</Link></Pair>
<Pair single="benefit" id="traitcorpsehunter-corpse-hunter-fn2-12-fn3-9-benefit">You have dedicated yourself to the destruction of undead, and gain a +1 trait bonus on attacks made against undead.</Pair>
</Ability>
<Ability id="traitspiritguide-spirit-guide-fn2-13-fn3-10" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitstabilizingtouch-stabilizing-touch-fn2-14" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitundeadslayerpharasma-undead-slayer-pharasma-fn4-3-fn5-3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitstriptheveils-strip-the-veils-fn2-15-fn3-11" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitveilsuponveils-veils-upon-veils-fn2-16" extraClasses="trait" icon={["Religion"]}>
...
</IonLabel></IonItem><section data-footnotes><h3 id="main-traits_religion_nn-label">Footnotes</h3><ol>
...
<li id="main-traits_religion_nn-fake-fn-2-target"><p><Link to="/source/inner_sea_gods">Inner Sea Gods</Link> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2" data-hash-target to="main-traits_religion_nn-fake-fn-2">↩</InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.2" data-hash-target to="main-traits_religion_nn-fake-fn-2.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.3" data-hash-target to="main-traits_religion_nn-fake-fn-2.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.4" data-hash-target to="main-traits_religion_nn-fake-fn-2.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.5" data-hash-target to="main-traits_religion_nn-fake-fn-2.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.6" data-hash-target to="main-traits_religion_nn-fake-fn-2.6">↩<sup>6</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.7" data-hash-target to="main-traits_religion_nn-fake-fn-2.7">↩<sup>7</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.8" data-hash-target to="main-traits_religion_nn-fake-fn-2.8">↩<sup>8</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.9" data-hash-target to="main-traits_religion_nn-fake-fn-2.9">↩<sup>9</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.10" data-hash-target to="main-traits_religion_nn-fake-fn-2.10">↩<sup>10</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.11" data-hash-target to="main-traits_religion_nn-fake-fn-2.11">↩<sup>11</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.12" data-hash-target to="main-traits_religion_nn-fake-fn-2.12">↩<sup>12</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.13" data-hash-target to="main-traits_religion_nn-fake-fn-2.13">↩<sup>13</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.14" data-hash-target to="main-traits_religion_nn-fake-fn-2.14">↩<sup>14</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.15" data-hash-target to="main-traits_religion_nn-fake-fn-2.15">↩<sup>15</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_nn-fake-fn-2.16" data-hash-target to="main-traits_religion_nn-fake-fn-2.16">↩<sup>16</sup></InnerLink></p></li>
<li id="main-traits_religion_nn-fake-fn-3-target"><p><Link to="/source/faiths_of_balance">Faiths of Balance</Link> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_nn-fake-fn-3" data-hash-target to="main-traits_religion_nn-fake-fn-3">↩</InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_nn-fake-fn-3.2" data-hash-target to="main-traits_religion_nn-fake-fn-3.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_nn-fake-fn-3.3" data-hash-target to="main-traits_religion_nn-fake-fn-3.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_nn-fake-fn-3.4" data-hash-target to="main-traits_religion_nn-fake-fn-3.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_nn-fake-fn-3.5" data-hash-target to="main-traits_religion_nn-fake-fn-3.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_nn-fake-fn-3.6" data-hash-target to="main-traits_religion_nn-fake-fn-3.6">↩<sup>6</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_nn-fake-fn-3.7" data-hash-target to="main-traits_religion_nn-fake-fn-3.7">↩<sup>7</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_nn-fake-fn-3.8" data-hash-target to="main-traits_religion_nn-fake-fn-3.8">↩<sup>8</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_nn-fake-fn-3.9" data-hash-target to="main-traits_religion_nn-fake-fn-3.9">↩<sup>9</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_nn-fake-fn-3.10" data-hash-target to="main-traits_religion_nn-fake-fn-3.10">↩<sup>10</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_nn-fake-fn-3.11" data-hash-target to="main-traits_religion_nn-fake-fn-3.11">↩<sup>11</sup></InnerLink></p></li>
<li id="main-traits_religion_nn-fake-fn-4-target"><p><Link to="/source/ultimate_campaign">Ultimate Campaign</Link> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_nn-fake-fn-4" data-hash-target to="main-traits_religion_nn-fake-fn-4">↩</InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_nn-fake-fn-4.2" data-hash-target to="main-traits_religion_nn-fake-fn-4.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_nn-fake-fn-4.3" data-hash-target to="main-traits_religion_nn-fake-fn-4.3">↩<sup>3</sup></InnerLink></p></li>
<li id="main-traits_religion_nn-fake-fn-5-target"><p><Link to="/source/advanced_players_guide">Advanced Player's Guide</Link> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_nn-fake-fn-5" data-hash-target to="main-traits_religion_nn-fake-fn-5">↩</InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_nn-fake-fn-5.2" data-hash-target to="main-traits_religion_nn-fake-fn-5.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_nn-fake-fn-5.3" data-hash-target to="main-traits_religion_nn-fake-fn-5.3">↩<sup>3</sup></InnerLink></p></li>
<li id="main-traits_religion_nn-fake-fn-6-target"><p><Link to="/source/sargava_the_lost_colony">Sargava, the Lost Colony</Link> <InnerLink aria-label="Back to reference 6" id="backlink-main-traits_religion_nn-fake-fn-6" data-hash-target to="main-traits_religion_nn-fake-fn-6">↩</InnerLink></p></li>
<li id="main-traits_religion_nn-fake-fn-7-target"><p><Link to="/source/legacy_of_fire_players_guide">Legacy of Fire Player's Guide</Link> <InnerLink aria-label="Back to reference 7" id="backlink-main-traits_religion_nn-fake-fn-7" data-hash-target to="main-traits_religion_nn-fake-fn-7">↩</InnerLink></p></li>
<li id="main-traits_religion_nn-fake-fn-8-target"><p><Link to="/source/faiths_of_purity">Faiths of Purity</Link> <InnerLink aria-label="Back to reference 8" id="backlink-main-traits_religion_nn-fake-fn-8" data-hash-target to="main-traits_religion_nn-fake-fn-8">↩</InnerLink></p></li>
</ol></section></IonList>};
const _traits_religion_ne = {title: "Religion Traits: Neutral Evil", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitpoisonousslayer-poisonous-slayer-fn1" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitpracticeddeception-practiced-deception-fn1-2-fn2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitsecretknowledge-secret-knowledge-fn1-3-fn2-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitshadowwhispers-shadow-whispers-fn3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitvenomdrenched-venom-drenched-fn4" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitcorpsecannibal-corpse-cannibal-fn3-2" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="flavor" id="traitcorpsecannibal-corpse-cannibal-fn3-2-flavor">Your faith encourages you to indulge a variety of perverse hungers, leading you to shrug at even some of the darkest taboos.</Pair>
<Pair single="benefit" id="traitcorpsecannibal-corpse-cannibal-fn3-2-benefit">You gain a +2 trait bonus on Fortitude saves against diseases and can gain sustenance from rotting flesh with no negative side effects.</Pair>
</Ability>
<Ability id="traitdeathspeaker-deathspeaker-fn1-4-fn2-3" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitdeathspeaker-deathspeaker-fn1-4-fn2-3"><Link to="/trait/deathspeaker">⮞</Link> Deathspeaker <sup><InnerLink showBacklink="backlink-main-traits_religion_ne-fake-fn-1.4" id="main-traits_religion_ne-fake-fn-1.4" data-hash-target to="main-traits_religion_ne-fake-fn-1-target">1</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_ne-fake-fn-2.3" id="main-traits_religion_ne-fake-fn-2.3" data-hash-target to="main-traits_religion_ne-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/urgathoa">Urgathoa</Link></Pair>
<Pair single="benefit" id="traitdeathspeaker-deathspeaker-fn1-4-fn2-3-benefit">Your experience with undead creatures gives you a +2 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link> checks when dealing with undead, as well as a +2 trait bonus on Charisma checks to influence undead (such as with the <Link to="/spell/command_undead">command undead</Link> spell).</Pair>
</Ability>
<Ability id="traitdenialoffate-denial-of-fate-fn1-5" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitdenialoffate-denial-of-fate-fn1-5"><Link to="/trait/denial_of_fate">⮞</Link> Denial of Fate <sup><InnerLink showBacklink="backlink-main-traits_religion_ne-fake-fn-1.5" id="main-traits_religion_ne-fake-fn-1.5" data-hash-target to="main-traits_religion_ne-fake-fn-1-target">1</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/urgathoa">Urgathoa</Link></Pair>
<Pair single="flavor" id="traitdenialoffate-denial-of-fate-fn1-5-flavor">The Pallid Princess has blessed you with the ability to avoid the final fate.</Pair>
<Pair single="benefit" id="traitdenialoffate-denial-of-fate-fn1-5-benefit">Once per day while you are below 0 hit points, at the start of your turn you can choose to stabilize without needing to succeed at a Constitution check.</Pair>
</Ability>
<Ability id="traitinoculated-inoculated-fn1-6-fn2-4" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitinoculated-inoculated-fn1-6-fn2-4"><Link to="/trait/inoculated">⮞</Link> Inoculated <sup><InnerLink showBacklink="backlink-main-traits_religion_ne-fake-fn-1.6" id="main-traits_religion_ne-fake-fn-1.6" data-hash-target to="main-traits_religion_ne-fake-fn-1-target">1</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_ne-fake-fn-2.4" id="main-traits_religion_ne-fake-fn-2.4" data-hash-target to="main-traits_religion_ne-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/urgathoa">Urgathoa</Link></Pair>
<Pair single="benefit" id="traitinoculated-inoculated-fn1-6-fn2-4-benefit">Your regular exposure to plagues grants you a +2 trait bonus on saving throws against disease effects.</Pair>
</Ability>
<Ability id="traitaccidentresistant-accident-resistant-fn1-7" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitaccidentresistant-accident-resistant-fn1-7"><Link to="/trait/accident_resistant">⮞</Link> Accident Resistant <sup><InnerLink showBacklink="backlink-main-traits_religion_ne-fake-fn-1.7" id="main-traits_religion_ne-fake-fn-1.7" data-hash-target to="main-traits_religion_ne-fake-fn-1-target">1</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/zyphus">Zyphus</Link></Pair>
<Pair single="flavor" id="traitaccidentresistant-accident-resistant-fn1-7-flavor">Your understanding of pointless and unexpected death grants you a special awareness.</Pair>
<Pair single="benefit" id="traitaccidentresistant-accident-resistant-fn1-7-benefit">You gain a +2 trait bonus on Reflex saves when denied your Dexterity bonus or during a surprise round.</Pair>
</Ability>
<Ability id="traitfataltrapper-fatal-trapper-fn1-8-fn2-5" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitfataltrapper-fatal-trapper-fn1-8-fn2-5"><Link to="/trait/fatal_trapper">⮞</Link> Fatal Trapper <sup><InnerLink showBacklink="backlink-main-traits_religion_ne-fake-fn-1.8" id="main-traits_religion_ne-fake-fn-1.8" data-hash-target to="main-traits_religion_ne-fake-fn-1-target">1</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_ne-fake-fn-2.5" id="main-traits_religion_ne-fake-fn-2.5" data-hash-target to="main-traits_religion_ne-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/zyphus">Zyphus</Link></Pair>
<Pair single="flavor" id="traitfataltrapper-fatal-trapper-fn1-8-fn2-5-flavor">Your patron grants you expertise at creating or disabling traps.</Pair>
<Pair single="benefit" id="traitfataltrapper-fatal-trapper-fn1-8-fn2-5-benefit">You gain a +1 trait bonus on <Link to="/skill/craft">Craft</Link> (traps) checks, as well as a +1 trait bonus on <Link to="/skill/disable_device">Disable Device</Link> checks to disable traps.</Pair>
</Ability>
</IonLabel></IonItem><section data-footnotes><h3 id="main-traits_religion_ne-label">Footnotes</h3><ol>
<li id="main-traits_religion_ne-fake-fn-1-target"><p><Link to="/source/inner_sea_gods">Inner Sea Gods</Link> <InnerLink aria-label="Back to reference 1" id="backlink-main-traits_religion_ne-fake-fn-1" data-hash-target to="main-traits_religion_ne-fake-fn-1">↩</InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-main-traits_religion_ne-fake-fn-1.2" data-hash-target to="main-traits_religion_ne-fake-fn-1.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-main-traits_religion_ne-fake-fn-1.3" data-hash-target to="main-traits_religion_ne-fake-fn-1.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-main-traits_religion_ne-fake-fn-1.4" data-hash-target to="main-traits_religion_ne-fake-fn-1.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-main-traits_religion_ne-fake-fn-1.5" data-hash-target to="main-traits_religion_ne-fake-fn-1.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-main-traits_religion_ne-fake-fn-1.6" data-hash-target to="main-traits_religion_ne-fake-fn-1.6">↩<sup>6</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-main-traits_religion_ne-fake-fn-1.7" data-hash-target to="main-traits_religion_ne-fake-fn-1.7">↩<sup>7</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-main-traits_religion_ne-fake-fn-1.8" data-hash-target to="main-traits_religion_ne-fake-fn-1.8">↩<sup>8</sup></InnerLink></p></li>
<li id="main-traits_religion_ne-fake-fn-2-target"><p><Link to="/source/faiths_of_corruption">Faiths of Corruption</Link> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ne-fake-fn-2" data-hash-target to="main-traits_religion_ne-fake-fn-2">↩</InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ne-fake-fn-2.2" data-hash-target to="main-traits_religion_ne-fake-fn-2.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ne-fake-fn-2.3" data-hash-target to="main-traits_religion_ne-fake-fn-2.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ne-fake-fn-2.4" data-hash-target to="main-traits_religion_ne-fake-fn-2.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ne-fake-fn-2.5" data-hash-target to="main-traits_religion_ne-fake-fn-2.5">↩<sup>5</sup></InnerLink></p></li>
<li id="main-traits_religion_ne-fake-fn-3-target"><p><Link to="/source/ultimate_campaign">Ultimate Campaign</Link> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_ne-fake-fn-3" data-hash-target to="main-traits_religion_ne-fake-fn-3">↩</InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_ne-fake-fn-3.2" data-hash-target to="main-traits_religion_ne-fake-fn-3.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_religion_ne-fake-fn-4-target"><p><Link to="/source/halflings_of_golarion">Halflings of Golarion</Link> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_ne-fake-fn-4" data-hash-target to="main-traits_religion_ne-fake-fn-4">↩</InnerLink></p></li>
</ol></section></IonList>};
const _traits_religion_cg = {title: "Religion Traits: Chaotic Good", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitadventurousimbiber-adventurous-imbiber-fn1" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitadventurousimbiber-adventurous-imbiber-fn1"><Link to="/trait/adventurous_imbiber">⮞</Link> Adventurous Imbiber <sup><InnerLink showBacklink="backlink-main-traits_religion_cg-fake-fn-1" id="main-traits_religion_cg-fake-fn-1" data-hash-target to="main-traits_religion_cg-fake-fn-1-target">1</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/cayden_cailean">Cayden Cailean</Link></Pair>
<Pair single="flavor" id="traitadventurousimbiber-adventurous-imbiber-fn1-flavor">You've never been afraid of good, strong drink, and that has prepared you for the perils of more dangerous substances.</Pair>
<Pair single="benefit" id="traitadventurousimbiber-adventurous-imbiber-fn1-benefit">You gain a +1 trait bonus on saving throws against poison.</Pair>
</Ability>
<Ability id="traitfortifieddrinker-fortified-drinker-fn2-fn3" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitfortifieddrinker-fortified-drinker-fn2-fn3"><Link to="/trait/fortified_drinker">⮞</Link> Fortified Drinker <sup><InnerLink showBacklink="backlink-main-traits_religion_cg-fake-fn-2" id="main-traits_religion_cg-fake-fn-2" data-hash-target to="main-traits_religion_cg-fake-fn-2-target">2</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_cg-fake-fn-3" id="main-traits_religion_cg-fake-fn-3" data-hash-target to="main-traits_religion_cg-fake-fn-3-target">3</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/cayden_cailean">Cayden Cailean</Link></Pair>
<Pair single="flavor" id="traitfortifieddrinker-fortified-drinker-fn2-fn3-flavor">Cayden Cailean's holy brews invigorate your mind, making you less susceptible to mental attacks.</Pair>
<Pair single="benefit" id="traitfortifieddrinker-fortified-drinker-fn2-fn3-benefit">Whenever you imbibe any alcoholic beverage, you gain a +2 trait bonus on saves against mind-affecting effects for 1 hour.</Pair>
</Ability>
<Ability id="traitgoodnatured-good-natured-fn1-2-fn4" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitstrongwilled-strong-willed-fn4-2-fn1-3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitfaithfulartist-faithful-artist-fn1-4-fn4-3" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="flavor" id="traitfaithfulartist-faithful-artist-fn1-4-fn4-3-flavor">With Desna's blessing, you have pursued an artistic path.</Pair>
<Pair single="benefit" id="traitfaithfulartist-faithful-artist-fn1-4-fn4-3-benefit">Choose one <Link to="/skill/perform">Perform</Link> skill; you gain a +1 trait bonus on Perform checks of the selected type, and Perform is a class skill for you.</Pair>
</Ability>
<Ability id="traitfollowerofthestars-follower-of-the-stars-fn5" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitfollowerofthestars-follower-of-the-stars-fn5"><Link to="/trait/follower_of_the_stars">⮞</Link> Follower of the Stars <sup><InnerLink showBacklink="backlink-main-traits_religion_cg-fake-fn-5" id="main-traits_religion_cg-fake-fn-5" data-hash-target to="main-traits_religion_cg-fake-fn-5-target">5</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/desna">Desna</Link></Pair>
<Pair single="benefit" id="traitfollowerofthestars-follower-of-the-stars-fn5-benefit">You gain a +4 trait bonus when using <Link to="/skill/survival">Survival</Link> to navigate under clear skies.</Pair>
</Ability>
<Ability id="traitgooddreams-good-dreams-fn6" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitgooddreams-good-dreams-fn6"><Link to="/trait/good_dreams">⮞</Link> Good Dreams <sup><InnerLink showBacklink="backlink-main-traits_religion_cg-fake-fn-6" id="main-traits_religion_cg-fake-fn-6" data-hash-target to="main-traits_religion_cg-fake-fn-6-target">6</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/desna">Desna</Link></Pair>
<Pair title="Requirements" hl><Link to="/race/halfling">Halfling</Link></Pair>
...
<Ability id="traitstarchild-starchild-fn2-2-fn7-fn3-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitstoicoptimism-stoic-optimism-fn1-5-fn4-4" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitthrillseekerisg-thrill-seeker-isg-fn1-6" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitsplitseconddefense-split-second-defense-fn1-7" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traittalentedorganizer-talented-organizer-fn1-8-fn4-5" extraClasses="trait" icon={["Religion"]}>
...
</IonLabel></IonItem><section data-footnotes><h3 id="main-traits_religion_cg-label">Footnotes</h3><ol>
...
<li id="main-traits_religion_cg-fake-fn-2-target"><p><Link to="/source/ultimate_campaign">Ultimate Campaign</Link> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_cg-fake-fn-2" data-hash-target to="main-traits_religion_cg-fake-fn-2">↩</InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_cg-fake-fn-2.2" data-hash-target to="main-traits_religion_cg-fake-fn-2.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_religion_cg-fake-fn-3-target"><p><Link to="/source/advanced_players_guide">Advanced Player's Guide</Link> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_cg-fake-fn-3" data-hash-target to="main-traits_religion_cg-fake-fn-3">↩</InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_cg-fake-fn-3.2" data-hash-target to="main-traits_religion_cg-fake-fn-3.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_religion_cg-fake-fn-4-target"><p><Link to="/source/faiths_of_purity">Faiths of Purity</Link> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_cg-fake-fn-4" data-hash-target to="main-traits_religion_cg-fake-fn-4">↩</InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_cg-fake-fn-4.2" data-hash-target to="main-traits_religion_cg-fake-fn-4.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_cg-fake-fn-4.3" data-hash-target to="main-traits_religion_cg-fake-fn-4.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_cg-fake-fn-4.4" data-hash-target to="main-traits_religion_cg-fake-fn-4.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_cg-fake-fn-4.5" data-hash-target to="main-traits_religion_cg-fake-fn-4.5">↩<sup>5</sup></InnerLink></p></li>
<li id="main-traits_religion_cg-fake-fn-5-target"><p><Link to="/source/wilderness_origins">Wilderness Origins</Link> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_cg-fake-fn-5" data-hash-target to="main-traits_religion_cg-fake-fn-5">↩</InnerLink></p></li>
<li id="main-traits_religion_cg-fake-fn-6-target"><p><Link to="/source/halflings_of_golarion">Halflings of Golarion</Link> <InnerLink aria-label="Back to reference 6" id="backlink-main-traits_religion_cg-fake-fn-6" data-hash-target to="main-traits_religion_cg-fake-fn-6">↩</InnerLink></p></li>
<li id="main-traits_religion_cg-fake-fn-7-target"><p><Link to="/source/elves_of_golarion">Elves of Golarion</Link> <InnerLink aria-label="Back to reference 7" id="backlink-main-traits_religion_cg-fake-fn-7" data-hash-target to="main-traits_religion_cg-fake-fn-7">↩</InnerLink></p></li>
</ol></section></IonList>};
const _traits_religion_cn = {title: "Religion Traits: Chaotic Neutral", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitadherentofancientosirion-adherent-of-ancient-osirion-fn1" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitadherentofancientosirion-adherent-of-ancient-osirion-fn1"><Link to="/trait/adherent_of_ancient_osirion">⮞</Link> Adherent of Ancient Osirion <sup><InnerLink showBacklink="backlink-main-traits_religion_cn-fake-fn-1" id="main-traits_religion_cn-fake-fn-1" data-hash-target to="main-traits_religion_cn-fake-fn-1-target">1</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
...
<Pair single="flavor" id="traitadherentofancientosirion-adherent-of-ancient-osirion-fn1-flavor">Although Bastet has been all but forgotten by the native Osirians, you either sojourned with or were raised in a cult dedicated to the cat-headed goddess of Ancient Osirion.</Pair>
<Pair single="benefit" id="traitadherentofancientosirion-adherent-of-ancient-osirion-fn1-benefit">You treat the <Link to="/eq-weapon/tekko_kagi">tekko-kagi</Link> as a martial weapon instead of an exotic weapon. You also treat the tekko-kagi as if it were a set of <Link to="/eq-weapon/claw_blades">claw blades</Link> when determining how it interacts with other effects.</Pair>
</Ability>
<Ability id="traitbesmarasname-besmaras-name-fn2" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitbesmarasname-besmaras-name-fn2"><Link to="/trait/besmaras_name">⮞</Link> Besmara's Name <sup><InnerLink showBacklink="backlink-main-traits_religion_cn-fake-fn-2" id="main-traits_religion_cn-fake-fn-2" data-hash-target to="main-traits_religion_cn-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/besmara">Besmara</Link></Pair>
<Pair single="flavor" id="traitbesmarasname-besmaras-name-fn2-flavor">Besmara sometimes answers your call.</Pair>
<Pair single="benefit" id="traitbesmarasname-besmaras-name-fn2-benefit">Once per day when casting a divine spell, you can speak or whisper her name in place of using a divine focus.</Pair>
</Ability>
<Ability id="traitbesmarasstrength-besmaras-strength-fn3" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitbesmarasstrength-besmaras-strength-fn3"><Link to="/trait/besmaras_strength">⮞</Link> Besmara's Strength <sup><InnerLink showBacklink="backlink-main-traits_religion_cn-fake-fn-3" id="main-traits_religion_cn-fake-fn-3" data-hash-target to="main-traits_religion_cn-fake-fn-3-target">3</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/besmara">Besmara</Link></Pair>
<Pair single="flavor" id="traitbesmarasstrength-besmaras-strength-fn3-flavor">The Pirate Queen sometimes answers your calls when you tread dangerous waters.</Pair>
<Pair single="benefit" id="traitbesmarasstrength-besmaras-strength-fn3-benefit">Once per day when attempting a <Link to="/skill/swim">Swim</Link> check, you can treat the water as if it were one category calmer (as if stormy water were rough water or rough water were calm water).</Pair>
</Ability>
<Ability id="traitcheatdeath-cheat-death-fn4" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitcheatdeath-cheat-death-fn4"><Link to="/trait/cheat_death">⮞</Link> Cheat Death <sup><InnerLink showBacklink="backlink-main-traits_religion_cn-fake-fn-4" id="main-traits_religion_cn-fake-fn-4" data-hash-target to="main-traits_religion_cn-fake-fn-4-target">4</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/besmara">Besmara</Link></Pair>
<Pair single="flavor" id="traitcheatdeath-cheat-death-fn4-flavor">Even Besmara's most faithful worshipers usually call upon her only in times of greatest need. Sometimes Besmara intervenes on behalf of her faithful; other times, she turns her face away as they sink beneath the waves.</Pair>
<Pair single="benefit" id="traitcheatdeath-cheat-death-fn4-benefit">Once per day, when you would be reduced to 0 or fewer hit points as a result of a failed ability check, skill check, or saving throw on your part, you may invoke this ability in order to reroll the failed check. You must take the result of the second roll, even if it is worse than the original.</Pair>
</Ability>
<Ability id="traitdeckfighter-deck-fighter-fn2-2-fn5" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitdeckfighter-deck-fighter-fn2-2-fn5"><Link to="/trait/deck_fighter">⮞</Link> Deck Fighter <sup><InnerLink showBacklink="backlink-main-traits_religion_cn-fake-fn-2.2" id="main-traits_religion_cn-fake-fn-2.2" data-hash-target to="main-traits_religion_cn-fake-fn-2-target">2</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_cn-fake-fn-5" id="main-traits_religion_cn-fake-fn-5" data-hash-target to="main-traits_religion_cn-fake-fn-5-target">5</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/besmara">Besmara</Link></Pair>
<Pair single="benefit" id="traitdeckfighter-deck-fighter-fn2-2-fn5-benefit">Your long experience in compensating for the pitch and yaw of ocean-going ships grants you a +1 trait bonus on attacks of opportunity when fighting aboard a ship.</Pair>
</Ability>
<Ability id="traitexpertboarder-expert-boarder-fn4-2" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitexpertboarder-expert-boarder-fn4-2"><Link to="/trait/expert_boarder">⮞</Link> Expert Boarder <sup><InnerLink showBacklink="backlink-main-traits_religion_cn-fake-fn-4.2" id="main-traits_religion_cn-fake-fn-4.2" data-hash-target to="main-traits_religion_cn-fake-fn-4-target">4</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/besmara">Besmara</Link></Pair>
<Pair single="flavor" id="traitexpertboarder-expert-boarder-fn4-2-flavor">Besmara rewards those who board other vessels and take what they want.</Pair>
<Pair single="benefit" id="traitexpertboarder-expert-boarder-fn4-2-benefit">While fighting on the deck of a ship, you gain a +1 bonus on all attacks made with one-handed weapons.</Pair>
</Ability>
<Ability id="traitcalistriancourtesan-calistrian-courtesan-fn6-fn7-fn8" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitcalistriancourtesan-calistrian-courtesan-fn6-fn7-fn8"><Link to="/trait/calistrian_courtesan">⮞</Link> Calistrian Courtesan <sup><InnerLink showBacklink="backlink-main-traits_religion_cn-fake-fn-6" id="main-traits_religion_cn-fake-fn-6" data-hash-target to="main-traits_religion_cn-fake-fn-6-target">6</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_cn-fake-fn-7" id="main-traits_religion_cn-fake-fn-7" data-hash-target to="main-traits_religion_cn-fake-fn-7-target">7</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_cn-fake-fn-8" id="main-traits_religion_cn-fake-fn-8" data-hash-target to="main-traits_religion_cn-fake-fn-8-target">8</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/calistria">Calistria</Link></Pair>
<Pair single="flavor" id="traitcalistriancourtesan-calistrian-courtesan-fn6-fn7-fn8-flavor">You worked in one of Calistria's temples as a sacred courtesan, and you know how to flatter, please, and (most of all) listen.</Pair>
<Pair single="benefit" id="traitcalistriancourtesan-calistrian-courtesan-fn6-fn7-fn8-benefit">You gain a +1 trait bonus on <Link to="/skill/sense_motive">Sense Motive</Link> checks and <Link to="/skill/diplomacy">Diplomacy</Link> checks to gather information, and one of these skills (your choice) is always a class skill for you.</Pair>
</Ability>
<Ability id="traitenchantingconniver-enchanting-conniver-fn2-3" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitenchantingconniver-enchanting-conniver-fn2-3"><Link to="/trait/enchanting_conniver">⮞</Link> Enchanting Conniver <sup><InnerLink showBacklink="backlink-main-traits_religion_cn-fake-fn-2.3" id="main-traits_religion_cn-fake-fn-2.3" data-hash-target to="main-traits_religion_cn-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/calistria">Calistria</Link></Pair>
<Pair single="benefit" id="traitenchantingconniver-enchanting-conniver-fn2-3-benefit">You gain a +2 trait bonus on <Link to="/skill/bluff">Bluff</Link> and <Link to="/skill/diplomacy">Diplomacy</Link> checks against creatures affected by one of your charm or compulsion effects.</Pair>
</Ability>
<Ability id="traitholyschemer-holy-schemer-fn2-4-fn5-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitopportunistic-opportunistic-fn2-5-fn5-3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitsacredavenger-sacred-avenger-fn8-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitwaspwhisperer-wasp-whisperer-fn8-3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitirongrip-iron-grip-fn2-6-fn5-4" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitshieldtrained-shield-trained-fn2-7" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitstrongheart-strong-heart-fn2-8-fn5-5" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitveteranofbattle-veteran-of-battle-fn6-2-fn7-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitbrokenmind-broken-mind-fn2-9-fn5-6" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="benefit" id="traitbrokenmind-broken-mind-fn2-9-fn5-6-benefit">You're used to living with your own madness, and gain a +2 trait bonus on saving throws against madness and confusion effects.</Pair>
</Ability>
<Ability id="traitlightsleeper-light-sleeper-fn2-10" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitriverfreedom-river-freedom-fn2-11-fn5-7" extraClasses="trait" icon={["Religion"]}>
...
</IonLabel></IonItem><section data-footnotes><h3 id="main-traits_religion_cn-label">Footnotes</h3><ol>
...
<li id="main-traits_religion_cn-fake-fn-2-target"><p><Link to="/source/inner_sea_gods">Inner Sea Gods</Link> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_cn-fake-fn-2" data-hash-target to="main-traits_religion_cn-fake-fn-2">↩</InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_cn-fake-fn-2.2" data-hash-target to="main-traits_religion_cn-fake-fn-2.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_cn-fake-fn-2.3" data-hash-target to="main-traits_religion_cn-fake-fn-2.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_cn-fake-fn-2.4" data-hash-target to="main-traits_religion_cn-fake-fn-2.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_cn-fake-fn-2.5" data-hash-target to="main-traits_religion_cn-fake-fn-2.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_cn-fake-fn-2.6" data-hash-target to="main-traits_religion_cn-fake-fn-2.6">↩<sup>6</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_cn-fake-fn-2.7" data-hash-target to="main-traits_religion_cn-fake-fn-2.7">↩<sup>7</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_cn-fake-fn-2.8" data-hash-target to="main-traits_religion_cn-fake-fn-2.8">↩<sup>8</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_cn-fake-fn-2.9" data-hash-target to="main-traits_religion_cn-fake-fn-2.9">↩<sup>9</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_cn-fake-fn-2.10" data-hash-target to="main-traits_religion_cn-fake-fn-2.10">↩<sup>10</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_cn-fake-fn-2.11" data-hash-target to="main-traits_religion_cn-fake-fn-2.11">↩<sup>11</sup></InnerLink></p></li>
<li id="main-traits_religion_cn-fake-fn-3-target"><p><Link to="/source/people_of_the_wastes">People of the Wastes</Link> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_cn-fake-fn-3" data-hash-target to="main-traits_religion_cn-fake-fn-3">↩</InnerLink></p></li>
<li id="main-traits_religion_cn-fake-fn-4-target"><p><Link to="/source/pirates_of_the_inner_sea">Pirates of the Inner Sea</Link> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_cn-fake-fn-4" data-hash-target to="main-traits_religion_cn-fake-fn-4">↩</InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-main-traits_religion_cn-fake-fn-4.2" data-hash-target to="main-traits_religion_cn-fake-fn-4.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_religion_cn-fake-fn-5-target"><p><Link to="/source/faiths_of_balance">Faiths of Balance</Link> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_cn-fake-fn-5" data-hash-target to="main-traits_religion_cn-fake-fn-5">↩</InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_cn-fake-fn-5.2" data-hash-target to="main-traits_religion_cn-fake-fn-5.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_cn-fake-fn-5.3" data-hash-target to="main-traits_religion_cn-fake-fn-5.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_cn-fake-fn-5.4" data-hash-target to="main-traits_religion_cn-fake-fn-5.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_cn-fake-fn-5.5" data-hash-target to="main-traits_religion_cn-fake-fn-5.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_cn-fake-fn-5.6" data-hash-target to="main-traits_religion_cn-fake-fn-5.6">↩<sup>6</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-main-traits_religion_cn-fake-fn-5.7" data-hash-target to="main-traits_religion_cn-fake-fn-5.7">↩<sup>7</sup></InnerLink></p></li>
<li id="main-traits_religion_cn-fake-fn-6-target"><p><Link to="/source/ultimate_campaign">Ultimate Campaign</Link> <InnerLink aria-label="Back to reference 6" id="backlink-main-traits_religion_cn-fake-fn-6" data-hash-target to="main-traits_religion_cn-fake-fn-6">↩</InnerLink> <InnerLink aria-label="Back to reference 6" id="backlink-main-traits_religion_cn-fake-fn-6.2" data-hash-target to="main-traits_religion_cn-fake-fn-6.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_religion_cn-fake-fn-7-target"><p><Link to="/source/advanced_players_guide">Advanced Player's Guide</Link> <InnerLink aria-label="Back to reference 7" id="backlink-main-traits_religion_cn-fake-fn-7" data-hash-target to="main-traits_religion_cn-fake-fn-7">↩</InnerLink> <InnerLink aria-label="Back to reference 7" id="backlink-main-traits_religion_cn-fake-fn-7.2" data-hash-target to="main-traits_religion_cn-fake-fn-7.2">↩<sup>2</sup></InnerLink></p></li>
<li id="main-traits_religion_cn-fake-fn-8-target"><p><Link to="/source/elves_of_golarion">Elves of Golarion</Link> <InnerLink aria-label="Back to reference 8" id="backlink-main-traits_religion_cn-fake-fn-8" data-hash-target to="main-traits_religion_cn-fake-fn-8">↩</InnerLink> <InnerLink aria-label="Back to reference 8" id="backlink-main-traits_religion_cn-fake-fn-8.2" data-hash-target to="main-traits_religion_cn-fake-fn-8.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 8" id="backlink-main-traits_religion_cn-fake-fn-8.3" data-hash-target to="main-traits_religion_cn-fake-fn-8.3">↩<sup>3</sup></InnerLink></p></li>
</ol></section></IonList>};
const _traits_religion_ce = {title: "Religion Traits: Chaotic Evil", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitdragontracker-dragon-tracker-fn1" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitdragontracker-dragon-tracker-fn1"><Link to="/trait/dragon_tracker">⮞</Link> Dragon Tracker <sup><InnerLink showBacklink="backlink-main-traits_religion_ce-fake-fn-1" id="main-traits_religion_ce-fake-fn-1" data-hash-target to="main-traits_religion_ce-fake-fn-1-target">1</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/dahak">Dahak</Link></Pair>
<Pair single="flavor" id="traitdragontracker-dragon-tracker-fn1-flavor">You have been taught to identify the subtle and not-so-subtle signs of a dragon's passage.</Pair>
<Pair single="benefit" id="traitdragontracker-dragon-tracker-fn1-benefit">You gain a +2 trait bonus on <Link to="/skill/survival">Survival</Link> checks to track dragons, and you can track a dragon with Survival untrained if the check's DC is 15 or lower.</Pair>
</Ability>
<Ability id="traitdragonslayer-dragonslayer-fn1-2-fn2" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitdragonslayer-dragonslayer-fn1-2-fn2"><Link to="/trait/dragonslayer">⮞</Link> Dragonslayer <sup><InnerLink showBacklink="backlink-main-traits_religion_ce-fake-fn-1.2" id="main-traits_religion_ce-fake-fn-1.2" data-hash-target to="main-traits_religion_ce-fake-fn-1-target">1</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_ce-fake-fn-2" id="main-traits_religion_ce-fake-fn-2" data-hash-target to="main-traits_religion_ce-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/dahak">Dahak</Link></Pair>
<Pair single="flavor" id="traitdragonslayer-dragonslayer-fn1-2-fn2-flavor">You're greatly skilled in hunting and slaying those who resemble your lord's favored prey.</Pair>
<Pair single="benefit" id="traitdragonslayer-dragonslayer-fn1-2-fn2-benefit">You gain a +1 trait bonus on attack rolls against creatures of the dragon type.</Pair>
</Ability>
<Ability id="traitdiseasedheart-diseased-heart-fn1-3" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitdiseasedheart-diseased-heart-fn1-3"><Link to="/trait/diseased_heart">⮞</Link> Diseased Heart <sup><InnerLink showBacklink="backlink-main-traits_religion_ce-fake-fn-1.3" id="main-traits_religion_ce-fake-fn-1.3" data-hash-target to="main-traits_religion_ce-fake-fn-1-target">1</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/ghlaunder">Ghlaunder</Link></Pair>
<Pair single="flavor" id="traitdiseasedheart-diseased-heart-fn1-3-flavor">Your work with infections has infused your spirit with disease.</Pair>
<Pair single="benefit" id="traitdiseasedheart-diseased-heart-fn1-3-benefit">Any creature that performs a <Link to="/umr/blood_drain">blood drain</Link> or <Link to="/umr/swallow_whole">swallow whole</Link> attack on you must succeed at a Fortitude saving throw (DC = 10 + your character level + your Constitution modifier) or become infected with <Link to="/disease/filth_fever">filth fever</Link>. This is a poison effect.</Pair>
</Ability>
<Ability id="traitpotentconcoctions-potent-concoctions-fn1-4-fn2-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitvindictivestrike-vindictive-strike-fn2-3" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="benefit" id="traitvindictivestrike-vindictive-strike-fn2-3-benefit">Once per day during a combat encounter, you can choose to gain a +1 trait bonus on a single attack roll against the creature that last hit you.</Pair>
</Ability>
<Ability id="traitwronged-wronged-fn1-5" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitdeformed-deformed-fn1-6-fn2-4" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="benefit" id="traitdeformed-deformed-fn1-6-fn2-4-benefit">Your monstrous deformities grant you a +1 trait bonus on <Link to="/skill/intimidate">Intimidate</Link> checks, and Intimidate is a class skill for you.</Pair>
</Ability>
<Ability id="traitmothersrage-mothers-rage-fn3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitmothersteeth-mothers-teeth-fn4" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitopportuneslayer-opportune-slayer-fn1-7" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitunhingedmentality-unhinged-mentality-fn1-8-fn2-5" extraClasses="trait" icon={["Religion"]}>
...
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/lamashtu">Lamashtu</Link></Pair>
<Pair single="benefit" id="traitunhingedmentality-unhinged-mentality-fn1-8-fn2-5-benefit">Your goddess-granted madness gives you a +2 trait bonus on saving throws against confusion, insanity, and fear effects.</Pair>
</Ability>
<Ability id="traitvoiceofmonsters-voice-of-monsters-fn5" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitbestialwrath-bestial-wrath-fn1-9" extraClasses="trait" icon={["Religion"]}>
...
<Pair single="flavor" id="traitbestialwrath-bestial-wrath-fn1-9-flavor">When you strike hard, you strike deep.</Pair>
<Pair single="benefit" id="traitbestialwrath-bestial-wrath-fn1-9-benefit">You gain a +2 trait bonus on critical confirmation rolls.</Pair>
</Ability>
<Ability id="traitdestructiveblows-destructive-blows-fn1-10-fn2-6" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitdestructiveblows-destructive-blows-fn1-10-fn2-6"><Link to="/trait/destructive_blows">⮞</Link> Destructive Blows <sup><InnerLink showBacklink="backlink-main-traits_religion_ce-fake-fn-1.10" id="main-traits_religion_ce-fake-fn-1.10" data-hash-target to="main-traits_religion_ce-fake-fn-1-target">1</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_religion_ce-fake-fn-2.6" id="main-traits_religion_ce-fake-fn-2.6" data-hash-target to="main-traits_religion_ce-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/rovagug">Rovagug</Link></Pair>
<Pair single="flavor" id="traitdestructiveblows-destructive-blows-fn1-10-fn2-6-flavor">Your faith strengthens your powers of destruction.</Pair>
<Pair single="benefit" id="traitdestructiveblows-destructive-blows-fn1-10-fn2-6-benefit">You gain a +2 trait bonus on Strength checks to break objects, as well as on combat maneuver checks to <Link to="/rule/sunder">sunder</Link>.</Pair>
</Ability>
<Ability id="traitfury-fury-fn3-2" extraClasses="trait" icon={["Religion"]}>
<Pair single id="traitfury-fury-fn3-2"><Link to="/trait/fury">⮞</Link> Fury <sup><InnerLink showBacklink="backlink-main-traits_religion_ce-fake-fn-3.2" id="main-traits_religion_ce-fake-fn-3.2" data-hash-target to="main-traits_religion_ce-fake-fn-3-target">3</InnerLink></sup></Pair>
<Pair title="Type">Religion</Pair>
<Pair title="Religion" hl><Link to="/faith/rovagug">Rovagug</Link></Pair>
<Pair single="flavor" id="traitfury-fury-fn3-2-flavor">The flood of battle and destruction stirs deep within you.</Pair>
<Pair single="benefit" id="traitfury-fury-fn3-2-benefit">When wielding a <Link to="/eq-weapon/greataxe">greataxe</Link>, you receive a +2 trait bonus on attack rolls to confirm critical hits.</Pair>
</Ability>
<Ability id="traithatredofthegods-hatred-of-the-gods-fn1-11-fn2-7" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitsacredsmasher-sacred-smasher-fn3-3" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitwreckingwrath-wrecking-wrath-fn5-2" extraClasses="trait" icon={["Religion"]}>
...
<Ability id="traitserpentinesqueeze-serpentine-squeeze-fn1-12-fn2-8" extraClasses="trait" icon={["Religion"]}>
...
</IonLabel></IonItem><section data-footnotes><h3 id="main-traits_religion_ce-label">Footnotes</h3><ol>
...
<li id="main-traits_religion_ce-fake-fn-2-target"><p><Link to="/source/faiths_of_corruption">Faiths of Corruption</Link> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ce-fake-fn-2" data-hash-target to="main-traits_religion_ce-fake-fn-2">↩</InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ce-fake-fn-2.2" data-hash-target to="main-traits_religion_ce-fake-fn-2.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ce-fake-fn-2.3" data-hash-target to="main-traits_religion_ce-fake-fn-2.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ce-fake-fn-2.4" data-hash-target to="main-traits_religion_ce-fake-fn-2.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ce-fake-fn-2.5" data-hash-target to="main-traits_religion_ce-fake-fn-2.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ce-fake-fn-2.6" data-hash-target to="main-traits_religion_ce-fake-fn-2.6">↩<sup>6</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ce-fake-fn-2.7" data-hash-target to="main-traits_religion_ce-fake-fn-2.7">↩<sup>7</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-main-traits_religion_ce-fake-fn-2.8" data-hash-target to="main-traits_religion_ce-fake-fn-2.8">↩<sup>8</sup></InnerLink></p></li>
<li id="main-traits_religion_ce-fake-fn-3-target"><p><Link to="/source/orcs_of_golarion">Orcs of Golarion</Link> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_ce-fake-fn-3" data-hash-target to="main-traits_religion_ce-fake-fn-3">↩</InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_ce-fake-fn-3.2" data-hash-target to="main-traits_religion_ce-fake-fn-3.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_religion_ce-fake-fn-3.3" data-hash-target to="main-traits_religion_ce-fake-fn-3.3">↩<sup>3</sup></InnerLink></p></li>
...
const _traits_casmaron = {title: "Regional Traits: Casmaron", jsx: <IonList lines="full"><MainLink to="/main/traits_regional" className="reversed" info="Back to Regional Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitcentaurvengeance-centaur-vengeance-fn1" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitcentaurvengeance-centaur-vengeance-fn1-flavor">Your nomadic tribe wanders the Ice Steppes of Iobaria. They live in constant fear of the great white wyrm Sjohvornor and feel helpless to stop the dragon's aggression. Your tribe is filled with wise sages and great warriors, and they resent being cowed by any foe. You vowed that one day you would not have to be afraid of Sjohvornor or any other wyrm.</Pair>
<Pair single="benefit" id="traitcentaurvengeance-centaur-vengeance-fn1-benefit">You gain a +2 bonus on saving throws against any dragon's <Link to="/umr/frightful_presence">frightful presence</Link>.</Pair>
</Ability>
<Ability id="traitiobariansurvivor-iobarian-survivor-fn2" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitalabasterodalisque-alabaster-odalisque-fn3" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitalabasterodalisque-alabaster-odalisque-fn3-flavor">The rajahs of Jalmeray favored you for your stately physique and flawless skin, and so endorsed your candidacy for tutelage at the Conservatory on the island of Grand Sarret.</Pair>
<Pair single="benefit" id="traitalabasterodalisque-alabaster-odalisque-fn3-benefit"><p>Trained to be the perfect bard, courtesan, or undercover operative, you gain a +1 trait bonus on two Charisma-based skills of your choice.</p>
<p>In addition, once per day as a <strong className="hl">swift action</strong>, you can brush your fingers against a closed door or stone wall up to 1 foot thick. Doing so allows you to ignore penalties on <Link to="/skill/perception">Perception</Link> checks to listen through the designated object for 1 minute.</p>
</Pair>
</Ability>
<Ability id="traitcandidateforperfection-candidate-for-perfection-fn4" extraClasses="trait" icon={["Regional"]}>
...
<Pair title="Type">Regional</Pair>
<Pair title="Region" hl>Jalmeray</Pair>
<Pair single="flavor" id="traitcandidateforperfection-candidate-for-perfection-fn4-flavor">You have begun training to enter one of the <Link to="/rule/houses_of_perfection">Houses of Perfection</Link>, and have honed your body, mind, and spirit into one well-trained weapon.</Pair>
<Pair single="benefit" id="traitcandidateforperfection-candidate-for-perfection-fn4-benefit">You gain a +1 trait bonus on attack of opportunity attack rolls made with unarmed strikes.</Pair>
</Ability>
<Ability id="traitnagaemissary-naga-emissary-fn5" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitsecretoftheimpossiblekingdom-secret-of-the-impossible-kingdom-fn4-2" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitkeleshitetrader-keleshite-trader-fn6" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitkeleshitetrader-keleshite-trader-fn6-flavor">Your cosmopolitan upbringing has given you familiarity with many cultures.</Pair>
<Pair single="benefit" id="traitkeleshitetrader-keleshite-trader-fn6-benefit">You gain two bonus languages and a +2 trait bonus on <Link to="/skill/knowledge_local">Knowledge (local)</Link> checks.</Pair>
</Ability>
<Ability id="traitbravewords-brave-words-fn7" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitbravewords-brave-words-fn7-flavor">You inherit your forebears' ability to fight off terror with bragging or insults.</Pair>
<Pair single="benefit" id="traitbravewords-brave-words-fn7-benefit"><p>As a <strong className="hl">swift action</strong>, when you have the <Link to="/misc/frightened">frightened</Link> condition, you can function as if you only have the <Link to="/misc/shaken">shaken</Link> condition for 1 round by shouting at the source of your fear. You must be able to see the source of the fear condition.</p>
<p>You can use this trait only once per fear effect. This trait grants no benefits against the shaken or <Link to="/misc/panicked">panicked</Link> conditions.</p>
</Pair>
</Ability>
<Ability id="traitelementalpupil-elemental-pupil-fn8" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitelementalpupil-elemental-pupil-fn8-flavor">You have studied at the feet of the masters of Katheer's colleges of magic, and so increased your own mastery of the elements.</Pair>
<Pair single="benefit" id="traitelementalpupil-elemental-pupil-fn8-benefit">Choose one of the following energy types: acid, cold, electricity, or fire. When casting a spell of 1st level or higher that deals damage of your chosen energy type, the spell deals 1 extra point of damage of this type.</Pair>
</Ability>
<Ability id="traitemberkinimposter-emberkin-imposter-fn6-2" extraClasses="trait" icon={["Regional"]}>
...
<Pair title="Type">Regional</Pair>
<Pair title="Region" hl>Qadira</Pair>
<Pair single="flavor" id="traitemberkinimposter-emberkin-imposter-fn6-2-flavor">You have found it is easier to be mistaken for someone with celestial blood than to reveal your true nature.</Pair>
<Pair single="benefit" id="traitemberkinimposter-emberkin-imposter-fn6-2-benefit">You gain a +5 trait bonus on Disguise checks when pretending to be an aasimar, and a +2 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link> checks against those you have convinced of your supposed celestial nature.</Pair>
</Ability>
<Ability id="traitempathicdiplomat-empathic-diplomat-fn6-3" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitempathicdiplomat-empathic-diplomat-fn6-3-flavor">You have long followed the path of common sense and empathic insight when using diplomacy.</Pair>
<Pair single="benefit" id="traitempathicdiplomat-empathic-diplomat-fn6-3-benefit">You modify your <Link to="/skill/diplomacy">Diplomacy</Link> checks using your Wisdom modifier, not your Charisma modifier.</Pair>
</Ability>
<Ability id="traitgeniecaller-genie-caller-fn4-3-fn8-2" extraClasses="trait" icon={["Regional"]}>
...
<Pair title="Type">Regional</Pair>
<Pair title="Region" hl>Qadira</Pair>
<Pair single="flavor" id="traitgeniecaller-genie-caller-fn4-3-fn8-2-flavor">Your exploration of the magic for calling genies has increased your overall aptitude for summoning.</Pair>
<Pair single="benefit" id="traitgeniecaller-genie-caller-fn4-3-fn8-2-benefit">Once per day, you may cast one conjuration (summoning) spell as if your caster level were 2 higher than normal.</Pair>
</Ability>
<Ability id="traitkeeperoftheveil-keeper-of-the-veil-fn8-3" extraClasses="trait" icon={["Regional"]}>
...
<Pair title="Type">Regional</Pair>
<Pair title="Region" hl>Qadira</Pair>
<Pair single="flavor" id="traitkeeperoftheveil-keeper-of-the-veil-fn8-3-flavor">Even when not cloaked in magic, your training has taught you how to conceal your true nature.</Pair>
<Pair single="benefit" id="traitkeeperoftheveil-keeper-of-the-veil-fn8-3-benefit">You gain a +1 competence bonus on <Link to="/skill/bluff">Bluff</Link> and <Link to="/skill/disguise">Disguise</Link> checks, and one of these skills (your choice) is always a class skill for you.</Pair>
</Ability>
<Ability id="traitmerchantofkatheer-merchant-of-katheer-fn8-4" extraClasses="trait" icon={["Regional"]}>
...
<Pair title="Type">Regional</Pair>
<Pair title="Region" hl>Qadira</Pair>
<Pair single="flavor" id="traitmerchantofkatheer-merchant-of-katheer-fn8-4-flavor">You grew up among the market stalls of the greatest trading post in all the world, and can almost smell the value of an item before you touch it.</Pair>
<Pair single="benefit" id="traitmerchantofkatheer-merchant-of-katheer-fn8-4-benefit">You gain a +1 trait bonus to <Link to="/skill/appraise">Appraise</Link> checks, and Appraise is always a class skill for you.</Pair>
</Ability>
<Ability id="traitparaheenweaponsmith-paraheen-weaponsmith-fn6-4" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitriderofparesh-rider-of-paresh-fn4-4-fn8-5" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitshaer-shaer-fn9" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitskilledsurgeon-skilled-surgeon-fn2-2" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitvenicaanmedic-venicaan-medic-fn8-6" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitwalkingward-walking-ward-fn8-7" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitwatchingtaldor-watching-taldor-fn6-5-fn8-8" extraClasses="trait" icon={["Regional"]}>
...
</IonLabel></IonItem><section data-footnotes><h3 id="main-traits_casmaron-label">Footnotes</h3><ol>
...
const _traits_tian_xia = {title: "Regional Traits: Tian Xia", jsx: <IonList lines="full"><MainLink to="/main/traits_regional" className="reversed" info="Back to Regional Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traiteducateddruggist-educated-druggist-fn1" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="benefit" id="traitheirofchuye-heir-of-chu-ye-fn1-2-benefit">If you would take a penalty for using the <Link to="/skill/heal">Heal</Link> skill to treat deadly wounds without one or more uses of a <Link to="/eq-misc/healers_kit">healer's kit</Link>, that penalty is reduced by 2 (minimum no penalty). Additionally, a creature can benefit from you treating its deadly wounds if you do so within 48 hours of its injury instead of within 24 hours.</Pair>
</Ability>
<Ability id="traitservitorofspirits-servitor-of-spirits-fn1-3" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traithoneyedtongue-honeyed-tongue-fn2" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traithoneyedtongue-honeyed-tongue-fn2-flavor">Having matured in the melting pot of New Oppara, you know the customs of the Tian-Shus as well as those of the Taldans, and you utilize this knowledge to create peace between rival groups.</Pair>
<Pair single="benefit" id="traithoneyedtongue-honeyed-tongue-fn2-benefit">You gain a +1 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link> checks, and Diplomacy becomes a class skill for you.</Pair>
</Ability>
<Ability id="traitmilitia-militia-fn2-2" extraClasses="trait" icon={["Regional"]}>
...
<Pair title="Type">Regional</Pair>
<Pair title="Region" hl>Amanandar</Pair>
<Pair single="flavor" id="traitmilitia-militia-fn2-2-flavor">As part of Amanandar's militia, you have trained extensively with groups.</Pair>
<Pair single="benefit" id="traitmilitia-militia-fn2-2-benefit">You gain a +1 trait bonus on attacks made while <Link to="/rule/flanking">flanking</Link> an opponent.</Pair>
</Ability>
<Ability id="traitdtangmabloodline-dtang-ma-bloodline-fn2-3" extraClasses="trait" icon={["Regional"]}>
...
<Pair title="Type">Regional</Pair>
<Pair title="Region" hl>Dtang Ma</Pair>
<Pair single="flavor" id="traitguerilla-guerilla-fn2-4-flavor">You have spent much time in the rainforests of Dtang Ma, and know its secrets.</Pair>
<Pair single="benefit" id="traitguerilla-guerilla-fn2-4-benefit">You gain a +1 trait bonus on <Link to="/skill/knowledge_nature">Knowledge (nature)</Link> checks as well as <Link to="/skill/survival">Survival</Link> checks made in the rainforest. One of these skills becomes a class skill for you.</Pair>
</Ability>
<Ability id="traitkamitalker-kami-talker-fn2-5" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitkamitalker-kami-talker-fn2-5-flavor">You have traversed the Forest of Spirits numerous times, and have learned how best to communicate with its otherworldly inhabitants.</Pair>
<Pair single="benefit" id="traitkamitalker-kami-talker-fn2-5-benefit">You gain a +2 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link> and <Link to="/skill/intimidate">Intimidate</Link> checks made against outsiders that have the native subtype.</Pair>
</Ability>
<Ability id="traitspiritualforester-spiritual-forester-fn2-6" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traithongalbloodrider-hongal-bloodrider-fn2-7" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traithongalbloodrider-hongal-bloodrider-fn2-7-flavor">You belong to one of the nomadic groups of horseback riders that range throughout Hongal.</Pair>
<Pair single="benefit" id="traithongalbloodrider-hongal-bloodrider-fn2-7-benefit">You gain a +1 trait bonus on <Link to="/skill/handle_animal">Handle Animal</Link> and <Link to="/skill/ride">Ride</Link> checks.</Pair>
</Ability>
<Ability id="traitstormhunter-storm-hunter-fn2-8" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitaltruisticdiplomat-altruistic-diplomat-fn2-9" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitaltruisticdiplomat-altruistic-diplomat-fn2-9-flavor">Your upbringing in Hwanggot has influenced you to be both peaceful and wise, and your arguments are consistently sound.</Pair>
<Pair single="benefit" id="traitaltruisticdiplomat-altruistic-diplomat-fn2-9-benefit">You gain a +2 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link> checks.</Pair>
</Ability>
<Ability id="traithwanartist-hwan-artist-fn2-10" extraClasses="trait" icon={["Regional"]}>
...
<Pair title="Type">Regional</Pair>
<Pair title="Region" hl>Hwanggot</Pair>
<Pair single="flavor" id="traithwanartist-hwan-artist-fn2-10-flavor">You grew up in Hwanggot, and your artistic talents were cherished and honed from an early age. You have been nurtured on the artistic spirit of Hwanggot.</Pair>
<Pair single="benefit" id="traithwanartist-hwan-artist-fn2-10-benefit">Choose one <Link to="/skill/perform">Perform</Link> skill. You gain a +1 trait bonus on checks with that skill, and it becomes a class skill for you.</Pair>
</Ability>
<Ability id="traitconscientiousminer-conscientious-miner-fn2-11" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitconscientiousminer-conscientious-miner-fn2-11-flavor">You were one of the mithral miners of Jinin, and learned how to extract the delicate ore as well as determine its value.</Pair>
<Pair single="benefit" id="traitconscientiousminer-conscientious-miner-fn2-11-benefit">You gain a +1 trait bonus on <Link to="/skill/appraise">Appraise</Link> checks, and a +1 trait bonus on <Link to="/skill/profession">Profession</Link> (miner) checks. In addition, Profession (miner) becomes a class skill for you.</Pair>
</Ability>
<Ability id="traitintrepiddelver-intrepid-delver-fn2-12" extraClasses="trait" icon={["Regional"]}>
...
<Pair title="Type">Regional</Pair>
<Pair title="Region" hl>Jinin</Pair>
<Pair single="flavor" id="traitintrepiddelver-intrepid-delver-fn2-12-flavor">One of the elder elves in Ayajinbo told you many stories of the Darklands beneath the city, and your nerves have hardened to horrors others can hardly fathom.</Pair>
<Pair single="benefit" id="traitintrepiddelver-intrepid-delver-fn2-12-benefit">You gain a +2 trait bonus on saving throws against fear effects.</Pair>
</Ability>
<Ability id="traitborderguard-border-guard-fn2-13" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitborderguard-border-guard-fn2-13-flavor">You are one of the warriors on the front lines between Kwanlai and Wanshou, and excel at combat against water-dwelling foes.</Pair>
<Pair single="benefit" id="traitborderguard-border-guard-fn2-13-benefit">You gain a +2 trait bonus on rolls to confirm critical hits against foes with the aquatic subtype.</Pair>
</Ability>
<Ability id="traitkwanlaibeliever-kwanlai-believer-fn2-14" extraClasses="trait" icon={["Regional"]}>
...
<Pair title="Type">Regional</Pair>
<Pair title="Region" hl>Kwanlai</Pair>
<Pair single="flavor" id="traitkwanlaibeliever-kwanlai-believer-fn2-14-flavor">You were raised in Kwanlai in one of the devout tengu churches, and your dedication to your cause makes your divine abilities particularly potent.</Pair>
<Pair single="benefit" id="traitkwanlaibeliever-kwanlai-believer-fn2-14-benefit">You gain a +2 trait bonus on <Link to="/rule/concentration">concentration</Link> checks made while casting divine spells.</Pair>
</Ability>
<Ability id="traitbelempirate-belem-pirate-fn2-15" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitbelempirate-belem-pirate-fn2-15-flavor">The hidden coves and bays of the island of Belem have been your home throughout most of your career as a pirate, and the winding waterways of Minata have trained you well in the art of sailing.</Pair>
<Pair single="benefit" id="traitbelempirate-belem-pirate-fn2-15-benefit">You gain a +1 trait bonus on <Link to="/skill/knowledge_geography">Knowledge (geography)</Link> checks and <Link to="/skill/profession">Profession</Link> (sailor) checks, and one of these skills becomes a class skill for you.</Pair>
</Ability>
<Ability id="traitwayangspellhunter-wayang-spellhunter-fn2-16" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitinstigatorofrebellion-instigator-of-rebellion-fn2-17" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitinstigatorofrebellion-instigator-of-rebellion-fn2-17-flavor">Your rage over the political repositioning within Minkai has led you to incite rage within your compatriots. You have become adept at organizing rallies in opposition to the government.</Pair>
<Pair single="benefit" id="traitinstigatorofrebellion-instigator-of-rebellion-fn2-17-benefit">You gain a +1 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link> and <Link to="/skill/intimidate">Intimidate</Link> checks.</Pair>
</Ability>
<Ability id="traitminkaiadvocate-minkai-advocate-fn2-18" extraClasses="trait" icon={["Regional"]}>
...
<Pair title="Type">Regional</Pair>
<Pair title="Region" hl>Minkai</Pair>
<Pair single="flavor" id="traitminkaiadvocate-minkai-advocate-fn2-18-flavor">You possess strong ties to Minkai, and spread flattering words regarding your empire.</Pair>
<Pair single="benefit" id="traitminkaiadvocate-minkai-advocate-fn2-18-benefit">You gain a +1 trait bonus on <Link to="/skill/bluff">Bluff</Link> checks, and Bluff becomes a class skill for you.</Pair>
</Ability>
<Ability id="traitjungleresilience-jungle-resilience-fn2-19" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitjungleresilience-jungle-resilience-fn2-19-flavor">Having grown up in Nagajor, you are used to the myriad poisons of its people, and have developed a strong immune system.</Pair>
<Pair single="benefit" id="traitjungleresilience-jungle-resilience-fn2-19-benefit">You gain a +2 trait bonus on Fortitude saves against poison effects.</Pair>
</Ability>
<Ability id="traitsnakebleeder-snake-bleeder-fn2-20" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitmutabiqiexplorer-mutabi-qi-explorer-fn2-21" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitmutabiqiexplorer-mutabi-qi-explorer-fn2-21-flavor">You belong to one of the nomadic Mutabi-qi tribes that wander the wastes of Shaguang, and you are adept at navigating the seemingly endless desert wastes.</Pair>
<Pair single="benefit" id="traitmutabiqiexplorer-mutabi-qi-explorer-fn2-21-benefit">You gain a +1 trait bonus on <Link to="/skill/knowledge_geography">Knowledge (geography)</Link> checks and <Link to="/skill/survival">Survival</Link> checks made in the desert.</Pair>
</Ability>
<Ability id="traitheavenlytouch-heavenly-touch-fn2-22" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitheavenlytouch-heavenly-touch-fn2-22-flavor">Growing up, you were exposed to everyday miracles performed by your half-celestial friends, and some of this magic rubbed off.</Pair>
<Pair single="benefit" id="traitheavenlytouch-heavenly-touch-fn2-22-benefit">At will, you can touch a dying creature to <Link to="/misc/stabilize">stabilize</Link> it as a <strong className="hl">standard action</strong>.</Pair>
</Ability>
<Ability id="traittianjingtempleguard-tianjing-temple-guard-fn2-23" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitjunglediplomat-jungle-diplomat-fn2-24" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitjunglediplomat-jungle-diplomat-fn2-24-flavor">You know the ways and mores of the tribes of the Valashmai Jungle, and how to handle delicate communications with different groups of people.</Pair>
<Pair single="benefit" id="traitjunglediplomat-jungle-diplomat-fn2-24-benefit">You gain a +1 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link> and <Link to="/skill/sense_motive">Sense Motive</Link> checks.</Pair>
</Ability>
<Ability id="traitvalashmaiveteran-valashmai-veteran-fn2-25" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitmasterofpeaks-master-of-peaks-fn2-26" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitmasterofpeaks-master-of-peaks-fn2-26-flavor">You have made it to the summits of a number of the Wall of Heaven's peaks, and your body is used to the effects of both extreme cold and high altitude.</Pair>
<Pair single="benefit" id="traitmasterofpeaks-master-of-peaks-fn2-26-benefit">You gain a +2 trait bonus on Fortitude saving throws made against the effects of <Link to="/rule/cold_dangers">cold dangers</Link> and <Link to="/rule/altitude_sickness">altitude sickness</Link>.</Pair>
</Ability>
<Ability id="traitseasonedclimber-seasoned-climber-fn2-27" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitpearldiverxidao-pearl-diver-xidao-fn2-28" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traittrenchnavigator-trench-navigator-fn2-29" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitdiscerningbeliefs-discerning-beliefs-fn2-30" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitdiscerningbeliefs-discerning-beliefs-fn2-30-flavor">You helped the samsarans maintain the magical boundaries around valleys in the Enlightened Peaks, and learned the secrets of avoiding such illusions yourself.</Pair>
<Pair single="benefit" id="traitdiscerningbeliefs-discerning-beliefs-fn2-30-benefit">You gain a +2 trait bonus on saving throws to disbelieve illusions.</Pair>
</Ability>
<Ability id="traitsoundofmind-sound-of-mind-fn2-31" extraClasses="trait" icon={["Regional"]}>
...
</IonLabel></IonItem><section data-footnotes><h3 id="main-traits_tian_xia-label">Footnotes</h3><ol>
...
const _traits_lung_wa = {title: "Regional Traits: Former Lung Wa Empire", jsx: <IonList lines="full"><MainLink to="/main/traits_regional" className="reversed" info="Back to Regional Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitexhibitionfighter-exhibition-fighter-fn1" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitexhibitionfighter-exhibition-fighter-fn1-flavor">You fight at your best in martial arts tournaments, such as those once popular in Lung Wa and still common in Quain. While others may attempt to cheat or chafe against the constraints placed upon them, you thrive under such limitations.</Pair>
<Pair single="benefit" id="traitexhibitionfighter-exhibition-fighter-fn1-benefit">You gain a +1 bonus on attack and damage rolls when fighting as part of a tournament or other structured setting with rules and restrictions, so long as you do not break these rules.</Pair>
</Ability>
<Ability id="traitgodlessresolve-godless-resolve-fn2" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitszaezancragsminer-szaezan-crags-miner-fn3" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traittigerbrigadier-tiger-brigadier-fn3-2" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitacupuncturist-acupuncturist-fn3-3" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitacupuncturist-acupuncturist-fn3-3-flavor">You have studied the ancient art of acupuncture, and use it to pursue enlightenment and healing.</Pair>
<Pair single="benefit" id="traitacupuncturist-acupuncturist-fn3-3-benefit">You gain a +2 trait bonus on all Fortitude saves made against poison effects.</Pair>
</Ability>
<Ability id="traitmizukihikarirebel-mizu-ki-hikari-rebel-fn3-4" extraClasses="trait" icon={["Regional"]}>
...
<Pair title="Type">Regional</Pair>
<Pair title="Region" hl>Chu Ye</Pair>
<Pair single="flavor" id="traitmizukihikarirebel-mizu-ki-hikari-rebel-fn3-4-flavor">You have trained in martial arts under the banner of Mizu Ki Hikari rebels.</Pair>
<Pair single="benefit" id="traitmizukihikarirebel-mizu-ki-hikari-rebel-fn3-4-benefit">You gain a +1 trait bonus on damage rolls made with unarmed attacks.</Pair>
</Ability>
<Ability id="traitcosmopolitan-cosmopolitan-fn3-5-fn4" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitcosmopolitan-cosmopolitan-fn3-5-fn4-flavor">Your exposure to the many peoples intersecting in Goka and the tongues spoken there has given you a particular facility for speech.</Pair>
<Pair single="benefit" id="traitcosmopolitan-cosmopolitan-fn3-5-fn4-benefit">You gain a +1 trait bonus on <Link to="/skill/linguistics">Linguistics</Link> checks, and Linguistics becomes a class skill for you.</Pair>
</Ability>
<Ability id="traitundermarketsmuggler-undermarket-smuggler-fn3-6" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitindenturedblacksmith-indentured-blacksmith-fn3-7" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitindenturedblacksmith-indentured-blacksmith-fn3-7-flavor">As a former slave of the hobgoblins, you were forced to make many of the weapons and shields that your captors used in war.</Pair>
<Pair single="benefit" id="traitindenturedblacksmith-indentured-blacksmith-fn3-7-benefit">Choose either <Link to="/skill/craft">Craft</Link> (armor) or Craft (weapons). You gain a +1 trait bonus on the chosen skill, and it becomes a class skill for you.</Pair>
</Ability>
<Ability id="traitprivilegedslave-privileged-slave-fn3-8" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitheartofclay-heart-of-clay-fn3-9" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitheartofclay-heart-of-clay-fn3-9-flavor">You believe you are destined for an afterlife of service as part of King Huang's terra-cotta army, so you do not fear death as others do.</Pair>
<Pair single="benefit" id="traitheartofclay-heart-of-clay-fn3-9-benefit">You gain a +1 trait bonus on Fortitude saves.</Pair>
</Ability>
<Ability id="traitlingshensfinest-lingshens-finest-fn3-10" extraClasses="trait" icon={["Regional"]}>
...
<Pair title="Type">Regional</Pair>
<Pair title="Region" hl>Lingshen</Pair>
<Pair single="flavor" id="traitlingshensfinest-lingshens-finest-fn3-10-flavor">You are an elite soldier in one of Lingshen's numerous armies, and your discipline has made you a truly deadly foe.</Pair>
<Pair single="benefit" id="traitlingshensfinest-lingshens-finest-fn3-10-benefit">You gain a +1 trait bonus on all rolls to confirm critical hits.</Pair>
</Ability>
<Ability id="traitskyspiritworshipper-sky-spirit-worshipper-fn3-11" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitchosenchild-chosen-child-fn3-12" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitchosenchild-chosen-child-fn3-12-flavor">The oracles of Po Li smiled upon you when your parents claimed you were of divine right, and you were raised with privileges few Po Lians can fathom.</Pair>
<Pair single="benefit" id="traitchosenchild-chosen-child-fn3-12-benefit">Your starting money increases by 900 gp.</Pair>
</Ability>
<Ability id="traitpassionatebeliever-passionate-believer-fn3-13" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitquainmartialartist-quain-martial-artist-fn3-14" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitsilvertonguedeunuch-silvertongued-eunuch-fn3-15" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitaberrationhunter-aberration-hunter-fn3-16" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitaberrationhunter-aberration-hunter-fn3-16-flavor">You refuse to give in to the monsters that feast on your people, and hunt them instead.</Pair>
<Pair single="benefit" id="traitaberrationhunter-aberration-hunter-fn3-16-benefit">You gain a +1 trait bonus on attacks of opportunity against aberrations.</Pair>
</Ability>
<Ability id="traitshenmenprospector-shenmen-prospector-fn3-17" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitfreedomfightershokuro-freedom-fighter-shokuro-fn3-18" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitfreedomfightershokuro-freedom-fighter-shokuro-fn3-18-flavor">You come from a family of farmers, but are determined to fight for your rights.</Pair>
<Pair single="benefit" id="traitfreedomfightershokuro-freedom-fighter-shokuro-fn3-18-benefit">You gain a +1 trait bonus on attacks made with <Link to="/misc/improvised_weapons">improvised weapons</Link>. If you do not possess the <Link to="/feat/catch_off_guard">Catch Off-Guard</Link> or <Link to="/feat/throw_anything">Throw Anything</Link> feats, you still take penalties on these attack rolls as normal.</Pair>
</Ability>
<Ability id="traitrebelleader-rebel-leader-fn3-19" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitricerunner-rice-runner-fn3-20" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitswamprebel-swamp-rebel-fn3-21" extraClasses="trait" icon={["Regional"]}>
...
<Ability id="traitclanartisan-clan-artisan-fn3-22" extraClasses="trait" icon={["Regional"]}>
...
<Pair single="flavor" id="traitclanartisan-clan-artisan-fn3-22-flavor">You were raised in one of the numerous clans of Xa Hoi, and learned a valuable trade in your early years.</Pair>
<Pair single="benefit" id="traitclanartisan-clan-artisan-fn3-22-benefit">Pick one <Link to="/skill/craft">Craft</Link> skill. You gain a +2 trait bonus on checks with that skill, and it becomes a class skill for you.</Pair>
</Ability>
<Ability id="traitxahoisoldier-xa-hoi-soldier-fn3-23" extraClasses="trait" icon={["Regional"]}>
...
</IonLabel></IonItem><section data-footnotes><h3 id="main-traits_lung_wa-label">Footnotes</h3><ol>
...
const _traits_race_aasimar = {title: "Aasimar Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_race" className="reversed" info="Back to Race Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitadrift-adrift-fn1" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitcelestialcommunity-celestial-community-fn2" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitcelestialcontact-celestial-contact-fn3" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitclergymember-clergy-member-fn1-2" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitethicalleader-ethical-leader-fn1-3" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitfaithhealer-faith-healer-fn1-4" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitidealizedcampaigner-idealized-campaigner-fn3-2" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitinnocent-innocent-fn1-5" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitmartyrsblood-martyrs-blood-fn4" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitplanarnegotiatorboa-planar-negotiator-boa-fn1-6" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitselectivehealth-selective-health-fn1-7" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitwaryboa-wary-boa-fn1-8" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitcelestialtracker-celestial-tracker-fn1-9" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitplanetarsvisions-planetars-visions-fn1-10" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitburnishedskin-burnished-skin-fn1-11" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitpyromancer-pyromancer-fn1-12" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitenlightenedwarrior-enlightened-warrior-fn1-13" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitspeechofthewilds-speech-of-the-wilds-fn1-14" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitgoodinfluence-good-influence-fn1-15" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitlanternspirit-lantern-spirit-fn1-16" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitbralanisstep-bralanis-step-fn1-17" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitlillendsharp-lillends-harp-fn1-18" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitsnakehater-snake-hater-fn1-19" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traittoxophilite-toxophilite-fn1-20" extraClasses="trait" icon={["Race"]}>
...
</IonLabel></IonItem><section data-footnotes><h3 id="main-traits_race_aasimar-label">Footnotes</h3><ol>
...
const _traits_race_tiefling = {title: "Tiefling Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_race" className="reversed" info="Back to Race Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitanticipateevil-anticipate-evil-fn1" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitbeastbully-beast-bully-fn1-2" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitblessingofdarkness-blessing-of-darkness-fn1-3" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitborndamned-born-damned-fn1-4" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitdarkmagicaffinity-dark-magic-affinity-fn1-5" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitenduringheritage-enduring-heritage-fn2" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traiteverwary-ever-wary-fn1-6" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitfamilyconnections-family-connections-fn1-7" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitfiendishsniper-fiendish-sniper-fn3" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitfriendless-friendless-fn1-8" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traithardtopindown-hard-to-pin-down-fn4" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitincitertiefling-inciter-tiefling-fn1-9" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitmaligninstrument-malign-instrument-fn2-2" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitmotherless-motherless-fn1-10" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitneutralizinggut-neutralizing-gut-fn5" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitpersecutedexpatriate-persecuted-expatriate-fn4-2" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitpridefultemper-prideful-temper-fn1-11" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitprolongmagic-prolong-magic-fn1-12" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitshadowstabber-shadow-stabber-fn1-13" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitsuicidal-suicidal-fn1-14" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traittempterstongue-tempters-tongue-fn6" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traittwilightzeal-twilight-zeal-fn1-15" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitunderling-underling-fn1-16" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitbentbody-bent-body-fn1-17" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traittoughskin-tough-skin-fn1-18" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitarmsmaster-arms-master-fn1-19" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitprayerbreaker-prayer-breaker-fn1-20" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitgodscorn-god-scorn-fn1-21" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitrepulsive-repulsive-fn1-22" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitdeathsdeputy-deaths-deputy-fn1-23" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitsouleater-soul-eater-fn1-24" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitbloodstalker-blood-stalker-fn1-25" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitunearthsecrets-unearth-secrets-fn1-26" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitbigboned-big-boned-fn1-27" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitsuperiorclutch-superior-clutch-fn1-28" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitdeadlyrush-deadly-rush-fn1-29" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitflairfordestruction-flair-for-destruction-fn1-30" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitchainmaster-chain-master-fn1-31" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitpainartist-pain-artist-fn1-32" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitburiedanxiety-buried-anxiety-fn1-33" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitshifttheblame-shift-the-blame-fn1-34" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitrepelsin-repel-sin-fn1-35" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitvilekiss-vile-kiss-fn1-36" extraClasses="trait" icon={["Race"]}>
...
const _traits_race_vampire = {title: "Vampire Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_race" className="reversed" info="Back to Race Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitcalculatedrisk-calculated-risk-fn1" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitintunewithlanguage-in-tune-with-language-fn1-2" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitproudprogenitor-proud-progenitor-fn1-3" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitweatherworn-weatherworn-fn1-4" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitrapiddrain-rapid-drain-fn1-5" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traittelekineticdependence-telekinetic-dependence-fn1-6" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitselfaware-self-aware-fn1-7" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitstubborn-stubborn-fn1-8" extraClasses="trait" icon={["Race"]}>
...
const _traits_race_other_races = {title: "Other Races Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_race" className="reversed" info="Back to Race Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitvermindriver-vermin-driver-fn1" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitcreativereality-creative-reality-fn2" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitfrustrating-frustrating-fn1-2" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traithonoredprovider-honored-provider-fn1-3" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitazlantiinheritor-azlanti-inheritor-fn3-fn4" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitmemorymastery-memory-mastery-fn1-4" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitcanopyshooter-canopy-shooter-fn1-5" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitinciterhobgoblin-inciter-hobgoblin-fn1-6" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitguarded-guarded-fn1-7" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitlonglung-longlung-fn1-8" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitnagajinationalist-nagaji-nationalist-fn1-9" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitwallsofhalftruths-walls-of-half-truths-fn1-10" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitaerialharrier-aerial-harrier-fn1-11" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitsecretkeepersvirfneblin-secret-keeper-svirfneblin-fn1-12" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitwingedaloofness-winged-aloofness-fn1-13" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitseafaringslayer-seafaring-slayer-fn1-14" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitmagicsurvivor-magic-survivor-fn1-15" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traittrickstervanara-trickster-vanara-fn1-16" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitaugmentedspellpoisons-augmented-spell-poisons-fn1-17" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitwaterlurker-water-lurker-fn1-18" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitresilientconstruction-resilient-construction-fn1-19" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitfierceflanker-fierce-flanker-fn1-20" extraClasses="trait" icon={["Race"]}>
...
const _traits_race_skinwalker = {title: "Skinwalker Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_race" className="reversed" info="Back to Race Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitcurseintheblood-curse-in-the-blood-fn1" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitmarkedbynaturesmagic-marked-by-natures-magic-fn2" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitmasteryofform-mastery-of-form-fn3" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traittraumaticshift-traumatic-shift-fn3-2" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitfightwiththeflock-fight-with-the-flock-fn3-3" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitprecisionhearing-precision-hearing-fn3-4" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitdurablechange-durable-change-fn3-5" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitrevivingrest-reviving-rest-fn3-6" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitboarresilience-boar-resilience-fn3-7" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitstrengthofbody-strength-of-body-fn3-8" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitcrocodileswim-crocodile-swim-fn3-9" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitterrifyinglunge-terrifying-lunge-fn3-10" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitinuredtodisease-inured-to-disease-fn3-11" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitratsqueeze-rat-squeeze-fn3-12" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitsharkchild-sharkchild-fn3-13" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitshorelineskirmisher-shoreline-skirmisher-fn3-14" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitfelineinstinct-feline-instinct-fn3-15" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traittigersclaw-tigers-claw-fn3-16" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitlycanthropicbloodlust-lycanthropic-bloodlust-fn3-17" extraClasses="trait" icon={["Race"]}>
...
<Ability id="traitsharedcurse-shared-curse-fn3-18" extraClasses="trait" icon={["Race"]}>
