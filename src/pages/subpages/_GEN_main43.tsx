...
const _traits_religion_lg = {title: "Religion Traits: Lawful Good", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitinspiringleader-inspiring-leader-fn1" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traiterastilsspeaker-erastils-speaker-fn1-4-fn2-2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitpatientoptimist-patient-optimist-fn3-fn4-fn5" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitdivinewarrior-divine-warrior-fn3-2-fn7-fn4-2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitinheritorsimmunity-inheritors-immunity-fn8" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitancestorsblade-ancestors-blade-fn10" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitpristinereputation-pristine-reputation-fn10-2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traiteyeofthefather-eye-of-the-father-fn1-10-fn2-7" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitguardianoftheforge-guardian-of-the-forge-fn3-3-fn11-fn4-3" extraClasses="trait" icon={["prayer"]}>
...
const _traits_religion_ln = {title: "Religion Traits: Lawful Neutral", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traiteyeforquality-eye-for-quality-fn1" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traiteyesandearsofthecity-eyes-and-ears-of-the-city-fn2-fn3-fn4" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traithoneytongued-honey-tongued-fn1-2-fn5" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traiteternalunderstanding-eternal-understanding-fn1-6" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitseerofreality-seer-of-reality-fn1-7-fn5-5" extraClasses="trait" icon={["prayer"]}>
...
const _traits_religion_le = {title: "Religion Traits: Lawful Evil", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitdeepwounding-deep-wounding-fn1" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitfrighteningspeed-frightening-speed-fn1-2-fn2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitcontractmaster-contract-master-fn1-3-fn2-2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitdemonhunter-demon-hunter-fn3-fn4-fn5" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitfiendishconfidence-fiendish-confidence-fn1-4-fn2-3" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitliarstongue-liars-tongue-fn1-5" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitdemoralizingpresence-demoralizing-presence-fn1-7" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitkuthitecaster-kuthite-caster-fn1-8-fn2-5" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitpainispleasure-pain-is-pleasure-fn5-2" extraClasses="trait" icon={["prayer"]}>
...
const _traits_religion_ng = {title: "Religion Traits: Neutral Good", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitstrengthsfanfare-strengths-fanfare-fn1" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitbladeofmercy-blade-of-mercy-fn4" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitcleansinglight-cleansing-light-fn1-3-fn2-2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitcleansingthetwisted-cleansing-the-twisted-fn4-2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitdawnrenewal-dawn-renewal-fn5" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitenvoyofhealing-envoy-of-healing-fn6" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitflameofthedawnflower-flame-of-the-dawnflower-fn7-fn8-fn9" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitilluminator-illuminator-fn1-4-fn2-3" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitinnerbeauty-inner-beauty-fn1-6-fn2-4" extraClasses="trait" icon={["prayer"]}>
...
const _traits_religion_nn = {title: "Religion Traits: True Neutral", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitbrighsinsight-brighs-insight-fn1" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitnimblefingerskeenmind-nimble-fingers-keen-mind-fn2-fn3" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitgozrehssight-gozrehs-sight-fn1-2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitknowtheland-know-the-land-fn2-6-fn3-5" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitarcanedepth-arcane-depth-fn2-8-fn3-7" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitmagicislife-magic-is-life-fn4-2-fn5-2-fn7" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitcorpsehunter-corpse-hunter-fn2-12-fn3-9" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitspiritguide-spirit-guide-fn2-13-fn3-10" extraClasses="trait" icon={["prayer"]}>
...
const _traits_religion_ne = {title: "Religion Traits: Neutral Evil", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitpoisonousslayer-poisonous-slayer-fn1" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitdeathspeaker-deathspeaker-fn1-4-fn2-3" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitdenialoffate-denial-of-fate-fn1-5" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitinoculated-inoculated-fn1-6-fn2-4" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitaccidentresistant-accident-resistant-fn1-7" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitfataltrapper-fatal-trapper-fn1-8-fn2-5" extraClasses="trait" icon={["prayer"]}>
...
const _traits_religion_cg = {title: "Religion Traits: Chaotic Good", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitadventurousimbiber-adventurous-imbiber-fn1" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitfortifieddrinker-fortified-drinker-fn2-fn3" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitgoodnatured-good-natured-fn1-2-fn4" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitfollowerofthestars-follower-of-the-stars-fn5" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitgooddreams-good-dreams-fn6" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitbesmarasname-besmaras-name-fn2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitbesmarasstrength-besmaras-strength-fn3" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitcheatdeath-cheat-death-fn4" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitdeckfighter-deck-fighter-fn2-2-fn5" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitexpertboarder-expert-boarder-fn4-2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitcalistriancourtesan-calistrian-courtesan-fn6-fn7-fn8" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitenchantingconniver-enchanting-conniver-fn2-3" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitholyschemer-holy-schemer-fn2-4-fn5-2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitlightsleeper-light-sleeper-fn2-10" extraClasses="trait" icon={["prayer"]}>
...
const _traits_religion_ce = {title: "Religion Traits: Chaotic Evil", jsx: <IonList lines="full"><MainLink to="/main/traits_religion" className="reversed" info="Back to Religion Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitdragontracker-dragon-tracker-fn1" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitdragonslayer-dragonslayer-fn1-2-fn2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitdiseasedheart-diseased-heart-fn1-3" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitpotentconcoctions-potent-concoctions-fn1-4-fn2-2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitwronged-wronged-fn1-5" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitmothersrage-mothers-rage-fn3" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitvoiceofmonsters-voice-of-monsters-fn5" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitdestructiveblows-destructive-blows-fn1-10-fn2-6" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traitfury-fury-fn3-2" extraClasses="trait" icon={["prayer"]}>
...
<Ability id="traithatredofthegods-hatred-of-the-gods-fn1-11-fn2-7" extraClasses="trait" icon={["prayer"]}>
...
const _traits_casmaron = {title: "Regional Traits: Casmaron", jsx: <IonList lines="full"><MainLink to="/main/traits_regional" className="reversed" info="Back to Regional Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitcentaurvengeance-centaur-vengeance-fn1" extraClasses="trait" icon={["planet-conquest"]}>
...
const _traits_tian_xia = {title: "Regional Traits: Tian Xia", jsx: <IonList lines="full"><MainLink to="/main/traits_regional" className="reversed" info="Back to Regional Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traiteducateddruggist-educated-druggist-fn1" extraClasses="trait" icon={["planet-conquest"]}>
...
const _traits_lung_wa = {title: "Regional Traits: Former Lung Wa Empire", jsx: <IonList lines="full"><MainLink to="/main/traits_regional" className="reversed" info="Back to Regional Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitexhibitionfighter-exhibition-fighter-fn1" extraClasses="trait" icon={["planet-conquest"]}>
...
const _traits_race_aasimar = {title: "Aasimar Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_race" className="reversed" info="Back to Race Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitadrift-adrift-fn1" extraClasses="trait" icon={["person"]}>
...
const _traits_race_tiefling = {title: "Tiefling Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_race" className="reversed" info="Back to Race Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitanticipateevil-anticipate-evil-fn1" extraClasses="trait" icon={["person"]}>
