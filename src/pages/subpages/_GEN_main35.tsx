...
const _traits_faith_all = {title: "All Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><Ability id="traitabjectbelief-abject-belief-fn1" extraClasses="trait" icon={["bolt-eye"]}>
...
const _traits_faith_def = {title: "Defense Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><Ability id="traitabjectbelief-abject-belief-fn1" extraClasses="trait" icon={["bolt-eye"]}>
...
const _traits_faith_combat = {title: "Combat-Related Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><Ability id="traitcalled-called-fn1" extraClasses="trait" icon={["bolt-eye"]}>
...
const _traits_faith_spell = {title: "Spell Ability Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><Ability id="traitapprentice-apprentice-fn1" extraClasses="trait" icon={["bolt-eye"]}>
...
const _traits_faith_magic = {title: "Magic-Related Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><Ability id="traiteyeforthewondrous-eye-for-the-wondrous-fn1" extraClasses="trait" icon={["bolt-eye"]}>
...
const _traits_faith_class = {title: "Class-Specific Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><Ability id="traitacolyteofapocrypha-acolyte-of-apocrypha-fn1" extraClasses="trait hasSubs" icon={["bolt-eye"]}>
...
const _traits_faith_ab = {title: "Skill/Feat/Ability Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><Ability id="traitacclimatizealignment-acclimatize-alignment-fn1" extraClasses="trait" icon={["bolt-eye"]}>
