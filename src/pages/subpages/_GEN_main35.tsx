...
const _traits_faith_all = {title: "All Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitabjectbelief-abject-belief-fn1" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitacclimatizealignment-acclimatize-alignment-fn2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitacolyteofapocrypha-acolyte-of-apocrypha-fn3" extraClasses="trait hasSubs" icon={["Faith"]}>
...
<Ability id="traitapprentice-apprentice-fn3-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitarcanescholar-arcane-scholar-fn3-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitaspectofthequah-aspect-of-the-quah-fn4" extraClasses="trait hasSubs" icon={["Faith"]}>
...
<Ability id="traitbeaconoffaith-beacon-of-faith-fn6" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitbirthmark-birthmark-fn6-2-fn7-fn8" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitblessed-blessed-fn6-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitcalled-called-fn5-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitcaretaker-caretaker-fn6-4-fn8-2-fn7-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitchildofthetemple-child-of-the-temple-fn6-5-fn7-3-fn8-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitchosenofiomedae-chosen-of-iomedae-fn9-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitcovertchanneler-covert-channeler-fn11" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitcrusader-crusader-fn3-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdarkestbeforedawn-darkest-before-dawn-fn3-5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdeepfaith-deep-faith-fn12" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdefymadness-defy-madness-fn13" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdevotedhealer-devoted-healer-fn5-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdevoteeofthegreen-devotee-of-the-green-fn6-6-fn8-4-fn7-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdisdainfuldefender-disdainful-defender-fn6-7" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdivineconfidante-divine-confidante-fn14" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdogged-dogged-fn4-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traiteaseoffaith-ease-of-faith-fn6-8-fn7-5-fn8-5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traiteldritchsmith-eldritch-smith-fn15-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitempyrealpantheon-empyreal-pantheon-fn16" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitexaltedofthesociety-exalted-of-the-society-fn17-fn13-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traiteyeforthewondrous-eye-for-the-wondrous-fn18" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitfaithfulfeedback-faithful-feedback-fn13-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitfatesfavored-fates-favored-fn6-9" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitfearlessdefiance-fearless-defiance-fn6-10" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitfirstmemories-first-memories-fn19" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitfocuseddisciple-focused-disciple-fn6-11" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitgodclawdisciple-godclaw-disciple-fn20" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitgreateradeptofthesociety-greater-adept-of-the-society-fn17-2-fn13-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traithavocofthesociety-havoc-of-the-society-fn17-3-fn13-5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitheedfulreadiness-heedful-readiness-fn3-6" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traithellknightinquisitor-hellknight-inquisitor-fn20-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traithereticscaution-heretics-caution-fn4-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traithiddenfaith-hidden-faith-fn14-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traithistoryofheresy-history-of-heresy-fn6-12-fn8-6-fn7-6" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traithonest-honest-fn5-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitimperfectrecall-imperfect-recall-fn4-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitindomitablefaith-indomitable-faith-fn6-13-fn7-7-fn8-7" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitinhabitantofillusion-inhabitant-of-illusion-fn21" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitinspired-inspired-fn6-14" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitirrepressible-irrepressible-fn5-5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitirreverent-irreverent-fn22" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitjinxeater-jinx-eater-fn23" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitkalistocraticprophecy-kalistocratic-prophecy-fn14-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitlightinthedarkness-light-in-the-darkness-fn12-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitloyaltyacrosslifetimes-loyalty-across-lifetimes-fn6-15" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitluciddreamer-lucid-dreamer-fn13-6" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitmartialmanuscript-martial-manuscript-fn6-16" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitmasked-masked-fn3-7" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitmeditativerest-meditative-rest-fn3-8" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitmysteryinitiate-mystery-initiate-fn5-6" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitnaturalritualist-natural-ritualist-fn4-5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitnaturallygifted-naturally-gifted-fn19-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitnecroticaura-necrotic-aura-fn13-7" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitoathbound-oathbound-fn6-17" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitomen-omen-fn6-18" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitpactservant-pact-servant-fn16-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitpatientcalm-patient-calm-fn5-7" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitperpetualcompanion-perpetual-companion-fn6-19" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitpersuasiveinsight-persuasive-insight-fn14-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitplanarsavant-planar-savant-fn6-20" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitpriestblessed-priest-blessed-fn1-9" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitprincipled-principled-fn6-21" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitprophesied-prophesied-fn6-22" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitproxyofmany-proxy-of-many-fn1-10" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitrebukethecurse-rebuke-the-curse-fn24" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitredeemer-redeemer-fn9-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitreincarnated-reincarnated-fn6-23" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitreligiousreformer-religious-reformer-fn1-11" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitriveracumen-river-acumen-fn25" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitsacredconduit-sacred-conduit-fn6-24-fn8-8-fn7-8" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitsacredtouch-sacred-touch-fn6-25-fn7-9-fn8-9" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitscholarofthegreatbeyond-scholar-of-the-great-beyond-fn6-26-fn8-10-fn7-10" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitschooledinquisitor-schooled-inquisitor-fn6-27" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitscourgeofthedarkness-scourge-of-the-darkness-fn12-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitsecondtongue-second-tongue-fn13-8" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitsecretkeeper-secret-keeper-fn3-9" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitselfactualization-self-actualization-fn1-12" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitselfsustaining-self-sustaining-fn4-6" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitsoulsearchersstrength-soul-searchers-strength-fn26" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitspellintuition-spell-intuition-fn5-8" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitspiritsense-spirit-sense-fn6-28" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitstclydwellsward-st-clydwells-ward-fn13-9" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitstalwartofthesociety-stalwart-of-the-society-fn17-4-fn13-10" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitstrengthofsubmission-strength-of-submission-fn3-10" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitstrengthoftheland-strength-of-the-land-fn15-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitstudentofhistory-student-of-history-fn3-11" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traittarbaphonswhisper-tar-baphons-whisper-fn13-11" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traittirelessavenger-tireless-avenger-fn6-29" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traittotemist-totemist-fn1-13" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traittraditionalist-traditionalist-fn3-12-fn1-14" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traittrickstergnome-trickster-gnome-fn19-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traittwoworldmagic-two-world-magic-fn27" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitundaunted-undaunted-fn3-13" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitunnaturalpresence-unnatural-presence-fn13-12" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitunshackled-unshackled-fn3-14" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traituntrainedscholar-untrained-scholar-fn3-15" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traiturbanacolyte-urban-acolyte-fn28" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitviledomain-vile-domain-fn29" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitwanderersshroud-wanderers-shroud-fn6-30" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitwendifaapprentice-wendifa-apprentice-fn1-15" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitzealot-zealot-fn19-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitzealotsbearing-zealots-bearing-fn1-16" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitzealousstriker-zealous-striker-fn6-31" extraClasses="trait" icon={["Faith"]}>
...
const _traits_faith_def = {title: "Defense Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitabjectbelief-abject-belief-fn1" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitauthoritarian-authoritarian-fn2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitbirthmark-birthmark-fn3-fn4-fn5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitblessed-blessed-fn3-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitcanonofcoin-canon-of-coin-fn6" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdarkestbeforedawn-darkest-before-dawn-fn7" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdefymadness-defy-madness-fn8" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdisdainfuldefender-disdainful-defender-fn3-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdogged-dogged-fn9" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitfatesfavored-fates-favored-fn3-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitfocuseddisciple-focused-disciple-fn3-5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traithiddenfaith-hidden-faith-fn10" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traithistoryofheresy-history-of-heresy-fn3-6-fn5-2-fn4-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitindomitablefaith-indomitable-faith-fn3-7-fn4-3-fn5-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitinhabitantofillusion-inhabitant-of-illusion-fn11" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitirrepressible-irrepressible-fn2-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitirreverent-irreverent-fn12" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitjinxeater-jinx-eater-fn13" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitluciddreamer-lucid-dreamer-fn8-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitnecroticaura-necrotic-aura-fn8-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitoathbound-oathbound-fn3-8" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitprincipled-principled-fn3-9" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitreincarnated-reincarnated-fn3-10" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitscourgeofthedarkness-scourge-of-the-darkness-fn14" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitsoulsearchersstrength-soul-searchers-strength-fn15" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitundaunted-undaunted-fn7-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitwanderersshroud-wanderers-shroud-fn3-11" extraClasses="trait" icon={["Faith"]}>
...
const _traits_faith_combat = {title: "Combat-Related Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitcalled-called-fn1" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitcrusader-crusader-fn2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdogged-dogged-fn3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitfatesfavored-fates-favored-fn4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitheedfulreadiness-heedful-readiness-fn2-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitpersuasiveinsight-persuasive-insight-fn5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitstrengthofsubmission-strength-of-submission-fn2-3" extraClasses="trait" icon={["Faith"]}>
...
const _traits_faith_spell = {title: "Spell Ability Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitapprentice-apprentice-fn1" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitchosenofiomedae-chosen-of-iomedae-fn2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitfirstmemories-first-memories-fn3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitnaturallygifted-naturally-gifted-fn3-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitrebukethecurse-rebuke-the-curse-fn4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitsacredtouch-sacred-touch-fn5-fn6-fn7" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitselfsustaining-self-sustaining-fn8" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitstclydwellsward-st-clydwells-ward-fn9" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traittarbaphonswhisper-tar-baphons-whisper-fn9-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traittotemist-totemist-fn10" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitwendifaapprentice-wendifa-apprentice-fn10-2" extraClasses="trait" icon={["Faith"]}>
...
const _traits_faith_magic = {title: "Magic-Related Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traiteyeforthewondrous-eye-for-the-wondrous-fn1" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traithavocofthesociety-havoc-of-the-society-fn2-fn3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitsecondtongue-second-tongue-fn3-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitstrengthoftheland-strength-of-the-land-fn4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traittrickstergnome-trickster-gnome-fn5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitviledomain-vile-domain-fn6" extraClasses="trait" icon={["Faith"]}>
...
const _traits_faith_class = {title: "Class-Specific Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitacolyteofapocrypha-acolyte-of-apocrypha-fn1" extraClasses="trait hasSubs" icon={["Faith"]}>
...
<Ability id="traitaspectofthequah-aspect-of-the-quah-fn2" extraClasses="trait hasSubs" icon={["Faith"]}>
...
<Ability id="traitbeaconoffaith-beacon-of-faith-fn3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitblessedtouch-blessed-touch-fn4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdeepfaith-deep-faith-fn5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitearthbound-earthbound-fn6" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitempyrealpantheon-empyreal-pantheon-fn7" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitexaltedofthesociety-exalted-of-the-society-fn8-fn9" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitfaithfulfeedback-faithful-feedback-fn9-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitfearlessdefiance-fearless-defiance-fn3-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitgreateradeptofthesociety-greater-adept-of-the-society-fn8-2-fn9-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traithellknightinquisitor-hellknight-inquisitor-fn10" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitlightinthedarkness-light-in-the-darkness-fn5-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitloyaltyacrosslifetimes-loyalty-across-lifetimes-fn3-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitmartialmanuscript-martial-manuscript-fn3-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitmeditativerest-meditative-rest-fn1-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitpactservant-pact-servant-fn7-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitperpetualcompanion-perpetual-companion-fn3-5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitsacredconduit-sacred-conduit-fn3-6-fn11-fn12" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitstalwartofthesociety-stalwart-of-the-society-fn8-3-fn9-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traittirelessavenger-tireless-avenger-fn3-7" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traittwoworldmagic-two-world-magic-fn13" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitzealousstriker-zealous-striker-fn3-8" extraClasses="trait" icon={["Faith"]}>
...
const _traits_faith_ab = {title: "Skill/Feat/Ability Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_faith" className="reversed" info="Back to Faith Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitacclimatizealignment-acclimatize-alignment-fn1" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitcanonofcoin-canon-of-coin-fn3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitcaretaker-caretaker-fn4-fn5-fn6" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitchildofthetemple-child-of-the-temple-fn4-2-fn6-2-fn5-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitchosenofiomedae-chosen-of-iomedae-fn7" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitcovertchanneler-covert-channeler-fn8" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdevotedhealer-devoted-healer-fn9" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdevoteeofthegreen-devotee-of-the-green-fn4-3-fn5-3-fn6-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdivineconfidante-divine-confidante-fn10" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitdogged-dogged-fn11" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traiteaseoffaith-ease-of-faith-fn4-4-fn6-4-fn5-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traiteldritchsmith-eldritch-smith-fn12" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitfatesfavored-fates-favored-fn4-5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitgodclawdisciple-godclaw-disciple-fn13" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traithereticscaution-heretics-caution-fn11-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traithonest-honest-fn9-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitimperfectrecall-imperfect-recall-fn11-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitinspired-inspired-fn4-6" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitkalistocraticprophecy-kalistocratic-prophecy-fn10-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitluciddreamer-lucid-dreamer-fn14" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitmasked-masked-fn2-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitmysteryinitiate-mystery-initiate-fn9-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitnaturalritualist-natural-ritualist-fn11-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitnaturallygifted-naturally-gifted-fn15" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitomen-omen-fn4-7" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitpatientcalm-patient-calm-fn9-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitpersuasiveinsight-persuasive-insight-fn10-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitplanarsavant-planar-savant-fn4-8" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitpriestblessed-priest-blessed-fn16" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitprophesied-prophesied-fn4-9" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitproxyofmany-proxy-of-many-fn16-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitredeemer-redeemer-fn7-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitreligiousreformer-religious-reformer-fn16-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitriveracumen-river-acumen-fn17" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitscholarofthegreatbeyond-scholar-of-the-great-beyond-fn4-10-fn5-5-fn6-5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitschooledinquisitor-schooled-inquisitor-fn4-11" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitscourgeofthedarkness-scourge-of-the-darkness-fn18" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitsecretkeeper-secret-keeper-fn2-3" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitselfactualization-self-actualization-fn16-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitspellintuition-spell-intuition-fn9-5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitspiritsense-spirit-sense-fn4-12" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitstudentofhistory-student-of-history-fn2-4" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traittraditionalist-traditionalist-fn2-5-fn16-5" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitunnaturalpresence-unnatural-presence-fn14-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitunshackled-unshackled-fn2-6" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traituntrainedscholar-untrained-scholar-fn2-7" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitzealot-zealot-fn15-2" extraClasses="trait" icon={["Faith"]}>
...
<Ability id="traitzealotsbearing-zealots-bearing-fn16-6" extraClasses="trait" icon={["Faith"]}>
...
const _traits_social_sm = {title: "Sense Motive Social Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_social" className="reversed" info="Back to Social Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitbastarduc-bastard-uc-fn1" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitcallous-callous-fn2" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitcanter-canter-fn1-2-fn3-fn4" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitdetectdisobedience-detect-disobedience-fn5" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traithardlyafool-hardly-a-fool-fn6" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitheartoftwoworlds-heart-of-two-worlds-fn7" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitinfluence-influence-fn1-3" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitlawenforcer-law-enforcer-fn8" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitmalevolenttemptations-malevolent-temptations-fn9" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitmercenary-mercenary-fn1-4" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitmerchant-merchant-fn1-5" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitpreternaturalawareness-preternatural-awareness-fn9-2" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitsuspicious-suspicious-fn1-6-fn4-2-fn3-2" extraClasses="trait" icon={["Social"]}>
...
const _traits_social_sur_per = {title: "Survival and Perception Social Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_social" className="reversed" info="Back to Social Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitbeastkin-beastkin-fn1" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitexplorer-explorer-fn2" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitorphaned-orphaned-fn3" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitpovertystricken-poverty-stricken-fn3-2-fn4-fn5" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitpreternaturalawareness-preternatural-awareness-fn6" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitruggeddragonhunter-rugged-dragon-hunter-fn7" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitsavage-savage-fn3-3" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitseeker-seeker-fn3-4" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traittriaxustrained-triaxus-trained-fn7-2" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitvigilantspycatcher-vigilant-spycatcher-fn8" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitwastelandvargrant-wasteland-vargrant-fn9" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitweatheredemissary-weathered-emissary-fn3-5" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitwiscraniear-wiscrani-ear-fn8-2" extraClasses="trait" icon={["Social"]}>
...
const _traits_social_phys = {title: "Physical Skill Social Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_social" className="reversed" info="Back to Social Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitacrobat-acrobat-fn1" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitbeastbond-beast-bond-fn1-2" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitchildofthestreets-child-of-the-streets-fn1-3-fn2-fn3" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitcollector-collector-fn4" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitcriminal-criminal-fn1-4" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitdeepcover-deep-cover-fn5" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitgiftedsmuggler-gifted-smuggler-fn7" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitordinary-ordinary-fn1-5" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitslaverunner-slave-runner-fn5-2" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitunwelcomebusiness-unwelcome-business-fn8" extraClasses="trait" icon={["Social"]}>
...
const _traits_social_mental = {title: "Mental Skill Social Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_social" className="reversed" info="Back to Social Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitcollector-collector-fn1" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitetymologist-etymologist-fn1-2" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitexcellentpenmanship-excellent-penmanship-fn2" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitforthemoney-for-the-money-fn3" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitgestureexpertise-gesture-expertise-fn4" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitmerchant-merchant-fn5" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traittirelesslogic-tireless-logic-fn5-2" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitunintentionallinguist-unintentional-linguist-fn5-3" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitweatheredemissary-weathered-emissary-fn5-4" extraClasses="trait" icon={["Social"]}>
...
const _traits_social_cha = {title: "Charisma Skill Social Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_social" className="reversed" info="Back to Social Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitalliesinthedeep-allies-in-the-deep-fn1" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitbindersblood-binders-blood-fn2" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitcleverwordplay-clever-wordplay-fn3" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitfoundersheritage-founders-heritage-fn4" extraClasses="trait" icon={["Social"]}>
...
<Ability id="traitpacksavvy-pack-savvy-fn5" extraClasses="trait" icon={["Social"]}>
...
<Pair title="Type">Social</Pair>
<Pair single="flavor" id="traitpacksavvy-pack-savvy-fn5-flavor">You have learned how to gain the respect of gnolls in your region, and you know something of their social structure.</Pair>
<Pair single="benefit" id="traitpacksavvy-pack-savvy-fn5-benefit">You gain a +3 trait bonus on Charisma-based skill checks when dealing with <Link to="/monster/gnoll">gnolls</Link>.</Pair>
</Ability>
...
export default {traits_faith:_traits_faith,traits_faith_all:_traits_faith_all,traits_faith_def:_traits_faith_def,traits_faith_combat:_traits_faith_combat,traits_faith_spell:_traits_faith_spell,traits_faith_magic:_traits_faith_magic,traits_faith_class:_traits_faith_class,traits_faith_ab:_traits_faith_ab,traits_social_sm:_traits_social_sm,traits_social_sur_per:_traits_social_sur_per,traits_social_phys:_traits_social_phys,traits_social_mental:_traits_social_mental,traits_social_cha:_traits_social_cha}