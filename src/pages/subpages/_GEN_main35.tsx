...
const _traits_faith = {title: "Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits" className="reversed" info="Back to Traits" /><IonItemDivider className="mainItem divider"></IonItemDivider><MainLink to="/main/traits_faith_all" endem="(142 traits)" info="All Faith Traits" /><MainLink to="/main/traits_faith_def" className="indented" bottom="Affects armor bonuses or saving throws; 33 traits" info="Defense Traits" /><MainLink to="/main/traits_faith_combat" className="indented" bottom="Affects attack rolls, damage, initiative, etc; 64 traits" info="Other Combat-Related Traits" /><MainLink to="/main/traits_faith_spell" className="indented" bottom="Grants a spell, spell-like-ability, or an ability that duplicates a spell; 8 traits" info="Spell Ability Traits" /><MainLink to="/main/traits_faith_magic" className="indented" bottom="Affects caster level or spellcasting ability; 8 traits" info="Magic-Related Traits" /><MainLink to="/main/traits_faith_class" className="indented" bottom="Requires a class ability to function; 18 traits" info="Class-Specific Traits" /><MainLink to="/main/traits_faith_ab" className="indented" bottom="Affects a skill, feat, or ability; 31 traits" info="Skill/Feat/Ability Traits" /></IonList>};
...
<section data-footnotes><h3 id="main-traits_faith_all-label">Footnotes</h3><ol>
...
const _traits_faith_def = {title: "Defense Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits" className="reversed" info="Back to Traits" /><Ability id="traitabjectbelief-abject-belief-fn1" extraClasses="trait" icon={["bolt-eye"]}>
...
<Ability id="traitfocuseddisciple-focused-disciple-fn3-4" extraClasses="trait" icon={["bolt-eye"]}>
<Pair single id="traitfocuseddisciple-focused-disciple-fn3-4"><Link to="/trait/focused_disciple">⮞</Link> Focused Disciple <sup><InnerLink showBacklink="backlink-main-traits_faith_def-fake-fn-3.4" id="main-traits_faith_def-fake-fn-3.4" data-hash-target to="main-traits_faith_def-fake-fn-3-target">3</InnerLink></sup></Pair>
<Pair title="Type">Faith</Pair>
<Pair single="flavor" id="traitfocuseddisciple-focused-disciple-fn3-4-flavor">When weaker wills falter, you keep a clear mind.</Pair>
<Pair single="benefit" id="traitfocuseddisciple-focused-disciple-fn3-4-benefit">You gain a +2 trait bonus on saving throws against charm and compulsion effects.</Pair>
</Ability>
...
<Ability id="traithistoryofheresy-history-of-heresy-fn3-5-fn5-2-fn4-2" extraClasses="trait" icon={["bolt-eye"]}>
<Pair single id="traithistoryofheresy-history-of-heresy-fn3-5-fn5-2-fn4-2"><Link to="/trait/history_of_heresy">⮞</Link> History of Heresy <sup><InnerLink showBacklink="backlink-main-traits_faith_def-fake-fn-3.5" id="main-traits_faith_def-fake-fn-3.5" data-hash-target to="main-traits_faith_def-fake-fn-3-target">3</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_faith_def-fake-fn-5.2" id="main-traits_faith_def-fake-fn-5.2" data-hash-target to="main-traits_faith_def-fake-fn-5-target">5</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_faith_def-fake-fn-4.2" id="main-traits_faith_def-fake-fn-4.2" data-hash-target to="main-traits_faith_def-fake-fn-4-target">4</InnerLink></sup></Pair>
<Pair title="Type">Faith</Pair>
<Pair single="flavor" id="traithistoryofheresy-history-of-heresy-fn3-5-fn5-2-fn4-2-flavor">You were raised with heretical views that have made it difficult for you to accept most religious beliefs and often caused you or those you love to be treated as pariahs. As a result, you have turned your back on religious teachings.</Pair>
<Pair single="benefit" id="traithistoryofheresy-history-of-heresy-fn3-5-fn5-2-fn4-2-benefit">As long as you do not possess any levels in a class that grants divine spellcasting power, you gain a +1 trait bonus on all saving throws against divine spells.</Pair>
</Ability>
<Ability id="traitindomitablefaith-indomitable-faith-fn3-6-fn4-3-fn5-3" extraClasses="trait" icon={["bolt-eye"]}>
<Pair single id="traitindomitablefaith-indomitable-faith-fn3-6-fn4-3-fn5-3"><Link to="/trait/indomitable_faith">⮞</Link> Indomitable Faith <sup><InnerLink showBacklink="backlink-main-traits_faith_def-fake-fn-3.6" id="main-traits_faith_def-fake-fn-3.6" data-hash-target to="main-traits_faith_def-fake-fn-3-target">3</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_faith_def-fake-fn-4.3" id="main-traits_faith_def-fake-fn-4.3" data-hash-target to="main-traits_faith_def-fake-fn-4-target">4</InnerLink></sup> <sup><InnerLink showBacklink="backlink-main-traits_faith_def-fake-fn-5.3" id="main-traits_faith_def-fake-fn-5.3" data-hash-target to="main-traits_faith_def-fake-fn-5-target">5</InnerLink></sup></Pair>
<Pair title="Type">Faith</Pair>
<Pair single="flavor" id="traitindomitablefaith-indomitable-faith-fn3-6-fn4-3-fn5-3-flavor">You were born in a region where your faith was not popular, but you still have never abandoned it. Your constant struggle to maintain your own faith has bolstered your drive.</Pair>
<Pair single="benefit" id="traitindomitablefaith-indomitable-faith-fn3-6-fn4-3-fn5-3-benefit">You gain a +1 trait bonus on Will saves.</Pair>
</Ability>
...
<Ability id="traitoathbound-oathbound-fn3-7" extraClasses="trait" icon={["bolt-eye"]}>
<Pair single id="traitoathbound-oathbound-fn3-7"><Link to="/trait/oathbound">⮞</Link> Oathbound <sup><InnerLink showBacklink="backlink-main-traits_faith_def-fake-fn-3.7" id="main-traits_faith_def-fake-fn-3.7" data-hash-target to="main-traits_faith_def-fake-fn-3-target">3</InnerLink></sup></Pair>
<Pair title="Type">Faith</Pair>
<Pair single="flavor" id="traitoathbound-oathbound-fn3-7-flavor">You have made a solemn oath, and you pursue that oath with headstrong determination.</Pair>
<Pair single="benefit" id="traitoathbound-oathbound-fn3-7-benefit">Once per day, you may reroll a saving throw against a charm or compulsion effect. You must take the second result even if it is worse.</Pair>
</Ability>
<Ability id="traitprincipled-principled-fn3-8" extraClasses="trait" icon={["bolt-eye"]}>
<Pair single id="traitprincipled-principled-fn3-8"><Link to="/trait/principled">⮞</Link> Principled <sup><InnerLink showBacklink="backlink-main-traits_faith_def-fake-fn-3.8" id="main-traits_faith_def-fake-fn-3.8" data-hash-target to="main-traits_faith_def-fake-fn-3-target">3</InnerLink></sup></Pair>
<Pair title="Type">Faith</Pair>
<Pair single="flavor" id="traitprincipled-principled-fn3-8-flavor">You hold yourself to a strict code of behavior that guides all of your decisions and actions.</Pair>
<Pair single="benefit" id="traitprincipled-principled-fn3-8-benefit">You take a -2 penalty on <Link to="/skill/bluff">Bluff</Link> checks and gain a +2 trait bonus on saving throws against charm, compulsion, and emotion effects.</Pair>
</Ability>
<Ability id="traitreincarnated-reincarnated-fn3-9" extraClasses="trait" icon={["bolt-eye"]}>
<Pair single id="traitreincarnated-reincarnated-fn3-9"><Link to="/trait/reincarnated">⮞</Link> Reincarnated <sup><InnerLink showBacklink="backlink-main-traits_faith_def-fake-fn-3.9" id="main-traits_faith_def-fake-fn-3.9" data-hash-target to="main-traits_faith_def-fake-fn-3-target">3</InnerLink></sup></Pair>
<Pair title="Type">Faith</Pair>
<Pair single="flavor" id="traitreincarnated-reincarnated-fn3-9-flavor">You lived a previous life as someone - or something - else. For you, life and death are a cycle, and you have no fear of death.</Pair>
<Pair single="benefit" id="traitreincarnated-reincarnated-fn3-9-benefit">You gain a +2 trait bonus on saving throws against fear and death effects.</Pair>
</Ability>
...
<Ability id="traitwanderersshroud-wanderers-shroud-fn3-10" extraClasses="trait" icon={["bolt-eye"]}>
<Pair single id="traitwanderersshroud-wanderers-shroud-fn3-10"><Link to="/trait/wanderers_shroud">⮞</Link> Wanderer's Shroud <sup><InnerLink showBacklink="backlink-main-traits_faith_def-fake-fn-3.10" id="main-traits_faith_def-fake-fn-3.10" data-hash-target to="main-traits_faith_def-fake-fn-3-target">3</InnerLink></sup></Pair>
<Pair title="Type">Faith</Pair>
<Pair single="flavor" id="traitwanderersshroud-wanderers-shroud-fn3-10-flavor">Your wanderings often go unnoticed.</Pair>
<Pair single="benefit" id="traitwanderersshroud-wanderers-shroud-fn3-10-benefit">Efforts to use the <Link to="/skill/diplomacy">Diplomacy</Link> skill to gather information about you take a -1 penalty, and you gain a +1 trait bonus on all saving throws against scrying and mindreading effects that allow saving throws.</Pair>
</Ability>
<section data-footnotes><h3 id="main-traits_faith_def-label">Footnotes</h3><ol>
...
<li id="main-traits_faith_def-fake-fn-7-target"><p><Link to="/source/divine_anthology">Divine Anthology</Link> <InnerLink aria-label="Back to reference 7" id="backlink-main-traits_faith_def-fake-fn-7" data-hash-target to="main-traits_faith_def-fake-fn-7">↩</InnerLink></p></li>
...
const _traits_faith_combat = {title: "Combat-Related Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits" className="reversed" info="Back to Traits" /><Ability id="traitcalled-called-fn1" extraClasses="trait" icon={["bolt-eye"]}>
...
<section data-footnotes><h3 id="main-traits_faith_combat-label">Footnotes</h3><ol>
...
<section data-footnotes><h3 id="main-traits_faith_spell-label">Footnotes</h3><ol>
...
<li id="main-traits_faith_spell-fake-fn-3-target"><p><Link to="/source/gnomes_of_golarion">Gnomes of Golarion</Link> <InnerLink aria-label="Back to reference 3" id="backlink-main-traits_faith_spell-fake-fn-3" data-hash-target to="main-traits_faith_spell-fake-fn-3">↩</InnerLink></p></li>
...
const _traits_faith_magic = {title: "Magic-Related Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits" className="reversed" info="Back to Traits" /><Ability id="traiteyeforthewondrous-eye-for-the-wondrous-fn1" extraClasses="trait" icon={["bolt-eye"]}>
...
<section data-footnotes><h3 id="main-traits_faith_magic-label">Footnotes</h3><ol>
...
const _traits_faith_class = {title: "Class-Specific Traits", jsx: <IonList lines="full"><MainLink to="/main/traits" className="reversed" info="Back to Traits" /><Ability id="traitacolyteofapocrypha-acolyte-of-apocrypha-fn1" extraClasses="trait hasSubs" icon={["bolt-eye"]}>
...
<section data-footnotes><h3 id="main-traits_faith_class-label">Footnotes</h3><ol>
...
const _traits_faith_ab = {title: "Skill/Feat/Ability Faith Traits", jsx: <IonList lines="full"><MainLink to="/main/traits" className="reversed" info="Back to Traits" /><Ability id="traitacclimatizealignment-acclimatize-alignment-fn1" extraClasses="trait" icon={["bolt-eye"]}>
...
<Ability id="traitundaunted-undaunted-fn2-6" extraClasses="trait" icon={["bolt-eye"]}>
<Pair single id="traitundaunted-undaunted-fn2-6"><Link to="/trait/undaunted">⮞</Link> Undaunted <sup><InnerLink showBacklink="backlink-main-traits_faith_ab-fake-fn-2.6" id="main-traits_faith_ab-fake-fn-2.6" data-hash-target to="main-traits_faith_ab-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Faith</Pair>
<Pair single="flavor" id="traitundaunted-undaunted-fn2-6-flavor">Following the path of freedom has resulted in you being threatened by ruffians and bullies throughout your childhood, and it now takes a lot to rattle you.</Pair>
<Pair single="benefit" id="traitundaunted-undaunted-fn2-6-benefit">You increase the DC to demoralize you with an <Link to="/skill/intimidate">Intimidate</Link> check by 2.</Pair>
</Ability>
...
<Ability id="traitunshackled-unshackled-fn2-7" extraClasses="trait" icon={["bolt-eye"]}>
<Pair single id="traitunshackled-unshackled-fn2-7"><Link to="/trait/unshackled">⮞</Link> Unshackled <sup><InnerLink showBacklink="backlink-main-traits_faith_ab-fake-fn-2.7" id="main-traits_faith_ab-fake-fn-2.7" data-hash-target to="main-traits_faith_ab-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Faith</Pair>
<Pair single="flavor" id="traitunshackled-unshackled-fn2-7-flavor">You have escaped slavery or other imprisonment and have vowed never to be shackled again.</Pair>
<Pair single="benefit" id="traitunshackled-unshackled-fn2-7-benefit">You gain a +1 trait bonus on <Link to="/skill/escape_artist">Escape Artist</Link> checks, and Escape Artist is a class skill for you.</Pair>
</Ability>
<Ability id="traituntrainedscholar-untrained-scholar-fn2-8" extraClasses="trait" icon={["bolt-eye"]}>
<Pair single id="traituntrainedscholar-untrained-scholar-fn2-8"><Link to="/trait/untrained_scholar">⮞</Link> Untrained Scholar <sup><InnerLink showBacklink="backlink-main-traits_faith_ab-fake-fn-2.8" id="main-traits_faith_ab-fake-fn-2.8" data-hash-target to="main-traits_faith_ab-fake-fn-2-target">2</InnerLink></sup></Pair>
<Pair title="Type">Faith</Pair>
<Pair single="flavor" id="traituntrainedscholar-untrained-scholar-fn2-8-flavor">While scholarship is not your primary focus, you have spent enough time in classrooms and libraries to learn a few things.</Pair>
<Pair single="benefit" id="traituntrainedscholar-untrained-scholar-fn2-8-benefit">Once per day, you can attempt a <Link to="/skill/knowledge_geography">Knowledge (geography)</Link>, <Link to="/skill/knowledge_history">Knowledge (history)</Link> or <Link to="/skill/knowledge_local">Knowledge (local)</Link> check untrained with a +2 trait bonus.</Pair>
</Ability>
...
<section data-footnotes><h3 id="main-traits_faith_ab-label">Footnotes</h3><ol>
