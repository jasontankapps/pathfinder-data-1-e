...
const _traits_social_sur_per = {title: "Survival and Perception Social Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_social" className="reversed" info="Back to Social Traits" /><Ability id="traitbeastkin-beastkin-fn1" extraClasses="trait" icon={["village"]}>
