...
<TrapInfo id="rigged-construct-trap-trap" cr="Variable" pdc="20" dddc="20" trigger="location (all spaces occupied by the construct's remains)" eff="blast of electricity (1d6 electricity damage/2 HD of construct); Reflex negates (DC = 10 + 1/2 the ranger's level + his Intelligence modifier); multiple targets (all targets within 5 ft. of construct's remains)">Rigged Construct Trap</TrapInfo>
<p>Other types of destroyed constructs can serve as suitable materials for a rigged construct trap (at the GM's discretion). Constructs destroyed by <Link to="/spell/disintegrate">disintegrate</Link> or similar effects that leave no intact remains cannot be used to create a rigged construct trap.</p>
</Pair>
</Ability>
