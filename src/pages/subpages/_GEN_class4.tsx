...
<p>If a rage power requires another rage power (such as <Link to="/ragepower/disruptive">disruptive</Link>, which requires <Link to="/ragepower/superstition">superstition</Link>), you cannot grant that rage power to allies unless you can also grant that power's prerequisite. You may add multiple rage powers to an <em>inspired rage</em> at the same time using this ability (such as granting superstition and disruptive simultaneously).</p>
<p>If a rage power can only be used a certain number of times per day or per <em>rage</em> (such as <Link to="/ragepower/renewed_vigor">renewed vigor</Link>), each ally affected by the <em>inspired rage</em> song is subject to that limit (with once per <em>rage</em> abilities limited to once per inspired <em>rage</em>).</p>
<p>If you have rage powers from another source, you (but not your allies) can use those rage powers during an <em>inspired rage.</em> You cannot select a duplicate rage power, unless that rage power can be taken multiple times.</p>
<p>If you have the ability to <em>rage</em> from another source, you can use your skald rage powers during that <em>rage</em> as well.</p>
</Pair>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-skald--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<div className="archetype"><p><Link to="/arc-skald/red_tongue">Red Tongue</Link></p><p><strong>Modifies or Replaces:</strong> Bardic Knowledge; 7th, 12th, 17th-level Versatile Performance</p><p>(Tengu) The tengu tendency toward dramatic flourishes and rhetoric creates an environment in which political clubs led by hot-blooded firebrands - referred to as red tongues in polite company - dominate the political scene by swaying emotions in the moment and wielding magic in the shadows.</p></div>
...
<div className="archetype"><p><Link to="/arc-skald/war_painter">War Painter</Link></p><p><strong>Modifies or Replaces:</strong> Raging Song; Spell Kenning; Lore Master</p><p>(Grippli) The gripplis of the Valashmai Jungle exhibit savage strength for their size - attributed in part to the frightful magical pigments applied to their skin by the tribes' mystical lore keepers.</p></div>
...
<DisplayTable table={{"id":"skald archetypes","columns":[{"header":"Archetype","link":"arc-skald"},{"header":"Alignment"},{"header":"Armor Proficiency"},{"header":"Bardic Knowledge"},{"header":"Class Skills"},{"header":"Damage Reduction"},{"header":"Deity"},{"header":"Dirge of Doom"},{"header":"Inspired Rage"},{"header":"Lore Master"},{"header":"Master Skald"},{"header":"Rage Powers"},{"header":"3rd-level Rage Power"},{"header":"6th-level Rage Power"},{"header":"9th-level Rage Power"},{"header":"12th-level Rage Power"},{"header":"18th-level Rage Power"},{"header":"Raging Song"},{"header":"Scribe Scroll"},{"header":"Song of Marching"},{"header":"Song of Strength"},{"header":"Song of the Fallen"},{"header":"Spell Kenning"},{"header":"Uncanny Dodge"},{"header":"Improved Uncanny Dodge"},{"header":"Versatile Performance"},{"header":"7th-level Versatile Performance"},{"header":"12th-level Versatile Performance"},{"header":"17th-level Versatile Performance"},{"header":"Weapon Proficiency"},{"header":"Well-Versed"}],"data":[[["Augur","augur"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X"],[["Bacchanal","bacchanal"],null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,"X",null,null,null,null,null],[["Battle Scion","battle_scion"],null,null,"X",null,null,null,"X",null,null,"X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null],[["Bekyar Demon Dancer","bekyar_demon_dancer"],null,null,null,"X",null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null],[["Belkzen War Drummer","belkzen_war_drummer"],null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,"X",null,null,"X",null],[["Boaster","boaster"],null,null,null,null,null,null,null,null,"X",null,"X",null,"X",null,null,null,null,"X","X",null,"X",null,"X",null,null,null,null,null,null,null],[["Bold Schemer","bold_schemer"],null,null,"X","X","X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null],[["Court Poet","court_poet"],null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,"X"],[["Dragon Skald","dragon_skald"],null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,null,"X"],[["Elegist","elegist"],null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X"],[["Fated Champion","fated_champion"],null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,"X"],[["Herald of the Horn","herald_of_the_horn"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,null,null,null],[["Hunt Caller","hunt_caller"],null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,"X","X","X",null,null,null,null,null,null,null,"X"],[["Instigator","instigator"],null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Red Tongue","red_tongue"],null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null,null],[["Serpent Herald","serpent_herald"],null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Spell Warrior","spell_warrior"],null,null,null,null,null,null,"X","X",null,"X",null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,null,null,null],[["Sunsinger","sunsinger"],"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,null,null,null],[["Totem Channeler","totem_channeler"],null,null,"X",null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Totemic Skald","totemic_skald"],null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null],[["Twilight Speaker","twilight_speaker"],"X",null,"X",null,null,"X","X","X","X","X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,"X"],[["Undying Word","undying_word"],null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null,null,"X",null,"X",null,"X",null,null,null,null,null,null,null,null],[["Urban Skald","urban_skald"],null,"X",null,null,"X",null,"X","X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,"X",null],[["War Painter","war_painter"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Warlord","warlord"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,"X",null,null,null,null,null,"X"],[["Wyrm Singer","wyrm_singer"],null,null,null,null,null,null,null,"X",null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null]],"initialColumn":0,"nullValue":"&nbsp;"}} />
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-slayer--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-slayer/ankous_shadow">Ankou's Shadow</Link></p><p><strong>Modifies or Replaces:</strong> Studied Target; Stalker; Quarry; Improved Quarry</p><p>Ankou's shadow practice the deadliest skills of the First World's most feared enforcers: terrifying, winged fey assassins dispatched by the greatest lords of the First World to eliminate their rivals</p></div>
...
<DisplayTable table={{"id":"slayer archetypes","columns":[{"header":"Archetype","link":"arc-slayer"},{"header":"Alignment"},{"header":"Armor Proficiency"},{"header":"Class Skills"},{"header":"Master Slayer"},{"header":"Quarry"},{"header":"Improved Quarry"},{"header":"Slayer Talents"},{"header":"2nd-level Slayer Talent"},{"header":"4th-level Slayer Talent"},{"header":"6th-level Slayer Talent"},{"header":"8th-level Slayer Talent"},{"header":"10th-level Slayer Talent"},{"header":"12th-level Slayer Talent"},{"header":"16th-level Slayer Talent"},{"header":"Slayer's Advance"},{"header":"Sneak Attack"},{"header":"Stalker"},{"header":"Studied Target"},{"header":"Swift Tracker"},{"header":"Track"},{"header":"Weapon Proficiency"}],"data":[[["Ankou's Shadow","ankous_shadow"],null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null],[["Avalancher","avalancher"],null,null,null,"X","X","X",null,null,null,null,null,null,null,null,null,null,"X","X","X","X",null],[["Bloody Jake","bloody_jake"],"X","X",null,null,null,null,null,null,"X","X","X",null,"X","X","X",null,null,"X","X",null,"X"],[["Bounty Hunter","bounty_hunter"],null,"X",null,null,null,null,null,"X",null,"X",null,"X",null,null,null,null,null,null,null,null,"X"],[["Butterfly Blade","butterfly_blade"],null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,"X","X","X","X","X",null],[["Cleaner","cleaner"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,"X",null,null,"X",null],[["Covenbane","covenbane"],null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,"X",null,"X","X",null],[["Cutthroat","cutthroat"],null,null,"X",null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null,"X",null],[["Deliverer","deliverer"],null,"X",null,null,null,null,null,"X",null,"X",null,"X",null,null,null,null,null,null,null,null,"X"],[["Dune Rider","dune_rider"],null,null,null,"X",null,null,null,null,"X",null,"X",null,null,null,null,null,"X","X","X","X",null],[["Family Hunter","family_hunter"],null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,"X",null,"X",null,null,null],[["Grave Warden","grave_warden"],null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,"X",null,null,null,null],[["Guerrilla","guerrilla"],null,null,null,null,"X","X",null,null,null,"X",null,null,null,null,null,null,null,null,"X","X",null],[["Pureblade","pureblade"],null,null,null,"X",null,null,null,"X",null,null,"X",null,null,null,null,null,"X",null,null,"X",null],[["Sczarni Executioner","sczarni_executioner"],null,null,"X",null,"X","X",null,null,"X",null,null,null,null,null,null,null,null,"X","X",null,null],[["Sniper","sniper"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null],[["Spawn Slayer","spawn_slayer"],null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null],[["Spire Diver","spire_diver"],null,null,null,null,"X","X",null,null,null,null,null,null,null,null,"X",null,"X","X","X","X",null],[["Spiritslayer","spiritslayer"],null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,"X",null,null,null,null],[["Stygian Slayer","stygian_slayer"],null,"X",null,null,null,null,null,null,"X",null,null,"X",null,null,null,null,"X",null,null,null,null],[["Toxic Sniper","toxic_sniper"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,"X",null,"X","X"],[["Turncoat","turncoat"],null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null],[["Vanguard","vanguard"],null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,"X",null,null,"X",null],[["Velvet Blade","velvet_blade"],null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null],[["Witch Killer","witch_killer"],null,null,"X",null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,"X",null,null,null],[["Woodland Sniper","woodland_sniper"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null,"X","X",null]],"initialColumn":0,"nullValue":"&nbsp;"}} />
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-sorcerer--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Deep Magics (Su)</td><td>At 20th level, the character's repertoire of spells deepens dramatically. She gains an additional spell known for each spell level she can cast. A character of any class with spells known can select this capstone.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
<tr><td>The Boss (Ex)</td><td>At 20th level, the character has become more than just a lone hero - she has become one of the senior figures of her field, with powers and responsibilities to match. The character becomes one of the leading figures in some manner of group or organization, as appropriate to the campaign and the setting. A wizard might become the dean of an arcane university or mages' guild, a fighter could command a mercenary army or a city guard, a cleric might lead a major temple or her own sect, and so forth. The player and the GM should work together to determine the specifics. The character gains the <Link to="/feat/leadership">Leadership</Link> feat if she does not already have it, and the number of followers that the feat grants is multiplied by 10 (although depending on the campaign and setting, the position may grant other powers as well). If multiple characters in a party select this capstone, the GM may consider pooling them to grant the players a particularly large and powerful organization, such as a small kingdom. Characters of any class can select this ability.</td></tr>
...
<Message arch /><div className="archetype"><p><Link to="/arc-sorcerer/bloodline_familiars">Bloodline Familiars</Link></p><p><strong>Modifies or Replaces:</strong> Bloodline; Bloodline Spells; 1st-Level Bloodline Power</p><p>Those with an inherent connection to magic often attract creatures who feel a similar instinctive pull toward magical forces.</p></div>
...
<p>Phantoms are self-involved, even jealous, creatures that do not play well with other summoned companions. A phantom refuses to manifest (either fully or as part of a <em>bonded manifestation</em>) in the presence of an eidolon or shadow you have summoned. Furthermore, if a phantom is manifested when such a creature is summoned, it immediately retreats into your consciousness, and will not manifest again until the eidolon or shadow is dismissed.</p>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-spiritualist--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Deep Magics (Su)</td><td>At 20th level, the character's repertoire of spells deepens dramatically. She gains an additional spell known for each spell level she can cast. A character of any class with spells known can select this capstone.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
...
<Message arch /><div className="archetype"><p><Link to="/arc-spiritualist/drowned_channeler">Drowned Channeler</Link></p><p><strong>Modifies or Replaces:</strong> Class Skills; Phantom; Shared Consciousness; Etheric Tether; Bonded Manifestation; Bonded Senses; Detect Undead; Calm Spirit; See Invisibility; Call Spirit</p><p>When a drowned spirit doomed to a watery grave descends toward the evil of undeath and seeks refuge in a mortal shell, the result is an unusual spiritualist with powers that resonate with the drowned spirit's demise.</p></div>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-swashbuckler--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<DisplayTable table={{"id":"swashbuckler archetypes","columns":[{"header":"Archetype","link":"arc-swashbuckler"},{"header":"Alignment"},{"header":"Armor Proficiency"},{"header":"Bleeding Wound"},{"header":"Bonus Feats"},{"header":"4th-level Bonus Feat"},{"header":"Charmed Life"},{"header":"Class Skills"},{"header":"Deadly Stab"},{"header":"1st, 7th, 15th-level Deeds"},{"header":"Derring-Do"},{"header":"Dizzying Defense"},{"header":"Dodging Panache"},{"header":"Kip-Up"},{"header":"Menacing Swordplay"},{"header":"Nimble"},{"header":"Opportune Parry and Riposte"},{"header":"Panache"},{"header":"Perfect Thrust"},{"header":"Precise Strike"},{"header":"Subtle Blade"},{"header":"Superior Feint"},{"header":"Swashbuckler Finesse"},{"header":"Swashbuckler Initiative"},{"header":"Swashbuckler Weapon Training"},{"header":"Swashbuckler Weapon Mastery"},{"header":"Swashbuckler's Edge"},{"header":"Swashbuckler's Grace"},{"header":"Targeted Strike"},{"header":"Weapon Proficiency"}],"data":[[["Arrow Champion","arrow_champion"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,"X",null,null,null,"X","X","X",null,null,null,null],[["Azatariel","azatariel"],"X",null,"X","X",null,"X",null,null,null,null,null,null,null,"X","X",null,null,null,"X",null,null,null,null,null,null,null,null,"X",null],[["Courser","courser"],null,null,"X",null,null,null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Daring Infiltrator","daring_infiltrator"],null,null,"X","X",null,null,"X",null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null],[["Dashing Thief","dashing_thief"],null,null,null,"X",null,null,"X",null,null,"X","X",null,null,"X",null,null,"X",null,null,null,null,null,null,null,null,"X",null,null,null],[["Flying Blade","flying_blade"],null,null,"X",null,null,null,null,null,null,null,null,"X","X","X",null,null,"X","X",null,null,null,null,null,"X","X",null,null,"X",null],[["Guiding Blade","guiding_blade"],null,null,null,"X",null,"X",null,null,"X",null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Inspired Blade","inspired_blade"],null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,"X","X",null,null,null,null],[["Mouser","mouser"],null,null,"X",null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null,null,null,"X",null],[["Musketeer","musketeer"],null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,"X"],[["Mysterious Avenger","mysterious_avenger"],"X","X",null,null,"X",null,"X",null,null,null,null,null,null,null,"X",null,null,null,null,null,null,"X",null,"X",null,null,null,null,"X"],[["Noble Fencer","noble_fencer"],null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null],[["Okayo Corsair","okayo_corsair"],null,"X","X","X",null,null,null,null,null,null,"X",null,null,"X",null,null,"X",null,null,null,"X","X",null,null,null,null,null,null,"X"],[["Picaroon","picaroon"],null,null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,"X","X",null,null,null,"X","X",null,null,null,null,null,null,"X"],[["Rondelero Swashbuckler","rondelero_swashbuckler"],null,null,"X",null,null,"X",null,null,null,"X",null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null],[["Rostland Bravo","rostland_bravo"],null,"X","X",null,null,null,"X",null,null,null,null,null,null,"X",null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Shackles Corsair","shackles_corsair"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,"X",null,null,null,null,"X",null],[["Veiled Blade","veiled_blade"],null,null,null,null,null,null,"X",null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null,"X","X",null,null],[["Whirling Dervish","whirling_dervish"],null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,"X",null,null,null,"X","X",null,null,null,null,null,"X",null],[["Wildstrider","wildstrider"],null,null,null,null,null,null,"X",null,null,"X",null,"X","X",null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null]],"initialColumn":0,"nullValue":"&nbsp;"}} />
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-vigilante--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<div className="archetype"><p><Link to="/arc-vigilante/hidden_current">Hidden Current</Link></p><p><strong>Modifies or Replaces:</strong> 1st-level Social Talent; 2nd-level Vigilante Talent; Frightening Appearance</p><p>(Gillman Only) The hidden current operates above and below the sea.</p></div>
...
<div className="archetype"><p><Link to="/arc-vigilante/zealot">Zealot</Link></p><p><strong>Modifies or Replaces:</strong> Class Skills; Skill Ranks; Weapon Proficiency; 4th, 8th, 10th, 14th, 16th-level Vigilante Talent; Alignment; Vigilante Specialization</p><p>Dedicated to a single deity, the zealot hunts the enemies of his faith in secret, often because his religion is outlawed or persecuted in the region.</p></div>
<h3 id="class-vigilante-archetypes-by-feature" data-hash-target>Archetypes by Feature</h3>
<DisplayTable table={{"id":"vigilante archetypes","columns":[{"header":"Archetype","link":"arc-vigilante"},{"header":"Alignment"},{"header":"Armor Proficiency"},{"header":"Base Saving Throws"},{"header":"Class Skills"},{"header":"Dual Identity"},{"header":"Frightening Appearance"},{"header":"Seamless Guise"},{"header":"Skill Ranks"},{"header":"Social Talents"},{"header":"1st-level Social Talent"},{"header":"3rd-level Social Talent"},{"header":"5th-level Social Talent"},{"header":"7th-level Social Talent"},{"header":"9th-level Social Talent"},{"header":"11th-level Social Talent"},{"header":"15th-level Social Talent"},{"header":"17th-level Social Talent"},{"header":"19th-level Social Talent"},{"header":"Startling Appearance"},{"header":"Stunning Appearance"},{"header":"Unshakable"},{"header":"Vengeance Strike"},{"header":"Vigilante Specialization"},{"header":"Vigilante Talents"},{"header":"2nd-level Vigilante Talent"},{"header":"4th-level Vigilante Talent"},{"header":"6th-level Vigilante Talent"},{"header":"8th-level Vigilante Talent"},{"header":"10th-level Vigilante Talent"},{"header":"12th-level Vigilante Talent"},{"header":"14th-level Vigilante Talent"},{"header":"16th-level Vigilante Talent"},{"header":"18th-level Vigilante Talent"},{"header":"Weapon Proficiency"}],"data":[[["Agathiel","agathiel"],null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,null,null],[["Anaphexia Thought-Killer","anaphexia_thought_killer"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null],[["Avenging Beast","avenging_beast"],null,null,null,"X","X","X",null,"X",null,null,null,null,null,null,null,null,null,null,"X","X",null,null,"X",null,null,"X",null,"X","X",null,"X","X",null,null],[["Bellflower Harvester","bellflower_harvester"],null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null],[["Brute","brute"],"X","X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,null,"X"],[["Cabalist","cabalist"],null,"X",null,"X",null,"X",null,"X",null,null,null,null,null,null,null,null,null,null,"X","X",null,null,"X",null,null,"X",null,"X","X",null,"X","X",null,"X"],[["Chu Ye Enforcer","chu_ye_enforcer"],null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,"X","X",null,"X",null],[["Darklantern","darklantern"],null,null,null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Dragonscale Loyalist","dragonscale_loyalist"],null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null,null,null,null,null,null,null],[["Experimenter","experimenter"],"X",null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,null,null,null,"X","X","X",null,"X",null,null,null,null,null,null,null,null,null,null,null],[["Faceless Enforcer","faceless_enforcer"],null,"X",null,null,"X",null,null,null,null,null,null,"X",null,null,"X",null,"X",null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,"X"],[["Ferocious Hunter","ferocious_hunter"],null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,"X",null,null,null,null,null,null],[["Gunmaster","gunmaster"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null,null,"X"],[["Half-Elf Double Scion","half_elf_double_scion"],null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Hangman","hangman"],null,"X",null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null,"X",null,"X","X",null,null,null,null,null,null,null,"X"],[["Hidden Current","hidden_current"],null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null],[["Imperial Agent","imperial_agent"],null,null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null],[["Magical Child","magical_child"],null,"X",null,"X",null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,"X",null,null,"X","X",null,"X"],[["Masked Maiden","masked_maiden"],null,"X",null,null,"X",null,"X",null,null,null,"X",null,"X",null,"X","X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X"],[["Mounted Fury","mounted_fury"],null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,"X",null,null,"X",null,null,null,null],[["Mutated Defender","mutated_defender"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,null],[["Psychometrist","psychometrist"],null,null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,"X",null,null,"X",null,null,"X",null],[["Serial Killer","serial_killer"],"X",null,null,null,null,"X",null,null,null,null,null,null,"X","X",null,null,null,"X","X","X","X",null,"X",null,null,"X","X",null,null,"X","X",null,null,null],[["Splintersoul","splintersoul"],null,null,null,null,"X","X",null,null,null,null,"X",null,"X",null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null,null,null,null,null,null,null],[["Teisatsu","teisatsu"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null,null,"X"],[["Warlock","warlock"],null,"X",null,"X",null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,null,"X",null,"X","X",null,"X","X",null,null],[["Wildsoul","wildsoul"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,"X",null,null,"X",null,null,"X",null],[["Zealot","zealot"],"X",null,null,"X",null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,"X","X",null,"X","X",null,"X"]],"initialColumn":0,"nullValue":"&nbsp;"}} />
