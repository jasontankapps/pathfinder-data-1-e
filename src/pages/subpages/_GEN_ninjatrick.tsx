...
<Ability id="ki-block-su" icon={["lower"]}>
...
<Ability id="pressure-points-su" icon={["boost"]}>
...
<Ability id="deadly-range-ex" icon={["boost","ranged"]}>
...
<Ability id="acrobatic-master-su" icon={["boost"]}>
...
<Ability id="high-jumper-ex" icon={["boost"]}>
...
<Ability id="blood-debt-su" icon={["power","protect","def"]}>
...
<Ability id="breath-of-the-ancestors-su" icon={["cone","line"]}>
...
<Ability id="darkvision-su" icon={["power"]}>
...
<Ability id="feather-fall-su" icon={["magic"]}>
...
<Ability id="flurry-of-stars-ex" icon={["ranged","boost","down"]}>
...
<Ability id="forgotten-trick-ex" icon={["power"]}>
...
<Ability id="herbal-compound-ex" icon={["down","def"]}>
...
<Ability id="kamikaze-su" icon={["boost"]}>
...
<Ability id="ki-charge-su" icon={["ranged"]}>
...
<Ability id="ki-venom-ex" icon={["power","lower"]}>
...
<Ability id="shadow-clone-su" icon={["def","magic"]}>
...
<Ability id="smoke-bomb-ex" icon={["power","zap"]}>
...
<Ability id="poison-bomb-ex" icon={["power"]}>
...
<Ability id="choking-bomb-ex" icon={["power","lower"]}>
...
<Ability id="strangler-ex" icon={["melee"]}>
...
<Ability id="sudden-disguise-su" icon={["magic"]}>
...
<Ability id="vanishing-trick-su" icon={["magic"]}>
...
<Ability id="ventriloquism-su" icon={["magic"]}>
...
<Ability id="arcane-backfire-su" icon={["lower"]}>
...
<Ability id="hidden-weapons-ex" icon={["boost"]}>
...
<Ability id="redirect-force-ex" icon={["down","boost"]}>
...
<Ability id="rogue-talent" icon={["power"]}>
...
<Ability id="slow-metabolism-ex" icon={["def"]}>
...
<Ability id="style-master" icon={["power"]}>
...
<Ability id="swarming-attack" icon={["boost"]}>
...
<Ability id="swift-poisoner-ex" icon={["boost"]}>
...
<Ability id="unarmed-combat-training-ex" icon={["power","melee"]}>
...
<Ability id="deflect-arrows-ex" icon={["power"]}>
...
<Ability id="snatch-arrows" icon={["def","power"]}>
...
<Ability id="undetected-sabotage-ex" icon={["power"]}>
...
<Ability id="wall-climber-su" icon={["power"]}>
...
<Ability id="assassinate-ex" icon={["power","lower"]}>
...
<Ability id="blinding-bomb-ex" icon={["lower"]}>
...
<Ability id="fractured-mirror-su" icon={["def","magic","boost"]}>
...
<Ability id="greater-ki-venom-ex" icon={["boost"]}>
...
<Ability id="invisible-blade-su" icon={["magic"]}>
...
<Ability id="master-disguise-su" icon={["boost"]}>
...
<Ability id="shadow-split-su" icon={["def","magic"]}>
...
<Ability id="acceleration-of-form-su" icon={["def","boost"]}>
...
<Ability id="deep-cover-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="many-guises-ex" icon={["power"]}>
...
<Ability id="false-face-su" icon={["power","magic"]}>
...
<Ability id="ghost-step-su" icon={["power"]}>
...
<Ability id="kami-warden-su" icon={["power","protect","def"]}>
...
<Ability id="kawarimi-su" icon={["def"]}>
...
<Ability id="occulted-soul-su" icon={["magic","def"]}>
...
<Ability id="see-the-unseen-su" icon={["magic"]}>
...
<Ability id="unbound-steps-su" icon={["power"]}>
...
<Ability id="advanced-talent" icon={["power"]}>
...
<Ability id="all-the-stars-in-the-sky-ex" icon={["power"]}>
...
<Ability id="deadly-shuriken-ex" icon={["ranged","boost"]}>
...
<Ability id="spiritual-companion-ex" icon={["power"]}>
...
<Ability id="unarmed-combat-mastery-ex" icon={["melee","boost"]}>
