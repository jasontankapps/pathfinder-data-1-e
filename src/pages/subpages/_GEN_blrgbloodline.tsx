...
<div className="abPair"><div className="abStart plain"><div className="box">16th</div></div><div className="abEnd simple"><div className="box"><Link to="/spell/fire_shield">Fire shield</Link> (warm only)</div></div></div></div>
