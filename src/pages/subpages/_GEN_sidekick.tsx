...
<Message arch /><div className="archetype"><p><Link to="/arc-companion/aberrant_companion">Aberrant Companion</Link></p><p><strong>Modifies or Replaces:</strong> Devotion, Multiattack, Natural Armor Progression, Share Spells</p><p>Though aberrant companions are touched by eldritch magic or mutated by strange influences, they are still loyal, if unnatural, allies.</p></div>
...
<Message arch /><div className="archetype"><p><Link to="/arc-familiar/ambassador">Ambassador</Link></p><p><strong>Modifies or Replaces:</strong> Alertness, Class Skills, Intelligence Score Progression</p><p>An ambassador speaks on its master's behalf and sometimes on behalf of its master's patron or other extraplanar contacts.</p></div>
