...
<Pair single="benefit" id="diabolist-raised-benefit">Your knowledge of diabolism grants you a +1 bonus on Bluff, Diplomacy, Intimidate, and Sense Motive checks made against Westcrown's nobility, and a +1 bonus on all saving throws made against mind-affecting attacks from devils.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="shadow-child-benefit">When attacking targets in areas of dim light, you do not suffer the standard 20% miss chance on attack rolls for being in the poorly lit area.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="giantslayer-scion-benefit">You take no penalty on Intimidate checks against creatures with the giant subtype that are larger than you, and you gain a +1 trait bonus to the DC of any fear-based effect you use against a creature with the giant subtype.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="unbreakable-survivor-benefit">Once per day as a full round action, you may shrug off some of your injuries and immediately heal a number of hit points equal to your Constitution modifier + 1 per Hit Die. Your reputation for tenacity inspires your neighbors, and you gain a +1 trait bonus whenever you attempt to influence residents of Phaendar with Diplomacy or Intimidate checks. At 6th level, your reputation spreads further across the nation, and you may apply your trait bonus on Diplomacy and Intimidate checks to influence all humanoids in Nirmathas.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="brigand-benefit">You begin the campaign with an extra 100 gp in ill-gotten gains. You also gain a +1 trait bonus on Bluff, Diplomacy, Intimidate, and Sense Motive checks when dealing with brigands, thieves, bandits, and their ilk.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="seeking-adventure-benefit">You begin the game with your own wayfinder, a loan from your venture-captain. you've promised to pay your venture-captain 500 gp for the wayfinder some day, but for now it's yours to use. A wayfinder is a magical compass that grants you a +2 circumstance bonus on Survival checks to avoid becoming lost, and can be commanded to emit <Link to="/spell/light">light</Link> as the spell (CL 5th) as a standard action.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="friends-and-enemies-benefit">Once you make it to Sandpoint and meet up with Daviren Hosk at the Goblin Squash Stables, he gives you one of his best steeds and all the necessary accoutrements as gratitude for your family member's help: a heavy combat trained horse, a military saddle, saddlebags, bit and bridle, a month's worth of feed, and lifetime stabling at the Goblin Squash Stables.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="merchant-family-benefit">You increase the gp limit of any settlement by 20% and can resell items at an additional 10% over the amount of gp you normally would get from selling off treasure.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="student-of-faith-benefit">Because of your strong faith and broad range of study, you cast all <Link to="/main/cure_spells">cure spells</Link> at +1 caster level, and whenever you channel energy, you gain a +1 trait bonus to the save DC of your channeled energy.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="thrill-seeker-rotr-benefit">The thrill of danger grants you an additional +5 feet of movement during the first round of any combat. Additionally, you begin play with three star candle fireworks.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="daring-doomsayer-benefit">Whenever you roll a <strong>1</strong> on an attack roll, you gain a +1 trait bonus on your next attack roll so long as it is made within 1 minute. You also begin play with a placard bearing an apocalyptic slogan of your choice; this wooden sign can be used as a club.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Second Darkness</Pair>
<Pair single="flavor" id="optimistic-gambler-flavor">You've always seemed to have trouble keeping money. Worse, you always seem to have debts looming over your head. When you heard about the "Cheat the Devil and Take His Gold" gambling tournament, you felt in your gut that your luck was about to change. You've always been optimistic, in fact, and even though right now is one of those rare times where you don't owe anyone any money (you just paid off a recent loan from local moneylender Lymas Smeed), you know that'll change soon enough. Better to start amassing money now when you're at one of those rare windfall times! You've set aside a gold coin for the entrance fee, and look forward to making it big - you can feel it in your bones! This time's gonna be the big one!</Pair>
<Pair single="benefit" id="optimistic-gambler-benefit">Your boundless optimism, even in the face of crushing situations, has always bolstered your spirit. Effects that grant you morale bonuses persist 1d4 rounds longer than they normally would as a result.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="portentous-perception-benefit">For you, Perception checks only start increasing in difficulty at a range of 20 feet or farther, as opposed to the normal 10. This has no effect on checks made to perceive things within 10 feet.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="researching-the-blot-benefit">You can use Spellcraft to identify magic items in the same way you can use Spellcraft to identify a potion. The DC to identify a magic item is equal to 20 + the item's caster level.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="boarded-in-cheliax-benefit">You begin the campaign with a detailed map of the Mwangi Expanse (this grants +2 competence bonus on all Knowledge [geography] checks made regarding this region) and 200 gp worth of mundane equipment to aid your exploration of the jungle.</Pair>
</Ability>
</>};
