...
<Pair single="benefit" id="charlatan-benefit"><p>As a <strong className="hl">swift action</strong>, you may expend one prepared spell or spell slot to gain a bonus on the next <Link to="/skill/bluff">Bluff</Link> check you make, provided the check takes place before the beginning of your next turn. The bonus on this check is equal to the level of the spell consumed.</p>
...
<Pair single="benefit" id="lamias-bane-benefit">You gain a +1 trait bonus on saving throws against enchantment effects and a +2 trait bonus on saving throws against the spells and spell-like abilities of <Link to="/monster/lamia">lamias</Link>.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="lunar-birth-benefit">You gain a +1 trait bonus on saving throws against the spells and spell-like abilities cast by humans.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="magic-crafter-benefit">You gain a +1 trait bonus on <Link to="/skill/appraise">Appraise</Link> checks and a +1 bonus on any <Link to="/skill/craft">Craft</Link> checks attempted while making magic items.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="magical-knack-benefit">Pick a class when you gain this trait - your caster level in that class gains a +2 trait bonus as long as this bonus doesn't raise your caster level above your current Hit Dice.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="magical-lineage-benefit">Pick one spell when you choose this trait. When you apply <Link to="/rule/metamagic_feats">metamagic feats</Link> to this spell that add at least 1 level to the spell, treat its actual level as 1 lower for determining the spell's final adjusted level.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="magical-talent-benefit">Choose a 0-level spell. You may cast that spell once per day as a spell-like ability. This spell-like ability is cast at your highest caster level gained; if you have no caster level, it functions at CL 1st. The spell-like ability's save DC is Charisma-based.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="mathematical-prodigy-benefit">You gain a +1 bonus on <Link to="/skill/knowledge_arcana">Knowledge (arcana)</Link> and <Link to="/skill/knowledge_engineering">Knowledge (engineering)</Link> checks, and one of these skills (your choice) is always a class skill for you.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="meticulous-concoction-benefit">Once per day, you can either add a +2 trait bonus to the save DC for one bomb you throw or extend the duration of one extract you imbibe by 2 rounds. Extracts with an instantaneous duration are not affected by this trait.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="outcasts-intuition-benefit">You gain a +1 trait bonus on <Link to="/skill/sense_motive">Sense Motive</Link> checks, and Sense Motive is always a class skill for you. In addition, your caster level is treated as 1 level higher for the purposes of any attempts to dispel your magic.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="overwhelming-beauty-benefit">The DC of your mind-affecting effects increases by 1 against creatures that have at least one of the same subtypes as you.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="partial-protege-benefit">You gain a +1 trait bonus on <Link to="/skill/bluff">Bluff</Link> checks and on <Link to="/skill/use_magic_device">Use Magic Device</Link> checks made to emulate a class feature.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="perfectionists-brew-benefit">You gain a +2 trait bonus on all <Link to="/skill/craft">Craft</Link> (alchemy) checks and on <Link to="/skill/spellcraft">Spellcraft</Link> checks made to brew potions.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="planar-escapee-benefit">At character creation, select acid, cold, electricity, or fire (once chosen, this selection can't be changed). Once per day as a <strong className="hl">swift action</strong>, you can choose a single creature that is within 30 feet of you and within your line of sight; treat that creature's <Link to="/umr/resistance">resistance</Link> against your chosen energy as 5 lower than its normal energy resistance for 1 round. This ability has no effect if the creature has no resistance to the chosen energy or if the creature has <Link to="/umr/immunity">immunity</Link> to the chosen energy.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="pragmatic-activator-benefit">You may use your Intelligence modifier when making <Link to="/skill/use_magic_device">Use Magic Device</Link> checks instead of your Charisma modifier.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="precise-treatment-benefit">You gain a +1 trait bonus on all <Link to="/skill/heal">Heal</Link> checks, and you may use your Intelligence modifier when making Heal checks instead of your Wisdom modifier.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="reluctant-apprentice-benefit">You gain a +1 trait bonus on <Link to="/skill/knowledge_arcana">Knowledge (arcana)</Link> checks, and are considered trained in that skill even if you have no ranks in it.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="resilient-caster-benefit">Your caster level is treated as 1 level higher whenever someone attempts to dispel one of your spells.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="scholar-of-the-analects-benefit">You can cast <Link to="/spell/read_magic">read magic</Link> as a spell-like ability three times per day, using your character level as your caster level.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="scorned-by-magic-benefit"><p>Reduce the caster level of spells and spell-like abilities cast upon you by 1 for the purpose of attempting dispel checks and overcoming your spell resistance (if any).</p>
...
<Pair single="benefit" id="secret-scrolls-benefit">You can cast <Link to="/spell/read_magic">read magic</Link> once per day as a spell-like ability, and gain a +1 trait bonus on <Link to="/skill/use_magic_device">Use Magic Device</Link> checks to activate scrolls you cannot normally use.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="shrouded-casting-benefit">Choose one school of magic when you pick this trait. You can cast spells from that school as if you had the <Link to="/feat/eschew_materials">Eschew Materials</Link> feat.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="skeptic-benefit">You gain a +2 trait bonus on all saving throws against illusions.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="spark-of-creation-benefit">You gain a +1 trait bonus on <Link to="/skill/craft">Craft</Link> checks, and the cost of creating magic items is reduced by 5%.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="spiritual-attachment-benefit">You gain a +4 trait bonus on checks to notice <Link to="/rule/haunts">haunts</Link>, and when interacting with someone who is possessed by an incorporeal undead creature, you gain a +2 trait bonus on <Link to="/skill/bluff">Bluff</Link>, <Link to="/skill/diplomacy">Diplomacy</Link>, <Link to="/skill/intimidate">Intimidate</Link>, and <Link to="/skill/sense_motive">Sense Motive</Link> checks against that target.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="stabbing-spells-benefit">Whenever you strike a foe with a weapon, you gain a +2 trait bonus on caster level checks to overcome that foe's spell resistance until the end of your next turn.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="storm-touched-benefit">You gain DR 1/- against creatures and attacks with the electricity type.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="strength-foretold-benefit">Once per day as a <strong className="hl">free action</strong>, you gain a +1 trait bonus to the DC of the saving throw of one of your bonus bloodline spells.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="sun-blessed-benefit">Whenever you're affected by a healing effect that would heal more hit points than your maximum hit point total, you gain the excess healing as <Link to="/rule/temporary_hit_points">temporary hit points</Link>. You can gain up to a number of temporary hit points per day equal to your character level in this way. These temporary hit points last for 1 minute.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="tenacious-shifting-benefit">Any transmutation spell you cast upon yourself has its duration increased by 2 rounds. Transmutation spells with an instantaneous duration are not affected by this trait.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="theoretical-magician-benefit">You gain a +2 trait bonus on <Link to="/skill/spellcraft">Spellcraft</Link> checks, or a +3 bonus if you aren't a spellcaster.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="transmuter-of-korada-benefit"><p>Whenever you cast a spell from the transmutation school, its effects manifest at +1 caster level.</p>
...
<Pair single="benefit" id="twisted-tattoo-benefit">Once per day as you cast a spell whose casting time is 1 round or less, you can roll 1d4-2 (no minimum) and add the result to that spell's effective caster level. In an area of <Link to="/rule/primal_magic">primal magic</Link>, the minimum result of this roll is 0, not -1.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="unscathed-benefit">Each type of energy <Link to="/umr/resistance">resistance</Link> you have (if any) increases by 2 points.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="volatile-conduit-benefit">Once per day as a <strong className="hl">free action</strong>, when you cast a spell that deals acid, cold, electricity, or fire damage, you can enhance that spell with volatile energy. When you do, it deals 1d4 points of extra damage of the same energy type.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="water-touched-benefit">You gain DR 1/- against creatures and attacks with the water type.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="winter-witchcraft-survivor-benefit">You gain cold <Link to="/umr/resistance">resistance</Link> 5 against the first cold damage you take each day, and gain a +2 bonus on saving throws against the fear effects of creatures with the cold subtype.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="chance-savior-benefit">You gain a +2 trait bonus on Initiative checks.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="teachers-pet-benefit">You gain a +2 trait bonus to one <Link to="/skill/knowledge">Knowledge</Link> skill of your choosing and consider it a class skill.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="child-of-infamy-benefit">You gain a +1 trait bonus on <Link to="/skill/perform">Perform</Link> (act) skill checks, and the skill is always considered a class skill for you. Furthermore, You've inherited some of your relative's funds, and begin play with a nest egg of 300 gp that you can spend however you wish.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Council of Thieves</Pair>
<Pair single="flavor" id="shadow-child-flavor">Westcrown has long suffered under a peculiar curse, a blight that rises every night, bringing with it fell beasts that hunt the shadows. No one can say from whence these night-horrors come - though some blame the mysterious wizards of Nidal, other claim that it's some curse laid by fallen Aroden, while still others suggest some shadowy mastermind manipulates an ebon brood from the depths of Westcrown's northern ruins. Whatever the case, the people of Westcrown have long feared the night, but not you. You're goal is to reclaim the darkness from the beasts that hide within. You've acclimated yourself to the dark, and thus act with greater precision in the shadow than most.</Pair>
<Pair single="benefit" id="shadow-child-benefit">When attacking targets in areas of <Link to="/rule/dim_light">dim light</Link>, you do not suffer the standard 20% miss chance on attack rolls for being in the poorly lit area.</Pair>
</Ability>
</>};
...
<ul>
<li><strong>Hungry for Revenge:</strong> You've never forgiven Gaedren for his betrayal, and have vowed to make him pay for what he did. Whether that's seeing him rot in jail or a shallow grave, you hope to taste vengeance someday. Whenever you deal damage with a melee weapon on a creature that is <Link to="/rule/flat_footed">flat-footed</Link>, you gain a +1 trait bonus on the damage roll.</li>
<li><strong>Reformed Criminal:</strong> You've given up the life of crime, and managed to talk your way out of any repercussions such as jail time or fines. You've told yourself that you would rather leave your past behind, yet the concept of seeing Gaedren Lamm pay for his crimes still appeals to you. You gain a +1 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link> checks, and Diplomacy is a class skill for you.</li>
</ul>
</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Curse of the Crimson Throne</Pair>
<Pair single="flavor" id="dockside-avenger-flavor">No crime is too despicable for Gaedren Lamm and his thugs - a gang of lowlife murderers, kidnappers, and drug dealers that operate in Korvosa's Midland district. You've lost someone to Lamm and now you're out for revenge.</Pair>
<Pair single="benefit" id="dockside-avenger-benefit">While Lamm remains alive and free, you are not slain until your hit point total reaches a negative number equal to your Constitution score + 3. Once Lamm is imprisoned or killed, you lose the former benefit but gain 3 permanent hit points.</Pair>
</Ability>
</>};
...
<ul>
<li><strong>Addicted Friend:</strong> The addict is a friend or lover who might or might not have survived the overdose. Your research into the drug scene and local politics has given you a respectable education in street knowledge. You gain a +1 trait bonus on <Link to="/skill/knowledge_local">Knowledge (local)</Link> checks, and Knowledge (local) is a class skill for you.</li>
...
<ul>
<li><strong>Dropout:</strong> You were the one accused of the murder. Although you were eventually freed when a friend confronted the fisherman and got the truth, the damage had been done. You were forced to leave your school or church. As a result, you were forced to self-train and promised yourself you would become better at your chosen profession despite the spurning of your peers. You gain a +1 trait bonus on <Link to="/skill/spellcraft">Spellcraft</Link> checks, and Spellcraft is a class skill for you.</li>
<li><strong>Family Honor:</strong> The person who was framed was a family member, perhaps a father or sister. You managed to trick the fisherman into revealing the truth with your skilled tongue. You gain a +1 trait bonus on <Link to="/skill/bluff">Bluff</Link> checks, and Bluff is a class skill for you.</li>
</ul>
</Pair>
</Ability>
</>};
...
<ul>
<li><strong>All Alone:</strong> The murder victim was a lover. With your lover's death, a part of you died as well, leaving you haunted, grim, and prone to dark musings. You gain a +1 trait bonus on <Link to="/skill/intimidate">Intimidate</Link> checks, and Intimidate is a class skill for you.</li>
<li><strong>Orphaned:</strong> The murder victim was your only surviving parent. You had to work hard to make ends meet for yourself and any siblings, and often had to scavenge for food. You gain a +1 trait bonus on <Link to="/skill/survival">Survival</Link> checks, and Survival is a class skill for you.</li>
</ul>
</Pair>
</Ability>
</>};
...
<ul>
<li><strong>Missing Sibling:</strong> The missing child is a brother or sister. Although everyone else has given up hope, you believe your sibling still lives. Your constant search for the missing sibling has developed into great skill at rumormongering and finding out information from others. You gain a +1 trait bonus on <Link to="/skill/sense_motive">Sense Motive</Link> checks, and Sense Motive is a class skill for you.</li>
...
<Pair single="benefit" id="varisian-immunity-benefit"><p>You gain a +1 trait bonus on saving throws made to resist diseases. Additionally, you are immune to the diseases <Link to="/disease/vorels_phage">Vorel's phage</Link> and <Link to="/disease/blood_veil">blood veil</Link>.</p>
<p>You do not need to be of the Varisian ethnicity to take this campaign trait, but if you're not, your background should explain how you have a Varisian ancestor.</p>
</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="artifact-hunter-gs-benefit"><p>You gain a +1 trait bonus on <Link to="/skill/spellcraft">Spellcraft</Link> checks to identify the properties of magic items and a +1 trait bonus on <Link to="/skill/use_magic_device">Use Magic Device</Link> checks, and one of these skills (your choice) becomes a class skill for you.</p>
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Giantslayer</Pair>
<Pair title="Requirements" hl>Cannot be a dwarf or gnome</Pair>
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Giantslayer</Pair>
<Pair single="flavor" id="giantslayer-scion-flavor">You grew up listening to tales of a famed ancestor's mighty battles against giant foes. Just the mention of your ancestor's name is enough to strike fear into the heart of the most stalwart giant warrior, and you've resolved to follow in your forebear's footsteps.</Pair>
<Pair single="benefit" id="giantslayer-scion-benefit">You take no penalty on <Link to="/skill/intimidate">Intimidate</Link> checks against creatures with the giant subtype that are larger than you, and you gain a +1 trait bonus to the DC of any fear-based effect you use against a creature with the giant subtype.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="roll-with-it-benefit"><p>You gain a +1 trait bonus on Reflex saves. In addition, once per day, when a creature with the giant subtype successfully confirms a critical hit against you with a weapon or a slam attack (not a spell or special ability), you can roll with the attack. You take normal damage from the blow, as if the critical had not been confirmed. You must be aware of the attack and able to react to it - if you are denied your Dexterity bonus to AC, you can't use this ability.</p>
...
<Pair single="benefit" id="trunau-native-benefit">You begin play with a <em>hopeknife</em> (a <Link to="/rule/masterwork_w">masterwork</Link> <Link to="/eq-weapon/dagger">dagger</Link>), and your tenacity in the face of adversity grants you a +1 trait bonus on Will saves.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="vexing-defender-benefit">You gain a +1 trait bonus on <Link to="/skill/acrobatics">Acrobatics</Link> checks, and Acrobatics becomes a class skill for you. In addition, you gain a +4 trait bonus on Acrobatics checks to move through an enemy's space without provoking an attack of opportunity, provided that enemy is larger than you.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="child-of-kintargo-benefit"><p>You gain a +1 trait bonus on <Link to="/skill/knowledge_nobility">Knowledge (nobility)</Link> checks, and Knowledge (nobility) is always a class skill for you. The Noble Scion feat does not have a Charisma prerequisite for you. In addition, you start play with a <Link to="/eq-misc/nobles_outfit">noble's outfit</Link>, a <Link to="/eq-misc/signet_ring">signet ring</Link>, and a single additional nonmagical item worth no more than 200 gp.</p>
...
<Pair single="benefit" id="diva-in-training-benefit">Choose one type of <Link to="/skill/perform">Perform</Link> skill. You gain a +1 trait bonus in that specific Perform skill, and all Perform skills are class skills for you. You also increase the save DCs of all language-dependent spells and effects you create by 1.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="gifted-satirist-benefit">You gain a +1 trait bonus on <Link to="/skill/linguistics">Linguistics</Link> checks, and Linguistics is always a class skill for you. In addition, your irreverent attitude grants you a +2 trait bonus on all saving throws against fear effects.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="historian-of-the-rebellion-benefit"><p>Your familiarity with rebel groups allows you to grant a +2 bonus on an <Link to="/rule/organization_check">Organization check</Link> of your choice once the party reestablishes the Silver Ravens during the first adventure. You can change which check you assign this bonus to once at the start of the rebellion's Upkeep phase.</p>
...
<Pair single="benefit" id="pattern-seeker-benefit">You gain a +1 trait bonus on all <Link to="/skill/perception">Perception</Link> checks, and Perception is always a class skill for you. In addition, you increase the save DC of any illusion (pattern) spell you cast by 1, and you gain a +1 trait bonus on all saving throws against illusion effects.</Pair>
</Ability>
</>};
...
<ul>
<li><strong>Devil's Bells:</strong> <Link to="/skill/knowledge_arcana">Knowledge (arcana)</Link> or <Link to="/skill/knowledge_planes">Knowledge (planes)</Link>.</li>
<li><strong>Local Dragons:</strong> Knowledge (arcana) or <Link to="/skill/knowledge_history">Knowledge (history)</Link>.</li>
<li><strong>Professor Mangvhune:</strong> <Link to="/skill/knowledge_local">Knowledge (local)</Link> or Knowledge (planes).</li>
...
<Pair single="benefit" id="asmodean-acolyte-benefit">You gain a +1 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link>, <Link to="/skill/knowledge_planes">Knowledge (planes)</Link>, and <Link to="/skill/knowledge_religion">Knowledge (religion)</Link> checks, and one of these skills (your choice) is a class skill for you. You also know the Infernal tongue (this does not count toward your number of languages).</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="good-slip-benefit">You gain a +1 trait bonus on <Link to="/skill/bluff">Bluff</Link> checks, and Bluff is a class skill for you. In addition, your tacit support of Cheliax's social structure, and the clear knowledge of your own place in society, strengthens your resolve. Once per day, when you are adjacent to a human ally of Chelish descent, you can reroll a Will saving throw before success or failure is known. You must take the results of the second roll, even if it is worse.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="hellknight-aspirant-benefit"><p>You gain a +1 trait bonus on <Link to="/skill/knowledge_planes">Knowledge (planes)</Link> checks, and Knowledge (planes) is a class skill for you. In addition, choose one of the following Hellknight orders. You have trained yourself in the use of that order's favored weapon (if more than one weapon is listed, pick one), and gain a +1 trait bonus to your Combat Maneuver Defense whenever an opponent tries to sunder or disarm you of that weapon.</p>
<ul>
<li><strong>Order of the Chain:</strong> <Link to="/eq-weapon/flail">Flail</Link>.</li>
<li><strong>Order of the Gate:</strong> <Link to="/eq-weapon/dagger">Dagger</Link>.</li>
<li><strong>Order of the Godclaw:</strong> <Link to="/eq-weapon/morningstar">Morningstar</Link>.</li>
<li><strong>Order of the Nail:</strong> <Link to="/eq-weapon/lance">Lance</Link> or <Link to="/eq-weapon/halberd">halberd</Link>.</li>
<li><strong>Order of the Pike:</strong> <Link to="/eq-weapon/longspear">Longspear</Link>.</li>
<li><strong>Order of the Pyre:</strong> <Link to="/eq-weapon/glaive">Glaive</Link>.</li>
<li><strong>Order of the Rack:</strong> <Link to="/eq-weapon/longsword">Longsword</Link> or <Link to="/eq-weapon/whip">whip</Link>.</li>
<li><strong>Order of the Scourge:</strong> <Link to="/eq-weapon/heavy_mace">Heavy mace</Link> or whip.</li>
</ul>
</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="local-tough-benefit">You gain a +1 trait bonus on <Link to="/skill/intimidate">Intimidate</Link> checks, and Intimidate is a class skill for you. In addition, you gain a +1 trait bonus on weapon damage rolls when you are <Link to="/rule/flanking">flanking</Link> a foe with an ally.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="scion-of-the-nine-circles-benefit">You gain a +1 trait bonus on <Link to="/skill/knowledge_planes">Knowledge (planes)</Link> checks, and Knowledge (planes) is a class skill for you. You also know the Infernal tongue (this does not count toward your number of languages). In addition, your studies of Hell's underlying structure give strength to your determination. You gain a +2 trait bonus on Will saves against the mind-affecting effects of outsiders with the good subtype.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="thrune-informant-benefit">You gain a +1 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link> checks to gather information, <Link to="/skill/disguise">Disguise</Link> checks, and <Link to="/skill/knowledge_local">Knowledge (local)</Link> checks, and one of these skills (your choice) is a class skill for you.</Pair>
</Ability>
</>};
...
<Pair single="flavor" id="thrune-loyal-agent-flavor">You have sworn your body to Queen Abrogail and House Thrune in a ritual ceremony, and are willing to lay down your life in service to Thrune.</Pair>
<Pair single="benefit" id="thrune-loyal-agent-benefit"><p>Once per week, when reduced to fewer than 0 hit points, you automatically gain <Link to="/umr/fast_healing">fast healing</Link> 1 for 1 minute. Once this ability has been used, you instead gain a +4 trait bonus on Constitution checks to stabilize when reduced to negative hit points.</p>
<p>In addition, you receive an invisible <Link to="/spell/arcane_mark">arcane mark</Link> of the encircled cross emblem of Cheliax as a symbol of your loyalty. This mark does not fade and is visible only to other creatures with this trait, or creatures with the ability to perceive the invisible (via <Link to="/spell/see_invisibility">see invisibility</Link> or <Link to="/spell/true_seeing">true seeing</Link>, for example). You can make this mark visible to other creatures for 1 round as a <strong className="hl">swift action</strong>. If the mark is dispelled or removed (such as with <Link to="/spell/erase">erase</Link>), it can be replaced with another casting of <em>arcane mark,</em> which thereafter functions as detailed in this trait.</p>
</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="stargazer-ig-benefit">You gain a +2 trait bonus on <Link to="/skill/knowledge">Knowledge</Link> checks to identify alien monsters' abilities and weaknesses. In addition, you gain a +1 trait bonus on <Link to="/skill/knowledge_geography">Knowledge (geography)</Link> checks, and this skill is a class skill for you. You are treated as if you possessed the <Link to="/feat/technologist">Technologist</Link> feat for the purposes of resolving checks to identify an alien creature using a Knowledge skill and for all Knowledge (geography) checks. If you already possess the Technologist feat, then your trait bonus on Knowledge (geography) checks increases to +3.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="animal-whisperer-benefit"><p>You gain a +1 trait bonus on <Link to="/skill/handle_animal">Handle Animal</Link> checks, and Handle Animal is always a class skill for you. Your trait bonus increases to +5 whenever you attempt to "push" a wild animal to perform a trick for you, so long as its attitude is indifferent or friendlier.</p>
...
<Pair title="Camapign" hl>Ironfang Invasion</Pair>
<Pair title="Requirements" hl><Link to="/race/dwarf">Dwarf</Link></Pair>
<Pair single="flavor" id="kraggodan-castaway-flavor">You hail from the dwarven Sky Citadel of Kraggodan in southern Nirmathas and have spent the past several years among the surface people serving as a mercenary in the war, trading with Nirmathi towns, or simply seeing the surface world. Molthune's recent siege of Kraggodan has squelched any hopes you had of returning home, and now you struggle to find a home on the surface.</Pair>
<Pair single="benefit" id="kraggodan-castaway-benefit"><p>Thanks to your travels, you gain one of the following as a bonus language: Common, Hallit, Varisian, or Undercommon.</p>
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Ironfang Invasion</Pair>
<Pair single="flavor" id="unbreakable-survivor-flavor">Over a decade ago, bandits took everything you valued in life and left you barely alive. You managed to rebuild your life in the years since, and your tenacity has made you a local legend.</Pair>
<Pair single="benefit" id="unbreakable-survivor-benefit">Once per day as a <strong className="hl">full-round action</strong>, you may shrug off some of your injuries and immediately heal a number of hit points equal to your Constitution modifier + 1 per Hit Die. Your reputation for tenacity inspires your neighbors, and you gain a +1 trait bonus whenever you attempt to influence residents of Phaendar with <Link to="/skill/diplomacy">Diplomacy</Link> or <Link to="/skill/intimidate">Intimidate</Link> checks. At 6th level, your reputation spreads further across the nation, and you may apply your trait bonus on Diplomacy and Intimidate checks to influence all humanoids in Nirmathas.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="world-weary-benefit">You gain one of the following as a permanent class skill: <Link to="/skill/appraise">Appraise</Link>, <Link to="/skill/heal">Heal</Link>, <Link to="/skill/knowledge_history">Knowledge (history)</Link>, <Link to="/skill/sense_motive">Sense Motive</Link>, or <Link to="/skill/survival">Survival</Link>. When you perform an <Link to="/rule/aid_another_2">aid another</Link> action to improve a creature's Armor Class, you increase its AC by +4 rather than +2.</Pair>
</Ability>
</>};
...
<Pair single="flavor" id="best-customer-flavor">You've sat on your favorite barstool at the Rusty Dragon every night for as long as you can remember- and some nights you can't remember thanks to a few too many drinks. In your various hazes, You've gotten to know the tap house's proprietor, Ameiko, or one of her regulars, Sandru, quite well. Additionally, you're well acquainted with a variety of uses for strong drink.</Pair>
<Pair single="benefit" id="best-customer-benefit"><p>Any time you have an alcoholic beverage on hand, you can expend one use of it to grant you a +2 trait bonus on a <Link to="/skill/heal">Heal</Link> check. This bonus increases to +4 if you're treating your favorite drinking buddy (your NPC of choice).</p>
<ul>
<li><strong>NPC Choices:</strong> Ameiko, Sandru.</li>
</ul>
</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Jade Regent</Pair>
<Pair single="flavor" id="best-friend-flavor">You are best friends with one of the NPCs; you've grown up together, and while your friend has had a much more exciting life than you so far, you hope one day to follow in your friend's footsteps and see the world - or perhaps even become an adventurer yourself. you've picked up a lot from your friend, but particularly his or her skill in interacting with others.</Pair>
<Pair single="benefit" id="best-friend-benefit"><p>If Ameiko is your best friend, you gain a +2 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link> checks. If Sandru is your best friend, you gain a +2 trait bonus on <Link to="/skill/bluff">Bluff</Link> checks. Whichever skill you gain a trait bonus on, that skill is always considered a class skill for you.</p>
<p>In addition, in situations where your best friend is in danger, you gain a +1 trait bonus on all attack rolls against foes that threaten your friend.</p>
<ul>
<li><strong>NPC Choices:</strong> Ameiko, Sandru.</li>
</ul>
</Pair>
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Jade Regent</Pair>
<Pair single="flavor" id="childhood-crush-flavor">You've never had the guts to act on it, but for as long as you can remember, You've had a crush on one of the NPCs. Someday, maybe you'll be able to earn the NPC's love, but for now, you're content to spend time in the NPC's proximity, or even to do things for the NPC that might earn you a word of thanks or a smile.</Pair>
<Pair single="benefit" id="childhood-crush-benefit"><p>Once per day, you may attempt to earn a kind word or a smile from the NPC whom you have a crush on by making a DC 15 Charisma check. If you're successful, the elation and joy at the attention gives you a +1 trait bonus on all saving throws for the remainder of the day. If you're ever lucky enough to win the NPC's love, this +1 trait bonus on saving throws applies at all times, as long as your relationship remains active.</p>
<p>Note that gender isn't an issue in the case of these three NPCs. Unless your GM says otherwise, all three of these NPCs are considered to be bisexual as far as this trait's implications are concerned. Note that if you take this trait, you'll likely want to coordinate NPC choices with any other player who chooses this trait as well, since choosing the same NPC could cause unwanted party strife. Of course, if that's what you and the other player are looking for, go for it!</p>
<p>In addition, you gain a +1 trait bonus on all attack rolls against foes that threaten your crush.</p>
<ul>
<li><strong>NPC Choices:</strong> Ameiko, Sandru, Shalelu.</li>
</ul>
</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="foreign-tongued-benefit"><p>Choose one of the following characters. You may select one of that character's languages as a bonus language. Additionally, you gain a +2 trait bonus on <Link to="/skill/bluff">Bluff</Link> checks made to pass secret messages to the chosen character (see the description of the Bluff skill).</p>
<ul>
...
<Pair single="benefit" id="friend-of-the-family-benefit"><p>As long as Koya remains alive, you gain a +1 trait bonus on <Link to="/skill/perception">Perception</Link> checks, and Perception becomes a class skill for you. In addition, you gain a +1 trait bonus on all attack rolls against foes that threaten Koya.</p>
<ul>
<li><strong>NPC Choices:</strong> Koya.</li>
</ul>
</Pair>
...
<Pair single="benefit" id="hero-worship-benefit"><p>If your hero is Ameiko, you gain a +2 bonus on <Link to="/rule/concentration">concentration</Link> checks. If your hero is Shalelu, you gain a +1 bonus to your AC against attacks of opportunity.</p>
<p>In addition, you gain a +1 trait bonus on all attack rolls against foes that threaten your hero.</p>
<ul>
<li><strong>NPC Choices:</strong> Ameiko, Shalelu.</li>
</ul>
</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Jade Regent</Pair>
<Pair single="flavor" id="rescued-flavor">At some point in the past, you had a terrifyingly close brush with death. Maybe a goblin nearly killed you during an attack on the town, or perhaps a building struck by a giant's boulder collapsed around you. Whatever the peril was, you would have certainly died if not for the swift actions of Koya or Shalelu, who intervened just in time to save your life. You've never forgotten this, and remain fiercely loyal to the NPC who saved you. Perhaps even more importantly, the method in which she saved you seems to have had an impact on your own skills.</Pair>
<Pair single="benefit" id="rescued-benefit"><p>If Koya saved you, she did so by casting a healing spell on you just before you died, and as a result you gain a +2 trait bonus whenever you use <Link to="/main/cure_spells">cure spells</Link> to heal damage. If it was Shalelu who saved you, she did so by pulling you to safety while simultaneously defeating the peril that almost did you in, and as a result, you gain a +1 trait bonus on <Link to="/skill/acrobatics">Acrobatics</Link> checks and Acrobatics is a class skill for you.</p>
<p>In addition, you gain a +1 trait bonus on all attack rolls against foes that threaten your savior.</p>
<ul>
<li><strong>NPC Choices:</strong> Koya, Shalelu.</li>
</ul>
</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Jade Regent</Pair>
<Pair single="flavor" id="student-survivalist-flavor">Although she is seen as something of a mystery to most of Sandpoint's citizens, Shalelu has never really seemed all that mysterious to you. Of course, that's probably because she helped raise you. You have never quite figured out why Shalelu decided to treat you as a younger sibling, but you certainly appreciated it - and you eagerly absorbed all of the survivalist tricks that she showed you over the years.</Pair>
<Pair single="benefit" id="student-survivalist-benefit"><p>You gain a +2 trait bonus on all <Link to="/skill/survival">Survival</Link> checks, and Survival is a class skill for you. In addition, you gain a +1 trait bonus on all attack rolls against foes that threaten your mentor.</p>
<ul>
<li><strong>NPC Choices:</strong> Shalelu.</li>
</ul>
</Pair>
</Ability>
</>};
...
<p><strong>Note:</strong> Although you're a younger sibling of an established NPC, this doesn't necessarily lock you in to being the same race as that NPC - if you're a different race or ethnicity than the NPC you choose as your older sister or brother, you were adopted into the family by your parents.</p>
<p>In addition, you gain a +1 trait bonus on all attack rolls against foes that threaten your older sibling.</p>
</Pair>
</Ability>
</>};
...
<Pair single="flavor" id="bastard-km-flavor">One of your parents was a member of one of the great families of Brevoy, perhaps even of the line of Rogarvia itself. Yet you have no substantive proof of your nobility, and you've learned that claiming nobility without evidence makes you as good as a liar. While you might own a piece of jewelry, a scrap of once-rich fabric, or an aged confession of love, none of this directly supports your claim. Thus, you've lived your life in the shadow of nobility, knowing that you deserve the comforts and esteem of the elite, even though the contempt of fate brings you nothing but their scorn. Whether a recent attempt to prove your heritage has brought down the wrath of a noble family's henchmen or you merely seek to prove the worth of the blood in your veins, you've joined an expedition into the Stolen Lands, hoping to make a name all your own.</Pair>
<Pair single="benefit" id="bastard-km-benefit">You take a -1 penalty on all Charisma-based skill checks made when dealing with members of Brevic nobility but gain a +1 trait bonus on Will saves as a result of your stubbornness and individuality. (The penalty aspect of this trait is removed if you ever manage to establish yourself as a true noble.)</Pair>
</Ability>
</>};
...
<li><strong>Lodovka:</strong> Your family has made a living off the coasts of the Lake of Mists and Veils since before Brevoy existed. You gain a +1 trait bonus on <Link to="/skill/swim">Swim</Link> checks, and Swim is always treated as a class skill for you. Your family motto is "The Waters, Our Fields."</li>
<li><strong>Medvyed:</strong> Your family has long a deep respect for the wilderness and is superstitious about the creatures that dwell therein. You gain a +2 trait bonus on all <Link to="/skill/diplomacy">Diplomacy</Link> checks made to deal with fey creatures and a +1 trait bonus on Will saves made against their spells and supernatural abilities. Your family motto is "Endurance Overcomes All."</li>
<li><strong>Orlovsky:</strong> Your family has a reputation for avoiding conflicts. You gain a +1 trait bonus on your CMD. In addition, choose <Link to="/skill/acrobatics">Acrobatics</Link>, Diplomacy, or <Link to="/skill/stealth">Stealth</Link> - you gain a +1 trait bonus on this skill. Your family motto is "High Above."</li>
<li><strong>Surtova:</strong> Your family is well known for their political agility and scheming natures. You deal +2 damage when attacking a <Link to="/rule/flat_footed">flat-footed</Link> opponent while wielding a light or one-handed weapon. Your family motto is "Ours is the Right."</li>
</ul>
</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="sword-scion-benefit">You begin play with a <Link to="/eq-weapon/longsword">longsword</Link> or <Link to="/eq-weapon/aldori_dueling_sword">Aldori dueling sword</Link> and gain a +1 trait bonus on all attacks and combat maneuvers made with such weapons.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="gnoll-killer-benefit">You gain a +1 trait bonus on attack rolls and weapon damage rolls made against <Link to="/monster/gnoll">gnolls</Link>. If you are a barbarian and you're fighting gnolls, your rage lasts 1 round longer than normal. If you're a ranger and you select humanoid (gnoll) as a <Link to="/ability/favored_enemy">favored enemy</Link>, your trait bonus on attack rolls and weapon damage rolls against gnolls increases to +2. If you're a spellcaster, you gain a +1 trait bonus to spell save DCs for damaging spells against gnolls.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Legacy of Fire</Pair>
<Pair single="flavor" id="seeking-adventure-flavor">The <Link to="/rule/pathfinder_society">Pathfinder Society</Link> has long intrigued you  -tales of the exotic lands and strange discoveries made by Pathfinders have enchanted your dreams and fired your imagination since childhood. When Pathfinders came through your village or neighborhood, they immediately enthralled you with their stories and knowledge. Yet at the time, you were far too young to join them, and when they left for adventure you had to stay behind. Now that you are of age, you've traveled to Absalom to apply for membership. The application process went well, and you're now a full member. Your first assignment is to accompany Garavel's group to Kelmarane - the Pathfinder Society has heard rumors of several ancient structures in the area, including a ruined monastery once dedicated to Sarenrae, and would like to learn more about them. Even more pressing is the mystery of what brought about Kelmarane's ruin in the first place - reports of which are vague at best. If you can determine the cause of the village's abandonment so many years ago, you're sure the Society would be impressed.</Pair>
<Pair single="benefit" id="seeking-adventure-benefit">You begin the game with your own <Link to="/magic-wondrous/wayfinder">wayfinder</Link>, a loan from your venture-captain. you've promised to pay your venture-captain 500 gp for the wayfinder some day, but for now it's yours to use. A wayfinder is a magical compass that grants you a +2 circumstance bonus on <Link to="/skill/survival">Survival</Link> checks to avoid becoming lost, and can be commanded to emit <Link to="/spell/light">light</Link> as the spell (CL 5th) as a standard action.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="blood-of-pharaohs-benefit">You gain a +1 trait bonus on Will saves. You also gain a +1 trait bonus on <Link to="/skill/knowledge_nobility">Knowledge (nobility)</Link> checks and that skill is always a class skill for you. In addition, you may choose Ancient Osiriani as one of your bonus languages.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="foreign-opportunist-benefit">You gain a +2 trait bonus on <Link to="/skill/appraise">Appraise</Link> checks, and that skill is always a class skill for you. In addition, your contacts in the antiquities markets allow you to sell relics of Ancient Osirion for 60% of their listed price, rather than the normal 50% value. What is considered a relic of Ancient Osirion is left to the GM's discretion.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="mummy-cursed-benefit">You gain a +2 trait bonus on saving throws against curses and curse effects (including <Link to="/curse/mummy_rot">mummy rot</Link> and spells with the curse descriptor) and a +2 trait bonus on saving throws against a <Link to="/monster/mummy">mummy's</Link> <em>aura of despair.</em></Pair>
</Ability>
</>};
...
<Pair single="benefit" id="sphinx-riddler-benefit">You gain a +1 trait bonus on <Link to="/skill/bluff">Bluff</Link> and <Link to="/skill/diplomacy">Diplomacy</Link> checks against <Link to="/family/sphinx">sphinxes</Link>, and a +1 trait bonus on any skill check to decipher a puzzle or riddle. In addition, you may choose Sphinx as one of your bonus languages.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="trap-finder-benefit">You gain a +1 trait bonus on <Link to="/skill/disable_device">Disable Device</Link> checks, and that skill is always a class skill for you. In addition, you can use Disable Device to disarm magic traps, like a rogue.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="undead-crusader-benefit">You gain a +1 trait bonus on damage rolls against undead creatures. In addition, you gain a +1 trait bonus on <Link to="/skill/knowledge_religion">Knowledge (religion)</Link> checks, and that skill is always a class skill for you.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="wati-native-benefit">You gain a +2 trait bonus on saves against fear effects. In addition, your knowledge of the city grants you a +1 trait bonus on <Link to="/skill/knowledge_local">Knowledge (local)</Link> checks, and that skill is always a class skill for you.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="adaptive-magic-benefit">You gain a +1 trait bonus on <Link to="/skill/knowledge_arcana">Knowledge (arcana)</Link> and <Link to="/skill/use_magic_device">Use Magic Device</Link> checks, and Use Magic Device is a class skill for you.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="blood-of-giants-benefit">You gain a +1 trait bonus on combat maneuver checks to <Link to="/rule/sunder">sunder</Link>, and a +1 trait bonus to your CMD against <Link to="/rule/bull_rush">bull rush</Link> and <Link to="/rule/overrun">overrun</Link> combat maneuvers.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="failed-winter-witch-apprentice-benefit">You gain a +1 trait bonus on <Link to="/skill/knowledge_arcana">Knowledge (arcana)</Link> and <Link to="/skill/spellcraft">Spellcraft</Link> checks to identify spells or magical effects with the cold descriptor, and one of these skills (your choice) is a class skill for you. In addition, you learn Hallit or Skald (this does not count toward your number of languages).</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="northern-ancestry-benefit">You gain a +1 trait bonus on Fortitude saves, as well as cold <Link to="/umr/resistance">resistance</Link> 2; this resistance does not stack with cold resistance gained from any other source.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="restless-wayfarer-benefit">You gain a +1 trait bonus on <Link to="/skill/knowledge_geography">Knowledge (geography)</Link> and <Link to="/skill/knowledge_local">Knowledge (local)</Link> checks, and one of these skills (your choice) is a class skill for you. You can also speak one additional language (this does not count toward your number of languages).</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="vigilante-witch-hunter-benefit">You gain a +1 trait bonus on <Link to="/skill/sense_motive">Sense Motive</Link> checks, and Sense Motive is a class skill for you. In addition, you begin the campaign with 1d4 <Link to="/magic-wondrous/hex_nail">hex nails</Link>.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="warded-against-witchery-benefit">You gain a +1 trait bonus on saving throws against the spells, spell-like abilities, and supernatural abilities of evil arcane spellcasters, and a +1 trait bonus on <Link to="/skill/spellcraft">Spellcraft</Link> checks to identify spells cast by evil arcane spellcasters.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="time-lost-benefit"><p>You have a knack for knowing when to act a few instants in advance and gain a +2 trait bonus on Initiative checks.</p>
<p>Once per adventure as an <strong className="hl">immediate action</strong>, you may use your strange link to the flow of time to force the GM to reroll a single d20 roll. You must declare the use of this ability immediately after the GM rolls the d20, but you can choose to do so after learning the results of the roll.</p>
</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="eager-performer-benefit">You gain a +1 trait bonus on checks for any one <Link to="/skill/perform">Perform</Link> skill. Additionally, choose any one spell of the enchantment school; its save DC increases by +1.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="family-ties-rotrl-benefit">You gain a +1 trait bonus on <Link to="/skill/knowledge_local">Knowledge (local)</Link> checks and Knowledge (local) is always a class skill for you. In addition, you begin play able to speak and read Varisian.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Rise of the Runelords</Pair>
<Pair single="flavor" id="friends-and-enemies-flavor">One of your family members, perhaps a parent, cousin, aunt, or uncle, helped Daviren Hosk put down a group of goblins near Sandpoint. Since then, your family member passed away, but not before telling you about that day and the offer Daviren made her should she ever be in need.</Pair>
<Pair single="benefit" id="friends-and-enemies-benefit">Once you make it to Sandpoint and meet up with Daviren Hosk at the Goblin Squash Stables, he gives you one of his best steeds and all the necessary accoutrements as gratitude for your family member's help: a <Link to="/eq-misc/heavy_combat_trained_horse">heavy combat trained horse</Link>, a <Link to="/eq-misc/military_saddle">military saddle</Link>, <Link to="/eq-misc/saddlebags">saddlebags</Link>, <Link to="/eq-misc/bit_and_bridle">bit and bridle</Link>, a month's worth of <Link to="/eq-misc/animal_feed">feed</Link>, and lifetime stabling at the Goblin Squash Stables.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="giant-slayer-benefit">You gain a +1 trait bonus on <Link to="/skill/bluff">Bluff</Link>, <Link to="/skill/perception">Perception</Link>, and <Link to="/skill/sense_motive">Sense Motive</Link> checks and +1 trait bonus on attack rolls and damage rolls against creatures of the giant subtype.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="goblin-watcher-benefit">You gain a +1 trait bonus on <Link to="/skill/perception">Perception</Link> and <Link to="/skill/appraise">Appraise</Link> checks, and a +5 trait bonus on Appraise checks to determine the most valuable item visible in a treasure hoard.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Rise of the Runelords</Pair>
<Pair single="flavor" id="merchant-family-flavor">You are related to one of the four noble families from Magnimar who founded the Mercantile League of Sandpoint. You either grew up in Magnimar as a cousin in the Valdemar or Deverin family or were born and raised in Sandpoint. Education in running a business and years of looking after the family enterprise have given you a knack for trade.</Pair>
<Pair single="benefit" id="merchant-family-benefit">You increase the <Link to="/rule/purchasing_magic_items">gp limit of any settlement</Link> by 20% and can resell items at an additional 10% over the amount of gp you normally would get from selling off treasure.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Rise of the Runelords</Pair>
<Pair single="flavor" id="monster-hunter-flavor">Perhaps you came to the Varisian Gulf in search of the Sandpoint Devil, or maybe you followed fisherman's tales of Old Murdermaw; regardless, you've ventured through Varisia to hunt down famous monsters. While they have all eluded you so far, you made it to Sandpoint to research and restock before heading back out into the wilderness.</Pair>
<Pair single="benefit" id="monster-hunter-benefit">Because of your training, you gain a +1 trait bonus on attack rolls and weapon damage rolls against aberrations and magical beasts.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="sandpoint-faithful-benefit">You gain a <Link to="/eq-misc/silver_holy_symbol">silver holy symbol</Link> of your chosen deity, and so long as you worship that deity and openly wear his or her symbol, you regain +1 additional hit point every time you receive magical healing.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="scholar-of-the-ancients-benefit">You gain a +1 trait bonus on <Link to="/skill/knowledge_arcana">Knowledge (arcana)</Link> and <Link to="/skill/knowledge_history">Knowledge (history)</Link> checks, and begin play able to speak and read Thassilonian.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Rise of the Runelords</Pair>
<Pair single="flavor" id="student-of-faith-flavor">While you have personally dedicated your life to a single deity, you study all religions and mortal faiths. Upon hearing that the town of Sandpoint recently completed a cathedral dedicated to the six deities most popular in the area, you had to see the place for yourself, and have arrived in time for the consecration of this holy edifice.</Pair>
<Pair single="benefit" id="student-of-faith-benefit">Because of your strong faith and broad range of study, you cast all <Link to="/main/cure_spells">cure spells</Link> at +1 caster level, and whenever you <Link to="/ability/channel_energy">channel energy</Link>, you gain a +1 trait bonus to the save DC of your channeled energy.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Rise of the Runelords</Pair>
<Pair single="flavor" id="thrill-seeker-rotr-flavor">You've grown up in or around Sandpoint and are the heir to your family's modest farm, shop, or fishing boat, but You've always dreamed of more. Searching for a taste of excitement, You've come into town to participate in this year's Swallowtail festival.</Pair>
<Pair single="benefit" id="thrill-seeker-rotr-benefit">The thrill of danger grants you an additional +5 feet of movement during the first round of any combat. Additionally, you begin play with three <Link to="/eq-weapon/star_candle_fireworks">star candle fireworks</Link>.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="athletic-benefit">You reduce your armor check penalty by a number equal to one-third your character level (minimum 1) for purposes of <Link to="/skill/acrobatics">Acrobatics</Link>, <Link to="/skill/climb">Climb</Link>, and <Link to="/skill/swim">Swim</Link> checks, and you gain a +1 trait bonus to one of these three skills, chosen when you take this trait.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="azlanti-scholar-roapg-benefit">You gain a +1 trait bonus on <Link to="/skill/knowledge_history">Knowledge (history)</Link>, <Link to="/skill/knowledge_local">Knowledge (local)</Link>, and <Link to="/skill/use_magic_device">Use Magic Device</Link> checks, and one of these skills is a class skill for you. In addition, you gain Azlanti as a bonus language.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="eagle-knight-recruit-benefit">You begin play with a <Link to="/eq-armor/breastplate">breastplate</Link>, a <Link to="/eq-weapon/longsword">longsword</Link> (or some other martial or simple weapon), and an additional 100 gp of gear. In addition, you gain a +1 trait bonus on saving throws against mind-affecting effects.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="employee-benefit"><p>You begin play with an additional 150 gp of equipment and know (at least in some capacity) one of the other company employees: Lyra Heatherly, Perrell Beys, or Ramona Avandth.</p>
<p>Due to your association with the Bountiful Venture Company, your words and ideas may carry additional weight with the other employees of the company. (Your GM can grant a +1 circumstance bonus on <Link to="/skill/diplomacy">Diplomacy</Link> checks in regards to these people in certain situations.) In addition, you gain a +1 trait bonus on <Link to="/skill/bluff">Bluff</Link> checks, and Bluff is always a class skill for you.</p>
</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="expert-explorer-benefit">Choose one <Link to="/skill/knowledge">Knowledge</Link> skill when you gain this trait. You gain a +1 trait bonus to check with that Knowledge skill and <Link to="/skill/survival">Survival</Link> checks, and either that Knowledge skill or Survival is a class skill for you. In addition, you treat the <Link to="/eq-weapon/machete">machete</Link> as a simple weapon.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="following-in-the-footsteps-benefit">Whenever you use the <Link to="/rule/aid_another">aid another</Link> action to aid an adjacent ally, increase the bonus you grant your ally by 1. In addition, due to your positive and helpful nature, you gain a +1 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link> checks.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="resourceful-benefit"><p>Choose one <Link to="/skill/craft">Craft</Link> or <Link to="/skill/profession">Profession</Link> skill when you gain this trait. You gain a +1 trait bonus on checks with that skill.</p>
<p>In addition, the time required for you to create a magic item is decreased. You require only 8 hours for every 1,500 gp in the item's base price (instead of the normal 8 hours per 1,000 gp). You can create potions and scrolls whose base price is 375 gp in just 2 hours; potions and scrolls with a base price more than 375 gp but less than 1,500 gp take 8 hours to create, just like any other magic item.</p>
</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="set-mind-benefit">Once per day when you fail a saving throw against a charm or compulsion effect that would cause you to act differently than you normally would, you can immediately reroll that saving throw as a <strong className="hl">free action</strong>. You must take the second result, even if it's worse.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="skillful-benefit">Once per day when you fail an <Link to="/skill/acrobatics">Acrobatics</Link>, <Link to="/skill/climb">Climb</Link>, <Link to="/skill/spellcraft">Spellcraft</Link>, <Link to="/skill/stealth">Stealth</Link>, or <Link to="/skill/use_magic_device">Use Magic Device</Link> check, you can immediately reroll that check as a <strong className="hl">free action</strong>. You must take the second result, even if it's worse.</Pair>
</Ability>
</>};
...
<Pair single="flavor" id="daring-doomsayer-flavor">The end times are coming, and the shadow in the sky over Riddleport is just the first piece of proof. Convinced that the end of the world is nigh, you've decided to take part in the Golden Goblin's gambling tournament - after all, what do you have to lose?</Pair>
<Pair single="benefit" id="daring-doomsayer-benefit">Whenever you roll a 1 on an attack roll, you gain a +1 trait bonus on your next attack roll so long as it is made within 1 minute. You also begin play with a placard bearing an apocalyptic slogan of your choice; this wooden sign can be used as a <Link to="/eq-weapon/club">club</Link>.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="fixer-of-odds-benefit">You gain a +1 trait bonus on <Link to="/skill/profession">Profession</Link> (gambling) checks, and creatures searching you for objects hidden on your body don't gain the usual +4 bonus on their Perception checks. Additionally, you begin play with a "fixed" six-sided die (it has two 6s and no 1) and a <Link to="/eq-weapon/dagger">dagger</Link>.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="looking-for-work-benefit">Pick one of the following skills: <Link to="/skill/bluff">Bluff</Link>, <Link to="/skill/craft">Craft</Link> (any), <Link to="/skill/diplomacy">Diplomacy</Link>, <Link to="/skill/intimidate">Intimidate</Link>, <Link to="/skill/perform">Perform</Link> (any), <Link to="/skill/profession">Profession</Link> (gambler), or <Link to="/skill/perception">Perception</Link>. You gain a +1 trait bonus in that skill, and that skill is always considered a class skill for you.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Second Darkness</Pair>
<Pair single="flavor" id="optimistic-gambler-flavor">You've always seemed to have trouble keeping money. Worse, you always seem to have debts looming over your head. When you heard about the "Cheat the Devil and Take His Gold" gambling tournament, you felt in your gut that your luck was about to change. You've always been optimistic, in fact, and even though right now is one of those rare times where you don't owe anyone any money (you just paid off a recent loan from local moneylender Lymas Smeed), you know that'll change soon enough. Better to start amassing money now when you're at one of those rare windfall times! You've set aside a gold coin for the entrance fee, and look forward to making it big - you can feel it in your bones! This time's gonna be the big one! Your boundless optimism, even in the face of crushing situations, has always bolstered your spirit.</Pair>
<Pair single="benefit" id="optimistic-gambler-benefit">Effects that grant you morale bonuses persist 1d4 rounds longer than they normally would.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Second Darkness</Pair>
<Pair single="flavor" id="portentous-perception-flavor">You've come (or been sent) to Riddleport to observe the strange Blot that has appeared in the city's sky. You've decided to put your keen senses to the test at the Golden Goblin's upcoming gambling competition while you're here. Your sharp eyesight makes it easier for you to notice things at a distance.</Pair>
<Pair single="benefit" id="portentous-perception-benefit">For you, <Link to="/skill/perception">Perception</Link> checks only start increasing in difficulty at a range of 20 feet or farther, as opposed to the normal 10. This has no effect on checks made to perceive things within 10 feet.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Second Darkness</Pair>
<Pair single="flavor" id="scouting-for-fiends-flavor">You belong to an organization (most likely a religion) that has definite views on the menace posed by the lower planes. The willfulness with which the city of Korvosa (they even allow a temple of Asmodeus to operate in broad daylight!) tolerates infernal influences is, to you and your organization, the greatest symbol of what's wrong with civilization today. And now, in Riddleport, there's news that a gambling tournament is using devils and Hell as an idle decoration. It's likely that this is just an example of poor taste, but there's a chance that something sinister may be lurking beneath the goings-on at the Gold Goblin. You have been contacted by your organization (or may have decided on your own) to travel to Riddleport (if you don't already live there) and attend this tournament under the guise of a patron. Keep an eye on things there, even after the tournament is over; if you can, get a job working for the owner. Demons and devils can be subtle, and it could take weeks or even months to find proof of their involvement.</Pair>
<Pair single="benefit" id="scouting-for-fiends-benefit">Your near-obsessive hatred of all things fiendish grants you a +1 trait bonus on all attack rolls made against foes you know to be evil outsiders.</Pair>
</Ability>
</>};
...
<Pair single="flavor" id="boarded-in-cheliax-flavor">While you aren't necessarily a native of Cheliax, you boarded the Jenivere at one of that country's port cities. As the people of Cheliax generally know the Mwangi Expanse as a near legendary land home to strange beasts and exotic treasures, your views of the region have a distinctly romantic tinge, and the desire for fame, wealth, and adventure likely motivate your travels.</Pair>
<Pair single="benefit" id="boarded-in-cheliax-benefit">You begin the campaign with a detailed map of the Mwangi Expanse (this grants +2 competence bonus on all <Link to="/skill/knowledge_geography">Knowledge [geography]</Link> checks made regarding this region) and 200 gp worth of mundane equipment to aid your exploration of the jungle.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Serpent's Skull</Pair>
<Pair single="flavor" id="boarded-in-mediogalti-flavor">Your travels have brought you to the Jenivere through the dangerous port of Ilizmagorti, home to both pirates and assassins. Perhaps you're fleeing a price on your head, perhaps you've jumped ship from another vessel, or perhaps you're merely looking for a new start in a land where the dangers make themselves more obvious.</Pair>
<Pair single="benefit" id="boarded-in-mediogalti-benefit">Your familiarity with subtle slayings and toxins grants you a +2 trait bonus on all saves against poison. In addition, you can pick one type of poison listed below to be immune to, having undergone a long and painful process of building up an immunity to its effects: <Link to="/eq-poison/blue_whinnis">blue whinnis</Link>, <Link to="/eq-poison/giant_wasp_poison">giant wasp poison</Link>, <Link to="/eq-poison/medium_spider_venom">medium spider venom</Link>, <Link to="/eq-poison/small_centipede_poison">small centipede poison</Link>, or <em>spider vine poison</em> (a poison derived from a toxic plant native to the Mwangi Expanse).</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="boarded-in-mwangi-expanse-benefit">You gain Polyglot as a bonus language and receive a +1 trait bonus on all <Link to="/skill/knowledge_nature">Knowledge (nature)</Link> checks regarding the jungle.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="boarded-in-varisia-benefit">Choose to gain either a +2 trait bonus on all <Link to="/skill/bluff">Bluff</Link> checks made against inhabitants of the jungle, or treat your spells with the mind-affecting descriptor as being +1 caster level higher when cast against creatures and natives of the jungle.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="get-the-cargo-through-benefit">Your character's history as a merchant or mercenary has earned her a respectable living, and you begin the campaign with an additional 300 gp in starting wealth.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Serpent's Skull</Pair>
<Pair single="flavor" id="jenivere-crew-flavor">This trip to Eleder is just one of many in a long career as a sailor aboard the Jenivere and other cargo vessels. Whether you joined the crew with the hope of one day captaining your own ship, as the means of paying your way to a foreign port with sweat and blood, or as a slave or indentured servant, you now call the ship home.~~~Characters with this trait have likely been on the Jenivere since it departed Magnimar.</Pair>
<Pair single="benefit" id="jenivere-crew-benefit">Pick one of the following skills: <Link to="/skill/acrobatics">Acrobatics</Link>, <Link to="/skill/climb">Climb</Link>, <Link to="/skill/knowledge_nature">Knowledge (nature)</Link>, <Link to="/skill/knowledge_geography">Knowledge (geography)</Link>, <Link to="/skill/swim">Swim</Link>, or <Link to="/skill/survival">Survival</Link>. You gain a +1 trait bonus on that skill, and that skill is always treated as a class skill for you.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="mwangi-scholar-benefit">You gain Polyglot as a bonus language and receive a +1 trait bonus on all <Link to="/skill/knowledge_history">Knowledge (history)</Link> checks regarding the Mwangi Expanse.</Pair>
</Ability>
</>};
...
<Pair title="Type">Campaign</Pair>
<Pair title="Camapign" hl>Serpent's Skull</Pair>
<Pair single="flavor" id="stowaway-flavor">Not all passengers on seafaring vessels are legal or even known to the captain and crew, and the Jenivere is no exception. Whether too poor to book legal passage on the ship or fearing discovery by customs officials in your home port, you or an ally stowed away on the ship in secret. This may mean that the crew doesn't know you're on board, or perhaps they do now but didn't when the ship set sail.~~~Characters with this trait might have boarded the Jenivere at any port, but especially in the cities of the Shackles.</Pair>
<Pair single="benefit" id="stowaway-benefit">You gain a +1 trait bonus on <Link to="/skill/stealth">Stealth</Link> checks and <Link to="/skill/survival">Survival</Link> checks to find food.</Pair>
</Ability>
</>};
...
<Pair single="flavor" id="alabaster-outcast-flavor">You are a member of one of Magnimar's wealthiest families - or rather, you used to be. A falling-out left you disowned and disinherited. Now you hope to get away from the city and find fortune enough to shame your former kinsfolk - goals which led you to the <Link to="/rule/pathfinder_society">Pathfinder Society</Link>.</Pair>
<Pair single="benefit" id="alabaster-outcast-benefit">Despite your exile, your name still carries considerable weight in Magnimar, and you gain a +1 trait bonus on <Link to="/skill/diplomacy">Diplomacy</Link> and <Link to="/skill/intimidate">Intimidate</Link> checks made within the city. Additionally, you start play with a <Link to="/eq-misc/nobles_outfit">noble's outfit</Link>, a <Link to="/eq-misc/signet_ring">signet ring</Link>, and a single additional nonmagical item worth no more than 200 gp. Your last name is probably Derexhi, Kaddren, Mindurian, Niroden, Scarnetti, Valdemar, Vanderale, or Versade (but may be another of your choosing).</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="ex-sczarni-benefit">You gain a +2 trait bonus on <Link to="/skill/bluff">Bluff</Link> checks to pass hidden messages. Also, anytime you deliver a <Link to="/misc/coup_de_grace">coup de grace</Link>, you deal an additional 1d6 points of damage.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="exchange-agent-benefit"><p>To represent your experience in distant lands, choose a country other than Varisia as your homeland and gain one of the <Link to="/misc/languages">languages</Link> spoken in that country as a bonus language.</p>
<p>Additionally, choose one of the following skills: <Link to="/skill/handle_animal">Handle Animal</Link>, <Link to="/skill/knowledge_geography">Knowledge (geography)</Link>, <Link to="/skill/linguistics">Linguistics</Link>, or <Link to="/skill/survival">Survival</Link>. You gain a +1 trait bonus on checks made with this skill and it is always a class skill for you.</p>
</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="ruin-raider-benefit">You gain a +1 trait bonus on <Link to="/skill/appraise">Appraise</Link> checks. Additionally, you gain a +4 bonus on <Link to="/skill/perception">Perception</Link> checks made to distinguish statue-like creatures (like <Link to="/monster/caryatid_column">caryatid columns</Link> and <Link to="/monster/gargoyle">gargoyles</Link>) from actual sculptures.</Pair>
</Ability>
</>};
...
<li>You gain a +2 trait bonus on <Link to="/skill/intimidate">Intimidate</Link> checks to demoralize opponents.</li>
</ul>
</Pair>
</Ability>
</>};
