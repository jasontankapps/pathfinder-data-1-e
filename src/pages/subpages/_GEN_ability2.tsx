...
<Ability id="evolutionbasicmagic-basic-magic-sp-fn1" icon={["magic"]}>
...
<Ability id="evolutionbite-bite-ex-fn2" icon={["melee"]}>
...
<Ability id="evolutionbleed-bleed-ex-fn3" icon={["melee"]}>
...
<Ability id="evolutionclaws-claws-ex-fn2-2" icon={["melee"]}>
...
</aside><Ability id="evolutionclimb-climb-ex-fn2-3" icon={["power","boost"]}>
...
<Ability id="evolutiongills-gills-ex-fn2-4" icon={["power"]}>
...
<Ability id="evolutionhooves-hooves-ex-fn4" icon={["melee"]}>
...
<Ability id="evolutionimproveddamage-improved-damage-ex-fn2-5" icon={["boost"]}>
...
<Ability id="evolutionimprovednaturalarmor-improved-natural-armor-ex-fn2-6" icon={["def"]}>
...
<Ability id="evolutionlowlightvision-low-light-vision-ex-fn4-2" icon={["power"]}>
...
<Ability id="evolutionmagicattacks-magic-attacks-su-fn2-7" icon={["boost"]}>
...
<Ability id="evolutionmount-mount-ex-fn2-8" icon={["power"]}>
...
<Ability id="evolutionpincers-pincers-ex-fn2-9" icon={["melee"]}>
...
<Ability id="evolutionpounce-pounce-ex-fn2-10" icon={["melee"]}>
...
<Ability id="evolutionpull-pull-ex-fn2-11" icon={["melee"]}>
...
<Ability id="evolutionpush-push-ex-fn5" icon={["melee"]}>
...
<Ability id="evolutionreach-reach-ex-fn5-2" icon={["melee"]}>
...
<Ability id="evolutionresistance-resistance-ex-fn5-3" icon={["def"]}>
...
<Ability id="evolutionscent-scent-ex-fn5-4" icon={["power"]}>
...
<Ability id="evolutionskilled-skilled-ex-fn5-5" icon={["boost"]}>
...
<Ability id="evolutionslam-slam-ex-fn5-6" icon={["melee"]}>
...
<Ability id="evolutionslippery-slippery-ex-fn3-2" icon={["def","boost"]}>
...
<Ability id="evolutionsticky-sticky-ex-fn3-3" icon={["boost"]}>
...
<Ability id="evolutionsting-sting-ex-fn5-7" icon={["melee"]}>
...
<Ability id="evolutionswim-swim-ex-fn5-8" icon={["power","boost"]}>
...
<Ability id="evolutiontail-tail-ex-fn5-9" icon={["power","boost"]}>
...
<Ability id="evolutiontailslap-tail-slap-ex-fn5-10" icon={["melee"]}>
...
<Ability id="evolutiontentacle-tentacle-ex-fn5-11" icon={["melee"]}>
...
<Ability id="evolutionunnaturalaura-unnatural-aura-su-fn4-3" icon={["def"]}>
...
<Ability id="evolutionwingbuffet-wing-buffet-ex-fn5-12" icon={["melee"]}>
...
<Ability id="evolutionabilityincrease-ability-increase-ex-fn5-13" icon={["boost"]}>
...
<Ability id="evolutionalignmentsmite-alignment-smite-su-fn6" icon={["boost"]}>
...
<Ability id="evolutionchannelresistance-channel-resistance-ex-fn4-4" icon={["def"]}>
...
<Ability id="evolutionconstrict-constrict-ex-fn5-14" icon={["boost"]}>
...
<Ability id="evolutionenergyattacks-energy-attacks-su-fn7" icon={["boost"]}>
...
<Ability id="evolutionflight-flight-ex-or-su-fn7-2" icon={["power"]}>
...
<Ability id="evolutiongore-gore-ex-fn7-3" icon={["power"]}>
...
<Ability id="evolutiongrab-grab-ex-fn7-4" icon={["melee","boost"]}>
...
<Ability id="evolutionhead-head-ex-fn4-5" icon={["power"]}>
...
<Ability id="evolutionimmunity-immunity-su-fn7-5" icon={["def"]}>
...
<Ability id="evolutionkeenscent-keen-scent-ex-fn4-6" icon={["boost"]}>
...
<Ability id="evolutionlimbs-limbs-ex-fn7-6" icon={["power","boost"]}>
...
<Ability id="evolutionminormagic-minor-magic-sp-fn4-7" icon={["magic"]}>
...
<Ability id="evolutionpoison-poison-ex-fn7-7" icon={["melee"]}>
...
<Ability id="evolutionrake-rake-ex-fn7-8" icon={["melee"]}>
...
<Ability id="evolutionrend-rend-ex-fn7-9" icon={["melee"]}>
...
<Ability id="evolutionriderbond-rider-bond-ex-fn8" icon={["boost","power"]}>
...
<Ability id="evolutionshadowblend-shadow-blend-su-fn9" icon={["def"]}>
...
<Ability id="evolutionshadowform-shadow-form-su-fn9-2" icon={["def","boost","down"]}>
...
<Ability id="evolutionsickening-sickening-ex-fn3-4" icon={["def","aura"]}>
...
<Ability id="evolutiontrample-trample-ex-fn7-10" icon={["melee"]}>
...
<Ability id="evolutiontremorsense-tremorsense-ex-fn7-11" icon={["power"]}>
...
<Ability id="evolutiontrip-trip-ex-fn10" icon={["power"]}>
...
<Ability id="evolutionundeadappearance-undead-appearance-ex-fn4-8" icon={["down","boost"]}>
...
<Ability id="evolutionweapontraining-weapon-training-ex-fn10-2" icon={["melee"]}>
...
<Ability id="evolutionblindsense-blindsense-ex-fn10-3" icon={["power"]}>
...
<Ability id="evolutionburrow-burrow-ex-fn10-4" icon={["power"]}>
...
<Ability id="evolutioncelestialappearance-celestial-appearance-ex-fn6-2" icon={["power","def"]}>
...
<Ability id="evolutiondamagereduction-damage-reduction-su-fn10-5" icon={["def"]}>
...
<Ability id="evolutionfiendishappearance-fiendish-appearance-ex-fn3-5" icon={["power","def"]}>
...
<Ability id="evolutionfrightfulpresence-frightful-presence-ex-fn10-6" icon={["lower"]}>
...
<Ability id="evolutionmajormagic-major-magic-sp-fn11" icon={["magic"]}>
...
<Ability id="evolutionsacrifice-sacrifice-su-fn6-3" icon={["aid"]}>
...
<Ability id="evolutionseeindarkness-see-in-darkness-su-fn11-2" icon={["power"]}>
...
<Ability id="evolutionswallowwhole-swallow-whole-ex-fn10-7" icon={["melee"]}>
...
<Ability id="evolutionweb-web-ex-fn10-8" icon={["power","zap"]}>
...
<Ability id="evolutionblindsight-blindsight-ex-fn10-9" icon={["boost"]}>
...
<Ability id="evolutionbreathweapon-breath-weapon-su-fn10-10" icon={["cone","line"]}>
...
<Ability id="evolutiondimensiondoor-dimension-door-sp-fn11-3" icon={["magic"]}>
...
<Ability id="evolutionfasthealing-fast-healing-su-fn12" icon={["def"]}>
...
<Ability id="evolutionincorporealform-incorporeal-form-sp-fn11-4" icon={["power"]}>
...
<Ability id="evolutionlarge-large-ex-fn12-2" icon={["boost","def","down"]}>
...
<Ability id="evolutionlifesense-lifesense-su-fn11-5" icon={["power"]}>
...
<Ability id="evolutionnobreath-no-breath-ex-fn11-6" icon={["power","def"]}>
...
<Ability id="evolutionspellresistance-spell-resistance-ex-fn12-3" icon={["def"]}>
...
<Ability id="evolutionultimatemagic-ultimate-magic-sp-fn11-7" icon={["magic"]}>
...
<p>The following evolutions cost 1 point from the eidolon's evolution pool.</p>
<Ability id="unchevolutionbasicpsychicmagic-basic-psychic-magic-fn1" icon={["magic"]}>
...
<Ability id="unchevolutionbite-bite-ex-fn2" icon={["melee"]}>
...
<Ability id="unchevolutionclaws-claws-ex-fn2-2" icon={["melee"]}>
...
<p>If you are a quadruped (or have more than four legs), you can have claws on your feet. If you have claws on all of your feet, normally you can't use all of those claw attacks on your turn unless you have a special ability such as <Link to="/umr/pounce">pounce</Link> or <Link to="/umr/rake">rake</Link>.</p>
<p>Talons are much like claws, but go on a creature's feet, usually a bipedal creature (especially a flying bipedal creature such as a <Link to="/monster/giant_eagle">giant eagle</Link> or <Link to="/monster/harpy">harpy</Link>). An ability that grants you claw attacks cannot be used as if they were talon attacks (in other words, you can't "re-skin" the ability's game mechanics so you can use it on a different limb).</p>
</aside><Ability id="unchevolutionclimb-climb-ex-fn2-3" icon={["power","boost"]}>
...
<Ability id="unchevolutiongills-gills-ex-fn2-4" icon={["power"]}>
...
<Ability id="unchevolutionimproveddamage-improved-damage-ex-fn2-5" icon={["boost"]}>
...
<Ability id="unchevolutionimprovednaturalarmor-improved-natural-armor-ex-fn2-6" icon={["def"]}>
...
<Ability id="unchevolutionmagicattacks-magic-attacks-su-fn2-7" icon={["boost"]}>
...
<Ability id="unchevolutionmount-mount-ex-fn2-8" icon={["power"]}>
...
<Ability id="unchevolutionpincers-pincers-ex-fn2-9" icon={["melee"]}>
...
<Ability id="unchevolutionpull-pull-ex-fn2-10" icon={["melee"]}>
...
<Ability id="unchevolutionpush-push-ex-fn2-11" icon={["melee"]}>
...
<Ability id="unchevolutionreach-reach-ex-fn3" icon={["boost"]}>
...
<Ability id="unchevolutionresistance-resistance-ex-fn3-2" icon={["def"]}>
...
<Ability id="unchevolutionscent-scent-ex-fn3-3" icon={["power"]}>
...
<Ability id="unchevolutionsharedevolution-shared-evolution-su-fn4" icon={["power"]}>
...
<Ability id="unchevolutionskilled-skilled-ex-fn3-4" icon={["boost"]}>
...
<Ability id="unchevolutionslam-slam-ex-fn3-5" icon={["melee"]}>
...
<Ability id="unchevolutionsting-sting-ex-fn3-6" icon={["melee"]}>
...
<Ability id="unchevolutionswim-swim-ex-fn3-7" icon={["power","boost"]}>
...
<Ability id="unchevolutiontail-tail-ex-fn3-8" icon={["power","boost"]}>
...
<Ability id="unchevolutiontailslap-tail-slap-ex-fn3-9" icon={["melee"]}>
...
<Ability id="unchevolutiontentacle-tentacle-ex-fn3-10" icon={["melee"]}>
...
<Ability id="unchevolutiontentaclemass-tentacle-mass-ex-fn1-2" icon={["melee"]}>
...
<Ability id="unchevolutionwingbuffet-wing-buffet-ex-fn3-11" icon={["melee"]}>
...
<p>The following evolutions cost 2 points from the eidolon's evolution pool.</p>
<Ability id="unchevolutionabilityincrease-ability-increase-ex-fn3-12" icon={["boost"]}>
...
<Ability id="unchevolutionbloodfrenzy-blood-frenzy-ex-fn5" icon={["boost"]}>
...
<Ability id="unchevolutionconstrict-constrict-ex-fn3-13" icon={["boost"]}>
...
<Ability id="unchevolutionenergyattacks-energy-attacks-su-fn3-14" icon={["boost"]}>
...
<Ability id="unchevolutionextrafeat-extra-feat-ex-fn4-2" icon={["power"]}>
...
<Ability id="unchevolutionflight-flight-ex-or-su-fn6" icon={["power"]}>
...
<Ability id="unchevolutiongore-gore-ex-fn6-2" icon={["melee"]}>
...
<Ability id="unchevolutiongrab-grab-ex-fn6-3" icon={["melee","boost"]}>
...
<Ability id="unchevolutionimmunity-immunity-su-fn6-4" icon={["def"]}>
...
<Ability id="unchevolutionintermediatepsychicmagic-intermediate-psychic-magic-fn5-2" icon={["magic"]}>
...
<Ability id="unchevolutionlimbs-limbs-ex-fn6-5" icon={["power","boost"]}>
...
<Ability id="unchevolutionpoison-poison-ex-fn6-6" icon={["boost"]}>
...
<Ability id="unchevolutionrake-rake-ex-fn6-7" icon={["melee"]}>
...
<Ability id="unchevolutionrend-rend-ex-fn6-8" icon={["boost"]}>
...
<Ability id="unchevolutionsharedslot-shared-slot-su-fn4-3" icon={["power"]}>
...
<Ability id="unchevolutiontrample-trample-ex-fn6-9" icon={["melee","def"]}>
...
<Ability id="unchevolutiontremorsense-tremorsense-ex-fn6-10" icon={["power"]}>
...
<Ability id="unchevolutiontrip-trip-ex-fn6-11" icon={["melee"]}>
...
<Ability id="unchevolutionweapontraining-weapon-training-ex-fn6-12" icon={["power"]}>
...
<p>The following evolutions cost 3 points from the eidolon's evolution pool.</p>
<Ability id="unchevolutionadvancedpsychicmagic-advanced-psychic-magic-fn5-3" icon={["magic"]}>
...
<Ability id="unchevolutionalienconsciousness-alien-consciousness-ex-fn5-4" icon={["def"]}>
...
<Ability id="unchevolutionblindsense-blindsense-ex-fn7" icon={["power"]}>
...
<Ability id="unchevolutionburrow-burrow-ex-fn7-2" icon={["power"]}>
...
<Ability id="unchevolutiondamagereduction-damage-reduction-su-fn7-3" icon={["def"]}>
...
<Ability id="unchevolutionfrightfulpresence-frightful-presence-ex-fn7-4" icon={["lower"]}>
...
<Ability id="unchevolutionpounce-pounce-ex-fn7-5" icon={["melee"]}>
...
<Ability id="unchevolutionswallowwhole-swallow-whole-ex-fn7-6" icon={["melee"]}>
...
<Ability id="unchevolutionweb-web-ex-fn7-7" icon={["power","zap"]}>
...
<p>The following evolutions cost 4 points from the eidolon's evolution pool.</p>
<Ability id="unchevolutionamorphous-amorphous-ex-fn5-5" icon={["def"]}>
...
<Ability id="unchevolutionblindsight-blindsight-ex-fn7-8" icon={["power"]}>
...
<Ability id="unchevolutionbreathweapon-breath-weapon-su-fn7-9" icon={["cone","line"]}>
...
<Ability id="unchevolutiondisease-disease-fn5-6" icon={["boost"]}>
...
<Ability id="unchevolutionfasthealing-fast-healing-su-fn7-10" icon={["def"]}>
...
<Ability id="unchevolutionlarge-large-ex-fn8" icon={["boost","def","down"]}>
...
<Ability id="unchevolutionspellresistance-spell-resistance-ex-fn8-2" icon={["def"]}>
...
<Ability id="unchevolutionsuperiorpsychicmagic-superior-psychic-magic-fn5-7" icon={["magic"]}>
...
<hr/>
<Ability id="hexabominate-abominate-su-fn1" icon={["magic","lower"]}>
...
<Ability id="hexanimalservant-animal-servant-su-fn2" icon={["lower"]}>
...
<Ability id="hexcurseofnonviolence-curse-of-nonviolence-su-fn3" icon={["lower"]}>
...
<Ability id="hexdeathcurse-death-curse-su-fn4" icon={["lower"]}>
...
<Ability id="hexdeathinterrupted-death-interrupted-su-fn5" icon={["magic","aid"]}>
...
<Ability id="hexdireprophecy-dire-prophecy-su-fn6" icon={["lower"]}>
...
<Ability id="hexeternalslumber-eternal-slumber-su-fn4-2" icon={["lower"]}>
...
<Ability id="hexforcedreincarnation-forced-reincarnation-su-fn4-3" icon={["lower","magic"]}>
...
<Ability id="hexlaytorest-lay-to-rest-sp-fn3-2" icon={["magic","lower"]}>
...
<Ability id="hexlifegiver-life-giver-su-fn4-4" icon={["aid"]}>
...
<Ability id="hexnaturaldisaster-natural-disaster-su-fn4-5" icon={["magic"]}>
...
<Ability id="hexsummonspirit-summon-spirit-sp-fn7" icon={["magic"]}>
...
<Ability id="hexwitchshut-witchs-hut-su-fn7-2" icon={["magic"]}>
...
<Ability id="deeddeadeye-deadeye-ex-fn1" icon={["zap","boost"]}>
...
<Ability id="deedgunslingersdodge-gunslingers-dodge-ex-fn1-2" icon={["def"]}>
...
<Ability id="deedquickclear-quick-clear-ex-fn1-3" icon={["power"]}>
...
<Ability id="deedgunslingerinitiative-gunslinger-initiative-ex-fn1-4" icon={["boost","power"]}>
...
<Ability id="deedpistolwhip-pistol-whip-ex-fn2" icon={["melee"]}>
...
<Ability id="deedutilityshot-utility-shot-ex-fn2-2" extraClasses="hasSubs" icon={["ranged","aid"]}>
...
<Ability id="deeddeadshot-dead-shot-ex-fn2-3" icon={["ranged"]}>
...
<Ability id="deedstartlingshot-startling-shot-ex-fn2-4" icon={["lower"]}>
...
<Ability id="deedtargeting-targeting-ex-fn2-5" icon={["ranged","lower"]}>
...
<Ability id="deedbleedingwound-bleeding-wound-ex-fn3" icon={["down"]}>
...
<Ability id="deedexpertloading-expert-loading-ex-fn3-2" icon={["def"]}>
...
<Ability id="deedlightningreload-lightning-reload-ex-fn3-3" icon={["boost"]}>
...
<Ability id="deedevasive-evasive-ex-fn3-4" icon={["def"]}>
...
<Ability id="deedmenacingshot-menacing-shot-ex-fn3-5" icon={["aura","lower"]}>
...
<Ability id="deedslingersluck-slingers-luck-ex-fn3-6" icon={["def","boost","roll"]}>
...
<Ability id="deedcheatdeath-cheat-death-ex-fn3-7" icon={["def"]}>
...
<Ability id="deeddeathsshot-deaths-shot-ex-fn3-8" icon={["lower"]}>
...
<Ability id="deedstunningshot-stunning-shot-ex-fn3-9" icon={["lower"]}>
...
<Ability id="thundering-shot-ex" icon={["ranged","cone","lower"]}>
...
<Ability id="gruesome-parry-ex" icon={["ranged","def","melee"]}>
...
<Ability id="lethal-patience-ex" icon={["ranged","lower"]}>
...
<hr/>
<Ability id="hkdisciplinebrand-brand-sp-fn1" icon={["magic"]}>
...
<Ability id="hkdisciplinecallarmor-call-armor-su-fn2" icon={["def"]}>
...
<Ability id="hkdisciplinecensor-censor-su-fn1-2" icon={["lower"]}>
...
<Ability id="hkdisciplinecommand-command-sp-fn2-2" icon={["magic"]}>
...
<Ability id="hkdisciplinedispelchaos-dispel-chaos-sp-fn2-3" icon={["magic"]}>
...
<Ability id="hkdisciplinefavoredquarry-favored-quarry-ex-fn2-4" icon={["boost"]}>
...
<Ability id="hkdisciplinefearsomeness-fearsomeness-ex-fn3" icon={["lower"]}>
...
<Ability id="hkdisciplineinvokeglyph-invoke-glyph-sp-and-ex-fn4" icon={["magic","def"]}>
...
<Ability id="hkdisciplinementalintrusion-mental-intrusion-sp-fn2-5" icon={["magic"]}>
...
<Ability id="hkdisciplineonslaught-onslaught-su-fn3-2" icon={["boost"]}>
...
<Ability id="hkdisciplinepentamicfaith-pentamic-faith-ex-fn3-3" icon={["boost"]}>
...
<Ability id="hkdisciplineseekthetaken-seek-the-taken-fn5" icon={["magic"]}>
...
<Ability id="hkdisciplineshackle-shackle-su-fn3-4" icon={["lower"]}>
...
<Ability id="hkdisciplineshadowstep-shadow-step-sp-fn2-6" icon={["magic"]}>
...
<Ability id="hkdisciplinesummondevil-summon-devil-sp-fn3-5" icon={["magic"]}>
...
<Ability id="hkdisciplinesummonservantoflaw-summon-servant-of-law-sp-fn2-7" icon={["magic"]}>
...
<Ability id="hkdisciplinetrace-trace-su-fn2-8" icon={["magic"]}>
...
<Ability id="hkdisciplinetracker-tracker-sp-fn3-6" icon={["magic"]}>
...
<Ability id="hkdisciplineversatileintimidation-versatile-intimidation-ex-fn2-9" icon={["boost"]}>
...
<Ability id="hkdisciplinevigilance-vigilance-su-fn3-7" icon={["power"]}>
...
<Ability id="hkdisciplinewrack-wrack-su-fn3-8" icon={["touch"]}>
...
<hr/>
<Ability id="hexameliorating-ameliorating-su-fn1" icon={["aid","protect"]}>
...
<Ability id="hexauraofpurity-aura-of-purity-su-fn2" icon={["aura","aid"]}>
...
<Ability id="hexbeastofillomen-beast-of-ill-omen-su-fn3" icon={["lower"]}>
...
<Ability id="hexblight-blight-su-fn4" icon={["lower","touch"]}>
...
<Ability id="hexcackle-cackle-su-fn4-2-fn5-fn6-fn7-fn8" icon={["boost"]}>
...
<Ability id="hexcauldron-cauldron-ex-fn4-3" icon={["power","boost"]}>
...
<Ability id="hexpoisonsteep-poison-steep-sp-fn3-2" icon={["magic"]}>
...
<Ability id="hexwitchsbottle-witchs-bottle-su-fn9" icon={["magic"]}>
...
<Ability id="hexcharm-charm-su-fn4-4" icon={["power"]}>
...
<Ability id="hexchildscent-child-scent-ex-fn3-3" icon={["power"]}>
...
<Ability id="hexcitysight-city-sight-su-fn10" icon={["lower"]}>
...
<Ability id="hexcombathypnosis-combat-hypnosis-su-fn11" icon={["magic"]}>
...
<Ability id="hexcongeal-congeal-su-fn8-2" icon={["lower"]}>
...
<Ability id="hexcoven-coven-ex-fn4-5" icon={["boost"]}>
...
<Ability id="hexcursedwound-cursed-wound-fn12" icon={["lower"]}>
...
<Ability id="hexdarkapothecary-dark-apothecary-ex-fn11-2" icon={["boost"]}>
...
<Ability id="hexdeathcall-deathcall-su-fn13" icon={["lower","aura"]}>
...
<Ability id="hexdiscord-discord-su-fn5-2" icon={["lower"]}>
...
<Ability id="hexdisguise-disguise-sp-fn4-6" icon={["magic"]}>
...
<Ability id="hexdisruptconnection-disrupt-connection-su-fn6-2" icon={["lower"]}>
...
<Ability id="hexdistraction-distraction-su-fn7-2" icon={["lower"]}>
...
<Ability id="hexenemyground-enemy-ground-su-fn10-2" icon={["lower"]}>
...
<Ability id="hexevileye-evil-eye-su-fn4-7" icon={["lower"]}>
...
<Ability id="hexferalspeech-feral-speech-su-fn3-4" icon={["power"]}>
...
<Ability id="hexflight-flight-su-fn4-8" icon={["magic","boost"]}>
...
<Ability id="hexfloatinglotus-floating-lotus-su-fn14" icon={["magic","boost"]}>
...
<Ability id="hexfortune-fortune-su-fn4-9" icon={["roll","boost"]}>
...
<Ability id="hexgiftofconsumption-gift-of-consumption-su-fn15" icon={["lower"]}>
...
<div className="abilityGroup">
<Ability id="hexgreatergiftofconsumption-greater-gift-of-consumption-su-fn15-2" icon={["lower"]}>
...
<Ability id="hexhealing-healing-su-fn4-10" icon={["aid"]}>
...
<Ability id="hexheraldingbloom-heralding-bloom-su-fn14-2" icon={["magic"]}>
...
<Ability id="hexiceplant-iceplant-su-fn16" icon={["def"]}>
...
<Ability id="hexleshysummoning-leshy-summoning-su-fn16-2" icon={["boost","magic"]}>
...
<Ability id="hexminorprophecy-minor-prophecy-su-fn11-3" icon={["magic"]}>
...
<Ability id="hexmisfortune-misfortune-su-fn4-11" icon={["roll","lower"]}>
...
<Ability id="hexmotherseye-mothers-eye-su-fn17" icon={["power"]}>
...
<Ability id="hexmurksight-murksight-su-fn8-3" icon={["power"]}>
...
<Ability id="hexnails-nails-ex-fn3-5" icon={["melee"]}>
...
<Ability id="hexnoplacelikehome-no-place-like-home-su-fn10-3" icon={["protect","lower"]}>
...
<Ability id="hexpeacebond-peacebond-su-fn2-2" icon={["lower"]}>
...
<Ability id="hexpoisontouch-poison-touch-ex-fn15-3" icon={["melee"]}>
...
<Ability id="hexpollutewater-pollute-water-su-fn8-4" icon={["magic","lower"]}>
...
<div className="abilityGroup">
<Ability id="hexpollutingglance-polluting-glance-su-fn8-5" icon={["magic","lower"]}>
...
<Ability id="hexprehensilehair-prehensile-hair-su-fn3-6" icon={["melee"]}>
...
<Ability id="hexprotectiveluck-protective-luck-su-fn7-3" icon={["roll","protect"]}>
...
<Ability id="hexscar-scar-su-fn3-7" icon={["lower"]}>
...
<Ability id="hexseduction-seduction-su-fn17-2" icon={["lower"]}>
...
<Ability id="hexsink-sink-su-fn8-6" icon={["lower"]}>
...
<Ability id="hexslumber-slumber-su-fn4-12" icon={["magic"]}>
...
<Ability id="hexsoothsayer-soothsayer-su-fn18-fn7-4" icon={["boost"]}>
...
<Ability id="hexsummersheat-summers-heat-su-fn10-4" icon={["lower"]}>
...
<Ability id="hexswamphag-swamp-hag-sp-fn19" icon={["power","def"]}>
...
<div className="abilityGroup">
<Ability id="hexmudwitch-mud-witch-su-fn20" icon={["magic","def"]}>
...
<Ability id="hexswampsgrasp-swamps-grasp-fn12-2" icon={["power"]}>
...
<Ability id="hexswine-swine-su-fn11-4" icon={["magic","lower"]}>
...
<Ability id="hextongues-tongues-su-fn21" icon={["power"]}>
...
<Ability id="hexunnervebeasts-unnerve-beasts-su-fn19-2" icon={["lower"]}>
...
<Ability id="hexverdantfamiliar-verdant-familiar-ex-fn16-3" icon={["power"]}>
...
<Ability id="hexward-ward-su-fn21-2" icon={["protect"]}>
...
<Ability id="hexwaterlung-water-lung-su-fn19-3" icon={["power"]}>
