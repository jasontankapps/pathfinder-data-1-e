...
<Ability id="armor-piercer-ex" icon={["lower"]}>
...
<Ability id="befuddling-strike-ex" icon={["lower"]}>
...
<Ability id="bleeding-attack-ex" icon={["boost"]}>
...
<Ability id="distracting-attack-ex" icon={["lower"]}>
...
<Ability id="emboldening-strike-ex" icon={["def"]}>
...
<Ability id="extinguishing-strike-ex" icon={["magic"]}>
...
<Ability id="focusing-attack-ex" icon={["def"]}>
...
<Ability id="obscuring-blow-ex" icon={["lower"]}>
...
<Ability id="offensive-defense-ex" icon={["def"]}>
...
<Ability id="powerful-sneak-ex" icon={["down","boost"]}>
...
<Ability id="powerful-sneak-unchained-rogue-ex" icon={["down","boost"]}>
...
<Ability id="sacred-sneak-attack-su" icon={["boost"]}>
...
<Ability id="sever-alignment-su" icon={["lower"]}>
...
<Ability id="shadows-chill-su" icon={["boost"]}>
...
<Ability id="silencing-strike-su" icon={["lower"]}>
...
<Ability id="slow-reactions-ex" icon={["lower"]}>
...
<Ability id="sneaky-maneuver-ex" icon={["melee"]}>
...
<Ability id="stem-the-flow-su" icon={["lower"]}>
...
<Ability id="underhanded-ex" icon={["boost"]}>
...
<Ability id="aligned-sneak-attack-su" icon={["lower"]}>
...
<Ability id="careful-stab-ex" icon={["power"]}>
...
<Ability id="demand-attention-ex" icon={["lower"]}>
...
<Ability id="disabling-stunt-ex" icon={["boost"]}>
...
<Ability id="fast-getaway-ex" icon={["power"]}>
...
<Ability id="set-up-ex" icon={["lower"]}>
...
<Ability id="sneak-training-ex" icon={["boost"]}>
...
<Ability id="snipers-eye-ex" icon={["boost"]}>
...
<Ability id="surprise-attack-ex" icon={["lower"]}>
...
<Ability id="surprise-attack-unchained-rogue-ex" icon={["lower","boost"]}>
...
<Ability id="swimming-stunt-ex" icon={["lower"]}>
...
<Ability id="accurate-poisoner-ex" icon={["boost"]}>
...
<Ability id="developed-poison-immunity-ex" icon={["def"]}>
...
<Ability id="iron-guts-ex" icon={["def"]}>
...
<Ability id="knockout-queen-ex" icon={["power"]}>
...
<Ability id="lasting-poison-ex" icon={["boost","down"]}>
...
<Ability id="lasting-poison-unchained-rogue-ex" icon={["boost","down"]}>
...
<Ability id="lingering-poison-ex" icon={["power"]}>
...
<Ability id="signature-poison-ex" icon={["boost"]}>
...
<Ability id="suppress-poison-ex" icon={["def"]}>
...
<Ability id="swift-poison-ex" icon={["boost"]}>
...
<Ability id="toxic-regurgitation-ex" icon={["zap"]}>
...
<Ability id="deadly-scratch-ex" icon={["power"]}>
...
<Ability id="disarming-luck-ex" icon={["def","roll"]}>
...
<Ability id="graceful-faller-ex" icon={["power"]}>
...
<Ability id="nimble-climber-ex" icon={["boost"]}>
...
<Ability id="single-minded-appraiser-ex" icon={["power"]}>
...
<Ability id="vicious-claws-ex" icon={["boost"]}>
...
<Ability id="cloying-shades-su" icon={["lower"]}>
...
<Ability id="extra-earthcraft" icon={["boost"]}>
...
<Ability id="minor-magic-sp" icon={["magic"]}>
...
<Ability id="demon-lantern-sp" icon={["magic"]}>
...
<Ability id="gloom-magic-sp" icon={["magic"]}>
...
<Ability id="greater-gloom-magic-sp" icon={["magic"]}>
...
<Ability id="innocent-facade-sp" icon={["magic"]}>
...
<Ability id="major-magic-sp" icon={["magic"]}>
...
<Ability id="one-of-those-faces-sp" icon={["magic"]}>
...
<Ability id="shadow-duplicate-sp" icon={["def"]}>
...
<Ability id="wild-magic-sp" icon={["magic"]}>
...
<Ability id="expert-cypher-ex" icon={["boost"]}>
...
<Ability id="occult-dungeoneer-su" icon={["magic","boost"]}>
...
<Ability id="spell-storing-su" icon={["magic"]}>
...
<Ability id="the-whole-time-su" icon={["magic","def"]}>
...
<Ability id="aspexias-mysticism-ex" icon={["power"]}>
...
<Ability id="black-market-connection-ex" icon={["boost"]}>
...
<Ability id="bomber-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="bombers-discovery-su" icon={["power"]}>
...
<Ability id="eldritch-conduit-su" icon={["magic"]}>
...
<Ability id="follow-along-ex" icon={["lower"]}>
...
<Ability id="grig-jig-su" icon={["magic"]}>
...
<Ability id="scry-slip-su" icon={["def"]}>
...
<Ability id="scrying-familiarity-ex" icon={["def","roll"]}>
...
<Ability id="shades-of-gray-ex" icon={["def"]}>
...
<Ability id="umbral-gear-su" icon={["magic"]}>
...
<Ability id="acrobatic-assist-ex" icon={["boost","protect"]}>
...
<Ability id="assault-leader-ex" icon={["melee"]}>
...
<Ability id="got-your-back-ex" icon={["boost"]}>
...
<Ability id="heads-up-ex" icon={["boost"]}>
...
<Ability id="sacrifice-self-ex" icon={["protect"]}>
...
<Ability id="shove-aside-ex" icon={["protect"]}>
...
<Ability id="acrobatic-stunt-ex" icon={["def","down"]}>
...
<Ability id="ambuscading-grapple-ex" icon={["melee"]}>
...
<Ability id="card-sharp-su" icon={["power","ranged"]}>
...
<Ability id="castling-ex" icon={["def"]}>
...
<Ability id="combat-swipe" icon={["power"]}>
...
<Ability id="combat-trick" icon={["power"]}>
...
<Ability id="deft-palm-ex" icon={["power"]}>
...
<Ability id="disease-use" icon={["power","melee"]}>
...
<Ability id="eerie-disappearance-ex" icon={["power"]}>
...
<Ability id="escaping-stunt-ex" icon={["def"]}>
...
<Ability id="false-attacker-ex" icon={["power"]}>
...
<Ability id="feint-from-shadows-ex" icon={["lower"]}>
...
<Ability id="finesse-rogue" icon={["power"]}>
...
<Ability id="firearm-training-ex" icon={["power"]}>
...
<Ability id="flying-stunt-ex" icon={["boost"]}>
...
<Ability id="fortified-position-ex" icon={["def"]}>
...
<Ability id="maneuvering-dodge-ex" icon={["boost"]}>
...
<Ability id="mien-of-despair-su" icon={["lower"]}>
...
<Ability id="positioning-attack-ex" icon={["melee"]}>
...
<Ability id="resiliency-ex" icon={["aid"]}>
...
<Ability id="rogue-crawl-ex" icon={["power"]}>
...
<Ability id="rogue-crawl-unchained-rogue-ex" icon={["power","boost","def"]}>
...
<Ability id="sleight-of-hand-stunt-ex" icon={["power"]}>
...
<Ability id="snap-shot-ex" icon={["ranged"]}>
...
<Ability id="stand-up-ex" icon={["power"]}>
...
<Ability id="stand-up-unchained-rogue-ex" icon={["power"]}>
...
<Ability id="stealth-stunt-ex" icon={["lower"]}>
...
<Ability id="superior-sniper" icon={["power"]}>
...
<Ability id="unbalancing-trick-ex" icon={["power"]}>
...
<Ability id="underhanded-trick" icon={["power"]}>
...
<Ability id="weapon-training" icon={["power"]}>
...
<Ability id="without-a-trace-ex" icon={["def"]}>
...
<Ability id="canny-observer-ex" icon={["boost"]}>
...
<Ability id="cunning-trigger-ex" icon={["power"]}>
...
<Ability id="quick-trapsmith-ex" icon={["power"]}>
...
<Ability id="trap-spotter-ex" icon={["power"]}>
...
<Ability id="fast-picks-ex" icon={["boost"]}>
...
<Ability id="hairpin-trick-ex" icon={["boost"]}>
...
<Ability id="last-ditch-effort" icon={["def"]}>
...
<Ability id="papercraft-tools-ex" icon={["power"]}>
...
<Ability id="quick-disable-ex" icon={["boost"]}>
...
<Ability id="quick-disable-unchained-rogue-ex" icon={["boost"]}>
...
<Ability id="camouflage-ex" icon={["power","def"]}>
...
<Ability id="charmer-ex" icon={["roll"]}>
...
<Ability id="coax-information-ex" icon={["boost"]}>
...
<Ability id="convincing-lie-ex" icon={["boost"]}>
...
<Ability id="dampen-presence" icon={["power"]}>
...
<Ability id="face-in-the-crowd" icon={["boost"]}>
...
<Ability id="false-friend-ex" icon={["boost"]}>
...
<Ability id="fast-fingers-ex" icon={["roll"]}>
...
<Ability id="fast-stealth-ex" icon={["boost"]}>
...
<Ability id="honeyed-words-ex" icon={["roll"]}>
...
<Ability id="innocuous-servant-ex" icon={["boost"]}>
...
<Ability id="just-a-face-in-the-crowd-su" icon={["boost"]}>
...
<Ability id="obfuscate-story-ex" icon={["lower"]}>
...
<Ability id="steal-the-story-ex" icon={["lower"]}>
...
<Ability id="quick-disguise-ex" icon={["boost"]}>
...
<Ability id="rapid-boost-ex" icon={["roll"]}>
...
<Ability id="sczarni-smuggler-ex" icon={["power","boost"]}>
...
<Ability id="scavenger" icon={["power","boost"]}>
...
<Ability id="terrain-mastery-ex" icon={["power"]}>
...
<Ability id="bardic-pretender-ex" icon={["power"]}>
...
<Ability id="certainty-ex" icon={["roll"]}>
...
<Ability id="claimed-turf-ex" icon={["power"]}>
...
<Ability id="climbing-stunt-ex" icon={["power"]}>
...
<Ability id="esoteric-scholar-ex" icon={["power"]}>
...
<Ability id="expert-leaper-ex" icon={["boost","def"]}>
...
<Ability id="expert-leaper-unchained-rogue-ex" icon={["boost","def"]}>
...
<Ability id="follow-clues-ex" icon={["boost"]}>
...
<Ability id="getaway-artist-ex" icon={["skill","boost"]}>
...
<Ability id="graceful-athlete" icon={["power"]}>
...
<Ability id="green-tongue-ex" icon={["power"]}>
...
<Ability id="guileful-polyglot-ex" icon={["power"]}>
...
<Ability id="hard-to-fool-ex" icon={["roll"]}>
...
<Ability id="ki-pool-ex" icon={["power","boost"]}>
...
<Ability id="ledge-walker-ex" icon={["power","def"]}>
...
<Ability id="ledge-walker-unchained-rogue-ex" icon={["boost","def"]}>
...
<Ability id="multitalented-ex" icon={["power"]}>
...
<Ability id="nimble-climber-ex" icon={["def"]}>
<Pair single id="nimble-climber-ex">Nimble Climber (Ex)</Pair>
...
<Ability id="ninja-trick-ex" icon={["power"]}>
...
<Ability id="peerless-maneuver-ex" icon={["roll"]}>
...
<Ability id="philologist" icon={["roll","boost"]}>
...
<Ability id="quick-scrounge" icon={["boost"]}>
...
<Ability id="rapid-perception-su" icon={["boost"]}>
...
<Ability id="riding-stunt-ex" icon={["boost"]}>
...
<Ability id="rope-master-ex" icon={["boost"]}>
...
<Ability id="strong-impression" icon={["power"]}>
...
<Ability id="strong-stroke-ex" icon={["roll","boost"]}>
...
<Ability id="survivalist" icon={["skill"]}>
...
<Ability id="thrill-of-the-chase-ex" icon={["roll","power"]}>
...
<Ability id="wall-scramble-ex" icon={["roll","boost"]}>
...
<Ability id="confounding-blades-ex" icon={["lower"]}>
...
<Ability id="crippling-strike-ex" icon={["lower"]}>
...
<Ability id="deadly-sneak-ex" icon={["boost"]}>
...
<Ability id="deadly-sneak-unchained-rogue-ex" icon={["roll"]}>
...
<Ability id="dispelling-attack-su" icon={["lower"]}>
...
<Ability id="double-debilitation-ex" icon={["lower"]}>
...
<Ability id="entanglement-of-blades-ex" icon={["lower"]}>
...
<Ability id="hamstring-strike-ex" icon={["lower"]}>
...
<Ability id="harrow-strike-ex" icon={["lower"]}>
...
<Ability id="improved-shadows-chill-su" icon={["boost"]}>
...
<Ability id="resonating-rumbles-su" icon={["lower"]}>
...
<Ability id="aligned-disguise-sp" icon={["def"]}>
...
<Ability id="founders-blessing" icon={["boost"]}>
...
<Ability id="glib-facade-sp" icon={["magic"]}>
...
<Ability id="hidden-mind-ex" icon={["def"]}>
...
<Ability id="slippery-mind-ex" icon={["def"]}>
...
<Ability id="against-the-wall-ex" icon={["boost"]}>
...
<Ability id="another-day-ex" icon={["def","down"]}>
...
<Ability id="blinding-strike" icon={["power"]}>
...
<Ability id="dance-of-disorienting-shadows-ex" icon={["melee"]}>
...
<Ability id="deadly-cocktail-ex" icon={["power"]}>
...
<Ability id="fast-tumble-ex" icon={["boost"]}>
...
<Ability id="grazing-shot-ex" icon={["ranged"]}>
...
<Ability id="hard-minded-ex" icon={["def"]}>
...
<Ability id="hunters-surprise-ex" icon={["boost"]}>
...
<Ability id="knock-out-blow-ex" icon={["lower"]}>
...
<Ability id="light-walker-ex" icon={["boost","power"]}>
...
<Ability id="opportunist-ex" icon={["power"]}>
...
<Ability id="quick-shot-ex" icon={["ranged"]}>
...
<Ability id="redirect-attack-ex" icon={["def"]}>
...
<Ability id="reflexive-shadow-shield-su" icon={["def"]}>
...
<Ability id="shrinewalk-sp" icon={["power","magic"]}>
...
<Ability id="stealthy-sniper-ex" icon={["boost"]}>
...
<Ability id="unwitting-ally-ex" icon={["power"]}>
...
<Ability id="weapon-snatcher-ex" icon={["melee"]}>
...
<Ability id="cutting-edge-ex" icon={["power"]}>
...
<Ability id="frugal-trapsmith-ex" icon={["boost"]}>
...
<Ability id="hide-in-plain-sight-ex" icon={["power","def"]}>
...
<Ability id="greater-multitalented-ex" icon={["power"]}>
...
<Ability id="pierce-the-darkness-ex" icon={["power"]}>
...
<Ability id="rumormonger-ex" icon={["power"]}>
...
<Ability id="skill-mastery" icon={["boost"]}>
...
<Ability id="stalker-talent" icon={["power"]}>
...
<Ability id="stony-skin-ex" icon={["def"]}>
...
<Ability id="greater-terrain-mastery-ex" icon={["boost"]}>
...
<Ability id="thoughtful-reexamining-ex" icon={["roll"]}>
...
<Ability id="unlock-ki-su" icon={["boost"]}>
