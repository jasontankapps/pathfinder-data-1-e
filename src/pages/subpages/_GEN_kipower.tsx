...
<Ability id="action-before-thought-ex" icon={["roll"]}>
...
<Ability id="breaking-down-koan-su" icon={["lower"]}>
...
<Ability id="building-up-koan-su" icon={["def","boost","down"]}>
...
<Ability id="master-thought-koan-su" icon={["boost"]}>
...
<Ability id="cobra-breath-su" icon={["zap"]}>
...
<Ability id="diamond-mind-su" icon={["def"]}>
...
<Ability id="diamond-resilience-ex" icon={["def"]}>
...
<Ability id="ki-volley-su" icon={["def","magic"]}>
...
<Ability id="elemental-fury-su" icon={["melee","boost"]}>
...
<Ability id="elemental-burst-su" icon={["cone"]}>
...
<Ability id="feather-balance-ex" icon={["boost"]}>
...
<Ability id="light-steps-ex" icon={["boost"]}>
...
<Ability id="floating-breath-su" icon={["magic"]}>
...
<Ability id="formless-mastery-ex" icon={["def","boost"]}>
...
<Ability id="freedom-of-movement-su" icon={["magic"]}>
...
<Ability id="furious-defense-ex" icon={["def"]}>
...
<Ability id="wind-jump-su" icon={["power"]}>
...
<Ability id="improvised-weapon-proficiency-ex-su" icon={["boost"]}>
...
<Ability id="insightful-wisdom-su" icon={["protect"]}>
...
<Ability id="ki-blocker-su" icon={["lower"]}>
...
<Ability id="ki-guardian-su" icon={["protect"]}>
...
<Ability id="ki-meditation-su" icon={["boost"]}>
...
<Ability id="ki-metabolism-su" icon={["def","power"]}>
...
<Ability id="ki-mount-su" icon={["aid"]}>
...
<Ability id="ki-range-su" icon={["ranged","boost"]}>
...
<Ability id="ki-sunder-ex" icon={["boost"]}>
...
<Ability id="bare-hand-block-ex" icon={["melee"]}>
...
<Ability id="ki-visions-su" icon={["power"]}>
...
<Ability id="one-touch-ex" icon={["touch"]}>
...
<Ability id="qinggong-power-su" icon={["power"]}>
...
<Ability id="quivering-palm-su" icon={["lower"]}>
...
<Ability id="racing-current-su" icon={["magic"]}>
...
<Ability id="slow-fall-su" icon={["def"]}>
...
<Ability id="sudden-speed-su" icon={["boost"]}>
...
<Ability id="branch-runner-ex-su" icon={["boost"]}>
...
<Ability id="ki-hurricane-ex" icon={["power","melee"]}>
...
<Ability id="water-sprint-su" icon={["magic"]}>
...
<Ability id="wholeness-of-body-su" icon={["aid"]}>
...
<Ability id="zephyr-blow-su" icon={["magic"]}>
