...
<Ability id="powerful-strike-ex" icon={["boost","power"]}>
...
<Ability id="aura-of-fury-su" icon={["aura","boost","down"]}>
...
<Ability id="ferocious-mien-su" icon={["boost","power"]}>
...
<Ability id="furious-wail-su" icon={["magic"]}>
...
<Ability id="iron-will" icon={["power"]}>
...
<Ability id="dutiful-strike-su" icon={["boost"]}>
...
<Ability id="defending-aura-su" icon={["aura","protect"]}>
...
<Ability id="devoted-servant-su" icon={["protect"]}>
...
<Ability id="steadfast-devotion-su" icon={["def"]}>
...
<Row><Cell>Good Saves</Cell><Cell>Fortitude and Will</Cell></Row></Block>
<Ability id="power-from-despair" icon={["boost"]}>
...
<Ability id="miserable-strike-su" icon={["lower"]}>
...
<Ability id="aura-of-despair-su" icon={["aura","lower"]}>
...
<Ability id="despairing-shout-su" icon={["magic"]}>
...
<Ability id="inescapable-despair-su" icon={["boost"]}>
...
<Row><Cell>Good Saves</Cell><Cell>Reflex and Will</Cell></Row></Block>
<Ability id="combat-reflexes" icon={["power"]}>
...
<Ability id="frantic-grip-ex" icon={["boost","def"]}>
...
<Ability id="clutch-of-terror-su" icon={["ranged"]}>
...
<Ability id="burst-of-desperation-sp" icon={["boost"]}>
...
<Row><Cell>Skills</Cell><Cell>The phantom gains a number of ranks in <Link to="/skill/intimidate">Intimidate</Link> and <Link to="/skill/stealth">Stealth</Link> equal to its Hit Dice. While confined in its spiritualist's consciensness, it grants the spiritualist <Link to="/feat/skill_focus">Skill Focus</Link> in each of those skills.</Cell></Row>
<Row><Cell>Good Saves</Cell><Cell>Reflex and Will</Cell></Row></Block>
<Ability id="stealthy" icon={["power"]}>
...
<Ability id="horrifying-strike-ex" icon={["lower"]}>
...
<Ability id="increase-fear-su" icon={["aura","lower"]}>
...
<Ability id="frightful-attack-su" icon={["lower"]}>
...
<Ability id="shelter-allies-su" icon={["protect"]}>
...
<Ability id="eye-of-avarice" icon={["boost"]}>
...
<Ability id="assume-effect-su" icon={["boost"]}>
...
<Ability id="take-it-with-you-su" icon={["magic"]}>
...
<Ability id="hated-target-su" icon={["boost","down"]}>
...
<Ability id="shared-hatred-su" icon={["boost"]}>
...
<Ability id="jealous-combatant-su" icon={["lower"]}>
...
<Ability id="retribution-su" icon={["boost"]}>
...
<Ability id="mine-to-take-su" icon={["protect"]}>
...
<Row><Cell>Good Saves</Cell><Cell>Fortitude and Will</Cell></Row></Block>
<Ability id="benevolent" icon={["boost"]}>
...
<Ability id="opening-strike-su" icon={["melee"]}>
...
<Ability id="etheric-healing-su" icon={["power"]}>
...
<Ability id="expanded-aid-su" icon={["boost","aid"]}>
...
<Ability id="exceptional-aid-su" icon={["boost"]}>
...
<Row><Cell>Good Saves</Cell><Cell>Fortitude and Will</Cell></Row></Block>
<Ability id="constitution-focus" icon={["boost"]}>
...
<Ability id="alluring-presence-su" icon={["protect"]}>
...
<Ability id="mine-alone-su" icon={["def","roll"]}>
...
<Ability id="aura-of-ecstasy-su" icon={["aura","lower"]}>
...
<Ability id="sinful-command-su" icon={["magic"]}>
...
<Row><Cell>Good Saves</Cell><Cell>Reflex and Will</Cell></Row></Block>
<Ability id="resolve" icon={["def","down"]}>
...
<Ability id="flagrant-disregard-ex" icon={["boost","def"]}>
...
<Ability id="vainglorious-oration-su" icon={["lower"]}>
...
<Ability id="overwhelming-confidence-su" icon={["boost","down"]}>
...
<Ability id="illusion-of-perfection-su" icon={["boost"]}>
...
<Row><Cell>Good Saves</Cell><Cell>Fortitude and Will</Cell></Row></Block>
<Ability id="antagonistic" icon={["power"]}>
...
<Ability id="long-suffering-strike-su" icon={["lower"]}>
...
<Ability id="aura-of-regret-su" icon={["aura","lower"]}>
...
<Ability id="keening-su" icon={["cone"]}>
...
<Ability id="utter-misery-su" icon={["boost"]}>
...
<Ability id="repelling-strike-ex" icon={["melee"]}>
...
<Ability id="numbing-aura-su" icon={["aura","protect"]}>
...
<Ability id="suffer-in-stead-su" icon={["aid"]}>
...
<Ability id="willing-martyr-su" icon={["protect"]}>
...
<Row><Cell>Skills</Cell><Cell>The phantom gains a number of ranks in <Link to="/skill/acrobatics">Acrobatics</Link> and <Link to="/skill/perception">Perception</Link> equal to its Hit Dice. While confined in its spiritualist's consciensness, it grants the spiritualist <Link to="/feat/skill_focus">Skill Focus</Link> in each of those skills.</Cell></Row>
<Row><Cell>Good Saves</Cell><Cell>Reflex and Will</Cell></Row></Block>
<Ability id="tricky-combatant" icon={["power"]}>
...
<Ability id="colorful-burst-sp" icon={["cone"]}>
...
<Ability id="aura-of-laughter-sp" icon={["aura","lower"]}>
...
<Ability id="telekinetic-prankster-sp" icon={["ranged"]}>
...
<Ability id="invoke-laughter-sp" icon={["magic"]}>
...
<Row><Cell>Good Saves</Cell><Cell>Fortitude and Reflex</Cell></Row></Block>
<Ability id="tracking" icon={["boost"]}>
...
<Ability id="determination-aura-su" icon={["aura","boost","def"]}>
...
<Ability id="steadfast-servant-su" icon={["power"]}>
...
<Ability id="zeals-resolve-su" icon={["roll","boost","def"]}>
