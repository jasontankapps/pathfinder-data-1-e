...
<div className="title abSingle" id="class-unchained_monk-ac-bonus-ex" data-hash-target><div className="box">AC Bonus (Ex)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">When unarmored and unencumbered, you add your Wisdom bonus (if any) to your AC and CMD.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 4th Level</div></div><div className="abEnd"><div className="box">You gain an additional bonus to AC and CMD equal to <Link to="/misc/one_fourth">one-fourth</Link> of your monk level.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">These bonuses to AC apply even against touch attacks or when you're <Link to="/rule/flat_footed">flat-footed</Link>. You lose these bonuses when immobilized or helpless, when you wear any armor, when you carry a shield, or when you carry a medium or heavy load.</div></div></div></div>
...
<div className="title abSingle" id="class-unchained_monk-bonus-feat" data-hash-target><div className="box">Bonus Feat</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
</td></tr></tbody></table></ScrollContainer></div><div className="ability p"><div className="abIcon"><Link to="/icons/mailed-fist"><IonIcon icon="/icons/mailed-fist.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-unchained_monk-flurry-of-blows-ex" data-hash-target><div className="box">Flurry of Blows (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Full-Round Action</div></div><div className="abEnd"><div className="box">You can make a flurry of blows as a full-attack action. When doing this, you can make one additional attack at your highest base attack bonus. This additional attack stacks with the bonus attacks from <Link to="/spell/haste">haste</Link> and other similar effects. When using this ability, you can make these attacks with any combination of your unarmed strikes and weapons that have the monk special weapon quality. You take no penalty for using multiple weapons when making a flurry of blows, but you do not gain any additional attacks beyond what's already granted by the flurry for doing so. (You can still gain additional attacks from a high base attack bonus, from this ability, and from <em>haste</em> and similar effects).</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 11th Level</div></div><div className="abEnd"><div className="box">You can now make two additional attacks at your highest base attack bonus during your flurry of blows. This still stacks with <em>haste</em> and similar effects.</div></div></div></div>
...
<div className="title abSingle" id="class-unchained_monk-stunning-fist-ex" data-hash-target><div className="box">Stunning Fist (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
<div className="title abSingle" id="class-unchained_monk-evasion-ex" data-hash-target><div className="box">Evasion (Ex)</div><div className="flavor">A monk can avoid damage from many area-effect attacks.</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">If you succeed at a Reflex saving throw against an attack that normally deals half damage on a successful save, you instead take no damage.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box"><em>Evasion</em> can be used only if you are wearing light armor or no armor, and are also not <Link to="/misc/helpless">helpless</Link>.</div></div></div></div>
...
<div className="title abSingle" id="class-unchained_monk-fast-movement-ex" data-hash-target><div className="box">Fast Movement (Ex)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">You gain an enhancement bonus to your land speed equal to <Link to="/misc/one_third">one-third</Link> of your monk level &times; 10.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">If you wear armor or are carrying a medium or heavy load, you lose this extra speed.</div></div></div></div>
...
<div className="title abSingle" id="class-unchained_monk-ki-pool-su" data-hash-target><div className="box">Ki Pool (Su)</div><div className="flavor">A monk gains supernatural energy he can use to accomplish amazing feats.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 3rd Level</div></div></div>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-unchained_monk-ki-powers-su" data-hash-target><div className="box">Ki Powers (Su)</div><div className="flavor">A monk gains powers that allow him to perform amazing feats of mystical power and acrobatic prowess by expending points from his ki pool.</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain one <Link to="/ability/ki_powers">ki power</Link> of your choice. Once a ki power is selected, it cannot be changed.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">Some ki powers require you to be of a specific level or higher before they can be chosen. Unless otherwise noted, you cannot select an individual ki power more than once.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-unchained_monk-still-mind-ex" data-hash-target><div className="box">Still Mind (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 4th Level</div></div></div>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-unchained_monk-purity-of-body-ex" data-hash-target><div className="box">Purity of Body (Ex)</div></div>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/mailed-fist"><IonIcon icon="/icons/mailed-fist.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-unchained_monk-style-strike-ex" data-hash-target><div className="box">Style Strike (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 5th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You learn one type of <Link to="/ability/style_strikes">style strike</Link>. Whenever you make a flurry of blows, you can designate one of your unarmed strikes as a style strike. This attack is resolved as normal, but it has an additional effect depending on the type of strike chosen.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 9th Level</div></div><div className="abEnd"><div className="box">You learn an additional style strike.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 13th Level</div></div><div className="abEnd"><div className="box">You learn an additional style strike.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 15th Level</div></div><div className="abEnd"><div className="box">You can designate up to two of your unarmed strikes each round as a style strike, and each one can be a different type.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 17th Level</div></div><div className="abEnd"><div className="box">You learn an additional style strike.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">You must choose which style strike to apply before the attack roll is made.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-unchained_monk-improved-evasion-ex" data-hash-target><div className="box">Improved Evasion (Ex)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">Your <em>evasion</em> improves. You still take no damage on successful Reflex saving throws against attacks, but henceforth you take only half damage on failed saves.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">You do not gain the benefit of <em>improved evasion</em> while helpless.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-unchained_monk-tongue-of-the-sun-and-moon-ex" data-hash-target><div className="box">Tongue of the Sun and Moon (Ex)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">You can understand and speak with any living creature, as if under a permanent <Link to="/spell/tongues">tongues</Link> effect.</div></div></div></div>
...
<div className="title abSingle" id="class-unchained_monk-timeless-body-ex" data-hash-target><div className="box">Timeless Body (Ex)</div></div>
...
<div className="title abSingle" id="class-unchained_monk-flawless-mind" data-hash-target><div className="box">Flawless Mind</div><div className="flavor">A monk gains total control over his mental faculties.</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">Whenever you attempt a Will save, you can roll twice and take the better result. If you fail a Will saving throw against a spell or effect that has a duration longer than 1 hour, you can attempt a new saving throw at the end of each hour to end the effect.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-unchained_monk-perfect-self" data-hash-target><div className="box">Perfect Self</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">You become a magical creature. You are forevermore treated as an outsider rather than a humanoid (or whatever your original creature type was) for the purpose of spells and magical effects. You gain DR 10/chaotic. Unlike other outsiders, you can still be brought back from the dead as if you were a member of your previous creature type.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain the ability to enter a state of perfect calm. During this time, you can take no actions, but you regain ki at the rate of 1 point per 10 minutes spent at calm. You cannot use this ability to gain an amount of ki in excess of your maximum.</div></div></div></div>
...
<ScrollContainer id="class-unchained_monk--table-4"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<h3 id="class-unchained_monk-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-ninja-poison-use" data-hash-target><div className="box">Poison Use</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-ninja-sneak-attack" data-hash-target><div className="box">Sneak Attack</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You have the ability to <Link to="/ability/sneak_attack">sneak attack</Link>, the same as a rogue.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link><Link to="/icons/mailed-fist"><IonIcon icon="/icons/mailed-fist.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-ninja-ki-pool-su" data-hash-target><div className="box">Ki Pool (Su)</div><div className="flavor">A ninja gains supernatural energy she can use to accomplish amazing feats.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 2nd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain a pool of ki points. The number of points in your ki pool is equal to <Link to="/misc/half">half</Link> your ninja level + your Charisma modifier.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Swift Action</div></div><div className="abEnd"><div className="box">By spending 1 point from your ki pool, you can do one of the following: 1) take one additional attack at your highest attack bonus when making a full attack, 2) increase your speed by 20 feet for one round, or 3) give yourself a +4 insight bonus on Stealth checks for 1 round.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">As long as you have at least 1 point in your ki pool, you treat any <Link to="/skill/acrobatics">Acrobatics</Link> skill check made to jump as if you had a running start.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 10th Level</div></div><div className="abEnd"><div className="box">As long as you have at least 1 point in your ki pool, you reduce the DC of Acrobatics skill checks made to jump by 1/2 (although you still can't move farther than your speed allows).</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">You can gain additional powers that consume points from your ki pool by selecting certain <em>ninja tricks</em> (see below). The ki pool is replenished each morning after 8 hours of rest or meditation; these hours do not need to be consecutive.</div></div></div></div>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-ninja-ninja-tricks" data-hash-target><div className="box">Ninja Tricks</div><div className="flavor">As a ninja continues her training, she learns a number of ninja tricks that allow her to confuse her foes and grant her supernatural abilities.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 2nd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain one <Link to="/ability/ninja_tricks">ninja trick</Link>.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 4th Level</div></div><div className="abEnd"><div className="box">You gain a new ninja trick.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 6th Level</div></div><div className="abEnd"><div className="box">You gain a new ninja trick.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 8th Level</div></div><div className="abEnd"><div className="box">You gain a new ninja trick.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 10th Level</div></div><div className="abEnd"><div className="box">You gain either a new ninja trick, or a <em>master trick</em> (see below).</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 12th Level</div></div><div className="abEnd"><div className="box">You gain a new ninja trick or master trick.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 14th Level</div></div><div className="abEnd"><div className="box">You gain a new ninja trick or master trick.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 16th Level</div></div><div className="abEnd"><div className="box">You gain a new ninja trick or master trick.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 18th Level</div></div><div className="abEnd"><div className="box">You gain a new ninja trick or master trick.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 20th Level</div></div><div className="abEnd"><div className="box">You gain a new ninja trick or master trick.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">Unless otherwise noted, you cannot select an individual ninja trick more than once. If you have multiple tricks that add effects to your sneak attacks, only one may be used per attack.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-ninja-no-trace-ex" data-hash-target><div className="box">No Trace (Ex)</div><div className="flavor">A ninja learns to cover her tracks, remain hidden, and conceal her presence.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 3rd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">The DC to track you using the Survival skill increases by an amount equal to one-third of your ninja level. In addition, your training gives you a insight bonus on Disguise skill checks and on opposed Stealth checks whenever you are stationary and do not take any action for at least 1 round. This bonus is equal to one-third of your ninja level.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-ninja-uncanny-dodge-ex" data-hash-target><div className="box">Uncanny Dodge (Ex)</div><div className="flavor">A ninja can react to danger before her senses would normally allow her to do so.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 4th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">You cannot be caught <Link to="/rule/flat_footed">flat-footed</Link>, nor do you lose your Dexterity bonus to AC if the attacker is invisible. You still lose your Dexterity bonus to AC if immobilized, or if if an opponent successfully uses the <Link to="/skill/bluff">feint</Link> action against you.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">If you already possess uncanny dodge from a different class, you automatically gain <em>improved uncanny dodge,</em> instead.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-ninja-light-steps-ex" data-hash-target><div className="box">Light Steps (Ex)</div><div className="flavor">A ninja learns to move while barely touching the surface underneath you.</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">You can no longer be <Link to="/rule/flanked">flanked</Link>. This defense denies another ninja (or rogue) the ability to sneak attack you by flanking you, unless the attacker has at least four more ninja (or rogue) levels than you do.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">If you already have uncanny dodge from another class, the levels from the classes that grant uncanny dodge stack when determining the minimum ninja (or rogue) level required to flank you.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-ninja-master-tricks" data-hash-target><div className="box">Master Tricks</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">When you would gain a new ninja trick, you can choose a <Link to="/ability/master_tricks">master trick</Link> instead.</div></div></div></div>
...
<div className="title abSingle" id="class-ninja-hidden-master-su" data-hash-target><div className="box">Hidden Master (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 20th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Standard Action</div></div><div className="abEnd"><div className="box">You can cast <Link to="/spell/greater_invisibility">greater invisibility</Link> on yourself. While invisible in this way, you cannot be detected by any means, and not even <Link to="/spell/invisibility_purge">invisibility purge</Link>, <Link to="/spell/see_invisibility">see invisibility</Link>, and <Link to="/spell/true_seeing">true seeing</Link> can reveal you. You use your ninja level as your caster level for this ability. Using this ability consumes 3 <em>ki</em> points from your <em>ki</em> pool.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">In addition, whenever you deal sneak attack damage, you can sacrifice additional damage dice to apply a penalty to one ability score of the target equal to the number of dice sacrificed for 1 minute. This penalty does not stack with itself and cannot reduce an ability score below 1.</div></div></div></div>
<h3 id="class-ninja-alternate-capstones" data-hash-target>Alternate Capstones</h3>
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-ninja--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Ki Sage (Su)</td><td>At 20th level, the character is fully attuned to his own body and the ki that flows within. The character gains two <Link to="/ability/ki_powers">ki powers</Link> from those available to the unchained monk, treating his character level as his monk level for the purpose of any requirements. In addition, his ki pool increases by four. This capstone is available to any class with a ki pool.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
...
<h3 id="class-ninja-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
...
<div className="title abSingle" id="class-occultist-spells" data-hash-target><div className="box">Spells</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain the ability to cast psychic spells which are drawn from the <Link to="/main/spells_occultist">occultist spell list</Link>, limited by the implement groups you know. The DC for a saving throw against spells you cast is 10 + the spell level + your Intelligence modifier. You must choose and prepare your spells in advance.</div></div></div><div className="abPair"><div className="abStart"><div className="box">Info</div></div><div className="abEnd"><div className="box"><p>An occultist's selection of spells is limited. For each implement school you learn to use, you can add one spell of each level you can cast to your list of spells known, chosen from that school's spell list. If you select the same implement school multiple times, you add one spell of each level from that school's list for each time you have selected that school. When you learn to cast a new level of spells, you immediately add one spell of that level to your list of spells known from each implement school you know (plus any extra spells from schools you have selected multiple times).</p>
<p>At 5th level, and every three levels thereafter (8th, 11th, and so on), you can choose to learn a new spell in place of one you already know. In effect, you "lose" the old spell in exchange for the new one. The new spell's level must be the same as that of the spell being exchanged. The spell learned must come from the same list of spells provided by the implement school of the spell lost. You may swap out only a single spell at any given level and must choose whether or not to swap the spell at the same time that you gain new spells known for the level.</p></div></div></div><div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">Every occultist spell has an implement component (described below).</div></div></div></div><div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-occultist-knacks" data-hash-target><div className="box">Knacks</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You learn one knack, or 0-level psychic spell, each time you select an implement school (including when you again select a school that you have already learned to use). These spells are cast like any other spell, but they can be cast any number of times per day. Knacks cast using any other spell slots because of metamagic feats applied to them, for example, consume spell slots as normal.</div></div></div></div>
...
<div className="title abSingle" id="class-occultist-implements-su" data-hash-target><div className="box">Implements (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box"><p>You learn to use two <Link to="/ability/implements">implement schools</Link>. Each implement school adds one spell per spell level of that school of magic to your spell list. No spells from any other school are considered to be on your spell list until you select the associated implement school. You can't use spell trigger or spell completion magic items from unknown schools without succeeding at the appropriate Use Magic Device check.</p>
...
<div className="abPair"><div className="abStart"><div className="box">At 2nd Level</div></div><div className="abEnd"><div className="box">You learn to use one additional implement school.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 6th Level</div></div><div className="abEnd"><div className="box">You learn to use one additional implement school.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 10th Level</div></div><div className="abEnd"><div className="box">You learn to use one additional implement school.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 14th Level</div></div><div className="abEnd"><div className="box">You learn to use one additional implement school.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 18th Level</div></div><div className="abEnd"><div className="box">You learn to use one additional implement school.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">You can select an implement school more than once in order to learn additional spells from the associated school.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-occultist-mental-focus-su" data-hash-target><div className="box">Mental Focus (Su)</div><div className="flavor">An occultist can invest a portion of his mental focus into his chosen implements for the day, allowing him to utilize a variety of abilities depending on the implements and the amount of mental focus invested in them.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box"><p>You have a number of points of mental focus equal to your occultist level + your Intelligence modifier; these points refresh each day. You can divide this mental focus between your implements in any way you desire. If an implement is lost or destroyed, the focus invested in it is lost as well, though you still refresh those points of focus normally.</p>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-occultist-focus-powers-su" data-hash-target><div className="box">Focus Powers (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You learn the base focus power from both of your two implement schools and can select one more focus power from the list of those available to you through those schools. Whenever you learn a new implement school, you gain the base power of that school.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 3rd Level</div></div><div className="abEnd"><div className="box">You learn a new focus power selected from the options granted by all of the implement schools you know.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 5th Level</div></div><div className="abEnd"><div className="box">You learn a new focus power, as above.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 7th Level</div></div><div className="abEnd"><div className="box">You learn a new focus power, as above.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 9th Level</div></div><div className="abEnd"><div className="box">You learn a new focus power, as above.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 11th Level</div></div><div className="abEnd"><div className="box">You learn a new focus power, as above.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 13th Level</div></div><div className="abEnd"><div className="box">You learn a new focus power, as above.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 15th Level</div></div><div className="abEnd"><div className="box">You learn a new focus power, as above.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 17th Level</div></div><div className="abEnd"><div className="box">You learn a new focus power, as above.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 19th Level</div></div><div className="abEnd"><div className="box">You learn a new focus power, as above.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">You can use focus powers only by expending mental focus. Unless otherwise noted, the DC for any saving throw against a focus power equals 10 + <Link to="/misc/half">half</Link> your level + your Intelligence modifier. You can't select a focus power more than once. Some focus powers require you to reach a specific occultist level before you can choose them.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-occultist-magic-item-skill-ex" data-hash-target><div className="box">Magic Item Skill (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 2nd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">Your knowledge of magic items grants you a bonus when attempting to use them. You gain a bonus on all <Link to="/skill/use_magic_device">Use Magic Device</Link> checks equal to 1/2 your occultist level.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-occultist-object-reading-su" data-hash-target><div className="box">Object Reading (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 2nd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You learn how to read information from items you examine. Examining an item in this way requires you to spend 1 minute handling the item. If the item is a magic item, you learn its properties and command word as if you had successfully examined the item using <Link to="/spell/detect_magic">detect magic</Link> and succeeded at a Spellcraft check. This ability does not reveal whether the item is cursed unless your class level is equal to or greater than the caster level of the item. If the item has any historical significance, you learn one piece of information about its past (as determined by the GM). Finally, if the item was last used no longer than 1 day ago per your class level, you learn one piece of information about the last creature to use the item. This information might be a glimpse of the creature's appearance, a brief vision of what it saw while using the item, or perhaps its emotional state when it last used the item. The GM determines what information is gained in this way. This functions like the <Link to="/skill/psychometry">psychometry occult skill unlock</Link>, but doesn't require a skill check and can be used at will.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-occultist-shift-focus-su" data-hash-target><div className="box">Shift Focus (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 4th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain the ability to shift your mental focus from one implement to another, though some of the focus is lost along the way. Shifting mental focus removes a number of points of mental focus from one implement and adds the same number - 1 to another implement; this takes 1 minute of quiet contemplation while touching both implements.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">You can shift your mental focus only from one implement to another implement; you can't shift generic focus into an implement. Unlike expending focus normally, this shift can reduce the effect of a resonant power in the implement from which the mental focus was taken. It does not, however, add to the resonant power of the implement to which the focus is added.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-occultist-aura-sight-su" data-hash-target><div className="box">Aura Sight (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 5th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Standard Action</div></div><div className="abEnd"><div className="box">You can read the auras of creatures around you. This functions as the <Link to="/spell/aura_sight">aura sight</Link> spell with a duration of 1 round.</div></div></div></div>
...
<div className="title abSingle" id="class-occultist-magic-circles-su" data-hash-target><div className="box">Magic Circles (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 8th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You learn how to draw magic circles. To draw a circle, you must have chalk, salt, blood, powdered silver, or some other appropriate substance at hand (although you can press a magic circle into a softer surface such as dirt or clay). Drawing a circle takes 1 minute and requires you to expend 1 point of mental focus (either generic focus or focus from any one of your implements). Once completed, this circle functions as a permanent <Link to="/spell/magic_circle">magic circle</Link> against any alignment of your choosing. The circle can't be against a component of your alignment (if you are lawful good, for example, it can't be a <em>against good</em> or <em>against law</em>).</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">The circle remains until its form is physically broken (for example, if the lines are smeared or the salt is scattered). Only a living creature can break the circle; environmental effects can't break it. You can have only one circle created in this way at a time. If you create a second circle, the first one loses all its magic powers. This type of magic circle can't normally be focused inward to bind an outsider.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-occultist-outside-contact-su" data-hash-target><div className="box">Outside Contact (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 8th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box"><p>You learn the true name of one particular outsider. This outsider can have no more than 3 Hit Dice. Whenever you create a <em>magic circle,</em> you can expend 1 additional point of mental focus to focus the circle inward and lure that outsider to the circle (similar to using <Link to="/spell/lesser_planar_binding">lesser planar binding</Link>).</p>
...
<div className="abPair"><div className="abStart"><div className="box">At 12th Level</div></div><div className="abEnd"><div className="box">You learn to contact one additional outsider of the same type or a different type. Although you can call only one outsider in this way at a time, you can ask such an outsider one additional question, all for the same bargaining price. The questions must be in some way related to one another.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 16th Level</div></div><div className="abEnd"><div className="box">You learn to contact one more outsider of the same type or different type, and you may ask one more related question, as above. Also, in lieu of asking questions, you can demand that the outsider deliver a message to any one friendly creature that you know personally. You can also task the outsider to deliver one object weighing no more than 1 pound. Either of these demands requires an opposed check as described above. Delivery typically takes 1d4 hours, but this period is reduced to 1d6 minutes if the recipient is within 1 mile of you (or even less if the recipient is within sight). You must be able to accurately describe the recipient in both name and appearance. This ability can't be used to deliver anything to a location, or to enemies or creatures that are unfriendly to you.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 20th Level</div></div><div className="abEnd"><div className="box">You learn to contact a fourth outsider of the same type or different type, and you may ask one more related question, as above.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-occultist-binding-circles-su" data-hash-target><div className="box">Binding Circles (Su)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You learn to draw magic circles very quickly. You can draw a magic circle as a <strong className="hl">full-round action</strong>, but any circle drawn in this way has a duration of 1 minute per occultist level (unless it's drawn in conjunction with the <em>outside contact</em> class feature, in which case it lasts for 10 minutes as normal). If you draw a <em>binding circle</em> in this way, its duration is 1 round per occultist level.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-occultist-implement-mastery-su" data-hash-target><div className="box">Implement Mastery (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 20th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">You select one implement school to master. Whenever you use a focus power from an implement of that school, the DC to resist any of the effects increases by 4 and you treat your occultist level as 4 higher when determining the effects and duration of that power. The hardness of each of your implements of the mastered school increases by an additional 20 as long as the item has at least 1 point of mental focus stored within.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">In addition, you gain 4 extra points of mental focus, but these points must always be invested in implements of the mastered school. You can't save these points or expend them for any ability other than the focus powers of those implements.</div></div></div></div>
<h3 id="class-occultist-alternate-capstones" data-hash-target>Alternate Capstones</h3>
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-occultist--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<h3 id="class-occultist-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
...
<div className="ability"><div className="abIcon"><Link to="/icons"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-oracle-spells" data-hash-target><div className="box">Spells</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain the ability to cast divine spells which are drawn from the <Link to="/main/spells_oracle">oracle spell list</Link>. The DC for a saving throw against spells you cast is 10 + the spell level + your Charisma modifier. You do not need to prepare these spells in advance; you can cast any spell you know at any time, assuming you haven't yet used up your allotment of spells per day for the spell's level.</div></div></div><div className="abPair"><div className="abStart"><div className="box">Info</div></div><div className="abEnd"><div className="box"><p>An oracle's selection of spells is extremely limited. You begin play knowing four 0-level spells and two 1st-level spells of your choice. At each new oracle level you gain one or more new spells as indicated on the table above. Unlike spells per day, the number of spells you know is not affected by your Charisma score.</p>
...
<p>At 4th level, and every two levels thereafter (6th, 8th, and so on), you can choose to learn a new spell in place of one you already know. In effect, you "lose" the old spell in exchange for the new one. The new spell's level must be the same as that of the spell being exchanged. You may swap out only a single spell at any given level and must choose whether or not to swap the spell at the same time that you gain new spells known for the level. You cannot swap any <em>cure</em> or <em>inflict</em> spells, nor can you swap any spells gained from your mystery.</p></div></div></div><div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">Oracles do not need to provide a divine focus to cast spells that list divine focus (DF) as part of the components.</div></div></div></div><div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-oracle-orisons" data-hash-target><div className="box">Orisons</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
<div className="title abSingle" id="class-oracle-mystery" data-hash-target><div className="box">Mystery</div><div className="flavor">Each oracle draws upon a divine mystery to grant her spells and powers.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You must pick one <Link to="/ability/mystery">mystery</Link> upon taking your first level of oracle. Once made, this choice cannot be changed. This mystery grants additional class skills and other special abilities.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 2nd Level</div></div><div className="abEnd"><div className="box">At 2nd level, and every two levels thereafter (4th, 6th, 8th, and so on), you learn an additional spell derived from your mystery. These spells are in addition to the number of spells gained each level. They cannot be exchanged for different spells at higher levels.</div></div></div></div>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-oracle-oracles-curse-ex" data-hash-target><div className="box">Oracle's Curse (Ex)</div><div className="flavor">Each oracle is cursed, but this curse comes with a benefit as well as a hindrance.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You must choose a single <Link to="/ability/oracle_curses">oracle curse</Link>. Once made, this choice cannot be changed, and it cannot be removed or dispelled without the aid of a deity. Your curse is based on your oracle level plus one for every two levels or Hit Dice other than oracle.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-oracle-revelation" data-hash-target><div className="box">Revelation</div><div className="flavor">An oracle uncovers a new secret about her mystery that grants her powers and abilities.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You select a revelation from the list of revelations available to your mystery. Unless otherwise noted, activating the power of a revelation is a <strong className="hl">standard action</strong>.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 3rd Level</div></div><div className="abEnd"><div className="box">You gain a new revelation.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 7th Level</div></div><div className="abEnd"><div className="box">You gain a new revelation.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 11th Level</div></div><div className="abEnd"><div className="box">You gain a new revelation.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 15th Level</div></div><div className="abEnd"><div className="box">You gain a new revelation.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 19th Level</div></div><div className="abEnd"><div className="box">You gain a new revelation.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">If a revelation is chosen after 1st level, you gain all of the abilities and bonuses granted by that revelation based on your current level.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-oracle-final-revelation" data-hash-target><div className="box">Final Revelation</div><div className="flavor">At 20th level, an oracle learns the final revelation about her mystery, granting her amazing powers and abilities.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 20th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain the <em>final revelation</em> listed in your mystery. The nature of these bonuses depends upon the mystery.</div></div></div></div>
<h3 id="class-oracle-alternate-capstones" data-hash-target>Alternate Capstones</h3>
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-oracle--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Deep Magics (Su)</td><td>At 20th level, the character's repertoire of spells deepens dramatically. She gains an additional spell known for each spell level she can cast. A character of any class with spells known can select this capstone.</td></tr>
...
<h3 id="class-oracle-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
...
<div className="archetype"><p><Link to="/arc-oracle/pei_zin_practitioner">Pei Zin Practitioner</Link></p><p><strong>Modifies or Replaces:</strong> Mystery Class Skills; 1st-level Revelation</p><p>In distant Tian Xia, herbalists practice an obscure alchemical art known as Pei Zin herbalism, which involves medicinal and restorative techniques that are used throughout much of that continent.</p></div>
...
<div className="title abSingle" id="class-paladin-aura-of-good-ex" data-hash-target><div className="box">Aura of Good (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">The power of your aura of good (see <Link to="/spell/detect_good">detect good</Link>) is equal to your paladin level.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-paladin-detect-evil-sp" data-hash-target><div className="box">Detect Evil (Sp)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">At will, you can use <Link to="/spell/detect_evil">detect evil</Link>, as the spell.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Move-Equivalent Action</div></div><div className="abEnd"><div className="box">You can concentrate on a single item or individual within 60 feet and determine if it is evil, learning the strength of its aura as if having studied it for 3 rounds. While focusing on one individual or object, you do not <em>detect evil</em> in any other object or individual within range.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-paladin-smite-evil-su" data-hash-target><div className="box">Smite Evil (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Swift Action</div></div><div className="abEnd"><div className="box"><p>You can call out to the powers of good to aid you in your struggle against evil, choosing one target within sight to smite. If you target a creature that is not evil, the smite is wasted with no effect.</p>
...
<div className="title abSingle" id="class-paladin-lay-on-hands-su" data-hash-target><div className="box">Lay On Hands (Su)</div><div className="flavor">A paladin can heal wounds (her own or those of others) by touch.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 2nd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">Half your paladin level, plus your Cha modifier, times/day.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Standard Action</div></div><div className="abEnd"><div className="box">You heal 1d6 hit points of damage for every two paladin levels you possess. Despite the name of this ability, you only need one free hand to use this ability.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Swift Action</div></div><div className="abEnd"><div className="box">You can heal yourself instead of another creature, as above.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">Alternatively, as a melee touch attack, you can use this healing power to deal damage to undead creatures, dealing 1d6 points of damage for every two paladin levels you possess. This doesn't provoke an attack of opportunity. Undead do not receive a saving throw against this damage.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link><Link to="/icons/abstract-091"><IonIcon icon="/icons/abstract-091.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-paladin-aura-of-courage-su" data-hash-target><div className="box">Aura of Courage (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 3rd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">You are immune to fear (magical or otherwise). Each ally <Link to="/misc/emanation">within 10 feet of you</Link> gains a +4 morale bonus on saving throws against fear effects. This ability functions only while you are conscious, not if you're unconscious or dead.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-paladin-divine-health-ex" data-hash-target><div className="box">Divine Health (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 3rd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">You are immune to all diseases, including supernatural and magical diseases, including <Link to="/curse/mummy_rot">mummy rot</Link>.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link><Link to="/icons/heart-plus"><IonIcon icon="/icons/heart-plus.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-paladin-mercy-su" data-hash-target><div className="box">Mercy (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 3rd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain one <Link to="/ability/mercy">mercy</Link>, which adds an effect to your <em>lay on hands</em> ability. Whenever you use <em>lay on hands</em> to heal damage to one target, the target also receives the additional effects from <strong>all</strong> of the mercies you possess. Once a condition or spell effect is chosen, it can't be changed.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 6th Level</div></div><div className="abEnd"><div className="box">You gain a new mercy.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 9th Level</div></div><div className="abEnd"><div className="box">You gain a new mercy.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 12th Level</div></div><div className="abEnd"><div className="box">You gain a new mercy.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 15th Level</div></div><div className="abEnd"><div className="box">You gain a new mercy.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 18th Level</div></div><div className="abEnd"><div className="box">You gain a new mercy.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">A mercy can remove a condition caused by a curse, disease, or poison without curing the affliction. Such conditions return after 1 hour unless the mercy actually removes the affliction that causes the condition.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-paladin-channel-positive-energy-su" data-hash-target><div className="box">Channel Positive Energy (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 4th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Standard Action</div></div><div className="abEnd"><div className="box">You gain the supernatural ability to <Link to="/ability/channel_positive_energy">channel positive energy</Link> like a cleric. Using this ability consumes two uses of your <em>lay on hands</em> ability. You use your level as your effective cleric level when channeling positive energy. This is a Charisma-based ability.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-paladin-spells" data-hash-target><div className="box">Spells</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 4th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain the ability to cast a small number of divine spells which are drawn from the <Link to="/main/paladin_spell">paladin spell list</Link>. The DC for a saving throw against spells you cast is 10 + the spell level + your Charisma modifier. You must choose and prepare your spells in advance. Like other spellcasters, you can cast only a certain number of spells of each spell level per day. In addition, you receive <Link to="/rule/bonus_spells">bonus spells per day</Link> if you have a high Charisma score.</div></div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Info</div></div><div className="abEnd"><div className="box"><p>You must spend 1 hour each day in quiet prayer and meditation to regain your daily allotment of spells. You may prepare and cast any spell on the paladin spell list, provided that you can cast spells of that level, but you must choose which spells to prepare during your daily meditation.</p>
...
<div className="title abSingle" id="class-paladin-divine-bond-sp-su" data-hash-target><div className="box">Divine Bond (Sp, Su)</div><div className="flavor">A paladin forms a divine bond with her god.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 5th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">This bond can take one of two forms: bonded weapon or bonded mount. Once the form is chosen, it cannot be changed.</div></div></div></div>
...
<div className="title abSingle" id="class-paladin-bonded-weapon" data-hash-target><div className="box">Bonded Weapon</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Choice</div></div><div className="abEnd"><div className="box"><p>The first type of bond allows the paladin to enhance your weapon as a <strong className="hl">standard action</strong> by calling upon the aid of a celestial spirit for 1 minute per paladin level. This is a spell-like ability. When called, the spirit causes the weapon to shed light as a <Link to="/eq-misc/torch">torch</Link> and grants the weapon a +1 enhancement bonus.</p>
...
<div className="title abSingle" id="class-paladin-bonded-mount" data-hash-target><div className="box">Bonded Mount</div></div>
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">Once per day.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Choice</div></div><div className="abEnd"><div className="box"><p>The second type of bond allows you to gain the service of an unusually intelligent, strong, and loyal steed to serve you in your crusade against evil. This mount functions as a druid's <Link to="/sidekick/animal_companion">animal companion</Link>, using your level as your effective druid level. Bonded mounts have an Intelligence of at least 6. This mount may come from the following lists:</p>
<blockquote>
...
<div className="abPair"><div className="abStart"><div className="box">At 9th Level</div></div><div className="abEnd"><div className="box">You can use this ability twice a day.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 11th Level</div></div><div className="abEnd"><div className="box">The mount gains the <Link to="/template/celestial">celestial</Link> template and becomes a magical beast for the purposes of determining which spells affect it.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 13th Level</div></div><div className="abEnd"><div className="box">You can use this ability three times a day.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 15th Level</div></div><div className="abEnd"><div className="box">The mount gains spell resistance equal to your level + 11.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 17th Level</div></div><div className="abEnd"><div className="box">You can use this ability four times a day.</div></div></div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Free Action</div></div><div className="abEnd"><div className="box">You can expend two uses of your <em>smite evil</em> ability to grant the ability to <em>smite evil</em> to all allies within 10 feet, using your bonuses. Allies must use this <em>smite evil</em> ability by the start of your next turn and the bonuses last for 1 minute. Evil creatures gain no benefit from this ability.</div></div></div></div>
...
<div className="title abSingle" id="class-paladin-aura-of-faith-su" data-hash-target><div className="box">Aura of Faith (Su)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">Your weapons are treated as good-aligned for the purposes of overcoming <Link to="/rule/damage_reduction">damage reduction</Link>. Any attack made against an enemy within 10 feet of you is treated as good-aligned for the purposes of overcoming damage reduction. This ability functions only while you are conscious, not if you are unconscious or dead.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-paladin-aura-of-righteousness-su" data-hash-target><div className="box">Aura of Righteousness (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 17th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">You gain DR 5/evil and immunity to compulsion spells and spell-like abilities. Each ally within 10 feet of you gains a +4 morale bonus on saving throws against compulsion effects. This ability functions only while you are conscious, not if you are unconscious or dead.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link><Link to="/icons/heart-plus"><IonIcon icon="/icons/heart-plus.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-paladin-holy-champion-su" data-hash-target><div className="box">Holy Champion (Su)</div><div className="flavor">You become a conduit for the power of your god.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 20th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">Your DR increases to 10/evil. Whenever you use <em>smite evil</em> and successfully strikes an evil outsider, the outsider is also subject to a <Link to="/spell/banishment">banishment</Link>, using your paladin level as the caster level (your weapon and holy symbol automatically count as objects that the subject hates). After the <em>banishment</em> effect and the damage from the attack is resolved, the <em>smite</em> immediately ends. In addition, whenever you channel positive energy or use <em>lay on hands</em> to heal a creature, you heal the maximum possible amount.</div></div></div></div>
...
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-paladin--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<h3 id="class-paladin-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
...
<div className="archetype"><p><Link to="/arc-paladin/silver_champion">Silver Champion</Link></p><p><strong>Modifies or Replaces:</strong> Divine Bond; Channel Energy; Aura of Justice; Aura of Righteousness; Spells</p><p>Drake-riding paladins who serve as priests of Apsu.</p></div>
...
<table className="class p"><thead><tr><th className="nw ne ion-text-center" scope="col" colSpan={3}>Weapon and Armor Proficiencies</th></tr></thead><tbody><tr><th scope="row" rowSpan={1}>Weapons</th><td colSpan={2}>All <Link to="/main/equipment_weapons_simple">simple weapons</Link></td></tr><tr><th>Light Armor?</th><td colSpan={2}>No</td></tr><tr><th>Medium Armor?</th><td colSpan={2}>No</td></tr><tr><th>Heavy Armor?</th><td colSpan={2}>No</td></tr><tr><th className="sw">Shields?</th><td colSpan={2} className="se">No</td></tr></tbody></table>
<div className="ability"><div className="abIcon"><Link to="/icons"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-psychic-spells" data-hash-target><div className="box">Spells</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">To learn or cast a spell, you must have a Intelligence score equal to at least 10 + the spell level. You can cast only a certain number of spells of each spell level per day, as shown on the table above. In addition, you receive <Link to="/rule/determine_bonuses">bonus spells per day</Link> if you have a high Intelligence score.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain the ability to cast psychic spells which are drawn from the <Link to="/main/spells_psychic">psychic spell list</Link>. The DC for a saving throw against spells you cast is 10 + the spell level + your Intelligence modifier. You do not need to prepare these spells in advance; you can cast any spell you know at any time, assuming you haven't yet used up your allotment of spells per day for the spell's level.</div></div></div><div className="abPair"><div className="abStart"><div className="box">Info</div></div><div className="abEnd"><div className="box"><p>A psychic's selection of spells is limited. You begin play knowing four 0-level spells and two 1st-level spells of your choice. At each new psychic level you gain one or more new spells as indicated on the table above. Unlike spells per day, the number of spells you know is not affected by your Intelligence score.</p>
...
<div className="title abSingle" id="class-psychic-knacks" data-hash-target><div className="box">Knacks</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-psychic-phrenic-pool-su" data-hash-target><div className="box">Phrenic Pool (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You have a pool of supernatural mental energy that you can draw upon to manipulate psychic spells as you cast them. The maximum number of points in your <em>phrenic pool</em> is equal to <Link to="/misc/half">half</Link> your psychic level + your Wisdom or Charisma modifier, as determined by your <em>psychic discipline</em> (described below).</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">The <em>phrenic pool</em> is replenished each morning after 8 hours of rest or meditation; these hours don't need to be consecutive. You might be able to recharge points in your <em>phrenic pool</em> in additional circumstances dictated by your <em>psychic discipline.</em> Points gained in excess of the <em>pool's</em> maximum are lost.</div></div></div></div>
...
<div className="title abSingle" id="class-psychic-phrenic-amplifications" data-hash-target><div className="box">Phrenic Amplifications</div><div className="flavor">A psychic develops particular techniques to empower her spellcasting.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">You can activate a <em>phrenic amplification</em> only while casting a spell using psychic magic, and the amplification modifies either the spell's effects or the process of casting it. The spell being cast is called the linked spell.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You learn a <Link to="/ability/phrenic_amplifications">phrenic amplification</Link>. You can activate only one amplification each time you cast a spell, and doing so is part of the action used to cast the spell. You can use any amplification you know with any psychic spell, unless the amplification's description states that it can be linked only to certain types of spells.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 3rd Level</div></div><div className="abEnd"><div className="box">You learn a new <em>phrenic amplification.</em></div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 7th Level</div></div><div className="abEnd"><div className="box">You learn a new <em>phrenic amplification.</em></div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 11th Level</div></div><div className="abEnd"><div className="box">You learn a new <em>phrenic amplification</em> or <em>major phrenic amplification</em> (described below).</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 15th Level</div></div><div className="abEnd"><div className="box">You learn a new <em>phrenic amplification</em> or <em>major phrenic amplification.</em></div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 19th Level</div></div><div className="abEnd"><div className="box">You learn a new <em>phrenic amplification</em> or <em>major phrenic amplification.</em></div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">A <em>phrenic amplification</em> can't be selected more than once. Once a <em>phrenic amplification</em> has been selected, it can't be changed. <em>Phrenic amplifications</em> require you to expend 1 or more points from your <em>phrenic pool</em> to function.</div></div></div></div>
...
<div className="title abSingle" id="class-psychic-psychic-discipline-ex-or-sp" data-hash-target><div className="box">Psychic Discipline (Ex or Sp)</div><div className="flavor">Each psychic accesses and improves her mental powers through a particular method, such as rigorous study or attaining a particular mental state. This is called her psychic discipline.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">Choose one <Link to="/ability/disciplines">discipline</Link>. Once made, this choice can't be changed. You gain an additional spell known based on your selected discipline, and you gain its 1st-level discipline power. The DC of a saving throw against a <em>psychic discipline</em> ability equals 10 + 1/2 your psychic level + your Intelligence modifier.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 4th Level</div></div><div className="abEnd"><div className="box">You gain a new spell from your discipline.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 5th Level</div></div><div className="abEnd"><div className="box">You gain a new discipline power.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 6th Level</div></div><div className="abEnd"><div className="box">You gain a new spell from your discipline.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 8th Level</div></div><div className="abEnd"><div className="box">You gain a new spell from your discipline.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 10th Level</div></div><div className="abEnd"><div className="box">You gain a new spell from your discipline.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 12th Level</div></div><div className="abEnd"><div className="box">You gain a new spell from your discipline.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 13th Level</div></div><div className="abEnd"><div className="box">You gain a new discipline power.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 14th Level</div></div><div className="abEnd"><div className="box">You gain a new spell from your discipline.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 16th Level</div></div><div className="abEnd"><div className="box">You gain a new spell from your discipline.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 18th Level</div></div><div className="abEnd"><div className="box">You gain a new spell from your discipline.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">The discipline determines which ability score you use for your <em>phrenic pool</em> and <em>phrenic amplifications</em> abilities. Spells learned from a discipline can't be exchanged for different spells at higher levels.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-psychic-detect-thoughts-sp" data-hash-target><div className="box">Detect Thoughts (Sp)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 2nd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Standard Action</div></div><div className="abEnd"><div className="box">You can use <Link to="/spell/detect_thoughts">detect thoughts</Link> as a spell-like ability once per day.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can also expend any unused spell slot of 1st level or higher to cast <em>detect thoughts.</em> If you do so, you use the level of the spell slot expended to determine the Will save DC.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">When you gain this ability, if you already know <em>detect thoughts,</em> you can learn a different 1st-level spell in place of it, losing the old spell in exchange for the new one.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-psychic-telepathic-bond-sp" data-hash-target><div className="box">Telepathic Bond (Sp)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 9th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Standard Action</div></div><div className="abEnd"><div className="box">You can use <Link to="/spell/telepathic_bond">telepathic bond</Link> as a spell-like ability once per day, using your psychic level as your caster level. You can't leave yourself out of a <em>bond</em> created in this way.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can also expend any unused spell slot of 4th level or higher to cast <em>telepathic bond.</em> Casting the spell using a higher-level spell slot gives no benefit on its own, but you can apply metamagic feats that would increase the spell level to the appropriate level. For instance, if you know <Link to="/feat/extend_spell">Extend Spell</Link>, you can use a 5th-level spell slot to cast extended <em>telepathic bond</em> as a full-round action.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">When you gain this ability, if you already know <em>telepathic bond,</em> you can learn a different 4th-level spell in place of it, losing the old spell in exchange for the new one.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-psychic-major-amplifications" data-hash-target><div className="box">Major Amplifications</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 11th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">When you would learn a <em>phrenic amplification</em> from gaining a level, you can choose a <Link to="/ability/major_phrenic_amplifications">major phrenic amplification</Link> instead.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-psychic-telepathy-su" data-hash-target><div className="box">Telepathy (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 17th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can mentally communicate with any other creature within 100 feet that has a language. It is possible to address multiple creatures at once telepathically, although maintaining a telepathic conversation with more than one creature at a time is just as difficult as both speaking and listening to multiple people at the same time.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">When you gain this ability, if you already know the <Link to="/spell/telepathy">telepathy</Link> spell, you can learn a different 5th-level spell in place of it, losing the old spell in exchange for the new one.</div></div></div></div>
...
<div className="title abSingle" id="class-psychic-remade-self-sp" data-hash-target><div className="box">Remade Self (Sp)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 20th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">You are affected by one of the following spells as a constant spell-like ability: <Link to="/spell/arcane_sight">arcane sight</Link>, <Link to="/spell/fly">fly</Link>, <Link to="/spell/haste">haste</Link>, <Link to="/spell/heroism">heroism</Link>, <Link to="/spell/nondetection">nondetection</Link>, or <Link to="/spell/tongues">tongues</Link>. This ability is chosen when you reach 20th level and can't be changed.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">While you are under the effects of this spell-like ability, each time you cast a psychic spell, you can link one <em>phrenic amplification</em> or <em>major amplification</em> you know that has a point cost of 1 to that spell without spending any points from your <em>phrenic pool.</em> This amplification is in addition to the normal maximum of one amplification per spell.</div></div></div></div>
<h3 id="class-psychic-alternate-capstones" data-hash-target>Alternate Capstones</h3>
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-psychic--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Deep Magics (Su)</td><td>At 20th level, the character's repertoire of spells deepens dramatically. She gains an additional spell known for each spell level she can cast. A character of any class with spells known can select this capstone.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
...
<h3 id="class-psychic-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
...
<p><strong>Wyrwood:</strong> psychic gains 1/6 of a phrenic amplification.<sup><InnerLink showBacklink="backlink-class-psychic-ref-I-1" id="class-psychic-ref-I-1" data-hash-target to="class-psychic-I">9</InnerLink></sup></p>
</div>
...
<div className="archetype"><p><Link to="/arc-psychic/terror_weaver">Terror Weaver</Link></p><p><strong>Modifies or Replaces:</strong> Detect Thoughts; Telepathic Bond; 11th, 15th, 19th-level Phrenic Amplifications</p><p>A number of exceptional Darklands half-orcs have developed potent psychic abilities, unlocked by generations of exposure to a specific combination of mind-altering fungi and radiation</p></div>
