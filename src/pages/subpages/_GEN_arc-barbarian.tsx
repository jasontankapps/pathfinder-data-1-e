...
<Pair title="At 16th Level">She can instead spend 2 <em>drunken rage</em> points to increase the critical threat range of her next attack by 2.</Pair>
<Pair title="At 20th Level">She can instead spend 3 <em>drunken rage</em> points to increase the critical threat range of her next attack by 3.</Pair>
...
<Pair title="Usage">The barbarian must expend 1 round of <em>rage</em> for each round she uses this ability.</Pair>
</Ability>
...
<Pair title="At 13th Level">The pack rager chooses two teamwork feats when she enters a <em>rage,</em> and grants her allies the use of both of those feats when they are within 30 feet of her.</Pair>
<Pair title="At 16th Level">The pack rager grants these teamwork feats as long as her allies are within 60 feet of her.</Pair>
<Pair title="At 19th Level">The pack rager chooses three teamwork feats when she enters a <em>rage,</em> and grants her allies the use of all three feats when they are within 60 feet of her.</Pair>
</Ability>
</>};
...
<Pair title="At 5th Level">The raging cannibal now gains 2 additional rounds of <em>rage</em> each time she uses this ability.</Pair>
<Pair title="At 8th Level">She now gains 3 rounds of <em>rage.</em></Pair>
<Pair title="At 11th Level">She now gains 4 rounds of <em>rage.</em></Pair>
<Pair title="At 14th Level">She now gains 5 rounds of <em>rage.</em></Pair>
...
<Pair title="Special">The burn rider can only regain 1 round of <em>rage</em> per round.</Pair>
</Ability>
...
<p><strong className="hl"><Link to="/ragepower/lesser_beast_totem">Lesser Beast Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-C-1" id="arc-barbarian-totem_warrior-ref-C-1" data-hash-target to="arc-barbarian-totem_warrior-C">3</InnerLink></sup> While <em>raging,</em> the barbarian gains two claw attacks. These attacks are considered primary attacks and are made at the barbarian's full base attack bonus. The claws deal 1d6 points of slashing damage (1d4 if Small) plus the barbarian's Strength modifier.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/beast_totem">Beast Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-C-2" id="arc-barbarian-totem_warrior-ref-C-2" data-hash-target to="arc-barbarian-totem_warrior-C">3</InnerLink></sup> While <em>raging,</em> the barbarian gains a +1 natural armor bonus. This bonus increases by +1 for every four levels the barbarian has attained. A barbarian must have the <Link to="/ragepower/lesser_beast_totem">lesser beast totem</Link> rage power to select this rage power. A barbarian must be at least 6th level to select this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_beast_totem">Greater Beast Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-C-3" id="arc-barbarian-totem_warrior-ref-C-3" data-hash-target to="arc-barbarian-totem_warrior-C">3</InnerLink></sup> While <em>raging,</em> the barbarian gains the <Link to="/umr/pounce">pounce</Link> special ability, allowing her to make a full attack at the end of a charge. In addition, the damage from her claws increases to 1d8 (1d6 if Small) and the claws deal &times;3 damage on a critical hit. A barbarian must have the <Link to="/ragepower/beast_totem">beast totem</Link> rage power to select this rage power. A barbarian must be at least 10th level to select this rage power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_celestial_totem">Lesser Celestial Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-D-1" id="arc-barbarian-totem_warrior-ref-D-1" data-hash-target to="arc-barbarian-totem_warrior-D">4</InnerLink></sup> While <em>raging,</em> the barbarian benefits from increased magical healing. Whenever she is subject to a spell that cures hit point damage, she heals 1 additional point of damage per caster level. In the case of non-spell healing effects (such as channeled energy or lay on hands), she heals a number of additional points equal to the class level of the character performing the magical healing. This does not affect fast healing or regeneration.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/celestial_totem">Celestial Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-D-2" id="arc-barbarian-totem_warrior-ref-D-2" data-hash-target to="arc-barbarian-totem_warrior-D">4</InnerLink></sup> While <em>raging,</em> the barbarian shines with a righteous light. This effect bestows upon the barbarian a halo of gleaming light that shines as if it were <Link to="/spell/daylight">daylight</Link> and triggers an <Link to="/spell/invisibility_purge">invisibility purge</Link> effect in the barbarian's square and each adjacent square. The <em>invisibility purge</em> only affects nongood creatures. A barbarian must be at least 8th level and have the <Link to="/ragepower/lesser_celestial_totem">lesser celestial totem</Link> to select this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_celestial_totem">Greater Celestial Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-D-3" id="arc-barbarian-totem_warrior-ref-D-3" data-hash-target to="arc-barbarian-totem_warrior-D">4</InnerLink></sup> While <em>raging,</em> the barbarian gains spell resistance equal to 11 + the barbarian's class level against spells with the evil descriptor. She also gains a +2 bonus on all saving throws against spells and effects from evil creatures. A barbarian must have the <Link to="/ragepower/celestial_totem">celestial totem</Link> rage power and be at least 12th level to select this rage power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_chaos_totem">Lesser Chaos Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-C-4" id="arc-barbarian-totem_warrior-ref-C-4" data-hash-target to="arc-barbarian-totem_warrior-C">3</InnerLink></sup> While <em>raging,</em> the barbarian gains a +1 deflection bonus to AC against the attacks of lawful creatures and a +1 resistance bonus on saving throws against confusion, insanity, polymorph, and effects with the lawful descriptor. This bonus increases by +1 for each chaos totem rage power she possesses.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/chaos_totem">Chaos Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-C-5" id="arc-barbarian-totem_warrior-ref-C-5" data-hash-target to="arc-barbarian-totem_warrior-C">3</InnerLink></sup> While <em>raging,</em> the barbarian's form becomes infused with chaos. She gains a +4 bonus on Escape Artist checks and has a 25% chance to ignore extra damage from critical hits and sneak attacks. A barbarian must have the <Link to="/ragepower/lesser_chaos_totem">lesser chaos totem</Link> rage power to select this rage power. A barbarian must be at least 6th level to select this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_chaos_totem">Greater Chaos Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-C-6" id="arc-barbarian-totem_warrior-ref-C-6" data-hash-target to="arc-barbarian-totem_warrior-C">3</InnerLink></sup> While <em>raging,</em> the barbarian gains DR/lawful equal to 1/2 her barbarian level. Her weapons and natural weapons are considered chaotic for the purpose of overcoming damage reduction. A barbarian must have the <Link to="/ragepower/chaos_totem">chaos totem</Link> rage power to select this rage power. A barbarian must be at least 10th level to select this rage power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_cult_totem">Lesser Cult Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-E-1" id="arc-barbarian-totem_warrior-ref-E-1" data-hash-target to="arc-barbarian-totem_warrior-E">5</InnerLink></sup> While the barbarian is <em>raging,</em> any morale bonuses or bonuses for flanking she gains on attacks rolls are added to her damage rolls instead of her attack rolls. They are still morale bonuses, and they don't stack with other morale bonuses on damage rolls.</p>
<blockquote>
...
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_cult_totem">Greater Cult Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-E-3" id="arc-barbarian-totem_warrior-ref-E-3" data-hash-target to="arc-barbarian-totem_warrior-E">5</InnerLink></sup> While the barbarian is <em>raging,</em> when she takes hit point damage that would render her dying or dead, she remains conscious and <em>raging</em> until the end of her next turn after taking that damage, though she is <Link to="/misc/disabled">disabled</Link> during that turn. She becomes <Link to="/misc/dying">dying</Link> or <Link to="/misc/dead">dead</Link> at the end of her next turn as normal for her current hit point total. This ability has no effect if the barbarian dies from a cause other than hit point damage, such as from a death effect or if her Constitution damage exceeds her Constitution score. A barbarian must be at least 10th level and have the <Link to="/ragepower/lesser_cult_totem">lesser cult totem</Link> and <Link to="/ragepower/cult_totem">cult totem</Link> rage powers to select this rage power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_daemon_totem">Lesser Daemon Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-E-4" id="arc-barbarian-totem_warrior-ref-E-4" data-hash-target to="arc-barbarian-totem_warrior-E">5</InnerLink></sup> While <em>raging,</em> the barbarian gains a +2 bonus on saving throws against acid damage, death effects, disease, and poison. This bonus increases by 1 for each daemon totem rage power the barbarian has, excluding this one.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/daemon_totem">Daemon Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-E-5" id="arc-barbarian-totem_warrior-ref-E-5" data-hash-target to="arc-barbarian-totem_warrior-E">5</InnerLink></sup> While the barbarian is <em>raging,</em> her melee attacks impose a temporary negative level on her opponent on a successful critical hit. After 1 hour, these temporary negative levels disappear automatically (without a saving throw). A barbarian must be at least 6th level and have the <Link to="/ragepower/lesser_daemon_totem">lesser daemon totem</Link> rage power to select this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_daemon_totem">Greater Daemon Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-E-6" id="arc-barbarian-totem_warrior-ref-E-6" data-hash-target to="arc-barbarian-totem_warrior-E">5</InnerLink></sup> If the barbarian kills an intelligent creature with a CR equal to at least half her character level while <em>raging,</em> she heals 5 hit points. If she is already at her maximum number of hit points, she instead gains 5 <Link to="/rule/temporary_hit_points">temporary hit points</Link>, which don't stack if she kills multiple creatures. A barbarian must be at least 10th level and have the <Link to="/ragepower/lesser_daemon_totem">lesser daemon totem</Link> and <Link to="/ragepower/daemon_totem">daemon totem</Link> rage powers to select this rage power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/dragon_totem">Dragon Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-F-1" id="arc-barbarian-totem_warrior-ref-F-1" data-hash-target to="arc-barbarian-totem_warrior-F">6</InnerLink></sup> The barbarian must select a single color of dragon (black, blue, brass, bronze, copper, gold, green, red, silver, or white) as her totem. While <em>raging,</em> she gains a +1 bonus on Perception checks and a +1 morale bonus on saving throws against fear, paralysis, and sleep effects. This bonus increases by +1 for each additional dragon totem rage power (such as dragon totem resilience and dragon totem wings) the barbarian possesses. A barbarian must have the <Link to="/ragepower/animal_fury">animal fury</Link> and <Link to="/ragepower/intimidating_glare">intimidating glare</Link> rage powers and be at least 6th level before selecting this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/dragon_totem_resilience">Dragon Totem Resilience:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-F-2" id="arc-barbarian-totem_warrior-ref-F-2" data-hash-target to="arc-barbarian-totem_warrior-F">6</InnerLink></sup> While <em>raging,</em> the barbarian gains resistance to the energy type that is associated with her dragon totem - acid (black, copper, green), cold (silver, white), electricity (blue, bronze), or fire (brass, gold, red). This resistance equals double her current DR/- from her barbarian damage reduction class feature; this energy resistance increases by 2 for each dragon totem rage power she possesses, including this one. A barbarian must have the <Link to="/ragepower/dragon_totem">dragon totem</Link> rage power and be at least 8th level before selecting this rage power.</p>
<p><strong className="hl"><Link to="/ragepower/dragon_totem_wings">Dragon Totem Wings:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-F-3" id="arc-barbarian-totem_warrior-ref-F-3" data-hash-target to="arc-barbarian-totem_warrior-F">6</InnerLink></sup> When a barbarian selects this rage power, the Fly (Dex) skill becomes a class skill for her. While <em>raging</em> and wearing medium or lighter armor, the barbarian can spend a standard action to manifest a pair of spiritual dragon wings that grant her a fly speed equal to her base speed (average maneuverability). She can expend 2 rounds of her <em>rage</em> to instead spend an immediate action to gain this fly speed. She can end her fly speed at any time, even when it is not her turn. Each round she spends <em>raging</em> and flying counts as 2 rounds of <em>rage.</em> Her ability to fly ends automatically when she ceases <em>raging.</em> A barbarian must have the <Link to="/ragepower/dragon_totem">dragon totem</Link> and <Link to="/ragepower/dragon_totem_resilience">dragon totem resilience</Link> rage powers, and she must be at least 10th level before selecting this rage power.</p>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_elemental_totem">Lesser Elemental Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-G-1" id="arc-barbarian-totem_warrior-ref-G-1" data-hash-target to="arc-barbarian-totem_warrior-G">7</InnerLink></sup> The barbarian selects one elemental type (air, earth, fire, or water). Once selected, this choice cannot be changed. While <em>raging,</em> the barbarian gains a +1 bonus on saving throws against spells with the selected elemental descriptor. This bonus increases by 1 at 4th level and every 4 levels thereafter, to a maximum of +6 at 20th level. The barbarian gains access to the elemental totem rage power matching the element she selected.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/air_totem">Air Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-G-2" id="arc-barbarian-totem_warrior-ref-G-2" data-hash-target to="arc-barbarian-totem_warrior-G">7</InnerLink></sup> Once per <em>rage,</em> the barbarian can move for 1 round as if affected by <Link to="/spell/air_walk">air walk</Link>. You must be at least 6th level and must have selected air when you gained the <Link to="/ragepower/lesser_elemental_totem">lesser elemental totem</Link> rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_air_totem">Greater Air Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-G-3" id="arc-barbarian-totem_warrior-ref-G-3" data-hash-target to="arc-barbarian-totem_warrior-G">7</InnerLink></sup> While <em>raging,</em> the barbarian is surrounded by an aura of howling winds. Creatures attempting to cast spells while adjacent to the barbarian must succeed at a <Link to="/rule/concentration">concentration</Link> check (DC 15 + spell level), and ranged attack rolls against the barbarian take a -4 penalty. Creatures smaller than the barbarian that attack the barbarian in melee with a natural weapon or touch attack must succeed at a Fortitude save (DC 10 + 1/2 the barbarian's level + the barbarian's Constitution modifier) or the attack fails and the creature is flung back 5 feet and knocked <Link to="/rule/prone">prone</Link>. The barbarian can suspend this aura as a free action. You must be 10th level and have the <Link to="/ragepower/air_totem">air totem</Link> rage power before you can select this.</p>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/earth_totem">Earth Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-G-4" id="arc-barbarian-totem_warrior-ref-G-4" data-hash-target to="arc-barbarian-totem_warrior-G">7</InnerLink></sup> While <em>raging,</em> the barbarian can burrow through sand, loose soil, or gravel at a speed of 20 feet. This does not give the barbarian the ability to breathe underground. Loose material collapses behind the target 1 round after it leaves the area. You must be at least 6th level and must have selected earth when you gained the <Link to="/ragepower/lesser_elemental_totem">lesser elemental totem</Link> rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_earth_totem">Greater Earth Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-G-5" id="arc-barbarian-totem_warrior-ref-G-5" data-hash-target to="arc-barbarian-totem_warrior-G">7</InnerLink></sup> While <em>raging,</em> the barbarian's skin becomes as hard as stone. If the barbarian is hit with a manufactured weapon while <em>raging,</em> the weapon takes an amount of damage equal to half that dealt to the barbarian (ignoring damage reduction). You must be 10th level and have the <Link to="/ragepower/earth_totem">earth totem</Link> rage power before you can select this.</p>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/fire_totem">Fire Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-G-6" id="arc-barbarian-totem_warrior-ref-G-6" data-hash-target to="arc-barbarian-totem_warrior-G">7</InnerLink></sup> While the barbarian is <em>raging,</em> any opponent that confirms a critical hit against her with a piercing or slashing melee weapon is sprayed with liquid fire. (Creatures with reach weapons are immune.) The attacker takes 1d6 points of fire damage per barbarian level (Reflex halves; DC 10 + 1/2 the barbarian's level + the barbarian's Con modifier). You must be at least 6th level and must have selected fire when you gained the <Link to="/ragepower/lesser_elemental_totem">lesser elemental totem</Link> rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_fire_totem">Greater Fire Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-G-7" id="arc-barbarian-totem_warrior-ref-G-7" data-hash-target to="arc-barbarian-totem_warrior-G">7</InnerLink></sup> While <em>raging,</em> the barbarian can envelope herself in a cloud of smoke that fills a 10-foot-radius sphere and follows her as she moves. Creatures in the affected area must succeed at Fortitude saves each round or <Link to="/rule/forest_fires">suffer the effects of breathing heavy smoke</Link>. The barbarian is immune to the smoke's effects, including vision obstruction. She can end this smoke as a free action, or it can be dispersed by wind in the same manner as a <Link to="/spell/fog_cloud">fog cloud</Link> spell. You must be 10th level and have the <Link to="/ragepower/fire_totem">fire totem</Link> rage power before you can select this.</p>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/water_totem">Water Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-G-8" id="arc-barbarian-totem_warrior-ref-G-8" data-hash-target to="arc-barbarian-totem_warrior-G">7</InnerLink></sup> While <em>raging,</em> the barbarian can breathe water as well as air. You must be at least 6th level and must have selected water when you gained the <Link to="/ragepower/lesser_elemental_totem">lesser elemental totem</Link> rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_water_totem">Greater Water Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-G-9" id="arc-barbarian-totem_warrior-ref-G-9" data-hash-target to="arc-barbarian-totem_warrior-G">7</InnerLink></sup> While <em>raging,</em> the barbarian gains <Link to="/umr/tremorsense">tremorsense</Link> to a range of 30 feet while underwater. She can attack and move underwater as if affected by <Link to="/spell/freedom_of_movement">freedom of movement</Link>. You must be 10th level and have the <Link to="/ragepower/water_totem">water totem</Link> rage power before you can select this.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_fiend_totem">Lesser Fiend Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-C-7" id="arc-barbarian-totem_warrior-ref-C-7" data-hash-target to="arc-barbarian-totem_warrior-C">3</InnerLink></sup> While <em>raging,</em> the barbarian grows a pair of large horns, gaining a gore attack. This attack is a primary attack (unless she is also attacking with weapons, in which case it is a secondary attack) and is made at the barbarian's full base attack bonus (-5 if it is a secondary attack). The gore attack deals 1d8 points of piercing damage (1d6 if Small) plus the barbarian's Strength modifier (1/2 if it is a secondary attack).</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/fiend_totem">Fiend Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-C-8" id="arc-barbarian-totem_warrior-ref-C-8" data-hash-target to="arc-barbarian-totem_warrior-C">3</InnerLink></sup> While <em>raging,</em> the barbarian sprouts dozens of wicked barbs from her body. Anyone striking the barbarian with a melee weapon, an unarmed strike, or a natural weapon takes 1d6 points of piercing damage. A barbarian must have the <Link to="/ragepower/lesser_fiend_totem">lesser fiend totem</Link> rage power to select this rage power. A barbarian must be at least 6th level to select this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_fiend_totem">Greater Fiend Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-C-9" id="arc-barbarian-totem_warrior-ref-C-9" data-hash-target to="arc-barbarian-totem_warrior-C">3</InnerLink></sup> While <em>raging,</em> the barbarian is surrounded by an aura of menace. Good creatures adjacent to the barbarian are <Link to="/misc/shaken">shaken</Link> and take 2d6 points of slashing damage at the beginning of the barbarian's turn as dozens of small cuts open across their flesh. Neutral creatures that are adjacent to the barbarian are shaken, but do not take any damage. Evil creatures are unaffected. A barbarian must have the <Link to="/ragepower/fiend_totem">fiend totem</Link> rage power to select this rage power. A barbarian must be at least 10th level to select this rage power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/hive_totem">Hive Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-F-4" id="arc-barbarian-totem_warrior-ref-F-4" data-hash-target to="arc-barbarian-totem_warrior-F">6</InnerLink></sup> While <em>raging,</em> the barbarian takes half damage from attacks by swarms of vermin, including spells and effects that act like a swarm of vermin (like <Link to="/spell/summon_swarm">summon swarm</Link> used to summon spiders or <Link to="/spell/insect_plague">insect plague</Link>). She also gains a +1 bonus on Strength ability checks and to CMD against bull rush, drag, and trip attacks for every four barbarian levels she has (maximum +5). A barbarian must have the <Link to="/ragepower/animal_fury">animal fury</Link> rage power and be at least 4th level before selecting this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/hive_totem_resilience">Hive Totem Resilience:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-F-5" id="arc-barbarian-totem_warrior-ref-F-5" data-hash-target to="arc-barbarian-totem_warrior-F">6</InnerLink></sup> While <em>raging,</em> the barbarian takes no damage from attacks by swarms of vermin, preventing harmful secondary effects of such attacks like poison or bleed. She also gains a +1 bonus on combat maneuver checks and to CMD when grappling for every four barbarian levels she has (maximum +5). A barbarian must have the <Link to="/ragepower/hive_totem">hive totem</Link> rage power and be at least 6th level before selecting this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/hive_totem_toxicity">Hive Totem Toxicity:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-F-6" id="arc-barbarian-totem_warrior-ref-F-6" data-hash-target to="arc-barbarian-totem_warrior-F">6</InnerLink></sup> While <em>raging,</em> the barbarian increases her bite damage die type with the <Link to="/ragepower/animal_fury">animal fury</Link> rage power <Link to="/umr/natural_attacks">by one die type</Link> and decreases the penalty on attack rolls with that bite to -2. Once per <em>rage,</em> a bite that hits can deliver an injury toxin that has a frequency of once per round for 4 rounds, deals 1d3 points of <Link to="/rule/constitution_damage">Constitution damage</Link>, and has a cure of one save. The saving throw has a Fortitude save DC of 10 + 1/2 the barbarian's level + the barbarian's Constitution modifier. A barbarian must have the <Link to="/ragepower/hive_totem">hive totem</Link> and <Link to="/ragepower/hive_totem_resilience">hive totem resilience</Link> rage powers and be at least 8th level before selecting this rage power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_moon_totem">Lesser Moon Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-A-4" id="arc-barbarian-totem_warrior-ref-A-4" data-hash-target to="arc-barbarian-totem_warrior-A">1</InnerLink></sup> While <em>raging,</em> the barbarian gains darkvision with a range of 30 feet. If the barbarian already has darkvision, the range of her darkvision increases by 30 feet while she is <em>raging.</em></p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/moon_totem">Moon Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-A-5" id="arc-barbarian-totem_warrior-ref-A-5" data-hash-target to="arc-barbarian-totem_warrior-A">1</InnerLink></sup> While <em>raging,</em> the barbarian gains a bonus equal to half her level on Perception checks to pinpoint the location of an unseen creature, and unseen attackers gain no bonus on attacks against the barbarian. A barbarian must have the <Link to="/ragepower/lesser_moon_totem">lesser moon totem</Link> rage power and be at least 6th level to select this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_moon_totem">Greater Moon Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-A-6" id="arc-barbarian-totem_warrior-ref-A-6" data-hash-target to="arc-barbarian-totem_warrior-A">1</InnerLink></sup> While <em>raging,</em> the barbarian ignores the miss chance for <Link to="/rule/concealment">concealment</Link> and treats total concealment as concealment. She must have the <Link to="/ragepower/moon_totem">moon totem</Link> rage power and be at least 10th level to select this rage power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/lesser_psychopomp_totem">Lesser Psychopomp Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-H-1" id="arc-barbarian-totem_warrior-ref-H-1" data-hash-target to="arc-barbarian-totem_warrior-H">8</InnerLink></sup> While <em>raging,</em> the barbarian gains a +1 deflection bonus to AC against the attacks of undead creatures and a +1 bonus on saving throws against death effects, diseases, and poisons. This bonus increases by 1 for each psychopomp totem rage power she has, excepting this one.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/psychopomp_totem">Psychopomp Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-H-2" id="arc-barbarian-totem_warrior-ref-H-2" data-hash-target to="arc-barbarian-totem_warrior-H">8</InnerLink></sup> The first time each round a creature with <Link to="/umr/regeneration">regeneration</Link> or <Link to="/umr/fast_healing">fast healing</Link> is struck by the barbarian while she is <em>raging,</em> the creature must succeed at a Will save (DC = 10 + half the barbarian's level + the barbarian's Strength modifier) or that ability is suppressed for 1 round. A barbarian must have the <Link to="/ragepower/lesser_psychopomp_totem">lesser psychopomp totem</Link> rage power and be at least 6th level to select this rage power.</p>
<blockquote>
...
<p><strong className="hl"><Link to="/ragepower/lesser_tyrant_totem">Lesser Tyrant Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-J-1" id="arc-barbarian-totem_warrior-ref-J-1" data-hash-target to="arc-barbarian-totem_warrior-J">10</InnerLink></sup> While <em>raging,</em> the barbarian's bite attack deals damage as if the barbarian were <Link to="/umr/natural_attacks">one size larger</Link> than her actual size. The barbarian must have the <Link to="/ragepower/animal_fury">animal fury</Link> rage power or a natural bite attack to choose this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/tyrant_totem">Tyrant Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-J-2" id="arc-barbarian-totem_warrior-ref-J-2" data-hash-target to="arc-barbarian-totem_warrior-J">10</InnerLink></sup> While <em>raging,</em> the barbarian can begin a <Link to="/rule/grapple">grapple</Link> as a free action against any creature she hits with her bite attack. A barbarian must be at least 8th level and have the <Link to="/ragepower/lesser_tyrant_totem">lesser tyrant totem</Link> to choose this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/greater_tyrant_totem">Greater Tyrant Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-J-3" id="arc-barbarian-totem_warrior-ref-J-3" data-hash-target to="arc-barbarian-totem_warrior-J">10</InnerLink></sup> While <em>raging,</em> the barbarian gains <Link to="/umr/swallow_whole">swallow whole</Link> as per the universal monster rule. A barbarian must be at least 12th level and have the <Link to="/ragepower/tyrant_totem">tyrant totem</Link> to choose this rage power.</p>
</blockquote>
</blockquote>
<p><strong className="hl"><Link to="/ragepower/world_serpent_totem">World Serpent Totem:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-F-7" id="arc-barbarian-totem_warrior-ref-F-7" data-hash-target to="arc-barbarian-totem_warrior-F">6</InnerLink></sup> While <em>raging,</em> the barbarian gains a +1 insight bonus to AC against outsiders and aberrations. This bonus increases by +1 for each world serpent rage power the barbarian possesses, excluding this one.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/world_serpent_spirit">World Serpent Spirit:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-F-8" id="arc-barbarian-totem_warrior-ref-F-8" data-hash-target to="arc-barbarian-totem_warrior-F">6</InnerLink></sup> While <em>raging,</em> the barbarian considers her weapons to be chaotic-, evil-, good-, and lawful-aligned for the purposes of overcoming damage reduction. She also gains a +1 resistance bonus on saving throws against spells and effects that have an alignment descriptor or come from an outsider or aberration. This bonus increases by +1 for each world serpent rage power the barbarian possesses, excluding this one. A barbarian must have the <Link to="/ragepower/world_serpent_totem">world serpent totem</Link> rage power and be at least 6th level before selecting this rage power.</p>
<blockquote>
<p><strong className="hl"><Link to="/ragepower/world_serpent_totem_unity">World Serpent Totem Unity:</Link></strong> <sup><InnerLink showBacklink="backlink-arc-barbarian-totem_warrior-ref-F-9" id="arc-barbarian-totem_warrior-ref-F-9" data-hash-target to="arc-barbarian-totem_warrior-F">6</InnerLink></sup> While <em>raging,</em> the barbarian doubles her fast movement bonus to land speed and cannot be knocked <Link to="/rule/prone">prone</Link>. She also doubles her world serpent totem insight bonus to AC against attack rolls made by an outsider or aberration to confirm a critical hit against her. A barbarian must have the <Link to="/ragepower/world_serpent_totem">world serpent totem</Link> and <Link to="/ragepower/world_serpent_spirit">world serpent spirit</Link> rage powers and be at least 10th level before selecting this rage power.</p>
</blockquote>
</blockquote>
