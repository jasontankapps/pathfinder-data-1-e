...
<Ability id="emotional-reading-su" icon={["magic"]}>
...
<Ability id="courtly-contacts-su" icon={["power"]}>
...
<Ability id="panoply-bond-su" icon={["power","def"]}>
...
<Ability id="battle-skill" icon={["down"]}>
...
<Ability id="battle-reading" icon={["down"]}>
...
<Ability id="spirit-warrior-sp" icon={["magic"]}>
...
<Ability id="heroic-splendor-su" icon={["boost"]}>
...
<Ability id="constructed-focus-su" icon={["power","magic"]}>
...
<Ability id="repower-construct-su" icon={["magic"]}>
...
<Ability id="extensive-collection-su" icon={["power"]}>
...
<Ability id="split-focus-su" icon={["down"]}>
...
<Ability id="adaptable-powers-su" icon={["magic"]}>
...
<Ability id="relic-resistance-ex" icon={["def"]}>
...
<Ability id="complex-collection-su" icon={["boost"]}>
...
<Ability id="mental-catalog-su" icon={["boost"]}>
...
<Ability id="implements-of-the-palatine-eye-su" icon={["magic","boost"]}>
...
<Ability id="symbolism-sp" icon={["power"]}>
...
<Ability id="improvisational-combatant-ex" icon={["boost","power"]}>
...
<Ability id="fleeting-focus-su" icon={["magic","power"]}>
...
<Ability id="transformative-resonance-su" icon={["boost"]}>
...
<Ability id="withdraw-focus-su" icon={["magic"]}>
...
<Ability id="improvised-spell-su" icon={["magic"]}>
...
<Ability id="geomantic-focus-su" icon={["power"]}>
...
<Ability id="geomancy-su" extraClasses="hasSubs" icon={["down","learn"]}>
...
<Ability id="cold-terrain" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="desert-terrain" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="forest-terrain" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="jungle-terrain" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="mountain-terrain" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="plains-terrain" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="planes-other-than-the-material-plane" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="swamp-terrain" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="underground-terrain" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="urban-terrain" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="water-terrain" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="survivalist-su" icon={["boost"]}>
...
<Ability id="terrain-stride-su" icon={["boost"]}>
...
<Ability id="dominion-su" icon={["boost","def"]}>
...
<Ability id="wall-of-terrain-sp" icon={["magic"]}>
...
<Ability id="possessed-possessions-su" icon={["power"]}>
...
<Ability id="hauntist-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="spirit-speaker-sp" icon={["magic"]}>
...
<Ability id="extricate-haunt-su" icon={["magic"]}>
...
<Ability id="natural-focus-su" icon={["boost","warning"]}>
...
<Ability id="tree-talker-sp" icon={["magic"]}>
...
<Ability id="reflect-on-the-land-sp" icon={["magic"]}>
...
<Ability id="necromantic-bond-su" icon={["down","learn","boost"]}>
...
<Ability id="deadspeaker-su" icon={["magic"]}>
...
<Ability id="ghostly-horde-su" icon={["magic"]}>
...
<Ability id="life-drain-sp" icon={["zap","aid"]}>
...
<Ability id="ruin-reading-su" icon={["magic"]}>
...
<Ability id="panoply-specialization" icon={["down"]}>
...
<Ability id="panoply-focus-su" icon={["boost"]}>
...
<Ability id="implement-specialist-su" icon={["boost"]}>
...
<Ability id="panoptic-harmony-su" icon={["boost"]}>
...
<Ability id="panoptic-call-su" icon={["magic"]}>
...
<Ability id="combined-powers-su" icon={["power"]}>
...
<Ability id="conductor-su" icon={["down","learn","boost"]}>
...
<Ability id="planar-scholar-su" icon={["boost"]}>
...
<Ability id="harmonic-shield-su" icon={["boost","def"]}>
...
<Ability id="outside-messenger-su" icon={["power","magic"]}>
...
<Ability id="trophies-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="monster-hunting-lore-ex" icon={["boost"]}>
...
<Ability id="discern-death-su" icon={["magic"]}>
...
<Ability id="seek-prey-su" icon={["magic"]}>
...
<Ability id="residual-hatred-su" icon={["boost"]}>
...
<Ability id="manifest-abilities-su" icon={["power","magic"]}>
...
<Ability id="domain" icon={["magic","learn"]}>
...
<Ability id="diminished-focus-power-su" icon={["down"]}>
...
<Ability id="sacred-implements-su" icon={["magic","warning"]}>
...
<Ability id="divine-focus-su" icon={["boost"]}>
...
<Ability id="knowledge-is-power" icon={["down","info","boost"]}>
...
<Ability id="broker-secrets-su" icon={["magic"]}>
...
<Ability id="share-memory-sp" icon={["magic"]}>
...
<Ability id="steal-secret-sp" icon={["magic"]}>
...
<Ability id="erase-secret-sp" icon={["magic"]}>
...
<Ability id="purge-secret-sp" icon={["boost"]}>
...
<Ability id="jin-su" icon={["power","down","learn"]}>
...
<Ability id="augment-jin-sp-su" icon={["boost"]}>
...
<Ability id="manifest-jin-su" icon={["boost"]}>
...
<Ability id="jin-spy-su" icon={["magic"]}>
...
<Ability id="implements" icon={["info","warning"]}>
...
<Ability id="mental-focus-su" icon={["boost"]}>
...
<Ability id="devoted-mystic" icon={["down","boost"]}>
...
<Ability id="silksworn-eloquence-ex" icon={["boost"]}>
...
<Ability id="silksworn-deception-su" icon={["power"]}>
...
<Ability id="silksworn-arcana-su" icon={["boost"]}>
...
<Ability id="spellbound-tailsman-su" icon={["magic","zap","touch"]}>
...
<Ability id="shared-talisman-su" icon={["magic"]}>
...
<Ability id="warding-seal-su" icon={["magic"]}>
...
<Ability id="bonded-tome-su" icon={["magic","boost"]}>
...
<Ability id="devour-books-and-scrolls-sp" icon={["magic","boost","def"]}>
...
<Ability id="word-sense-sp-su" icon={["power","magic"]}>
