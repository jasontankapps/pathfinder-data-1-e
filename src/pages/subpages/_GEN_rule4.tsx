...
<p>Instead of verbal and somatic components, all psychic spells have components related to the caster's inner being. The two psychic components are called emotion components and thought components. If a spell's components line lists a somatic component, that spell instead requires an emotion component when cast by psychic spellcasters, and if it has a verbal component, it instead requires a thought component when cast by psychic spellcasters. Psychic spells cast by non-psychic arcane and divine casters use any listed somatic and verbal components as normal.</p>
