...
<Pair single id="lore-ex">Lore (Ex)</Pair>
...
<Ability id="learn-from-failure-ex" icon={["upgrade"]}>
<Pair single id="learn-from-failure-ex">Learn from Failure (Ex)</Pair>
...
<Ability id="eye-of-the-sun-and-moon-ex" icon={["stairs-goal"]}>
<Pair single id="eye-of-the-sun-and-moon-ex">Eye of the Sun and Moon (Ex)</Pair>
...
<Ability id="walk-with-the-master-su" icon={["magic-swirl"]}>
<Pair single id="walk-with-the-master-su">Walk with the Master (Su)</Pair>
...
<div style={{clear:"both"}}></div><Ability id="ki-power" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="ki-power">Ki Power</Pair>
...
<Ability id="feats" extraClasses="subAbility numbered" icon={["stairs-goal"]}>
...
<Ability id="monk-abilities" extraClasses="subAbility numbered" icon={["stairs-goal"]}>
<Pair single id="monk-abilities">Monk Abilities</Pair>
...
<Ability id="spells" extraClasses="subAbility numbered" icon={["magic-swirl"]}>
...
<Pair single id="cunning-fist-ex">Cunning Fist (Ex)</Pair>
...
<Ability id="feinting-flurry" icon={["stairs-goal","broken-shield"]}>
<Pair single id="feinting-flurry">Feinting Flurry</Pair>
...
<Ability id="deceptive-ki-su" icon={["upgrade"]}>
<Pair single id="deceptive-ki-su">Deceptive Ki (Su)</Pair>
...
<Ability id="draconic-might" icon={["info"]}>
<Pair single id="draconic-might">Draconic Might</Pair>
...
<Ability id="draconic-mettle-su" icon={["armor-upgrade"]}>
<Pair single id="draconic-mettle-su">Draconic Mettle (Su)</Pair>
<Pair hl title="Replaces">Still mind</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="draconic-fury-su" icon={["mailed-fist"]}>
<Pair single id="draconic-fury-su">Draconic Fury (Su)</Pair>
...
<Ability id="draconic-breath-su" icon={["tornado-discs"]}>
<Pair single id="draconic-breath-su">Draconic Breath (Su)</Pair>
...
<Ability id="draconic-mettle-su" icon={["stairs-goal"]}>
<Pair single id="draconic-mettle-su">Draconic Mettle (Su)</Pair>
<Pair hl title="Replaces">4th-level ki power</Pair>
<Pair title="Gained">At 4th Level</Pair>
<Pair title="Passive Ability">A scaled fist gains a +2 bonus on saving throws attempted against all fear, paralysis, and sleep effects.</Pair>
</Ability>
<Ability id="draconic-fury-su" icon={["armor-upgrade"]}>
<Pair single id="draconic-fury-su">Draconic Fury (Su)</Pair>
<Pair hl title="Replaces">Still mind</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="mortifications-su" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="mortifications-su">Mortifications (Su)</Pair>
...
<Ability id="armor-of-scars-su" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="armor-of-scars-su">Armor of Scars (Su)</Pair>
...
<Ability id="blood-eagle-su" extraClasses="subAbility" icon={["mailed-fist","upgrade"]}>
<Pair single id="blood-eagle-su">Blood Eagle (Su)</Pair>
...
<Ability id="contortionist-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="contortionist-su">Contortionist (Su)</Pair>
...
<Ability id="eyes-stitched-shut-su" extraClasses="subAbility" icon={["broken-shield","stairs-goal"]}>
<Pair single id="eyes-stitched-shut-su">Eyes Stitched Shut (Su)</Pair>
...
<Ability id="face-collector-su" extraClasses="subAbility" icon={["upgrade","armor-upgrade"]}>
<Pair single id="face-collector-su">Face Collector (Su)</Pair>
...
<Ability id="doll-face-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="doll-face-su">Doll Face (Su)</Pair>
...
<Ability id="pain-binding-su" extraClasses="subAbility" icon={["mailed-fist"]}>
<Pair single id="pain-binding-su">Pain Binding (Su)</Pair>
...
<Ability id="rings-of-pain-su" extraClasses="subAbility" icon={["aura"]}>
<Pair single id="rings-of-pain-su">Rings of Pain (Su)</Pair>
...
<Ability id="share-pain-su" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="share-pain-su">Share Pain (Su)</Pair>
...
<Ability id="torturous-vision-su" extraClasses="subAbility" icon={["smoking-finger"]}>
<Pair single id="torturous-vision-su">Torturous Vision (Su)</Pair>
...
<Ability id="third-eye-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="third-eye-su">Third Eye (Su)</Pair>
...
<Ability id="tongueless-master-su" extraClasses="subAbility" icon={["broken-shield","armor-downgrade"]}>
<Pair single id="tongueless-master-su">Tongueless Master (Su)</Pair>
...
<Ability id="insightful-strike-ex" icon={["upgrade"]}>
<Pair single id="insightful-strike-ex">Insightful Strike (Ex)</Pair>
...
<Ability id="mystic-wisdom-su" icon={["upgrade","aura"]}>
<Pair single id="mystic-wisdom-su">Mystic Wisdom (Su)</Pair>
...
<Pair single id="chakra-training">Chakra Training</Pair>
...
<Ability id="chakra-expertise-ex" icon={["armor-upgrade"]}>
<Pair single id="chakra-expertise-ex">Chakra Expertise (Ex)</Pair>
...
<Ability id="light-spirit-su" icon={["stairs-goal","upgrade"]}>
<Pair single id="light-spirit-su">Light Spirit (Su)</Pair>
...
<Ability id="chakra-adept-ex" icon={["stairs-goal"]}>
<Pair single id="chakra-adept-ex">Chakra Adept (Ex)</Pair>
...
<Ability id="linked-chakras-ex" icon={["stairs-goal"]}>
<Pair single id="linked-chakras-ex">Linked Chakras (Ex)</Pair>
...
<Ability id="chakra-mastery-ex" icon={["stairs-goal"]}>
<Pair single id="chakra-mastery-ex">Chakra Mastery (Ex)</Pair>
...
<Ability id="well-of-sin-su" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="well-of-sin-su">Well of Sin (Su)</Pair>
...
<Ability id="envy" extraClasses="subAbility" icon={["upgrade"]}>
...
<Ability id="gluttony" extraClasses="subAbility" icon={["remedy"]}>
<Pair single id="gluttony">Gluttony</Pair>
...
<Ability id="greed" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="greed">Greed</Pair>
...
<Ability id="lust" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="lust">Lust</Pair>
<Pair title="Passive Ability">The sin monk gains a +4 bonus on Bluff and Diplomacy checks.</Pair>
<Pair title="At 10th Level">This bonus increases to +6.</Pair>
<Pair title="At 16th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="pride" extraClasses="subAbility" icon={["armor-upgrade"]}>
...
<Ability id="sloth" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="sloth">Sloth</Pair>
...
<Ability id="wrath" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="wrath">Wrath</Pair>
...
<Ability id="sinful-strike-su" icon={["upgrade"]}>
<Pair single id="sinful-strike-su">Sinful Strike (Su)</Pair>
<Pair hl title="Replaces">Wholeness of body</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="burden-with-sin-su" icon={["armor-downgrade"]}>
<Pair single id="burden-with-sin-su">Burden with Sin (Su)</Pair>
...
<Ability id="simultaneous-sins-su" icon={["stairs-goal"]}>
<Pair single id="simultaneous-sins-su">Simultaneous Sins (Su)</Pair>
...
<Ability id="spawn-of-sin-ex" icon={["magic-swirl","armor-upgrade"]}>
<Pair single id="spawn-of-sin-ex">Spawn of Sin (Ex)</Pair>
...
<Ability id="weapon-proficiency" icon={["stairs-goal","broken-shield"]}>
...
<Ability id="feather-touch-ex" icon={["upgrade"]}>
<Pair single id="feather-touch-ex">Feather Touch (Ex)</Pair>
...
<Ability id="nonlethal-strikes-ex" icon={["mailed-fist","broken-shield"]}>
<Pair single id="nonlethal-strikes-ex" flavor="A softstrike monk focuses on blows that do not inflict deadly harm.">Nonlethal Strikes (Ex)</Pair>
...
<Ability id="tenet-of-life-su" icon={["broken-shield"]}>
<Pair single id="tenet-of-life-su">Tenet of Life (Su)</Pair>
...
<Ability id="life-giving-blows-su" icon={["mailed-fist","armor-downgrade"]}>
<Pair single id="life-giving-blows-su" flavor="A softstrike monk can force a piece of his life force into a nonliving creature to disrupt its animating essence.">Life-Giving Blows (Su)</Pair>
...
<Ability id="wholeness-of-body-and-spirit-su" icon={["broken-shield","remedy","armor-upgrade"]}>
<Pair single id="wholeness-of-body-and-spirit-su">Wholeness of Body and Spirit (Su)</Pair>
...
<Ability id="incapacitating-palm-su" icon={["broken-shield"]}>
<Pair single id="incapacitating-palm-su">Incapacitating Palm (Su)</Pair>
...
<Ability id="resilient-body-su" icon={["armor-upgrade"]}>
<Pair single id="resilient-body-su">Resilient Body (Su)</Pair>
<Pair hl title="Replaces">Empty body</Pair>
<Pair title="Gained">At 19th Level</Pair>
...
<Ability id="devoted-guardian-ex" icon={["stairs-goal","upgrade","rolling-dices"]}>
<Pair single id="devoted-guardian-ex">Devoted Guardian (Ex)</Pair>
...
<Ability id="unarmed-strike" icon={["broken-shield"]}>
...
<Ability id="monastic-mount-su" icon={["remedy","shield-reflect","stairs-goal"]}>
<Pair single id="monastic-mount-su">Monastic Mount (Su)</Pair>
...
<Ability id="ki-weapon-su" icon={["upgrade"]}>
...
<Ability id="calming-strike-su" icon={["mailed-fist","magic-palm"]}>
<Pair single id="calming-strike-su">Calming Strike (Su)</Pair>
<Pair hl title="Replaces">Stunning fist</Pair>
...
<Ability id="otherworldly-resilience-ex" icon={["armor-upgrade"]}>
<Pair single id="otherworldly-resilience-ex">Otherworldly Resilience (Ex)</Pair>
...
<Ability id="spirit-sense-su" icon={["stairs-goal"]}>
...
<Ability id="yamarajs-judgment-sp" icon={["remedy"]}>
<Pair single id="yamarajs-judgment-sp">Yamaraj's Judgment (Sp)</Pair>
<Pair hl title="Replaces">Quivering palm</Pair>
<Pair title="Gained">At 15th Level</Pair>
...
<Ability id="resilient-soul-ex" icon={["armor-upgrade"]}>
<Pair single id="resilient-soul-ex">Resilient Soul (Ex)</Pair>
<Pair hl title="Replaces">Still mind</Pair>
<Pair title="Gained">At 3rd Level</Pair>
<Pair title="Passive Ability">A spirit master gains a +2 bonus on saving throws against necromancy spells and effects.</Pair>
</Ability>
<Ability id="spirit-combat-su" icon={["upgrade"]}>
<Pair single id="spirit-combat-su">Spirit Combat (Su)</Pair>
<Pair hl title="Replaces">Maneuver training</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="diamond-spirit-ex" icon={["armor-upgrade"]}>
<Pair single id="diamond-spirit-ex">Diamond Spirit (Ex)</Pair>
...
<Ability id="spirit-burst-su" icon={["aura"]}>
<Pair single id="spirit-burst-su">Spirit Burst (Su)</Pair>
<Pair hl title="Replaces">Wholeness of body</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="purifying-palm-su" icon={["mailed-fist","armor-downgrade"]}>
<Pair single id="purifying-palm-su" flavor="The spirit master gains the ability to alter the balance of positive and negative energy within an opponent's body.">Purifying Palm (Su)</Pair>
<Pair hl title="Replaces">Quivering palm</Pair>
<Pair title="Gained">At 15th Level</Pair>
...
<Ability id="spirit-flow-su" icon={["armor-upgrade"]}>
<Pair single id="spirit-flow-su" flavor="A spirit master can dramatically alter the flow of his own ki.">Spirit Flow (Su)</Pair>
<Pair hl title="Replaces">Empty body</Pair>
<Pair title="Gained">At 19th Level</Pair>
...
<Ability id="spirit-mastery-su" icon={["armor-upgrade","magic-swirl"]}>
<Pair single id="spirit-mastery-su">Spirit Mastery (Su)</Pair>
<Pair hl title="Replaces">Perfect self</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="strength-of-stone-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="strength-of-stone-ex" flavor="A student of stone learns to draw strength from the earth.">Strength of Stone (Ex)</Pair>
...
<Ability id="bones-of-stone-su" icon={["armor-upgrade"]}>
<Pair single id="bones-of-stone-su">Bones of Stone (Su)</Pair>
...
<Ability id="body-of-stone-ex" icon={["armor-upgrade"]}>
<Pair single id="body-of-stone-ex">Body of Stone (Ex)</Pair>
...
<Ability id="soul-of-stone-su" icon={["stairs-goal"]}>
<Pair single id="soul-of-stone-su">Soul of Stone (Su)</Pair>
<Pair hl title="Replaces">Abundant step</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="stone-self" icon={["magic-swirl","armor-upgrade","stairs-goal"]}>
<Pair single id="stone-self">Stone Self</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Pair single id="trap-intuition-ex">Trap Intuition (Ex)</Pair>
<Pair hl title="Replaces">Evasion</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="stone-grip-su" icon={["upgrade","stairs-goal"]}>
<Pair single id="stone-grip-su">Stone Grip (Su)</Pair>
<Pair hl title="Replaces">High jump</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="trap-dodge-ex" icon={["armor-upgrade"]}>
<Pair single id="trap-dodge-ex">Trap Dodge (Ex)</Pair>
<Pair hl title="Replaces">Improved evasion</Pair>
...
<Ability id="sudden-adit-su" icon={["magic-swirl"]}>
<Pair single id="sudden-adit-su">Sudden Adit (Su)</Pair>
<Pair hl title="Replaces">Abundant step</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="rainmaker-su" icon={["magic-swirl"]}>
<Pair single id="rainmaker-su">Rainmaker (Su)</Pair>
<Pair hl title="Replaces">Empty body</Pair>
<Pair title="Gained">At 19th Level</Pair>
...
<Ability id="graceful-grappler-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="graceful-grappler-ex">Graceful Grappler (Ex)</Pair>
...
<Ability id="counter-grapple-ex" icon={["mailed-fist"]}>
<Pair single id="counter-grapple-ex">Counter-Grapple (Ex)</Pair>
<Pair hl title="Replaces">Slow fall</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="break-free-ex" icon={["upgrade"]}>
<Pair single id="break-free-ex">Break Free (Ex)</Pair>
<Pair hl title="Replaces">High jump</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="inescapable-grasp-su" icon={["armor-downgrade"]}>
<Pair single id="inescapable-grasp-su">Inescapable Grasp (Su)</Pair>
...
<Ability id="form-lock-su" icon={["magic-swirl"]}>
<Pair single id="form-lock-su">Form Lock (Su)</Pair>
...
<Ability id="iron-body-su" icon={["armor-upgrade","upgrade","broken-shield"]}>
<Pair single id="iron-body-su">Iron Body (Su)</Pair>
<Pair hl title="Replaces">Empty body</Pair>
<Pair title="Gained">At 19th Level</Pair>
...
<Ability id="wood-affinity-su" icon={["stairs-goal"]}>
<Pair single id="wood-affinity-su">Wood Affinity (Su)</Pair>
<Pair hl title="Replaces">Purity of body</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="freedom-of-movement-su" icon={["armor-upgrade"]}>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-monk-underfoot_adept--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><Link to="/race/halfling">Halfling</Link></td></tr></tbody></table></ScrollContainer></div><Ability id="underfoot-grace-ex" icon={["armor-upgrade"]}>
<Pair single id="underfoot-grace-ex" flavor="An underfoot adept uses his size and grace to avoid the attacks of those he passes.">Underfoot Grace (Ex)</Pair>
...
<Ability id="underfoot-trip-ex" icon={["stairs-goal"]}>
<Pair single id="underfoot-trip-ex" flavor="An underfoot adept learns a number of maneuvers and grabs that can cause even the largest opponents to stumble and fall.">Underfoot Trip (Ex)</Pair>
<Pair hl title="Replaces">Stunning fist</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="improved-underfoot-grace-ex" icon={["armor-upgrade"]}>
<Pair single id="improved-underfoot-grace-ex" flavor="An underfoot adept's ability to avoid attacks of opportunity against those he passes improves.">Improved Underfoot Grace (Ex)</Pair>
<Pair hl title="Replaces">High jump</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="long-walk-ex" icon={["stairs-goal","upgrade","armor-upgrade"]}>
<Pair single id="long-walk-ex">Long Walk (Ex)</Pair>
<Pair hl title="Replaces">Still mind</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="light-step-su" icon={["armor-upgrade","magic-swirl"]}>
<Pair single id="light-step-su">Light Step (Su)</Pair>
<Pair hl title="Replaces">Slow fall</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="wanderers-wisdom-ex" icon={["upgrade"]}>
<Pair single id="wanderers-wisdom-ex" flavor="The wanderer can dispense excellent advice in the form of philosophical proverbs and parables.">Wanderer's Wisdom (Ex)</Pair>
<Pair hl title="Replaces">Wholeness of body</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="disappear-unnoticed-ex" icon={["armor-upgrade"]}>
<Pair single id="disappear-unnoticed-ex">Disappear Unnoticed (Ex)</Pair>
<Pair hl title="Replaces">Abundant step</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="free-step-su" icon={["armor-upgrade"]}>
<Pair single id="free-step-su">Free Step (Su)</Pair>
<Pair hl title="Replaces">Diamond soul</Pair>
<Pair title="Gained">At 13th Level</Pair>
...
<Ability id="dehydrating-strike-su" icon={["mailed-fist","armor-downgrade"]}>
<Pair single id="dehydrating-strike-su">Dehydrating Strike (Su)</Pair>
<Pair hl title="Replaces">Stunning fist</Pair>
...
<Ability id="vigor-ex" icon={["armor-upgrade"]}>
<Pair single id="vigor-ex">Vigor (Ex)</Pair>
<Pair hl title="Replaces">Evasion</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="desert-strider-ex" icon={["stairs-goal","armor-upgrade"]}>
<Pair single id="desert-strider-ex">Desert Strider (Ex)</Pair>
<Pair hl title="Replaces">Slow fall</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="improved-vigor-ex" icon={["armor-upgrade"]}>
<Pair single id="improved-vigor-ex">Improved Vigor (Ex)</Pair>
<Pair hl title="Replaces">Improved evasion</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="pillar-of-salt-su" icon={["mailed-fist","armor-downgrade"]}>
<Pair single id="pillar-of-salt-su" flavor="A wasteland meditant can transform a creature's body into a column of crumbling salt with a touch.">Pillar of Salt (Su)</Pair>
<Pair hl title="Replaces">Quivering palm</Pair>
<Pair title="Gained">At 15th Level</Pair>
...
<Ability id="elemental-focus-su-and-sp" icon={["stairs-goal"]}>
<Pair single id="elemental-focus-su-and-sp">Elemental Focus (Su and Sp)</Pair>
...
<Ability id="nereids-grace-su" icon={["armor-upgrade","info"]}>
<Pair single id="nereids-grace-su">Nereid's Grace (Su)</Pair>
<Pair hl title="Replaces">Bonus feat gained at 1st level</Pair>
...
<Ability id="unarmed-strike" icon={["mailed-fist","broken-shield"]}>
<Pair single id="unarmed-strike">Unarmed Strike</Pair>
<Pair hl title="Alters">Unarmed strike</Pair>
...
<Ability id="water-dance-su" icon={["stairs-goal"]}>
<Pair single id="water-dance-su">Water Dance (Su)</Pair>
<Pair hl title="Replaces">Slow fall</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="metakinesis-su" icon={["magic-swirl"]}>
<Pair single id="metakinesis-su">Metakinesis (Su)</Pair>
<Pair hl title="Replaces">Improved evasion</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="water-stride-sp" icon={["magic-swirl"]}>
<Pair single id="water-stride-sp">Water Stride (Sp)</Pair>
<Pair hl title="Replaces">Abundant step</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="perfect-strike-ex" icon={["stairs-goal","rolling-dices"]}>
...
<Ability id="way-of-the-weapon-master-ex" icon={["stairs-goal"]}>
<Pair single id="way-of-the-weapon-master-ex">Way of the Weapon Master (Ex)</Pair>
<Pair hl title="Replaces">Evasion</Pair>
...
<Ability id="uncanny-initiative-ex" icon={["rolling-dices"]}>
<Pair single id="uncanny-initiative-ex">Uncanny Initiative (Ex)</Pair>
...
<Ability id="pure-power" icon={["upgrade"]}>
<Pair single id="pure-power">Pure Power</Pair>
<Pair hl title="Replaces">Perfect self</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="ready-for-anything-ex" icon={["upgrade"]}>
<Pair single id="ready-for-anything-ex">Ready for Anything (Ex)</Pair>
<Pair hl title="Replaces">Still mind</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="brawler-maneuver-training-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="brawler-maneuver-training-ex" flavor="A wildcat gains additional training with the dirty tricks.">Brawler Maneuver Training (Ex)</Pair>
...
<Ability id="improvised-weapon-mastery-ex" icon={["upgrade"]}>
...
<Ability id="knockout-ex" icon={["mailed-fist","armor-downgrade"]}>
...
<Ability id="turn-the-tables-ex" icon={["armor-downgrade"]}>
<Pair single id="turn-the-tables-ex">Turn the Tables (Ex)</Pair>
<Pair hl title="Replaces">Diamond soul</Pair>
<Pair title="Gained">At 13th Level</Pair>
...
<Ability id="dirty-blow-ex" icon={["upgrade"]}>
<Pair single id="dirty-blow-ex">Dirty Blow (Ex)</Pair>
<Pair hl title="Replaces">Empty body</Pair>
<Pair title="Gained">At 19th Level</Pair>
...
<Ability id="hurricane-punch-ex" icon={["stairs-goal"]}>
<Pair single id="hurricane-punch-ex">Hurricane Punch (Ex)</Pair>
<Pair hl title="Replaces">Stunning fist</Pair>
...
<Ability id="wind-step-su" icon={["stairs-goal"]}>
<Pair single id="wind-step-su" flavor="The windstep master's steps become supernaturally light.">Wind Step (Su)</Pair>
<Pair hl title="Replaces">Slow fall</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="swift-ki-su" icon={["magic-swirl","upgrade"]}>
<Pair single id="swift-ki-su">Swift Ki (Su)</Pair>
...
<Ability id="flurry-of-blows-ex" icon={["stairs-goal","broken-shield"]}>
...
<Ability id="bonus-feats" icon={["stairs-goal","broken-shield"]}>
<Pair single id="bonus-feats">Bonus Feats</Pair>
...
<Ability id="way-of-the-bow-ex" icon={["stairs-goal"]}>
<Pair single id="way-of-the-bow-ex">Way of the Bow (Ex)</Pair>
<Pair hl title="Replaces">Evasion</Pair>
...
<Ability id="zen-archery-ex" icon={["upgrade"]}>
<Pair single id="zen-archery-ex">Zen Archery (Ex)</Pair>
<Pair hl title="Replaces">Maneuver training</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="point-blank-master-ex" icon={["stairs-goal"]}>
<Pair single id="point-blank-master-ex">Point Blank Master (Ex)</Pair>
<Pair hl title="Replaces">Still mind</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="ki-pool-su" icon={["bowman"]}>
...
<Ability id="ki-arrows-su" icon={["upgrade","bowman"]}>
<Pair single id="ki-arrows-su">Ki Arrows (Su)</Pair>
<Pair hl title="Replaces">Purity of body</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="reflexive-shot-ex" icon={["stairs-goal"]}>
<Pair single id="reflexive-shot-ex">Reflexive Shot (Ex)</Pair>
<Pair hl title="Replaces">Improved evasion</Pair>
<Pair title="Gained">At 9th Level</Pair>
...
<Ability id="trick-shot-su" icon={["bowman","armor-downgrade"]}>
<Pair single id="trick-shot-su" flavor="A zen archer may hit targets that he might otherwise miss.">Trick Shot (Su)</Pair>
...
<Ability id="ki-focus-bow-su" icon={["upgrade"]}>
<Pair single id="ki-focus-bow-su">Ki Focus Bow (Su)</Pair>
<Pair hl title="Replaces">Tongue of the sun and moon</Pair>
<Pair title="Gained">At 17th Level</Pair>
