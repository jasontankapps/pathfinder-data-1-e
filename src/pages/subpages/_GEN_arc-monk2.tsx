...
<Ability id="learn-from-failure-ex" icon={["boost"]}>
...
<Ability id="eye-of-the-sun-and-moon-ex" icon={["power"]}>
...
<Ability id="walk-with-the-master-su" icon={["magic"]}>
...
<div style={{clear:"both"}}></div><Ability id="ki-power" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="feats" extraClasses="subAbility numbered" icon={["power"]}>
...
<Ability id="monk-abilities" extraClasses="subAbility numbered" icon={["power"]}>
...
<Ability id="spells" extraClasses="subAbility numbered" icon={["magic"]}>
...
<Ability id="cunning-fist-ex" icon={["power"]}>
...
<Ability id="feinting-flurry" icon={["power","down"]}>
...
<Ability id="deceptive-ki-su" icon={["boost"]}>
...
<Ability id="draconic-mettle-su" icon={["def"]}>
...
<Ability id="draconic-fury-su" icon={["melee"]}>
...
<Ability id="draconic-breath-su" icon={["cone"]}>
...
<Ability id="draconic-mettle-su" icon={["power"]}>
<Pair single id="draconic-mettle-su">Draconic Mettle (Su)</Pair>
<Pair hl title="Replaces">4th-level ki power</Pair>
<Pair title="Gained">At 4th Level</Pair>
<Pair title="Passive Ability">A scaled fist gains a +2 bonus on saving throws attempted against all fear, paralysis, and sleep effects.</Pair>
</Ability>
<Ability id="draconic-fury-su" icon={["def"]}>
<Pair single id="draconic-fury-su">Draconic Fury (Su)</Pair>
<Pair hl title="Replaces">Still mind</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="mortifications-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="armor-of-scars-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="blood-eagle-su" extraClasses="subAbility" icon={["melee","boost"]}>
...
<Ability id="contortionist-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="eyes-stitched-shut-su" extraClasses="subAbility" icon={["down","power"]}>
...
<Ability id="face-collector-su" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="doll-face-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="pain-binding-su" extraClasses="subAbility" icon={["melee"]}>
...
<Ability id="share-pain-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="torturous-vision-su" extraClasses="subAbility" icon={["zap"]}>
...
<Ability id="third-eye-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="tongueless-master-su" extraClasses="subAbility" icon={["down","lower"]}>
...
<Ability id="advice-ex" icon={["power","boost"]}>
...
<Ability id="insightful-strike-ex" icon={["boost"]}>
...
<Ability id="mystic-wisdom-su" icon={["boost","aura"]}>
...
<Ability id="chakra-training" icon={["power"]}>
...
<Ability id="chakra-expertise-ex" icon={["def"]}>
...
<Ability id="light-spirit-su" icon={["power","boost"]}>
...
<Ability id="chakra-adept-ex" icon={["power"]}>
...
<Ability id="linked-chakras-ex" icon={["power"]}>
...
<Ability id="chakra-mastery-ex" icon={["power"]}>
...
<Ability id="well-of-sin-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="envy" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="gluttony" extraClasses="subAbility" icon={["aid"]}>
...
<Ability id="greed" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="sloth" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="wrath" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="sinful-strike-su" icon={["boost"]}>
...
<Ability id="burden-with-sin-su" icon={["lower"]}>
...
<Ability id="simultaneous-sins-su" icon={["power"]}>
...
<Ability id="spawn-of-sin-ex" icon={["magic","def"]}>
...
<Ability id="weapon-proficiency" icon={["power","down"]}>
...
<Ability id="feather-touch-ex" icon={["boost"]}>
...
<Ability id="nonlethal-strikes-ex" icon={["melee","down"]}>
...
<Ability id="tenet-of-life-su" icon={["down"]}>
...
<Ability id="life-giving-blows-su" icon={["melee","lower"]}>
...
<Ability id="wholeness-of-body-and-spirit-su" icon={["down","aid","def"]}>
...
<Ability id="incapacitating-palm-su" icon={["down"]}>
...
<Ability id="resilient-body-su" icon={["def"]}>
...
<Ability id="devoted-guardian-ex" icon={["power","boost","roll"]}>
...
<Ability id="unarmed-strike" icon={["down"]}>
...
<Ability id="monastic-mount-su" icon={["aid","protect","power"]}>
...
<Ability id="ki-weapon-su" icon={["boost"]}>
...
<Ability id="calming-strike-su" icon={["melee","touch"]}>
...
<Ability id="otherworldly-resilience-ex" icon={["def"]}>
...
<Ability id="spirit-sense-su" icon={["power"]}>
...
<Ability id="yamarajs-judgment-sp" icon={["aid"]}>
...
<Ability id="resilient-soul-ex" icon={["def"]}>
...
<Ability id="spirit-combat-su" icon={["boost"]}>
...
<Ability id="diamond-spirit-ex" icon={["def"]}>
...
<Ability id="purifying-palm-su" icon={["melee","lower"]}>
...
<Ability id="spirit-flow-su" icon={["def"]}>
...
<Ability id="spirit-mastery-su" icon={["def","magic"]}>
...
<Ability id="strength-of-stone-ex" icon={["boost","def"]}>
...
<Ability id="bones-of-stone-su" icon={["def"]}>
...
<Ability id="body-of-stone-ex" icon={["def"]}>
...
<Ability id="soul-of-stone-su" icon={["power"]}>
...
<Ability id="stone-self" icon={["magic","def","power"]}>
...
<Ability id="trap-intuition-ex" icon={["power","boost"]}>
...
<Ability id="stone-grip-su" icon={["boost","power"]}>
...
<Ability id="trap-dodge-ex" icon={["def"]}>
...
<Ability id="sudden-adit-su" icon={["magic"]}>
...
<Ability id="petrifying-strike-su" icon={["lower"]}>
...
<Ability id="rainmaker-su" icon={["magic"]}>
...
<Ability id="graceful-grappler-ex" icon={["boost","def"]}>
...
<Ability id="counter-grapple-ex" icon={["melee"]}>
...
<Ability id="break-free-ex" icon={["boost"]}>
...
<Ability id="inescapable-grasp-su" icon={["lower"]}>
...
<Ability id="form-lock-su" icon={["magic"]}>
...
<Ability id="iron-body-su" icon={["def","boost","down"]}>
...
<Ability id="wood-affinity-su" icon={["power"]}>
...
<Ability id="freedom-of-movement-su" icon={["def"]}>
...
<Ability id="underfoot-trip-ex" icon={["power"]}>
...
<Ability id="improved-underfoot-grace-ex" icon={["def"]}>
...
<Ability id="far-traveler-ex" icon={["power"]}>
...
<Ability id="long-walk-ex" icon={["power","boost","def"]}>
...
<Ability id="light-step-su" icon={["def","magic"]}>
...
<Ability id="wanderers-wisdom-ex" icon={["boost"]}>
...
<Ability id="disappear-unnoticed-ex" icon={["def"]}>
...
<Ability id="free-step-su" icon={["def"]}>
...
<Ability id="dehydrating-strike-su" icon={["melee","lower"]}>
...
<Ability id="desert-strider-ex" icon={["power","def"]}>
...
<Ability id="improved-vigor-ex" icon={["def"]}>
...
<Ability id="pillar-of-salt-su" icon={["melee","lower"]}>
...
<Ability id="elemental-focus-su-and-sp" icon={["power"]}>
...
<Ability id="nereids-grace-su" icon={["def","info"]}>
...
<Ability id="unarmed-strike" icon={["melee","down"]}>
<Pair single id="unarmed-strike">Unarmed Strike</Pair>
<Pair hl title="Alters">Unarmed strike</Pair>
...
<Ability id="water-dance-su" icon={["power"]}>
...
<Ability id="metakinesis-su" icon={["magic"]}>
...
<Ability id="water-stride-sp" icon={["magic"]}>
...
<Ability id="perfect-strike-ex" icon={["power","roll"]}>
...
<Ability id="way-of-the-weapon-master-ex" icon={["power"]}>
...
<Ability id="uncanny-initiative-ex" icon={["roll"]}>
...
<Ability id="pure-power" icon={["boost"]}>
...
<Ability id="ready-for-anything-ex" icon={["boost"]}>
...
<Ability id="brawler-maneuver-training-ex" icon={["boost","def"]}>
...
<Ability id="improvised-weapon-mastery-ex" icon={["boost"]}>
...
<Ability id="knockout-ex" icon={["melee","lower"]}>
...
<Ability id="turn-the-tables-ex" icon={["lower"]}>
...
<Ability id="dirty-blow-ex" icon={["boost"]}>
...
<Ability id="hurricane-punch-ex" icon={["power"]}>
...
<Ability id="wind-step-su" icon={["power"]}>
...
<Ability id="swift-ki-su" icon={["magic","boost"]}>
...
<Ability id="flurry-of-blows-ex" icon={["power","down"]}>
...
<Ability id="bonus-feats" icon={["power","down"]}>
<Pair single id="bonus-feats">Bonus Feats</Pair>
...
<Ability id="way-of-the-bow-ex" icon={["power"]}>
...
<Ability id="zen-archery-ex" icon={["boost"]}>
...
<Ability id="point-blank-master-ex" icon={["power"]}>
...
<Ability id="ki-pool-su" icon={["ranged"]}>
...
<Ability id="ki-arrows-su" icon={["boost","ranged"]}>
...
<Ability id="reflexive-shot-ex" icon={["power"]}>
...
<Ability id="trick-shot-su" icon={["ranged","lower"]}>
...
<Ability id="ki-focus-bow-su" icon={["boost"]}>
