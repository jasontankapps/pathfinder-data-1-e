...
<Ability id="smite-nature-su" icon={["boost"]}>
...
<Ability id="corrupted-companion-sp" icon={["magic"]}>
...
<Ability id="feed-on-decay-ex" icon={["boost","def"]}>
...
<Ability id="enervating-touch-su" icon={["touch"]}>
...
<Ability id="unnatural-champion-ex" icon={["magic"]}>
...
<Ability id="beacon-of-evil-su" icon={["boost","aura","aid","def"]}>
...
<Ability id="dark-emissary-sp" icon={["magic","lower"]}>
...
<Ability id="feed-on-fear-su" icon={["boost"]}>
...
<Ability id="frightening-cruelty-su" extraClasses="hasSubs" icon={["touch"]}>
...
<Ability id="panicked" extraClasses="subAbility" icon={["touch"]}>
...
<Ability id="invocation-ex" icon={["magic"]}>
...
<Ability id="detect-balance-sp" icon={["magic"]}>
...
<Ability id="smite-impudence-su" icon={["boost"]}>
...
<Ability id="selfish-healing-su" icon={["aid"]}>
...
<Ability id="aura-of-ego-su" icon={["aura","def","lower"]}>
...
<Ability id="stubborn-health-ex" icon={["def"]}>
...
<Ability id="ambitious-bond-sp" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="bonded-weapon" extraClasses="subAbility numbered" icon={["boost"]}>
...
<Ability id="outsider-servant" extraClasses="subAbility numbered" icon={["power"]}>
...
<Ability id="aura-of-ambition-su" icon={["aura","lower","boost"]}>
...
<Ability id="aura-of-glory-su" icon={["power"]}>
...
<Ability id="aura-of-belief-su" icon={["boost"]}>
...
<Ability id="aura-of-indomitability-su" icon={["def"]}>
...
<Ability id="personal-champion-su" icon={["def","boost"]}>
...
<Ability id="ex-insinuators" icon={["warning"]}>
...
<Ability id="iron-fist-ex" icon={["power","boost"]}>
...
<Ability id="unstoppable-ex" icon={["boost"]}>
...
<Ability id="fiendish-bond-su" extraClasses="hasSubs" icon={["power","warning"]}>
...
<Ability id="at-5th-level" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="touch-of-the-crypt-ex" icon={["def","down"]}>
...
<Ability id="fortitude-of-the-crypt-ex" icon={["def","power"]}>
...
<Ability id="cloak-of-the-crypt-ex" icon={["def"]}>
...
<Ability id="will-of-the-crypt-ex" icon={["def"]}>
...
<Ability id="weapons-of-sin-su" icon={["boost"]}>
...
<Ability id="crypt-lord-ex" icon={["def","power"]}>
...
<Ability id="soul-of-the-crypt-su" icon={["def"]}>
...
<Ability id="undying-champion-ex" icon={["def","power"]}>
...
<Ability id="aura-of-blood-su" icon={["aura","lower"]}>
...
<Ability id="aura-of-putrefaction-su" icon={["aura","lower"]}>
...
<Ability id="aura-of-quietus-su" icon={["aura","lower"]}>
...
<Ability id="code-of-conduct" icon={["info","warning"]}>
<Pair single id="code-of-conduct">Code of Conduct</Pair>
...
<Ability id="aura-of-the-grave-su" icon={["def"]}>
...
<Ability id="corpse-rider-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="undead-mount" extraClasses="subAbility numbered" icon={["power"]}>
...
<Ability id="aura-of-death-su" icon={["aura","def"]}>
...
<Ability id="aura-of-rebirth-su" icon={["magic"]}>
...
<Ability id="tyrants-code" icon={["info","warning"]}>
...
<Ability id="diabolic-boon-sp" icon={["power"]}>
