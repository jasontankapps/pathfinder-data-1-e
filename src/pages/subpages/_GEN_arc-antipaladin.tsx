...
<Ability id="smite-nature-su" icon={["upgrade"]}>
<Pair single id="smite-nature-su" flavor="A blighted myrmidon can drain the life from a creature tied to nature.">Smite Nature (Su)</Pair>
...
<Ability id="corrupted-companion-sp" icon={["magic-swirl"]}>
<Pair single id="corrupted-companion-sp" flavor="A blighted myrmidon can call upon a corrupted servant of nature.">Corrupted Companion (Sp)</Pair>
...
<Ability id="feed-on-decay-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="feed-on-decay-ex" flavor="A blighted myrmidon draws strength from corrupting the natural world.">Feed on Decay (Ex)</Pair>
...
<Ability id="aura-of-decay-su" icon={["aura"]}>
...
<Ability id="enervating-touch-su" icon={["magic-palm"]}>
<Pair single id="enervating-touch-su">Enervating Touch (Su)</Pair>
...
<Ability id="unnatural-champion-ex" icon={["magic-swirl"]}>
<Pair single id="unnatural-champion-ex">Unnatural Champion (Ex)</Pair>
...
<Ability id="beacon-of-evil-su" icon={["upgrade","aura","remedy","armor-upgrade"]}>
<Pair single id="beacon-of-evil-su" flavor="A dread vanguard unleashes the powers of his vile masters to strengthen both himself and his allies.">Beacon of Evil (Su)</Pair>
...
<Ability id="dark-emissary-sp" icon={["magic-swirl","armor-downgrade"]}>
<Pair single id="dark-emissary-sp" flavor="A dread vanguard becomes a true messenger of the forces of darkness he serves.">Dark Emissary (Sp)</Pair>
...
<Ability id="feed-on-fear-su" icon={["upgrade"]}>
...
<Ability id="frightening-cruelty-su" extraClasses="hasSubs" icon={["magic-palm"]}>
<Pair single id="frightening-cruelty-su">Frightening Cruelty (Su)</Pair>
...
<Ability id="panicked" extraClasses="subAbility" icon={["magic-palm"]}>
<Pair single id="panicked">Panicked</Pair>
...
<Ability id="code-of-conduct" icon={["info"]}>
...
<Ability id="invocation-ex" icon={["magic-swirl"]}>
<Pair single id="invocation-ex">Invocation (Ex)</Pair>
...
<Ability id="detect-balance-sp" icon={["magic-swirl"]}>
<Pair single id="detect-balance-sp">Detect Balance (Sp)</Pair>
...
<Ability id="smite-impudence-su" icon={["upgrade"]}>
<Pair single id="smite-impudence-su" flavor="An insinuator can beseech the forces empowering him to punish their shared enemies.">Smite Impudence (Su)</Pair>
...
<Ability id="selfish-healing-su" icon={["remedy"]}>
<Pair single id="selfish-healing-su">Selfish Healing (Su)</Pair>
<Pair hl title="Replaces">Touch of corruption</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="aura-of-ego-su" icon={["aura","armor-upgrade","armor-downgrade"]}>
<Pair single id="aura-of-ego-su">Aura of Ego (Su)</Pair>
...
<Ability id="stubborn-health-ex" icon={["armor-upgrade"]}>
<Pair single id="stubborn-health-ex">Stubborn Health (Ex)</Pair>
...
<Ability id="greeds-su" icon={["remedy"]}>
<Pair single id="greeds-su">Greeds (Su)</Pair>
...
<Ability id="ambitious-bond-sp" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="ambitious-bond-sp">Ambitious Bond (Sp)</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="bonded-weapon" extraClasses="subAbility numbered" icon={["upgrade"]}>
...
<Ability id="outsider-servant" extraClasses="subAbility numbered" icon={["stairs-goal"]}>
<Pair single id="outsider-servant">Outsider Servant</Pair>
...
<Ability id="aura-of-ambition-su" icon={["aura","armor-downgrade","upgrade"]}>
<Pair single id="aura-of-ambition-su">Aura of Ambition (Su)</Pair>
...
<Ability id="aura-of-glory-su" icon={["stairs-goal"]}>
<Pair single id="aura-of-glory-su">Aura of Glory (Su)</Pair>
<Pair hl title="Replaces">Aura of vengeance</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="aura-of-belief-su" icon={["upgrade"]}>
<Pair single id="aura-of-belief-su">Aura of Belief (Su)</Pair>
<Pair hl title="Replaces">Aura of sin</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="aura-of-indomitability-su" icon={["armor-upgrade"]}>
<Pair single id="aura-of-indomitability-su">Aura of Indomitability (Su)</Pair>
...
<Ability id="personal-champion-su" icon={["armor-upgrade","upgrade"]}>
<Pair single id="personal-champion-su">Personal Champion (Su)</Pair>
...
<Ability id="ex-insinuators" icon={["hazard-sign"]}>
<Pair single id="ex-insinuators">Ex-Insinuators</Pair>
...
<Ability id="iron-fist-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="iron-fist-ex">Iron Fist (Ex)</Pair>
<Pair hl title="Replaces">Touch of corruption</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="unstoppable-ex" icon={["upgrade"]}>
<Pair single id="unstoppable-ex">Unstoppable (Ex)</Pair>
...
<Ability id="fiendish-bond-su" extraClasses="hasSubs" icon={["stairs-goal","hazard-sign"]}>
<Pair single id="fiendish-bond-su" flavor={<>Instead of forming a <em>fiendish bond</em> with his weapon or a servant, an iron tyrant can form a bond with his armor.</>}>Fiendish Bond (Su)</Pair>
...
<Ability id="touch-of-the-crypt-ex" icon={["armor-upgrade","broken-shield"]}>
<Pair single id="touch-of-the-crypt-ex">Touch of the Crypt (Ex)</Pair>
<Pair hl title="Replaces">Fiendish boon</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="fortitude-of-the-crypt-ex" icon={["armor-upgrade","stairs-goal"]}>
<Pair single id="fortitude-of-the-crypt-ex">Fortitude of the Crypt (Ex)</Pair>
<Pair hl title="Replaces">Aura of despair</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="cloak-of-the-crypt-ex" icon={["armor-upgrade"]}>
<Pair single id="cloak-of-the-crypt-ex">Cloak of the Crypt (Ex)</Pair>
...
<Ability id="will-of-the-crypt-ex" icon={["armor-upgrade"]}>
<Pair single id="will-of-the-crypt-ex">Will of the Crypt (Ex)</Pair>
<Pair hl title="Replaces">Aura of vengeance</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="weapons-of-sin-su" icon={["upgrade"]}>
<Pair single id="weapons-of-sin-su">Weapons of Sin (Su)</Pair>
<Pair hl title="Replaces">Aura of sin</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="crypt-lord-ex" icon={["armor-upgrade","stairs-goal"]}>
<Pair single id="crypt-lord-ex">Crypt Lord (Ex)</Pair>
<Pair hl title="Replaces">Cruelty</Pair>
<Pair title="Gained">At 15th Level</Pair>
...
<Ability id="soul-of-the-crypt-su" icon={["armor-upgrade"]}>
<Pair single id="soul-of-the-crypt-su">Soul of the Crypt (Su)</Pair>
<Pair hl title="Replaces">Aura of depravity</Pair>
<Pair title="Gained">At 17th Level</Pair>
<Pair title="Passive Ability">A knight of the sepulcher gains DR 5/bludgeoning and good.</Pair>
</Ability>
<Ability id="undying-champion-ex" icon={["armor-upgrade","stairs-goal"]}>
<Pair single id="undying-champion-ex" flavor="A knight of the sepulcher joins the ranks of the undead.">Undying Champion (Ex)</Pair>
<Pair hl title="Replaces">Unholy champion</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="aura-of-blood-su" icon={["aura","armor-downgrade"]}>
<Pair single id="aura-of-blood-su">Aura of Blood (Su)</Pair>
<Pair hl title="Replaces">Aura of cowardice</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="aura-of-putrefaction-su" icon={["aura","armor-downgrade"]}>
<Pair single id="aura-of-putrefaction-su">Aura of Putrefaction (Su)</Pair>
<Pair hl title="Replaces">Aura of despair</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="aura-of-quietus-su" icon={["aura","armor-downgrade"]}>
<Pair single id="aura-of-quietus-su">Aura of Quietus (Su)</Pair>
<Pair hl title="Replaces">Aura of sin</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="code-of-conduct" icon={["info","hazard-sign"]}>
<Pair single id="code-of-conduct">Code of Conduct</Pair>
...
<Ability id="aura-of-the-grave-su" icon={["armor-upgrade"]}>
<Pair single id="aura-of-the-grave-su" flavor="A seal-breaker is constantly surrounded by the chill of death.">Aura of the Grave (Su)</Pair>
<Pair hl title="Replaces">Aura of cowardice</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="corpse-rider-su" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="corpse-rider-su">Corpse Rider (Su)</Pair>
<Pair hl title="Replaces">Fiendish boon</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="undead-mount" extraClasses="subAbility numbered" icon={["stairs-goal"]}>
<Pair single id="undead-mount">Undead Mount</Pair>
...
<Ability id="aura-of-death-su" icon={["aura","armor-upgrade"]}>
<Pair single id="aura-of-death-su">Aura of Death (Su)</Pair>
<Pair hl title="Replaces">Aura of despair</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="aura-of-rebirth-su" icon={["magic-swirl"]}>
<Pair single id="aura-of-rebirth-su">Aura of Rebirth (Su)</Pair>
<Pair hl title="Replaces">Aura of vengeance</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="tyrants-code" icon={["info","hazard-sign"]}>
<Pair single id="tyrants-code">Tyrant's Code</Pair>
...
<Pair single id="diabolic-boon-sp">Diabolic Boon (Sp)</Pair>
<Pair hl title="Alters">Fiendish boon</Pair>
<Pair title="Gained">At 5th Level</Pair>
