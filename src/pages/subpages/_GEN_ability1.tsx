...
const _oracle_curses = {title: "Oracle Curses", topLink: ["Oracle","class/oracle"], className: "inlineIcons", jsx: <div className="compilation"><h2 id="ability-oracle_curses-oracle-curses">Oracle Curses</h2>
...
<td><Icons id="ability-oracle_curses-down-learn-def-icons" wrapper="prefixIcon" list={["down","learn","def"]} /> You have (unknowingly) fulfilled most (but not all) of the ritualistic components to achieve lichdom. You have yet to turn into an undead creature, but you are close.</td>
<td></td>
</tr>
<tr>
