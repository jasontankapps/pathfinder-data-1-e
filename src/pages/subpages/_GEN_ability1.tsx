...
<li id="ability-oracle_curses-fake-fn-3-target"><p><Link to="/source/advanced_players_guide">Advanced Player's Guide</Link> <InnerLink aria-label="Back to reference 3" id="backlink-ability-oracle_curses-fake-fn-3" data-hash-target to="ability-oracle_curses-fake-fn-3">↩</InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-oracle_curses-fake-fn-3.2" data-hash-target to="ability-oracle_curses-fake-fn-3.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-oracle_curses-fake-fn-3.3" data-hash-target to="ability-oracle_curses-fake-fn-3.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-oracle_curses-fake-fn-3.4" data-hash-target to="ability-oracle_curses-fake-fn-3.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-oracle_curses-fake-fn-3.5" data-hash-target to="ability-oracle_curses-fake-fn-3.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-oracle_curses-fake-fn-3.6" data-hash-target to="ability-oracle_curses-fake-fn-3.6">↩<sup>6</sup></InnerLink></p></li>
<li id="ability-oracle_curses-fake-fn-4-target"><p><Link to="/source/monster_codex">Monster Codex</Link> <InnerLink aria-label="Back to reference 4" id="backlink-ability-oracle_curses-fake-fn-4" data-hash-target to="ability-oracle_curses-fake-fn-4">↩</InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-ability-oracle_curses-fake-fn-4.2" data-hash-target to="ability-oracle_curses-fake-fn-4.2">↩<sup>2</sup></InnerLink></p></li>
<li id="ability-oracle_curses-fake-fn-5-target"><p><Link to="/source/blood_of_fiends">Blood of Fiends</Link> <InnerLink aria-label="Back to reference 5" id="backlink-ability-oracle_curses-fake-fn-5" data-hash-target to="ability-oracle_curses-fake-fn-5">↩</InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-ability-oracle_curses-fake-fn-5.2" data-hash-target to="ability-oracle_curses-fake-fn-5.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-ability-oracle_curses-fake-fn-5.3" data-hash-target to="ability-oracle_curses-fake-fn-5.3">↩<sup>3</sup></InnerLink></p></li>
<li id="ability-oracle_curses-fake-fn-6-target"><p><Link to="/source/legacy_of_dragons">Legacy of Dragons</Link> <InnerLink aria-label="Back to reference 6" id="backlink-ability-oracle_curses-fake-fn-6" data-hash-target to="ability-oracle_curses-fake-fn-6">↩</InnerLink></p></li>
<li id="ability-oracle_curses-fake-fn-7-target"><p><Link to="/source/elemental_masters_handbook">Elemental Master's Handbook</Link> <InnerLink aria-label="Back to reference 7" id="backlink-ability-oracle_curses-fake-fn-7" data-hash-target to="ability-oracle_curses-fake-fn-7">↩</InnerLink></p></li>
<li id="ability-oracle_curses-fake-fn-8-target"><p><Link to="/source/heroes_of_golarion">Heroes of Golarion</Link> <InnerLink aria-label="Back to reference 8" id="backlink-ability-oracle_curses-fake-fn-8" data-hash-target to="ability-oracle_curses-fake-fn-8">↩</InnerLink></p></li>
<li id="ability-oracle_curses-fake-fn-9-target"><p><Link to="/source/inner_sea_monster_codex">Inner Sea Monster Codex</Link> <InnerLink aria-label="Back to reference 9" id="backlink-ability-oracle_curses-fake-fn-9" data-hash-target to="ability-oracle_curses-fake-fn-9">↩</InnerLink> <InnerLink aria-label="Back to reference 9" id="backlink-ability-oracle_curses-fake-fn-9.2" data-hash-target to="ability-oracle_curses-fake-fn-9.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 9" id="backlink-ability-oracle_curses-fake-fn-9.3" data-hash-target to="ability-oracle_curses-fake-fn-9.3">↩<sup>3</sup></InnerLink></p></li>
<li id="ability-oracle_curses-fake-fn-10-target"><p><Link to="/source/legacy_of_the_first_world">Legacy of the First World</Link> <InnerLink aria-label="Back to reference 10" id="backlink-ability-oracle_curses-fake-fn-10" data-hash-target to="ability-oracle_curses-fake-fn-10">↩</InnerLink> <InnerLink aria-label="Back to reference 10" id="backlink-ability-oracle_curses-fake-fn-10.2" data-hash-target to="ability-oracle_curses-fake-fn-10.2">↩<sup>2</sup></InnerLink></p></li>
<li id="ability-oracle_curses-fake-fn-11-target"><p><Link to="/source/wilderness_origins">Wilderness Origins</Link> <InnerLink aria-label="Back to reference 11" id="backlink-ability-oracle_curses-fake-fn-11" data-hash-target to="ability-oracle_curses-fake-fn-11">↩</InnerLink> <InnerLink aria-label="Back to reference 11" id="backlink-ability-oracle_curses-fake-fn-11.2" data-hash-target to="ability-oracle_curses-fake-fn-11.2">↩<sup>2</sup></InnerLink></p></li>
<li id="ability-oracle_curses-fake-fn-12-target"><p><Link to="/source/pathfinder_88_valley_of_the_brain_collectors">Pathfinder #88: Valley of the Brain Collectors</Link> <InnerLink aria-label="Back to reference 12" id="backlink-ability-oracle_curses-fake-fn-12" data-hash-target to="ability-oracle_curses-fake-fn-12">↩</InnerLink></p></li>
<li id="ability-oracle_curses-fake-fn-13-target"><p><Link to="/source/blood_of_the_sea">Blood of the Sea</Link> <InnerLink aria-label="Back to reference 13" id="backlink-ability-oracle_curses-fake-fn-13" data-hash-target to="ability-oracle_curses-fake-fn-13">↩</InnerLink></p></li>
<li id="ability-oracle_curses-fake-fn-14-target"><p><Link to="/source/villain_codex">Villain Codex</Link> <InnerLink aria-label="Back to reference 14" id="backlink-ability-oracle_curses-fake-fn-14" data-hash-target to="ability-oracle_curses-fake-fn-14">↩</InnerLink></p></li>
<li id="ability-oracle_curses-fake-fn-15-target"><p><Link to="/source/dirty_tactics_toolbox">Dirty Tactics Toolbox</Link> <InnerLink aria-label="Back to reference 15" id="backlink-ability-oracle_curses-fake-fn-15" data-hash-target to="ability-oracle_curses-fake-fn-15">↩</InnerLink></p></li>
</ol></section></div>};
