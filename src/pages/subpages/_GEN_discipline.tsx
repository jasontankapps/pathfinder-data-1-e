...
<Ability id="discipline-powers" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="dark-half-su" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="morphic-form-ex" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="psychic-safeguard-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="draining-touch" extraClasses="subAbility" icon={["touch"]}>
...
<Ability id="emotionally-distant" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="dream-leech-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="oneiromancy-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="mind-heist-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="waking-dream-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="expanded-awareness-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="patient-insight-ex" extraClasses="subAbility" icon={["roll"]}>
...
<Ability id="focused-trance-ex" extraClasses="subAbility" icon={["def","boost"]}>
...
<Ability id="empty-mind-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="discipline-powers" extraClasses="hasSubs" icon={["power","warning"]}>
<Pair single id="discipline-powers">Discipline Powers</Pair>
...
<Ability id="divine-energy" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="resilience-of-the-faithful-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="prayer-aura-su" extraClasses="subAbility" icon={["aura","boost","def","lower"]}>
...
<Ability id="enhanced-senses-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="survival-instinct-ex" extraClasses="subAbility" icon={["def","boost"]}>
...
<Ability id="ferocity-ex" extraClasses="subAbility" icon={["def","boost"]}>
...
<Ability id="primal-fury-su" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="threefold-casting-ex" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="mothers-embrace-su" extraClasses="subAbility" icon={["roll","def"]}>
...
<Ability id="deceptive-shapes-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="curse-mastery-sp" extraClasses="subAbility" icon={["def","boost"]}>
...
<Ability id="lingering-spirits-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="spiritual-bulwark-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="phantasmal-assault-su" extraClasses="subAbility" icon={["boost","lower"]}>
...
<Ability id="illuminating-answers-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="mnemonic-cache-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="superior-automatic-writing-ex" extraClasses="subAbility" icon={["boost","magic"]}>
...
<Ability id="memory-palace-su" extraClasses="subAbility" icon={["magic","boost"]}>
...
<Ability id="synergized-energy-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="attune-implants-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="dominate-technology-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="ritual-unity-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="power-from-pageantry-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="force-of-habit-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="unrivaled-focus-su" extraClasses="subAbility" icon={["roll"]}>
...
<Ability id="painful-reminder-su" extraClasses="subAbility" icon={["zap"]}>
...
<Ability id="power-from-pain-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="live-on-sp" extraClasses="subAbility" icon={["power","aid"]}>
...
<Ability id="agonizing-wound-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="drug-resistance-ex" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="cognatogen-su" extraClasses="subAbility" icon={["power","boost","down"]}>
...
<Ability id="warped-brain-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="hallucinogenic-aura-su" extraClasses="subAbility" icon={["aura","power"]}>
...
<Ability id="emotional-bond-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="emotional-push-su" extraClasses="subAbility" icon={["def","protect"]}>
...
<Ability id="share-memory-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="team-player-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="shared-skill-ex" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="past-life-memories-ex" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="mnemonic-esoterica-ex" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="resurgence-su" extraClasses="subAbility" icon={["def","aid"]}>
...
<Ability id="physical-regression-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="agitating-cognizance-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="metamorphosis-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="spirit-channeling-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="greater-spirit-channeling-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="ac-bonus-ex" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="physical-push-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="bodily-purge-su" extraClasses="subAbility" icon={["aid"]}>
...
<Ability id="pure-body-ex" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="twilight-influence-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="dark-defense-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="adumbration-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="numb-to-the-pain-ex" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="despair-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="wave-of-gloom-su" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="fortress-of-sorrow-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="self-assurance-su" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="at-arms-length-ex" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="magical-hoarder-su" extraClasses="subAbility" icon={["aid"]}>
...
<Ability id="animal-mastery-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="one-with-nature-sp-su" extraClasses="subAbility" icon={["magic","boost"]}>
...
<Ability id="bionetwork-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="animate-trees-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="mental-placidity-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="calming-presence-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="purge-disquiet-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="planar-scent-su" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="rift-reach-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="turn-aside-su" extraClasses="subAbility" icon={["power","def"]}>
...
<Ability id="sidestep-su" extraClasses="subAbility" icon={["magic"]}>
