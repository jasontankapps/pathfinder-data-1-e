...
<RoomInfo id="alchemy-lab-room" e={10} eGoods eMagic eGp benefit={<>Counts as an <Link to="/eq-misc/alchemists_lab">alchemist's lab</Link></>} cGoods={8} cInf={1} cLabor={5} cMagic={1} c={390} t={16} s1={8} s2={16}>Alchemy Lab</RoomInfo>
<p>This room aids you when you're attempting Craft (alchemy) checks, researching new alchemist formulae, and performing similar alchemical tasks. Up to three people can use the room at a time.</p>
</>};
...
<RoomInfo id="altar-room" e={3} eInf benefit={<>Counts as a permanent fixture dedicated to your deity for the purpose of <Link to="/spell/consecrate">consecrate</Link> and similar spells</>} cGoods={2} cInf={1} cLabor={2} cMagic={1} c={210} t={4} s1={2} s2={8}>Altar</RoomInfo>
<p>This spiritual focal point has the iconography and materials required for a ceremony. A typical Altar takes the form of a stone altar, but it could also be a sacred pool, a sacrificial pyre, a collection of statuettes, or a similar sacred convergence.</p>
</>};
...
<RoomInfo id="animal-pen-room" e={8} eGoods eLabor eGp cGoods={6} cInf={1} cLabor={5} c={250} t={16} s1={4} s2={16} to="Habitat">Animal Pen</RoomInfo>
<p>An Animal Pen houses animals that need more attention than horses and cattle. It could be used to house animals for food (like chickens or pigs), display (like song birds or reptiles), or protection (like dogs or large cats). One animal pen can support 1 Large, 2 Medium, 4 Small, or 8 Tiny or smaller creatures, providing them with water and shelter. Food is not provided.</p>
</>};
...
<RoomInfo id="artisans-workshop-room" e={10} eGoods eInf eGp benefit={<>Counts as <Link to="/eq-misc/masterwork_artisans_tools">masterwork artisan's tools</Link> for one Craft skill</>} cGoods={9} cLabor={9} c={360} t={20} s1={8} s2={16}>Artisan's Workshop</RoomInfo>
<p>This specialist's workshop provides a variety of tools and materials for a particular art form, such as glassworking, gemcutting, or sculpting, which you choose when you build the room. Up to three people can use the room at a time.</p>
</>};
...
<RoomInfo id="auditorium-room" e={15} eInf eGp benefit="Bonus on Perform checks" cGoods={19} cInf={1} cLabor={25} c={910} t={40} s1={40} s2={100} from="Ballroom">Auditorium</RoomInfo>
<p>This large room is used for various artistic performances. It contains a stage, costumes, instruments, and seating for an audience. The superior acoustics and decor grant a +2 bonus on all Perform checks made in this room.</p>
</>};
...
<RoomInfo id="ballroom-room" e={10} eInf eGp benefit="Bonus on Perform checks" cGoods={19} cLabor={19} c={760} t={40} s1={40} s2={60} from="Common Room" to="Auditorium">Ballroom</RoomInfo>
<p>This large open room is intended for dances, receptions, and other elaborate events. The superior acoustics and decor grant a +2 bonus on all Perform checks made in this room.</p>
</>};
...
<RoomInfo id="bar-room" e={10} eInf eGp benefit="Bonus on Diplomacy checks to gather information" cGoods={6} cInf={1} cLabor={5} c={250} t={16} s1={10} s2={20}>Bar</RoomInfo>
<p>A Bar stores a selection of drinks and includes a counter for preparing them. After spending an hour with local people in this room, for the next 24 hours you gain a +1 bonus on Diplomacy checks you make to gather information in the settlement.</p>
</>};
...
<RoomInfo id="bath-room" e={3} eInf eGp benefit="Bonus on Fortitude saves against disease" cGoods={3} cInf={1} cLabor={2} c={130} t={8} s1={3} s2={6} from="Sauna">Bath</RoomInfo>
<p>A Bath contains a single large bathtub or multiple smaller basins, along with a stove for heating water. After spending 1 hour in this room, you gain a +2 bonus on your next ongoing Fortitude save against disease.</p>
</>};
...
<RoomInfo id="bedroom-room" e={3} eInf eGp cGoods={8} cLabor={7} c={300} t={20} s1={4} s2={8}>Bedroom</RoomInfo>
<p>A Bedroom provides comfort and privacy for one to two people, and typically features one large bed or two smaller beds. Many also have furnishings or features, such as chairs, wardrobes, chests, tables, or small fireplaces. A Bedroom might be the sleeping place of a building's owner or a comfortable room for rent.</p>
</>};
...
<RoomInfo id="bell-tower-room" earnings="Capital +1 (of a type the building already generates)" cGoods={11} cInf={3} cLabor={7} c={450} t={28} s1={9} s2={25}>Bell Tower</RoomInfo>
<p>This two-story room contains one or more bells suitable for warnings or music, along with bell pulls for operating the instruments from below. The bells can be heard up to 1 mile away.</p>
</>};
...
<RoomInfo id="brewery-room" e={10} eInf eGp cGoods={9} cInf={2} cLabor={7} c={380} t={24} s1={12} s2={24}>Brewery</RoomInfo>
<p>A Brewery allows you to ferment or distill ingredients such as fruits and grain to create potent beverages.</p>
</>};
...
<RoomInfo id="bunks-room" e={8} eLabor eGp cGoods={7} cInf={4} cLabor={7} c={400} t={24} s1={15} s2={35} to="Lodging">Bunks</RoomInfo>
...
<RoomInfo id="classroom-room" earnings="Capital +8" cGoods={6} cInf={1} cLabor={5} c={250} t={14} s1={5} s2={20}>Classroom</RoomInfo>
<p>This small meeting place gives numerous attendees an unobstructed view of a single lecturer. Many classrooms contain seating for those in attendance, a lectern, and a display table or chalkboard.</p>
</>};
...
<RoomInfo id="clockwork-shop-room" e={10} eGoods eLabor eGp benefit={<>Counts as <Link to="/eq-misc/masterwork_artisans_tools">masterwork artisan's tools</Link> for Craft (clockwork)</>} cGoods={9} cLabor={9} c={360} t={20} s1={8} s2={16}>Clockwork Shop</RoomInfo>
<p>This workshop provides all of the precision tools and workstations required for creating delicate clockwork goods. Up to three people can use the room at a time.</p>
</>};
...
<RoomInfo id="common-room-room" e={7} eInf eGp cGoods={7} cLabor={8} c={300} t={16} s1={10} s2={30} to="Ballroom~Ceremonial Room~Throne Room">Common Room</RoomInfo>
<p>This versatile open area has enough space for many people to use at once. A Common Room is typically furnished with benches, chairs, cushions, mats, pews, or stools, and might have tables.</p>
</>};
...
<RoomInfo id="courtyard-room" earnings="Capital +5 (of a type the building already generates)" cGoods={4} cLabor={5} c={180} t={24} s1={20} s2={40}>Courtyard</RoomInfo>
<p>This large, open area might be constructed to feature decorative landscaping or be a more utilitarian space for drills, meetings, or storage.</p>
</>};
...
<RoomInfo id="crypt-room" e={5} eInf eMagic eGp cGoods={5} cInf={3} cLabor={5} cMagic={2} c={490} t={16} s1={8} s2={30} from="Burial Ground">Crypt</RoomInfo>
<p>This space is dedicated to the storage of prominent corpses. Above ground this space might take the form of a tomb. The duration of spells that preserve or protect corpses (such as <Link to="/spell/gentle_repose">gentle repose</Link>) are doubled when cast on a corpse that remains in this room.</p>
</>};
...
<RoomInfo id="dock-room" e={12} eGoods eInf eLabor eGp cGoods={7} cInf={2} cLabor={6} c={320} t={20} s1={10} s2={30}>Dock</RoomInfo>
<p>This is a series of walkways and sturdy posts used to safely moor a water vessel such as a boat or ship. If attached to Storage, it allows you to easily move cargo to and from the water.</p>
</>};
...
<RoomInfo id="drawbridge-room" cGoods={8} cInf={2} cLabor={5} c={320} t={6} s1={4} s2={8}>Drawbridge</RoomInfo>
...
<RoomInfo id="escape-route-room" cGoods={9} cLabor={9} c={360} t={16} s1={6} s2={12} from="Secret Room">Escape Route</RoomInfo>
<p>This is a hallway or tunnel leading to a hidden exit from the building. The exit door is typically a simple wooden door with an average lock (Disable Device DC 20 to open). Either or both ends of the hallway can be secret doors (Perception DC 20 to notice).</p>
</>};
...
<RoomInfo id="farmland-room" e={10} eGoods eGp cGoods={15} cLabor={15} c={600} t={20} s1={60} s2={100}>Farmland</RoomInfo>
<p>This large swath of fertile land is used for farming or fodder for livestock. The price for this room includes clearing the land, fertilizing the soil, and so on. At the GM's discretion, you might discover a plot of available land that automatically counts as a Farmland at no cost.</p>
</>};
...
<RoomInfo id="forge-room" e={10} eGoods eGp benefit={<>Counts as <Link to="/eq-misc/masterwork_artisans_tools">masterwork artisan's tools</Link> for smithing skills</>} cGoods={9} cInf={1} cLabor={8} c={370} t={20} s1={8} s2={16}>Forge</RoomInfo>
<p>A Forge includes a hearth, an anvil, a slack tub, metalworking tools, and other appropriate materials for shaping iron and other metals. A Forge counts as artisan's tools for up to three people working on metalworking skills such as Craft (armor) and Craft (weapons).</p>
</>};
...
<RoomInfo id="game-room-room" earnings="gp +10 (see below)" benefit="Crime +1, Danger +10 (see below)" cGoods={8} cLabor={7} c={300} t={16} s1={10} s2={20}>Game Room</RoomInfo>
<p>A Game Room has tables for gambling or other forms of gaming, and is often used to make wagers on blood sports or other illicit activities. The listed earnings includes illegal gaming. If your building allows only legal gaming (whether recreational or using money), the earnings are gp +5 (not +10) and the benefit is Crime +0, Danger +0.</p>
</>};
...
<RoomInfo id="garden-room" e={8} eGoods eGp cGoods={5} cLabor={4} c={180} t={12} s1={10} s2={20} to="Greenhouse">Garden</RoomInfo>
<p>This area of carefully tended soil is fit for growing plants that require greater attention than crops, though you can use it to grow food crops if you choose.</p>
</>};
...
<RoomInfo id="gauntlet-room" benefit="Defenders get improved cover" cGoods={4} cLabor={4} c={160} t={10} s1={4} s2={8} to="Gatehouse">Gauntlet</RoomInfo>
...
<RoomInfo id="greenhouse-room" e={12} eGoods eInf eGp cGoods={8} cLabor={7} c={300} t={16} s1={10} s2={20} from="Garden">Greenhouse</RoomInfo>
<p>This garden is protected by glass and has its interior climate deliberately regulated. Delicate or exotic plants raised in this area grow larger and healthier than in a normal garden. Certain types of rare plants can be raised only in a Greenhouse.</p>
<blockquote>
...
<RoomInfo id="guard-post-room" e={4} eGoods eGp benefit="Defenders get a bonus on initiative and Perception checks" cGoods={7} cInf={2} cLabor={6} c={320} t={20} s1={6} s2={10} from="Tollbooth" to="Gatehouse">Guard Post</RoomInfo>
<p>This defensive structure prevents access to a building. It is normally arranged so defenders have a clear line of sight to all room entrances or a clear view of all approaches to the building. You can construct this room in a tower layout (at no additional cost), which includes a second story that also counts as a Guard Post. The listed price includes the cost of having unskilled employees as guards (1st-level commoners or experts with uniforms, but no armor or weapons). If the building has an Armory, these employees are armed and armored, but still mostly for show. If you want trained guards who can defend against dangerous intruders, hire professional guards or recruit a team of Guards or Soldiers. Any defender using the Guard Post's defenses gains a +1 bonus on initiative checks and on Perception checks against intruders at the Guard Post.</p>
</>};
...
<RoomInfo id="habitat-room" e={12} eInf eGp cGoods={18} cInf={3} cLabor={17} c={790} t={40} s1={40} s2={60} from="Animal Pen~Stall">Habitat</RoomInfo>
...
<RoomInfo id="infirmary-room" e={8} eInf eGp benefit={<>Counts as a <Link to="/eq-misc/healers_kit">healer's kit</Link> (see below)</>} cGoods={6} cInf={1} cLabor={6} cMagic={1} c={370} t={16} s1={4} s2={12}>Infirmary</RoomInfo>
...
<RoomInfo id="kitchen-room" e={4} eGoods eGp cGoods={4} cLabor={4} c={160} t={12} s1={2} s2={6}>Kitchen</RoomInfo>
<p>A Kitchen is used to prepare food. It contains a stove, sink, and small pantry with basic cooking tools and supplies. A Kitchen for a business that serves food, such as an Inn, probably also has Storage just for foodstuffs.</p>
</>};
...
<RoomInfo id="labyrinth-room" e={5} eInf eGp cGoods={15} cLabor={15} c={370} t={30} s1={40} s2={100}>Labyrinth</RoomInfo>
<p>A Labyrinth is a walled maze, hedge maze, or simple tiled pattern on the ground that those in need of tranquility can walk for quiet meditation.</p>
</>};
...
<RoomInfo id="laundry-room" e={3} eGoods eGp benefit="Bonus on Fortitude saves against contracting disease" cGoods={3} cLabor={3} c={120} t={8} s1={2} s2={6}>Laundry</RoomInfo>
<p>A Laundry contains a large vat for soaking clothes, a cauldron to heat water, washboards, drying lines, and racks and bins for dry clothes. This might be an outside area adjacent to a building. Employees and regular users of a Laundry gain a +1 bonus on Fortitude saves to resist contracting a disease while they're in the settlement.</p>
</>};
...
<RoomInfo id="leather-workshop-room" e={10} eGoods eGp benefit={<>Counts as <Link to="/eq-misc/masterwork_artisans_tools">masterwork artisan's tools</Link> for leatherworking skills</>} cGoods={7} cInf={1} cLabor={7} c={310} t={16} s1={4} s2={10}>Leather Workshop</RoomInfo>
<p>This workshop includes a sturdy table, stool, vats, drying racks, and tools designed for turning raw hides into leather. The Leather Workshop counts as masterwork artisan's tools for up to three people creating leather goods with skills such as Craft (leather) and Craft (shoes).</p>
</>};
...
<RoomInfo id="lodging-room" e={12} eGp cGoods={10} cInf={1} cLabor={10} c={430} t={30} s1={20} s2={35} from="Bunks">Lodging</RoomInfo>
<p>This area is subdivided into smaller chambers and provides private housing and limited storage for up to 10 people. Each chamber typically includes one or two small beds, linens, a chamber pot, and a small table and chair. The door to the chamber is a simple wooden door with a simple lock. You may upgrade individual locks by paying the price difference between a simple lock and the desired lock.</p>
</>};
...
<RoomInfo id="mill-room-room" e={8} eGoods eGp cGoods={8} cLabor={7} c={300} t={20} s1={20} s2={30}>Mill Room</RoomInfo>
<p>A Mill Room contains a mechanism to process grain, foodstuffs, and other raw materials. Most simple mills are powered by hand, but those powered by horses or other beasts of burden require a stable, those powered by water require running water for the water wheel, and those powered by wind require a tower.</p>
</>};
...
<RoomInfo id="nursery-room" e={6} eInf eGp cGoods={6} cInf={1} cLabor={5} c={250} t={14} s1={8} s2={16}>Nursery</RoomInfo>
<p>A Nursery is used to care for infants and children. It contains cribs and beds for children, toys for their entertainment, a table for changing, and cabinets for supplies.</p>
</>};
...
<RoomInfo id="office-room" cGoods={3} cLabor={3} c={120} t={8} s1={2} s2={5} from="Storage">Office</RoomInfo>
<p>This simple room includes a door with a simple lock, a chair, and a large desk that has two drawers with simple locks. An Office affords its user privacy and a refuge from other activity in the building.</p>
</>};
...
<RoomInfo id="pit-room" e={1} eLabor eGp cGoods={1} cLabor={1} c={40} t={2} s1={1} s2={5}>Pit</RoomInfo>
<p>This is a place to dump things no longer needed. It can be used to contain refuse, dangerous waste, and piles of junk, or as a mass graveyard, communal latrine, or crude surface well. A typical pit is 5-15 feet deep with steep sides.</p>
</>};
...
<RoomInfo id="printer-room" e={8} eGoods eInf eLabor eGp benefit={<>Counts as <Link to="/eq-misc/masterwork_artisans_tools">masterwork artisan's tools</Link> for writing and printing skills</>} cGoods={9} cInf={2} cLabor={7} c={380} t={20} s1={5} s2={16} from="Scriptorium">Printer</RoomInfo>
<p>This specialized workshop contains a printing press, storage for paper, and drying racks for finished books and pamphlets. Up to three people can use the room at a time.</p>
</>};
...
<RoomInfo id="reliquary-room" e={5} eInf eGp benefit="Bonus on Knowledge (religion) checks relating to its contents" cGoods={4} cLabor={4} cMagic={1} c={260} t={12} s1={1} s2={4} to="Vault">Reliquary</RoomInfo>
<p>A Reliquary is built to securely store religious artifacts, and dedicated to a specific deity or philosophy. It contains shelves to house the items, special display cases to protect them, and sometimes chairs and tables to allow study. It's secured by a strong wooden door or grating with a good lock. Unlike a Vault, a Reliquary is intended to allow people to observe its contents. When stocked with relics appropriate to the chosen deity or philosophy, the room grants a +1 bonus on Knowledge (religion) checks relating to the history, powers, and purpose of those relics.</p>
</>};
...
<RoomInfo id="scriptorium-room" e={5} eGoods eInf eLabor eMagic eGp benefit="Counts as masterwork artisan's tools for writing skills" cGoods={7} cInf={2} cLabor={6} c={320} t={16} s1={5} s2={16} to="Printer">Scriptorium</RoomInfo>
<p>A Scriptorium is where scribes do their work. It contains chairs and writing desks, as well as ink, paper, and other supplies needed to create or copy written works. Up to three people can use the room at a time for scribing scrolls or using Craft (calligraphy) or Profession (scribe).</p>
</>};
...
<RoomInfo id="secret-room-room" cGoods={5} cLabor={6} c={220} t={16} s1={6} s2={10} from="Vault" to="Escape Route">Secret Room</RoomInfo>
<p>This is either a room or a passage connecting two rooms in the building. The access to this space is controlled by a <Link to="/rule/doors">secret door</Link> (DC 20). A passage can have secret doors at both ends or a normal door at one end and a secret door at the other. If it's a room, it is typically used to hide someone or something you don't want discovered. If it's a passage, it's typically used for clandestine travel within the building, often for the purpose of smuggling or spying. For every 500 extra gp you spend, you can improve one secret door in the building to a well-hidden secret door (DC 30).</p>
</>};
...
<RoomInfo id="sewing-room-room" e={10} eGoods eInf eGp benefit={<>Counts as <Link to="/eq-misc/masterwork_artisans_tools">masterwork artisan's tools</Link> for one Craft skill</>} cGoods={8} cLabor={7} c={300} t={16} s1={6} s2={12}>Sewing Room</RoomInfo>
...
<RoomInfo id="shack-room" cGoods={3} cLabor={2} c={100} t={3} s1={2} s2={4} to="Lavatory~Storage">Shack</RoomInfo>
<p>This no-frills wooden shelter contains a simple table, pallet bed, and stool. One person can build a shack with simple tools and basic materials. For an additional 1 point of Goods and 2 points of Labor, you can construct a brick or stone hut instead of a wooden shack.</p>
</>};
...
<RoomInfo id="sports-field-room" e={10} eInf eGp cGoods={17} cInf={3} cLabor={18} c={790} t={20} s1={40} s2={100} from="Battle Ring">Sports Field</RoomInfo>
<p>This outdoor area is used for jousting, athletics, war games, and other sports. A Sports Field contains a playing area, seats for spectators and equipment for one type of game.</p>
</>};
...
<RoomInfo id="stall-room" e={8} eGoods eLabor eGp cGoods={6} cInf={1} cLabor={5} c={250} t={16} s1={6} s2={16} to="Habitat">Stall</RoomInfo>
<p>A Stall is a place to keep 1-2 horses or other Large domestic animals. It contains gates, feed troughs, feed, and straw.</p>
</>};
...
<RoomInfo id="statue-room" e={1} eInf eGp cGoods={1} cLabor={2} c={60} t={2} s1={1} s2={9}>Statue</RoomInfo>
<p>This area contains a statue, fountain, or other large decoration. If it has religious significance, it might serve as a shrine. The listed cost and time are only to install a completed wood, bronze, or stone feature - they don't include the cost and time to create the feature in the first place, but it must be installed to produce Earnings.</p>
</>};
...
<RoomInfo id="storage-room" e={2} eGp cGoods={3} cLabor={3} c={120} t={8} s1={4} s2={8} from="False Front~Shack" to="Office~Vault">Storage</RoomInfo>
<p>Storage is any room used to store objects, keeping them out of the way for later use. Most Warehouses are just multiple Storage rooms built into a single building. A low-cost shop may allow its customers to browse items in the Storage area. A door to a Storage room includes an average lock.</p>
</>};
...
<RoomInfo id="storefront-room" earnings="Capital +5 (of a type the building already generates)" cGoods={5} cInf={1} cLabor={3} c={190} t={12} s1={2} s2={4} from="False Front">Storefront</RoomInfo>
<p>This is a simple storefront, holding a wooden counter, a ledger, shelves, and other necessities to run a business.</p>
</>};
...
<RoomInfo id="summmoning-chamber-room" e={3} eMagic benefit="Bonus on Charisma, Diplomacy, Intimidate, and Knowledge (planes) checks" cGoods={11} cInf={4} cLabor={10} cMagic={5} c={1040} t={28} s1={6} s2={16}>Summmoning Chamber</RoomInfo>
<p>A Summoning Chamber is used to perform magical rituals to conjure outsiders. It contains a well-drawn, nearly complete magic circle on the floor - which you can complete with just a few chalk marks - suitable for use with <Link to="/spell/magic_circle">magic circle</Link> spells, <Link to="/spell/planar_binding">planar binding</Link> spells, and so on. A person who uses a Summoning Chamber gains a +3 bonus on Knowledge (planes) checks relating to a creature being called or summoned, and a +3 bonus on Charisma checks, Diplomacy checks, and Intimidate checks to influence or bargain with a creature called or summoned here.</p>
</>};
...
<RoomInfo id="throne-room-room" e={15} eInf benefit="Bonus on Bluff, Diplomacy, and Intimidate, Knowledge (local), and Perform checks" cGoods={25} cInf={5} cLabor={25} cMagic={5} c={1650} t={40} s1={40} s2={80} from="Ceremonial Room~Common Room">Throne Room</RoomInfo>
<p>A Throne Room is used to receive important visitors, such as nobles. The room contains a throne, various decorations, and a few seats for visitors. By spending an hour conversing with visitors, the host of the room gains a +1 bonus on Bluff, Diplomacy, Intimidate, Knowledge (local), and Perform checks to influence or learn about those guests for the next 24 hours.</p>
</>};
...
<RoomInfo id="tollbooth-room" e={4} eGoods eGp cGoods={2} cInf={1} cLabor={2} c={110} t={6} s1={1} s2={5} to="Guard Post">Tollbooth</RoomInfo>
<p>A Tollbooth is a small shelter designed to restrict movement on a road or bridge so the owner can collect fees from travelers. If this room is built near a settlement, it requires 1 point of Influence per day to maintain - or might be illegal, depending on the settlement.</p>
</>};
...
<RoomInfo id="torture-chamber-room" benefit="Bonus on Intimidate checks" cGoods={7} cInf={3} cLabor={5} c={330} t={20} s1={6} s2={16}>Torture Chamber</RoomInfo>
<p>This grim room is used for interrogation as well as torture and other morally questionable acts. It contains structures to bind humanoids and various implements designed to inflict pain and discomfort. Interrogators in this room gain a +3 bonus on Intimidate checks to influence captives.</p>
</>};
...
<RoomInfo id="vault-room" cGoods={8} cLabor={7} c={300} t={16} s1={4} s2={8} from="Reliquary~Storage" to="Secret Room">Vault</RoomInfo>
<p>This is a secure room designed to keep out intruders. The access to this space is controlled by an iron door with a good lock. If you upgrade this room to a Secret Room, the door retains its material and lock and also becomes a secret door.</p>
</>};
...
<RoomInfo id="workstation-room" e={8} eGoods eInf eGp benefit={<>Counts as <Link to="/eq-misc/masterwork_artisans_tools">masterwork artisan's tools</Link> for one Craft or Profession skill</>} cGoods={8} cLabor={7} c={300} t={16} s1={8} s2={16}>Workstation</RoomInfo>
<p>This includes a table, chair, and appropriate masterwork artisan's tools for one Craft or Profession skill you choose when you build the room. For example, if intended for a carpenter, it has clamps, saws, nails, hammers, and a sturdy worktable. Up to three people can use the room at a time.</p>
</>};
...
<RoomInfo id="acolyte-team" e={4} eInf eMagic eGp cGoods={2} cInf={2} cLabor={2} cMagic={3} c={440} t={3} s={1} to="Priest~Sage">Acolyte</RoomInfo>
<p>An Acolyte is a newly trained divine spellcaster, sufficient for tending to the sick or advising on religious matters. An Acolyte is typically a 1st-level adept, cleric, druid, or oracle, with light armor (or no armor if an adept) and a weapon appropriate to her faith.</p>
</>};
...
<RoomInfo id="apprentice-team" e={4} eInf eMagic eGp cGoods={2} cInf={2} cLabor={1} cMagic={4} c={520} t={3} s={1} to="Mage~Sage">Apprentice</RoomInfo>
<p>An Apprentice is a newly-trained arcane spellcaster, sufficient for helping with magical rituals, generating flashy effects, or advising on magical matters. An Apprentice is typically a 1st-level bard, sorcerer, summoner, witch, or wizard.</p>
</>};
...
<RoomInfo id="archers-team" e={6} eInf eLabor eGp cGoods={4} cInf={3} cLabor={7} c={310} t={4} s={5} from="Soldiers" to="Elite Archers">Archers</RoomInfo>
<p>Archers are soldiers trained to use projectile weapons. They are typically 1st-level warriors, each with scale mail, a longbow, a buckler, and a longsword.</p>
<blockquote>
...
<RoomInfo id="cavalry-team" e={7} eInf eLabor eGp cGoods={8} cInf={8} c={410} t={6} s={5} from="Elite Soldiers~Soldiers" to="Cavalry Archers">Cavalry</RoomInfo>
<p>Cavalry are soldiers trained to ride mounts in combat. They are typically 3rd-level warriors, each equipped with breastplate armor, a longsword, a lance, and a heavy steel shield and riding a combat-trained light horse.</p>
</>};
...
<RoomInfo id="cavalry-archers-team" e={8} eInf eLabor eGp cGoods={9} cInf={3} cLabor={10} c={470} t={7} s={5} from="Cavalry~Elite Archers">Cavalry Archers</RoomInfo>
<p>Cavalry Archers are soldiers trained to ride mounts and use ranged weapons in combat before closing to melee. They are typically 3rd-level warriors, each equipped with breastplate armor, a short bow, a longsword, a lance, and a heavy steel shield and riding a combat-trained light horse.</p>
</>};
...
<RoomInfo id="craftspeople-team" e={4} eGoods eLabor eGp cGoods={3} cInf={2} cLabor={4} c={200} t={2} s={3}>Craftspeople</RoomInfo>
<p>Craftspeople are trained in a particular Craft or Profession skill and make a living using that skill. Examples of this team are alchemists, carpenters, leatherworkers, masons, and smiths. A typical carpenter is a 4th-level expert with 4 ranks each in Climb, Craft (carpentry), Diplomacy, and Knowledge (engineering and local). Craftspeople in other fields have a similar skill arrangement.</p>
</>};
...
<RoomInfo id="cutpurses-team" e={3} eGoods eLabor eGp cInf={3} cLabor={1} c={110} t={1} s={5} to="Robbers">Cutpurses</RoomInfo>
<p>Cutpurses are minor thieves (often youths) who earn money from petty crimes such as pickpocketing or stealing items from market stalls. They are typically 1st-level commoners, experts, or rogues with 1 rank in Perception, Sleight of Hand, and Stealth.</p>
</>};
...
<RoomInfo id="drivers-team" e={2} eGoods eLabor eGp cGoods={2} cInf={1} cLabor={1} c={90} time="undefined" s={1} from="Laborers" to="Lackeys">Drivers</RoomInfo>
<p>Drivers are trained to handle and move common animals' managing ox-drawn carts, herding cattle, or training riding horses. A Driver is typically 1st-level expert with ranks in Handle Animal, Knowledge (geography), Profession (driver), Ride, and Survival.</p>
</>};
...
<RoomInfo id="elite-archers-team" e={7} eInf eLabor eGp cGoods={5} cInf={4} cLabor={8} c={380} t={6} s={5} from="Archers~Elite Soldiers" to="Cavalry Archers">Elite Archers</RoomInfo>
<p>An Elite Archers team consists of 3rd-level warriors, each with scale mail, a longbow, a buckler, and a longsword.</p>
</>};
...
<RoomInfo id="elite-guards-team" e={4} eInf eLabor eGp cGoods={3} cInf={1} cLabor={4} c={170} t={2} s={5} from="Guards" to="Elite Soldiers">Elite Guards</RoomInfo>
<p>Like Guards, this team defends a location but doesn't take on an active role. An Elite Guards team consists of 3rd-level warriors, each wearing a chain shirt or banded mail and using a heavy steel shield and shortspear, a guisarme, or a halberd.</p>
</>};
...
<RoomInfo id="elite-soldiers-team" e={6} eInf eLabor eGp cGoods={5} cInf={3} cLabor={7} c={330} t={5} s={5} from="Elite Guards~Soldiers" to="Cavalry~Elite Archers">Elite Soldiers</RoomInfo>
<p>Like Soldiers, this team will take aggressive action and seek out your enemies to kill them. An Elite Soldiers team consists of 3rd-level warriors, each wearing a chain shirt or banded mail and using a guisarme, a halberd, or a heavy steel shield and a shortspear.</p>
</>};
...
<RoomInfo id="laborers-team" e={2} eLabor eGp cInf={1} cLabor={2} c={70} time="undefined" s={5} to="Drivers~Guards~Lackeys~Sailors~Scofflaws">Laborers</RoomInfo>
<p>Laborers are unskilled workers who carry out basic orders. In most cases, their work is physical labor, though you may recruit laborers for specialized tasks such as begging for your thieves' guild, being professional mourners for your cult, or filling out the cast of a theater performance. They are typically 1st-level commoners with no ranks in Craft or Profession.</p>
<blockquote>
...
<RoomInfo id="lackeys-team" e={2} eInf eLabor cGoods={1} cInf={2} cLabor={2} c={120} t={1} s={5} from="Drivers~Laborers">Lackeys</RoomInfo>
<p>Lackeys wait on you hand and foot and take care of common domestic and traveling issues; their ranks include butlers, valets, maids, heralds, footmen, ladies-in-waiting, and similar service personnel. Skilled Lackeys anticipate your needs and coordinate with your other employees as well as those of your guests or host. A typical Lackey is a 1st-level commoner or expert with ranks in a subset of Diplomacy, Disguise, Intimidate, Knowledge (local), Knowledge (nobility), Linguistics, Perception, and Sense Motive.</p>
</>};
...
<RoomInfo id="mage-team" e={7} eInf eMagic eGp cGoods={3} cInf={2} cLabor={2} cMagic={8} c={960} t={7} s={1} from="Apprentice">Mage</RoomInfo>
<p>A Mage is a skilled but not especially remarkable arcane spellcaster, often a 3rd-level bard, sorcerer, summoner, witch, or wizard.</p>
</>};
...
<RoomInfo id="priest-team" e={7} eInf eMagic eGp cGoods={3} cInf={3} cLabor={3} cMagic={6} c={810} t={7} s={1} from="Acolyte">Priest</RoomInfo>
<p>A Priest is a skilled but unremarkable divine spellcaster, typically a 3rd-level adept, cleric, druid, or oracle, with light armor (or no armor, if an adept) and a weapon appropriate to her faith.</p>
</>};
...
<RoomInfo id="robbers-team" e={4} eGoods eInf eGp cGoods={1} cInf={4} cLabor={3} c={200} t={3} s={5} from="Cutpurses">Robbers</RoomInfo>
<p>Robbers are expert thieves who commit burglary, robbery, and other violent crimes for profit. A typical robber is a 3rd-level expert or rogue with 3 ranks each in Climb, Disable Device, Intimidate, Perception, and Stealth.</p>
<blockquote>
<p><em>This can also be upgraded into <Link to="/rule/wilderness_teams">Skirmishers</Link>.</em></p>
</blockquote>
</>};
...
<RoomInfo id="sage-team" e={5} eInf eGp cGoods={5} cInf={2} cLabor={2} c={200} t={4} s={1} from="Acolyte~Apprentice">Sage</RoomInfo>
<p>A sage is a person with extensive knowledge in one or more related areas who can advise you about his areas of expertise. A typical sage is a 3rd-level expert with 3 ranks each in skills such as Appraise, Knowledge, Linguistics, Profession, and Spellcraft.</p>
</>};
...
<RoomInfo id="sailors-team" e={2} eGoods eLabor eGp cGoods={1} cInf={1} cLabor={2} c={90} time="undefined" s={5} from="Laborers">Sailors</RoomInfo>
<p>Sailors know how to sail a ship, navigate while at sea, and defend the vessel against pirates and other hostile boarders. A typical sailor is a <Link to="/npc/old_sailor">2nd-level expert</Link> with 2 ranks each in Acrobatics, Climb, Perception, Profession (sailor), Survival, and Swim.</p>
</>};
...
<RoomInfo id="soldiers-team" e={5} eInf eLabor eGp cGoods={3} cInf={2} cLabor={5} c={220} t={2} s={5} from="Guards" to="Archers~Bureaucrats~Cavalry~Elite Soldiers">Soldiers</RoomInfo>
<p>Soldiers are trained in combat and have the means and will to kill your enemies. Unlike Guards, Soldiers actively engage in fighting on behest of a leader (although you can make Soldiers act as Guards). Depending on the nature of your organization, they might be enforcers rather than military-style soldiers. They are typically 1st-level warriors, each with scale mail, a longsword, a heavy wooden shield, and javelins.</p>
<blockquote>
<p><em>This can also be upgraded into <Link to="/rule/wilderness_teams">Skirmishers</Link>.</em></p>
</blockquote>
</>};
...
<p><strong className="hl">Shield Bash Attacks:</strong> You can bash an opponent with a light or heavy shield. Used this way, a shield is a martial bludgeoning weapon. For the purpose of penalties on attack rolls, treat a light shield as a light weapon, and treat a heavy shield as a one-handed weapon. If you use your shield as a weapon, you lose its AC bonus until your next turn. An enhancement bonus on a shield does not improve the effectiveness of a shield bash made with it, but the shield can be made into a magic weapon in its own right.</p>
<p><strong>Damage</strong> Varies; <strong>Critical</strong> &times;2; <strong>Range</strong> -; <strong>Type</strong> Varies; <strong>Special</strong> Varies<br/><strong>Category</strong> Varies; <strong>Proficiency</strong> Varies<br/><strong><Link to="/ability/weapon_groups">Weapon Group</Link></strong> Varies</p>
<p>See a specific shield's entry to determine its damage, category, proficiency, etc.</p>
</>};
