...
<Ability id="brawlers-cunning-ex" icon={["boost"]}>
...
<Pair title="At 6th Level">You can use this ability to gain the benefit of two combat feats at the same time. You may select one feat as a <strong className="hl">swift action</strong> or two feats as a <strong className="hl">move action</strong>. You may use one of these feats to meet a prerequisite of the second feat; doing so means that you cannot replace a feat currently fulfilling another's prerequisite without also replacing those feats that require it. Each individual feat selected counts toward your daily uses of this ability.</Pair>
<Pair title="At 10th Level">You can use this ability to gain the benefit of three combat feats at the same time. You may select one feat as a <strong className="hl">free action</strong>, two feats as a <strong className="hl">swift action</strong>, or three feats as a <strong className="hl">move action</strong>. You may use one of the feats to meet a prerequisite of the second and third feats, and use the second feat to meet a prerequisite of the third feat. Each individual feat selected counts toward your daily uses of this ability.</Pair>
<Pair title="At 12th Level">You gain the benefit of one combat feat as an <strong className="hl">immediate action</strong> or three combat feats as a <strong className="hl">swift action</strong>. Each individual feat selected counts toward your daily uses of this ability.</Pair>
...
<Ability id="martial-training-ex" icon={["boost"]}>
...
<Ability id="bonus-combat-feats" icon={["power"]}>
...
<Pair title="At 8th Level">You gain a new bonus combat feat and may swap out a previous combat feat (with the same limitations as above).</Pair>
<Pair title="At 11th Level">You gain a new bonus combat feat and may swap out a previous combat feat (with the same limitations as above).</Pair>
<Pair title="At 14th Level">You gain a new bonus combat feat and may swap out a previous combat feat (with the same limitations as above).</Pair>
...
<Ability id="brawlers-flurry-ex" icon={["melee"]}>
...
<Ability id="maneuver-training-ex" icon={["melee","def"]}>
...
<Pair title="At 11th Level">You select a new combat maneuver and gain the +1 bonuses above, while the previous maneuvers' bonuses become +2 and +3.</Pair>
...
<Ability id="knockout-ex" icon={["melee"]}>
...
<Ability id="brawlers-strike-ex" icon={["melee","boost"]}>
...
<Ability id="close-weapon-mastery-ex" icon={["melee"]}>
...
<Ability id="awesome-blow-ex" icon={["melee"]}>
...
<Ability id="improved-awesome-blow-ex" icon={["boost"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-brawler--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-brawler/battle_dancer">Battle Dancer</Link></p><p><strong>Modifies or Replaces:</strong> Class Skills; Armor Proficiencies; Brawler's Cunning; Brawler's Flurry; AC Bonus; Knockout</p><p>Battle dancers practice a martial art that emphasizes constant motion</p></div>
...
<Ability id="summon-monster-i-sp" icon={["magic"]}>
...
<Pair title="At 3rd Level">This now behaves as <Link to="/spell/summon_monster_ii">summon monster II</Link>.</Pair>
<Pair title="At 5th Level">This now behaves as <Link to="/spell/summon_monster_iii">summon monster III</Link>.</Pair>
<Pair title="At 7th Level">This now behaves as <Link to="/spell/summon_monster_iv">summon monster IV</Link>.</Pair>
<Pair title="At 9th Level">This now behaves as <Link to="/spell/summon_monster_v">summon monster V</Link>.</Pair>
<Pair title="At 11th Level">This now behaves as <Link to="/spell/summon_monster_vi">summon monster VI</Link>.</Pair>
<Pair title="At 13th Level">This now behaves as <Link to="/spell/summon_monster_vii">summon monster VII</Link>.</Pair>
<Pair title="At 15th Level">This now behaves as <Link to="/spell/summon_monster_viii">summon monster VIII</Link>.</Pair>
<Pair title="At 17th Level">This now behaves as <Link to="/spell/summon_monster_ix">summon monster IX</Link>.</Pair>
...
<Ability id="bond-senses-su" icon={["boost"]}>
...
<Ability id="shield-ally-ex" icon={["def"]}>
...
<Ability id="makers-call-su" icon={["magic"]}>
...
<Ability id="transposition-su" icon={["magic"]}>
...
<Ability id="aspect-su" icon={["boost"]}>
...
<Ability id="greater-shield-ally-su" icon={["protect"]}>
...
<Ability id="life-bond-su" icon={["def"]}>
...
<Ability id="merge-forms-su" icon={["def","power"]}>
...
<Ability id="greater-aspect-su" icon={["boost"]}>
...
<Ability id="twin-eidolon-su" icon={["power"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-summoner--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-summoner/blood_god_disciple">Blood God Disciple</Link></p><p><strong>Modifies or Replaces:</strong> Summon Monster</p><p>(Half-Orc) A half-orc summoner who devotes himself to one of the bloody orc gods may believe his eidolon is an avatar of that god rather than a mere supernatural creature.</p></div>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-unchained_summoner--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Deep Magics (Su)</td><td>At 20th level, the character's repertoire of spells deepens dramatically. She gains an additional spell known for each spell level she can cast. A character of any class with spells known can select this capstone.</td></tr>
<tr><td>Grand Eidolon (Su)</td><td>At 20th level, the summoner's eidolon becomes an absolute monstrosity - a thing of legend and terror. The summoner gains 4 additional evolution points to spend as he likes, not subject to subtype - based requirements.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
...
<Message arch /><div className="archetype"><p><Link to="/arc-unchained_summoner/construct_caller">Construct Caller</Link></p><p><strong>Modifies or Replaces:</strong> Subtype; Summon Monster</p><p>Construct callers use their mechanical and planar understandings to work planar energies as a tinkerer works parts</p></div>
...
<Ability id="consummate-liar" icon={["boost"]}>
...
<Ability id="hypnotic-stare-su" icon={["lower"]}>
...
<Ability id="mesmerist-tricks-su" icon={["power","magic"]}>
...
<Ability id="painful-stare-su" icon={["zap"]}>
...
<Ability id="towering-ego-su" icon={["def"]}>
...
<Ability id="bold-stare-su" icon={["boost"]}>
...
<Pair title="At 11th Level">You choose a new <em>bold stare improvement.</em></Pair>
<Pair title="At 15th Level">You choose a new <em>bold stare improvement.</em></Pair>
<Pair title="At 19th Level">You choose a new <em>bold stare improvement.</em></Pair>
...
</aside><Ability id="touch-treatment-su" icon={["aid"]}>
...
<Ability id="manifold-tricks-su" icon={["boost"]}>
...
<Pair title="At 13th Level">You can have four <em>mesmerist tricks</em> implanted at a time.</Pair>
...
<Ability id="mental-potency-ex" icon={["boost","magic"]}>
...
<Ability id="glib-lie-su" icon={["boost"]}>
...
<Ability id="masterful-tricks-su" icon={["boost"]}>
...
<Ability id="rule-minds-su" icon={["power","magic"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-mesmerist--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Deep Magics (Su)</td><td>At 20th level, the character's repertoire of spells deepens dramatically. She gains an additional spell known for each spell level she can cast. A character of any class with spells known can select this capstone.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
...
<Message arch /><div className="archetype"><p><Link to="/arc-mesmerist/aromaphile">Aromaphile</Link></p><p><strong>Modifies or Replaces:</strong> Hypnotic Stare; Painful Stare; Towering Ego; Bold Stare; Touch Treatment; Mental Potency</p><p>(Ghoran only) Rather than employ the baleful glares of the typical mesmerist, aromaphiles hypnotize others using an array of sickeningly sweet scents developed from their unique ghoran physiology.</p></div>
...
<Ability id="sneak-attack" icon={["boost"]}>
...
<Ability id="trapfinding" icon={["def","power"]}>
...
<Ability id="advanced-talents" icon={["boost"]}>
...
<Ability id="master-strike-ex" icon={["boost","lower"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-rogue--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-rogue/acrobat">Acrobat</Link></p><p><strong>Modifies or Replaces:</strong> Trapfinding; Trap Sense</p><p>Whether they are daring thieves, infiltrating assassins, or intrepid spies, proper training in acrobatics is a valuable boon for rogues.</p></div>
...
<DisplayTable table={{"id":"rogue archetypes","columns":[{"header":"Archetype","link":"arc-rogue"},{"header":"Armor Proficiency"},{"header":"Class Skills"},{"header":"Evasion"},{"header":"Improved Evasion"},{"header":"Master Strike"},{"header":"Rogue Talents"},{"header":"2nd-level Rogue Talent"},{"header":"4th-level Rogue Talent"},{"header":"6th-level Rogue Talent"},{"header":"8th-level Rogue Talent"},{"header":"10th-level Rogue Talent"},{"header":"12th-level Rogue Talent"},{"header":"14th-level Rogue Talent"},{"header":"16th-level Rogue Talent"},{"header":"18th-level Rogue Talent"},{"header":"20th-level Rogue Talent"},{"header":"Advanced Talents"},{"header":"Skill Ranks"},{"header":"Sneak Attack"},{"header":"Trap Sense"},{"header":"Trap Sense 1"},{"header":"Trap Sense 2"},{"header":"Trap Sense 3"},{"header":"Trap Sense 4"},{"header":"Trapfinding"},{"header":"Uncanny Dodge"},{"header":"Improved Uncanny Dodge"},{"header":"Weapon Proficiency"}],"data":[[["Acrobat","acrobat"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Bandit","bandit"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null],[["Bekyar Kidnapper","bekyar_kidnapper"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Bellflower Irrigator","bellflower_irrigator"],null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null],[["Burglar","burglar"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null],[["Carnivalist","carnivalist"],null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null],[["Cat Burglar","cat_burglar"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null],[["Chameleon","chameleon"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Charlatan","charlatan"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Consigliere","consigliere"],null,"X","X",null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X","X",null],[["Construct Saboteur","construct_saboteur"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Counterfeit Mage","counterfeit_mage"],null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null],[["Cutpurse","cutpurse"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Dark Lurker","dark_lurker"],null,null,"X",null,null,null,"X",null,null,"X",null,null,"X",null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null],[["Deadly Courtesan","deadly_courtesan"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,"X",null],[["Desert Raider","desert_raider"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Discretion Specialist","discretion_specialist"],null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,null,null,"X",null,null,null,null,"X","X","X",null],[["Dreamthief","dreamthief"],null,"X",null,null,"X",null,null,null,null,null,null,"X",null,null,null,null,null,null,"X","X",null,null,null,null,null,"X","X",null],[["Driver","driver"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Earthshadow","earthshadow"],null,null,"X",null,null,null,null,"X",null,"X",null,"X",null,"X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null],[["Eldritch Raider","eldritch_raider"],null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null],[["Eldritch Scoundrel","eldritch_scoundrel"],"X","X",null,null,null,"X",null,null,null,null,null,null,null,null,null,null,"X","X","X","X",null,null,null,null,null,"X","X",null],[["Escapologist","escapologist"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null],[["False Medium","false_medium"],null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Fey Prankster","fey_prankster"],null,null,null,null,null,null,"X",null,"X","X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null],[["Filcher","filcher"],null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X","X",null],[["Galtan Agitator","galtan_agitator"],null,null,null,null,null,null,null,"X",null,"X",null,"X",null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Guerrilla","guerrilla"],null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X","X",null],[["Guild Agent","guild_agent"],null,null,"X","X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null],[["Gun Smuggler","gun_smuggler"],null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,"X","X","X","X"],[["Heister","heister"],null,null,null,null,null,null,"X","X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null],[["Investigator","investigator"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null],[["Kintargo Rebel","kintargo_rebel"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null],[["Kitsune Trickster","kitsune_trickster"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Knife Master","knife_master"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,"X",null,null,null],[["Makeshift Scrapper","makeshift_scrapper"],null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,"X"],[["Master of Disguise","master_of_disguise"],null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null],[["Nameless Shadow","nameless_shadow"],null,null,null,null,null,null,"X","X","X","X","X",null,"X",null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null],[["Needler","needler"],null,null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null],[["Numerian Scavenger","numerian_scavenger"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null],[["Okeno Liberator","okeno_liberator"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X",null,null],[["Phantom Thief","phantom_thief"],null,"X",null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null,"X",null,null,null],[["Pirate","pirate"],null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null],[["Planar Sneak","planar_sneak"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X","X",null],[["Poisoner","poisoner"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Rake","rake"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Relic Raider","relic_raider"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null],[["River Rat","river_rat"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Roof Runner","roof_runner"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Rotdrinker","rotdrinker"],null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null],[["Sanctified Rogue","sanctified_rogue"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null],[["Sapper","sapper"],null,null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null],[["Scout","scout"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null],[["Scroll Scoundrel","scroll_scoundrel"],null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X","X",null],[["Sczarni Swindler","sczarni_swindler"],null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X","X",null],[["Seeker of the Lost","seeker_of_the_lost"],null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null],[["Shadow Scion","shadow_scion"],null,null,null,null,"X",null,"X",null,null,"X",null,null,"X",null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null],[["Shadow Walker","shadow_walker"],null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X","X",null],[["Sharper","sharper"],null,null,null,null,null,null,"X","X","X","X","X",null,null,"X",null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Skulking Slayer","skulking_slayer"],"X","X",null,null,null,"X",null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X","X","X","X","X",null,null,"X"],[["Sly Saboteur","sly_saboteur"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X","X",null],[["Smuggler","smuggler"],null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Snare Setter","snare_setter"],null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null],[["Sniper","sniper"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Snoop","snoop"],null,null,"X",null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null],[["Spy","spy"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Survivalist","survivalist"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Swamp Poisoner","swamp_poisoner"],null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Swashbuckler","swashbuckler"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Swordmaster","swordmaster"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Sylvan Trickster","sylvan_trickster"],null,"X",null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null],[["Thug","thug"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X",null,null,null],[["Tidal Trickster","tidal_trickster"],null,null,null,null,null,null,null,"X",null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X","X",null],[["Toxic Talon","toxic_talon"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X","X","X"],[["Trapsmith","trapsmith"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null],[["Underground Chemist","underground_chemist"],null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null],[["Vexing Dodger","vexing_dodger"],null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X","X",null],[["Waylayer","waylayer"],null,null,null,null,null,null,null,null,null,null,null,"X",null,null,null,"X",null,null,null,null,null,null,null,null,"X","X","X",null]],"initialColumn":0,"nullValue":"&nbsp;"}} />
...
<Ability id="finesse-training-ex" icon={["boost","melee"]}>
...
<Pair title="At 11th Level">You choose a second weapon to also gain these benefits with.</Pair>
...
<Ability id="danger-sense-ex" icon={["def"]}>
<Pair single id="danger-sense-ex">Danger Sense (Ex)</Pair>
<Pair title="Gained">At 3rd Level</Pair>
<Pair title="Passive Ability">You gain a bonus on Reflex saves made to avoid traps and a dodge bonus to AC against attacks made by traps. In addition, you gain a bonus on Perception checks to avoid being surprised by a foe. <Bonus y c="rogue" n={3} pl />.</Pair>
...
<Ability id="debilitating-injury-ex" extraClasses="hasSubs" icon={["lower"]}>
...
<Ability id="bewildered" extraClasses="subAbility numbered" icon={["lower"]}>
...
<Ability id="disoriented" extraClasses="subAbility numbered" icon={["lower"]}>
...
<Ability id="hampered" extraClasses="subAbility numbered" icon={["lower"]}>
...
<Ability id="rogues-edge-ex" icon={["boost","power"]}>
...
<Pair title="At 15th Level">You choose another skill and gain its skill unlock powers.</Pair>
...
<Message arch /><p>There are no official archetypes for the Unchained Rogue. You can use <Link to="/class/rogue">rogue</Link> archetypes if the features being replaced by the archetype match those of the unchained rogue.</p>
<h3 id="class-unchained_rogue-alternate-capstones" data-hash-target>Alternate Capstones</h3>
<Message capstone /><div className="capstones"><ScrollContainer id="class-unchained_rogue--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Masterful Talent (Ex)</td><td>At 20th level, the rogue has been a thief, an actor, a merchant, a scout, a confessor, a friend, an assassin, and a dozen more things besides. The rogue gains a +4 bonus on all of her skills.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
<tr><td>The Boss (Ex)</td><td>At 20th level, the character has become more than just a lone hero - she has become one of the senior figures of her field, with powers and responsibilities to match. The character becomes one of the leading figures in some manner of group or organization, as appropriate to the campaign and the setting. A wizard might become the dean of an arcane university or mages' guild, a fighter could command a mercenary army or a city guard, a cleric might lead a major temple or her own sect, and so forth. The player and the GM should work together to determine the specifics. The character gains the <Link to="/feat/leadership">Leadership</Link> feat if she does not already have it, and the number of followers that the feat grants is multiplied by 10 (although depending on the campaign and setting, the position may grant other powers as well). If multiple characters in a party select this capstone, the GM may consider pooling them to grant the players a particularly large and powerful organization, such as a small kingdom. Characters of any class can select this ability.</td></tr>
