...
<Ability id="immortal-commitment-su" icon={["warning"]}>
...
<Ability id="bestial-identity-su" icon={["magic"]}>
...
<Ability id="agathion-blessing-su" icon={["power"]}>
...
<Ability id="tongue-sacrifice-su" icon={["info","down","magic"]}>
...
<Ability id="monastic-communication-ex" icon={["power","boost"]}>
...
<Ability id="silent-to-magic-su" icon={["def"]}>
...
<Ability id="thought-scent-su" icon={["power"]}>
...
<Ability id="false-reading-su" icon={["def","power"]}>
...
<Ability id="animal-mask-ex" icon={["power"]}>
...
<Ability id="spellcasting" icon={["learn","magic"]}>
...
<Ability id="patron-spells" icon={["learn"]}>
...
<Ability id="rebellious-identity-ex" icon={["warning"]}>
...
<Ability id="bellflower-crop-ex" icon={["protect"]}>
...
<Ability id="crop-vigilance-ex" icon={["boost"]}>
...
<Ability id="obsequious-ex" icon={["boost"]}>
...
<Ability id="tend-the-garden-ex" icon={["power"]}>
...
<Ability id="chaotic-vigilante-ex" icon={["warning"]}>
...
<Ability id="brutish-fortitude-ex" icon={["def","down"]}>
...
<Ability id="brute-form-ex" icon={["power","down"]}>
...
<Ability id="brute-talents" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="awesome-blow-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="heavy-punches-ex" extraClasses="subAbility" icon={["melee","boost"]}>
...
<Ability id="scale-surroundings-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="sizing-equipment-ex" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="total-destruction-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="tear-them-apart-ex" icon={["melee","boost"]}>
...
<Ability id="spellcasting-and-spellbook" icon={["magic"]}>
...
<Ability id="spill-blood-ex" icon={["boost"]}>
...
<Ability id="cabalist-talents" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="bond-of-blood-sp-su" extraClasses="subAbility" icon={["aid"]}>
...
<Ability id="familiar-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="living-shadow-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="necromantic-focus-ex" extraClasses="subAbility" icon={["power","learn"]}>
...
<Ability id="shadow-jump-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="tattoo-chamber-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="bloodbound-spell-ex" icon={["lower"]}>
...
<Ability id="bloody-horror-ex" icon={["lower"]}>
...
<Ability id="shadowy-appearance-sp" icon={["def","magic"]}>
...
<Ability id="yokai-heart-su" icon={["info","power"]}>
...
<Ability id="oni-mask-ex" icon={["power","boost"]}>
...
<Ability id="steel-dictate-ex" icon={["power","boost"]}>
...
<Ability id="deceitful-form-sp" icon={["magic"]}>
...
<Ability id="deadly-horns-ex" icon={["melee"]}>
...
<Ability id="third-eye-su" icon={["zap"]}>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-vigilante-darklantern--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Must be a creature with the <Link to="/subtype/elf">elf</Link> subtype</td></tr></tbody></table></ScrollContainer></div><Ability id="dark-identity-su" icon={["power","boost","down"]}>
...
<Ability id="drow-magic-sp" icon={["magic"]}>
...
<Ability id="drow-paragon-su" icon={["def","boost"]}>
...
<Ability id="ruby-courtier-ex" icon={["power","info"]}>
...
<Ability id="reflexive-reaction-ex" icon={["power"]}>
...
<Ability id="false-allegiance-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="house-garess" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="house-lebeda" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="house-lodovka" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="house-medvyed" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="house-orlovsky" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="house-rogarvia" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="house-surtova" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="dragonscale-vigilance-su" icon={["magic"]}>
...
<Ability id="conquerors-wrath-ex" icon={["melee","down"]}>
...
<Ability id="forbidden-science-ex" extraClasses="hasSubs" icon={["boost"]}>
...
<Ability id="mutagenic-change-ex" icon={["power"]}>
...
<Ability id="brew-potion" icon={["power"]}>
...
<Ability id="lore-master-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="lore-master-ex" extraClasses="subAbility" icon={["boost","roll"]}>
...
<Ability id="mutable-mutagen" icon={["boost"]}>
...
<Ability id="weapon-and-armor-proficiencies" icon={["power","down"]}>
<Pair single id="weapon-and-armor-proficiencies">Weapon and Armor Proficiencies</Pair>
<Pair hl title="Alters">Weapon and armor proficiencies</Pair>
...
<Ability id="armored-juggernaut-ex" icon={["boost"]}>
...
<Ability id="faceless-infiltrator-ex" icon={["power","boost","down"]}>
...
<Ability id="enforcers-wrath-ex" icon={["boost"]}>
...
<Ability id="symbol-of-pride" icon={["power"]}>
...
<Ability id="spirit-of-ferocity-ex" icon={["boost"]}>
...
<Ability id="symbol-of-mastery" icon={["power"]}>
...
<Ability id="gunmaster" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="gunsmith" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="gunmaster-talents" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="deadeye-ex" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="deaths-shot-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="gunmaster-initiative-ex" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="half-elf-double-scion-talents" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="elven-weapon-command-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="arrogant-strike-ex" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="slick-step-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="hangmans-noose-ex" icon={["melee"]}>
...
<Ability id="bound-to-truth-ex-sp" icon={["boost","magic"]}>
...
<Ability id="twisted-rope-su" icon={["boost"]}>
...
<Ability id="chokehold" icon={["power"]}>
...
<Ability id="tighten-the-noose-ex" icon={["boost"]}>
...
<Ability id="suffocation-ex" icon={["melee","lower"]}>
...
<Ability id="seas-return-sp" icon={["magic"]}>
...
<Ability id="stealthy-swimmer-ex" icon={["boost"]}>
...
<Ability id="slander-ex" icon={["power"]}>
...
<Ability id="manipulative-ex" icon={["boost"]}>
...
<Ability id="false-flag-ex" icon={["power","boost","down"]}>
...
<Ability id="transformation-sequence-su" icon={["boost","down"]}>
...
<Ability id="animal-guide-ex" icon={["power"]}>
...
<Ability id="staunch-ally-ex" icon={["power"]}>
...
<Ability id="imperfect-control-ex" icon={["info","down"]}>
...
<Ability id="scars-of-the-past-ex" icon={["info","power"]}>
...
<Ability id="armor-training-ex" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="armor-mastery-ex" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="thorough-change" icon={["down"]}>
...
<Ability id="furious-charge-ex" icon={["boost","def"]}>
...
<Ability id="mighty-charge-ex" icon={["boost","melee"]}>
...
<Ability id="vengeance-strike-ex" icon={["down"]}>
...
<Ability id="mutant-specialization" icon={["boost","power"]}>
...
<Ability id="mutant-talents" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="mutant-blast-su" extraClasses="subAbility" icon={["zap"]}>
...
<Ability id="mutant-evolution" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="mutated-lobe-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="occult-awareness" icon={["power"]}>
...
<Ability id="implements-and-focus-powers-su" icon={["power"]}>
...
<Ability id="mental-focus-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="mental-focus-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="object-reading-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="object-reading-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="psychometric-strike-su" icon={["boost"]}>
...
<Ability id="thwart-pursuit-ex" icon={["boost"]}>
...
<Ability id="charming-ex" icon={["magic"]}>
...
<Ability id="death-attack-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="death-attack-ex" extraClasses="subAbility" icon={["melee"]}>
...
<Ability id="calling-card-ex" icon={["power","boost"]}>
...
<Ability id="grisly-murder-ex" icon={["power","lower"]}>
...
<Ability id="quiet-death-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="quiet-death-ex" extraClasses="subAbility" icon={["melee"]}>
...
<Ability id="swift-death-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="swift-death-ex" extraClasses="subAbility" icon={["melee"]}>
...
<Ability id="splintered-identity-ex" icon={["info","down"]}>
...
<Ability id="sudden-change-ex" icon={["power"]}>
...
<Ability id="surprising-change-ex" icon={["power"]}>
...
<Ability id="ki-pool-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="teisatsu-talents" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="ki-power-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="shadow-tricks-ex" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="armor-proficiencies" icon={["down","power"]}>
...
<Ability id="spellcasting" icon={["learn"]}>
<Pair single id="spellcasting">Spellcasting</Pair>
<Pair hl title="Replaces">4th-, 8th-, 10th-, 14th-, and 16th-level vigilante talents</Pair>
...
<Ability id="spellbook" icon={["learn"]}>
...
<Ability id="mystic-bolts-su" icon={["melee","ranged"]}>
...
<Ability id="piercing-bolts-ex" icon={["touch","zap"]}>
...
<Ability id="warlock-talents" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="arcane-striker-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="elemental-armor-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="social-simulacrum-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="natural-course-ex" icon={["power"]}>
...
<Ability id="heightened-senses-ex" icon={["power"]}>
...
<Ability id="shoot-webs-ex" icon={["zap"]}>
...
<Ability id="web-specialist-ex" icon={["power"]}>
...
<Ability id="web-master-ex" icon={["boost","power"]}>
...
<Ability id="soft-landing-ex" icon={["magic"]}>
...
<Ability id="eagle-eye-ex" icon={["boost"]}>
...
<Ability id="take-to-the-air-ex" icon={["power"]}>
...
<Ability id="deadly-dive-ex" icon={["melee"]}>
...
<Ability id="deadly-claws-ex" icon={["melee"]}>
...
<Ability id="bear-jaws-ex" icon={["melee"]}>
...
<Ability id="thick-hide-ex" icon={["def"]}>
...
<Ability id="bear-form-su" icon={["magic"]}>
...
<Ability id="feline-attributes-ex" icon={["power","boost"]}>
...
<Ability id="feline-grace-ex" icon={["def"]}>
...
<Ability id="feline-pounce-ex" icon={["power"]}>
...
<Ability id="nine-lives-su" icon={["def"]}>
...
<Ability id="weapon-proficiencies" icon={["power"]}>
...
<Ability id="chaotic-evil-good-and-lawful-spells" icon={["down"]}>
...
<Ability id="inquisition-ex" icon={["magic"]}>
...
<Ability id="zealot-talents" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="discern-lies-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="empower-symbol-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="harsh-judgment-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="stalwart-ex" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="stern-gaze-ex" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="zealot-smite-su" extraClasses="subAbility" icon={["power","lower"]}>
