...
<p><strong className="hl">Inhaled poisons</strong> are contracted the moment a creature enters an area containing such poisons. Most inhaled poisons fill a volume equal to a 10-foot cube per dose. Creatures can attempt to <Link to="/rule/suffocation">hold their breaths</Link> while inside to avoid inhaling the toxin. Creatures holding their breaths receive a 50% chance of not having to make a Fortitude save each round. Note that a character that would normally suffocate while attempting to hold its breath instead begins to breathe normally again.</p>
...
<p>Poisons are listed <Link to="/main/equipment_poisons">here</Link>.</p>
</>};
