...
<Ability id="enhanced-personality-ex" icon={["upgrade","broken-shield"]}>
<Pair single id="enhanced-personality-ex">Enhanced Personality (Ex)</Pair>
...
<Ability id="echo-su" icon={["magic-swirl"]}>
<Pair single id="echo-su">Echo (Su)</Pair>
...
<Ability id="reverberate-su" icon={["magic-swirl"]}>
<Pair single id="reverberate-su">Reverberate (Su)</Pair>
...
<Ability id="resonate-su" icon={["magic-swirl"]}>
<Pair single id="resonate-su">Resonate (Su)</Pair>
...
<Ability id="mockingbird-ex" icon={["stairs-goal"]}>
...
<Ability id="masters-guise-sp" icon={["magic-swirl"]}>
<Pair single id="masters-guise-sp">Master's Guise (Sp)</Pair>
...
<Ability id="order-master-ex" icon={["stairs-goal"]}>
<Pair single id="order-master-ex">Order Master (Ex)</Pair>
...
<Ability id="receive-touch-spells-ex" icon={["magic-swirl","stairs-goal"]}>
<Pair single id="receive-touch-spells-ex">Receive Touch Spells (Ex)</Pair>
...
<Ability id="scry-on-master-sp" icon={["magic-swirl"]}>
<Pair single id="scry-on-master-sp">Scry on Master (Sp)</Pair>
<Pair hl title="Replaces">Scry on familiar</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="elemental-type-ex" icon={["upgrade"]}>
<Pair single id="elemental-type-ex">Elemental Type (Ex)</Pair>
<Pair title="Passive Ability">An elemental familiar gains a subtype that matches its element: air, earth, fire, or water.</Pair>
</Ability>
<Ability id="elemental-manifestation-ex" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="elemental-manifestation-ex">Elemental Manifestation (Ex)</Pair>
...
<Ability id="air-familiar" extraClasses="subAbility numbered" icon={["stairs-goal","upgrade"]}>
<Pair single id="air-familiar">Air Familiar</Pair>
...
<Ability id="earth-familiar" extraClasses="subAbility numbered" icon={["armor-upgrade"]}>
<Pair single id="earth-familiar">Earth Familiar</Pair>
...
<Ability id="fire-familiar" extraClasses="subAbility numbered" icon={["smoking-finger"]}>
<Pair single id="fire-familiar">Fire Familiar</Pair>
...
<Ability id="water-familiar" extraClasses="subAbility numbered" icon={["stairs-goal","armor-upgrade"]}>
<Pair single id="water-familiar">Water Familiar</Pair>
...
<Ability id="elemental-speech-ex" icon={["stairs-goal"]}>
<Pair single id="elemental-speech-ex">Elemental Speech (Ex)</Pair>
...
<Ability id="share-will-su" icon={["armor-upgrade","shield-reflect"]}>
<Pair single id="share-will-su">Share Will (Su)</Pair>
...
<Ability id="domain-influence-sp-or-su" icon={["magic-swirl"]}>
<Pair single id="domain-influence-sp-or-su">Domain Influence (Sp or Su)</Pair>
<Pair hl title="Replaces">Deliver touch spells</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="recurring-dream-su" icon={["broken-shield"]}>
<Pair single id="recurring-dream-su">Recurring Dream (Su)</Pair>
<Pair hl title="Replaces">Improved evasion</Pair>
...
<Ability id="manifest-dreams-su" icon={["stairs-goal"]}>
<Pair single id="manifest-dreams-su">Manifest Dreams (Su)</Pair>
...
<Ability id="share-spells-ex" icon={["broken-shield"]}>
<Pair single id="share-spells-ex">Share Spells (Ex)</Pair>
...
<Ability id="uncanny-stealth-ex" icon={["armor-upgrade"]}>
<Pair single id="uncanny-stealth-ex">Uncanny Stealth (Ex)</Pair>
<Pair hl title="Replaces">Improved evasion</Pair>
...
<Ability id="scry-on-familiar-sp" icon={["stairs-goal"]}>
<Pair single id="scry-on-familiar-sp">Scry on Familiar (Sp)</Pair>
<Pair hl title="Replaces">Speak with animals of its kind</Pair>
...
<Ability id="lucky-mascot-su" icon={["upgrade"]}>
<Pair single id="lucky-mascot-su">Lucky Mascot (Su)</Pair>
<Pair hl title="Replaces">Improved evasion</Pair>
...
<Ability id="share-spells-ex" icon={["broken-shield","stairs-goal"]}>
<Pair single id="share-spells-ex">Share Spells (Ex)</Pair>
<Pair hl title="Alters">Share spells</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="deliver-touch-spells-su" icon={["broken-shield","stairs-goal"]}>
...
<Ability id="speak-with-team-ex" icon={["stairs-goal"]}>
<Pair single id="speak-with-team-ex">Speak with Team (Ex)</Pair>
<Pair hl title="Replaces">Speak with master, speak with animals of its kind</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="heart-of-the-team-ex" icon={["upgrade"]}>
<Pair single id="heart-of-the-team-ex">Heart of the Team (Ex)</Pair>
...
<Ability id="increased-strength-ex" icon={["upgrade","broken-shield"]}>
<Pair single id="increased-strength-ex">Increased Strength (Ex)</Pair>
...
<Ability id="battle-form-su" icon={["stairs-goal"]}>
<Pair single id="battle-form-su">Battle Form (Su)</Pair>
<Pair hl title="Replaces">Deliver touch spells</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Pair single id="damage-reduction-su">Damage Reduction (Su)</Pair>
<Pair hl title="Replaces">Spell resistance</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="see-the-unseen-ex" icon={["stairs-goal"]}>
<Pair single id="see-the-unseen-ex">See the Unseen (Ex)</Pair>
<Pair hl title="Replaces">Alertness</Pair>
...
<Ability id="teacher-from-afar-ex" icon={["upgrade"]}>
<Pair single id="teacher-from-afar-ex">Teacher from Afar (Ex)</Pair>
<Pair hl title="Replaces">Deliver touch spells</Pair>
...
<p>Removing a parasite requires a successful Heal check opposed by the familiar's Stealth check, or a successful casting of <Link to="/spell/break_enchantment">break enchantment</Link> against a DC of 11 + the parasite's level. If successful, the parasite is destroyed. The parasite can leave the host willingly as a <strong className="hl">full-round action</strong>. If the host is killed, the parasite must succeed at a DC 20 Fortitude save or be killed as well.</p>
</Pair>
</Ability>
<Ability id="puppeteer-sp" icon={["stairs-goal","magic-swirl"]}>
<Pair single id="puppeteer-sp">Puppeteer (Sp)</Pair>
...
<Ability id="nondetection-su" icon={["armor-upgrade"]}>
<Pair single id="nondetection-su">Nondetection (Su)</Pair>
<Pair hl title="Replaces">Improved evasion</Pair>
...
<Ability id="sneak-ex" icon={["upgrade"]}>
<Pair single id="sneak-ex">Sneak (Ex)</Pair>
<Pair hl title="Replaces">Deliver touch spells</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="greater-steal-ex" icon={["stairs-goal"]}>
<Pair single id="greater-steal-ex">Greater Steal (Ex)</Pair>
<Pair hl title="Replaces">Speak with animals of its kind</Pair>
...
<Ability id="magical-pranks-sp" icon={["magic-swirl"]}>
<Pair single id="magical-pranks-sp">Magical Pranks (Sp)</Pair>
<Pair hl title="Replaces">Improved evasion, share spells</Pair>
...
<Ability id="glib-comedy-ex" icon={["upgrade"]}>
<Pair single id="glib-comedy-ex">Glib Comedy (Ex)</Pair>
<Pair hl title="Replaces">Deliver touch spells</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="greater-dirty-trick-ex" icon={["stairs-goal"]}>
<Pair single id="greater-dirty-trick-ex">Greater Dirty Trick (Ex)</Pair>
<Pair hl title="Replaces">Spell resistance</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="unreliable-narrator-sp" icon={["stairs-goal","magic-swirl"]}>
<Pair single id="unreliable-narrator-sp">Unreliable Narrator (Sp)</Pair>
...
<Ability id="loyal-bodyguard-ex" icon={["stairs-goal","shield-reflect"]}>
<Pair single id="loyal-bodyguard-ex">Loyal Bodyguard (Ex)</Pair>
<Pair hl title="Replaces">Alertness, improved evasion</Pair>
...
<Ability id="shield-master-su" icon={["armor-upgrade"]}>
<Pair single id="shield-master-su">Shield Master (Su)</Pair>
...
<Ability id="able-defender-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="able-defender-ex">Able Defender (Ex)</Pair>
<Pair hl title="Replaces">Spell resistance</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="sages-knowledge-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="sages-knowledge-ex">Sage's Knowledge (Ex)</Pair>
...
<Ability id="school-link-su" icon={["broken-shield"]}>
<Pair single id="school-link-su">School Link (Su)</Pair>
...
<Ability id="school-cantrip-sp" icon={["magic-swirl"]}>
<Pair single id="school-cantrip-sp">School Cantrip (Sp)</Pair>
...
<Ability id="specialty-stowaway-sp-or-su" icon={["magic-swirl","stairs-goal"]}>
<Pair single id="specialty-stowaway-sp-or-su">Specialty Stowaway (Sp or Su)</Pair>
...
<Ability id="lesser-school-power" icon={["stairs-goal"]}>
<Pair single id="lesser-school-power">Lesser School Power</Pair>
<Pair title="Ability">A school familiar gains the lesser school power matching its associated arcane school.</Pair>
</Ability>
<Ability id="greater-school-power" icon={["stairs-goal"]}>
<Pair single id="greater-school-power">Greater School Power</Pair>
...
<Ability id="energy-block-su" icon={["armor-upgrade","shield-reflect"]}>
<Pair single id="energy-block-su">Energy Block (Su)</Pair>
...
<Ability id="disruptive-spirit-su" icon={["mailed-fist"]}>
<Pair single id="disruptive-spirit-su">Disruptive Spirit (Su)</Pair>
...
<Ability id="masters-side-sp" icon={["magic-swirl"]}>
<Pair single id="masters-side-sp">Master's Side (Sp)</Pair>
<Pair title="Type">Lesser Power</Pair>
...
<Ability id="summoned-shell-sp" icon={["stairs-goal"]}>
<Pair single id="summoned-shell-sp">Summoned Shell (Sp)</Pair>
<Pair title="Type">Greater Power</Pair>
...
<Ability id="ever-ready-su" icon={["rolling-dices","upgrade"]}>
<Pair single id="ever-ready-su">Ever Ready (Su)</Pair>
<Pair title="Type">Lesser Power</Pair>
...
<Ability id="greater-scry-on-familiar-sp" icon={["stairs-goal"]}>
<Pair single id="greater-scry-on-familiar-sp">Greater Scry on Familiar (Sp)</Pair>
<Pair title="Type">Greater Power</Pair>
...
<Ability id="manipulative-abettor-su" icon={["armor-downgrade"]}>
<Pair single id="manipulative-abettor-su">Manipulative Abettor (Su)</Pair>
<Pair title="Type">Lesser Power</Pair>
...
<Ability id="puppet-master-su" icon={["magic-palm"]}>
<Pair single id="puppet-master-su">Puppet Master (Su)</Pair>
<Pair title="Type">Greater Power</Pair>
...
<Ability id="energy-boost-su" icon={["armor-upgrade","upgrade"]}>
<Pair single id="energy-boost-su">Energy Boost (Su)</Pair>
<Pair title="Type">Lesser Power</Pair>
...
<Ability id="eldritch-battery-su" icon={["armor-upgrade","stairs-goal","magic-swirl"]}>
<Pair single id="eldritch-battery-su">Eldritch Battery (Su)</Pair>
<Pair title="Type">Greater Power</Pair>
...
<Ability id="illusory-maestro-su" icon={["stairs-goal","upgrade"]}>
<Pair single id="illusory-maestro-su">Illusory Maestro (Su)</Pair>
<Pair title="Type">Lesser Power</Pair>
...
<Ability id="phantom-swarm-su" icon={["stairs-goal","mailed-fist"]}>
<Pair single id="phantom-swarm-su">Phantom Swarm (Su)</Pair>
<Pair title="Type">Greater Power</Pair>
...
<Ability id="spirit-warden-su" icon={["upgrade","magic-palm"]}>
<Pair single id="spirit-warden-su">Spirit Warden (Su)</Pair>
<Pair title="Type">Lesser Power</Pair>
...
<Ability id="one-with-the-negative-su" icon={["broken-shield","armor-upgrade","mailed-fist"]}>
<Pair single id="one-with-the-negative-su">One With the Negative (Su)</Pair>
<Pair title="Type">Greater Power</Pair>
...
<Ability id="dispel-bait-su" icon={["stairs-goal","shield-reflect"]}>
<Pair single id="dispel-bait-su">Dispel Bait (Su)</Pair>
<Pair title="Type">Lesser Power</Pair>
...
<Ability id="infinite-forms-su" icon={["magic-swirl"]}>
<Pair single id="infinite-forms-su">Infinite Forms (Su)</Pair>
<Pair title="Type">Greater Power</Pair>
...
<Ability id="soul-focus-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="soul-focus-ex">Soul Focus (Ex)</Pair>
<Pair hl title="Replaces">Alertness</Pair>
...
<Ability id="alignment-variation-ex" icon={["magic-swirl"]}>
<Pair single id="alignment-variation-ex">Alignment Variation (Ex)</Pair>
...
<Ability id="magical-manipulation-sp" icon={["magic-swirl"]}>
<Pair single id="magical-manipulation-sp">Magical Manipulation (Sp)</Pair>
<Pair hl title="Replaces">Share spells</Pair>
...
<Ability id="teammate-ex" icon={["stairs-goal"]}>
<Pair single id="teammate-ex">Teammate (Ex)</Pair>
<Pair hl title="Replaces">Improved evasion</Pair>
...
<Ability id="deliver-touch-spells-su" icon={["upgrade"]}>
<Pair single id="deliver-touch-spells-su">Deliver Touch Spells (Su)</Pair>
<Pair hl title="Alters">Deliver touch spells</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="deliver-aid-ex" icon={["upgrade"]}>
<Pair single id="deliver-aid-ex">Deliver Aid (Ex)</Pair>
<Pair hl title="Replaces">Speak with animals of its kind</Pair>
<Pair title="Gained">At 7th Level</Pair>
...
<Ability id="aide-to-all-ex" icon={["upgrade"]}>
<Pair single id="aide-to-all-ex">Aide to All (Ex)</Pair>
<Pair hl title="Replaces">Scry on familiar</Pair>
<Pair title="Gained">At 13th Level</Pair>
