...
<Ability id="persuasive-ex" icon={["power"]}>
...
<Ability id="enhanced-personality-ex" icon={["boost","down"]}>
...
<Ability id="influence-animals-ex-sp" icon={["boost","power","magic"]}>
...
<Ability id="reverberate-su" icon={["magic"]}>
...
<Ability id="resonate-su" icon={["magic"]}>
...
<Ability id="mockingbird-ex" icon={["power"]}>
...
<Ability id="masters-guise-sp" icon={["magic"]}>
...
<Ability id="song-of-myself-ex" icon={["power"]}>
...
<Ability id="order-master-ex" icon={["power"]}>
...
<Ability id="receive-touch-spells-ex" icon={["magic","power"]}>
...
<Ability id="scry-on-master-sp" icon={["magic"]}>
...
<Ability id="elemental-type-ex" icon={["boost"]}>
...
<Ability id="elemental-manifestation-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="air-familiar" extraClasses="subAbility numbered" icon={["power","boost"]}>
...
<Ability id="earth-familiar" extraClasses="subAbility numbered" icon={["def"]}>
...
<Ability id="fire-familiar" extraClasses="subAbility numbered" icon={["zap"]}>
...
<Ability id="water-familiar" extraClasses="subAbility numbered" icon={["power","def"]}>
...
<Ability id="elemental-speech-ex" icon={["power"]}>
...
<Ability id="divine-guidance-sp" icon={["magic"]}>
...
<Ability id="share-will-su" icon={["def","protect"]}>
...
<Ability id="domain-influence-sp-or-su" icon={["magic"]}>
...
<Ability id="recurring-dream-su" icon={["down"]}>
...
<Ability id="manifest-dreams-su" icon={["power"]}>
...
<Ability id="share-spells-ex" icon={["down"]}>
...
<Ability id="uncanny-stealth-ex" icon={["def"]}>
...
<Ability id="scry-on-familiar-sp" icon={["power"]}>
...
<Ability id="affinity-for-my-team-su" icon={["power","boost"]}>
...
<Ability id="lucky-mascot-su" icon={["boost"]}>
...
<Ability id="share-spells-ex" icon={["down","power"]}>
<Pair single id="share-spells-ex">Share Spells (Ex)</Pair>
<Pair hl title="Alters">Share spells</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="deliver-touch-spells-su" icon={["down","power"]}>
...
<Ability id="speak-with-team-ex" icon={["power"]}>
...
<Ability id="heart-of-the-team-ex" icon={["boost"]}>
...
<Pair id="class-skills" single>Class Skills</Pair>
<Pair title="Alters" hl>Class skills</Pair><Pair title="New Class Skills"><Link to="/skill/intimidate">Intimidate</Link> (CHA)</Pair></Ability>
<Ability id="bond-forged-in-blood-su" icon={["down","boost"]}>
...
<Ability id="increased-strength-ex" icon={["boost","down"]}>
...
<Ability id="battle-form-su" icon={["power"]}>
...
<Ability id="see-the-unseen-ex" icon={["power"]}>
...
<Ability id="teacher-from-afar-ex" icon={["boost"]}>
...
<Ability id="infest-su" icon={["power"]}>
...
<Ability id="puppeteer-sp" icon={["power","magic"]}>
...
<Ability id="improved-steal-ex" icon={["power"]}>
...
<Ability id="nondetection-su" icon={["def"]}>
...
<Ability id="sneak-ex" icon={["boost"]}>
...
<Ability id="greater-steal-ex" icon={["power"]}>
...
<Ability id="autonomous-link-ex" icon={["power"]}>
...
<Ability id="magical-pranks-sp" icon={["magic"]}>
...
<Ability id="glib-comedy-ex" icon={["boost"]}>
...
<Ability id="greater-dirty-trick-ex" icon={["power"]}>
...
<Ability id="unreliable-narrator-sp" icon={["power","magic"]}>
...
<Ability id="loyal-bodyguard-ex" icon={["power","protect"]}>
...
<Ability id="shield-master-su" icon={["def"]}>
...
<Ability id="able-defender-ex" icon={["power","boost"]}>
...
<Ability id="dazzling-intellect-ex" icon={["boost","down"]}>
...
<Ability id="sages-knowledge-ex" icon={["power","boost"]}>
...
<Ability id="school-link-su" icon={["down"]}>
...
<Ability id="school-cantrip-sp" icon={["magic"]}>
...
<Ability id="specialty-stowaway-sp-or-su" icon={["magic","power"]}>
...
<Ability id="lesser-school-power" icon={["power"]}>
...
<Ability id="greater-school-power" icon={["power"]}>
...
<Ability id="energy-block-su" icon={["def","protect"]}>
...
<Ability id="disruptive-spirit-su" icon={["melee"]}>
...
<Ability id="masters-side-sp" icon={["magic"]}>
...
<Ability id="summoned-shell-sp" icon={["power"]}>
...
<Ability id="ever-ready-su" icon={["roll","boost"]}>
...
<Ability id="greater-scry-on-familiar-sp" icon={["power"]}>
...
<Ability id="manipulative-abettor-su" icon={["lower"]}>
...
<Ability id="puppet-master-su" icon={["touch"]}>
...
<Ability id="energy-boost-su" icon={["def","boost"]}>
...
<Ability id="eldritch-battery-su" icon={["def","power","magic"]}>
...
<Ability id="illusory-maestro-su" icon={["power","boost"]}>
...
<Ability id="phantom-swarm-su" icon={["power","melee"]}>
...
<Ability id="spirit-warden-su" icon={["boost","touch"]}>
...
<Ability id="one-with-the-negative-su" icon={["down","def","melee"]}>
...
<Ability id="dispel-bait-su" icon={["power","protect"]}>
...
<Ability id="infinite-forms-su" icon={["magic"]}>
...
<Ability id="soul-focus-ex" icon={["power","boost"]}>
...
<Ability id="alignment-variation-ex" icon={["magic"]}>
...
<Ability id="able-assistant-ex" icon={["power"]}>
...
<Ability id="magical-manipulation-sp" icon={["magic"]}>
...
<Ability id="teammate-ex" icon={["power"]}>
...
<Ability id="deliver-touch-spells-su" icon={["boost"]}>
<Pair single id="deliver-touch-spells-su">Deliver Touch Spells (Su)</Pair>
<Pair hl title="Alters">Deliver touch spells</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="deliver-aid-ex" icon={["boost"]}>
...
<Ability id="aide-to-all-ex" icon={["boost"]}>
