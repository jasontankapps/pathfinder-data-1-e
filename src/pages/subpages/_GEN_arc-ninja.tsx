...
<Ability id="track-victim-ex" icon={["upgrade","stairs-goal","armor-upgrade"]}>
...
<Ability id="swift-tracker-ex" icon={["upgrade","armor-upgrade"]}>
...
<Ability id="gunpowder-bomb-ex" icon={["bowman"]}>
...
<Ability id="explosive-impairment-su" icon={["armor-downgrade"]}>
...
<Ability id="delayed-explosive-ex" icon={["stairs-goal"]}>
...
<Ability id="death-mark-ex" icon={["upgrade"]}>
...
<Ability id="certain-demise-ex" icon={["upgrade"]}>
...
<Ability id="weapon-and-armor-proficiencies" icon={["stairs-goal"]}>
...
<Ability id="mask-ex" icon={["hazard-sign"]}>
...
<Ability id="undercover-faith-ex" icon={["stairs-goal"]}>
...
<Ability id="expurgate-sp" icon={["armor-downgrade"]}>
...
<Ability id="burst-of-blossoms-su" icon={["magic-swirl","upgrade"]}>
...
<Ability id="sundial-su" icon={["magic-swirl"]}>
