...
<Ability id="hardy-killer-ex" icon={["def"]}>
<Pair single id="hardy-killer-ex">Hardy Killer (Ex)</Pair>
...
<Ability id="track-victim-ex" icon={["boost","power","def"]}>
<Pair single id="track-victim-ex">Track Victim (Ex)</Pair>
...
<Ability id="swift-tracker-ex" icon={["boost","def"]}>
...
<p><strong className="hl">The following ninja tricks complement the frozen shadow archetype:</strong> <Link to="/ninjatrick/bleeding_attack">bleeding attack</Link>, <Link to="/ninjatrick/darkvision">darkvision</Link>, <Link to="/ninjatrick/deadly_range">deadly range</Link>, <Link to="/ninjatrick/fast_stealth">fast stealth</Link>, <Link to="/ninjatrick/hidden_weapons">hidden weapons</Link>, <Link to="/ninjatrick/sudden_disguise">sudden disguise</Link>, <Link to="/ninjatrick/vanishing_trick">vanishing trick</Link>, and <Link to="/ninjatrick/wall_climber">wall climber</Link>.</p>
<p><strong className="hl">The following advanced ninja tricks complement the frozen shadow archetype:</strong> <Link to="/ninjatrick/assassinate">assassinate</Link>, <Link to="/ninjatrick/ghost_step">ghost step</Link>, <Link to="/ninjatrick/invisible_blade">invisible blade</Link>, <Link to="/ninjatrick/master_disguise">master disguise</Link>, and <Link to="/ninjatrick/see_the_unseen">see the unseen</Link>.</p>
</>};
...
<Ability id="gunpowder-bomb-ex" icon={["ranged"]}>
<Pair single id="gunpowder-bomb-ex">Gunpowder Bomb (Ex)</Pair>
...
<Ability id="explosive-impairment-su" icon={["lower"]}>
<Pair single id="explosive-impairment-su">Explosive Impairment (Su)</Pair>
<Pair hl title="Replaces">Uncanny dodge</Pair>
...
<Ability id="delayed-explosive-ex" icon={["power"]}>
<Pair single id="delayed-explosive-ex">Delayed Explosive (Ex)</Pair>
<Pair hl title="Replaces">Improved uncanny dodge</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Pair single id="relentless-pursuit-ex">Relentless Pursuit (Ex)</Pair>
...
<Ability id="death-mark-ex" icon={["boost"]}>
<Pair single id="death-mark-ex">Death Mark (Ex)</Pair>
...
<Ability id="certain-demise-ex" icon={["boost"]}>
<Pair single id="certain-demise-ex">Certain Demise (Ex)</Pair>
...
<Ability id="weapon-and-armor-proficiencies" icon={["power"]}>
...
<Ability id="mask-ex" icon={["warning"]}>
<Pair single id="mask-ex">Mask (Ex)</Pair>
...
<Ability id="undercover-faith-ex" icon={["power"]}>
<Pair single id="undercover-faith-ex">Undercover Faith (Ex)</Pair>
...
<Ability id="expurgate-sp" icon={["lower"]}>
<Pair single id="expurgate-sp" flavor="The role of a mask of the Living God is to silence heretics and blasphemers, and he is an expert at rendering even the most glib of his foes into babbling fools.">Expurgate (Sp)</Pair>
...
<Pair single id="stern-gaze-ex" flavor="A mask of the Living God is trained to sense deception and strike fear into the hearts of his foes.">Stern Gaze (Ex)</Pair>
<Pair hl title="Replaces">No trace</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<p><strong className="hl">The following ninja tricks complement the mask of the Living God archetype:</strong> <Link to="/ninjatrick/forgotten_trick">forgotten trick</Link>, <Link to="/ninjatrick/kamikaze">kamikaze</Link>, <Link to="/ninjatrick/unarmed_combat_training">unarmed combat training</Link>, <Link to="/ninjatrick/vanishing_trick">vanishing trick</Link>, <Link to="/ninjatrick/weapon_training">weapon training</Link>.</p>
<p><strong className="hl">The following master tricks complement the mask of the Living God:</strong> <Link to="/ninjatrick/ghost_step">ghost step</Link>, <Link to="/ninjatrick/see_the_unseen">see the unseen</Link>, and <Link to="/ninjatrick/shadow_split">shadow split</Link>.</p>
</>};
...
<Ability id="blossom-shower-ex" icon={["power","def","lower"]}>
...
<Ability id="burst-of-blossoms-su" icon={["magic","boost"]}>
<Pair single id="burst-of-blossoms-su" flavor="A petal ninja gains the ability to transform into a cloud of blossoms.">Burst of Blossoms (Su)</Pair>
...
<Ability id="sundial-su" icon={["magic"]}>
<Pair single id="sundial-su">Sundial (Su)</Pair>
