...
<Ability id="dancers-cunning-ex" icon={["power"]}>
...
<Ability id="dancing-dodge-ex" icon={["def"]}>
...
<Ability id="sparring-partners-ex" icon={["boost"]}>
...
<Ability id="crowd-control-ex" icon={["power"]}>
...
<Ability id="lesser-flexibility-ex" icon={["down"]}>
...
<Ability id="drunk-handler-ex" icon={["boost","lower"]}>
...
<Ability id="drunk-knockout-ex" icon={["power"]}>
...
<Ability id="bar-fight-mastery-ex" icon={["power"]}>
...
<Ability id="constructed-limb-ex" icon={["power"]}>
...
<Ability id="limb-modification" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="flex-limb" extraClasses="subAbility" icon={["melee"]}>
...
<Ability id="grapnel-arm" extraClasses="subAbility" icon={["ranged"]}>
...
<Ability id="limb-extender" extraClasses="subAbility" icon={["melee"]}>
...
<Ability id="shielding-limb" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="tight-grip" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="vicious-blades" extraClasses="subAbility" icon={["melee","boost"]}>
...
<Ability id="vicious-spikes" extraClasses="subAbility" icon={["melee","boost"]}>
...
<Ability id="bonus-item-creation-feats" icon={["power"]}>
...
<Ability id="call-to-arms-ex" icon={["boost"]}>
...
<Ability id="inspiring-prowess-ex" icon={["power","boost"]}>
...
<Ability id="field-instruction-ex" icon={["power","boost"]}>
...
<Ability id="feral-aspect-su" icon={["power"]}>
...
<Ability id="humble-beginnings-ex" icon={["power","down"]}>
...
<Ability id="improvisation-training-ex" icon={["boost"]}>
...
<Ability id="improvised-maneuver-ex" icon={["power"]}>
...
<Ability id="improvisation-mastery-ex" icon={["boost"]}>
...
<Ability id="earth-discipline-ex" icon={["power"]}>
...
<Ability id="landslide-ex" icon={["down","boost"]}>
...
<Ability id="unyielding-ex" icon={["def"]}>
...
<Ability id="avalanche-ex" icon={["power"]}>
...
<Ability id="improved-avalanche-ex" icon={["boost"]}>
...
<Ability id="mutagen-su" extraClasses="hasSubs" icon={["power","melee"]}>
...
<Ability id="beastmorph-su" icon={["power","boost"]}>
...
<Ability id="throw-shield-ex" icon={["ranged"]}>
...
<Ability id="returning-shield-ex" icon={["ranged","power"]}>
...
<Ability id="champion-defense-ex" icon={["def"]}>
...
<Ability id="snake-feint-ex" icon={["power"]}>
...
<Ability id="opportunist-ex" icon={["melee"]}>
...
<Pair title="Removed Skills">Knowledge (dungeoneering)</Pair></Ability>
<Ability id="exploit-weakness-ex" icon={["boost","lower","def"]}>
...
<Ability id="sunder-training-ex" icon={["melee","boost","def"]}>
...
<Ability id="strangle-ex" icon={["boost"]}>
...
<Ability id="practiced-strangler-ex" icon={["def","melee"]}>
...
<Ability id="sleeper-hold-ex" icon={["power"]}>
...
<Ability id="neckbreaker-ex" icon={["power"]}>
...
<Ability id="lead-leg-ex" icon={["def","boost"]}>
...
<Ability id="favored-turf-ex" icon={["boost","def"]}>
...
<Ability id="terrain-mastery-su" icon={["def","boost"]}>
...
<Ability id="beast-training-ex" icon={["boost"]}>
...
<Ability id="beast-defenses-ex" icon={["def"]}>
...
<Ability id="venomous-strike-ex" icon={["down","boost"]}>
...
<Ability id="green-grasp-su" icon={["power"]}>
...
<Ability id="thorny-embrace-su" icon={["boost"]}>
...
<Ability id="phytological-anatomy-su" icon={["power","def"]}>
...
<Ability id="hunters-tricks" icon={["power"]}>
...
<Ability id="maneuver-training-ex" icon={["power"]}>
...
<Ability id="wild-tricks-ex" icon={["power"]}>
...
<Ability id="school-focus-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="mystery-of-unblinking-flame-su" extraClasses="subAbility" icon={["boost","melee","def"]}>
...
<Ability id="mystery-of-unfolding-wind-su" extraClasses="subAbility" icon={["boost","power"]}>
...
<Ability id="mystery-of-untwisting-iron-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="monk-moves-ex" icon={["power"]}>
