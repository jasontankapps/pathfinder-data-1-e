...
<Ability id="dancers-cunning-ex" icon={["stairs-goal"]}>
<Pair single id="dancers-cunning-ex">Dancer's Cunning (Ex)</Pair>
...
<Ability id="rolling-flurry-ex" icon={["info"]}>
<Pair single id="rolling-flurry-ex">Rolling Flurry (Ex)</Pair>
...
<Ability id="dancing-dodge-ex" icon={["armor-upgrade"]}>
<Pair single id="dancing-dodge-ex">Dancing Dodge (Ex)</Pair>
...
<Ability id="sparring-partners-ex" icon={["upgrade"]}>
<Pair single id="sparring-partners-ex">Sparring Partners (Ex)</Pair>
...
<Ability id="crowd-control-ex" icon={["stairs-goal"]}>
...
<Ability id="lesser-flexibility-ex" icon={["broken-shield"]}>
<Pair single id="lesser-flexibility-ex">Lesser Flexibility (Ex)</Pair>
...
<Ability id="drunk-handler-ex" icon={["upgrade","armor-downgrade"]}>
<Pair single id="drunk-handler-ex">Drunk Handler (Ex)</Pair>
...
<Ability id="drunk-knockout-ex" icon={["stairs-goal"]}>
<Pair single id="drunk-knockout-ex">Drunk Knockout (Ex)</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="bar-fight-mastery-ex" icon={["stairs-goal"]}>
<Pair single id="bar-fight-mastery-ex">Bar Fight Mastery (Ex)</Pair>
...
<Ability id="limb-modification" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="limb-modification">Limb Modification</Pair>
...
<Ability id="flex-limb" extraClasses="subAbility" icon={["mailed-fist"]}>
<Pair single id="flex-limb">Flex Limb</Pair>
...
<Ability id="grapnel-arm" extraClasses="subAbility" icon={["bowman"]}>
<Pair single id="grapnel-arm">Grapnel Arm</Pair>
...
<Ability id="limb-extender" extraClasses="subAbility" icon={["mailed-fist"]}>
<Pair single id="limb-extender">Limb Extender</Pair>
...
<Ability id="shielding-limb" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="shielding-limb">Shielding Limb</Pair>
...
<Ability id="tight-grip" extraClasses="subAbility" icon={["upgrade","armor-upgrade"]}>
<Pair single id="tight-grip">Tight Grip</Pair>
...
<Ability id="vicious-blades" extraClasses="subAbility" icon={["mailed-fist","upgrade"]}>
<Pair single id="vicious-blades">Vicious Blades</Pair>
...
<Ability id="vicious-spikes" extraClasses="subAbility" icon={["mailed-fist","upgrade"]}>
<Pair single id="vicious-spikes">Vicious Spikes</Pair>
...
<Ability id="bonus-item-creation-feats" icon={["stairs-goal"]}>
<Pair single id="bonus-item-creation-feats">Bonus Item Creation Feats</Pair>
...
<Ability id="call-to-arms-ex" icon={["upgrade"]}>
<Pair single id="call-to-arms-ex">Call to Arms (Ex)</Pair>
...
<Ability id="inspiring-prowess-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="inspiring-prowess-ex">Inspiring Prowess (Ex)</Pair>
...
<Ability id="field-instruction-ex" icon={["stairs-goal","upgrade"]}>
<Pair single id="field-instruction-ex">Field Instruction (Ex)</Pair>
...
<Ability id="feral-aspect-su" icon={["stairs-goal"]}>
<Pair single id="feral-aspect-su">Feral Aspect (Su)</Pair>
<Pair hl title="Replaces">Martial flexibility</Pair>
...
<Ability id="humble-beginnings-ex" icon={["stairs-goal","broken-shield"]}>
<Pair single id="humble-beginnings-ex">Humble Beginnings (Ex)</Pair>
<Pair hl title="Alters">The brawler's armor proficiencies</Pair>
...
<Ability id="improvisation-training-ex" icon={["upgrade"]}>
<Pair single id="improvisation-training-ex">Improvisation Training (Ex)</Pair>
...
<Ability id="improvised-maneuver-ex" icon={["stairs-goal"]}>
<Pair single id="improvised-maneuver-ex" flavor="A hinyasi learns to confound and befuddle her opponents with improvised weapons.">Improvised Maneuver (Ex)</Pair>
<Pair hl title="Replaces">Knockout</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="improvisation-mastery-ex" icon={["upgrade"]}>
<Pair single id="improvisation-mastery-ex">Improvisation Mastery (Ex)</Pair>
...
<Ability id="earth-discipline-ex" icon={["stairs-goal"]}>
<Pair single id="earth-discipline-ex">Earth Discipline (Ex)</Pair>
...
<Ability id="landslide-ex" icon={["broken-shield","upgrade"]}>
<Pair single id="landslide-ex">Landslide (Ex)</Pair>
...
<Ability id="unyielding-ex" icon={["armor-upgrade"]}>
<Pair single id="unyielding-ex">Unyielding (Ex)</Pair>
...
<Ability id="avalanche-ex" icon={["stairs-goal"]}>
<Pair single id="avalanche-ex">Avalanche (Ex)</Pair>
...
<Ability id="improved-avalanche-ex" icon={["upgrade"]}>
<Pair single id="improved-avalanche-ex">Improved Avalanche (Ex)</Pair>
...
<Ability id="mutagen-su" extraClasses="hasSubs" icon={["stairs-goal","mailed-fist"]}>
...
<Ability id="beastmorph-su" icon={["stairs-goal","upgrade"]}>
<Pair single id="beastmorph-su">Beastmorph (Su)</Pair>
<Pair hl title="Replaces">AC bonus</Pair>
...
<Ability id="throw-shield-ex" icon={["bowman"]}>
<Pair single id="throw-shield-ex">Throw Shield (Ex)</Pair>
...
<Ability id="champion-defense-ex" icon={["armor-upgrade"]}>
<Pair single id="champion-defense-ex">Champion Defense (Ex)</Pair>
...
<Ability id="snake-feint-ex" icon={["stairs-goal"]}>
<Pair single id="snake-feint-ex">Snake Feint (Ex)</Pair>
...
<Ability id="opportunist-ex" icon={["mailed-fist"]}>
...
<Ability id="sunder-training-ex" icon={["mailed-fist","upgrade","armor-upgrade"]}>
<Pair single id="sunder-training-ex" flavor="A steel-breaker receives additional training in sunder combat maneuvers.">Sunder Training (Ex)</Pair>
<Pair hl title="Alters">Maneuver training</Pair>
...
<Ability id="practiced-strangler-ex" icon={["armor-upgrade","mailed-fist"]}>
<Pair single id="practiced-strangler-ex">Practiced Strangler (Ex)</Pair>
<Pair hl title="Replaces">AC bonus</Pair>
...
<Ability id="sleeper-hold-ex" icon={["stairs-goal"]}>
<Pair single id="sleeper-hold-ex">Sleeper Hold (Ex)</Pair>
...
<Ability id="neckbreaker-ex" icon={["stairs-goal"]}>
<Pair single id="neckbreaker-ex">Neckbreaker (Ex)</Pair>
...
<Pair single id="strong-side-fist-ex">Strong-Side Fist (Ex)</Pair>
...
<Ability id="lead-leg-ex" icon={["armor-upgrade","upgrade"]}>
<Pair single id="lead-leg-ex">Lead Leg (Ex)</Pair>
<Pair hl title="Replaces">Close weapon mastery</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="favored-turf-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="favored-turf-ex">Favored Turf (Ex)</Pair>
<Pair hl title="Replaces">Maneuver training</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="terrain-mastery-su" icon={["armor-upgrade","upgrade"]}>
<Pair single id="terrain-mastery-su">Terrain Mastery (Su)</Pair>
<Pair hl title="Replaces">Knockout</Pair>
...
<Ability id="beast-training-ex" icon={["upgrade"]}>
<Pair single id="beast-training-ex">Beast Training (Ex)</Pair>
<Pair hl title="Replaces">Maneuver training</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="beast-defenses-ex" icon={["armor-upgrade"]}>
<Pair single id="beast-defenses-ex">Beast Defenses (Ex)</Pair>
<Pair hl title="Replaces">AC bonus</Pair>
...
<Ability id="venomous-strike-ex" icon={["broken-shield","upgrade"]}>
<Pair single id="venomous-strike-ex">Venomous Strike (Ex)</Pair>
...
<Ability id="green-grasp-su" icon={["stairs-goal"]}>
<Pair single id="green-grasp-su">Green Grasp (Su)</Pair>
...
<Ability id="thorny-embrace-su" icon={["upgrade"]}>
<Pair single id="thorny-embrace-su">Thorny Embrace (Su)</Pair>
<Pair hl title="Replaces">Close weapon mastery</Pair>
...
<Ability id="phytological-anatomy-su" icon={["stairs-goal","armor-upgrade"]}>
<Pair single id="phytological-anatomy-su">Phytological Anatomy (Su)</Pair>
...
<Ability id="hunters-tricks" icon={["stairs-goal"]}>
<Pair single id="hunters-tricks">Hunter's Tricks</Pair>
<Pair hl title="Replaces">Close weapon mastery</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="maneuver-training-ex" icon={["stairs-goal"]}>
...
<Ability id="wild-tricks-ex" icon={["stairs-goal"]}>
<Pair single id="wild-tricks-ex" flavor="The wild child has learned a number of tricks to aid his allies and his animal companion, as well as to hinder his opponents.">Wild Tricks (Ex)</Pair>
...
<Ability id="school-focus-ex" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="school-focus-ex">School Focus (Ex)</Pair>
...
<Ability id="mystery-of-unblinking-flame-su" extraClasses="subAbility" icon={["upgrade","mailed-fist","armor-upgrade"]}>
<Pair single id="mystery-of-unblinking-flame-su">Mystery of Unblinking Flame (Su)</Pair>
...
<Ability id="mystery-of-unfolding-wind-su" extraClasses="subAbility" icon={["upgrade","stairs-goal"]}>
<Pair single id="mystery-of-unfolding-wind-su">Mystery of Unfolding Wind (Su)</Pair>
...
<Ability id="mystery-of-untwisting-iron-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="mystery-of-untwisting-iron-su">Mystery of Untwisting Iron (Su)</Pair>
...
<Ability id="monk-moves-ex" icon={["stairs-goal"]}>
<Pair single id="monk-moves-ex">Monk Moves (Ex)</Pair>
<Pair hl title="Replaces">AC bonus</Pair>
<Pair title="Gained">At 4th Level</Pair>
