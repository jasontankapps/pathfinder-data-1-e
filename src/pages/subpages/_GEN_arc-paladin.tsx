...
<Ability id="banishing-smite-su" icon={["magic-swirl"]}>
<Pair single id="banishing-smite-su">Banishing Smite (Su)</Pair>
...
<Ability id="smiting-aura-su" icon={["stairs-goal"]}>
<Pair single id="smiting-aura-su">Smiting Aura (Su)</Pair>
...
<Pair single id="swiftsurge-ex">Swiftsurge (Ex)</Pair>
...
<Ability id="flowing-stride-su" icon={["stairs-goal"]}>
<Pair single id="flowing-stride-su">Flowing Stride (Su)</Pair>
...
<Ability id="rising-tide-su" icon={["magic-swirl"]}>
<Pair single id="rising-tide-su" flavor="A champion of the cascade's connection to her deity allows her to summon rivers and alter her surroundings">Rising Tide (Su)</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-paladin-chaos_knight--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td><Link to="/race/ganzi">Ganzi</Link></td></tr></tbody></table></ScrollContainer></div><Ability id="entropic-touch-su" icon={["shield-reflect","armor-upgrade"]}>
<Pair single id="entropic-touch-su" flavor="A chaos knight can employ the forces of entropy with a touch to shatter a mind-affecting spell or effect currently affecting an ally.">Entropic Touch (Su)</Pair>
...
<Ability id="aura-of-chaos-su" icon={["upgrade","armor-downgrade"]}>
...
<Ability id="bondless" icon={["broken-shield"]}>
<Pair single id="bondless">Bondless</Pair>
<Pair title="Info">A chosen one does not gain the <em>divine bond</em> class feature.</Pair>
</Ability>
<Ability id="divine-emissary-ex" icon={["stairs-goal"]}>
<Pair single id="divine-emissary-ex">Divine Emissary (Ex)</Pair>
...
<Ability id="religious-mentor-ex" icon={["upgrade","broken-shield","skills"]}>
<Pair single id="religious-mentor-ex" flavor={<>The <Link to="/sidekick/familiar">familiar's</Link> sworn duty is to help train the chosen one for her future glory.</>}>Religious Mentor (Ex)</Pair>
...
<Ability id="delayed-grace-su" icon={["info","broken-shield"]}>
<Pair single id="delayed-grace-su" flavor="A chosen one begins her adventuring career without fully understanding her true potential.">Delayed Grace (Su)</Pair>
...
<Ability id="lay-on-paws-su" icon={["stairs-goal"]}>
<Pair single id="lay-on-paws-su" flavor="A chosen one's familiar is able to borrow some of her divine energy to heal itself and others.">Lay on Paws (Su)</Pair>
...
<Ability id="true-form-ex" icon={["magic-swirl"]}>
...
<Ability id="emissarys-smite-su" icon={["upgrade"]}>
<Pair single id="emissarys-smite-su">Emissary's Smite (Su)</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="careful-healer-ex" icon={["armor-upgrade"]}>
<Pair single id="careful-healer-ex">Careful Healer (Ex)</Pair>
...
<Ability id="dress-wounds-su" icon={["remedy"]}>
<Pair single id="dress-wounds-su">Dress Wounds (Su)</Pair>
...
<Ability id="swift-healer-ex" icon={["upgrade"]}>
<Pair single id="swift-healer-ex">Swift Healer (Ex)</Pair>
<Pair hl title="Replaces">Divine health</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="shared-defense-su" icon={["shield-reflect"]}>
<Pair single id="shared-defense-su">Shared Defense (Su)</Pair>
<Pair hl title="Replaces">Mercy</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="divine-bond-su" icon={["armor-upgrade","hazard-sign"]}>
<Pair single id="divine-bond-su" flavor={<>Instead of forming a <em>divine bond</em> with her weapon or a mount, a divine defender can form a bond with her armor.</>}>Divine Bond (Su)</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="martial-focus" icon={["broken-shield"]}>
<Pair single id="martial-focus">Martial Focus</Pair>
...
<Ability id="divine-troth-sp" icon={["shield-reflect","magic-swirl"]}>
<Pair single id="divine-troth-sp">Divine Troth (Sp)</Pair>
<Pair hl title="Replaces">Detect evil</Pair>
...
<Ability id="guarding-hands-su" icon={["info","broken-shield"]}>
<Pair single id="guarding-hands-su">Guarding Hands (Su)</Pair>
...
<Ability id="courageous-defense-ex" icon={["shield-reflect","broken-shield"]}>
<Pair single id="courageous-defense-ex">Courageous Defense (Ex)</Pair>
...
<Ability id="precise-shot" icon={["stairs-goal"]}>
<Pair single id="precise-shot">Precise Shot</Pair>
...
<Ability id="shared-precision-su" icon={["upgrade"]}>
<Pair single id="shared-precision-su">Shared Precision (Su)</Pair>
...
<Ability id="divine-bond-su" icon={["upgrade"]}>
...
<Ability id="distant-mercy-sp" icon={["remedy"]}>
<Pair single id="distant-mercy-sp">Distant Mercy (Sp)</Pair>
...
<Ability id="aura-of-care-su" icon={["upgrade"]}>
<Pair single id="aura-of-care-su">Aura of Care (Su)</Pair>
...
<Ability id="hunters-blessing-su" icon={["stairs-goal"]}>
<Pair single id="hunters-blessing-su">Hunter's Blessing (Su)</Pair>
...
<Ability id="righteous-hunter-su" icon={["armor-downgrade"]}>
<Pair single id="righteous-hunter-su">Righteous Hunter (Su)</Pair>
...
<Pair single id="shadow-smite-su">Shadow Smite (Su)</Pair>
<Pair hl title="Alters">Smite evil</Pair>
...
<Ability id="illuminating-zeal-su" icon={["stairs-goal"]}>
<Pair single id="illuminating-zeal-su" flavor="A dusk knight gains the ability to grant darkvision to her allies.">Illuminating Zeal (Su)</Pair>
...
<Ability id="shadows-embrace-su" icon={["stairs-goal"]}>
<Pair single id="shadows-embrace-su" flavor="A dusk knight learns to fight effectively in areas of darkness.">Shadow's Embrace (Su)</Pair>
<Pair hl title="Replaces">Divine bond</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="cloak-of-shadow-su" icon={["upgrade"]}>
<Pair single id="cloak-of-shadow-su" flavor="A dusk knight becomes adept at moving through darkness.">Cloak of Shadow (Su)</Pair>
<Pair hl title="Replaces">Aura of resolve</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="clouding-smite-su" icon={["armor-downgrade"]}>
<Pair single id="clouding-smite-su" flavor="A dusk knight's smite impairs her foe's abilities in the dark.">Clouding Smite (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="voices-of-the-spheres" icon={["stairs-goal"]}>
<Pair single id="voices-of-the-spheres">Voices of the Spheres</Pair>
<Pair hl title="Replaces">Divine grace</Pair>
<Pair title="Gained">At 2nd Level</Pair>
<Pair title="Ability">An empyreal knight learns to speak and read Celestial, if she could not already.</Pair>
</Ability>
<Ability id="celestial-heart-su" icon={["armor-upgrade","stairs-goal","shield-reflect"]}>
<Pair single id="celestial-heart-su" flavor={<>As an empyreal knight advances, her ties with the celestial realms grant her a portion of the abilities and defenses of true <Link to="/family/angel">angels</Link>.</>}>Celestial Heart (Su)</Pair>
<Pair hl title="Replaces">Mercy</Pair>
...
<Ability id="celestial-ally-sp" icon={["magic-swirl"]}>
<Pair single id="celestial-ally-sp">Celestial Ally (Sp)</Pair>
...
<Ability id="divine-bond-su" icon={["stairs-goal"]}>
<Pair single id="divine-bond-su">Divine Bond (Su)</Pair>
...
<Ability id="empyreal-champion" icon={["armor-upgrade","stairs-goal"]}>
<Pair single id="empyreal-champion">Empyreal Champion</Pair>
...
<Pair single id="wanderers-lore" flavor="A faithful wanderer quickly learns that everything in the wastes is evil, and she develops the skills she needs to survive.">Wanderer's Lore</Pair>
<Pair hl title="Replaces">Detect evil</Pair>
...
<Ability id="hidden-aura-su" icon={["info","stairs-goal","armor-upgrade"]}>
<Pair single id="hidden-aura-su">Hidden Aura (Su)</Pair>
...
<Ability id="stalk-evil-su" icon={["upgrade"]}>
<Pair single id="stalk-evil-su">Stalk Evil (Su)</Pair>
...
<Ability id="champions-bond-su" icon={["info","armor-upgrade","magic-swirl"]}>
<Pair single id="champions-bond-su">Champion's Bond (Su)</Pair>
<Pair hl title="Replaces">Holy champion</Pair>
<Pair hl title="Alters">Divine bond</Pair>
...
<Ability id="sacred-botany-ex" icon={["spell-book"]}>
<Pair single id="sacred-botany-ex">Sacred Botany (Ex)</Pair>
<Pair hl title="Replaces">Channel positive energy</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="fireproof-aura-su" icon={["armor-upgrade","shield-reflect"]}>
<Pair single id="fireproof-aura-su">Fireproof Aura (Su)</Pair>
<Pair hl title="Replaces">Aura of resolve</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="sacred-grove-su" icon={["magic-swirl"]}>
<Pair single id="sacred-grove-su">Sacred Grove (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="aura-of-preservation-su" icon={["shield-reflect"]}>
<Pair single id="aura-of-preservation-su">Aura of Preservation (Su)</Pair>
<Pair hl title="Replaces">Aura of faith</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-paladin-forgefathers_seeker--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Must select <Link to="/faith/torag">Torag</Link> as her patron deity.</td></tr></tbody></table></ScrollContainer></div><Ability id="detect-construct-sp" icon={["stairs-goal"]}>
<Pair single id="detect-construct-sp">Detect Construct (Sp)</Pair>
<Pair hl title="Replaces">Detect evil</Pair>
...
<Ability id="smite-construct-su" icon={["broken-shield","upgrade"]}>
<Pair single id="smite-construct-su">Smite Construct (Su)</Pair>
<Pair hl title="Alters">Smite evil</Pair>
...
<Ability id="aura-of-destruction-su" icon={["stairs-goal"]}>
<Pair single id="aura-of-destruction-su">Aura of Destruction (Su)</Pair>
<Pair hl title="Alters">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="aura-of-unmaking-su" icon={["armor-downgrade"]}>
<Pair single id="aura-of-unmaking-su">Aura of Unmaking (Su)</Pair>
<Pair hl title="Replaces">Aura of faith</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="forgefathers-champion-su" icon={["armor-upgrade","remedy","stairs-goal"]}>
<Pair single id="forgefathers-champion-su" flavor="A Forgefather's seeker becomes capable of completely dismantling constructs.">Forgefather's Champion (Su)</Pair>
<Pair hl title="Replaces">Holy champion</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="ghostly-smite-su" icon={["broken-shield","upgrade"]}>
<Pair single id="ghostly-smite-su">Ghostly Smite (Su)</Pair>
<Pair hl title="Alters">Smite evil</Pair>
...
<Ability id="exorcise-possession-su" icon={["magic-swirl","remedy"]}>
<Pair single id="exorcise-possession-su">Exorcise Possession (Su)</Pair>
<Pair hl title="Replaces">6th-level mercy</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="speak-to-the-restless-sp" icon={["magic-swirl"]}>
<Pair single id="speak-to-the-restless-sp">Speak to the Restless (Sp)</Pair>
...
<Ability id="code-of-conduct" icon={["hazard-sign"]}>
<Pair single id="code-of-conduct">Code of Conduct</Pair>
...
<Ability id="enhanced-health-ex" icon={["armor-upgrade"]}>
<Pair single id="enhanced-health-ex">Enhanced Health (Ex)</Pair>
<Pair hl title="Replaces">Divine health</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="smite-foe-su" icon={["stairs-goal"]}>
<Pair single id="smite-foe-su">Smite Foe (Su)</Pair>
<Pair hl title="Replaces">Channel positive energy</Pair>
<Pair hl title="Alters">Smite evil</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="aura-of-subtlety-sp-su" icon={["armor-upgrade","shield-reflect"]}>
<Pair single id="aura-of-subtlety-sp-su">Aura of Subtlety (Sp, Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="teamwork-feat-ex" icon={["stairs-goal"]}>
<Pair single id="teamwork-feat-ex">Teamwork Feat (Ex)</Pair>
<Pair hl title="Replaces">6th-level mercy</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="have-gun" icon={["stairs-goal","bowman"]}>
<Pair single id="have-gun">Have Gun</Pair>
<Pair hl title="Replaces">Detect evil</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="divine-deed" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="divine-deed">Divine Deed</Pair>
<Pair hl title="Replaces">Smite evil</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="smiting-shot-su" extraClasses="subAbility" icon={["bowman"]}>
<Pair single id="smiting-shot-su">Smiting Shot (Su)</Pair>
...
<Ability id="divine-bond" icon={["stairs-goal"]}>
<Pair single id="divine-bond">Divine Bond</Pair>
<Pair hl title="Replaces">Divine bond</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="holy-grit-ex" icon={["stairs-goal"]}>
<Pair single id="holy-grit-ex">Holy Grit (Ex)</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="holy-slinger-ex" icon={["info"]}>
<Pair single id="holy-slinger-ex">Holy Slinger (Ex)</Pair>
...
<Ability id="tactical-acumen-ex" icon={["stairs-goal"]}>
<Pair single id="tactical-acumen-ex">Tactical Acumen (Ex)</Pair>
...
<Ability id="battlefield-presence-su" icon={["stairs-goal"]}>
<Pair single id="battlefield-presence-su">Battlefield Presence (Su)</Pair>
<Pair hl title="Replaces">Aura of courage</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="guide-the-battle-ex" icon={["stairs-goal"]}>
<Pair single id="guide-the-battle-ex">Guide the Battle (Ex)</Pair>
<Pair hl title="Replaces">Aura of resolve</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="weals-wrath-su" icon={["upgrade"]}>
<Pair single id="weals-wrath-su">Weal's Wrath (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="masterful-presence-su" icon={["stairs-goal","upgrade"]}>
<Pair single id="masterful-presence-su">Masterful Presence (Su)</Pair>
<Pair hl title="Replaces">Holy champion</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="smite-evil-su" icon={["broken-shield"]}>
<Pair single id="smite-evil-su">Smite Evil (Su)</Pair>
<Pair hl title="Alters">Smite evil</Pair>
...
<Ability id="channel-positive-energy-su" icon={["aura"]}>
...
<Ability id="aura-of-healing-su" icon={["aura","remedy"]}>
<Pair single id="aura-of-healing-su">Aura of Healing (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="hunt-evil-su" icon={["upgrade","stairs-goal","rolling-dices","armor-upgrade","hazard-sign"]}>
<Pair single id="hunt-evil-su">Hunt Evil (Su)</Pair>
...
<Ability id="detect-evil-su" icon={["broken-shield","magic-swirl"]}>
<Pair single id="detect-evil-su">Detect Evil (Su)</Pair>
...
<Ability id="tireless-aura-su" icon={["armor-upgrade","shield-reflect"]}>
<Pair single id="tireless-aura-su">Tireless Aura (Su)</Pair>
<Pair hl title="Replaces">Aura of resolve</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="holy-fount-su" icon={["remedy","aura"]}>
<Pair single id="holy-fount-su">Holy Fount (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="champion-of-life-sp" icon={["magic-swirl","upgrade"]}>
<Pair single id="champion-of-life-sp" flavor="An invigorator's holy resolve can sometimes overcome death - or smite the horror that is undeath.">Champion of Life (Sp)</Pair>
<Pair hl title="Replaces">Holy champion</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="smite-chaos-su" icon={["info","upgrade"]}>
...
<Ability id="aura-of-order" icon={["armor-downgrade","aura"]}>
<Pair single id="aura-of-order">Aura of Order</Pair>
...
<Ability id="armor-of-law-su" icon={["info"]}>
<Pair single id="armor-of-law-su">Armor of Law (Su)</Pair>
...
<Ability id="aura-of-law-su" icon={["info"]}>
<Pair single id="aura-of-law-su">Aura of Law (Su)</Pair>
...
<Ability id="sense-perfection-su" icon={["magic-swirl"]}>
<Pair single id="sense-perfection-su">Sense Perfection (Su)</Pair>
<Pair hl title="Replaces">Detect evil</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="personal-trial-su" icon={["upgrade"]}>
...
<Ability id="aura-of-excellence-su" icon={["armor-upgrade","shield-reflect","rolling-dices"]}>
<Pair single id="aura-of-excellence-su">Aura of Excellence (Su)</Pair>
<Pair hl title="Replaces">Aura of courage</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="ki-pool-su" icon={["magic-swirl","armor-downgrade"]}>
...
<Ability id="divine-body-su" icon={["info"]}>
<Pair single id="divine-body-su">Divine Body (Su)</Pair>
<Pair hl title="Replaces">Divine bond</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="aura-of-perfection-su" icon={["rolling-dices"]}>
<Pair single id="aura-of-perfection-su">Aura of Perfection (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="eye-for-forgeries-sp" icon={["magic-swirl"]}>
<Pair single id="eye-for-forgeries-sp">Eye for Forgeries (Sp)</Pair>
<Pair hl title="Replaces">Detect evil</Pair>
...
<Ability id="blessing-of-prosperity-su" extraClasses="hasSubs" icon={["upgrade"]}>
<Pair single id="blessing-of-prosperity-su" flavor="A knight of coins is a patron of wealth and seeks to even the playing field for those who have unfair economic disadvantages.">Blessing of Prosperity (Su)</Pair>
...
<Ability id="wealth" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="wealth">Wealth</Pair>
...
<Ability id="insight" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="insight">Insight</Pair>
<Pair title="Passive Ability">The target gains a +4 sacred bonus on Appraise and Sense Motive checks.</Pair>
</Ability>
<Ability id="seeing" extraClasses="subAbility" icon={["upgrade","armor-upgrade"]}>
<Pair single id="seeing">Seeing</Pair>
...
<Ability id="work" extraClasses="subAbility" icon={["upgrade"]}>
...
<Ability id="seeking" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="seeking">Seeking</Pair>
...
<Ability id="quality" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="quality">Quality</Pair>
...
<Ability id="variety" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="variety">Variety</Pair>
...
<Ability id="smite-deepest-evil-su" icon={["broken-shield","stairs-goal"]}>
<Pair single id="smite-deepest-evil-su">Smite Deepest Evil (Su)</Pair>
<Pair hl title="Alters">Smite evil</Pair>
...
<Ability id="divine-immunity-ex" icon={["armor-upgrade"]}>
<Pair single id="divine-immunity-ex">Divine Immunity (Ex)</Pair>
<Pair hl title="Replaces">Divine health</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="divine-bond-sp" icon={["info"]}>
...
<Ability id="aura-of-elusion-su" icon={["upgrade","armor-upgrade","shield-reflect"]}>
<Pair single id="aura-of-elusion-su">Aura of Elusion (Su)</Pair>
<Pair hl title="Replaces">Aura of faith</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Ability id="celestial-armor-sp" icon={["magic-swirl","armor-upgrade"]}>
<Pair single id="celestial-armor-sp">Celestial Armor (Sp)</Pair>
<Pair hl title="Replaces">Mercy</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="stigmata" icon={["broken-shield","upgrade"]}>
<Pair single id="stigmata">Stigmata</Pair>
<Pair hl title="Replaces">Smite evil</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="see-no-evil-hear-no-evil-su" icon={["armor-upgrade"]}>
<Pair single id="see-no-evil-hear-no-evil-su">See No Evil, Hear No Evil (Su)</Pair>
<Pair hl title="Replaces">Divine grace</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="aura-mastery-su" icon={["upgrade","broken-shield"]}>
<Pair single id="aura-mastery-su">Aura Mastery (Su)</Pair>
...
<Ability id="aura-of-health-su" icon={["armor-upgrade","shield-reflect"]}>
<Pair single id="aura-of-health-su">Aura of Health (Su)</Pair>
<Pair hl title="Replaces">Divine health</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="martyrs-mercy-su" icon={["upgrade","broken-shield"]}>
<Pair single id="martyrs-mercy-su">Martyr's Mercy (Su)</Pair>
...
<Ability id="mind-arsenal-su" icon={["bowman"]}>
<Pair single id="mind-arsenal-su">Mind Arsenal (Su)</Pair>
<Pair hl title="Replaces">Lay on hands</Pair>
...
<Ability id="touch-treatment-su" extraClasses="hasSubs" icon={["remedy"]}>
...
<Ability id="aquatic-domain-su" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="aquatic-domain-su">Aquatic Domain (Su)</Pair>
...
<Ability id="sealord-su" extraClasses="subAbility" icon={["aura","remedy"]}>
<Pair single id="sealord-su" flavor="From the Aquatic domain">Sealord (Su)</Pair>
...
<Ability id="seastrike-su" extraClasses="subAbility" icon={["stairs-goal","bowman"]}>
<Pair single id="seastrike-su" flavor="From the Aquatic domain">Seastrike (Su)</Pair>
...
<Ability id="vision-magic" icon={["spell-book","magic-swirl"]}>
<Pair single id="vision-magic">Vision Magic</Pair>
<Pair hl title="Alters">Spells</Pair>
...
<Ability id="monstrous-rapport-ex" icon={["upgrade"]}>
<Pair single id="monstrous-rapport-ex">Monstrous Rapport (Ex)</Pair>
<Pair hl title="Replaces">Detect evil</Pair>
<Pair title="Gained">At 1st Level</Pair>
...
<Ability id="pact-of-peace-sp" icon={["magic-swirl"]}>
<Pair single id="pact-of-peace-sp">Pact of Peace (Sp)</Pair>
<Pair hl title="Replaces">Aura of resolve</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="aura-of-mercy-su" icon={["stairs-goal"]}>
<Pair single id="aura-of-mercy-su">Aura of Mercy (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="associates" icon={["info"]}>
<Pair single id="associates">Associates</Pair>
...
<Ability id="call-celestial-ally-sp" icon={["magic-swirl"]}>
<Pair single id="call-celestial-ally-sp">Call Celestial Ally (Sp)</Pair>
<Pair hl title="Replaces">Aura of resolve</Pair>
...
<Ability id="bastion-of-good-su" icon={["shield-reflect","armor-upgrade"]}>
...
<Ability id="holy-shield-su" icon={["shield-reflect"]}>
<Pair single id="holy-shield-su">Holy Shield (Su)</Pair>
<Pair hl title="Replaces">Channel positive energy</Pair>
...
<Ability id="divine-bond-su" icon={["armor-upgrade","hazard-sign"]}>
<Pair single id="divine-bond-su" flavor={<>Instead of forming a <em>divine bond</em> with her weapon or a mount, a sacred shield forms a bond with her shield.</>}>Divine Bond (Su)</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="improved-bastion" icon={["aura"]}>
<Pair single id="improved-bastion">Improved Bastion</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
<Pair title="Ability">The radius of a sacred shield's <em>bastion of good</em> ability increases to 20 feet.</Pair>
</Ability>
<Ability id="perfect-bastion" icon={["remedy"]}>
<Pair single id="perfect-bastion">Perfect Bastion</Pair>
<Pair hl title="Replaces">Holy champion</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Pair single id="scions-faith-ex">Scion's Faith (Ex)</Pair>
<Pair title="Info">A scion of Talmandor must worship a lawful good deity.</Pair>
</Ability>
<Ability id="egalitarian-su" icon={["broken-shield","shield-reflect"]}>
<Pair single id="egalitarian-su">Egalitarian (Su)</Pair>
...
<Ability id="bonded-eagle-sp" icon={["stairs-goal"]}>
<Pair single id="bonded-eagle-sp">Bonded Eagle (Sp)</Pair>
<Pair hl title="Replaces">Divine bond</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="consensus-ex" icon={["shield-reflect"]}>
<Pair single id="consensus-ex">Consensus (Ex)</Pair>
<Pair hl title="Replaces">Aura of resolve</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="talmandors-gift-sp" icon={["magic-swirl"]}>
<Pair single id="talmandors-gift-sp">Talmandor's Gift (Sp)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="skilled-rider-ex-and-su" icon={["upgrade"]}>
<Pair single id="skilled-rider-ex-and-su">Skilled Rider (Ex and Su)</Pair>
<Pair hl title="Replaces">Divine health</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="divine-bond-su" icon={["info"]}>
<Pair single id="divine-bond-su">Divine Bond (Su)</Pair>
<Pair hl title="Alters">Divine bond</Pair>
...
<Ability id="knights-charge-su" icon={["armor-upgrade","shield-reflect","armor-downgrade"]}>
<Pair single id="knights-charge-su">Knight's Charge (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="dragon-magic" extraClasses="hasSubs" icon={["spell-book","broken-shield"]}>
<Pair single id="dragon-magic">Dragon Magic</Pair>
...
<Ability id="reprieve-su" icon={["remedy"]}>
<Pair single id="reprieve-su" flavor="A soul sentinel relieves manic and tortured souls exposed to the harsh evil of the world.">Reprieve (Su)</Pair>
<Pair hl title="Replaces">6th-level mercy</Pair>
...
<Ability id="sacred-soul-su" icon={["armor-upgrade","shield-reflect"]}>
<Pair single id="sacred-soul-su">Sacred Soul (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="greater-reprieve-su" icon={["remedy"]}>
<Pair single id="greater-reprieve-su" flavor="The soul sentinel suppresses the stain of corruption on the spirits of those she heals.">Greater Reprieve (Su)</Pair>
...
<Ability id="heartstone-ex" icon={["armor-upgrade"]}>
...
<Ability id="stoneblood-ex" icon={["armor-upgrade"]}>
<Pair single id="stoneblood-ex">Stoneblood (Ex)</Pair>
...
<Ability id="defensive-stance-ex" icon={["armor-upgrade"]}>
<Pair single id="defensive-stance-ex">Defensive Stance (Ex)</Pair>
...
<Ability id="earth-channel-su" icon={["stairs-goal"]}>
<Pair single id="earth-channel-su">Earth Channel (Su)</Pair>
<Pair hl title="Replaces">Channel positive energy</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="stone-servant-su" icon={["magic-swirl"]}>
<Pair single id="stone-servant-su">Stone Servant (Su)</Pair>
<Pair hl title="Replaces">Divine bond</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="stonebane-su" icon={["upgrade"]}>
<Pair single id="stonebane-su">Stonebane (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="phase-strike-su" icon={["armor-downgrade"]}>
<Pair single id="phase-strike-su" flavor={<>A stonelord's <em>stonestrike</em> may pass through stone and metal as if they weren't there.</>}>Phase Strike (Su)</Pair>
<Pair hl title="Replaces">12th-level mercy</Pair>
...
<Ability id="mobile-defense-ex" icon={["stairs-goal"]}>
<Pair single id="mobile-defense-ex">Mobile Defense (Ex)</Pair>
...
<Ability id="stone-body-ex" icon={["stairs-goal","armor-upgrade"]}>
<Pair single id="stone-body-ex">Stone Body (Ex)</Pair>
<Pair hl title="Replaces">Holy champion</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-paladin-sword_of_valor--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Must have <Link to="/faith/iomedae">Iomedae</Link> as a patron deity</td></tr></tbody></table></ScrollContainer></div><Ability id="first-into-battle-su" icon={["stairs-goal","upgrade"]}>
<Pair single id="first-into-battle-su">First Into Battle (Su)</Pair>
<Pair hl title="Replaces">Divine grace</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="prayer-of-the-fourth-act-su" icon={["remedy"]}>
<Pair single id="prayer-of-the-fourth-act-su">Prayer of the Fourth Act (Su)</Pair>
<Pair hl title="Replaces">6th-level mercy</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="worthy-enemy-su" icon={["armor-downgrade"]}>
<Pair single id="worthy-enemy-su">Worthy Enemy (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="divine-weapon-specialization-ex" extraClasses="hasSubs" icon={["stairs-goal","upgrade"]}>
<Pair single id="divine-weapon-specialization-ex">Divine Weapon Specialization (Ex)</Pair>
...
<Ability id="divine-bond-su" icon={["broken-shield","stairs-goal"]}>
<Pair single id="divine-bond-su">Divine Bond (Su)</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="spells" icon={["broken-shield"]}>
<Pair single id="spells">Spells</Pair>
...
<Ability id="domain-granted-power" icon={["stairs-goal"]}>
<Pair single id="domain-granted-power">Domain Granted Power</Pair>
...
<Ability id="blessing-su" icon={["stairs-goal"]}>
<Pair single id="blessing-su">Blessing (Su)</Pair>
...
<Ability id="torment" icon={["info"]}>
<Pair single id="torment" flavor="A tortured crusader's great suffering in the face of inevitable horror strengthens her faith and resolve, even as it makes her introverted and far less personable than most paladins.">Torment</Pair>
...
<Pair single id="self-sufficient">Self-Sufficient</Pair>
...
<Ability id="all-is-darkness" icon={["broken-shield"]}>
<Pair single id="all-is-darkness" flavor="Everything around a tortured crusader is so bleak that detecting evil only reminds her that the odds are always against her.">All is Darkness</Pair>
...
<Ability id="alone-in-the-dark" icon={["broken-shield","stairs-goal"]}>
<Pair single id="alone-in-the-dark" flavor="Faced with endless foes, a tortured crusader can't ask others to confront the same horrors she does.">Alone in the Dark</Pair>
...
<Ability id="second-chance-su" icon={["stairs-goal"]}>
<Pair single id="second-chance-su">Second Chance (Su)</Pair>
<Pair hl title="Alters">Lay on hands, mercy</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="last-stand-su" icon={["stairs-goal"]}>
<Pair single id="last-stand-su">Last Stand (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="serene-strike-su" icon={["stairs-goal"]}>
<Pair single id="serene-strike-su">Serene Strike (Su)</Pair>
<Pair hl title="Replaces">Aura of courage</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="divine-bond-su" icon={["broken-shield"]}>
<Pair single id="divine-bond-su">Divine Bond (Su)</Pair>
...
<Ability id="aura-of-calm-su" icon={["armor-upgrade","shield-reflect"]}>
<Pair single id="aura-of-calm-su">Aura of Calm (Su)</Pair>
<Pair hl title="Replaces">Aura of resolve</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="waves-of-peace-su" icon={["stairs-goal"]}>
<Pair single id="waves-of-peace-su">Waves of Peace (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="apostle-of-peace-su" icon={["armor-upgrade","upgrade"]}>
<Pair single id="apostle-of-peace-su">Apostle of Peace (Su)</Pair>
<Pair hl title="Replaces">Holy champion</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="aura-of-life-su" icon={["aura","armor-downgrade"]}>
...
<Ability id="undead-annihilation-su" icon={["mailed-fist"]}>
<Pair single id="undead-annihilation-su">Undead Annihilation (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="no-aura" icon={["info"]}>
<Pair single id="no-aura">No Aura</Pair>
<Pair hl title="Alters">Aura</Pair>
<Pair title="Info">A vindictive bastard does not radiate an alignment aura.</Pair>
</Ability>
<Ability id="locate-ally-sp" icon={["magic-swirl"]}>
<Pair single id="locate-ally-sp">Locate Ally (Sp)</Pair>
<Pair hl title="Replaces">Detect evil</Pair>
...
<Ability id="vindictive-smite-ex" icon={["upgrade","armor-upgrade"]}>
<Pair single id="vindictive-smite-ex" flavor="A vindictive bastard is particularly ruthless against those who have harmed her or her allies.">Vindictive Smite (Ex)</Pair>
<Pair hl title="Replaces">Smite evil</Pair>
<Pair title="Usage">1 time/day + 1 per three paladin levels beyond 1st<ByLevelPop levels={[[1,1],[4,2],[7,3],[10,4],[13,5],[16,6],[19,7]]} unit="time" postText="/day" /></Pair>
...
<Ability id="faded-grace-ex" icon={["stairs-goal","armor-upgrade"]}>
<Pair single id="faded-grace-ex">Faded Grace (Ex)</Pair>
<Pair hl title="Replaces">Divine grace</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="solo-tactics-ex" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="solo-tactics-ex">Solo Tactics (Ex)</Pair>
<Pair hl title="Replaces">Lay on hands</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="solo-tactics-ex" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="solo-tactics-ex" flavor="Text from the inquisitor ability.">Solo Tactics (Ex)</Pair>
...
<Ability id="spiteful-tenacity-ex" icon={["upgrade"]}>
<Pair single id="spiteful-tenacity-ex">Spiteful Tenacity (Ex)</Pair>
<Pair hl title="Replaces">Divine health</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="teamwork-feat" icon={["stairs-goal"]}>
<Pair single id="teamwork-feat">Teamwork Feat</Pair>
...
<Ability id="gang-up-ex" icon={["upgrade"]}>
<Pair single id="gang-up-ex" flavor="A vindictive bastard forms a close bond with her companions.">Gang Up (Ex)</Pair>
<Pair hl title="Replaces">Divine bond</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="swift-justice-ex" icon={["upgrade"]}>
<Pair single id="swift-justice-ex">Swift Justice (Ex)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="stalwart-ex" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="stalwart-ex">Stalwart (Ex)</Pair>
<Pair hl title="Replaces">Aura of faith</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Pair single id="stalwart-ex" flavor="Relevant text from the inquisitor ability.">Stalwart (Ex)</Pair>
...
<Ability id="aura-of-self-righteousness-ex" icon={["armor-upgrade","shield-reflect"]}>
<Pair single id="aura-of-self-righteousness-ex">Aura of Self-Righteousness (Ex)</Pair>
<Pair hl title="Replaces">Aura of righteousness</Pair>
...
<Ability id="ultimate-vindication-ex" icon={["magic-swirl"]}>
<Pair single id="ultimate-vindication-ex">Ultimate Vindication (Ex)</Pair>
<Pair hl title="Replaces">Holy champion</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="bravos-finesse-ex" icon={["upgrade"]}>
<Pair single id="bravos-finesse-ex">Bravo's Finesse (Ex)</Pair>
...
<Ability id="bravos-smite-su" icon={["broken-shield"]}>
<Pair single id="bravos-smite-su">Bravo's Smite (Su)</Pair>
<Pair hl title="Alters">Smite evil</Pair>
...
<Ability id="panache-and-deeds-ex" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="panache-and-deeds-ex">Panache and Deeds (Ex)</Pair>
<Pair hl title="Replaces">Spellcasting</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="advanced-deeds-ex" icon={["stairs-goal"]}>
<Pair single id="advanced-deeds-ex">Advanced Deeds (Ex)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
...
<Ability id="bravos-holy-strike-su" icon={["mailed-fist"]}>
<Pair single id="bravos-holy-strike-su" flavor="A virtuous bravo becomes a master at dispensing holy justice with her blade.">Bravo's Holy Strike (Su)</Pair>
<Pair hl title="Replaces">Holy champion</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="power-of-faith-su" icon={["broken-shield","upgrade","armor-upgrade","shield-reflect","remedy"]}>
<Pair single id="power-of-faith-su">Power of Faith (Su)</Pair>
<Pair hl title="Replaces">Spells</Pair>
...
<Ability id="shining-light-su" icon={["aura","armor-downgrade","remedy"]}>
<Pair single id="shining-light-su">Shining Light (Su)</Pair>
<Pair hl title="Replaces">Aura of faith</Pair>
<Pair title="Gained">At 14th Level</Pair>
...
<Pair single id="natural-defense-su">Natural Defense (Su)</Pair>
<Pair hl title="Replaces">Divine grace</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="aura-of-comfort-ex" icon={["armor-upgrade","shield-reflect"]}>
<Pair single id="aura-of-comfort-ex">Aura of Comfort (Ex)</Pair>
<Pair hl title="Replaces">Aura of courage</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="aura-of-purity-su" icon={["armor-upgrade","shield-reflect"]}>
...
<Ability id="natural-shield-su" icon={["shield-reflect"]}>
<Pair single id="natural-shield-su">Natural Shield (Su)</Pair>
<Pair hl title="Replaces">Aura of justice</Pair>
<Pair title="Gained">At 11th Level</Pair>
