...
<Ability id="smite-evil-su" icon={["down","boost"]}>
...
<Ability id="banishing-smite-su" icon={["magic"]}>
...
<Ability id="smiting-aura-su" icon={["power"]}>
...
<Pair title="Removed Skills">Knowledge (nobility)</Pair></Ability>
<Ability id="swiftsurge-ex" icon={["boost"]}>
...
<Ability id="flowing-stride-su" icon={["power"]}>
...
<Ability id="rising-tide-su" icon={["magic"]}>
...
<Ability id="blessings-of-the-maelstrom-su" icon={["protect","def","boost"]}>
...
<Ability id="aura-of-chaos-su" icon={["boost","lower"]}>
...
<Ability id="religious-mentor-ex" icon={["boost","down","skill"]}>
...
<Ability id="delayed-grace-su" icon={["info","down"]}>
...
<Ability id="lay-on-paws-su" icon={["power"]}>
...
<Ability id="true-form-ex" icon={["magic"]}>
...
<Ability id="emissarys-smite-su" icon={["boost"]}>
...
<Ability id="careful-healer-ex" icon={["def"]}>
...
<Ability id="dress-wounds-su" icon={["aid"]}>
...
<Ability id="swift-healer-ex" icon={["boost"]}>
...
<Ability id="shared-defense-su" icon={["protect"]}>
...
<Ability id="divine-bond-su" icon={["def","warning"]}>
...
<Ability id="martial-focus" icon={["down"]}>
...
<Ability id="divine-troth-sp" icon={["protect","magic"]}>
...
<Ability id="guarding-hands-su" icon={["info","down"]}>
...
<Ability id="courageous-defense-ex" icon={["protect","down"]}>
...
<Ability id="precise-shot" icon={["power"]}>
...
<Ability id="shared-precision-su" icon={["boost"]}>
...
<Ability id="divine-bond-su" icon={["boost"]}>
...
<Ability id="distant-mercy-sp" icon={["aid"]}>
...
<Ability id="aura-of-care-su" icon={["boost"]}>
...
<Ability id="hunters-blessing-su" icon={["power"]}>
...
<Ability id="righteous-hunter-su" icon={["lower"]}>
...
<Ability id="shadow-smite-su" icon={["def","down"]}>
...
<Ability id="illuminating-zeal-su" icon={["power"]}>
...
<Ability id="shadows-embrace-su" icon={["power"]}>
...
<Ability id="cloak-of-shadow-su" icon={["boost"]}>
...
<Ability id="clouding-smite-su" icon={["lower"]}>
...
<Ability id="voices-of-the-spheres" icon={["power"]}>
...
<Ability id="celestial-heart-su" icon={["def","power","protect"]}>
...
<Ability id="celestial-ally-sp" icon={["magic"]}>
...
<Ability id="divine-bond-su" icon={["power"]}>
<Pair single id="divine-bond-su">Divine Bond (Su)</Pair>
...
<Ability id="empyreal-champion" icon={["def","power"]}>
...
<Ability id="wanderers-lore" icon={["skill","boost"]}>
...
<Ability id="hidden-aura-su" icon={["info","power","def"]}>
...
<Ability id="stalk-evil-su" icon={["boost"]}>
...
<Ability id="champions-bond-su" icon={["info","def","magic"]}>
...
<Ability id="favored-terrain-ex" icon={["boost"]}>
...
<Ability id="sacred-botany-ex" icon={["learn"]}>
...
<Ability id="fireproof-aura-su" icon={["def","protect"]}>
...
<Ability id="sacred-grove-su" icon={["magic"]}>
...
<Ability id="aura-of-preservation-su" icon={["protect"]}>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-paladin-forgefathers_seeker--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Must select <Link to="/faith/torag">Torag</Link> as her patron deity.</td></tr></tbody></table></ScrollContainer></div><Ability id="detect-construct-sp" icon={["power"]}>
...
<Ability id="smite-construct-su" icon={["down","boost"]}>
...
<Ability id="aura-of-destruction-su" icon={["power"]}>
...
<Ability id="aura-of-unmaking-su" icon={["lower"]}>
...
<Ability id="forgefathers-champion-su" icon={["def","aid","power"]}>
...
<Ability id="ghostly-smite-su" icon={["down","boost"]}>
...
<Ability id="exorcise-possession-su" icon={["magic","aid"]}>
...
<Ability id="speak-to-the-restless-sp" icon={["magic"]}>
...
<Ability id="weakened-grace" icon={["down","info"]}>
...
<Ability id="code-of-conduct" icon={["warning"]}>
...
<Ability id="enhanced-health-ex" icon={["def"]}>
...
<Ability id="smite-foe-su" icon={["power"]}>
...
<Ability id="aura-of-subtlety-sp-su" icon={["def","protect"]}>
...
<Ability id="teamwork-feat-ex" icon={["power"]}>
...
<Ability id="have-gun" icon={["power","ranged"]}>
...
<Ability id="divine-deed" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="smiting-shot-su" extraClasses="subAbility" icon={["ranged"]}>
...
<Ability id="divine-bond" icon={["power"]}>
...
<Ability id="holy-grit-ex" icon={["power"]}>
...
<Ability id="weals-champion-su" icon={["boost"]}>
...
<Ability id="tactical-acumen-ex" icon={["power"]}>
...
<Ability id="battlefield-presence-su" icon={["power"]}>
...
<Ability id="guide-the-battle-ex" icon={["power"]}>
...
<Ability id="weals-wrath-su" icon={["boost"]}>
...
<Ability id="masterful-presence-su" icon={["power","boost"]}>
...
<Ability id="smite-evil-su" icon={["down"]}>
<Pair single id="smite-evil-su">Smite Evil (Su)</Pair>
<Pair hl title="Alters">Smite evil</Pair>
...
<Ability id="aura-of-healing-su" icon={["aura","aid"]}>
...
<Ability id="hunt-evil-su" icon={["boost","power","roll","def","warning"]}>
...
<Ability id="detect-evil-su" icon={["down","magic"]}>
...
<Ability id="tireless-aura-su" icon={["def","protect"]}>
...
<Ability id="bestow-hope-su" icon={["def","protect"]}>
...
<Ability id="holy-fount-su" icon={["aid","aura"]}>
...
<Ability id="champion-of-life-sp" icon={["magic","boost"]}>
...
<Ability id="smite-chaos-su" icon={["info","boost"]}>
...
<Ability id="aura-of-order" icon={["lower","aura"]}>
...
<Ability id="confident-defense-ex" icon={["def"]}>
...
<Ability id="sense-perfection-su" icon={["magic"]}>
...
<Ability id="personal-trial-su" icon={["boost"]}>
...
<Ability id="ki-pool-su" icon={["magic","lower"]}>
...
<Ability id="aura-of-perfection-su" icon={["roll"]}>
...
<Ability id="eye-for-forgeries-sp" icon={["magic"]}>
...
<Ability id="blessing-of-prosperity-su" extraClasses="hasSubs" icon={["boost"]}>
...
<Ability id="wealth" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="insight" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="seeing" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="work" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="seeking" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="quality" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="variety" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="smite-deepest-evil-su" icon={["down","power"]}>
...
<Ability id="divine-immunity-ex" icon={["def"]}>
...
<Ability id="aura-of-elusion-su" icon={["boost","def","protect"]}>
...
<Ability id="celestial-armor-sp" icon={["magic","def"]}>
...
<Ability id="stigmata" icon={["down","boost"]}>
...
<Ability id="see-no-evil-hear-no-evil-su" icon={["def"]}>
...
<Ability id="aura-mastery-su" icon={["boost","down"]}>
...
<Ability id="aura-of-health-su" icon={["def","protect"]}>
...
<Ability id="martyrs-mercy-su" icon={["boost","down"]}>
...
<Ability id="mind-arsenal-su" icon={["ranged"]}>
...
<Ability id="touch-treatment-su" extraClasses="hasSubs" icon={["aid"]}>
...
<Ability id="seek-impressions-ex-sp" icon={["power"]}>
...
<Ability id="aquatic-domain-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="sealord-su" extraClasses="subAbility" icon={["aura","aid"]}>
...
<Ability id="seastrike-su" extraClasses="subAbility" icon={["power","ranged"]}>
...
<Ability id="vision-magic" icon={["learn","magic"]}>
...
<Ability id="monstrous-rapport-ex" icon={["boost"]}>
...
<Ability id="pact-of-peace-sp" icon={["magic"]}>
...
<Ability id="aura-of-mercy-su" icon={["power"]}>
...
<Ability id="divine-bond-su" icon={["boost","warning"]}>
...
<Ability id="call-celestial-ally-sp" icon={["magic"]}>
...
<Ability id="bastion-of-good-su" icon={["protect","def"]}>
...
<Ability id="perfect-bastion" icon={["aid"]}>
...
<Ability id="egalitarian-su" icon={["down","protect"]}>
...
<Ability id="bonded-eagle-sp" icon={["power"]}>
...
<Ability id="consensus-ex" icon={["protect"]}>
...
<Ability id="talmandors-gift-sp" icon={["magic"]}>
...
<Ability id="skilled-rider-ex-and-su" icon={["boost"]}>
...
<Ability id="knights-charge-su" icon={["def","protect","lower"]}>
...
<Ability id="dragon-magic" extraClasses="hasSubs" icon={["learn","down"]}>
...
<Ability id="reprieve-su" icon={["aid"]}>
...
<Ability id="sacred-soul-su" icon={["def","protect"]}>
...
<Ability id="greater-reprieve-su" icon={["aid"]}>
...
<Ability id="stoneblood-ex" icon={["def"]}>
...
<Ability id="defensive-stance-ex" icon={["def"]}>
...
<Ability id="earth-channel-su" icon={["power"]}>
...
<Ability id="stone-servant-su" icon={["magic"]}>
...
<Ability id="stonebane-su" icon={["boost"]}>
...
<Ability id="phase-strike-su" icon={["lower"]}>
...
<Ability id="mobile-defense-ex" icon={["power"]}>
...
<Ability id="stone-body-ex" icon={["power","def"]}>
...
<Ability id="prayer-of-the-fourth-act-su" icon={["aid"]}>
...
<Ability id="worthy-enemy-su" icon={["lower"]}>
...
<Ability id="divine-weapon-specialization-ex" extraClasses="hasSubs" icon={["power","boost"]}>
...
<Ability id="divine-bond-su" icon={["down","power"]}>
<Pair single id="divine-bond-su">Divine Bond (Su)</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="domain-granted-power" icon={["power"]}>
...
<Ability id="blessing-su" icon={["power"]}>
...
<Ability id="self-sufficient" icon={["boost"]}>
...
<Ability id="all-is-darkness" icon={["down"]}>
...
<Ability id="alone-in-the-dark" icon={["down","power"]}>
...
<Ability id="second-chance-su" icon={["power"]}>
...
<Ability id="last-stand-su" icon={["power"]}>
...
<Ability id="serene-strike-su" icon={["power"]}>
...
<Ability id="divine-bond-su" icon={["down"]}>
<Pair single id="divine-bond-su">Divine Bond (Su)</Pair>
...
<Ability id="aura-of-calm-su" icon={["def","protect"]}>
...
<Ability id="waves-of-peace-su" icon={["power"]}>
...
<Ability id="apostle-of-peace-su" icon={["def","boost"]}>
...
<Ability id="aura-of-life-su" icon={["aura","lower"]}>
...
<Ability id="undead-annihilation-su" icon={["melee"]}>
...
<Ability id="locate-ally-sp" icon={["magic"]}>
...
<Ability id="vindictive-smite-ex" icon={["boost","def"]}>
...
<Ability id="faded-grace-ex" icon={["power","def"]}>
...
<Ability id="solo-tactics-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="solo-tactics-ex" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="spiteful-tenacity-ex" icon={["boost"]}>
...
<Ability id="teamwork-feat" icon={["power"]}>
...
<Ability id="gang-up-ex" icon={["boost"]}>
...
<Ability id="swift-justice-ex" icon={["boost"]}>
...
<Ability id="stalwart-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="aura-of-self-righteousness-ex" icon={["def","protect"]}>
...
<Ability id="ultimate-vindication-ex" icon={["magic"]}>
...
<Ability id="bravos-finesse-ex" icon={["boost"]}>
...
<Ability id="bravos-smite-su" icon={["down"]}>
...
<Ability id="panache-and-deeds-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="advanced-deeds-ex" icon={["power"]}>
...
<Ability id="bravos-holy-strike-su" icon={["melee"]}>
...
<Ability id="power-of-faith-su" icon={["down","boost","def","protect","aid"]}>
...
<Ability id="shining-light-su" icon={["aura","lower","aid"]}>
...
<Pair title="Removed Skills">Diplomacy, Heal, Knowledge (nobility), Spellcraft</Pair></Ability>
<Ability id="natural-defense-su" icon={["def"]}>
...
<Ability id="aura-of-comfort-ex" icon={["def","protect"]}>
...
<Ability id="aura-of-purity-su" icon={["def","protect"]}>
...
<Ability id="natural-shield-su" icon={["protect"]}>
