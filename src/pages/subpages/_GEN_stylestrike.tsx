...
<Ability id="defensive-spin" icon={["def"]}>
...
<Ability id="dirty-strikes" icon={["melee"]}>
...
<Ability id="elbow-smash" icon={["melee"]}>
...
<Ability id="flying-kick" icon={["melee"]}>
...
<Ability id="foot-stomp" icon={["lower"]}>
...
<Ability id="hammerblow" icon={["boost"]}>
...
<Ability id="head-butt" icon={["melee"]}>
...
<Ability id="knockback-kick" icon={["melee"]}>
...
<Ability id="leg-sweep" icon={["melee"]}>
...
<Ability id="overbearing-assault" icon={["melee"]}>
...
<Ability id="rabbit-punch" icon={["boost"]}>
...
<Ability id="shattering-punch" icon={["boost"]}>
...
<Ability id="spin-kick" icon={["boost"]}>
...
<Ability id="throat-crush" icon={["melee"]}>
