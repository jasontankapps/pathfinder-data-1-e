...
<section data-footnotes><h3 id="ability-phrenic_amplifications-label">Footnotes</h3><ol>
<li id="ability-phrenic_amplifications-fake-fn-1-target"><p><Link to="/source/occult_origins">Occult Origins</Link> pg. 16 <InnerLink aria-label="Back to reference 1" id="backlink-ability-phrenic_amplifications-fake-fn-1" data-hash-target to="ability-phrenic_amplifications-fake-fn-1">↩</InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-ability-phrenic_amplifications-fake-fn-1.2" data-hash-target to="ability-phrenic_amplifications-fake-fn-1.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-ability-phrenic_amplifications-fake-fn-1.3" data-hash-target to="ability-phrenic_amplifications-fake-fn-1.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-ability-phrenic_amplifications-fake-fn-1.4" data-hash-target to="ability-phrenic_amplifications-fake-fn-1.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-ability-phrenic_amplifications-fake-fn-1.5" data-hash-target to="ability-phrenic_amplifications-fake-fn-1.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-ability-phrenic_amplifications-fake-fn-1.6" data-hash-target to="ability-phrenic_amplifications-fake-fn-1.6">↩<sup>6</sup></InnerLink></p></li>
<li id="ability-phrenic_amplifications-fake-fn-2-target"><p><Link to="/source/occult_adventures">Occult Adventures</Link> pg. 60 <InnerLink aria-label="Back to reference 2" id="backlink-ability-phrenic_amplifications-fake-fn-2" data-hash-target to="ability-phrenic_amplifications-fake-fn-2">↩</InnerLink></p></li>
<li id="ability-phrenic_amplifications-fake-fn-3-target"><p>Occult Adventures pg. 61 <InnerLink aria-label="Back to reference 3" id="backlink-ability-phrenic_amplifications-fake-fn-3" data-hash-target to="ability-phrenic_amplifications-fake-fn-3">↩</InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-phrenic_amplifications-fake-fn-3.2" data-hash-target to="ability-phrenic_amplifications-fake-fn-3.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-phrenic_amplifications-fake-fn-3.3" data-hash-target to="ability-phrenic_amplifications-fake-fn-3.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-phrenic_amplifications-fake-fn-3.4" data-hash-target to="ability-phrenic_amplifications-fake-fn-3.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-phrenic_amplifications-fake-fn-3.5" data-hash-target to="ability-phrenic_amplifications-fake-fn-3.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-phrenic_amplifications-fake-fn-3.6" data-hash-target to="ability-phrenic_amplifications-fake-fn-3.6">↩<sup>6</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-phrenic_amplifications-fake-fn-3.7" data-hash-target to="ability-phrenic_amplifications-fake-fn-3.7">↩<sup>7</sup></InnerLink></p></li>
<li id="ability-phrenic_amplifications-fake-fn-4-target"><p><Link to="/source/heroes_of_golarion">Heroes of Golarion</Link> pg. 13 <InnerLink aria-label="Back to reference 4" id="backlink-ability-phrenic_amplifications-fake-fn-4" data-hash-target to="ability-phrenic_amplifications-fake-fn-4">↩</InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-ability-phrenic_amplifications-fake-fn-4.2" data-hash-target to="ability-phrenic_amplifications-fake-fn-4.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-ability-phrenic_amplifications-fake-fn-4.3" data-hash-target to="ability-phrenic_amplifications-fake-fn-4.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-ability-phrenic_amplifications-fake-fn-4.4" data-hash-target to="ability-phrenic_amplifications-fake-fn-4.4">↩<sup>4</sup></InnerLink></p></li>
<li id="ability-phrenic_amplifications-fake-fn-5-target"><p>Occult Adventures pg. 62 <InnerLink aria-label="Back to reference 5" id="backlink-ability-phrenic_amplifications-fake-fn-5" data-hash-target to="ability-phrenic_amplifications-fake-fn-5">↩</InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-ability-phrenic_amplifications-fake-fn-5.2" data-hash-target to="ability-phrenic_amplifications-fake-fn-5.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-ability-phrenic_amplifications-fake-fn-5.3" data-hash-target to="ability-phrenic_amplifications-fake-fn-5.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-ability-phrenic_amplifications-fake-fn-5.4" data-hash-target to="ability-phrenic_amplifications-fake-fn-5.4">↩<sup>4</sup></InnerLink></p></li>
</ol></section></div>};
...
const _ranger_traps = {hasJL:true,title: "Ranger Traps", topLink: ["Trapper (Ranger Archetype)","arc-ranger/trapper"], jsx: <div className="compilation"><div className="jumpList" id="ability-ranger_traps-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="ability-ranger_traps-rangertrapacidtrap-acid-trap-ex-or-su-fn1">Acid Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapalarmtrap-alarm-trap-ex-or-su-fn2">Alarm Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapanchoringtrap-anchoring-trap-su-fn3">Anchoring Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapblightburntrap-blightburn-trap-ex-fn1-2">Blightburn Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapblightedmarktrap-blighted-mark-trap-ex-or-su-fn4">Blighted Mark Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapbludgeoningtrap-bludgeoning-trap-ex-or-su-fn5">Bludgeoning Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapburningtrap-burning-trap-ex-or-su-fn2-2">Burning Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapchanneledenergytrap-channeled-energy-trap-ex-or-su-fn1-3">Channeled Energy Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapcleansingtrap-cleansing-trap-ex-or-su-fn4-2">Cleansing Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapdecoytrap-decoy-trap-su-fn5-2">Decoy Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapdirtytricktrap-dirty-trick-trap-ex-or-su-fn5-3">Dirty Trick Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapdistractiontrap-distraction-trap-ex-or-su-fn1-4">Distraction Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapexplodingtrap-exploding-trap-ex-or-su-fn2-3">Exploding Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapfiretrap-fire-trap-ex-or-su-fn2-4">Fire Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapfireworktrap-firework-trap-ex-or-su-fn6">Firework Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapfreezingtrap-freezing-trap-su-fn2-5">Freezing Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapinfectedsnaretrap-infected-snare-trap-ex-or-su-fn4-3">Infected Snare Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertraplazuritetrap-lazurite-trap-ex-or-su-fn1-5">Lazurite Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertraplimningtrap-limning-trap-ex-or-su-fn6-2">Limning Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapmarkingtrap-marking-trap-ex-or-su-fn2-6">Marking Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapoversizedbarbs-oversized-barbs-ex-or-su-fn1-6">Oversized Barbs</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrappenetratingtrap-penetrating-trap-ex-or-su-fn7">Penetrating Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrappittrap-pit-trap-ex-or-su-fn8">Pit Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrappoisontrap-poison-trap-ex-or-su-fn2-7">Poison Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapquicksandtrap-quicksand-trap-su-fn7-2">Quicksand Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertraprustmonstertrap-rust-monster-trap-ex-or-su-fn8-2">Rust Monster Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapselectivetrigger-selective-trigger-ex-or-su-fn8-3">Selective Trigger</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapsleettrap-sleet-trap-su-fn9">Sleet Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapsmoketrap-smoke-trap-ex-or-su-fn6-3">Smoke Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapsnaretrap-snare-trap-ex-or-su-fn9-2">Snare Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapspellstealingtrap-spell-stealing-trap-su-fn8-4">Spell-Stealing Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapspellstoringtrap-spell-storing-trap-su-fn8-5">Spell-Storing Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapsummonedallytrap-summoned-ally-trap-su-fn5-4">Summoned Ally Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapswarmtrap-swarm-trap-ex-or-su-fn9-3">Swarm Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertraptartrap-tar-trap-ex-or-su-fn8-6">Tar Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertraptelepathytrap-telepathy-trap-su-fn3-2">Telepathy Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertraptoxicfumestrap-toxic-fumes-trap-ex-or-su-fn6-4">Toxic Fumes Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertraptransdimensionaltrap-transdimensional-trap-su-fn8-7">Transdimensional Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertraptranspositionaltrap-transpositional-trap-su-fn3-3">Transpositional Trap</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertraptripwire-tripwire-ex-or-su-fn8-8">Tripwire</InnerLink></li><li><InnerLink toTop to="ability-ranger_traps-rangertrapwoundingtrap-wounding-trap-ex-or-su-fn7-3">Wounding Trap</InnerLink></li></ul></div><h2 id="ability-ranger_traps-ranger-traps">Ranger Traps</h2>
<p><strong>Sources</strong> <Link to="/source/ultimate_magic">Ultimate Magic</Link><br/>Rangers are legendary for their ability to hunt down and capture their prey. Some rangers can create elaborate <Link to="/rule/traps">traps</Link> out of scraps, vines, and perhaps a little bit of specialized magic. Characters can learn how to set these traps by taking the <Link to="/feat/learn_ranger_trap">Learn Ranger Trap</Link> feat or by having the <Link to="/arc-ranger/trapper">trapper</Link> ranger archetype.</p>
<p>Setting a trap is a <strong className="hl">full-round action</strong> that provokes attacks of opportunity. A trap fills a single 5-foot square, and cannot be placed in the same area as another ranger trap or a magical trap such as a glyph of warding. The ranger only needs simple materials to create the trap, such as a piece of cloth, a small amount of metal (such as a dagger, iron spike, or a few nails), a foot of rope or vine, and so on. The DCs for Perception checks to notice the trap, Disable Device checks to disable it, and for saving throws to avoid it are equal to 10 + 1/2 the character's level + the character's Wisdom bonus. All ranger traps are <em>Trigger: location,</em> and <em>Reset: none.</em></p>
<p>Ranger traps are either extraordinary or supernatural; extraordinary traps are <em>Type: mechanical,</em> and supernatural traps are <em>Type: magic.</em></p>
<p>Some of the traps listed below may be set as extraordinary traps or as magical (supernatural) traps; learning such a trap lets a ranger set it either way. An extraordinary trap has a -2 penalty to its DC. An extraordinary trap lasts 1 day per ranger level or until it is triggered, whichever comes first. A magical trap lasts only 1 hour per level or until triggered, whichever comes first. A trap's DC decreases by 1 for each full day (or hour, for a magical trap) that passes after it is set.</p>
<p>Certain traps add to or modify the effects of another trap; a ranger can add one of these <strong className="hl">modifications</strong> to any standard ranger trap (this costs 1 additional use of the trap ability).</p>
<p>Some supernatural traps can be created by a character who isn't a ranger (but who has the <Link to="/feat/learn_ranger_trap">Learn Ranger Trap</Link> feat) through including an additional <strong className="hl">magical component</strong>. This component - usually a scroll, potion, or oil - is expended at the time of the trap's creation. Including it increases the time to lay the trap to 1 full minute.</p>
<Block titled size="minimal"><Row><Cell id="rangertrapacidtrap-acid-trap-ex-or-su-fn1"><p><Link to="/rangertrap/acid_trap">⮞</Link> Acid Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-1" id="ability-ranger_traps-fake-fn-1" data-hash-target to="ability-ranger_traps-fake-fn-1-target">1</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal" hl><Row><Cell id="rangertrapalarmtrap-alarm-trap-ex-or-su-fn2"><p><Link to="/rangertrap/alarm_trap">⮞</Link> Alarm Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-2" id="ability-ranger_traps-fake-fn-2" data-hash-target to="ability-ranger_traps-fake-fn-2-target">2</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal" hl><Row><Cell id="rangertrapanchoringtrap-anchoring-trap-su-fn3"><p><Link to="/rangertrap/anchoring_trap">⮞</Link> Anchoring Trap (Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-3" id="ability-ranger_traps-fake-fn-3" data-hash-target to="ability-ranger_traps-fake-fn-3-target">3</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapblightburntrap-blightburn-trap-ex-fn1-2"><p><Link to="/rangertrap/blightburn_trap">⮞</Link> Blightburn Trap (Ex) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-1.2" id="ability-ranger_traps-fake-fn-1.2" data-hash-target to="ability-ranger_traps-fake-fn-1-target">1</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapblightedmarktrap-blighted-mark-trap-ex-or-su-fn4"><p><Link to="/rangertrap/blighted_mark_trap">⮞</Link> Blighted Mark Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-4" id="ability-ranger_traps-fake-fn-4" data-hash-target to="ability-ranger_traps-fake-fn-4-target">4</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapbludgeoningtrap-bludgeoning-trap-ex-or-su-fn5"><p><Link to="/rangertrap/bludgeoning_trap">⮞</Link> Bludgeoning Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-5" id="ability-ranger_traps-fake-fn-5" data-hash-target to="ability-ranger_traps-fake-fn-5-target">5</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal" hl><Row><Cell id="rangertrapburningtrap-burning-trap-ex-or-su-fn2-2"><p><Link to="/rangertrap/burning_trap">⮞</Link> Burning Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-2.2" id="ability-ranger_traps-fake-fn-2.2" data-hash-target to="ability-ranger_traps-fake-fn-2-target">2</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapchanneledenergytrap-channeled-energy-trap-ex-or-su-fn1-3"><p><Link to="/rangertrap/channeled_energy_trap">⮞</Link> Channeled Energy Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-1.3" id="ability-ranger_traps-fake-fn-1.3" data-hash-target to="ability-ranger_traps-fake-fn-1-target">1</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapcleansingtrap-cleansing-trap-ex-or-su-fn4-2"><p><Link to="/rangertrap/cleansing_trap">⮞</Link> Cleansing Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-4.2" id="ability-ranger_traps-fake-fn-4.2" data-hash-target to="ability-ranger_traps-fake-fn-4-target">4</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapdecoytrap-decoy-trap-su-fn5-2"><p><Link to="/rangertrap/decoy_trap">⮞</Link> Decoy Trap (Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-5.2" id="ability-ranger_traps-fake-fn-5.2" data-hash-target to="ability-ranger_traps-fake-fn-5-target">5</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal" hl><Row><Cell id="rangertrapdirtytricktrap-dirty-trick-trap-ex-or-su-fn5-3"><p><Link to="/rangertrap/dirty_trick_trap">⮞</Link> Dirty Trick Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-5.3" id="ability-ranger_traps-fake-fn-5.3" data-hash-target to="ability-ranger_traps-fake-fn-5-target">5</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapdistractiontrap-distraction-trap-ex-or-su-fn1-4"><p><Link to="/rangertrap/distraction_trap">⮞</Link> Distraction Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-1.4" id="ability-ranger_traps-fake-fn-1.4" data-hash-target to="ability-ranger_traps-fake-fn-1-target">1</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal" hl><Row><Cell id="rangertrapexplodingtrap-exploding-trap-ex-or-su-fn2-3"><p><Link to="/rangertrap/exploding_trap">⮞</Link> Exploding Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-2.3" id="ability-ranger_traps-fake-fn-2.3" data-hash-target to="ability-ranger_traps-fake-fn-2-target">2</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapfiretrap-fire-trap-ex-or-su-fn2-4"><p><Link to="/rangertrap/fire_trap">⮞</Link> Fire Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-2.4" id="ability-ranger_traps-fake-fn-2.4" data-hash-target to="ability-ranger_traps-fake-fn-2-target">2</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal" hl><Row><Cell id="rangertrapfireworktrap-firework-trap-ex-or-su-fn6"><p><Link to="/rangertrap/firework_trap">⮞</Link> Firework Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-6" id="ability-ranger_traps-fake-fn-6" data-hash-target to="ability-ranger_traps-fake-fn-6-target">6</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapfreezingtrap-freezing-trap-su-fn2-5"><p><Link to="/rangertrap/freezing_trap">⮞</Link> Freezing Trap (Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-2.5" id="ability-ranger_traps-fake-fn-2.5" data-hash-target to="ability-ranger_traps-fake-fn-2-target">2</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapinfectedsnaretrap-infected-snare-trap-ex-or-su-fn4-3"><p><Link to="/rangertrap/infected_snare_trap">⮞</Link> Infected Snare Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-4.3" id="ability-ranger_traps-fake-fn-4.3" data-hash-target to="ability-ranger_traps-fake-fn-4-target">4</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertraplazuritetrap-lazurite-trap-ex-or-su-fn1-5"><p><Link to="/rangertrap/lazurite_trap">⮞</Link> Lazurite Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-1.5" id="ability-ranger_traps-fake-fn-1.5" data-hash-target to="ability-ranger_traps-fake-fn-1-target">1</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertraplimningtrap-limning-trap-ex-or-su-fn6-2"><p><Link to="/rangertrap/limning_trap">⮞</Link> Limning Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-6.2" id="ability-ranger_traps-fake-fn-6.2" data-hash-target to="ability-ranger_traps-fake-fn-6-target">6</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal" hl><Row><Cell id="rangertrapmarkingtrap-marking-trap-ex-or-su-fn2-6"><p><Link to="/rangertrap/marking_trap">⮞</Link> Marking Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-2.6" id="ability-ranger_traps-fake-fn-2.6" data-hash-target to="ability-ranger_traps-fake-fn-2-target">2</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapoversizedbarbs-oversized-barbs-ex-or-su-fn1-6"><p><Link to="/rangertrap/oversized_barbs">⮞</Link> Oversized Barbs (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-1.6" id="ability-ranger_traps-fake-fn-1.6" data-hash-target to="ability-ranger_traps-fake-fn-1-target">1</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal" hl><Row><Cell id="rangertrappenetratingtrap-penetrating-trap-ex-or-su-fn7"><p><Link to="/rangertrap/penetrating_trap">⮞</Link> Penetrating Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-7" id="ability-ranger_traps-fake-fn-7" data-hash-target to="ability-ranger_traps-fake-fn-7-target">7</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrappittrap-pit-trap-ex-or-su-fn8"><p><Link to="/rangertrap/pit_trap">⮞</Link> Pit Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-8" id="ability-ranger_traps-fake-fn-8" data-hash-target to="ability-ranger_traps-fake-fn-8-target">8</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrappoisontrap-poison-trap-ex-or-su-fn2-7"><p><Link to="/rangertrap/poison_trap">⮞</Link> Poison Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-2.7" id="ability-ranger_traps-fake-fn-2.7" data-hash-target to="ability-ranger_traps-fake-fn-2-target">2</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapquicksandtrap-quicksand-trap-su-fn7-2"><p><Link to="/rangertrap/quicksand_trap">⮞</Link> Quicksand Trap (Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-7.2" id="ability-ranger_traps-fake-fn-7.2" data-hash-target to="ability-ranger_traps-fake-fn-7-target">7</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertraprustmonstertrap-rust-monster-trap-ex-or-su-fn8-2"><p><Link to="/rangertrap/rust_monster_trap">⮞</Link> Rust Monster Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-8.2" id="ability-ranger_traps-fake-fn-8.2" data-hash-target to="ability-ranger_traps-fake-fn-8-target">8</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal" hl><Row><Cell id="rangertrapselectivetrigger-selective-trigger-ex-or-su-fn8-3"><p><Link to="/rangertrap/selective_trigger">⮞</Link> Selective Trigger (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-8.3" id="ability-ranger_traps-fake-fn-8.3" data-hash-target to="ability-ranger_traps-fake-fn-8-target">8</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapsleettrap-sleet-trap-su-fn9"><p><Link to="/rangertrap/sleet_trap">⮞</Link> Sleet Trap (Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-9" id="ability-ranger_traps-fake-fn-9" data-hash-target to="ability-ranger_traps-fake-fn-9-target">9</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapsmoketrap-smoke-trap-ex-or-su-fn6-3"><p><Link to="/rangertrap/smoke_trap">⮞</Link> Smoke Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-6.3" id="ability-ranger_traps-fake-fn-6.3" data-hash-target to="ability-ranger_traps-fake-fn-6-target">6</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapsnaretrap-snare-trap-ex-or-su-fn9-2"><p><Link to="/rangertrap/snare_trap">⮞</Link> Snare Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-9.2" id="ability-ranger_traps-fake-fn-9.2" data-hash-target to="ability-ranger_traps-fake-fn-9-target">9</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapspellstealingtrap-spell-stealing-trap-su-fn8-4"><p><Link to="/rangertrap/spell_stealing_trap">⮞</Link> Spell-Stealing Trap (Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-8.4" id="ability-ranger_traps-fake-fn-8.4" data-hash-target to="ability-ranger_traps-fake-fn-8-target">8</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapspellstoringtrap-spell-storing-trap-su-fn8-5"><p><Link to="/rangertrap/spell_storing_trap">⮞</Link> Spell-Storing Trap (Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-8.5" id="ability-ranger_traps-fake-fn-8.5" data-hash-target to="ability-ranger_traps-fake-fn-8-target">8</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapsummonedallytrap-summoned-ally-trap-su-fn5-4"><p><Link to="/rangertrap/summoned_ally_trap">⮞</Link> Summoned Ally Trap (Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-5.4" id="ability-ranger_traps-fake-fn-5.4" data-hash-target to="ability-ranger_traps-fake-fn-5-target">5</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapswarmtrap-swarm-trap-ex-or-su-fn9-3"><p><Link to="/rangertrap/swarm_trap">⮞</Link> Swarm Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-9.3" id="ability-ranger_traps-fake-fn-9.3" data-hash-target to="ability-ranger_traps-fake-fn-9-target">9</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertraptartrap-tar-trap-ex-or-su-fn8-6"><p><Link to="/rangertrap/tar_trap">⮞</Link> Tar Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-8.6" id="ability-ranger_traps-fake-fn-8.6" data-hash-target to="ability-ranger_traps-fake-fn-8-target">8</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertraptelepathytrap-telepathy-trap-su-fn3-2"><p><Link to="/rangertrap/telepathy_trap">⮞</Link> Telepathy Trap (Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-3.2" id="ability-ranger_traps-fake-fn-3.2" data-hash-target to="ability-ranger_traps-fake-fn-3-target">3</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal" hl><Row><Cell id="rangertraptoxicfumestrap-toxic-fumes-trap-ex-or-su-fn6-4"><p><Link to="/rangertrap/toxic_fumes_trap">⮞</Link> Toxic Fumes Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-6.4" id="ability-ranger_traps-fake-fn-6.4" data-hash-target to="ability-ranger_traps-fake-fn-6-target">6</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal" hl><Row><Cell id="rangertraptransdimensionaltrap-transdimensional-trap-su-fn8-7"><p><Link to="/rangertrap/transdimensional_trap">⮞</Link> Transdimensional Trap (Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-8.7" id="ability-ranger_traps-fake-fn-8.7" data-hash-target to="ability-ranger_traps-fake-fn-8-target">8</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertraptranspositionaltrap-transpositional-trap-su-fn3-3"><p><Link to="/rangertrap/transpositional_trap">⮞</Link> Transpositional Trap (Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-3.3" id="ability-ranger_traps-fake-fn-3.3" data-hash-target to="ability-ranger_traps-fake-fn-3-target">3</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertraptripwire-tripwire-ex-or-su-fn8-8"><p><Link to="/rangertrap/tripwire">⮞</Link> Tripwire (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-8.8" id="ability-ranger_traps-fake-fn-8.8" data-hash-target to="ability-ranger_traps-fake-fn-8-target">8</InnerLink></sup></p>
</Cell></Row>
...
<Block titled size="minimal"><Row><Cell id="rangertrapwoundingtrap-wounding-trap-ex-or-su-fn7-3"><p><Link to="/rangertrap/wounding_trap">⮞</Link> Wounding Trap (Ex or Su) <sup><InnerLink showBacklink="backlink-ability-ranger_traps-fake-fn-7.3" id="ability-ranger_traps-fake-fn-7.3" data-hash-target to="ability-ranger_traps-fake-fn-7-target">7</InnerLink></sup></p>
</Cell></Row>
...
<section data-footnotes><h3 id="ability-ranger_traps-label">Footnotes</h3><ol>
<li id="ability-ranger_traps-fake-fn-1-target"><p><Link to="/source/kobolds_of_golarion">Kobolds of Golarion</Link> pg. 20 <InnerLink aria-label="Back to reference 1" id="backlink-ability-ranger_traps-fake-fn-1" data-hash-target to="ability-ranger_traps-fake-fn-1">↩</InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-ability-ranger_traps-fake-fn-1.2" data-hash-target to="ability-ranger_traps-fake-fn-1.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-ability-ranger_traps-fake-fn-1.3" data-hash-target to="ability-ranger_traps-fake-fn-1.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-ability-ranger_traps-fake-fn-1.4" data-hash-target to="ability-ranger_traps-fake-fn-1.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-ability-ranger_traps-fake-fn-1.5" data-hash-target to="ability-ranger_traps-fake-fn-1.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-ability-ranger_traps-fake-fn-1.6" data-hash-target to="ability-ranger_traps-fake-fn-1.6">↩<sup>6</sup></InnerLink></p></li>
<li id="ability-ranger_traps-fake-fn-2-target"><p><Link to="/source/ultimate_magic">Ultimate Magic</Link> pg. 64 <InnerLink aria-label="Back to reference 2" id="backlink-ability-ranger_traps-fake-fn-2" data-hash-target to="ability-ranger_traps-fake-fn-2">↩</InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-ability-ranger_traps-fake-fn-2.2" data-hash-target to="ability-ranger_traps-fake-fn-2.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-ability-ranger_traps-fake-fn-2.3" data-hash-target to="ability-ranger_traps-fake-fn-2.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-ability-ranger_traps-fake-fn-2.4" data-hash-target to="ability-ranger_traps-fake-fn-2.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-ability-ranger_traps-fake-fn-2.5" data-hash-target to="ability-ranger_traps-fake-fn-2.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-ability-ranger_traps-fake-fn-2.6" data-hash-target to="ability-ranger_traps-fake-fn-2.6">↩<sup>6</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-ability-ranger_traps-fake-fn-2.7" data-hash-target to="ability-ranger_traps-fake-fn-2.7">↩<sup>7</sup></InnerLink></p></li>
<li id="ability-ranger_traps-fake-fn-3-target"><p><Link to="/source/demon_hunters_handbook">Demon Hunter's Handbook</Link> pg. 11 <InnerLink aria-label="Back to reference 3" id="backlink-ability-ranger_traps-fake-fn-3" data-hash-target to="ability-ranger_traps-fake-fn-3">↩</InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-ranger_traps-fake-fn-3.2" data-hash-target to="ability-ranger_traps-fake-fn-3.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-ranger_traps-fake-fn-3.3" data-hash-target to="ability-ranger_traps-fake-fn-3.3">↩<sup>3</sup></InnerLink></p></li>
<li id="ability-ranger_traps-fake-fn-4-target"><p><Link to="/source/people_of_the_wastes">People of the Wastes</Link> pg. 17 <InnerLink aria-label="Back to reference 4" id="backlink-ability-ranger_traps-fake-fn-4" data-hash-target to="ability-ranger_traps-fake-fn-4">↩</InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-ability-ranger_traps-fake-fn-4.2" data-hash-target to="ability-ranger_traps-fake-fn-4.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-ability-ranger_traps-fake-fn-4.3" data-hash-target to="ability-ranger_traps-fake-fn-4.3">↩<sup>3</sup></InnerLink></p></li>
<li id="ability-ranger_traps-fake-fn-5-target"><p><Link to="/source/ranged_tactics_toolbox">Ranged Tactics Toolbox</Link> pg. 15 <InnerLink aria-label="Back to reference 5" id="backlink-ability-ranger_traps-fake-fn-5" data-hash-target to="ability-ranger_traps-fake-fn-5">↩</InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-ability-ranger_traps-fake-fn-5.2" data-hash-target to="ability-ranger_traps-fake-fn-5.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-ability-ranger_traps-fake-fn-5.3" data-hash-target to="ability-ranger_traps-fake-fn-5.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-ability-ranger_traps-fake-fn-5.4" data-hash-target to="ability-ranger_traps-fake-fn-5.4">↩<sup>4</sup></InnerLink></p></li>
<li id="ability-ranger_traps-fake-fn-6-target"><p><Link to="/source/champions_of_balance">Champions of Balance</Link> pg. 25 <InnerLink aria-label="Back to reference 6" id="backlink-ability-ranger_traps-fake-fn-6" data-hash-target to="ability-ranger_traps-fake-fn-6">↩</InnerLink> <InnerLink aria-label="Back to reference 6" id="backlink-ability-ranger_traps-fake-fn-6.2" data-hash-target to="ability-ranger_traps-fake-fn-6.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 6" id="backlink-ability-ranger_traps-fake-fn-6.3" data-hash-target to="ability-ranger_traps-fake-fn-6.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 6" id="backlink-ability-ranger_traps-fake-fn-6.4" data-hash-target to="ability-ranger_traps-fake-fn-6.4">↩<sup>4</sup></InnerLink></p></li>
<li id="ability-ranger_traps-fake-fn-7-target"><p><Link to="/source/magical_marketplace">Magical Marketplace</Link> pg. 12 <InnerLink aria-label="Back to reference 7" id="backlink-ability-ranger_traps-fake-fn-7" data-hash-target to="ability-ranger_traps-fake-fn-7">↩</InnerLink> <InnerLink aria-label="Back to reference 7" id="backlink-ability-ranger_traps-fake-fn-7.2" data-hash-target to="ability-ranger_traps-fake-fn-7.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 7" id="backlink-ability-ranger_traps-fake-fn-7.3" data-hash-target to="ability-ranger_traps-fake-fn-7.3">↩<sup>3</sup></InnerLink></p></li>
<li id="ability-ranger_traps-fake-fn-8-target"><p>Kobolds of Golarion pg. 21 <InnerLink aria-label="Back to reference 8" id="backlink-ability-ranger_traps-fake-fn-8" data-hash-target to="ability-ranger_traps-fake-fn-8">↩</InnerLink> <InnerLink aria-label="Back to reference 8" id="backlink-ability-ranger_traps-fake-fn-8.2" data-hash-target to="ability-ranger_traps-fake-fn-8.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 8" id="backlink-ability-ranger_traps-fake-fn-8.3" data-hash-target to="ability-ranger_traps-fake-fn-8.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 8" id="backlink-ability-ranger_traps-fake-fn-8.4" data-hash-target to="ability-ranger_traps-fake-fn-8.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 8" id="backlink-ability-ranger_traps-fake-fn-8.5" data-hash-target to="ability-ranger_traps-fake-fn-8.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 8" id="backlink-ability-ranger_traps-fake-fn-8.6" data-hash-target to="ability-ranger_traps-fake-fn-8.6">↩<sup>6</sup></InnerLink> <InnerLink aria-label="Back to reference 8" id="backlink-ability-ranger_traps-fake-fn-8.7" data-hash-target to="ability-ranger_traps-fake-fn-8.7">↩<sup>7</sup></InnerLink> <InnerLink aria-label="Back to reference 8" id="backlink-ability-ranger_traps-fake-fn-8.8" data-hash-target to="ability-ranger_traps-fake-fn-8.8">↩<sup>8</sup></InnerLink></p></li>
<li id="ability-ranger_traps-fake-fn-9-target"><p>Ultimate Magic pg. 65 <InnerLink aria-label="Back to reference 9" id="backlink-ability-ranger_traps-fake-fn-9" data-hash-target to="ability-ranger_traps-fake-fn-9">↩</InnerLink> <InnerLink aria-label="Back to reference 9" id="backlink-ability-ranger_traps-fake-fn-9.2" data-hash-target to="ability-ranger_traps-fake-fn-9.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 9" id="backlink-ability-ranger_traps-fake-fn-9.3" data-hash-target to="ability-ranger_traps-fake-fn-9.3">↩<sup>3</sup></InnerLink></p></li>
</ol></section></div>};
...
const _slayer_talents = {hasJL:true,title: "Slayer Talents", topLink: ["Slayer","class/slayer"], jsx: <div className="compilation"><div className="jumpList" id="ability-slayer_talents-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="ability-slayer_talents-primary-sneak-attack-talents">Primary Sneak Attack Talents</InnerLink></li><li><InnerLink toTop to="ability-slayer_talents-other-sneak-attack-talents">Other Sneak Attack Talents</InnerLink></li><li><InnerLink toTop to="ability-slayer_talents-studied-target-talents">Studied Target Talents</InnerLink></li><li><InnerLink toTop to="ability-slayer_talents-other-talents">Other Talents</InnerLink></li></ul></div><h2 id="ability-slayer_talents-slayer-talents">Slayer Talents</h2>
...
<section data-footnotes><h3 id="ability-slayer_talents-label">Footnotes</h3><ol>
<li id="ability-slayer_talents-fake-fn-1-target"><p><Link to="/source/distant_realms">Distant Realms</Link> pg. 13 <InnerLink aria-label="Back to reference 1" id="backlink-ability-slayer_talents-fake-fn-1" data-hash-target to="ability-slayer_talents-fake-fn-1">↩</InnerLink> <InnerLink aria-label="Back to reference 1" id="backlink-ability-slayer_talents-fake-fn-1.2" data-hash-target to="ability-slayer_talents-fake-fn-1.2">↩<sup>2</sup></InnerLink></p></li>
<li id="ability-slayer_talents-fake-fn-2-target"><p><Link to="/source/advanced_class_guide">Advanced Class Guide</Link> pg. 53 <InnerLink aria-label="Back to reference 2" id="backlink-ability-slayer_talents-fake-fn-2" data-hash-target to="ability-slayer_talents-fake-fn-2">↩</InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-ability-slayer_talents-fake-fn-2.2" data-hash-target to="ability-slayer_talents-fake-fn-2.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-ability-slayer_talents-fake-fn-2.3" data-hash-target to="ability-slayer_talents-fake-fn-2.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-ability-slayer_talents-fake-fn-2.4" data-hash-target to="ability-slayer_talents-fake-fn-2.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 2" id="backlink-ability-slayer_talents-fake-fn-2.5" data-hash-target to="ability-slayer_talents-fake-fn-2.5">↩<sup>5</sup></InnerLink></p></li>
<li id="ability-slayer_talents-fake-fn-3-target"><p><Link to="/source/heroes_of_golarion">Heroes of Golarion</Link> pg. 4 <InnerLink aria-label="Back to reference 3" id="backlink-ability-slayer_talents-fake-fn-3" data-hash-target to="ability-slayer_talents-fake-fn-3">↩</InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-slayer_talents-fake-fn-3.2" data-hash-target to="ability-slayer_talents-fake-fn-3.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 3" id="backlink-ability-slayer_talents-fake-fn-3.3" data-hash-target to="ability-slayer_talents-fake-fn-3.3">↩<sup>3</sup></InnerLink></p></li>
<li id="ability-slayer_talents-fake-fn-4-target"><p><Link to="/source/advanced_class_origins">Advanced Class Origins</Link> pg. 21 <InnerLink aria-label="Back to reference 4" id="backlink-ability-slayer_talents-fake-fn-4" data-hash-target to="ability-slayer_talents-fake-fn-4">↩</InnerLink> <InnerLink aria-label="Back to reference 4" id="backlink-ability-slayer_talents-fake-fn-4.2" data-hash-target to="ability-slayer_talents-fake-fn-4.2">↩<sup>2</sup></InnerLink></p></li>
<li id="ability-slayer_talents-fake-fn-5-target"><p><Link to="/source/martial_arts_handbook">Martial Arts Handbook</Link> pg. 18 <InnerLink aria-label="Back to reference 5" id="backlink-ability-slayer_talents-fake-fn-5" data-hash-target to="ability-slayer_talents-fake-fn-5">↩</InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-ability-slayer_talents-fake-fn-5.2" data-hash-target to="ability-slayer_talents-fake-fn-5.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-ability-slayer_talents-fake-fn-5.3" data-hash-target to="ability-slayer_talents-fake-fn-5.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-ability-slayer_talents-fake-fn-5.4" data-hash-target to="ability-slayer_talents-fake-fn-5.4">↩<sup>4</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-ability-slayer_talents-fake-fn-5.5" data-hash-target to="ability-slayer_talents-fake-fn-5.5">↩<sup>5</sup></InnerLink> <InnerLink aria-label="Back to reference 5" id="backlink-ability-slayer_talents-fake-fn-5.6" data-hash-target to="ability-slayer_talents-fake-fn-5.6">↩<sup>6</sup></InnerLink></p></li>
<li id="ability-slayer_talents-fake-fn-6-target"><p><Link to="/source/elemental_masters_handbook">Elemental Master's Handbook</Link> pg. 9 <InnerLink aria-label="Back to reference 6" id="backlink-ability-slayer_talents-fake-fn-6" data-hash-target to="ability-slayer_talents-fake-fn-6">↩</InnerLink> <InnerLink aria-label="Back to reference 6" id="backlink-ability-slayer_talents-fake-fn-6.2" data-hash-target to="ability-slayer_talents-fake-fn-6.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 6" id="backlink-ability-slayer_talents-fake-fn-6.3" data-hash-target to="ability-slayer_talents-fake-fn-6.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 6" id="backlink-ability-slayer_talents-fake-fn-6.4" data-hash-target to="ability-slayer_talents-fake-fn-6.4">↩<sup>4</sup></InnerLink></p></li>
<li id="ability-slayer_talents-fake-fn-7-target"><p><Link to="/source/dirty_tactics_toolbox">Dirty Tactics Toolbox</Link> pg. 22 <InnerLink aria-label="Back to reference 7" id="backlink-ability-slayer_talents-fake-fn-7" data-hash-target to="ability-slayer_talents-fake-fn-7">↩</InnerLink></p></li>
<li id="ability-slayer_talents-fake-fn-8-target"><p><Link to="/source/blood_of_the_beast">Blood of the Beast</Link> pg. 6 <InnerLink aria-label="Back to reference 8" id="backlink-ability-slayer_talents-fake-fn-8" data-hash-target to="ability-slayer_talents-fake-fn-8">↩</InnerLink></p></li>
<li id="ability-slayer_talents-fake-fn-9-target"><p><Link to="/source/spymasters_handbook">Spymaster's Handbook</Link> pg. 21 <InnerLink aria-label="Back to reference 9" id="backlink-ability-slayer_talents-fake-fn-9" data-hash-target to="ability-slayer_talents-fake-fn-9">↩</InnerLink></p></li>
<li id="ability-slayer_talents-fake-fn-10-target"><p><Link to="/source/blood_of_shadows">Blood of Shadows</Link> pg. 8 <InnerLink aria-label="Back to reference 10" id="backlink-ability-slayer_talents-fake-fn-10" data-hash-target to="ability-slayer_talents-fake-fn-10">↩</InnerLink></p></li>
<li id="ability-slayer_talents-fake-fn-11-target"><p><Link to="/source/ultimate_wilderness">Ultimate Wilderness</Link> pg. 86 <InnerLink aria-label="Back to reference 11" id="backlink-ability-slayer_talents-fake-fn-11" data-hash-target to="ability-slayer_talents-fake-fn-11">↩</InnerLink> <InnerLink aria-label="Back to reference 11" id="backlink-ability-slayer_talents-fake-fn-11.2" data-hash-target to="ability-slayer_talents-fake-fn-11.2">↩<sup>2</sup></InnerLink> <InnerLink aria-label="Back to reference 11" id="backlink-ability-slayer_talents-fake-fn-11.3" data-hash-target to="ability-slayer_talents-fake-fn-11.3">↩<sup>3</sup></InnerLink> <InnerLink aria-label="Back to reference 11" id="backlink-ability-slayer_talents-fake-fn-11.4" data-hash-target to="ability-slayer_talents-fake-fn-11.4">↩<sup>4</sup></InnerLink></p></li>
<li id="ability-slayer_talents-fake-fn-12-target"><p><Link to="/source/potions_and_poisons">Potions and Poisons</Link> pg. 13 <InnerLink aria-label="Back to reference 12" id="backlink-ability-slayer_talents-fake-fn-12" data-hash-target to="ability-slayer_talents-fake-fn-12">↩</InnerLink> <InnerLink aria-label="Back to reference 12" id="backlink-ability-slayer_talents-fake-fn-12.2" data-hash-target to="ability-slayer_talents-fake-fn-12.2">↩<sup>2</sup></InnerLink></p></li>
<li id="ability-slayer_talents-fake-fn-13-target"><p>Spymaster's Handbook pg. 23 <InnerLink aria-label="Back to reference 13" id="backlink-ability-slayer_talents-fake-fn-13" data-hash-target to="ability-slayer_talents-fake-fn-13">↩</InnerLink></p></li>
<li id="ability-slayer_talents-fake-fn-14-target"><p>Advanced Class Guide pg. 54 <InnerLink aria-label="Back to reference 14" id="backlink-ability-slayer_talents-fake-fn-14" data-hash-target to="ability-slayer_talents-fake-fn-14">↩</InnerLink></p></li>
</ol></section></div>};
...
export default {patrons:_patrons,phrenic_amplifications:_phrenic_amplifications,psi_tech:_psi_tech,ranger_traps:_ranger_traps,rogue_talents:_rogue_talents,shaman_hexes:_shaman_hexes,shaman_spirits:_shaman_spirits,simple_kinetic_blasts:_simple_kinetic_blasts,slayer_talents:_slayer_talents,social_talents:_social_talents,stance_rage_powers:_stance_rage_powers}