...
<Ability id="patronagility-agility-fn1" icon={["learn"]}>
...
<Ability id="patronancestors-ancestors-fn2" icon={["learn"]}>
...
<Ability id="patronanimals-animals-fn1-2" icon={["learn"]}>
...
<Ability id="patronaurora-aurora-fn3" icon={["learn"]}>
...
<Ability id="patronautumn-autumn-fn4" icon={["learn"]}>
...
<Ability id="patronboundaries-boundaries-fn5" icon={["learn"]}>
...
<Ability id="patronconspiracies-conspiracies-fn6" icon={["learn"]}>
...
<Ability id="patrondeath-death-fn2-2" icon={["learn"]}>
...
<Ability id="patrondecadence-decadence-fn6-2" icon={["learn"]}>
...
<Ability id="patrondeception-deception-fn1-3" icon={["learn"]}>
...
<Ability id="patrondevotion-devotion-fn5-2" icon={["learn"]}>
...
<Ability id="patronelements-elements-fn1-4" icon={["learn"]}>
...
<Ability id="patronenchantment-enchantment-fn2-3" icon={["learn"]}>
...
<Ability id="patronendurance-endurance-fn1-5" icon={["learn"]}>
...
<Ability id="patronentropy-entropy-fn6-3" icon={["learn"]}>
...
<Ability id="patronethereal-ethereal-fn7" icon={["learn"]}>
...
<Ability id="patronfate-fate-fn8" icon={["learn"]}>
...
<Ability id="patronhealing-healing-fn2-4" icon={["learn"]}>
...
<Ability id="patroninsanity-insanity-fn2-5" icon={["learn"]}>
...
<Ability id="patronjynx-jynx-fn9" icon={["learn"]}>
...
<Ability id="patronlight-light-fn2-6" icon={["learn"]}>
...
<Ability id="patronmercy-mercy-fn9-2" icon={["learn"]}>
...
<Ability id="patronmind-mind-fn7-2" icon={["learn"]}>
...
<Ability id="patronmoon-moon-fn2-7" icon={["learn"]}>
...
<Ability id="patronmountain-mountain-fn10" icon={["learn"]}>
...
<Ability id="patronnightmares-nightmares-fn6-4" icon={["learn"]}>
...
<Ability id="patronoccult-occult-fn2-8" icon={["learn"]}>
...
<Ability id="patronpeace-peace-fn5-3" icon={["learn"]}>
...
<Ability id="patronplague-plague-fn1-6" icon={["learn"]}>
...
<Ability id="patronplant-plant-fn11" icon={["learn"]}>
...
<Ability id="patronportents-portents-fn2-9" icon={["learn"]}>
...
<Ability id="patronprotection-protection-fn12" icon={["learn"]}>
...
<Ability id="patronrecovery-recovery-fn13" icon={["learn"]}>
...
<Ability id="patronrevenge-revenge-fn6-5" icon={["learn"]}>
...
<Ability id="patronrot-rot-fn9-3" icon={["learn"]}>
...
<Ability id="patronshadow-shadow-fn1-7" icon={["learn"]}>
...
<Ability id="patronspace-space-fn6-6" icon={["learn"]}>
...
<Ability id="patronspirits-spirits-fn2-10" icon={["learn"]}>
...
<Ability id="patronspring-spring-fn4-2" icon={["learn"]}>
...
<Ability id="patronstars-stars-fn2-11" icon={["learn"]}>
...
<Ability id="patronstorms-storms-fn10-2" icon={["learn"]}>
...
<Ability id="patronstrength-strength-fn1-8" icon={["learn"]}>
...
<Ability id="patronsummer-summer-fn10-3-fn4-3" icon={["learn"]}>
...
<Ability id="patronthorns-thorns-fn10-4-fn4-4" icon={["learn"]}>
...
<Ability id="patrontime-time-fn2-12" icon={["learn"]}>
...
<Ability id="patrontransformation-transformation-fn1-9" icon={["learn"]}>
...
<Ability id="patrontrickery-trickery-fn1-10" icon={["learn"]}>
...
<Ability id="patronvengeance-vengeance-fn2-13" icon={["learn"]}>
...
<Ability id="patronwater-water-fn1-11" icon={["learn"]}>
...
<Ability id="patronwinter-winter-fn2-14-fn4-5" icon={["learn"]}>
...
<Ability id="patronwisdom-wisdom-fn1-12" icon={["learn"]}>
...
<Ability id="patronwoodlands-woodlands-fn14" icon={["learn"]}>
...
<Ability id="patroncelestialagenda-celestial-agenda-fn15" icon={["power","down","learn"]}>
...
<Ability id="patronempath-empath-fn15-2" icon={["power","down","learn"]}>
...
<Ability id="patronfeygifts-fey-gifts-fn15-3" icon={["power","down","learn"]}>
...
<Ability id="patrongreenwhispers-green-whispers-fn15-4" icon={["power","down","learn"]}>
...
<Ability id="patronhagscalling-hags-calling-fn15-5" icon={["power","down","learn"]}>
...
<Ability id="patroninfernalcontract-infernal-contract-fn15-6" icon={["power","down","learn"]}>
...
<Ability id="patronshadowbound-shadowbound-fn15-7" icon={["power","down","learn"]}>
...
<Ability id="patrontheconditionofall-the-condition-of-all-fn15-8" icon={["power","down","learn"]}>
...
<Ability id="patrontouchedbytheoutergods-touched-by-the-outer-gods-fn15-9" icon={["power","down","learn"]}>
...
<hr/>
<Ability id="artificial-ascension" icon={["power"]}>
...
<Ability id="disease-transference-su" icon={["magic","aid"]}>
...
<Ability id="force-field-su" icon={["def"]}>
...
<Ability id="kinetic-enhancement" icon={["boost","def"]}>
...
<Ability id="laser-blast-su" icon={["zap"]}>
...
<Ability id="mind-over-augmentation" icon={["boost"]}>
...
<Ability id="psychic-battery-su" icon={["boost"]}>
...
<Ability id="radiation-resistance" icon={["def"]}>
...
<Ability id="techsmith" icon={["boost"]}>
...
<Ability id="talentbefuddlingstrike-befuddling-strike-ex-fn2" icon={["lower"]}>
...
<Ability id="talentbleedingattack-bleeding-attack-ex-fn3" icon={["boost"]}>
...
<Ability id="talentdistractingattack-distracting-attack-ex-fn2-2" icon={["lower"]}>
...
<Ability id="talentoffensivedefense-offensive-defense-ex-fn2-3" icon={["def"]}>
...
<Ability id="talentpowerfulsneak-powerful-sneak-ex-fn5" icon={["down","boost"]}>
...
<Ability id="talentsacredsneakattack-sacred-sneak-attack-su-fn6" icon={["boost"]}>
...
<Ability id="talentseveralignment-sever-alignment-su-fn7" icon={["lower"]}>
...
<Ability id="talentsilencingstrike-silencing-strike-su-fn8" icon={["lower"]}>
...
<Ability id="talentslowreactions-slow-reactions-ex-fn3-2" icon={["lower"]}>
...
<Ability id="talentsneakymaneuver-sneaky-maneuver-ex-fn9" icon={["melee"]}>
...
<Ability id="talentstemtheflow-stem-the-flow-su-fn6-2" icon={["lower"]}>
...
<Ability id="talentunderhanded-underhanded-ex-fn10" icon={["boost"]}>
...
<Ability id="talentalignedsneakattack-aligned-sneak-attack-su-fn7-2" icon={["lower"]}>
...
<Ability id="talentcarefulstab-careful-stab-ex-fn8-2" icon={["power"]}>
...
<Ability id="talentdemandattention-demand-attention-ex-fn11" icon={["lower"]}>
...
<Ability id="talentdisablingstunt-disabling-stunt-ex-fn12" icon={["boost"]}>
...
<Ability id="talentfastgetaway-fast-getaway-ex-fn2-4" icon={["power"]}>
...
<Ability id="talentsetup-set-up-ex-fn11-2" icon={["lower"]}>
...
<Ability id="talentsneaktraining-sneak-training-ex-fn13" icon={["boost"]}>
...
<Ability id="talentsniperseye-snipers-eye-ex-fn5-2" icon={["boost"]}>
...
<Ability id="talentsurpriseattack-surprise-attack-ex-fn14" icon={["lower"]}>
...
<Ability id="talentswimmingstunt-swimming-stunt-ex-fn12-2" icon={["lower"]}>
...
<Ability id="talentaccuratepoisoner-accurate-poisoner-ex-fn15" icon={["boost"]}>
...
<Ability id="talentdevelopedpoisonimmunity-developed-poison-immunity-ex-fn16" icon={["def"]}>
...
<Ability id="talentironguts-iron-guts-ex-fn17" icon={["def"]}>
...
<Ability id="talentknockoutqueen-knockout-queen-ex-fn8-3" icon={["power"]}>
...
<Ability id="talentlastingpoison-lasting-poison-ex-fn5-3" icon={["boost","down"]}>
...
<Ability id="talentlingeringpoison-lingering-poison-ex-fn15-2" icon={["power"]}>
...
<Ability id="talentsignaturepoison-signature-poison-ex-fn15-3" icon={["boost"]}>
...
<Ability id="talentsuppresspoison-suppress-poison-ex-fn15-4" icon={["def"]}>
...
<Ability id="talentswiftpoison-swift-poison-ex-fn5-4" icon={["boost"]}>
...
<Ability id="talenttoxicregurgitation-toxic-regurgitation-ex-fn15-5" icon={["zap"]}>
...
<Ability id="talentdeadlyscratch-deadly-scratch-ex-fn18" icon={["power"]}>
...
<Ability id="talentdisarmingluck-disarming-luck-ex-fn18-2" icon={["def","roll"]}>
...
<Ability id="talentgracefulfaller-graceful-faller-ex-fn18-3" icon={["power"]}>
...
<Ability id="talentnimbleclimbercatfolk-nimble-climber-ex-fn18-4" icon={["boost"]}>
...
<Ability id="talentsinglemindedappraiser-single-minded-appraiser-ex-fn18-5" icon={["power"]}>
...
<Ability id="talentviciousclaws-vicious-claws-ex-fn18-6" icon={["boost"]}>
...
<Ability id="talentcloyingshades-cloying-shades-su-fn19" icon={["lower"]}>
...
<Ability id="talentextraearthcraft-extra-earthcraft-fn20" icon={["boost"]}>
...
<Ability id="talentminormagic-minor-magic-sp-fn3-3" icon={["magic"]}>
...
<Ability id="talentdemonlantern-demon-lantern-sp-fn21" icon={["magic"]}>
...
<Ability id="talentinnocentfacade-innocent-facade-sp-fn22" icon={["magic"]}>
...
<Ability id="talentmajormagic-major-magic-sp-fn3-4" icon={["magic"]}>
...
<Ability id="talentoneofthosefaces-one-of-those-faces-sp-fn23" icon={["magic"]}>
...
<Ability id="talentwildmagic-wild-magic-sp-fn16-2" icon={["magic"]}>
...
<Ability id="talentexpertcypher-expert-cypher-ex-fn24" icon={["boost"]}>
...
<Ability id="talentoccultdungeoneer-occult-dungeoneer-su-fn25" icon={["magic","boost"]}>
...
<Ability id="talentspellstoring-spell-storing-su-fn25-2" icon={["magic"]}>
...
<Ability id="talentthewholetime-the-whole-time-su-fn25-3" icon={["magic","def"]}>
...
<Ability id="talentaspexiasmysticism-aspexias-mysticism-ex-fn8-4" icon={["power"]}>
...
<Ability id="talentblackmarketconnections-black-market-connection-ex-fn17-2" icon={["boost"]}>
...
<Ability id="talentbomber-bomber-su-fn26" extraClasses="hasSubs" icon={["power"]}>
...
<div className="abilityGroup">
<Ability id="talentbombersdiscovery-bombers-discovery-su-fn26-2" icon={["power"]}>
...
<Ability id="talenteldritchconduit-eldritch-conduit-su-fn25-4" icon={["magic"]}>
...
<Ability id="talentfollowalong-follow-along-ex-fn27" icon={["lower"]}>
...
<Ability id="talentgrigjig-grig-jig-su-fn21-2" icon={["magic"]}>
...
<Ability id="talentscryslip-scry-slip-su-fn22-2" icon={["def"]}>
...
<Ability id="talentscryingfamiliarity-scrying-familiarity-ex-fn28" icon={["def","roll"]}>
...
<Ability id="talentshadesofgray-shades-of-gray-ex-fn27-2" icon={["def"]}>
...
<Ability id="talentacrobaticassist-acrobatic-assist-ex-fn11-3" icon={["boost","protect"]}>
...
<Ability id="talentassaultleader-assault-leader-ex-fn2-5" icon={["melee"]}>
...
<Ability id="talentgotyourback-got-your-back-ex-fn11-4" icon={["boost"]}>
...
<Ability id="talentheadsup-heads-up-ex-fn11-5" icon={["boost"]}>
...
<Ability id="talentsacrificeself-sacrifice-self-ex-fn6-3" icon={["protect"]}>
...
<Ability id="talentshoveaside-shove-aside-ex-fn11-6" icon={["protect"]}>
...
<Ability id="talentacrobaticstunt-acrobatic-stunt-ex-fn12-3" icon={["def","down"]}>
...
<Ability id="talentcardsharp-card-sharp-su-fn21-3" icon={["power","ranged"]}>
...
<Ability id="talentcastling-castling-ex-fn20-2" icon={["def"]}>
...
<Ability id="talentcombatswipe-combat-swipe-fn2-6-fn29" icon={["power"]}>
...
</td></tr></tbody></table></ScrollContainer></div><Ability id="talentcombattrick-combat-trick-fn3-5" icon={["power"]}>
...
<Ability id="talentdeftpalm-deft-palm-ex-fn17-3" icon={["power"]}>
...
<Ability id="talentdiseaseuse-disease-use-fn30" icon={["power","melee"]}>
...
<Ability id="talenteeriedisappearance-eerie-disappearance-ex-fn31" icon={["power"]}>
...
<Ability id="talentescapingstunt-escaping-stunt-ex-fn12-4" icon={["def"]}>
...
<Ability id="talentfalseattacker-false-attacker-ex-fn31-2" icon={["power"]}>
...
<Ability id="talentfinesserogue-finesse-rogue-fn3-6" icon={["power"]}>
...
<Ability id="talentfirearmtraining-firearm-training-ex-fn17-4" icon={["power"]}>
...
<div className="abilityGroup">
<Ability id="talentgrit-grit-ex-fn17-5" icon={["power"]}>
...
<Ability id="talentflyingstunt-flying-stunt-ex-fn12-5" icon={["boost"]}>
...
<Ability id="talentfortifiedposition-fortified-position-ex-fn20-3" icon={["def"]}>
...
<Ability id="talentmaneuveringdodge-maneuvering-dodge-ex-fn32" icon={["boost"]}>
...
<Ability id="talentpositioningattack-positioning-attack-ex-fn5-5" icon={["melee"]}>
...
<Ability id="talentresiliency-resiliency-ex-fn3-7" icon={["aid"]}>
...
<Ability id="talentroguecrawl-rogue-crawl-ex-fn3-8" icon={["power"]}>
...
<Ability id="talentsleightofhandstunt-sleight-of-hand-stunt-ex-fn12-6" icon={["power"]}>
...
<Ability id="talentsnapshot-snap-shot-ex-fn5-6" icon={["ranged"]}>
...
<Ability id="talentstandup-stand-up-ex-fn3-9" icon={["power"]}>
...
<Ability id="talentstealthstunt-stealth-stunt-ex-fn12-7" icon={["lower"]}>
...
<Ability id="talentsuperiorsniper-superior-sniper-fn22-3" icon={["power"]}>
...
<Ability id="talentunbalancingtrick-unbalancing-trick-ex-fn20-4" icon={["power"]}>
...
<Ability id="talentweapontraining-weapon-training-fn14-2" icon={["power"]}>
...
<Ability id="talentwithoutatrace-without-a-trace-ex-fn26-3" icon={["def"]}>
...
<Ability id="talentcannyobserver-canny-observer-ex-fn2-7" icon={["boost"]}>
...
<Ability id="talentcunningtrigger-cunning-trigger-ex-fn2-8" icon={["power"]}>
...
<Ability id="talentquicktrapsmith-quick-trapsmith-ex-fn5-7" icon={["power"]}>
...
<Ability id="talenttrapspotter-trap-spotter-ex-fn14-3" icon={["power"]}>
...
<Ability id="talentfastpicks-fast-picks-ex-fn2-9" icon={["boost"]}>
...
<Ability id="talenthairpintrick-hairpin-trick-ex-fn8-5" icon={["boost"]}>
...
<Ability id="talentlastditcheffort-last-ditch-effort-fn33" icon={["def"]}>
...
<Ability id="talentpapercrafttools-papercraft-tools-ex-fn34" icon={["power"]}>
...
<Ability id="talentquickdisable-quick-disable-ex-fn3-10" icon={["boost"]}>
...
<Ability id="talentcamouflage-camouflage-ex-fn2-10" icon={["power","def"]}>
...
<Ability id="talentcharmer-charmer-ex-fn2-11" icon={["roll"]}>
...
<Ability id="talentcoaxinformation-coax-information-ex-fn35" icon={["boost"]}>
...
<Ability id="talentconvincinglie-convincing-lie-ex-fn17-6" icon={["boost"]}>
...
<Ability id="talentdampenpresence-dampen-presence-fn22-4" icon={["power"]}>
...
<Ability id="talentfaceinthecrowd-face-in-the-crowd-fn30-2" icon={["boost"]}>
...
<Ability id="talentfalsefriend-false-friend-ex-fn36" icon={["boost"]}>
...
<Ability id="talentfastfingers-fast-fingers-ex-fn2-12" icon={["roll"]}>
...
<Ability id="talentfaststealth-fast-stealth-ex-fn3-11" icon={["boost"]}>
...
<Ability id="talenthoneyedwords-honeyed-words-ex-fn5-8" icon={["roll"]}>
...
<Ability id="talentinnocuousservant-innocuous-servant-ex-fn32-2" icon={["boost"]}>
...
<Ability id="talentjustafaceinthecrowd-just-a-face-in-the-crowd-su-fn25-5" icon={["boost"]}>
...
<Ability id="talentobfuscatestory-obfuscate-story-ex-fn36-2" icon={["lower"]}>
...
<div className="abilityGroup">
<Ability id="talentstealthestory-steal-the-story-ex-fn36-3" icon={["lower"]}>
...
<Ability id="talentquickdisguise-quick-disguise-ex-fn5-9" icon={["boost"]}>
...
<Ability id="talentrapidboost-rapid-boost-ex-fn34-2" icon={["roll"]}>
...
<Ability id="talentsczarnismuggler-sczarni-smuggler-ex-fn32-3" icon={["power","boost"]}>
...
<Ability id="talentscavenger-scavenger-fn30-3" icon={["power","boost"]}>
...
<Ability id="talentterrainmastery-terrain-mastery-ex-fn10-2" icon={["power"]}>
...
<Ability id="talentbardicpretender-bardic-pretender-ex-fn13-2" icon={["power"]}>
...
<Ability id="talentclaimedturf-claimed-turf-ex-fn32-4" icon={["power"]}>
...
<Ability id="talentclimbingstunt-climbing-stunt-ex-fn12-8" icon={["power"]}>
...
<Ability id="talentesotericscholar-esoteric-scholar-ex-fn17-7" icon={["power"]}>
...
<Ability id="talentexpertleaper-expert-leaper-ex-fn2-13" icon={["boost","def"]}>
...
<Ability id="talentfavoredterrain-favored-terrain-ex-fn16-3" icon={["power"]}>
...
<Ability id="talentfollowclues-follow-clues-ex-fn2-14" icon={["boost"]}>
...
<Ability id="talentgetawayartist-getaway-artist-ex-fn17-8" icon={["skill","boost"]}>
...
<Ability id="talentgracefulathlete-graceful-athlete-fn37" icon={["power"]}>
...
<Ability id="talentgreentongue-green-tongue-ex-fn16-4" icon={["power"]}>
...
<Ability id="talentguilefulpolyglot-guileful-polyglot-ex-fn2-15" icon={["power"]}>
...
<Ability id="talenthardtofool-hard-to-fool-ex-fn2-16" icon={["roll"]}>
...
<Ability id="talentholdbreath-hold-breath-ex-fn17-9" icon={["boost"]}>
...
<Ability id="talentkipool-ki-pool-ex-fn17-10" icon={["power","boost"]}>
...
<Ability id="talentledgewalker-ledge-walker-ex-fn3-12" icon={["power","def"]}>
...
<Ability id="talentninjatrick-ninja-trick-ex-fn10-3" icon={["power"]}>
...
<Ability id="talentpeerlessmaneuver-peerless-maneuver-ex-fn5-10" icon={["roll"]}>
...
<Ability id="talentphilologist-philologist-fn33-2" icon={["roll","boost"]}>
...
<Ability id="talentquickscrounge-quick-scrounge-fn30-4" icon={["boost"]}>
...
<Ability id="talentrapidperception-rapid-perception-su-fn22-5" icon={["boost"]}>
...
<Ability id="talentridingstunt-riding-stunt-ex-fn12-9" icon={["boost"]}>
...
<Ability id="talentropemaster-rope-master-ex-fn10-4" icon={["boost"]}>
...
<Ability id="talentstrongimpression-strong-impression-fn5-11" icon={["power"]}>
...
<Ability id="talentstrongstroke-strong-stroke-ex-fn10-5" icon={["roll","boost"]}>
...
<Ability id="talentsurvivalist-survivalist-fn5-12" icon={["skill"]}>
...
<Ability id="talentswifttracker-swift-tracker-ex-fn16-5" icon={["boost"]}>
...
<Ability id="talentthrillofthechase-thrill-of-the-chase-ex-fn32-5" icon={["roll","power"]}>
...
<Ability id="talentwallscramble-wall-scramble-ex-fn10-6" icon={["roll","boost"]}>
...
<hr/>
<Ability id="shamanhexchant-chant-su-fn1" icon={["boost"]}>
...
<Ability id="shamanhexcharm-charm-su-fn1-2" icon={["magic"]}>
...
<Ability id="shamanhexdraconicresilience-draconic-resilience-ex-fn2" icon={["protect"]}>
...
<Ability id="shamanhexevileye-evil-eye-su-fn1-3" icon={["lower"]}>
...
<Ability id="shamanhexfetish-fetish-ex-fn1-4" icon={["power","boost"]}>
...
<Ability id="shamanhexfortune-fortune-su-fn1-5" icon={["roll"]}>
...
<Ability id="shamanhexfury-fury-su-fn1-6" icon={["boost","def"]}>
...
<Ability id="shamanhexhealing-healing-su-fn3" icon={["aid"]}>
...
<Ability id="shamanhexintimidatingdisplay-intimidating-display-ex-fn2-2" icon={["power"]}>
...
<Ability id="shamanhexmisfortune-misfortune-su-fn3-2" icon={["roll","lower"]}>
...
<Ability id="shamanhexsecret-secret-ex-fn3-3" icon={["power"]}>
...
<Ability id="shamanhexshapeshift-shapeshift-su-fn3-4" icon={["magic"]}>
...
<Ability id="shamanhexsilkstringsnare-silkstring-snare-su-fn4" icon={["lower"]}>
...
<Ability id="shamanhextongues-tongues-su-fn3-5" icon={["power"]}>
...
<Ability id="shamanhexward-ward-su-fn3-6" icon={["protect"]}>
...
<Ability id="shamanhexwings-wings-su-fn2-3" icon={["power"]}>
...
<Ability id="shamanhexwitchhex-witch-hex-fn3-7" icon={["power"]}>
...
<hr/>
<Ability id="soctalentalwaysprepared-always-prepared-ex-fn1" icon={["power"]}>
...
<Ability id="soctalentancestralenlightenment-ancestral-enlightenment-ex-fn2" icon={["boost"]}>
...
<Ability id="soctalentbeginnersluck-beginners-luck-ex-fn3" icon={["boost"]}>
...
<Ability id="soctalentbellflowerinnuendo-bellflower-innuendo-ex-fn4" icon={["power","boost"]}>
...
<Ability id="soctalentcasethejoint-case-the-joint-ex-fn5" icon={["power","roll"]}>
...
<Ability id="soctalentcompaniontothelonely-companion-to-the-lonely-ex-fn4-2" icon={["power","roll","boost","def"]}>
...
<Ability id="soctalentconflictedidentity-conflicted-identity-ex-fn3-2" icon={["def"]}>
...
<Ability id="soctalentdoubletime-double-time-ex-fn6" icon={["boost"]}>
...
<div className="abilityGroup">
<Ability id="soctalentinvogue-in-vogue-ex-fn6-2" icon={["boost"]}>
...
<Ability id="soctalententrepreneur-entrepreneur-ex-fn7" icon={["power","boost"]}>
...
<Ability id="soctalentgossipcollector-gossip-collector-ex-fn6-3" icon={["power","boost"]}>
...
<Ability id="soctalentguiseoflife-guise-of-life-su-fn7-2" icon={["power"]}>
...
<Ability id="soctalentguiseofunlife-guise-of-unlife-su-fn7-3" icon={["power"]}>
...
<Ability id="soctalenthiddenmagic-hidden-magic-ex-fn3-3" icon={["def"]}>
...
<Ability id="soctalentintriguefeats-intrigue-feats-ex-fn8" icon={["power"]}>
...
<Ability id="soctalentkalistocratsacumen-kalistocrats-acumen-ex-fn4-3" icon={["warning","boost"]}>
...
<Ability id="soctalentmanyguises-many-guises-ex-fn9" icon={["power"]}>
...
<div className="abilityGroup">
<Ability id="soctalenteveryman-everyman-ex-fn6-4" icon={["power","boost"]}>
...
<div className="abilityGroup">
<Ability id="soctalentanyguise-any-guise-su-fn5-2" icon={["power"]}>
...
<Ability id="soctalentmockingbird-mockingbird-ex-fn9-2" icon={["power","magic"]}>
...
<Ability id="soctalentmorphicmask-morphic-mask-su-fn1-2" icon={["power","boost"]}>
...
<Ability id="soctalentnotoriousfool-notorious-fool-ex-fn3-4" icon={["def"]}>
...
<Ability id="soctalentobscurity-obscurity-ex-fn10" icon={["def"]}>
...
<Ability id="soctalentowlssight-owls-sight-ex-fn11" icon={["power","boost"]}>
...
<Ability id="soctalentquickchange-quick-change-ex-fn9-3" icon={["boost","def"]}>
...
<div className="abilityGroup">
<Ability id="soctalentimmediatechange-immediate-change-ex-fn6-5" icon={["boost"]}>
...
<Ability id="renown-ex" icon={["boost"]}>
...
<div className="abilityGroup">
<Ability id="soctalentcelebritydiscount-celebrity-discount-ex-fn5-3" icon={["boost"]}>
...
<Ability id="soctalentcelebrityperks-celebrity-perks-ex-fn6-6" icon={["boost"]}>
...
<Ability id="soctalentdiscreetinquiries-discreet-inquiries-ex-fn4-4" icon={["def"]}>
...
<Ability id="soctalentfeigninnocence-feign-innocence-ex-fn6-7" icon={["def"]}>
...
<div className="abilityGroup">
<Ability id="soctalentsubjectivetruth-subjective-truth-ex-fn12" icon={["def"]}>
...
<Ability id="soctalentgreatrenown-great-renown-ex-fn6-8" icon={["boost"]}>
...
<div className="abilityGroup">
<Ability id="soctalentincrediblerenown-incredible-renown-ex-fn6-9" icon={["boost"]}>
...
<div className="abilityGroup">
<Ability id="soctalentinstantrecognition-instant-recognition-ex-fn6-10" icon={["boost"]}>
...
<Ability id="loyal-aid-ex" icon={["power","boost","def"]}>
...
<Ability id="soctalenttriumphantreturn-triumphant-return-ex-fn12-2" icon={["boost"]}>
...
<Ability id="soctalentsafehouse-safe-house-ex-fn9-5" icon={["power","def"]}>
...
<Ability id="soctalentseemlessshapechanger-seemless-shapechanger-ex-fn10-2" icon={["def"]}>
...
<Ability id="soctalentskillfamiliarity-skill-familiarity-ex-fn2-2" icon={["power","boost"]}>
...
<Ability id="soctalentsocialgrace-social-grace-ex-fn9-6" icon={["boost"]}>
...
<Ability id="soctalentsongbird-songbird-su-fn11-2" icon={["magic","skill"]}>
...
<div className="abilityGroup">
<Ability id="soctalentbeastfriend-beast-friend-su-fn11-3" icon={["magic"]}>
...
<Ability id="soctalentbeastspeech-beast-speech-su-fn11-4" icon={["magic"]}>
...
<Ability id="soctalenttransformationsequence-transformation-sequence-su-fn10-3" icon={["boost","down"]}>
...
<Ability id="well-known-expert-ex" icon={["power","boost"]}>
