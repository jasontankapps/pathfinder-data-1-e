...
<Pair single="benefit" id="ancient-explorer-benefit">You gain a +1 trait bonus on Knowledge (history) and Knowledge (local) checks, and one of these skills is a class skill for you. In addition, you gain Cyclops or Polyglot as a bonus language.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="barroom-talespinner-benefit">You gain a +1 trait bonus on Diplomacy checks and one category of Perform checks, and one of these skills is a class skill for you. In addition, once per week you can make a DC 15 Knowledge (local) or Intelligence check to see if you know a popular legendary pirate tale, the telling of which grants you a +1 trait bonus on checks made to influence NPCs on the Wormwood.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="besmaras-blessing-benefit">You gain a +1 trait bonus on Perception and Profession (sailor) checks. In addition, once per week you can reroll a Profession (sailor) check and take the higher result (you must announce that you are using this ability before the results of the check are known).</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="buccaneers-blood-benefit">You gain a +1 trait bonus on Intimidate and Profession (sailor) checks. In addition, you gain a one-time +1 trait bonus to your <Link to="/rule/fame">Disrepute and Infamy</Link> scores.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="dockside-brawler-benefit">You gain a +1 trait bonus on damage rolls with <Link to="/eq-weapon/brass_knuckles">brass knuckles</Link> and improvised weapons. Fortunately, you were able to conceal your brass knuckles when you were press-ganged, and you begin the campaign with them, regardless of your starting circumstances.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="eye-for-plunder-benefit">You gain a +1 trait bonus on Appraise and Perception checks to find concealed or secret objects (including doors and traps). In addition, you begin the campaign with a selection mundane trade goods worth 50 gp that you were able to scrounge together during your first day on the Wormwood.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="enduring-stoicism-benefit">You gain a +2 trait bonus on all saving throws against spells or effects with the fear or emotion descriptors. In addition, you gain a +1 trait bonus on Intimidate checks due to your intimidating presence, as people don't know what to expect from you.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="foe-of-the-strange-benefit">You gain a +1 trait bonus on saving throws against extraordinary, spell-like, and supernatural abilities of aberrations (for example, a <Link to="/monster/gibbering_mouther">gibbering mouther's gibbering</Link> or an <Link to="/monster/intellect_devourer">intellect devourer's confusion</Link>). In addition, whenever you're confused and roll to determine behavior in a given round, subtract 10 from the result.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="formerly-mind-swapped-benefit">Once per day, you can reroll one Knowledge check that you have just failed. In addition, you can attempt untrained Knowledge checks with DCs up to 20 instead of 10.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="the-snoop-benefit">You gain a +1 trait bonus on <Link to="/skill/knowledge_history">Knowledge (history)</Link> and <Link to="/skill/knowledge_local">Knowledge (local)</Link> checks, and these both become class skills for you. Once each day you can reroll a single Bluff or Sense Motive check against a creature you have known for at least 24 hours, using the better result.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="child-of-oppara-benefit">You gain a +1 trait bonus on Appraise and Knowledge (nobility) checks, and one of these skills is always a class skill for you. The Noble Scion feat does not have a Charisma prerequisite for you. In addition, you start play with a <Link to="/eq-misc/nobles_outfit">noble's outfit</Link>, a <Link to="/eq-misc/signet_ring">signet ring</Link>, and a single additional nonmagical item worth no more than 200 gp.</Pair>
</Ability>
</>};
...
<p>Once each week you can call on family connections to obtain a single piece of equipment or consumable magic item (such as a potion or scroll) worth up to your character level &times; 25 gp. Delivery of the goods you request takes 1d4 days. At 10th level, the potential value of a magical item increases to your character level &times; 50 gp, and your requests can also include spellcasting services and wands.</p>
</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="touched-by-divinity-benefit"><p>You begin play with a silver holy symbol of your chosen deity for free. In addition, choose one domain associated with your chosen deity. You gain the use of that domain's 1st-level domain spell as a spell-like ability usable once per day (CL equals your character level).</p>
...
<Pair single="benefit" id="black-sheep-benefit"><p>You gain a +1 trait bonus on Knowledge (local) checks, and Knowledge (local) is a class skill for you. In addition, you can choose any one notorious citizen from below as an ally; depending on the person you pick, you'll get different benefits.</p>
<ul>
...
<Pair single="benefit" id="favored-son-or-daughter-benefit"><p>You gain a +1 trait bonus on Knowledge (local) checks, and Knowledge (local) is always a class skill for you. In addition, you can choose any one law-abiding citizen of Sandpoint from below as an ally; depending on the person you pick, you'll get different benefits.</p>
<ul>
...
<Pair title="Type">Equipment</Pair>
<Pair single="benefit" id="iron-liver-benefit">Due to a lucky constitution or frequent exposure, your body is resistant to poison, including alcohol and drugs. You gain a +2 trait bonus on Fortitude saves against poison and drugs, and a +4 trait bonus on Fortitude saves to avoid the effects of alcohol.</Pair>
</Ability>
</>};
...
<Pair title="Type">Equipment</Pair>
<Pair single="benefit" id="power-of-suggestion-benefit">People trust your words over their own eyes. You may make a Bluff check to make observers believe that an object in your possession is actually a different object entirely. The DC for the check is 20 for items of a similar size, shape, and color (such as a glaive and a quarterstaff). Items of a different shape, size, or color raise the DC by 5 for each dissimilar aspect, or more if the dissimilarity is extreme. This deception lasts 1 minute; if the item is still in view, the observers may recognize their error unless you make another bluff check.</Pair>
</Ability>
</>};
...
<Pair title="Type">Equipment</Pair>
<Pair single="benefit" id="prehensile-whip-benefit">In your hand a whip has a life of its own, wrapping around pillars and beams with ease. You can use a whip as if it were a rope with a grappling hook at the end. Attaching your whip is a standard action, but detaching it is a full-round action.</Pair>
</Ability>
</>};
...
<Pair title="Type">Equipment</Pair>
<Pair single="benefit" id="rough-and-ready-benefit">Your intense familiarity with the tools of your trade allows you to use them in combat as if they were actual weapons and makes them more effective for that purpose than they would normally be. When you use a tool of your trade (requiring at least 1 rank in the appropriate Craft or Profession skill) as a weapon, you do not take the improvised weapon penalty and instead receive a +1 trait bonus on your attack. This trait is commonly used with shovels, picks, blacksmith hammers, and other sturdy tools - lutes and brooms make terribly fragile weapons.</Pair>
</Ability>
</>};
...
<Pair title="Type">Equipment</Pair>
<Pair single="benefit" id="thrown-together-fashion-benefit">You can modify old clothing to make it effective in new circumstances. With a basic sewing kit or disguise kit, you can make a Disguise check to change one outfit into another outfit. The DC of this check is equal to 10 + the gp difference between costs of the outfits, as found in the <Link to="/main/equipment_misc">outfits' entries</Link>. The alteration takes 10 minutes per 1-gp difference in the cost of the outfits.</Pair>
</Ability>
</>};
...
<Pair title="Type">Family</Pair>
<Pair single="benefit" id="blood-resonance-benefit">Select one racial, inherited template (such as half-dragon), or bloodline ability you can currently use at least three times each day. Once per day when you are within 60 feet of another character with this family trait who shares the race, template, or bloodline, you can use the selected ability without it counting against your normal daily limit.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="black-as-night-benefit">While astride a fell pony, you gain a +1 trait bonus on attack rolls against enemies you are flanking.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="burst-of-speed-benefit">Three times per day, while riding a Dort charger and making a charge attack, you can increase your mount's speed by 15 feet as a free action.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="cunning-breed-benefit">A Taldor jennet can learn a total of eight tricks when trained using the Handle Animal skill (as opposed to the standard six for having an Intelligence score of 2).</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="fleet-of-foot-benefit">While riding a chiardmar, you treat your mount's base speed as +10 feet faster for the purpose of using the run or withdraw actions.</Pair>
</Ability>
</>};
const _keleshite_trade_camel = {title: "Keleshite Trade Camel", topLink: ["Mount Traits","main/traits_mount"], jsx: <><p><strong>Sources</strong> <Link to="/source/wilderness_origins">Wilderness Origins</Link></p>
<Ability id="keleshite-trade-camel" extraClasses="trait" icon={["cavalry"]}>
<Pair single id="keleshite-trade-camel">Keleshite Trade Camel</Pair>
<Pair title="Type">Mount</Pair>
<Pair title="Requirements" hl>Have a camel as a mount</Pair>
<Pair single="benefit" id="keleshite-trade-camel-benefit">Once per hour, a Keleshite trade camel can regurgitate the contents of its stomach, spitting the foul material at a single target within 10 feet as a ranged touch attack. The target must succeed at a Fortitude save (DC = 10 + half the camel's Hit Dice + the camel's Constitution modifier) or be nauseated for 1 round.</Pair>
</Ability>
</>};
const _lucky_hound = {title: "Lucky Hound", topLink: ["Mount Traits","main/traits_mount"], jsx: <><p><strong>Sources</strong> <Link to="/source/wilderness_origins">Wilderness Origins</Link></p>
<Ability id="lucky-hound" extraClasses="trait" icon={["cavalry"]}>
<Pair single id="lucky-hound">Lucky Hound</Pair>
<Pair title="Type">Mount</Pair>
<Pair title="Requirements" hl>Have a riding dog as a mount</Pair>
<Pair single="benefit" id="lucky-hound-benefit">Lucky hounds gain a +1 luck bonus on saves against spells or effects with the evil descriptor or which originate from evil outsiders or undead.</Pair>
</Ability>
</>};
const _mindspin_mountain_goat = {title: "Mindspin Mountain Goat", topLink: ["Mount Traits","main/traits_mount"], jsx: <><p><strong>Sources</strong> <Link to="/source/wilderness_origins">Wilderness Origins</Link></p>
<Ability id="mindspin-mountain-goat" extraClasses="trait" icon={["cavalry"]}>
<Pair single id="mindspin-mountain-goat">Mindspin Mountain Goat</Pair>
<Pair title="Type">Mount</Pair>
<Pair title="Requirements" hl>Have a ram as a mount</Pair>
<Pair single="benefit" id="mindspin-mountain-goat-benefit">Mindspin mountain goats gain a +2 trait bonus on Climb checks, and Climb is a class skill for them.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="relentless-fortitude-benefit">Qadiran dromedaries heal nonlethal damage at a rate of 2 hit points per hour per Hit Die. This trait does not stack with other effects that increase a creature's rate of healing nonlethal damage.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="stalwart-elk-benefit">While riding a Chernasardo riding elk, you gain a +4 trait bonus on Handle Animal, Ride, and <Link to="/ability/wild_empathy">wild empathy</Link> checks to resist another creature's unnatural aura.</Pair>
</Ability>
</>};
const _warthog = {title: "Warthog", topLink: ["Mount Traits","main/traits_mount"], jsx: <><p><strong>Sources</strong> <Link to="/source/wilderness_origins">Wilderness Origins</Link></p>
<Ability id="warthog" extraClasses="trait" icon={["cavalry"]}>
<Pair single id="warthog">Warthog</Pair>
<Pair title="Type">Mount</Pair>
<Pair title="Requirements" hl>Have a boar as a mount</Pair>
<Pair single="benefit" id="warthog-benefit">Warthogs are quicker than they look, with a base speed of 45 feet instead of the boar's 40 feet.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="water-trained-benefit">Lastwall jaspers gain a +2 trait bonus on Swim checks, and Swim is a class skill for them.</Pair>
</Ability>
</>};
...
<Pair single="benefit" id="weather-beaten-benefit">Erutaki huskies gain a +4 trait bonus on Fortitude saves to avoid nonlethal damage from cold environments, and only take a -2 penalty on Perception checks made in inclement weather such as rain or snow (instead of the usual -4 penalty).</Pair>
</Ability>
</>};
