...
<Ability id="arrow-champions-panache-ex" icon={["info"]}>
<Pair single id="arrow-champions-panache-ex">Arrow Champion's Panache (Ex)</Pair>
...
<Ability id="okayo-panache-ex" icon={["info"]}>
<Pair single id="okayo-panache-ex">Okayo Panache (Ex)</Pair>
<Pair hl title="Alters">Panache</Pair>
