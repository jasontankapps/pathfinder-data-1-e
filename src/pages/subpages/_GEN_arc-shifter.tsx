...
<Ability id="mudslide-su" extraClasses="subAbility" icon={["aura"]}>
<Pair single id="mudslide-su">Mudslide (Su)</Pair>
...
<Ability id="sandstorm-su" extraClasses="subAbility" icon={["aura"]}>
<Pair single id="sandstorm-su">Sandstorm (Su)</Pair>
...
<Ability id="steam-cloud-su" extraClasses="subAbility" icon={["aura"]}>
...
<Ability id="natural-strikes-ex" icon={["info"]}>
<Pair single id="natural-strikes-ex">Natural Strikes (Ex)</Pair>
<Pair hl title="Alters">Shifter claws</Pair>
