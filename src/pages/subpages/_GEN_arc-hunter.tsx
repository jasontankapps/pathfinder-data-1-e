...
<Ability id="animal-focus-su" extraClasses="hasSubs" icon={["info"]}>
...
<Ability id="crab" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="crab">Crab</Pair>
...
<Ability id="dolphin" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="dolphin">Dolphin</Pair>
...
<Ability id="eel" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="eel">Eel</Pair>
...
<Ability id="manta-ray" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="manta-ray">Manta Ray</Pair>
...
<Ability id="octopus" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="octopus">Octopus</Pair>
...
<Ability id="orca" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="orca">Orca</Pair>
<Pair title="Passive Ability">The creature gains a +2 enhancement bonus to Strength</Pair>
<Pair title="At 8th Level">This bonus increases to +4.</Pair>
<Pair title="At 15th Level">It increases to +6.</Pair>
</Ability>
<Ability id="shark" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="shark">Shark</Pair>
...
<Ability id="snake" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="turtle" extraClasses="subAbility" icon={["def"]}>
<Pair single id="turtle">Turtle</Pair>
...
<Ability id="wild-empathy-ex" icon={["down","power"]}>
...
<Ability id="oceanic-defense-ex" icon={["def"]}>
<Pair single id="oceanic-defense-ex">Oceanic Defense (Ex)</Pair>
...
<Ability id="shifting-companion-su" icon={["magic"]}>
...
<Ability id="terrain-chameleon-su" icon={["boost"]}>
<Pair single id="terrain-chameleon-su">Terrain Chameleon (Su)</Pair>
...
<Ability id="savage-diplomacy-ex" icon={["boost"]}>
<Pair single id="savage-diplomacy-ex">Savage Diplomacy (Ex)</Pair>
...
<Ability id="animal-shape-su" icon={["magic"]}>
<Pair single id="animal-shape-su">Animal Shape (Su)</Pair>
...
<Ability id="improved-shifting-companion-su" extraClasses="hasSubs" icon={["magic"]}>
<Pair single id="improved-shifting-companion-su">Improved Shifting Companion (Su)</Pair>
...
<Ability id="one-with-the-wild-ex" icon={["boost"]}>
...
<Ability id="scapegoat-ex" icon={["lower"]}>
...
<Ability id="backstabber-ex" icon={["boost"]}>
<Pair single id="backstabber-ex">Backstabber (Ex)</Pair>
...
<Ability id="master-backstabber-ex" icon={["power"]}>
<Pair single id="master-backstabber-ex" flavor="A colluding scoundrel becomes a master at dispatching distracted targets.">Master Backstabber (Ex)</Pair>
...
<Ability id="courtly-companion" icon={["power"]}>
<Pair single id="courtly-companion">Courtly Companion</Pair>
...
<Ability id="refined-focus-su" extraClasses="hasSubs" icon={["power"]}>
<Pair single id="refined-focus-su">Refined Focus (Su)</Pair>
<Pair hl title="Alters">Animal focus</Pair>
...
<Ability id="beaver" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="beaver">Beaver</Pair>
...
<Ability id="chameleon" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="eagle" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="eagle">Eagle</Pair>
...
<Ability id="fox" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="fox">Fox</Pair>
<Pair title="Passive Ability">The creature gains a +4 competence bonus on Bluff checks.</Pair>
<Pair title="At 8th Level">This bonus becomes +6.</Pair>
<Pair title="At 15th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="frilled-lizard" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="frilled-lizard">Frilled Lizard</Pair>
...
<Ability id="raccoon" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="raccoon">Raccoon</Pair>
<Pair title="Passive Ability">The creature gains a +4 competence bonus on Sleight of Hand checks.</Pair>
<Pair title="At 8th Level">This bonus becomes +6.</Pair>
<Pair title="At 15th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="songbird" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="songbird">Songbird</Pair>
<Pair title="Passive Ability">The creature gains a +4 competence bonus on Perform checks.</Pair>
<Pair title="At 8th Level">This bonus becomes +6.</Pair>
<Pair title="At 15th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="subtle-companion-su" icon={["magic"]}>
<Pair single id="subtle-companion-su">Subtle Companion (Su)</Pair>
<Pair hl title="Replaces">Precise companion</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="skill-bond-ex" icon={["power"]}>
<Pair single id="skill-bond-ex">Skill Bond (Ex)</Pair>
...
<Ability id="alternate-form-su" icon={["magic"]}>
<Pair single id="alternate-form-su">Alternate Form (Su)</Pair>
...
<Ability id="otherworldly-companion-su" icon={["magic"]}>
<Pair single id="otherworldly-companion-su">Otherworldly Companion (Su)</Pair>
...
<Ability id="feral-focus-su" icon={["power"]}>
...
<Ability id="precise-summoned-animal-ex" icon={["power"]}>
<Pair single id="precise-summoned-animal-ex">Precise Summoned Animal (Ex)</Pair>
...
<Ability id="summon-pack-sp" icon={["boost"]}>
<Pair single id="summon-pack-sp">Summon Pack (Sp)</Pair>
...
<Ability id="animal-focus-su" extraClasses="hasSubs" icon={["power"]}>
<Pair single id="animal-focus-su">Animal Focus (Su)</Pair>
<Pair hl title="Alters">Animal focus</Pair>
...
<Ability id="crow" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="crow">Crow</Pair>
<Pair title="Passive Ability">The creature gains a +4 competence bonus on Knowledge checks to identify the abilities and weaknesses of creatures.</Pair>
<Pair title="At 8th Level">This bonus becomes +6.</Pair>
<Pair title="At 15th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="goat" extraClasses="subAbility" icon={["def"]}>
<Pair single id="goat">Goat</Pair>
...
<Ability id="mongoose" extraClasses="subAbility" icon={["boost","def"]}>
<Pair single id="mongoose">Mongoose</Pair>
...
<Ability id="iron-talons-ex" icon={["boost"]}>
<Pair single id="iron-talons-ex" flavor="Through training and prayer, a feykiller imbues her animal companion with an enhanced ability to fight fey.">Iron Talons (Ex)</Pair>
...
<Ability id="grounded-su" icon={["def"]}>
<Pair single id="grounded-su">Grounded (Su)</Pair>
...
<Ability id="twin-hunters-ex" icon={["power"]}>
<Pair single id="twin-hunters-ex">Twin Hunters (Ex)</Pair>
<Pair hl title="Replaces">Hunter tactics</Pair>
...
<Ability id="skilled-ambusher-ex" icon={["power"]}>
<Pair single id="skilled-ambusher-ex">Skilled Ambusher (Ex)</Pair>
...
<Ability id="watery-stride-ex" icon={["power","def"]}>
<Pair single id="watery-stride-ex">Watery Stride (Ex)</Pair>
<Pair hl title="Replaces">Woodland stride</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="water-striker-ex" icon={["power"]}>
<Pair single id="water-striker-ex">Water Striker (Ex)</Pair>
...
<Ability id="submerged-stealth-ex" icon={["boost","power"]}>
<Pair single id="submerged-stealth-ex">Submerged Stealth (Ex)</Pair>
...
<Ability id="aquatic-action-ex" icon={["power"]}>
...
<Ability id="sudden-strike-ex" icon={["power"]}>
<Pair single id="sudden-strike-ex">Sudden Strike (Ex)</Pair>
...
<Ability id="fast-submerged-stealth-ex" icon={["power"]}>
<Pair single id="fast-submerged-stealth-ex">Fast Submerged Stealth (Ex)</Pair>
...
<Ability id="fast-swimmer-ex" icon={["boost"]}>
...
<Ability id="bonus-feat-ex" icon={["power"]}>
...
<Ability id="favored-terrain-ex" icon={["power","boost"]}>
...
<Ability id="breath-of-life-sp" icon={["magic"]}>
<Pair single id="breath-of-life-sp">Breath of Life (Sp)</Pair>
<Pair hl title="Replaces">Raise animal companion</Pair>
<Pair title="Gained">At 10th Level</Pair>
...
<Ability id="hide-in-plain-sight-ex" icon={["power"]}>
...
<Ability id="pack-bond-ex" icon={["power"]}>
...
<Ability id="pack-focus-su" icon={["info"]}>
<Pair single id="pack-focus-su">Pack Focus (Su)</Pair>
<Pair hl title="Replaces">Animal focus</Pair>
...
<Ability id="second-pack-focus-su" icon={["power"]}>
<Pair single id="second-pack-focus-su">Second Pack Focus (Su)</Pair>
<Pair hl title="Replaces">Second animal focus</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="master-of-the-pack-ex" icon={["power","boost"]}>
<Pair single id="master-of-the-pack-ex">Master of the Pack (Ex)</Pair>
<Pair hl title="Replaces">Master hunter</Pair>
...
<Ability id="snare-trap-ex-or-su" icon={["power"]}>
<Pair single id="snare-trap-ex-or-su">Snare Trap (Ex or Su)</Pair>
<Pair hl title="Replaces">Hunter tactics</Pair>
...
<Ability id="additional-traps-ex-or-su" icon={["power"]}>
<Pair single id="additional-traps-ex-or-su">Additional Traps (Ex or Su)</Pair>
<Pair hl title="Replaces">Teamwork feats</Pair>
<Pair title="Gained">At 3rd Level</Pair>
...
<Ability id="launch-trap-su" icon={["power"]}>
<Pair single id="launch-trap-su">Launch Trap (Su)</Pair>
<Pair hl title="Replaces">Raise animal companion</Pair>
<Pair title="Gained">At 10th Level</Pair>
...
<Ability id="pelagic-companion" icon={["down"]}>
<Pair single id="pelagic-companion">Pelagic Companion</Pair>
<Pair hl title="Alters">Animal companion</Pair>
<Pair title="Choice">A pelagic hunter must select an aquatic animal companion.</Pair>
</Ability>
<Ability id="pelagic-focus-su" extraClasses="hasSubs" icon={["power"]}>
<Pair single id="pelagic-focus-su">Pelagic Focus (Su)</Pair>
<Pair hl title="Alters">Animal focus</Pair>
...
<Ability id="aboleth" extraClasses="subAbility" icon={["def"]}>
<Pair single id="aboleth">Aboleth</Pair>
...
<Ability id="cetus" extraClasses="subAbility" icon={["power"]}>
<Pair single id="cetus">Cetus</Pair>
...
<Ability id="charybdis" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="charybdis">Charybdis</Pair>
...
<Ability id="deep-one" extraClasses="subAbility" icon={["def"]}>
<Pair single id="deep-one">Deep One</Pair>
...
<Ability id="hippocampus" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="hippocampus">Hippocampus</Pair>
<Pair title="Passive Ability">The creature gains a +4 competence bonus on Swim checks.</Pair>
<Pair title="At 8th Level">This bonus becomes +6.</Pair>
<Pair title="At 15th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="kraken" extraClasses="subAbility" icon={["power"]}>
<Pair single id="kraken">Kraken</Pair>
...
<Ability id="reefclaw" extraClasses="subAbility" icon={["power"]}>
<Pair single id="reefclaw">Reefclaw</Pair>
...
<Ability id="scylla" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="scylla">Scylla</Pair>
...
<Ability id="sea-serpent" extraClasses="subAbility" icon={["def"]}>
<Pair single id="sea-serpent">Sea Serpent</Pair>
...
<Ability id="selkie" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="selkie">Selkie</Pair>
<Pair title="Passive Ability">The creature gains a +4 competence bonus on Bluff checks.</Pair>
<Pair title="At 8th Level">This bonus becomes +6.</Pair>
<Pair title="At 15th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="shoggoth" extraClasses="subAbility" icon={["boost","def"]}>
<Pair single id="shoggoth">Shoggoth</Pair>
...
<Ability id="siyokoy" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="siyokoy">Siyokoy</Pair>
...
<Ability id="blood-to-water-su" icon={["def"]}>
<Pair single id="blood-to-water-su">Blood to Water (Su)</Pair>
<Pair hl title="Replaces">Woodland stride</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="plant-companion-ex" icon={["power"]}>
<Pair single id="plant-companion-ex">Plant Companion (Ex)</Pair>
<Pair hl title="Replaces">Animal companion</Pair>
...
<Ability id="plant-focus-su" extraClasses="hasSubs" icon={["power"]}>
<Pair single id="plant-focus-su">Plant Focus (Su)</Pair>
<Pair hl title="Replaces">Animal focus</Pair>
<Pair title="Usage">1 minute/day per hunter level; these minutes need not be consecutive, but they must be spent in 1-minute increments</Pair>
...
<Ability id="plant-shield-ex" icon={["def"]}>
<Pair single id="plant-shield-ex">Plant Shield (Ex)</Pair>
<Pair hl title="Replaces">One with the wild</Pair>
<Pair title="Gained">At 17th Level</Pair>
...
<Ability id="master-hunter-ex" icon={["power"]}>
...
<Ability id="primal-transformation-su" icon={["power"]}>
...
<Ability id="primal-surge-su" icon={["boost"]}>
...
<Ability id="primal-master-su" icon={["boost"]}>
<Pair single id="primal-master-su">Primal Master (Su)</Pair>
<Pair hl title="Replaces">Master hunter</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="skilled-ex" icon={["down"]}>
...
<Ability id="natural-leaper-ex" icon={["boost"]}>
...
<Ability id="shingle-stride-ex" icon={["boost"]}>
...
<Ability id="alley-ghost-ex" icon={["power"]}>
<Pair single id="alley-ghost-ex">Alley Ghost (Ex)</Pair>
<Pair hl title="Replaces">Swift tracker</Pair>
<Pair title="Gained">At 8th Level</Pair>
...
<Ability id="master-climber-ex" icon={["power"]}>
<Pair single id="master-climber-ex">Master Climber (Ex)</Pair>
<Pair hl title="Alters">Master hunter</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="sacred-animal-focus-su" extraClasses="hasSubs" icon={["down","power"]}>
<Pair single id="sacred-animal-focus-su">Sacred Animal Focus (Su)</Pair>
<Pair hl title="Alters">Animal focus</Pair>
...
<Ability id="bee" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="bee">Bee</Pair>
<Pair title="Passive Ability">The creature gains a +4 competence bonus on Fly checks.</Pair>
<Pair title="At 8th Level">This bonus becomes +6.</Pair>
<Pair title="At 15th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="cat" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="cat">Cat</Pair>
<Pair title="Passive Ability">The creature gains a +4 competence bonus on Acrobatics checks.</Pair>
<Pair title="At 8th Level">This bonus becomes +6.</Pair>
<Pair title="At 15th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="cow" extraClasses="subAbility" icon={["def"]}>
<Pair single id="cow">Cow</Pair>
<Pair title="Passive Ability">The creature gains a +1 resistance bonus on Fortitude saving throws.</Pair>
<Pair title="At 8th Level">This bonus becomes +2.</Pair>
<Pair title="At 15th Level">This bonus increases to +3.</Pair>
</Ability>
<Ability id="crocodile" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="crocodile">Crocodile</Pair>
<Pair title="Passive Ability">The creature gains a +4 competence bonus on Swim checks.</Pair>
<Pair title="At 8th Level">This bonus becomes +6.</Pair>
<Pair title="At 15th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="ibis" extraClasses="subAbility" icon={["def"]}>
<Pair single id="ibis">Ibis</Pair>
<Pair title="Passive Ability">The creature gains a +2 resistance bonus on saving throws against disease.</Pair>
<Pair title="At 8th Level">This bonus becomes +4.</Pair>
<Pair title="At 15th Level">This bonus increases to +6.</Pair>
</Ability>
<Ability id="jackal" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="jackal">Jackal</Pair>
<Pair title="Passive Ability">The creature gains a +4 competence bonus on Survival checks.</Pair>
<Pair title="At 8th Level">This bonus becomes +6.</Pair>
<Pair title="At 15th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="kite" extraClasses="subAbility" icon={["aid"]}>
<Pair single id="kite">Kite</Pair>
...
<Ability id="leopard" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="leopard">Leopard</Pair>
<Pair title="Passive Ability">The creature gains a +4 competence bonus on Escape Artist checks.</Pair>
<Pair title="At 8th Level">This bonus becomes +6.</Pair>
<Pair title="At 15th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="lion" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="lion">Lion</Pair>
<Pair title="Passive Ability">The creature gains a +4 competence bonus on Intimidate checks.</Pair>
<Pair title="At 8th Level">This bonus becomes +6.</Pair>
<Pair title="At 15th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="ram" extraClasses="subAbility" icon={["power"]}>
<Pair single id="ram">Ram</Pair>
<Pair title="Passive Ability">The creature gains a +1 bonus on damage rolls when making charge attacks.</Pair>
<Pair title="At 8th Level">This bonus becomes +2.</Pair>
<Pair title="At 15th Level">This bonus increases to +3.</Pair>
</Ability>
<Ability id="scarab-beetle" extraClasses="subAbility" icon={["def"]}>
<Pair single id="scarab-beetle">Scarab Beetle</Pair>
<Pair title="Passive Ability">The creature gains a +1 enhancement bonus to its natural armor bonus.</Pair>
<Pair title="At 8th Level">This bonus becomes +2.</Pair>
<Pair title="At 15th Level">This bonus increases to +3.</Pair>
</Ability>
<Ability id="scorpion" extraClasses="subAbility" icon={["def"]}>
<Pair single id="scorpion">Scorpion</Pair>
<Pair title="Passive Ability">The creature gains a +2 resistance bonus on saving throws against poison.</Pair>
<Pair title="At 8th Level">This bonus becomes +4.</Pair>
<Pair title="At 15th Level">This bonus increases to +6.</Pair>
</Ability>
<Ability id="sha" extraClasses="subAbility" icon={["power"]}>
<Pair single id="sha">Sha</Pair>
...
<Ability id="uraeus" extraClasses="subAbility" icon={["def"]}>
<Pair single id="uraeus">Uraeus</Pair>
...
<Ability id="desert-walker-ex" icon={["boost"]}>
<Pair single id="desert-walker-ex">Desert Walker (Ex)</Pair>
<Pair hl title="Replaces">Woodland stride</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="primeval-companion-ex" icon={["power"]}>
<Pair single id="primeval-companion-ex">Primeval Companion (Ex)</Pair>
<Pair hl title="Alters">Animal companion</Pair>
...
<Ability id="shared-strength-su" icon={["boost"]}>
...
<Ability id="animal-companion" icon={["info"]}>
...
<Ability id="improved-unarmed-strike-ex" icon={["power"]}>
<Pair single id="improved-unarmed-strike-ex">Improved Unarmed Strike (Ex)</Pair>
<Pair hl title="Replaces">Precise companion</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="tree-stride-sp" icon={["magic"]}>
<Pair single id="tree-stride-sp">Tree Stride (Sp)</Pair>
<Pair hl title="Replaces">Raise animal companion</Pair>
<Pair title="Gained">At 10th Level</Pair>
...
<Ability id="lore-of-the-blight-ex" icon={["boost"]}>
<Pair single id="lore-of-the-blight-ex">Lore of the Blight (Ex)</Pair>
...
<Ability id="unnatural-stride-ex" icon={["power"]}>
<Pair single id="unnatural-stride-ex">Unnatural Stride (Ex)</Pair>
<Pair hl title="Replaces">Raise animal companion</Pair>
<Pair title="Gained">At 10th Level</Pair>
...
<Ability id="demons-end-ex" icon={["lower"]}>
<Pair single id="demons-end-ex" flavor="Even demons must respect the number of their kindred an Uprooter scout has slain, and lesser demons quake before her.">Demon's End (Ex)</Pair>
<Pair hl title="Replaces">One with the wild</Pair>
<Pair title="Gained">At 17th Level</Pair>
...
<Ability id="captor-ex" icon={["boost"]}>
<Pair single id="captor-ex">Captor (Ex)</Pair>
...
<Ability id="animal-insight-ex" icon={["boost","def"]}>
<Pair single id="animal-insight-ex" flavor="An urban hunter and her animal companion learn to combine their insights to defeat deception and manipulation.">Animal Insight (Ex)</Pair>
<Pair hl title="Replaces">Woodland stride</Pair>
<Pair title="Gained">At 5th Level</Pair>
...
<Ability id="frightful-ferocity-ex" icon={["boost"]}>
<Pair single id="frightful-ferocity-ex">Frightful Ferocity (Ex)</Pair>
<Pair hl title="Replaces">One with the wild</Pair>
<Pair title="Gained">At 17th Level</Pair>
...
<Ability id="vermin-companion-ex" icon={["info"]}>
<Pair single id="vermin-companion-ex">Vermin Companion (Ex)</Pair>
...
<Ability id="vermin-empathy-ex" icon={["power"]}>
<Pair single id="vermin-empathy-ex">Vermin Empathy (Ex)</Pair>
<Pair hl title="Alters">Wild empathy</Pair>
...
<Ability id="vermin-focus-su" extraClasses="hasSubs" icon={["power"]}>
<Pair single id="vermin-focus-su">Vermin Focus (Su)</Pair>
...
<Ability id="ant" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="ant">Ant</Pair>
<Pair title="Passive Ability">The creature gains a +2 enhancement bonus to Strength.</Pair>
<Pair title="At 8th Level">This bonus becomes +4.</Pair>
<Pair title="At 15th Level">This bonus increases to +6.</Pair>
</Ability>
<Ability id="beetle" extraClasses="subAbility" icon={["def"]}>
<Pair single id="beetle">Beetle</Pair>
<Pair title="Passive Ability">The creature gains a +2 enhancement bonus to its natural armor bonus.</Pair>
<Pair title="At 8th Level">This bonus becomes +4.</Pair>
<Pair title="At 15th Level">This bonus increases to +6.</Pair>
<Pair title="Special">A creature without natural armor has an effective natural armor bonus of +0.</Pair>
</Ability>
<Ability id="centipede" extraClasses="subAbility" icon={["boost","def"]}>
<Pair single id="centipede">Centipede</Pair>
...
<Ability id="cockroach" extraClasses="subAbility" icon={["def"]}>
<Pair single id="cockroach">Cockroach</Pair>
...
<Ability id="flea" extraClasses="subAbility" icon={["def","boost"]}>
<Pair single id="flea">Flea</Pair>
...
<Ability id="fly" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="leech" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="leech">Leech</Pair>
...
<Ability id="mantis" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="mantis">Mantis</Pair>
...
<Ability id="moth" extraClasses="subAbility" icon={["power"]}>
<Pair single id="moth">Moth</Pair>
...
<Ability id="phasmid" extraClasses="subAbility" icon={["power","boost"]}>
<Pair single id="phasmid">Phasmid</Pair>
...
<Ability id="scorpion" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="scorpion">Scorpion</Pair>
...
<Ability id="spider" extraClasses="subAbility" icon={["boost","def"]}>
<Pair single id="spider">Spider</Pair>
...
<Ability id="wasp" extraClasses="subAbility" icon={["boost"]}>
<Pair single id="wasp">Wasp</Pair>
<Pair title="Passive Ability">The creature gains a +4 competence bonus on Perception checks.</Pair>
<Pair title="At 8th Level">This bonus becomes +6.</Pair>
<Pair title="At 15th Level">This bonus increases to +8.</Pair>
</Ability>
<Ability id="worm" extraClasses="subAbility" icon={["def"]}>
<Pair single id="worm">Worm</Pair>
<Pair hl title="Replaces">Animal focus</Pair>
...
<Ability id="swarm-stride-ex" icon={["def"]}>
<Pair single id="swarm-stride-ex" flavor="A verminous hunter learns to move through vermin without danger.">Swarm Stride (Ex)</Pair>
<Pair hl title="Replaces">Woodland stride</Pair>
<Pair title="Gained">At 5th Level</Pair>
