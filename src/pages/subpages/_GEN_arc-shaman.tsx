...
<Ability id="animist-spirit-magic" icon={["spell-book"]}>
<Pair single id="animist-spirit-magic">Animist Spirit Magic</Pair>
...
<Ability id="exorcism-su" icon={["shield-reflect"]}>
<Pair single id="exorcism-su">Exorcism (Su)</Pair>
...
<Ability id="dominate-spirit-sp" icon={["magic-swirl"]}>
<Pair single id="dominate-spirit-sp">Dominate Spirit (Sp)</Pair>
...
<Ability id="contact-with-the-spirit-world-su" icon={["mailed-fist"]}>
<Pair single id="contact-with-the-spirit-world-su">Contact with the Spirit World (Su)</Pair>
...
<Ability id="etherealness-sp" icon={["magic-swirl"]}>
<Pair single id="etherealness-sp">Etherealness (Sp)</Pair>
...
<Ability id="spirit-shaman-sp" icon={["magic-swirl"]}>
<Pair single id="spirit-shaman-sp">Spirit Shaman (Sp)</Pair>
...
<Ability id="benefactor-ethos" icon={["broken-shield"]}>
<Pair single id="benefactor-ethos">Benefactor Ethos</Pair>
...
<Ability id="benefactor-hexes" extraClasses="hasSubs" icon={["magic-swirl","broken-shield"]}>
<Pair single id="benefactor-hexes">Benefactor Hexes</Pair>
...
<Ability id="boon-reservoir-su" extraClasses="subAbility" icon={["armor-upgrade"]}>
<Pair single id="boon-reservoir-su">Boon Reservoir (Su)</Pair>
...
<Ability id="expanded-boon-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="expanded-boon-su">Expanded Boon (Su)</Pair>
...
<Ability id="suppress-curse-sp" extraClasses="subAbility" icon={["remedy"]}>
<Pair single id="suppress-curse-sp">Suppress Curse (Sp)</Pair>
...
<Ability id="scion-of-the-stones-ex" icon={["info","armor-upgrade","broken-shield"]}>
<Pair single id="scion-of-the-stones-ex" flavor="A crystal tender forms a mystic connection with the precious stones and gems she has sworn to protect.">Scion of the Stones (Ex)</Pair>
...
<Ability id="reciprocal-resonance-su" icon={["armor-upgrade"]}>
<Pair single id="reciprocal-resonance-su" flavor="A crystal tender learns to form a temporary bond with a spirit of crystal.">Reciprocal Resonance (Su)</Pair>
...
<Ability id="invoke-latent-facets-su" icon={["upgrade"]}>
<Pair single id="invoke-latent-facets-su">Invoke Latent Facets (Su)</Pair>
...
<Ability id="cabochon-form-sp" icon={["armor-upgrade"]}>
<Pair single id="cabochon-form-sp">Cabochon Form (Sp)</Pair>
<Pair hl title="Replaces">Manifestation</Pair>
<Pair title="Gained">At 20th Level</Pair>
...
<Ability id="deep-spirit" icon={["broken-shield","stairs-goal"]}>
<Pair single id="deep-spirit">Deep Spirit</Pair>
...
<Ability id="buoyancy-control-sp" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="buoyancy-control-sp">Buoyancy Control (Sp)</Pair>
...
<Ability id="deep-heart-su" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="deep-heart-su">Deep Heart (Su)</Pair>
...
<Ability id="aquatic-spirit-abilities-su" icon={["upgrade"]}>
<Pair single id="aquatic-spirit-abilities-su">Aquatic Spirit Abilities (Su)</Pair>
...
<Ability id="brine-dragon-form-su" icon={["magic-swirl"]}>
<Pair single id="brine-dragon-form-su">Brine Dragon Form (Su)</Pair>
...
<Ability id="drake-companion" icon={["stairs-goal","broken-shield"]}>
...
<Ability id="plant-spirit-ex" icon={["stairs-goal"]}>
<Pair single id="plant-spirit-ex">Plant Spirit (Ex)</Pair>
<Pair hl title="Alters">Spirit animal</Pair>
...
<Ability id="verdant-magic" icon={["spell-book"]}>
<Pair single id="verdant-magic">Verdant Magic</Pair>
...
<Ability id="greentongue-sp" icon={["magic-swirl"]}>
<Pair single id="greentongue-sp">Greentongue (Sp)</Pair>
...
<Ability id="flowers-form-sp" icon={["magic-swirl"]}>
<Pair single id="flowers-form-sp">Flower's Form (Sp)</Pair>
...
<Pair single id="inherited-wayfinder-su">Inherited Wayfinder (Su)</Pair>
...
<Ability id="keeper-spirit-magic" icon={["spell-book"]}>
<Pair single id="keeper-spirit-magic">Keeper Spirit Magic</Pair>
<Pair hl title="Replaces">Spirit magic spells gained from the shaman's spirit</Pair>
...
<Ability id="pathfinders-past-su" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="pathfinders-past-su">Pathfinders Past (Su)</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="scrolls" extraClasses="subAbility" icon={["stairs-goal","upgrade"]}>
<Pair single id="scrolls">Scrolls</Pair>
...
<Ability id="spells" extraClasses="subAbility" icon={["spell-book"]}>
...
<Ability id="swords" extraClasses="subAbility" icon={["stairs-goal"]}>
<Pair single id="swords">Swords</Pair>
...
<Ability id="versatile-hex-su" icon={["stairs-goal"]}>
<Pair single id="versatile-hex-su">Versatile Hex (Su)</Pair>
...
<Ability id="controlling-magic-su" icon={["spell-book"]}>
<Pair single id="controlling-magic-su">Controlling Magic (Su)</Pair>
<Pair hl title="Replaces">Spirit magic spells gained from the shaman's spirit</Pair>
...
<Ability id="spirit-surge-ex" icon={["magic-swirl","upgrade"]}>
<Pair single id="spirit-surge-ex">Spirit Surge (Ex)</Pair>
...
<Ability id="shared-skill-su" icon={["upgrade"]}>
<Pair single id="shared-skill-su">Shared Skill (Su)</Pair>
...
<Ability id="crowded-vessel-su" icon={["armor-upgrade"]}>
<Pair single id="crowded-vessel-su">Crowded Vessel (Su)</Pair>
...
<Ability id="wandering-skills-su" icon={["upgrade"]}>
<Pair single id="wandering-skills-su" flavor="A possessed shaman is able to make room for another spirit.">Wandering Skills (Su)</Pair>
...
<Ability id="spirit-animal" icon={["armor-upgrade"]}>
...
<Ability id="unstable-spellcasting" icon={["magic-swirl"]}>
<Pair single id="unstable-spellcasting" flavor="A primal warden's spirit is ever shifting, and the spells it grants the primal warden change from moment to moment.">Unstable Spellcasting</Pair>
<Pair hl title="Replaces">Hex gained at 8th level</Pair>
<Pair hl title="Alters">Spirit magic</Pair>
...
<Ability id="primal-blessing-su" extraClasses="subAbility" icon={["magic-swirl"]}>
<Pair single id="primal-blessing-su">Primal Blessing (Su)</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="greater-primal-blessing-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="greater-primal-blessing-su">Greater Primal Blessing (Su)</Pair>
<Pair title="Gained">At 12th Level</Pair>
...
<Ability id="luck-hexes" extraClasses="hasSubs" icon={["stairs-goal"]}>
<Pair single id="luck-hexes">Luck Hexes</Pair>
...
<Ability id="channel-luck-su" extraClasses="subAbility" icon={["upgrade"]}>
<Pair single id="channel-luck-su">Channel Luck (Su)</Pair>
...
<Ability id="misfortune-ex" extraClasses="subAbility" icon={["armor-downgrade"]}>
...
<Ability id="spirit-magic" extraClasses="subAbility" icon={["spell-book"]}>
...
<Ability id="tweak-the-odds-su" extraClasses="subAbility" icon={["rolling-dices"]}>
<Pair single id="tweak-the-odds-su">Tweak the Odds (Su)</Pair>
...
<Ability id="revelations-of-the-past" icon={["stairs-goal"]}>
<Pair single id="revelations-of-the-past">Revelations of the Past</Pair>
...
<Pair single id="unnatural-mien-ex" flavor="The spirit warden's dealings with the spirit world give her an unsettling demeanor.">Unnatural Mien (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Passive Ability">She gains a +2 bonus on Intimidate checks to demoralize a foe.</Pair>
</Ability>
<Ability id="restless-magic-su" icon={["spell-book"]}>
<Pair single id="restless-magic-su">Restless Magic (Su)</Pair>
<Pair hl title="Replaces">Spirit magic spells gained from the shaman's spirit</Pair>
...
<Ability id="rebuke-spirits-su" icon={["aura"]}>
<Pair single id="rebuke-spirits-su">Rebuke Spirits (Su)</Pair>
<Pair hl title="Replaces">Hex gained at 2nd level</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="laugh-at-death-su" icon={["armor-upgrade"]}>
<Pair single id="laugh-at-death-su" flavor="The spirit warden's familiarity with the dead has filled her with contempt for death itself.">Laugh at Death (Su)</Pair>
<Pair hl title="Replaces">Hex gained at 10th level</Pair>
<Pair title="Gained">At 10th Level</Pair>
...
<Pair single id="occult-grimoire-ex">Occult Grimoire (Ex)</Pair>
<Pair hl title="Replaces">Spirit animal</Pair>
...
<Ability id="ritual-hex" icon={["stairs-goal"]}>
<Pair single id="ritual-hex">Ritual Hex</Pair>
<Pair title="Ability">A true silvered throne gains <Link to="/feat/ritual_hex">Ritual Hex</Link> as a bonus feat.</Pair>
</Ability>
<Ability id="scarab-of-the-second-throne-ex" icon={["stairs-goal","armor-upgrade"]}>
<Pair single id="scarab-of-the-second-throne-ex">Scarab of the Second Throne (Ex)</Pair>
<Pair title="Gained">At 4th Level</Pair>
...
<Ability id="wandering-ritual-su" icon={["stairs-goal"]}>
<Pair single id="wandering-ritual-su">Wandering Ritual (Su)</Pair>
<Pair hl title="Replaces">Wandering spirit, wandering hex</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<Ability id="esoteric-rites-ex" icon={["upgrade"]}>
<Pair single id="esoteric-rites-ex">Esoteric Rites (Ex)</Pair>
...
<Ability id="minor-spirit-su" icon={["stairs-goal"]}>
<Pair single id="minor-spirit-su">Minor Spirit (Su)</Pair>
...
<Ability id="spirit-animal" icon={["upgrade"]}>
<Pair single id="spirit-animal">Spirit Animal</Pair>
<Pair hl title="Alters">Spirit animal</Pair>
<Pair title="Gained">At 2nd Level</Pair>
...
<Ability id="wandering-spirit-su" icon={["stairs-goal"]}>
...
<Ability id="spirit-magic-sp" icon={["broken-shield"]}>
<Pair single id="spirit-magic-sp">Spirit Magic (Sp)</Pair>
<Pair hl title="Alters">Spirit magic</Pair>
...
<Ability id="discern-magical-expertise-ex" icon={["stairs-goal"]}>
<Pair single id="discern-magical-expertise-ex">Discern Magical Expertise (Ex)</Pair>
...
<Ability id="vision-spirit-magic" icon={["spell-book"]}>
<Pair single id="vision-spirit-magic">Vision Spirit Magic</Pair>
...
<Ability id="improved-divination-su" icon={["upgrade","spell-book"]}>
<Pair single id="improved-divination-su">Improved Divination (Su)</Pair>
<Pair hl title="Replaces">Wandering hex gained at 6th level</Pair>
<Pair title="Gained">At 6th Level</Pair>
...
<div className="sideNoteWrap startAlign singular delist"><ScrollContainer id="arc-shaman-witch_doctor--table-0"><table><tbody><tr><ThLink scope="row" to="/icons/confirmed"><IonIcon aria-label="Prerequisites" icon="/icons/confirmed.svg" /></ThLink><td>Nonevil alignment</td></tr></tbody></table></ScrollContainer></div><Ability id="channel-energy-su" icon={["aura"]}>
...
<Ability id="counter-curse-su" icon={["armor-upgrade","shield-reflect"]}>
...
<Ability id="countering-hex-su" icon={["armor-upgrade"]}>
<Pair single id="countering-hex-su">Countering Hex (Su)</Pair>
<Pair hl title="Replaces">Hex gained at 10th level</Pair>
<Pair title="Gained">At 10th Level</Pair>
