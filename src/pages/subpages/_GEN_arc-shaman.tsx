...
<Ability id="animist-spirit-magic" icon={["learn"]}>
...
<Ability id="wrangle-condition" icon={["aid"]}>
...
<Ability id="exorcism-su" icon={["protect"]}>
...
<Ability id="dominate-spirit-sp" icon={["magic"]}>
...
<Ability id="contact-with-the-spirit-world-su" icon={["melee"]}>
...
<Ability id="etherealness-sp" icon={["magic"]}>
...
<Ability id="spirit-shaman-sp" icon={["magic"]}>
...
<Ability id="benefactor-ethos" icon={["down"]}>
...
<Ability id="benefactor-hexes" extraClasses="hasSubs" icon={["magic","down"]}>
...
<Ability id="boon-reservoir-su" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="expanded-boon-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="suppress-curse-sp" extraClasses="subAbility" icon={["aid"]}>
...
<Ability id="scion-of-the-stones-ex" icon={["info","def","down"]}>
...
<Ability id="reciprocal-resonance-su" icon={["def"]}>
...
<Ability id="invoke-latent-facets-su" icon={["boost"]}>
...
<Ability id="cabochon-form-sp" icon={["def"]}>
...
<Ability id="deep-spirit" icon={["down","power"]}>
...
<Ability id="aquatic-hexes-su" extraClasses="hasSubs" icon={["lower"]}>
...
<Ability id="buoyancy-control-sp" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="deep-heart-su" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="aquatic-spirit-abilities-su" icon={["boost"]}>
...
<Ability id="brine-dragon-form-su" icon={["magic"]}>
...
<Ability id="drake-companion" icon={["power","down"]}>
...
<Ability id="plant-spirit-ex" icon={["power"]}>
...
<Ability id="verdant-magic" icon={["learn"]}>
...
<Ability id="greentongue-sp" icon={["magic"]}>
...
<Ability id="flowers-form-sp" icon={["magic"]}>
...
<Ability id="inherited-wayfinder-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="keeper-spirit-magic" icon={["learn"]}>
...
<Ability id="pathfinders-past-su" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="scrolls" extraClasses="subAbility" icon={["power","boost"]}>
...
<Ability id="spells" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="swords" extraClasses="subAbility" icon={["power"]}>
...
<Ability id="versatile-hex-su" icon={["power"]}>
...
<Ability id="controlling-magic-su" icon={["learn"]}>
...
<Ability id="spirit-surge-ex" icon={["magic","boost"]}>
...
<Ability id="shared-skill-su" icon={["boost"]}>
...
<Ability id="crowded-vessel-su" icon={["def"]}>
...
<Ability id="wandering-skills-su" icon={["boost"]}>
...
<Ability id="unstable-spellcasting" icon={["magic"]}>
...
<Ability id="primal-blessing-su" extraClasses="subAbility" icon={["magic"]}>
...
<Ability id="greater-primal-blessing-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="luck-hexes" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="channel-luck-su" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="misfortune-ex" extraClasses="subAbility" icon={["lower"]}>
...
<Ability id="spirit-magic" extraClasses="subAbility" icon={["learn"]}>
...
<Ability id="tweak-the-odds-su" extraClasses="subAbility" icon={["roll"]}>
...
<Ability id="mysteries-of-the-past" icon={["learn"]}>
...
<Ability id="revelations-of-the-past" icon={["power"]}>
...
<Ability id="unnatural-mien-ex" icon={["boost"]}>
...
<Ability id="restless-magic-su" icon={["learn"]}>
...
<Ability id="laugh-at-death-su" icon={["def"]}>
...
<Ability id="occult-grimoire-ex" icon={["learn","warning"]}>
...
<Ability id="ritual-hex" icon={["power"]}>
...
<Ability id="scarab-of-the-second-throne-ex" icon={["power","def"]}>
...
<Ability id="wandering-ritual-su" icon={["power"]}>
...
<Ability id="esoteric-rites-ex" icon={["boost"]}>
...
<Ability id="minor-spirit-su" icon={["power"]}>
...
<Ability id="wandering-spirit-su" icon={["power"]}>
...
<Ability id="spirit-magic-sp" icon={["down"]}>
...
<Ability id="discern-magical-expertise-ex" icon={["power"]}>
...
<Ability id="vision-spirit-magic" icon={["learn"]}>
...
<Ability id="improved-divination-su" icon={["boost","learn"]}>
...
<Ability id="counter-curse-su" icon={["def","protect"]}>
...
<Ability id="countering-hex-su" icon={["def"]}>
