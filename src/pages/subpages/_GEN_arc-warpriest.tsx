...
<p><strong>Class Skills:</strong> The cult leader's class skills are <Link to="/skill/acrobatics">Acrobatics</Link> (Dex), <Link to="/skill/bluff">Bluff</Link> (Cha), <Link to="/skill/climb">Climb</Link> (Str), <Link to="/skill/craft">Craft</Link> (Int), <Link to="/skill/diplomacy">Diplomacy</Link> (Cha), <Link to="/skill/disguise">Disguise</Link> (Cha), <Link to="/skill/escape_artist">Escape Artist</Link> (Dex), <Link to="/skill/heal">Heal</Link> (Wis), <Link to="/skill/intimidate">Intimidate</Link> (Cha), <Link to="/skill/knowledge_local">Knowledge (local)</Link> (Int), <Link to="/skill/knowledge_religion">Knowledge (religion)</Link> (Int), <Link to="/skill/perception">Perception</Link> (Wis), <Link to="/skill/profession">Profession</Link> (Wis), <Link to="/skill/sense_motive">Sense Motive</Link> (Wis), <Link to="/skill/sleight_of_hand">Sleight of Hand</Link> (Dex), <Link to="/skill/spellcraft">Spellcraft</Link> (Int), and <Link to="/skill/stealth">Stealth</Link> (Dex). These skills replace the warpriest's class skills.</p>
...
<p><strong>Class Skills:</strong> A Jistkan magistrate gains Knowledge (planes) as a class skill. Survival is not a class skill for a Jistkan magistrate.</p>
<p>This alters the warpriest's <strong className="hl">class skills</strong>.</p>
...
<p><strong>Class Skills:</strong> The sacred fist's class skills are <Link to="/skill/acrobatics">Acrobatics</Link> (Dex), <Link to="/skill/climb">Climb</Link> (Str), <Link to="/skill/craft">Craft</Link> (Int), <Link to="/skill/diplomacy">Diplomacy</Link> (Cha), <Link to="/skill/escape_artist">Escape Artist</Link> (Dex), <Link to="/skill/heal">Heal</Link> (Wis), <Link to="/skill/intimidate">Intimidate</Link> (Cha), <Link to="/skill/knowledge_history">Knowledge (history)</Link> (Int), <Link to="/skill/knowledge_religion">Knowledge (religion)</Link> (Int), <Link to="/skill/perception">Perception</Link> (Wis), <Link to="/skill/profession">Profession</Link> (Wis), <Link to="/skill/ride">Ride</Link> (Dex), <Link to="/skill/sense_motive">Sense Motive</Link> (Wis), <Link to="/skill/spellcraft">Spellcraft</Link> (Int), <Link to="/skill/stealth">Stealth</Link> (Dex), and <Link to="/skill/swim">Swim</Link> (Str). These skills replace the warpriest's class skills.</p>
