...
const _traits_magic_conconj = {title: "Other Spellcasting Magic Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_magic" className="reversed" info="Back to Magic Traits" /><Ability id="traitarcanetemper-arcane-temper-fn1" extraClasses="trait" icon={["magic-swirl"]}>
