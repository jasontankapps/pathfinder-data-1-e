...
const _traits_magic_all = {title: "All Magic Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_magic" className="reversed" info="Back to Magic Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitacadamaeneophyte-acadamae-neophyte-fn1" extraClasses="trait" icon={["magic-swirl"]}>
...
const _traits_magic_def = {title: "Defensive Magic Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_magic" className="reversed" info="Back to Magic Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitairtouched-air-touched-fn1" extraClasses="trait" icon={["magic-swirl"]}>
...
const _traits_magic_spell = {title: "Spell Ability Magic Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_magic" className="reversed" info="Back to Magic Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitgreenblooded-green-blooded-fn1" extraClasses="trait" icon={["magic-swirl"]}>
...
const _traits_magic_class = {title: "Class-Specific Magic Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_magic" className="reversed" info="Back to Magic Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitarcanerevitalization-arcane-revitalization-fn1" extraClasses="trait" icon={["magic-swirl"]}>
...
const _traits_magic_cl = {title: "Caster Level Magic Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_magic" className="reversed" info="Back to Magic Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitaeromanticaffinity-aeromantic-affinity-fn1" extraClasses="trait" icon={["magic-swirl"]}>
...
const _traits_magic_boost = {title: "Spell-Boosting Magic Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_magic" className="reversed" info="Back to Magic Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitbalancersbanishing-balancers-banishing-fn1" extraClasses="trait" icon={["magic-swirl"]}>
...
const _traits_magic_conconj = {title: "Other Spellcasting Magic Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_magic" className="reversed" info="Back to Magic Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitarcanetemper-arcane-temper-fn1" extraClasses="trait" icon={["magic-swirl"]}>
...
<Ability id="traitcovencasting-coven-casting-fn2" extraClasses="trait" icon={["magic-swirl"]}>
...
<Ability id="traitdeepguardian-deep-guardian-fn3" extraClasses="trait" icon={["magic-swirl"]}>
...
<Ability id="traitdesperatefocus-desperate-focus-fn4" extraClasses="trait" icon={["magic-swirl"]}>
...
<Ability id="traitdesperateresolve-desperate-resolve-fn1-2" extraClasses="trait" icon={["magic-swirl"]}>
...
<Ability id="traitdiabolicaldabbler-diabolical-dabbler-fn4-2" extraClasses="trait" icon={["magic-swirl"]}>
...
<Ability id="traitfocusedmind-focused-mind-fn1-3-fn5-fn6" extraClasses="trait" icon={["magic-swirl"]}>
...
<Ability id="traitoutsiderties-outsider-ties-fn7" extraClasses="trait" icon={["magic-swirl"]}>
...
const _traits_magic_general = {title: "Magic-Related Magic Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_magic" className="reversed" info="Back to Magic Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitarcaneresearcher-arcane-researcher-fn1" extraClasses="trait" icon={["magic-swirl"]}>
...
const _traits_magic_int = {title: "Intelligence-Based-Skill Magic Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_magic" className="reversed" info="Back to Magic Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitacadamaeneophyte-acadamae-neophyte-fn1" extraClasses="trait" icon={["magic-swirl"]}>
...
const _traits_magic_cha = {title: "Charisma-Based-Skill Magic Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_magic" className="reversed" info="Back to Magic Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitcharlatan-charlatan-fn1" extraClasses="trait" icon={["magic-swirl"]}>
...
const _traits_magic_ab = {title: "Other Skill Magic Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_magic" className="reversed" info="Back to Magic Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitchildofthemoon-child-of-the-moon-fn1" extraClasses="trait" icon={["magic-swirl"]}>
...
const _traits_magic_other = {title: "Other Skill/Feat/Ability Magic Traits", jsx: <IonList lines="full"><MainLink to="/main/traits_magic" className="reversed" info="Back to Magic Traits" /><IonItem className="mainItem basic"><IonLabel><Ability id="traitbountifulherblore-bountiful-herb-lore-fn1" extraClasses="trait" icon={["magic-swirl"]}>
...
<Ability id="traitplanarescapee-planar-escapee-fn6" extraClasses="trait" icon={["magic-swirl"]}>
