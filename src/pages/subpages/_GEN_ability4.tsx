...
<Ability id="invtalentblindingstrike-blinding-strike-ex-fn1" icon={["lower"]}>
...
<Ability id="invtalentconfusingstrike-confusing-strike-ex-fn1-2" icon={["lower"]}>
...
<Ability id="invtalentdeafeningstrike-deafening-strike-ex-fn1-3" icon={["lower"]}>
...
<Ability id="invtalentdominoeffect-domino-effect-ex-fn2" icon={["boost"]}>
...
<Ability id="invtalenticonclasticstrike-iconclastic-strike-ex-fn3" icon={["melee"]}>
...
<Ability id="invtalentnumericalstrike-numerical-strike-ex-fn4" icon={["roll"]}>
...
<Ability id="invtalentgreaternumericalstrike-greater-numerical-strike-ex-fn4-2" icon={["boost"]}>
...
<Ability id="invtalentmasterfulnumericalstrike-masterful-numerical-strike-ex-fn4-3" icon={["boost"]}>
...
<Ability id="invtalentprolongedstudy-prolonged-study-ex-fn2-2" icon={["boost"]}>
...
<Ability id="invtalentrepositioningstrike-repositioning-strike-ex-fn1-4" icon={["melee"]}>
...
<Ability id="invtalentsappingoffensive-sapping-offensive-ex-fn1-5" icon={["lower"]}>
...
<Ability id="invtalentsickeningoffensive-sickening-offensive-ex-fn1-6" icon={["lower"]}>
...
<Ability id="invtalentsilencingstrike-silencing-strike-ex-fn3-2" icon={["lower"]}>
...
<Ability id="invtalentslowingstrike-slowing-strike-ex-fn2-3" icon={["lower"]}>
...
<Ability id="invtalentstealingstrike-stealing-strike-ex-fn1-7" icon={["melee"]}>
...
<Ability id="invtalenttimedstrike-timed-strike-ex-fn2-4" icon={["boost"]}>
...
<Ability id="invtalenttopplingstrike-toppling-strike-ex-fn1-8" icon={["melee"]}>
...
<Ability id="invtalenttwilighttalonimprovisation-twilight-talon-improvisation-ex-fn3-3" icon={["melee"]}>
...
<Ability id="invtalentdidacticstrike-didactic-strike-fn5" icon={["boost"]}>
...
<Ability id="invtalentquickstudy-quick-study-ex-fn1-9" icon={["boost"]}>
...
<Ability id="invtalentstudieddefense-studied-defense-ex-fn1-10" icon={["def"]}>
...
<Ability id="invtalentamazinginspiration-amazing-inspiration-ex-fn1-11" icon={["boost"]}>
...
<Ability id="invtalentappliedengineering-applied-engineering-ex-fn2-5" icon={["boost"]}>
...
<Ability id="invtalentatheistinspiration-atheist-inspiration-ex-fn3-4" icon={["def"]}>
...
<Ability id="invtalentchroniclersinsight-chroniclers-insight-ex-fn6" extraClasses="hasSubs" icon={["boost"]}>
...
<Ability id="arcana-nature-planes-or-religion" extraClasses="subAbility" icon={["boost","def"]}>
...
<Ability id="dungeoneering" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="engineering" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="geography" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="history" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="local" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="nobility" extraClasses="subAbility" icon={["boost"]}>
...
<Ability id="invtalentcombatinspiration-combat-inspiration-ex-fn1-12" icon={["boost"]}>
...
<Ability id="invtalentgreatercombatinspiration-greater-combat-inspiration-ex-fn1-13" icon={["boost"]}>
...
<Ability id="invtalenteideticrecollection-eidetic-recollection-su-fn1-14" icon={["boost"]}>
...
<Ability id="invtalentempathy-empathy-ex-su-fn1-15" icon={["roll","power"]}>
...
<Ability id="invtalentexpandedinspiration-expanded-inspiration-ex-fn1-16" icon={["boost"]}>
...
<div className="abilityGroup">
<Ability id="invtalentrapidperception-rapid-perception-su-fn7" icon={["boost"]}>
...
<Ability id="invtalenthiddenagendas-hidden-agendas-ex-fn1-17" icon={["roll","def"]}>
...
<Ability id="invtalentinspirationalexpertise-inspirational-expertise-ex-fn1-18" icon={["boost"]}>
...
<div className="abilityGroup">
<Ability id="invtalentsustainedinspirationalexpertise-sustained-inspirational-expertise-ex-fn3-5" icon={["boost"]}>
...
<Ability id="invtalentinspiredalertness-inspired-alertness-ex-fn1-19" icon={["def"]}>
...
<Ability id="invtalentinspiredintelligence-inspired-intelligence-ex-fn1-20" icon={["boost"]}>
...
<Ability id="invtalentinspiredintimidator-inspired-intimidator-ex-fn1-21" icon={["lower"]}>
...
<Ability id="invtalenttenaciousinspiration-tenacious-inspiration-ex-fn1-22" icon={["roll"]}>
...
<Ability id="invtalentunconventionalinspiration-unconventional-inspiration-ex-fn1-23" icon={["boost"]}>
...
<Ability id="invtalentunderworldinspiration-underworld-inspiration-ex-fn1-24" icon={["boost"]}>
...
<div className="abilityGroup">
<Ability id="invtalentinnocentfacade-innocent-facade-sp-fn7-2" icon={["magic","def"]}>
...
<Ability id="invtalentalchemistdiscovery-alchemist-discovery-ex-fn1-25" icon={["power"]}>
...
<Ability id="invtalentanathema-anathema-ex-fn8" icon={["lower"]}>
...
<div className="abilityGroup">
<Ability id="invtalentgreateranathema-greater-anathema-ex-fn8-2" icon={["boost","lower"]}>
...
<Ability id="invtalentfalsespellcaster-false-spellcaster-ex-fn3-6" icon={["power","magic"]}>
...
<Ability id="invtalentlingeringvenom-lingering-venom-ex-fn8-3" icon={["boost"]}>
...
<Ability id="invtalentnumericalalchemy-numerical-alchemy-su-fn4-4" icon={["boost"]}>
...
<div className="abilityGroup">
<Ability id="invtalentgreaternumericalalchemy-greater-numerical-alchemy-su-fn4-5" icon={["boost"]}>
...
<Ability id="invtalentcastling-castling-ex-fn9" icon={["def"]}>
...
<Ability id="invtalentdevicetalent-device-talent-ex-fn1-26" icon={["boost"]}>
...
<Ability id="invtalenteffortlessaid-effortless-aid-ex-fn1-27" icon={["boost"]}>
...
<Ability id="invtalenteldritchconduit-eldritch-conduit-su-fn10" icon={["boost","magic"]}>
...
<Ability id="invtalentextraearthcraft-extra-earthcraft-fn9-2" icon={["boost"]}>
...
<Ability id="invtalentfavoredbeat-favored-beat-ex-fn3-7" icon={["power"]}>
...
<Ability id="invtalentfortifiedposition-fortified-position-ex-fn9-3" icon={["def"]}>
...
<Ability id="invtalentgracefulathlete-graceful-athlete-fn11" icon={["power"]}>
...
<Ability id="invtalentitemlore-item-lore-ex-fn1-28" icon={["boost","magic"]}>
...
<Ability id="invtalentjustafaceinthecrowd-just-a-face-in-the-crowd-su-fn10-2" icon={["def","boost"]}>
...
<Ability id="invtalentoccultdungeoneer-occult-dungeoneer-su-fn10-3" icon={["power","magic"]}>
...
<Ability id="invtalentoneofthosefaces-one-of-those-faces-sp-fn12" icon={["magic"]}>
...
<Ability id="invtalentperceptivetracking-perceptive-tracking-ex-fn1-29" icon={["boost"]}>
...
<Ability id="invtalentroguetalent-rogue-talent-ex-fn1-30" icon={["power"]}>
...
<Ability id="invtalentscryslip-scry-slip-su-fn7-3" icon={["def"]}>
...
<Ability id="invtalentscryingfamiliarity-scrying-familiarity-ex-fn13" icon={["roll","def","boost"]}>
...
<Ability id="invtalentspellstoring-spell-storing-su-fn10-4" icon={["magic"]}>
...
<Ability id="invtalentthewholetime-the-whole-time-su-fn10-5" icon={["power","magic","def"]}>
...
<Ability id="invtalentunbalancingtrick-unbalancing-trick-ex-fn9-4" icon={["power"]}>
...
<Ability id="kipowerabundantstep-abundant-step-su-fn1" icon={["magic"]}>
...
<Ability id="kipoweractionbeforethought-action-before-thought-ex-fn2" icon={["roll"]}>
...
<Ability id="kipowerbreakingdownkoan-breaking-down-koan-su-fn2-2" icon={["lower"]}>
...
<Ability id="kipowerbuildingupkoan-building-up-koan-su-fn2-3" icon={["def","boost","down"]}>
...
<div className="abilityGroup">
<Ability id="kipowermasterthoughtkoan-master-thought-koan-su-fn2-4" icon={["boost"]}>
...
<Ability id="kipowerdiamondbody-diamond-body-su-fn1-2" icon={["def"]}>
...
<div className="abilityGroup">
<Ability id="kipowercobrabreath-cobra-breath-su-fn1-3" icon={["zap"]}>
...
<Ability id="kipowerdiamondmind-diamond-mind-su-fn1-4" icon={["def"]}>
...
<Ability id="kipowerdiamondresilience-diamond-resilience-ex-fn1-5" icon={["def"]}>
...
<Ability id="kipowerdiamondsoul-diamond-soul-ex-fn1-6" icon={["def"]}>
...
<div className="abilityGroup">
<Ability id="kipowerkivolley-ki-volley-su-fn3" icon={["def","magic"]}>
...
<Ability id="kipowerelementalfury-elemental-fury-su-fn1-7" icon={["melee","boost"]}>
...
<div className="abilityGroup">
<Ability id="kipowerelementalburst-elemental-burst-su-fn1-8" icon={["cone"]}>
...
<Ability id="kipoweremptybody-empty-body-su-fn1-9" icon={["magic"]}>
...
<Ability id="kipowerfeatherbalance-feather-balance-ex-fn4" icon={["boost"]}>
...
<div className="abilityGroup">
<Ability id="kipowerlightsteps-light-steps-ex-fn3-2" icon={["boost"]}>
...
<Ability id="kipowerfloatingbreath-floating-breath-su-fn5" icon={["magic"]}>
...
<Ability id="kipowerformlessmastery-formless-mastery-ex-fn4-2" icon={["def","boost"]}>
...
<Ability id="kipowerfreedomofmovement-freedom-of-movement-su-fn6" icon={["magic"]}>
...
<Ability id="kipowerfuriousdefense-furious-defense-ex-fn4-3" icon={["def"]}>
...
<Ability id="kipowerhighjump-high-jump-ex-fn4-4" icon={["boost"]}>
...
<div className="abilityGroup">
<Ability id="kipowerwindjump-wind-jump-su-fn3-3" icon={["power"]}>
...
<Ability id="kipowerimprovisedweaponproficiency-improvised-weapon-proficiency-ex-su-fn6-2" icon={["boost"]}>
...
<Ability id="kipowerinsightfulwisdom-insightful-wisdom-su-fn4-5" icon={["protect"]}>
...
<Ability id="kipowerkiblocker-ki-blocker-su-fn4-6" icon={["lower"]}>
...
<Ability id="kipowerkiguardian-ki-guardian-su-fn4-7" icon={["protect"]}>
...
<Ability id="kipowerkimeditation-ki-meditation-su-fn6-3" icon={["boost"]}>
...
<Ability id="kipowerkimetabolism-ki-metabolism-su-fn4-8" icon={["def","power"]}>
...
<Ability id="kipowerkimount-ki-mount-su-fn4-9" icon={["aid"]}>
...
<Ability id="kipowerkirange-ki-range-su-fn4-10" icon={["ranged","boost"]}>
...
<Ability id="kipowerkisunder-ki-sunder-ex-fn2-5" icon={["boost"]}>
...
<div className="abilityGroup">
<Ability id="kipowerbarehandblock-bare-hand-block-ex-fn2-6" icon={["melee"]}>
...
<Ability id="kipowerkivisions-ki-visions-su-fn4-11" icon={["power"]}>
...
<Ability id="kipoweronetouch-one-touch-ex-fn3-4" icon={["touch"]}>
...
<Ability id="kipowerqinggongpower-qinggong-power-su-fn3-5" icon={["power"]}>
...
<Ability id="kipowerquiveringpalm-quivering-palm-su-fn3-6" icon={["lower"]}>
...
<Ability id="kipowerracingcurrent-racing-current-su-fn5-2" icon={["magic"]}>
...
<Ability id="kipowerslowfall-slow-fall-su-fn3-7" icon={["def"]}>
...
<Ability id="kipowersuddenspeed-sudden-speed-su-fn3-8" icon={["boost"]}>
...
<div className="abilityGroup">
<Ability id="kipowerbranchrunner-branch-runner-ex-su-fn7" icon={["boost"]}>
...
<Ability id="kipowerkihurricane-ki-hurricane-ex-fn4-12" icon={["power","melee"]}>
...
<Ability id="kipowerwatersprint-water-sprint-su-fn3-9" icon={["magic"]}>
...
<Ability id="kipowerwholenessofbody-wholeness-of-body-su-fn3-10" icon={["aid"]}>
...
<Ability id="kipowerzephyrblow-zephyr-blow-su-fn5-3" icon={["magic"]}>
...
<hr/>
<Ability id="hexagony-agony-su-fn1" icon={["lower"]}>
...
<Ability id="hexanimalskin-animal-skin-fn2" icon={["magic"]}>
...
<Ability id="hexbeasteye-beast-eye-su-fn3" icon={["magic"]}>
...
<Ability id="hexbeastsgift-beasts-gift-su-fn4" icon={["melee"]}>
...
<Ability id="hexcookpeople-cook-people-su-fn3-2" icon={["magic"]}>
...
<Ability id="hexdeliciousfright-delicious-fright-fn2-2" icon={["lower","boost","def"]}>
...
<Ability id="hexdrugged-drugged-su-fn4-2" icon={["lower"]}>
...
<Ability id="hexfalsehospitality-false-hospitality-su-fn4-3" icon={["magic"]}>
...
<Ability id="hexhagseye-hags-eye-su-fn1-2" icon={["magic"]}>
...
<Ability id="hexharrowingcurse-harrowing-curse-su-fn5" icon={["lower"]}>
...
<Ability id="hexhiddenhome-hidden-home-sp-fn3-3" icon={["def","magic"]}>
...
<Ability id="hexhoarfrost-hoarfrost-su-fn3-4" icon={["lower"]}>
...
<Ability id="hexicetomb-ice-tomb-su-fn3-5" icon={["lower"]}>
...
<Ability id="hexinfectedwounds-infected-wounds-su-fn3-6" icon={["lower"]}>
...
<Ability id="hexmajorameliorating-major-ameliorating-su-fn6" icon={["aid","protect"]}>
...
<Ability id="hexmajorhealing-major-healing-su-fn7" icon={["aid"]}>
...
<Ability id="hexnightmares-nightmares-su-fn7-2" icon={["lower"]}>
...
<Ability id="hexpariah-pariah-su-fn8" icon={["lower"]}>
...
<Ability id="hexprophecy-prophecy-su-fn4-4" icon={["magic"]}>
...
<Ability id="hexregenerativesinew-regenerative-sinew-su-fn6-2" icon={["aid"]}>
...
<Ability id="hexrestlessslumber-restless-slumber-su-fn9" icon={["lower"]}>
...
<Ability id="hexretribution-retribution-su-fn7-3" icon={["lower"]}>
...
<Ability id="hexspeakindreams-speak-in-dreams-sp-fn3-7" icon={["magic"]}>
...
<Ability id="hexstealvoice-steal-voice-su-fn10" icon={["lower"]}>
...
<Ability id="hexvision-vision-su-fn7-4" icon={["magic"]}>
...
<Ability id="hexwaxenimage-waxen-image-su-fn7-5" icon={["magic","lower"]}>
...
<Ability id="hexweathercontrol-weather-control-su-fn11" icon={["magic"]}>
...
<Ability id="hexwitchsbounty-witchs-bounty-su-fn12" icon={["magic"]}>
...
<Ability id="hexwitchsbrew-witchs-brew-ex-fn3-8" icon={["power"]}>
...
<Ability id="hexwitchscharge-witchs-charge-su-fn12-2" icon={["protect"]}>
...
<Ability id="hexwithering-withering-su-fn9-2" icon={["lower","boost"]}>
...
<hr/>
<Ability id="phrenicampdeflectionfield-deflection-field-su-fn1" icon={["def"]}>
...
<Ability id="phrenicampdispellingpulse-dispelling-pulse-su-fn2" icon={["lower"]}>
...
<Ability id="phrenicampdualamplification-dual-amplification-ex-fn2-2" icon={["power"]}>
...
<Ability id="phrenicampmimicmetamagic-mimic-metamagic-ex-fn2-3" icon={["power","magic"]}>
...
<Ability id="phrenicampspacerendingspell-space-rending-spell-su-fn2-4" icon={["magic"]}>
...
<Ability id="phrenicampsubordinatespell-subordinate-spell-ex-fn3" icon={["magic"]}>
...
<Ability id="phrenicampsynapticshock-synaptic-shock-su-fn3-2" icon={["lower"]}>
...
<Ability id="phrenicamptelepathictargeting-telepathic-targeting-su-fn1-2" icon={["magic","boost"]}>
...
<Ability id="phrenicampturningshield-turning-shield-su-fn3-3" icon={["def"]}>
...
<hr/>
<Ability id="trickallaypain-allay-pain-fn1" icon={["protect"]}>
...
<Ability id="trickavianescape-avian-escape-fn2" icon={["protect","magic"]}>
...
<Ability id="trickconcealingveil-concealing-veil-fn3" icon={["protect"]}>
...
<Ability id="trickcursedsanction-cursed-sanction-fn2-2" icon={["protect"]}>
...
<Ability id="trickfakeddeath-faked-death-fn4" icon={["protect","magic"]}>
...
<Ability id="trickfreeinbody-free-in-body-fn4-2" icon={["protect"]}>
...
<Ability id="trickgreatermaskmisery-greater-mask-misery-fn4-3" icon={["aid"]}>
...
<Ability id="trickmentalfallback-mental-fallback-fn4-4" icon={["protect","magic"]}>
...
<Ability id="trickshadowblend-shadow-blend-fn1-2" icon={["protect"]}>
...
<Ability id="trickspatialswitch-spatial-switch-fn4-5" icon={["magic"]}>
...
<Ability id="trickspellanticipation-spell-anticipation-fn4-6" icon={["protect","magic"]}>
...
<Ability id="trickumbraltransformation-umbral-transformation-fn1-3" icon={["power","down"]}>
...
<Ability id="trickvisionofblood-vision-of-blood-fn4-7" icon={["lower"]}>
...
<Ability id="trickwillfulignorance-willful-ignorance-fn3-2" icon={["power","protect"]}>
...
<Ability id="ninjatrickassassinate-assassinate-ex-fn1" icon={["power","lower"]}>
...
<Ability id="ninjatrickblindingbomb-blinding-bomb-ex-fn1-2" icon={["lower"]}>
...
<Ability id="ninjatrickfracturedmirror-fractured-mirror-su-fn2" icon={["def","magic","boost"]}>
...
<Ability id="ninjatrickgreaterkivenom-greater-ki-venom-ex-fn3" icon={["boost"]}>
...
<Ability id="ninjatrickinvisibleblade-invisible-blade-su-fn1-3" icon={["magic"]}>
...
<Ability id="ninjatrickmasterdisguise-master-disguise-su-fn1-4" icon={["boost"]}>
...
<Ability id="ninjatrickshadowsplit-shadow-split-su-fn1-5" icon={["def","magic"]}>
...
<Ability id="ninjatrickaccelerationofform-acceleration-of-form-su-fn2-2" icon={["def","boost"]}>
...
<Ability id="ninjatrickdeepcover-deep-cover-ex-fn3-2" icon={["power"]}>
...
<div className="abilityGroup">
<Ability id="ninjatrickmanyguises-many-guises-ex-fn3-3" icon={["power"]}>
...
<Ability id="ninjatrickfalseface-false-face-su-fn2-3" icon={["power","magic"]}>
...
<Ability id="ninjatrickghoststep-ghost-step-su-fn1-6" icon={["power"]}>
...
<Ability id="ninjatrickkamiwarden-kami-warden-su-fn2-4" icon={["power","protect","def"]}>
...
<Ability id="ninjatrickkawarimi-kawarimi-su-fn4" icon={["def"]}>
...
<Ability id="ninjatrickoccultedsoul-occulted-soul-su-fn3-4" icon={["magic","def"]}>
...
<Ability id="ninjatrickseetheunseen-see-the-unseen-su-fn1-7" icon={["magic"]}>
...
<Ability id="ninjatrickunboundsteps-unbound-steps-su-fn1-8" icon={["power"]}>
...
<Ability id="ninjatrickadvancedtalent-advanced-talent-fn1-9" icon={["power"]}>
...
<Ability id="ninjatrickallthestarsinthesky-all-the-stars-in-the-sky-ex-fn2-5" icon={["power"]}>
...
<Ability id="ninjatrickdeadlyshuriken-deadly-shuriken-ex-fn1-10" icon={["ranged","boost"]}>
...
<Ability id="ninjatrickevasion-evasion-ex-fn1-11" icon={["def"]}>
...
<Ability id="ninjatrickfeat-feat-fn1-12" icon={["power"]}>
...
<Ability id="ninjatrickspiritualcompanion-spiritual-companion-ex-fn2-6" icon={["power"]}>
...
<Ability id="ninjatrickunarmedcombatmastery-unarmed-combat-mastery-ex-fn1-13" icon={["melee","boost"]}>
...
<p>These tricks add effects to a ninja's <Link to="/ability/sneak_attack">sneak attack</Link>. Only one of these tricks can be applied to an individual attack and the decision must be made before the attack is made.</p>
<Ability id="ninjatrickbleedingattack-bleeding-attack-ex-fn1" icon={["boost"]}>
...
<Ability id="ninjatrickkiblock-ki-block-su-fn1-2" icon={["lower"]}>
...
<Ability id="ninjatrickpressurepoints-pressure-points-su-fn1-3" icon={["boost"]}>
...
<Ability id="ninjatrickslowreactions-slow-reactions-ex-fn1-4" icon={["lower"]}>
...
<Ability id="ninjatrickdeadlyrange-deadly-range-ex-fn1-5" icon={["boost","ranged"]}>
...
<p>These tricks use or modify the ninja's ki pool.</p>
<Ability id="ninjatrickacrobaticmaster-acrobatic-master-su-fn1-6" icon={["boost"]}>
...
<div className="abilityGroup">
<Ability id="ninjatrickhighjumper-high-jumper-ex-fn1-7" icon={["boost"]}>
...
<Ability id="ninjatrickblooddebt-blood-debt-su-fn2" icon={["power","protect","def"]}>
...
<Ability id="ninjatrickbreathoftheancestors-breath-of-the-ancestors-su-fn3" icon={["cone","line"]}>
...
<Ability id="ninjatrickdarkvision-darkvision-su-fn1-8" icon={["power"]}>
...
<Ability id="ninjatrickfeatherfall-feather-fall-su-fn1-9" icon={["magic"]}>
...
<Ability id="ninjatrickflurryofstars-flurry-of-stars-ex-fn1-10" icon={["ranged","boost","down"]}>
...
<Ability id="ninjatrickforgottentrick-forgotten-trick-ex-fn1-11" icon={["power"]}>
...
<Ability id="ninjatrickherbalcompound-herbal-compound-ex-fn4" icon={["down","def"]}>
...
<Ability id="ninjatrickkamikaze-kamikaze-su-fn2-2" icon={["boost"]}>
...
<Ability id="ninjatrickkicharge-ki-charge-su-fn1-12" icon={["ranged"]}>
...
<Ability id="ninjatrickkivenom-ki-venom-ex-fn4-2" icon={["power","lower"]}>
...
<Ability id="ninjatrickshadowclone-shadow-clone-su-fn1-13" icon={["def","magic"]}>
...
<Ability id="ninjatricksmokebomb-smoke-bomb-ex-fn1-14" icon={["power","zap"]}>
...
<div className="abilityGroup">
<Ability id="ninjatrickpoisonbomb-poison-bomb-ex-fn1-15" icon={["power"]}>
...
<div className="abilityGroup">
<Ability id="ninjatrickchokingbomb-choking-bomb-ex-fn1-16" icon={["power","lower"]}>
...
<Ability id="ninjatrickstrangler-strangler-ex-fn4-3" icon={["melee"]}>
...
<Ability id="ninjatricksuddendisguise-sudden-disguise-su-fn1-17" icon={["magic"]}>
...
<Ability id="ninjatrickvanishingtrick-vanishing-trick-su-fn1-18" icon={["magic"]}>
...
<Ability id="ninjatrickventriloquism-ventriloquism-su-fn1-19" icon={["magic"]}>
...
<Ability id="ninjatrickarcanebackfire-arcane-backfire-su-fn5" icon={["lower"]}>
...
<Ability id="ninjatrickcombattrick-combat-trick-ex-fn1-20" icon={["power"]}>
...
<Ability id="ninjatrickfaststealth-fast-stealth-ex-fn1-21" icon={["boost"]}>
...
<Ability id="ninjatrickhiddenweapons-hidden-weapons-ex-fn1-22" icon={["boost"]}>
...
<Ability id="ninjatrickredirectforce-redirect-force-ex-fn2-3" icon={["down","boost"]}>
...
<Ability id="ninjatrickroguetalent-rogue-talent-fn1-23" icon={["power"]}>
...
<Ability id="ninjatrickslowmetabolism-slow-metabolism-ex-fn1-24" icon={["def"]}>
...
<Ability id="ninjatrickstylemaster-style-master-fn1-25" icon={["power"]}>
...
<Ability id="ninjatrickswarmingattack-swarming-attack-fn5-2" icon={["boost"]}>
...
<Ability id="ninjatrickswiftpoisoner-swift-poisoner-ex-fn4-4" icon={["boost"]}>
...
<Ability id="ninjatrickunarmedcombattraining-unarmed-combat-training-ex-fn1-26" icon={["power","melee"]}>
...
<div className="abilityGroup">
<Ability id="ninjatrickdeflectarrows-deflect-arrows-ex-fn1-27" icon={["power"]}>
...
<div className="abilityGroup">
<Ability id="ninjatricksnatcharrows-snatch-arrows-fn1-28" icon={["def","power"]}>
...
<Ability id="ninjatrickundetectedsabotage-undetected-sabotage-ex-fn1-29" icon={["power"]}>
...
<Ability id="ninjatrickwallclimber-wall-climber-su-fn1-30" icon={["power"]}>
...
<Ability id="ninjatrickweapontraining-weapon-training-ex-fn1-31" icon={["power"]}>
...
<Ability id="swashdeedderringdo-derring-do-ex-fn1" icon={["boost"]}>
...
<Ability id="swashdeeddodgingpanache-dodging-panache-ex-fn2" icon={["def"]}>
...
<Ability id="swashdeedopportuneparryandriposte-opportune-parry-and-riposte-ex-fn2-2" icon={["def","melee"]}>
...
<Ability id="swashdeedkipup-kip-up-ex-fn2-3" icon={["power"]}>
...
<Ability id="swashdeedmenacingswordplay-menacing-swordplay-ex-fn2-4" icon={["lower"]}>
...
<Ability id="swashdeedprecisestrike-precise-strike-ex-fn2-5" icon={["melee","boost"]}>
...
<Ability id="swashdeedswashbucklerinitiative-swashbuckler-initiative-ex-fn3" icon={["boost"]}>
...
<Ability id="swashdeedsuperiorfeint-superior-feint-ex-fn3-2" icon={["lower"]}>
...
<Ability id="swashdeedswashbucklersgrace-swashbucklers-grace-ex-fn3-3" icon={["boost"]}>
...
<Ability id="swashdeedtargetedstrike-targeted-strike-ex-fn3-4" icon={["melee","lower"]}>
...
<Ability id="swashdeedbleedingwound-bleeding-wound-ex-fn3-5" icon={["boost"]}>
...
<Ability id="swashdeedevasive-evasive-ex-fn4" icon={["def"]}>
...
<Ability id="swashdeedsubtleblade-subtle-blade-ex-fn4-2" icon={["def"]}>
...
<Ability id="swashdeeddizzyingdefense-dizzying-defense-ex-fn4-3" icon={["boost","def"]}>
...
<Ability id="swashdeedperfectthrust-perfect-thrust-ex-fn4-4" icon={["touch","lower"]}>
...
<Ability id="swashdeedswashbucklersedge-swashbucklers-edge-ex-fn4-5" icon={["power"]}>
...
<Ability id="swashdeedcheatdeath-cheat-death-ex-fn4-6" icon={["def"]}>
...
<Ability id="swashdeeddeadlystab-deadly-stab-ex-fn4-7" icon={["lower"]}>
...
<Ability id="swashdeedstunningstab-stunning-stab-ex-fn4-8" icon={["lower"]}>
...
<Ability id="vengeful-heart-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="resolve-ex" extraClasses="subAbility" icon={["power","aid","roll","def"]}>
...
<Ability id="hilt-hammer-ex" icon={["down","boost"]}>
...
<Ability id="dodging-dance-ex" icon={["def","melee"]}>
...
<Ability id="vengeful-soul-ex" extraClasses="hasSubs" icon={["power"]}>
...
<Ability id="greater-resolve-ex" extraClasses="subAbility" icon={["def"]}>
...
<Ability id="true-resolve-ex" extraClasses="subAbility" icon={["def"]}>
...
<hr/>
<Ability id="trickastoundingavoidance-astounding-avoidance-fn1" icon={["protect"]}>
...
<Ability id="trickbreakstupor-break-stupor-fn2" icon={["aid","down"]}>
...
<Ability id="trickchainofeyes-chain-of-eyes-fn3" icon={["power","down"]}>
...
<Ability id="trickcompelalacrity-compel-alacrity-fn1-2" icon={["boost","def"]}>
...
<Ability id="trickenchantingwords-enchanting-words-fn2-2" icon={["boost"]}>
...
<Ability id="trickfalseflanker-false-flanker-fn1-3" icon={["boost"]}>
...
<Ability id="trickfearsomeguise-fearsome-guise-fn1-4" icon={["magic","boost"]}>
...
<Ability id="trickfleetinshadows-fleet-in-shadows-fn4" icon={["boost"]}>
...
<Ability id="trickgiftofwill-gift-of-will-fn1-5" icon={["protect"]}>
...
<Ability id="tricklevitationbuffer-levitation-buffer-fn5" icon={["protect"]}>
...
<Ability id="trickliferevier-life-revier-fn6" icon={["boost"]}>
...
<Ability id="tricklinkedreaction-linked-reaction-fn5-2" icon={["boost"]}>
...
<Ability id="trickmaskmisery-mask-misery-fn5-3" icon={["aid"]}>
...
<Ability id="trickmeekfacade-meek-facade-fn5-4" icon={["protect","magic"]}>
...
<Ability id="trickmesmericmirror-mesmeric-mirror-fn5-5" icon={["protect"]}>
...
<Ability id="trickmesmericpantomime-mesmeric-pantomime-fn5-6" icon={["boost"]}>
...
<Ability id="trickmisdirection-misdirection-fn5-7" icon={["lower"]}>
...
<Ability id="trickpsychicimpression-psychic-impression-fn7" icon={["magic"]}>
...
<Ability id="trickpsychosomaticsurge-psychosomatic-surge-fn5-8" icon={["aid"]}>
...
<Ability id="trickreflectfear-reflect-fear-fn4-2" icon={["aid"]}>
...
<Ability id="trickreflectionofweakness-reflection-of-weakness-fn5-9" icon={["protect","lower"]}>
...
<Ability id="trickseeindarkness-see-in-darkness-fn4-3" icon={["power"]}>
...
<Ability id="trickshadowsplinter-shadow-splinter-fn8" icon={["protect"]}>
...
<Ability id="trickslipbonds-slip-bonds-fn3-2" icon={["protect"]}>
...
<Ability id="trickspectralsmoke-spectral-smoke-fn8-2" icon={["protect"]}>
...
<Ability id="tricktelepathiclink-telepathic-link-fn7-2" icon={["power"]}>
...
<Ability id="trickumbralshield-umbral-shield-fn4-4" icon={["protect"]}>
...
<Ability id="trickunwittingmessenger-unwitting-messenger-fn3-3" icon={["magic"]}>
...
<Ability id="trickvanisharrow-vanish-arrow-fn8-3" icon={["protect"]}>
...
<Ability id="trickvoiceofreason-voice-of-reason-fn7-3" icon={["protect"]}>
