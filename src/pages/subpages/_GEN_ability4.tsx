...
const _unchained_eidolon_subtypes = {title: "Unchained Eidolon Subtypes", topLink: ["Unchained Summoner","class/unchained_summoner"], jsx: <div className="compilation"><h2 id="ability-unchained_eidolon_subtypes-subtypes">Subtypes</h2>
...
<p><Link to="/eidolon/aeon">⮞</Link> Created to monitor a specific duality, an aeon eidolon often proves frustratingly headstrong in enforcing its own interpretation of balance. <sup><InnerLink showBacklink="backlink-ability-unchained_eidolon_subtypes-fake-fn-2" id="ability-unchained_eidolon_subtypes-fake-fn-2" data-hash-target to="ability-unchained_eidolon_subtypes-fake-fn-2-target">2</InnerLink></sup></p>
<Block size="simple">
...
<p><Link to="/eidolon/daemon">⮞</Link> The agents of horrible deaths, <Link to="/family/daemon">daemon</Link> eidolons desire the utter annihilation of all things. Their forms vary wildly depending on which type of death they embody, and daemon eidolons sometimes represent a more obscure kind of death than the most famous daemons. Daemon eidolons wish to sow death and misery through a variety of means. Most are capable of seeing the big picture, and will obediently follow even a neutral summoner. Ending lives is a typical part of an adventurer's career, so following along with a summoner gives a daemon eidolon many opportunities to gather mortal soul energy for its own dark and inscrutable purposes. <sup><InnerLink showBacklink="backlink-ability-unchained_eidolon_subtypes-fake-fn-6" id="ability-unchained_eidolon_subtypes-fake-fn-6" data-hash-target to="ability-unchained_eidolon_subtypes-fake-fn-6-target">6</InnerLink></sup></p>
<Block size="simple">
...
<p><Link to="/eidolon/protean">⮞</Link> Serpentine beings of pure chaos, <Link to="/family/protean">proteans</Link> seek to reshape reality. Protean eidolons appreciate creative summoners who often rebuild their forms and make liberal use of the <Link to="/spell/transmogrify">transmogrify</Link> spell. Beyond that, protean eidolons are happy to work with their summoners for any purpose, though they are quick to remind their summoners that while they have a mutually beneficial relationship, they are not servants. <sup><InnerLink showBacklink="backlink-ability-unchained_eidolon_subtypes-fake-fn-9.3" id="ability-unchained_eidolon_subtypes-fake-fn-9.3" data-hash-target to="ability-unchained_eidolon_subtypes-fake-fn-9-target">9</InnerLink></sup></p>
<Block size="simple">
...
<p><Link to="/eidolon/radiant">⮞</Link> Practically glowing with the Positive Energy Plane's potential, radiant eidolons make for passionate, if judgmental, companions that often have avian features. <sup><InnerLink showBacklink="backlink-ability-unchained_eidolon_subtypes-fake-fn-15" id="ability-unchained_eidolon_subtypes-fake-fn-15" data-hash-target to="ability-unchained_eidolon_subtypes-fake-fn-15-target">15</InnerLink></sup></p>
<Block size="simple">
<Row><Cell>Alignment</Cell><Cell>Neutral.</Cell></Row>
