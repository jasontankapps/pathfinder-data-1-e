...
<Ability id="deadly-range-ex" icon={["boost"]}>
...
<Ability id="blood-reader-ex" icon={["power"]}>
...
<Ability id="eternal-opposition-ex" icon={["def"]}>
...
<Ability id="jaguars-grace-ex" icon={["boost"]}>
...
<Ability id="jaguars-pounce-ex" icon={["melee"]}>
...
<Ability id="jaguars-protection-ex" icon={["protect"]}>
...
<Ability id="mountainside-ambush-ex" icon={["boost"]}>
...
<Ability id="studied-ally-ex" icon={["boost","protect"]}>
...
<Ability id="catfolk-rogue-talent" icon={["power"]}>
...
<Ability id="experience-across-ages-ex" icon={["power"]}>
...
<Ability id="foil-scrutiny" icon={["boost","def"]}>
...
<Ability id="inured-to-terror-ex" icon={["def"]}>
...
<Ability id="mystic-veil-sp" icon={["magic"]}>
...
<Ability id="toxin-training-ex" icon={["def"]}>
...
<Ability id="focused-poison-ex" icon={["boost"]}>
...
<Ability id="ranger-combat-style-ex" icon={["power"]}>
...
<Ability id="recall-training-ex" icon={["power"]}>
...
<Ability id="redirect-poison-ex" icon={["def","melee"]}>
...
<Ability id="scrying-familiarity-ex" icon={["def","boost","roll"]}>
...
<Ability id="sticks-and-stones-ex" icon={["power"]}>
...
<Ability id="sunlight-strike-ex" icon={["lower"]}>
...
<Ability id="sure-footing-ex" icon={["boost"]}>
...
<Ability id="trapfinding" icon={["skill","power"]}>
...
<Ability id="armored-marauder-ex" icon={["power","boost"]}>
...
<Ability id="marksmans-shot-ex" icon={["boost"]}>
...
<Ability id="reaping-stalker-ex" icon={["boost"]}>
...
<Ability id="rogue-and-ninja-advanced-talents" icon={["power"]}>
...
<Ability id="slayer-camouflage-ex" icon={["def"]}>
...
<Ability id="swallow-reversal-ex" icon={["melee","roll"]}>
