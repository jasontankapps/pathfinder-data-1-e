...
<Ability id="spirit-su" icon={["power","boost"]}>
...
<Ability id="spirit-bonus-su" icon={["boost"]}>
<Pair single id="spirit-bonus-su">Spirit Bonus (Su)</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Passive Ability">When you channel a spirit, you gain a bonus on certain checks and to certain statistics, depending on the spirit. <Bonus y c="medium" n={4} p={1} />.</Pair>
</Ability>
<Ability id="spirit-surge-su" icon={["def"]}>
...
<Ability id="shared-seance-su" icon={["boost"]}>
...
<Ability id="taboo-ex" icon={["boost"]}>
...
<Ability id="haunt-channeler-su" icon={["boost","melee"]}>
...
<Ability id="connection-channel-sp" icon={["boost"]}>
...
<Ability id="propitiation-su" icon={["def"]}>
...
<Ability id="ask-the-spirits-sp" icon={["magic"]}>
...
<Ability id="astral-journey-sp" icon={["magic"]}>
...
<Ability id="trance-of-three-su" icon={["boost"]}>
...
<Ability id="spacious-soul-su" icon={["power","magic"]}>
...
<Ability id="spirit-mastery-ex" icon={["boost"]}>
...
<Ability id="astral-beacon-su" icon={["power","boost"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-medium--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-medium/fiend_keeper">Fiend Keeper</Link></p><p><strong>Modifies or Replaces:</strong> Alignment; Spirit; Haunt Channeler; Location Channel; Connection Channel; Ask the Spirits</p><p>(Grippli only) Fiend keepers serve as a vessel to contain one of the world's evil spirits so that it cannot inflict further harm.</p></div>
...
<Ability id="order-ex" icon={["power","boost","skill"]}>
...
<Ability id="resolve-ex" icon={["power","aid","roll","def"]}>
<Pair single id="resolve-ex">Resolve (Ex)</Pair>
<Pair title="Gained">At 1st Level</Pair>
<Pair title="Passive Ability">You gain <em>resolve</em> that you can call upon to endure even the most devastating wounds and afflictions. Whenever you defeat the target of your <em>challenge,</em> you regain one daily use of your <em>resolve,</em> up to your maximum number of uses per day. Defeating the target of your <em>challenge</em> usually involves reducing the target to 0 hit points or fewer, but the GM might rule that an enemy who surrenders or flees the battle is also defeated. You can use this <em>resolve</em> in a number of ways.</Pair>
...
<Ability id="weapon-expertise-ex" icon={["boost"]}>
...
<Ability id="mounted-archer-ex" icon={["boost"]}>
...
<Ability id="banner-ex" icon={["def","boost"]}>
...
<Ability id="greater-resolve-ex" icon={["def"]}>
...
<Ability id="honorable-stand-ex" icon={["def","roll"]}>
...
<Ability id="true-resolve-ex" icon={["def"]}>
...
<Ability id="last-stand-ex" icon={["def"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-samurai--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Ability id="spirit-su" icon={["power","magic"]}>
...
<Ability id="spirit-animal-ex" icon={["power"]}>
...
<Ability id="spirit-magic" icon={["magic"]}>
...
</aside><Ability id="wandering-spirit-su" icon={["power","magic"]}>
...
<Ability id="wandering-hex" icon={["magic"]}>
...
<Ability id="manifestation-su" icon={["power"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-shaman--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
</aside><Ability id="chaotic-evil-good-and-lawful-spells" icon={["magic"]}>
...
<Ability id="blessings-su" icon={["power","magic"]}>
...
<Ability id="focus-weapon" icon={["power"]}>
...
</aside><Ability id="sacred-weapon-su" icon={["boost"]}>
...
<Ability id="fervor-su" icon={["aid","touch","magic"]}>
...
<Ability id="channel-energy-su" icon={["aura","aid"]}>
...
<Ability id="sacred-armor-su" icon={["def"]}>
...
<Ability id="aspect-of-war-su" icon={["boost","def","magic"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-warpriest--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<Message arch /><div className="archetype"><p><Link to="/arc-warpriest/calamity_caller">Calamity Caller</Link></p><p><strong>Modifies or Replaces:</strong> Blessings; Focus Weapon; Sacred Weapon; Bonus Feats; Aspect of War</p><p>(Elf Only) While all elves feel a deep connection to nature, some elven priests take this bond further, using their link to call down the wrath of nature upon their enemies</p></div>
...
<DisplayTable table={{"id":"warpriest archetypes","columns":[{"header":"Archetype","link":"arc-warpriest"},{"header":"Alignment"},{"header":"Armor Proficiency"},{"header":"Aspect of War"},{"header":"Blessings"},{"header":"Blessings (Major)"},{"header":"Bonus Feats"},{"header":"3rd-level Bonus Feat"},{"header":"6th-level Bonus Feat"},{"header":"9th-level Bonus Feat"},{"header":"12th-level Bonus Feat"},{"header":"15th-level Bonus Feat"},{"header":"18th-level Bonus Feat"},{"header":"Bonus Languages"},{"header":"Channel Energy"},{"header":"Class Skills"},{"header":"Deity"},{"header":"Fervor"},{"header":"Focus Weapon"},{"header":"Sacred Armor"},{"header":"Sacred Weapon"},{"header":"Skill Ranks"},{"header":"Spellcasting"},{"header":"Spontaneous Casting"},{"header":"Weapon Proficiency"}],"data":[[["Calamity Caller","calamity_caller"],null,null,"X","X",null,"X",null,null,null,null,null,null,null,null,null,null,null,"X",null,"X",null,null,null,null],[["Champion of the Faith","champion_of_the_faith"],null,null,null,null,null,null,"X",null,null,null,null,null,null,"X",null,null,null,null,null,"X",null,null,null,null],[["Cult Leader","cult_leader"],null,"X",null,null,null,null,"X",null,"X","X","X",null,null,"X","X",null,null,"X",null,null,"X",null,null,"X"],[["Disenchanter","disenchanter"],null,null,null,null,null,"X",null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null,null],[["Divine Champion","divine_champion"],null,null,null,null,null,null,"X","X","X","X",null,"X",null,null,null,null,null,null,null,null,null,null,null,null],[["Divine Commander","divine_commander"],null,null,null,"X",null,null,"X","X",null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null],[["Feral Champion","feral_champion"],null,null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,null],[["Fist of the Godclaw","fist_of_the_godclaw"],"X",null,"X","X",null,null,"X","X",null,"X",null,null,null,null,null,"X",null,null,null,null,null,null,null,null],[["Forgepriest","forgepriest"],null,null,null,"X",null,"X","X","X",null,null,null,null,null,"X",null,null,null,null,null,null,null,"X",null,null],[["Jistkan Magistrate","jistkan_magistrate"],null,null,null,"X",null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null,"X",null],[["Liberty's Blade","libertys_blade"],null,null,null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X",null,null,null,null],[["Mantis Zealot","mantis_zealot"],"X","X","X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null,"X","X",null,null,null,"X"],[["Molthuni Arsenal Chaplain","molthuni_arsenal_chaplain"],null,null,null,"X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,"X","X",null,null,null,null],[["Proclaimer","proclaimer"],"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,"X","X",null,"X",null,null,null,"X",null],[["Proselytizer","proselytizer"],null,"X",null,"X","X",null,"X",null,null,null,null,null,null,null,null,null,null,null,"X","X",null,null,null,"X"],[["Sacred Fist","sacred_fist"],null,"X",null,null,null,null,"X","X","X","X",null,"X",null,null,"X",null,null,"X","X","X",null,null,null,"X"],[["Shieldbearer","shieldbearer"],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,"X","X","X",null,null,null,null],[["Sixth Wing Bulwark","sixth_wing_bulwark"],null,"X",null,null,null,null,null,"X",null,"X",null,"X",null,null,null,null,null,"X","X","X",null,null,null,null]],"initialColumn":0,"nullValue":"&nbsp;"}} />
...
<Ability id="hex" icon={["power","magic"]}>
...
</aside><Ability id="witchs-familiar-ex" icon={["power","magic"]}>
...
<Ability id="patron-spells" icon={["power","magic"]}>
...
<Ability id="major-hex" icon={["boost"]}>
...
<Ability id="grand-hex" icon={["boost"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-witch--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Arch-Familiar (Su)</td><td>At 20th level, the character's familiar is smarter and savvier than plenty of adventurers - and also more dangerous! The familiar's Intelligence increases by 5, and it gains 12 spells levels' worth of spell-like abilities (for example, three daily castings of <Link to="/spell/greater_invisibility">greater invisibility</Link>), drawn from spells its master can cast and using its master's caster levels, DCs, and so forth. This capstone is available to any class with a familiar.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
<tr><td>The Boss (Ex)</td><td>At 20th level, the character has become more than just a lone hero - she has become one of the senior figures of her field, with powers and responsibilities to match. The character becomes one of the leading figures in some manner of group or organization, as appropriate to the campaign and the setting. A wizard might become the dean of an arcane university or mages' guild, a fighter could command a mercenary army or a city guard, a cleric might lead a major temple or her own sect, and so forth. The player and the GM should work together to determine the specifics. The character gains the <Link to="/feat/leadership">Leadership</Link> feat if she does not already have it, and the number of followers that the feat grants is multiplied by 10 (although depending on the campaign and setting, the position may grant other powers as well). If multiple characters in a party select this capstone, the GM may consider pooling them to grant the players a particularly large and powerful organization, such as a small kingdom. Characters of any class can select this ability.</td></tr>
...
<Message arch /><div className="archetype"><p><Link to="/arc-witch/alley_witch">Alley Witch</Link></p><p><strong>Modifies or Replaces:</strong> Familiar; 1st and 6th-level Hexes</p><p>Some witches find their spark of magic in the long, dark shadows and forgotten places within the city.</p></div>
...
<Ability id="spellbooks" icon={["magic"]}>
...
<Ability id="arcane-bond-ex-or-sp" extraClasses="hasSubs" icon={["power","magic"]}>
...
<Ability id="bonded-object" extraClasses="subAbility numbered" icon={["magic"]}>
...
<Ability id="arcane-school" icon={["magic"]}>
...
<Message capstone /><div className="capstones"><ScrollContainer id="class-wizard--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Arch-Familiar (Su)</td><td>At 20th level, the character's familiar is smarter and savvier than plenty of adventurers - and also more dangerous! The familiar's Intelligence increases by 5, and it gains 12 spells levels' worth of spell-like abilities (for example, three daily castings of <Link to="/spell/greater_invisibility">greater invisibility</Link>), drawn from spells its master can cast and using its master's caster levels, DCs, and so forth. This capstone is available to any class with a familiar.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
<tr><td>The Boss (Ex)</td><td>At 20th level, the character has become more than just a lone hero - she has become one of the senior figures of her field, with powers and responsibilities to match. The character becomes one of the leading figures in some manner of group or organization, as appropriate to the campaign and the setting. A wizard might become the dean of an arcane university or mages' guild, a fighter could command a mercenary army or a city guard, a cleric might lead a major temple or her own sect, and so forth. The player and the GM should work together to determine the specifics. The character gains the <Link to="/feat/leadership">Leadership</Link> feat if she does not already have it, and the number of followers that the feat grants is multiplied by 10 (although depending on the campaign and setting, the position may grant other powers as well). If multiple characters in a party select this capstone, the GM may consider pooling them to grant the players a particularly large and powerful organization, such as a small kingdom. Characters of any class can select this ability.</td></tr>
...
<Message arch /><div className="archetype"><p><Link to="/arc-wizard/arcane_bomber">Arcane Bomber</Link></p><p><strong>Modifies or Replaces:</strong> Arcane Bond; Cantrips; Arcane School</p><p>To many wizards, the experimentation of the alchemist seems quaint, if not dangerous or frightening. A few wizards take up the secrets of the bomb, however, fusing alchemy with their already considerable magical power.</p></div>
...
<DisplayTable table={{"id":"wizard archetypes","columns":[{"header":"Archetype","link":"arc-wizard"},{"header":"Alignment"},{"header":"Arcane Bond"},{"header":"Arcane School"},{"header":"1st-level Arcane School Ability"},{"header":"6th-level Arcane School Ability"},{"header":"8th-level Arcane School Ability"},{"header":"Bonus Feats"},{"header":"5th-level Bonus Feat"},{"header":"10th-level Bonus Feat"},{"header":"15th-level Bonus Feat"},{"header":"20th-level Bonus Feat"},{"header":"Bonus School Spell Slots"},{"header":"Cantrips"},{"header":"Class Skills"},{"header":"Metamagic Mastery"},{"header":"Scribe Scroll"},{"header":"Spellbook"},{"header":"Spellcasting"}],"data":[[["Arcane Bomber","arcane_bomber"],null,"X","X",null,null,null,null,null,null,null,null,null,"X",null,null,null,null,null],[["Arcane Physician","arcane_physician"],null,null,"X",null,null,null,null,null,null,null,null,null,null,null,null,"X",null,null],[["Arcane Warden","arcane_warden"],null,null,"X",null,null,null,"X",null,null,null,null,null,null,"X","X","X",null,null],[["Bonded Wizard","bonded_wizard"],null,null,null,null,null,null,null,"X","X","X",null,null,null,null,null,"X",null,null],[["Chronomancer","chronomancer"],null,"X",null,null,null,null,null,null,"X","X","X",null,null,null,null,null,null,null],[["Clocksmith","clocksmith"],null,"X","X",null,null,null,"X",null,null,null,null,null,null,null,null,"X",null,null],[["Cruoromancer","cruoromancer"],null,"X",null,null,null,null,null,"X","X","X","X",null,null,null,null,null,null,null],[["Elder Mythos Scholar","elder_mythos_scholar"],null,"X",null,"X",null,"X",null,"X","X",null,null,null,null,null,null,"X","X",null],[["Exploiter Wizard","exploiter_wizard"],null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Familiar Adept","familiar_adept"],null,"X",null,null,null,null,null,"X","X",null,null,null,null,null,null,"X","X",null],[["First World Caller","first_world_caller"],null,"X","X",null,null,null,null,null,"X","X",null,null,null,null,null,"X",null,null],[["Hallowed Necromancer","hallowed_necromancer"],null,null,"X",null,null,null,null,"X","X","X",null,null,null,null,null,"X",null,"X"],[["Instructor","instructor"],null,"X",null,null,null,null,null,"X","X","X","X",null,null,null,null,null,null,null],[["Pact Wizard (FF)","pact_wizard_ff"],null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Pact Wizard (HHH)","pact_wizard_hhh"],null,null,null,null,null,null,null,"X","X","X","X",null,null,null,null,"X",null,"X"],[["Poleiheira Adherent","poleiheira_adherent"],null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Primalist","primalist"],null,"X",null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null],[["Runesage","runesage"],null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Scroll Scholar","scroll_scholar"],null,null,"X",null,null,null,null,"X",null,null,null,null,null,null,null,null,null,"X"],[["Scrollmaster","scrollmaster"],null,"X",null,null,null,null,null,null,"X",null,null,null,null,null,null,null,null,null],[["Shadowcaster","shadowcaster"],null,"X",null,null,null,null,null,"X","X",null,null,null,null,null,null,null,null,null],[["Siege Mage","siege_mage"],null,"X","X",null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null],[["Spell Sage","spell_sage"],null,"X","X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Spellbinder","spellbinder"],null,"X",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],[["Spellslinger","spellslinger"],null,"X","X",null,null,null,null,null,null,null,null,null,"X",null,null,"X",null,null],[["Spirit Binder","spirit_binder"],null,"X","X",null,null,null,"X",null,null,null,null,null,null,null,null,"X",null,null],[["Spirit Whisperer","spirit_whisperer"],null,"X","X",null,null,null,"X",null,null,null,"X",null,null,null,null,null,"X",null],[["Sword Binder","sword_binder"],null,"X","X",null,null,null,null,null,"X",null,null,"X",null,null,null,null,null,null],[["Undead Master","undead_master"],"X","X","X",null,null,null,null,"X","X","X","X",null,null,null,null,"X",null,null],[["Wind Listener","wind_listener"],null,"X","X",null,null,null,null,"X","X","X",null,null,null,"X",null,null,null,null],[["Worldseeker","worldseeker"],null,"X",null,null,"X","X",null,"X",null,"X",null,null,null,null,null,"X",null,null]],"initialColumn":0,"nullValue":"&nbsp;"}} />
