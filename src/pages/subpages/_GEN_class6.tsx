...
<div className="title abSingle" id="class-medium-spells" data-hash-target><div className="box">Spells</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain the ability to cast psychic spells which are drawn from the <Link to="/main/spells_medium">medium spell list</Link>. The DC for a saving throw against spells you cast is 10 + the spell level + your Charisma modifier. You must choose and prepare your spells in advance.</div></div></div><div className="abPair"><div className="abStart"><div className="box">Info</div></div><div className="abEnd"><div className="box"><p>A medium's selection of spells is limited. You begin play knowing two 0-level spells of your choice. At each new medium level you gain one or more new spells as indicated on the table above. Unlike spells per day, the number of spells you know is not affected by your Charisma score.</p>
...
<div className="title abSingle" id="class-medium-knacks" data-hash-target><div className="box">Knacks</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
<div className="title abSingle" id="class-medium-spirit-su" data-hash-target><div className="box">Spirit (Su)</div><div className="flavor">A medium serves as a vessel to channel spirits - astral echoes of powerful souls from ages past that live on in myth and legend.</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">At 6th Level</div></div><div className="abEnd"><div className="box">You also gain the spirit's intermediate spirit power.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 11th Level</div></div><div className="abEnd"><div className="box">You also gain its greater spirit power.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 17th Level</div></div><div className="abEnd"><div className="box">You also gain its supreme spirit power.</div></div></div>
...
<div className="title abSingle" id="class-medium-spirit-bonus-su" data-hash-target><div className="box">Spirit Bonus (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">When you channel a spirit, you gain a bonus on certain checks and to certain statistics, depending on the spirit. This bonus is equal to 1 + <Link to="/misc/one_fourth">one-fourth</Link> of your medium level.</div></div></div></div>
...
<div className="title abSingle" id="class-medium-spirit-surge-su" data-hash-target><div className="box">Spirit Surge (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">Once a round, at most.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">After failing a d20 roll that was modified by your spirit bonus, you can allow your spirit to gain 1 additional point of influence over you in order to add 1d6 to the check's result without taking an action. This can cause the check to succeed instead of fail. You must be conscious and aware to use this ability, and you can use this ability at most once per round.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 10th Level</div></div><div className="abEnd"><div className="box">Your spirit surge die increases to 1d8.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 20th Level</div></div><div className="abEnd"><div className="box">You spirit surge die increases to 1d10.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-medium-shared-seance-su" data-hash-target><div className="box">Shared Seance (Su)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">All allies who participate in your seance gain the channeled spirit's seance boon for 24 hours.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-medium-taboo-ex" data-hash-target><div className="box">Taboo (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 2nd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box"><p>During your daily seance, you can accept a taboo in order to appease your spirit. Each spirit lists example taboos, and the GM may allow additional taboos as well. Accepting a taboo allows you to use your spirit surge ability twice without incurring influence. You can select only a single taboo.</p>
...
<div className="title abSingle" id="class-medium-haunt-channeler-su" data-hash-target><div className="box">Haunt Channeler (Su)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">You can always act on the surprise round against a haunt.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">Your touch funnels a portion of the haunt into yourself, dealing 1d6 points of damage to the haunt per 2 medium levels you possess as if via positive energy and allowing you to ask the haunt a single question. The haunt can answer the question however it chooses. Additionally, you can forgo your saving throw against a haunt's effects to funnel the haunt entirely into yourself. If you do so, you suffer the haunt's full effect, but the haunt doesn't affect anyone else (even if it normally would). The haunt then gains control of your body for 24 hours. Once per minute, you can attempt to end this possession early by succeeding at a Will save (DC = 20 + 1/2 your medium level).</div></div></div></div>
...
<div className="title abSingle" id="class-medium-location-channel-sp" data-hash-target><div className="box">Location Channel (Sp)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can perform a special seance at the site of a person's death - or a location that was precious to that person in life - to call forth that person's spirit into your body so your allies can ask it questions. The effects are similar to the spell <Link to="/spell/call_spirit">call spirit</Link>, except that the duration is 1 round per medium level and the spirit possesses your body instead of appearing in a wispy form. The other participants of the seance must ask the questions.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">Once you attempt to call a spirit, you cannot attempt to call the same spirit again for 24 hours. Once per round, you can attempt to end the seance early by succeeding at a Will save (DC = 20 + 1/2 your medium level).</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-medium-connection-channel-sp" data-hash-target><div className="box">Connection Channel (Sp)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can use your <em>location channel</em> ability at any location, so long as you possess some connection to the deceased. If another participant in the seance is more familiar with the deceased than you, you can substitute that participant's familiarity in place of your own to determine the DC of the <em>call spirit</em> effect.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-medium-propitiation-su" data-hash-target><div className="box">Propitiation (Su)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You have learned hidden techniques and rites that allow you to mollify your channeled spirit once per day, reducing its influence over you by 1 point (to a minimum of 1 point of influence). The details of the propitiation ritual vary based on the individual spirit, but the process always takes around 10 minutes to perform and it never requires any additional cost (such as an offering of wealth or a live sacrifice).</div></div></div></div>
...
<div className="title abSingle" id="class-medium-ask-the-spirits-sp" data-hash-target><div className="box">Ask the Spirits (Sp)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can send your consciousness to the Astral Plane any number of times per day to ask the spirits for advice, as if using <Link to="/spell/contact_other_plane">contact other plane</Link> to contact the Astral Plane. You automatically succeed at the Intelligence check to avoid the possible decrease to your Intelligence and Charisma.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-medium-astral-journey-sp" data-hash-target><div className="box">Astral Journey (Sp)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can enter a deep coma in order to project yourself onto the Astral Plane as <Link to="/spell/astral_projection">astral projection</Link>, except you can project only yourself, you can't enter other planes, and your projected gear has no magical properties.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-medium-trance-of-three-su" data-hash-target><div className="box">Trance of Three (Su)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Swift Action</div></div><div className="abEnd"><div className="box">You can allow your spirit to gain 1 point of influence over you in order to allow a portion of a legendary spirit from another legend to enter you for 1 round per level, granting you the intermediate spirit power from another legend.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Free Action</div></div><div className="abEnd"><div className="box">You can end the <em>trance of three</em> early.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">If the granted power has a limited number of uses per day, you must keep track of the remaining uses even after the secondary spirit is gone; if you call the secondary spirit again that day, it can grant the remaining uses of that power. If you use an ability that incurs influence, your primary spirit gains that amount of influence over you, not the secondary spirit. You don't gain the benefits of your spirit bonus from the secondary spirit.</div></div></div></div>
...
<div className="title abSingle" id="class-medium-spacious-soul-su" data-hash-target><div className="box">Spacious Soul (Su)</div><div className="flavor">A medium's soul is spacious enough to provide a foothold for his fallen allies, if he so chooses.</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Immediate Action</div></div><div className="abEnd"><div className="box">If one of the allies who participated in your seance that day dies within line of effect and line of sight of you, you can accept that ally's spirit within you. Since the ally inhabits the portion of your soul normally reserved for a spirit, this suppresses your <em>spirit, spirit bonus,</em> and <em>spirit surge</em> abilities as long as you maintain this ability.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Info</div></div><div className="abEnd"><div className="box">The ally's spirit and you share the your body and can decide each round on the your turn which of you will take the you actions for that round. If you don't agree on who should act, you attempt opposed Charisma checks to determine who is dominant for the next hour, and the dominant character decides who acts on each round. The ally's spirit has all the spells and limited use abilities (such as uses of <em>channel energy, ki,</em> and <em>panache</em>) that it possessed at the time of death, but it is incapable of regaining any abilities, points, spells, or uses of abilities it expends. When the ally's spirit acts, it uses the ally's base attack bonus, caster level, and special abilities (such as weapon proficiency), but uses your physical ability scores.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Standard Action</div></div><div className="abEnd"><div className="box">You can end this effect early, though if the ally is unwilling to depart, you must succeed at a Will saving throw (DC = 10 + 1/2 the ally's hit dice + the ally's Charisma modifier) or the attempt fails and the ally becomes dominant for 24 hours.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">If the ally returns to life, this ability immediately ends. Otherwise, you can maintain this ability indefinitely.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-medium-spirit-mastery-ex" data-hash-target><div className="box">Spirit Mastery (Ex)</div><div className="flavor">The medium become a legend among spirits, particularly lesser spirits.</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can use your spirit surge ability an additional two times per day without incurring influence, regardless of whether you accept a taboo or channels a weaker spirit. When channeling a weaker spirit, you can use your spirit surge ability an additional four times per day for each power you forgo, instead of an additional two times.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-medium-astral-beacon-su" data-hash-target><div className="box">Astral Beacon (Su)</div><div className="flavor">A medium is an open connection to the Astral Plane and a shining beacon for spirits.</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Free Action</div></div><div className="abEnd"><div className="box">You can channel spirits of any of the five legends you did not contact via your seance. This ability lasts for 1 round and grants access to the intermediate, greater, and supreme spirit powers of the chosen spirits.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">Unlike trance of three, astral beacon allows spirits of the chosen legends (for instance, archmage) to gain influence over you until 24 hours from when you contacted your primary spirit. Also unlike trance of three, if you would incur influence by using one of the new spirits' abilities, that influence is added to your total influence from that spirit rather than from your primary spirit.</div></div></div></div>
...
<ScrollContainer id="class-medium--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<h3 id="class-medium-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
<p><strong>Catfolk:</strong> Add 1/3 to the result of any spirit surge die that the medium rolls.<sup><InnerLink showBacklink="backlink-class-medium-ref-A-1" id="class-medium-ref-A-1" data-hash-target to="class-medium-A">1</InnerLink></sup></p>
<p><strong>Dwarf:</strong> Gain a +1/2 bonus on saving throws against possession and a +1/2 bonus on saving throws to end haunt channeler, location channel, and spacious soul.<sup><InnerLink showBacklink="backlink-class-medium-ref-B-1" id="class-medium-ref-B-1" data-hash-target to="class-medium-B">2</InnerLink></sup></p>
<p><strong>Elf:</strong> Gain a +1/3 bonus on all skill checks using occult skill unlocks.<sup><InnerLink showBacklink="backlink-class-medium-ref-B-2" id="class-medium-ref-B-2" data-hash-target to="class-medium-B">2</InnerLink></sup></p>
<p><strong>Gillman:</strong> Increase the medium's spirit bonus by 1/6.<sup><InnerLink showBacklink="backlink-class-medium-ref-C-1" id="class-medium-ref-C-1" data-hash-target to="class-medium-C">3</InnerLink></sup></p>
<p><strong>Gnome:</strong> Gain a +1/2 bonus on Bluff, Diplomacy, Intimidate, and Sense Motive skill checks against spirits, undead, phantoms, and creatures native to the Astral Plane.<sup><InnerLink showBacklink="backlink-class-medium-ref-D-1" id="class-medium-ref-D-1" data-hash-target to="class-medium-D">4</InnerLink></sup></p>
<p><strong>Grippli:</strong> Add 1/4 to any checks modified by the medium's spirit surge ability.<sup><InnerLink showBacklink="backlink-class-medium-ref-E-1" id="class-medium-ref-E-1" data-hash-target to="class-medium-E">5</InnerLink></sup></p>
<p><strong>Half-elf:</strong> Gain a +1/3 bonus on all skill checks using occult skill unlocks.<sup><InnerLink showBacklink="backlink-class-medium-ref-D-2" id="class-medium-ref-D-2" data-hash-target to="class-medium-D">4</InnerLink></sup></p>
<p><strong>Halfling:</strong> Increase the bonus the medium gains from its seance boon by 1/3 point. This doesn't increase the bonus allies gain from shared seance.<sup><InnerLink showBacklink="backlink-class-medium-ref-D-3" id="class-medium-ref-D-3" data-hash-target to="class-medium-D">4</InnerLink></sup></p>
<p><strong>Half-orc:</strong> When gaining a taboo, the medium can use spirit surge without incurring influence an additional 1/4 time per day.<sup><InnerLink showBacklink="backlink-class-medium-ref-D-4" id="class-medium-ref-D-4" data-hash-target to="class-medium-D">4</InnerLink></sup></p>
<p><strong>Human:</strong> When gaining a taboo, the medium can use spirit surge without incurring influence an additional 1/4 time per day.<sup><InnerLink showBacklink="backlink-class-medium-ref-D-5" id="class-medium-ref-D-5" data-hash-target to="class-medium-D">4</InnerLink></sup></p>
<p><strong>Kitsune:</strong> Gain 1/6 of a new Magical Tail feat. Any kitsune character can choose this bonus upon gaining a level in her favored class.<sup><InnerLink showBacklink="backlink-class-medium-ref-F-1" id="class-medium-ref-F-1" data-hash-target to="class-medium-F">6</InnerLink></sup></p>
<p><strong>Shabti:</strong> Add 1/5 to the bonus allies gain from shared seance. This doesn't increase the medium's seance boon.<sup><InnerLink showBacklink="backlink-class-medium-ref-G-1" id="class-medium-ref-G-1" data-hash-target to="class-medium-G">7</InnerLink></sup></p>
<p><strong>Tengu:</strong> Add 1/4 to the bonus on checks when the medium uses the spirit surge ability.<sup><InnerLink showBacklink="backlink-class-medium-ref-H-1" id="class-medium-ref-H-1" data-hash-target to="class-medium-H">8</InnerLink></sup></p>
<p><strong>Wayang:</strong> When gaining a taboo, the medium can use spirit surge without incurring influence an additional 1/4 time per day.<sup><InnerLink showBacklink="backlink-class-medium-ref-I-1" id="class-medium-ref-I-1" data-hash-target to="class-medium-I">9</InnerLink></sup></p>
</div>
<h3 id="class-medium-archetypes" data-hash-target>Archetypes</h3>
<div className="archetype"><p><Link to="/arc-medium/fiend_keeper">Fiend Keeper</Link></p><p><strong>Modifies or Replaces:</strong> Alignment; Spirit; Haunt Channeler; Location Channel; Connection Channel; Ask the Spirits</p><p>Fiend keepers serve as a vessel to contain one of the world's evil spirits so that it cannot inflict further harm.</p></div>
...
<h3 id="class-medium-label">Footnotes</h3>
<ol>
<li id="class-medium-A">
<p><Link to="/source/blood_of_the_beast">Blood of the Beast pg. 4</Link> <InnerLink id="backlink-class-medium-ref-A-1" data-hash-target to="class-medium-ref-A-1" aria-label="Back to reference A-1">↩</InnerLink></p>
</li>
<li id="class-medium-B">
<p><Link to="/source/occult_adventures">Occult Adventures pg. 84</Link> <InnerLink id="backlink-class-medium-ref-B-1" data-hash-target to="class-medium-ref-B-1" aria-label="Back to reference B-1">↩</InnerLink> <InnerLink id="backlink-class-medium-ref-B-2" data-hash-target to="class-medium-ref-B-2" aria-label="Back to reference B-2">↩<sup>2</sup></InnerLink></p>
</li>
<li id="class-medium-C">
<p><Link to="/source/blood_of_the_sea">Blood of the Sea pg. 9</Link> <InnerLink id="backlink-class-medium-ref-C-1" data-hash-target to="class-medium-ref-C-1" aria-label="Back to reference C-1">↩</InnerLink></p>
</li>
<li id="class-medium-D">
<p>Occult Adventures pg. 85 <InnerLink id="backlink-class-medium-ref-D-1" data-hash-target to="class-medium-ref-D-1" aria-label="Back to reference D-1">↩</InnerLink> <InnerLink id="backlink-class-medium-ref-D-2" data-hash-target to="class-medium-ref-D-2" aria-label="Back to reference D-2">↩<sup>2</sup></InnerLink> <InnerLink id="backlink-class-medium-ref-D-3" data-hash-target to="class-medium-ref-D-3" aria-label="Back to reference D-3">↩<sup>3</sup></InnerLink> <InnerLink id="backlink-class-medium-ref-D-4" data-hash-target to="class-medium-ref-D-4" aria-label="Back to reference D-4">↩<sup>4</sup></InnerLink> <InnerLink id="backlink-class-medium-ref-D-5" data-hash-target to="class-medium-ref-D-5" aria-label="Back to reference D-5">↩<sup>5</sup></InnerLink></p>
</li>
<li id="class-medium-E">
<p>Blood of the Beast pg. 8 <InnerLink id="backlink-class-medium-ref-E-1" data-hash-target to="class-medium-ref-E-1" aria-label="Back to reference E-1">↩</InnerLink></p>
</li>
<li id="class-medium-F">
<p>Blood of the Beast pg. 12 <InnerLink id="backlink-class-medium-ref-F-1" data-hash-target to="class-medium-ref-F-1" aria-label="Back to reference F-1">↩</InnerLink></p>
</li>
<li id="class-medium-G">
<p><Link to="/source/plane_hoppers_handbook">Plane-Hopper's Handbook pg. 23</Link> <InnerLink id="backlink-class-medium-ref-G-1" data-hash-target to="class-medium-ref-G-1" aria-label="Back to reference G-1">↩</InnerLink></p>
</li>
<li id="class-medium-H">
<p>Blood of the Beast pg. 24 <InnerLink id="backlink-class-medium-ref-H-1" data-hash-target to="class-medium-ref-H-1" aria-label="Back to reference H-1">↩</InnerLink></p>
</li>
<li id="class-medium-I">
<p><Link to="/source/blood_of_shadows">Blood of Shadows pg. 11</Link> <InnerLink id="backlink-class-medium-ref-I-1" data-hash-target to="class-medium-ref-I-1" aria-label="Back to reference I-1">↩</InnerLink></p>
</li>
</ol>
</section>
</>};
const _samurai = {hasJL:true,title: "Samurai", jsx: <><div className="jumpList" id="class-samurai-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="class-samurai-challenge-ex">Challenge</InnerLink></li><li><InnerLink toTop to="class-samurai-mount-ex">Mount</InnerLink></li><li><InnerLink toTop to="class-samurai-order-ex">Order</InnerLink></li><li><InnerLink toTop to="class-samurai-resolve-ex">Resolve</InnerLink></li><li><InnerLink toTop to="class-samurai-determined">Determined</InnerLink></li><li><InnerLink toTop to="class-samurai-resolute">Resolute</InnerLink></li><li><InnerLink toTop to="class-samurai-unstoppable">Unstoppable</InnerLink></li><li><InnerLink toTop to="class-samurai-weapon-expertise-ex">Weapon Expertise</InnerLink></li><li><InnerLink toTop to="class-samurai-mounted-archer-ex">Mounted Archer</InnerLink></li><li><InnerLink toTop to="class-samurai-banner-ex">Banner</InnerLink></li><li><InnerLink toTop to="class-samurai-bonus-feat">Bonus Feat</InnerLink></li><li><InnerLink toTop to="class-samurai-greater-resolve-ex">Greater Resolve</InnerLink></li><li><InnerLink toTop to="class-samurai-honorable-stand-ex">Honorable Stand</InnerLink></li><li><InnerLink toTop to="class-samurai-demanding-challenge-ex">Demanding Challenge</InnerLink></li><li><InnerLink toTop to="class-samurai-greater-banner-ex">Other Abilities</InnerLink></li><li><InnerLink toTop to="class-samurai-alternate-capstones">Alternate Capstones</InnerLink></li><li><InnerLink toTop to="class-samurai-favored-class-bonuses">Favored Class Bonuses</InnerLink></li><li><InnerLink toTop to="class-samurai-archetypes">Archetypes</InnerLink></li><li><InnerLink toTop to="class-samurai-archetypes-by-feature">Archetypes by Feature</InnerLink></li></ul></div><h2 id="class-samurai-samurai">Samurai</h2>
...
<div className="title abSingle" id="class-samurai-challenge-ex" data-hash-target><div className="box">Challenge (Ex)</div><div className="flavor">A samurai can challenge a foe to combat.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Swift Action</div></div><div className="abEnd"><div className="box">You choose one target within sight to challenge. Your melee attacks deal extra damage when made against the target of your <em>challenge.</em> This extra damage is equal to your level. Challenging a foe requires much of your concentration. You take a -2 penalty to your Armor Class, except against attacks made by the target of your <em>challenge.</em></div></div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">The <em>challenge</em> remains in effect until the target is dead or unconscious or until the combat ends. Each samurai's <em>challenge</em> also includes another effect which is listed in the section describing your <em>order.</em></div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-samurai-mount-ex" data-hash-target><div className="box">Mount (Ex)</div><div className="flavor">A samurai gains the service of a loyal and trusty steed to carry him into battle.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box"><p>Your mount functions as a druid's <Link to="/sidekick/animal_companion">animal companion</Link>, using your samurai level as your effective druid level. The creature must be one that you are capable of riding and that is suitable as a mount. You do not take an armor check penalty on Ride checks while riding your mount. The mount is always considered combat trained and begins play with <Link to="/feat/light_armor_proficiency">Light Armor Proficiency</Link> as a bonus feat. Your mount does not gain the <em>share spells</em> special ability.</p>
...
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">Should your mount die, you may find another mount to serve you after 1 week of mourning. This new mount does not gain the <em>link, evasion, devotion,</em> or <em>improved evasion</em> special abilities until the next time you gain a level.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link><Link to="/icons/skills"><IonIcon icon="/icons/skills.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-samurai-order-ex" data-hash-target><div className="box">Order (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You must pledge yourself to a specific <Link to="/ability/orders">order</Link>, typically the <Link to="/order/order_of_the_warrior">order of the warrior</Link>. The order grants you a number of bonuses, class skills, and special abilities. In addition, each order includes a number of <strong className="hl">edicts</strong> that you must follow. If you violate any of these edicts, you lose the benefits from your order's <em>challenge</em> ability for 24 hours. The violation of an edict is subject to GM interpretation.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Info</div></div><div className="abEnd"><div className="box">Most samurai belong to the order of the warrior and are dedicated to their lord. Those without a lord, or who chose to abandon their lord, are <Link to="/order/ronin">ronin</Link>. You may instead elect to dedicate yourself to any other order, but such samurai are rare.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">A samurai who wishes to change his order must undertake a lengthy process to dedicate himself to a new cause. When this choice is made, you immediately lose all of the benefits from your old order. You must then follow the edicts of your new order for one entire level without gaining any benefits from that order. Once you have accomplished this, you gain all the bonuses from your new order. The only exception to this is when a samurai decides to become a ronin. You can elect to become a ronin immediately, losing all the benefits from your old order and replacing them with the new benefits from the ronin order. Once a ronin, however, the only way for you to change to another order is through the method described above. Note that the names of these orders might vary depending upon the campaign setting or GM's preference.</div></div></div></div>
<div className="ability hasSubs"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-samurai-resolve-ex" data-hash-target><div className="box">Resolve (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
<div className="ability subAbility numbered"><div className="abIcon"><Link to="/icons/heart-plus"><IonIcon icon="/icons/heart-plus.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-samurai-determined" data-hash-target><div className="box">Determined</div></div>
<div className="abPair"><div className="abStart"><div className="box">Standard Action</div></div><div className="abEnd"><div className="box">You can spend one use of your <em>resolve</em> to remove the <Link to="/misc/fatigued">fatigued</Link>, <Link to="/misc/shaken">shaken</Link>, or <Link to="/misc/sickened">sickened</Link> condition.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 8th Level</div></div><div className="abEnd"><div className="box">You can now remove the <Link to="/misc/exhausted">exhausted</Link>, <Link to="/misc/frightened">frightened</Link>, <Link to="/misc/nauseated">nauseated</Link>, or <Link to="/misc/staggered">staggered</Link> conditions, instead.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">If the condition has a duration longer than 1 hour or is permanent, this ability removes the condition for 1 hour, at which time the condition returns.</div></div></div></div>
<div className="ability subAbility numbered"><div className="abIcon"><Link to="/icons/rolling-dices"><IonIcon icon="/icons/rolling-dices.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-samurai-resolute" data-hash-target><div className="box">Resolute</div></div>
<div className="abPair"><div className="abStart"><div className="box">Immediate Action</div></div><div className="abEnd"><div className="box">Whenever you are required to make a Fortitude or Will save, you can spend one use of your <em>resolve</em> to roll twice and take the better result. You must decide to use this ability before you roll the saving throw.</div></div></div></div>
<div className="ability subAbility numbered"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-samurai-unstoppable" data-hash-target><div className="box">Unstoppable</div></div>
<div className="abPair"><div className="abStart"><div className="box">Immediate Action</div></div><div className="abEnd"><div className="box">When you are reduced to fewer than 0 hit points but not slain, you can spend one use of your <em>resolve</em> to instantly <Link to="/misc/stabilize">stabilize</Link> and remain conscious. You are staggered, but you do not fall unconscious and begin dying if you take a standard action. You do fall unconscious if you take additional damage from any source.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-samurai-weapon-expertise-ex" data-hash-target><div className="box">Weapon Expertise (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 3rd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">Select either the katana, <Link to="/eq-weapon/longbow">longbow</Link>, naginata, or wakizashi. Whenever you threaten a critical hit with the selected weapon, you gain a +2 bonus on the confirmation roll.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Free Action</div></div><div className="abEnd"><div className="box">You can draw the selected weapon as if you had the <Link to="/feat/quick_draw">Quick Draw</Link> feat.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">Your samurai levels count as fighter levels and stack with any fighter levels you possess for the purposes of meeting the prerequisites for feats that specifically select your chosen weapon, such as <Link to="/feat/weapon_specialization">Weapon Specialization</Link>.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-samurai-mounted-archer-ex" data-hash-target><div className="box">Mounted Archer (Ex)</div><div className="flavor">A samuari becomes skilled at firing ranged weapons while mounted.</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">You only take a -2 penalty on attack rolls with ranged weapons while your mount takes a double move. This penalty increases to -4 while your mount is running.</div></div></div></div>
...
<div className="title abSingle" id="class-samurai-banner-ex" data-hash-target><div className="box">Banner (Ex)</div><div className="flavor">A samurai's banner becomes a symbol of inspiration to his allies and companions.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 5th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">As long as your banner is clearly visible, all allies within 60 feet receive a +2 morale bonus on saving throws against fear and a +1 morale bonus on attack rolls made as part of a <Link to="/rule/charge">charge</Link>.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 10th Level</div></div><div className="abEnd"><div className="box">The bonus on saving throws becomes +3 and the charge bonus becomes +2.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 15th Level</div></div><div className="abEnd"><div className="box">These bonuses become +4 and +3.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 20th Level</div></div><div className="abEnd"><div className="box">These bonuses become +5 and +4.</div></div></div>
...
<div className="title abSingle" id="class-samurai-bonus-feat" data-hash-target><div className="box">Bonus Feat</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain a bonus <Link to="/main/combat_feat">combat feat</Link>. You must meet the prerequisites of this feat.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 12th Level</div></div><div className="abEnd"><div className="box">You gain a second bonus combat feat. You must meet the prerequisites of this feat.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 18th Level</div></div><div className="abEnd"><div className="box">You gain a third bonus combat feat. You must meet the prerequisites of this feat.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-samurai-greater-resolve-ex" data-hash-target><div className="box">Greater Resolve (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 9th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Immediate Action</div></div><div className="abEnd"><div className="box">After a critical hit is confirmed against you, you can spend one use of your <em>resolve</em> to treat that critical hit as a normal hit.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">Effects that only trigger on a critical hit do not trigger when you use this ability.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link><Link to="/icons/rolling-dices"><IonIcon icon="/icons/rolling-dices.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-samurai-honorable-stand-ex" data-hash-target><div className="box">Honorable Stand (Ex)</div><div className="flavor">A samurai can make an honorable stand, deciding to fight the target of his <em>challenge</em> to the bitter end, no matter the cost.</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">Once a day.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Swift Action</div></div><div className="abEnd"><div className="box">You can make an honorable stand. While doing so, you are immune to the shaken, frightened, and <Link to="/misc/panicked">panicked</Link> conditions. You do not fall unconscious while your hit point total is below 0. Finally, if you are making an honorable stand and must make a saving throw, you can spend one daily use of your <em>resolve</em> to reroll the saving throw after the first roll is made. You must take the result of the second roll, even if it is worse.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 16th Level</div></div><div className="abEnd"><div className="box">You can make an <em>honorable stand</em> twice a day.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">If you are making an honorable stand and ever retreat from battle against your <em>challenged</em> foe, you lose the ability to make a <em>challenge</em> for 24 hours.</div></div></div></div>
...
<div className="title abSingle" id="class-samurai-demanding-challenge-ex" data-hash-target><div className="box">Demanding Challenge (Ex)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">Whenever you declare a <em>challenge,</em> your target must pay attention to the threat you pose. As long as the target is within your threatened area, it takes a -2 penalty to its AC from attacks made by anyone other than you.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-samurai-greater-banner-ex" data-hash-target><div className="box">Greater Banner (Ex)</div><div className="flavor">A samurai's banner becomes a rallying call to his allies.</div></div>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-samurai-true-resolve-ex" data-hash-target><div className="box">True Resolve (Ex)</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">If you have at least two uses of your <em>resolve</em> remaining, you can spend all of the daily uses of your <em>resolve</em> that you have available to you to avoid death. Regardless of the source of the attack that would have killed you, you are left alive, at -1 hit points (or lower if you were already below -1), <Link to="/misc/unconscious">unconscious</Link>, and <Link to="/misc/stable">stable</Link>.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-samurai-last-stand-ex" data-hash-target><div className="box">Last Stand (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 20th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">Once a day.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can make a <em>last stand</em> whenever you make a <em>challenge.</em> While this <em>challenge</em> is in effect, all melee and ranged weapons deal the minimum amount of damage to you, unless the attack scored is a critical hit. In addition, you remain conscious and are not staggered while you are below 0 hit points.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">While using this ability, you cannot be killed by melee or ranged weapons unless they are wielded by the target of your <em>challenge.</em> Attacks made by opponents that are not the target of your <em>challenge</em> deal no damage when you have 0 or fewer hit points. This ability has no effect on spells, environmental effects, supernatural abilities, or any other source of damage other than melee and ranged weapons. Such sources of damage affect you normally and can kill you (although they do not cause you to fall unconscious or to become staggered if they reduce your hit points below 0).</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">This effect lasts until the <em>challenge</em> ends or you take an offensive action against a target other than the target of your <em>challenge.</em></div></div></div></div>
<h3 id="class-samurai-alternate-capstones" data-hash-target>Alternate Capstones</h3>
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-samurai--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<h3 id="class-samurai-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
<p><strong>Aasimar:</strong> Add +1/4 to the samurai's bonus on damage against targets of his challenge.<sup><InnerLink showBacklink="backlink-class-samurai-ref-A-1" id="class-samurai-ref-A-1" data-hash-target to="class-samurai-A">1</InnerLink></sup></p>
<p><strong>Aquatic elf:</strong> Add 1 skill rank to the samurai's mount. If the samurai ever replaces his mount, the new mount gains these bonus skill ranks.<sup><InnerLink showBacklink="backlink-class-samurai-ref-B-1" id="class-samurai-ref-B-1" data-hash-target to="class-samurai-B">2</InnerLink></sup></p>
<p><strong>Catfolk:</strong> Add +1/4 to the samurai's banner bonus.<sup><InnerLink showBacklink="backlink-class-samurai-ref-C-1" id="class-samurai-ref-C-1" data-hash-target to="class-samurai-C">3</InnerLink></sup></p>
<p><strong>Dwarf:</strong> Add +1/2 to the samurai's bonus to damage against targets of his challenge.<sup><InnerLink showBacklink="backlink-class-samurai-ref-D-1" id="class-samurai-ref-D-1" data-hash-target to="class-samurai-D">4</InnerLink></sup></p>
<p><strong>Elf:</strong> Add +1 hit point to the samurai's mount. If the samurai ever replaces his mount, the new mount gains these bonus hit points.<sup><InnerLink showBacklink="backlink-class-samurai-ref-E-1" id="class-samurai-ref-E-1" data-hash-target to="class-samurai-E">5</InnerLink></sup> <sup><InnerLink showBacklink="backlink-class-samurai-ref-F-1" id="class-samurai-ref-F-1" data-hash-target to="class-samurai-F">6</InnerLink></sup></p>
<p><strong>Gathlain:</strong> Add a +1/2 bonus to the samurai's Knowledge (nature) and Knowledge (nobility) checks relating to fey courts and fey courtiers.<sup><InnerLink showBacklink="backlink-class-samurai-ref-G-1" id="class-samurai-ref-G-1" data-hash-target to="class-samurai-G">7</InnerLink></sup></p>
<p><strong>Gnome:</strong> Add +1 to the samurai's mounted base speed. In combat this has no effect unless the samurai has selected this reward five times (or another increment of five). If the samurai ever replaces his mount, the new mount gains this bonus to its speed.<sup><InnerLink showBacklink="backlink-class-samurai-ref-H-1" id="class-samurai-ref-H-1" data-hash-target to="class-samurai-H">8</InnerLink></sup></p>
<p><strong>Goblin:</strong> Add +1 hit points to the samurai's mount companion. If the samurai ever replaces his mount, the new mount gains these bonus hit points.<sup><InnerLink showBacklink="backlink-class-samurai-ref-I-1" id="class-samurai-ref-I-1" data-hash-target to="class-samurai-I">9</InnerLink></sup> <sup><InnerLink showBacklink="backlink-class-samurai-ref-J-1" id="class-samurai-ref-J-1" data-hash-target to="class-samurai-J">10</InnerLink></sup></p>
<p><strong>Half-elf:</strong> Add +1 foot to the samurai's mount's base speed. This option has no effect unless the samurai has selected it 5 times (or another increment of 5); a speed of 54 feet is effectively a speed of 50 feet, for example. If the samurai ever replaces his mount, the new companion gains this base speed bonus.<sup><InnerLink showBacklink="backlink-class-samurai-ref-K-1" id="class-samurai-ref-K-1" data-hash-target to="class-samurai-K">11</InnerLink></sup></p>
<p><strong>Halfling:</strong> Add +1/2 to the samurai's effective class level for the purposes of determining the damage he deals when making an attack of opportunity against a challenged foe.<sup><InnerLink showBacklink="backlink-class-samurai-ref-L-1" id="class-samurai-ref-L-1" data-hash-target to="class-samurai-L">12</InnerLink></sup></p>
<p><strong>Halfling:</strong> The samurai's mount gains a +1/2 bonus on saving throws against fear effects. If the samurai ever replaces his mount, the new mount gains this bonus.<sup><InnerLink showBacklink="backlink-class-samurai-ref-M-1" id="class-samurai-ref-M-1" data-hash-target to="class-samurai-M">13</InnerLink></sup></p>
<p><strong>Half-orc:</strong> Add +1 hit point to the samurai's mount companion. If the samurai ever replaces his mount, the new mount gains these bonus hit points.<sup><InnerLink showBacklink="backlink-class-samurai-ref-N-1" id="class-samurai-ref-N-1" data-hash-target to="class-samurai-N">14</InnerLink></sup></p>
<p><strong>Hobgoblin:</strong> Add a +1/2 bonus on Intimidate checks and Ride checks.<sup><InnerLink showBacklink="backlink-class-samurai-ref-O-1" id="class-samurai-ref-O-1" data-hash-target to="class-samurai-O">15</InnerLink></sup></p>
<p><strong>Human:</strong> Add +1/4 to the samurai's banner bonus.<sup><InnerLink showBacklink="backlink-class-samurai-ref-P-1" id="class-samurai-ref-P-1" data-hash-target to="class-samurai-P">16</InnerLink></sup> <sup><InnerLink showBacklink="backlink-class-samurai-ref-Q-1" id="class-samurai-ref-Q-1" data-hash-target to="class-samurai-Q">17</InnerLink></sup></p>
<p><strong>Kitsune:</strong> Gain 1/6 of a new Magical Tail feat. Any kitsune character can choose this bonus upon gaining a level in her favored class.<sup><InnerLink showBacklink="backlink-class-samurai-ref-R-1" id="class-samurai-ref-R-1" data-hash-target to="class-samurai-R">18</InnerLink></sup></p>
<p><strong>Kitsune:</strong> Add 1/4 to the samurai's banner bonus.<sup><InnerLink showBacklink="backlink-class-samurai-ref-R-2" id="class-samurai-ref-R-2" data-hash-target to="class-samurai-R">18</InnerLink></sup></p>
<p><strong>Kobold:</strong> Add 5 feet (up to 15 feet maximum) to the samurai's mount's speed when it uses the charge or withdraw action.<sup><InnerLink showBacklink="backlink-class-samurai-ref-S-1" id="class-samurai-ref-S-1" data-hash-target to="class-samurai-S">19</InnerLink></sup></p>
<p><strong>Locathah:</strong> Add 1 hit point to the samurai's mount. If the samurai ever replaces his mount, the new mount gains these bonus hit points.<sup><InnerLink showBacklink="backlink-class-samurai-ref-T-1" id="class-samurai-ref-T-1" data-hash-target to="class-samurai-T">20</InnerLink></sup></p>
<p><strong>Nagaji:</strong> Add 1 foot to the base speed of the samurai's mount. This has no effect in combat unless the samurai has selected this reward five times (or another increment of five). If the samurai ever replaces this mount, the new mount gains this bonus to its speed.<sup><InnerLink showBacklink="backlink-class-samurai-ref-U-1" id="class-samurai-ref-U-1" data-hash-target to="class-samurai-U">21</InnerLink></sup></p>
<p><strong>Orc:</strong> Add +1 to the samurai's CMB when making bull rush or overrun combat maneuvers against a challenged target.<sup><InnerLink showBacklink="backlink-class-samurai-ref-V-1" id="class-samurai-ref-V-1" data-hash-target to="class-samurai-V">22</InnerLink></sup></p>
</div>
...
<section data-footnotes>
<h3 id="class-samurai-label">Footnotes</h3>
<ol>
<li id="class-samurai-A">
<p><Link to="/source/advanced_race_guide">Advanced Race Guide pg. 85</Link> <InnerLink id="backlink-class-samurai-ref-A-1" data-hash-target to="class-samurai-ref-A-1" aria-label="Back to reference A-1">↩</InnerLink></p>
</li>
<li id="class-samurai-B">
<p><Link to="/source/blood_of_the_sea">Blood of the Sea pg. 5</Link> <InnerLink id="backlink-class-samurai-ref-B-1" data-hash-target to="class-samurai-ref-B-1" aria-label="Back to reference B-1">↩</InnerLink></p>
</li>
<li id="class-samurai-C">
<p>Advanced Race Guide pg. 92 <InnerLink id="backlink-class-samurai-ref-C-1" data-hash-target to="class-samurai-ref-C-1" aria-label="Back to reference C-1">↩</InnerLink></p>
</li>
<li id="class-samurai-D">
<p>Advanced Race Guide pg. 13 <InnerLink id="backlink-class-samurai-ref-D-1" data-hash-target to="class-samurai-ref-D-1" aria-label="Back to reference D-1">↩</InnerLink></p>
</li>
<li id="class-samurai-E">
<p>Advanced Race Guide pg. 23 <InnerLink id="backlink-class-samurai-ref-E-1" data-hash-target to="class-samurai-ref-E-1" aria-label="Back to reference E-1">↩</InnerLink></p>
</li>
<li id="class-samurai-F">
<p><Link to="/source/advanced_players_guide">Advanced Player's Guide pg. 13</Link> <InnerLink id="backlink-class-samurai-ref-F-1" data-hash-target to="class-samurai-ref-F-1" aria-label="Back to reference F-1">↩</InnerLink></p>
</li>
<li id="class-samurai-G">
<p><Link to="/source/ultimate_wilderness">Ultimate Wilderness pg. 10</Link> <InnerLink id="backlink-class-samurai-ref-G-1" data-hash-target to="class-samurai-ref-G-1" aria-label="Back to reference G-1">↩</InnerLink></p>
</li>
<li id="class-samurai-H">
<p>Advanced Race Guide pg. 33 <InnerLink id="backlink-class-samurai-ref-H-1" data-hash-target to="class-samurai-ref-H-1" aria-label="Back to reference H-1">↩</InnerLink></p>
</li>
<li id="class-samurai-I">
<p>Advanced Race Guide pg. 115 <InnerLink id="backlink-class-samurai-ref-I-1" data-hash-target to="class-samurai-ref-I-1" aria-label="Back to reference I-1">↩</InnerLink></p>
</li>
<li id="class-samurai-J">
<p><Link to="/source/goblins_of_golarion">Goblins of Golarion pg. 31</Link> <InnerLink id="backlink-class-samurai-ref-J-1" data-hash-target to="class-samurai-ref-J-1" aria-label="Back to reference J-1">↩</InnerLink></p>
</li>
<li id="class-samurai-K">
<p>Advanced Race Guide pg. 42 <InnerLink id="backlink-class-samurai-ref-K-1" data-hash-target to="class-samurai-ref-K-1" aria-label="Back to reference K-1">↩</InnerLink></p>
</li>
<li id="class-samurai-L">
<p>Advanced Race Guide pg. 63 <InnerLink id="backlink-class-samurai-ref-L-1" data-hash-target to="class-samurai-ref-L-1" aria-label="Back to reference L-1">↩</InnerLink></p>
</li>
<li id="class-samurai-M">
<p><Link to="/source/horror_adventures">Horror Adventures pg. 41</Link> <InnerLink id="backlink-class-samurai-ref-M-1" data-hash-target to="class-samurai-ref-M-1" aria-label="Back to reference M-1">↩</InnerLink></p>
</li>
<li id="class-samurai-N">
<p>Advanced Race Guide pg. 53 <InnerLink id="backlink-class-samurai-ref-N-1" data-hash-target to="class-samurai-ref-N-1" aria-label="Back to reference N-1">↩</InnerLink></p>
</li>
<li id="class-samurai-O">
<p>Advanced Race Guide pg. 121 <InnerLink id="backlink-class-samurai-ref-O-1" data-hash-target to="class-samurai-ref-O-1" aria-label="Back to reference O-1">↩</InnerLink></p>
</li>
<li id="class-samurai-P">
<p>Advanced Race Guide pg. 73 <InnerLink id="backlink-class-samurai-ref-P-1" data-hash-target to="class-samurai-ref-P-1" aria-label="Back to reference P-1">↩</InnerLink></p>
</li>
<li id="class-samurai-Q">
<p>Advanced Player's Guide pg. 23 <InnerLink id="backlink-class-samurai-ref-Q-1" data-hash-target to="class-samurai-ref-Q-1" aria-label="Back to reference Q-1">↩</InnerLink></p>
</li>
<li id="class-samurai-R">
<p><Link to="/source/blood_of_the_beast">Blood of the Beast pg. 12</Link> <InnerLink id="backlink-class-samurai-ref-R-1" data-hash-target to="class-samurai-ref-R-1" aria-label="Back to reference R-1">↩</InnerLink> <InnerLink id="backlink-class-samurai-ref-R-2" data-hash-target to="class-samurai-ref-R-2" aria-label="Back to reference R-2">↩<sup>2</sup></InnerLink></p>
</li>
<li id="class-samurai-S">
<p>Advanced Race Guide pg. 133 <InnerLink id="backlink-class-samurai-ref-S-1" data-hash-target to="class-samurai-ref-S-1" aria-label="Back to reference S-1">↩</InnerLink></p>
</li>
<li id="class-samurai-T">
<p>Blood of the Sea pg. 11 <InnerLink id="backlink-class-samurai-ref-T-1" data-hash-target to="class-samurai-ref-T-1" aria-label="Back to reference T-1">↩</InnerLink></p>
</li>
<li id="class-samurai-U">
<p>Blood of the Beast pg. 16 <InnerLink id="backlink-class-samurai-ref-U-1" data-hash-target to="class-samurai-ref-U-1" aria-label="Back to reference U-1">↩</InnerLink></p>
</li>
<li id="class-samurai-V">
<p>Advanced Race Guide pg. 139 <InnerLink id="backlink-class-samurai-ref-V-1" data-hash-target to="class-samurai-ref-V-1" aria-label="Back to reference V-1">↩</InnerLink></p>
</li>
</ol>
</section>
</>};
const _shaman = {hasJL:true,title: "Shaman", jsx: <><div className="jumpList" id="class-shaman-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="class-shaman-spells">Spells</InnerLink></li><li><InnerLink toTop to="class-shaman-spirit-su">Spirit</InnerLink></li><li><InnerLink toTop to="class-shaman-spirit-animal-ex">Spirit Animal</InnerLink></li><li><InnerLink toTop to="class-shaman-spirit-magic">Spirit Magic</InnerLink></li><li><InnerLink toTop to="class-shaman-hex">Hex</InnerLink></li><li><InnerLink toTop to="class-shaman-wandering-spirit-su">Wandering Spirit</InnerLink></li><li><InnerLink toTop to="class-shaman-wandering-hex">Wandering Hex</InnerLink></li><li><InnerLink toTop to="class-shaman-manifestation-su">Manifestation</InnerLink></li><li><InnerLink toTop to="class-shaman-alternate-capstones">Alternate Capstones</InnerLink></li><li><InnerLink toTop to="class-shaman-favored-class-bonuses">Favored Class Bonuses</InnerLink></li><li><InnerLink toTop to="class-shaman-archetypes">Archetypes</InnerLink></li><li><InnerLink toTop to="class-shaman-archetypes-by-feature">Archetypes by Feature</InnerLink></li></ul></div><h2 id="class-shaman-shaman">Shaman</h2>
...
<table className="class p"><thead><tr><th className="nw ne ion-text-center" scope="col" colSpan={3}>Weapon and Armor Proficiencies</th></tr></thead><tbody><tr><th scope="row" rowSpan={1}>Weapons</th><td colSpan={2}>All <Link to="/main/equipment_weapons_simple">simple weapons</Link></td></tr><tr><th>Light Armor?</th><td colSpan={2}>Yes</td></tr><tr><th>Medium Armor?</th><td colSpan={2}>Yes</td></tr><tr><th>Heavy Armor?</th><td colSpan={2}>No</td></tr><tr><th className="sw">Shields?</th><td colSpan={2} className="se">No</td></tr></tbody></table>
<div className="ability"><div className="abIcon"><Link to="/icons"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-shaman-spells" data-hash-target><div className="box">Spells</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain the ability to cast Wisdom spells which are drawn from the <Link to="/main/spells_shaman">shaman spell list</Link>. The DC for a saving throw against spells you cast is 10 + the spell level + your Wisdom modifier. You must choose and prepare your spells in advance.</div></div></div><div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">You must spend 1 hour each day in quiet contemplation with your spirit animal to regain your daily allotment of spells. You may prepare and cast any spell on your spell list, provided that you can cast spells of that level, but you must choose which spells to prepare.</div></div></div></div><div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-shaman-orisons" data-hash-target><div className="box">Orisons</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-shaman-spirit-su" data-hash-target><div className="box">Spirit (Su)</div><div className="flavor">A shaman forms a mystical bond with the spirits of the world.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You form a lasting bond with a single <Link to="/ability/shaman_spirits">spirit</Link>, which grants a number of abilities and defines many of your other class features.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 1st Level</div></div><div className="abEnd"><div className="box">You gain the <em>spirit ability</em> granted by your chosen spirit. You add the spells granted by that spirit to the list of spells that you can cast using <em>spirit magic.</em> You also add the hexes possessed by that spirit to the list of hexes that you can use with the <em>hex</em> and <em>wandering hex</em> class features.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 8th Level</div></div><div className="abEnd"><div className="box">You gain the abilities listed in the <em>greater</em> version of your selected spirit.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 16th Level</div></div><div className="abEnd"><div className="box">You gain the abilities listed for the <em>true</em> version of your selected spirit.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">If you take levels in another class that grants a mystery (such as the oracle), the spirit and mystery must match, even if that means one of them must change. Subject to GM discretion, you can change your former mystery or spirit to make them conform.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-shaman-spirit-animal-ex" data-hash-target><div className="box">Spirit Animal (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box"><p>You form a close bond with a spirit animal tied to your chosen <em>spirit.</em> This animal is your conduit to the spirit world, guiding you along the path to enlightenment.</p>
...
<div className="abPair"><div className="abStart"><div className="box">At 1st Level</div></div><div className="abEnd"><div className="box">Your spirit animal gains specific abilities, depending upon the type of spirit selected by you using your spirit class feature. These abilities affect the animal's appearance and grant it special abilities that can aid it in serving you and the spirit it represents and is connected to. These abilities are described in the <em>spirit animal</em> section of each individual <em>spirit</em> description.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 3rd Level</div></div><div className="abEnd"><div className="box">Your spirit animal can deliver touch spells or hexes for you. If you and the spirit animal are in contact at the time you cast a touch spell, you can designate your animal as the "toucher." The spirit animal can then deliver the touch spell just as you would. If you cast another spell before the touch is delivered, the touch spell dissipates. If you activate a <em>hex,</em> your spirit animal can be used to make the touch; you don't have to be in contact with the animal to use this ability with hexes.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-shaman-spirit-magic" data-hash-target><div className="box">Spirit Magic</div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can spontaneously cast a limited number of spells per day beyond those you prepared ahead of time. You have one spell slot per day of each shaman spell level you can cast, not including orisons. You can choose these spells from the list of spells granted by your spirits at the time you cast them. You can enhance these spells using any metamagic feat that you know, using up a higher-level spell slot as required by the feat and increasing the time to cast the spell.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-shaman-hex" data-hash-target><div className="box">Hex</div><div className="flavor">A shaman learns a number of magical tricks, called hexes, which grant her powers or weaken foes.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 2nd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You learn one hex. You can select from any <Link to="/ability/shaman_hexes">of these shaman hexes</Link> or from any of the hexes listed in the description of your chosen spirit. You cannot select a hex more than once unless noted otherwise.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 4th Level</div></div><div className="abEnd"><div className="box">You learn a new hex.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 8th Level</div></div><div className="abEnd"><div className="box">You learn a new hex.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 10th Level</div></div><div className="abEnd"><div className="box">You learn a new hex.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 12th Level</div></div><div className="abEnd"><div className="box">You learn a new hex.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 16th Level</div></div><div className="abEnd"><div className="box">You learn a new hex.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 18th Level</div></div><div className="abEnd"><div className="box">You learn a new hex.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 20th Level</div></div><div className="abEnd"><div className="box">You learn a new hex.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">Using a hex is a standard action that doesn't provoke an attack of opportunity unless otherwise noted. The saving throw DC to resist a hex is equal to 10 + <Link to="/misc/half">half</Link> your shaman level + your Wisdom modifier.</div></div></div></div>
...
<div className="title abSingle" id="class-shaman-wandering-spirit-su" data-hash-target><div className="box">Wandering Spirit (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 4th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can form a temporary bond with a spirit other than the one selected using your <em>spirit</em> class feature. You must make this selection each day when preparing your spells. While this feature is active, you gain the <em>spirit ability</em> granted by the spirit. You also add the spells granted by that spirit to your list of spells that you can cast using <em>spirit magic.</em> You do not add the hexes from your <em>wandering spirit</em> to your list of hexes that you can choose from with the hex class feature.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 12th Level</div></div><div className="abEnd"><div className="box">You gain the abilities listed in the <em>greater</em> version of your <em>wandering spirit.</em></div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 20th Level</div></div><div className="abEnd"><div className="box">You gain the ability listed in the <em>true</em> version of your <em>wandering spirit.</em></div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-shaman-wandering-hex" data-hash-target><div className="box">Wandering Hex</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 6th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can temporarily gain the use of one of the hexes possessed by either one of your spirits. You must make this selection each day when you prepare your spells. For the purposes of this ability, you can select any hex possessed by your <em>spirit</em> or <em>wandering spirit.</em> If you select it from your <em>wandering spirit,</em> you lose the hex immediately if you bond with another spirit, although you can then select a different hex to gain using this ability, from either your <em>spirit</em> or your new <em>wandering spirit.</em></div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 14th Level</div></div><div className="abEnd"><div className="box">You can select two wandering hexes each day instead of one.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">This ability otherwise functions as the hex class feature.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-shaman-manifestation-su" data-hash-target><div className="box">Manifestation (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 20th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You undergo a transformation as you manifest as a pinnacle of your main spirit. The nature of this manifestation depends on your <em>spirit,</em> and is described in its entry.</div></div></div></div>
<h3 id="class-shaman-alternate-capstones" data-hash-target>Alternate Capstones</h3>
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-shaman--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<h3 id="class-shaman-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
<p><strong>Catfolk:</strong> Add 1/6 to the shaman's class level for the purpose of determining the effects of one hex.<sup><InnerLink showBacklink="backlink-class-shaman-ref-A-1" id="class-shaman-ref-A-1" data-hash-target to="class-shaman-A">1</InnerLink></sup></p>
<p><strong>Dwarf:</strong> Add 1/4 to the natural armor bonus of the shaman's spirit animal.<sup><InnerLink showBacklink="backlink-class-shaman-ref-B-1" id="class-shaman-ref-B-1" data-hash-target to="class-shaman-B">2</InnerLink></sup></p>
<p><strong>Elf:</strong> Add 5 feet to the range of a chosen shaman hex. Multiple bonuses from this ability can apply to the same hex, to a maximum of an additional 30 feet for any single hex.<sup><InnerLink showBacklink="backlink-class-shaman-ref-B-2" id="class-shaman-ref-B-2" data-hash-target to="class-shaman-B">2</InnerLink></sup></p>
<p><strong>Gathlain:</strong> Add one spell from the druid spell list to the shaman's spell list. This spell must be at least 1 level lower than the highest-level spell the shaman can cast.<sup><InnerLink showBacklink="backlink-class-shaman-ref-C-1" id="class-shaman-ref-C-1" data-hash-target to="class-shaman-C">3</InnerLink></sup></p>
<p><strong>Ghoran:</strong> Add one spell from the druid spell list that isn't on the shaman spell list to the list of spells she knows. This spell must be at least 1 level lower than the highest-level spell the shaman can cast.<sup><InnerLink showBacklink="backlink-class-shaman-ref-D-1" id="class-shaman-ref-D-1" data-hash-target to="class-shaman-D">4</InnerLink></sup></p>
<p><strong>Gnome:</strong> The shaman gains 1/6 of a new shaman hex.<sup><InnerLink showBacklink="backlink-class-shaman-ref-E-1" id="class-shaman-ref-E-1" data-hash-target to="class-shaman-E">5</InnerLink></sup></p>
<p><strong>Grippli:</strong> Add one spell from the druid spell list that isn't on the shaman spell list to the list of spells the shaman knows. This spell must be at least 1 level below the highest spell level the shaman can cast.<sup><InnerLink showBacklink="backlink-class-shaman-ref-F-1" id="class-shaman-ref-F-1" data-hash-target to="class-shaman-F">6</InnerLink></sup></p>
<p><strong>Half-elf:</strong> Add one spell from the cleric spell list that isn't on the shaman spell list to the list of spells the shaman knows. This spell must be at least 1 level below the highest spell level the shaman can cast.<sup><InnerLink showBacklink="backlink-class-shaman-ref-E-2" id="class-shaman-ref-E-2" data-hash-target to="class-shaman-E">5</InnerLink></sup></p>
<p><strong>Halfling:</strong> Add 1/2 to the shaman's effective class level for the purpose of determining her spirit animal's natural armor adjustment, Intelligence, and special abilities.<sup><InnerLink showBacklink="backlink-class-shaman-ref-E-3" id="class-shaman-ref-E-3" data-hash-target to="class-shaman-E">5</InnerLink></sup></p>
<p><strong>Half-orc:</strong> Add one spell from the cleric spell list that isn't on the shaman spell list to the list of spells the shaman knows. This spell must be at least 1 level below the highest spell level the shaman can cast.<sup><InnerLink showBacklink="backlink-class-shaman-ref-G-1" id="class-shaman-ref-G-1" data-hash-target to="class-shaman-G">7</InnerLink></sup></p>
<p><strong>Human:</strong> Add one spell from the cleric spell list that isn't on the shaman spell list to the list of spells the shaman knows. This spell must be at least 1 level below the highest spell level the shaman can cast.<sup><InnerLink showBacklink="backlink-class-shaman-ref-G-2" id="class-shaman-ref-G-2" data-hash-target to="class-shaman-G">7</InnerLink></sup></p>
<p><strong>Kitsune:</strong> Gain 1/6 of a new Magical Tail feat. Any kitsune character can choose this bonus upon gaining a level in her favored class.<sup><InnerLink showBacklink="backlink-class-shaman-ref-H-1" id="class-shaman-ref-H-1" data-hash-target to="class-shaman-H">8</InnerLink></sup></p>
<p><strong>Kitsune:</strong> Add one enchantment spell from the sorcerer/ wizard spell list that isn't on the shaman spell list to the list of spells the shaman knows. This spell must be at least 1 level below the highest spell level the shaman can cast.<sup><InnerLink showBacklink="backlink-class-shaman-ref-H-2" id="class-shaman-ref-H-2" data-hash-target to="class-shaman-H">8</InnerLink></sup></p>
<p><strong>Shabti:</strong> Add one spell from the psychic spell list that isn't on the shaman spell list to the list of spells the shaman knows. This spell must be at least 1 level below the highest spell level the shaman can cast.<sup><InnerLink showBacklink="backlink-class-shaman-ref-I-1" id="class-shaman-ref-I-1" data-hash-target to="class-shaman-I">9</InnerLink></sup></p>
<p><strong>Strix:</strong> Add 1/2 to the shaman's effective class level for the purpose of determining her spirit animal's natural armor adjustment, Intelligence, and special abilities.<sup><InnerLink showBacklink="backlink-class-shaman-ref-J-1" id="class-shaman-ref-J-1" data-hash-target to="class-shaman-J">10</InnerLink></sup></p>
<p><strong>Vanara:</strong> Add one spell from the cleric spell list that isn't on the shaman spell list to the list of spells the shaman knows. This spell must be at least 1 level below the highest level the shaman can cast.<sup><InnerLink showBacklink="backlink-class-shaman-ref-K-1" id="class-shaman-ref-K-1" data-hash-target to="class-shaman-K">11</InnerLink></sup></p>
<p><strong>Vine leshy:</strong> Shamans with the nature or wood spirit add one spell from the druid's spell list that isn't on the shaman spell list to the shaman's spell list; she still must select this spell as one of her spells known in order to cast it. This spell must be at least 1 level lower than the highest spell level the shaman can cast.<sup><InnerLink showBacklink="backlink-class-shaman-ref-L-1" id="class-shaman-ref-L-1" data-hash-target to="class-shaman-L">12</InnerLink></sup></p>
<p><strong>Wayang:</strong> Add one spell from the sorcerer/wizard spell list that isn't on the shaman spell list to the list of spells the shaman knows. This spell must be at least 1 level below the highest spell level the shaman can cast and be of the illusion (shadow) subschool or have the darkness descriptor.<sup><InnerLink showBacklink="backlink-class-shaman-ref-M-1" id="class-shaman-ref-M-1" data-hash-target to="class-shaman-M">13</InnerLink></sup></p>
</div>
...
<section data-footnotes>
<h3 id="class-shaman-label">Footnotes</h3>
<ol>
<li id="class-shaman-A">
<p><Link to="/source/blood_of_the_beast">Blood of the Beast pg. 4</Link> <InnerLink id="backlink-class-shaman-ref-A-1" data-hash-target to="class-shaman-ref-A-1" aria-label="Back to reference A-1">↩</InnerLink></p>
</li>
<li id="class-shaman-B">
<p><Link to="/source/advanced_class_guide">Advanced Class Guide pg. 69</Link> <InnerLink id="backlink-class-shaman-ref-B-1" data-hash-target to="class-shaman-ref-B-1" aria-label="Back to reference B-1">↩</InnerLink> <InnerLink id="backlink-class-shaman-ref-B-2" data-hash-target to="class-shaman-ref-B-2" aria-label="Back to reference B-2">↩<sup>2</sup></InnerLink></p>
</li>
<li id="class-shaman-C">
<p><Link to="/source/ultimate_wilderness">Ultimate Wilderness pg. 10</Link> <InnerLink id="backlink-class-shaman-ref-C-1" data-hash-target to="class-shaman-ref-C-1" aria-label="Back to reference C-1">↩</InnerLink></p>
</li>
<li id="class-shaman-D">
<p>Ultimate Wilderness pg. 17 <InnerLink id="backlink-class-shaman-ref-D-1" data-hash-target to="class-shaman-ref-D-1" aria-label="Back to reference D-1">↩</InnerLink></p>
</li>
<li id="class-shaman-E">
<p>Advanced Class Guide pg. 70 <InnerLink id="backlink-class-shaman-ref-E-1" data-hash-target to="class-shaman-ref-E-1" aria-label="Back to reference E-1">↩</InnerLink> <InnerLink id="backlink-class-shaman-ref-E-2" data-hash-target to="class-shaman-ref-E-2" aria-label="Back to reference E-2">↩<sup>2</sup></InnerLink> <InnerLink id="backlink-class-shaman-ref-E-3" data-hash-target to="class-shaman-ref-E-3" aria-label="Back to reference E-3">↩<sup>3</sup></InnerLink></p>
</li>
<li id="class-shaman-F">
<p>Blood of the Beast pg. 8 <InnerLink id="backlink-class-shaman-ref-F-1" data-hash-target to="class-shaman-ref-F-1" aria-label="Back to reference F-1">↩</InnerLink></p>
</li>
<li id="class-shaman-G">
<p>Advanced Class Guide pg. 71 <InnerLink id="backlink-class-shaman-ref-G-1" data-hash-target to="class-shaman-ref-G-1" aria-label="Back to reference G-1">↩</InnerLink> <InnerLink id="backlink-class-shaman-ref-G-2" data-hash-target to="class-shaman-ref-G-2" aria-label="Back to reference G-2">↩<sup>2</sup></InnerLink></p>
</li>
<li id="class-shaman-H">
<p>Blood of the Beast pg. 12 <InnerLink id="backlink-class-shaman-ref-H-1" data-hash-target to="class-shaman-ref-H-1" aria-label="Back to reference H-1">↩</InnerLink> <InnerLink id="backlink-class-shaman-ref-H-2" data-hash-target to="class-shaman-ref-H-2" aria-label="Back to reference H-2">↩<sup>2</sup></InnerLink></p>
</li>
<li id="class-shaman-I">
<p><Link to="/source/plane_hoppers_handbook">Plane-Hopper's Handbook pg. 23</Link> <InnerLink id="backlink-class-shaman-ref-I-1" data-hash-target to="class-shaman-ref-I-1" aria-label="Back to reference I-1">↩</InnerLink></p>
</li>
<li id="class-shaman-J">
<p><Link to="/source/pathfinder_101_the_kintargo_contract">Pathfinder #101: The Kintargo Contract pg. 73</Link> <InnerLink id="backlink-class-shaman-ref-J-1" data-hash-target to="class-shaman-ref-J-1" aria-label="Back to reference J-1">↩</InnerLink></p>
</li>
<li id="class-shaman-K">
<p>Blood of the Beast pg. 28 <InnerLink id="backlink-class-shaman-ref-K-1" data-hash-target to="class-shaman-ref-K-1" aria-label="Back to reference K-1">↩</InnerLink></p>
</li>
<li id="class-shaman-L">
<p>Ultimate Wilderness pg. 22 <InnerLink id="backlink-class-shaman-ref-L-1" data-hash-target to="class-shaman-ref-L-1" aria-label="Back to reference L-1">↩</InnerLink></p>
</li>
<li id="class-shaman-M">
<p><Link to="/source/blood_of_shadows">Blood of Shadows pg. 11</Link> <InnerLink id="backlink-class-shaman-ref-M-1" data-hash-target to="class-shaman-ref-M-1" aria-label="Back to reference M-1">↩</InnerLink></p>
</li>
</ol>
</section>
</>};
const _warpriest = {hasJL:true,title: "Warpriest", jsx: <><div className="jumpList" id="class-warpriest-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="class-warpriest-spells">Spells</InnerLink></li><li><InnerLink toTop to="class-warpriest-spontaneous-casting">Spontaneous Casting</InnerLink></li><li><InnerLink toTop to="class-warpriest-chaotic-evil-good-and-lawful-spells">Aligned Spells</InnerLink></li><li><InnerLink toTop to="class-warpriest-bonus-languages">Bonus Languages</InnerLink></li><li><InnerLink toTop to="class-warpriest-aura-ex">Aura</InnerLink></li><li><InnerLink toTop to="class-warpriest-focus-weapon">Focus and Sacred Weapon</InnerLink></li><li><InnerLink toTop to="class-warpriest-fervor-su">Fervor</InnerLink></li><li><InnerLink toTop to="class-warpriest-bonus-feats">Bonus Feats</InnerLink></li><li><InnerLink toTop to="class-warpriest-channel-energy-su">Channel Energy</InnerLink></li><li><InnerLink toTop to="class-warpriest-sacred-armor-su">Sacred Armor</InnerLink></li><li><InnerLink toTop to="class-warpriest-aspect-of-war-su">Aspect of War</InnerLink></li><li><InnerLink toTop to="class-warpriest-ex-warpriests">Ex-Warpriests</InnerLink></li><li><InnerLink toTop to="class-warpriest-alternate-capstones">Alternate Capstones</InnerLink></li><li><InnerLink toTop to="class-warpriest-favored-class-bonuses">Favored Class Bonuses</InnerLink></li><li><InnerLink toTop to="class-warpriest-archetypes">Archetypes</InnerLink></li><li><InnerLink toTop to="class-warpriest-archetypes-by-feature">Archetypes by Feature</InnerLink></li></ul></div><h2 id="class-warpriest-warpriest">Warpriest</h2>
...
<div className="ability"><div className="abIcon"><Link to="/icons"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-warpriest-spells" data-hash-target><div className="box">Spells</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">To prepare or cast a spell, you must have a Wisdom score equal to at least 10 + the spell level. You can cast only a certain number of spells of each spell level per day, as shown on the table above. In addition, you receive <Link to="/rule/determine_bonuses">bonus spells per day</Link> if you have a high Wisdom score.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain the ability to cast divine spells which are drawn from the <Link to="/main/spells_warpriest">warpriest spell list</Link>. The DC for a saving throw against spells you cast is 10 + the spell level + your Wisdom modifier. Your alignment may restrict you from casting certain spells opposed to your moral or ethical beliefs; see <em>Chaotic, Evil, Good, and Lawful Spells.</em> You must choose and prepare your spells in advance.</div></div></div><div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">You must spend 1 hour each day in quiet contemplation or supplication to regain your daily allotment of spells. You may prepare and cast any spell on your spell list, provided that you can cast spells of that level, but you must choose which spells to prepare.</div></div></div></div><div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-warpriest-orisons" data-hash-target><div className="box">Orisons</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You learn a number of orisons, or 0-level divine spells. These spells are prepared like any other spell, but they are not expended when cast and may be used again. Orisons prepared using other spell slots, such as those due to metamagic feats, are expended normally.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-warpriest-spontaneous-casting" data-hash-target><div className="box">Spontaneous Casting</div><div className="flavor">A good warpriest (or a neutral warpriest of a good deity) can channel stored spell energy into healing spells that he did not prepare ahead of time.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">If you are good (or a neutral warpriest of a good deity), you can "lose" any prepared spell that is not an orison in order to cast any <em>cure</em> spell of the same spell level or lower. If you are evil (or a neutral warpriest of an evil deity), you can convert spells to <em>inflict</em> spells.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">If you are neither good nor evil and your deity is neither good nor evil, you choose whether you can convert spells into either <em>cure spells</em> or <em>inflict spells.</em> Once this choice is made, it cannot be changed. This choice also determines whether you channel positive or negative energy (see below).</div></div></div></div>
...
<div className="title abSingle" id="class-warpriest-chaotic-evil-good-and-lawful-spells" data-hash-target><div className="box">Chaotic, Evil, Good, and Lawful Spells</div></div>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-warpriest-bonus-languages" data-hash-target><div className="box">Bonus Languages</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">Your bonus language options include Abyssal, Celestial, and Infernal. These choices are in addition to the bonus languages available because of your race.</div></div></div></div>
...
<div className="title abSingle" id="class-warpriest-aura-ex" data-hash-target><div className="box">Aura (Ex)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">If you are a warpriest of a chaotic, evil, good, or lawful deity, you have a particularly powerful aura (as a <Link to="/class/cleric">cleric</Link>) corresponding to your deity's alignment (see <Link to="/spell/detect_evil">detect evil</Link>).</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-warpriest-blessings-su" data-hash-target><div className="box">Blessings (Su)</div><div className="flavor">A warpriest's deity influences his alignment, what magic he can perform, his values, and how others see him.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can select two <Link to="/ability/blessings">blessings</Link> from among those granted by your deity (each deity grants the blessings tied to its domains), obtaining each blessing's <strong className="hl">minor</strong> power.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">3 times/day + <Link to="/misc/half">half</Link> your warpriest level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Standard Action</div></div><div className="abEnd"><div className="box">Unless otherwise stated, using a blessing is a standard action that does not provoke an attack of opportunity. Each time you call upon any one of your blessings, it counts against your daily limit.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 10th Level</div></div><div className="abEnd"><div className="box">You obtain the <strong className="hl">major</strong> power of each of your blessings.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">You can select an alignment blessing (<Link to="/blessing/chaos">Chaos</Link>, <Link to="/blessing/evil">Evil</Link>, <Link to="/blessing/good">Good</Link>, or <Link to="/blessing/law">Law</Link>) only if your alignment matches that domain. If you aren't devoted to a particular deity, you still select two blessings to represent your spiritual inclinations and abilities, subject to GM approval. The restriction on alignment domains still applies.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-warpriest-focus-weapon" data-hash-target><div className="box">Focus Weapon</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You receive <Link to="/feat/weapon_focus">Weapon Focus</Link> as a bonus feat (you can choose any weapon, not just your deity's favored weapon).</div></div></div></div>
...
<div className="title abSingle" id="class-warpriest-sacred-weapon-su" data-hash-target><div className="box">Sacred Weapon (Su)</div><div className="flavor">Weapons wielded by a warpriest are charged with the power of his faith.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Passive Ability</div></div><div className="abEnd"><div className="box">Whenever you hit with your sacred weapon, the weapon damage is based on your size and level and not the weapon type. (Only Medium warpriest damage is listed above; see the table below if you are Small or Large.) You can decide to use the weapon's base damage instead of the sacred weapon damage - this must be declared before the attack roll is made. (If the weapon's base damage exceeds the sacred weapon damage, its damage is unchanged.) This increase in damage does not affect any other aspect of the weapon, and doesn't apply to alchemical items, bombs, or other weapons that only deal energy damage.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">In addition to the favored weapon of your deity,you can designate a weapon as a sacred weapon by selecting that weapon with the Weapon Focus feat; if you have multiple Weapon Focus feats, this ability applies to all of them.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 4th Level</div></div><div className="abEnd"><div className="box"><p>You gain the ability to enhance one of your sacred weapons with divine power as a <strong className="hl">swift action</strong>. This power grants the weapon an enhancement bonus. This bonus is equal to one-fourth of your warpriest level; see the table below. If you have more than one sacred weapon, you can enhance another on the following round by using another swift action. You can use this ability a number of rounds per day equal to your warpriest level, but these rounds need not be consecutive.</p>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/heart-plus"><IonIcon icon="/icons/heart-plus.svg" color="secondary" /></Link><Link to="/icons/magic-palm"><IonIcon icon="/icons/magic-palm.svg" color="secondary" /></Link><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-warpriest-fervor-su" data-hash-target><div className="box">Fervor (Su)</div><div className="flavor">A warpriest can draw upon the power of his faith to heal wounds or harm foes. He can also use this ability to quickly cast spells that aid in his struggles.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">If you spontaneously cast <em>cure</em> spells, this ability harms undead (no save) and heals other creatures as positive energy. Otherwise, it heals undead and harms other creatures (no save) as negative energy.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">Wis modifier times/day + 1/2 your warpriest level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Standard Action</div></div><div className="abEnd"><div className="box">By expending one use of this ability, you can touch a creature to heal it of 1d6 points of damage, or damage it for the same amount. Attempting to harm is a melee touch attack that provokes attacks of opportunity.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Swift Action</div></div><div className="abEnd"><div className="box">You can expend one use of this ability to either heal yourself (as if you touched a creature to heal it) or cast any one warpriest spell you have prepared with a casting time of 1 round or shorter. The spell can target only you, even if it could normally affect other or multiple targets. Spells cast in this way ignore somatic components and do not provoke attacks of opportunity. You do not need to have a free hand to cast a spell in this way.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 5th Level</div></div><div className="abEnd"><div className="box">The damage you deal or heal becomes 2d6.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 8th Level</div></div><div className="abEnd"><div className="box">The damage you deal or heal becomes 3d6.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 11th Level</div></div><div className="abEnd"><div className="box">The damage you deal or heal becomes 4d6.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 14th Level</div></div><div className="abEnd"><div className="box">The damage you deal or heal becomes 5d6.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 17th Level</div></div><div className="abEnd"><div className="box">The damage you deal or heal becomes 6d6.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 20th Level</div></div><div className="abEnd"><div className="box">The damage you deal or heal becomes 7d6.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-warpriest-bonus-feats" data-hash-target><div className="box">Bonus Feats</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 3rd Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain a bonus <Link to="/main/combat_feat">combat feat</Link> in addition to those gained from normal advancement. You must meet the prerequisites for this feat, but you treat your warpriest level as your base attack bonus (in addition to base attack bonuses gained from other classes and Hit Dice) for the purpose of qualifying for this feat. Finally, for the purposes of this feat, you can select one that have a minimum number of fighter levels as a prerequisite, treating your warpriest level as your fighter level.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 6th Level</div></div><div className="abEnd"><div className="box">You gain another bonus combat feat, following the same restrictions as above.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 9th Level</div></div><div className="abEnd"><div className="box">You gain another bonus combat feat, following the same restrictions as above.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 12th Level</div></div><div className="abEnd"><div className="box">You gain another bonus combat feat, following the same restrictions as above.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 15th Level</div></div><div className="abEnd"><div className="box">You gain another bonus combat feat, following the same restrictions as above.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 18th Level</div></div><div className="abEnd"><div className="box">You gain another bonus combat feat, following the same restrictions as above.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/abstract-091"><IonIcon icon="/icons/abstract-091.svg" color="secondary" /></Link><Link to="/icons/heart-plus"><IonIcon icon="/icons/heart-plus.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-warpriest-channel-energy-su" data-hash-target><div className="box">Channel Energy (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 4th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain the ability to <Link to="/ability/channel_energy">channel energy</Link> like a cleric, by presenting your holy (or unholy) symbol.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Standard Action</div></div><div className="abEnd"><div className="box">By expending two uses of your <em>fervor,</em> you cause a <Link to="/misc/burst">burst</Link> that heals (or deals damage to) all creatures in a 30-foot radius centered on you (following the same rules as your <em>fervor</em>). The amount of damage healed or dealt is equal to that of your <em>fervor</em> ability. You can choose whether or not to include yourself in this effect.</div></div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">Creatures that take damage from channeled energy must succeed at a Will saving throw to halve the damage. The save DC is 10 + 1/2 your warpriest level + your Wisdom modifier.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/armor-upgrade"><IonIcon icon="/icons/armor-upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-warpriest-sacred-armor-su" data-hash-target><div className="box">Sacred Armor (Su)</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 7th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Swift Action</div></div><div className="abEnd"><div className="box">You grant your armor a +1 enhancement bonus.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">1 minute/day per warpriest level; these minutes need not be consecutive, but they must be spent in 1-minute increments</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Free Action</div></div><div className="abEnd"><div className="box">When you grant this bonus, you can also use your <em>sacred weapon</em> ability by expending one use of your <em>fervor.</em></div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box"><p>These bonuses stack with any existing bonuses the armor might have, to a maximum of +5. You can enhance armor any of the following armor special abilities: <Link to="/magic-enh/energy_resistance">energy resistance</Link> (normal, improved, and greater), <Link to="/magic-enh/fortification">fortification</Link> (heavy, light, or moderate), <Link to="/magic-enh/glamered">glamered</Link>, and <Link to="/magic-enh/spell_resistance">spell resistance</Link> (13, 15, 17, and 19). Adding any of these special abilities replaces an amount of bonus equal to the special ability's base cost. For this purpose, <em>glamered</em> counts as a +1 bonus, <em>energy resistance</em> counts as +2, <Link to="/magic-enh/improved_energy_resistance">improved energy resistance</Link> counts as +4, and <Link to="/magic-enh/greater_energy_resistance">greater energy resistance</Link> counts as +5. Duplicate abilities do not stack. The armor must have at least a +1 enhancement bonus before any other special abilities can be added.</p>
...
<div className="abPair"><div className="abStart"><div className="box">At 13th Level</div></div><div className="abEnd"><div className="box">The bonus increases to +3.</div></div></div>
...
<div className="abPair"><div className="abStart"><div className="box">At 19th Level</div></div><div className="abEnd"><div className="box">The bonus increases to +5.</div></div></div></div>
...
<div className="title abSingle" id="class-warpriest-aspect-of-war-su" data-hash-target><div className="box">Aspect of War (Su)</div><div className="flavor">The warpriest can channel an aspect of war, growing in power and martial ability.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 20th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">Once a day.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Swift Action</div></div><div className="abEnd"><div className="box">You can treat your level as your base attack bonus, gain DR 10/-, and can move at your full speed regardless of the armor you are wearing or your encumbrance. In addition, the <em>blessings</em> you call upon don't count against your daily limit during this time. This ability lasts for 1 minute.</div></div></div></div>
...
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-warpriest--table-2"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
...
<h3 id="class-warpriest-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
<p><strong>Aphorite:</strong> Add 1/2 to the number of times per day the warpriest can use blessings, but he can use these additional blessings on only those from the Artifice, Community, Knowledge, Law, Magic, or Rune domains.<sup><InnerLink showBacklink="backlink-class-warpriest-ref-A-1" id="class-warpriest-ref-A-1" data-hash-target to="class-warpriest-A">1</InnerLink></sup></p>
<p><strong>Drow:</strong> Add 1/2 point to the amount of damage dealt or healed by the warpriest's fervor ability.<sup><InnerLink showBacklink="backlink-class-warpriest-ref-B-1" id="class-warpriest-ref-B-1" data-hash-target to="class-warpriest-B">2</InnerLink></sup></p>
<p><strong>Dwarf:</strong> Add 1/3 to the number of times per day the warpriest can use blessings, but he can only use these additional uses on blessings that affect weapons or armor.<sup><InnerLink showBacklink="backlink-class-warpriest-ref-C-1" id="class-warpriest-ref-C-1" data-hash-target to="class-warpriest-C">3</InnerLink></sup></p>
<p><strong>Elf:</strong> Add 1/2 to the number of times per day the warpriest can use blessings, but he can use these additional blessings on only those from the Air, Animal, Charm, Magic, Plant, or Sun domains.<sup><InnerLink showBacklink="backlink-class-warpriest-ref-D-1" id="class-warpriest-ref-D-1" data-hash-target to="class-warpriest-D">4</InnerLink></sup></p>
<p><strong>Gnome:</strong> Add 1/2 to the result of the warpriest's channeled energy when healing creatures of the animal, fey, and plant types.<sup><InnerLink showBacklink="backlink-class-warpriest-ref-D-2" id="class-warpriest-ref-D-2" data-hash-target to="class-warpriest-D">4</InnerLink></sup></p>
<p><strong>Half-elf:</strong> Gain a +1/3 bonus on the damage dealt or healed with the warpriest's channel energy ability.<sup><InnerLink showBacklink="backlink-class-warpriest-ref-D-3" id="class-warpriest-ref-D-3" data-hash-target to="class-warpriest-D">4</InnerLink></sup></p>
<p><strong>Halfling:</strong> Add 1/4 to the warpriest's effective level when determining the damage of his sacred weapon.<sup><InnerLink showBacklink="backlink-class-warpriest-ref-D-4" id="class-warpriest-ref-D-4" data-hash-target to="class-warpriest-D">4</InnerLink></sup></p>
<p><strong>Half-orc:</strong> Gain a +2 bonus on rolls to stabilize when dying.<sup><InnerLink showBacklink="backlink-class-warpriest-ref-E-1" id="class-warpriest-ref-E-1" data-hash-target to="class-warpriest-E">5</InnerLink></sup></p>
<p><strong>Human:</strong> Gain 1/6 of a new bonus combat feat.<sup><InnerLink showBacklink="backlink-class-warpriest-ref-E-2" id="class-warpriest-ref-E-2" data-hash-target to="class-warpriest-E">5</InnerLink></sup></p>
<p><strong>Kitsune:</strong> Gain 1/6 of a new Magical Tail feat. Any kitsune character can choose this bonus upon gaining a level in her favored class.<sup><InnerLink showBacklink="backlink-class-warpriest-ref-F-1" id="class-warpriest-ref-F-1" data-hash-target to="class-warpriest-F">6</InnerLink></sup></p>
<p><strong>Nagaji:</strong> Add 1/2 to the number of times per day the warpriest can use blessings, although he can use these additional blessings only for Charm, Magic, Nobility, Rune, or Scalykind blessings.<sup><InnerLink showBacklink="backlink-class-warpriest-ref-G-1" id="class-warpriest-ref-G-1" data-hash-target to="class-warpriest-G">7</InnerLink></sup></p>
</div>
...
<section data-footnotes>
<h3 id="class-warpriest-label">Footnotes</h3>
<ol>
<li id="class-warpriest-A">
<p><Link to="/source/plane_hoppers_handbook">Plane-Hopper's Handbook pg. 15</Link> <InnerLink id="backlink-class-warpriest-ref-A-1" data-hash-target to="class-warpriest-ref-A-1" aria-label="Back to reference A-1">↩</InnerLink></p>
</li>
<li id="class-warpriest-B">
<p><Link to="/source/blood_of_shadows">Blood of Shadows pg. 15</Link> <InnerLink id="backlink-class-warpriest-ref-B-1" data-hash-target to="class-warpriest-ref-B-1" aria-label="Back to reference B-1">↩</InnerLink></p>
</li>
<li id="class-warpriest-C">
<p><Link to="/source/advanced_class_guide">Advanced Class Guide pg. 69</Link> <InnerLink id="backlink-class-warpriest-ref-C-1" data-hash-target to="class-warpriest-ref-C-1" aria-label="Back to reference C-1">↩</InnerLink></p>
</li>
<li id="class-warpriest-D">
<p>Advanced Class Guide pg. 70 <InnerLink id="backlink-class-warpriest-ref-D-1" data-hash-target to="class-warpriest-ref-D-1" aria-label="Back to reference D-1">↩</InnerLink> <InnerLink id="backlink-class-warpriest-ref-D-2" data-hash-target to="class-warpriest-ref-D-2" aria-label="Back to reference D-2">↩<sup>2</sup></InnerLink> <InnerLink id="backlink-class-warpriest-ref-D-3" data-hash-target to="class-warpriest-ref-D-3" aria-label="Back to reference D-3">↩<sup>3</sup></InnerLink> <InnerLink id="backlink-class-warpriest-ref-D-4" data-hash-target to="class-warpriest-ref-D-4" aria-label="Back to reference D-4">↩<sup>4</sup></InnerLink></p>
</li>
<li id="class-warpriest-E">
<p>Advanced Class Guide pg. 71 <InnerLink id="backlink-class-warpriest-ref-E-1" data-hash-target to="class-warpriest-ref-E-1" aria-label="Back to reference E-1">↩</InnerLink> <InnerLink id="backlink-class-warpriest-ref-E-2" data-hash-target to="class-warpriest-ref-E-2" aria-label="Back to reference E-2">↩<sup>2</sup></InnerLink></p>
</li>
<li id="class-warpriest-F">
<p><Link to="/source/blood_of_the_beast">Blood of the Beast pg. 12</Link> <InnerLink id="backlink-class-warpriest-ref-F-1" data-hash-target to="class-warpriest-ref-F-1" aria-label="Back to reference F-1">↩</InnerLink></p>
</li>
<li id="class-warpriest-G">
<p>Blood of the Beast pg. 16 <InnerLink id="backlink-class-warpriest-ref-G-1" data-hash-target to="class-warpriest-ref-G-1" aria-label="Back to reference G-1">↩</InnerLink></p>
</li>
</ol>
</section>
</>};
const _witch = {hasJL:true,title: "Witch", jsx: <><div className="jumpList" id="class-witch-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="class-witch-spells">Spells</InnerLink></li><li><InnerLink toTop to="class-witch-hex">Hex</InnerLink></li><li><InnerLink toTop to="class-witch-witchs-familiar-ex">Witch's Familiar</InnerLink></li><li><InnerLink toTop to="class-witch-patron-spells">Patron Spells</InnerLink></li><li><InnerLink toTop to="class-witch-major-hex">Major and Grand Hex</InnerLink></li><li><InnerLink toTop to="class-witch-adding-spells-to-a-witchs-familiar">Adding Spells to a Witch's Familiar</InnerLink></li><li><InnerLink toTop to="class-witch-alternate-capstones">Alternate Capstones</InnerLink></li><li><InnerLink toTop to="class-witch-favored-class-bonuses">Favored Class Bonuses</InnerLink></li><li><InnerLink toTop to="class-witch-archetypes">Archetypes</InnerLink></li><li><InnerLink toTop to="class-witch-archetypes-by-feature">Archetypes by Feature</InnerLink></li></ul></div><h2 id="class-witch-witch">Witch</h2>
...
<div className="ability"><div className="abIcon"><Link to="/icons"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-witch-spells" data-hash-target><div className="box">Spells</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">To learn or cast a spell, you must have a Intelligence score equal to at least 10 + the spell level. You can cast only a certain number of spells of each spell level per day, as shown on the table above. In addition, you receive <Link to="/rule/determine_bonuses">bonus spells per day</Link> if you have a high Intelligence score.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain the ability to cast arcane spells which are drawn from the <Link to="/main/spells_witch">witch spell list</Link>. The DC for a saving throw against spells you cast is 10 + the spell level + your Intelligence modifier. You must choose and prepare your spells in advance.</div></div></div><div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">You may know any number of spells. You must choose and prepare your spells ahead of time by getting 8 hours of sleep and spending 1 hour communing with your familiar and deciding which spells to prepare.</div></div></div></div><div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-witch-cantrips" data-hash-target><div className="box">Cantrips</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-witch-hex" data-hash-target><div className="box">Hex</div><div className="flavor">Witches learn a number of magic tricks, called hexes, that grant them powers or weaken foes.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain one <Link to="/ability/hexes">hex</Link> of your choice. Unless otherwise noted, using a hex is a standard action that does not provoke an attack of opportunity. The save to resist a hex is equal to 10 + <Link to="/misc/half">half</Link> your witch level + your Intelligence modifier.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">You gain a new hex at 2nd level, and at every even-numbered level (4th, 6th, 8th, and so on). You cannot select an individual hex more than once.</div></div></div></div>
...
<div className="title abSingle" id="class-witch-witchs-familiar-ex" data-hash-target><div className="box">Witch's Familiar (Ex)</div><div className="flavor">A witch forms a close bond with a familiar, a creature that teaches her magic and helps to guide her along her path. Familiars also aid a witch by granting her skill bonuses, additional spells, and help with some types of magic.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">This functions like the wizard's arcane bond class feature, except as noted in this section. You must commune with your <Link to="/sidekick/familiar">familiar</Link> each day to prepare your spells. Familiars store all of the spells that a witch knows, and you cannot prepare a spell that is not stored by your familiar. Your familiar begins play storing all of the 0-level witch spells plus three 1st-level spells of your choice. You also select a number of additional 1st-level spells equal to your Intelligence modifier to store in your familiar.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">At each new witch level, you add two new spells of any spell level or levels that you can cast (based on your new witch level) to your familiar. You can also add additional spells to your familiar through a special ritual, described below under <em>Adding Spells to a Witch's Familiar.</em></div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-witch-patron-spells" data-hash-target><div className="box">Patron Spells</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">When you gain your familiar, you must also select a patron. This <Link to="/ability/patrons">patron</Link> is a vague and mysterious force, granting you power for reasons that you might not entirely understand. While these forces need not be named, they typically hold influence over a certain force.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">At 2nd level, and every two levels thereafter, your patron adds new spells to your list of spells known. These spells are also automatically added to the list of spells stored by the familiar. The spells gained depend upon the patron chosen. Each patron is listed by its theme. Its actual name is up to the GM and the witch to decide.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-witch-major-hex" data-hash-target><div className="box">Major Hex</div></div>
...
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can choose a <Link to="/ability/major_hexes">major hex</Link> whenever you could select a new hex.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/upgrade"><IonIcon icon="/icons/upgrade.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-witch-grand-hex" data-hash-target><div className="box">Grand Hex</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 18th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can choose a <Link to="/ability/grand_hexes">grand hex</Link> whenever you could select a new hex.</div></div></div></div>
...
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-witch--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Arch-Familiar (Su)</td><td>At 20th level, the character's familiar is smarter and savvier than plenty of adventurers - and also more dangerous! The familiar's Intelligence increases by 5, and it gains 12 spells levels' worth of spell-like abilities (for example, three daily castings of <Link to="/spell/greater_invisibility">greater invisibility</Link>), drawn from spells its master can cast and using its master's caster levels, DCs, and so forth. This capstone is available to any class with a familiar.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
<tr><td>The Boss (Ex)</td><td>At 20th level, the character has become more than just a lone hero - she has become one of the senior figures of her field, with powers and responsibilities to match. The character becomes one of the leading figures in some manner of group or organization, as appropriate to the campaign and the setting. A wizard might become the dean of an arcane university or mages' guild, a fighter could command a mercenary army or a city guard, a cleric might lead a major temple or her own sect, and so forth. The player and the GM should work together to determine the specifics. The character gains the <Link to="/feat/leadership">Leadership</Link> feat if she does not already have it, and the number of followers that the feat grants is multiplied by 10 (although depending on the campaign and setting, the position may grant other powers as well). If multiple characters in a party select this capstone, the GM may consider pooling them to grant the players a particularly large and powerful organization, such as a small kingdom. Characters of any class can select this ability.</td></tr>
...
<tr><td>Witch's Dance</td><td><em>Rather than gaining a capstone, a witch can select the following grand hex:</em> Once per day as a standard action, the witch can proclaim a celebration, leading her friends in a riotous and bloodthirsty dance. All allies within 30 feet gain the ability to fly (as per the <Link to="/hex/flight">flight</Link> hex) and a +2 dodge bonus to AC, and when they take a 5-foot step, they can instead move up to 10 feet instead of just 5 feet. The benefits remain for 1 round but can be extended with the <Link to="/hex/cackle">cackle</Link> hex.</td></tr>
<tr><td>With This Sword (Ex)</td><td>At 20th level, the character's blade has become as well-known as the character herself. The character selects one item she has - preferably something iconic and significant, such as a weapon or arcane bond. The item becomes a <Link to="/rule/artifacts">minor artifact</Link> and gains 100,000 gp worth of new powers. The player and the GM should work together to select the new powers, with an eye towards making something memorable yet campaign-appropriate. Characters of any class can select this ability.</td></tr>
<tr><td>Won't Stay Dead (Ex)</td><td>At 20th level, the character becomes a paragon of resilience. Once per week, if the character is killed, petrified, or otherwise removed from play, the character manages to survive by some dint of skill or luck and returns at the end of the combat or the scene (GM's discretion). The player and the GM should work together to ensure that the method of the character's survival is at least vaguely plausible, if unlikely. Characters of any class can select this ability.</td></tr>
</tbody></table></ScrollContainer>
<h3 id="class-witch-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
<p><strong>Aphorite:</strong> The witch gains 1/6 of a new witch hex.<sup><InnerLink showBacklink="backlink-class-witch-ref-A-1" id="class-witch-ref-A-1" data-hash-target to="class-witch-A">1</InnerLink></sup></p>
<p><strong>Aquatic elf:</strong> When casting a witch spell underwater, add 1/3 to the effective caster level of the spell for the purpose of determining the spell's duration.<sup><InnerLink showBacklink="backlink-class-witch-ref-B-1" id="class-witch-ref-B-1" data-hash-target to="class-witch-B">2</InnerLink></sup></p>
<p><strong>Changeling:</strong> Add one spell from the witch spell list to the witch's familiar. This spell must be at least one level below the highest spell level she can cast. If the witch ever replaces her familiar, the new familiar knows these bonus spells.<sup><InnerLink showBacklink="backlink-class-witch-ref-C-1" id="class-witch-ref-C-1" data-hash-target to="class-witch-C">3</InnerLink></sup></p>
<p><strong>Duskwalker:</strong> Add 1/4 to the witch's caster level when casting spells of the necromancy school.<sup><InnerLink showBacklink="backlink-class-witch-ref-D-1" id="class-witch-ref-D-1" data-hash-target to="class-witch-D">4</InnerLink></sup></p>
<p><strong>Dwarf:</strong> Add +1/4 natural armor bonus to the AC of the witch's familiar.<sup><InnerLink showBacklink="backlink-class-witch-ref-E-1" id="class-witch-ref-E-1" data-hash-target to="class-witch-E">5</InnerLink></sup></p>
<p><strong>Elf:</strong> Add one spell from the witch spell list to the witch's familiar. This spell must be at least one level lower than the highest-level spell she can cast. If the witch ever replaces her familiar, the new familiar knows these bonus spells.<sup><InnerLink showBacklink="backlink-class-witch-ref-F-1" id="class-witch-ref-F-1" data-hash-target to="class-witch-F">6</InnerLink></sup></p>
<p><strong>Elf:</strong> Add a +1/2 bonus on Spellcraft checks to identify cursed items and on Sense Motive checks to notice enchantment or possession.<sup><InnerLink showBacklink="backlink-class-witch-ref-G-1" id="class-witch-ref-G-1" data-hash-target to="class-witch-G">7</InnerLink></sup></p>
<p><strong>Gathlain:</strong> Add one spell from the druid spell list to the witch's familiar. This spell must be at least one level below the highest spell level the witch can cast. If the familiar is ever replaced, the new familiar knows these bonus spells.<sup><InnerLink showBacklink="backlink-class-witch-ref-H-1" id="class-witch-ref-H-1" data-hash-target to="class-witch-H">8</InnerLink></sup></p>
<p><strong>Ghoran:</strong> Add 1/4 to the witch's caster level when attempting dispel checks using <Link to="/spell/dispel_magic">dispel magic</Link>, <Link to="/spell/break_enchantment">break enchantment</Link>, and similar effects.<sup><InnerLink showBacklink="backlink-class-witch-ref-I-1" id="class-witch-ref-I-1" data-hash-target to="class-witch-I">9</InnerLink></sup></p>
<p><strong>Gnome:</strong> The witch gains 1/6 of a new witch hex.<sup><InnerLink showBacklink="backlink-class-witch-ref-J-1" id="class-witch-ref-J-1" data-hash-target to="class-witch-J">10</InnerLink></sup></p>
<p><strong>Goblin:</strong> Add +1 spell from the witch spell list to the witch's familiar. This spell must be at least one level below the highest spell level she can cast. If the witch ever replaces her familiar, the new familiar knows these bonus spells.<sup><InnerLink showBacklink="backlink-class-witch-ref-K-1" id="class-witch-ref-K-1" data-hash-target to="class-witch-K">11</InnerLink></sup> <sup><InnerLink showBacklink="backlink-class-witch-ref-L-1" id="class-witch-ref-L-1" data-hash-target to="class-witch-L">12</InnerLink></sup></p>
<p><strong>Grippli:</strong> Add 1/3 to the saving throw DC to resist the poison of the witch's familiar.<sup><InnerLink showBacklink="backlink-class-witch-ref-M-1" id="class-witch-ref-M-1" data-hash-target to="class-witch-M">13</InnerLink></sup></p>
<p><strong>Half-elf:</strong> Add one spell from the witch spell list to the witch's familiar. This spell must be at least one level below the highest spell level she can cast. If the witch ever replaces her familiar, the new familiar knows these bonus spells.<sup><InnerLink showBacklink="backlink-class-witch-ref-N-1" id="class-witch-ref-N-1" data-hash-target to="class-witch-N">14</InnerLink></sup> <sup><InnerLink showBacklink="backlink-class-witch-ref-O-1" id="class-witch-ref-O-1" data-hash-target to="class-witch-O">15</InnerLink></sup></p>
<p><strong>Halfling:</strong> Add +1/4 to the witch's caster level when determining the effects of the spells granted to her by her patron.<sup><InnerLink showBacklink="backlink-class-witch-ref-P-1" id="class-witch-ref-P-1" data-hash-target to="class-witch-P">16</InnerLink></sup></p>
<p><strong>Half-orc:</strong> Add +1 skill rank to the witch's familiar. If the half-orc ever replaces her familiar, the new familiar gains these bonus skill ranks.<sup><InnerLink showBacklink="backlink-class-witch-ref-Q-1" id="class-witch-ref-Q-1" data-hash-target to="class-witch-Q">17</InnerLink></sup> <sup><InnerLink showBacklink="backlink-class-witch-ref-R-1" id="class-witch-ref-R-1" data-hash-target to="class-witch-R">18</InnerLink></sup></p>
<p><strong>Human:</strong> Add one spell from the witch spell list to the witch's familiar. This spell must be at least one level below the highest spell level she can cast. If the witch ever replaces her familiar, the new familiar knows these bonus spells.<sup><InnerLink showBacklink="backlink-class-witch-ref-S-1" id="class-witch-ref-S-1" data-hash-target to="class-witch-S">19</InnerLink></sup> <sup><InnerLink showBacklink="backlink-class-witch-ref-T-1" id="class-witch-ref-T-1" data-hash-target to="class-witch-T">20</InnerLink></sup></p>
<p><strong>Kitsune:</strong> Gain 1/6 of a new Magical Tail feat. Any kitsune character can choose this bonus upon gaining a level in her favored class.<sup><InnerLink showBacklink="backlink-class-witch-ref-U-1" id="class-witch-ref-U-1" data-hash-target to="class-witch-U">21</InnerLink></sup></p>
<p><strong>Kobold:</strong> Add +5 feet to the distance at which her familiar grants the <Link to="/feat/alertness">Alertness</Link> feat (maximum +20 feet).<sup><InnerLink showBacklink="backlink-class-witch-ref-V-1" id="class-witch-ref-V-1" data-hash-target to="class-witch-V">22</InnerLink></sup></p>
<p><strong>Merfolk:</strong> Add 1 to the witch's caster level for one of her patron spells (to a maximum of +3 caster level to any one spell).<sup><InnerLink showBacklink="backlink-class-witch-ref-W-1" id="class-witch-ref-W-1" data-hash-target to="class-witch-W">23</InnerLink></sup></p>
<p><strong>Orc:</strong> Add one spell from the witch spell list to the witch's familiar. This spell must be at least one level below the highest spell level she can cast. If the witch ever replaces her familiar, the new familiar knows these bonus spells.<sup><InnerLink showBacklink="backlink-class-witch-ref-X-1" id="class-witch-ref-X-1" data-hash-target to="class-witch-X">24</InnerLink></sup></p>
<p><strong>Ratfolk:</strong> Add +5 feet to the range of one hex with a range other than "touch."<sup><InnerLink showBacklink="backlink-class-witch-ref-Y-1" id="class-witch-ref-Y-1" data-hash-target to="class-witch-Y">25</InnerLink></sup></p>
<p><strong>Strix:</strong> Add one spell from the witch spell list to the witch's familiar. This spell must be at least 1 level below the highest spell level the witch can cast. If the witch ever replaces this familiar, the new familiar knows these bonus spells.<sup><InnerLink showBacklink="backlink-class-witch-ref-Z-1" id="class-witch-ref-Z-1" data-hash-target to="class-witch-Z">26</InnerLink></sup></p>
<p><strong>Sylph:</strong> Add a +1/2 bonus on Stealth checks and Perception checks made by the witch's familiar. If the sylph ever replaces her familiar, the new familiar gains these bonus skill ranks.<sup><InnerLink showBacklink="backlink-class-witch-ref-1-1" id="class-witch-ref-1-1" data-hash-target to="class-witch-1">27</InnerLink></sup></p>
<p><strong>Tengu:</strong> Add one spell from the witch spell list to the witch's familiar. This spell must be at least one level below the highest spell level she can cast. If the witch ever replaces her familiar, the new familiar knows these bonus spells.<sup><InnerLink showBacklink="backlink-class-witch-ref-2-1" id="class-witch-ref-2-1" data-hash-target to="class-witch-2">28</InnerLink></sup></p>
<p><strong>Tiefling:</strong> The witch's familiar gains resistance 1 against cold, electricity, or fire. Each time the witch selects this reward, increase the familiar's resistance to one of these energy types by 1 (maximum 5 for any one type). If the witch ever replaces her familiar, the new familiar has these resistances.<sup><InnerLink showBacklink="backlink-class-witch-ref-3-1" id="class-witch-ref-3-1" data-hash-target to="class-witch-3">29</InnerLink></sup></p>
<p><strong>Vanara:</strong> Add 1/4 to the witch's caster level when determining the effects of spells granted to her by her patron (to a maximum of +2).<sup><InnerLink showBacklink="backlink-class-witch-ref-4-1" id="class-witch-ref-4-1" data-hash-target to="class-witch-4">30</InnerLink></sup></p>
<p><strong>Wayang:</strong> Add one spell from the sorcerer/wizard spell list that isn't on the witch spell list to the list of spells the witch knows. This spell must be at least 1 level below the highest spell level the witch can cast and be of the illusion (shadow) subschool or have the darkness descriptor.<sup><InnerLink showBacklink="backlink-class-witch-ref-5-1" id="class-witch-ref-5-1" data-hash-target to="class-witch-5">31</InnerLink></sup></p>
</div>
...
<section data-footnotes>
<h3 id="class-witch-label">Footnotes</h3>
<ol>
<li id="class-witch-A">
<p><Link to="/source/plane_hoppers_handbook">Plane-Hopper's Handbook pg. 15</Link> <InnerLink id="backlink-class-witch-ref-A-1" data-hash-target to="class-witch-ref-A-1" aria-label="Back to reference A-1">↩</InnerLink></p>
</li>
<li id="class-witch-B">
<p><Link to="/source/blood_of_the_sea">Blood of the Sea pg. 5</Link> <InnerLink id="backlink-class-witch-ref-B-1" data-hash-target to="class-witch-ref-B-1" aria-label="Back to reference B-1">↩</InnerLink></p>
</li>
<li id="class-witch-C">
<p><Link to="/source/advanced_race_guide">Advanced Race Guide pg. 184</Link> <InnerLink id="backlink-class-witch-ref-C-1" data-hash-target to="class-witch-ref-C-1" aria-label="Back to reference C-1">↩</InnerLink></p>
</li>
<li id="class-witch-D">
<p>Plane-Hopper's Handbook pg. 17 <InnerLink id="backlink-class-witch-ref-D-1" data-hash-target to="class-witch-ref-D-1" aria-label="Back to reference D-1">↩</InnerLink></p>
</li>
<li id="class-witch-E">
<p>Advanced Race Guide pg. 13 <InnerLink id="backlink-class-witch-ref-E-1" data-hash-target to="class-witch-ref-E-1" aria-label="Back to reference E-1">↩</InnerLink></p>
</li>
<li id="class-witch-F">
<p>Advanced Race Guide pg. 23 <InnerLink id="backlink-class-witch-ref-F-1" data-hash-target to="class-witch-ref-F-1" aria-label="Back to reference F-1">↩</InnerLink></p>
</li>
<li id="class-witch-G">
<p><Link to="/source/horror_adventures">Horror Adventures pg. 39</Link> <InnerLink id="backlink-class-witch-ref-G-1" data-hash-target to="class-witch-ref-G-1" aria-label="Back to reference G-1">↩</InnerLink></p>
</li>
<li id="class-witch-H">
<p><Link to="/source/ultimate_wilderness">Ultimate Wilderness pg. 10</Link> <InnerLink id="backlink-class-witch-ref-H-1" data-hash-target to="class-witch-ref-H-1" aria-label="Back to reference H-1">↩</InnerLink></p>
</li>
<li id="class-witch-I">
<p>Ultimate Wilderness pg. 17 <InnerLink id="backlink-class-witch-ref-I-1" data-hash-target to="class-witch-ref-I-1" aria-label="Back to reference I-1">↩</InnerLink></p>
</li>
<li id="class-witch-J">
<p>Advanced Race Guide pg. 34 <InnerLink id="backlink-class-witch-ref-J-1" data-hash-target to="class-witch-ref-J-1" aria-label="Back to reference J-1">↩</InnerLink></p>
</li>
<li id="class-witch-K">
<p>Advanced Race Guide pg. 116 <InnerLink id="backlink-class-witch-ref-K-1" data-hash-target to="class-witch-ref-K-1" aria-label="Back to reference K-1">↩</InnerLink></p>
</li>
<li id="class-witch-L">
<p><Link to="/source/goblins_of_golarion">Goblins of Golarion pg. 31</Link> <InnerLink id="backlink-class-witch-ref-L-1" data-hash-target to="class-witch-ref-L-1" aria-label="Back to reference L-1">↩</InnerLink></p>
</li>
<li id="class-witch-M">
<p><Link to="/source/blood_of_the_beast">Blood of the Beast pg. 8</Link> <InnerLink id="backlink-class-witch-ref-M-1" data-hash-target to="class-witch-ref-M-1" aria-label="Back to reference M-1">↩</InnerLink></p>
</li>
<li id="class-witch-N">
<p>Advanced Race Guide pg. 43 <InnerLink id="backlink-class-witch-ref-N-1" data-hash-target to="class-witch-ref-N-1" aria-label="Back to reference N-1">↩</InnerLink></p>
</li>
<li id="class-witch-O">
<p><Link to="/source/advanced_players_guide">Advanced Player's Guide pg. 17</Link> <InnerLink id="backlink-class-witch-ref-O-1" data-hash-target to="class-witch-ref-O-1" aria-label="Back to reference O-1">↩</InnerLink></p>
</li>
<li id="class-witch-P">
<p>Advanced Race Guide pg. 63 <InnerLink id="backlink-class-witch-ref-P-1" data-hash-target to="class-witch-ref-P-1" aria-label="Back to reference P-1">↩</InnerLink></p>
</li>
<li id="class-witch-Q">
<p>Advanced Race Guide pg. 53 <InnerLink id="backlink-class-witch-ref-Q-1" data-hash-target to="class-witch-ref-Q-1" aria-label="Back to reference Q-1">↩</InnerLink></p>
</li>
<li id="class-witch-R">
<p>Advanced Player's Guide pg. 19 <InnerLink id="backlink-class-witch-ref-R-1" data-hash-target to="class-witch-ref-R-1" aria-label="Back to reference R-1">↩</InnerLink></p>
</li>
<li id="class-witch-S">
<p>Advanced Race Guide pg. 73 <InnerLink id="backlink-class-witch-ref-S-1" data-hash-target to="class-witch-ref-S-1" aria-label="Back to reference S-1">↩</InnerLink></p>
</li>
<li id="class-witch-T">
<p>Advanced Player's Guide pg. 23 <InnerLink id="backlink-class-witch-ref-T-1" data-hash-target to="class-witch-ref-T-1" aria-label="Back to reference T-1">↩</InnerLink></p>
</li>
<li id="class-witch-U">
<p>Blood of the Beast pg. 12 <InnerLink id="backlink-class-witch-ref-U-1" data-hash-target to="class-witch-ref-U-1" aria-label="Back to reference U-1">↩</InnerLink></p>
</li>
<li id="class-witch-V">
<p>Advanced Race Guide pg. 134 <InnerLink id="backlink-class-witch-ref-V-1" data-hash-target to="class-witch-ref-V-1" aria-label="Back to reference V-1">↩</InnerLink></p>
</li>
<li id="class-witch-W">
<p>Blood of the Sea pg. 13 <InnerLink id="backlink-class-witch-ref-W-1" data-hash-target to="class-witch-ref-W-1" aria-label="Back to reference W-1">↩</InnerLink></p>
</li>
<li id="class-witch-X">
<p>Advanced Race Guide pg. 139 <InnerLink id="backlink-class-witch-ref-X-1" data-hash-target to="class-witch-ref-X-1" aria-label="Back to reference X-1">↩</InnerLink></p>
</li>
<li id="class-witch-Y">
<p>Advanced Race Guide pg. 151 <InnerLink id="backlink-class-witch-ref-Y-1" data-hash-target to="class-witch-ref-Y-1" aria-label="Back to reference Y-1">↩</InnerLink></p>
</li>
<li id="class-witch-Z">
<p><Link to="/source/pathfinder_101_the_kintargo_contract">Pathfinder #101: The Kintargo Contract pg. 73</Link> <InnerLink id="backlink-class-witch-ref-Z-1" data-hash-target to="class-witch-ref-Z-1" aria-label="Back to reference Z-1">↩</InnerLink></p>
</li>
<li id="class-witch-1">
<p>Advanced Race Guide pg. 157 <InnerLink id="backlink-class-witch-ref-1-1" data-hash-target to="class-witch-ref-1-1" aria-label="Back to reference 1-1">↩</InnerLink></p>
</li>
<li id="class-witch-2">
<p>Advanced Race Guide pg. 167 <InnerLink id="backlink-class-witch-ref-2-1" data-hash-target to="class-witch-ref-2-1" aria-label="Back to reference 2-1">↩</InnerLink></p>
</li>
<li id="class-witch-3">
<p>Advanced Race Guide pg. 170 <InnerLink id="backlink-class-witch-ref-3-1" data-hash-target to="class-witch-ref-3-1" aria-label="Back to reference 3-1">↩</InnerLink></p>
</li>
<li id="class-witch-4">
<p>Blood of the Beast pg. 28 <InnerLink id="backlink-class-witch-ref-4-1" data-hash-target to="class-witch-ref-4-1" aria-label="Back to reference 4-1">↩</InnerLink></p>
</li>
<li id="class-witch-5">
<p><Link to="/source/blood_of_shadows">Blood of Shadows pg. 11</Link> <InnerLink id="backlink-class-witch-ref-5-1" data-hash-target to="class-witch-ref-5-1" aria-label="Back to reference 5-1">↩</InnerLink></p>
</li>
</ol>
</section>
</>};
const _wizard = {hasJL:true,title: "Wizard", jsx: <><div className="jumpList" id="class-wizard-jumplist"><h2>Jump to:</h2><ul><li><InnerLink toTop to="class-wizard-bonus-languages">Bonus Languages</InnerLink></li><li><InnerLink toTop to="class-wizard-spells">Spells</InnerLink></li><li><InnerLink toTop to="class-wizard-arcane-bond-ex-or-sp">Arcane Bond</InnerLink></li><li><InnerLink toTop to="class-wizard-arcane-school">Arcane School</InnerLink></li><li><InnerLink toTop to="class-wizard-scribe-scroll">Scribe Scroll</InnerLink></li><li><InnerLink toTop to="class-wizard-bonus-feats">Bonus Feats</InnerLink></li><li><InnerLink toTop to="class-wizard-arcane-discoveries">Arcane Discoveries</InnerLink></li><li><InnerLink toTop to="class-wizard-alternate-capstones">Alternate Capstones</InnerLink></li><li><InnerLink toTop to="class-wizard-favored-class-bonuses">Favored Class Bonuses</InnerLink></li><li><InnerLink toTop to="class-wizard-archetypes">Archetypes</InnerLink></li><li><InnerLink toTop to="class-wizard-archetypes-by-feature">Archetypes by Feature</InnerLink></li></ul></div><h2 id="class-wizard-wizard">Wizard</h2>
...
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-wizard-bonus-languages" data-hash-target><div className="box">Bonus Languages</div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You may substitute Draconic for one of the bonus languages available to you because of your race.</div></div></div></div>
<div className="ability"><div className="abIcon"><Link to="/icons"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-wizard-spells" data-hash-target><div className="box">Spells</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Usage</div></div><div className="abEnd"><div className="box">To learn, prepare, or cast a spell, you must have a Intelligence score equal to at least 10 + the spell level. You can cast only a certain number of spells of each spell level per day, as shown on the table above. In addition, you receive <Link to="/rule/determine_bonuses">bonus spells per day</Link> if you have a high Intelligence score.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain the ability to cast arcane spells which are drawn from the <Link to="/main/spells_wizard">wizard spell list</Link>. The DC for a saving throw against spells you cast is 10 + the spell level + your Intelligence modifier. You must choose and prepare your spells in advance.</div></div></div><div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">You may know any number of spells. You must choose and prepare your spells ahead of time by getting 8 hours of sleep and spending 1 hour studying your spellbook and deciding which spells to prepare.</div></div></div></div><div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-wizard-cantrips" data-hash-target><div className="box">Cantrips</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You can prepare a number of cantrips, or 0-level arcane spells, each day. These spells are cast like any other but they are not expended when cast and may be used again. You can prepare a cantrip from a prohibited school, but it uses up two of your available slots.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-wizard-spellbooks" data-hash-target><div className="box">Spellbooks</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You must study your spellbook each day to prepare your spells. You can't prepare any spell not recorded in your spellbook, except for <Link to="/spell/read_magic">read magic</Link> (which all wizards can prepare from memory).</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">You begin play with a spellbook containing all 0-level wizard spells (except those from his prohibited schools, if any; see <em>Arcane Schools</em>) plus three 1st-level spells of your choice. You also select a number of additional 1st-level spells equal to your Intelligence modifier to add to the spellbook. At each new wizard level, you gain two new spells of any spell level or levels that you can cast (based on your new wizard level) for your spellbook. At any time, you can also add spells found in wizards' spellbooks to your own (see <Link to="/rule/arcane_magical_writing">Arcane Magical Writing</Link>).</div></div></div></div>
<div className="ability hasSubs"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-wizard-arcane-bond-ex-or-sp" data-hash-target><div className="box">Arcane Bond (Ex or Sp)</div><div className="flavor">At 1st level, wizards form a powerful bond with an object or a creature.</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Choice</div></div><div className="abEnd"><div className="box">This bond can take one of two forms: a familiar or a bonded object. Once you make this choice, it is permanent and cannot be changed.</div></div></div></div>
<div className="ability subAbility numbered"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-wizard-familiar" data-hash-target><div className="box">Familiar</div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">A <Link to="/sidekick/familiar">familiar</Link> is a magical pet that enhances your skills and senses and can aid you in magic. The full rules for familiars can be found <Link to="/ability/familiars">here</Link>.</div></div></div></div>
<div className="ability subAbility numbered"><div className="abIcon"><Link to="/icons/magic-swirl"><IonIcon icon="/icons/magic-swirl.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-wizard-bonded-object" data-hash-target><div className="box">Bonded Object</div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box"><p>If you select a bonded object, you begin play with one at no cost. Objects that are the subject of an arcane bond must fall into one of the following categories: amulet, ring, staff, wand, or weapon. These objects are always masterwork quality. Weapons acquired at 1st level are not made of any special material. If the object is an amulet or ring, it must be worn to have effect, while staves, wands, and weapons must be wielded. If you attempt to cast a spell without your bonded object worn or in hand, you must make a <Link to="/rule/concentration">concentration</Link> check or lose the spell. The DC for this check is equal to 20 + the spell's level. If the object is a ring or amulet, it occupies the <Link to="/rule/neck_slot">ring or neck slot</Link> accordingly.</p>
...
<div className="abPair"><div className="abStart"><div className="box">Special</div></div><div className="abEnd"><div className="box">This choice must be made at 1st level, and once made, it cannot be changed. If you choose not to specialize, you receive the <Link to="/arcaneschool/universalist">universalist</Link> school instead; a universalist wizard has no opposition schools and thus can prepare spells from any school without restriction, but he does not receive a school slot.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-wizard-scribe-scroll" data-hash-target><div className="box">Scribe Scroll</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 1st Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">you gain <Link to="/feat/scribe_scroll">Scribe Scroll</Link> as a bonus feat.</div></div></div></div>
<div className="ability p"><div className="abIcon"><Link to="/icons/stairs-goal"><IonIcon icon="/icons/stairs-goal.svg" color="secondary" /></Link></div>
<div className="title abSingle" id="class-wizard-bonus-feats" data-hash-target><div className="box">Bonus Feats</div></div>
<div className="abPair"><div className="abStart"><div className="box">Gained</div></div><div className="abEnd"><div className="box">At 5th Level</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">Ability</div></div><div className="abEnd"><div className="box">You gain a bonus feat from the following choices: <Link to="/feat/spell_mastery">Spell Mastery</Link>, <Link to="/feat/eldritch_aid">Eldritch Aid</Link>, <Link to="/feat/planned_spontaneity">Planned Spontaneity</Link>, any <Link to="/main/metamagic_feat">metamagic feat</Link>, any <Link to="/main/item_creation_feat">item creation feat</Link>, or any <Link to="/main/feats_familiar">familiar feat</Link>. You must meet all prerequisites for a bonus feat, including caster level minimums.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 10th Level</div></div><div className="abEnd"><div className="box">You gain another bonus feat from the given choices. You still need to meet its prerequisites.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 15th Level</div></div><div className="abEnd"><div className="box">You gain another bonus feat from the given choices. You still need to meet its prerequisites.</div></div></div>
<div className="abPair"><div className="abStart"><div className="box">At 20th Level</div></div><div className="abEnd"><div className="box">You gain another bonus feat from the given choices. You still need to meet its prerequisites.</div></div></div></div>
...
<p><strong>Sources</strong> <Link to="/source/chronicle_of_legends">Chronicle of Legends pg. 28</Link><br/>When a character reaches the 20th level of a class, she gains a powerful class feature or ability, sometimes referred to as a capstone. The following section provides <Link to="/ability/capstones">new capstones</Link> for characters to select at 20th level. A character can select one of the following capstones in place of the capstone provided by her class. Some capstones are for specific classes, while others are for a range of classes that qualify for them. In some cases, a capstone specifies what ability it replaces. A character can't select a new capstone if she has previously traded away her class capstone via an archetype. Clerics and wizards can receive a capstone at 20th level, despite not having one to begin with. A character that gains certain abilities may be eligible for capstones other than those listed below.</p>
<ScrollContainer id="class-wizard--table-1"><table><thead><tr><th scope="col">Capstone</th><th scope="col">Benefit</th></tr></thead>
<tbody>
<tr><td>Arch-Familiar (Su)</td><td>At 20th level, the character's familiar is smarter and savvier than plenty of adventurers - and also more dangerous! The familiar's Intelligence increases by 5, and it gains 12 spells levels' worth of spell-like abilities (for example, three daily castings of <Link to="/spell/greater_invisibility">greater invisibility</Link>), drawn from spells its master can cast and using its master's caster levels, DCs, and so forth. This capstone is available to any class with a familiar.</td></tr>
<tr><td>Perfect Body, Flawless Mind (Ex)</td><td>At 20th level, the character's endless training and study has resulted in an unmatched mastery of the self. The character increases her ability scores by a collective total of 8. For example, she can increase one score by 8, or one score by 5 and another by 3, or four scores by 2, and so on. Characters of any class can select this ability.</td></tr>
<tr><td>The Boss (Ex)</td><td>At 20th level, the character has become more than just a lone hero - she has become one of the senior figures of her field, with powers and responsibilities to match. The character becomes one of the leading figures in some manner of group or organization, as appropriate to the campaign and the setting. A wizard might become the dean of an arcane university or mages' guild, a fighter could command a mercenary army or a city guard, a cleric might lead a major temple or her own sect, and so forth. The player and the GM should work together to determine the specifics. The character gains the <Link to="/feat/leadership">Leadership</Link> feat if she does not already have it, and the number of followers that the feat grants is multiplied by 10 (although depending on the campaign and setting, the position may grant other powers as well). If multiple characters in a party select this capstone, the GM may consider pooling them to grant the players a particularly large and powerful organization, such as a small kingdom. Characters of any class can select this ability.</td></tr>
...
<h3 id="class-wizard-favored-class-bonuses" data-hash-target>Favored Class Bonuses</h3>
<div className="hanging striped">
<p><strong>Aphorite:</strong> Add 1/3 to the wizard's caster level when casting spells with the lawful descriptor or spells that create magical glyphs, runes, or symbols.<sup><InnerLink showBacklink="backlink-class-wizard-ref-A-1" id="class-wizard-ref-A-1" data-hash-target to="class-wizard-A">1</InnerLink></sup></p>
<p><strong>Aquatic elf:</strong> Add 1 to the wizard's caster level check when attempting to cast a spell with the fire descriptor underwater.<sup><InnerLink showBacklink="backlink-class-wizard-ref-B-1" id="class-wizard-ref-B-1" data-hash-target to="class-wizard-B">2</InnerLink></sup></p>
<p><strong>Dhampir:</strong> Add +1/4 to the wizard's caster level when casting spells of the necromancy school.<sup><InnerLink showBacklink="backlink-class-wizard-ref-C-1" id="class-wizard-ref-C-1" data-hash-target to="class-wizard-C">3</InnerLink></sup></p>
<p><strong>Drow:</strong> Select one arcane school power at 1st level that is normally usable a number of times per day equal to 3 + the wizard's Intelligence modifier. The wizard adds +1/2 to the number of uses per day of that arcane school power.<sup><InnerLink showBacklink="backlink-class-wizard-ref-D-1" id="class-wizard-ref-D-1" data-hash-target to="class-wizard-D">4</InnerLink></sup></p>
<p><strong>Duskwalker:</strong> Add 1/4 to the wizard's caster level when casting spells of the necromancy school.<sup><InnerLink showBacklink="backlink-class-wizard-ref-E-1" id="class-wizard-ref-E-1" data-hash-target to="class-wizard-E">5</InnerLink></sup></p>
<p><strong>Dwarf:</strong> Select one item creation feat known by the wizard. Whenever he crafts an item using that feat, the amount of progress he makes in an 8-hour period increases by 200 gp (50 gp if crafting while adventuring). This does not reduce the cost of the item; it just increases the rate at which the item is crafted.<sup><InnerLink showBacklink="backlink-class-wizard-ref-F-1" id="class-wizard-ref-F-1" data-hash-target to="class-wizard-F">6</InnerLink></sup></p>
<p><strong>Dwarf:</strong> Add 1/3 to the effective caster level of wizard abjuration spells, but only to determine duration.<sup><InnerLink showBacklink="backlink-class-wizard-ref-G-1" id="class-wizard-ref-G-1" data-hash-target to="class-wizard-G">7</InnerLink></sup></p>
<p><strong>Elf:</strong> Select one arcane school power at 1st level that is normally usable a number of times per day equal to 3 + the wizard's Intelligence modifier. The wizard adds +1/2 to the number of uses per day of that arcane school power.<sup><InnerLink showBacklink="backlink-class-wizard-ref-H-1" id="class-wizard-ref-H-1" data-hash-target to="class-wizard-H">8</InnerLink></sup> <sup><InnerLink showBacklink="backlink-class-wizard-ref-I-1" id="class-wizard-ref-I-1" data-hash-target to="class-wizard-I">9</InnerLink></sup></p>
<p><strong>Fetchling:</strong> Add one spell from the wizard spell list to wizard's spellbook. The spell must be at or below the highest level he can cast and be of the illusion (shadow) subschool or have the darkness descriptor.<sup><InnerLink showBacklink="backlink-class-wizard-ref-J-1" id="class-wizard-ref-J-1" data-hash-target to="class-wizard-J">10</InnerLink></sup></p>
<p><strong>Ganzi:</strong> Add 1/3 to the wizard's effective caster level when casting a spell with the chaotic descriptor.<sup><InnerLink showBacklink="backlink-class-wizard-ref-K-1" id="class-wizard-ref-K-1" data-hash-target to="class-wizard-K">11</InnerLink></sup></p>
<p><strong>Gillman:</strong> Add one spell from the wizard spell list to the wizard's spellbook. This spell must be at least one level below the highest spell level he can cast.<sup><InnerLink showBacklink="backlink-class-wizard-ref-L-1" id="class-wizard-ref-L-1" data-hash-target to="class-wizard-L">12</InnerLink></sup></p>
<p><strong>Gnome:</strong> Select one arcane school power at 1st level that is normally usable a number of times per day equal to 3 + the wizard's Intelligence modifier. The wizard adds +1/2 to the number of uses per day of that arcane school power.<sup><InnerLink showBacklink="backlink-class-wizard-ref-M-1" id="class-wizard-ref-M-1" data-hash-target to="class-wizard-M">13</InnerLink></sup> <sup><InnerLink showBacklink="backlink-class-wizard-ref-N-1" id="class-wizard-ref-N-1" data-hash-target to="class-wizard-N">14</InnerLink></sup></p>
<p><strong>Half-elf:</strong> When casting wizard enchantment spells, add +1/3 to the effective caster level of the spell, but only to determine the spell's duration.<sup><InnerLink showBacklink="backlink-class-wizard-ref-O-1" id="class-wizard-ref-O-1" data-hash-target to="class-wizard-O">15</InnerLink></sup></p>
<p><strong>Halfling:</strong> Add +1/2 to the wizard's effective class level for the purposes of determining his familiar's natural armor adjustment, Intelligence, and special abilities.<sup><InnerLink showBacklink="backlink-class-wizard-ref-P-1" id="class-wizard-ref-P-1" data-hash-target to="class-wizard-P">16</InnerLink></sup></p>
<p><strong>Half-orc:</strong> Add a +1 bonus on concentration checks made due to taking damage while casting wizard spells.<sup><InnerLink showBacklink="backlink-class-wizard-ref-Q-1" id="class-wizard-ref-Q-1" data-hash-target to="class-wizard-Q">17</InnerLink></sup></p>
<p><strong>Human:</strong> Add one spell from the wizard spell list to the wizard's spellbook. This spell must be at least one level below the highest spell level the wizard can cast.<sup><InnerLink showBacklink="backlink-class-wizard-ref-R-1" id="class-wizard-ref-R-1" data-hash-target to="class-wizard-R">18</InnerLink></sup> <sup><InnerLink showBacklink="backlink-class-wizard-ref-S-1" id="class-wizard-ref-S-1" data-hash-target to="class-wizard-S">19</InnerLink></sup></p>
<p><strong>Kitsune:</strong> Gain 1/6 of a new Magical Tail feat. Any kitsune character can choose this bonus upon gaining a level in her favored class.<sup><InnerLink showBacklink="backlink-class-wizard-ref-T-1" id="class-wizard-ref-T-1" data-hash-target to="class-wizard-T">20</InnerLink></sup></p>
<p><strong>Kobold:</strong> Add 1/2 to your familiar's Will saves against enchantment effects, or increase the hit points of your bonded item by 1.<sup><InnerLink showBacklink="backlink-class-wizard-ref-U-1" id="class-wizard-ref-U-1" data-hash-target to="class-wizard-U">21</InnerLink></sup></p>
<p><strong>Samsaran:</strong> Add one spell from the wizard spell list to the wizard's spellbook. This spell must be at least one level below the highest spell level the wizard can cast.<sup><InnerLink showBacklink="backlink-class-wizard-ref-V-1" id="class-wizard-ref-V-1" data-hash-target to="class-wizard-V">22</InnerLink></sup></p>
<p><strong>Sylph:</strong> Select one arcane school power from the air or wood elemental schools that the wizard can currently use. The wizard treats her class level as though it were +1/6 higher (to a maximum of +2) when determining the effects of that power.<sup><InnerLink showBacklink="backlink-class-wizard-ref-W-1" id="class-wizard-ref-W-1" data-hash-target to="class-wizard-W">23</InnerLink></sup></p>
<p><strong>Tiefling:</strong> Select one arcane school power at 1st level that is normally usable a number of times per day equal to 3 + the wizard's Intelligence modifier. The wizard adds +1/2 to the number of uses per day of that arcane school power.<sup><InnerLink showBacklink="backlink-class-wizard-ref-X-1" id="class-wizard-ref-X-1" data-hash-target to="class-wizard-X">24</InnerLink></sup></p>
<p><strong>Undine:</strong> Add one spell from the cleric, druid, or wizard spell list with the water descriptor to the wizard's spellbook. This spell must be at least one level below the highest spell level he can cast. This spell is treated as one level higher unless it also appears on the wizard spell list.<sup><InnerLink showBacklink="backlink-class-wizard-ref-Y-1" id="class-wizard-ref-Y-1" data-hash-target to="class-wizard-Y">25</InnerLink></sup></p>
<p><strong>Vanara:</strong> 1/6 of a bonus feat. This feat must be an <Link to="/main/item_creation_feat">item creation feat</Link>, a <Link to="/main/metamagic_feat">metamagic feat</Link>, or <Link to="/feat/spell_mastery">Spell Mastery</Link>.<sup><InnerLink showBacklink="backlink-class-wizard-ref-Z-1" id="class-wizard-ref-Z-1" data-hash-target to="class-wizard-Z">26</InnerLink></sup></p>
<p><strong>Wayang:</strong> Add one spell from the wizard spell list to the wizard's spellbook. The spell must be an illusion spell of the shadow subschool or have the darkness descriptor.<sup><InnerLink showBacklink="backlink-class-wizard-ref-1-1" id="class-wizard-ref-1-1" data-hash-target to="class-wizard-1">27</InnerLink></sup></p>
<p><strong>Wyrwood:</strong> The wizard gains 1/6 of a bonus <Link to="/main/item_creation_feat">item creation</Link>, <Link to="/main/metamagic_feat">metamagic</Link>, or <Link to="/feat/spell_mastery">spell mastery</Link> feat.<sup><InnerLink showBacklink="backlink-class-wizard-ref-2-1" id="class-wizard-ref-2-1" data-hash-target to="class-wizard-2">28</InnerLink></sup></p>
</div>
...
<section data-footnotes>
<h3 id="class-wizard-label">Footnotes</h3>
<ol>
<li id="class-wizard-A">
<p><Link to="/source/plane_hoppers_handbook">Plane-Hopper's Handbook pg. 15</Link> <InnerLink id="backlink-class-wizard-ref-A-1" data-hash-target to="class-wizard-ref-A-1" aria-label="Back to reference A-1">↩</InnerLink></p>
</li>
<li id="class-wizard-B">
<p><Link to="/source/blood_of_the_sea">Blood of the Sea pg. 5</Link> <InnerLink id="backlink-class-wizard-ref-B-1" data-hash-target to="class-wizard-ref-B-1" aria-label="Back to reference B-1">↩</InnerLink></p>
</li>
<li id="class-wizard-C">
<p><Link to="/source/advanced_race_guide">Advanced Race Guide pg. 98</Link> <InnerLink id="backlink-class-wizard-ref-C-1" data-hash-target to="class-wizard-ref-C-1" aria-label="Back to reference C-1">↩</InnerLink></p>
</li>
<li id="class-wizard-D">
<p>Advanced Race Guide pg. 104 <InnerLink id="backlink-class-wizard-ref-D-1" data-hash-target to="class-wizard-ref-D-1" aria-label="Back to reference D-1">↩</InnerLink></p>
</li>
<li id="class-wizard-E">
<p>Plane-Hopper's Handbook pg. 17 <InnerLink id="backlink-class-wizard-ref-E-1" data-hash-target to="class-wizard-ref-E-1" aria-label="Back to reference E-1">↩</InnerLink></p>
</li>
<li id="class-wizard-F">
<p>Advanced Race Guide pg. 13 <InnerLink id="backlink-class-wizard-ref-F-1" data-hash-target to="class-wizard-ref-F-1" aria-label="Back to reference F-1">↩</InnerLink></p>
</li>
<li id="class-wizard-G">
<p><Link to="/source/horror_adventures">Horror Adventures pg. 38</Link> <InnerLink id="backlink-class-wizard-ref-G-1" data-hash-target to="class-wizard-ref-G-1" aria-label="Back to reference G-1">↩</InnerLink></p>
</li>
<li id="class-wizard-H">
<p>Advanced Race Guide pg. 23 <InnerLink id="backlink-class-wizard-ref-H-1" data-hash-target to="class-wizard-ref-H-1" aria-label="Back to reference H-1">↩</InnerLink></p>
</li>
<li id="class-wizard-I">
<p><Link to="/source/advanced_players_guide">Advanced Player's Guide pg. 13</Link> <InnerLink id="backlink-class-wizard-ref-I-1" data-hash-target to="class-wizard-ref-I-1" aria-label="Back to reference I-1">↩</InnerLink></p>
</li>
<li id="class-wizard-J">
<p>Advanced Race Guide pg. 109 <InnerLink id="backlink-class-wizard-ref-J-1" data-hash-target to="class-wizard-ref-J-1" aria-label="Back to reference J-1">↩</InnerLink></p>
</li>
<li id="class-wizard-K">
<p>Plane-Hopper's Handbook pg. 19 <InnerLink id="backlink-class-wizard-ref-K-1" data-hash-target to="class-wizard-ref-K-1" aria-label="Back to reference K-1">↩</InnerLink></p>
</li>
<li id="class-wizard-L">
<p>Advanced Race Guide pg. 188 <InnerLink id="backlink-class-wizard-ref-L-1" data-hash-target to="class-wizard-ref-L-1" aria-label="Back to reference L-1">↩</InnerLink></p>
</li>
<li id="class-wizard-M">
<p>Advanced Race Guide pg. 34 <InnerLink id="backlink-class-wizard-ref-M-1" data-hash-target to="class-wizard-ref-M-1" aria-label="Back to reference M-1">↩</InnerLink></p>
</li>
<li id="class-wizard-N">
<p>Advanced Player's Guide pg. 15 <InnerLink id="backlink-class-wizard-ref-N-1" data-hash-target to="class-wizard-ref-N-1" aria-label="Back to reference N-1">↩</InnerLink></p>
</li>
<li id="class-wizard-O">
<p>Advanced Race Guide pg. 43 <InnerLink id="backlink-class-wizard-ref-O-1" data-hash-target to="class-wizard-ref-O-1" aria-label="Back to reference O-1">↩</InnerLink></p>
</li>
<li id="class-wizard-P">
<p>Advanced Race Guide pg. 63 <InnerLink id="backlink-class-wizard-ref-P-1" data-hash-target to="class-wizard-ref-P-1" aria-label="Back to reference P-1">↩</InnerLink></p>
</li>
<li id="class-wizard-Q">
<p>Advanced Race Guide pg. 53 <InnerLink id="backlink-class-wizard-ref-Q-1" data-hash-target to="class-wizard-ref-Q-1" aria-label="Back to reference Q-1">↩</InnerLink></p>
</li>
<li id="class-wizard-R">
<p>Advanced Race Guide pg. 73 <InnerLink id="backlink-class-wizard-ref-R-1" data-hash-target to="class-wizard-ref-R-1" aria-label="Back to reference R-1">↩</InnerLink></p>
</li>
<li id="class-wizard-S">
<p>Advanced Player's Guide pg. 23 <InnerLink id="backlink-class-wizard-ref-S-1" data-hash-target to="class-wizard-ref-S-1" aria-label="Back to reference S-1">↩</InnerLink></p>
</li>
<li id="class-wizard-T">
<p><Link to="/source/blood_of_the_beast">Blood of the Beast pg. 12</Link> <InnerLink id="backlink-class-wizard-ref-T-1" data-hash-target to="class-wizard-ref-T-1" aria-label="Back to reference T-1">↩</InnerLink></p>
</li>
<li id="class-wizard-U">
<p><Link to="/source/kobolds_of_golarion">Kobolds of Golarion pg. 15</Link> <InnerLink id="backlink-class-wizard-ref-U-1" data-hash-target to="class-wizard-ref-U-1" aria-label="Back to reference U-1">↩</InnerLink></p>
</li>
<li id="class-wizard-V">
<p>Advanced Race Guide pg. 198 <InnerLink id="backlink-class-wizard-ref-V-1" data-hash-target to="class-wizard-ref-V-1" aria-label="Back to reference V-1">↩</InnerLink></p>
</li>
<li id="class-wizard-W">
<p>Advanced Race Guide pg. 157 <InnerLink id="backlink-class-wizard-ref-W-1" data-hash-target to="class-wizard-ref-W-1" aria-label="Back to reference W-1">↩</InnerLink></p>
</li>
<li id="class-wizard-X">
<p>Advanced Race Guide pg. 170 <InnerLink id="backlink-class-wizard-ref-X-1" data-hash-target to="class-wizard-ref-X-1" aria-label="Back to reference X-1">↩</InnerLink></p>
</li>
<li id="class-wizard-Y">
<p>Advanced Race Guide pg. 176 <InnerLink id="backlink-class-wizard-ref-Y-1" data-hash-target to="class-wizard-ref-Y-1" aria-label="Back to reference Y-1">↩</InnerLink></p>
</li>
<li id="class-wizard-Z">
<p>Blood of the Beast pg. 28 <InnerLink id="backlink-class-wizard-ref-Z-1" data-hash-target to="class-wizard-ref-Z-1" aria-label="Back to reference Z-1">↩</InnerLink></p>
</li>
<li id="class-wizard-1">
<p><Link to="/source/blood_of_shadows">Blood of Shadows pg. 11</Link> <InnerLink id="backlink-class-wizard-ref-1-1" data-hash-target to="class-wizard-ref-1-1" aria-label="Back to reference 1-1">↩</InnerLink></p>
</li>
<li id="class-wizard-2">
<p><Link to="/source/heroes_of_golarion">Heroes of Golarion pg. 6</Link> <InnerLink id="backlink-class-wizard-ref-2-1" data-hash-target to="class-wizard-ref-2-1" aria-label="Back to reference 2-1">↩</InnerLink></p>
</li>
</ol>
</section>
</>};
