...
const ErrorPage: React.FC = () => {
	...
	return (m ?
		<BasicPage pageId="error-page" error title="Not Found" hierarchy={hierarchy} sources={sources}>
			<p>Unable to find the requested information. [Error 201]</p>
		</BasicPage>
	:
		<BasicPage pageId="error-page-other" error title="Not Found" hierarchy={hierarchy} sources={sources}>
