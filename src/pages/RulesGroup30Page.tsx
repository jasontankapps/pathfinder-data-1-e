import rules from './subpages/__rule30';
...
const RulesGroup30Page: React.FC<RulesProps> = ({id}) => {
	...
	const {
		...
		sources = [],
		className
	} = (rules[id as Prop]) as JsonRulesProps3<Name>;
...
export default RulesGroup30Page;
